...
ATP_PuzzleBlock::ATP_PuzzleBlock()
{
	...
	BlockMesh->OnTouchBegan.AddDynamic(this, &ATP_PuzzleBlock::OnFingerPressedBlock);
...
void ATP_PuzzleBlock::OnFingerPressedBlock(FTouchId, APlayerController*, const FHitResult&, UPrimitiveComponent*)
{
	HandleClicked();
}
