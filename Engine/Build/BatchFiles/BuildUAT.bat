...
set BAK_DEPENDS_FILE=..\Intermediate\Build\AutomationTool.dep.bak.csv
:tempRetry
set TEMP_DEPENDS_FILE=..\Intermediate\Build\AutomationTool.dep.tmp-%random%%random%.csv
...
copy /y "%DEPENDS_FILE%" "%BAK_DEPENDS_FILE%" >nul
