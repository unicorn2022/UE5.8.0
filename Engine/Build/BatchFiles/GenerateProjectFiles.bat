...
if not exist "%~dp0..\..\Source" goto Error_EngineSourceMissing
...
:Error_EngineSourceMissing
echo.
echo GenerateProjectFiles ERROR: The /Engine/Source directory appears to be missing or inaccessable from the location of this batch file.
echo.
pause
goto Exit
