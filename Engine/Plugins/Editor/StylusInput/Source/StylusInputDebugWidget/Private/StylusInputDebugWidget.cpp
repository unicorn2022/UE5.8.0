...
namespace UE::StylusInput::DebugWidget
{
	...
	{
		UE_LOGF(LogStylusInputDebugWidget, Error, "%ls", *Message);
	}

	inline void LogWarning(const FString& Message)
	{
		UE_LOGF(LogStylusInputDebugWidget, Warning, "%ls", *Message);
	}

	inline void LogVerbose(const FString& Message)
	{
		UE_LOGF(LogStylusInputDebugWidget, Verbose, "%ls", *Message);
	}
