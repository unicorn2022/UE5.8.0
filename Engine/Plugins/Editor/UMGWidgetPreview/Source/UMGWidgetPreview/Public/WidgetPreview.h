...
public:
	...
	UE_API bool ShouldDefaultConstructViewmodels() const;
	UE_API void SetDefaultConstructViewmodels(bool bInDefaultConstruct);
...
private:
	...
	/** When this preview is opened in the previewer, automatically construct any missing viewmodels. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Getter = ShouldDefaultConstructViewmodels, Setter = SetDefaultConstructViewmodels, Category = "Widget", meta = (AllowPrivateAccess = "true"))
	bool bDefaultConstructViewmodels;
