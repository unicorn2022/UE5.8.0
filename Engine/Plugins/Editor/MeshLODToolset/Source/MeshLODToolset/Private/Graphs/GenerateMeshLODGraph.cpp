	...
	FProgressCancel* Progress)
{
	...
	UE_LOGF(LogMeshLODToolset, Display, "NormalMapPass - Evaluated %d Nodes, Recomputed %d", NormalMapEvalInfo->NumEvaluations(), NormalMapEvalInfo->NumComputes());
	...
	for (FBakeTextureGraphInfo& TexBakeStep : BakeTextureNodes)
	{
		...
		UE_LOGF(LogMeshLODToolset, Display, "TextureBakePass %ls - Evaluated %d Nodes, Recomputed %d", *TexBakeStep.Identifier, TexBakeEvalInfo->NumEvaluations(), TexBakeEvalInfo->NumComputes());
	}
	...
	//
	{
		...
		UE_LOGF(LogMeshLODToolset, Display, "MultiTextureBake - Evaluated %d Nodes, Recomputed %d", MultiTextureBakeEvalInfo->NumEvaluations(), MultiTextureBakeEvalInfo->NumComputes());
	}
	...
	UE_LOGF(LogMeshLODToolset, Display, "OutputTangentsPass - Evaluated %d Nodes, Recomputed %d", TangentsEvalInfo->NumEvaluations(), TangentsEvalInfo->NumComputes());
	...
	UE_LOGF(LogMeshLODToolset, Display, "OutputMeshPass - Evaluated %d Nodes, Recomputed %d", MeshEvalInfo->NumEvaluations(), MeshEvalInfo->NumComputes());
	...
	UE_LOGF(LogMeshLODToolset, Display, "OutputCollisionPass - Evaluated %d Nodes, Recomputed %d", CollisionEvalInfo->NumEvaluations(), CollisionEvalInfo->NumComputes());
