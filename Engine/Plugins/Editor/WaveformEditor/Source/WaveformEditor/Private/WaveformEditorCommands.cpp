...
void FWaveformEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND(SkipToNextZeroCrossing, "Skip To Next Zero Crossing", "Skips the playhead to the next zero crossing", EUserInterfaceActionType::Button, FInputChord(EKeys::H));
}
