...
bool FModelingToolsEditorModeToolkit::RequestAcceptCancelButtonOverride(IToolHostCustomizationAPI::FAcceptCancelButtonOverrideParams& Params)
{
	...
	{
		UE_LOGF(LogGeometry, Warning, "FModelingToolsEditorModeToolkit::RequestAcceptCancelButtonOverride received request with insufficient parameters.");
		return false;
	}
...
bool FModelingToolsEditorModeToolkit::RequestCompleteButtonOverride(IToolHostCustomizationAPI::FCompleteButtonOverrideParams& Params)
{
	...
	{
		UE_LOGF(LogGeometry, Warning, "FModelingToolsEditorModeToolkit::RequestCompleteButtonOverride received request with insufficient parameters.");
		return false;
	}
