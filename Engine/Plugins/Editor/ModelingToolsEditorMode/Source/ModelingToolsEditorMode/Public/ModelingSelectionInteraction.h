...
public:
	...
	UE_API void SetActiveDragMode(EModelingSelectionInteraction_DragMode NewMode);
	...
	UE_API void SetLocalFrameMode(EModelingSelectionInteraction_LocalFrameMode NewLocalFrameMode);
