...
public:
	...
	{
		static const TArray<FAssetCategoryPath> Categories = { FAssetCategoryPath(EAssetCategoryPaths::Data, NSLOCTEXT("AssetDefinition", "DataTable", "Data Table"), ECategoryMenuType::Section) };
		return Categories;
	}
