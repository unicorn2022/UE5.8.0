...
public:
	...
	{
		static const TArray<FAssetCategoryPath> Categories = { FAssetCategoryPath(EAssetCategoryPaths::Data, NSLOCTEXT("AssetDefinition", "CurveLinearColorAtlas", "Curve"), ECategoryMenuType::Section) };
		return Categories;
	}
