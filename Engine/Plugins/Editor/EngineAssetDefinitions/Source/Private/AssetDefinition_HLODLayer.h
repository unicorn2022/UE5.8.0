...
public:
	...
	{
		static const FAssetCategoryPath Categories[] = { FAssetCategoryPath(EAssetCategoryPaths::World, NSLOCTEXT("AssetDefinition", "HLODLayer_SubMenu", "World"), ECategoryMenuType::Section) };
		return Categories;
	}
