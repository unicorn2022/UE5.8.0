...
{
	static const auto Categories = { FAssetCategoryPath(EAssetCategoryPaths::Blueprint, LOCTEXT("EditorUtilityWidgetBlueprint_SubMenus", "Editor Utilities"), ECategoryMenuType::Section) };
	return Categories;
}
