...
public:
	...
	virtual TConstArrayView<FAssetCategoryPath> GetAssetCategories() const override
   	{
   		static const FAssetCategoryPath Categories[] = { FAssetCategoryPath(EAssetCategoryPaths::Input, NSLOCTEXT("AssetDefinition", "ForceFeedbackAttenuation_SubMenu", "Force Feedback"), ECategoryMenuType::Section) };
   		return Categories;
   	}
