...
public:
	...
	{
		static const auto Categories = { FAssetCategoryPath(EAssetCategoryPaths::Blueprint, NSLOCTEXT("AssetDefinition", "Struct", "Composite Variables"), ECategoryMenuType::Section) };
		return Categories;
	}
