...
{
	static const auto Categories = { FAssetCategoryPath(EAssetCategoryPaths::Blueprint, LOCTEXT("EditorUtilityBlueprint_SubMenus", "Editor Utilities"), ECategoryMenuType::Section) };
	return Categories;
}
