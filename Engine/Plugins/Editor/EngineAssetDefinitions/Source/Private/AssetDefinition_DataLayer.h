...
public:
	...
	{
		static const FAssetCategoryPath Categories[] = { FAssetCategoryPath(EAssetCategoryPaths::World, NSLOCTEXT("AssetDefinition", "DataLayer_SubMenu", "World"), ECategoryMenuType::Section) };
		return Categories;
	}
