...
public:
	...
	{
		static const FAssetCategoryPath Categories[] = { FAssetCategoryPath(EAssetCategoryPaths::Input, NSLOCTEXT("AssetDefinition", "TouchInterface_SubMenu", "Touchscreen"), ECategoryMenuType::Section) };
		return Categories;
	}
