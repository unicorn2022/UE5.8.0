...
public:
	...
	{
		static const TArray<FAssetCategoryPath> Categories = { FAssetCategoryPath(EAssetCategoryPaths::Data, NSLOCTEXT("AssetDefinition", "Curve", "Curve"), ECategoryMenuType::Section) };
		return Categories;
	}
