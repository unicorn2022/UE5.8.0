...
public:
	...
	{
		static const auto Categories = { FAssetCategoryPath(EAssetCategoryPaths::Blueprint, NSLOCTEXT("AssetDefinition", "Enum", "Composite Variables"), ECategoryMenuType::Section) };
		return Categories;
	}
