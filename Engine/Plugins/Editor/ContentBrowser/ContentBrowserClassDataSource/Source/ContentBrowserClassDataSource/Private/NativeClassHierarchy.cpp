...
void FNativeClassHierarchy::PopulateHierarchy()
{
	...
	UE_LOGF(LogNativeClassHierarchy, Verbose, "Native class hierarchy populated in %0.4f seconds. Added %d classes and %d folders.", FPlatformTime::Seconds() - StartTime, ClassChanges.ClassesModified.Num(), ClassChanges.FoldersModified.Num());
...
void FNativeClassHierarchy::AddClassesForModule(const FName& InModuleName)
{
	...
	GetObjectsWithOuter(ClassPackage, PackageObjects, EGetObjectsFlags::None);
	...
	UE_LOGF(LogNativeClassHierarchy, Verbose, "Native class hierarchy updated for '%ls' in %0.4f seconds. Added %d classes and %d folders.", *InModuleName.ToString(), FPlatformTime::Seconds() - StartTime, ClassChanges.ClassesModified.Num(), ClassChanges.FoldersModified.Num());
