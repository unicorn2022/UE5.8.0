...
{
public:
	virtual ~FUVEditorUVTransformBaseOp() = default;
...
{
public:
	virtual ~FUVEditorUVTransformOp() = default;
...
{
public:
	virtual ~FUVEditorUVAlignOp() = default;
...
{
public:
	virtual ~FUVEditorUVDistributeOp() = default;
