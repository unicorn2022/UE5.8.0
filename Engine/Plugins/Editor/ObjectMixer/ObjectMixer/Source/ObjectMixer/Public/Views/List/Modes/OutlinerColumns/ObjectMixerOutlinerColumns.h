...
public:
	...
	virtual ~FObjectMixerOutlinerVisibilityColumn() override = default;
...
public:
	...
	virtual ~FObjectMixerOutlinerSoloColumn() override = default;
	static FName GetID();
...
public:
	...
	virtual ~FObjectMixerOutlinerPropertyColumn() override = default;
