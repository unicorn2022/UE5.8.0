...
public:
	...
	// This is a very bespoke function to work around UE-225445, see comment in cpp file
	UE_INTERNAL void SetTemporarilyNonTransactional(bool bInIsTemporarilyNonTransactional);
...
protected:
	UPROPERTY()
	// Allows to indicate that the object has temporarily lost its RF_Transactional flag and should not add it back, neither to itself or to 
	//  any of its sub-objects at this time (see SetTemporarilyNonTransactional)
	bool bIsTemporarilyNonTransactional = false;
};
