...
public:
	BEGIN_SHADER_PARAMETER_STRUCT(FParameters, )
		...
		// Texture patches apply the assigned edit layer's weightmap alpha to all weightmaps (including visibility)
		// For consistency, the circle patch similarly applies the edit layer's weightmap alpha to visibility
