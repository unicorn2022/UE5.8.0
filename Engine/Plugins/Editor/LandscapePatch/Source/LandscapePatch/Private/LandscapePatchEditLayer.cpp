...
void ULandscapePatchEditLayer::NotifyOfPatchRemoval(ULandscapePatchComponent* Patch)
{
	...
	{
		UE_LOGF(LogLandscapePatch, Warning, "LandscapePatchEditLayer: Received NotifyOfPatchRemoval call for an unregistered patch.");
		return;
	}
...
void ULandscapePatchEditLayer::NotifyOfPriorityChange(ULandscapePatchComponent* Patch)
{
	...
	if (!OriginalIndexPtr)
	{
		UE_LOGF(LogLandscapePatch, Warning, "LandscapePatchEditLayer: Received NotifyOfPriorityChange call for an unregistered patch.");
		return;
	}
