...
void FApplyLandscapeTextureHeightPatchPS::ModifyCompilationEnvironment(const FGlobalShaderPermutationParameters& Parameters, FShaderCompilerEnvironment& OutEnvironment)
{
	...
	OutEnvironment.SetDefine(TEXT("ALPHA_PATCH_NONE"), static_cast<uint8>(ELandscapeTexturePatchAlphaSourceMode::None));
	OutEnvironment.SetDefine(TEXT("ALPHA_PATCH_INTERNAL_TEXTURE"), static_cast<uint8>(ELandscapeTexturePatchAlphaSourceMode::InternalTexture));
	OutEnvironment.SetDefine(TEXT("ALPHA_PATCH_RENDER_TARGET"), static_cast<uint8>(ELandscapeTexturePatchAlphaSourceMode::TextureBackedRenderTarget));
	OutEnvironment.SetDefine(TEXT("ALPHA_PATCH_TEXTURE_ASSET"), static_cast<uint8>(ELandscapeTexturePatchAlphaSourceMode::TextureAsset));
	OutEnvironment.SetDefine(TEXT("ALPHA_PATCH_SRC_TEXTURE_CHANNEL"), static_cast<uint8>(ELandscapeTexturePatchAlphaSourceMode::SourceTextureChannel));

	OutEnvironment.SetDefine(TEXT("TEXTURE_CHANNEL_R"), static_cast<uint8>(ELandscapeTexturePatchTextureChannel::Red));
	OutEnvironment.SetDefine(TEXT("TEXTURE_CHANNEL_G"), static_cast<uint8>(ELandscapeTexturePatchTextureChannel::Green));
	OutEnvironment.SetDefine(TEXT("TEXTURE_CHANNEL_B"), static_cast<uint8>(ELandscapeTexturePatchTextureChannel::Blue));
	OutEnvironment.SetDefine(TEXT("TEXTURE_CHANNEL_A"), static_cast<uint8>(ELandscapeTexturePatchTextureChannel::Alpha));
	OutEnvironment.SetDefine(TEXT("TEXTURE_CHANNEL_LUM"), static_cast<uint8>(ELandscapeTexturePatchTextureChannel::Luminance));
}
