...
bool UBrushEditingSubsystemImpl::ProcessClickOnGeomPoly(FEditorViewportClient* ViewportClient, HGeomPolyProxy* GeomHitProxy, const FViewportClick& Click)
{
	...
	{
		UE_LOGF(LogBrushEditing, Warning, "Invalid hitproxy");
		return false;
	}
	...
	else if (Click.GetKey() == EKeys::LeftMouseButton)
	{
		...
		if (Mode)
		{
			...
			else
			{
				...
				UE_LOGF(LogBrushEditing, Warning, "Invalid PolyIndex %d on %ls", GeomHitProxy->PolyIndex, *name);
			}
		}
	}
...
bool UBrushEditingSubsystemImpl::ProcessClickOnGeomVertex(FEditorViewportClient* ViewportClient, HGeomVertexProxy* GeomHitProxy, const FViewportClick& Click)
{
	...
	if (Click.GetKey() == EKeys::RightMouseButton)
	{
		...
		{
			UE_LOGF(LogBrushEditing, Warning, "Invalid InHitProxy->VertexIndex");
			return false;
		}
