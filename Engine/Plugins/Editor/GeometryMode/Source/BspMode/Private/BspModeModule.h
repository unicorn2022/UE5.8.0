...
struct FBspBuilderType
{
	...
	/** The class name of the builder brush */
	FName BuilderClassName;
...
public:
	...
	virtual void UnregisterBspBuilderType( class FName InBuilderClassName ) override;
...
private:
	...
	TArray<FName> BspBuilderTypesToUnregisterOnShutdown;
};
