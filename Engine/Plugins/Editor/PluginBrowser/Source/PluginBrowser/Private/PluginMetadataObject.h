...
public:
	...
	/** Sort the plugins and disallowed plugins references in ascending name order */
	UFUNCTION(CallInEditor, Category=Dependencies, meta = (DisplayName = "Sort dependencies"))
