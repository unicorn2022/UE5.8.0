...
public:
	...
	virtual const TArray<TSharedRef<FPluginTemplateDescription>>& GetDefaultPluginTemplates() const override { return DefaultPluginTemplates; }
...
private:
	...
	/** Generate Default Plugin Template Descriptions */
	void GenerateDefaultPluginTemplateDescriptions();
	...
	/** List of default plugin templates */
	TArray<TSharedRef<FPluginTemplateDescription>> DefaultPluginTemplates;
