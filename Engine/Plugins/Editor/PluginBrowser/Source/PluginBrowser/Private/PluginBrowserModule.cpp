...
void FPluginBrowserModule::StartupModule()
{
	...
	GenerateDefaultPluginTemplateDescriptions();
...
void FPluginBrowserModule::GenerateDefaultPluginTemplateDescriptions()
{
	DefaultPluginTemplates.Reset(7);
	const FString PluginBaseDir = IPluginManager::Get().FindPlugin(TEXT("PluginBrowser"))->GetBaseDir();
	...
	DefaultPluginTemplates.Add(ContentOnlyTemplate);
	...
	DefaultPluginTemplates.Add(BlankTemplate);

	DefaultPluginTemplates.Add(MakeShareable(new FPluginTemplateDescription(BlueprintLibTemplateName, BlueprintLibDescription, PluginBaseDir / TEXT("Templates") / TEXT("BlueprintLibrary"), true, EHostType::Runtime, ELoadingPhase::PreLoadingScreen, false)));
	DefaultPluginTemplates.Add(MakeShareable(new FPluginTemplateDescription(BasicTemplateName, BasicDescription, PluginBaseDir / TEXT("Templates") / TEXT("Basic"), false, EHostType::Editor, ELoadingPhase::Default, false)));
	DefaultPluginTemplates.Add(MakeShareable(new FPluginTemplateDescription(AdvancedTemplateName, AdvancedDescription, PluginBaseDir / TEXT("Templates") / TEXT("Advanced"), false, EHostType::Editor, ELoadingPhase::Default, false)));
	DefaultPluginTemplates.Add(MakeShareable(new FPluginTemplateDescription(EditorModeTemplateName, EditorModeDescription, PluginBaseDir / TEXT("Templates") / TEXT("EditorMode"), false, EHostType::Editor, ELoadingPhase::Default, false)));
	DefaultPluginTemplates.Add(MakeShareable(new FPluginTemplateDescription(ThirdPartyTemplateName, ThirdPartyDescription, PluginBaseDir / TEXT("Templates") / TEXT("ThirdPartyLibrary"), true, EHostType::Runtime, ELoadingPhase::Default, false)));
}
