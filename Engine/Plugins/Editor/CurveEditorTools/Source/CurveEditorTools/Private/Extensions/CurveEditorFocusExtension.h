...
private:
	...
	/** Focuses the curve editor around the current Selection Range of the linked Time Controller (falls back to Playback Range if empty). */
	void FocusSelectionRange();
