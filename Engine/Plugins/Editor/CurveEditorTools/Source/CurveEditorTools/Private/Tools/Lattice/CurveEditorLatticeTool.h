...
#include "Drag/DelayedDragData.h"
...
private:
	...
	using FMovePointsSignature = void(FCurveEditorLatticeTool::*)(
	...
	void HandleDragPoints(
		FMovePointsSignature InMovePointsCallback, TConstArrayView<int32> InVertexIndices, TConstArrayView<FVector2D> InNewControlPoints,
		EPropertyChangeType::Type InChangeType, EKeyMoveMode InSnapMode
		);
	...
	void OnMoveControlPoint(
		FPerCurveDeformer2D& InDeformer, FCurveModel& InCurveModel, TConstArrayView<int32> InVertexIndices, TConstArrayView<FVector2D> InNewControlPointPositions,
		EPropertyChangeType::Type InChangeType, EKeyMoveMode InSnapMode
		);
	/** Called when an edge is dragged. */
	void OnMoveEdge(FPerCurveDeformer2D& InDeformer, FCurveModel& InCurveModel,
		TConstArrayView<int32> InVertexIndices, TConstArrayView<FVector2D> InNewControlPointPositions,
		EPropertyChangeType::Type InChangeType, EKeyMoveMode InSnapMode
		);
	/** Generic function for updating control points. */
	void OnSetControlPoints(
		FPerCurveDeformer2D& InDeformer, FCurveModel& InCurveModel,
		TConstArrayView<int32> InControlPointsToUpdate, TConstArrayView<FVector2D> InNewControlPoints,
		EPropertyChangeType::Type InChangeType, EKeyMoveMode InSnapMode = EKeyMoveMode::Unrestricted
		);
