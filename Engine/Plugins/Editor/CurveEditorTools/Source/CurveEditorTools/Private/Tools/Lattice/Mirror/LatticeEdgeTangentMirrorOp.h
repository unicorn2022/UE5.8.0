...
public:
	...
	static TOptional<FLatticeEdgeTangentsMirrorOp> MakeMirrorOpForDragLatticeEdge(
		int32 InEdgeIndex, const FCurveModelID& InCurveId, const FPerCurveDeformer2D& InDeformer,
...
private:
	...
	static TOptional<FCurveMirrorData> ComputeTangentMirrorData(
		...
		const FLatticeDeformer2D& InCurveDeformer, const FCurveModelID& InCurve, TConstArrayView<FLatticePointMetaData> InMetaData
		);
};
}
