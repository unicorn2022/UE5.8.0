...
public:
	...
	DECLARE_DELEGATE_TwoParams(FOnControlPointsMoved, const TConstArrayView<FVector2D>& InNewControlPointPositions, EKeyMoveMode InSnapMode);
...
protected:
	...
	virtual void OnBeginDrag(const FGeometry& InGeometry, const FVector2D& InInitialMousePosition, EKeyMoveMode InSnapMode) override;
	virtual void OnMoveMouse(const FGeometry& InGeometry, const FVector2D& InScreenPosition, EKeyMoveMode InSnapMode) override;
	virtual void OnEndDrag(const FGeometry& InGeometry, const FVector2D& InMousePosition, EKeyMoveMode InSnapMode) override;
