...
public:
	...
	static TOptional<FLatticePointTangentsMirrorOp> MakeMirrorOpForDragLatticeControlPoint(
		int32 InControlPointIndex, const FCurveModelID& InCurveId, const FPerCurveDeformer2D& InDeformer,
...
private:
	...
	static TOptional<FCurveMirrorData> ComputeTangentMirrorData(
		int32 InControlPointIndex, const FCurveEditor& CurveEditor, const FCurveModelID& InCurveId, const FPerCurveDeformer2D& InDeformer
		);
};
}
