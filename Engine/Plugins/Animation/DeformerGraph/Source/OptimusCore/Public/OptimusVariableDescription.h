...
public:
	...
	UPROPERTY(EditAnywhere, Category = VariableDefinition,  meta=(NoResetToDefault))
	FName VariableName;

	/** The data type of the variable */
	UPROPERTY(EditAnywhere, Category = VariableDefinition, meta=(UseInVariable, UseInProperty, NoResetToDefault))
