...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = ResourceDescription, meta=(NoResetToDefault))
	FName ResourceName;

	/** The the data type of each element of the resource */
	UPROPERTY(EditAnywhere, Category=ResourceDescription, meta=(UseInResource, NoResetToDefault))
