...
void UReOrientRootBoneModifier::ReOrientRootBone_Internal(UAnimSequence* Animation, const FQuat& Quat)
{
	...
	{
		UE_LOGF(LogAnimation, Error, "ReOrientMeshModifier failed. Reason: Invalid Animation");
		return;
	}
	...
	if (Model == nullptr)
	{
		UE_LOGF(LogAnimation, Error, "ReOrientMeshModifier failed. Reason: Invalid Data Model. Animation: %ls", *GetNameSafe(Animation));
		return;
	}
	...
	if (Skeleton == nullptr)
	{
		UE_LOGF(LogAnimation, Error, "ReOrientMeshModifier failed. Reason: Invalid Skeleton. Animation: %ls", *GetNameSafe(Animation));
		return;
	}
	...
	{
		UE_LOGF(LogAnimation, Error, "ReOrientMeshModifier failed. Reason: Ref Skeleton. Animation: %ls", *GetNameSafe(Animation));
		return;
	}
