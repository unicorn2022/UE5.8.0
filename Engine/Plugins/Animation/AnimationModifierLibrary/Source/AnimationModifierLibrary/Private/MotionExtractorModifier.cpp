...
void UMotionExtractorModifier::OnApply_Implementation(UAnimSequence* Animation)
{
	...
	{
		UE_LOGF(LogAnimation, Error, "MotionExtractorModifier failed. Reason: Invalid Animation");
		return;
	}
	...
	if (Skeleton == nullptr)
	{
		UE_LOGF(LogAnimation, Error, "MotionExtractorModifier failed. Reason: Animation with invalid Skeleton. Animation: %ls",
	...
	{
		UE_LOGF(LogAnimation, Error, "MotionExtractorModifier failed. Reason: Invalid Bone Index. BoneName: %ls Animation: %ls Skeleton: %ls",
	...
	if (bUseRelativeToBone)
	{
		...
		{
			UE_LOGF(LogAnimation, Error, "MotionExtractorModifier failed. Reason: Invalid Bone Index for RelativeToBoneName. BoneName: %ls Animation: %ls Skeleton: %ls",
				*BoneName.ToString(), *GetNameSafe(Animation), *GetNameSafe(Skeleton));
			return;
		}
	}
	...
	{
		UE_LOGF(LogAnimation, Error, "MotionExtractorModifier failed. Reason: Only X, Y or Z axes are valid options for the selected motion type");
		return;
	}
