...
void UZeroOutRootBoneModifier::OnApply_Implementation(UAnimSequence* Animation)
{
	...
	{
		UE_LOGF(LogAnimation, Error, "ZeroOutRootBoneModifier failed. Reason: Invalid Animation");
		return;
	}
	...
	if (Model == nullptr)
	{
		UE_LOGF(LogAnimation, Error, "ZeroOutRootBoneModifier failed. Reason: Invalid Data Model. Animation: %ls", *GetNameSafe(Animation));
		return;
	}
	...
	if (Skeleton == nullptr)
	{
		UE_LOGF(LogAnimation, Error, "ZeroOutRootBoneModifier failed. Reason: Invalid Skeleton. Animation: %ls", *GetNameSafe(Animation));
		return;
	}
	...
	{
		UE_LOGF(LogAnimation, Error, "ZeroOutRootBoneModifier failed. Reason: Ref Skeleton. Animation: %ls", *GetNameSafe(Animation));
		return;
	}
