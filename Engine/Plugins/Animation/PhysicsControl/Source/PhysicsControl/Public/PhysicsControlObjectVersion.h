...
struct FPhysicsControlObjectVersion
{
	enum Type
	{
		...
		ControlRigAutomaticallyAddPhysicsBodyComponents,
		...
		EnableCCD,
		ControlRigAllowCCD,
		ControlRigConvexCollision,
		ControlDataDriveForceMode,    // bUseAccelerationDriveMode added to FPhysicsControlData / FPhysicsControlSparseData
