...
typename std::enable_if<std::is_integral<U>::value, typename TContainer::value_type&>::type getAt(TContainer& target, U index) {
    ensureHasSize(target, index + 1ul);
    return target[index];
}

template<class TContainer, typename TSize, typename TValue>
typename std::enable_if<std::is_integral<TSize>::value>::type setAt(TContainer& target, TSize index, const TValue& value) {
...
public:
    ...
    void setRotationSequence(RotationSequence rotationSequence) override;
    void setRotationSign(const RotationSign& rotationSign) override;
    void setFaceWindingOrder(FaceWindingOrder faceWindingOrder) override;
    ...
    void setBlendShapeChannelIndices(std::uint16_t index,
    ...
    void setMeshBlendShapeChannelMapping(std::uint32_t index,
    ...
    void setJointGroupInputIndices(std::uint16_t jointGroupIndex,
                                   const std::uint16_t* inputIndices,
                                   std::uint16_t count) override;
    void setJointGroupOutputIndices(std::uint16_t jointGroupIndex,
    ...
    void setJointGroupJointIndices(std::uint16_t jointGroupIndex,
    ...
    void setVertexTextureCoordinates(std::uint16_t meshIndex,
    ...
    void setSkinWeightsValues(std::uint16_t meshIndex,
    ...
    void setNeuralNetworkInputIndices(std::uint16_t netIndex, const std::uint16_t* inputIndices, std::uint16_t count) override;
    void setNeuralNetworkOutputIndices(std::uint16_t netIndex, const std::uint16_t* outputIndices, std::uint16_t count) override;
    void clearNeuralNetworkLayers(std::uint16_t netIndex) override;
    void setNeuralNetworkLayerActivationFunction(std::uint16_t netIndex,
    ...
    void setRBFPoseOutputControlIndices(std::uint16_t poseIndex,
                                        const std::uint16_t* controlIndices,
                                        std::uint16_t controlIndexCount) override;
    void setRBFPoseOutputControlWeights(std::uint16_t poseIndex,
    ...
    void setRBFSolverRawControlIndices(std::uint16_t solverIndex,
                                       const std::uint16_t* inputIndices,
                                       std::uint16_t count) override;
    ...
    void setTwistInputControlIndices(std::uint16_t twistIndex,
                                     const std::uint16_t* controlIndices,
                                     std::uint16_t controlIndexCount) override;
    void setTwistOutputJointIndices(std::uint16_t twistIndex,
                                    const std::uint16_t* jointIndices,
    ...
    void setSwingInputControlIndices(std::uint16_t swingIndex,
                                     const std::uint16_t* controlIndices,
                                     std::uint16_t controlIndexCount) override;
    void setSwingOutputJointIndices(std::uint16_t swingIndex,
                                    const std::uint16_t* jointIndices,
                                    std::uint16_t jointIndexCount) override;
    void setSwingBlendWeights(std::uint16_t swingIndex, const float* blendWeights, std::uint16_t blendWeightCount) override;

    // MachineLearnedBehaviorExtWriter methods
    void clearMLExtData() override;
    void clearMLOperationSets(std::uint16_t mlTypeIndex) override;
    void clearMLOperations(std::uint16_t mlTypeIndex, std::uint16_t mlOperationSetIndex) override;
    void setMLOperationType(std::uint16_t mlTypeIndex,
                            std::uint16_t mlOperationSetIndex,
                            std::uint16_t mlOperationIndex,
                            MachineLearnedBehaviorOperationType operationType) override;
    void setMLOperationParameters(std::uint16_t mlTypeIndex,
                                  std::uint16_t mlOperationSetIndex,
                                  std::uint16_t mlOperationIndex,
                                  const std::uint32_t* parameters,
                                  std::uint16_t count) override;
    void setMLOperationDependencyOperationSetIndices(std::uint16_t mlTypeIndex,
                                                     std::uint16_t mlOperationSetIndex,
                                                     std::uint16_t mlOperationIndex,
                                                     const std::uint16_t* indices,
                                                     std::uint16_t count) override;
    void setMLOperationDependencyOperationIndices(std::uint16_t mlTypeIndex,
                                                  std::uint16_t mlOperationSetIndex,
                                                  std::uint16_t mlOperationIndex,
                                                  const std::uint16_t* indices,
                                                  std::uint16_t count) override;
    void clearMLOperationIndicesAndLODMappings() override;
    void clearMLOperationIndices(std::uint16_t mlTypeIndex, std::uint16_t mlOperationSetIndex) override;
    void clearLODMLOperationMappings(std::uint16_t mlTypeIndex, std::uint16_t mlOperationSetIndex) override;
    void setMLOperationIndices(std::uint16_t mlTypeIndex,
                               std::uint16_t mlOperationSetIndex,
                               std::uint16_t index,
                               const std::uint16_t* mlOperationIndices,
                               std::uint16_t count) override;
    void setLODMLOperationMapping(std::uint16_t mlTypeIndex,
                                  std::uint16_t mlOperationSetIndex,
                                  std::uint16_t lod,
                                  std::uint16_t index) override;
    void setMLJointsParameterKeys(const std::uint16_t* parameterKeys, std::uint16_t count) override;
    void setMLJointsParameterValues(const std::uint16_t* parameterValues, std::uint16_t count) override;
    void setMLJointsInputIndices(const std::uint16_t* inputIndices, std::uint16_t count) override;
    void setMLJointsOutputIndices(const std::uint16_t* outputIndices, std::uint16_t count) override;
};
...
#endif
template<class TWriterBase>
WriterImpl<TWriterBase>::WriterImpl(MemoryResource* memRes_) :
    BaseImpl{memRes_} {
}
...
inline void WriterImpl<TWriterBase>::setCoordinateSystem(CoordinateSystem system) {
    dna.descriptor.coordinateSystem.xAxis = static_cast<std::uint16_t>(system.x);
    dna.descriptor.coordinateSystem.yAxis = static_cast<std::uint16_t>(system.y);
    dna.descriptor.coordinateSystem.zAxis = static_cast<std::uint16_t>(system.z);
}

template<class TWriterBase>
inline void WriterImpl<TWriterBase>::setRotationSequence(RotationSequence rotationSequence) {
    dna.descriptorExt.rotationSequence = rotationSequence;
}

template<class TWriterBase>
inline void WriterImpl<TWriterBase>::setRotationSign(const RotationSign& rotationSign) {
    dna.descriptorExt.rotationSign = rotationSign;
}

template<class TWriterBase>
inline void WriterImpl<TWriterBase>::setFaceWindingOrder(FaceWindingOrder faceWindingOrder) {
    dna.descriptorExt.faceWindingOrder = faceWindingOrder;
}
...
template<class TWriterBase>
inline void WriterImpl<TWriterBase>::setJointIndices(std::uint16_t index,
                                                     const std::uint16_t* jointIndices,
                                                     std::uint16_t count) {
...
template<class TWriterBase>
inline void WriterImpl<TWriterBase>::setJointGroupValues(std::uint16_t jointGroupIndex,
                                                         const float* values,
                                                         std::uint32_t count) {
    auto& jointGroup = getAt(dna.behavior.joints.jointGroups, jointGroupIndex);
...
template<class TWriterBase>
inline void WriterImpl<TWriterBase>::clearMLExtData() {
    dna.machineLearnedBehaviorExt.mlbTypeData.clear();
    dna.machineLearnedBehaviorExt.mlbJoints.parameterKeys.clear();
    dna.machineLearnedBehaviorExt.mlbJoints.parameterValues.clear();
    dna.machineLearnedBehaviorExt.mlbJoints.inputIndices.clear();
    dna.machineLearnedBehaviorExt.mlbJoints.outputIndices.clear();
}

template<class TWriterBase>
inline void WriterImpl<TWriterBase>::clearMLOperationSets(std::uint16_t mlTypeIndex) {
    if (mlTypeIndex < dna.machineLearnedBehaviorExt.mlbTypeData.size()) {
        dna.machineLearnedBehaviorExt.mlbTypeData[mlTypeIndex].operations.clear();
    }
}

template<class TWriterBase>
inline void WriterImpl<TWriterBase>::clearMLOperations(std::uint16_t mlTypeIndex, std::uint16_t mlOperationSetIndex) {
    if (mlTypeIndex < dna.machineLearnedBehaviorExt.mlbTypeData.size()) {
        auto& mlbTypeData = dna.machineLearnedBehaviorExt.mlbTypeData[mlTypeIndex];
        if (mlOperationSetIndex < mlbTypeData.operations.size()) {
            mlbTypeData.operations[mlOperationSetIndex].clear();
        }
    }
}

template<class TWriterBase>
inline void WriterImpl<TWriterBase>::setMLOperationType(std::uint16_t mlTypeIndex,
                                                        std::uint16_t mlOperationSetIndex,
                                                        std::uint16_t mlOperationIndex,
                                                        MachineLearnedBehaviorOperationType operationType) {
    auto& mlbTypeData = getAt(dna.machineLearnedBehaviorExt.mlbTypeData, mlTypeIndex);
    auto& operationSet = getAt(mlbTypeData.operations, mlOperationSetIndex);
    auto& operation = getAt(operationSet, mlOperationIndex);
    operation.operationType = static_cast<std::uint16_t>(operationType);
}

template<class TWriterBase>
inline void WriterImpl<TWriterBase>::setMLOperationParameters(std::uint16_t mlTypeIndex,
                                                              std::uint16_t mlOperationSetIndex,
                                                              std::uint16_t mlOperationIndex,
                                                              const std::uint32_t* parameters,
                                                              std::uint16_t count) {
    ...
    auto& operationSet = getAt(mlbTypeData.operations, mlOperationSetIndex);
    auto& operation = getAt(operationSet, mlOperationIndex);
    operation.parameters.assign(parameters, parameters + count);
}

template<class TWriterBase>
inline void WriterImpl<TWriterBase>::setMLOperationDependencyOperationSetIndices(std::uint16_t mlTypeIndex,
                                                                                 std::uint16_t mlOperationSetIndex,
                                                                                 std::uint16_t mlOperationIndex,
                                                                                 const std::uint16_t* indices,
                                                                                 std::uint16_t count) {
    ...
    auto& operationSet = getAt(mlbTypeData.operations, mlOperationSetIndex);
    auto& operation = getAt(operationSet, mlOperationIndex);
    operation.mlOperationSetDependencyIndices.assign(indices, indices + count);
}

template<class TWriterBase>
inline void WriterImpl<TWriterBase>::setMLOperationDependencyOperationIndices(std::uint16_t mlTypeIndex,
                                                                              std::uint16_t mlOperationSetIndex,
                                                                              std::uint16_t mlOperationIndex,
                                                                              const std::uint16_t* indices,
                                                                              std::uint16_t count) {
    ...
    auto& operationSet = getAt(mlbTypeData.operations, mlOperationSetIndex);
    auto& operation = getAt(operationSet, mlOperationIndex);
    operation.mlOperationDependencyIndices.assign(indices, indices + count);
}

template<class TWriterBase>
inline void WriterImpl<TWriterBase>::clearMLOperationIndicesAndLODMappings() {
    for (auto& typeData : dna.machineLearnedBehaviorExt.mlbTypeData) {
        typeData.lodMLOperationMappings.clear();
    }
}

template<class TWriterBase>
inline void WriterImpl<TWriterBase>::clearMLOperationIndices(std::uint16_t mlTypeIndex, std::uint16_t mlOperationSetIndex) {
    if (mlTypeIndex < dna.machineLearnedBehaviorExt.mlbTypeData.size()) {
        if (mlOperationSetIndex < dna.machineLearnedBehaviorExt.mlbTypeData[mlTypeIndex].lodMLOperationMappings.size()) {
            dna.machineLearnedBehaviorExt.mlbTypeData[mlTypeIndex].lodMLOperationMappings[mlOperationSetIndex].resetIndices();
        }
    }
}

template<class TWriterBase>
inline void WriterImpl<TWriterBase>::clearLODMLOperationMappings(std::uint16_t mlTypeIndex, std::uint16_t mlOperationSetIndex) {
    if (mlTypeIndex < dna.machineLearnedBehaviorExt.mlbTypeData.size()) {
        if (mlOperationSetIndex < dna.machineLearnedBehaviorExt.mlbTypeData[mlTypeIndex].lodMLOperationMappings.size()) {
            dna.machineLearnedBehaviorExt.mlbTypeData[mlTypeIndex].lodMLOperationMappings[mlOperationSetIndex].resetLODs();
        }
    }
}

template<class TWriterBase>
inline void WriterImpl<TWriterBase>::setMLOperationIndices(std::uint16_t mlTypeIndex,
                                                           std::uint16_t mlOperationSetIndex,
                                                           std::uint16_t index,
                                                           const std::uint16_t* mlOperationIndices,
                                                           std::uint16_t count) {
    auto& mlbTypeData = getAt(dna.machineLearnedBehaviorExt.mlbTypeData, mlTypeIndex);
    auto& mapping = getAt(mlbTypeData.lodMLOperationMappings, mlOperationSetIndex);
    mapping.clearIndices(index);
    mapping.addIndices(index, mlOperationIndices, count);
}

template<class TWriterBase>
inline void WriterImpl<TWriterBase>::setLODMLOperationMapping(std::uint16_t mlTypeIndex,
                                                              std::uint16_t mlOperationSetIndex,
                                                              std::uint16_t lod,
                                                              std::uint16_t index) {
    auto& mlbTypeData = getAt(dna.machineLearnedBehaviorExt.mlbTypeData, mlTypeIndex);
    auto& mapping = getAt(mlbTypeData.lodMLOperationMappings, mlOperationSetIndex);
    mapping.associateLODWithIndices(lod, index);
}

template<class TWriterBase>
inline void WriterImpl<TWriterBase>::setMLJointsParameterKeys(const std::uint16_t* parameterKeys, std::uint16_t count) {
    dna.machineLearnedBehaviorExt.mlbJoints.parameterKeys.assign(parameterKeys, parameterKeys + count);
}

template<class TWriterBase>
inline void WriterImpl<TWriterBase>::setMLJointsParameterValues(const std::uint16_t* parameterValues, std::uint16_t count) {
    dna.machineLearnedBehaviorExt.mlbJoints.parameterValues.assign(parameterValues, parameterValues + count);
}

template<class TWriterBase>
inline void WriterImpl<TWriterBase>::setMLJointsInputIndices(const std::uint16_t* inputIndices, std::uint16_t count) {
    dna.machineLearnedBehaviorExt.mlbJoints.inputIndices.assign(inputIndices, inputIndices + count);
}

template<class TWriterBase>
inline void WriterImpl<TWriterBase>::setMLJointsOutputIndices(const std::uint16_t* outputIndices, std::uint16_t count) {
    dna.machineLearnedBehaviorExt.mlbJoints.outputIndices.assign(outputIndices, outputIndices + count);
}
