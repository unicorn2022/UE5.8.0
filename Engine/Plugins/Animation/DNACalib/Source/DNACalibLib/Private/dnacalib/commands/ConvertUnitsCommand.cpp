...
ConvertUnitsCommand::ConvertUnitsCommand(MemoryResource* memRes) :
    pImpl{makeScoped<Impl>(memRes)} {
}

ConvertUnitsCommand::ConvertUnitsCommand(TranslationUnit translationUnit, RotationUnit rotationUnit, MemoryResource* memRes) :
    pImpl{makeScoped<Impl>(memRes)} {
