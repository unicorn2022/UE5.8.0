...
public:
    explicit AnimatedMapDNAReader(dnac::MemoryResource* memRes = nullptr) :
        ...
        animatedMapNames.assign({{"animatedMap1", memRes},
                                 {"animatedMap2", memRes},
                                 {"animatedMap3", memRes},
                                 {"animatedMap4", memRes},
                                 {"animatedMap5", memRes}});
        ...
        animatedMapCutValues.assign({0.0f, 0.0f, 0.0f, -0.066667f, 0.0f, 0.0f, -0.1f, 0.0f, 0.0f, -0.1f, -0.333333f, -0.333333f});
        animatedMapSlopeValues.assign({1.0f, -1.0f, 1.0f, 0.266667f, 1.0f, 0.5f, 0.4f, 1.0f, 0.5f, 0.4f, 1.333333f, 1.333333f});
