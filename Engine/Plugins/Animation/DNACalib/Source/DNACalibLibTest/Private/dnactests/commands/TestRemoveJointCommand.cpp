...
TEST_F(RemoveJointCommandTest, RemoveSingleJoint) {
    ...
    ASSERT_ELEMENTS_EQ(output->getJointGroupJointIndices(0),
                       (dnac::ConstArrayView<std::uint16_t>{expectedJointIndices, 2ul}),
                       2ul);
    ...
    ASSERT_ELEMENTS_EQ(output->getJointGroupInputIndices(0),
                       (dnac::ConstArrayView<std::uint16_t>{expectedInputIndices, 3ul}),
                       3ul);

    static const std::uint16_t expectedOutputIndices[] = {8, 9};
    ASSERT_ELEMENTS_EQ(output->getJointGroupOutputIndices(0),
                       (dnac::ConstArrayView<std::uint16_t>{expectedOutputIndices, 2ul}),
                       2ul);

    static const float expectedValues[] = {0.5f, 0.2f, 0.3f, 0.1f, 0.75f, 1.0f};
...
TEST_F(RemoveJointCommandTest, RemoveMultipleJoints) {
    ...
    ASSERT_ELEMENTS_EQ(output->getJointGroupJointIndices(0),
                       (dnac::ConstArrayView<std::uint16_t>{expectedJointIndices, 1ul}),
                       1ul);
    ...
    ASSERT_ELEMENTS_EQ(output->getJointGroupOutputIndices(0),
                       (dnac::ConstArrayView<std::uint16_t>{expectedOutputIndices, 1u}),
                       1u);
...
TEST_F(RemoveJointCommandTest, RemoveJointNotInAnyLOD) {
    ...
    ASSERT_ELEMENTS_EQ(output->getJointGroupJointIndices(0),
                       (dnac::ConstArrayView<std::uint16_t>{expectedJointIndices, 3ul}),
                       3ul);
    ...
    ASSERT_ELEMENTS_EQ(output->getJointGroupOutputIndices(0),
                       (dnac::ConstArrayView<std::uint16_t>{expectedOutputIndices, 4ul}),
                       4ul);

    static const float expectedValues[] = {0.5f, 0.2f, 0.3f, 0.25f, 0.4f, 0.15f, 0.1f, 0.1f, 0.9f, 0.1f, 0.75f, 1.0f};
