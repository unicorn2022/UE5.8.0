...
TEST_F(SetVertexPositionsCommandTest, InterpolatePositions) {
    ...
    dnac::Vector<dnac::Vector3> positionsOther{{1.0f, 1.0f, 1.0f}, {2.0f, 2.0f, 2.0f}, {3.0f, 3.0f, 3.0f}};
...
TEST_F(SetVertexPositionsCommandTest, SubtractPositions) {
...
TEST_F(SetVertexPositionsCommandTest, MultiplyPositions) {
    ...
    dnac::Vector<dnac::Vector3> positionsOther{{2.0f, 2.0f, 2.0f}, {4.0f, 4.0f, 4.0f}, {6.0f, 6.0f, 6.0f}};
    // Multiply vertices on non-empty output
    dnac::SetVertexPositionsCommand mulCmd(meshIndex,
                                           dnac::ConstArrayView<dnac::Vector3>{positionsOther},
...
TEST_F(SetVertexPositionsCommandTest, OverwritePositions) {
    ...
    dnac::SetVertexPositionsCommand overwriteCmd(meshIndex,
                                                 dnac::ConstArrayView<dnac::Vector3>{positionsOther},
                                                 dnac::VectorOperation::Interpolate);
