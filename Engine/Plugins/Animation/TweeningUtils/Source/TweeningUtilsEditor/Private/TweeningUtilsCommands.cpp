...
void FTweeningUtilsCommands::RegisterCommands()
{
	...
	UI_COMMAND(SetSliderLeft, "Set Slider left (100%)", "Drag the anim slider 100% to the left", EUserInterfaceActionType::Button, FInputChord(EKeys::Home));
	UI_COMMAND(SetSliderRight, "Set Slider right (100%)", "Drag the anim slider 100% to the right", EUserInterfaceActionType::Button, FInputChord(EKeys::End));
	UI_COMMAND(SetSliderHalfLeft, "Set Slider half left (50%)", "Drag the anim slider 50% to the left", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(SetSliderHalfRight, "Set Slider half right (50%)", "Drag the anim slider 50% to the right", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(SetSliderQuarterLeft, "Set Slider quarter left (25%)", "Drag the anim slider 25% to the left", EUserInterfaceActionType::Button, FInputChord(EKeys::Home, EModifierKey::Shift));
	UI_COMMAND(SetSliderQuarterRight, "Set Slider quarter right (25%)", "Drag the anim slider 25% to the right", EUserInterfaceActionType::Button, FInputChord(EKeys::End, EModifierKey::Shift));
}
}
