...
#include "MoveSliderByHotkeyController.h"
...
struct FTweenControllers
{
	...
	/** Allows moving the slider via hotkeys. */
	FMoveSliderByHotkeyController MoveSliderByHotkeyController;
	...
	/** @return The current slider override position that may be driven by one of the subsytems, like MouseSlidingController. Range [-1,1]. */
