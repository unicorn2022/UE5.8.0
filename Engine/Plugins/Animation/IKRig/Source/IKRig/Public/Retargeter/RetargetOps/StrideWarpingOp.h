...
struct FRetargetStrideWarpChainSettings
{
	...
	/** Range 0 to 1. Default 1. Blends the effect of the stride warping on this chain only. At 0, there is no effect. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Chain Settings", meta = (EditCondition = "EnableStrideWarping", UIMin = "0.0", UIMax = "1.0", ClampMin = "0.0", ClampMax = "1.0"))
	float Alpha = 1.0;
...
struct FIKRetargetStrideWarpingOpSettings : public FIKRetargetOpSettingsBase
{
	...
	/** Range 0 to 1. Default 1. Blends the effect of all stride warping on/off. At 0, there is no effect. */
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Op Settings", meta=(EditCondition="DirectionSource == EWarpingDirectionSource::Chain"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Op Settings", meta = (UIMin = "0.0", UIMax = "5.0", ClampMin = "0.0"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Op Settings", meta = (UIMin = "-10.0", UIMax = "100.0"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Op Settings", meta = (UIMin = "0.0", UIMax = "2.0", ClampMin = "0.0"))
...
struct FStrideWarpGoalData
{
	FStrideWarpGoalData(
		...
		const FTransform& InGlobalRefPoseOfGoalBone,
		const FRetargetStrideWarpChainSettings& InChainSettings) :
		IKRigGoalName(InGoalName),
		GlobalRefPoseOfGoalBone(InGlobalRefPoseOfGoalBone),
		Settings(&InChainSettings) {};
	
	FName IKRigGoalName;
	FTransform GlobalRefPoseOfGoalBone;
	const FRetargetStrideWarpChainSettings* Settings;
};
