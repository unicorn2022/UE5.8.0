...
struct FIKRetargetScaleSourceOpSettings : public FIKRetargetOpSettingsBase
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Op Settings", meta = (ReinitializeOnEdit, ClampMin = "0.01", UIMin = "0.01", UIMax = "10.0"))
	...
	UPROPERTY(EditAnywhere, Category = "Op Settings", meta=(NotOverrideable))
