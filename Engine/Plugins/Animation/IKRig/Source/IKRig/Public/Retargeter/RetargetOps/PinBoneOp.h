...
struct FPinBoneData
{
	...
	UPROPERTY(EditAnywhere, Category=Settings, meta=(ReinitializeOnEdit, NotOverrideable))
...
struct FIKRetargetPinBoneOpSettings : public FIKRetargetOpSettingsBase
{
	...
	UE_API virtual void PostLoad(const FIKRigObjectVersion::Type InVersion) override;
