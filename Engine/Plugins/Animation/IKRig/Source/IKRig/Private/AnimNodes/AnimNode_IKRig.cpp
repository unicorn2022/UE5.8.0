...
namespace UE::Anim::IKRig
{
	static bool bEnableIKRig = true;
	FAutoConsoleVariableRef CVarEnableIKRigNode(TEXT("a.animnode.IKRig.Enable"), bEnableIKRig, TEXT("Enables/disables IK Rig Node in Anim Graph."));
}
...
void FAnimNode_IKRig::Evaluate_AnyThread(FPoseContext& Output) 
{
	...
	if (!IKRigProcessor.IsInitialized() || !UE::Anim::IKRig::bEnableIKRig)
	{
		return;
	}
