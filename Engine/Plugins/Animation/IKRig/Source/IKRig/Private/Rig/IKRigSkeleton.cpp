...
void FIKRigInputSkeleton::Initialize(const USkeletalMesh* InSkeletalMesh)
{
	Reset();
...
void FIKRigSkeleton::SetInputSkeleton(const USkeletalMesh* InSkeletalMesh, const TArray<FName>& InExcludedBones)
{
	const FIKRigInputSkeleton InputSkeleton = FIKRigInputSkeleton(InSkeletalMesh);
...
void FIKRigSkeleton::SetInputSkeleton(const FIKRigInputSkeleton& InputSkeleton, const TArray<FName>& InExcludedBones)
{
	...
	// store skeletal mesh for reinit
	SkeletalMesh = InputSkeleton.SkeletalMesh;
