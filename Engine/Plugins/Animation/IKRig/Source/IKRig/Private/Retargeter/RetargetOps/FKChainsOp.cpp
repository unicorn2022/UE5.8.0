...
void FIKRetargetFKChainsOpSettings::CopySettingsAtRuntime(const FIKRetargetOpSettingsBase* InSettingsToCopyFrom)
{
	...
	const TArray<FName> PropertiesToIgnore = {GET_MEMBER_NAME_CHECKED(FIKRetargetFKChainsOpSettings, ChainsToRetarget)};
...
uint8* FIKRetargetFKChainsOp::GetChainSettingsMemory(const FName InChainName)
{
