...
void FIKRetargetAlignPoleVectorOpSettings::CopySettingsAtRuntime(const FIKRetargetOpSettingsBase* InSettingsToCopyFrom)
{
	...
	const TArray<FName> PropertiesToIgnore = {GET_MEMBER_NAME_CHECKED(FIKRetargetAlignPoleVectorOpSettings, ChainsToAlign)};
	FIKRetargetOpBase::CopyStructProperties(
		FIKRetargetAlignPoleVectorOpSettings::StaticStruct(),
	...
	IKRetargetOpUtils::CopyChainSettingsAtRuntime(NewSettings->ChainsToAlign, ChainsToAlign);
}
...
{
	IKRetargetOpUtils::ResetChainSettingsToDefault(Settings.ChainsToAlign, InChainName);
}

bool FIKRetargetAlignPoleVectorOp::AreChainSettingsAtDefault(const FName& InChainName)
{
	return IKRetargetOpUtils::AreChainSettingsAtDefault(Settings.ChainsToAlign, InChainName);
}

uint8* FIKRetargetAlignPoleVectorOp::GetChainSettingsMemory(const FName InChainName)
{
	return IKRetargetOpUtils::GetChainSettingsMemory(Settings.ChainsToAlign, InChainName);
}
#endif
