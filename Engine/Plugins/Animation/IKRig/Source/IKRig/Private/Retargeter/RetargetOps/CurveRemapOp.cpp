...
void FIKRetargetCurveRemapOp::ProcessAnimSequenceCurves(FIKRetargetCurvesOpBase::FCurveData InCurveMetaData, FIKRetargetCurvesOpBase::FFrameValues InCurveFrameValues,
	FIKRetargetCurvesOpBase::FCurveData& OutCurveMetaData, FIKRetargetCurvesOpBase::FFrameValues& OutCurveFrameValues) const
{
	FIKRetargetCurvesOpBase::FCurveData SourceCurveMetaData;
	FIKRetargetCurvesOpBase::FFrameValues SourceCurveFrameValues;
