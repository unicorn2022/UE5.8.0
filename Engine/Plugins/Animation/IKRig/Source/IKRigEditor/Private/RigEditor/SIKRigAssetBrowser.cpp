	...
	TSharedRef<FIKRigEditorController> InEditorController)
{
	...
	CommandList->MapAction(
		...
		FExecuteAction::CreateSP(this, &SIKRigAssetBrowser::ExecuteFindInContentBrowserAction),
		FCanExecuteAction::CreateSP(this, &SIKRigAssetBrowser::CanExecuteFindInContentBrowserAction)
	);
...
FReply SIKRigAssetBrowser::OnKeyDown(const FGeometry& InGeometry, const FKeyEvent& InKeyEvent)
{
...
void SIKRigAssetBrowser::ExecuteFindInContentBrowserAction()
{
...
bool SIKRigAssetBrowser::CanExecuteFindInContentBrowserAction()
{
