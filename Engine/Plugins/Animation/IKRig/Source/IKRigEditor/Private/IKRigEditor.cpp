...
void FIKRigEditor::StartupModule()
{
	...
	PropertyEditorModule.RegisterCustomPropertyTypeLayout(
				"IKRetargetBlendToSourceOpSettings",
				FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FBlendToSourceOpCustomization::MakeInstance));
	PropertyEditorModule.RegisterCustomPropertyTypeLayout(
				"IKRetargetOffsetGoalsOpSettings",
				FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FOffsetGoalsOpCustomization::MakeInstance));
	PropertyEditorModule.RegisterCustomPropertyTypeLayout(
				"IKRetargetScaleGoalsOpSettings",
				FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FScaleGoalsOpCustomization::MakeInstance));
	// retarget profile details
	PropertyEditorModule.RegisterCustomPropertyTypeLayout(
				"RetargetOverrideSet",
				FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FRetargetOverrideCustomization::MakeInstance));
