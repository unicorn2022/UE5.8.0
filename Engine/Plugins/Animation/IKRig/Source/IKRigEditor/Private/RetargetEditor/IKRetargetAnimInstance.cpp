...
void UIKRetargetAnimInstance::SetOverrideSets(const TArray<FName>& InOverrideSets)
{
	RetargetNode.bUseCustomOverrideSets = !InOverrideSets.IsEmpty();
	RetargetNode.OverrideSetsToApply = InOverrideSets;
}
