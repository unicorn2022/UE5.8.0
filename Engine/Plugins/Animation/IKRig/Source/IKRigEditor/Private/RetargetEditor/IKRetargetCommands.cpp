...
void FIKRetargetCommands::RegisterCommands()
{
	...
	UI_COMMAND(ShowOverrideSets, "Override Sets", "Open the Override Sets tab to create / edit sets of op property overrides.", EUserInterfaceActionType::ToggleButton, FInputChord());
	UI_COMMAND(ShowVariables, "Variables", "Open the Variables tab to create / edit variables to drive property overrides.", EUserInterfaceActionType::ToggleButton, FInputChord());
