	...
	: FApplicationMode(IKRetargetApplicationModes::IKRetargetApplicationMode)
{
	...
	TabFactories.RegisterFactory(MakeShared<FIKRetargetOverridesTabSummoner>(IKRetargetEditor));
	TabFactories.RegisterFactory(MakeShared<FIKRetargetVariablesTabSummoner>(IKRetargetEditor));

	// create tab layout
	TabLayout = FTabManager::NewLayout("Standalone_IKRetargetEditor_Layout_v1.022")
		->AddArea
		(
				...
				FTabManager::NewSplitter()
					...
					(
						...
						(
							...
							->AddTab(FIKRetargetOverridesTabSummoner::TabID, ETabState::OpenedTab)
							->AddTab(FIKRetargetVariablesTabSummoner::TabID, ETabState::OpenedTab)
						)
					)
					->Split
					(
