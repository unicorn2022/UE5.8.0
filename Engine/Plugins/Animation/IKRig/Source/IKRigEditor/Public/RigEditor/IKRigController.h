...
public:
	...
	// Set the Pelvis Bone of the retargeting (can only be one). 
	...
	// Get the name of the Pelvis Bone of the retargeting (can only be one). 
	UFUNCTION(BlueprintCallable, Category="IK Rig", DisplayName="GetPelvisBone")
	UE_API FName GetRetargetRoot() const;

	// Set the bone used to store root motion for the skeleton (could be different from the root of the hierarchy).
	UFUNCTION(BlueprintCallable, BlueprintPure=false, Category="IK Rig")
	UE_API bool SetRootMotionBone(const FName RootBoneName) const;

	// Get the bone used to store root motion for the skeleton (could be different from the root of the hierarchy).
	UFUNCTION(BlueprintCallable, Category="IK Rig")
	UE_API FName GetRootMotionBone() const;
