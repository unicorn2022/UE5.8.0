...
struct FCharacterizationStandard
{
	...
	// feet
	static const FName LeftFoot;
	static const FName RightFoot;
	// arms
...
struct FAllBoneSettingsForIK
{
	...
	void SetPositionStiffness(const FName BoneName, const float PositionStiffness);
