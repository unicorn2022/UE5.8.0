...
class SIKRetargetVariablesEditor;
...
public:
	...
	virtual ~FIKRetargetEditorController() override = default;
	...
	// delegate handles to un-bind
	FDelegateHandle RetargeterReInitDelegateHandle;
	FDelegateHandle OpStackModifiedDelegateHandle;
	FDelegateHandle OverrideSetsModifiedDelegateHandle;
	FDelegateHandle VariablesModifiedDelegateHandle;
	...
	void SetOverrideSetsView(const TSharedPtr<SIKRetargetOverrideManager>& InOverrideSetView) { OverrideSetView = InOverrideSetView; };
	void SetVariablesView(const TSharedPtr<SIKRetargetVariablesEditor>& InVariablesView) { VariablesView = InVariablesView; };
	...
	void RefreshOverrideSetView() const;
	void RefreshVariablesView() const;
	...
	// SELECTION - OVERRIDE SETS
	FName GetSelectedOverrideSet() const;
	// END override set selection
	...
	FName GetChainDisplayNameForBone(const FName& BoneName, ERetargetSourceOrTarget SourceOrTarget) const;
...
private:
	...
	// overrides widget
	TSharedPtr<SIKRetargetOverrideManager> OverrideSetView;
	// variables widget
	TSharedPtr<SIKRetargetVariablesEditor> VariablesView;
