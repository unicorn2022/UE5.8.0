										...
										float ActivationDelay)
{
	if (AnimationAsset != nullptr)
	{
		if (FAnimNode_BlendStack* BlendStackNodePtr = BlendStackNode.GetAnimNodePtr<FAnimNode_BlendStack>())
		{
			...
			{
				UE_LOGF(LogBlendStack, Warning, "UBlendStackAnimNodeLibrary::BlendTo called with an invalid context.");
			}
		}
		else
		{
			UE_LOGF(LogBlendStack, Warning, "UBlendStackAnimNodeLibrary::BlendTo called with an invalid type.");
		}
	}
}
													...
													float ActivationDelay /*= 0.f*/)
{
	if (AnimationAsset != nullptr)
	{
		if (FAnimNode_BlendStack* BlendStackNodePtr = BlendStackNode.GetAnimNodePtr<FAnimNode_BlendStack>())
		{
			...
			{
				UE_LOGF(LogBlendStack, Warning, "UBlendStackAnimNodeLibrary::BlendToWithSettings called with an invalid context.");
			}
		}
		else
		{
			UE_LOGF(LogBlendStack, Warning, "UBlendStackAnimNodeLibrary::BlendToWithSettings called with an invalid type.");
		}
	}
}
...
UAnimationAsset* UBlendStackAnimNodeLibrary::GetCurrentAsset(const FBlendStackAnimNodeReference& BlendStackNode)
{
	...
	UE_LOGF(LogBlendStack, Warning, "UBlendStackAnimNodeLibrary::GetCurrentAsset called with an invalid type.");
	return nullptr;
}
...
float UBlendStackAnimNodeLibrary::GetCurrentAssetTime(const FBlendStackAnimNodeReference& BlendStackNode)
{
	...
	UE_LOGF(LogBlendStack, Warning, "UBlendStackAnimNodeLibrary::GetCurrentAssetTime called with an invalid type.");
	return 0.0f;
}
...
float UBlendStackAnimNodeLibrary::GetCurrentAssetTimeRemaining(const FBlendStackAnimNodeReference& BlendStackNode)
{
	...
	UE_LOGF(LogBlendStack, Warning, "UBlendStackAnimNodeLibrary::GetCurrentAssetTimeRemaining called with an invalid type.");
	return 0.0f;
}
...
bool UBlendStackAnimNodeLibrary::IsCurrentAssetLooping(const FBlendStackAnimNodeReference& BlendStackNode)
{
	...
	UE_LOGF(LogBlendStack, Warning, "UBlendStackAnimNodeLibrary::IsCurrentAssetLooping called with an invalid type.");
	return false;
}
...
void UBlendStackAnimNodeLibrary::ForceBlendNextUpdate(const FBlendStackAnimNodeReference& BlendStackNode)
{
	...
	{
		UE_LOGF(LogBlendStack, Warning, "UBlendStackAnimNodeLibrary::ForceBlendNextUpdate called with an invalid type.");
	}
}
