...
class UAnimGraphNode_ControlRig : public UAnimGraphNode_CustomProperty
{
	...
	virtual UStruct* GetTargetSkeletonStruct() const override;
	virtual UStruct* GetTargetStruct() const override;
	virtual FControlRigAssetStrongReference GetTargetAssetReference() const;
