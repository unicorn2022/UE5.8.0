...
void FControlRigEditModeCommands::RegisterCommands()
{
	...
	UI_COMMAND(ToggleManipulators, "Toggle Shapes", "Toggles visibility of active control rig shapes in the viewport", EUserInterfaceActionType::Button, FInputChord(EKeys::T, EModifierKey::Control | EModifierKey::Alt));
	...
	UI_COMMAND(ToggleAllManipulators, "Toggle All Shapes", "Toggles visibility of all control rig shapes in the viewport", EUserInterfaceActionType::Button, FInputChord(EKeys::T));
	...
	UI_COMMAND(SelectAnimLayerWeightChannel, "Select Anim Layer Weight Channel", "Select the weight channel for the selected anim layer", EUserInterfaceActionType::Button, FInputChord());
	...
	UI_COMMAND(IsolateLinkedAnimTracks, "Isolate Linked Anim Tracks", "Isolate linked anim tracks for every binding in the current Sequencer", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(UnIsolateLinkedAnimTracks, "Un-Isolate Linked Anim Tracks", "Un-isolate linked anim tracks for every binding in the current Sequencer", EUserInterfaceActionType::Button, FInputChord());
	...
	UI_COMMAND(ClickAndDrag, "Enable Click and Drag", "Enables Click and Drag manipulation.", EUserInterfaceActionType::None, FInputChord(EKeys::N));
}
