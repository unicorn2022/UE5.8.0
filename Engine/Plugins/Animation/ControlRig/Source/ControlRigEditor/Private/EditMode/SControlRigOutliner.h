...
public:
	...
	FText GetName() const;
	FText GetDisplayName(const FRigHierarchyTreeDisplaySettings& DisplaySettings) const;
	void InvalidateDisplayName() const;
	FText GetToolTipText(const FRigHierarchyTreeDisplaySettings& Settings) const;
...
public:
	...
	TSharedRef<ITableRow> MakeTreeRowWidget(const TSharedRef<STableViewBase>& InOwnerTable, TSharedRef<FMultiRigTreeElement> InRigTreeElement, TSharedPtr<SMultiRigHierarchyTreeView> InTreeView, const FRigHierarchyTreeDisplaySettings& InSettings, bool bPinned);
...
public:
	...
	void Construct(const FArguments& InArgs, const TSharedRef<STableViewBase>& OwnerTable, TSharedRef<FMultiRigTreeElement> InRigTreeElement, TSharedPtr<SMultiRigHierarchyTreeView> InTreeView, const FRigHierarchyTreeDisplaySettings& InSettings, bool bPinned);
...
public:
	...
	void Construct(const FArguments& InArgs);
	virtual ~SSearchableMultiRigHierarchyTreeView() = default;
