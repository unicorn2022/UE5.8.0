...
FTweenOverlayManager::FTweenOverlayManager(
	...
	, FlyoutCommands(FlyoutWidgetManager, 
		FFlyoutCommandArgs(InToolkitCommandList)
...
void FTweenOverlayManager::OnTweenCommandInvoked()
{
	...
	if (!IsShowingWidget())
	{
		FlyoutWidgetManager.TryTemporarilyPositionWidgetAtCursor(ETemporaryFlyoutPositionFlags::HideAtEnd);
	}
}
}
