...
#include "SpacePicker/Views/SRigLevelEditorSpacePicker.h"
...
TSharedRef<SWidget> SConstrainToolsRoot::CreateSpacesContent(FControlRigEditMode& InOwningEditMode, const TSharedRef<FRigSelectionViewModel>& InSelectionViewModel)
{
	...
	return SNew(SRigLevelEditorSpacePicker, InOwningEditMode, InSelectionViewModel)
		.InitialSelection(InitialSelection.WeakHierarchyToControlsMap);
}
