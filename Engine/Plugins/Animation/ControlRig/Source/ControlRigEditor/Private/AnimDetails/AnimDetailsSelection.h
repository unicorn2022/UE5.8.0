...
private:
	...
	/** Propagates the selection to curve editor on the next tick */
	void RequestPropagateSelectionToCurveEditor();
		
	/** Propagates the selection to curve editor */
	void PropagateSelectionToCurveEditor();
	...
	/** When updating, restores property data from this map and resets it */
	TMap<FName, FAnimDetailsSelectionPropertyData> RestorePropertyIDToPropertyDataMap;
	...
	/** Timer handle to propagate the selection to the curve editor */
	FTimerHandle PropagateSelectionToCurveEditorTimerHandle;

	/** Timer handle to used when anim layers were selected */
	FTimerHandle OnAnimLayersSelectedTimerHandle;
};
