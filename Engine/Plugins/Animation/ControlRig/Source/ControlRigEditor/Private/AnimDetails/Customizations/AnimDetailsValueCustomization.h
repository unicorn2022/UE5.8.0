...
namespace UE::ControlRigEditor
{
	...
	private:
		...
		/** Determines whether the transform property should use an expanded layout for its UI in property customizations */
		static bool ShouldUseTransformPropertyExpansion(const TSharedRef<IPropertyHandle>& InStructPropertyHandle);
