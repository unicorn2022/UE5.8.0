...
public:
	...
	/** Propagates the current proxy values to control rig or the bound sequencer object */
	...
	/** Sets a key for this property in sequencer */
	void SetKey(const IPropertyHandle& KeyedPropertyHandle);

	/** Removes all keys for this property in sequencer */
	void RemoveAllKeys(const IPropertyHandle& KeyedPropertyHandle);
