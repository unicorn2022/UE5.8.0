...
public:
		...
		, SocketUserInterfaceColor(0.0, 112.f/255.f, 224.f/255.f)
	{
		...
		// Control Rig Editor styles
		{
			...
			// Modular rig hierarchy tree
			{
				Set("ModularRig.Tree.RoundedBox", new FSlateRoundedBoxBrush(FStyleColors::White, 4.0f, FStyleColors::Transparent, 0.0f));
			}
		}
		...
		// Space picker
		{
			const FTableRowStyle SpacePickerTransparentTableRowStyle = FTableRowStyle()
			...
			Set("ControlRig.SpacePicker.TableRowStyle", SpacePickerTransparentTableRowStyle);

			Set("ControlRig.SpacePicker.RoundedRect", new FSlateRoundedBoxBrush(FStyleColors::White, 4.0f, FStyleColors::Transparent, 0.0f));

			Set("ControlRig.SpacePicker.ActiveSpaceColor", FStyleColors::Select);
			Set("ControlRig.SpacePicker.PartiallyActiveSpaceColor", FStyleColors::SelectInactive);
		}
		...
		Set("ControlRig.ConnectorPlain.Small", new IMAGE_BRUSH_SVG("Slate/Connector_Plain", Icon16x16));
