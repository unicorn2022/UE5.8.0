...
public:
	...
	virtual UClass* GetRigVMLegacyBlueprintClass() const override;
	...
	virtual TSharedRef<IControlRigEditor> CreateControlRigEditor(const EToolkitMode::Type Mode, const TSharedPtr<IToolkitHost>& InitToolkitHost, UControlRigRuntimeAsset* Asset) override;
	...
	static void ModifyLevelSequenceLinkSettings(UAnimSequence* AnimSequence);
...
private:
	...
	/** Guids for registered functions for creating custom UObjects for space and constraint channels for scripting*/
	FGuid SpaceCustomChannelGuid;
	FGuid ConstraintCustomChannelGuid;
