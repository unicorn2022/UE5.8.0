...
public:
	...
	virtual void InitRigVMEditor(const EToolkitMode::Type Mode, const TSharedPtr< class IToolkitHost >& InitToolkitHost, FRigVMEditorAssetInterfacePtr InRigVMBlueprint) override { return FControlRigBaseEditor::InitRigVMEditorImpl(Mode, InitToolkitHost, InRigVMBlueprint); }
	virtual void InitRigVMEditorSuper(const EToolkitMode::Type Mode, const TSharedPtr< class IToolkitHost >& InitToolkitHost, FRigVMEditorAssetInterfacePtr InRigVMBlueprint) override { return IControlRigLegacyEditor::InitRigVMEditor(Mode, InitToolkitHost, InRigVMBlueprint); }
...
public:
	...
	virtual FRigVMEditorAssetInterfacePtr GetRigVMAssetInterface() const override { return IControlRigLegacyEditor::GetRigVMAssetInterface(); }
...
public:
	...
	virtual void AddViewportOverlayWidget(TSharedRef<SWidget> InViewportOverlayWidget, int32 ZOrder = INDEX_NONE) override { if (PreviewViewport.IsValid()) { PreviewViewport->AddOverlayWidget(InViewportOverlayWidget, ZOrder); } }
	virtual void RemoveViewportOverlayWidget(TSharedRef<SWidget> InViewportOverlayWidget) override { if (PreviewViewport.IsValid()) { PreviewViewport->RemoveOverlayWidget(InViewportOverlayWidget); } }
#if WITH_RIGVMLEGACYEDITOR
...
protected:
	...
	virtual bool CanRunGraphOnce() const override { return IsRunningForwardSolve(); }
	virtual void OnRunGraphOnceToggled(bool bRunGraphOnceEnabled) override { OnRunGraphOnceToggledImpl(bRunGraphOnceEnabled); }
...
private:
	...
	virtual void HandleRefreshEditorFromBlueprint(FRigVMEditorAssetInterfacePtr InBlueprint) override { return FControlRigBaseEditor::HandleRefreshEditorFromBlueprintImpl(InBlueprint); }
	virtual void HandleRefreshEditorFromBlueprintSuper(FRigVMEditorAssetInterfacePtr InBlueprint) override { return IControlRigLegacyEditor::HandleRefreshEditorFromBlueprint(InBlueprint); }
