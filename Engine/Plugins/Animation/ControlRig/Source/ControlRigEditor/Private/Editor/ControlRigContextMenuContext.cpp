...
SModularRigHierarchy* UControlRigContextMenuContext::GetModularRigModelPanel() const
{
	if (const TSharedPtr<SModularRigHierarchy> ModularRigModelPanel = MenuSpecificContext.ModularRigModelPanel.Pin())
	{
