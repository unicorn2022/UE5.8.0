...
FRigModuleAssetBrowserTabSummoner::FRigModuleAssetBrowserTabSummoner(const TSharedPtr<FAssetEditorToolkit>& InEditorToolkit)
	: FWorkflowTabFactory(TabID, InEditorToolkit)
{
...
{
	return SNew(SRigModuleAssetBrowser);
}
