...
public:
	...
	virtual void InitRigVMEditorSuper(const EToolkitMode::Type Mode, const TSharedPtr<class IToolkitHost>& InitToolkitHost, FRigVMEditorAssetInterfacePtr InRigVMBlueprint) override { return IControlRigNewEditor::InitRigVMEditor(Mode, InitToolkitHost, InRigVMBlueprint); }
...
public:
	...
	virtual FRigVMEditorAssetInterfacePtr GetRigVMAssetInterface() const override { return IControlRigNewEditor::GetRigVMAssetInterface(); }
...
private:
	...
	virtual void HandleRefreshEditorFromBlueprintSuper(FRigVMEditorAssetInterfacePtr InBlueprint) override { return IControlRigNewEditor::HandleRefreshEditorFromBlueprint(InBlueprint); }
