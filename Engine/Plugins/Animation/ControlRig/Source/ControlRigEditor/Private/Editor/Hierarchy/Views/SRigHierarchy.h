...
#include "Editor/Hierarchy/RigHierarchyImportSettings.h"
...
private:
	...
	void OnSelectionChanged(TSharedPtr<FRigHierarchyTreeElement> Selection, ESelectInfo::Type SelectInfo);

	TSharedRef< SWidget > CreateFilterMenu();
	TSharedPtr< SWidget > CreateContextMenuWidget();
	void OnItemClicked(TSharedPtr<FRigHierarchyTreeElement> InItem);
	void OnItemDoubleClicked(TSharedPtr<FRigHierarchyTreeElement> InItem);
	void OnSetExpansionRecursive(TSharedPtr<FRigHierarchyTreeElement> InItem, bool bShouldBeExpanded);
	...
	TOptional<EItemDropZone> OnCanAcceptDrop(const FDragDropEvent& DragDropEvent, EItemDropZone DropZone, TSharedPtr<FRigHierarchyTreeElement> TargetItem);
	FReply OnAcceptDrop(const FDragDropEvent& DragDropEvent, EItemDropZone DropZone, TSharedPtr<FRigHierarchyTreeElement> TargetItem);
	...
	void HandleFrameSelection(const bool bFrameInViewport);
...
public:
	...
	friend class FRigHierarchyTreeElement;
