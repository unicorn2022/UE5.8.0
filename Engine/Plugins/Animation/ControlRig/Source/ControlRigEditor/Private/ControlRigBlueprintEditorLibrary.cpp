...
UControlRigRuntimeAsset* UControlRigBlueprintEditorLibrary::CreateControlRigAssetFromBlueprint(UControlRigBlueprint* InRigBlueprint)
{
	return FControlRigAssetActions::CreateNewControlRigAsset(InRigBlueprint);
}
