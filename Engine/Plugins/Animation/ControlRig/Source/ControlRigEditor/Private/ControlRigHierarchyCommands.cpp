...
void FControlRigHierarchyCommands::RegisterCommands()
{
	...
	UI_COMMAND(AddSocketItem, "New Socket", "Add new socket at the origin (0, 0, 0) to the hierarchy.\nNote: This is only available for Rig Modules and Modular Rigs.", EUserInterfaceActionType::Button, FInputChord(EKeys::K, EModifierKey::Control));
	...
	UI_COMMAND(ControlBoneTransform, "Control Bone Transform", "Sets the bone transform using a shape", EUserInterfaceActionType::Button, FInputChord(EKeys::B, EModifierKey::Alt));
