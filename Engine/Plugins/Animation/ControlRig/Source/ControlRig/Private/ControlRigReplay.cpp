					...
					(void)ValidateExpectedResults(OutputTimeIndex, OutputTracks.SampleTrackIndex, ControlRig,
						[ControlRig](EMessageSeverity::Type InSeverity, const FString InMessage)
						{
							switch(InSeverity)
							{
								...
								{
									UE_LOGF(LogControlRig, Warning, "%ls", *InMessage);
									break;
								}
								case EMessageSeverity::Error:
								{
									UE_LOGF(LogControlRig, Error, "%ls", *InMessage);
									break;
								}
								case EMessageSeverity::Info:
								default:
								{
									UE_LOGF(LogControlRig, Display, "%ls", *InMessage);
									break;
								}
							}
						}
