...
class UModularRigController : public UObject
{
	...
	UFUNCTION(BlueprintCallable, Category = "Control Rig | Modules", meta=(DeprecatedFunction, DeprecationMessage="Use AddModuleFromAssetReference"))
	...
	UE_API FName AddModuleFromAssetReference(const FName& InModuleName, FControlRigAssetStrongReference InHandle, const FName& InParentModuleName, bool bSetupUndo = true);
	...
	UFUNCTION(BlueprintCallable, Category = "ControlRig | Modules", meta=(DeprecatedFunction, DeprecationMessage="Use SwapModuleSource"))
	UE_API bool SwapModuleClass(const FName& InModuleName, TSubclassOf<UControlRig> InNewClass, bool bSetupUndo = true);
	UFUNCTION(BlueprintCallable, Category = "ControlRig | Modules")
	UE_API bool SwapModuleSource(const FName& InModuleName, FControlRigAssetStrongReference InNewSource, bool bSetupUndo = true);

	UFUNCTION(BlueprintCallable, Category = "ControlRig | Modules", meta=(DeprecatedFunction, DeprecationMessage="Use SwapModulesWithSource"))
	...
	UFUNCTION(BlueprintCallable, Category = "ControlRig | Modules")
	UE_API bool SwapModulesWithSource(FControlRigAssetStrongReference InOldClass, FControlRigAssetStrongReference InNewClass, bool bSetupUndo = true);
