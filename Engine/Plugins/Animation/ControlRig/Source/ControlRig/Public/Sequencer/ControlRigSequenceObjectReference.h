...
struct FControlRigSequenceObjectReference
{
	...
	{
		return A.ControlRigAssetReference == B.ControlRigAssetReference;
	}
...
template<>
struct TStructOpsTypeTraits<FControlRigSequenceObjectReference> : public TStructOpsTypeTraitsBase2<FControlRigSequenceObjectReference>
{
	enum
	{
