...
private:
	...
	*/
	...
	template<typename T>
	T* MakeElement(bool bAllocateStorage = false, bool bUpdateAllElementsStorage = false)
	{
		T* Element = GetHierarchy()->NewElement<T>(1, bAllocateStorage, bUpdateAllElementsStorage);
