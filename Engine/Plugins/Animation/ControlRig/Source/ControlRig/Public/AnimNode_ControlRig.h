...
public:
	...
	virtual TSubclassOf<UControlRig> GetControlRigClass() const override { return ControlRigAssetReference.GetBlueprintClass(); }
	virtual FControlRigAssetStrongReference GetControlRigAssetReference() const override { return ControlRigAssetReference; }
	...
	UE_API virtual void InitializeProperties(const UObject* InSourceInstance, FControlRigAssetStrongReference InTargetReference);
...
private:
	...
	UPROPERTY()
	FControlRigAssetStrongReference DefaultControlRigAssetReference;
	...
	// only if the Control Rig Class is exposed as a pin.
	UPROPERTY(meta=(DeprecatedProperty))
	TSubclassOf<UControlRig> DefaultControlRigClass_DEPRECATED;
	...
	UPROPERTY(transient)
	TMap<FControlRigAssetStrongReference, TObjectPtr<UControlRig>> ControlRigPerClass;
...
protected:
	...
	UE_API virtual FControlRigAssetStrongReference GetTargetAssetReference() const override;
