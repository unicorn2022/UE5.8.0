...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = ControlRig, meta = (DisallowCreateNew), BlueprintSetter = SetControlRigAssetReference)
	...
	UFUNCTION(BlueprintCallable, Category = "ControlRig", meta=(DeprecatedFunction, DeprecationMessage="Use SetControlRigAssetReference instead."))
	CONTROLRIG_API void SetControlRigClass(TSubclassOf<UControlRig> InControlRigClass);
	
	UFUNCTION(BlueprintCallable, Category = "ControlRig")
	CONTROLRIG_API void SetControlRigAssetReference(FControlRigAssetStrongReference InControlRigAssetReference);
