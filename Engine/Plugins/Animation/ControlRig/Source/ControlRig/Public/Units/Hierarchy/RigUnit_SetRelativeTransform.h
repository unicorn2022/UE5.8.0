...
struct FRigUnit_SetRelativeTranslationForItem : public FRigUnitMutable
{
	...
	/**
	 * The child item to set the translation for
	 */
	UPROPERTY(meta = (Input, ExpandByDefault))
	FRigElementKey Child;
	...
	/**
	 * The parent item to use.
	 * The child translation will be set in the space of the parent.
	 */
	UPROPERTY(meta = (Input, ExpandByDefault))
	FRigElementKey Parent;
	...
	// The translation of the child item relative to the provided parent
	UPROPERTY(meta=(Input))
	FVector Value;
...
struct FRigUnit_SetRelativeRotationForItem : public FRigUnitMutable
{
	...
	/**
	 * The child item to set the rotation for
	 */
	UPROPERTY(meta = (Input, ExpandByDefault))
	FRigElementKey Child;
	...
	/**
	 * The parent item to use.
	 * The child rotation will be set in the space of the parent.
	 */
	UPROPERTY(meta = (Input, ExpandByDefault))
	FRigElementKey Parent;
	...
	// The rotation of the child item relative to the provided parent
	UPROPERTY(meta=(Input))
	FQuat Value;
