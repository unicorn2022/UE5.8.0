...
/*
 * The base class for all pure dynamic hierarchy nodes
 */
USTRUCT(meta = (Abstract, NodeColor="0.262745, 0.8, 0, 0.229412", Category = "DynamicHierarchy", DocumentationPolicy = "Strict"))
...
/*
 * The base class for all mutable dynamic hierarchy nodes
 */
USTRUCT(meta = (Abstract, NodeColor="0.262745, 0.8, 0, 0.229412", Category = "DynamicHierarchy", DocumentationPolicy = "Strict"))
...
struct FRigUnit_HierarchyImportFromSkeleton : public FRigUnit_DynamicHierarchyBaseMutable
{
	...
	// The namespace to use when importing bones and curves
	UPROPERTY(meta = (Input))
	FName NameSpace;

	// If True the curves will be imported
	UPROPERTY(meta = (Input))
	bool bIncludeCurves;

	// If true the mesh sockets will be imported
	UPROPERTY(meta = (Input))
	bool bIncludeMeshSockets;

	// If true virtual bones will be imported
	UPROPERTY(meta = (Input))
	bool bIncludeVirtualBones;

	// The resulting imported items
	UPROPERTY(meta = (Output))
...
/*
 * The base class for all spawning nodes for the dynamic hierarchy set of nodes
 */
...
struct FRigUnit_HierarchyAddControl_Settings
{
	...
	{}
	virtual ~FRigUnit_HierarchyAddControl_Settings()= default;
...
struct FRigUnit_HierarchyAddControlFloat_Settings : public FRigUnit_HierarchyAddControl_Settings
{
	...
	FRigUnit_HierarchyAddControlFloat_Settings()
		...
		, bIsScale(false)
	{}
	virtual ~FRigUnit_HierarchyAddControlFloat_Settings() override = default;
...
struct FRigUnit_HierarchyAddControlInteger_Settings : public FRigUnit_HierarchyAddControl_Settings
{
	...
	FRigUnit_HierarchyAddControlInteger_Settings()
		...
		, PrimaryAxis(ERigControlAxis::X)
	{}
	virtual ~FRigUnit_HierarchyAddControlInteger_Settings() override = default;
...
struct FRigUnit_HierarchyAddControlVector2D_Settings : public FRigUnit_HierarchyAddControl_Settings
{
	...
	virtual ~FRigUnit_HierarchyAddControlVector2D_Settings() override = default;
...
struct FRigUnit_HierarchyAddControlVector_Settings : public FRigUnit_HierarchyAddControl_Settings
{
	...
	virtual ~FRigUnit_HierarchyAddControlVector_Settings() override = default;
...
struct FRigUnit_HierarchyAddControlRotator_Settings : public FRigUnit_HierarchyAddControl_Settings
{
	...
	virtual ~FRigUnit_HierarchyAddControlRotator_Settings() override = default;
...
struct FRigUnit_HierarchyAddControlTransform_Settings : public FRigUnit_HierarchyAddControl_Settings
{
	...
	virtual ~FRigUnit_HierarchyAddControlTransform_Settings() override = default;
...
struct FRigUnit_HierarchyAddAnimationChannelBool : public FRigUnit_HierarchyAddElement
{
	...
	/*
	 * The minimum value of the new animation channel
	 */
	UPROPERTY(meta = (Input))
	bool MinimumValue;
 ...
 * Note: This node only runs as part of the construction event.
 */
USTRUCT(meta=(DisplayName="Spawn Scale Animation Channel", TemplateName="SpawnScaleAnimationChannel", Keywords="Construction,Create,New,AddAnimationChannel,NewAnimationChannel,CreateAnimationChannel,AddChannel,NewChannel,CreateChannel,SpawnChannel", Varying))
