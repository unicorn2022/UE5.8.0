...
struct FRigUnit_SphericalPoseReader: public FRigUnit_HighlevelBaseMutable
{
	...
	UE_API virtual void ConfigureDirectManipulationControl(const URigVMUnitNode* InNode, TSharedPtr<FRigDirectManipulationInfo> InInfo, FRigControlSettings& InOutSettings, FRigControlValue& InOutValue) const override;
	...
	UPROPERTY()
	FRigElementKey CachedParentElementKey;
	UPROPERTY()
