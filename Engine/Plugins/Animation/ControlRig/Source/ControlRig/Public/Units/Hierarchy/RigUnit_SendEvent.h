...
/**
 * SendEvent is used to notify the engine / editor of a change that happened within the Control Rig.
 */
USTRUCT(meta=(DisplayName="Send Event", Category="Hierarchy", DocumentationPolicy="Strict", TemplateName = "SendEvent", Keywords="Event,Notify,Notification", NodeColor="1, 0, 0"))
