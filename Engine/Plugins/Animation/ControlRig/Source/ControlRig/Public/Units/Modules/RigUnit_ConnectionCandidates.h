...
struct FRigUnit_DiscardMatches : public FRigUnitMutable
{
	...
	// The message to send to the user interface when discarding matches 
	UPROPERTY(EditAnywhere, Transient, Category = "Modules", meta = (Input))
	FString Message;
};
 ...
 */
USTRUCT(meta=(DisplayName="Set Default Match", Category="Modules", TitleColor="1 0 0", NodeColor="1 1 1", TemplateName = "Set Default Match", Keywords="Connection,Resolve,Match,Default"))
 ...
 */
USTRUCT(meta = (DisplayName = "Set Default Match (Array)", Category = "Modules", TitleColor = "1 0 0", NodeColor = "1 1 1", TemplateName = "Set Default Match", Keywords = "Connection,Resolve,Match,Array,Default"))
struct FRigUnit_SetDefaultMatchArray : public FRigUnitMutable
{
	GENERATED_BODY()
	...
	// The items being interacted on
	UPROPERTY(EditAnywhere, Transient, Category = "Modules", meta = (Input, ExpandByDefault))
	TArray<FRigElementKey> Default;
};
