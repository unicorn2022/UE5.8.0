...
struct FRigUnit_SetControlBool : public FRigUnitMutable
{
	...
	/**
	 * The bool value to get / set for the given Control.
	 */
...
struct FRigUnit_SetControlFloat : public FRigUnitMutable
{
	...
	/**
	 * The float value to get / set for the given Control.
	 */
 ...
 */
USTRUCT(meta=(DisplayName="Set Control Integer", Category="Controls", DocumentationPolicy="Strict", Keywords = "SetControlInteger,SetGizmoInteger", TemplateName="SetControlValue", NodeColor = "0.0 0.36470600962638855 1.0", Deprecated="5.8.0"))
struct FRigUnit_SetControlInteger : public FRigUnitMutable
{
	...
	/**
	 * The integer value to get / set for the given Control.
	 */
	UPROPERTY(meta = (Input, Output))
	int32 IntegerValue;
...
struct FRigUnit_SetControlIntegerFloatWeight : public FRigUnitMutable
{
	GENERATED_BODY()

	FRigUnit_SetControlIntegerFloatWeight()
		: Weight(1.f)
		, IntegerValue(0)
		, CachedControlIndex(FCachedRigElement())
	{}
...
struct FRigUnit_SetControlVector2D : public FRigUnitMutable
{
	...
	/**
	 * The 2d vector value to get / set for the given Control.
	 */
	UPROPERTY(meta = (Input, Output))
	FVector2D Vector;
...
struct FRigUnit_SetControlVector : public FRigUnitMutable
{
	...
	/**
	 * The vector value to get / set for the given Control.
	 */
	UPROPERTY(meta = (Input, Output))
	FVector Vector;
...
struct FRigUnit_SetControlRotator : public FRigUnitMutable
{
	...
	/**
	 * The rotator value to get / set for the given Control.
	 */
	UPROPERTY(meta = (Input, Output))
	FRotator Rotator;
...
struct FRigUnit_SetControlTransform : public FRigUnitMutable
{
	...
	/**
	 * The transform value to get / set for the given Control.
	 */
	UPROPERTY(meta = (Input, Output))
