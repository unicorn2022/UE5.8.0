...
struct FRigHierarchySettings
{
	...
	bool operator==(const FRigHierarchySettings& InOther) const
	{
		return ElementNameDisplayMode == InOther.ElementNameDisplayMode &&
			ProceduralElementLimit == InOther.ProceduralElementLimit;
	}
