...
struct FAnimNode_ControlRigBase : public FAnimNode_CustomProperty
{
	...
	virtual FControlRigAssetStrongReference GetControlRigAssetReference() const PURE_VIRTUAL(FAnimNode_ControlRigBase::GetControlRigAssetReference, return FControlRigAssetStrongReference(); );
...
protected:
	...
	UE_API virtual FControlRigAssetStrongReference GetTargetAssetReference() const;
