...
struct FRigControlCopy
{
	...
	FRigControlCopy(FRigControlElement* InControlElement, URigHierarchy* InHierarchy, bool bGetValues = true)
	{
...
struct FControlRigControlPose
{
	...
	~FControlRigControlPose() = default;

	UE_API void SavePose(UControlRig* ControlRig, bool bUseAll, bool bSaveValues = true);
...
public:
	...
	UE_API void SavePose(UControlRig* InControlRig, bool bUseAll, bool bSaveValues = true);
