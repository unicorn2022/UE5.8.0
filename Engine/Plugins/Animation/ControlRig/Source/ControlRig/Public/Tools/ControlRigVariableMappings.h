...
struct FControlRigVariableMappings
{
	...
	UE_API void InitializeProperties(const UClass* InSourceClass
		...
		, FControlRigAssetStrongReference InTargetClass
	...
	UE_API void UpdateCurveInputs(UControlRig* InControlRig, const TMap<FName, FName>& InputMapping, const FBlendedCurve& CurveData) const;

	UE_API void UpdateCurveOutputs(UControlRig* InControlRig, const TMap<FName, FName>& OutputMapping, FBlendedCurve& InCurveData) const;
