...
class FSpeechAnimationSolverV3 : public ISpeechAnimationSolver
{
public:

	UE_API FSpeechAnimationSolverV3(const TObjectPtr<class UNNEModelData> InModelData, const FString& InNNEBackend);
