...
const unsigned char geometry[] = {
    ...
    0x02,  // Vertex position: 2
    0x00,
    0x06,  // Blend shape index in Definition
    // Mesh-1
    0x00,
    0x00,
    0x01,
    ...
    0x02,  // Vertex position: 2
    0x00,
    0x07  // Blend shape index in Definition
};
...
const Vector<StringPair> metadata = {{"key-A", "value-A"}, {"key-B", "value-B"}};
const TranslationUnit translationUnit = TranslationUnit::m;
const RotationUnit rotationUnit = RotationUnit::radians;
const CoordinateSystem coordinateSystem = {Direction::right, Direction::up, Direction::front};
...
// Definition
const Vector<String<char>> guiControlNames = {"GA", "GB", "GC", "GD", "GE", "GF", "GG", "GH", "GI"};
const Vector<String<char>> rawControlNames = {"RA", "RB", "RC", "RD", "RE", "RF", "RG", "RH", "RI"};
const VectorOfCharStringMatrix jointNames = {{// MaxLOD-0 - MinLOD-1
...
const VectorOfCharStringMatrix blendShapeNames = {{// MaxLOD-0 - MinLOD-1
...
const VectorOfCharStringMatrix animatedMapNames = {{// MaxLOD-0 - MinLOD-1
...
const VectorOfCharStringMatrix meshNames = {{// MaxLOD-0 - MinLOD-1
                                             {"MA", "MB"},
                                             {"MC"}},
                                            {// MaxLOD-1 - MinLOD-1
                                             {"MC"}},
                                            {// MaxLOD-0 - MinLOD-0
                                             {"MA", "MB"}}};
const Vector<Matrix<std::uint16_t>> meshBlendShapeIndices = {{// MaxLOD-0 - MinLOD-1
                                                              {0, 1, 2, 3, 4, 5, 6},
                                                              {7, 8}},
                                                             {// MaxLOD-1 - MinLOD-1
                                                              {0, 1}},
...
const Matrix<std::uint16_t> jointHierarchy = {{// MaxLOD-0 - MinLOD-1
                                               {0, 0, 0, 1, 1, 4, 2, 4, 2}},
                                              {// MaxLOD-1 - MinLOD-1
                                               {0, 0, 0, 1, 2, 2}},
                                              {// MaxLOD-0 - MinLOD-0
...
const Vector<Matrix<float>> conditionalCutValues = {
    ...
    {// MaxLOD-0 - MinLOD-0
     {0.0f, 0.5f, 0.5f, 0.4f, 0.3f, 0.3f, 1.0f, 1.0f, 1.0f, 0.2f, 0.4f, 0.8f, 0.8f, 1.0f, 0.2f}}};
// Behavior->PSDs
const Vector<std::uint16_t> psdRowIndices = {8,  8,  8,  9,  9,  10, 10, 10, 11, 12, 13, 13,
                                             13, 14, 14, 15, 16, 18, 18, 18, 18, 19, 19, 20};
const Vector<std::uint16_t> psdColumnIndices = {0, 3, 6, 2, 5, 2, 3, 7, 3, 2, 0, 1, 2, 3, 6, 0, 4, 0, 3, 4, 5, 6, 7, 2};
const Vector<float> psdValues = {1.0f, 0.9f, 0.9f, 0.6f, 1.0f, 0.8f, 0.9f, 0.8f, 1.0f, 0.3f, 1.0f, 0.9f,
...
const Vector<Matrix<std::uint16_t>> jointVariableIndices = {{// MaxLOD-0 - MinLOD-1
...
const Vector<Vector<Matrix<std::uint16_t>>> jointGroupInputIndices = {{ // Joint Group 0
                                                                       {// MaxLOD-0 - MaxLOD-1
                                                                        {0, 1, 2, 3, 6, 7, 8},
                                                                        {0, 1, 2, 3, 6, 7, 8}},
                                                                       {// MaxLOD-1 - MaxLOD-1
                                                                      ...
                                                                      { // Joint Group 3
                                                                       ...
                                                                       {// MaxLOD-0 - MaxLOD-0
                                                                        {2, 5, 6, 8}}}};
const Vector<Vector<Matrix<std::uint16_t>>> jointGroupOutputIndices = {{ // Joint Group 0
                                                                        {// MaxLOD-0 - MaxLOD-1
                                                                         {2, 3, 5},
                                                                         {2, 3, 5}},
                                                                        {// MaxLOD-1 - MaxLOD-1
...
const Vector<Vector<Matrix<float>>> jointGroupValues = {
    ...
    { // Joint group 3
     ...
     {// MaxLOD-0 - MinLOD-0
      {0.31f, 0.36f, 0.42f, 0.47f, 0.53f, 0.58f, 0.64f, 0.69f, 0.75f, 0.80f, 0.86f, 0.91f}}}};
const Vector<Vector<Matrix<std::uint16_t>>> jointGroupJointIndices = {{ // Joint Group 0
                                                                       {// MaxLOD-0 - MaxLOD-1
                                                                        {0},
                                                                        {0}},
                                                                       {// MaxLOD-1 - MinLOD-1
...
const Vector<Matrix<std::uint16_t>> blendShapeInputIndices = {{// MaxLOD-0 - MaxLOD-1
                                                               {0, 1, 2, 3, 6, 7, 8},
                                                               {0, 1, 2, 3}},
                                                              {// MaxLOD-1 - MinLOD-1
                                                               {0, 1, 2, 3}},
                                                              {// MaxLOD-0 - MinLOD-0
                                                               {0, 1, 2, 3, 6, 7, 8}}};
const Vector<Matrix<std::uint16_t>> blendShapeOutputIndices = {{// MaxLOD-0 - MaxLOD-1
                                                                {0, 1, 2, 3, 6, 7, 8},
                                                                {0, 1, 2, 3}},
                                                               {// MaxLOD-1 - MinLOD-1
                                                                {0, 1, 2, 3}},
...
const Vector<Matrix<Vector3>> vertexPositions = {{ // MaxLOD-0 - MaxLOD-1
                                                  {// Mesh-0
                                                   {7.0f, 7.0f, 7.0f},
                                                   {8.0f, 8.0f, 8.0f},
                                                   {9.0f, 9.0f, 9.0f}},
                                                 ...
                                                 { // MaxLOD-0 - MinLOD-0
                                                  ...
                                                  {// Mesh-1
                                                   ...
                                                   {5.0f, 5.0f, 5.0f},
                                                   {6.0f, 6.0f, 6.0f}}}};
const Vector<Matrix<TextureCoordinate>> vertexTextureCoordinates = {{ // MaxLOD-0 - MaxLOD-1
                                                                     {// Mesh-0
                                                                      {7.0f, 7.0f},
                                                                      {8.0f, 8.0f},
                                                                      {9.0f, 9.0f}},
                                                                    ...
                                                                    { // MaxLOD-0 - MinLOD-0
                                                                     ...
                                                                     {// Mesh-1
                                                                      ...
                                                                      {5.0f, 5.0f},
                                                                      {6.0f, 6.0f}}}};
const Vector<Matrix<Vector3>> vertexNormals = {{ // MaxLOD-0 - MaxLOD-1
                                                {// Mesh-0
                                                 {7.0f, 7.0f, 7.0f},
                                                 {8.0f, 8.0f, 8.0f},
                                                 {9.0f, 9.0f, 9.0f}},
                                               ...
                                               { // MaxLOD-0 - MinLOD-0
                                                ...
                                                {// Mesh-1
                                                 ...
                                                 {5.0f, 5.0f, 5.0f},
                                                 {6.0f, 6.0f, 6.0f}}}};
const Vector<Matrix<VertexLayout>> vertexLayouts = {{ // MaxLOD-0 - MaxLOD-1
                                                     {// Mesh-0
                                                      {0, 0, 0},
                                                      {1, 1, 1},
                                                      {2, 2, 2}},
                                                    ...
                                                    { // MaxLOD-0 - MinLOD-0
                                                     ...
                                                     {// Mesh-1
                                                      ...
                                                      {1, 1, 1},
                                                      {2, 2, 2}}}};
const Matrix<Matrix<std::uint32_t>> faces = {{ // MaxLOD-0 - MaxLOD-1
                                              {// Mesh-0
                                               {0, 1, 2}},
                                              {// Mesh-1
                                               {0, 1, 2}},
...
const Matrix<Matrix<float>> skinWeightsValues = {{ // MaxLOD-0 - MinLOD-1
                                                  {// Mesh-0
                                                   {0.7f, 0.1f, 0.2f},
                                                   {0.5f, 0.5f},
                                                   {0.4f, 0.6f}},
                                                 ...
                                                 { // MaxLOD-0 - MinLOD-0
                                                  ...
                                                  {// Mesh-1
                                                   ...
                                                   {0.8f, 0.2f},
                                                   {0.1f, 0.9f}}}};
const Matrix<Matrix<std::uint16_t>> skinWeightsJointIndices = {{ // MaxLOD-0 - MaxLOD-1
                                                                {// Mesh-0
                                                                 {0, 1, 2},
                                                                 {3, 4},
                                                                 {5, 6}},
                                                               ...
                                                               { // MaxLOD-0 - MinLOD-0
                                                                ...
                                                                {// Mesh-1
                                                                 ...
                                                                 {3, 4},
                                                                 {5, 6}}}};
const Vector<Matrix<std::uint16_t>> correctiveBlendShapeIndices = {{ // MaxLOD-0 - MaxLOD-1
                                                                    {// Mesh-0
                                                                     6},
                                                                    {// Mesh-1
                                                                     6},
                                                                   ...
                                                                   { // MaxLOD-0 - MinLOD-0
                                                                    ...
                                                                    {// Mesh-1
                                                                     6}}};
const Matrix<Matrix<Vector3>> correctiveBlendShapeDeltas = {{  // MaxLOD-0 - MaxLOD-1
                                                             { // Mesh-0
                                                              {// Blendshape-0
                                                               {7.0f, 7.0f, 7.0f},
                                                               {8.0f, 8.0f, 8.0f},
                                                            ...
                                                            {  // MaxLOD-0 - MinLOD-0
                                                             ...
                                                             { // Mesh-1
                                                              {// Blendshape-0
                                                               ...
                                                               {5.0f, 5.0f, 5.0f},
                                                               {6.0f, 6.0f, 6.0f}}}}};
const Matrix<Matrix<std::uint32_t>> correctiveBlendShapeVertexIndices = {{// MaxLOD-0 - MaxLOD-1
                                                                          {
                                                                              // Mesh-0
                                                                              {0, 1, 2},  // Blendshape-0
                                                                          },
...
// Machine learned behavior
const Vector<String<char>> mlControlNames = {"MA", "MB", "MC", "MD", "ME", "MF", "MG", "MH", "MI"};
...
const VectorOfCharStringMatrix regionNames = {{ // MaxLOD-0 - MinLOD-1
                                               {// Mesh-0
                                                "RA",
                                                "RB"},
                                               {// Mesh-1
                                              ...
                                              { // MaxLOD-0 - MinLOD-0
                                               ...
                                               {// Mesh-1
                                                "RC",
                                                "RD"}}};
const Matrix<Matrix<std::uint16_t>> neuralNetworkIndicesPerMeshRegion = {{  // MaxLOD-0 - MaxLOD-1
                                                                          { // Mesh-0
                                                                           {// Region-0
                                                                            0},
                                                                           {// Region-1
                                                                         ...
                                                                         {  // MaxLOD-0 - MinLOD-0
                                                                          ...
                                                                          { // Mesh-1
                                                                           ...
                                                                           {// Region-1
                                                                            3}}}};
const Vector<Matrix<std::uint16_t>> neuralNetworkInputIndices = {{ // MaxLOD-0 - MaxLOD-1
                                                                  {// Mesh-0 Region-0
                                                                   0,
                                                                   1},
                                                                  {// Mesh-0 Region-1
                                                                 ...
                                                                 { // MaxLOD-0 - MinLOD-0
                                                                  ...
                                                                  {// Mesh-1 Region-1
                                                                   6,
                                                                   7}}};
const Vector<Matrix<std::uint16_t>> neuralNetworkOutputIndices = {{ // MaxLOD-0 - MaxLOD-1
                                                                   {// Mesh-0 Region-0
                                                                    9},
                                                                   {// Mesh-0 Region-1
                                                                    10},
...
const Vector<Matrix<std::uint16_t>> neuralNetworkActivationFunction = {{ // MaxLOD-0 - MaxLOD-1
                                                                        {// Mesh-0 Region-0
                                                                         1,
                                                                         1},
                                                                        {// Mesh-0 Region-1
                                                                       ...
                                                                       { // MaxLOD-0 - MinLOD-0
                                                                        ...
                                                                        {// Mesh-1 Region-1
                                                                         1,
                                                                         1}}};
const Matrix<Matrix<float>> neuralNetworkActivationFunctionParameters = {{// MaxLOD-0 - MaxLOD-1
                                                                          {
                                                                              // Mesh-0  Region-0
                                                                              {0.5f},  // Layer-0
                                                                              {0.5f}   // Layer-1
...
const Matrix<Matrix<float>> neuralNetworkBiases = {{// MaxLOD-0 - MaxLOD-1
                                                    {
                                                        // Mesh-0 Region-0
                                                        {1.0f, 1.0f},  // Layer-0
                                                        {1.0f}         // Layer-1
...
const Matrix<Matrix<float>> neuralNetworkWeights = {{// MaxLOD-0 - MaxLOD-1
                                                     {
                                                         // Mesh-0 Region-0
