...
const unsigned char RawV25::header[] = {
    ...
    0x00,
    0x0d,
    0x8a,  // Machine learned behavior offset
    0x00,
    0x00,
    0x02,
    ...
    0x00,
    0x12,
    0xaf,  // Joint behavior metadata offset
    0x00,
    0x00,
    0x00,
    ...
    0x00,
    0x12,
    0xe9,  // Twist swing setups offset
    0x00,
    0x00,
    0x00,
...
const pma::Vector<DecodedV25::StringPair> DecodedV25::metadata = {{"key-A", "value-A"}, {"key-B", "value-B"}};
...
const CoordinateSystem DecodedV25::coordinateSystem = {Direction::right, Direction::up, Direction::front};
...
// Definition
const pma::Vector<pma::String<char>> DecodedV25::guiControlNames = {"GA", "GB", "GC", "GD", "GE", "GF", "GG", "GH", "GI"};
const pma::Vector<pma::String<char>> DecodedV25::rawControlNames = {"RA", "RB", "RC", "RD", "RE", "RF", "RG", "RH", "RI"};
const DecodedV25::VectorOfCharStringMatrix DecodedV25::jointNames = {{// MaxLOD-0 - MinLOD-1
...
const DecodedV25::VectorOfCharStringMatrix DecodedV25::meshNames = {{// MaxLOD-0 - MinLOD-1
                                                                     {"MA", "MB"},
                                                                     {"MC"}},
                                                                    {// MaxLOD-1 - MinLOD-1
                                                                     {"MC"}},
                                                                    {// MaxLOD-0 - MinLOD-0
                                                                     {"MA", "MB"}}};
const pma::Vector<pma::Matrix<std::uint16_t>> DecodedV25::meshBlendShapeIndices = {{// MaxLOD-0 - MinLOD-1
                                                                                    {0, 1, 2, 3, 4, 5, 6},
                                                                                    {7, 8}},
                                                                                   {// MaxLOD-1 - MinLOD-1
                                                                                    {0, 1}},
...
const pma::Matrix<std::uint16_t> DecodedV25::jointHierarchy = {{// MaxLOD-0 - MinLOD-1
                                                                {0, 0, 0, 1, 1, 4, 2, 4, 2}},
                                                               {// MaxLOD-1 - MinLOD-1
                                                                {0, 0, 0, 1, 2, 2}},
                                                               {// MaxLOD-0 - MinLOD-0
...
const pma::Vector<pma::Matrix<float>> DecodedV25::conditionalCutValues = {
    ...
    {// MaxLOD-0 - MinLOD-0
     {0.0f, 0.5f, 0.5f, 0.4f, 0.3f, 0.3f, 1.0f, 1.0f, 1.0f, 0.2f, 0.4f, 0.8f, 0.8f, 1.0f, 0.2f}}};
// Behavior->PSDs
const pma::Vector<std::uint16_t> DecodedV25::psdRowIndices = {8,  8,  8,  9,  9,  10, 10, 10, 11, 12, 13, 13,
                                                              13, 14, 14, 15, 16, 18, 18, 18, 18, 19, 19, 20};
const pma::Vector<std::uint16_t> DecodedV25::psdColumnIndices = {0, 3, 6, 2, 5, 2, 3, 7, 3, 2, 0, 1,
                                                                 2, 3, 6, 0, 4, 0, 3, 4, 5, 6, 7, 2};
const pma::Vector<float> DecodedV25::psdValues = {1.0f, 0.9f, 0.9f, 0.6f, 1.0f, 0.8f, 0.9f, 0.8f, 1.0f, 0.3f, 1.0f, 0.9f,
...
const pma::Vector<pma::Vector<pma::Matrix<std::uint16_t>>> DecodedV25::jointGroupInputIndices = {{ // Joint Group 0
                                                                                                  {// MaxLOD-0 - MaxLOD-1
                                                                                                   {0, 1, 2, 3, 6, 7, 8},
                                                                                                   {0, 1, 2, 3, 6, 7, 8}},
                                                                                                  {// MaxLOD-1 - MaxLOD-1
                                                                                                 ...
                                                                                                 { // Joint Group 3
                                                                                                  ...
                                                                                                  {// MaxLOD-0 - MaxLOD-0
                                                                                                   {2, 5, 6, 8}}}};
const pma::Vector<pma::Vector<pma::Matrix<std::uint16_t>>> DecodedV25::jointGroupOutputIndices = {{ // Joint Group 0
                                                                                                   {// MaxLOD-0 - MaxLOD-1
                                                                                                    {2, 3, 5},
                                                                                                    {2, 3, 5}},
                                                                                                   {// MaxLOD-1 - MaxLOD-1
...
const pma::Vector<pma::Vector<pma::Matrix<float>>> DecodedV25::jointGroupValues = {
    ...
    { // Joint group 3
     ...
     {// MaxLOD-0 - MinLOD-0
      {0.31f, 0.36f, 0.42f, 0.47f, 0.53f, 0.58f, 0.64f, 0.69f, 0.75f, 0.80f, 0.86f, 0.91f}}}};
const pma::Vector<pma::Vector<pma::Matrix<std::uint16_t>>> DecodedV25::jointGroupJointIndices = {{ // Joint Group 0
                                                                                                  {// MaxLOD-0 - MaxLOD-1
                                                                                                   {0},
                                                                                                   {0}},
                                                                                                  {// MaxLOD-1 - MinLOD-1
...
const pma::Vector<pma::Matrix<std::uint16_t>> DecodedV25::blendShapeInputIndices = {{// MaxLOD-0 - MaxLOD-1
                                                                                     {0, 1, 2, 3, 6, 7, 8},
                                                                                     {0, 1, 2, 3}},
                                                                                    {// MaxLOD-1 - MinLOD-1
                                                                                     {0, 1, 2, 3}},
                                                                                    {// MaxLOD-0 - MinLOD-0
                                                                                     {0, 1, 2, 3, 6, 7, 8}}};
const pma::Vector<pma::Matrix<std::uint16_t>> DecodedV25::blendShapeOutputIndices = {{// MaxLOD-0 - MaxLOD-1
                                                                                      {0, 1, 2, 3, 6, 7, 8},
                                                                                      {0, 1, 2, 3}},
                                                                                     {// MaxLOD-1 - MinLOD-1
                                                                                      {0, 1, 2, 3}},
...
const pma::Vector<pma::Matrix<Vector3>> DecodedV25::vertexPositions = {{ // MaxLOD-0 - MaxLOD-1
                                                                        {// Mesh-0
                                                                         {7.0f, 7.0f, 7.0f},
                                                                         {8.0f, 8.0f, 8.0f},
                                                                         {9.0f, 9.0f, 9.0f}},
                                                                       ...
                                                                       { // MaxLOD-0 - MinLOD-0
                                                                        ...
                                                                        {// Mesh-1
                                                                         ...
                                                                         {5.0f, 5.0f, 5.0f},
                                                                         {6.0f, 6.0f, 6.0f}}}};
const pma::Vector<pma::Matrix<TextureCoordinate>> DecodedV25::vertexTextureCoordinates = {{ // MaxLOD-0 - MaxLOD-1
                                                                                           {// Mesh-0
                                                                                            {7.0f, 7.0f},
                                                                                            {8.0f, 8.0f},
                                                                                            {9.0f, 9.0f}},
                                                                                          ...
                                                                                          { // MaxLOD-0 - MinLOD-0
                                                                                           ...
                                                                                           {// Mesh-1
                                                                                            ...
                                                                                            {5.0f, 5.0f},
                                                                                            {6.0f, 6.0f}}}};
const pma::Vector<pma::Matrix<Vector3>> DecodedV25::vertexNormals = {{ // MaxLOD-0 - MaxLOD-1
                                                                      {// Mesh-0
                                                                       {7.0f, 7.0f, 7.0f},
                                                                       {8.0f, 8.0f, 8.0f},
                                                                       {9.0f, 9.0f, 9.0f}},
                                                                     ...
                                                                     { // MaxLOD-0 - MinLOD-0
                                                                      ...
                                                                      {// Mesh-1
                                                                       ...
                                                                       {5.0f, 5.0f, 5.0f},
                                                                       {6.0f, 6.0f, 6.0f}}}};
const pma::Vector<pma::Matrix<VertexLayout>> DecodedV25::vertexLayouts = {{ // MaxLOD-0 - MaxLOD-1
                                                                           {// Mesh-0
                                                                            {0, 0, 0},
                                                                            {1, 1, 1},
                                                                            {2, 2, 2}},
                                                                          ...
                                                                          { // MaxLOD-0 - MinLOD-0
                                                                           ...
                                                                           {// Mesh-1
                                                                            ...
                                                                            {1, 1, 1},
                                                                            {2, 2, 2}}}};
const pma::Matrix<pma::Matrix<std::uint32_t>> DecodedV25::faces = {{ // MaxLOD-0 - MaxLOD-1
                                                                    {// Mesh-0
                                                                     {0, 1, 2}},
                                                                    {// Mesh-1
                                                                     {0, 1, 2}},
...
const pma::Matrix<pma::Matrix<float>> DecodedV25::skinWeightsValues = {{ // MaxLOD-0 - MinLOD-1
                                                                        {// Mesh-0
                                                                         {0.7f, 0.1f, 0.2f},
                                                                         {0.5f, 0.5f},
                                                                         {0.4f, 0.6f}},
                                                                       ...
                                                                       { // MaxLOD-0 - MinLOD-0
                                                                        ...
                                                                        {// Mesh-1
                                                                         ...
                                                                         {0.8f, 0.2f},
                                                                         {0.1f, 0.9f}}}};
const pma::Matrix<pma::Matrix<std::uint16_t>> DecodedV25::skinWeightsJointIndices = {{ // MaxLOD-0 - MaxLOD-1
                                                                                      {// Mesh-0
                                                                                       {0, 1, 2},
                                                                                       {3, 4},
                                                                                       {5, 6}},
                                                                                     ...
                                                                                     { // MaxLOD-0 - MinLOD-0
                                                                                      ...
                                                                                      {// Mesh-1
                                                                                       ...
                                                                                       {3, 4},
                                                                                       {5, 6}}}};
const pma::Vector<pma::Matrix<std::uint16_t>> DecodedV25::correctiveBlendShapeIndices = {{ // MaxLOD-0 - MaxLOD-1
                                                                                          {// Mesh-0
                                                                                           2},
                                                                                          {// Mesh-1
                                                                                           2},
                                                                                         ...
                                                                                         { // MaxLOD-0 - MinLOD-0
                                                                                          ...
                                                                                          {// Mesh-1
                                                                                           2}}};
const pma::Matrix<pma::Matrix<Vector3>> DecodedV25::correctiveBlendShapeDeltas = {{  // MaxLOD-0 - MaxLOD-1
                                                                                   { // Mesh-0
                                                                                    {// Blendshape-0
                                                                                     {7.0f, 7.0f, 7.0f},
                                                                                     {8.0f, 8.0f, 8.0f},
...
// Machine learned behavior
const pma::Vector<pma::String<char>> DecodedV25::mlControlNames = {"MA", "MB", "MC", "MD", "ME", "MF", "MG", "MH", "MI"};
...
const DecodedV25::VectorOfCharStringMatrix DecodedV25::regionNames = {{ // MaxLOD-0 - MinLOD-1
                                                                       {// Mesh-0
                                                                        "RA",
                                                                        "RB"},
                                                                       {// Mesh-1
                                                                      ...
                                                                      { // MaxLOD-0 - MinLOD-0
                                                                       ...
                                                                       {// Mesh-1
                                                                        "RC",
                                                                        "RD"}}};
const pma::Matrix<pma::Matrix<std::uint16_t>> DecodedV25::neuralNetworkIndicesPerMeshRegion = {{  // MaxLOD-0 - MaxLOD-1
                                                                                                { // Mesh-0
                                                                                                 {// Region-0
                                                                                                  0},
                                                                                                 {// Region-1
...
const pma::Matrix<pma::Matrix<float>> DecodedV25::neuralNetworkBiases = {{// MaxLOD-0 - MaxLOD-1
                                                                          {
                                                                              // Mesh-0 Region-0
                                                                              {1.0f, 1.0f},  // Layer-0
                                                                              {1.0f}         // Layer-1
...
const pma::Matrix<pma::Matrix<float>> DecodedV25::neuralNetworkWeights = {{// MaxLOD-0 - MaxLOD-1
                                                                           {
                                                                               // Mesh-0 Region-0
...
const pma::Matrix<std::uint16_t> DecodedV25::solverIndicesPerLOD{{// MaxLOD-0 - MinLOD-1
                                                                  0,
                                                                  1,
                                                                  2},
                                                                 {// MaxLOD-1 - MinLOD-1
...
const pma::Vector<pma::String<char>> DecodedV25::solverNames{"RSA", "RSB", "RSC"};

const pma::Matrix<std::uint16_t> DecodedV25::solverRawControlIndices{// Solver 0
                                                                     {11, 12},
                                                                     // Solver 1
                                                                     {3},
                                                                     // Solver 2
...
const pma::Vector<float> DecodedV25::solverRadius{1.0f, 2.0f, 1.0f};

const pma::Vector<float> DecodedV25::solverWeightThreshold{1.0f, 2.0f, 1.0f};

const pma::Vector<std::uint16_t> DecodedV25::solverType{0, 1, 0};

const pma::Vector<std::uint16_t> DecodedV25::solverAutomaticRadius{0, 0, 0};

const pma::Vector<std::uint16_t> DecodedV25::solverDistanceMethod{1, 3, 1};

const pma::Vector<std::uint16_t> DecodedV25::solverNormalizeMethod{0, 1, 0};

const pma::Vector<std::uint16_t> DecodedV25::solverFunctionType{2, 2, 0};

const pma::Vector<std::uint16_t> DecodedV25::solverTwistAxis{0, 1, 0};

const pma::Vector<pma::String<char>> DecodedV25::poseNames{"RA", "RB", "RC", "RD", "RE", "RF", "RG", "RH"};
...
const pma::Vector<pma::String<char>> DecodedV25::poseControlNames = {"PA", "PB", "PC", "PD", "PE", "PF", "PG", "PH", "PI"};
...
const Matrix<float> DecodedV25::poseOutputControlWeights = {{1.0f}, {1.0f}, {1.0f}, {1.0f}, {1.0f}, {1.0f}, {1.0f}, {0.5f, 0.5f}};

const pma::Matrix<TranslationRepresentation> DecodedV25::jointTranslationRepresentation = {{// MaxLOD-0 - MinLOD-1
...
const pma::Matrix<ScaleRepresentation> DecodedV25::jointScaleRepresentation = {{// MaxLOD-0 - MinLOD-1
...
const pma::Vector<pma::Matrix<float>> DecodedV25::swingBlendWeights = {{// MaxLOD-0 - MinLOD-1
                                                                        {1.0f, 2.0f},
                                                                        {-2.0f, -1.0f},
                                                                        {1.0f}},
                                                                       {
...
const pma::Vector<pma::Matrix<std::uint16_t>> DecodedV25::swingOutputJointIndices = {{// MaxLOD-0 - MinLOD-1
                                                                                      {0u, 1u},
                                                                                      {4u, 6u},
                                                                                      {5u}},
                                                                                     {// MaxLOD-1 - MinLOD-0
...
const pma::Vector<pma::Matrix<std::uint16_t>> DecodedV25::swingInputControlIndices = {{// MaxLOD-0 - MinLOD-1
                                                                                       {5u, 6u, 7u, 8u},
                                                                                       {11u, 12u, 13u, 14u},
                                                                                       {27u, 28u, 29u, 30u}},
                                                                                      {// MaxLOD-1 - MinLOD-0
...
const pma::Matrix<TwistAxis> DecodedV25::swingTwistAxes = {{// MaxLOD-0 - MinLOD-1
                                                            TwistAxis::X,
                                                            TwistAxis::Y,
                                                            TwistAxis::Z},
                                                           {// MaxLOD-1 - MinLOD-0
...
const pma::Vector<pma::Matrix<float>> DecodedV25::twistBlendWeights = {{// MaxLOD-0 - MinLOD-1
                                                                        {1.0f, 2.0f},
                                                                        {-2.0f, -1.0f},
                                                                        {1.0f}},
                                                                       {
...
const pma::Vector<pma::Matrix<std::uint16_t>> DecodedV25::twistOutputJointIndices = {{// MaxLOD-0 - MinLOD-1
                                                                                      {0u, 1u},
                                                                                      {4u, 6u},
                                                                                      {5u}},
                                                                                     {// MaxLOD-1 - MinLOD-0
...
const pma::Vector<pma::Matrix<std::uint16_t>> DecodedV25::twistInputControlIndices = {{// MaxLOD-0 - MinLOD-1
                                                                                       {5u, 6u, 7u, 8u},
                                                                                       {11u, 12u, 13u, 14u},
                                                                                       {27u, 28u, 29u, 30u}},
                                                                                      {// MaxLOD-1 - MinLOD-0
...
const pma::Matrix<TwistAxis> DecodedV25::twistTwistAxes = {{// MaxLOD-0 - MinLOD-1
                                                            TwistAxis::X,
                                                            TwistAxis::Y,
                                                            TwistAxis::Z},
                                                           {// MaxLOD-1 - MinLOD-0
...
RawAnimatedMaps DecodedV25::getAnimatedMaps(std::uint16_t currentMaxLOD,
                                            std::uint16_t currentMinLOD,
                                            pma::MemoryResource* memRes) {
