...
const unsigned char RawV23::header[] = {
    ...
    0x00,
    0x0d,
    0x4a,  // Machine learned behavior offset
    0x00,
    0x00,
    0x02,
...
const pma::Vector<DecodedV23::StringPair> DecodedV23::metadata = {{"key-A", "value-A"}, {"key-B", "value-B"}};
...
const CoordinateSystem DecodedV23::coordinateSystem = {Direction::right, Direction::up, Direction::front};
...
// Definition
const pma::Vector<pma::String<char>> DecodedV23::guiControlNames = {"GA", "GB", "GC", "GD", "GE", "GF", "GG", "GH", "GI"};
const pma::Vector<pma::String<char>> DecodedV23::rawControlNames = {"RA", "RB", "RC", "RD", "RE", "RF", "RG", "RH", "RI"};
const DecodedV23::VectorOfCharStringMatrix DecodedV23::jointNames = {{// MaxLOD-0 - MinLOD-1
...
const DecodedV23::VectorOfCharStringMatrix DecodedV23::meshNames = {{// MaxLOD-0 - MinLOD-1
                                                                     {"MA", "MB"},
                                                                     {"MC"}},
                                                                    {// MaxLOD-1 - MinLOD-1
                                                                     {"MC"}},
                                                                    {// MaxLOD-0 - MinLOD-0
                                                                     {"MA", "MB"}}};
const pma::Vector<pma::Matrix<std::uint16_t>> DecodedV23::meshBlendShapeIndices = {{// MaxLOD-0 - MinLOD-1
                                                                                    {0, 1, 2, 3, 4, 5, 6},
                                                                                    {7, 8}},
                                                                                   {// MaxLOD-1 - MinLOD-1
                                                                                    {0, 1}},
...
const pma::Matrix<std::uint16_t> DecodedV23::jointHierarchy = {{// MaxLOD-0 - MinLOD-1
                                                                {0, 0, 0, 1, 1, 4, 2, 4, 2}},
                                                               {// MaxLOD-1 - MinLOD-1
                                                                {0, 0, 0, 1, 2, 2}},
                                                               {// MaxLOD-0 - MinLOD-0
...
const pma::Vector<pma::Matrix<float>> DecodedV23::conditionalCutValues = {
    ...
    {// MaxLOD-0 - MinLOD-0
     {0.0f, 0.5f, 0.5f, 0.4f, 0.3f, 0.3f, 1.0f, 1.0f, 1.0f, 0.2f, 0.4f, 0.8f, 0.8f, 1.0f, 0.2f}}};
// Behavior->PSDs
const pma::Vector<std::uint16_t> DecodedV23::psdRowIndices = {8,  8,  8,  9,  9,  10, 10, 10, 11, 12, 13, 13,
                                                              13, 14, 14, 15, 16, 18, 18, 18, 18, 19, 19, 20};
const pma::Vector<std::uint16_t> DecodedV23::psdColumnIndices = {0, 3, 6, 2, 5, 2, 3, 7, 3, 2, 0, 1,
                                                                 2, 3, 6, 0, 4, 0, 3, 4, 5, 6, 7, 2};
const pma::Vector<float> DecodedV23::psdValues = {1.0f, 0.9f, 0.9f, 0.6f, 1.0f, 0.8f, 0.9f, 0.8f, 1.0f, 0.3f, 1.0f, 0.9f,
...
const pma::Vector<pma::Vector<pma::Matrix<std::uint16_t>>> DecodedV23::jointGroupInputIndices = {{ // Joint Group 0
                                                                                                  {// MaxLOD-0 - MaxLOD-1
                                                                                                   {0, 1, 2, 3, 6, 7, 8},
                                                                                                   {0, 1, 2, 3, 6, 7, 8}},
                                                                                                  {// MaxLOD-1 - MaxLOD-1
                                                                                                 ...
                                                                                                 { // Joint Group 3
                                                                                                  ...
                                                                                                  {// MaxLOD-0 - MaxLOD-0
                                                                                                   {2, 5, 6, 8}}}};
const pma::Vector<pma::Vector<pma::Matrix<std::uint16_t>>> DecodedV23::jointGroupOutputIndices = {{ // Joint Group 0
                                                                                                   {// MaxLOD-0 - MaxLOD-1
                                                                                                    {2, 3, 5},
                                                                                                    {2, 3, 5}},
                                                                                                   {// MaxLOD-1 - MaxLOD-1
...
const pma::Vector<pma::Vector<pma::Matrix<float>>> DecodedV23::jointGroupValues = {
    ...
    { // Joint group 3
     ...
     {// MaxLOD-0 - MinLOD-0
      {0.31f, 0.36f, 0.42f, 0.47f, 0.53f, 0.58f, 0.64f, 0.69f, 0.75f, 0.80f, 0.86f, 0.91f}}}};
const pma::Vector<pma::Vector<pma::Matrix<std::uint16_t>>> DecodedV23::jointGroupJointIndices = {{ // Joint Group 0
                                                                                                  {// MaxLOD-0 - MaxLOD-1
                                                                                                   {0},
                                                                                                   {0}},
                                                                                                  {// MaxLOD-1 - MinLOD-1
...
const pma::Vector<pma::Matrix<std::uint16_t>> DecodedV23::blendShapeInputIndices = {{// MaxLOD-0 - MaxLOD-1
                                                                                     {0, 1, 2, 3, 6, 7, 8},
                                                                                     {0, 1, 2, 3}},
                                                                                    {// MaxLOD-1 - MinLOD-1
                                                                                     {0, 1, 2, 3}},
                                                                                    {// MaxLOD-0 - MinLOD-0
                                                                                     {0, 1, 2, 3, 6, 7, 8}}};
const pma::Vector<pma::Matrix<std::uint16_t>> DecodedV23::blendShapeOutputIndices = {{// MaxLOD-0 - MaxLOD-1
                                                                                      {0, 1, 2, 3, 6, 7, 8},
                                                                                      {0, 1, 2, 3}},
                                                                                     {// MaxLOD-1 - MinLOD-1
                                                                                      {0, 1, 2, 3}},
...
const pma::Vector<pma::Matrix<Vector3>> DecodedV23::vertexPositions = {{ // MaxLOD-0 - MaxLOD-1
                                                                        {// Mesh-0
                                                                         {7.0f, 7.0f, 7.0f},
                                                                         {8.0f, 8.0f, 8.0f},
                                                                         {9.0f, 9.0f, 9.0f}},
                                                                       ...
                                                                       { // MaxLOD-0 - MinLOD-0
                                                                        ...
                                                                        {// Mesh-1
                                                                         ...
                                                                         {5.0f, 5.0f, 5.0f},
                                                                         {6.0f, 6.0f, 6.0f}}}};
const pma::Vector<pma::Matrix<TextureCoordinate>> DecodedV23::vertexTextureCoordinates = {{ // MaxLOD-0 - MaxLOD-1
                                                                                           {// Mesh-0
                                                                                            {7.0f, 7.0f},
                                                                                            {8.0f, 8.0f},
                                                                                            {9.0f, 9.0f}},
                                                                                          ...
                                                                                          { // MaxLOD-0 - MinLOD-0
                                                                                           ...
                                                                                           {// Mesh-1
                                                                                            ...
                                                                                            {5.0f, 5.0f},
                                                                                            {6.0f, 6.0f}}}};
const pma::Vector<pma::Matrix<Vector3>> DecodedV23::vertexNormals = {{ // MaxLOD-0 - MaxLOD-1
                                                                      {// Mesh-0
                                                                       {7.0f, 7.0f, 7.0f},
                                                                       {8.0f, 8.0f, 8.0f},
                                                                       {9.0f, 9.0f, 9.0f}},
                                                                     ...
                                                                     { // MaxLOD-0 - MinLOD-0
                                                                      ...
                                                                      {// Mesh-1
                                                                       ...
                                                                       {5.0f, 5.0f, 5.0f},
                                                                       {6.0f, 6.0f, 6.0f}}}};
const pma::Vector<pma::Matrix<VertexLayout>> DecodedV23::vertexLayouts = {{ // MaxLOD-0 - MaxLOD-1
                                                                           {// Mesh-0
                                                                            {0, 0, 0},
                                                                            {1, 1, 1},
                                                                            {2, 2, 2}},
                                                                          ...
                                                                          { // MaxLOD-0 - MinLOD-0
                                                                           ...
                                                                           {// Mesh-1
                                                                            ...
                                                                            {1, 1, 1},
                                                                            {2, 2, 2}}}};
const pma::Matrix<pma::Matrix<std::uint32_t>> DecodedV23::faces = {{ // MaxLOD-0 - MaxLOD-1
                                                                    {// Mesh-0
                                                                     {0, 1, 2}},
                                                                    {// Mesh-1
                                                                     {0, 1, 2}},
...
const pma::Matrix<pma::Matrix<float>> DecodedV23::skinWeightsValues = {{ // MaxLOD-0 - MinLOD-1
                                                                        {// Mesh-0
                                                                         {0.7f, 0.1f, 0.2f},
                                                                         {0.5f, 0.5f},
                                                                         {0.4f, 0.6f}},
                                                                       ...
                                                                       { // MaxLOD-0 - MinLOD-0
                                                                        ...
                                                                        {// Mesh-1
                                                                         ...
                                                                         {0.8f, 0.2f},
                                                                         {0.1f, 0.9f}}}};
const pma::Matrix<pma::Matrix<std::uint16_t>> DecodedV23::skinWeightsJointIndices = {{ // MaxLOD-0 - MaxLOD-1
                                                                                      {// Mesh-0
                                                                                       {0, 1, 2},
                                                                                       {3, 4},
                                                                                       {5, 6}},
                                                                                     ...
                                                                                     { // MaxLOD-0 - MinLOD-0
                                                                                      ...
                                                                                      {// Mesh-1
                                                                                       ...
                                                                                       {3, 4},
                                                                                       {5, 6}}}};
const pma::Vector<pma::Matrix<std::uint16_t>> DecodedV23::correctiveBlendShapeIndices = {{ // MaxLOD-0 - MaxLOD-1
                                                                                          {// Mesh-0
                                                                                           2},
                                                                                          {// Mesh-1
                                                                                           2},
                                                                                         ...
                                                                                         { // MaxLOD-0 - MinLOD-0
                                                                                          ...
                                                                                          {// Mesh-1
                                                                                           2}}};
const pma::Matrix<pma::Matrix<Vector3>> DecodedV23::correctiveBlendShapeDeltas = {{  // MaxLOD-0 - MaxLOD-1
                                                                                   { // Mesh-0
                                                                                    {// Blendshape-0
                                                                                     {7.0f, 7.0f, 7.0f},
                                                                                     {8.0f, 8.0f, 8.0f},
...
// Machine learned behavior
const pma::Vector<pma::String<char>> DecodedV23::mlControlNames = {"MA", "MB", "MC", "MD", "ME", "MF", "MG", "MH", "MI"};
...
const DecodedV23::VectorOfCharStringMatrix DecodedV23::regionNames = {{ // MaxLOD-0 - MinLOD-1
                                                                       {// Mesh-0
                                                                        "RA",
                                                                        "RB"},
                                                                       {// Mesh-1
                                                                      ...
                                                                      { // MaxLOD-0 - MinLOD-0
                                                                       ...
                                                                       {// Mesh-1
                                                                        "RC",
                                                                        "RD"}}};
const pma::Matrix<pma::Matrix<std::uint16_t>> DecodedV23::neuralNetworkIndicesPerMeshRegion = {{  // MaxLOD-0 - MaxLOD-1
                                                                                                { // Mesh-0
                                                                                                 {// Region-0
                                                                                                  0},
                                                                                                 {// Region-1
...
const pma::Matrix<pma::Matrix<float>> DecodedV23::neuralNetworkBiases = {{// MaxLOD-0 - MaxLOD-1
                                                                          {
                                                                              // Mesh-0 Region-0
                                                                              {1.0f, 1.0f},  // Layer-0
                                                                              {1.0f}         // Layer-1
...
const pma::Matrix<pma::Matrix<float>> DecodedV23::neuralNetworkWeights = {{// MaxLOD-0 - MaxLOD-1
                                                                           {
                                                                               // Mesh-0 Region-0
...
RawAnimatedMaps DecodedV23::getAnimatedMaps(std::uint16_t currentMaxLOD,
                                            std::uint16_t currentMinLOD,
                                            pma::MemoryResource* memRes) {
