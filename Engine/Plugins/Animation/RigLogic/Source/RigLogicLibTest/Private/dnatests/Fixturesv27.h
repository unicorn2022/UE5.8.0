...
struct RawV27 {
    ...
    static const unsigned char machineLearnedBehaviorExt[448];
    static const unsigned char descriptorExt[16];

    static std::vector<char> getBytes();
};

struct RawV26DowngradedFromV27 {
    static std::vector<char> getBytes();
};
...
struct DecodedV27 {
    ...
    static const pma::Matrix<pma::Matrix<MachineLearnedBehaviorOperationType>> mlOperationTypes;
    static const pma::Vector<pma::Matrix<pma::Matrix<std::uint32_t>>> mlOperationParameters;
    static const pma::Vector<pma::Matrix<pma::Matrix<std::uint16_t>>> mlDependencyOperationSetIndices;
    static const pma::Vector<pma::Matrix<pma::Matrix<std::uint16_t>>> mlDependencyOperationIndices;
    static const pma::Vector<pma::Matrix<pma::Matrix<std::uint16_t>>> mlOperationIndicesPerLOD;

    // Descriptor ext
    static const RotationSequence rotationSequence;
    static const RotationSign rotationSign;
    static const FaceWindingOrder faceWindingOrder;
