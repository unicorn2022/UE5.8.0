...
const unsigned char RawV22::header[] = {
    ...
    0x01,
    0x00,
    0x03,  // Unknown 1 version
    0x00,
    0x00,
    0x0d,
    0x5a,  // Unknown 1 offset
    0x00,
    0x00,
    0x00,
    0x10,  // Unknown 1 size
    ...
    0x01,
    0x00,
    0x02,  // Unknown 2 version
    0x00,
    0x00,
    0x0d,
    0x6a,  // Unknown 2 offset
    0x00,
    0x00,
    0x00,
    0x20  // Unknown 2 size
...
const unsigned char RawV22::unknownLayer2[] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b,
...
const unsigned char RawV2xNewer::header[] = {
    ...
    0x01,
    0x00,
    0x02,  // Definition version
    0x00,
    0x00,
    0x00,
    0x7b,  // Definition offset
    0x00,
    0x00,
    0x00,
    0x10,  // Definition size
    0x62,
    0x68,
    0x76,
    0x72,  // Behavior id
    ...
    0x01,
    0x00,
    0x02,  // Behavior version
    0x00,
    0x00,
    0x00,
    0x8b,  // Behavior offset
    0x00,
    0x00,
    0x00,
    0x20,  // Behavior size
    ...
    0x01,
    0x00,
    0x02,  // Geometry version
    0x00,
    0x00,
    0x00,
    0xab,  // Geometry offset
    0x00,
    0x00,
    0x00,
    0x20,  // Geometry size
...
const unsigned char RawV2xNewer::unknownBehavior[] = {0x5c, 0xb9, 0xe1, 0x7e, 0x50, 0x2f, 0x3b, 0x8a, 0x72, 0x3c, 0xd9,
                                                      0xbf, 0x6f, 0x10, 0xcc, 0xee, 0xa4, 0xd8, 0x65, 0x98, 0xc0, 0xb2,
                                                      0xff, 0xa2, 0x0d, 0x4d, 0xc5, 0x79, 0x99, 0x3a, 0xef, 0xc8};

const unsigned char RawV2xNewer::unknownGeometry[] = {0x9e, 0x60, 0x76, 0xe8, 0x04, 0x15, 0x99, 0xda, 0x38, 0xdd, 0xc9,
                                                      0x4a, 0xe8, 0x86, 0x83, 0x42, 0x4b, 0x32, 0x59, 0x5d, 0xf8, 0x07,
                                                      0x33, 0x7c, 0x01, 0xa4, 0x05, 0x65, 0x22, 0x25, 0x57, 0x8e};
...
const unsigned char RawV2xNewer::unknownCustom2[] = {0xf1, 0x12, 0xca, 0xcb, 0x29, 0x3f, 0xeb, 0x0d, 0x19, 0x3e, 0x86,
                                                     0x73, 0xd9, 0x6d, 0x76, 0xd3, 0xa7, 0x70, 0xfb, 0x06, 0x6a, 0xe1,
                                                     0x8e, 0x4b, 0xb9, 0x3d, 0xf9, 0xfe, 0x49, 0xc9, 0xbe, 0x3c};
...
const unsigned char RawV2xNewerWithUnknownDataPreservedAndDNARewritten::header[] = {
    ...
    0x00,
    0x01,
    0xcf,  // Definition offset
    0x00,
    0x00,
    0x00,
    0x5c,  // Definition size
    0x62,
    0x68,
    0x76,
    0x72,  // Behavior id
    ...
    0x00,
    0x02,
    0x85,  // Machine learned behavior offset
    0x00,
    0x00,
    0x00,
    0x18,  // Machine learned behavior size
    0x72,
    0x62,
    0x66,
    ...
    0x00,
    0x02,
    0x9d,  // RBF behavior offset
    0x00,
    0x00,
    0x00,
    0x10,  // RBF behavior size
    0x72,
    0x62,
    0x66,
    ...
    0x00,
    0x02,
    0xad,  // RBF behavior ext offset
    0x00,
    0x00,
    0x00,
    0x08,  // RBF behavior ext size
    0x6a,
    0x62,
    0x6d,
    ...
    0x00,
    0x02,
    0xb5,  // Joint behavior metadata offset
    0x00,
    0x00,
    0x00,
    0x04,  // Joint behavior metadata size
    0x74,
    0x77,
    0x73,
    ...
    0x00,
    0x02,
    0xb9,  // Twist swing setups offset
    0x00,
    0x00,
    0x00,
    0x08,  // Twist swing setups size
    0x6d,
    0x6c,
    0x62,
    ...
    0x00,
    0x00,
    0x14,  // Machine learned behavior ext size
    0x64,
    0x73,
    0x63,
...
const unsigned char RawV2xNewerWithUnknownDataPreservedAndDNARewritten::geometry[] = {0x00, 0x00, 0x00, 0x00};
...
const unsigned char RawV2xNewerWithUnknownDataPreservedAndDNARewritten::jointBehaviorMetaData[] = {0x00, 0x00, 0x00, 0x00};

const unsigned char RawV2xNewerWithUnknownDataPreservedAndDNARewritten::twistSwingBehavior[] =
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};

const unsigned char RawV2xNewerWithUnknownDataPreservedAndDNARewritten::machineLearnedBehaviorExt[] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};

const unsigned char RawV2xNewerWithUnknownDataPreservedAndDNARewritten::descriptorExt[] =
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00};
...
const unsigned char RawV2xNewerWithUnknownDataIgnoredAndDNARewritten::header[] = {
    ...
    0x00,
    0x01,
    0x95,  // Machine learned behavior offset
    0x00,
    0x00,
    0x00,
    0x18,  // Machine learned behavior size
    ...
    0x00,
    0x01,
    0xc5,  // Joint behavior metadata offset
    0x00,
    0x00,
    0x00,
    0x04,  // Joint behavior metadata size
    ...
    0x00,
    0x01,
    0xc9,  // Twist swing setups offset
    0x00,
    0x00,
    0x00,
    0x08,  // Twist swing setups size
...
std::vector<char> RawV2xNewerWithUnknownDataIgnoredAndDNARewritten::getBytes() {
    ...
    // Machine learned behavior ext
    bytes.insert(bytes.end(),
                 RawV2xNewerWithUnknownDataPreservedAndDNARewritten::machineLearnedBehaviorExt,
                 RawV2xNewerWithUnknownDataPreservedAndDNARewritten::machineLearnedBehaviorExt +
                     sizeof(RawV2xNewerWithUnknownDataPreservedAndDNARewritten::machineLearnedBehaviorExt));
    // Descriptor ext
    bytes.insert(bytes.end(),
                 RawV2xNewerWithUnknownDataPreservedAndDNARewritten::descriptorExt,
                 RawV2xNewerWithUnknownDataPreservedAndDNARewritten::descriptorExt +
                     sizeof(RawV2xNewerWithUnknownDataPreservedAndDNARewritten::descriptorExt));
...
const pma::Vector<DecodedV22::StringPair> DecodedV22::metadata = {{"key-A", "value-A"}, {"key-B", "value-B"}};
...
const CoordinateSystem DecodedV22::coordinateSystem = {Direction::right, Direction::up, Direction::front};
...
// Definition
const pma::Vector<pma::String<char>> DecodedV22::guiControlNames = {"GA", "GB", "GC", "GD", "GE", "GF", "GG", "GH", "GI"};
const pma::Vector<pma::String<char>> DecodedV22::rawControlNames = {"RA", "RB", "RC", "RD", "RE", "RF", "RG", "RH", "RI"};
const DecodedV22::VectorOfCharStringMatrix DecodedV22::jointNames = {{// MaxLOD-0 - MinLOD-1
...
const DecodedV22::VectorOfCharStringMatrix DecodedV22::meshNames = {{// MaxLOD-0 - MinLOD-1
                                                                     {"MA", "MB"},
                                                                     {"MC"}},
                                                                    {// MaxLOD-1 - MinLOD-1
                                                                     {"MC"}},
                                                                    {// MaxLOD-0 - MinLOD-0
                                                                     {"MA", "MB"}}};
const pma::Vector<pma::Matrix<std::uint16_t>> DecodedV22::meshBlendShapeIndices = {{// MaxLOD-0 - MinLOD-1
                                                                                    {0, 1, 2, 3, 4, 5, 6},
                                                                                    {7, 8}},
                                                                                   {// MaxLOD-1 - MinLOD-1
                                                                                    {0, 1}},
...
const pma::Matrix<std::uint16_t> DecodedV22::jointHierarchy = {{// MaxLOD-0 - MinLOD-1
                                                                {0, 0, 0, 1, 1, 4, 2, 4, 2}},
                                                               {// MaxLOD-1 - MinLOD-1
                                                                {0, 0, 0, 1, 2, 2}},
                                                               {// MaxLOD-0 - MinLOD-0
...
const pma::Vector<pma::Matrix<float>> DecodedV22::conditionalCutValues = {
    ...
    {// MaxLOD-0 - MinLOD-0
     {0.0f, 0.5f, 0.5f, 0.4f, 0.3f, 0.3f, 1.0f, 1.0f, 1.0f, 0.2f, 0.4f, 0.8f, 0.8f, 1.0f, 0.2f}}};
// Behavior->PSDs
const pma::Vector<std::uint16_t> DecodedV22::psdRowIndices = {8,  8,  8,  9,  9,  10, 10, 10, 11, 12, 13, 13,
                                                              13, 14, 14, 15, 16, 18, 18, 18, 18, 19, 19, 20};
const pma::Vector<std::uint16_t> DecodedV22::psdColumnIndices = {0, 3, 6, 2, 5, 2, 3, 7, 3, 2, 0, 1,
                                                                 2, 3, 6, 0, 4, 0, 3, 4, 5, 6, 7, 2};
const pma::Vector<float> DecodedV22::psdValues = {1.0f, 0.9f, 0.9f, 0.6f, 1.0f, 0.8f, 0.9f, 0.8f, 1.0f, 0.3f, 1.0f, 0.9f,
...
const pma::Vector<pma::Vector<pma::Matrix<std::uint16_t>>> DecodedV22::jointGroupInputIndices = {{ // Joint Group 0
                                                                                                  {// MaxLOD-0 - MaxLOD-1
                                                                                                   {0, 1, 2, 3, 6, 7, 8},
                                                                                                   {0, 1, 2, 3, 6, 7, 8}},
                                                                                                  {// MaxLOD-1 - MaxLOD-1
                                                                                                 ...
                                                                                                 { // Joint Group 3
                                                                                                  ...
                                                                                                  {// MaxLOD-0 - MaxLOD-0
                                                                                                   {2, 5, 6, 8}}}};
const pma::Vector<pma::Vector<pma::Matrix<std::uint16_t>>> DecodedV22::jointGroupOutputIndices = {{ // Joint Group 0
                                                                                                   {// MaxLOD-0 - MaxLOD-1
                                                                                                    {2, 3, 5},
                                                                                                    {2, 3, 5}},
                                                                                                   {// MaxLOD-1 - MaxLOD-1
...
const pma::Vector<pma::Vector<pma::Matrix<float>>> DecodedV22::jointGroupValues = {
    ...
    { // Joint group 3
     ...
     {// MaxLOD-0 - MinLOD-0
      {0.31f, 0.36f, 0.42f, 0.47f, 0.53f, 0.58f, 0.64f, 0.69f, 0.75f, 0.80f, 0.86f, 0.91f}}}};
const pma::Vector<pma::Vector<pma::Matrix<std::uint16_t>>> DecodedV22::jointGroupJointIndices = {{ // Joint Group 0
                                                                                                  {// MaxLOD-0 - MaxLOD-1
                                                                                                   {0},
                                                                                                   {0}},
                                                                                                  {// MaxLOD-1 - MinLOD-1
...
const pma::Vector<pma::Matrix<std::uint16_t>> DecodedV22::blendShapeInputIndices = {{// MaxLOD-0 - MaxLOD-1
                                                                                     {0, 1, 2, 3, 6, 7, 8},
                                                                                     {0, 1, 2, 3}},
                                                                                    {// MaxLOD-1 - MinLOD-1
                                                                                     {0, 1, 2, 3}},
                                                                                    {// MaxLOD-0 - MinLOD-0
                                                                                     {0, 1, 2, 3, 6, 7, 8}}};
const pma::Vector<pma::Matrix<std::uint16_t>> DecodedV22::blendShapeOutputIndices = {{// MaxLOD-0 - MaxLOD-1
                                                                                      {0, 1, 2, 3, 6, 7, 8},
                                                                                      {0, 1, 2, 3}},
                                                                                     {// MaxLOD-1 - MinLOD-1
                                                                                      {0, 1, 2, 3}},
...
const pma::Vector<pma::Matrix<Vector3>> DecodedV22::vertexPositions = {{ // MaxLOD-0 - MaxLOD-1
                                                                        {// Mesh-0
                                                                         {7.0f, 7.0f, 7.0f},
                                                                         {8.0f, 8.0f, 8.0f},
                                                                         {9.0f, 9.0f, 9.0f}},
                                                                       ...
                                                                       { // MaxLOD-0 - MinLOD-0
                                                                        ...
                                                                        {// Mesh-1
                                                                         ...
                                                                         {5.0f, 5.0f, 5.0f},
                                                                         {6.0f, 6.0f, 6.0f}}}};
const pma::Vector<pma::Matrix<TextureCoordinate>> DecodedV22::vertexTextureCoordinates = {{ // MaxLOD-0 - MaxLOD-1
                                                                                           {// Mesh-0
                                                                                            {7.0f, 7.0f},
                                                                                            {8.0f, 8.0f},
                                                                                            {9.0f, 9.0f}},
                                                                                          ...
                                                                                          { // MaxLOD-0 - MinLOD-0
                                                                                           ...
                                                                                           {// Mesh-1
                                                                                            ...
                                                                                            {5.0f, 5.0f},
                                                                                            {6.0f, 6.0f}}}};
const pma::Vector<pma::Matrix<Vector3>> DecodedV22::vertexNormals = {{ // MaxLOD-0 - MaxLOD-1
                                                                      {// Mesh-0
                                                                       {7.0f, 7.0f, 7.0f},
                                                                       {8.0f, 8.0f, 8.0f},
                                                                       {9.0f, 9.0f, 9.0f}},
                                                                     ...
                                                                     { // MaxLOD-0 - MinLOD-0
                                                                      ...
                                                                      {// Mesh-1
                                                                       ...
                                                                       {5.0f, 5.0f, 5.0f},
                                                                       {6.0f, 6.0f, 6.0f}}}};
const pma::Vector<pma::Matrix<VertexLayout>> DecodedV22::vertexLayouts = {{ // MaxLOD-0 - MaxLOD-1
                                                                           {// Mesh-0
                                                                            {0, 0, 0},
                                                                            {1, 1, 1},
                                                                            {2, 2, 2}},
                                                                          ...
                                                                          { // MaxLOD-0 - MinLOD-0
                                                                           ...
                                                                           {// Mesh-1
                                                                            ...
                                                                            {1, 1, 1},
                                                                            {2, 2, 2}}}};
const pma::Matrix<pma::Matrix<std::uint32_t>> DecodedV22::faces = {{ // MaxLOD-0 - MaxLOD-1
                                                                    {// Mesh-0
                                                                     {0, 1, 2}},
                                                                    {// Mesh-1
                                                                     {0, 1, 2}},
...
const pma::Matrix<pma::Matrix<float>> DecodedV22::skinWeightsValues = {{ // MaxLOD-0 - MinLOD-1
                                                                        {// Mesh-0
                                                                         {0.7f, 0.1f, 0.2f},
                                                                         {0.5f, 0.5f},
                                                                         {0.4f, 0.6f}},
                                                                       ...
                                                                       { // MaxLOD-0 - MinLOD-0
                                                                        ...
                                                                        {// Mesh-1
                                                                         ...
                                                                         {0.8f, 0.2f},
                                                                         {0.1f, 0.9f}}}};
const pma::Matrix<pma::Matrix<std::uint16_t>> DecodedV22::skinWeightsJointIndices = {{ // MaxLOD-0 - MaxLOD-1
                                                                                      {// Mesh-0
                                                                                       {0, 1, 2},
                                                                                       {3, 4},
                                                                                       {5, 6}},
                                                                                     ...
                                                                                     { // MaxLOD-0 - MinLOD-0
                                                                                      ...
                                                                                      {// Mesh-1
                                                                                       ...
                                                                                       {3, 4},
                                                                                       {5, 6}}}};
const pma::Vector<pma::Matrix<std::uint16_t>> DecodedV22::correctiveBlendShapeIndices = {{ // MaxLOD-0 - MaxLOD-1
                                                                                          {// Mesh-0
                                                                                           2},
                                                                                          {// Mesh-1
                                                                                           2},
                                                                                         ...
                                                                                         { // MaxLOD-0 - MinLOD-0
                                                                                          ...
                                                                                          {// Mesh-1
                                                                                           2}}};
const pma::Matrix<pma::Matrix<Vector3>> DecodedV22::correctiveBlendShapeDeltas = {{  // MaxLOD-0 - MaxLOD-1
                                                                                   { // Mesh-0
                                                                                    {// Blendshape-0
                                                                                     {7.0f, 7.0f, 7.0f},
                                                                                     {8.0f, 8.0f, 8.0f},
...
RawAnimatedMaps DecodedV22::getAnimatedMaps(std::uint16_t currentMaxLOD,
                                            std::uint16_t currentMinLOD,
                                            pma::MemoryResource* memRes) {
