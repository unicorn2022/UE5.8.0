...
public:
    Joints(JointsEvaluator::Pointer evaluator_, RigMetadata* meta, MemoryResource* memRes);
    ...
    void calculate(ControlsInputInstance* inputs, JointsOutputInstance* outputs, std::uint16_t lod) const;
