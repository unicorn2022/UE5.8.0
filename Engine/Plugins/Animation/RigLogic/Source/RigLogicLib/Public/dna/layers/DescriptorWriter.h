...
public:
    ...
    */
    ...
    virtual void setRotationSequence(RotationSequence rotationSequence) = 0;
    virtual void setRotationSign(const RotationSign& rotationSign) = 0;
    virtual void setFaceWindingOrder(FaceWindingOrder faceWindingOrder) = 0;
    /**
