...
// its proxy is found
    ...
    typename std::enable_if<!traits::is_batchable<TContainer>::value>::type processElements(const TContainer& source) {
...
public:
    explicit BinaryOutputArchive(TStream* stream_) :
