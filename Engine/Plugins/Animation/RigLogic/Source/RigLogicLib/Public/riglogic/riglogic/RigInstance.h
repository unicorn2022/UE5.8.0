...
public:
    ...
    */
    ...
    virtual ArrayView<float> getGUIControlValues() = 0;
    ...
    virtual ArrayView<float> getRawControlValues() = 0;
    ...
    virtual ConstArrayView<float> getMLMaskValues() const = 0;
    virtual ArrayView<float> getMLMaskValues() = 0;
