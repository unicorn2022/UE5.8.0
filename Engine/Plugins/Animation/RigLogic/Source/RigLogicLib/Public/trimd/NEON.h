...
struct F128 {
    ...
    explicit F128(float32x4_t value) :
        data{value} {
    }

    explicit F128(float value) :
        F128{vdupq_n_f32(value)} {
    }
...
TRIMD_TARGET_NEON_FP16 inline F128 F128::fromAlignedSource(const std::uint16_t* source) {
    return F128{vcvt_f32_f16(vld1_f16(reinterpret_cast<const float16_t*>(source)))};
}

TRIMD_TARGET_NEON_FP16 inline F128 F128::fromUnalignedSource(const std::uint16_t* source) {
    return F128{vcvt_f32_f16(vld1_f16(reinterpret_cast<const float16_t*>(source)))};
}

TRIMD_TARGET_NEON_FP16 inline F128 F128::loadSingleValue(const std::uint16_t* source) {
    float16_t value;
    std::memcpy(&value, source, sizeof(float16_t));
    return F128{vcvt_f32_f16(vset_lane_f16(value, vdup_n_f16(float16_t{}), 0))};
}

TRIMD_TARGET_NEON_FP16 inline void F128::alignedLoad(const std::uint16_t* source) {
    data = vcvt_f32_f16(vld1_f16(reinterpret_cast<const float16_t*>(source)));
}

TRIMD_TARGET_NEON_FP16 inline void F128::unalignedLoad(const std::uint16_t* source) {
    data = vcvt_f32_f16(vld1_f16(reinterpret_cast<const float16_t*>(source)));
}

TRIMD_TARGET_NEON_FP16 inline void F128::alignedStore(std::uint16_t* dest) const {
    vst1_f16(reinterpret_cast<float16_t*>(dest), vcvt_f16_f32(data));
}

TRIMD_TARGET_NEON_FP16 inline void F128::unalignedStore(std::uint16_t* dest) const {
    vst1_f16(reinterpret_cast<float16_t*>(dest), vcvt_f16_f32(data));
}
