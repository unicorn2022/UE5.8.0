...
RigLogicDNAReader::RigLogicDNAReader(const dna::Reader* DNAReader) : Reader{DNAReader}
{
}
...
{
	return Reader->getJointGroupValues(jointGroupIndex);
}
...
{
	return Reader->getRBFSolverRawControlValues(solverIndex);
}
...
uint16 RigLogicDNAReader::getMLTypeCount() const
{
	return Reader->getMLTypeCount();
}

uint16 RigLogicDNAReader::getMLOperationSetCount(uint16 mlTypeIndex) const
{
	return Reader->getMLOperationSetCount(mlTypeIndex);
}

uint16 RigLogicDNAReader::getMLOperationCount(uint16 mlTypeIndex, uint16 mlOperationSetIndex) const
{
	return Reader->getMLOperationCount(mlTypeIndex, mlOperationSetIndex);
}

dna::MachineLearnedBehaviorOperationType RigLogicDNAReader::getMLOperationType(uint16 mlTypeIndex, uint16 mlOperationSetIndex, uint16 mlOperationIndex) const
{
	return Reader->getMLOperationType(mlTypeIndex, mlOperationSetIndex, mlOperationIndex);
}

dna::ConstArrayView<uint32> RigLogicDNAReader::getMLOperationParameters(uint16 mlTypeIndex, uint16 mlOperationSetIndex, uint16 mlOperationIndex) const
{
	return Reader->getMLOperationParameters(mlTypeIndex, mlOperationSetIndex, mlOperationIndex);
}

dna::ConstArrayView<uint16> RigLogicDNAReader::getMLOperationDependencyOperationSetIndices(uint16 mlTypeIndex, uint16 mlOperationSetIndex, uint16 mlOperationIndex) const
{
	return Reader->getMLOperationDependencyOperationSetIndices(mlTypeIndex, mlOperationSetIndex, mlOperationIndex);
}

dna::ConstArrayView<uint16> RigLogicDNAReader::getMLOperationDependencyOperationIndices(uint16 mlTypeIndex, uint16 mlOperationSetIndex, uint16 mlOperationIndex) const
{
	return Reader->getMLOperationDependencyOperationIndices(mlTypeIndex, mlOperationSetIndex, mlOperationIndex);
}

uint16 RigLogicDNAReader::getMLOperationIndexListCount(uint16 mlTypeIndex, uint16 mlOperationSetIndex) const
{
	return Reader->getMLOperationIndexListCount(mlTypeIndex, mlOperationSetIndex);
}

dna::ConstArrayView<uint16> RigLogicDNAReader::getMLOperationIndicesForLOD(uint16 mlTypeIndex, uint16 mlOperationSetIndex, uint16 lod) const
{
	return Reader->getMLOperationIndicesForLOD(mlTypeIndex, mlOperationSetIndex, lod);
}

dna::ConstArrayView<uint16> RigLogicDNAReader::getMLJointsInputIndices() const
{
	return Reader->getMLJointsInputIndices();
}

dna::ConstArrayView<uint16> RigLogicDNAReader::getMLJointsOutputIndices() const
{
	return Reader->getMLJointsOutputIndices();
}

dna::ConstArrayView<uint16> RigLogicDNAReader::getMLJointsParameterKeys() const
{
	return Reader->getMLJointsParameterKeys();
}

dna::ConstArrayView<uint16> RigLogicDNAReader::getMLJointsParameterValues() const
{
	return Reader->getMLJointsParameterValues();
}
