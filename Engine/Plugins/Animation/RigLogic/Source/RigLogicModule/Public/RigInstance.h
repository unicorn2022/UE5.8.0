...
public:
	...
	UE_API TArrayView<float> GetGUIControlValues();
	...
	UE_API TArrayView<float> GetRawControlValues();
	...
	UE_API TArrayView<float> GetMLMaskValues();
	UE_API TArrayView<const float> GetMLMaskValues() const;
