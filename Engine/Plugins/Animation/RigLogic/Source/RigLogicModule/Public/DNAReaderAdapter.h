...
{
public:
	FDNAReader(TWrappedReader* Source, const FDNAConfig& InConfig);
	~FDNAReader() = default;
...
template <class TWrappedReader>
FDNAReader<TWrappedReader>::FDNAReader(TWrappedReader* Source, const FDNAConfig& InConfig) :
...
template <class TWrappedReader>
const FDNAConfig& FDNAReader<TWrappedReader>::GetConfig() const
{
	return Config;
}
...
template <class TWrappedReader>
ERotationSequence FDNAReader<TWrappedReader>::GetRotationSequence() const
{
	return static_cast<ERotationSequence>(ReaderPtr->getRotationSequence());
}

template <class TWrappedReader>
FRotationSign FDNAReader<TWrappedReader>::GetRotationSign() const
{
...
template <class TWrappedReader>
EFaceWindingOrder FDNAReader<TWrappedReader>::GetFaceWindingOrder() const
{
...
FVector FDNAReader<TWrappedReader>::GetBlendShapeTargetDelta(uint16 MeshIndex, uint16 BlendShapeTargetIndex, uint32 DeltaIndex) const
{
	...
	return FVector(Delta.x, Delta.y, Delta.z);
}
...
template <class TWrappedReader>
uint16 FDNAReader<TWrappedReader>::GetMLTypeCount() const
{
	return ReaderPtr->getMLTypeCount();
}

template <class TWrappedReader>
uint16 FDNAReader<TWrappedReader>::GetMLOperationSetCount(uint16 MLTypeIndex) const
{
	return ReaderPtr->getMLOperationSetCount(MLTypeIndex);
}

template <class TWrappedReader>
uint16 FDNAReader<TWrappedReader>::GetMLOperationCount(uint16 MLTypeIndex, uint16 MLOperationSetIndex) const
{
	return ReaderPtr->getMLOperationCount(MLTypeIndex, MLOperationSetIndex);
}

template <class TWrappedReader>
EMachineLearnedBehaviorOperationType FDNAReader<TWrappedReader>::GetMLOperationType(uint16 MLTypeIndex, uint16 MLOperationSetIndex, uint16 MLOperationIndex) const
{
...
template <class TWrappedReader>
TArrayView<const uint32> FDNAReader<TWrappedReader>::GetMLOperationParameters(uint16 MLTypeIndex, uint16 MLOperationSetIndex, uint16 MLOperationIndex) const
{
...
template <class TWrappedReader>
TArrayView<const uint16> FDNAReader<TWrappedReader>::GetMLOperationDependencyOperationSetIndices(uint16 MLTypeIndex, uint16 MLOperationSetIndex, uint16 MLOperationIndex) const
{
...
template <class TWrappedReader>
TArrayView<const uint16> FDNAReader<TWrappedReader>::GetMLOperationDependencyOperationIndices(uint16 MLTypeIndex, uint16 MLOperationSetIndex, uint16 MLOperationIndex) const
{
...
template <class TWrappedReader>
uint16 FDNAReader<TWrappedReader>::GetMLOperationIndexListCount(uint16 MLTypeIndex, uint16 MLOperationSetIndex) const
{
	return ReaderPtr->getMLOperationIndexListCount(MLTypeIndex, MLOperationSetIndex);
}

template <class TWrappedReader>
TArrayView<const uint16> FDNAReader<TWrappedReader>::GetMLOperationIndicesForLOD(uint16 MLTypeIndex, uint16 MLOperationSetIndex, uint16 LOD) const
{
...
template <class TWrappedReader>
TArrayView<const uint16> FDNAReader<TWrappedReader>::GetMLJointsInputIndices() const
{
...
template <class TWrappedReader>
TArrayView<const uint16> FDNAReader<TWrappedReader>::GetMLJointsOutputIndices() const
{
...
template <class TWrappedReader>
TArrayView<const uint16> FDNAReader<TWrappedReader>::GetMLJointsParameterKeys() const
{
...
template <class TWrappedReader>
TArrayView<const uint16> FDNAReader<TWrappedReader>::GetMLJointsParameterValues() const
{
