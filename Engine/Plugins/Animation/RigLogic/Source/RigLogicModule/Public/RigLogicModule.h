...
DECLARE_DWORD_COUNTER_STAT_EXTERN(TEXT("Multi-thread ML Compute [ 0 = False, 1 = True ]"), STAT_RigLogic_MultiThreadMLCompute, STATGROUP_RigLogic, RIGLOGICMODULE_API);
...
DECLARE_DWORD_COUNTER_STAT_EXTERN(TEXT("ML Operation Count"), STAT_RigLogic_MLOperationCount, STATGROUP_RigLogic, RIGLOGICMODULE_API);
...
DECLARE_DWORD_COUNTER_STAT_EXTERN(TEXT("Vertex Count"), STAT_RigLogic_VertexCount, STATGROUP_RigLogic, RIGLOGICMODULE_API);
...
DECLARE_CYCLE_STAT_EXTERN(TEXT("Calculate PSD Controls Time"), STAT_RigLogic_CalculatePSDControlsTime, STATGROUP_RigLogic, RIGLOGICMODULE_API);
