...
public:
	...
	/** Override to provide a custom Window menu section for this mode's tabs instead of the shared
	 *  "Live Link Hub" section. Return nullptr to use the shared section (default behaviour). */
	virtual TSharedPtr<FWorkspaceItem> GetCustomWindowMenuCategory() const { return nullptr; }
