...
protected:
	...
	virtual FName GetOverrideTabId() const override { return "LiveLinkHub"; }
...
private:
	...
	/** Shared workspace menu category for all tabs in the Window menu. */
	TSharedPtr<FWorkspaceItem> DataViewsWorkspaceCategory;

	/** Workspace category resolved at registration time for each mode, keyed by mode name. */
	TMap<FName, TSharedPtr<FWorkspaceItem>> CachedModeWorkspaceCategories;
