...
public:
	...
	/** Get the recording mount manager. */
	FLiveLinkHubRecordingMountManager* GetRecordingMountManager() const;
...
private:
	...
	/** Manages custom mount points for recording directories. */
	TUniquePtr<FLiveLinkHubRecordingMountManager> RecordingMountManager;
