...
public:
	...
	virtual void SaveFromExistingRecording(ULiveLinkRecording* InRecording, const FString& InFilePath, bool bUpgradeInPlace) override;
...
private:
	...
	void SaveRecordingInPlace(ULiveLinkUAssetRecording* InRecording);
