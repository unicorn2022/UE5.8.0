...
public:
	...
	virtual void StartupModule() override
	{
		...
		StyleSet->Set("LiveLinkHub.SpokeMode", new IMAGE_PLUGIN_BRUSH_SVG(TEXT("Starship/SpokeMode"), Icon16x16, FSlateColor(FLinearColor(1.000f, 0.168f, 0.350f))));
		StyleSet->Set("LiveLinkHub.HubMode", new IMAGE_PLUGIN_BRUSH_SVG(TEXT("Starship/HubMode"), Icon16x16, FSlateColor(FLinearColor(0.271f, 0.554f, 0.067f))));
...
private:
	...
	void RegisterPlacementModeItems()
	{
		auto RegisterPlaceActors = [&]() -> void
			{
				...
				if (!Info)
				{
					UE_LOGF(LogLiveLinkEditor, Warning, "Could not find or create VirtualProduction Place Actor Category");
					return;
				}
		...
		if (FApp::CanEverRender())
		{
			...
			{
				FCoreDelegates::GetOnPostEngineInit().AddLambda(RegisterPlaceActors);
			}
		}
	}
