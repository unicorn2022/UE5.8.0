...
void FLiveLinkModule::CreateStyle()
{
	...
	const FSlateColor ValidColor = FSlateColor(FLinearColor(0.0146f, 0.7874f, 0.0736f));
	const FSlateColor InvalidColor = FSlateColor(FLinearColor(1.0f, 0.4654f, 0.0f));
	const FSlateColor ErrorColor = FSlateColor(FLinearColor(0.8524f, 0.0372f, 0.0372f));
	const FSlateColor PausedColor = FSlateColor(FLinearColor(0.2159f, 0.2159f, 0.2159f));
