...
void FLiveLinkTransformControllerData::CheckForError(FName OwnerName, USceneComponent* SceneComponent) const
{
	...
	{
		UE_LOGF(LogLiveLinkComponents, Warning, "The component to control is invalid for '%ls'.", *OwnerName.ToString());
#if WITH_EDITOR
	...
	{
		UE_LOGF(LogLiveLinkComponents, Warning, "The component '%ls' has an invalid mobility.", *OwnerName.ToString());
#if WITH_EDITOR
