...
void FAnimNode_OffsetRootBone::Evaluate_AnyThread(FPoseContext& Output)
{
	...
	FTransform LastComponentTransform = ComponentTransform;
...
bool FAnimNode_OffsetRootBone::GetResetOnTeleport() const
{
	return GET_ANIM_NODE_DATA(bool, bResetOnTeleport);
}
