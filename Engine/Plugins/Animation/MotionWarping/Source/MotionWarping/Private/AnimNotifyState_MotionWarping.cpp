...
void UAnimNotifyState_MotionWarping::OnBecomeRelevant(UMotionWarpingComponent* MotionWarpingComp, const UAnimSequenceBase* Animation, float StartTime, float EndTime) const
{
	...
	if (RootMotionModifierNew)
	{
		...
		{
			RootMotionModifierNew->OnActivateDelegate.BindDynamic(const_cast<UAnimNotifyState_MotionWarping*>(this), &UAnimNotifyState_MotionWarping::OnRootMotionModifierActivate);
		}

		if (!RootMotionModifierNew->OnUpdateDelegate.IsBound())
		{
			RootMotionModifierNew->OnUpdateDelegate.BindDynamic(const_cast<UAnimNotifyState_MotionWarping*>(this), &UAnimNotifyState_MotionWarping::OnRootMotionModifierUpdate);
		}

		if (!RootMotionModifierNew->OnDeactivateDelegate.IsBound())
		{
			RootMotionModifierNew->OnDeactivateDelegate.BindDynamic(const_cast<UAnimNotifyState_MotionWarping*>(this), &UAnimNotifyState_MotionWarping::OnRootMotionModifierDeactivate);
		}
	}
}
