...
public:
    ...
    static Impl* create(MemoryResource* memRes) {
        ...
        SplicerPtr neutralJointSplicer = pma::UniqueInstance<NeutralJointSplicer<CT>, Splicer>::with(memRes).create(memRes);
        SplicerPtr jointBehaviorSplicer = pma::UniqueInstance<JointBehaviorSplicer<CT>, Splicer>::with(memRes).create(memRes);
        SplicerPtr blendShapeSplicer = pma::UniqueInstance<BlendShapeSplicer<CT>, Splicer>::with(memRes).create(memRes);
