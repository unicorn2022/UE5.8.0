...
using dna::Direction;
using dna::Gender;
using dna::MachineLearnedBehaviorOperationType;
using dna::MachineLearnedBehaviorParameterKey;
...
using dna::FaceWindingOrder;
using dna::RotationDirection;
using dna::RotationRepresentation;
using dna::RotationSequence;
using dna::RotationSign;
