	...
	public class GeneSplicerLibTest : ModuleRules
	{
		public GeneSplicerLibTest(ReadOnlyTargetRules Target) : base(Target)
		{
			...
			if (Target.LinkType == TargetLinkType.Monolithic)
			{
				...
				// Only tests (this module) should have access to Lib module's Private directory, so that's why Private was not made Internal.
				CppCompileWarningSettings.ModuleIncludePrivateWarningLevel = WarningLevel.Off;
