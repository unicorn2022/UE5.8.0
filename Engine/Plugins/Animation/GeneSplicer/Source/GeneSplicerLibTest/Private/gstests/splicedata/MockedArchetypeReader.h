...
public:
    MockedArchetypeReader() {
        outputIndicesPerJointGroup = {{2u, 3u, 7u, 8u, 15u, 18u, 19u, 22u, 23u, 25u}, {38u, 39u, 40u, 43u}};
        jointIndicesPerJointGroup = {{0u, 1u, 2u}, {4u}};
        jointIndicesPerVertex = {{0u, 1u, 2u, 4u}, {0u, 1u, 2u}};
        jointWeightsPerVertex = {{0.1f, 0.2f, 0.4f, 0.5f}, {0.3f, 0.1f, 0.2f}};
        jointCount = 3u;
