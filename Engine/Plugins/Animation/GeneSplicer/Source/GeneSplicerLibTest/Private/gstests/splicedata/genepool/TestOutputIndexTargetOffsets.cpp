...
TEST(OutputIndexTargetOffsets, MapJointGroup) {
    ...
    outputIndexTargetOffsets.mapJointGroup(ConstArrayView<std::uint16_t>{outputIndices},
    ...
    Vector<expected>
        expectedValues{{0u, 2u, 1u}, {0u, 3u, 2u}, {0u, 5u, 3u}, {1u, 3u, 5u}, {2u, 1u, 6u}, {16u, 4u, 8u}, {16u, 5u, 9u}};
