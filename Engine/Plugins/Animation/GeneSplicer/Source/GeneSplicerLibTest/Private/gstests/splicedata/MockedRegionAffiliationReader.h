...
public:
    MockedRegionAffiliationReader() {
        ...
        jointRegionIndices = {{}, {0u}, {0u, 1u}};
        jointRegionAffiliations = {{}, {1.0f}, {0.3f, 0.7f}};
    }
    ...
    gs4::ConstArrayView<std::uint16_t> getVertexRegionIndices(std::uint16_t meshIndex, std::uint32_t vertexIndex) const override {
