		...
		if(GameplayProvider->HasAnyData())
		{
			...
			GameplayProvider->EnumerateObjects([this, &InTimingViewSession, &InAnalysisSession, &GameplayProvider](const FObjectInfo& InObjectInfo)
			{
				if(bObjectTracksEnabled || bObjectPropertyTracksEnabled)
				{
					...
					GameplayProvider->ReadObjectEventsTimeline(InObjectInfo.GetId(), [this, &InTimingViewSession, &InAnalysisSession, &InObjectInfo, &ObjectEventsTrack](const IGameplayProvider::ObjectEventsTimeline& InTimeline)
					{
					...
					GameplayProvider->ReadObjectPropertiesTimeline(InObjectInfo.GetUObjectId(), [this, &InObjectInfo, &ObjectEventsTrack, &InTimingViewSession, &InAnalysisSession](const IGameplayProvider::ObjectPropertiesTimeline& InTimeline)
					{
