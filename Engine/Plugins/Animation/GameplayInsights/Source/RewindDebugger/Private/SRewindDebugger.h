...
public:
	...
	DECLARE_DELEGATE(FForceRefreshTracks)
	...
	SLATE_BEGIN_ARGS(SRewindDebugger) {}
		...
		SLATE_EVENT(FForceRefreshTracks, ForceRefreshTracks);
	SLATE_END_ARGS()
...
private:
	...
	bool ShouldSortObjectsByName() const;
	void SortObjectsByTime();
	bool ShouldSortObjectsByTime() const;
	...
	FForceRefreshTracks ForceRefreshTracks;
