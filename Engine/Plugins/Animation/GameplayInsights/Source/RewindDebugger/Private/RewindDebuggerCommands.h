...
public:
	...
	virtual void RegisterCommands() override
	{
		...
		UI_COMMAND(StartRecording, "Start Recording", "Start recording gameplay data", EUserInterfaceActionType::Button, FInputChord(EModifierKey::Control | EModifierKey::Shift, EKeys::R));
		UI_COMMAND(StopRecording, "Stop Recording", "Stop recording gameplay data", EUserInterfaceActionType::Button, FInputChord(EModifierKey::Control | EModifierKey::Shift, EKeys::S));
		...
		UI_COMMAND(ClearAnalysis, "Clear Analysis", "Stop current analysis and clear related debugger data", EUserInterfaceActionType::Button, FInputChord());
	...
	TSharedPtr<FUICommandInfo> ClearAnalysis;
