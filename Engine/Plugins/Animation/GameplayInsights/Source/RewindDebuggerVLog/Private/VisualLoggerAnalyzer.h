...
private:
	enum : uint16
	{
		RouteId_VisualLogEntry UE_DEPRECATED(5.8, "Used only to read old recordings; now using header + chunk to handle large events"),
		RouteId_VisualLogEntryHeader,
		RouteId_VisualLogEntryChunk,
	};
