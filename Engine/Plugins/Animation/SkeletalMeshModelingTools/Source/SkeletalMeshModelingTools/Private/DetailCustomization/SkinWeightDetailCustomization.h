...
public:
	...
	virtual ~SVertexWeightItem() override = default;
...
private:
	/** Called when the selection in this editor changed */
	void OnSelectionChanged(TSharedPtr<FWeightEditorElement> Selection, ESelectInfo::Type SelectInfo);
