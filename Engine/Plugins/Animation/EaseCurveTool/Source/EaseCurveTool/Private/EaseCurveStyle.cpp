	...
	: FSlateStyleSet(TEXT("EaseCurveTool"))
{
	...
	FButtonStyle MenuHoverHintOnly = FButtonStyle()
		...
		.SetHovered(CORE_BOX_BRUSH("Common/ButtonHoverHint", FMargin(), FStyleColors::Highlight.GetSpecifiedColor()))
		.SetPressed(CORE_BOX_BRUSH("Common/ButtonHoverHint", FMargin(), FStyleColors::Highlight.GetSpecifiedColor()))
