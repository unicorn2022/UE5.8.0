...
void FEaseCurveTool::ApplyQuickEaseToSequencerKeySelections(const EEaseCurveToolOperation InOperation)
{
	...
	{
		UE_LOGF(LogTemp, Warning, "Ease curve tool failed to apply quick ease tangents: "
...
void FEaseCurveTool::PostUndo(const bool bInSuccess)
{
	UpdateEaseCurveFromKeySelections();
}

void FEaseCurveTool::PostRedo(const bool bInSuccess)
{
	UpdateEaseCurveFromKeySelections();
}
