...
{
	UE_LOGF(LogPoseSearch, Log, "UPoseSearchFeatureChannel_Padding::IndexAsset: padding data with '%d' additional floats per pose in UPoseSearchSchema '%ls'", PaddingSize, *GetNameSafe(GetSchema()));
	return true;
}
