...
void UMotionMatchingAnimNodeLibrary::GetMotionMatchingSearchResult(const FMotionMatchingAnimNodeReference& MotionMatchingNode, FPoseSearchBlueprintResult& Result, bool& bIsResultValid)
{
	...
	else
	{
		...
		UE_LOGF(LogPoseSearch, Warning, "UMotionMatchingAnimNodeLibrary::GetMotionMatchingSearchResult called on an invalid context or with an invalid type");
	}
}
...
void UMotionMatchingAnimNodeLibrary::GetMotionMatchingBlendSettings(const FMotionMatchingAnimNodeReference& MotionMatchingNode, FMotionMatchingBlueprintBlendSettings& BlendSettings, bool& bIsResultValid)
{
	...
	else
	{
		...
		bIsResultValid = false;
		UE_LOGF(LogPoseSearch, Warning, "UMotionMatchingAnimNodeLibrary::GetMotionMatchingBlendSettings called on an invalid context or with an invalid type");
	}
}

void UMotionMatchingAnimNodeLibrary::OverrideMotionMatchingBlendSettings(const FMotionMatchingAnimNodeReference& MotionMatchingNode, const FMotionMatchingBlueprintBlendSettings& BlendSettings)
{
	if (FAnimNode_MotionMatching* MotionMatchingNodePtr = MotionMatchingNode.GetAnimNodePtr<FAnimNode_MotionMatching>())
	{
	...
	{
		UE_LOGF(LogPoseSearch, Warning, "UMotionMatchingAnimNodeLibrary::OverrideMotionMatchingBlendSettings called on an invalid context or with an invalid type");
	}
}
...
void UMotionMatchingAnimNodeLibrary::SetDatabaseToSearch(const FMotionMatchingAnimNodeReference& MotionMatchingNode, UPoseSearchDatabase* Database, EPoseSearchInterruptMode InterruptMode)
{
	...
	{
		UE_LOGF(LogPoseSearch, Warning, "UMotionMatchingAnimNodeLibrary::SetDatabaseToSearch called on an invalid context or with an invalid type");
	}
}
...
void UMotionMatchingAnimNodeLibrary::SetDatabasesToSearch(const FMotionMatchingAnimNodeReference& MotionMatchingNode, const TArray<UPoseSearchDatabase*>& Databases, EPoseSearchInterruptMode InterruptMode)
{
	...
	{
		UE_LOGF(LogPoseSearch, Warning, "UMotionMatchingAnimNodeLibrary::SetDatabasesToSearch called on an invalid context or with an invalid type");
	}
}
...
void UMotionMatchingAnimNodeLibrary::ResetDatabasesToSearch(const FMotionMatchingAnimNodeReference& MotionMatchingNode, EPoseSearchInterruptMode InterruptMode)
{
	...
	{
		UE_LOGF(LogPoseSearch, Warning, "UMotionMatchingAnimNodeLibrary::ResetDatabasesToSearch called on an invalid context or with an invalid type");
	}
}
...
void UMotionMatchingAnimNodeLibrary::SetInterruptMode(const FMotionMatchingAnimNodeReference& MotionMatchingNode, EPoseSearchInterruptMode InterruptMode)
{
	...
	{
		UE_LOGF(LogPoseSearch, Warning, "UMotionMatchingAnimNodeLibrary::SetInterruptMode called on an invalid context or with an invalid type");
	}
}

bool UMotionMatchingAnimNodeLibrary::AnyNewBlendToThisFrame(const FMotionMatchingAnimNodeReference& MotionMatchingNode)
{
	if (const FAnimNode_MotionMatching* MotionMatchingNodePtr = MotionMatchingNode.GetAnimNodePtr<FAnimNode_MotionMatching>())
	{
		return MotionMatchingNodePtr->AnyNewBlendToThisFrame();
	}
	
	UE_LOGF(LogPoseSearch, Warning, "UMotionMatchingAnimNodeLibrary::AnyNewBlendToThisFrame called on an invalid context or with an invalid type");
	return false;
}