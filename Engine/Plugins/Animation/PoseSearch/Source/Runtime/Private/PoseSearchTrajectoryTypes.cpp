...
{
#if WITH_EDITOR
	UE_LOGF(LogPoseSearch, Warning, "Converting FTransformTrajectory to FPoseSearchQueryTrajectory (deprecated type) implicitly. Consider updating code to avoid this conversion.")
#endif
