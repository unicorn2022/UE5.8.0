...
public:
	...
	UE_DEPRECATED(5.8, "Use BP_GetWorldPositionFromContext instead")
	...
	UFUNCTION(BlueprintPure, BlueprintNativeEvent, meta=(BlueprintThreadSafe, DisplayName = "Get World Position From Context"), Category = "Settings")
	UE_API FVector BP_GetWorldPositionFromContext(UPARAM(Ref) FChooserEvaluationContext& Context) const;
	...
	static UE_API void FindOrAddToSchema(UPoseSearchSchema* Schema, float SampleTimeOffset, const FName& BoneName, const UE::PoseSearch::FRole& Role, EPermutationTimeType PermutationTimeType = EPermutationTimeType::UseSampleTime, bool bDefaultWithRootBone = true);
};
