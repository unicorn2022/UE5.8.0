...
#ifndef UE_POSE_SEARCH_ENABLE_ITERATIVE_KDTREE_CONSTRUCTION_VALIDATION
#define UE_POSE_SEARCH_ENABLE_ITERATIVE_KDTREE_CONSTRUCTION_VALIDATION ENABLE_ANIM_DEBUG
#endif
...
struct FKDTree
{
	struct FDataSource
	{
		...
		bool bUseRecursiveDivideTree = false;
