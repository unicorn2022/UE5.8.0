...
static constexpr int32 DatabaseIndexDerivedDataCacheKeyVersion = 2737; // bump this value to force reindex ALL the UPoseSearchDatabases, without having to change the global FDevSystemGuids::POSESEARCHDB_DERIVEDDATA_VER
