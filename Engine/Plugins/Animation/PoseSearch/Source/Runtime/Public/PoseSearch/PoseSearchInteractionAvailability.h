...
{
// Experimental, this feature might be removed without warning, not for production use
struct FInteractionAvailability : public FPoseSearchInteractionAvailability
{
	void Init(const FPoseSearchInteractionAvailability& InAvailability, FName InPoseHistoryName, const IPoseHistory* InPoseHistory)
	{
	...
	const IPoseHistory* GetPoseHistory(const UObject* AnimContext) const;
...
// Experimental, this feature might be removed without warning, not for production use
struct FInteractionAnimContextAvailabilities
{
	TObjectPtr<const UObject> AnimContext;
	TArray<FInteractionAvailability> Availabilities;
};
