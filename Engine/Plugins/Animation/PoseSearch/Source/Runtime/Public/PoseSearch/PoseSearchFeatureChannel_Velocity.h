...
public:
	...
	UE_DEPRECATED(5.8, "Use BP_GetWorldVelocityFromContext instead")
	...
	UFUNCTION(BlueprintPure, BlueprintNativeEvent, meta=(BlueprintThreadSafe, DisplayName = "Get World Velocity From Context"), Category = "Settings")
	UE_API FVector BP_GetWorldVelocityFromContext(UPARAM(Ref) FChooserEvaluationContext& Context) const;
