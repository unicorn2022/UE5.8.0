...
extern thread_local TraceServices::FProviderLock::FThreadLocalState GPoseSearchProviderLockState;

/**
 * Provider to the widgets for pose search functionality, largely mimicking FAnimationProvider
 */
class FTraceProvider : public TraceServices::IProvider, public TraceServices::IEditableProvider
{
public:
	...
	{
		Lock.BeginRead(GPoseSearchProviderLockState);
	}
	virtual void EndRead() const override
	{
		Lock.EndRead(GPoseSearchProviderLockState);
	}
	virtual void ReadAccessCheck() const override
	{
		Lock.ReadAccessCheck(GPoseSearchProviderLockState);
	}

	//~ IEditableProvider (edit lock)
	virtual void BeginEdit() const override
	{
		Lock.BeginWrite(GPoseSearchProviderLockState);
	}
	virtual void EndEdit() const override
	{
		Lock.EndWrite(GPoseSearchProviderLockState);
	}
	virtual void EditAccessCheck() const override
	{
		Lock.WriteAccessCheck(GPoseSearchProviderLockState);
	}
