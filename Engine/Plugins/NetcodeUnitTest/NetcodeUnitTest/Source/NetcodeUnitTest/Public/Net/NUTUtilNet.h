...
private:
	virtual bool NetSerializeItem(FArchive& Ar, UPackageMap* Map, TNotNull<void*> Data, TArray<uint8>* MetaData /*=nullptr*/) const override;

public:

	FNetPropertyHook(FFieldVariant InOwner, const FName& InName)
