...
public:
	...
	UE_API void RegisterPrimitive(UPrimitiveComponent* InPrimitiveComponent, ECompositeCoreHoldoutManagement HoldoutManagement = ECompositeCoreHoldoutManagement::Automatic);

	/* Register multiple primitives for compositing. */
	UE_API void RegisterPrimitives(const TArray<UPrimitiveComponent*>& InPrimitiveComponents, ECompositeCoreHoldoutManagement HoldoutManagement = ECompositeCoreHoldoutManagement::Automatic);

	/* Unregister a single primitive from compositing. */
	UFUNCTION(BlueprintCallable, Category = "Composite Core")
	UE_API void UnregisterPrimitive(UPrimitiveComponent* InPrimitiveComponent, ECompositeCoreHoldoutManagement HoldoutManagement = ECompositeCoreHoldoutManagement::Automatic);

	/* Unregister multiple primitives from compositing. */
	UE_API void UnregisterPrimitives(const TArray<UPrimitiveComponent*>& InPrimitiveComponents, ECompositeCoreHoldoutManagement HoldoutManagement = ECompositeCoreHoldoutManagement::Automatic);
