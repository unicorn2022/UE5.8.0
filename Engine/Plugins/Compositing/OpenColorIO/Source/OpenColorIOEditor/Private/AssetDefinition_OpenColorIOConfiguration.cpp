...
TConstArrayView<FAssetCategoryPath> UAssetDefinition_OpenColorIOConfiguration::GetAssetCategories() const
{
	static const auto Categories = { FAssetCategoryPath(LOCTEXT("OpenColorIOConfiguration_AssetCategory", "Virtual Production")) };
	return Categories;
}
