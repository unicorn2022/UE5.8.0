...
public:
	...
	~FOpenColorIOShaderMapId() = default;
	...
	uint64 GetOpenColorIOHash() const;
...
#if WITH_EDITOR
	FShader* ProcessCompilationResultsForSingleJob(const TRefCountPtr<class FShaderCommonCompileJob>& SingleJob, uint64 InShaderMapHash);
#endif
