	...
	EOpenColorIOTransformAlpha TransformAlpha) 
{
	...
	float DisplayGamma = DefaultDisplayGammaRT / EngineDisplayGamma;

	if (IsDefaultBackBufferLinearSDR())
	{
		// Note: To match editor in this mode, transforms need to output linear colors.
		DisplayGamma = 1.0f;
	}
	...
	else if ((View.Family->EngineShowFlags.Tonemapper == 0) || (View.Family->EngineShowFlags.PostProcessing == 0))
	{
		DisplayGamma = DefaultDisplayGammaRT;
	}
