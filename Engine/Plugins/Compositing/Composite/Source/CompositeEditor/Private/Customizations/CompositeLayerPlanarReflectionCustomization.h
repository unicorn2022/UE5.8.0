...
/**
 * Customization for the composite planar reflection layer, primarily for displaying custom widgets for picking actors and managing passes
 */
class FCompositeLayerPlanarReflectionCustomization : public FCompositeLayerCustomization
{
public:
