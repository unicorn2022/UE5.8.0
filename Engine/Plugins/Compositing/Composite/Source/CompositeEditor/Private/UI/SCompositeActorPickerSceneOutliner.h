...
private:
	...
	/** Raised when the header checkbox toggles to select or deselect all actors at once */
	void OnAllActorsSelected(const TArray<AActor*>& InActors, bool bIsSelected);
