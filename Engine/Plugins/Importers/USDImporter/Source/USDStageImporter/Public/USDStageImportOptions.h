...
public:
	...
	UPROPERTY(BlueprintReadWrite, config, EditAnywhere, Category = "USD options", meta = (ClampMin = "0", ClampMax = "6", UIMin = "0", UIMax = "6"))
	...
	UE_DEPRECATED(all, "Use 'Share Assets for Identical Prims' instead")
	UPROPERTY()
