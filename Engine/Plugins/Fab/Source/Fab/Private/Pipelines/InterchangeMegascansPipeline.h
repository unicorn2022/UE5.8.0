...
public:
	...
	// Version of the plugin materials that were last copied into this project.
	// Used to detect breaking changes when the plugin is updated.
	UPROPERTY(config)
	FString CopiedMaterialVersion;
};
...
public:
	...
	void SetCommonMeshesProperties(TWeakObjectPtr<UInterchangeGenericCommonMeshesProperties> InCommonMeshesProperties) { CommonMeshesProperties = InCommonMeshesProperties; }
