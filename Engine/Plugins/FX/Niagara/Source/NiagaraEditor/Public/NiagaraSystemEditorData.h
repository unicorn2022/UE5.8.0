...
public:
	...
	NIAGARAEDITOR_API const UNiagaraScriptVariable* FindUserScriptVariable(FNiagaraVariable UserParameter, const UNiagaraSystem& System) const;
	...
	bool GetViewportManualFocusDistanceEnabled() const { return bViewportManualFocusDistanceEnabled; }
	void SetViewportManualFocusDistanceEnabled(bool bEnabled) { bViewportManualFocusDistanceEnabled = bEnabled; }

	float GetViewportManualFocusDistance() const { return ViewportManualFocusDistance; }
	void SetViewportManualFocusDistance(float Distance) { ViewportManualFocusDistance = FMath::Max(Distance, 1.0f); }
...
private:
	...
	UPROPERTY()
	bool bViewportManualFocusDistanceEnabled = false;

	UPROPERTY()
	float ViewportManualFocusDistance = 100.0f;
};
