...
private:
	...
	void DumpShaderScript(const UNiagaraScript* GPUComputeScript, const FString& PathName, const FString& HashName, const FString& FilePath);
	...
	TArray<FShaderMetaData> ShaderMetaData;
};