...
class UEdGraphSchema_Niagara : public UEdGraphSchema
{
	...
	*/
	...
	/**
	  * Tries to get a default value string for a graph pin from a Niagara variant.
	  * @param Variable The variable.
	  * @param Value The variant containing the data for the variable.
	  * @param OutPinDefaultValue The pin default value string if this call was successful, otherwise empty.
	  * @returns Whether or not we could get a default value form the supplied variable.
	  */
	NIAGARAEDITOR_API bool TryGetPinDefaultValueFromNiagaraVariant(const FNiagaraVariableBase& Variable, const FNiagaraVariant& Value, FString& OutPinDefaultValue) const;
