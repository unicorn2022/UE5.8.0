...
public:
	...
	TArray<UNiagaraClipboardFunctionInput*> CopyOldInputs() const;
	TArray<UNiagaraClipboardFunctionInput*> CopyNewInputs() const;
	
private:
	UNiagaraPythonScriptModuleInput* GetNewInput(const FName& InputName) const;
	TArray<UNiagaraClipboardFunctionInput*> CopyInputs(const TArray<TObjectPtr<UNiagaraPythonScriptModuleInput>>& Source) const;
