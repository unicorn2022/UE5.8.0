...
public:
	...
	DECLARE_DELEGATE_ThreeParams(FOnGetExternalTabsForAsset, TSharedRef<FAssetEditorToolkit> /*InHostToolkit*/, UObject& /*InAsset*/, TArray<TSharedRef<FWorkflowTabFactory>>& /*OutExternalTabSpawners*/);
	DECLARE_DELEGATE_TwoParams(FOnExternalExtendLayoutForAsset, TSharedRef<FLayoutExtender> /*InLayoutExtender*/, UObject& /*InAsset*/);
	...
	NIAGARAEDITOR_API void SetOnGetExternalAssetTabSpawners(FOnGetExternalTabsForAsset InOnGetExternalTabsForAsset, FOnExternalExtendLayoutForAsset InOnExternalExtendLayoutForAsset);
	...
	NIAGARAEDITOR_API void GetExternalTabSpawnersForAsset(TSharedRef<FAssetEditorToolkit> InHostToolkit, UObject& InAsset, TArray<TSharedRef<FWorkflowTabFactory>>& OutExternalTabSpawners) const;

	NIAGARAEDITOR_API void ExternalExtendLayoutForAsset(TSharedRef<FLayoutExtender> InLayoutExtender, UObject& InAsset) const;
...
private:
	...
	FOnGetExternalTabsForAsset OnGetExternalTabsForAsset;
	FOnExternalExtendLayoutForAsset OnExternalExtendLayoutForAsset;
