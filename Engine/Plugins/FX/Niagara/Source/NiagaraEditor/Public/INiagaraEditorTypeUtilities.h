...
public:
	virtual ~INiagaraEditorTypeUtilities() = default;
...
{
public:
	virtual ~INiagaraEditorExternalObjectUtilities() = default;
	virtual bool SupportsClipboardPortableValues() const = 0;
	virtual bool TryUpdateClipboardPortableValueFromObject(const UObject& InExternalObject, FNiagaraClipboardPortableValue& InTargetClipboardPortableValue) const = 0;
};

class FNiagaraEditorExternalObjectUtilities : public INiagaraEditorExternalObjectUtilities
{
public:
	virtual bool SupportsClipboardPortableValues() const override { return false; }
	virtual bool TryUpdateClipboardPortableValueFromObject(const UObject& InExternalObject, FNiagaraClipboardPortableValue& InTargetClipboardPortableValue) const override { return false; }
};