...
public:
	...
	virtual ~UNiagaraHierarchyModuleInput() override = default;
...
public:
	...
	virtual ~UNiagaraHierarchyAssignmentInput() override = default;
...
public:
	...
	virtual ~UNiagaraSummaryViewViewModel() override = default;
	...
	NIAGARAEDITOR_API virtual TSharedRef<FHierarchyDragDropOp> CreateDragDropOp(const FDataHierarchyDragDropContext& DragContext) override;
	
	virtual bool SupportsDetailsPanel() override { return true; }
	virtual bool SupportsMultiEditInDetailsPanel() override { return false; }
...
public:
	...
	explicit FNiagaraHierarchyInputParameterHierarchyDragDropOp(const FDataHierarchyDragDropContext& InDragContext) : FHierarchyDragDropOp(InDragContext) {}
