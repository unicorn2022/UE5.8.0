...
public:
	...
	const TArray<FNiagaraStackModuleData>& GetStackModuleDataByModuleEntry(const UNiagaraStackEntry* ModuleEntry);
	...
	void AddParameter(const FNiagaraVariableBase& InUserParameter);
	...
	bool SetParameterDefaultValue(const FNiagaraVariableBase& InUserParameter, const FNiagaraVariant& InDefaultValue);
