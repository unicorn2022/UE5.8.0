...
public:
	...
	virtual ~UNiagaraHierarchyUserParameter() override = default;
...
public:
	...
	virtual ~UNiagaraUserParametersHierarchyViewModel() override = default;
	...
	virtual TSharedRef<FHierarchyDragDropOp> CreateDragDropOp(const FDataHierarchyDragDropContext& DragContext) override;
...
public:
	...
	explicit FNiagaraUserParameterHierarchyDragDropOp(const FDataHierarchyDragDropContext& InDragContext) : FHierarchyDragDropOp(InDragContext) {}
