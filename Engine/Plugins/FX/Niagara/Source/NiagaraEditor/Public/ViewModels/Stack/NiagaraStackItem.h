...
public:
	virtual ~INiagaraStackItemHeaderValueHandler() = default;
...
struct FNiagaraStackItemCustomIcon
{
	const FSlateBrush*		IconBrush = nullptr;
	TAttribute<FText>		ToolTipText;
	TAttribute<EVisibility>	VisibleFunction;
};
...
public:
	...
	virtual TArray<FNiagaraStackItemCustomIcon> GetCustomIcons() const { return {}; }
