...
public:
	...
	UE_API virtual TSharedRef<FHierarchyDragDropOp> CreateDragDropOp(const FDataHierarchyDragDropContext& DragContext) override;
...
public:
	...
	explicit FNiagaraHierarchyScriptParameterDragDropOp(const FDataHierarchyDragDropContext& InDragContext) : FHierarchyDragDropOp(InDragContext) {}
