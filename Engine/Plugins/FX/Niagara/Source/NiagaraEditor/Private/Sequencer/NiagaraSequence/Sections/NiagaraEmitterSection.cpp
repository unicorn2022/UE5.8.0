...
{
	if (UMovieSceneNiagaraEmitterSection* SectionObj = EmitterSection.Get())
	{
		TSharedPtr<FNiagaraEmitterHandleViewModel> EmitterHandleviewModel = SectionObj->GetEmitterHandleViewModel();
