	...
	bool bFilterForCompilation)
{
	...
	if (GNiagaraGraphDataCacheValidation)
	{
		...
		if (!ensureMsgf(ValidationVariables == OutInputVariables, TEXT("FNiagaraGraphDataCache failed to accurately collect StackFunctionInputPins for Function %s"), *FunctionCallNode.GetPathName()))
		{
