...
public:
	...
	/* Custom logic class to convert between version. Will also be used as fallback when no python script is assigned or the python runtime is unavailable. Needs to be a subclass of UNiagaraVersionUpgradeBase.*/
	UPROPERTY(EditAnywhere, Category="Scripting")
