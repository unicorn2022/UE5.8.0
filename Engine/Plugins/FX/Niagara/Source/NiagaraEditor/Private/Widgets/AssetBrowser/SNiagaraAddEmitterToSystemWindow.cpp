...
bool SNiagaraAddEmitterToSystemWindow::CheckValidArguments(const FArguments& InArgs) const
{
...
void SNiagaraAddEmitterToSystemWindow::Construct(const FArguments& InArgs, const UTaggedAssetBrowserConfiguration& Configuration, TSharedRef<FNiagaraSystemViewModel> SystemViewModel)
{
	...
	AssetBrowserArgs._OnAssetsActivated = FOnAssetsActivated::CreateSP(this, &SNiagaraAddEmitterToSystemWindow::OnAssetsActivated);
...
void SNiagaraAddEmitterToSystemWindow::OnAssetsActivated(const TArray<FAssetData>& AssetData, EAssetTypeActivationMethod::Type)
{
