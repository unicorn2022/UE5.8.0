...
#undef NIAGARA_GRAPH_DIGEST_NODE_TYPE
	...
	virtual void UpdateFunctionAliasForContext(FNiagaraGraphFunctionAliasContext& InOutFunctionAliasContext) const {};
...
{
public:
	virtual ~FNiagaraCompilationGraph() = default;
...
public:
	...
	virtual void BuildParameterMapHistory(FParameterMapHistoryBuilder& Builder, bool bRecursive, bool bFilterForCompilation) const override;
	virtual void Compile(FTranslator* Translator, TArray<int32>& Outputs) const;
	virtual void UpdateFunctionAliasForContext(FNiagaraGraphFunctionAliasContext& InOutFunctionAliasContext) const override;
