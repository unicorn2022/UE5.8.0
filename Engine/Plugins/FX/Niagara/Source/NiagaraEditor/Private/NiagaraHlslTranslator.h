...
protected:
	...
	struct FNiagaraFunctionBody
	{
		...
		TArray<FName> StageWriteTargets;
		TArray<FName> StageReadTargets;
	};
	...
	FString GetFunctionIncludeStatement(const FNiagaraCustomHlslInclude& Include);
...
public:
	...
	static NIAGARAEDITOR_API void AppendSanitizedFunctionNameSuffix(FStringView Name, FStringBuilderBase& StringBuilder);
...
public:
	...
	void RegisterFunctionCall(ENiagaraScriptUsage ScriptUsage, const FString& InName, FName InFullName, const FGuid& CallNodeId, const FString& InFunctionNameSuffix, const FGraph* SourceGraph, const FNiagaraFunctionSignature& InSignature, bool bIsCustomHlsl, const FString& InCustomHlsl, const TArray<FNiagaraCustomHlslInclude>& InCustomHlslIncludeFilePaths, TArray<int32>& Inputs, TConstArrayView<const FInputPin*> CallInputs, TConstArrayView<const FOutputPin*> CallOutputs,
...
protected:
	...
	int32 HandleReadUnknownMissingDefault(const FNiagaraVariable& DefaultVar, const FInputPin* DefaultPin);
	...
	void GenerateFunctionSignature(ENiagaraScriptUsage ScriptUsage, FStringView InName, FName InFullName, FStringView InFunctionNameSuffix, const FGraph* FuncGraph, TConstArrayView<const FInputPin*> CallInputs, TArray<int32>& Inputs,
		FString& FunctionComment, FNiagaraFunctionSignature& OutSig) const;
	void ResolveGraphFunctionAlias(const FNiagaraGraphFunctionAliasContext& FunctionAliasContext, FStringBuilderBase& FunctionAliasSuffix) const;
