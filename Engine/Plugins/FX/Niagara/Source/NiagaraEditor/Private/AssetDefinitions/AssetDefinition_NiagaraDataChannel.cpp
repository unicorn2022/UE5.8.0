...
{
	static FAssetCategoryPath AssetPaths[] = { FAssetCategoryPath(EAssetCategoryPaths::FX, LOCTEXT("NiagaraDataChannel_SubCategory", "Advanced"), ECategoryMenuType::Section) };
	return AssetPaths;
}
