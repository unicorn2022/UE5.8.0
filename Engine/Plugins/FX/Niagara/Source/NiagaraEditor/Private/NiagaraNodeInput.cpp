...
void UNiagaraNodeInput::UpdateFunctionAliasForContext(FNiagaraGraphFunctionAliasContext& InOutFunctionAliasContext) const
{
...
void UNiagaraNodeInput::AllocateDefaultPins()
{
	...
	//If we're a parameter node for a function or a module the we allow a "default" input pin.
