...
{
	using Super = FNiagaraStackObjectPropertyCustomization;
...
public:
	...
	UE_API virtual void GenerateContextMenuActions(UNiagaraStackPropertyRow* PropertyRow, FMenuBuilder& MenuBuilder) const override;
...
private:
	...
	UE_API TOptional<float> TryGetDefaultValueForDynamicMaterialParameter(TSharedPtr<FNiagaraEmitterHandleViewModel> EmitterHandleViewModel, int32 ParameterIndex, int32 ParameterChannel) const;
