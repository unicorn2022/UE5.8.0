...
protected:
	...
	TSharedPtr<struct FNiagaraMaterialParameterValueHelper>	ValueHelper;
};
...
public:
	...
	virtual void GetMaterialParameterInfos(UMaterialInterface* Material, TArray<FMaterialParameterInfo>& OutMaterialParameterInfos) const override;
	virtual bool CustomizeChildProperty(IDetailChildrenBuilder& ChildBuilder, TSharedPtr<IPropertyHandle> PropertyHandle) override;
};
