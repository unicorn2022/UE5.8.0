...
public:
	SLATE_BEGIN_ARGS(SNiagaraStackFunctionInputValue)
		...
		SLATE_NAMED_SLOT(FArguments, ValueDecorator)
	SLATE_END_ARGS();
...
private:
	...
	void ConstructLinkedSharedValueWidgets(TSharedRef<SHorizontalBox>& ValueBox);
	...
	EVisibility GetVisibilityForHoverOnlyWidgets() const;
