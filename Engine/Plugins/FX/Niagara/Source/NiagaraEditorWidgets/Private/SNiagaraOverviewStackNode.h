...
protected:
	...
	TSharedRef<SButton> CreateBoundsButton();
...
private:
	...
	FText GetToggleBoundsToolTip() const;
	FReply OnToggleBoundsButtonClicked();
	EVisibility GetToggleBoundsVisibility() const;
	const FSlateBrush* GetToggleBoundsImage() const;
	FSlateColor GetToggleBoundsImageColor() const;
