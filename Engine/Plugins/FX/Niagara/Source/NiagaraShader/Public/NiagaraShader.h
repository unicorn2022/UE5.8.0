...
/** Base class for all generated Niagara compute shaders. */
...
public:
	...
	BEGIN_SHADER_PARAMETER_STRUCT(FSystemParameters, )
		...
		SHADER_PARAMETER(int32,		PREV_Engine_System_CurrentTimeStep)
		SHADER_PARAMETER(int32,		PREV_Engine_System_NumTimeSteps)
		SHADER_PARAMETER(float,		PREV_Engine_System_TimeStepFraction)
