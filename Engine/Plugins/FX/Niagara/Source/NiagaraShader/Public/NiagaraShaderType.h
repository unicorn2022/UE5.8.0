...
public:
	...
	FNiagaraShaderType(
		...
		: FShaderType(EShaderTypeForDynamicCast::Niagara, InTypeLayout, InName, InSourceFilename, InFunctionName, SF_Compute, InTotalPermutationCount, InTotalSpecializationCount,
	 ...
	 * @param NiagaraShaderMapHash - The hash computed for the owning shadermap
	 * @param CurrentJob - Compile job that was enqueued by BeginCompileShader.
	 */
	FShader* FinishCompileShader(
		uint64 NiagaraShaderMapHash,
