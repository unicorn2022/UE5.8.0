...
namespace NiagaraStateless
{
	...
	BEGIN_SHADER_PARAMETER_STRUCT(FCameraOffsetModule_ShaderParameters, NIAGARASHADER_API)
		...
		SHADER_PARAMETER(float,										CameraOffset_Scale)
	END_SHADER_PARAMETER_STRUCT()
	...
	BEGIN_SHADER_PARAMETER_STRUCT(FShapeLocationModule_ShaderParameters, NIAGARASHADER_API)
		...
		SHADER_PARAMETER(FNiagaraStatelessBuiltDistributionType, ShapeLocation_TransformOffset)
		SHADER_PARAMETER(FVector3f,		ShapeLocation_TransformOffsetScale)
	END_SHADER_PARAMETER_STRUCT()

	BEGIN_SHADER_PARAMETER_STRUCT(FSolveVelocitiesAndForcesModule_ShaderParameters, NIAGARASHADER_API)
		SHADER_PARAMETER(FVector3f,		SolveVelocitiesAndForces_OwnerAccelerationScale)
		//SHADER_PARAMETER(float,			SolveVelocitiesAndForces_OwnerDragScale)
		SHADER_PARAMETER(FVector3f,		SolveVelocitiesAndForces_OwnerVelocityScale)
		...
		SHADER_PARAMETER(FVector3f,				SolveVelocitiesAndForces_NoiseFieldOffsetScale)
		SHADER_PARAMETER(FVector3f,				SolveVelocitiesAndForces_NoiseFieldOffsetBias)
