...
{
	DECLARE_EXPORTED_TYPE_LAYOUT(FNiagaraVertexFactoryShaderParametersBase, NIAGARAVERTEXFACTORIES_API, NonVirtual);

public:
	NIAGARAVERTEXFACTORIES_API void Bind(const FShaderParameterMap& ParameterMap);
	NIAGARAVERTEXFACTORIES_API void GetElementShaderBindings(
