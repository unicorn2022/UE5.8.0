...
UObject* FNiagaraActorSceneComponentUtils::GetOwner() const
{
	return WeakOwnerComponent.Get();
}

UClass* FNiagaraActorSceneComponentUtils::FindPropertyInterface(UObject* SourceObject, FName InterfaceFullPath) const
{
	return nullptr;
}
...
FNiagaraSceneComponentSocketUtils* FNiagaraActorSceneComponentUtils::CreateSocketUtils() const
{
	return new FNiagaraActorSceneComponentSocketUtils(WeakOwnerComponent);
}
