		...
		FConsoleCommandDelegate::CreateLambda(
			[]()
			{
				auto DumpPriority =
					...
					{
						UE_LOGF(LogNiagara, Log, "%ls = %d = Thread Priority(%d) Task Priority(%d)", TaskName, NiagaraPriority, ENamedThreads::GetThreadPriorityIndex(TaskThread), ENamedThreads::GetTaskPriority(TaskThread));
					};

				UE_LOGF(LogNiagara, Log, "=== Niagara Task Priorities");
