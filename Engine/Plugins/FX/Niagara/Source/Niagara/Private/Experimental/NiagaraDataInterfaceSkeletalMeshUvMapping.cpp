...
FSkeletalMeshUvMapping::FSkeletalMeshUvMapping(TWeakObjectPtr<USkinnedAsset> InMeshObject, int32 InLodIndex, int32 InUvSetIndex)
	: FMeshUvMapping(InLodIndex, InUvSetIndex)
	, MeshObject(InMeshObject)
{
}

bool FSkeletalMeshUvMapping::IsValidMeshObject(const TWeakObjectPtr<USkinnedAsset>& MeshObject, int32 InLodIndex, int32 InUvSetIndex)
{
...
bool FSkeletalMeshUvMapping::Matches(const TWeakObjectPtr<USkinnedAsset>& InMeshObject, int32 InLodIndex, int32 InUvSetIndex) const
{
...
const FSkeletalMeshLODRenderData* FSkeletalMeshUvMapping::GetLodRenderData(const USkinnedAsset& Mesh, int32 LodIndex, int32 UvSetIndex)
{
