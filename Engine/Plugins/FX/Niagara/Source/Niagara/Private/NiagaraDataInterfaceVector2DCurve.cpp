...
bool UNiagaraDataInterfaceVector2DCurve::CopyToInternal(UNiagaraDataInterface* Destination) const
{
	...
	{
		UE_LOGF(LogNiagara, Log, "Post CopyToInternal LUT generation is out of sync. Please investigate. %ls", *GetPathName());
	}
#endif
	return true;
}
