...
void UNiagaraDataInterfaceEmitterProperties::GetVMExternalFunction(const FVMExternalFunctionBindingInfo& BindingInfo, void* PerInstanceData, FVMExternalFunction& OutFunc)
{
	...
	{
		OutFunc.BindUObject(this, &UNiagaraDataInterfaceEmitterProperties::VMGetLocalSpace);
	}
	else if (BindingInfo.Name == GetBoundsName)
	{
		OutFunc.BindUObject(this, &UNiagaraDataInterfaceEmitterProperties::VMGetBounds);
	}
	else if (BindingInfo.Name == GetFixedBoundsName)
	{
		OutFunc.BindUObject(this, &UNiagaraDataInterfaceEmitterProperties::VMGetFixedBounds);
	}
	else if (BindingInfo.Name == SetFixedBoundsName)
	{
		OutFunc.BindUObject(this, &UNiagaraDataInterfaceEmitterProperties::VMSetFixedBounds);
	}
}
