...
UNiagaraComponent* UNiagaraFunctionLibrary::SpawnSystemAttachedWithParams(const FFXSystemSpawnParameters& SpawnParams)
{
	...
	if (NiagaraSystem)
	{
		...
		{
			UE_LOGF(LogScript, Warning, "UGameplayStatics::SpawnNiagaraEmitterAttached: NULL AttachComponent specified!");
		}
		else
		{
...
void UNiagaraFunctionLibrary::OverrideSystemUserVariableStaticMeshComponent(UNiagaraComponent* NiagaraSystem, const FString& OverrideName, UStaticMeshComponent* StaticMeshComponent)
{
	if (!NiagaraSystem)
	{
		...
		{
			UE_LOGF(LogNiagara, Warning, "NiagaraSystem in \"Set Niagara Static Mesh Component\" is NULL, OverrideName \"%ls\" and StaticMeshComponent \"%ls\", skipping.", *OverrideName, *GetFullNameSafe(StaticMeshComponent));
		}
		return;
	}
	...
	{
		UE_LOGF(LogNiagara, Warning, "StaticMeshComponent in \"Set Niagara Static Mesh Component\" is NULL, OverrideName \"%ls\" and NiagaraSystem \"%ls\", skipping.", *OverrideName, *GetFullNameSafe(NiagaraSystem));
		return;
	}
	...
	if (Index == INDEX_NONE)
	{
		UE_LOGF(LogNiagara, Warning, "Could not find index of variable \"%ls\" in the OverrideParameters map of NiagaraSystem \"%ls\".", *OverrideName, *GetFullNameSafe(NiagaraSystem));
		return;
	}
	...
	{
		UE_LOGF(LogNiagara, Warning, "Did not find a matching Static Mesh Data Interface variable named \"%ls\" in the User variables of NiagaraSystem \"%ls\" .", *OverrideName, *GetFullNameSafe(NiagaraSystem));
		return;
	}
...
void UNiagaraFunctionLibrary::OverrideSystemUserVariableStaticMesh(UNiagaraComponent* NiagaraSystem, const FString& OverrideName, UStaticMesh* StaticMesh)
{
	if (!NiagaraSystem)
	{
		if (FNiagaraUtilities::LogVerboseWarnings())
		{
			UE_LOGF(LogNiagara, Warning, "NiagaraSystem in \"Set Niagara Static Mesh Component\" is NULL, OverrideName \"%ls\" and StaticMesh \"%ls\", skipping.", *OverrideName, *GetFullNameSafe(StaticMesh));
		}
		return;
	}
	...
	if (!StaticMesh)
	{
		UE_LOGF(LogNiagara, Warning, "StaticMesh in \"Set Niagara Static Mesh Component\" is NULL, OverrideName \"%ls\" and NiagaraSystem \"%ls\", skipping.", *OverrideName, *GetFullNameSafe(NiagaraSystem));
		return;
	}
...
void UNiagaraFunctionLibrary::OverrideSystemUserVariableSkeletalMeshComponent(UNiagaraComponent* NiagaraSystem, const FString& OverrideName, USkeletalMeshComponent* SkeletalMeshComponent)
{
	if (!NiagaraSystem)
	{
		if (FNiagaraUtilities::LogVerboseWarnings())
		{
			UE_LOGF(LogNiagara, Warning, "NiagaraSystem in \"Set Niagara Skeletal Mesh Component\" is NULL, OverrideName \"%ls\" and SkeletalMeshComponent \"%ls\" SkeletalMesh \"%ls\", skipping.", *OverrideName, *GetFullNameSafe(SkeletalMeshComponent), *GetFullNameSafe(SkeletalMeshComponent ? SkeletalMeshComponent->GetSkeletalMeshAsset() : nullptr));
		}
		return;
	}
	...
	{
		UE_LOGF(LogNiagara, Warning, "SkeletalMeshComponent in \"Set Niagara Skeletal Mesh Component\" is NULL, OverrideName \"%ls\" and NiagaraSystem \"%ls\", skipping.", *OverrideName, *GetFullNameSafe(NiagaraSystem));
		return;
	}
	...
	{
		UE_LOGF(LogNiagara, Warning, "UNiagaraFunctionLibrary::OverrideSystemUserVariableSkeletalMeshComponent: Did not find a matching Skeletal Mesh Data Interface variable named \"%ls\" in the User variables of NiagaraSystem \"%ls\" .", *OverrideName, *GetFullNameSafe(NiagaraSystem));
		return;
	}
...
void UNiagaraFunctionLibrary::SetSkeletalMeshDataInterfaceSamplingRegions(UNiagaraComponent* NiagaraSystem, const FString& OverrideName, const TArray<FName>& SamplingRegions)
{
	if (!NiagaraSystem)
	{
		if (FNiagaraUtilities::LogVerboseWarnings())
		{
			UE_LOGF(LogNiagara, Warning, "NiagaraSystem in \"Set Skeletal Mesh Data Interface Sampling Regions\" is NULL, OverrideName \"%ls\", skipping.", *OverrideName);
		}
		return;
	}
	...
	if (!SkeletalMeshInterface)
	{
		UE_LOGF(LogNiagara, Warning, "UNiagaraFunctionLibrary::SetSkeletalMeshDataInterfaceSamplingRegions: Did not find a matching Skeletal Mesh Data Interface variable named \"%ls\" in the User variables of NiagaraSystem \"%ls\" .", *OverrideName, *GetFullNameSafe(NiagaraSystem));
		return;
	}
...
void UNiagaraFunctionLibrary::SetSkeletalMeshDataInterfaceFilteredBones(UNiagaraComponent* NiagaraSystem, const FString& OverrideName, const TArray<FName>& FilteredBones)
{
	if (!NiagaraSystem)
	{
		if (FNiagaraUtilities::LogVerboseWarnings())
		{
			UE_LOGF(LogNiagara, Warning, "NiagaraSystem in \"Set Skeletal Mesh Data Interface Filtered Bones\" is NULL, OverrideName \"%ls\", skipping.", *OverrideName);
		}
		return;
	}
	...
	if (!SkeletalMeshInterface)
	{
		UE_LOGF(LogNiagara, Warning, "UNiagaraFunctionLibrary::SetSkeletalMeshDataInterfaceFilteredBones: Did not find a matching Skeletal Mesh Data Interface variable named \"%ls\" in the User variables of NiagaraSystem \"%ls\" .", *OverrideName, *GetFullNameSafe(NiagaraSystem));
		return;
	}
...
void UNiagaraFunctionLibrary::SetSkeletalMeshDataInterfaceFilteredSockets(UNiagaraComponent* NiagaraSystem, const FString& OverrideName, const TArray<FName>& FilteredSockets)
{
	if (!NiagaraSystem)
	{
		if (FNiagaraUtilities::LogVerboseWarnings())
		{
			UE_LOGF(LogNiagara, Warning, "NiagaraSystem in \"Set Skeletal Mesh Data Interface Filtered Sockets\" is NULL, OverrideName \"%ls\", skipping.", *OverrideName);
		}
		return;
	}
	...
	if (!SkeletalMeshInterface)
	{
		UE_LOGF(LogNiagara, Warning, "UNiagaraFunctionLibrary::SetSkeletalMeshDataInterfaceFilteredSockets: Did not find a matching Skeletal Mesh Data Interface variable named \"%ls\" in the User variables of NiagaraSystem \"%ls\" .", *OverrideName, *GetFullNameSafe(NiagaraSystem));
		return;
	}
...
NIAGARA_API void UNiagaraFunctionLibrary::SetSceneCapture2DDataInterfaceManagedMode(UNiagaraComponent* NiagaraSystem, const FName& DIName, 
	...
	bool bManagedCaptureOnMovement, const TArray<AActor*>& ShowOnlyActors, float ManagedLODDistanceFactor)
{
	if (!NiagaraSystem)
	{
		if (FNiagaraUtilities::LogVerboseWarnings())
		{
			UE_LOGF(LogNiagara, Warning, "NiagaraSystem in \"SetSceneCapture2DDataInterfaceManagedMode\" is NULL, skipping.");
		}
		return;
	}
	...
	if (!CaptureDI)
	{
		if (FNiagaraUtilities::LogVerboseWarnings())
		{
			UE_LOGF(LogNiagara, Warning, "Scene Capture 2D DI \"%ls\" is Null in \"SetSceneCapture2DDataInterfaceManagedMode\" is NULL, skipping.", *DIName.ToString());
		}
		return;
	}
	...
	CaptureDI->ManagedLODDistanceFactor = ManagedLODDistanceFactor;
...
void UNiagaraFunctionLibrary::SetTextureObject(UNiagaraComponent* NiagaraSystem, const FString& OverrideName, UTexture* Texture)
{
	if (!NiagaraSystem)
	{
		if (FNiagaraUtilities::LogVerboseWarnings())
		{
			UE_LOGF(LogNiagara, Warning, "NiagaraSystem in \"SetTextureObject\" is NULL, OverrideName \"%ls\" and Texture \"%ls\", skipping.", *OverrideName, *GetFullNameSafe(Texture));
		}
		return;
	}
	...
	if (!Texture)
	{
		UE_LOGF(LogNiagara, Warning, "Texture in \"SetTextureObject\" is NULL, OverrideName \"%ls\" and NiagaraSystem \"%ls\", skipping.", *OverrideName, *GetFullNameSafe(NiagaraSystem));
		return;
	}
	...
	if (Texture->IsA<UTexture2D>() || Texture->IsA<UTextureRenderTarget2D>())
	{
		...
		if (!TextureDI)
		{
			UE_LOGF(LogNiagara, Warning, "Did not find a matching Texture Data Interface variable named \"%ls\" in the User variables of NiagaraSystem \"%ls\" .", *OverrideName, *GetFullNameSafe(NiagaraSystem));
			return;
		}
	...
	{
		UE_LOGF(LogNiagara, Warning, "Texture in \"SetTextureObject\" is of an unsupported type \"%ls\", OverrideName \"%ls\" and NiagaraSystem \"%ls\", skipping.", *OverrideName, *GetNameSafe(Texture->GetClass()), *GetFullNameSafe(NiagaraSystem));
		return;
	}
}
...
TArray<FNiagaraUserParameterInfo> UNiagaraFunctionLibrary::GetAllUserParameters(UNiagaraSystem* NiagaraSystem)
{
	TArray<FNiagaraUserParameterInfo> Result;
	if (NiagaraSystem)
	{
		TArray<FNiagaraVariable> Parameters;
		NiagaraSystem->GetExposedParameters().GetUserParameters(Parameters);
		for (const FNiagaraVariable& UserVar : Parameters)
		{
			FNiagaraUserParameterInfo& ParameterInfo = Result.AddDefaulted_GetRef();
			ParameterInfo.ParameterName = UserVar.GetName();
			ParameterInfo.ParameterType = UserVar.GetType().GetStruct();
			ParameterInfo.TypeName = UserVar.GetType().GetFName();
			ParameterInfo.ParameterSizeBytes = UserVar.GetType().GetSize();
			ParameterInfo.bIsEnumType = UserVar.GetType().IsEnum();
		}
	}
	return Result;
}

TArray<FNiagaraMinimalEmitterInfo> UNiagaraFunctionLibrary::GetAllEmitters(UNiagaraSystem* NiagaraSystem)
{
	TArray<FNiagaraMinimalEmitterInfo> Result;
	if (NiagaraSystem)
	{
		for (const FNiagaraEmitterHandle& EmitterHandle : NiagaraSystem->GetEmitterHandles())
		{
			
			FNiagaraMinimalEmitterInfo& EmitterInfo = Result.AddDefaulted_GetRef();
			EmitterInfo.EmitterName = EmitterHandle.GetName();
			EmitterInfo.bIsEnabled = EmitterHandle.GetIsEnabled();
			EmitterInfo.bIsLightweight = EmitterHandle.GetEmitterMode() == ENiagaraEmitterMode::Stateless;
			
			EmitterHandle.ForEachEnabledRendererWithIndex([&EmitterInfo](const UNiagaraRendererProperties* Properties, int32)
				{
					TArray<UMaterialInterface*> Materials;
					Properties->GetUsedMaterials(nullptr, Materials);
					EmitterInfo.UsedRendererMaterials.Append(Materials);

					TArray<UObject*> Meshes;
					Properties->GetUsedMeshes(nullptr, Meshes);
					EmitterInfo.UsedRendererMeshes.Append(Meshes);
				});
		}
	}
	return Result;
...
UNiagaraDataInterface* UNiagaraFunctionLibrary::GetDataInterface(UClass* DIClass, UNiagaraComponent* NiagaraSystem, FName OverrideName)
{
	if (NiagaraSystem == nullptr)
	{
		if (FNiagaraUtilities::LogVerboseWarnings())
		{
			UE_LOGF(LogNiagara, Warning, "NiagaraSystem was nullptr for OverrideName \"%ls\".", *OverrideName.ToString());
		}
		return nullptr;
	}
	...
	if (Index == nullptr)
	{
		UE_LOGF(LogNiagara, Warning, "OverrideParameter(%ls) System(%ls) DataInterface(%ls) was not found", *OverrideName.ToString(), *GetNameSafe(NiagaraSystem->GetAsset()), *GetNameSafe(DIClass));
		return nullptr;
	}
	...
	{
		UE_LOGF(LogNiagara, Warning, "OverrideParameter(%ls) System(%ls) DataInterface is nullptr.", *OverrideName.ToString(), *GetNameSafe(NiagaraSystem->GetAsset()));
		return nullptr;
	}
	...
	UE_LOGF(LogNiagara, Warning, "OverrideParameter(%ls) System(%ls) DataInterface is a (%ls) and not expected type (%ls)", *OverrideName.ToString(), *GetNameSafe(NiagaraSystem->GetAsset()), *GetNameSafe(UntypedDI->GetClass()), *GetNameSafe(DIClass));
	return nullptr;
}
...
UNiagaraParameterCollectionInstance* UNiagaraFunctionLibrary::CreateNiagaraParameterCollectionInstance(UObject* WorldContextObject, UNiagaraParameterCollection* ParentCollection)
{
	UWorld* World = GEngine->GetWorldFromContextObject(WorldContextObject, EGetWorldErrorMode::LogAndReturnNull);
	if (!ParentCollection || !World)
	{
		return nullptr;
	}

	UObject* CollectionOuter = GetTransientPackage();
	static const FName CollectionBaseName("RuntimeNPC");
	const FName CollectionName = MakeUniqueObjectName(CollectionOuter, UNiagaraParameterCollectionInstance::StaticClass(), CollectionBaseName);

	UNiagaraParameterCollectionInstance* DefaultInstance = ParentCollection->GetDefaultInstance();
	UNiagaraParameterCollectionInstance* NewInstance = CastChecked<UNiagaraParameterCollectionInstance>(StaticDuplicateObject(DefaultInstance, CollectionOuter, CollectionName));

#if WITH_EDITOR
	// Bind to the default instance so that changes to the collection propagate through.
	DefaultInstance->GetParameterStore().Bind(&NewInstance->GetParameterStore());
#endif

	NewInstance->Bind(World);
	return NewInstance;
}
