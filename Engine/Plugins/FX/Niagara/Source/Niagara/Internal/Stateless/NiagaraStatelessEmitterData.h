...
{
	friend class FNiagaraStatelessEmitterDataBuildContext;
	...
	TArray<uint8>									SharedBuiltData;			// Shared built data, allocated by modules generally used during parameter setting
	TArray<TPair<FName, uint32>>					SharedBuiltDataOffsets;		// Shared build data offsets, used to find the data
