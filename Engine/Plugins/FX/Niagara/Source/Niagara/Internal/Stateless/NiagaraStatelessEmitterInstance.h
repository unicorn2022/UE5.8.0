...
public:
	...
	virtual void RebindParameterCollection(UNiagaraParameterCollectionInstance* OldCollection, UNiagaraParameterCollectionInstance* NewCollection) override;
...
private:
	...
	void UpdateSimulationData(float DeltaSeconds, bool bForceParametersUpdate);
