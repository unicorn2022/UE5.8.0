...
struct FNDCMapEntryBase
{
	...
	*/
	...
	const TArray<TObjectPtr<UNiagaraComponent>>& GetSpawnedSystems() { return SpawnedComponents; }
protected:
...
struct FNDCMapEntry
{
	...
	[[nodiscard]] explicit FNDCMapEntry(TNDCMapEntryType EntryType, int32 InIndex)
	: Index(InIndex)
	{
...
private:
	...
	/** Index of this entry in the owning pool. */
