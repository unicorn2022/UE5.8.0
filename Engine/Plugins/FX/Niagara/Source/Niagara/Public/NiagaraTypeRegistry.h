...
public:
	...
	static NIAGARA_API void InvalidateTypesByPaths(TConstArrayView<FString> AssetPaths);
	...
	{
	public:
		UE_NODISCARD_CTOR FSuspendPluginUnmounting() { SuspendPluginUnmount(); }
		~FSuspendPluginUnmounting() { ResumePluginUnmount(); }
	};
...
private:
	...
	static NIAGARA_API void SuspendPluginUnmount();
	static NIAGARA_API void ResumePluginUnmount();
