...
namespace FNiagaraComponentSettings
{
	...
	extern NIAGARA_API bool IsEmitterAllowedToRun(const FVersionedNiagaraEmitterData& EmitterData, const UNiagaraEmitter& NiagaraEmitter, const FGuid& EmitterHandleId);
};
