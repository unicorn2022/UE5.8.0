...
public:
	...
	static NIAGARA_API bool IsViewRenderingOpaqueOnly(const FSceneView* View, bool bCanCastTranslucentShadows);
	static NIAGARA_API bool AreViewsRenderingOpaqueOnly(const TArray<const FSceneView*>& Views, int32 ViewVisibilityMask, bool bCanCastTranslucentShadows);
