...
public:
	...
	~FNiagaraSystemSimulation();
	bool Init(UNiagaraSystem* InSystem, UWorld* InWorld, bool bInIsSolo, ETickingGroup InTickGroup, const FNiagaraParameterCollectionResolver& ParameterCollectionResolver);
	void Destroy();
