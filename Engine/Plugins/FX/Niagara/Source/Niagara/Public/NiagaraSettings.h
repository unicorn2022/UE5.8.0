...
class UNiagaraSettings : public UDeveloperSettings
{
	...
	ENiagaraLwcTileUpdateMode LargeWorldCoordinateTileUpdateMode = ENiagaraLwcTileUpdateMode::Rebase;
	...
	*/
	...
	UPROPERTY(config, EditAnywhere, Category = Scalability)
	FNiagaraSystemPSOPrecacheSettings DefaultPSOPrecacheSettings;
