...
public:
	...
	virtual bool IsSimTargetSupported(ENiagaraSimTarget InSimTarget) const override { return InSimTarget == ENiagaraSimTarget::CPUSim || SourceMode == ENiagaraRendererSourceDataMode::Emitter; };
#if WITH_EDITORONLY_DATA
