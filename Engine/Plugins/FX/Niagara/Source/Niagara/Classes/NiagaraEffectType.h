...
class UNiagaraEffectType : public UObject
{
	...
	*/
	...
	/** Readiness Settings used by systems using this Effect Type. If unset, the defaults in the project settings will be used. */
	UPROPERTY(EditAnywhere, Category = "Scalability")
	TObjectPtr<UNiagaraSystemReadinessSettings> ReadinessSettings;

	/** How urgent it is that System's using this Effect Type are ready in time for activation and rendering. Settings controlling readiness and possible delays in rendering can be found in ReadinessSettings. */
	UPROPERTY(EditAnywhere, Category = "Scalability", meta = (DisplayInScalabilityValuesBar, Categories = "Niagara.ScalabilityProfile"))
	FGameplayTag ReadinessProfile = TAG_Niagara_ScalabilityProfile_Medium;
	...
	const FNiagaraReadinessSettingsProfile* FindReadinessSettingsProfile(FGameplayTag Profile = FGameplayTag()) const;
private:
...
public:
	...
	virtual ~FParticlePerfStatsListener_EffectType() = default;
