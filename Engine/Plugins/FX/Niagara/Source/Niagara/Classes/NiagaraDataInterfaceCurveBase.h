...
public:
	...
	NIAGARA_API virtual void CacheStaticBuffers(struct FNiagaraSystemStaticBuffers& StaticBuffers, bool bIsExternalDataInterface, bool bUsedByCPU, bool bUsedByGPU) override;
#if WITH_EDITORONLY_DATA
