...
namespace UE::PixelStreaming2
{
	FEpicRtcLogFilter::FEpicRtcLogFilter()
	{
		...
		if (UPixelStreaming2PluginSettings::FDelegates* Delegates = UPixelStreaming2PluginSettings::Delegates(); Delegates)
		{
	...
	FEpicRtcLogFilter::FEpicRtcLogFilter(const TArray<FRegexPattern>& RegexPatterns)
	...
	FEpicRtcLogFilter::~FEpicRtcLogFilter()
	{
		if (UPixelStreaming2PluginSettings::FDelegates* Delegates = UPixelStreaming2PluginSettings::Delegates(); Delegates && EpicRtcLogFilterChangedHandle.IsValid())
		{
			Delegates->OnEpicRtcLogFilterChanged.Remove(EpicRtcLogFilterChangedHandle);
		}
	}
