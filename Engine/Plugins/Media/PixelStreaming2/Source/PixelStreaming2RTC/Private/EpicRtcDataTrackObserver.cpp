...
namespace UE::PixelStreaming2
{
	...
	void FEpicRtcDataTrackObserver::OnDataTrackMessage(EpicRtcDataTrackInterface* DataTrack, const EpicRtcDataFrame& DataFrame)
	{
		if (UserObserver)
		{
			UserObserver->OnDataTrackMessage(DataTrack, DataFrame);
		}
	}
