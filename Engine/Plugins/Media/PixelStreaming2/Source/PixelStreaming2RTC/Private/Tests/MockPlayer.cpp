...
namespace UE::PixelStreaming2
{
	...
	{
		UE_LOGF(LogPixelStreaming2RTC, VeryVerbose, "FMockPlayer::OnVideoTrackFrame received a video frame.");
	...
	void FMockPlayer::OnDataTrackMessage(EpicRtcDataTrackInterface* InDataTrack, const EpicRtcDataFrame& InDataFrame)
	{
		...
		const TArray<uint8> Data(InDataFrame._data, InDataFrame._size);
		AsyncTask(ENamedThreads::GameThread, [WeakPlayer, Data]() {
