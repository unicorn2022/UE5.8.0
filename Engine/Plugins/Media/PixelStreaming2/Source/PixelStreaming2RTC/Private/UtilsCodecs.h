...
namespace UE::PixelStreaming2
{
	...
	inline TOptional<FString> H264ProfileLevelToString(EH264Profile Profile, EH264Level Level)
	{
		...
		else
		{
			...
			ProfileString = FString::Printf(TEXT("%s%02x"), *ProfileIdcIopString, static_cast<uint32>(Level));
		}

		return ProfileString;
	}

	inline FEpicRtcParameterPairArray* CreateH264Format(EH264Profile Profile, EH264Level Level)
	{
	...
	inline FEpicRtcParameterPairArray* CreateVP9Format(EProfile Profile)
	{
		FString ProfileIdString = FString::Printf(TEXT("%d"), EnumToUnderlyingType(Profile));
		return new FEpicRtcParameterPairArray(
			{
	...
	inline EpicRtcVideoCodec ToEpicRtcVideoCodec(EVideoCodec Codec)
	{
		switch (Codec)
		{
			case EVideoCodec::VP8:
				return EpicRtcVideoCodec::VP8;
			case EVideoCodec::VP9:
				return EpicRtcVideoCodec::VP9;
			case EVideoCodec::H264:
				return EpicRtcVideoCodec::H264;
			case EVideoCodec::AV1:
				return EpicRtcVideoCodec::AV1;
			default:
				checkNoEntry();
				return EpicRtcVideoCodec::VP8;
		}
