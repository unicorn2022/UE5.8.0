...
namespace UE::PixelStreaming2
{
	...
	void FEpicRtcVideoSource::PushFrame()
	{
...
#if PLATFORM_ANDROID
		// Android uses the internal EpicRtc coders which require I420 frames
		TRefCountPtr<EpicRtcVideoBufferInterface> OldFrameBuffer = FrameBuffer;
		FrameBuffer = OldFrameBuffer->ToI420();
		if (!FrameBuffer)
		{
			return;
		}
		...
		{
			UE_LOGF(LogPixelStreaming2RTC, Error, "Unable to push Video frame id: %d", Frame._id);
		}
	}
} // namespace UE::PixelStreaming2
