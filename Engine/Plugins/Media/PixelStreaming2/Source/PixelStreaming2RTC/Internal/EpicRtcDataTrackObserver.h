...
public:
	...
	virtual void OnDataTrackMessage(EpicRtcDataTrackInterface* DataTrack, const EpicRtcDataFrame& DataFrame) = 0;
...
namespace UE::PixelStreaming2
{
	...
	private:
		...
		UE_API virtual void OnDataTrackMessage(EpicRtcDataTrackInterface* DataTrack, const EpicRtcDataFrame& DataFrame) override;
