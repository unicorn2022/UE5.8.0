...
#include "epic_rtc/plugins/signalling/join_options.h"
...
namespace UE::PixelStreaming2
{
	...
	public:
		...
		virtual ~FEpicRtcParameterPairArray()
		{
		...
		FEpicRtcParameterPairArray(const TArray<TRefCountPtr<EpicRtcParameterPairInterface>>& ParameterPairs)
		{
		...
		FEpicRtcParameterPairArray(const TArray<EpicRtcParameterPairInterface*>& ParameterPairs)
		{
			for (auto& ParameterPair : ParameterPairs)
			{
		...
		FEpicRtcParameterPairArray(std::initializer_list<EpicRtcParameterPairInterface*> ParameterPairs)
		{
			for (auto& ParameterPair : ParameterPairs)
			{
				Data.Add(ParameterPair);
	...
	{
	public:
		FEpicRtcVideoCodecInfo(EpicRtcVideoCodec Codec, EpicRtcParameterPairArrayInterface* Parameters = new FEpicRtcParameterPairArray(), EpicRtcVideoScalabilityModeArrayInterface* ScalabilityModes = new FEpicRtcScalabilityModeArray())
			: Codec(Codec)
		...
		virtual EpicRtcParameterPairArrayInterface* GetParameters() override
		{
			return Parameters;
		}
	...
	class FEpicRtcSignallingJoinOptionsArray : public EpicRtcSignallingJoinOptionsArrayInterface
	{
	public:
		FEpicRtcSignallingJoinOptionsArray() = default;
		virtual ~FEpicRtcSignallingJoinOptionsArray() = default;

		FEpicRtcSignallingJoinOptionsArray(const TArray<EpicRtcSignallingJoinOptions>& SignallingJoinOptions)
			: Data(SignallingJoinOptions)
		{
		}

		FEpicRtcSignallingJoinOptionsArray(std::initializer_list<EpicRtcSignallingJoinOptions> SignallingJoinOptions)
			: Data(SignallingJoinOptions)
		{
		}

		virtual const EpicRtcSignallingJoinOptions* Get() const override
		{
			return Data.GetData();
		}

		virtual EpicRtcSignallingJoinOptions* Get() override
		{
			return Data.GetData();
		}
	...
	private:
		TArray<EpicRtcSignallingJoinOptions> Data;
