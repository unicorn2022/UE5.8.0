...
#include "epic_rtc/plugins/signalling/join_parameters.h"
...
struct EpicRtcRoomConfig
{
    ...
    /**
     * Join parameters specific to this room.
     */
    EpicRtcSignallingJoinParameters _joinParameters;
...
static_assert(sizeof(EpicRtcRoomConfig) == 16 + 16 + 64 + 16 + 16 + 8 + 8 + 8 + 8);  // Ensure EpicRtcRoomConfig is expected size on all platforms
