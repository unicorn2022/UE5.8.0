 ...
 * A reference counted Array container that allows arrays to be copied over ABI and DLL boundary.
 */
class EpicRtcSignallingJoinOptionsArrayInterface : public EpicRtcRefCountInterface
{
public:
    /**
     * Get the pointer to the data.
     * @return The data.
     */
    virtual EPICRTC_API const EpicRtcSignallingJoinOptions* Get() const = 0;

    /**
     * Get the pointer to the data.
     * @return The data.
     */
    virtual EPICRTC_API EpicRtcSignallingJoinOptions* Get() = 0;
    ...
    // Prevent copying
    EpicRtcSignallingJoinOptionsArrayInterface(const EpicRtcSignallingJoinOptionsArrayInterface&) = delete;
    EpicRtcSignallingJoinOptionsArrayInterface& operator=(const EpicRtcSignallingJoinOptionsArrayInterface&) = delete;

protected:
    // Only class Implementation can be constructed or destroyed
    EPICRTC_API EpicRtcSignallingJoinOptionsArrayInterface() = default;
    virtual EPICRTC_API ~EpicRtcSignallingJoinOptionsArrayInterface() = default;
};
