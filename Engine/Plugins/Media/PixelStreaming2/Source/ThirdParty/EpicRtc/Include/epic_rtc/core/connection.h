...
public:
    ...
    /**
     * Sets the preferred codecs used for this connection. The default value is the order of codecs returned by the EpicRtcVideoEncoderInitializerInterface/EpicRtcVideoDecoderInitializerInterface,
     * but this method can be used to update the preferred codecs if you are using the inbuilt codecs and have no control over the order of codecs returned by the initializer
     */
    virtual EPICRTC_API EpicRtcErrorCode SetPreferredVideoCodecs(const EpicRtcStringView& inParticipantId, EpicRtcVideoCodecInfoArrayInterface* inPreferredVideoCodecs) = 0;
