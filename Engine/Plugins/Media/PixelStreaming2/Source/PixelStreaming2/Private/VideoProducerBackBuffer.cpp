...
namespace UE::PixelStreaming2
{
	...
	void FVideoProducerBackBuffer::OnBackBufferReady(SWindow& SlateWindow, ISlateViewportProvider& ViewportProvider)
	{
		PushFrame(FPixelCaptureInputFrameRHI(ViewportProvider.GetBackBufferResource()));
	}
