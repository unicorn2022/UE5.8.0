...
bool UPixelStreaming2VideoComponent::StreamerWatch(FString StreamerId, FString PlayerId)
{
	...
	{
		UE_LOGF(LogPixelStreaming2, Verbose, "Pixel Streaming video component could not watch anything because Pixel Streaming module is not loaded. This is expected on dedicated servers.");
		return false;
	}
...
void UPixelStreaming2VideoComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
	...
	{
		UE_LOGF(LogPixelStreaming2, Log, "PixelStreaming2 video component found a WebRTC peer to watch.");
	}
}
