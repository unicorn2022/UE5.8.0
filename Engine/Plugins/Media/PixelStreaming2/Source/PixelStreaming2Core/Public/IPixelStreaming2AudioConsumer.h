...
public:
	 ...
	 * @param NumFrames Number of Audio frames in a single channel.
	 */
	virtual void ConsumeRawPCM(const int16_t* AudioData, int SampleRate, size_t NumChannels, size_t NumFrames) = 0;
