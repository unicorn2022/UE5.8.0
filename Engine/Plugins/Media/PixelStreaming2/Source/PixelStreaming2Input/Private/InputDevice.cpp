...
namespace UE::PixelStreaming2Input
{
	...
	uint8 FInputDevice::OnControllerConnected()
	{
		...
		{
			static const FName PixelStreamingInputDeviceName(TEXT("PixelStreaming2InputDevice"));
			FInputDeviceDescriptor Desc;
			Desc.HardwareDeviceHandle     = DeviceId;
			Desc.InputDeviceName          = PixelStreamingInputDeviceName;
			Desc.HardwareDeviceIdentifier = FName(TEXT("PixelStreaming2_Controller"));
