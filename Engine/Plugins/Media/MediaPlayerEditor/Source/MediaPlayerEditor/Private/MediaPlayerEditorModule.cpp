...
#include "Customizations/StreamMediaSourceCustomization.h"
...
public:
	...
	virtual void StartupModule() override
	{
		...
		StreamMediaSourceName = UStreamMediaSource::StaticClass()->GetFName();
...
protected:
	...
	void RegisterCustomizations()
	{
		FPropertyEditorModule& PropertyModule = FModuleManager::LoadModuleChecked<FPropertyEditorModule>("PropertyEditor");
		{
			...
			PropertyModule.RegisterCustomClassLayout(StreamMediaSourceName, FOnGetDetailCustomizationInstance::CreateStatic(&FStreamMediaSourceCustomization::MakeInstance));
	...
	void UnregisterCustomizations()
	{
		FPropertyEditorModule& PropertyModule = FModuleManager::LoadModuleChecked<FPropertyEditorModule>("PropertyEditor");
		{
			...
			PropertyModule.UnregisterCustomClassLayout(StreamMediaSourceName);
