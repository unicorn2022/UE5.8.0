...
public:
	...
	{ }
		...
		/** Command list for executing keybinds and mouse clicks. */
...
public:
	...
	UE_API UMediaPlayer* GetMediaPlayer() const;
...
private:
	...
	/** Callback for creating the Background sub-menu. */
	UE_API void HandleBackgroundMenuNewMenu(FMenuBuilder& MenuBuilder);

	/** Callback for creating the timer units sub-menu. */
	UE_API void HandleTimerUnitMenuNewMenu(FMenuBuilder& MenuBuilder);
	...
	/** Creates controls for the media */
	UE_API TSharedRef<SWidget> CreatePlayerControls();
...
private:
	...
	/** The controls that can be executed by this viewer. */
