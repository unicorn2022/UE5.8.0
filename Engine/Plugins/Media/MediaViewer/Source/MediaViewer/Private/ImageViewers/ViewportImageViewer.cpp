...
void FViewportImageViewer::NotifyPostChange(const FPropertyChangedEvent& InPropertyChangedEvent, FProperty* InPropertyThatChanged)
{
...
void FViewportImageViewer::OnMirrored()
{
