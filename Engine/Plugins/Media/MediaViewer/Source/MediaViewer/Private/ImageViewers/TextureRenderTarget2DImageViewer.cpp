...
void FTextureRenderTarget2DImageViewer::NotifyPostChange(const FPropertyChangedEvent& InPropertyChangedEvent, FProperty* InPropertyThatChanged)
{
...
void FTextureRenderTarget2DImageViewer::OnMirrored()
{
