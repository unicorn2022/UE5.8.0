...
public:
	static constexpr float MaxScale = 20.f;
...
protected:
	...
	/** Sets the mirror plane flag on all image viewers. */
	void MirrorAll(EMediaImageMirrorPlane InPlane, bool bInSet);
	...
	/** Forwards the mirror bind to the first valid viewer. */
