...
enum class EMediaViewerMediaSyncType : uint8
{
	...
	/** The offset is relative to slider value on both videos. A scrub change of 10% in video A will move video B by 10%. */
	RelativeProgress,
...
struct FMediaViewerSettings
{
	...
	FLinearColor ClearColor = FStyleColors::Black.GetSpecifiedColor();
