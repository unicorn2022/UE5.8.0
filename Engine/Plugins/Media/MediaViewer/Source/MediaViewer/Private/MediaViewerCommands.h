...
public:
	...
	TSharedPtr<FUICommandInfo> ToggleAutoFiltering;
	TSharedPtr<FUICommandInfo> TogglePixelGrid;
	...
	TSharedPtr<FUICommandInfo> Scale1000;
	...
	TSharedPtr<FUICommandInfo> MirrorHorizonal;
	TSharedPtr<FUICommandInfo> MirrorVertical;
	TSharedPtr<FUICommandInfo> MirrorDepth;
