...
struct FMediaViewerDelegates
{
	...
	DECLARE_DELEGATE_TwoParams(FSetAllMirrorPlaneFlags, EMediaImageMirrorPlane, bool /* bInSet */)
	...
	/** Set the mirror plane flag (on/off) to all image viewers. */
	FSetAllMirrorPlaneFlags MirrorAll;
