...
private:
	...
	void RegisterCustomizations()
	{
		...
		PropertyModule.RegisterCustomPropertyTypeLayout(FMediaCaptureOptions::StaticStruct()->GetFName(), FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FMediaCaptureOptionsCustomization::MakeInstance));
	...
	void UnregisterCustomizations()
	{
		...
		PropertyModule.UnregisterCustomPropertyTypeLayout(FMediaCaptureOptions::StaticStruct()->GetFName());
