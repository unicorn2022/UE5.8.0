...
namespace UE::MediaCaptureData
{
	...
	public:
		...
		virtual void* Lock(FRHICommandListImmediate& RHICmdList, int32& OutRowStride) override
		{
			...
			{
				UE_LOGF(LogMediaIOCore, Verbose, "Fence for texture readback was not ready");
			}
	...
	public:
		...
		virtual void* Lock(FRHICommandListImmediate& RHICmdList, int32& OutRowStride) override
		{
			...
			{
				UE_LOGF(LogMediaIOCore, Verbose, "Fence for buffer readback was not ready, blocking.");
