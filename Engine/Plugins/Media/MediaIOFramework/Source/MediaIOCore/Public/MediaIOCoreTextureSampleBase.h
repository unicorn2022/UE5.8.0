...
{
	struct UE_DEPRECATED(5.8, "FColorFormatArgs is deprecated. Please use FNativeMediaSourceColorSettings instead.") FColorFormatArgs
	{
...
public:
	 ...
	 */
	UE_API bool Initialize(const void* InVideoBuffer, uint32 InBufferSize, uint32 InStride, uint32 InWidth, uint32 InHeight, EMediaTextureSampleFormat InSampleFormat, FTimespan InTime, const FFrameRate& InFrameRate, const TOptional<FTimecode>& InTimecode, TSharedPtr<FNativeMediaSourceColorSettings, ESPMode::ThreadSafe> InSourceColorSettings);
	 ...
	 * @param InSourceColorSettings Information about the texture color encoding and color space.
	 */
	UE_API bool Initialize(TArray<uint8>&& InVideoBuffer, uint32 InStride, uint32 InWidth, uint32 InHeight, EMediaTextureSampleFormat InSampleFormat, FTimespan InTime, const FFrameRate& InFrameRate, const TOptional<FTimecode>& InTimecode, TSharedPtr<FNativeMediaSourceColorSettings, ESPMode::ThreadSafe> InSourceColorSettings);
	 ...
	 *
	 * @param InStride The number of channel of the video buffer.
	 * @param InWidth The width the video buffer.
	 * @param InHeight The height of the video buffer.
	 * @param InSampleFormat The sample format of the video buffer.
	 * @param InTime The sample time (in the player's own clock).
	 * @param InFrameRate The framerate of the media that produce the sample.
	 * @param InTimecode The sample timecode if available.
	 * @param InSourceColorSettings Information about the texture color encoding and color space.
	 */
	UE_API bool SetProperties(uint32 InStride, uint32 InWidth, uint32 InHeight, EMediaTextureSampleFormat InSampleFormat, FTimespan InTime, const FFrameRate& InFrameRate, const TOptional<FTimecode>& InTimecode, TSharedPtr<FNativeMediaSourceColorSettings, ESPMode::ThreadSafe> InSourceColorSettings);
	 ...
	 * @param InVideoBuffer The video frame data.
	 * @param InStride The number of channel of the video buffer.
	 * @param InWidth The width of the video buffer.
	 * @param InHeight The height of the video buffer.
	 * @param InSampleFormat The sample format of the video buffer.
	 * @param InTime The sample time (in the player's own clock).
	 * @param InTimecode The sample timecode if available.
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
	UE_DEPRECATED(5.8, "Deprecated method. Please use method with FNativeMediaSourceColorSettings argument instead.")
...
public:
	...
	UE_API virtual bool HasEncodingOverride() const;
	UE_API virtual bool HasColorSpaceOverride() const;
	...
	UE_API virtual UE::Color::EChromaticAdaptationMethod GetChromaticAdapationMethod() const override;
	UE_API virtual float GetHDRNitsNormalizationFactor() const override;
	
	UE_DEPRECATED(5.8, "GetColorSpaceType is deprecated, please use GetSourceColorSpace instead.")
...
protected:
	...
	UE_DEPRECATED(5.8, "Please use SourceColorSettings instead.")
	UE::Color::EEncoding Encoding = UE::Color::EEncoding::Linear;
