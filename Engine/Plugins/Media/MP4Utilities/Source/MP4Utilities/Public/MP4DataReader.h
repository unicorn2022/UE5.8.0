...
namespace MP4Utilities
{
	...
	{
	public:
		virtual ~IMP4DataReaderBase() = default;
	...
	class FMP4FileDataReader : public IMP4DataReaderBase
	{
	public:
		static UE_API TSharedPtr<FMP4FileDataReader, ESPMode::ThreadSafe> Create();
		virtual ~FMP4FileDataReader() = default;
		virtual bool Open(const FString& InFilename) = 0;
	};



	class FMP4BufferDataReader : public IMP4DataReaderBase
	{
	public:
		static UE_API TSharedPtr<FMP4BufferDataReader, ESPMode::ThreadSafe> Create(TConstArrayView<const uint8> InData);
		virtual ~FMP4BufferDataReader() = default;
	};
