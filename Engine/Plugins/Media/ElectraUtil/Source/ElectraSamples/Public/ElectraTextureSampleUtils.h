...
namespace ElectraColorimetryUtils
{
	...
	inline UE::Color::EColorSpace TranslateMPEGColorPrimaries(uint8 InPrimaries)
	{
		switch (InPrimaries)
		{
			case 1:				// Rec709
	...
	inline UE::Color::EColorSpace TranslateMPEGMatrixCoefficients(uint8 InMatrixCoefficients)
	{
	...
	inline UE::Color::EEncoding TranslateMPEGTransferCharacteristics(uint8 InTransferCharacteristics)
	{
		switch (InTransferCharacteristics)
		{
			...
			case 18: // Rec. ITU-R BT.2100-2 (HLG)
			{
