...
//private:
	...
	ELECTRASAMPLES_API TRefCountPtr<IUnknown> GetSync(uint64& OutSyncValue, TSharedPtr<std::atomic<bool>>& OutFenceSignalled);
	...
	uint64 FenceValue = 0;
	TSharedPtr<std::atomic<bool>> FenceSignalled;
...
public:
	...
	{ }
	~FElectraTextureSamplePool() = default;
