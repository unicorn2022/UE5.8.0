...
{
public:
	virtual ~FVideoDecoderOutputD3D12Electra() = default;
...
{
public:
	static bool D3D12VIDEODECODERSELECTRA_API CheckPlatformDecodeCapabilities(D3D12_FEATURE_DATA_VIDEO_DECODE_SUPPORT& InOutDecodeSupport,  const Electra::FCodecTypeFormat& InCodecFormat, const TMap<FString, FVariant>& InOptions);
