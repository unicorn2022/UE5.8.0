	...
	namespace Facility
	{
		...
		static const TCHAR* GetName(EFacility InFacility)
		{
			switch (InFacility)
			{
				...
				case EFacility::ISOBMFFPlaylistReader:
					return TEXT("ISOBMFF playlist reader");
				case EFacility::ISOBMFFPlaylist:
					return TEXT("ISOBMFF playlist");
				case EFacility::ISOBMFFStreamReader:
					return TEXT("ISOBMFF reader");
