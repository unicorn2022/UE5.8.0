...
EMediaFormatType FManifestMKVInternal::GetMediaFormatType() const
{
	return EMediaFormatType::MKV;
}

bool FManifestMKVInternal::ReloadsPlaylistPeriodically() const
{
	return false;
}

bool FManifestMKVInternal::SupportsMultipleTracksPerKind() const
{
	return true;
}

bool FManifestMKVInternal::OrderOfTracksCanChangeDynamically() const
{
	return false;
}
...
void FManifestMKVInternal::UpdateRunningMetaData(TSharedPtrTS<FMetadataParser> InUpdatedMetaData)
{
	// No-op.
}
...
FErrorDetail FManifestMKVInternal::FTimelineAssetMKV::Build(IPlayerSessionServices* InPlayerSessionServices, TSharedPtrTS<IParserMKV> InMKVParser, const FString& URL)
{
	...
	MovieDuration = InMKVParser->GetDuration();
