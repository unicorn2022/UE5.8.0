...
void FCMCDHandler::ReportMediaMetadataChanged(TSharedPtrTS<FMetadataParser> InMetadata) { }
...
void FCMCDHandler::ReportVideoFrameStats(const Metrics::FFrameStats& InFrameStats) { }
void FCMCDHandler::ReportAudioFrameStats(const Metrics::FFrameStats& InFrameStats) { }
