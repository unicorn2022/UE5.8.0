...
namespace Electra
{
	...
	public:
		...
		explicit FStreamCodecInformation(const FCodecTypeFormat& InFromCodecTypeFormat);
		FCodecTypeFormat ToCodecTypeFormat() const;
	...
	namespace StreamCodecInformationOptions
	{
		...
		static const FName AV1cBox(TEXT("av1C_box"));
		static const FName ColrBox(TEXT("colr_box"));
