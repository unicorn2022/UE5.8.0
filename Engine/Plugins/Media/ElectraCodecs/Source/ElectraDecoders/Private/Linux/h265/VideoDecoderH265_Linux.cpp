...
{
public:
	FElectraVideoDecoderH265_Linux(const Electra::FCodecTypeFormat& InCodecFormat, const TMap<FString, FVariant>& InAdditionalOptions);
...
TSharedPtr<IElectraDecoder, ESPMode::ThreadSafe> IElectraVideoDecoderH265_Linux::Create(const Electra::FCodecTypeFormat& InCodecFormat, const TMap<FString, FVariant>& InAdditionalOptions)
{
	TSharedPtr<FElectraVideoDecoderH265_Linux, ESPMode::ThreadSafe> New = MakeShared<FElectraVideoDecoderH265_Linux>(InCodecFormat, InAdditionalOptions);
	return New;
}

FElectraVideoDecoderH265_Linux::FElectraVideoDecoderH265_Linux(const Electra::FCodecTypeFormat& InCodecFormat, const TMap<FString, FVariant>& InAdditionalOptions)
