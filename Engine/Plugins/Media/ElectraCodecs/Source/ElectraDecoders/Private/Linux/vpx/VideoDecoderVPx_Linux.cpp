...
{
public:
	FElectraVideoDecoderVPx_Linux(const Electra::FCodecTypeFormat& InCodecFormat, const TMap<FString, FVariant>& InAdditionalOptions);
...
TSharedPtr<IElectraDecoder, ESPMode::ThreadSafe> IElectraVideoDecoderVPx_Linux::Create(const Electra::FCodecTypeFormat& InCodecFormat, const TMap<FString, FVariant>& InAdditionalOptions)
{
	TSharedPtr<FElectraVideoDecoderVPx_Linux, ESPMode::ThreadSafe> New = MakeShared<FElectraVideoDecoderVPx_Linux>(InCodecFormat, InAdditionalOptions);
	return New;
}

FElectraVideoDecoderVPx_Linux::FElectraVideoDecoderVPx_Linux(const Electra::FCodecTypeFormat& InCodecFormat, const TMap<FString, FVariant>& InAdditionalOptions)
