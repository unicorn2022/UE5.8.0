...
{
public:
	FElectraAudioDecoderAAC_Linux(const Electra::FCodecTypeFormat& InCodecFormat, const TMap<FString, FVariant>& InAdditionalOptions);
...
TSharedPtr<IElectraDecoder, ESPMode::ThreadSafe> IElectraAudioDecoderAAC_Linux::Create(const Electra::FCodecTypeFormat& InCodecFormat, const TMap<FString, FVariant>& InAdditionalOptions)
{
	TSharedPtr<FElectraAudioDecoderAAC_Linux, ESPMode::ThreadSafe> New = MakeShared<FElectraAudioDecoderAAC_Linux>(InCodecFormat, InAdditionalOptions);
	return New;
}

FElectraAudioDecoderAAC_Linux::FElectraAudioDecoderAAC_Linux(const Electra::FCodecTypeFormat& InCodecFormat, const TMap<FString, FVariant>& InAdditionalOptions)
{
