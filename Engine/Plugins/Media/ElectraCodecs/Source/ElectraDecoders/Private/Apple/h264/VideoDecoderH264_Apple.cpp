...
public:
	FElectraVideoDecoderH264_Apple(const Electra::FCodecTypeFormat& InCodecFormat, const TMap<FString, FVariant>& InAdditionalOptions);
...
TSharedPtr<IElectraDecoder, ESPMode::ThreadSafe> IElectraVideoDecoderH264_Apple::Create(const Electra::FCodecTypeFormat& InCodecFormat, const TMap<FString, FVariant>& InAdditionalOptions)
{
	TSharedPtr<FElectraVideoDecoderH264_Apple, ESPMode::ThreadSafe> New = MakeShared<FElectraVideoDecoderH264_Apple>(InCodecFormat, InAdditionalOptions);
	return New;
}

FElectraVideoDecoderH264_Apple::FElectraVideoDecoderH264_Apple(const Electra::FCodecTypeFormat& InCodecFormat, const TMap<FString, FVariant>& InAdditionalOptions)
