...
public:
	...
	{ return MakeShareable<>(new FElectraDecoderBitstreamProcessorVPx(InDecoderParams, InInitialCodecFormat, InAdditionalFormatParams)); }
...
private:
	ELECTRADECODERS_API FElectraDecoderBitstreamProcessorVPx(const TMap<FString, FVariant>& InDecoderParams, const Electra::FCodecTypeFormat& InInitialCodecFormat, const TMap<FString, FVariant>& InAdditionalFormatParams);
	class FImpl;
