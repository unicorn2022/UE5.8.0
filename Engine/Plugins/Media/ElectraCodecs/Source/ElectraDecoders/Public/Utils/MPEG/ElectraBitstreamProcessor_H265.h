...
public:
	...
	{ return MakeShareable<>(new FElectraDecoderBitstreamProcessorH265(InDecoderParams, InInitialCodecFormat, InAdditionalFormatParams)); }
...
private:
	ELECTRADECODERS_API FElectraDecoderBitstreamProcessorH265(const TMap<FString, FVariant>& InDecoderParams, const Electra::FCodecTypeFormat& InInitialCodecFormat, const TMap<FString, FVariant>& InAdditionalFormatParams);
	class FImpl;
