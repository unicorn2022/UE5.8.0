...
public:
	...
	{ return MakeShareable<>(new FElectraDecoderBitstreamProcessorGenericVideo(InDecoderParams, InInitialCodecFormat, InAdditionalFormatParams)); }
...
private:
	ELECTRADECODERS_API FElectraDecoderBitstreamProcessorGenericVideo(const TMap<FString, FVariant>& InDecoderParams, const Electra::FCodecTypeFormat& InInitialCodecFormat, const TMap<FString, FVariant>& InAdditionalFormatParams);
	class FImpl;
