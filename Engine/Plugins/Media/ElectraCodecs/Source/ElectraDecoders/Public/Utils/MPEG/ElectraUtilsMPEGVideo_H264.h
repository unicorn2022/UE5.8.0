...
#include "ElectraDecodersTypes.h"
	...
	namespace MPEG
	{
		namespace H264
		{
			...
			public:
				...
				{
					int32 lz = -1;
					for(uint32 b=0; b==0 && GetRemainingBits(); ++lz)
					{
						b = GetBits(1);
					}
					if (lz >= 0 && GetRemainingBits() >= lz)
					{
			...
			public:
				...
				{ return ChromaFormat; }
				inline uint8 GetBitDepthLuma() const
				{ return 8 + BitDepthLumaMinus8; }
				inline uint8 GetBitDepthChroma() const
				{ return 8+ BitDepthChromaMinus8; }
