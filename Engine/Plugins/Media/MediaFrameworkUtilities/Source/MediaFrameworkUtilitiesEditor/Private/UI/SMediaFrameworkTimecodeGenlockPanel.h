...
private:
	/** Refreshes the timecode and genlock to match the settings in the current media profile */
	void RefreshTimecodeGenlock(bool bRefreshTimecode, bool bRefreshGenlock);
