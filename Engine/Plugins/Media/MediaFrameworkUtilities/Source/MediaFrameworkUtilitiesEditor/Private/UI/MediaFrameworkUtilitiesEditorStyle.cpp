...
void FMediaFrameworkUtilitiesEditorStyle::Register()
{
	...
	MediaFrameworkUtilitiesStyle::StyleInstance->SetCoreContentRoot(FPaths::EngineContentDir());
	...
	MediaFrameworkUtilitiesStyle::StyleInstance->Set("ClassIcon.MediaProfile", new IMAGE_BRUSH_SVG("MediaProfile", MediaFrameworkUtilitiesStyle::Icon20x20));
	...
	MediaFrameworkUtilitiesStyle::StyleInstance->Set("ToolbarIcon.ClearCurrentMediaProfile", new IMAGE_BRUSH_SVG("MediaProfile", MediaFrameworkUtilitiesStyle::Icon16x16));
	MediaFrameworkUtilitiesStyle::StyleInstance->Set("ToolbarIcon.SaveLayout", new CORE_IMAGE_BRUSH_SVG("Editor/Slate/Starship/Common/LayoutSave", MediaFrameworkUtilitiesStyle::Icon16x16));
	MediaFrameworkUtilitiesStyle::StyleInstance->Set("ToolbarIcon.SaveLayoutAs", new CORE_IMAGE_BRUSH_SVG( "Editor/Slate/Starship/Common/SaveCurrentAs", MediaFrameworkUtilitiesStyle::Icon16x16));
	MediaFrameworkUtilitiesStyle::StyleInstance->Set("ToolbarIcon.LoadLayout", new CORE_IMAGE_BRUSH_SVG( "Editor/Slate/Starship/Common/LayoutLoad", MediaFrameworkUtilitiesStyle::Icon16x16));
	MediaFrameworkUtilitiesStyle::StyleInstance->Set("ToolbarIcon.RemoveLayout", new CORE_IMAGE_BRUSH_SVG( "Editor/Slate/Starship/Common/LayoutRemove", MediaFrameworkUtilitiesStyle::Icon16x16));
	MediaFrameworkUtilitiesStyle::StyleInstance->Set("ToolbarIcon.ToggleFullscreen", new CORE_IMAGE_BRUSH_SVG("Editor/Slate/Starship/Common/EnableFullscreen", MediaFrameworkUtilitiesStyle::Icon16x16));
	...
	MediaFrameworkUtilitiesStyle::StyleInstance->Set("ToolbarIcon.Refresh", new CORE_IMAGE_BRUSH_SVG("Slate/Starship/Common/Update", MediaFrameworkUtilitiesStyle::Icon16x16));
