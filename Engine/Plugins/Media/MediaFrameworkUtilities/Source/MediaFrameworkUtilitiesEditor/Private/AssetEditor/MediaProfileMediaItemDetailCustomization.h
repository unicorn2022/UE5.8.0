...
private:
	...
	/** Gets whether the properties of the media player that is playing the media source should be displayed in the details panel */
	bool ShowMediaPlayerOptions(UMediaSource* InSource) const;

	/** Adds appropraite media player properties to the details panel of the media source being displayed */
	void AddMediaPlayerProperties(UMediaSource* InMediaSource, IDetailLayoutBuilder& DetailBuilder);

private:
	/** Weak pointer to the media player of the media source being customized */
	TWeakObjectPtr<UMediaPlayer> SourceMediaPlayer;
};
