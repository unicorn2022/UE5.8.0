...
public:
	...
	virtual void StartupModule() override
	{
		...
		{
			UE_LOGF(LogWmfMedia, Log, "Failed to load required Windows Media Foundation libraries");
		...
		if (FAILED(Result))
		{
			UE_LOGF(LogWmfMedia, Log, "Failed to initialize Windows Media Foundation, Error %i", Result);
...
protected:
	...
	bool LoadRequiredLibraries()
	{
		...
		{
			UE_LOGF(LogWmfMedia, Log, "Failed to load shlwapi.dll");
		...
		{
			UE_LOGF(LogWmfMedia, Log, "Failed to load mf.dll");
		...
		{
			UE_LOGF(LogWmfMedia, Log, "Failed to load mfplat.dll");
		...
		{
			UE_LOGF(LogWmfMedia, Log, "Failed to load mfplay.dll");
