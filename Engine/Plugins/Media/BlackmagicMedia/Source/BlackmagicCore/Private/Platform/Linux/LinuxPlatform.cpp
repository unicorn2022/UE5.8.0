...
namespace BlackmagicPlatform
{
	...
	IDeckLinkIterator* CreateDeckLinkIterator()
	{
		...
		if (!DeckLinkIterator)
		{
			UE_LOGF(LogBlackmagicCore, Error,"A DeckLink iterator could not be created. The DeckLink drivers may not be installed.");
		}
	...
	IDeckLinkVideoConversion* CreateDeckLinkVideoConversion()
	{
		...
		{
			UE_LOGF(LogBlackmagicCore, Error,"A DeckLink video conversion could not be created. The DeckLink drivers may not be installed.");
		}
