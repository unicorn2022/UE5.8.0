...
public:
	...
	/**
	 * Call this to start playing at a rate of 1.0 (forward at normal speed)
	...
	/**
	 * Call this to start playing at a rate of -1.0 (reverse at normal speed)
	 * Open must be called before this.
	 */
	UFUNCTION(BlueprintCallable, Category = "Media|MediaPlateComponent")
	UE_API void PlayReverse();
