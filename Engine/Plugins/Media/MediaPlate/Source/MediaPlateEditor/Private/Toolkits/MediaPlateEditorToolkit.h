...
private:
	...
	/** Callback specifically to validate the toggle between play and pause. */
	bool CanHandleMediaPlateTogglePlayPauseEvent();

	/** Callback specifically for toggle play/pause which then triggers a play or pause event. */
	void HandleMediaPlateTogglePlayPauseEvent();

	/** Callback specifically to validate the toggle between reverse play and pause. */
	bool CanHandleMediaPlateTogglePlayReversePauseEvent();

	/** Callback specifically for toggle play/pause which then triggers a reverse play or pause event. */
	void HandleMediaPlateTogglePlayReversePauseEvent();
