...
private:
	/**
	 * Callback for enabling the action to add a media track to an object binding.
	 */
	bool HandleAddMediaTrackToObjectBindingMenuEntryCanExecute(TArray<FGuid> InObjectBindingID);
	/**
