...
void FPixelCaptureCapturerRHIToI420CPU::Initialize(int32 InputWidth, int32 InputHeight)
{
	...
	StagingTexture = RHICmdList.CreateTexture(TextureDesc);
...
void FPixelCaptureCapturerRHIToI420CPU::Initialize(int32 InputWidth, int32 InputHeight)
{
	...
	StagingTexture = RHICmdList.CreateTexture(StagingTextureDesc);
	...
	ReadbackTexture = RHICmdList.CreateTexture(ReadbackTextureDesc);
