...
public:
	...
	UE_API void ReadFrames(FTimespan AmountOfTimeToRead, TArray<TSharedPtr<FWebMFrame, ESPMode::ThreadSafe>>& AudioFrames, TArray<TSharedPtr<FWebMFrame, ESPMode::ThreadSafe>>& VideoFrames);
