...
class MEDIAPROFILE_API UMediaProfileSettings
	: public UObject
{
	GENERATED_BODY()	
...
public:
	...
	/** 
	 * Forces the media profile to save itself after a property change (if the profile was already saved once)
	 */
	UPROPERTY(Config)
	bool bAutosaveAfterChange = false;
#endif
...
class MEDIAPROFILE_API UMediaProfileEditorSettings
	: public UObject
{
	GENERATED_BODY()
