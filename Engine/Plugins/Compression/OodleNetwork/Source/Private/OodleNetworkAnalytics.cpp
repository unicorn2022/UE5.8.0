...
void FOodleNetAnalyticsData::SendAnalytics()
{
	...
	if (!(*this == NullVars) && AnalyticsProvider.IsValid())
	{
		...
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, "OodleNetwork Analytics:");
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - InCompressedNum: %llu", InCompressedNum);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - InNotCompressedNum: %llu", InNotCompressedNum);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - InCompressedWithOverheadLengthTotal: %llu", InCompressedWithOverheadLengthTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - InCompressedLengthTotal: %llu", InCompressedLengthTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - InDecompressedLengthTotal: %llu", InDecompressedLengthTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - InNotCompressedLengthTotal: %llu", InNotCompressedLengthTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutCompressedNum: %llu", OutCompressedNum);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutNotCompressedFailedNum: %llu", OutNotCompressedFailedNum);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutNotCompressedFailedAckOnlyNum: %llu", OutNotCompressedFailedAckOnlyNum);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutNotCompressedFailedKeepAliveNum: %llu", OutNotCompressedFailedKeepAliveNum);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutNotCompressedBoundedNum: %llu", OutNotCompressedBoundedNum);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutNotCompressedFlaggedNum: %llu", OutNotCompressedFlaggedNum);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutNotCompressedSkippedNum: %llu", OutNotCompressedSkippedNum);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutNotCompressedClientDisabledNum: %llu", OutNotCompressedClientDisabledNum);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutNotCompressedTooSmallNum: %llu", OutNotCompressedTooSmallNum);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutCompressedWithOverheadLengthTotal: %llu", OutCompressedWithOverheadLengthTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutCompressedLengthTotal: %llu", OutCompressedLengthTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutBeforeCompressedLengthTotal: %llu", OutBeforeCompressedLengthTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutNotCompressedFailedLengthTotal: %llu", OutNotCompressedFailedLengthTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutNotCompressedSkippedLengthTotal: %llu", OutNotCompressedSkippedLengthTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutNotCompressedNumTotal: %llu", OutNotCompressedNumTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutPostLengthTotal: %llu", OutPostLengthTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - InPostLengthTotal: %llu", InPostLengthTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - InSavingsPercentTotal: %i", InSavingsPercentTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutSavingsPercentTotal: %i", OutSavingsPercentTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - InSavingsBytesTotal: %lli", InSavingsBytesTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutSavingsBytesTotal: %lli", OutSavingsBytesTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - InSavingsWithOverheadPercentTotal: %i", InSavingsWithOverheadPercentTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutSavingsWithOverheadPercentTotal: %i", OutSavingsWithOverheadPercentTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - InSavingsWithOverheadBytesTotal: %lli", InSavingsWithOverheadBytesTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutSavingsWithOverheadBytesTotal: %lli", OutSavingsWithOverheadBytesTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - InAttemptedSavingsWithOverheadPercentTotal: %i", InAttemptedSavingsWithOverheadPercentTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - OutAttemptedSavingsWithOverheadPercentTotal: %i", OutAttemptedSavingsWithOverheadPercentTotal);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - NumOodleNetworkHandlers: %i", NumOodleNetworkHandlers);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - NumOodleNetworkHandlersCompressionEnabled: %i", NumOodleNetworkHandlersCompressionEnabled);
		UE_LOGF(OodleNetworkHandlerComponentLog, Log, " - NumOodleNetworkHandlersCompressionDisabled: %i", NumOodleNetworkHandlersCompressionDisabled);
