...
public:
	...
	/** Create an instance using a specific named platform config. Used to enable interaction with e.g. lobby voice channels via an IVoiceChat interface. */
	EOSVOICECHAT_API IVoiceChatPtr CreateInstanceWithPlatformConfig(const FString& PlatformConfigName);
