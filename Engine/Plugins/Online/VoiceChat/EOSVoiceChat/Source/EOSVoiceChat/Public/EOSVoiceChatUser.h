...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	EOSVOICECHAT_API virtual FDelegateHandle RegisterOnVoiceChatBeforeRecvMixedAudioRenderedDelegate(const FOnVoiceChatBeforeRecvAudioRenderedDelegate::FDelegate& Delegate) override;
	EOSVOICECHAT_API virtual void UnregisterOnVoiceChatBeforeRecvMixedAudioRenderedDelegate(FDelegateHandle Handle) override;
	EOSVOICECHAT_API virtual FDelegateHandle RegisterOnVoiceChatBeforeRecvUnmixedAudioRenderedDelegate(const FOnVoiceChatBeforeRecvAudioRenderedDelegate::FDelegate& Delegate) override;
	EOSVOICECHAT_API virtual void UnregisterOnVoiceChatBeforeRecvUnmixedAudioRenderedDelegate(FDelegateHandle Handle) override;
...
protected:
	...
	struct FChannelSession
	{
		...
		EOS_NotificationId OnMixedAudioBeforeRenderNotificationId = EOS_INVALID_NOTIFICATIONID;
		EOS_NotificationId OnUnmixedAudioBeforeRenderNotificationId = EOS_INVALID_NOTIFICATIONID;
	...
	static EOSVOICECHAT_API void EOS_CALL OnChannelMixedAudioBeforeRenderStatic(const EOS_RTCAudio_AudioBeforeRenderCallbackInfo* CallbackInfo);
	EOSVOICECHAT_API void OnChannelMixedAudioBeforeRender(const EOS_RTCAudio_AudioBeforeRenderCallbackInfo* CallbackInfo);
	static EOSVOICECHAT_API void EOS_CALL OnChannelUnmixedAudioBeforeRenderStatic(const EOS_RTCAudio_AudioBeforeRenderCallbackInfo* CallbackInfo);
	EOSVOICECHAT_API void OnChannelUnmixedAudioBeforeRender(const EOS_RTCAudio_AudioBeforeRenderCallbackInfo* CallbackInfo);
