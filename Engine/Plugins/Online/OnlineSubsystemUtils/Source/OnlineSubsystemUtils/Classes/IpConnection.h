...
private:
	...
	/** If address resolution has results ready, assigns the resolved socket and RemoteAddr. Returns true if socket was assigned. */
	UE_API bool TryConsumeAddressResolution(const TCHAR* LogSuffix = TEXT(""));
