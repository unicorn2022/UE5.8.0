...
/**
 * Parameters used when initializing AOnlineBeaconClient.
 */
struct FOnlineBeaconClientInitParams
{
	FURL URL;
...
class AOnlineBeaconClient : public AOnlineBeacon
{
	 ...
	 *
	 * @param Params Parameters used for initialization of the client.
	 *
	 * @return true if connection is being attempted, false otherwise
	 */
	UE_API bool InitClient(const FOnlineBeaconClientInitParams& Params);
