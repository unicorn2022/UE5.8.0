...
public:
	...
	virtual ~IOnlineSubsystemUtils() = default;
	...
	/**
	 * Static check for whether online PIE is enabled. Safe to call at any point during startup —
	 * uses CDO if UObjectInitialized(), falls back to reading INI + command line auth credentials.
	 */
	static ONLINESUBSYSTEMUTILS_API bool IsOnlinePIEEnabledStatic();
#endif // WITH_EDITOR
};
