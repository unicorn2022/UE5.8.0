...
public:
	...
	virtual void RequestExternalPurchaseToken(const FOnRequestExternalPurchaseTokenComplete& Delegate) const override;
	...
	/**
	 * Asynchronously retrieves the App Store receipt data
	 */
	void GetAppReceipt(TFunction<void(const FString&)> OnComplete);
