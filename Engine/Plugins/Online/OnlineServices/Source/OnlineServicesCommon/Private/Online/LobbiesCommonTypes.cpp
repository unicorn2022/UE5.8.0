...
TOnlineResult<FLobbyClientDataPrepareServiceSnapshot> FLobbyClientData::PrepareServiceSnapshot(FLobbyClientDataPrepareServiceSnapshot::Params&& Params) const
{
	...
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbyClientData::PrepareServiceSnapshot] Failed to prepare lobby service snapshot: Lobby[%ls], Result[%ls]",
	...
	for (const TPair<FAccountId, TSharedRef<FLobbyMemberInternal>>& MemberData : MemberDataStorage)
	{
		...
		if (!Params.LobbySnapshot.Members.Contains(MemberData.Key))
		{
			...
			else
			{
				...
				UE_LOGF(LogOnlineServices, Warning, "[FLobbyClientData::PrepareServiceSnapshot] Member left lobby without giving reason, defaulting to %ls: Lobby[%ls], Member[%ls]",
	...
	for (TPair<FAccountId, FLobbyMemberServiceSnapshot>& MemberSnapshotPair : Params.LobbyMemberSnapshots)
	{
		...
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbyClientData::PrepareServiceSnapshot] Member update ignored for unknown member: Lobby[%ls], Member[%ls]",
		...
		else
		{
			...
			{
				UE_LOGF(LogOnlineServices, Warning, "[FLobbyClientData::PrepareServiceSnapshot] Failed to prepare lobby member service snapshot: Lobby[%ls], Member[%ls], Result[%ls]",
	...
	if (InternalPublicData->OwnerAccountId != Params.LobbySnapshot.OwnerAccountId)
	{
		...
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbyClientData::PrepareServiceSnapshot] Lobby owner chage failed - lobby member data not found: Lobby[%ls], Member[%ls]",
...
FLobbyClientDataCommitServiceSnapshot::Result FLobbyClientData::CommitServiceSnapshot(FLobbyClientDataCommitServiceSnapshot::Params&& Params)
{
	...
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbyClientData::CommitServiceSnapshot] Commit failed, no pending changes found: Lobby[%ls]",
...
TOnlineResult<FLobbyClientDataPrepareClientChanges> FLobbyClientData::PrepareClientChanges(FLobbyClientDataPrepareClientChanges::Params&& Params) const
{
	...
	// Prepare lobby changes.
	{
		...
		if (Params.ClientChanges.LocalName && InternalPublicData->LocalName != *Params.ClientChanges.LocalName)
		{
			...
			{
				UE_LOGF(LogOnlineServices, Warning, "[FLobbyClientData::PrepareClientChanges] Local name chage failed - local name cannot be changed once set: Lobby[%ls], CurrentName[%ls], NewName[%ls]",
		...
		if (Params.ClientChanges.OwnerAccountId && InternalPublicData->OwnerAccountId != Params.ClientChanges.OwnerAccountId)
		{
			...
			{
				UE_LOGF(LogOnlineServices, Warning, "[FLobbyClientData::PrepareClientChanges] Lobby owner chage failed - new owner is not in lobby: Lobby[%ls], NewOwner[%ls]",
		...
		if (Params.ClientChanges.KickedTargetMember)
		{
			...
			{
				UE_LOGF(LogOnlineServices, Warning, "[FLobbyClientData::PrepareClientChanges] Kick target member failed - target is not in the lobby: Lobby[%ls], KickedTargetMember[%ls]",
		...
		if (Params.ClientChanges.LobbySchema || Params.ClientChanges.Attributes)
		{
			...
			{
				UE_LOGF(LogOnlineServices, Warning, "[FLobbyClientData::PrepareClientChanges] Failed to prepare lobby attribute changes: Lobby[%ls], Result[%ls]",
		...
		if (bLobbyDataChanged)
		{
			...
			{
				UE_LOGF(LogOnlineServices, Warning, "[FLobbyClientData::PrepareClientChanges] Failed to prepare lobby changes. LocalAccountId is not the lobby owner: Lobby[%ls], LocalAccountId[%ls], OwnerAccountId[%ls]",
			...
			{
				UE_LOGF(LogOnlineServices, Warning, "[FLobbyClientData::PrepareClientChanges] Failed to prepare lobby changes. Unable to modify the lobby while leaving: Lobby[%ls], LocalAccountId[%ls]",
	...
	// Prepare lobby member changes.
	{
		...
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbyClientData::PrepareClientChanges] Failed to prepare lobby member changes. Member cannot be updated and removed: Lobby[%ls], LocalAccountId[%ls]",
				*ToLogString(InternalPublicData->LobbyId), *ToLogString(Params.LocalAccountId));
			return TOnlineResult<FLobbyClientDataPrepareClientChanges>(Errors::InvalidParams());
		}
		...
		if (Params.ClientChanges.MemberAttributes)
		{
			...
			if (PrepareClientChangesResult.IsError())
			{
				UE_LOGF(LogOnlineServices, Warning, "[FLobbyClientData::PrepareClientChanges] Failed to prepare lobby member attribute changes: Lobby[%ls], LocalMember[%ls], Result[%ls]",
		...
		if (Params.ClientChanges.LocalUserLeaveReason)
		{
			...
			{
				UE_LOGF(LogOnlineServices, Warning, "[FLobbyClientData::PrepareClientChanges] Local user leave faild - user is not in the lobby: Lobby[%ls], LocalAccountId[%ls]",
					*ToLogString(InternalPublicData->LobbyId), *ToLogString(Params.LocalAccountId));
				return TOnlineResult<FLobbyClientDataPrepareClientChanges>(Errors::InvalidParams());
			}
...
FLobbyClientDataCommitClientChanges::Result FLobbyClientData::CommitClientChanges(FLobbyClientDataCommitClientChanges::Params&& Params)
{
	...
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbyClientData::CommitClientChanges] Commit failed, no pending changes found: Lobby[%ls]",
			*ToLogString(InternalPublicData->LobbyId));
		return CommitResult;
	}
