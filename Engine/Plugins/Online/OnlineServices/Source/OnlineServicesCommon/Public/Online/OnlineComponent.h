...
public:
	...
	{
		TOnlineAsyncOpRef<OpType> Op = Services.template GetOp<OpType>(MoveTemp(Params), GetConfigSectionHierarchy(OpType::Name));
	...
	{
		TOnlineAsyncOpRef<OpType> Op = Services.template GetJoinableOp<OpType, ParamsFuncsType>(MoveTemp(Params), GetConfigSectionHierarchy(OpType::Name));
		Op->SetInterfaceName(InterfaceName);
		return Op;
	}
	...
	{
		TOnlineAsyncOpRef<OpType> Op = Services.template GetMergeableOp<OpType, ParamsFuncsType>(MoveTemp(Params), GetConfigSectionHierarchy(OpType::Name));
		Op->SetInterfaceName(InterfaceName);
		return Op;
	}
	...
	TArray<FString> GetConfigSectionHierarchy(const FString& OperationName = FString())
	{
