...
public:
	...
	{ 
		return QueuedOperations.IsEmpty() && InFlightOperations.IsEmpty();
	}
...
public:
	...
	{
		if (InFlightOperation.IsValid())
		{
			ContinuationDelegateHandle.Unbind();
	...
	virtual bool IsIdle() const override
	{
		return QueuedOperations.IsEmpty() && !InFlightOperation.IsValid();
	}
