...
#define PLATFORM_ATTRIBUTE_KEY FString(TEXT("PlatformAttributeKey"))
...
struct FUserPresence
{
	...
	bool operator==(const FUserPresence& Other) const = default;
};
...
inline FPartialUpdatePresence::Params::FMutations& FPartialUpdatePresence::Params::FMutations::operator+=(FPartialUpdatePresence::Params::FMutations&& NewParams)
{
	...
	if (NewParams.RichPresenceString.IsSet())
	{
		RichPresenceString = MoveTemp(NewParams.RichPresenceString);
	}
