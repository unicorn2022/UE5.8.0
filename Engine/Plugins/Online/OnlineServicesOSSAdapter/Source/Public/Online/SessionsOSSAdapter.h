...
private:
	...
	FOnlineSessionSettings BuildV1SettingsForUpdate(const FAccountId& LocalAccountId, const TSharedRef<ISession>& Session, const FSessionSettings& SessionSettings) const;
