...
public:
	...
	static UE_API bool MustAlwaysSendPlatformSessionInvites();
...
private:
	...
	/** Some platforms require a platform invite to be sent along with the in-game invitation, even if the players are not friends in the platform */
	UPROPERTY(config)
	bool bMustAlwaysSendPlatformInvites=true;
