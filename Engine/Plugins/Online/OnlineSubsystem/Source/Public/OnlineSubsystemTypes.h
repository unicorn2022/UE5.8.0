...
public:
	...
	virtual ~IOnlinePlatformData() = default;
...
extern ONLINESUBSYSTEM_API FName NAME_Unset;
...
public:
	...
	virtual ~FSharedContentHandle() = default;
};
...
public:
	FOnlinePagedResult()
		...
		, Total(0)
	{}
	virtual ~FOnlinePagedResult() = default;
...
public:
	virtual ~FOnlinePartyId() = default;
};
...
public:
	...
	virtual ~FOnlineFriendSettingsSourceData() = default;
