...
public:
	...
	/** Show the required Google Play system alternative billing informational dialog */
	virtual void ShowAlternativeBillingInformationDialog(const FOnShowAlternativeBillingInformationDialogComplete& Delegate) override;

	/** Handle response from showing the Google Play alternative billing only information dialog **/
	void OnAlternativeBillingOnlyInformationDialogComplete(EGooglePlayBillingResponseCode InResponseCode);
...
private:
	...
	/** Returns true if the Billing Client is connected and ready */
	bool IsBillingClientConnected();
...
private:
	...
	*/
	...
	/** Is the system dialog already being shown */
	bool bRequestedAlternativeBillingOnlyInformationDialog = false;

	/** Delegate to call when the system dialog is finished */
	FOnShowAlternativeBillingInformationDialogComplete AlternativeBillingOnlyInformationDialogComplete;
