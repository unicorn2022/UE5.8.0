...
namespace UE::Jni::Download
{
	struct FUEDownloadWorker: Java::Lang::FObject
	{
		...
		static void JNICALL nativeAndroidBackgroundDownloadOnProgress(JNIEnv* env, jobject thiz, jstring TaskID, jlong TotalBytesWritten, jlong BytesWrittenSinceLastCall);
		static void JNICALL nativeAndroidBackgroundDownloadOnComplete(JNIEnv* env, jobject thiz, jstring TaskID, jboolean bWasSuccess);
