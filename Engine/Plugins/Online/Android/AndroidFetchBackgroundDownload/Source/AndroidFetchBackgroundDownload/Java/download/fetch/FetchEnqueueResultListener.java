...
public interface FetchEnqueueResultListener
{
	...
	public void OnFetchEnqueueErrorCallback(@NonNull String DestinationLocation, @NonNull Error EnqueueError);
	...
	{
		public FetchEnqueueRequestCallback(@NonNull FetchEnqueueResultListener Owner, @NonNull String DestinationLocation)
		{
			this.Owner = Owner;
		...
		public void call(@NonNull Request result)
		{
			if (Owner != null) 
			{
				Owner.OnFetchEnqueueRequestCallback(DestinationLocation, result);
			}			
			Owner = null;
		}
	...
	{
		public FetchEnqueueErrorCallback(@NonNull FetchEnqueueResultListener Owner, @NonNull String DestinationLocation)
		{
			this.Owner = Owner;
			this.DestinationLocation = DestinationLocation;
		}
		...
		public void call(@NonNull Error error)
		{
			if (Owner != null) 
			{
				Owner.OnFetchEnqueueErrorCallback(DestinationLocation, error);
			}
			Owner = null;
		}
