...
typedef TSharedPtr<class FOnlineTitleFileNull, ESPMode::ThreadSafe> FOnlineTitleFileNullPtr;
#if WITH_ENGINE
...
private:
	...
	/** Interface for title file storage */
	FOnlineTitleFileNullPtr TitleFileInterface;
