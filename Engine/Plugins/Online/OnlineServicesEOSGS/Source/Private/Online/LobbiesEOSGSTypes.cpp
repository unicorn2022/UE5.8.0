	...
	EOS_LobbyId LobbyIdEOS)
{
	...
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsEOS::CreateFromLobbyId] EOS_Lobby_CopyLobbyDetailsHandle Failed: User[%ls], Lobby[%ls], Result[%ls]",
	...
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsEOS::CreateFromLobbyId] FLobbyDetailsInfoEOS::Create Failed: User[%ls], Lobby[%ls], Result[%ls]",
			*ToLogString(LocalAccountId), UTF8_TO_TCHAR(LobbyIdEOS), *ToLogString(EOSResult));
	...
	UE_LOGF(LogOnlineServices, VeryVerbose, "[FLobbyDetailsEOS::CreateFromLobbyId] Succeeded: User[%ls], Lobby[%ls]",
	...
	const char* InviteId)
{
	...
	if (EOSResult != EOS_EResult::EOS_Success)
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsEOS::CreateFromInviteId] EOS_Lobby_CopyLobbyDetailsHandleByInviteId Failed: User[%ls], InviteId[%ls], Result[%ls]",
	...
	if (LobbyDetailsInfoResult.IsError())
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsEOS::CreateFromInviteId] FLobbyDetailsInfoEOS::Create Failed: User[%ls], InviteId[%ls], Result[%ls]",
			*ToLogString(LocalAccountId), UTF8_TO_TCHAR(InviteId), *LobbyDetailsInfoResult.GetErrorValue().GetLogString());
		EOS_LobbyDetails_Release(LobbyDetailsHandle);
		return TDefaultErrorResultInternal<TSharedRef<FLobbyDetailsEOS>>(MoveTemp(LobbyDetailsInfoResult.GetErrorValue()));
	}

	UE_LOGF(LogOnlineServices, VeryVerbose, "[FLobbyDetailsEOS::CreateFromInviteId] Succeeded: User[%ls], InviteId[%ls], Lobby[%ls]",
	...
	EOS_UI_EventId UiEventId)
{
	...
	if (EOSResult != EOS_EResult::EOS_Success)
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsEOS::CreateFromUiEventId] EOS_Lobby_CopyLobbyDetailsHandleByUiEventId Failed: User[%ls], Result[%ls]",
	...
	if (LobbyDetailsInfoResult.IsError())
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsEOS::CreateFromUiEventId] FLobbyDetailsInfoEOS::Create Failed: User[%ls], Result[%ls]",
			*ToLogString(LocalAccountId), *LobbyDetailsInfoResult.GetErrorValue().GetLogString());
		EOS_LobbyDetails_Release(LobbyDetailsHandle);
		return TDefaultErrorResultInternal<TSharedRef<FLobbyDetailsEOS>>(MoveTemp(LobbyDetailsInfoResult.GetErrorValue()));
	}

	UE_LOGF(LogOnlineServices, VeryVerbose, "[FLobbyDetailsEOS::CreateFromUiEventId] Succeeded: User[%ls], Lobby[%ls]",
	...
	uint32_t ResultIndex)
{
	...
	if (EOSResult != EOS_EResult::EOS_Success)
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsEOS::CreateFromSearchResult] EOS_LobbySearch_CopySearchResultByIndex Failed: User[%ls], Result[%ls]",
			*ToLogString(LocalAccountId), *ToLogString(EOSResult));
		return TDefaultErrorResultInternal<TSharedRef<FLobbyDetailsEOS>>(Errors::FromEOSResult(EOSResult));
	}
	...
	if (LobbyDetailsInfoResult.IsError())
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsEOS::CreateFromSearchResult] FLobbyDetailsInfoEOS::Create Failed: User[%ls], Result[%ls]",
			*ToLogString(LocalAccountId), *LobbyDetailsInfoResult.GetErrorValue().GetLogString());
		EOS_LobbyDetails_Release(LobbyDetailsHandle);
		return TDefaultErrorResultInternal<TSharedRef<FLobbyDetailsEOS>>(MoveTemp(LobbyDetailsInfoResult.GetErrorValue()));
	}

	UE_LOGF(LogOnlineServices, VeryVerbose, "[FLobbyDetailsEOS::CreateFromSearchResult] Succeeded: User[%ls], Lobby[%ls]",
		*ToLogString(LocalAccountId), UTF8_TO_TCHAR(LobbyDetailsInfoResult.GetOkValue()->GetLobbyIdEOS()));
...
TFuture<TDefaultErrorResultInternal<FLobbyServiceSnapshot>> FLobbyDetailsEOS::GetLobbySnapshot(bool bCopyMemberData) const
{
	...
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsEOS::GetLobbySnapshot] Failed: Resolver interface missing. Lobby[%ls]",
	...
	.Next([StrongThis = AsShared(), Promise = MoveTemp(Promise), MemberProductUserIds, LobbyOwner](TArray<FAccountId>&& ResolvedAccountIds) mutable
	{
		...
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsEOS::GetLobbySnapshot] ResolveAccountIds Failed: Expected Count[%d], Received Count[%d], Lobby[%ls]",
		...
		// Resolve lobby attributes
		{
			...
			for (uint32_t AttributeIndex = 0; AttributeIndex < AttributeCount; ++AttributeIndex)
			{
				...
				if (EOSResult != EOS_EResult::EOS_Success)
				{
					UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsEOS::GetLobbySnapshot] EOS_LobbyDetails_CopyAttributeByIndex Failed: Lobby[%ls], Result[%ls]",
		...
		UE_LOGF(LogOnlineServices, VeryVerbose, "[FLobbyDetailsEOS::GetLobbySnapshot] Succeeded: Lobby[%ls]",
...
TDefaultErrorResultInternal<FLobbyMemberServiceSnapshot> FLobbyDetailsEOS::GetLobbyMemberSnapshot(FAccountId MemberAccountId) const
{
	...
	// Fetch attributes.
	{
		...
		for (uint32_t MemberAttributeIndex = 0; MemberAttributeIndex < MemberAttributeCount; ++MemberAttributeIndex)
		{
			...
			if (EOSResult != EOS_EResult::EOS_Success)
			{
				UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsEOS::GetLobbyMemberSnapshot] EOS_LobbyDetails_CopyMemberAttributeByIndex Failed: Member[%ls], Lobby[%ls], Result[%ls]",
	...
	UE_LOGF(LogOnlineServices, VeryVerbose, "[FLobbyDetailsEOS::GetLobbyMemberSnapshot] Succeeded: Member[%ls], Lobby[%ls]",
...
TFuture<EOS_EResult> FLobbyDetailsEOS::ApplyLobbyDataUpdateFromLocalChanges(FAccountId LocalAccountId, const FLobbyClientServiceChanges& ServiceChanges) const
{
	...
	if (EOSResult != EOS_EResult::EOS_Success)
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsEOS::ApplyLobbyDataUpdateFromLocalChanges] EOS_Lobby_UpdateLobbyModification Failed: User[%ls], Lobby[%ls], Result[%ls]",
	...
	if (ServiceChanges.JoinPolicy)
	{
		...
		if (EOSResult != EOS_EResult::EOS_Success)
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsEOS::ApplyLobbyDataUpdateFromLocalChanges] EOS_LobbyModification_SetPermissionLevel Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(LocalAccountId), UTF8_TO_TCHAR(GetInfo()->GetLobbyIdEOS()), *LexToString(EOSResult));
			return MakeFulfilledPromise<EOS_EResult>(EOSResult).GetFuture();
		}
	}
	...
	for (const TPair<FSchemaAttributeId, FSchemaServiceAttributeData>& UpdatedAttribute : ServiceChanges.UpdatedAttributes)
	{
		...
		if (EOSResult != EOS_EResult::EOS_Success)
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsEOS::ApplyLobbyDataUpdateFromLocalChanges] EOS_LobbyModification_AddAttribute Failed: User[%ls], Lobby[%ls], Key[%ls], Value[%ls], Result[%ls]",
	...
	for (const FSchemaAttributeId& RemovedAttribute : ServiceChanges.RemovedAttributes)
	{
		...
		if (EOSResult != EOS_EResult::EOS_Success)
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsEOS::ApplyLobbyDataUpdateFromLocalChanges] EOS_LobbyModification_RemoveAttribute Failed: User[%ls], Lobby[%ls], Key[%ls], Result[%ls]",
	...
	for (const TPair<FSchemaAttributeId, FSchemaServiceAttributeData>& UpdatedAttribute : ServiceChanges.UpdatedMemberAttributes)
	{
		...
		if (EOSResult != EOS_EResult::EOS_Success)
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsEOS::ApplyLobbyMemberDataUpdateFromLocalChanges] EOS_LobbyModification_AddMemberAttribute Failed: User[%ls], Lobby[%ls], Key[%ls], Value[%ls], Result[%ls]",
				*ToLogString(LocalAccountId), UTF8_TO_TCHAR(GetInfo()->GetLobbyIdEOS()), *UpdatedAttribute.Key.ToString().ToLower(), *ToLogString(UpdatedAttribute.Value.Value), *LexToString(EOSResult));
			return MakeFulfilledPromise<EOS_EResult>(EOSResult).GetFuture();
		}
	}
	...
	for (const FSchemaAttributeId& RemovedAttribute : ServiceChanges.RemovedMemberAttributes)
	{
		...
		if (EOSResult != EOS_EResult::EOS_Success)
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsEOS::ApplyLobbyMemberDataUpdateFromLocalChanges] EOS_LobbyModification_RemoveMemberAttribute Failed: User[%ls], Lobby[%ls], Key[%ls], Result[%ls]",
				*ToLogString(LocalAccountId), UTF8_TO_TCHAR(GetInfo()->GetLobbyIdEOS()), *RemovedAttribute.ToString().ToLower(), *LexToString(EOSResult));
			return MakeFulfilledPromise<EOS_EResult>(EOSResult).GetFuture();
		}
	}
	...
	[LocalAccountId, LobbyInfo = GetInfo(), Promise = MoveTemp(Promise)](const EOS_Lobby_UpdateLobbyCallbackInfo* Data) mutable
	{
		...
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsEOS::ApplyLobbyDataUpdateFromLocalChanges] EOS_Lobby_UpdateLobby Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(LocalAccountId), UTF8_TO_TCHAR(LobbyInfo->GetLobbyIdEOS()), *LexToString(Data->ResultCode));
		}
		else
		{
			UE_LOGF(LogOnlineServices, VeryVerbose, "[FLobbyDetailsEOS::ApplyLobbyDataUpdateFromLocalChanges] Succeeded: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(LocalAccountId), UTF8_TO_TCHAR(LobbyInfo->GetLobbyIdEOS()), *LexToString(Data->ResultCode));
		}
...
TDefaultErrorResultInternal<TSharedRef<FLobbyDetailsInfoEOS>> FLobbyDetailsInfoEOS::Create(EOS_HLobbyDetails LobbyDetailsHandle)
{
	...
	if (EOSResult != EOS_EResult::EOS_Success)
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsInfoEOS] EOS_LobbyDetails_CopyInfo Failed: Result[%ls]",
	...
	: LobbyDetailsInfo(MoveTemp(InLobbyDetailsInfo))
{
	...
	if (!BucketId.IsValid())
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbyDetailsInfoEOS] Failed: Unable to parse lobby bucket id. Lobby[%ls], Bucket[%ls]",
	...
	FUnregisterFn UnregisterFn)
{
	...
	(TDefaultErrorResultInternal<FLobbyServiceSnapshot>&& Result) mutable
	{
		if (Result.IsError())
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbyDataEOS::Create] FLobbyDetailsEOS::GetLobbySnapshot Failed: Lobby[%ls], Result[%ls]",
		...
		for (FAccountId MemberAccountId : LobbySnapshot.Members)
		{
			...
			{
				UE_LOGF(LogOnlineServices, Warning, "[FLobbyDataEOS::Create] FLobbyDetailsEOS::GetLobbyMemberSnapshot Failed: Lobby[%ls], User[%ls], Result[%ls]",
		...
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbyDataEOS::Create] FLobbyClientData::PrepareServiceSnapshot Failed: Lobby[%ls], Result[%ls]",
		...
		UE_LOGF(LogOnlineServices, VeryVerbose, "[FLobbyDataEOS::Create] Succeeded: Lobby[%ls]",
...
TFuture<TDefaultErrorResultInternal<TSharedRef<FLobbyDataEOS>>> FLobbyDataRegistryEOS::FindOrCreateFromLobbyDetails(FAccountId LocalAccountId, const TSharedRef<FLobbyDetailsEOS>& LobbyDetails)
{
	...
	{
		UE_LOGF(LogOnlineServices, VeryVerbose, "[FLobbyDataRegistryEOS::FindOrCreateFromLobbyDetails] Succeeded: Lobby data already exists. User[%ls], Lobby[%ls]",
	...
	.Next([WeakThis = AsWeak(), Promise = MoveTemp(Promise), LocalAccountId, LobbyDetails](TDefaultErrorResultInternal<TSharedRef<FLobbyDataEOS>>&& Result) mutable
	{
		...
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbyDataRegistryEOS::FindOrCreateFromLobbyDetails] Failed: FLobbyDataRegistryEOS has been destroyed. User[%ls], Lobby[%ls], Result[%ls]",
		...
		if (Result.IsError())
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbyDataRegistryEOS::FindOrCreateFromLobbyDetails] FLobbyDataEOS::Create Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(LocalAccountId), UTF8_TO_TCHAR(LobbyDetails->GetInfo()->GetLobbyIdEOS()), *Result.GetErrorValue().GetLogString());
			Promise.EmplaceValue(MoveTemp(Result.GetErrorValue()));
			return;
		}

		UE_LOGF(LogOnlineServices, VeryVerbose, "[FLobbyDataRegistryEOS::FindOrCreateFromLobbyDetails] Succeeded: Created new lobby data. User[%ls], Lobby[%ls]",
	...
	EOS_ProductUserId Sender)
{
	...
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbyInviteDataEOS::CreateFromInviteId] FLobbyDetailsEOS::CreateFromInviteId Failed: User[%ls], InviteId[%ls], Result[%ls]",
	...
	.Next([Promise = MoveTemp(Promise), InviteId, LocalAccountId, Sender, LobbyDetails](TDefaultErrorResultInternal<TSharedRef<FLobbyDataEOS>>&& Result) mutable
	{
		if (Result.IsError())
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbyInviteDataEOS::CreateFromInviteId] FLobbyDataEOS::FindOrCreateFromLobbyDetails Failed: User[%ls], InviteId[%ls], Lobby[%ls], Result[%ls]",
		...
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbyInviteDataEOS::CreateFromInviteId] Failed: Unable to find account id for sender. User[%ls], InviteId[%ls], Lobby[%ls]",
		...
		UE_LOGF(LogOnlineServices, VeryVerbose, "[FLobbyInviteDataEOS::CreateFromInviteId] Succeeded: User[%ls], Sender[%ls], InviteId[%ls], Lobby[%ls]",
	...
	const FLobbySearchParameters& Params)
{
	...
	if (EOSResult != EOS_EResult::EOS_Success)
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbySearchEOS::Create] EOS_Lobby_CreateLobbySearch Failed: User[%ls], Result[%ls]",
	...
	if (Params.LobbyId) // Search for specific lobby.
	{
		...
		if (!LobbyData)
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbySearchEOS::Create] Failed: Unable to find lobby data for lobby. User[%ls], Lobby[%ls]",
		...
		if (EOSResult != EOS_EResult::EOS_Success)
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbySearchEOS::Create] EOS_LobbySearch_SetLobbyId Failed: User[%ls], Lobby[%ls], Result[%ls]",
	...
	else if (Params.TargetUser) // Search for specific user.
	{
		...
		if (EOSResult != EOS_EResult::EOS_Success)
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbySearchEOS::Create] EOS_LobbySearch_SetTargetUserId Failed: User[%ls], Target[%ls], Result[%ls]",
	...
	else // Search using parameters.
	{
		// Bucket id.
		{
			...
			if (EOSResult != EOS_EResult::EOS_Success)
			{
				UE_LOGF(LogOnlineServices, Warning, "[FLobbySearchEOS::Create] EOS_LobbySearch_SetParameter Failed: User[%ls], Key[%ls], Result[%ls]",
		...
		for (const FFindLobbySearchFilter& Filter : Params.Filters)
		{
			...
			{
				UE_LOGF(LogOnlineServices, Warning, "[FLobbySearchEOS::Create] VerifyBaseAttributeData failed: User[%ls], Key[%ls], Value[%ls]",
			...
			if (EOSResult != EOS_EResult::EOS_Success)
			{
				UE_LOGF(LogOnlineServices, Warning, "[FLobbySearchEOS::Create] EOS_LobbySearch_SetParameter Failed: User[%ls], Key[%ls], Value[%ls], Result[%ls]",
	...
	](const EOS_LobbySearch_FindCallbackInfo* Data) mutable
	{
		...
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbySearchEOS::Create] EOS_LobbySearch_Find Failed: User[%ls], Result[%ls]",
		...
		for (uint32_t SearchResultIndex = 0; SearchResultIndex < NumSearchResults; ++SearchResultIndex)
		{
			...
			if (Result.IsError())
			{
				UE_LOGF(LogOnlineServices, Warning, "[FLobbySearchEOS::Create] FLobbyDetailsEOS::CreateFromSearchResult Failed: User[%ls], Result[%ls]",
		...
		.Next([LocalAccountId, Promise = MoveTemp(Promise), SearchHandle](TArray<TDefaultErrorResultInternal<TSharedRef<FLobbyDataEOS>>>&& ResultArray) mutable
		{
			...
			for (TDefaultErrorResultInternal<TSharedRef<FLobbyDataEOS>>& Result : ResultArray)
			{
				if (Result.IsError())
				{
					UE_LOGF(LogOnlineServices, Warning, "[FLobbySearchEOS::Create] FLobbyDataRegistryEOS::FindOrCreateFromLobbyDetails Failed: Unable to resolve search result. User[%ls], Result[%ls]",
						*ToLogString(LocalAccountId), *Result.GetErrorValue().GetLogString());
					Promise.EmplaceValue(MoveTemp(Result.GetErrorValue()));
					return;
				}
			...
			UE_LOGF(LogOnlineServices, VeryVerbose, "[FLobbySearchEOS::Create] Succeeded: User[%ls], NumResults[%d]",
