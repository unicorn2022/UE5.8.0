...
TOnlineAsyncOpHandle<FCreateLobby> FLobbiesEOSGS::CreateLobby(FCreateLobby::Params&& InParams)
{
		...
		FOnlineError ErrorResult) -> TFuture<void>
	{
		...
		](TDefaultErrorResult<FLobbiesDestroyLobbyImpl>&& Result) mutable
		{
			if (Result.IsError())
			{
				UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::CreateLobby] DestroyLobbyImpl Failed: User[%ls], Lobby[%ls], Result[%ls]",
	...
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::CreateLobby] Failed: User is not logged in. User[%ls]", *ToLogString(Params.LocalAccountId));
	...
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::CreateLobby] Failed: Unknown lobby schema [%ls]", *Params.SchemaId.ToString().ToLower());
	...
	if (Params.bPresenceEnabled)
	{
		...
		{
			UE_LOGF(LogTemp, Warning, "[%ls] Failed: bPresenceEnabled was set to true, but there is already a presence Lobby", UTF8_TO_TCHAR(__FUNCTION__));
	...
	.Then([this](TOnlineAsyncOp<FCreateLobby>& InAsyncOp, const EOS_Lobby_CreateLobbyCallbackInfo* Data)
	{
		...
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::CreateLobby] EOS_Lobby_CreateLobby Failed: User[%ls], Result[%ls]",
	...
	.Then([this, DestroyLobbyDuringCreate](TOnlineAsyncOp<FCreateLobby>& InAsyncOp)
	{
		...
		if (Result.IsError())
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::CreateLobby] FLobbyDetailsEOS::CreateFromLobbyId Failed: User[%ls], Lobby[%ls], Result[%ls]",
	...
	.Then([this, DestroyLobbyDuringCreate](TOnlineAsyncOp<FCreateLobby>& InAsyncOp, TDefaultErrorResultInternal<TSharedRef<FLobbyDataEOS>>&& Result)
	{
		...
		if (Result.IsError())
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::CreateLobby] FLobbyDataRegistryEOS::FindOrCreateFromLobbyDetails Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(Params.LocalAccountId), *LobbyIdString, *Result.GetErrorValue().GetLogString());
	...
	.Then([this](TOnlineAsyncOp<FCreateLobby>& InAsyncOp)
	{
		...
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::CreateLobby] PrepareClientChanges Failed: User[%ls], Lobby[%ls], Result[%ls]",
	...
	.Then([this, DestroyLobbyDuringCreate](TOnlineAsyncOp<FCreateLobby>& InAsyncOp, TDefaultErrorResult<FLobbiesModifyLobbyDataImpl>&& Result) mutable
	{
		...
		if (Result.IsError())
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::CreateLobby] ModifyLobbyDataImpl Failed: User[%ls], Lobby[%ls], Result[%ls]",
	...
	.Then([this](TOnlineAsyncOp<FCreateLobby>& InAsyncOp)
	{
		...
		UE_LOGF(LogOnlineServices, Log, "[FLobbiesEOSGS::CreateLobby] Succeeded: User[%ls], Lobby[%ls]",
...
TOnlineAsyncOpHandle<FFindLobbies> FLobbiesEOSGS::FindLobbies(FFindLobbies::Params&& InParams)
{
	...
	if (!Services.GetAuthInterface()->IsLoggedIn(Params.LocalAccountId))
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::FindLobbies] Failed: User is not logged in. User[%ls]", *ToLogString(Params.LocalAccountId));
		Op->SetError(Errors::InvalidUser());
		return Op->GetHandle();
	}
	...
	.Then([this](TOnlineAsyncOp<FFindLobbies>& InAsyncOp, TDefaultErrorResultInternal<TSharedRef<FLobbySearchEOS>> Result)
	{
		if (Result.IsError())
		{
			...
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::JoinLobby] FLobbySearchEOS::Create Failed: User[%ls], Result[%ls]",
	...
	.Then([this](TOnlineAsyncOp<FFindLobbies>& InAsyncOp)
	{
		...
		UE_LOGF(LogOnlineServices, Log, "[FLobbiesEOSGS::FindLobbies] Succeeded: User[%ls]",
...
TOnlineAsyncOpHandle<FJoinLobby> FLobbiesEOSGS::JoinLobby(FJoinLobby::Params&& InParams)
{
		...
		FOnlineError ErrorResult) -> TFuture<void>
	{
		...
		](TDefaultErrorResult<FLobbiesLeaveLobbyImpl>&& Result) mutable
		{
			if (Result.IsError())
			{
				UE_LOGF(LogTemp, Warning, "[FLobbiesEOSGS::JoinLobby] LeaveLobbyImpl Failed: User[%ls], Lobby[%ls], Result[%ls]",
	...
	if (!Services.GetAuthInterface()->IsLoggedIn(Params.LocalAccountId))
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::JoinLobby] Failed: User is not logged in. User[%ls]", *ToLogString(Params.LocalAccountId));
		Op->SetError(Errors::InvalidUser());
		return Op->GetHandle();
	}
	...
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::JoinLobby] Failed: Lobby id is invalid.");
		Op->SetError(Errors::InvalidParams());
		return Op->GetHandle();
	}
	...
	if (!LobbyData)
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::JoinLobby] Failed: Unable to find lobby data. LobbyId[%ls]", *ToLogString(Params.LobbyId));
		Op->SetError(Errors::InvalidParams());
		return Op->GetHandle();
	}
	...
	if (!LobbyDetails)
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::JoinLobby] Failed: Unable to find lobby details for user. User[%ls], Lobby[%ls]",
			*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString());
		Op->SetError(Errors::InvalidParams());
		return Op->GetHandle();
	}
	...
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::JoinLobby] Failed: Lobby is not compatible with the client version. Lobby[%ls], Bucket[%ls], ExpectedBucket[%ls].",
	...
	.Then([this](TOnlineAsyncOp<FJoinLobby>& InAsyncOp, const EOS_Lobby_JoinLobbyCallbackInfo* Data)
	{
		if (Data->ResultCode != EOS_EResult::EOS_Success)
		{
			...
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::JoinLobby] EOS_Lobby_JoinLobby Failed: User[%ls], Lobby[%ls], Result[%ls]",
	...
	.Then([this, LeaveLobbyDuringJoin](TOnlineAsyncOp<FJoinLobby>& InAsyncOp)
	{
		...
		if (Result.IsError())
		{
			UE_LOGF(LogTemp, Warning, "[FLobbiesEOSGS::JoinLobby] FLobbyDetailsEOS::CreateFromLobbyId Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(Params.LocalAccountId), *LobbyIdString, *Result.GetErrorValue().GetLogString());
	...
	.Then([this, LeaveLobbyDuringJoin](TOnlineAsyncOp<FJoinLobby>& InAsyncOp, TDefaultErrorResultInternal<TSharedRef<FLobbyDataEOS>>&& Result)
	{
		...
		if (Result.IsError())
		{
			UE_LOGF(LogTemp, Warning, "[FLobbiesEOSGS::JoinLobby] FLobbyDataRegistryEOS::FindOrCreateFromLobbyDetails Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString(), *Result.GetErrorValue().GetLogString());
			return LeaveLobbyDuringJoin(InAsyncOp, Params.LocalAccountId, LobbyData, MoveTemp(Result.GetErrorValue()));
		}
		else
	...
	.Then([this](TOnlineAsyncOp<FJoinLobby>& InAsyncOp)
	{
		...
		if (PrepareResult.IsError())
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::JoinLobby] PrepareClientChanges Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString(), *PrepareResult.GetErrorValue().GetLogString());
			InAsyncOp.SetError(MoveTemp(PrepareResult.GetErrorValue()));
			return MakeFulfilledPromise<TDefaultErrorResult<FLobbiesModifyLobbyDataImpl>>(FLobbiesModifyLobbyDataImpl::Result{}).GetFuture();
		}
	...
	.Then([this, LeaveLobbyDuringJoin](TOnlineAsyncOp<FJoinLobby>& InAsyncOp, TDefaultErrorResult<FLobbiesModifyLobbyDataImpl>&& Result)
	{
		if (Result.IsError())
		{
			...
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::JoinLobby] ModifyLobbyMemberDataImpl Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString(), *Result.GetErrorValue().GetLogString());
	...
	.Then([this](TOnlineAsyncOp<FJoinLobby>& InAsyncOp)
	{
		...
		UE_LOGF(LogOnlineServices, Log, "[FLobbiesEOSGS::JoinLobby] Succeeded: User[%ls], Lobby[%ls]",
			*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString());
...
TOnlineAsyncOpHandle<FLeaveLobby> FLobbiesEOSGS::LeaveLobby(FLeaveLobby::Params&& InParams)
{
	...
	if (!Services.GetAuthInterface()->IsLoggedIn(Params.LocalAccountId))
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::LeaveLobby] Failed: User is not logged in. User[%ls]", *ToLogString(Params.LocalAccountId));
		Op->SetError(Errors::InvalidUser());
		return Op->GetHandle();
	}
	...
	if (!Params.LobbyId.IsValid())
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::LeaveLobby] Failed: Lobby id is invalid.");
		Op->SetError(Errors::InvalidParams());
		return Op->GetHandle();
	}
	...
	if (!LobbyData)
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::LeaveLobby] Failed: Unable to find lobby data. LobbyId[%ls]", *ToLogString(Params.LobbyId));
		Op->SetError(Errors::InvalidParams());
		return Op->GetHandle();
	}
	Op->Data.Set<TSharedRef<FLobbyDataEOS>>(UE_ONLINE_LOBBY_EOS_KEY_NAME_LOBBY_DATA, LobbyData.ToSharedRef());
	...
	Op->Then([this](TOnlineAsyncOp<FLeaveLobby>& InAsyncOp)
	{
		...
		if (PrepareResult.IsError())
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::KickLobbyMember] PrepareClientChanges Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString(), *PrepareResult.GetErrorValue().GetLogString());
			InAsyncOp.SetError(MoveTemp(PrepareResult.GetErrorValue()));
	...
	.Then([this](TOnlineAsyncOp<FLeaveLobby>& InAsyncOp, TDefaultErrorResult<FLobbiesLeaveLobbyImpl>&& Result)
	{
		if (Result.IsError())
		{
			...
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::LeaveLobby] LeaveLobbyImpl Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString(), *Result.GetErrorValue().GetLogString());
	...
	.Then([this](TOnlineAsyncOp<FLeaveLobby>& InAsyncOp)
	{
		...
		UE_LOGF(LogOnlineServices, Log, "[FLobbiesEOSGS::LeaveLobby] Succeeded: User[%ls], Lobby[%ls]",
			*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString());
...
TOnlineAsyncOpHandle<FInviteLobbyMember> FLobbiesEOSGS::InviteLobbyMember(FInviteLobbyMember::Params&& InParams)
{
	...
	if (!Services.GetAuthInterface()->IsLoggedIn(Params.LocalAccountId))
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::InviteLobbyMember] Failed: User is not logged in. User[%ls]", *ToLogString(Params.LocalAccountId));
		Op->SetError(Errors::InvalidUser());
		return Op->GetHandle();
	}
	...
	if (!Params.LobbyId.IsValid())
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::InviteLobbyMember] Failed: Lobby id is invalid.");
		Op->SetError(Errors::InvalidParams());
		return Op->GetHandle();
	}
	...
	if (!LobbyData)
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::InviteLobbyMember] Failed: Unable to find lobby data. LobbyId[%ls]", *ToLogString(Params.LobbyId));
		Op->SetError(Errors::InvalidParams());
		return Op->GetHandle();
	}
	Op->Data.Set<TSharedRef<FLobbyDataEOS>>(UE_ONLINE_LOBBY_EOS_KEY_NAME_LOBBY_DATA, LobbyData.ToSharedRef());
	...
	.Then([this](TOnlineAsyncOp<FInviteLobbyMember>& InAsyncOp, TDefaultErrorResult<FLobbiesInviteLobbyMemberImpl>&& Result)
	{
		if (Result.IsError())
		{
			...
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::InviteLobbyMember] InviteLobbyMemberImpl Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString(), *Result.GetErrorValue().GetLogString());
			InAsyncOp.SetError(MoveTemp(Result.GetErrorValue()));
			return;
		}
	...
	.Then([this](TOnlineAsyncOp<FInviteLobbyMember>& InAsyncOp)
	{
		...
		UE_LOGF(LogOnlineServices, Verbose, "[FLobbiesEOSGS::InviteLobbyMember] Succeeded: User[%ls], Lobby[%ls]",
			*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString());
...
TOnlineAsyncOpHandle<FDeclineLobbyInvitation> FLobbiesEOSGS::DeclineLobbyInvitation(FDeclineLobbyInvitation::Params&& InParams)
{
	...
	if (!Services.GetAuthInterface()->IsLoggedIn(Params.LocalAccountId))
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::DeclineLobbyInvitation] Failed: User is not logged in. User[%ls]", *ToLogString(Params.LocalAccountId));
		Op->SetError(Errors::InvalidUser());
		return Op->GetHandle();
	}
	...
	if (!Params.LobbyId.IsValid())
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::DeclineLobbyInvitation] Failed: Lobby id is invalid.");
		Op->SetError(Errors::InvalidParams());
		return Op->GetHandle();
	}
	...
	if (!LobbyData)
	{
		UE_LOGF(LogTemp, Warning, "[FLobbiesEOSGS::JoinLobby] Failed: Unable to find lobby data. LobbyId[%ls]", *ToLogString(Params.LobbyId));
		Op->SetError(Errors::InvalidParams());
		return Op->GetHandle();
	}
	Op->Data.Set<TSharedRef<FLobbyDataEOS>>(UE_ONLINE_LOBBY_EOS_KEY_NAME_LOBBY_DATA, LobbyData.ToSharedRef());
	...
	.Then([this](TOnlineAsyncOp<FDeclineLobbyInvitation>& InAsyncOp, TDefaultErrorResult<FLobbiesDeclineLobbyInvitationImpl>&& Result)
	{
		if (Result.IsError())
		{
			...
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::DeclineLobbyInvitation] DeclineLobbyInvitationImpl Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString(), *Result.GetErrorValue().GetLogString());
			InAsyncOp.SetError(MoveTemp(Result.GetErrorValue()));
			return;
		}
	...
	.Then([this](TOnlineAsyncOp<FDeclineLobbyInvitation>& InAsyncOp)
	{
		...
		UE_LOGF(LogOnlineServices, Verbose, "[FLobbiesEOSGS::DeclineLobbyInvitation] Succeeded: User[%ls], Lobby[%ls]",
			*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString());
...
TOnlineAsyncOpHandle<FKickLobbyMember> FLobbiesEOSGS::KickLobbyMember(FKickLobbyMember::Params&& InParams)
{
	...
	if (!Services.GetAuthInterface()->IsLoggedIn(Params.LocalAccountId))
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::KickLobbyMember] Failed: User is not logged in. User[%ls]", *ToLogString(Params.LocalAccountId));
		Op->SetError(Errors::InvalidUser());
		return Op->GetHandle();
	}
	...
	if (!Params.LobbyId.IsValid())
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::KickLobbyMember] Failed: Lobby id is invalid.");
		Op->SetError(Errors::InvalidParams());
		return Op->GetHandle();
	}
	...
	if (!LobbyData)
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::KickLobbyMember] Failed: Unable to find lobby data. LobbyId[%ls]", *ToLogString(Params.LobbyId));
		Op->SetError(Errors::InvalidParams());
		return Op->GetHandle();
	}
	Op->Data.Set<TSharedRef<FLobbyDataEOS>>(UE_ONLINE_LOBBY_EOS_KEY_NAME_LOBBY_DATA, LobbyData.ToSharedRef());
	...
	.Then([this](TOnlineAsyncOp<FKickLobbyMember>& InAsyncOp, TDefaultErrorResult<FLobbiesKickLobbyMemberImpl>&& Result)
	{
		if (Result.IsError())
		{
			...
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::KickLobbyMember] KickLobbyMemberImpl Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString(), *Result.GetErrorValue().GetLogString());
			InAsyncOp.SetError(MoveTemp(Result.GetErrorValue()));
		}
	})
	.Then([this](TOnlineAsyncOp<FKickLobbyMember>& InAsyncOp)
	{
		...
		UE_LOGF(LogOnlineServices, Verbose, "[FLobbiesEOSGS::KickLobbyMember] Succeeded: User[%ls], Lobby[%ls]",
			*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString());
...
TOnlineAsyncOpHandle<FPromoteLobbyMember> FLobbiesEOSGS::PromoteLobbyMember(FPromoteLobbyMember::Params&& InParams)
{
	...
	if (!Services.GetAuthInterface()->IsLoggedIn(Params.LocalAccountId))
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::FPromoteLobbyMember] Failed: User is not logged in. User[%ls]", *ToLogString(Params.LocalAccountId));
		Op->SetError(Errors::InvalidUser());
		return Op->GetHandle();
	}
	...
	if (!Params.LobbyId.IsValid())
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::FPromoteLobbyMember] Failed: Lobby id is invalid.");
		Op->SetError(Errors::InvalidParams());
		return Op->GetHandle();
	}
	...
	if (!LobbyData)
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::FPromoteLobbyMember] Failed: Unable to find lobby data. LobbyId[%ls]", *ToLogString(Params.LobbyId));
		Op->SetError(Errors::InvalidParams());
		return Op->GetHandle();
	}
	Op->Data.Set<TSharedRef<FLobbyDataEOS>>(UE_ONLINE_LOBBY_EOS_KEY_NAME_LOBBY_DATA, LobbyData.ToSharedRef());
	...
	Op->Then([this](TOnlineAsyncOp<FPromoteLobbyMember>& InAsyncOp)
	{
		...
		if (PrepareResult.IsError())
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::FPromoteLobbyMember] PrepareClientChanges Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString(), *PrepareResult.GetErrorValue().GetLogString());
			InAsyncOp.SetError(MoveTemp(PrepareResult.GetErrorValue()));
	...
	.Then([this](TOnlineAsyncOp<FPromoteLobbyMember>& InAsyncOp, TDefaultErrorResult<FLobbiesPromoteLobbyMemberImpl>&& Result)
	{
		if (Result.IsError())
		{
			...
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::FPromoteLobbyMember] PromoteLobbyMemberImpl Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString(), *Result.GetErrorValue().GetLogString());
			InAsyncOp.SetError(MoveTemp(Result.GetErrorValue()));
			return;
		}
	...
	.Then([this](TOnlineAsyncOp<FPromoteLobbyMember>& InAsyncOp)
	{
		...
		UE_LOGF(LogOnlineServices, Verbose, "[FLobbiesEOSGS::FPromoteLobbyMember] Succeeded: User[%ls], Lobby[%ls]",
			*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString());
...
TOnlineAsyncOpHandle<FModifyLobbyJoinPolicy> FLobbiesEOSGS::ModifyLobbyJoinPolicy(FModifyLobbyJoinPolicy::Params&& InParams)
{
	...
	if (!Services.GetAuthInterface()->IsLoggedIn(Params.LocalAccountId))
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ModifyLobbyJoinPolicy] Failed: User is not logged in. User[%ls]", *ToLogString(Params.LocalAccountId));
		Op->SetError(Errors::InvalidUser());
		return Op->GetHandle();
	}
	...
	if (!Params.LobbyId.IsValid())
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ModifyLobbyJoinPolicy] Failed: Lobby id is invalid.");
		Op->SetError(Errors::InvalidParams());
		return Op->GetHandle();
	}
	...
	if (!LobbyData)
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ModifyLobbyJoinPolicy] Failed: Unable to find lobby data. LobbyId[%ls]", *ToLogString(Params.LobbyId));
		Op->SetError(Errors::InvalidParams());
		return Op->GetHandle();
	}
	Op->Data.Set<TSharedRef<FLobbyDataEOS>>(UE_ONLINE_LOBBY_EOS_KEY_NAME_LOBBY_DATA, LobbyData.ToSharedRef());
	...
	Op->Then([this](TOnlineAsyncOp<FModifyLobbyJoinPolicy>& InAsyncOp)
	{
		...
		if (PrepareResult.IsError())
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ModifyLobbyJoinPolicy] PrepareClientChanges Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString(), *PrepareResult.GetErrorValue().GetLogString());
			InAsyncOp.SetError(MoveTemp(PrepareResult.GetErrorValue()));
			return MakeFulfilledPromise<TDefaultErrorResult<FLobbiesModifyLobbyDataImpl>>(FLobbiesModifyLobbyDataImpl::Result{}).GetFuture();
		}
	...
	.Then([this](TOnlineAsyncOp<FModifyLobbyJoinPolicy>& InAsyncOp, TDefaultErrorResult<FLobbiesModifyLobbyDataImpl>&& Result)
	{
		if (Result.IsError())
		{
			...
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ModifyLobbyJoinPolicy] ModifyLobbyDataImpl Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString(), *Result.GetErrorValue().GetLogString());
			InAsyncOp.SetError(MoveTemp(Result.GetErrorValue()));
			return;
		}
	...
	.Then([this](TOnlineAsyncOp<FModifyLobbyJoinPolicy>& InAsyncOp)
	{
		...
		UE_LOGF(LogOnlineServices, Verbose, "[FLobbiesEOSGS::ModifyLobbyJoinPolicy] Succeeded: User[%ls], Lobby[%ls]",
			*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString());
...
TOnlineAsyncOpHandle<FModifyLobbyAttributes> FLobbiesEOSGS::ModifyLobbyAttributes(FModifyLobbyAttributes::Params&& InParams)
{
	...
	if (!Services.GetAuthInterface()->IsLoggedIn(Params.LocalAccountId))
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ModifyLobbyAttributes] Failed: User is not logged in. User[%ls]", *ToLogString(Params.LocalAccountId));
		Op->SetError(Errors::InvalidUser());
		return Op->GetHandle();
	}
	...
	if (!Params.LobbyId.IsValid())
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ModifyLobbyAttributes] Failed: Lobby id is invalid.");
		Op->SetError(Errors::InvalidParams());
		return Op->GetHandle();
	}
	...
	if (!LobbyData)
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ModifyLobbyAttributes] Failed: Unable to find lobby data. LobbyId[%ls]", *ToLogString(Params.LobbyId));
		Op->SetError(Errors::InvalidParams());
		return Op->GetHandle();
	}
	Op->Data.Set<TSharedRef<FLobbyDataEOS>>(UE_ONLINE_LOBBY_EOS_KEY_NAME_LOBBY_DATA, LobbyData.ToSharedRef());
	...
	Op->Then([this](TOnlineAsyncOp<FModifyLobbyAttributes>& InAsyncOp)
	{
		...
		if (PrepareResult.IsError())
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ModifyLobbyAttributes] PrepareClientChanges Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString(), *PrepareResult.GetErrorValue().GetLogString());
			InAsyncOp.SetError(MoveTemp(PrepareResult.GetErrorValue()));
			return MakeFulfilledPromise<TDefaultErrorResult<FLobbiesModifyLobbyDataImpl>>(FLobbiesModifyLobbyDataImpl::Result{}).GetFuture();
		}
	...
	.Then([this](TOnlineAsyncOp<FModifyLobbyAttributes>& InAsyncOp, TDefaultErrorResult<FLobbiesModifyLobbyDataImpl>&& Result)
	{
		if (Result.IsError())
		{
			...
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ModifyLobbyAttributes] ModifyLobbyDataImpl Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString(), *Result.GetErrorValue().GetLogString());
			InAsyncOp.SetError(MoveTemp(Result.GetErrorValue()));
			return;
		}
	...
	.Then([this](TOnlineAsyncOp<FModifyLobbyAttributes>& InAsyncOp)
	{
		...
		UE_LOGF(LogOnlineServices, Verbose, "[FLobbiesEOSGS::ModifyLobbyAttributes] Succeeded: User[%ls], Lobby[%ls]",
			*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString());
...
TOnlineAsyncOpHandle<FModifyLobbyMemberAttributes> FLobbiesEOSGS::ModifyLobbyMemberAttributes(FModifyLobbyMemberAttributes::Params&& InParams)
{
	...
	if (!Services.GetAuthInterface()->IsLoggedIn(Params.LocalAccountId))
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ModifyLobbyMemberAttributes] Failed: User is not logged in. User[%ls]", *ToLogString(Params.LocalAccountId));
		Op->SetError(Errors::InvalidUser());
		return Op->GetHandle();
	}
	...
	if (!Params.LobbyId.IsValid())
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ModifyLobbyMemberAttributes] Failed: Lobby id is invalid.");
		Op->SetError(Errors::InvalidParams());
		return Op->GetHandle();
	}
	...
	if (!LobbyData)
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ModifyLobbyMemberAttributes] Failed: Unable to find lobby data. LobbyId[%ls]", *ToLogString(Params.LobbyId));
		Op->SetError(Errors::InvalidParams());
		return Op->GetHandle();
	}
	Op->Data.Set<TSharedRef<FLobbyDataEOS>>(UE_ONLINE_LOBBY_EOS_KEY_NAME_LOBBY_DATA, LobbyData.ToSharedRef());
	...
	Op->Then([this](TOnlineAsyncOp<FModifyLobbyMemberAttributes>& InAsyncOp)
	{
		...
		if (PrepareResult.IsError())
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ModifyLobbyMemberAttributes] PrepareClientChanges Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString(), *PrepareResult.GetErrorValue().GetLogString());
			InAsyncOp.SetError(MoveTemp(PrepareResult.GetErrorValue()));
			return MakeFulfilledPromise<TDefaultErrorResult<FLobbiesModifyLobbyDataImpl>>(FLobbiesModifyLobbyDataImpl::Result{}).GetFuture();
		}
	...
	.Then([this](TOnlineAsyncOp<FModifyLobbyMemberAttributes>& InAsyncOp, TDefaultErrorResult<FLobbiesModifyLobbyDataImpl>&& Result)
	{
		if (Result.IsError())
		{
			...
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ModifyLobbyMemberAttributes] ModifyLobbyMemberDataImpl Failed: User[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString(), *Result.GetErrorValue().GetLogString());
			InAsyncOp.SetError(MoveTemp(Result.GetErrorValue()));
			return;
		}
	...
	.Then([this](TOnlineAsyncOp<FModifyLobbyMemberAttributes>& InAsyncOp)
	{
		...
		UE_LOGF(LogOnlineServices, Verbose, "[FLobbiesEOSGS::ModifyLobbyMemberAttributes] Succeeded: User[%ls], Lobby[%ls]",
			*ToLogString(Params.LocalAccountId), *LobbyData->GetLobbyIdString());
	...
	if (TSharedPtr<FLobbyDataEOS> LobbyData = LobbyDataRegistry->Find(Data->LobbyId))
	{
		...
		.OnComplete([LobbyData](const TOnlineResult<FLobbiesProcessLobbyNotificationImpl>& Result)
		{
			if (Result.IsError())
			{
				...
				UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::HandleLobbyUpdated] ProcessLobbyNotificationImplOp Failed: Lobby[%ls], Result[%ls]",
					*LobbyData->GetLobbyIdString(), *Result.GetErrorValue().GetLogString());
			}
			else
			{
				UE_LOGF(LogOnlineServices, Verbose, "[FLobbiesEOSGS::HandleLobbyUpdated] Succeeded: Lobby[%ls]",
...
void FLobbiesEOSGS::HandleLobbyMemberUpdated(const EOS_Lobby_LobbyMemberUpdateReceivedCallbackInfo* Data)
{
	if (TSharedPtr<FLobbyDataEOS> LobbyData = LobbyDataRegistry->Find(Data->LobbyId))
	{
		...
		.OnComplete([LobbyData](const TOnlineResult<FLobbiesProcessLobbyNotificationImpl>& Result)
		{
			...
			{
				// Todo: handle failure to update lobby from snapshot.
				UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::HandleLobbyMemberUpdated] ProcessLobbyNotificationImplOp Failed: Lobby[%ls], Result[%ls]",
					*LobbyData->GetLobbyIdString(), *Result.GetErrorValue().GetLogString());
			}
			else
			{
				UE_LOGF(LogOnlineServices, Verbose, "[FLobbiesEOSGS::HandleLobbyMemberUpdated] Succeeded: Lobby[%ls]",
					*LobbyData->GetLobbyIdString());
			}
		});
	}
...
void FLobbiesEOSGS::HandleLobbyMemberStatusReceived(const EOS_Lobby_LobbyMemberStatusReceivedCallbackInfo* Data)
{
	if (TSharedPtr<FLobbyDataEOS> LobbyData = LobbyDataRegistry->Find(Data->LobbyId))
	{
		...
		.OnComplete([LobbyData](const TOnlineResult<FLobbiesProcessLobbyNotificationImpl>& Result)
		{
			...
			{
				// Todo: handle failure to update lobby from snapshot.
				UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::HandleLobbyMemberStatusReceived] ProcessLobbyNotificationImplOp Failed: Lobby[%ls], Result[%ls]",
					*LobbyData->GetLobbyIdString(), *Result.GetErrorValue().GetLogString());
			}
			else
			{
				UE_LOGF(LogOnlineServices, Verbose, "[FLobbiesEOSGS::HandleLobbyMemberStatusReceived] Succeeded: Lobby[%ls]",
					*LobbyData->GetLobbyIdString());
			}
		});
	}
	...
	if (LocalAccountId.IsValid())
	{
		...
		.Next([this](TDefaultErrorResultInternal<TSharedRef<FLobbyInviteDataEOS>>&& Result)
		{
			if (Result.IsError())
			{
				...
				UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::HandleLobbyInviteReceived] FLobbyInviteDataEOS::CreateFromInviteId Failed: Result[%ls]",
					*Result.GetErrorValue().GetLogString());
			}
			else
			{
				UE_LOGF(LogOnlineServices, Verbose, "[FLobbiesEOSGS::HandleLobbyMemberStatusReceived] Succeeded: InviteId[%ls], Lobby[%ls], Receiver[%ls], Sender[%ls]",
...
void FLobbiesEOSGS::HandleLobbyInviteAccepted(const EOS_Lobby_LobbyInviteAcceptedCallbackInfo* Data)
{
	...
	if (LocalAccountId.IsValid())
	{
		...
		.Next([this](TDefaultErrorResultInternal<TSharedRef<FLobbyInviteDataEOS>>&& Result)
		{
			...
			{
				// Todo: Log / queue a manual fetch of invitations.
				UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::HandleLobbyInviteAccepted] FLobbyInviteDataEOS::CreateFromInviteId Failed: Result[%ls]",
					*Result.GetErrorValue().GetLogString());
			}
			else
			{
				UE_LOGF(LogOnlineServices, Verbose, "[FLobbiesEOSGS::HandleLobbyInviteAccepted] Succeeded: InviteId[%ls], Lobby[%ls], Receiver[%ls], Sender[%ls]",
					*Result.GetOkValue()->GetInviteId(),
					*Result.GetOkValue()->GetLobbyData()->GetLobbyIdString(),
					*ToLogString(Result.GetOkValue()->GetReceiver()),
					*ToLogString(Result.GetOkValue()->GetSender()));
...
void FLobbiesEOSGS::HandleJoinLobbyAccepted(const EOS_Lobby_JoinLobbyAcceptedCallbackInfo* Data)
{
	...
	if (LocalAccountId.IsValid())
	{
		...
		{
			// Todo: Log / queue a manual fetch of invitations.
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::HandleJoinLobbyAccepted] FLobbyDetailsEOS::CreateFromUiEventId Failed: User[%ls], Result[%ls]",
		...
		.Next([this, LocalAccountId](TDefaultErrorResultInternal<TSharedRef<FLobbyDataEOS>> && Result)
		{
			if (Result.IsError())
			{
				UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::HandleJoinLobbyAccepted] FLobbyDataRegistryEOS::FindOrCreateFromLobbyDetails Failed: User[%ls], Result[%ls]",
					*ToLogString(LocalAccountId), *Result.GetErrorValue().GetLogString());
			}
			else
			{
				UE_LOGF(LogOnlineServices, Verbose, "[FLobbiesEOSGS::HandleJoinLobbyAccepted] Succeeded: User[%ls], Lobby[%ls]",
	...
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::HandleJoinLobbyAccepted] Failed: Invalid local user.");
	}
}
...
TFuture<TDefaultErrorResult<FLobbiesLeaveLobbyImpl>> FLobbiesEOSGS::LeaveLobbyImpl(FLobbiesLeaveLobbyImpl::Params&& Params)
{
	...
	if (!Services.GetAuthInterface()->IsLoggedIn(Params.LocalAccountId))
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::LeaveLobbyImpl] Failed: User is not logged in. User[%ls]", *ToLogString(Params.LocalAccountId));
	...
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::LeaveLobbyImpl] Failed: No lobby data provided.");
	...
	](const EOS_Lobby_LeaveLobbyCallbackInfo* Result) mutable
	{
		...
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::DestroyLobbyImpl] EOS_Lobby_DestroyLobby Failed: User[%ls], Lobby[%ls], Result[%ls]",
		...
		UE_LOGF(LogOnlineServices, Verbose, "[FLobbiesEOSGS::DestroyLobbyImpl] Succeeded: User[%ls], Lobby[%ls]",
...
TFuture<TDefaultErrorResult<FLobbiesDestroyLobbyImpl>> FLobbiesEOSGS::DestroyLobbyImpl(FLobbiesDestroyLobbyImpl::Params&& Params)
{
	...
	if (!Services.GetAuthInterface()->IsLoggedIn(Params.LocalAccountId))
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::DestroyLobbyImpl] Failed: User is not logged in. User[%ls]", *ToLogString(Params.LocalAccountId));
	...
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::DestroyLobbyImpl] Failed: No lobby id provided.");
...
TFuture<TDefaultErrorResult<FLobbiesInviteLobbyMemberImpl>> FLobbiesEOSGS::InviteLobbyMemberImpl(FLobbiesInviteLobbyMemberImpl::Params&& Params)
{
	...
	if (!Services.GetAuthInterface()->IsLoggedIn(Params.LocalAccountId))
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::InviteLobbyMemberImpl] Failed: User is not logged in. User[%ls]", *ToLogString(Params.LocalAccountId));
		return MakeFulfilledPromise<TDefaultErrorResult<FLobbiesInviteLobbyMemberImpl>>(Errors::InvalidUser()).GetFuture();
	}

	if (!Params.LobbyData.IsValid())
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::InviteLobbyMemberImpl] Failed: No lobby data provided.");
	...
	](const EOS_Lobby_SendInviteCallbackInfo* Result) mutable
	{
		if (Result->ResultCode != EOS_EResult::EOS_Success)
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::InviteLobbyMemberImpl] EOS_Lobby_SendInvite Failed: User[%ls], TargetUser[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(LocalAccountId), *ToLogString(TargetAccountId), *LobbyData->GetLobbyIdString(), *LexToString(Result->ResultCode));
			Promise.EmplaceValue(Errors::FromEOSResult(Result->ResultCode));
			return;
		}

		UE_LOGF(LogOnlineServices, Verbose, "[FLobbiesEOSGS::InviteLobbyMemberImpl] Succeeded: User[%ls], TargetUser[%ls], Lobby[%ls]",
...
TFuture<TDefaultErrorResult<FLobbiesDeclineLobbyInvitationImpl>> FLobbiesEOSGS::DeclineLobbyInvitationImpl(FLobbiesDeclineLobbyInvitationImpl::Params&& Params)
{
	...
	if (!Services.GetAuthInterface()->IsLoggedIn(Params.LocalAccountId))
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::DeclineLobbyInvitationImpl] Failed: User is not logged in. User[%ls]", *ToLogString(Params.LocalAccountId));
		return MakeFulfilledPromise<TDefaultErrorResult<FLobbiesDeclineLobbyInvitationImpl>>(Errors::InvalidUser()).GetFuture();
	}

	if (!Params.LobbyId.IsValid())
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::DeclineLobbyInvitationImpl] Failed: Lobby id is invalid.");
	...
	if (!InviteData)
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::DeclineLobbyInvitationImpl] Failed: Unable to find invitation for lobby. User[%ls], Lobby[%ls]",
	...
	](const EOS_Lobby_RejectInviteCallbackInfo* Result) mutable
	{
		...
		if (Result->ResultCode != EOS_EResult::EOS_Success)
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::DeclineLobbyInvitationImpl] EOS_Lobby_RejectInvite Failed: User[%ls], Invitation[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(LocalAccountId), *InviteData->GetInviteId(), *InviteData->GetLobbyData()->GetLobbyIdString(), *LexToString(Result->ResultCode));
			Promise.EmplaceValue(Errors::FromEOSResult(Result->ResultCode));
			return;
		}

		UE_LOGF(LogOnlineServices, Verbose, "[FLobbiesEOSGS::DeclineLobbyInvitationImpl] Succeeded: User[%ls], Invitation[%ls], Lobby[%ls]",
...
TFuture<TDefaultErrorResult<FLobbiesKickLobbyMemberImpl>> FLobbiesEOSGS::KickLobbyMemberImpl(FLobbiesKickLobbyMemberImpl::Params&& Params)
{
	...
	if (!Services.GetAuthInterface()->IsLoggedIn(Params.LocalAccountId))
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::KickLobbyMemberImpl] Failed: User is not logged in. User[%ls]", *ToLogString(Params.LocalAccountId));
		return MakeFulfilledPromise<TDefaultErrorResult<FLobbiesKickLobbyMemberImpl>>(Errors::InvalidUser()).GetFuture();
	}

	if (!Params.LobbyData.IsValid())
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::KickLobbyMemberImpl] Failed: No lobby data provided.");
	...
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::KickLobbyMemberImpl] Failed: User is not the lobby owner. User[%ls], Lobby[%ls]",
	...
	](const EOS_Lobby_KickMemberCallbackInfo* Result) mutable
	{
		if (Result->ResultCode != EOS_EResult::EOS_Success)
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::KickLobbyMemberImpl] EOS_Lobby_KickMember Failed: User[%ls], TargetUser[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(LocalAccountId), *ToLogString(TargetAccountId), *LobbyData->GetLobbyIdString(), *LexToString(Result->ResultCode));
			Promise.EmplaceValue(Errors::FromEOSResult(Result->ResultCode));
			return;
		}

		UE_LOGF(LogOnlineServices, Verbose, "[FLobbiesEOSGS::KickLobbyMemberImpl] Succeeded: User[%ls], TargetUser[%ls], Lobby[%ls]",
			*ToLogString(LocalAccountId), *ToLogString(TargetAccountId), *LobbyData->GetLobbyIdString());
...
TFuture<TDefaultErrorResult<FLobbiesPromoteLobbyMemberImpl>> FLobbiesEOSGS::PromoteLobbyMemberImpl(FLobbiesPromoteLobbyMemberImpl::Params&& Params)
{
	...
	if (!Services.GetAuthInterface()->IsLoggedIn(Params.LocalAccountId))
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::PromoteLobbyMemberImpl] Failed: User is not logged in. User[%ls]", *ToLogString(Params.LocalAccountId));
		return MakeFulfilledPromise<TDefaultErrorResult<FLobbiesPromoteLobbyMemberImpl>>(Errors::InvalidUser()).GetFuture();
	}

	if (!Params.LobbyData.IsValid())
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::PromoteLobbyMemberImpl] Failed: No lobby data provided.");
		return MakeFulfilledPromise<TDefaultErrorResult<FLobbiesPromoteLobbyMemberImpl>>(Errors::InvalidParams()).GetFuture();
	}

	if (Params.LobbyData->GetLobbyClientData()->GetPublicData().OwnerAccountId != Params.LocalAccountId)
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::PromoteLobbyMemberImpl] Failed: User is not the lobby owner. User[%ls], Lobby[%ls]",
			*ToLogString(Params.LocalAccountId), *Params.LobbyData->GetLobbyIdString());
		return MakeFulfilledPromise<TDefaultErrorResult<FLobbiesPromoteLobbyMemberImpl>>(Errors::InvalidParams()).GetFuture();
	}
	...
	](const EOS_Lobby_PromoteMemberCallbackInfo* Result) mutable
	{
		if (Result->ResultCode != EOS_EResult::EOS_Success)
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::PromoteLobbyMemberImpl] EOS_Lobby_PromoteMember Failed: User[%ls], TargetUser[%ls], Lobby[%ls], Result[%ls]",
				*ToLogString(LocalAccountId), *ToLogString(TargetAccountId), *LobbyData->GetLobbyIdString(), *LexToString(Result->ResultCode));
			Promise.EmplaceValue(Errors::FromEOSResult(Result->ResultCode));
			return;
		}

		UE_LOGF(LogOnlineServices, Verbose, "[FLobbiesEOSGS::PromoteLobbyMemberImpl] Succeeded: User[%ls], TargetUser[%ls], Lobby[%ls]",
			*ToLogString(LocalAccountId), *ToLogString(TargetAccountId), *LobbyData->GetLobbyIdString());
...
TFuture<TDefaultErrorResult<FLobbiesModifyLobbyDataImpl>> FLobbiesEOSGS::ModifyLobbyDataImpl(FLobbiesModifyLobbyDataImpl::Params&& Params)
{
	...
	if (!Services.GetAuthInterface()->IsLoggedIn(Params.LocalAccountId))
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ModifyLobbyDataImpl] Failed: User is not logged in. User[%ls]", *ToLogString(Params.LocalAccountId));
		return MakeFulfilledPromise<TDefaultErrorResult<FLobbiesModifyLobbyDataImpl>>(Errors::InvalidUser()).GetFuture();
	}

	if (!Params.LobbyData.IsValid())
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ModifyLobbyDataImpl] Failed: No lobby data provided.");
	...
	if (!LobbyDetails)
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ModifyLobbyDataImpl] Failed: Unable to find lobby details for user. User[%ls], Lobby[%ls]",
			*ToLogString(Params.LocalAccountId), *Params.LobbyData->GetLobbyIdString());
		return MakeFulfilledPromise<TDefaultErrorResult<FLobbiesModifyLobbyDataImpl>>(Errors::InvalidParams()).GetFuture();
	}
	...
	](EOS_EResult EosResult) mutable
	{
		...
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ModifyLobbyDataImpl] ApplyLobbyDataUpdateFromLocalChanges Failed: User[%ls], Lobby[%ls], Result[%ls]",
		...
		UE_LOGF(LogOnlineServices, Verbose, "[FLobbiesEOSGS::ModifyLobbyDataImpl] Succeeded: User[%ls], Lobby[%ls]",
			*ToLogString(LocalAccountId), *LobbyData->GetLobbyIdString());
...
TOnlineAsyncOpHandle<FLobbiesProcessLobbyNotificationImpl> FLobbiesEOSGS::ProcessLobbyNotificationImplOp(FLobbiesProcessLobbyNotificationImpl::Params&& InParams)
{
	...
	if (!Params.LobbyData.IsValid())
	{
		UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ProcessLobbyNotificationImplOp] Failed: No lobby data provided.");
		Op->SetError(Errors::InvalidParams());
		return Op->GetHandle();
	}
	...
	Op->Then([this](TOnlineAsyncOp<FLobbiesProcessLobbyNotificationImpl>& InAsyncOp)
	{
		...
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ProcessLobbyNotificationImplOp] Failed: Unable to find active lobby details to process notificaions. Lobby[%ls]",
	...
	.Then([this](TOnlineAsyncOp<FLobbiesProcessLobbyNotificationImpl>& InAsyncOp, TDefaultErrorResultInternal<FLobbyServiceSnapshot>&& LobbySnapshotResult)
	{
		...
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ProcessLobbyNotificationImplOp] GetLobbySnapshot Failed. Lobby[%ls], Result[%ls]",
		...
		for (EOS_ProductUserId MutatedMember : Params.MutatedMembers)
		{
			...
			if (MutatedMemberAccountId.IsValid())
			{
				...
				{
					UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ProcessLobbyNotificationImplOp] GetLobbyMemberSnapshot Failed. User[%ls], Lobby[%ls], Result[%ls]",
		...
		{
			UE_LOGF(LogOnlineServices, Warning, "[FLobbiesEOSGS::ProcessLobbyNotificationImplOp] PrepareServiceSnapshot Failed. Lobby[%ls], Result[%ls]",
	...
	.Then([this](TOnlineAsyncOp<FLobbiesProcessLobbyNotificationImpl>& InAsyncOp)
	{
		...
		UE_LOGF(LogOnlineServices, Verbose, "[FLobbiesEOSGS::ProcessLobbyNotificationImplOp] Succeeded: Lobby[%ls]",
			*Params.LobbyData->GetLobbyIdString());
