...
namespace UE::Audio::Insights
{
	...
	*/
	...
	private:
		...
		UE_API virtual void SetSearchBoxFilterText(const FText& NewText) override;
		...
		void HandleOnTimeControlMethodReset();
		...
		void SetShowPlotVisibleRecursive(const TSharedPtr<IDashboardDataTreeViewEntry>& Entry);
		void PlotFilteredEntries();
		void ResetPlots();
		void BroadcastPlotUpdate();
		...
		bool bPinnedSectionNeedsRebuild = false;
		...
		bool bIsPlotFilteredMode = false;
