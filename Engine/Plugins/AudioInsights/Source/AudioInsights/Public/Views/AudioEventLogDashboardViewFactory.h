...
namespace UE::Audio::Insights
{
	...
	public:
		...
		UE_API void RegisterExternalEventTypes(const TMap<FString, TSet<FString>>& InCategoriesToEvents);
		UE_API void RegisterExternalDisplayNames(const TMap<FString, FText>& InDisplayNames);
	...
	private:
		...
		const TSharedPtr<FFilterCategory>& FindOrAddFilterCategory(const FString& CategoryName);
		...
		TMap<FString, TSet<FString>> ExternalEventTypeFilters;
		TMap<FString, FText> ExternalDisplayNames;
