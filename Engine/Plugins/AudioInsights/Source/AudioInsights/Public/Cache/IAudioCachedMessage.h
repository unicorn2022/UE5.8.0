...
namespace UE::Audio::Insights
{
	...
	public:
		...
		// Override to return a declare/write handler pair so this message type is included
		// when exporting the Audio Insights cache to a custom .utrace file.
		// See existing implementations in AudioInsights/Private/Messages/ for examples.
		virtual FCacheWriteHandler GetCacheWriteHandler() const { return {}; }
