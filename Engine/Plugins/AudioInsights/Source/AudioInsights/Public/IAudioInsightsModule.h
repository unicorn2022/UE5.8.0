...
namespace UE::Audio::Insights
{
	...
	class FAudioInsightsTimingViewExtender;
...
public:
	...
	UE_API virtual UE::Audio::Insights::FAudioInsightsTimingViewExtender& GetTimingViewExtender() override;

#if WITH_EDITOR
	UE_API virtual UE::Audio::Insights::FAudioInsightsDetailsSelectionManager& GetDetailsSelectionManager() override;
#endif // WITH_EDITOR

	virtual TSharedRef<SDockTab> CreateDashboardTabWidget(const FSpawnTabArgs& Args) = 0;

	UE_API static bool IsModuleLoaded();

	static UE_API bool IsLiveSession();
