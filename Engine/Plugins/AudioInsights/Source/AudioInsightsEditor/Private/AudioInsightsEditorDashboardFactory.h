...
namespace UE::Audio::Insights
{
	...
	private:
		...
		void OnOnlyTraceAudioChannelsPropertyChanged(const bool bInOnlyTraceAudioChannels);
		...
		FReply OnEnableTracesClicked();

		TSharedRef<SWidget> CreateEditorPreferencesButtonWidget();
		...
		bool ShouldOnlyTraceAudioChannels() const;
		...
		FDelegateHandle OnOnlyTraceAudioChannelsPropertyChangedHandle;
