...
TSharedPtr<IDatasmithScene> TranslateFile(const FString& InFilePath, TSharedPtr<IDatasmithScene> InSourceScene=nullptr)
{
	...
	{
		UE_LOGF(LogDirectLinkTest, Error, "Datasmith adapter import error: no suitable translator found for this source. Abort import.");
		return nullptr;
	}
	...
	{
		UE_LOGF(LogDirectLinkTest, Error, "Datasmith import error: Scene translation failure. Abort import.");
		return nullptr;
	}
...
bool UDirectLinkTestLibrary::SendScene(const FString& InFilePath)
{
	...
	UE_LOGF(LogDirectLinkTest, Display, "translate scene %ls...", *InFilePath);
	...
	{
		UE_LOGF(LogDirectLinkTest, Warning, "invalid scene");
		return false;
	}
