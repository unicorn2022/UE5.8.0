...
TArray<TSharedPtr<FDataprepSchemaAction>> FDataprepSelectionTransformMenuActionCollector::CollectActions()
{
	...
	UE_LOGF(LogDataprepEditor, Log, "The discovery of the selection transforms and the creation of the menu actions took %f seconds.", (FPlatformTime::Seconds() - Start));
