...
const UDataprepActionAsset* UDataprepAsset::GetAction(int32 Index) const
{
	...
	{
		UE_LOGF( LogDataprepCore
			, Error
			, "The action to retrieve is out of bound. (Passed index: %d, Number of actions: %d, Dataprepsset: %ls)"
			, Index
			, ActionAssets.Num()
			, *GetPathName()
			);
...
int32 UDataprepAsset::AddAction(const UDataprepActionAsset* InAction)
{
	...
	UE_LOGF( LogDataprepCore, Error, "UDataprepAsset::AddAction: The action is invalid" );
	ensure(false);
...
int32 UDataprepAsset::AddActions(const TArray<const UDataprepActionAsset*>& InActions)
{
	...
	UE_LOGF( LogDataprepCore, Error, "UDataprepAsset::AddActions: None of the action steps is invalid" );
	ensure(false);
...
int32 UDataprepAsset::AddAction(const TArray<const UDataprepActionStep*>& InActionSteps)
{
	...
	UE_LOGF( LogDataprepCore, Error, "UDataprepAsset::AddActionSteps: None of the action steps is invalid" );
	ensure(false);
...
bool UDataprepAsset::InsertAction(const UDataprepActionAsset* InAction, int32 Index)
{
	...
	{
		UE_LOGF( LogDataprepCore, Error, "UDataprepAsset::InsertAction: The index is invalid" );
		return false;
	}
	...
	UE_LOGF( LogDataprepCore, Error, "UDataprepAsset::InsertAction: The action is invalid" );
	ensure(false);
...
bool UDataprepAsset::InsertActions(const TArray<const UDataprepActionAsset*>& InActions, int32 Index)
{
	if(!ActionAssets.IsValidIndex(Index))
	{
		UE_LOGF( LogDataprepCore, Error, "UDataprepAsset::InsertActions: The index is invalid" );
		return false;
	}
	...
	UE_LOGF( LogDataprepCore, Error, "UDataprepAsset::InsertActions: one of the actions is invalid" );
	ensure(false);
...
bool UDataprepAsset::InsertAction(int32 Index)
{
	...
	UE_LOGF( LogDataprepCore, Error, "UDataprepAsset::AddAction: The index is invalid" );
	ensure(false);
	return false;
}
...
bool UDataprepAsset::InsertAction(const TArray<const UDataprepActionStep*>& InActionSteps, int32 Index)
{
	...
	UE_LOGF( LogDataprepCore, Error, "UDataprepAsset::InsertAction: One of the action steps is invalid or the index is invalid" );
	ensure(false);
...
bool UDataprepAsset::MoveAction(int32 SourceIndex, int32 DestinationIndex)
{
	...
	{
		UE_LOGF( LogDataprepCore, Error, "UDataprepAsset::MoveAction: Nothing done. Moving to current location" );
		return true;
	}
	...
	if ( !ActionAssets.IsValidIndex( SourceIndex ) || !ActionAssets.IsValidIndex( DestinationIndex ) )
	{
		...
		{
			UE_LOGF( LogDataprepCore, Error, "UDataprepAsset::MoveAction: The source index is out of range" );
		}

		if ( !ActionAssets.IsValidIndex( DestinationIndex ) )
		{
			UE_LOGF( LogDataprepCore, Error, "UDataprepAsset::MoveAction: The destination index is out of range" );
		}
		return false;
	}
...
bool UDataprepAsset::SwapActions(int32 FirstActionIndex, int32 SecondActionIndex)
{
	...
	{
		UE_LOGF( LogDataprepCore, Error, "UDataprepAsset::SwapAction: Nothing done. First and second indices are identical" );
		return true;
	}
	...
	if ( !ActionAssets.IsValidIndex( FirstActionIndex ) || !ActionAssets.IsValidIndex( SecondActionIndex ) )
	{
		...
		{
			UE_LOGF( LogDataprepCore, Error, "UDataprepAsset::SwapAction: The first index is out of range" );
		}

		if ( !ActionAssets.IsValidIndex( SecondActionIndex ) )
		{
			UE_LOGF( LogDataprepCore, Error, "UDataprepAsset::SwapAction: The second index is out of range" );
		}
...
bool UDataprepAsset::RemoveAction(int32 Index, bool bDiscardParametrization)
{
	...
	UE_LOGF( LogDataprepCore, Error, "UDataprepAsset::RemoveAction: The Index is out of range" );
...
bool UDataprepAsset::RemoveActions(const TArray<int32>& Indices, bool bDiscardParametrization)
{
	...
	UE_LOGF( LogDataprepCore, Error, "UDataprepAsset::RemoveActions: None of the indices are in range" );
