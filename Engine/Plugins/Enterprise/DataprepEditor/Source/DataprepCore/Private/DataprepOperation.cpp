...
UObject* UDataprepEditingOperation::AddAsset( const UObject* Asset, const FString& AssetName )
{
	...
	UE_LOGF( LogDataprepCore, Log, "UDataprepEditingOperation::AddAsset called without context" );
...
UObject* UDataprepEditingOperation::CreateAsset( UClass* AssetClass, const FString& AssetName )
{
	...
	UE_LOGF( LogDataprepCore, Log, "UDataprepEditingOperation::CreateAsset called without context" );
...
AActor * UDataprepEditingOperation::CreateActor(UClass* ActorClass, const FString& ActorName)
{
	...
	UE_LOGF( LogDataprepCore, Log, "UDataprepEditingOperation::CreateActor called without context" );
...
void UDataprepEditingOperation::RemoveObject( UObject* Object, bool bLocalContext )
{
	...
	UE_LOGF( LogDataprepCore, Log, "UDataprepEditingOperation::RemoveObject called without context" );
}
...
void UDataprepEditingOperation::RemoveObjects(TArray<UObject*> Objects, bool bLocalContext)
{
	...
	UE_LOGF( LogDataprepCore, Log, "UDataprepEditingOperation::RemoveObjects called without context" );
}
...
void UDataprepEditingOperation::DeleteObject( UObject* Object )
{
	...
	UE_LOGF( LogDataprepCore, Log, "UDataprepEditingOperation::DeleteObject called without context" );
}
...
void UDataprepEditingOperation::DeleteObjects( TArray<UObject*> Objects )
{
	...
	UE_LOGF( LogDataprepCore, Log, "UDataprepEditingOperation::DeleteObjects called without context" );
}
