...
const FText InterchangeFileProducerLabel( LOCTEXT( "InterchangeFileProducerLabel", "Interchange file producer" ) );
const FText InterchangeFileProducerDescription( LOCTEXT( "InterchangeFileProducerDesc", "Reads files of formats supported by Interchange, i.e. FBX, glTF, ..." ) );

bool bGEnableInterchangeProducer = true;
FAutoConsoleVariableRef GEnableInterchangeProducerVar(
	TEXT("Dataprep.Interchange.Producer"),
	bGEnableInterchangeProducer,
	TEXT("Enable/disable the Interchange file producer.\nDefault is enabled\n"),
	ECVF_Default
);
