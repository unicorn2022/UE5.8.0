...
bool UDataprepAssetProducers::RemoveProducer(int32 IndexToRemove)
{
	...
	UE_LOGF( LogDataprepCore
		, Error
		, "The producer to remove is out of bound. (Passed index: %d, Number of producer: %d, DataprepAssetProducers: %ls)"
		, IndexToRemove
		, AssetProducers.Num()
		, *GetPathName()
		);
...
const UDataprepContentProducer* UDataprepAssetProducers::GetProducer(int32 Index) const
{
	...
	UE_LOGF(LogDataprepCore
		, Error
		, "The producer to retrive is out of bound. (Passed index: %d, Number of producer: %d, DataprepAssetProducers: %ls)"
		, Index
		, AssetProducers.Num()
		, *GetPathName()
	);
