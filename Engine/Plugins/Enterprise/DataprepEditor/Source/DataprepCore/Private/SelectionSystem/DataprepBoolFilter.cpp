...
TArray<UObject*> UDataprepBoolFilter::FilterObjects(const TArrayView<UObject* const>& Objects) const
{
	...
	UE_LOGF( LogDataprepCore, Error, "UDataprepBoolFilter::FilterObjects: There was no Fetcher" );
	return {};
}
...
void UDataprepBoolFilter::FilterAndGatherInfo(const TArrayView<UObject*>& InObjects, const TArrayView<FDataprepSelectionInfo>& OutFilterResults) const
{
	...
	UE_LOGF( LogDataprepCore, Error, "UDataprepBoolFilter::FilterAndGatherInfo: There was no Fetcher" );
}
...
void UDataprepBoolFilter::FilterAndStoreInArrayView(const TArrayView<UObject *>& InObjects, const TArrayView<bool>& OutFilterResults) const
{
	...
	UE_LOGF( LogDataprepCore, Error, "UDataprepBoolFilter::FilterAndStoreInArrayView: There was no Fetcher" );
}
...
void UDataprepBoolFilter::SetFetcher(const TSubclassOf<UDataprepFetcher>& FetcherClass)
{
	...
	else
	{
		...
		UE_LOGF( LogDataprepCore, Error, "UDataprepBoolFilter::SetFetcher: The Fetcher Class is not compatible" );
	}
}
