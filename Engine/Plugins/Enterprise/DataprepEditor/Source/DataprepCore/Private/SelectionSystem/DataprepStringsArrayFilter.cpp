...
TArray<UObject*> UDataprepStringsArrayFilter::FilterObjects(const TArrayView<UObject* const>& Objects) const
{
	...
	UE_LOGF(LogDataprepCore, Error, "UDataprepStringsArrayFilter::FilterObjects: There was no Fetcher");
	return {};
}
...
void UDataprepStringsArrayFilter::FilterAndGatherInfo(const TArrayView<UObject *>& InObjects, const TArrayView<FDataprepSelectionInfo>& OutFilterResults) const
{
	...
	UE_LOGF( LogDataprepCore, Error, "UDataprepStringsArrayFilter::FilterAndGatherInfo: There was no Fetcher" );
}
...
void UDataprepStringsArrayFilter::FilterAndStoreInArrayView(const TArrayView<UObject*>& InObjects, const TArrayView<bool>& OutFilterResults) const
{
	...
	UE_LOGF( LogDataprepCore, Error, "UDataprepStringsArrayFilter::FilterAndStoreInArrayView: There was no Fetcher" );
}
...
void UDataprepStringsArrayFilter::SetFetcher(const TSubclassOf<UDataprepFetcher>& FetcherClass)
{
	...
	else
	{
		...
		UE_LOGF( LogDataprepCore, Error, "UDataprepStringFilter::SetFetcher: The Fetcher Class is not compatible" );
	}
}
