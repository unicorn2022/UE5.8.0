...
TArray<UObject*> UDataprepFloatFilter::FilterObjects(const TArrayView<UObject* const>& Objects) const
{
	...
	UE_LOGF( LogDataprepCore, Error, "UDataprepFloatFilter::FilterObjects: There was no Fetcher" );
	return {};
}
...
void UDataprepFloatFilter::FilterAndGatherInfo(const TArrayView<UObject*>& InObjects, const TArrayView<FDataprepSelectionInfo>& OutFilterResults) const
{
	...
	UE_LOGF( LogDataprepCore, Error, "UDataprepFloatFilter::FilterAndGatherInfo: There was no Fetcher" );
}
...
void UDataprepFloatFilter::FilterAndStoreInArrayView(const TArrayView<UObject*>& InObjects, const TArrayView<bool>& OutFilterResults) const
{
	...
	UE_LOGF( LogDataprepCore, Error, "UDataprepFloatFilter::FilterAndStoreInArrayView: There was no Fetcher" );
}
...
void UDataprepFloatFilter::SetFetcher(const TSubclassOf<UDataprepFetcher>& FetcherClass)
{
	...
	else
	{
		...
		UE_LOGF( LogDataprepCore, Error, "UDataprepFloatFilter::SetFetcher: The Fetcher Class is not compatible" );
	}
}
