...
template<>
CADINTERFACES_API void TUniqueTSObj<A3DAsmProductOccurrenceDataNX>::InitializeData();
template<>
...
template<>
CADINTERFACES_API A3DStatus TUniqueTSObj<A3DAsmProductOccurrenceDataNX>::GetData(const A3DEntity* InEntityPtr);
template<>
...
template<>
CADINTERFACES_API const A3DEntity* TUniqueTSObj<A3DAsmProductOccurrenceDataNX>::GetDefaultIndexerValue() const;
template<>
