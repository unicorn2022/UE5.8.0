...
ECADInterfaceAvailability ICADInterfacesModule::GetAvailability()
{
	...
	UE_LOGF(LogCADInterfaces, Warning, "Failed to load CADInterfaces module. Plug-in may not be functional.");
...
#error Platform not supported
	...
	{
		UE_LOGF(LogCADInterfaces, Warning, "TechSoft module is missing. Plug-in will not be functional.");
	}
	else
	{
		...
		{
			UE_LOGF(LogCADInterfaces, Warning, "Failed to load required library %ls. Plug-in will not be functional.", *TechSoftDll);
		}
