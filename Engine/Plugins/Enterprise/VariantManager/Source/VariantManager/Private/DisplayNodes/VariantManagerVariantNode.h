...
private:
	bool AreAssetsAcceptableForDrop(TArrayView<FAssetData> AssetDatas) const;
	void HandleAssetsDropped(const FDragDropEvent& DragDropEvent, TArrayView<FAssetData> AssetDatas);
