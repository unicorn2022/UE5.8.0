...
class UE_DEPRECATED(5.8, "The class UDatasmithStaticMeshCADImportData has been deprecated and will be removed next release. Please use UDatasmithParametricSurfaceData and child classes instead.")
UDatasmithStaticMeshCADImportData : public UDatasmithStaticMeshImportData
{
	GENERATED_BODY()
