...
#else
	UE_LOGF(LogMDLImporter, Log, "MDL SDK was not available when plugin was build - MDL plugin won't be functional!");
#endif
}
                                                ...
                                                bool&             bOutOperationCanceled)
{
	...
	UE_LOGF(LogMDLImporter, Log, "Imported %ls in [%d min %.3f s]", *Filepath, ElapsedMin, ElapsedSeconds);
#else
