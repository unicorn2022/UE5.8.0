...
{
	return RunTestInternal<int32>({
#if PLATFORM_MAC || PLATFORM_LINUX  // @todo_pcg: Mac/Linux Atoi handles this kind of overflow slightly differently, returning -1, which is a valid index. Disabling temporarily until further investigation with the core team.
	"0", "1", "-1", "1254", "Bla", "0xff", "0547"},
	{0, 1, -1, 1254, 0, 0xff, 547}
#else
	"0", "1", "-1", "1254", "9223372036854775807", "-9223372036854775808", "Bla", "0xff", "0547"},
	{0, 1, -1, 1254, -1, -1, 0, 0xff, 547}
#endif
		);
}
