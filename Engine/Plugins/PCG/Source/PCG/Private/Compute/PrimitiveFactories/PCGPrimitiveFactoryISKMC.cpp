...
int32 FPCGPrimitiveFactoryISKMC::GetNumInstances(int32 InPrimitiveIndex, int32 InCellID) const
{
	return NumInstances.IsValidIndex(InPrimitiveIndex) ? NumInstances[InPrimitiveIndex] : 0;
}

int32 FPCGPrimitiveFactoryISKMC::GetNumInstancesTotal(int32 InPrimitiveIndex) const
{
	return NumInstances.IsValidIndex(InPrimitiveIndex) ? NumInstances[InPrimitiveIndex] : 0;
}
...
bool FPCGPrimitiveFactoryISKMC::IsAnyRenderStateDirty() const
{
