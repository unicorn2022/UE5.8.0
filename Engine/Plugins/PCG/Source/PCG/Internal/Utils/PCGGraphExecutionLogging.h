...
namespace PCGGraphExecutionLogging
{
	...
	PCG_API void LogChangeOriginIgnoredForComponent(const UObject* InObject, const IPCGGraphExecutionSource* InExecutionSource, EPCGIgnoreChangeOriginReason InReason);
