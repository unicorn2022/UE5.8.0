...
public:
	/** If nothing is connected in the In pin, it will use these static paths to load.*/
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Settings")
	TArray<FSoftObjectPath> ObjectPathsToExtract;

	/** If something is connected in the In pin, it will look for this attribute value for the object to load.*/
