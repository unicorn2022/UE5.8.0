...
{
	Union UMETA(Tooltip="Computes the union of all the input polygons"),
	Difference UMETA(Tooltip="Computes the difference between each input polygon and the union of the clip polygons."),
	Intersection UMETA(Tooltip="Computes the intersection of each input polygon with the union of the clip polygons."),
	PairwiseIntersection UMETA(Tooltip="Computes the intersection of each input polygon and each clip polygon."),
	InnerIntersection UMETA(Tooltip="Computes the intersection between all the input polygons."),
	ExclusiveOr UMETA(Tooltip="Computes the exclusive OR of each input polygon and the union of the clip polygons."),
