...
public:
	...
	bool bUseInterpTypeAttribute = false;

	/** Name of the attribute containing the interpolation type, if any. */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = Settings, meta = (PCG_Overridable, EditCondition = "bUseInterpTypeAttribute"))
	FName InterpTypeAttribute;

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = Settings, meta = (PCG_Overridable, EditCondition = "Mode!= EPCGCreateSplineMode::CreateDataOnly", EditConditionHides))
	TArray<FName> TagsToAddOnComponents;
