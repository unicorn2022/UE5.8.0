...
private:
	void ProcessSpline(FPCGContext* InContext, const UPCGCleanSplineSettings* Settings, const FPCGTaggedData& InputData, const UPCGSplineData* InputSplineData) const;
	void ProcessPolygon(FPCGContext* InContext, const UPCGCleanSplineSettings* Settings, const FPCGTaggedData& InputData, const UPCGPolygon2DData* InputPolygonData) const;
};
