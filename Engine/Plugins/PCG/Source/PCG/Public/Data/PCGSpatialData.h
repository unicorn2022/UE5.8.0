...
struct FPCGPointDataCache
{
	...
	const UPCGBasePointData* ToBasePointDataInternal(FPCGContext* Context, const FBox& InBounds, bool bSupportsBoundedPointData, PCG::FLock& CacheLock, TFunctionRef<const UPCGBasePointData* (FPCGContext*, const FBox&)> CreatePointDataFunc);
