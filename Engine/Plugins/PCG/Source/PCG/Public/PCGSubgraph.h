...
{
	UE_DEPRECATED(5.8, "Use PCG::Private::UserParameterTagData")
	inline const FString& UserParameterTagData = PCG::Private::UserParameterTagData;
}
...
public:
	...
	virtual UPCGGraphInterface* GetSubgraphOverride() const { return nullptr; }
...
public:
	...
	virtual UPCGGraphInterface* GetSubgraphOverride() const override { return SubgraphOverride; }
...
{
public:
	UE_API virtual FPCGContext* Initialize(const FPCGInitializeElementParams& InParams) override;
	virtual bool IsCacheable(const UPCGSettings* InSettings) const override { return false; }

protected:
	UE_API virtual bool ExecuteInternal(FPCGContext* Context) const override;
	UE_API virtual bool IsPassthrough(const UPCGSettings* InSettings) const override;
	void PrepareSubgraphData(const UPCGBaseSubgraphSettings* Settings, FPCGSubgraphContext* Context, const FPCGDataCollection& InputData, FPCGDataCollection& OutputData) const;
	void PrepareSubgraphUserParameters(const UPCGBaseSubgraphSettings* Settings, FPCGSubgraphContext* Context, FPCGDataCollection& OutputData) const;
