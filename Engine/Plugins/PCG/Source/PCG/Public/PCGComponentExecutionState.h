...
public:
	...
	virtual FBox GetGeneratedBounds() const override;
	...
	virtual bool IsInPreviewMode() const override;
	...
	virtual void OnManagedResourceAdded(UPCGManagedResource* InResource) override;
	virtual FPCGTaskId Generate(const FGenerateParams& InGenerateParams = {}) override;
	virtual FPCGSourceDataContainer* GetSourceDataContainer() override;
	virtual const FPCGSourceDataContainer* GetSourceDataContainer() const override;
