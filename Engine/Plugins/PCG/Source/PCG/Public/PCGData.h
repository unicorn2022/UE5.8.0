...
{
	extern PCG_API const FName DataDomainName;
	extern PCG_API const FName DefaultDomainName;
}
...
private:
	...
	// Deprecated section
public:
	UE_DEPRECATED(5.8, "No longer required")
...
struct FPCGDataCollection
{
	...
	{
		if (!DataCrcs.IsEmpty() && !ensure(TaggedData.Num() == DataCrcs.Num()))
		{
