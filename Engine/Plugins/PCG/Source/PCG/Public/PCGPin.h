...
// Alternative to EEdGraphPinDirection which is an EdGraph dependency, which Runtime PCG avoids.
UENUM()
...
public:
	...
	UE_API bool BreakAllEdges(TSet<UPCGNode*>* InTouchedNodes = nullptr, TSet<UPCGPin*>* OptionalOtherPinsTouched = nullptr);

	/** Break all edges the connect pins of invalid type. Optionally returns list of affected nodes (including the pin owner). */
	UE_API bool BreakAllIncompatibleEdges(TSet<UPCGNode*>* InTouchedNodes = nullptr, FString* OptionalReason = nullptr);
