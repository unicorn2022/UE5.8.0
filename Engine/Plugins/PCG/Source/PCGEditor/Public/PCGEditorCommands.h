...
public:
	...
	TSharedPtr<FUICommandInfo> CollapseNodesToEmbeddedSubgraph;
	...
	TSharedPtr<FUICommandInfo> AutoLayoutNodes;
	...
	TSharedPtr<FUICommandInfo> EditGraph;
	...
	TSharedPtr<FUICommandInfo> AddOutputPin;
	...
	TSharedPtr<FUICommandInfo> EditInViewport;
	TSharedPtr<FUICommandInfo> MarkForViewportEditing;
};
