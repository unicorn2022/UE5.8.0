...
namespace FPCGEditorCommon
{
	...
	const FAssetCategoryPath PCGAssetCategoryPath(LOCTEXT("PCGCategory", "Procedural"));
	const FAssetCategoryPath PCGAssetSubCategoryPath(FPCGEditorCommon::PCGAssetCategoryPath, LOCTEXT("PCGSubCategory", "PCG"), ECategoryMenuType::Section);
