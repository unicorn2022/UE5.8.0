...
void SPCGToolPresetSection::UpdatePresets()
{
	...
	UPCGInteractiveToolSettings* ToolSettings = Cast<UPCGInteractiveToolSettings>(EdMode->GetCurrentToolSettings());
...
void SPCGToolPresetSection::ActivatePreset(TWeakPtr<FPresetItem> PresetItemWeakPtr, const UPCGToolPresetMenuContext* Context)
{
	...
	if (UPCGInteractiveToolSettings* ToolSettings = Cast<UPCGInteractiveToolSettings>(EdMode->GetCurrentToolSettings()))
	{
