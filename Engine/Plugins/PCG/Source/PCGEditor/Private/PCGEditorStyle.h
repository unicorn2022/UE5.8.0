...
namespace PCGEditorStyleConstants
{
	...
	const FName NodeFilter = TEXT("PCG.Graph.NodeFilter");
	const FName NodeConvert = TEXT("PCG.Graph.NodeConvert");

	const FName Node_ToolStart = TEXT("PCG.Node.ToolStart");
	const FName Node_DataOverride = TEXT("PCG.Node.DataOverride");
	const FName Node_ManualEdit = TEXT("PCG.Node.ManualEdit");
