...
{
	FCoreUObjectDelegates::OnObjectPropertyChanged.AddSP(this, &FPCGInteractiveToolSettingsDetails::Rebuild);
}
...
void FPCGInteractiveToolSettingsDetails::Rebuild(UObject* Object, FPropertyChangedEvent& PropertyChangedEvent)
{
	if(Object == ToolSettings)
	{
		if(PropertyChangedEvent.Property && PropertyChangedEvent.Property->GetFName() == GET_MEMBER_NAME_CHECKED(UPCGInteractiveToolSettings, ToolGraph))
		{
