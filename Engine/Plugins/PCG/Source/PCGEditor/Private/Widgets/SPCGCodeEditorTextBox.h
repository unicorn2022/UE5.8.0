...
class FPCGCodeEditorTextBoxCommands :
	public TCommands<FPCGCodeEditorTextBoxCommands>
{
public:
	FPCGCodeEditorTextBoxCommands();
...
/** Text box for editing code. */
class SPCGCodeEditorTextBox : public SCompoundWidget
{
public:
	SPCGCodeEditorTextBox();
	virtual ~SPCGCodeEditorTextBox() override;

	DECLARE_DELEGATE(FOnTextChangesApplied);

	SLATE_BEGIN_ARGS(SPCGCodeEditorTextBox) {};
