...
protected:
	...
	/** Whether to check when evaluating the input stack whether legacy inputs can consume keys  */
	bool bShouldCheckForLegacyKeyConsumption = false;

public:

	/**
	 * Sets whether this component supports checking for legacy input binds that might consume keys
	 *
	 */
	void SetShouldCheckForLegacyKeyConsumption(bool bNewValue) { bShouldCheckForLegacyKeyConsumption = bNewValue; }

	/**
	 * Whether this component supports checking for legacy input binds that might consume keys
	 *
	 */
	UE_API bool ShouldCheckForLegacyKeyConsumption() const;
