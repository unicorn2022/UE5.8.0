...
public:
	...
	/**
	 * Getter for the CVar EnhancedInput.TrackKeysForAllActionMappings which enables Enhanced Input to respect Key consumption.
	 */
	static bool TrackingKeysForAllActionMappings();
