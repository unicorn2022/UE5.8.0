...
void UInputAction::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
	...
	if (!PropertyChangedEvent.MemberProperty || PropertyChangedEvent.MemberProperty->GetFName() == GET_MEMBER_NAME_CHECKED(UInputAction, Modifiers))
	{
		OnModifiersChanged.Broadcast();
	}
	if (!PropertyChangedEvent.MemberProperty || PropertyChangedEvent.MemberProperty->GetFName() == GET_MEMBER_NAME_CHECKED(UInputAction, Triggers))
	{
	...
	if (!PropertyChangedEvent.MemberProperty || PropertyChangedEvent.MemberProperty->GetFName() == GET_MEMBER_NAME_CHECKED(UInputAction, ValueType))
	{
