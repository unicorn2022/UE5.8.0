...
UCLASS(MinimalAPI, BlueprintType, ClassGroup = (Procedural), AutoExpandCategories="Settings|Spline, Settings|Mesh")
...
public:
	...
	UPROPERTY(EditAnywhere, Category = "Settings|Spline", meta = (ClampMin = 0.001))
	double ErrorTolerance = 1.0;
	
	/** Whether and how to flatten the curves. If curves are flattened, they can also be offset. */
	UPROPERTY(EditAnywhere, Category = "Settings|Spline")
	EFlattenCurveMethod FlattenMethod = EFlattenCurveMethod::DoNotFlatten;

	/** If > 0, Extrude the triangulation by this amount. */
	UPROPERTY(EditAnywhere, Category = "Settings|Mesh", meta = (PCG_Overridable, ClampMin = 0.0))
	double Thickness = 0.0;

	UPROPERTY(EditAnywhere, Category = "Settings|Mesh", meta = (PCG_Overridable))
	FVector ExtrusionVector = FVector::ZAxisVector;

	UPROPERTY(EditAnywhere, Category = "Settings|Mesh")
	bool bExtrudeInLocalSpace = true;
	...
	UPROPERTY(EditAnywhere, Category = "Settings|Offset", meta = (EditCondition = "FlattenMethod != EFlattenCurveMethod::DoNotFlatten", EditConditionHides))
	...
	UPROPERTY(EditAnywhere, Category = "Settings|Offset", meta = (EditCondition = "FlattenMethod != EFlattenCurveMethod::DoNotFlatten && CurveOffset != 0", EditConditionHides))
	...
	UPROPERTY(EditAnywhere, Category = "Settings|Offset", meta = (EditCondition = "FlattenMethod != EFlattenCurveMethod::DoNotFlatten && OpenCurves != EOffsetOpenCurvesMethod::TreatAsClosed && CurveOffset != 0", EditConditionHides))
	...
	UPROPERTY(EditAnywhere, Category = "Settings|Offset", meta = (ClampMin = 0.0, EditCondition = "FlattenMethod != EFlattenCurveMethod::DoNotFlatten && CurveOffset != 0 && JoinMethod == EOffsetJoinMethod::Miter", EditConditionHides))
