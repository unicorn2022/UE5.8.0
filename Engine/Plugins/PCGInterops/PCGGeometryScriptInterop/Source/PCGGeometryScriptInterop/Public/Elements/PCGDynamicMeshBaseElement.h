...
template <typename ContextType> requires std::is_base_of_v<FPCGContext, ContextType>
class IPCGDynamicMeshBaseElementWithCustomContext : public IPCGDynamicMeshBaseElement
{
protected:
