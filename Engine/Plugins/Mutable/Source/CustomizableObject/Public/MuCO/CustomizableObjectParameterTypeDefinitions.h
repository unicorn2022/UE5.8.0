...
enum class EMutableParameterType : uint8
{
	...
	InstancedStruct UMETA(DisplayName = "InstancedStruct"),
};
...
struct FCustomizableObjectProjector
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = CustomizableObjectProjector)
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = CustomizableObjectProjector)
...
USTRUCT(BlueprintType)
struct FCustomizableObjectExternalTypeParameterValue
{
	GENERATED_USTRUCT_BODY()

	inline static const FInstancedStruct DEFAULT_PARAMETER_VALUE = {};

	UPROPERTY(Category = CustomizableObjectVectorParameterValue, VisibleAnywhere)
	FString ParameterName;

	UPROPERTY(Category = CustomizableObjectVectorParameterValue, VisibleAnywhere)
	FInstancedStruct ParameterValue;

	UPROPERTY(Category = CustomizableObjectVectorParameterValue, VisibleAnywhere)
	FGuid Id;

	UPROPERTY(Category = CustomizableObjectVectorParameterValue, VisibleAnywhere)
	TArray<FInstancedStruct> ParameterRangeValues;
};
