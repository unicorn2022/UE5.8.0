...
public:
	...
	UPROPERTY(EditAnywhere, Category = CustomizableObject, DisplayName = "Use Reference Skeletal Mesh As Placeholder")
...
public:
	...
	/** Get the default value of a parameter of type Vector.
	  * @param ParameterName The name of the Vector parameter to get the default value of.
	  * @return The default value of the provided parameter name. */
	UFUNCTION(BlueprintCallable, Category = CustomizableObject)
	CUSTOMIZABLEOBJECT_API FVector4f GetVectorParameterDefaultValue(const FString& ParameterName) const;
	...
	* @param ParameterName The name of the Material parameter to get the default value of. */
	...
	/** Get the default value of a parameter of type External Type.
	  * @param ParameterName The name of the External Type parameter to get the default value of.
	  * @return The default value of the provided parameter name. */
	CUSTOMIZABLEOBJECT_API FInstancedStruct GetExternalTypeParameterDefaultValue(const FString& ParameterName) const;
