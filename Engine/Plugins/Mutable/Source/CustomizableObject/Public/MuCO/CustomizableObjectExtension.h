...
public:
	 ...
	 */
	virtual void OnSkeletalMeshCreated(FName ComponentName, USkeletalMesh* SkeletalMesh) const {}
	...
	virtual void OnCustomizableObjectInstanceUsageUpdated(UCustomizableObjectInstanceUsage& Usage, TArray<TObjectPtr<const UObject>>& ExtensionData) const {}
