...
public:
	...
	FMutableUpdateImageContext(TSharedRef<UE::Mutable::Private::FLiveInstance> InLiveInstance)
...
struct FMutableImageOperationData
{
	...
	UE::Mutable::Private::TManagedPtr<const UE::Mutable::Private::FImage> Result;
