...
class SMutableSkeletonViewer : public SCompoundWidget
{
	SLATE_BEGIN_ARGS(SMutableSkeletonViewer) {}
		SLATE_ARGUMENT_DEFAULT(UE::Mutable::Private::TManagedPtr<const UE::Mutable::Private::FSkeleton>, Skeleton) { nullptr };
	SLATE_END_ARGS()
...
public:
	...
	void SetSkeleton(UE::Mutable::Private::TManagedPtr<const UE::Mutable::Private::FSkeleton> InSkeleton);
