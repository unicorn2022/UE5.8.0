...
public:
	...
	static UE_API UObject* BakeHelper_DuplicateAsset(UObject* Object,
											  TMap<UObject*, UObject*>* ReplacementMap, const bool bGenerateConstantMaterialInstances, FResourceBakingData& InOutPackageData);
	 ...
	 */
	static UE_API UTexture2D* BakeHelper_CreateAssetTexture(UTexture2D* SourceTexture, const UTexture* OrgTex,
