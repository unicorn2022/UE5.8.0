...
void SCustomizableObjectNodeSkeletalMeshRTMorphSelector::UpdateWidget()
{
    ...
    [
        ...
        [
	        ...
	        .IsEnabled(this, &ThisType::IsRuntimeMorphsListEnabled)
...
bool SCustomizableObjectNodeSkeletalMeshRTMorphSelector::IsRuntimeMorphsListEnabled() const
{
	return Node ? !Node->bUseAllRealTimeMorphs : true;
}
