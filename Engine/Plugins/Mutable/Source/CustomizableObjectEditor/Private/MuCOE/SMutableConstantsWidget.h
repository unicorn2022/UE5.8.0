...
{
	UE::Mutable::Private::TManagedPtr<const UE::Mutable::Private::FImage> ImagePtr;
};
...
{
	UE::Mutable::Private::TManagedPtr<const UE::Mutable::Private::FMesh> MeshPtr;
};
...
{
	UE::Mutable::Private::TManagedPtr<const UE::Mutable::Private::FLayout> Layout;
};
...
{
	UE::Mutable::Private::TManagedPtr<const UE::Mutable::Private::FSkeleton> Skeleton;
};
...
{
	UE::Mutable::Private::TManagedPtr<const UE::Mutable::Private::FPhysicsBody> Physics;
};

/**
* Cache object used for the generation of the ui elements related to the constant materials found on the model
*/
struct FMutableConstantMaterialElement : public FMutableConstantElement
{
	UE::Mutable::Private::TManagedPtr<const UE::Mutable::Private::FMaterial> MutableMaterial;
};
...
public:
	 ...
	 */
	void Construct(const FArguments& InArgs, TSharedPtr<UE::Mutable::Private::FModel> InModel,  TSharedPtr<SMutableCodeViewer> InMutableCodeViewerPtr);
...
private:
	 ...
	 */
	void SetModel(const TSharedPtr<UE::Mutable::Private::FModel>& InModel);
	...
	*/
	...
	TSharedPtr<SMutableMultiPageListView<TSharedPtr<FMutableConstantMaterialElement>>> MaterialistViewHandler;
	TSharedPtr<TArray<TSharedPtr<FMutableConstantMaterialElement>>> ConstantMaterialElements;
	...
	void OnSelectedMaterialChanged(TSharedPtr<FMutableConstantMaterialElement> MutableConstantMaterialElement, ESelectInfo::Type SelectionType) const;
	...
	*/
	...
	TSharedRef<ITableRow> OnGenerateMaterialRow(TSharedPtr<FMutableConstantMaterialElement> MutableConstantMaterialElement, const TSharedRef<STableViewBase>& OwnerTable) const;
	...
	/**
	 * Materials List sorting methods
	 */
	
	FName MaterialConstantsLastSortedColumnID = "";
	EColumnSortMode::Type MaterialListSortMode = EColumnSortMode::Type::None;
	
	void OnMaterialsTableSortRequested(EColumnSortPriority::Type ColumnSortPriority, const FName& ColumnID, EColumnSortMode::Type ColumnSortMode);
	EColumnSortMode::Type GetMaterialListColumnSortMode(FName ColumnName) const;

	
	/*
	 * Expandable areas objects and behaviors
	 */
	...
	TSharedPtr<SExpandableArea> MaterialsExpandableArea;
	...
	void OnMaterialsRegionExpansionChanged(bool bExpanded);
	...
	FText ConstantMaterialsFormattedSize;
	...
	FText OnDrawMaterialsAreaTitle() const;
