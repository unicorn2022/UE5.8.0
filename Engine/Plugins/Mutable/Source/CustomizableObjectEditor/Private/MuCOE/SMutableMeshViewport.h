...
class SMutableMeshViewport : public SEditorViewport , public FGCObject
{
	SLATE_BEGIN_ARGS(SMutableMeshViewport) {}
    	SLATE_ARGUMENT_DEFAULT(UE::Mutable::Private::TManagedPtr<const UE::Mutable::Private::FMesh>, Mesh) { nullptr };
    SLATE_END_ARGS()
...
public:
     ...
     */
    void SetMesh(const UE::Mutable::Private::TManagedPtr<const UE::Mutable::Private::FMesh>& InMesh);
...
private:
	...
	UE::Mutable::Private::TManagedPtr<const UE::Mutable::Private::FMesh> MutableMesh = nullptr;
