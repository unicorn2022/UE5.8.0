...
FLinearColor SMutableExpanderArrow::GetLevelColor(const int32 Level) const
{
	...
	{
		FLinearColor(0.40784313725490196f,0.5098039215686274f,0.08627450980392157f,Alpha),
		FLinearColor(0.6549019607843137f,0.3176470588235294f,0.0784313725490196f,Alpha),
		FLinearColor(0.6666666666666666f,0.10196078431372549f,0.3803921568627451f,Alpha),
		FLinearColor(0.2f,0.25098039215686274f,0.6392156862745098f, Alpha)
	};
