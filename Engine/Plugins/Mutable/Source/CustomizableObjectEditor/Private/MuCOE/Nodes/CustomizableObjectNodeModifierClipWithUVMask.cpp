...
void UCustomizableObjectNodeModifierClipWithUVMask::AllocateDefaultPins(UCustomizableObjectNodeRemapPins* RemapPins)
{
	...
	CustomCreatePin(EGPD_Input, Schema->PC_Texture, TEXT("Clip Mask"), LOCTEXT("ClipMask", "Clip Mask"));
	CustomCreatePin(EGPD_Output, Schema->PC_Modifier, TEXT("Modifier"), LOCTEXT("Modifier", "Modifier"));
