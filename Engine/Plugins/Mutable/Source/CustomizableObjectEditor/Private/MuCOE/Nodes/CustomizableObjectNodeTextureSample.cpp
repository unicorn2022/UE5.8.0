...
{
	// Output
	CustomCreatePin(EGPD_Output, UEdGraphSchema_CustomizableObject::PC_Color);
	
	// Inputs
	CustomCreatePin(EGPD_Input, UEdGraphSchema_CustomizableObject::PC_Texture);
	CustomCreatePin(EGPD_Input, UEdGraphSchema_CustomizableObject::PC_Float,  TEXT("X"), LOCTEXT("X", "X"));
	CustomCreatePin(EGPD_Input, UEdGraphSchema_CustomizableObject::PC_Float, TEXT("Y"), LOCTEXT("Y", "Y"));
}
...
{
	return LOCTEXT("Sample_Texture", "Color Sample Texture");
}
