...
void FCustomizableObjectNodeModifierExtendMeshSectionDetails::CustomizeDetails( IDetailLayoutBuilder& DetailBuilder )
{
	...
	{
		Node = Cast<UCONodeModifierExtendSkeletalMeshSection>( DetailsView->GetSelectedObjects()[0].Get() );
	}
	...
	{
		EnableTagsPropertyHandle = DetailBuilder.GetProperty(GET_MEMBER_NAME_CHECKED(UCONodeModifierExtendSkeletalMeshSection, Tags), UCONodeModifierExtendSkeletalMeshSection::StaticClass());
