...
{
	PASSTHROUGH_TEXTURE = 0 UMETA(DisplayName = "Object"),
...
public:
	...
	// TODO Remove. Only used because poses are the diff from a Reference Skeleton. Once the pose is absolute remove this.
	UPROPERTY(EditAnywhere, Category = TableProperties)
	TObjectPtr<USkeletalMesh> PoseReferenceMesh;
