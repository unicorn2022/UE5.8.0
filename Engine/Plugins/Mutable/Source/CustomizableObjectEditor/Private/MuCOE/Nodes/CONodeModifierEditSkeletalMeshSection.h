...
#include "CONodeModifierEditSkeletalMeshSection.generated.h"
...
UCLASS(MinimalAPI)
class UCONodeModifierEditSkeletalMeshSection : public UCustomizableObjectNodeModifierEditLayoutBlocks
{
