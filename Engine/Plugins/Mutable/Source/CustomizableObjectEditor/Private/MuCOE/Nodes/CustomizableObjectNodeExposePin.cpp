...
FText UCustomizableObjectNodeExposePin::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
	...
	{
		NodeTitle = LOCTEXT("Expose_Pin_Title_ListView", "{PinType} Export");
	}
