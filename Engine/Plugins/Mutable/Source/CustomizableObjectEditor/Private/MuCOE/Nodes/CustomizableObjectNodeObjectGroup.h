...
public:
	...
	// The pose defined in meshes deriving from this node will inherit this bone pose priority. Decides the bone pose to keep when two bones
	// that have the same bone usage flags (E.g. EBoneUsageFlags::Skinning). The one with higher priority will be kept.
	UPROPERTY(EditAnywhere, Category = MeshPose)
