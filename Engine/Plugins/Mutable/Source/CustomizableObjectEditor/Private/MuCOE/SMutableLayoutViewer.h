...
public:
	...
	SLATE_BEGIN_ARGS(SMutableLayoutViewer) {}
		...
		SLATE_ARGUMENT(UE::Mutable::Private::TManagedPtr<const UE::Mutable::Private::FLayout>, Layout)
	SLATE_END_ARGS()
	...
	void SetLayout(const UE::Mutable::Private::TManagedPtr<const UE::Mutable::Private::FLayout>& Image );
...
private:
	...
	UE::Mutable::Private::TManagedPtr<const UE::Mutable::Private::FLayout> MutableLayout;
