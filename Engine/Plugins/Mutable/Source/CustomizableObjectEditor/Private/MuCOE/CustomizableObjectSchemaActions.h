...
struct FCustomizableObjectSchemaAction_NewNode : public FEdGraphSchemaAction
{
	...
	FCustomizableObjectSchemaAction_NewNode(const FText& InNodeCategory, const FText& InMenuDesc, const FText& InToolTip, const int32 InGrouping, const FText& InKeywords = FText(), int32 InSectionID = 0)
