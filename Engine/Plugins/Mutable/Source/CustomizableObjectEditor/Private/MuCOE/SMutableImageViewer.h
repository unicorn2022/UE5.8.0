...
public:
	...
	SLATE_BEGIN_ARGS(SMutableImageViewer) {}
		SLATE_ATTRIBUTE(FIntPoint, GridSize)
		SLATE_ARGUMENT(UE::Mutable::Private::TManagedPtr<const UE::Mutable::Private::FImage>, Image)
	SLATE_END_ARGS()
	...
	/** Set the image to show in the widget. */
	void SetImage(const UE::Mutable::Private::TManagedPtr<const UE::Mutable::Private::FImage>& Image, int32 VisibleLOD );
...
private:
	...
	/** */
	UE::Mutable::Private::TManagedPtr<const UE::Mutable::Private::FImage> MutableImage;
