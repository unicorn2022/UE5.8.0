...
class FCustomizableObjectCompiler : public TSharedFromThis<FCustomizableObjectCompiler>, public FGCObject
{
public:
	/** Check for pending compilation process. Returns true if an object has been updated. */
	void Tick(bool bBlocking);
	
	int32 GetRemainingWork() const;
	
	int32 GetNumCompileRequests() const;
