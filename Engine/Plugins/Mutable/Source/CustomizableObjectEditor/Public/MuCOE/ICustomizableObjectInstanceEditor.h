...
public:
	...
	/** Returns the editor's ModeTools for use by viewport clients.
	 * Editors that inherit from FAssetEditorToolkit should return their EditorModeManager.
	 * Returns nullptr by default, which causes viewport clients to create their own. */
	virtual FEditorModeTools* GetEditorModeTools() { return nullptr; }
};
