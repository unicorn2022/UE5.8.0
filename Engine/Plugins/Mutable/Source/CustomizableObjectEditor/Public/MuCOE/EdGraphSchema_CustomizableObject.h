...
public:
	...
	static UE_API const FName PC_SkeletalMesh_Passthrough;
	static UE_API const FName PC_SkeletalMesh_Object;
	static UE_API const FName PC_Texture;
	static UE_API const FName PC_Texture_Passthrough;
	static UE_API const FName PC_Texture_Object;
	...
	static UE_API const FName PC_StaticMesh;

	static UE_API const FName PSC_Material_Override;
	static UE_API const FName PSC_Material_Overlay;
	...
	static UE_API FName GetPinCategoryName(const UScriptStruct* Type);
	static UE_API FName GetPinSubCategoryName(const FName& PinSubCategory);
	static UE_API FText GetPinFriendlyName(const FName& PinCategory);
	static UE_API FText GetPinCategoryFriendlyName(const FName& PinCategory);
	static UE_API FText GetPinSubCategoryFriendlyName(const FName& PinSubcategory);
	static UE_API bool IsPassthrough(const FName& PinCategory);
	static UE_API bool IsTypeNative(const UScriptStruct* Type);
	static UE_API FText GetSubCategoryTooltipText(FName PinSubType);
