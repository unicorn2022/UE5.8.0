...
TManagedPtr<FImage> FImageOperator::ImagePixelFormat(int32 CompressionQuality, const FImage* Base, EImageFormat TargetFormat, int32 OnlyLOD)
{
	...
	TManagedPtr<FImage> Result = CreateImage(ResultSize[0], ResultSize[1], ResultLODCount, TargetFormat, EInitializationType::NotInitialized);
		...
		int32 ResultLODBegin, int32 BaseLODBegin, int32 NumLODs)
{
	...
	else
	{
		...
		case EImageFormat::L_UByte:
		{
			...
			{
				TManagedPtr<FImage> TempBase = ImagePixelFormat(CompressionQuality, Base, EImageFormat::RGBA_UByte);
			...
			{
				TManagedPtr<FImage> TempBase = ImagePixelFormat(CompressionQuality, Base, EImageFormat::RGB_UByte);
...
//				{
//					// Verify
//					TManagedStrongPtr<FImage> Test = ImagePixelFormat(CompressionQuality, Result, EImageFormat::L_UByte);
...
//#endif
			...
			case EImageFormat::BGRA_UByte:
			{
				...
				TManagedPtr<FImage> TempBase = ImagePixelFormat(CompressionQuality, Base, EImageFormat::L_UByte, -1);
...
//#endif
		...
		case EImageFormat::RGB_UByte:
		{
			...
			case EImageFormat::RGBA_UByteRLE:
			{
				...
				TManagedPtr<FImage> TempBase = ImagePixelFormat(CompressionQuality, Base, EImageFormat::RGBA_UByte, -1);
		...
		case EImageFormat::RGBA_UByte:
		{
			...
			{
				check(bFormatAllLODs);
				TManagedPtr<FImage> TempBase = ImagePixelFormat(CompressionQuality, Base, EImageFormat::L_UByte);
		...
		case EImageFormat::RGBA_UByteRLE:
		{
			...
			case EImageFormat::RGB_UByte:
			{
				...
				// Test
				//TManagedStrongPtr<FImage> Test = ImagePixelFormat(CompressionQuality, Result, EImageFormat::RGBA_UByte); 
				//check(Test->DataStorage == Base->DataStorage);
			...
			case EImageFormat::RGB_UByteRLE:
			{
				...
				// \todo: optimise
				TManagedPtr<FImage> Temp1 = ImagePixelFormat(CompressionQuality, Base, EImageFormat::RGB_UByte);
				TManagedPtr<FImage> Temp2 = ImagePixelFormat(CompressionQuality, Temp1.Get(), EImageFormat::RGBA_UByte);
		...
		case EImageFormat::RGB_UByteRLE:
		{
			...
			case EImageFormat::RGB_UByte:
			{
				...
				// Test
				// TManagedStrongPtr<FImage> Test = ImagePixelFormat(CompressionQuality, Result, EImageFormat::RGB_UByte); 
				// check(Test->DataStorage == Base->DataStorage);
				break;
			}
			...
			case EImageFormat::RGBA_UByteRLE:
			{
				...
				// \todo: optimise
				TManagedPtr<FImage> Temp1 = ImagePixelFormat(CompressionQuality, Base, EImageFormat::RGBA_UByte);
				TManagedPtr<FImage> Temp2 = ImagePixelFormat(CompressionQuality, Temp1.Get(), EImageFormat::RGB_UByte);
		...
		case EImageFormat::BC1:
		{
			...
			default:
			{
				UE_LOGF(LogMutableCore, Log, "Image format conversion not implemented. Expensive generic one used. ");
