...
namespace UE::Mutable::Private
{
    ...
    MUTABLERUNTIME_API extern uint64 GetBeginTokenIterativeDecodeRLE_L(const uint8* Src, int32 NumRows);
    MUTABLERUNTIME_API extern void IterativeDecodeRLE_L(uint8* Dest, const uint8* Src, uint64& InOutDecodeToken, int32 NumElems);
    //---------------------------------------------------------------------------------------------
