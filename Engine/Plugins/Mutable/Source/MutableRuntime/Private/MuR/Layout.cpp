...
namespace UE::Mutable::Private {
	...
	TManagedRef<FLayout> FLayout::StaticUnserialise( FInputArchive& Arch )
	{
		LLM_SCOPE_BYNAME(TEXT("MutableRuntime"));
		TManagedRef<FLayout> Result = MakeManaged<FLayout>();
		Arch >> *Result;
		return Result;
	}


	TManagedPtr<FLayout> FLayout::Clone() const
	{
		LLM_SCOPE_BYNAME(TEXT("MutableRuntime"));
		TManagedPtr<FLayout> Result = MakeManaged<FLayout>();
		Result->Size = Size;
