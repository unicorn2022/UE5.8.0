...
namespace UE::Mutable::Private
{
	...
	//! colors, etc. for every column. It is useful to define a big number of similarly structured
	...
	public:
		...
		UE_API void SetCell( int32 Column, uint32 RowId, const UE::Mutable::Private::TManagedPtr<FImage>& Value, const void* ErrorContext = nullptr);
		UE_API void SetCell( int32 Column, uint32 RowId, const UE::Mutable::Private::TManagedPtr<FMesh>& Value, const void* ErrorContext = nullptr);
