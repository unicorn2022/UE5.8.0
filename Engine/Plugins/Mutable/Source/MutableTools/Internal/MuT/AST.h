...
namespace UE::Mutable::Private
{
    ...
    struct FModelOptimizationOptions
    {
        ...
        bool bDisableMaterialGeneration = false;
	};
	...
	struct FLinkerOptions
	{
		...
		*/
		...
		struct FDeduplicationMeshFuncs : TDefaultMapHashableKeyFuncs<TManagedPtr<const FMesh>, int32, false>
		{
		...
		TMap<TManagedPtr<const FMesh>, int32, FDefaultSetAllocator, FDeduplicationMeshFuncs> MeshConstantMap;

		/** Structure used to speedup image mip comparison. */
		struct FDeduplicationImageFuncs : TDefaultMapHashableKeyFuncs<TManagedPtr<const FImage>, int32, false>
		{
			static FORCEINLINE bool Matches(KeyInitType A, KeyInitType B)
			{
				return *A == *B;
		...
		TMap<TManagedPtr<const FImage>, int32, FDefaultSetAllocator, FDeduplicationImageFuncs> ImageConstantMipMap;
		...
		TMap<FOperation::ADDRESS, FInstancedStruct>* ExternalOperations = nullptr;
	};
	...
	inline uint32 GetTypeHash(const ASTChild& Child)
	{
		return PointerHash(Child.child().get());
	}
    ...
    public:
		...
		*/
		static FOperation::ADDRESS FullLink( Ptr<ASTOp>& Root, FProgram&, FLinkerOptions* );
    ...
    public:
        ...
        //! Kind of top-down, but really not.
        //! This version is slightly faster, but doesn't support recursive traversals so
        //! use it only in controlled cases.
        template<typename STATE>
        ...
        //!
        FOperation::ADDRESS LinkedAddress = 0;
    ...
    public:
        ...
        virtual bool IsImagePlainConstant(FVector4f& color ) const;
        virtual bool IsColorConstant(FVector4f& color ) const;
		...
		/** This can be overriden to help detect subgraph mesh properties.  */
    ...
    public:
        ...
        virtual ~Visitor_TopDown_Unique_Const() = default;
    ...
    public:
        ...
        //! Ensure virtual destruction
        virtual ~Visitor_TopDown_Unique_Cloning() = default;
