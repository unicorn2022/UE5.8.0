...
namespace UE::Mutable::Private
{
	...
	*/
    class NodeSurfaceModifierSurfaceEdit : public NodeSurfaceModifier
	{
	public:
		...
		struct FTexture
		{
			/** Key used to match the image with the original one being modified. 
			* This should match the MaterialParameterKey in a NodeSurfaceNew::FImageData.
			*/
			FParameterKey MaterialParameterKey;
	...
	public:
		...
		NodeSurfaceModifierSurfaceEdit() 
		{
	...
	protected:
		...
		~NodeSurfaceModifierSurfaceEdit() = default;
