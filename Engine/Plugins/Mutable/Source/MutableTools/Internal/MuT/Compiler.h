...
namespace UE::Mutable::Private
{
	...
	typedef TFunction<UE::Tasks::FTask(PASSTHROUGH_ID, TSharedPtr<TManagedPtr<FImage>>, bool)> FReferencedImageResourceFunc;
	...
	*/
	typedef TFunction<UE::Tasks::FTask(PASSTHROUGH_ID, const FString&, TSharedPtr<TManagedPtr<FMesh>>, bool)> FReferencedMeshResourceFunc;
    ...
    public:
        ...
        //! 
        UE_API void SetDataPackingStrategy( int32 MinTextureResidentMipCount, uint64 EmbeddedDataBytesLimit);
        ...
        UE_API void SetDisableMaterialGeneration(bool bDisabled);
    ...
    public:
		...
		UE_API TSharedPtr<FModel> Compile( const Ptr<Node>& pNode, TMap<FOperation::ADDRESS, FInstancedStruct>& ExternalOperations);
