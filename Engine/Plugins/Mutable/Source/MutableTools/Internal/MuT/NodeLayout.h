...
namespace UE::Mutable::Private
{
	...
	public:
		...
		/** */
		TManagedPtr<FLayout> BuildRuntimeLayout(uint32 BlockIDPrefix) const;
		...
		*/
		UE_API void GenerateLayoutBlocks(const TManagedPtr<FMesh>&, int32 LayoutIndex );
		UE_API void GenerateLayoutBlocksFromUVIslands(const TManagedPtr<FMesh>&, int32 LayoutIndex);
