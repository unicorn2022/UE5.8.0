...
namespace UE::Mutable::Private
{
	...
	uint32 ASTOpImageResizeRel::Hash() const
	{
	...
	bool ASTOpImageResizeRel::IsImagePlainConstant(FVector4f& OutColor) const
	{
		bool bResult = true;
		...
		Ptr<ASTOp> Visit(Ptr<ASTOp> at, const ASTOpImageResizeRel* CurrentSinkingOp)
		{
			...
			case EOpType::IM_MULTICOMPOSE:
			{
				...
				if (bIsAcceptable)
				{
					...
					NewOp->SourceImage = Visit(SourceImageOp, CurrentSinkingOp);
