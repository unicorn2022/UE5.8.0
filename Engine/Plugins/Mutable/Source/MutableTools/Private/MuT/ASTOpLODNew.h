...
namespace UE::Mutable::Private
{
	...
	class ASTOpLODNew final : public ASTOp
	{
	public:
		TArray<ASTChild> Meshes;
		
		TArray<FName> MaterialSlotName;

		TArray<uint32> MeshIds;
		TArray<uint32> MeshExternalIds;

		ASTOpLODNew();
		ASTOpLODNew(const ASTOpLODNew&) = delete;
		virtual ~ASTOpLODNew() override;
