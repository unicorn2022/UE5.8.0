...
namespace UE::Mutable::Private
{
	...
	class ASTOpMaterialSkeletalMeshObjectBreak final : public ASTOp
	{
	public:
		...
		ASTOpMaterialSkeletalMeshObjectBreak();
		virtual ~ASTOpMaterialSkeletalMeshObjectBreak() override;
