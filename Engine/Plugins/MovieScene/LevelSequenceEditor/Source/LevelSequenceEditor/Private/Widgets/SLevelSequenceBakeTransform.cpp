...
#define LOCTEXT_NAMESPACE "SLevelSequenceBakeTransform"

void SLevelSequenceBakeTransform::Construct(const FArguments& InArgs)
{
...
class SLevelSequenceBakeTransformDialogWindow : public SWindow
{
};

FReply SLevelSequenceBakeTransform::OpenDialog(bool bModal)
{
	check(!DialogWindow.IsValid());

	const FVector2D CursorPos = FSlateApplication::Get().GetCursorPos();

	TSharedRef<SLevelSequenceBakeTransformDialogWindow> Window = SNew(SLevelSequenceBakeTransformDialogWindow)
		.Title(LOCTEXT("SLevelSequenceBakeTransformWidgetTitle", "Bake Transform"))
		.CreateTitleBar(true)
...
void SLevelSequenceBakeTransform::CloseDialog()
{
