...
public:
	...
	*/
	...
	/** Enable merging of frame data. This can reduce data overhead in the common case where there is high coherance of requests across frames. */
	...
	/** Threshold of virtual texture page requests. We merge frames until up to and including the frame where we pass this threshold. */
	...
	/** Threshold of nanite page requests. We merge frames until up to and including the frame where we pass this threshold. */
