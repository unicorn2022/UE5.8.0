...
struct FMovieRenderPipelineCoreObjectVersion
{
	enum Type : int32
	{
		...
		/** Added EMoviePipelineConfigMode to UMoviePipelineExecutorJob. Pre-existing assets derive the mode from pointer state in Serialize(). */
		JobConfigModeAdded,

		/** Added bHasInitializedLegacyPresetDefaults to UMoviePipelineExecutorJob. Pre-existing assets backfill the flag to "true". */
		JobInitializedLegacyDefaultsTrackingAdded,
