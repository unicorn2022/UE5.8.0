...
// Note: There are a number of enums in here which are named with a MovieGraph prefix. This is no longer accurate; these are
// now usable in the broader movie pipeline with the legacy system as well, but the naming is kept as-is for backwards compatibility.
...
struct FMovieGraphPostRenderSettings
{
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Play Render Output")
	...
	/** When opening a directory instead of playing back media, this dictates which directories will be opened. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Play Render Output")
	EMovieGraphDirectoryOpenBehavior DirectoryOpenBehavior;

	/** These options are used to determine how to play the rendered images. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Play Render Output", DisplayName = "Image Sequences")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Play Render Output", DisplayName = "Apple ProRes Movies")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Play Render Output", DisplayName = "Avid DNxHR Movies")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Play Render Output", DisplayName = "H.264 MP4 Movies")
