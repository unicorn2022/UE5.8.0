...
public:
	...
	UE_DEPRECATED(5.8, "Lumen scene rebuild is now automatically applied during layer warm-ups in the deferred renderer. Use Layer Warm Up Frames on the Warm Up Settings or Render Layer nodes instead.")
	UPROPERTY(BlueprintReadWrite, Category = Overrides, meta = (InlineEditConditionToggle, DeprecatedProperty, DeprecationMessage = "Lumen scene rebuild is now automatically applied during layer warm-ups in the deferred renderer. Use Layer Warm Up Frames on the Warm Up Settings or Render Layer nodes instead."))
	...
	/**
	 * Deprecated: Lumen scene rebuild is now automatically applied during layer warm-ups in the deferred renderer.
	 * Use Layer Warm Up Frames on the Warm Up Settings or Render Layer nodes instead.
	 */
	UE_DEPRECATED(5.8, "Lumen scene rebuild is now automatically applied during layer warm-ups in the deferred renderer. Use Layer Warm Up Frames on the Warm Up Settings or Render Layer nodes instead.")
	UPROPERTY(BlueprintReadWrite, Category = "Lumen Render Layers (Experimental)", meta = (EditCondition = "bOverride_bRebuildLumenSceneBetweenRenderLayers", DeprecatedProperty, DeprecationMessage = "Lumen scene rebuild is now automatically applied during layer warm-ups in the deferred renderer. Use Layer Warm Up Frames on the Warm Up Settings or Render Layer nodes instead."))
