...
public:
	...
	SLATE_BEGIN_ARGS(SMovieGraphSimpleList<ListType>)
		 ...
		 * row widget. If this attribute is bound, those will be ignored, and this will be used instead. To hide the summary row, use SNullWidget::NullWidget
		 * as the widget.
		 */
	...
	void Construct(const FArguments& InArgs)
	{
		...
		[
			...
			[
				...
				{
					// Hide the summary widget if it's a null widget
					return CustomSummaryWidget.IsSet() && (CustomSummaryWidget.Get() == SNullWidget::NullWidget.ToSharedPtr())
