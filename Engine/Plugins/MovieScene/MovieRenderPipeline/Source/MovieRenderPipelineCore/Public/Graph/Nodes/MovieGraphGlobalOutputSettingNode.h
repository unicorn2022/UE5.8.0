...
#endif
	UE_API virtual bool GetCustomPromotionDefaultValue(const FMovieGraphPropertyInfo& InPropertyInfo, FString& OutSerializedValue) const override;
	// ~UMovieGraphSettingNode Interface
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "File Output", meta=(EditCondition="bOverride_OutputDirectory", MrgTokenAutocomplete))
