...
UE_DEPRECATED(5.8, "Use EMoviePipelinePostRenderActionType instead")
typedef EMoviePipelinePostRenderActionType EMovieGraphQuickRenderPostRenderActionType;
...
public:
	...
	EMoviePipelinePostRenderActionType PostRenderBehavior = EMoviePipelinePostRenderActionType::PlayRenderOutput;
