...
public:
	...
	virtual TArray<UMovieGraphModifierBase*> GetAllModifiers() const
	{
		return {};
	}
	...
	UFUNCTION(BlueprintCallable, Category = "Modifiers")
	virtual bool SupportsCollections() const
	{
		return true;
	}
	...
	UFUNCTION(BlueprintCallable, Category = "Modifiers")
	virtual bool IsCollectionEnabled(const FName& InCollectionName) const
	{
		return true;
	}
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Modifiers")
	virtual void SetCollectionEnabled(const FName& InCollectionName, const bool bIsCollectionEnabled)
	{
	...
	UFUNCTION(BlueprintCallable, Category = "Modifiers")
	virtual TArray<FName> GetAllCollections() const
	{
		return {};
	}
	...
	UFUNCTION(BlueprintCallable, Category = "Modifiers")
	virtual void AddCollection(const FName& InCollectionName)
	{
	...
	UFUNCTION(BlueprintCallable, Category = "Modifiers")
	virtual bool RemoveCollection(const FName& InCollectionName)
	{
		return false;
	}
};
...
private:
	...
	UPROPERTY()
	uint8 bOverride_DisabledCollections : 1 = 1;
