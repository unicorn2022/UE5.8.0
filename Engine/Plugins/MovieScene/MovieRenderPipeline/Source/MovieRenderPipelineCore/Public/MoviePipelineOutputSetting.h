...
public:
	...
	/** Exports additional .wav file for each submix if .wav output is selected, excludes the device's MasterSubmix. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "File Output")
	TArray<TObjectPtr<USoundSubmix>> AdditionalSubmixOutputs;
