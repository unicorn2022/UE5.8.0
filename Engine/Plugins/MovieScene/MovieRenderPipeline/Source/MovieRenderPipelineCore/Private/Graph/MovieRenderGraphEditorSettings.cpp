...
{
	// Seed default visible output types for Basic Config mode.
	// These defaults are used on first launch before the user modifies via the gear menu.
	VisibleBasicConfigOutputTypes.Add(FSoftClassPath(TEXT("/Script/MovieRenderPipelineRenderPasses.MovieGraphImageSequenceOutputNode_MultiLayerEXR")));
	VisibleBasicConfigOutputTypes.Add(FSoftClassPath(TEXT("/Script/MovieRenderPipelineRenderPasses.MovieGraphImageSequenceOutputNode_JPG")));
	VisibleBasicConfigOutputTypes.Add(FSoftClassPath(TEXT("/Script/MovieRenderPipelineMP4Encoder.MovieGraphMP4EncoderNode")));
	VisibleBasicConfigOutputTypes.Add(FSoftClassPath(TEXT("/Script/MovieRenderPipelineRenderPasses.MovieGraphImageSequenceOutputNode_PNG")));
	VisibleBasicConfigOutputTypes.Add(FSoftClassPath(TEXT("/Script/AppleProResMedia.MovieGraphAppleProResNode")));
}
