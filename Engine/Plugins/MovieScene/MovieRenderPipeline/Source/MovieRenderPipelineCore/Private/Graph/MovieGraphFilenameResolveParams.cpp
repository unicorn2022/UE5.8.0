...
FMovieGraphFilenameResolveParams FMovieGraphFilenameResolveParams::MakeResolveParams(
	...
	const UE::MovieGraph::FMovieGraphSampleState* InSamplePayload)
{
	...
	if (InSamplePayload)
	{
		Params.FileNameFormatOverrides.Append(InSamplePayload->AdditionalFormatArgs);
		Params.FileMetadata.Append(InSamplePayload->AdditionalFileMetadata);
	}
