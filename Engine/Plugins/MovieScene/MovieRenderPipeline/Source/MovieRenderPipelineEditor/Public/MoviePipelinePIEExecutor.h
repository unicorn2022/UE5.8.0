...
protected:
	//~ Begin UMoviePipelineLinearExecutorBase interface
	UE_API virtual void Start(const UMoviePipelineExecutorJob* InJob) override;
	UE_API virtual void BeginDestroy() override;
	UE_API virtual void OnExecutorFinishedImpl() override;
	//~ End UMoviePipelineLinearExecutorBase interface
...
private:
	...
	/** Output data generated from all jobs in the queue (one entry in the array for each job). May be a mix of graph and preset output data. */
	TArray<FMoviePipelineOutputData> AllJobOutputData;

	/** The resolved output directories for all jobs that have been rendered. */
	TArray<FString> ResolvedOutputDirectories;
