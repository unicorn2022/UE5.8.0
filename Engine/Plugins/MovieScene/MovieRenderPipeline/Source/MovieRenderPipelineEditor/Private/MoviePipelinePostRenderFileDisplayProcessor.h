...
public:
	 ...
	 * Both graph and preset output data is supported.
	 */
...
private:
	...
	/** Helper that implements graph-based logic for GroupFilesByShot(). */
	void GroupFilesByShot_Graph(
		FMoviePipelineOutputData& InPipelineOutputData,
		TArray<TMap<FString, TArray<FString>>>& InImagesGroupedByShot,
		TArray<TMap<FString, TArray<FString>>>& InFrameTemplateImagesGroupedByShot,
		TArray<TMap<FString, TArray<FString>>>& InVideosGroupedByShot) const;

	/** Helper that implements preset-based logic for GroupFilesByShot(). */
	void GroupFilesByShot_Preset(
		FMoviePipelineOutputData& InPipelineOutputData,
		TArray<TMap<FString, TArray<FString>>>& InImagesGroupedByShot,
		TArray<TMap<FString, TArray<FString>>>& InFrameTemplateImagesGroupedByShot,
		TArray<TMap<FString, TArray<FString>>>& InVideosGroupedByShot) const;
