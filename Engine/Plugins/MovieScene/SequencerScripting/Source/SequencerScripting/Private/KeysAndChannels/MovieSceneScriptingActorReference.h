...
class UMovieSceneScriptingActorReferenceKey : public UMovieSceneScriptingKey, public TMovieSceneScriptingKey<FMovieSceneActorReferenceChannel, FMovieSceneActorReferenceKey>
{
	GENERATED_BODY()
public:
	/**
...
class UMovieSceneScriptingActorReferenceChannel : public UMovieSceneScriptingChannel
{
	...
	using Impl = TMovieSceneScriptingChannel<FMovieSceneActorReferenceChannel, UMovieSceneScriptingActorReferenceKey, FMovieSceneActorReferenceKey>;
...
public:
	...
	*/
	...
	{
		// FMovieSceneActorReferenceChannel doesn't implement GetDefault via TOptional, so we're wrapping this function by hand as well.
		FMovieSceneActorReferenceChannel* Channel = ChannelHandle.Get();
		if (Channel)
		{
	...
	*/
	...
	void RemoveDefault()
	{
		...
		// FMovieSceneActorReferenceChannel doesn't implement RemoveDefault, instead it implements ClearDefault(). Wrapping this function by hand,
...
public:
	...
	TMovieSceneChannelHandle<FMovieSceneActorReferenceChannel> ChannelHandle;
};
