...
{
	const FLinearColor Low(0.01f, 0.01f, 0.01f, 0.25f);
	const FLinearColor High(1.0, 0.1f, 0.1f, 1.0f);
...
{
	static const uint32 HitColor = FLinearColor(0.01f, 0.01f, 0.01f, 0.25f).ToFColor(false).ToPackedARGB();
	static const uint32 MissColor = FLinearColor(1.0f, 0.1f, 0.1f, 1.0f).ToFColor(false).ToPackedARGB();
