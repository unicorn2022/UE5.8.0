...
{
	static const FAssetCategoryPath Categories[] = { FAssetCategoryPath(EAssetCategoryPaths::AI, LOCTEXT("AssetDefinition_EnvironmentQuerySubMenu", "NPC"), ECategoryMenuType::Section) };
	return Categories;
}
