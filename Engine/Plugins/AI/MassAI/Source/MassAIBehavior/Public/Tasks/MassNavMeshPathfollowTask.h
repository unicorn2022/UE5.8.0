...
{ 
	...
	/** Offset applied at path corners that touch corridor walls. Unlike OffsetFromBoundaries
	 *  (global string-pull bias), this only pushes corner points inward along their portal. */
	UPROPERTY(EditAnywhere, Category = Parameter, meta = (ClampMin = "0.0"))
	float OffsetCornersFromBoundaries = 0.f;
...
protected:
	...
	UE_API bool RequestPath(FStateTreeExecutionContext& Context, const FMassTargetLocation& InTargetLocation) const;
