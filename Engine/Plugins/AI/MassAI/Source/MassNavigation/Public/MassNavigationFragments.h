...
UE_DEPRECATED(5.8, "Renamed to FMassNavigationRelevantParameters.") typedef struct FNavigationRelevantParameters FMassNavigationRelevantParameters;
UE_DEPRECATED(5.8, "Renamed to FMassNavigationRelevantFragment") typedef struct FNavigationRelevantFragment FMassNavigationRelevantFragment;
