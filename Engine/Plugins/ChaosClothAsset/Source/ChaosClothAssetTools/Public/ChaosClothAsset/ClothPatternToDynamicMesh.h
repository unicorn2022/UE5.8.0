...
* When MaterialOffset is INDEX_NONE, no offset is applied and no fix up is run.
* Use bConvertWeightMaps to turn the cloth collection weight maps into a Dynamic Mesh attribute.
*/
