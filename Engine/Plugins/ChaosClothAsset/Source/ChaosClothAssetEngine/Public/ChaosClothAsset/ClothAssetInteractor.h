...
struct FClothAssetInteractorPropertyBag;
...
public:
	...
	/** Set properties from an interactor data set */
	UFUNCTION(BlueprintCallable, Category = ClothProperty)
	CHAOSCLOTHASSETENGINE_API void SetPropertySet(const FClothAssetInteractorPropertyBag& PropertySet, int32 LODIndex = -1);
