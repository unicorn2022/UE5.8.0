...
namespace UE::Chaos::ClothAsset
{
	...
	private:
		...
		virtual ~FSKMClothingSimulationContext() override = default;
	...
	private:
		...
		virtual TSharedPtr<const FChaosClothSimulationModel> GetActiveClothSimulationModel(const UChaosClothAssetBase* Asset, int32 ModelIndex) const override;
		virtual int32 GetSimulationGroupId(const UChaosClothAssetBase* Asset, int32 ModelIndex) const override;
		virtual int32 GetNextLinkedSimulationGroupId(int32 PrevSimulationGroupId) const override;
		...
		virtual void ClearPropertyCollectionsDirtyFlags(int32 LodIndex) const override;
