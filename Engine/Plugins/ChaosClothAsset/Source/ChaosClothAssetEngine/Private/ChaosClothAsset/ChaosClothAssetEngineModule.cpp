...
namespace UE::Chaos::ClothAsset
{
	...
	public:
		...
		virtual void StartupModule() override
		{
			...
			PropertyModule.RegisterCustomPropertyTypeLayout(FClothAssetInteractorPropertyBag::StaticStruct()->GetFName(), FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FPropertyBagDetails::MakeInstance));
		...
		virtual void ShutdownModule() override
		{
			...
			if (UObjectInitialized())
			{
				...
				PropertyModule.UnregisterCustomPropertyTypeLayout(FClothAssetInteractorPropertyBag::StaticStruct()->GetFName());
			}
#endif
		}
