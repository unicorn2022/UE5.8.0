...
namespace UE::Chaos::ClothAsset
{
	...
	public:
		...
		UE_API bool GetCopyAllUserAttributesToSimModel() const;
	...
	public:
		...
		/** Set whether all attributes should be copied to the FChaosClothSimulationModel (else legacy behavior of skipping unused sets and face int maps will be followed).*/
		UE_API void SetCopyAllUserAttributesToSimModel(bool bValue);
