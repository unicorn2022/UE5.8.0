...
{
	// Note: static variables that depend on other static variables from other translation units must be accessed through getter functions,
	// otherwise static variables can contain uninitialized values.

	// Lods Group
	static const TArray<FName>& GetLodsGroupAttributes()
	{
		static const TArray<FName> LodsGroupAttributes =
		{
			...
			ClothCollectionAttribute::CopyAllUserAttributesToSimModel,
		};
		return LodsGroupAttributes;
	}

	// Solvers Group
	static const TArray<FName>& GetSolverGroupAttributes()
	{
		...
		return SolverGroupAttributes;
	}

	// Fabrics Group
	static const TArray<FName>& GetSimFabricGroupAttributes()
	{
		...
		return SimFabricGroupAttributes;
	}

	// Seam Group
	static const TArray<FName>& GetSeamsGroupAttributes()
	{
		...
		return SeamsGroupAttributes;
	}

	// Seam Stitches Group
	static const TArray<FName>& GetSeamStitchesGroupAttributes()
	{
		...
		return SeamStitchesGroupAttributes;
	}

	// Sim Patterns Group
	static const TArray<FName>& GetSimPatternsGroupAttributes()
	{
		...
		return SimPatternsGroupAttributes;
	}

	// Render Patterns Group
	static const TArray<FName>& GetRenderPatternsGroupAttributes()
	{
		...
		return RenderPatternsGroupAttributes;
	}

	// Sim Faces Group
	static const TArray<FName>& GetSimFacesGroupAttributes()
	{
		...
		return SimFacesGroupAttributes;
	}

	// Sim Vertices 2D Group
	static const TArray<FName>& GetSimVertices2DGroupAttributes()
	{
		...
		return SimVertices2DGroupAttributes;
	}
	...
	static const TArray<FName>& GetSimVertices3DGroupAttributes()
	{
		...
		return SimVertices3DGroupAttributes;
	}

	static const TArray<FName>& GetSimAccessoryMeshVertices3DGroupAttributePrefixes()
	{
		...
		return SimAccessoryMeshVertices3DGroupAttributePrefixes;
	}

	//~ Sim Morph Targets Group
	static const TArray<FName>& GetSimMorphTargetsGroupAttributes()
	{
		...
		return SimMorphTargetsGroupAttributes;
	}

	//~ Sim Morph Targets Vertices Group
	static const TArray<FName>& GetSimMorphTargetVerticesGroupAttributes()
	{
		...
		return SimMorphTargetVerticesGroupAttributes;
	}

	// Render Faces Group
	static const TArray<FName>& GetRenderFacesGroupAttributes()
	{
		static const TArray<FName> RenderFacesGroupAttributes =
		{
			ClothCollectionAttribute::RenderIndices,
		};
		return RenderFacesGroupAttributes;
	}

	// Render Vertices Group
	static const TArray<FName>& GetRenderVerticesGroupAttributes()
	{
		...
		return RenderVerticesGroupAttributes;
	}

	//~ Group Resizing Group
	static const TArray<FName>& GetGroupResizingGroupAttributes()
	{
		...
		return GroupResizingGroupAttributes;
	}

	//~ Sim Accessory Meshes Group
	static const TArray<FName>& GetSimAccessoryMeshesGroupAttributes()
	{
		...
		return SimAccessoryMeshesGroupAttributes;
	}

	// All fixed attributes for this collection
	static const TMap<FName, TArray<FName>>& GetFixedAttributeNamesMap()
	{
		static const TMap<FName, TArray<FName>> FixedAttributeNamesMap =
		{
			{ ClothCollectionGroup::Lods, GetLodsGroupAttributes() },
			{ ClothCollectionGroup::Seams, GetSeamsGroupAttributes() },
			{ ClothCollectionGroup::SeamStitches, GetSeamStitchesGroupAttributes() },
			{ ClothCollectionGroup::SimPatterns, GetSimPatternsGroupAttributes() },
			{ ClothCollectionGroup::RenderPatterns, GetRenderPatternsGroupAttributes() },
			{ ClothCollectionGroup::SimFaces, GetSimFacesGroupAttributes() },
			{ ClothCollectionGroup::SimVertices2D, GetSimVertices2DGroupAttributes() },
			{ ClothCollectionGroup::SimVertices3D, GetSimVertices3DGroupAttributes() },
			{ ClothCollectionGroup::SimMorphTargets, GetSimMorphTargetsGroupAttributes() },
			{ ClothCollectionGroup::SimMorphTargetVertices, GetSimMorphTargetVerticesGroupAttributes() },
			{ ClothCollectionGroup::RenderFaces, GetRenderFacesGroupAttributes() },
			{ ClothCollectionGroup::RenderVertices, GetRenderVerticesGroupAttributes() },
			{ ClothCollectionGroup::Fabrics, GetSimFabricGroupAttributes() },
			{ ClothCollectionGroup::Solvers, GetSolverGroupAttributes() },
			{ ClothCollectionGroup::CustomResizingRegions, GetGroupResizingGroupAttributes() },
			{ ClothCollectionGroup::SimAccessoryMeshes, GetSimAccessoryMeshesGroupAttributes() },
		};
		return FixedAttributeNamesMap;
	}

	// All fixed attribute prefixes for this collection (see SimAccessoryMesh SimVertex3D)
	static const TMap<FName, TArray<FName>>& GetFixedAttributePrefixNamesMap()
	{
		static const TMap<FName, TArray<FName>> FixedAttributePrefixNamesMap = {
			{ ClothCollectionGroup::SimVertices3D, GetSimAccessoryMeshVertices3DGroupAttributePrefixes() },
		};
		return FixedAttributePrefixNamesMap;
	}

	// All paintable attributes for this collection
	static const TMap<FName, TArray<FName>>& GetUserAccessibleAttributeNamesMap()
	{
		...
		return UserAccessibleAttributeNamesMap;
	}
...
namespace UE::Chaos::ClothAsset
{
		...
		: ManagedArrayCollection(InManagedArrayCollection)
	{
		...
		CopyAllUserAttributesToSimModel = ManagedArrayCollection->FindAttribute<bool>(ClothCollectionAttribute::CopyAllUserAttributesToSimModel, ClothCollectionGroup::Lods);
	...
	bool FConstClothCollection::IsValid(EClothCollectionExtendedSchemas OptionalSchemas) const
	{
		...
		return
			...
			ReferenceBoneName &&
			CopyAllUserAttributesToSimModel &&
	...
	void FClothCollection::DefineSchema(EClothCollectionExtendedSchemas OptionalSchemas)
	{
		...
		CopyAllUserAttributesToSimModel = &GetManagedArrayCollection()->AddAttribute<bool>(ClothCollectionAttribute::CopyAllUserAttributesToSimModel, ClothCollectionGroup::Lods);
	...
	void FClothCollection::PostSerialize(const FArchive& Ar)
	{
		if (Ar.IsLoading())
		{
			...
			// Add CopyAllUserAttributesToSimModel attribute if other LODs group attributes are defined.
			if (PhysicsAssetSoftObjectPathName && SkeletalMeshSoftObjectPathName && ReferenceBoneName && !CopyAllUserAttributesToSimModel)
			{
				CopyAllUserAttributesToSimModel = &GetManagedArrayCollection()->AddAttribute<bool>(ClothCollectionAttribute::CopyAllUserAttributesToSimModel, ClothCollectionGroup::Lods);
			}
		}
	...
	{
		while (BaseElementIndex < ElementIndex && (*StartArray)[BaseElementIndex] == INDEX_NONE)
		{
			++BaseElementIndex;
		}
	...
	TArray<FName> FConstClothCollection::GetUserDefinedAttributeNames(const FName& GroupName) const
	{
		...
		if (const TArray<FName>* const FixedAttributeNames = GetFixedAttributeNamesMap().Find(GroupName))  // Also checks that the group name is a recognized group name
		{
			const TArray<FName>* const FixedAttributePrefixNames = GetFixedAttributePrefixNamesMap().Find(GroupName);
	...
	{
		using namespace UE::Chaos::ClothAsset::Private;
		if (const TArray<FName>* const FixedAttributePrefixes = GetFixedAttributePrefixNamesMap().Find(GroupName))
		{
		...
		if (const TArray<FName>* const FixedAttributeNames = GetFixedAttributeNamesMap().Find(GroupName))
		{
		...
		if (const TArray<FName>* const UserAccessibleAttributeNames = GetUserAccessibleAttributeNamesMap().Find(GroupName))
		{
	...
	/*static*/ TArray<FName> FConstClothCollection::GetValidClothCollectionGroupName()
	{
		...
		GetFixedAttributeNamesMap().GetKeys(ValidClothCollectionGroupName);
	...
	{
		using namespace UE::Chaos::ClothAsset::Private;
		return GetFixedAttributeNamesMap().Contains(GroupName);
	}
