...
public:
	...
	{
		static const auto Categories = { FAssetCategoryPath(EAssetCategoryPaths::Texture, NSLOCTEXT("AssetDefinition", "TextureGraphInstance_SubMenu", "Texture Graph"), ECategoryMenuType::Section) };
		return Categories;
	}
