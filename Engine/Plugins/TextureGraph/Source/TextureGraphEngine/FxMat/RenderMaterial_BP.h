...
#include "RenderMaterial_BP.generated.h"
...
struct FMaterialInstanceStaticSwitchPermutationMap
{
	...
	UPROPERTY()
	TMap<int32, TObjectPtr<UMaterialInstanceConstant>>	PermutationsMap;

	static UE_API FMaterialInstanceStaticSwitchPermutationMap Create(UMaterialInterface* InMaterial);
