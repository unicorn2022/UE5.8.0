...
public:
	...
	TWeakPtr<Chaos::VD::FChaosVDImplicitObjectView> GetRootImplicitView() const
	{
		return RootImplicitView.ToWeakPtr();
	}
...
protected:
	...
	void ProcessUpdatedAndRemovedHandles(TArray<TPair<TSharedPtr<FChaosVDExtractedGeometryDataHandle>, TSharedPtr<Chaos::VD::FChaosVDImplicitObjectView>>>& OutExtractedGeometryDataHandles);
	...
	TSharedPtr<Chaos::VD::FChaosVDImplicitObjectView> RootImplicitView;
