...
public:
	...
	{
		return ChaosVDTraceManager;
	}

	UE_DEPRECATED(5.8, "Use GetTraceSessionsManager")
	TSharedPtr<class FChaosVDTraceManager> GetTraceManager()
	{
		return nullptr;
	}
...
private:
	...
	TSharedPtr<UE::TraceBasedDebuggers::FTraceSessionsManager> ChaosVDTraceManager;
