...
DECLARE_MULTICAST_DELEGATE_OneParam(FChaosVDInitialFirstFramePlayed, TWeakPtr<FChaosVDPlaybackController>)
...
public:
	...
	bool LoadChaosVDRecordingFromTraceSession(const UE::TraceBasedDebuggers::FTraceSessionDescriptor& InSessionDescriptor);

PRAGMA_DISABLE_DEPRECATION_WARNINGS
	UE_DEPRECATED(5.8, "Use the version taking UE::TraceBasedDebuggers::FTraceSessionDescriptor in parameter")
	bool LoadChaosVDRecordingFromTraceSession(const struct FChaosVDTraceSessionDescriptor& InSessionDescriptor);
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	FChaosVDInitialFirstFramePlayed& OnFirstFramePlayed()
	{
		return ControllerFirstFramePlayedDelegate;
	}
...
protected:
	...
	void HandleGeneralSettingsUpdated(UObject* SettingsObject);
	...
	/** Delegate called when the first frame is played on recording load */
	FChaosVDInitialFirstFramePlayed ControllerFirstFramePlayedDelegate;
	...
	bool bStartLiveSessionPlaybackAutomatically = true;
