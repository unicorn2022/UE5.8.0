...
private:
	...
	struct FCachedFilterData
	{
		uint8 ChannelIndex = 0;
		uint8 MaskFilter = 0;
		Chaos::EFilterFlags Flags = Chaos::EFilterFlags::None;
	...
	TStaticArray<FCachedFilterData, ECollisionFilterDataType::Count> CachedFilterData;
	bool bFiltersRequireSplitView = false;
