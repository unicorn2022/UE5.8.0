...
void FChaosVDCommands::RegisterCommands()
{
	...
	UI_COMMAND(DisconnectFromLiveSession, "Disconnect from Live Session", "Disconnects from a legacy live session", EUserInterfaceActionType::Button, FInputChord(EModifierKey::Control | EModifierKey::Shift, EKeys::X));
