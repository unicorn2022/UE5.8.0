...
void ULegacyCameraShake::DoStopShake(bool bImmediately)
{
	...
	UE_LOGF(LogLegacyCameraShake, Verbose, "ULegacyCameraShake::DoStopShake %ls", *GetNameSafe(this));
...
void ULegacyCameraShake::DoStartShake(const FCameraShakePatternStartParams& Params)
{
	...
	UE_LOGF(LogLegacyCameraShake, Verbose, "ULegacyCameraShake::DoStartShake %ls Duration: %f", *GetNameSafe(this), ActualOscillationDuration);
...
void ULegacyCameraShake::DoUpdateShake(const FCameraShakePatternUpdateParams& Params, FCameraShakePatternUpdateResult& OutResult)
{
	...
	UE_LOGF(LogLegacyCameraShake, Verbose, "ULegacyCameraShake::DoUpdateShake %ls Finished: %i Duration: %f Remaining: %f", *GetNameSafe(this), bOscillationFinished, ActualOscillationDuration, OscillatorTimeRemaining);
}
