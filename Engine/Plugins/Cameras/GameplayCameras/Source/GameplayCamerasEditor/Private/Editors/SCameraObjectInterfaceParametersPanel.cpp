...
#define LOCTEXT_NAMESPACE "SCameraObjectInterfaceParametersPanel"
...
void SCameraObjectInterfaceParametersPanel::OnSearchInterfaceParameter(TObjectPtr<UCameraObjectInterfaceParameterBase> Item)
{
	Toolkit->OnSearchInterfaceParameterNodes().Broadcast(Item);
}
		...
		TSharedPtr<SListView<TObjectPtr<ItemType>>> ListView, TObjectPtr<ItemType> Item)
{
	...
	MenuBuilder.BeginSection(NAME_None, LOCTEXT("InterfaceParameterActionsSection", "Actions"));
	{
		TObjectPtr<UCameraObjectInterfaceParameterBase> ItemBase(Item);
		MenuBuilder.AddMenuEntry(
				LOCTEXT("SearchInterfaceParameterNodes", "Find References"),
				LOCTEXT("SearchInterfaceParameterNodesToolTip", "Find references to this interface parameter"),
				FSlateIcon(FAppStyle::GetAppStyleSetName(), "Icons.Search"),
				FExecuteAction::CreateSP(this, &SCameraObjectInterfaceParametersPanel::OnSearchInterfaceParameter, ItemBase));
	}
