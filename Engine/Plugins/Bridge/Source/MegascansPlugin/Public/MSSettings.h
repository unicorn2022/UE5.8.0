...
public:
	...
	TSoftObjectPtr<class UMaterial> MasterMaterial3d;
	//TSoftObjectPtr<class UMaterialInterface> MasterMaterial3d;
	...
	TSoftObjectPtr<class UMaterial> MasterMaterialSurface;
	...
	TSoftObjectPtr<class UMaterial> MasterMaterialPlant;
