...
void UClothMeshSelectionTool::Setup()
{
	...
	if (ExistingNodeSelection.SelectedCornerIDs.Num() > 0 || 
		SelectionNodeToUpdate->Group.Name == UE::Chaos::ClothAsset::ClothCollectionGroup::SimVertices3D || 
		SelectionNodeToUpdate->Group.Name == UE::Chaos::ClothAsset::ClothCollectionGroup::SimVertices2D ||
		SelectionNodeToUpdate->Group.Name == UE::Chaos::ClothAsset::ClothCollectionGroup::RenderVertices)
	{
