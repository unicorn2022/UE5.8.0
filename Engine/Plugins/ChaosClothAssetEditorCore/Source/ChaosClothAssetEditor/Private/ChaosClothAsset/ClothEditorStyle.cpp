	...
	: FSlateStyleSet(StyleName)
{
	...
	if (const TSharedPtr<IPlugin> ChaosClothAssetEditorPlugin = IPluginManager::Get().GetModuleOwnerPlugin(UE_MODULE_NAME))
	{
		SetContentRoot(ChaosClothAssetEditorPlugin->GetContentDir());
