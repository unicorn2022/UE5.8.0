...
public:
	...
	void OnRenderSettingsUpdated(const TArray<UDataflowRenderableTypeSettings*>& RenderSettings);
...
private:
	...
	void OnSettingsPropertiesChanged(const FPropertyChangedEvent& PropertyChangedEvent);

	void RefreshConstructionScene();
	...
	TArray<UDataflowRenderableTypeSettings*> RenderSettings;
};
