...
namespace UE::Dataflow
{
	...
	* return true if the animatiuon was properly set 
	*/
	bool SetupSkeletonAnimation(const TObjectPtr<AActor>& PreviewActor, const bool bSkeletalMeshVisibility = true);
