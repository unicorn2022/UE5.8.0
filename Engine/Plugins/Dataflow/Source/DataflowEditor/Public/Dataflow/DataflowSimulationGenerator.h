...
namespace UE::Dataflow
{
	...
	public:
		...
		/** Set the blueprint variables' values used to customize the blueprint */
		void SetBlueprintVariables(const FInstancedPropertyBag& InBlueprintVariables);
	...
	private:
		...
		/** Blueprint variables' values used to customize the blueprint */
