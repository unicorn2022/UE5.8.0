...
class FEditor2DMouseWheelZoomBehaviorTarget;
...
public:
	...
	UE::Widget::EWidgetMode GetToolWidgetMode() const {return WidgetMode;}

	UE_API void ShowMeshEdges(bool bShow);

	UE_API void FocusViewportOnBoundingBox(const FBox& BoundingBox, bool bInstant);
...
private:
	...
	UE_API void UpdateFromSettings();
	...
	FDelegateHandle OnSettingsChangeHandle;
};
