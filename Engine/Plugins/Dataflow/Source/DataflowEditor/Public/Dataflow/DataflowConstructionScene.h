...
class UDataflowDebugMeshRenderSettings;
...
public:
	...
	inline static FName DebugMeshComponentTag = TEXT("MeshDebugComponent");
	...
	/** Get all Debug draw components */
	UE_API TArray<TObjectPtr<UDebugDrawComponent>> GetDebugDrawComponents() const;

	/** Get the render settings for the selected nodes */
	UE_API TArray<UObject*> GetRenderSettings() const;
	...
	/** Get the render settings for matching the selected nodes */
	UE_API TArray<UDataflowRenderableTypeSettings*> GetRenderableTypeSettings() const;

	DECLARE_MULTICAST_DELEGATE(FOnConstructionSceneUpdated)
	FOnConstructionSceneUpdated OnConstructionSceneUpdated;
...
private:
	...
	TObjectPtr<UDataflowDebugMeshRenderSettings> DebugMeshRenderSettings = nullptr;
};
