...
public:
	...
	*/
	...
	TSharedPtr<FUICommandInfo> ConvertToEmbeddedDataflow;
	TSharedPtr<FUICommandInfo> ConvertToExternalDataflow;
	TSharedPtr<FUICommandInfo> ToggleDataflowEditingLock;
...
{
public:
	UE_DEPRECATED(5.8, "Use SDataflowGraphEditor::FGraphEvaluationCallback instead ")
	typedef TFunction<void(const FDataflowNode*, const FDataflowOutput*)> FGraphEvaluationCallback;

	UE_DEPRECATED(5.8, "Use SDataflowGraphEditor::FOnDragDropEventCallback instead ")
	...
	*/
	...
	static UE_API void OnCommentPropertyValueChanged(const FPropertyChangedEvent& PropertyChangedEvent, const TSet<TObjectPtr<UEdGraphNode_Comment>>& CommentSelection = {});
