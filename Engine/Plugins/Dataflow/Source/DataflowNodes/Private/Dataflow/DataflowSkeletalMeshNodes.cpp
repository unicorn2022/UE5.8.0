...
const FReferenceSkeleton& FDataflowDebugDrawSkeletonObject::GetReferenceSkeleton() const
{
...
void FDataflowDebugDrawSkeletonObject::DrawDataflowElements(FPrimitiveDrawInterface* PDI) 
{
	...
	{
		// this method can be called on a different thread than the game thread 
		// let's make sure the bon change broadcast happens on the game thread
