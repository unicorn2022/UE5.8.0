...
{
	static const FAssetCategoryPath Categories[] = { FAssetCategoryPath(EAssetCategoryPaths::Misc, LOCTEXT("DirectoryPlaceholder_CategorySection", "Other"), ECategoryMenuType::Section) };
	return Categories;
}
