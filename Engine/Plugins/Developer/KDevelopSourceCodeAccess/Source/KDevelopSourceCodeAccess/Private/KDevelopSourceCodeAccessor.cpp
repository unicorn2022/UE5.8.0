...
bool FKDevelopSourceCodeAccessor::OpenSolutionAtPath(const FString& InSolutionPath)
{
	...
	{
		UE_LOGF(LogKDevelopAccessor, Warning, "FKDevelopSourceCodeAccessor::OpenSourceFiles: cannot find kdevelop binary");
		return false;
	}
...
{
	FString SolutionPath = GetSolutionPath();
	UE_LOGF(LogKDevelopAccessor, Display, "SolutionPath: %ls", *SolutionPath);
