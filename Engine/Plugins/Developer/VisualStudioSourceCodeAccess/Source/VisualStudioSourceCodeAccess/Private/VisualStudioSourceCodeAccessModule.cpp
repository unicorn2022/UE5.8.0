...
void FVisualStudioSourceCodeAccessModule::StartupModule()
{
	...
	RegisterWrapper("VisualStudio2026", LOCTEXT("VisualStudio2026", "Visual Studio 2026"), LOCTEXT("UsingVisualStudio2026", "Open source code files in Visual Studio 2026"));
