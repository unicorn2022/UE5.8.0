...
bool FSubversionSourceControlProvider::UsesSoftRevertOnDelete() const
{
	return false;
}
...
TOptional<bool> FSubversionSourceControlProvider::HasChangesToSync() const
{
	return TOptional<bool>();
}

TOptional<bool> FSubversionSourceControlProvider::HasChangesToCheckIn() const
{
	return TOptional<bool>();
}
