...
{
	static const FAssetCategoryPath Categories[] = { FAssetCategoryPath(EAssetCategoryPaths::Misc, NSLOCTEXT("AssetDefinition_NamingTokens", "NamingTokens_CategorySection", "Other"), ECategoryMenuType::Section) };
	return Categories;
}
