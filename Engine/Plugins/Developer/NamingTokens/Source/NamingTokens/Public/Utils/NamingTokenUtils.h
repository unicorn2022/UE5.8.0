...
namespace UE::NamingTokens::Utils
{
	 ...
	 * @param InTokenString The string to process.
	 * @param bNormalizeString If the string should be normalized first, stripping any whitespace within braces.
	 */
	NAMINGTOKENS_API TArray<FString> GetTokenKeysFromString(const FString& InTokenString, bool bNormalizeString=true);
