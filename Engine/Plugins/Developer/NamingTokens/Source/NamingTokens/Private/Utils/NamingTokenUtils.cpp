...
TArray<FString> UE::NamingTokens::Utils::GetTokenKeysFromString(const FString& InTokenString, bool bNormalizeString)
{
	const FString NormalizedString = bNormalizeString ? Private::NormalizeTokenString(InTokenString) : InTokenString;
	...
	FRegexMatcher Matcher(Pattern, NormalizedString);
