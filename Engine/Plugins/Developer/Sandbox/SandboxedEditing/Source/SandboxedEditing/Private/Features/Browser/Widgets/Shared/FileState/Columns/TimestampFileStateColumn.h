...
{
/** Displays the timestamp of the sandboxed file change. */
class FTimestampFileStateColumn : public IFileStateColumnBehavior, public IFileStateColumnWidgetFactory
{
public:
