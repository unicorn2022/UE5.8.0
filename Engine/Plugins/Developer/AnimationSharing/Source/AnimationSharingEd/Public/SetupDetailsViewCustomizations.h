...
public:
	...
	virtual ~FPerSkeletonAnimationSharingSetupCustomization() = default;
...
public:
	...
	virtual ~FAnimationStateEntryCustomization() = default;
...
public:
	...
	virtual ~FAnimationSetupCustomization() = default;
