...
/** Returns an error messages if the specified path name is invalid, otherwise, returns an empty text. */
FText CONCERT_API ValidateFileSharingPath(const FString& Path);
