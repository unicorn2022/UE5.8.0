...
{
public:
	virtual ~IConcertRequestHandler() = default;
...
{
public:
	virtual ~IConcertEventHandler() = default;
...
public:
	...
	{}
	virtual ~TConcertFunctionEventHandler() = default;
...
public:
	...
	virtual ~TConcertRawEventHandler() = default;
...
public:
	...
	TConcertFunctionRequestHandler(FFuncType InFunc)
		: Func(MoveTemp(InFunc))
	{}
	virtual ~TConcertFunctionRequestHandler() = default;
...
public:
	...
	virtual ~TConcertRawRequestHandler() = default;
