...
private:
	...
	TWeakPtr<UE::FileSandboxUI::IExternalSandboxActiveViewModel> ExternalSandboxViewModel;
	...
	void AttachActiveWidget(const TSharedRef<IConcertSyncClient>& InConcertSyncClient);
	void AttachBrowserWidget(const TSharedRef<IConcertSyncClient>& InConcertSyncClient);
};
