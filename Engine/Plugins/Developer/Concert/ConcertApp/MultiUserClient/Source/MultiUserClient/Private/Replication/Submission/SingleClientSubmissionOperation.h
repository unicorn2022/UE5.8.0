...
namespace UE::MultiUserClient::Replication
{
	...
	public:
		...
		void EmplaceStreamPromise(FSubmitStreamChangesResponse Result)
		{
			...
			UE_LOGF(LogConcert, Log, "Submission operation: Completed stream request stage.");
		}
		void EmplaceAuthorityRequestPromise(FSubmitAuthorityChangesRequest Result)
		{
			...
			UE_LOGF(LogConcert, Log, "Submission operation: Complete authority request stage.");
		}
		void EmplaceAuthorityResponsePromise(FSubmitAuthorityChangesResponse Result)
		{
			...
			UE_LOGF(LogConcert, Log, "Submission operation: Completed authority response stage.");
		}
		void EmplaceCompleteOperationPromise(ESubmissionOperationCompletedCode Result)
		{
			...
			UE_LOGF(LogConcert, Log, "Submission operation: Completed operation.");
		}
