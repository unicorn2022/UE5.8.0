...
template <>
struct TWidgetTypeTraits<class SConcertWorkspaceLockStateIndicator>
{
...
template<>
struct TWidgetTypeTraits<class SConcertWorkspaceModifiedByOtherIndicator>
{
	static constexpr bool SupportsInvalidation() { return true; }
};
...
bool FConcertWorkspaceUI::PromptPersistSessionChanges()
{
	...
	FPersistResult PersistResult = ClientWorkspacePin->PersistSessionChanges(
		{PersistCmd.PackagesToPersist, PersistCmd.bShouldMakeFilesWritable});
