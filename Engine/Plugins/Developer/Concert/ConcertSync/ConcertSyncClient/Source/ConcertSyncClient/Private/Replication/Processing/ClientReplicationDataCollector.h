...
namespace UE::ConcertSyncClient::Replication
{
	...
	public:
		...
		virtual void ConsumePendingObjects(TFunctionRef<void(const ConcertSyncCore::FPendingObjectReplicationInfo& Info, ConcertSyncCore::IReplicationDataItem& Item)> InProcess) override;
