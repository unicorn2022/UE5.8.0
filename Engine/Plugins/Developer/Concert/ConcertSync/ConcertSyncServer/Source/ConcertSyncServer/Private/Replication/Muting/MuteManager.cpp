...
namespace UE::ConcertSyncServer::Replication
{
	...
	void FMuteManager::ApplyRequestInternal(const FConcertReplication_ChangeMuteState_Request& Request)
	{
		...
		UE_CLOGF(bResetState, LogConcert, Log, "Explicitly muting %d and unmuting %d objects.", Request.ObjectsToMute.Num(), Request.ObjectsToUnmute.Num());
		UE_CLOGF(!bResetState, LogConcert, Log, "Explicitly muting %d and unmuting %d objects. Resetting mute state before.", Request.ObjectsToMute.Num(), Request.ObjectsToUnmute.Num());
