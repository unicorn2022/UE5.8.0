...
public:
	...
	/**
	 * Creates a shared reference to the file sharing service to be used by concert.
	 *
	 * @return a non-null shared reference to the file sharing service. 
	 */
	virtual TSharedRef<IConcertFileSharingService> CreateFileSharingService(const FString& InRole) = 0;
