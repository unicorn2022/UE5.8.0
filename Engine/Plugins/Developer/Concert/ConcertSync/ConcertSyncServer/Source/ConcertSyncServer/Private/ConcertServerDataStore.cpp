	...
	if (Result.Code == EConcertDataStoreResultCode::Fetched)
	{
		...
		if ((Request.ExpectedVersion != 0 && Request.ExpectedVersion == Result.Value->Version) ||
		    (Request.ExpectedVersion == 0
			 && Result.Value->SerializedValue.PayloadCompressionMethod == Request.Expected.PayloadCompressionMethod
			 && Result.Value->SerializedValue.PayloadCompressionBias == Request.Expected.PayloadCompressionBias
