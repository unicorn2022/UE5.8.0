...
struct FConcertSyncServerLoopInitArgs
{
	...
	/** Function to get the file sharing service during initialization of concert server. f this is defined then it takes precedence over FileSharingService member. */
	TFunction<TSharedPtr<IConcertFileSharingService>()> GetFileSharingServiceFunc;
