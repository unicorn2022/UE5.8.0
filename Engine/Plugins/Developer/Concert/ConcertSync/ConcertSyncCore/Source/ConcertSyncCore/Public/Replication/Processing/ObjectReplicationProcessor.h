...
namespace UE::ConcertSyncCore
{
	...
	protected:
		...
		struct FObjectProcessArgs
		{
			...
			/** Item you can use to extract the replication info from. */
			IReplicationDataItem& Item;

			explicit FObjectProcessArgs(FPendingObjectReplicationInfo InObjectInfo, IReplicationDataItem& InItem)
				: ObjectInfo(MoveTemp(InObjectInfo)) , Item(InItem)
			{}
		};
