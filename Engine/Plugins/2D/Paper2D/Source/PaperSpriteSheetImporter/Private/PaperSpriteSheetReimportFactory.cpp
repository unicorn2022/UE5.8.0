...
EReimportResult::Type UPaperSpriteSheetReimportFactory::Reimport(UObject* Obj)
{
	...
	{
		UE_LOGF(LogPaperSpriteSheetImporter, Log, "Imported successfully");
	...
	else
	{
		if (OutCanceled)
		{
			UE_LOGF(LogPaperSpriteSheetImporter, Warning, "-- import canceled");
		}
		else
		{
			UE_LOGF(LogPaperSpriteSheetImporter, Warning, "-- import failed");
		}
