...
bool FSingleTileEditorViewportClient::OnTransformCanceled(const FGizmoState& InState)
{
	return HandleCancelTransform();
}
...
bool FSingleTileEditorViewportClient::HandleCancelTransform()
{
	if (TileSet)
	{
