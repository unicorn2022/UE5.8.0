...
namespace UE::Interchange::Utilities::Private
{
	...
	bool FilePickerDialog(const FString& Extensions, const FInterchangeFilePickerParameters& Parameters, TArray<FString>& OutFilenames)
	{
...
bool UInterchangeFilePickerGeneric::FilePickerForTranslatorAssetType(const EInterchangeTranslatorAssetType TranslatorAssetType, const FInterchangeFilePickerParameters& Parameters, TArray<FString>& OutFilenames)
{
...
bool UInterchangeFilePickerGeneric::FilePickerForTranslatorType(const EInterchangeTranslatorType TranslatorType, const FInterchangeFilePickerParameters& Parameters, TArray<FString>& OutFilenames)
{
	FString Extensions = UE::Interchange::Utilities::Private::GetOpenFileDialogExtensions
	(
