...
private:
	...
	void BuildStringInterchangeMeshLODDataValueContent(IDetailCategoryBuilder& AttributeCategory, UE::Interchange::FAttributeKey& AttributeKey);
	void BuildStringInterchangeMeshLODDataArrayValueContent(IDetailCategoryBuilder& AttributeCategory, UE::Interchange::FAttributeKey& AttributeKey);
