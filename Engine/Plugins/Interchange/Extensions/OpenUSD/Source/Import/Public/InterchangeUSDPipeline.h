...
public:
	...
	UE_DEPRECATED(5.8, "This option has moved back to the USD translator settings")
	UPROPERTY(meta = (Bitmask, BitmaskEnum = "/Script/UnrealUSDWrapper.EUsdPurpose"))
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "USD", meta = (ClampMin = "0", ClampMax = "6", UIMin = "0", UIMax = "6"))
