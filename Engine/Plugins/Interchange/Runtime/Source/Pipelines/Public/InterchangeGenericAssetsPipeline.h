...
{
	using FExpansionPredicate = TDelegate<bool(TSharedPtr<UInterchangeGenericAssetsPipeline::FSkeletonJoint>)>;
...
private:
	...
	//////////////////////////////////////////////////////////////////////////
	// Recursive Expansion
	void OnSetExpansionRecursive(TSharedPtr<UInterchangeGenericAssetsPipeline::FSkeletonJoint> SkeletonJoint, bool bShouldBeExpanded, const FExpansionPredicate Predicate = FExpansionPredicate());
	//////////////////////////////////////////////////////////////////////////
