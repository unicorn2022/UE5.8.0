...
public:
	...
	/** If enabled, import all groom bindings found in the source. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Grooms", meta = (EditCondition = bEnableGroomTypesImport))
	bool bImportGroomBindings = true;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Grooms", meta = (SubCategory = "Bindings", ClampMin = "0", ClampMax = "100"))
