...
UENUM(BlueprintType)
enum class EInterchangeFrameAlignment : uint8
{
	None            UMETA(DisplayName = "None"),
	SnapToFloor     UMETA(DisplayName = "Snap To Floor"),
	SnapToClosest   UMETA(DisplayName = "Snap To Closest Frame Boundary"),
	SnapToCeiling   UMETA(DisplayName = "Snap To Ceiling")
};
...
public:
	...
	EInterchangeFrameAlignment FrameAlignment = EInterchangeFrameAlignment::None;

	UPROPERTY()
	bool bSnapToClosestFrameBoundary_DEPRECATED = false;
