...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Interchange | Node | Material")
	INTERCHANGEFACTORYNODES_API bool GetCustomDisplacementMagnitude(float& AttributeValue) const;

	UFUNCTION(BlueprintCallable, Category = "Interchange | Node | Material")
	INTERCHANGEFACTORYNODES_API bool SetCustomDisplacementMagnitude(float AttributeValue);
...
private:
	...
	IMPLEMENT_NODE_ATTRIBUTE_KEY(DisplacementMagnitude)
};
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Interchange | Node | MaterialInstanceFactory")
	INTERCHANGEFACTORYNODES_API bool SetCustomTwoSided(bool AttributeValue);

	/** Used to enable displacement*/
	UFUNCTION(BlueprintCallable, Category = "Interchange | Node | MaterialInstanceFactory")
	INTERCHANGEFACTORYNODES_API bool GetCustomEnableTessellation(bool& AttributeValue) const;

	UFUNCTION(BlueprintCallable, Category = "Interchange | Node | MaterialInstanceFactory")
	INTERCHANGEFACTORYNODES_API bool SetCustomEnableTessellation(bool AttributeValue);
