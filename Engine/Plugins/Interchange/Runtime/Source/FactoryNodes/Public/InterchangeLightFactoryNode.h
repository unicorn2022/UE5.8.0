...
public:
	UFUNCTION(BlueprintCallable, Category = "Interchange | Node | DirectionalLightFactory")
	UE_API bool GetCustomLightSourceAngle(float& AttributeValue) const;

	UFUNCTION(BlueprintCallable, Category = "Interchange | Node | DirectionalLightFactory")
	UE_API bool SetCustomLightSourceAngle(float AttributeValue, bool bAddApplyDelegate = true);
...
private:
	IMPLEMENT_NODE_ATTRIBUTE_KEY(LightSourceAngle)
};
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Interchange | Node | PointLightFactory")
	UE_API bool GetCustomSourceRadius(float& AttributeValue) const;

	UFUNCTION(BlueprintCallable, Category = "Interchange | Node | PointLightFactory")
	UE_API bool SetCustomSourceRadius(float AttributeValue, bool bAddApplyDelegate = true);
...
private:
	...
	IMPLEMENT_NODE_ATTRIBUTE_KEY(SourceRadius)
};
