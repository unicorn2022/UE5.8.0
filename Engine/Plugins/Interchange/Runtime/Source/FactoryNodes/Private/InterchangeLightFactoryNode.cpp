...
bool UInterchangeDirectionalLightFactoryNode::GetCustomLightSourceAngle(float& AttributeValue) const
{
	IMPLEMENT_NODE_ATTRIBUTE_GETTER(LightSourceAngle, float)
}

bool UInterchangeDirectionalLightFactoryNode::SetCustomLightSourceAngle(float AttributeValue, bool bAddApplyDelegate)
{
	IMPLEMENT_NODE_ATTRIBUTE_SETTER(UInterchangeDirectionalLightFactoryNode, LightSourceAngle, float, UDirectionalLightComponent)
}

void UInterchangeDirectionalLightFactoryNode::CopyWithObject(const UInterchangeFactoryBaseNode* SourceNode, UObject* Object)
{
	Super::CopyWithObject(SourceNode, Object);

	if (const UInterchangeDirectionalLightFactoryNode* LightFactoryNode = Cast<UInterchangeDirectionalLightFactoryNode>(SourceNode))
	{
		COPY_NODE_DELEGATES(LightFactoryNode, LightSourceAngle, float, UDirectionalLightComponent)
	}
}

void UInterchangeDirectionalLightFactoryNode::OnRestoreAllCustomAttributeDelegates()
{
	Super::OnRestoreAllCustomAttributeDelegates();
	REFILL_CUSTOM_ATTRIBUTE_APPLY_DELEGATE(LightSourceAngle, float);
}
...
bool UInterchangePointLightFactoryNode::GetCustomSourceRadius(float& AttributeValue) const
{
	IMPLEMENT_NODE_ATTRIBUTE_GETTER(SourceRadius, float)
}

bool UInterchangePointLightFactoryNode::SetCustomSourceRadius(float AttributeValue, bool bAddApplyDelegate)
{
	IMPLEMENT_NODE_ATTRIBUTE_SETTER(UInterchangePointLightFactoryNode, SourceRadius, float, UPointLightComponent)
}
...
void UInterchangePointLightFactoryNode::CopyWithObject(const UInterchangeFactoryBaseNode* SourceNode, UObject* Object)
{
	...
	if (const UInterchangePointLightFactoryNode* LightFactoryNode = Cast<UInterchangePointLightFactoryNode>(SourceNode))
	{
		...
		COPY_NODE_DELEGATES(LightFactoryNode, SourceRadius, float, UPointLightComponent)
	}
}
