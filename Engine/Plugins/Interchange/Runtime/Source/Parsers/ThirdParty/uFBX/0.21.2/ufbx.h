...
struct ufbx_mesh {
	...
	ufbx_uint32_list face_smoothing_groups; // < Raw ByPolygon smoothing group bitmasks; two faces share a smooth edge iff (group_a & group_b) != 0
