	...
	namespace Interchange
	{
		...
		namespace Private
		{
			...
			struct FFbxJointMeshBindPoseGenerator
			{
				...
				FFbxJointMeshBindPoseGenerator(FbxScene* SDKScene, FFbxParser& Parser, const bool bConsiderClusterBeforePoseForMeshBindPose);
			...
			{
			public:
				virtual ~FMeshPayloadContext() = default;
			...
			{
			public:
				virtual ~FMorphTargetPayloadContext() = default;
