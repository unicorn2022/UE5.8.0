	...
	namespace Interchange
	{
		namespace Private
		{
			...
			protected:
				...
				void ConvertValuePropertyToMaterialInstanceNode(UInterchangeMaterialInstanceNode* MaterialInstanceNode,
					FbxProperty& Property, float Factor, FName InputName,
					const TVariant<FLinearColor, float>& DefaultValue, bool bInverse);
				const UInterchangeTexture2DNode* ConvertTexturePropertyToMaterialInstanceNode(UInterchangeBaseNodeContainer& NodeContainer,
				                                                  UInterchangeMaterialInstanceNode* MaterialInstanceNode,
				                                                  FName InputName, FbxFileTexture* FbxTexture);
