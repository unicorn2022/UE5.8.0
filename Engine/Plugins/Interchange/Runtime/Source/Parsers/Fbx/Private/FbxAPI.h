	...
	namespace Interchange
	{
		namespace Private
		{
			...
			public:
				...
				virtual void SetConvertSettings(const bool InbConvertScene, const bool InbForceFrontXAxis, const bool InbConvertSceneUnit, const bool InbKeepFbxNamespace, const bool InbConsiderClusterBeforePoseForMeshBindPose) = 0;
			...
			public:
				...
				*/
				...
				bool GetUseFbxClustersForBindPoseMatrices() const { return bConsiderClusterBeforePoseForMeshBindPose; }
