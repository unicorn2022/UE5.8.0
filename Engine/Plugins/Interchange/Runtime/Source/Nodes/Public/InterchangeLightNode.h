...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Interchange | Node | PointLight")
	UE_API bool SetCustomSourceRadius(float AttributeValue);
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Interchange | Node | DirectionalLight")
	UE_API bool GetCustomLightSourceAngle(float& AttributeValue) const;

	UFUNCTION(BlueprintCallable, Category = "Interchange | Node | DirectionalLight")
	UE_API bool SetCustomLightSourceAngle(float AttributeValue);
