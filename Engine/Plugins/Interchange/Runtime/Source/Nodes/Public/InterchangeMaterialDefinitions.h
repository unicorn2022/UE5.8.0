	...
	namespace Materials
	{
		namespace Standard
		{
			namespace Nodes
			{
				...
				namespace Luminance
				{
					const FName Name = TEXT("Luminance");
					...
					{
						const FName LuminanceFactors = TEXT("LuminanceFactors");
					}
				}
				...
				{
					const FName Name = TEXT("TextureProperty");
					...
					namespace Attributes
					{
						const FName Property = TEXT("Property"); // Type: enum
					}
				}
		...
		namespace StandardSurface
		{
			...
			namespace SubstrateMaterial
			{
				namespace Outputs
				{
					...
					const FName Refraction = TEXT("Refraction (IOR)");
				}
			}
		}
