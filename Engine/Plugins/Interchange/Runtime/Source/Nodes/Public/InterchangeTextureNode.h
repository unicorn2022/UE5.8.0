...
public:
	...
	/**
	 * Utility function to build a unique and deterministic UID and Name for a given texture file path.
	 */
	static INTERCHANGENODES_API bool ExtractNodeUidAndNameFromFilePath(const FStringView TextureFilePath, FString& OutNodeUid, FString& OutNodeName);
	...
	{
		return FName(TEXT("ClassIcon.Texture2D"));
	}
