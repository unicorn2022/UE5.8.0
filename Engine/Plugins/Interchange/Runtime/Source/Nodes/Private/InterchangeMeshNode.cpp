...
FString UInterchangeMeshNode::GetKeyDisplayName(const UE::Interchange::FAttributeKey& NodeAttributeKey) const
{
	...
	{
		return KeyDisplayName = UE::Interchange::BuildDisplayNameForArrayKey(TEXT("Skeleton Dependencies Index "), NodeAttributeKeyString);
	}
	...
	{
		return KeyDisplayName = UE::Interchange::BuildDisplayNameForArrayKey(TEXT("Morph Target Dependencies Index "), NodeAttributeKeyString);
	}
	...
	{
		return KeyDisplayName = UE::Interchange::BuildDisplayNameForArrayKey(TEXT("Scene mesh instances Index "), NodeAttributeKeyString);
	}
