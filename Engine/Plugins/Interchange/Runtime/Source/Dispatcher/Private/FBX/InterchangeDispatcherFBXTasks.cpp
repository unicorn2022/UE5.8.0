...
namespace UE::Interchange
{
	...
	const TCHAR* FJsonFBXLoadSourceCmd::UseFbxClustersForBindPoseMatricesJsonKey = TEXT("UseFbxClustersForBindPoseMatrices");
	...
	TSharedPtr<FJsonObject> FJsonFBXLoadSourceCmd::GetActionDataObject() const
	{
		...
		ActionDataObject->SetBoolField(UseFbxClustersForBindPoseMatricesJsonKey, bConsiderClusterBeforePoseForMeshBindPose);
	...
	bool FJsonFBXLoadSourceCmd::IsActionDataObjectValid(const FJsonObject& ActionDataObject)
	{
		...
		if (!(ActionDataObject.TryGetBoolField(UseFbxClustersForBindPoseMatricesJsonKey, bConsiderClusterBeforePoseForMeshBindPose)))
		{
			return false;
		}
