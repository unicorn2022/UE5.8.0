...
void FInterchangeImportModule::StartupModule()
{
	...
	auto RegisterItems = []()
	{
		...
		InterchangeManager.RegisterFactory(UInterchangeGroomBindingFactory::StaticClass());
		...
		InterchangeManager.RegisterFactory(UInterchangeGeometryCacheActorFactory::StaticClass());
