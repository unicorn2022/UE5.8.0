...
void FMaterialXBase::CollectAnalytics(TArray<FAnalyticsEventAttribute>& OutAnalyticsAttributes)
{
	OutAnalyticsAttributes.Append(AnalyticsAttributes);
}
...
void FMaterialXBase::ConvertGeomPropValueNodesToTexCoord(MaterialX::GraphElementPtr Graph)
{
	...
	for (mx::NodePtr Node : Nodes)
	{
		...
		// check if the value has either a value string or an interfacename
