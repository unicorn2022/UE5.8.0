...
enum class EInterchangeMaterialXShaders : uint8
{
	...
	/** Default settings for glTF Surface shader. */
	GltfPBR,
...
namespace UE
{
	...
	namespace Expressions
	{
		namespace Names
		{
			...
			inline constexpr const TCHAR* MaterialXFractal = TEXT("MaterialXFractal");
	...
	namespace MaterialFunctions
	{
		namespace Path
		{
			...
			inline constexpr const TCHAR* MxHeightToNormalMap = TEXT("/InterchangeAssets/Functions/MX_HeightToNormal.MX_HeightToNormal");
			inline constexpr const TCHAR* MxHexTiledImage = TEXT("/InterchangeAssets/Functions/MX_HexTiledImage.MX_HexTiledImage");
			inline constexpr const TCHAR* MxHexTiledNormalMap= TEXT("/InterchangeAssets/Functions/MX_HexTiledNormalMap.MX_HexTiledNormalMap");
			inline constexpr const TCHAR* MxHsvAdjust = TEXT("/InterchangeAssets/Functions/MX_HSVAdjust.MX_HSVAdjust");
			inline constexpr const TCHAR* MxLatLongImage = TEXT("/InterchangeAssets/Functions/MX_LatLongImage.MX_LatLongImage");
			...
			inline constexpr const TCHAR* MxRotate3D = TEXT("/InterchangeAssets/Functions/MX_Rotate3D.MX_Rotate3D");
...
MATERIALX_NAMESPACE_BEGIN
	...
	namespace OpenPBRSurface
	{
		...
		namespace DefaultValue
		{
			...
			inline constexpr FLinearColor BaseColor{ 0.8f, 0.8f, 0.8f };
			...
			inline constexpr FLinearColor SubsurfaceColor{ 0.8f, 0.8f, 0.8f };
	...
	namespace GltfPbr
	{
		namespace Input
		{
			...
			inline constexpr const char* AlphaMode = "alpha_mode";
			inline constexpr const char* AlphaCutoff = "alpha_cutoff";
			inline constexpr const char* Iridescence = "iridescence";
			inline constexpr const char* IridescenceIor = "iridescence_ior";
			inline constexpr const char* IridescenceThickness = "iridescence_thickness";
			inline constexpr const char* SheenColor = "sheen_color";
			inline constexpr const char* SheenRoughness = "sheen_roughness";
			inline constexpr const char* Clearcoat = "clearcoat";
			inline constexpr const char* ClearcoatRoughness = "clearcoat_roughness";
			inline constexpr const char* ClearcoatNormal = "clearcoat_normal";
			inline constexpr const char* Emissive = "emissive";
			inline constexpr const char* EmissiveStrength = "emissive_strength";
			inline constexpr const char* Thickness = "thickness";
			inline constexpr const char* AttenuationDistance = "attenuation_distance";
			inline constexpr const char* AttenuationColor = "attenuation_color";
			inline constexpr const char* AnisotropyStrength = "anisotropy_strength";
			inline constexpr const char* AnisotropyRotation = "anisotropy_rotation";
			inline constexpr const char* Dispersion = "dispersion";
		}
	}
	...
	namespace Category
	{
		...
		inline constexpr const char* Fractal2D = "fractal2d";
		...
		// Texture nodes 
		inline constexpr const char* HexTiledImage = "hextiledimage";
		inline constexpr const char* HexTiledNormalMap = "hextilednormalmap";
		inline constexpr const char* Image = "image";
		inline constexpr const char* LatLongImage = "latlongimage";
	...
	namespace NodeDefinition
	{
		...
		inline constexpr const char* GltfPbr = "ND_gltf_pbr_surfaceshader";
