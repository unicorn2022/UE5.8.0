...
public:
	...
	/** Returns true if there's at least 1 page in the active page list that can be loaded */
	bool CanLoadAllPages() const;
	/** Requests load all the pages in this page list that can play */
	void LoadAllPages();

	/** Returns true if there's at least 1 page in from the next pages in active page list that can be loaded */
	bool CanLoadNextPages() const;
	/** Requests load the next pages that can play */
	void LoadNextPages();

	/** Returns true if there's at least 1 page from the list of selected pages in active page list that can be loaded */
...
protected:
	...
	void PlayPageCommand(const TArray<FString>& InArgs, EAvaRundownPagePlayType InPlayType);
