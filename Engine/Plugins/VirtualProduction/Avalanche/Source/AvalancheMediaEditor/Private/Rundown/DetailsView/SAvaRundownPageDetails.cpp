	...
	[
		...
		[
			...
			[
				...
				[
					SNew(STextBlock)
					.Text(LOCTEXT("PerformanceTip_Desc", "Close Page Details during in-editor playback to improve performance.\n(Does not affect remote playback or playback in another process)"))
