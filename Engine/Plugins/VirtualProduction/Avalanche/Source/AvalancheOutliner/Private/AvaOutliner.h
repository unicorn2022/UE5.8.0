...
public:
	...
	void QueueActorHierarchyChange(AActor* InActor, const AActor* InParentActor, EAvaOutlinerHierarchyChangeType InChangeType);
...
private:
	...
	struct FActorHierarchyChange
	{
		TWeakObjectPtr<AActor> ActorWeak;
		TWeakObjectPtr<const AActor> ParentWeak;
		EAvaOutlinerHierarchyChangeType ChangeType;
	};
	TArray<FActorHierarchyChange> QueuedActorHierarchyChanges;
