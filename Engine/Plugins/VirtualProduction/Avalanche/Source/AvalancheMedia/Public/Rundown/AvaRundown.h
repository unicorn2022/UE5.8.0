...
public:
	 ...
	 * @param InSource the source that requested to play pages
	 * @return page Ids that where started.
	 */
	TArray<int32> PlayPages(const TArray<int32>& InPageIds, EAvaRundownPagePlayType InPlayType, EAvaRundownPagePlaySource InSource = EAvaRundownPagePlaySource::Default);
	 ...
	 * @return page Ids that where started.
	 */
	TArray<int32> PlayPages(const TArray<int32>& InPageIds, EAvaRundownPagePlayType InPlayType, const FName& InPreviewChannelName, EAvaRundownPagePlaySource InSource = EAvaRundownPagePlaySource::Default);

	bool PlayPage(int32 InPageId, EAvaRundownPagePlayType InPlayType, EAvaRundownPagePlaySource InSource = EAvaRundownPagePlaySource::Default);
	bool PlayPage(int32 InPageId, EAvaRundownPagePlayType InPlayType, const FName& InPreviewChannelName, EAvaRundownPagePlaySource InSource = EAvaRundownPagePlaySource::Default);
...
private:
	void OnPlayPages(const TArray<int32>& InPlayedPageIds, EAvaRundownPagePlayType InPlayType, FName InPreviewChannelName, EAvaRundownPagePlaySource InSource);
