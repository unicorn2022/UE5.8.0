...
public:
	...
	/**
	 * Called when the playable is visible, to determine if the playable is ready to transition and be shown.
	 * Should return true when all the elements are loaded/ready after becoming visible.
	 */
