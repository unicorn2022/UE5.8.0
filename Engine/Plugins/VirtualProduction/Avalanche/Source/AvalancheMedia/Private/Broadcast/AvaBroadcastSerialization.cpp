...
namespace UE::AvaMedia::BroadcastSerialization::Private
{
	...
	{
		for (TPair<FJsonObject::FStringType, TSharedPtr<FJsonValue>>& Value : InJsonObject->Values)
		{
...
bool FAvaBroadcastSerialization::SaveBroadcastToJson(const UAvaBroadcast* InBroadcast, const FString& InFilename)
{
	...
	{
		UE_LOGF(LogAvaBroadcast, Error, "Couldn't save data to file: %ls", *InFilename);
		return false;
	}
...
bool FAvaBroadcastSerialization::LoadBroadcastFromJson(const FString& InFilename, UAvaBroadcast* OutBroadcast)
{
	...
	{
		UE_LOGF(LogAvaBroadcast, Log, "Json Configuration file \"%ls\" not found.", *InFilename);
		return false;
	}
	...
	{
		UE_LOGF(LogAvaBroadcast, Error, "Couldn't read file: %ls", *InFilename);
		return false;
	}
	...
	{
		UE_LOGF(LogAvaBroadcast, Error, "Couldn't parse json data from file: %ls", *InFilename);
		return false;
	}
