...
bool UAvaDynamicMeshConverterModifier::ConvertComponents(TArray<TWeakObjectPtr<UMaterialInterface>>& OutMaterialsWeak)
{
	...
	FCEMeshBuilder::FCEMeshBuilderParams BuilderParams;
	BuilderParams.bNotifyMeshChangeEvents = true;
	return MeshBuilder.BuildDynamicMesh(DynamicMeshComponent->GetDynamicMesh(), OutMaterialsWeak, BuilderParams);
}
