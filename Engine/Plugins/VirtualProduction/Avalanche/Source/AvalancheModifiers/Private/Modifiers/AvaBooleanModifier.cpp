...
void UAvaBooleanModifier::OnTransformUpdated(AActor* InActor, bool bInParentMoved)
{
	...
	UActorModifierCoreSubsystem::GetModifierTicker().AddTicker(FTickerDelegate::CreateWeakLambda(this, [this, bInParentMoved, InActor](float InDelta)
	{
