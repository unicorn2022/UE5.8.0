...
public:
	...
	/**
	 * Retrieves the transition behavior from this context
	 */
	UFUNCTION(BlueprintPure, Category="Transition Logic", meta=(DefaultToSelf="InContextObject"))
	static UE_API TScriptInterface<IAvaTransitionBehavior> GetTransitionBehavior(UObject* InContextObject);
