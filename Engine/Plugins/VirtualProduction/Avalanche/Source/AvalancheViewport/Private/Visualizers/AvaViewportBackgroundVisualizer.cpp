	...
	: FAvaViewportPostProcessVisualizer(InAvaViewportClient)
{
	...
	if (!ViewportSettings)
	{
		UE_LOGF(AvaViewportLog, Warning, "FAvaViewportBackgroundVisualizer::FAvaViewportBackgroundVisualizer: Unable to find viewport settings.");
		return;
	}
	...
	{
		UE_LOGF(AvaViewportLog, Warning, "FAvaViewportBackgroundVisualizer::FAvaViewportBackgroundVisualizer: Unable to find background material.");
		return;
	}
...
void FAvaViewportBackgroundVisualizer::UpdatePostProcessMaterial()
{
	...
	{
		UE_LOGF(AvaViewportLog, Warning, "FAvaViewportBackgroundVisualizer::UpdatePostProcessMaterial: Invalid post process material.");
		return;
	}
