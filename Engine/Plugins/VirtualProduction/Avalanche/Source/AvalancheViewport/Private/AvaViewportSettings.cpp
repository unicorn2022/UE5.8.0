...
UAvaViewportSettings::UAvaViewportSettings()
{
	...
	GridSize = 50;
	GridColor = FLinearColor(0.6f, 0.0f, 0.0f, 0.4f);
	GridThickness = 1.f;

	bPixelGridEnabled = true;
	PixelGridColor = FLinearColor(0.5f, 0.5f, 0.5f, 0.4f);
