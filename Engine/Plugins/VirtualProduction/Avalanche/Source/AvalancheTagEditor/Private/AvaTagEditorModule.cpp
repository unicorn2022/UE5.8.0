...
#include "Customization/TagCustomizers/AvaTagSoftHandleContainerCustomizer.h"
...
void FAvalancheTagEditorModule::RegisterCustomizations()
{
	...
	PropertyEditorModule.RegisterCustomPropertyTypeLayout(CustomizedTypes.Add_GetRef(FAvaTagSoftHandleContainer::StaticStruct()->GetFName())
		, UE::AvaTagEditor::Private::CreateTagHandleCustomization<FAvaTagSoftHandleContainerCustomizer>());
