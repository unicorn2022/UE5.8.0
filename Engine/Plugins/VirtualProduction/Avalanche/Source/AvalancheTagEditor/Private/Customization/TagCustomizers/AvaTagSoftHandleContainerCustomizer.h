...
/** Customizer for FAvaTagSoftHandleContainer */
class FAvaTagSoftHandleContainerCustomizer : public IAvaTagHandleCustomizer
{
public:
	...
	virtual bool AllowMultipleTags() const override
	{
		return true;
	}
