...
namespace UE::AvaLevelViewport::Private
{
	...
	{
		const FSlateColor ActiveColor = FSlateColor(FLinearColor(0.0f, 0.45f, 0.9f, 1.0f));
		const FSlateColor EnabledColor = FSlateColor(FStyleColors::AccentGray.GetSpecifiedColor());
		const FSlateColor DisabledColor = FSlateColor(FLinearColor(0.5f, 0.1f, 0.1f, 1.0f));
