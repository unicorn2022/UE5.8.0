...
public:
	...
	/** Returns the root category for motion design tabs and other categories */
	virtual const TSharedPtr<FWorkspaceItem>& GetRootCategory() const = 0;

	/** Returns the outliner sub-category for motion design tabs */
	virtual const TSharedPtr<FWorkspaceItem>& GetOutlinerCategory() const = 0;

	/** Returns the tools sub-category for motion design tabs */
	virtual const TSharedPtr<FWorkspaceItem>& GetToolsCategory() const = 0;
