...
protected:
	...
	virtual const TSharedPtr<FWorkspaceItem>& GetRootCategory() const override;
	virtual const TSharedPtr<FWorkspaceItem>& GetOutlinerCategory() const override;
	virtual const TSharedPtr<FWorkspaceItem>& GetToolsCategory() const override;
	//~ End IAvaEditor
...
private:
	...
	/** Tab Categories */
	TSharedPtr<FWorkspaceItem> RootCategory;
	TSharedPtr<FWorkspaceItem> OutlinerCategory;
