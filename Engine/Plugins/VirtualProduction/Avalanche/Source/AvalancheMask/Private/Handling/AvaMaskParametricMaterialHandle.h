...
public:
	...
	virtual bool SetMaskParameters(UTexture* InTexture, float InBaseOpacity, bool bInInverted, const FVector2f& InPadding, bool bInApplyFeathering, float InOuterFeathering, float InInnerFeathering) override;
