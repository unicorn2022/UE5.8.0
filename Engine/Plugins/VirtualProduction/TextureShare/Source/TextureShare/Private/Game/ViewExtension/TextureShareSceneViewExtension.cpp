...
namespace UE::TextureShare::SceneViewExtension
{
	...
	{
		OutViewMatrices.ProjectionMatrix = InViewMatrices.GetViewToClip();
		OutViewMatrices.ProjectionNoAAMatrix = InViewMatrices.GetViewToClipNoAA();
		OutViewMatrices.ViewMatrix = InViewMatrices.GetWorldToView();
		OutViewMatrices.ViewProjectionMatrix = InViewMatrices.GetWorldToClip();
		OutViewMatrices.TranslatedViewProjectionMatrix = InViewMatrices.GetTranslatedWorldToClip();
