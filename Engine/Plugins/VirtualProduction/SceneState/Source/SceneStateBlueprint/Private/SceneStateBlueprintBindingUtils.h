...
{
	/**
	 * Finds the state node with id that matches the given struct id.
	 * @param InBlueprint the blueprint to look into
	 * @param InStructId the struct id to look for
	 * @return the found state node matching the given struct id, or null if not found
	 */
	...
	/** Creates the Binding Struct Desc for the Parameters in the given State Node */
