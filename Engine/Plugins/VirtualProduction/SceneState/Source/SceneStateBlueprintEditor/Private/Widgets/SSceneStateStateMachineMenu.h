...
private:
	...
	bool ShouldProcessNode(TNotNull<const USceneStateMachineNode*> InGraphNode) const;
	void CollectNodeActionsRecursive(TNotNull<USceneStateMachineNode*> InNode, FText InCategory, FGraphActionListBuilderBase& OutActions);
