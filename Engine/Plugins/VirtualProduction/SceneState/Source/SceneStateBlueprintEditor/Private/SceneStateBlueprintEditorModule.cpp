...
#include "DetailsView/SceneStateMachineStateNodeCustomization.h"
...
void FBlueprintEditorModule::StartupModule()
{
	...
	PostEngineInitHandle = FCoreDelegates::GetOnPostEngineInit().AddStatic(&Private::RegisterGraphCustomization);
}
...
void FBlueprintEditorModule::RegisterDetailCustomizations()
{
	...
	PropertyEditorModule.RegisterCustomClassLayout(CustomizedClasses.Add_GetRef(USceneStateMachineStateNode::StaticClass()->GetFName())
		, FOnGetDetailCustomizationInstance::CreateStatic(&FStateMachineStateNodeCustomization::MakeInstance));
