...
private:
	...
	/** Creates a new details view for debugged object */
	TSharedRef<IDetailsView> CreateDebuggedObjectDetailsView(const TSharedRef<FSceneStateBlueprintEditor>& InBlueprintEditor) const;
	...
	/** Details view of the debugged object */
	TSharedPtr<IDetailsView> DebuggedObjectDetailsView;
