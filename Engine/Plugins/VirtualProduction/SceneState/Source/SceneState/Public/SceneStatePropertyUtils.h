...
namespace UE::SceneState
{
	 ...
	 */
	UE_API bool ResolveProperty(const FSceneStateExecutionContext& InContext, const FSceneStatePropertyReference& InPropertyReference, FResolvePropertyResult& OutResult);
