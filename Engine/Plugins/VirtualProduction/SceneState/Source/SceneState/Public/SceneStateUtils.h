...
namespace UE::SceneState
{
	...
	UE_DEPRECATED(5.8, "Use PropertyVisitorHelpers::ResolveVisitedPath instead")
...
namespace Editor
{
	/** Returns true if the struct or its super structs contains the given metadata. */
	UE_API bool StructHasMetaData(const UStruct* InStruct, FName InMetaData, bool bInIncludeSuperStructs);

	/** Returns true if the struct or its super structs contains any of the given metadata. */
	UE_API bool StructHasAnyMetaData(const UStruct* InStruct, TConstArrayView<FName> InMetaData, bool bInIncludeSuperStructs);
