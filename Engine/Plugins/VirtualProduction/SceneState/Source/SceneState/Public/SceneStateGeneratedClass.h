...
private:
	/** Called to link the template data */
	void LinkData();

	/** Called to resolve the template data bindings */
	UE_INTERNAL UE_API void ResolveBindings();

	/** Returns true if this class is a 'full' class (i.e. not a SKEL_ or REINST_ class) */
	UE_INTERNAL UE_API bool IsFullClass() const;
