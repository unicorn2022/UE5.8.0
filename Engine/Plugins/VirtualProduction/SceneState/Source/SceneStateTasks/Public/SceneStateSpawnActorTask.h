...
USTRUCT(DisplayName="Spawn Actor", Category="Utility", meta=(UtilityTask, RequiresContextWorld))
...
protected:
	...
	UE_API virtual void OnPostTaskEditChange(UE::SceneState::FTaskEditChange& InEditChange, FStructView InTaskInstance) override;
#endif
