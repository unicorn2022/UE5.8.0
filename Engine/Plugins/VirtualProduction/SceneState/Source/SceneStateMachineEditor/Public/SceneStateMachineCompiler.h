...
#define UE_API SCENESTATEMACHINEEDITOR_API
...
{
public:
	UE_API explicit FStateMachineCompiler(USceneStateMachineGraph* InGraph, IStateMachineCompilerContext& InCompilerContext);

	UE_API FSceneStateMachine Compile();
...
private:
	...
	/** Map of a State's parameter id to the index of the states array below */
	TMap<FGuid, uint16> StateParameterIdIndexMap;
