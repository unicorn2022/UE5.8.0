...
namespace UE::SceneState
{
	 ...
	 */
	UE_API void HandleStructIdChanged(UObject& InObject, const FGuid& InOldStructId, const FGuid& InNewStructId);
#endif
	...
	UE_API void PatchBindingCollection(const FPatchBindingParams& InParams);
