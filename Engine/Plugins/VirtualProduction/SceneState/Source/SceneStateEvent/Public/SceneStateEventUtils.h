...
namespace UE::SceneState
{
	 ...
	 */
	UE_API bool PushEvent(USceneStateEventStream* InEventStream, const FSceneStateEventSchemaHandle& InEventSchemaHandle, FInstancedStruct&& InEventData);
	 ...
	 * @return true if the event was pushed successfully, false otherwise
	 */
	UE_API bool PushEvent(USceneStateEventStream* InEventStream, const FSceneStateEventTemplate& InEventTemplate);
	 ...
	 */
	UE_API const UWorld* GetContextWorld(const UObject* InObject);
	 ...
	 */
	UE_API bool BroadcastEvent(const UObject* InEventContext, const FSceneStateEventSchemaHandle& InEventSchemaHandle, FInstancedStruct&& InEventData);
	 ...
	 * @return true if the event was broadcasted successfully, false otherwise
	 */
	UE_API bool BroadcastEvent(const UObject* InEventContext, const FSceneStateEventTemplate& InEventTemplate);
