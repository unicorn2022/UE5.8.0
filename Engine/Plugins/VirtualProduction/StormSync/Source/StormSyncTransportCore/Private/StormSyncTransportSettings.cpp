...
FString UStormSyncTransportSettings::GetServerEndpoint() const
{
	...
	{
		UE_LOGF(LogStormSyncTransportCore, Display,
			"UStormSyncTransportSettings::GetServerEndpoint - Was unable to get UnicastEndpoint from UDPMessagingSettings, using \"%ls\" instead."
			, *ServerAddress);
	}
