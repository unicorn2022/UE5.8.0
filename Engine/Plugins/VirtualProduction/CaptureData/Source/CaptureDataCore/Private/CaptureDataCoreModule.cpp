...
void FCaptureDataCoreModule::CheckAssetMigration()
{
	...
	if (!Assets.IsEmpty())
	{
		UE_LOGF(LogCaptureDataCore, Display, "Found %d Capture Data assets which need to be updated. Starting update ...", Assets.Num());
		...
		UE_LOGF(LogCaptureDataCore, Display, "Finished updating Capture Data assets");
	}	
}
