...
public:
	...
	static UE_API bool GetImageSequenceFilesFromPath(const FString& InFullSequencePath, TArray<FString>& OutImageFiles, bool bInSort = true);
	...
	/** Returns if the image sequence is valid */
	static UE_API bool IsImageSequenceValid(const class UImgMediaSource* InImgSequence);
};
