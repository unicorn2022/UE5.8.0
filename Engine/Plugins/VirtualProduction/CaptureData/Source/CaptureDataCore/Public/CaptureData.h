...
enum class ECaptureDataInitializedCheck : uint8
{
	...
	Full = ImageSequences | DepthSequences | Calibrations | Metadata,
	ImageSequencesOnly = ImageSequences
};

ENUM_CLASS_FLAGS(ECaptureDataInitializedCheck);
...
public:
	...
	enum UE_DEPRECATED(5.8, "EInitializedCheck has been moved to global scope. Please use the ECaptureDataInitializedCheck::.") EInitializedCheck
	{
		Full = 0,
		ImageSequencesOnly,
	};
	...
	virtual bool IsInitialized(ECaptureDataInitializedCheck InInitializedCheck) const PURE_VIRTUAL(UCaptureData::IsInitialized, return false;);
...
public:
	...
	UE_API virtual bool IsInitialized(ECaptureDataInitializedCheck InInitializedCheck) const override;
...
public:
	...
	*/
	...
	UE_API FVerifyResult VerifyData(ECaptureDataInitializedCheck InInitializedCheck) const;
...
private:
	...
	UE_API FVerifyResult ViewsContainsValidData(ECaptureDataInitializedCheck InInitializedCheck) const;
