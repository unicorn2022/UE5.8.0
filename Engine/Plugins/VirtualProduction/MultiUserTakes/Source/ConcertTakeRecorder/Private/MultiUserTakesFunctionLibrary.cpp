...
bool UMultiUserTakesFunctionLibrary::GetRecordOnClientLocal()
{
	...
	UE_CLOGF(!Session, LogConcert, Warning, "MultiUserTakes: Cannot change local RecordOnClient state because this editor is nott in any session!");
...
void UMultiUserTakesFunctionLibrary::SetRecordOnClientLocal(bool bNewValue)
{
	...
	{
		UE_LOGF(LogConcert, Warning, "MultiUserTakes: Cannot change local RecordOnClient state because this editor is nott in any session!");
	}
}
