...
private:
	...
	/** Calculate the crop region for center-fit sampling of camera feed from media texture */
	bool CalculateCameraFeedCropRegion(FIntRect& OutCropRegion, FIntPoint& OutCropSize) const;
