...
void FLiveLinkXROpenXRExtension::PostCreateInstance(XrInstance InInstance)
{
	...
	{
		UE_LOGF(LogLiveLinkXROpenXRExt, Error, "IOpenXRHMDModule not available");
		return;
	}
	...
	{
		UE_LOGF(LogLiveLinkXROpenXRExt, Error, "XR_KHR_win32_convert_performance_counter_time extension not available");
		return;
	}
	...
	bIsSupported = true;
#else
	UE_LOGF(LogLiveLinkXROpenXRExt, Error, "Support not implemented for this platform");
	return;
#endif
}
