...
void UDMXProtocolSettings::PostInitProperties()
{
	...
	{
		UE_LOGF(LogDMXProtocol, Log, "Overridden Default Send DMX Enabled from command line, set to %ls.", bDefaultSendDMXEnabled ? TEXT("True") : TEXT("False"));
	}
	...
	{
		UE_LOGF(LogDMXProtocol, Log, "Overridden Default Receive DMX Enabled from command line, set to %ls.", bDefaultReceiveDMXEnabled ? TEXT("True") : TEXT("False"));
	}
