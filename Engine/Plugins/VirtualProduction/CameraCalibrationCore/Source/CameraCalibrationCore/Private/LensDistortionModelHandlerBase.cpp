...
{
	// By default, reverse distorting models prefer the plugin pass for accuracy, forward distorting models prefer TSR
	return IsForwardDistorting() ? EDistortionRenderingMode::TemporalSuperResolution : EDistortionRenderingMode::PassAfterTonemap;
}
