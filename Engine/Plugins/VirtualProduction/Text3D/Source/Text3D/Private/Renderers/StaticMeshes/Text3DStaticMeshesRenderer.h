...
protected:
	...
	void AllocateComponents(int32 InNewCharacterCount);

	/** 
	 * If UText3DProjectSettings::UseExistingCharactersAsTemplates is enabled, finds the first valid existing mesh component to use as template
	 * Otherwise this returns null and new character meshes will be default allocated.
	 */
	UStaticMeshComponent* FindTemplate() const;
