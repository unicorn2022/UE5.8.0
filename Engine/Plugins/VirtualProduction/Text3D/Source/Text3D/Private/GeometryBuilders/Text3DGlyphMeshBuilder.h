...
#include "Text3DGlyphContourList.h"
#include "Text3DGlyphData.h"
...
public:
	 ...
	 */
	void CreateMeshes(const FText3DGlyphContourNode& InRoot, const float InExtrude, const float InBevel, const EText3DBevelType InBevelType, const int32 InBevelSegments, const bool bInOutline, const float InOutlineExpand, const EText3DOutlineType InOutlineType);
	...
	void BuildMesh(FText3DCachedMesh& InMesh, EText3DMeshType InMeshType, UMaterialInterface* InDefaultMaterial);
...
private:
	...
	FText3DGlyphData Data;
	FText3DGlyphContourList Contours;
	 ...
	 * @param InOutlineType - Defines the outline behavior.
	 */
	void CreateFrontMesh(const FText3DGlyphContourNode& Root, const bool bOutline, const float OutlineExpand, const EText3DOutlineType InOutlineType);
	 ...
	 */
	void AddToVertexCount(const FText3DGlyphContourNode& Node, int32& OutVertexCount);
	 ...
	 * @param bOutline - Front face has outline and is not filled.
	 */
	void TriangulateAndConvert(const FText3DGlyphContourNode& Node, int32& OutVertexIndex, const bool bOutline, const EText3DOutlineType InOutlineType);
	 ...
	 */
	void ExpandPointWithoutAddingVertices(const FText3DGlyphPartPtr& Point);
