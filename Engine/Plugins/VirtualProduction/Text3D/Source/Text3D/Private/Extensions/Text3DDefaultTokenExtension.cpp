...
void UText3DDefaultTokenExtension::PrepareBuild(EText3DRendererFlags InUpdateFlags)
{
	TRACE_CPUPROFILER_EVENT_SCOPE(UText3DDefaultTokenExtension::PrepareRebuild);
