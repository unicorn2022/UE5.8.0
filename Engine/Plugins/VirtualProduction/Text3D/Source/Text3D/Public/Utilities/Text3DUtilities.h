...
{
	/** Finds the text build system for the given world context object */
	TEXT3D_API IText3DBuildSystemInterface* FindBuildSystem(const UObject* InWorldContextObject);
