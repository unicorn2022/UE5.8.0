...
public:
	...
	TEXT3D_API virtual void PostInitProperties() override;
	TEXT3D_API virtual void PostDuplicate(bool bInDuplicateForPIE) override;
#if WITH_EDITOR
	TEXT3D_API virtual void PostEditChangeProperty(FPropertyChangedEvent& InEvent) override;
	TEXT3D_API virtual void PostEditUndo() override;
#endif
	//~ End UObject

	//~ Begin UText3DExtensionBase
	TEXT3D_API virtual EText3DExtensionResult PreRendererUpdate(const UE::Text3D::Renderer::FUpdateParameters& InParameters) override;
	TEXT3D_API virtual EText3DExtensionResult PostRendererUpdate(const UE::Text3D::Renderer::FUpdateParameters& InParameters) override;
	//~ End UText3DExtensionBase

	//~ Begin UText3DMaterialExtensionBase
	TEXT3D_API virtual void SetMaterial(const UE::Text3D::Material::FMaterialParameters& InParameters, UMaterialInterface* InMaterial) override;
	TEXT3D_API virtual UMaterialInterface* GetMaterial(const UE::Text3D::Material::FMaterialParameters& InParameters) const override;
	TEXT3D_API virtual void RegisterMaterialOverride(FName InTag) override;
	TEXT3D_API virtual void UnregisterMaterialOverride(FName InTag) override;
	TEXT3D_API virtual void ForEachMaterial(TFunctionRef<bool(const UE::Text3D::Material::FMaterialParameters&, UMaterialInterface*)> InFunctor) const override;
	TEXT3D_API virtual int32 GetMaterialCount() const override;
	TEXT3D_API virtual void GetMaterialNames(TArray<FName>& OutNames) const override;
...
protected:
	...
	/** Clears the parameter values of all materials that are MIDs in this extension */
