...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Text3D|Geometry")
	TEXT3D_API void SetCollisionEnabled(ECollisionEnabled::Type InCollisionEnabled);
...
protected:
	...
	virtual ECollisionEnabled::Type GetGlyphCollisionEnabled() const override;
	...
	void OnCollisionEnabledChanged();
	...
	UPROPERTY(EditAnywhere, Setter, Getter, Category="Geometry", meta=(AllowPrivateAccess = "true"))
