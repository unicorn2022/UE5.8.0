...
UENUM()
enum class EText3DMeshType : uint8
{
	Unknown,
	Static,
	Dynamic,
...
struct FGlyphMeshParameters
{
	...
	UPROPERTY()
	EText3DMeshType MeshType = EText3DMeshType::Unknown;
	...
	friend uint32 GetTypeHash(const FGlyphMeshParameters& InElement)
	{
		...
		HashParameters = HashCombine(HashParameters, GetTypeHash(InElement.MeshType));
...
namespace UE::Text3D
{
	...
	namespace Geometry
	{
		...
		struct FCachedFontFaceGlyphHandle
		{
			...
			FCachedFontFaceGlyphHandle(const FText3DFontFaceCache& InFontFaceCache, uint32 InGlyphIndex, const FGlyphMeshParameters& InGlyphMeshParameters);
			FCachedFontFaceGlyphHandle(const FCachedFontFaceGlyphHandle& InOther);
			FCachedFontFaceGlyphHandle(FCachedFontFaceGlyphHandle&& InOther);
			~FCachedFontFaceGlyphHandle();

			FCachedFontFaceGlyphHandle& operator=(const FCachedFontFaceGlyphHandle& InOther);
			FCachedFontFaceGlyphHandle& operator=(FCachedFontFaceGlyphHandle&& InOther);
