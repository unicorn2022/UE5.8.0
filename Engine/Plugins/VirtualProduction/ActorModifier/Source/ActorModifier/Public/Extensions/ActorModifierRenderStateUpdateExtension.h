...
public:
	/** 
	 * Returns the relevant render state dirty event types relevant to this handler 
	 * Defaults to all for legacy
	 */
	virtual UE::ActorModifierCore::ERenderStateDirtyReason GetRenderStateDirtyEventTypes() const
	{
		return UE::ActorModifierCore::ERenderStateDirtyReason::All;
	}
...
public:
	ACTORMODIFIER_API explicit FActorModifierRenderStateUpdateExtension(TNotNull<IActorModifierRenderStateUpdateHandler*> InExtensionHandler);
...
private:
	...
	/** The render state dirty reasons that are relevant to this extension */
	UE::ActorModifierCore::ERenderStateDirtyReason RelevantReasons;
};
