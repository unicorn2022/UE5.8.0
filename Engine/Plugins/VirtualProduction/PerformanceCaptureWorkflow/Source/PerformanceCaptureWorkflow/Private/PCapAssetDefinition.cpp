...
/*------------------------------------------------------------------------------
	UPCapData Workflow Customization implementation.
------------------------------------------------------------------------------*/
const FSlateBrush* UAssetDefinition_PCapDataWorkflowCustomization::GetIconBrush(const FAssetData& InAssetData, const FName InClassName) const
{
	return FPerformanceCaptureStyle::Get().GetBrush("ClassIcon.PCapWorkflowCustomization");
}

const FSlateBrush* UAssetDefinition_PCapDataWorkflowCustomization::GetThumbnailBrush(const FAssetData& InAssetData, const FName InClassName) const
{
	return FPerformanceCaptureStyle::Get().GetBrush("ClassThumbnail.PCapWorkflowCustomization");
}
