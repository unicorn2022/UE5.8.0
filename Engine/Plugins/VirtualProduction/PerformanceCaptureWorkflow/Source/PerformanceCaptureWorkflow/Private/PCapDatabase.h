...
public:
	...
	/** The date and time the sequence was recorded. This is the local machine
	 * UTC at the moment recording is finalised
	 */
...
public:
	...
	/** The content browser path to this session record's ingest data. */
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category="Performance Capture Session", meta = (DisplayName = "Ingest Folder", ContentDir))
	FString IngestPath;
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category="Performance Capture Session")
	TSoftObjectPtr<UPCapDataTable> TakesDataTable;
