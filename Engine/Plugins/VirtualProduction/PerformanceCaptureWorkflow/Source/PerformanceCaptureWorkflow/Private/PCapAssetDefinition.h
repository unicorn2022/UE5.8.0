...
class PERFORMANCECAPTUREWORKFLOW_API UAssetDefinition_PCapDataTable : public UAssetDefinition_DataTable
{
	...
	virtual TConstArrayView<FAssetCategoryPath> GetAssetCategories() const override
	{
		...
		{
			FAssetCategoryPath(
				FAssetCategoryPath(NSLOCTEXT("AssetDefinition", "PCapDataTable_AssetCategory", "Virtual Production")),
				NSLOCTEXT("AssetDefinition", "PCapDataTable_CategorySection", "Performance Capture"), ECategoryMenuType::Section)
		};
...
public:
	...
	virtual TConstArrayView<FAssetCategoryPath> GetAssetCategories() const override
	{
		...
		{
			FAssetCategoryPath(
				FAssetCategoryPath(NSLOCTEXT("AssetDefinition", "PCapDataAsset_AssetCategory", "Virtual Production")),
				NSLOCTEXT("AssetDefinition", "PCapDataAsset_CategorySection", "Performance Capture"), ECategoryMenuType::Section)
		};
...
UCLASS()
class UAssetDefinition_PCapDataWorkflowCustomization : public UAssetDefinition_DataAsset
{
	GENERATED_BODY()
public:
	...
	virtual const FSlateBrush* GetIconBrush(const FAssetData& InAssetData, const FName InClassName) const override;
	virtual const FSlateBrush* GetThumbnailBrush(const FAssetData& InAssetData, const FName InClassName) const override;
	virtual TSoftClassPtr<UObject> GetAssetClass() const override { return UPCapWorkflowCustomization::StaticClass(); }
	// UAssetDefinition End
};