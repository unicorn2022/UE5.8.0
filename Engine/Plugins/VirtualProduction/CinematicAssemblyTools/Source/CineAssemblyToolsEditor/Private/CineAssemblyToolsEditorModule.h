...
{
	extern FAssetCategoryPath CineAssemblyAssetCategory;
}
...
private:
	...
	/** Subscribe to CineAssemblySchema property changes in order to refresh Style brushes for Schema thumbnails */
	void OnSchemaPropertyChanged(UObject* Object, FPropertyChangedEvent& PropertyChangedEvent);
...
private:
	...
	FDelegateHandle RegisterSubTrackEditorHandle;
	FDelegateHandle SchemaPropertyChangedHandle;
};
