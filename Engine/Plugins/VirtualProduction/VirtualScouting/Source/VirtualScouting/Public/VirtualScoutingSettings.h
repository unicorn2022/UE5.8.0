...
public:
	...
	TArray<float> ViewfinderApertureArray = {1.2f, 2.0f, 2.8f, 4.0f, 5.6f, 8.0f, 11.0f, 16.0f, 22.0f};

	UPROPERTY(Config, EditAnywhere, BlueprintReadWrite, Category="Virtual Scouting", meta=(DisplayName="Viewfinder Monitor Masks"))
	TArray<float> ViewfinderMaskArray = {1.33f, 1.66f, 1.78f, 2.0f, 2.35f, 2.39f };
