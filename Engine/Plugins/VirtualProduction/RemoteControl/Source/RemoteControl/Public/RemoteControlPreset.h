...
private:
	...
	/** Whether OnPostInitPropertiesRemoteControlProperties delegate is pending broadcast because it wasn't broadcast in URemoteControlPreset::PostInitProperties() */
	bool bPendingPostInitNotify = false;
