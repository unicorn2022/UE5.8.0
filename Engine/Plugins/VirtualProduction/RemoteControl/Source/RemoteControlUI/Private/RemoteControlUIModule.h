...
private:
	...
	/** Retrieves the saved details view. If invalid, optionally resolve by finding a new details panel to store in DetailsPanelWeak and return that */
	TSharedPtr<IDetailsView> GetDetailsView(bool bInResolveIfInvalid=true, TConstArrayView<FName> InDetailsTabIdentifierOverrides = {}) const;
...
private:
	...
	/** Holds a weak ptr to the global details panel. */
	mutable TWeakPtr<IDetailsView> DetailsPanelWeak;
