...
namespace UE::ViewportWidgetOverlay::Private
{
...
IMPLEMENT_GLOBAL_SHADER(FDrawTextureInShaderPS, "/Plugin/ViewportWidgetOverlay/Private/ViewportWidgetOverlay.usf", "OverlayWidgetPS", SF_Pixel);
