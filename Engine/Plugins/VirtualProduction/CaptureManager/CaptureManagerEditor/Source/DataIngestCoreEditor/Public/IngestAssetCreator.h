...
private:
	...
	/** Deletes all assets at the specified package path.
	 *  Returns true if all assets were deleted (or none existed), false if any deletion failed. */
	static UE_API bool RemoveAssetsByPath(const FString& InPackagePath);
