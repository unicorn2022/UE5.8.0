...
// Encoder token classes live in CaptureDataConverter (Core) so they are auto-discovered
// by UNamingTokensEngineSubsystem in both LiveLinkHub and UE Editor contexts.
...
public:
	...
	/** Path to the third party encoder executable. */
	UPROPERTY(config, EditAnywhere, Category = "Conversion",
