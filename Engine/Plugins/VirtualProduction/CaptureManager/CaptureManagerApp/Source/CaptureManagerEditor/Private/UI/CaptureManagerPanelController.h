...
public:
	...
	TSharedRef<FUpdateTakeListManager> GetUpdateTakeListManager() const;

private:

	void OnDeviceSelectionChanged(ULiveLinkDevice* InDevice);
	...
	FDelegateHandle DeviceSelectionChangedHandle;

	TSharedPtr<FUpdateTakeListManager> UpdateTakeListManager;
};