...
void ILiveLinkDeviceCapability_Ingest::UpdateTakeList_Implementation(UIngestCapability_UpdateTakeListCallback* InCallback)
{
	StopToken = StopRequester.CreateToken();

	RunUpdateTakeList(InCallback);
}

void ILiveLinkDeviceCapability_Ingest::RequestAbortUpdateTakeList_Implementation()
{
...
bool ILiveLinkDeviceCapability_Ingest::IsUpdateTakeListAbortRequested() const
{
