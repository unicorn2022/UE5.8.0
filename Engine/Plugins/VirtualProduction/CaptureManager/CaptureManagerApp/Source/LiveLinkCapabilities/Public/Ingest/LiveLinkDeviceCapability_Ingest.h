...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Live Link Device|Ingest")
	void RequestAbortUpdateTakeList();
	...
	void UpdateTakeList_Implementation(UIngestCapability_UpdateTakeListCallback* InCallback);
	void RequestAbortUpdateTakeList_Implementation();
...
protected:
	...
	bool IsUpdateTakeListAbortRequested() const;
...
private:
	...
	virtual void RunUpdateTakeList(UIngestCapability_UpdateTakeListCallback* InCallback) = 0;
