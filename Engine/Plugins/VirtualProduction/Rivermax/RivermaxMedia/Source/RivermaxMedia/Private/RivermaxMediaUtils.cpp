...
namespace UE::RivermaxMediaUtils::Private
{
	UE::RivermaxCore::ESamplingType PixelFormatToRivermaxSamplingType(ERivermaxPixelFormat InPixelFormat)
	{
		...
		{
		case ERivermaxPixelFormat::YUV422_8bit:    return ESamplingType::YUV422_8bit;
		case ERivermaxPixelFormat::YUV422_10bit:   return ESamplingType::YUV422_10bit;
		case ERivermaxPixelFormat::RGB_8bit:       return ESamplingType::RGB_8bit;
		case ERivermaxPixelFormat::RGB_10bit:      return ESamplingType::RGB_10bit;
		case ERivermaxPixelFormat::RGB_12bit:      return ESamplingType::RGB_12bit;
		case ERivermaxPixelFormat::RGB_16bit_Float: return ESamplingType::RGB_16bitFloat;
		default:
			checkNoEntry();
	...
	FSourceBufferDesc GetBufferDescription(const FIntPoint& InResolution, ERivermaxPixelFormat InPixelFormat)
	{
		using namespace UE::RivermaxCore;
		...
		const ESamplingType SamplingType = PixelFormatToRivermaxSamplingType(InPixelFormat);
	...
	ERivermaxPixelFormat RivermaxSamplingTypeToPixelFormat(UE::RivermaxCore::ESamplingType InSamplingType)
	{
		...
		{
		case ESamplingType::YUV422_8bit:   return ERivermaxPixelFormat::YUV422_8bit;
		case ESamplingType::YUV422_10bit:  return ERivermaxPixelFormat::YUV422_10bit;
		case ESamplingType::RGB_8bit:      return ERivermaxPixelFormat::RGB_8bit;
		case ESamplingType::RGB_10bit:     return ERivermaxPixelFormat::RGB_10bit;
		case ESamplingType::RGB_12bit:     return ERivermaxPixelFormat::RGB_12bit;
		case ESamplingType::RGB_16bitFloat: return ERivermaxPixelFormat::RGB_16bit_Float;
		default:
			checkNoEntry();
			return ERivermaxPixelFormat::RGB_10bit;
		}
	}
	...
	bool StreamOptionsToSDPDescription(const UE::RivermaxCore::FRivermaxOutputOptions& Options, TArray<char>& OutSDPDescription)
	{
		...
		if (VideoOptions.IsValid())
		{
			...
			{
				UE_LOGF(LogRivermaxMedia, Warning, "Fractional frame rates must be described using a denominator of 1001. Converting it for stream creation.");
			}
