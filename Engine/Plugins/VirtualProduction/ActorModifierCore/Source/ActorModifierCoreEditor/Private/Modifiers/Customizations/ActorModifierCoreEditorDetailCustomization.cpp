...
void FActorModifierCoreEditorDetailCustomization::CustomizeDetails(IDetailLayoutBuilder& InDetailBuilder)
{
	...
	const TSharedPtr<IPropertyHandle> FreezePropertyHandle = InDetailBuilder.GetProperty(
		GET_MEMBER_NAME_CHECKED(UActorModifierCoreStack, bModifierStackFrozen),
		UActorModifierCoreStack::StaticClass()
	);
	...
	InDetailBuilder.HideProperty(FreezePropertyHandle);
