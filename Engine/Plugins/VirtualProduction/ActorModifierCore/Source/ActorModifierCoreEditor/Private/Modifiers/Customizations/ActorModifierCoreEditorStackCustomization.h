...
protected:
	...
	/** Toggle the frozen state for a whole stack */
	bool IsModifierStackFrozen(FOperatorStackEditorItemPtr InItem) const;
	void ToggleModifierStackFrozenAction(FOperatorStackEditorItemPtr InItem) const;
