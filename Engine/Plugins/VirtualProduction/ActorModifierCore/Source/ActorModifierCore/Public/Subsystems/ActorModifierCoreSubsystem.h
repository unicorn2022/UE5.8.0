...
UCLASS()
class UActorModifierCoreSubsystem : public UEngineSubsystem, public FTickableGameObject
{
	GENERATED_BODY()
...
public:
	...
	/** Gets the ticker for modifiers to use instead of CoreTicker */
	ACTORMODIFIERCORE_API static FTSTicker& GetModifierTicker();
...
protected:
	...
	/** Ticker for modifiers to use instead of CoreTicker */
	static FTSTicker ModifierTicker;
