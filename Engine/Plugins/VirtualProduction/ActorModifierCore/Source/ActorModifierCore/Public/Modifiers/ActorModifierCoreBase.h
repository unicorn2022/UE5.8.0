...
public:
	...
	/** Returns whether a modifier can be marked dirty */
	ACTORMODIFIERCORE_API bool CanMarkModifierDirty() const;

	/** 
	 * Set this modifier as dirty to be able to execute only dirty modifiers 
	 * returns true if the modifier could be marked dirty
	 */
	ACTORMODIFIERCORE_API bool MarkModifierDirty(bool bExecute = true);
...
protected:
	...
	UE_DEPRECATED(5.8, "LogModifier deprecated. Prefer using UE_LOG instead.")
