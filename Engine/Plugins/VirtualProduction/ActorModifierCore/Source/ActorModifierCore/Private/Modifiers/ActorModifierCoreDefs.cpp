...
void FActorModifierCoreExecutionTask::ExecuteCurrentModifier()
{
	...
	{
		const bool bModifierStackFrozen = ModifierStack && ModifierStack->IsModifierStackFrozen();
		if (!bModifierStackFrozen && (Modifier->bModifierEnabled || Modifier->IsModifierStack()))
		{
