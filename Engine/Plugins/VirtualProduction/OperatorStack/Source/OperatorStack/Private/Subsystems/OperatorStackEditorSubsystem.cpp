...
bool UOperatorStackEditorSubsystem::RegisterStackCustomization(const TSubclassOf<UOperatorStackEditorStackCustomization> InStackCustomizationClass)
{
	...
	UE_LOGF(LogOperatorStackEditorSubsystem, Display, "OperatorStack customization registered : Class %ls - Identifier %ls", *InStackCustomizationClass->GetName(), *StackIdentifier.ToString());
...
bool UOperatorStackEditorSubsystem::UnregisterStackCustomization(const TSubclassOf<UOperatorStackEditorStackCustomization> InStackCustomizationClass)
{
	...
	UE_LOGF(LogOperatorStackEditorSubsystem, Display, "OperatorStack customization unregistered : Class %ls - Identifier %ls", *InStackCustomizationClass->GetName(), *StackIdentifier.ToString());
