...
public:
	...
	UViewportWidgetOverlay* GetUMGWidget() { return UMGWidget; };
...
protected:
	...
	UPROPERTY(Transient)
	EViewportWidgetOverlay_DisplayType DisplayType = EViewportWidgetOverlay_DisplayType::Inactive;
	...
	UViewportWidgetOverlay* GetUMGWidget() const { return UMGWidget; }
...
private:
	...
	UPROPERTY(Transient, NonTransactional)
	TObjectPtr<UViewportWidgetOverlay> UMGWidget = nullptr;
