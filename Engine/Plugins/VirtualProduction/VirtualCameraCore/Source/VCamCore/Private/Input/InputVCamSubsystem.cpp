...
void UInputVCamSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	UE_LOGF(LogVCamCore, Log, "Initializing UInputVCamSubsystem...");
...
{
	Super::Deinitialize();
	UE_LOGF(LogVCamCore, Log, "De-initializing UInputVCamSubsystem...");
...
const FVCamInputDeviceConfig& UInputVCamSubsystem::GetInputSettings() const
{
	...
	UE_CLOGF(PlayerInput == nullptr, LogVCamCore, Fatal, "PlayerInput is designed to exist for the lifetime of UInputVCamSubsystem. Investigate!");
