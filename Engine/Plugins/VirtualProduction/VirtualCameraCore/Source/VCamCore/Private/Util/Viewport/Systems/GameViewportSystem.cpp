...
namespace UE::VCamCore
{
...
#else 
		UE_LOGF(LogVCamCore, Warning, "ApplyOverrideResolutionForViewport: Override resolution not implemented for games");
#endif
	}
...
#else
		UE_LOGF(LogVCamCore, Warning, "RestoreOverrideResolutionForViewport: Override resolution not implemented for games");
#endif
	}
	...
	TSharedPtr<FSceneViewport> FGameViewportSystem::GetSceneViewport(EVCamTargetViewportID ViewportID) const
	{
		...
		UE_LOGF(LogVCamCore, Warning, "GetSceneViewport: No viewport window found for gameplay logic");
		return nullptr;
	}
	...
	TWeakPtr<SWindow> FGameViewportSystem::GetInputWindow(EVCamTargetViewportID ViewportID) const
	{
		...
		UE_LOGF(LogVCamCore, Warning, "GetInputWindow: No viewport window found for gameplay logic");
		return nullptr;
	}
