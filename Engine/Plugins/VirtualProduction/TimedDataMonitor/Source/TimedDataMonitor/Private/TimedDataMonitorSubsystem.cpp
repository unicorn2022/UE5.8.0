...
void UTimedDataMonitorSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	const bool bInitializeTimedDataMonitor = GConfig->GetBoolOrDefault(TEXT("TimedDataMonitor"), TEXT("bEnableTimedDataMonitor"), true, GEngineIni);
	if (bInitializeTimedDataMonitor)
	{
