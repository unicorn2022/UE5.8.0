...
void FFrameHitchDecorationRecorder::OnTickRecording(UTakeRecorder* InTakeRecorder, const FQualifiedFrameTime& InCurrentFrameTime)
{
	...
	UE_CLOGF(!LastSampled, LogTakesCore, Warning,
		"No timecode was sampled by the linear regression. Hitch analysis data for frame %ls will use actual frame time instead of underlying target frame time. Hitch visualization will be inaccurate for this frame.",
