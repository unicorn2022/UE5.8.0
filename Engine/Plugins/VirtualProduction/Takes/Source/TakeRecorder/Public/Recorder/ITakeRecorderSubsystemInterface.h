...
public:
	...
	virtual bool IsRecordingUsingExistingSequence() const = 0;
	...
	virtual void IncrementTakeNumber() = 0;
	...
	virtual UClass* GetPresetTargetRecordClass() const = 0;
	virtual void SetPresetTargetRecordClass(const TSubclassOf<ULevelSequence> InClass) = 0;
};
