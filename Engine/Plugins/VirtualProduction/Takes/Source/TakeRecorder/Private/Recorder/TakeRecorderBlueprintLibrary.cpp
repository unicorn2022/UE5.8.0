...
FTakeRecorderParameters UTakeRecorderBlueprintLibrary::GetDefaultParameters()
{
	...
	DefaultParams.HitchProtection = GetDefault<UTakeRecorderProjectSettings>()->HitchProtectionSettings;
...
void UTakeRecorderBlueprintLibrary::SetDefaultParameters(const FTakeRecorderParameters& InDefaultParameters)
{
	...
	GetMutableDefault<UTakeRecorderProjectSettings>()->HitchProtectionSettings = InDefaultParameters.HitchProtection;
}
