...
FTakeRecorderProjectParameters::FTakeRecorderProjectParameters()
	...
	, SpawnableOverwriteBehavior(ETakeRecorderSpawnableOverwriteBehavior::CreateNew)
	, AttachRecordBehaviour(ETakeRecorderAttachRecordBehaviour::Hierarchy)
	, bShowNotifications(true)
{
}

FString FTakeRecorderProjectParameters::GetResolvedRootTakeSaveDir() const
{
	return UE::TakeRecorder::Private::ResolvePathToProject(RootTakeSaveDir.Path);  
}
