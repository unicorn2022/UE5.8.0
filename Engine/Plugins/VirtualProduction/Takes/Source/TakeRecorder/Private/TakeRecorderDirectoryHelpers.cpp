...
FString GetDefaultProjectPath()
{
	...
	return AssetPath;
#else // WITH_EDITOR
	// When the editor is not present, return the Project Content Directory. This is the behaviour of default path of
	// FEditorDirectories if there is no last directory, and so will mimick its behaviour.
