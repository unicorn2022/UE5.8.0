...
AActor* FSerializedRecorder::SetActorPossesableOrSpawnable(UMovieSceneSequence* InMovieSceneSequence, UWorld *PlaybackContext, const FActorFileHeader& ActorHeader)
{
	...
	#else // WITH_EDITOR
		// Review the Guid here and how the binding is created at runtime.
		PossessableGuid = MovieSceneHelpers::TryCreateCustomSpawnableBinding(InMovieSceneSequence, Actor);
	#endif // WITH_EDITOR
