...
// This whole file is only active in an editor context, and inherits from an editor type.
// It is currently not needed at runtime, but if it is, then this will need revisiting to
// add that same functionality.
#if WITH_EDITOR
...
{
public:
	virtual ~FTakesCoreTakeData() = default;
