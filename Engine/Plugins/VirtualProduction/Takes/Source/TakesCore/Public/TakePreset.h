...
public:
	...
	/**
	 * Static multicast delegate fired by AllocateTransientPreset when it creates a new transient pending take.
	 */
	static UE_API FSimpleMulticastDelegate& OnTakePresetAllocated();
...
private:
	...
	static FSimpleMulticastDelegate OnTakePresetAllocatedDelegate;
};
