...
bool FCEMeshBuilder::BuildDynamicMesh(UDynamicMesh* OutMesh, TArray<TWeakObjectPtr<UMaterialInterface>>& OutMaterials, const FCEMeshBuilderParams& InParams)
{
	...
	const bool bDeferMeshChangeEvents = !InParams.bNotifyMeshChangeEvents;
	...
	}, EDynamicMeshChangeType::GeneralEdit, EDynamicMeshAttributeChangeFlags::Unknown, bDeferMeshChangeEvents);
