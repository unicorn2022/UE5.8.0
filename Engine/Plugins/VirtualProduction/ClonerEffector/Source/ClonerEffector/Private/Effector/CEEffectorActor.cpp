...
ACEEffectorActor::ACEEffectorActor()
{
	...
	{
		UDynamicMeshComponent* InnerVisualizerComponent = CreateEditorOnlyDefaultSubobject<UDynamicMeshComponent>(TEXT("InnerVisualizerComponent"));
	...
	if (GIsEditor && !HasAnyFlags(RF_ClassDefaultObject))
	{
		UDynamicMeshComponent* OuterVisualizerComponent = CreateEditorOnlyDefaultSubobject<UDynamicMeshComponent>(TEXT("OuterVisualizerComponent"));
...
void ACEEffectorActor::MigrateDeprecatedProperties()
{
	...
	UE_LOGF(LogCEEffector, Warning, "%ls : Effector migrating from version %i to latest %i, please re-save this asset", *GetActorNameOrLabel(), MigrateToVersion, FCEEffectorActorVersion::LatestVersion);
