...
public:
	...
	CLONEREFFECTOR_API UCEClonerExtensionBase* GetExtension(TSubclassOf<UCEClonerExtensionBase> InExtensionClass) const;

	CLONEREFFECTOR_API UCEClonerExtensionBase* GetExtension(FName InExtensionName) const;
