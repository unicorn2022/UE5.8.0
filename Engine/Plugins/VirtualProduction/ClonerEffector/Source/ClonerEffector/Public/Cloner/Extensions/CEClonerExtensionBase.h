...
public:
	...
	/**
	 * Called when the meshes are being updated. With opportunity for extension to change the mesh data.
	 * @return true if the meshes were changed.
	 */
	virtual bool OnUpdateClonerMeshes(TArray<FNiagaraMeshRendererMeshPropertiesBase>& InOutMeshes)
	{
		return false;
	}
