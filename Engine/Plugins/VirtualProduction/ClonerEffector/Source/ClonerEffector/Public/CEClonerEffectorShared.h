...
{
	/** Name for the mesh array data interface to use */
	static const FLazyName MeshArrayName = TEXT("MeshArray"); 

	/** Finds the 'MeshArray' data interface in the given cloner */
	UNiagaraDataInterfaceArrayMesh* FindMeshArrayDataInterface(UCEClonerComponent* InClonerComponent);
