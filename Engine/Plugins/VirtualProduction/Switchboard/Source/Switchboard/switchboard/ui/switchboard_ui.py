...
#
# To regenerate:
#     > cd (...)\Engine\Plugins\VirtualProduction\Switchboard\Source\Switchboard\switchboard
#     > ..\..\..\..\..\..\Extras\ThirdPartyNotUE\SwitchboardThirdParty\Python\Scripts\pyside6-uic.exe ui\switchboard.ui -o ui\switchboard_ui.py
#
# Manual fix-ups:
#  * Add this comment block, including copyright, to the top of the file
#  * Fix generated `from switchboard` import paths
#  * Remove `import resources_rc`
#  * Change Ui_switchboard_window base class from `object` to `QMainWindow`
...
class Ui_switchboard_window(QMainWindow):
    def setupUi(self, switchboard_window):
        ...
        switchboard_window.resize(1280, 952)
        ...
        self.menu_save_config_as = QAction(switchboard_window)
        ...
        sizePolicy3.setHeightForWidth(self.record_button.sizePolicy().hasHeightForWidth())
        self.record_button.setSizePolicy(sizePolicy3)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/images/Settings_40x.png", QSize(), QIcon.Normal, QIcon.On)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/images/icon_refresh.png", QSize(), QIcon.Normal, QIcon.Off)
        icon3.addFile(u":/icons/images/icon_refresh_disabled.png", QSize(), QIcon.Disabled, QIcon.Off)
        icon3.addFile(u":/icons/images/icon_refresh_hover.png", QSize(), QIcon.Active, QIcon.Off)
        ...
        sizePolicy4.setHeightForWidth(self.project_cl_combo_box.sizePolicy().hasHeightForWidth())
        self.project_cl_combo_box.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.refresh_project_cl_button.sizePolicy().hasHeightForWidth())
        self.refresh_project_cl_button.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.sync_all_button.sizePolicy().hasHeightForWidth())
        self.sync_all_button.setSizePolicy(sizePolicy4)
        self.sync_all_button.setMinimumSize(QSize(25, 30))
        icon4 = QIcon()
        icon4.addFile(u":/icons/images/icon_sync.png", QSize(), QIcon.Normal, QIcon.On)
        icon4.addFile(u":/icons/images/icon_sync_disabled.png", QSize(), QIcon.Disabled, QIcon.On)
        icon4.addFile(u":/icons/images/icon_sync_hover.png", QSize(), QIcon.Active, QIcon.On)
        ...
        sizePolicy4.setHeightForWidth(self.build_all_button.sizePolicy().hasHeightForWidth())
        self.build_all_button.setSizePolicy(sizePolicy4)
        self.build_all_button.setMinimumSize(QSize(25, 30))
        icon5 = QIcon()
        icon5.addFile(u":/icons/images/icon_build.png", QSize(), QIcon.Normal, QIcon.On)
        icon5.addFile(u":/icons/images/icon_build_hover.png", QSize(), QIcon.Active, QIcon.On)
        ...
        sizePolicy4.setHeightForWidth(self.sync_and_build_all_button.sizePolicy().hasHeightForWidth())
        self.sync_and_build_all_button.setSizePolicy(sizePolicy4)
        self.sync_and_build_all_button.setMinimumSize(QSize(25, 30))
        icon6 = QIcon()
        icon6.addFile(u":/icons/images/icon_sync_and_build.png", QSize(), QIcon.Normal, QIcon.On)
        icon6.addFile(u":/icons/images/icon_sync_and_build_disabled.png", QSize(), QIcon.Disabled, QIcon.On)
        icon6.addFile(u":/icons/images/icon_sync_and_build_hover.png", QSize(), QIcon.Active, QIcon.On)
        ...
        sizePolicy4.setHeightForWidth(self.device_settings_button.sizePolicy().hasHeightForWidth())
        self.device_settings_button.setSizePolicy(sizePolicy4)
        self.device_settings_button.setMinimumSize(QSize(25, 30))
        icon7 = QIcon()
        icon7.addFile(u":/icons/images/icon_settings_disabled.png", QSize(), QIcon.Normal, QIcon.Off)
        icon7.addFile(u":/icons/images/icon_settings.png", QSize(), QIcon.Normal, QIcon.On)
        icon7.addFile(u":/icons/images/icon_settings_hover.png", QSize(), QIcon.Active, QIcon.On)
        ...
        self.device_settings_button.setProperty("frameless", True)
        ...
        sizePolicy4.setHeightForWidth(self.launch_all_button.sizePolicy().hasHeightForWidth())
        self.launch_all_button.setSizePolicy(sizePolicy4)
        self.launch_all_button.setMinimumSize(QSize(25, 30))
        icon8 = QIcon()
        icon8.addFile(u":/icons/images/icon_open.png", QSize(), QIcon.Normal, QIcon.Off)
        icon8.addFile(u":/icons/images/icon_close.png", QSize(), QIcon.Normal, QIcon.On)
        icon8.addFile(u":/icons/images/icon_open_disabled.png", QSize(), QIcon.Disabled, QIcon.Off)
        icon8.addFile(u":/icons/images/icon_open_hover.png", QSize(), QIcon.Active, QIcon.Off)
        icon8.addFile(u":/icons/images/icon_close_hover.png", QSize(), QIcon.Active, QIcon.On)
        ...
        sizePolicy4.setHeightForWidth(self.connect_all_button.sizePolicy().hasHeightForWidth())
        self.connect_all_button.setSizePolicy(sizePolicy4)
        self.connect_all_button.setMinimumSize(QSize(25, 30))
        icon9 = QIcon()
        icon9.addFile(u":/icons/images/icon_connect.png", QSize(), QIcon.Normal, QIcon.Off)
        icon9.addFile(u":/icons/images/icon_connected.png", QSize(), QIcon.Normal, QIcon.On)
        icon9.addFile(u":/icons/images/icon_connect_hover.png", QSize(), QIcon.Active, QIcon.Off)
        icon9.addFile(u":/icons/images/icon_connected_hover.png", QSize(), QIcon.Active, QIcon.On)
        ...
        self.muserver_start_stop_button.setProperty("frameless", True)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icons/images/icon_add_disabled.png", QSize(), QIcon.Normal, QIcon.Off)
        icon10.addFile(u":/icons/images/icon_add.png", QSize(), QIcon.Normal, QIcon.On)
        self.multiuser_session_inc_button.setIcon(icon10)
        self.multiuser_session_inc_button.setProperty("frameless", True)
        ...
        self.logger_options_spacer_0 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)
        ...
        self.logger_options_spacer_1 = QSpacerItem(20, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)
        ...
        self.logger_options_spacer_2 = QSpacerItem(20, 0, QSizePolicy.Expanding, QSizePolicy.Minimum)
        ...
        self.recording_status = QLabel(self.frame_logger)
        self.recording_status.setObjectName(u"recording_status")

        self.horizontalLayout_6.addWidget(self.recording_status)

        self.line_6 = QFrame(self.frame_logger)
        ...
        sizePolicy4.setHeightForWidth(self.current_address_value.sizePolicy().hasHeightForWidth())
        self.current_address_value.setSizePolicy(sizePolicy4)
...
#endif // QT_CONFIG(tooltip)
        self.recording_status.setText(QCoreApplication.translate("switchboard_window", u"Recording Status", None))
