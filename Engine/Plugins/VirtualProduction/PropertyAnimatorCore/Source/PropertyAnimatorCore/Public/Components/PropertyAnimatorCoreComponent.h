...
public:
	...
	PROPERTYANIMATORCORE_API static UPropertyAnimatorCoreComponent* FindOrAdd(AActor* InActor);
	...
	PROPERTYANIMATORCORE_API void SetAnimators(const TArray<TObjectPtr<UPropertyAnimatorCoreBase>>& InAnimators);
