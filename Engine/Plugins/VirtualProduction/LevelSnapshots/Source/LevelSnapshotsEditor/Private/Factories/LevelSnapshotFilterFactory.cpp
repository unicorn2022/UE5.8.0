...
TArray<FAssetCategoryPath> ULevelSnapshotBlueprintFilterFactory::GetAssetMenuPathsForCategory(FName InCategory) const
{
	if (SupportedClass == UBlueprint::StaticClass() && ParentClass)
	{
		return GetAssetMenuPaths(ParentClass, InCategory);
	}
