...
{
	/**
	 * Get the world to use for taking a level snapshot.
	 * @param bIgnorePIE  if true and we are in a PIE world, we ignore the PIE world and use the editor world context.
	 *
	 * @return The current UWorld.
	 */
