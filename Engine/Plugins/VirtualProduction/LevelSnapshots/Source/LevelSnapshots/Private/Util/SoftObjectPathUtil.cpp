...
namespace UE::LevelSnapshots::Private
{
	...
	TOptional<TNonNullPtr<FActorSnapshotData>> FindSavedActorDataUsingObjectPath(TMap<FSoftObjectPath, FActorSnapshotData>& ActorData, const FSoftObjectPath& OriginalObjectPath, bool& bIsPathToActorSubobject)
	{
		...
		UE_CLOGF(Result == nullptr, LogLevelSnapshots, Warning, "Path %ls looks like an actor path but no data was saved for it. Maybe it was a reference to an auto-generated actor, e.g. a brush or volume present in all worlds by default?", *OriginalObjectPath.ToString());
