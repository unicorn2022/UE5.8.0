...
public:
	...
	DYNAMICMATERIAL_API static TSharedPtr<FJsonValue> Serialize(const TMap<FJsonObject::FStringType, TSharedPtr<FJsonValue>>& InMap);
	...
	DYNAMICMATERIAL_API static bool Deserialize(const TSharedPtr<FJsonValue>& InJsonValue, TMap<FJsonObject::FStringType, TSharedPtr<FJsonValue>>& OutMap);
