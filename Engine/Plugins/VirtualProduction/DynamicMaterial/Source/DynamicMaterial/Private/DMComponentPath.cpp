...
FDMComponentPathSegment FDMComponentPath::GetFirstSegment()
{
	...
	{
		UE_LOGF(LogDynamicMaterial, Error, "Malformed component path: %ls", PathSegment.GetData());
		return Segment;
	}
	...
	{
		UE_LOGF(LogDynamicMaterial, Error, "Malformed component path token: %ls", PathSegment.GetData());
	}

	if (Segment.Parameter.IsEmpty())
	{
		UE_LOGF(LogDynamicMaterial, Error, "Malformed component path parameter: %ls", PathSegment.GetData());
	}
