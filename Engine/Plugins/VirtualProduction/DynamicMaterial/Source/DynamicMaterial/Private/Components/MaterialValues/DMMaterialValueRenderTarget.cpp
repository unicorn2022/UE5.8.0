...
TSharedPtr<FJsonValue> UDMMaterialValueRenderTarget::JsonSerialize() const
{
	return FDMJsonUtils::Serialize({
		{FJsonObject::FStringType(GET_MEMBER_NAME_STRING_CHECKED(ThisClass, TextureSize)), FDMJsonUtils::Serialize(TextureSize)},
		{FJsonObject::FStringType(GET_MEMBER_NAME_STRING_CHECKED(ThisClass, TextureFormat)), FDMJsonUtils::Serialize<ETextureRenderTargetFormat>(TextureFormat)},
		{FJsonObject::FStringType(GET_MEMBER_NAME_STRING_CHECKED(ThisClass, ClearColor)), FDMJsonUtils::Serialize(ClearColor)},
		{FJsonObject::FStringType(GET_MEMBER_NAME_STRING_CHECKED(ThisClass, Renderer)), FDMJsonUtils::Serialize(Renderer.Get())}
	});
}
...
bool UDMMaterialValueRenderTarget::JsonDeserialize(const TSharedPtr<FJsonValue>& InJsonValue)
{
	...
	if (const TSharedPtr<FJsonValue>* JsonValue = Data.Find(FJsonObject::FStringType(GET_MEMBER_NAME_STRING_CHECKED(ThisClass, TextureSize))))
	{
	...
	if (const TSharedPtr<FJsonValue>* JsonValue = Data.Find(FJsonObject::FStringType(GET_MEMBER_NAME_STRING_CHECKED(ThisClass, TextureFormat))))
	{
	...
	if (const TSharedPtr<FJsonValue>* JsonClearColor = Data.Find(FJsonObject::FStringType(GET_MEMBER_NAME_STRING_CHECKED(ThisClass, ClearColor))))
	{
	...
	if (const TSharedPtr<FJsonValue>* JsonRenderer = Data.Find(FJsonObject::FStringType(GET_MEMBER_NAME_STRING_CHECKED(ThisClass, Renderer))))
	{
