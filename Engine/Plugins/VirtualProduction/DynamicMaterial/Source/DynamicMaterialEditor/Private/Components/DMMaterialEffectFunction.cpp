...
TSharedPtr<FJsonValue> UDMMaterialEffectFunction::JsonSerialize() const
{
	...
	return FDMJsonUtils::Serialize({
		{FJsonObject::FStringType(GET_MEMBER_NAME_STRING_CHECKED(ThisClass, bEnabled)), FDMJsonUtils::Serialize(bEnabled)},
		{FJsonObject::FStringType(GET_MEMBER_NAME_STRING_CHECKED(ThisClass, MaterialFunctionPtr)), FDMJsonUtils::Serialize(MaterialFunctionPtr)},
		{FJsonObject::FStringType(GET_MEMBER_NAME_STRING_CHECKED(ThisClass, InputValues)), MakeShared<FJsonValueArray>(ValueArray)},
	});
}
...
bool UDMMaterialEffectFunction::JsonDeserialize(const TSharedPtr<FJsonValue>& InJsonValue)
{
	...
	if (const TSharedPtr<FJsonValue>* JsonValue = Data.Find(FJsonObject::FStringType(GET_MEMBER_NAME_STRING_CHECKED(ThisClass, bEnabled))))
	{
	...
	if (const TSharedPtr<FJsonValue>* JsonValue = Data.Find(FJsonObject::FStringType(GET_MEMBER_NAME_STRING_CHECKED(ThisClass, MaterialFunctionPtr))))
	{
	...
	if (MaterialFunctionPtr)
	{
		if (const TSharedPtr<FJsonValue>* JsonValue = Data.Find(FJsonObject::FStringType(GET_MEMBER_NAME_STRING_CHECKED(ThisClass, InputValues))))
		{
