...
struct FDMMaterialChannelListPreset
{
	...
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "Usage",
		meta = (Bitmask, BitmaskEnum = "/Script/DynamicMaterialEditor.EDMMaterialFlagsUsage"))
	int32 UsageFlag = 0;

	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "General",
		meta = (Bitmask, BitmaskEnum = "/Script/DynamicMaterialEditor.EDMMaterialFlagsGeneral"))
	uint8 GeneralFlags = 0;

	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "Lighting",
		meta = (Bitmask, BitmaskEnum = "/Script/DynamicMaterialEditor.EDMMaterialFlagsLighting"))
	uint8 LightingFlags = 0;

	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "Translucency",
		meta = (Bitmask, BitmaskEnum = "/Script/DynamicMaterialEditor.EDMMaterialFlagsTranslucency"))
	uint8 TranslucencyFlags = 0;

	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "Motion",
		meta = (Bitmask, BitmaskEnum = "/Script/DynamicMaterialEditor.EDMMaterialFlagsMotion"))
	uint8 MotionFlags = 0;

	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "Forward Renderer",
		meta = (Bitmask, BitmaskEnum = "/Script/DynamicMaterialEditor.EDMMaterialFlagsForwardRenderer"))
	uint8 ForwardRendererFlags = 0;
	...
	UPROPERTY(Config, meta = (DeprecatedProperty, DeprecationMessage = "Moved to MotionFlags"))
	bool bDefaultAnimated_DEPRECATED = false;

	UE_DEPRECATED(5.8, "Moved to GeneralFlags")
	UPROPERTY(Config, meta = (DeprecatedProperty, DeprecationMessage = "Moved to GeneralFlags"))
	bool bDefaultTwoSided_DEPRECATED = true;

	PRAGMA_DISABLE_DEPRECATION_WARNINGS
	FDMMaterialChannelListPreset() = default;
	FDMMaterialChannelListPreset(const FDMMaterialChannelListPreset&) = default;
	FDMMaterialChannelListPreset(FDMMaterialChannelListPreset&&) = default;
	FDMMaterialChannelListPreset& operator=(const FDMMaterialChannelListPreset&) = default;
	FDMMaterialChannelListPreset& operator=(FDMMaterialChannelListPreset&&) = default;
...
public:
	...
	virtual ~UDynamicMaterialEditorSettings() override = default;

	DLLEXPORT static UDynamicMaterialEditorSettings* Get();
...
public:
	...
	UPROPERTY(Config)
	bool bConvertedVarsToFlags = false;
