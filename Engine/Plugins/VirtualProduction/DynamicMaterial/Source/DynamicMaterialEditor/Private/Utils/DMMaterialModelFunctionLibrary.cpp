...
UDynamicMaterialModel* UDMMaterialModelFunctionLibrary::ExportToTemplateMaterialModel(UDynamicMaterialModelDynamic* InMaterialModelDynamic)
{
	...
	if (SaveObjectPath.IsEmpty())
	{
		UE_LOGF(LogDynamicMaterialEditor, Warning, "No path was chosen for saving the new editable asset, cancelling.");
		return nullptr;
	}
...
UDynamicMaterialModel* UDMMaterialModelFunctionLibrary::ExportToTemplateMaterialModel(UDynamicMaterialModelDynamic* InMaterialModelDynamic, const FString& InSavePath)
{
	...
	if (!NewModel)
	{
		UE_LOGF(LogDynamicMaterialEditor, Error, "Failed to convert dynamic asset to editable.");
		return nullptr;
	}
	...
	if (!Package)
	{
		UE_LOGF(LogDynamicMaterialEditor, Error, "Failed to create new package for editable asset.");
		return nullptr;
	}
...
UDynamicMaterialInstance* UDMMaterialModelFunctionLibrary::ExportToTemplateMaterial(UDynamicMaterialModelDynamic* InMaterialModelDynamic)
{
	...
	if (!OldInstance)
	{
		UE_LOGF(LogDynamicMaterialEditor, Error, "Failed to find material instance.");
		return nullptr;
	}
