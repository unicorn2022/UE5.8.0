...
SDMMaterialPreview::~SDMMaterialPreview()
{
	...
	{
		Editor->OnPreviewShaderPlatformChanged().RemoveAll(this);
	}
	...
	UDynamicMaterialModelBase* InMaterialModelBase)
{
	...
	{
		Editor->OnPreviewShaderPlatformChanged().AddSP(this, &SDMMaterialPreview::OnFeatureLevelChanged);
	}
...
void SDMMaterialPreview::OnFeatureLevelChanged(EShaderPlatform NewShaderPlatform)
{
