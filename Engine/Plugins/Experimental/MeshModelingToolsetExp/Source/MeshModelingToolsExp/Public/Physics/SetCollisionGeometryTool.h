...
public:
	...
	/** Geometric tolerance to apply after simplifying to the target face count */
	UPROPERTY(EditAnywhere, Category = ConvexHulls, meta = (UIMin = "0", UIMax = "100", ClampMin = "0",
		EditConditionHides, EditCondition = "(GeometryType == ECollisionGeometryType::ConvexHulls  || GeometryType == ECollisionGeometryType::ConvexDecompositions) && bSimplifyHulls"))
	double HullSimplifyGeometryTolerance = 1.;
