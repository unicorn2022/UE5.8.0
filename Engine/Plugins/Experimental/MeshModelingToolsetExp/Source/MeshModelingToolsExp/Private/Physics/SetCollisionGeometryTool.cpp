...
void USetCollisionGeometryTool::Setup()
{
	...
	Settings->WatchProperty(Settings->HullSimplifyGeometryTolerance, [this](double) { InvalidateCompute(); });
...
TUniquePtr<UE::Geometry::TGenericDataOperator<FPhysicsDataCollection>> USetCollisionGeometryTool::MakeNewOperator()
{
	...
	Op->UseShapeGenerator->HullGeometricToleranceAfterTarget = Settings->HullSimplifyGeometryTolerance;
