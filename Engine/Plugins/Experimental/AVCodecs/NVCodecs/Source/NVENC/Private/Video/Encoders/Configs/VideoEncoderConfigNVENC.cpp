...
TAVResult<NV_ENC_PARAMS_RC_MODE> FVideoEncoderConfigNVENC::ConvertRateControlMode(ERateControlMode Mode)
{
	...
	default:
		return FAVResult(EAVResult::ErrorUnsupported, FString::Printf(TEXT("Rate control mode %d is not supported"), EnumToUnderlyingType(Mode)), TEXT("NVENC"));
	}
}
...
TAVResult<NV_ENC_MULTI_PASS> FVideoEncoderConfigNVENC::ConvertMultipassMode(EMultipassMode Mode)
{
	...
	default:
		return FAVResult(EAVResult::ErrorUnsupported, FString::Printf(TEXT("Multipass mode %d is not supported"), EnumToUnderlyingType(Mode)), TEXT("NVENC"));
	}
}
...
TAVResult<NV_ENC_BUFFER_FORMAT> FVideoEncoderConfigNVENC::ConvertFormat(EVideoFormat const& Format)
{
	...
	default:
		return FAVResult(EAVResult::ErrorUnsupported, FString::Printf(TEXT("Pixel format %d is not supported"), EnumToUnderlyingType(Format)), TEXT("NVENC"));
	}
...
DLLEXPORT FAVResult FAVExtension::TransformConfig(FVideoEncoderConfigNVENC& OutConfig, FVideoEncoderConfigH264 const& InConfig)
{
	...
	static auto const ConvertProfile = [](EH264Profile Profile) -> TAVResult<GUID> {
		...
		default:
			return FAVResult(EAVResult::ErrorUnsupported, FString::Printf(TEXT("H264 profile %d is not supported"), EnumToUnderlyingType(Profile)), TEXT("NVENC"));
		}
		};
	...
	static auto const ConvertAdaptiveTransformMode = [](EH264AdaptiveTransformMode TransformMode) -> TAVResult<NV_ENC_H264_ADAPTIVE_TRANSFORM_MODE> {
		...
		default:
			return FAVResult(EAVResult::ErrorUnsupported, FString::Printf(TEXT("H264 transform mode %d is not supported"), EnumToUnderlyingType(TransformMode)), TEXT("NVENC"));
		}
		};
	...
	static auto const ConvertEntropyCodingMode = [](EH264EntropyCodingMode EntropyCodingMode) -> TAVResult<NV_ENC_H264_ENTROPY_CODING_MODE> {
		...
		default:
			return FAVResult(EAVResult::ErrorUnsupported, FString::Printf(TEXT("H264 entropy coding mode %d is not supported"), EnumToUnderlyingType(EntropyCodingMode)), TEXT("NVENC"));
		}
		};
...
DLLEXPORT FAVResult FAVExtension::TransformConfig(FVideoEncoderConfigNVENC& OutConfig, FVideoEncoderConfigH265 const& InConfig)
{
	...
	static auto const ConvertProfile = [](EH265Profile Profile) -> TAVResult<GUID> {
		...
		default:
			return FAVResult(EAVResult::ErrorUnsupported, FString::Printf(TEXT("H265 profile %d is not supported"), EnumToUnderlyingType(Profile)), TEXT("NVENC"));
		}
		};
...
DLLEXPORT FAVResult FAVExtension::TransformConfig(FVideoEncoderConfigNVENC& OutConfig, FVideoEncoderConfigAV1 const& InConfig)
{
	static auto const ConvertProfile = [](EAV1Profile Profile) -> TAVResult<GUID> {
		...
		default:
			return FAVResult(EAVResult::ErrorUnsupported, FString::Printf(TEXT("AV1 profile %d is not supported"), EnumToUnderlyingType(Profile)), TEXT("NVENC"));
		}
		};
