...
// Always VertexHandle1 <= VertexHandle2.
struct FEdgeSpecifier
{
	FEdgeSpecifier(const FGraphVertexHandle& InVertexHandle1, const FGraphVertexHandle& InVertexHandle2);
	FEdgeSpecifier(const FEdgeSpecifier&) = default;
	FEdgeSpecifier(FEdgeSpecifier&&) = default;
	FEdgeSpecifier& operator=(const FEdgeSpecifier&) = default;
	FEdgeSpecifier& operator=(FEdgeSpecifier&&) = default;
...
inline FEdgeSpecifier::FEdgeSpecifier(const FGraphVertexHandle& InVertexHandle1, const FGraphVertexHandle& InVertexHandle2)
