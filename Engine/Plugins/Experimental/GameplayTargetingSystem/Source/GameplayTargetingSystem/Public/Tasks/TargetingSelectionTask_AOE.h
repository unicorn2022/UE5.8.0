...
public:
	...
	ETargetingAOEShape GetShapeType() const { return ShapeType; }
	...
	UE_API FCollisionShape GetCollisionShape() const;

	bool GetUseRelativeOffset() const { return bUseRelativeOffset; }
