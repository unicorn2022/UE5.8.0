...
public:
	...
	virtual void UpdateModel(int32 AllocationId, UObject* NNEModelData, FString RuntimeName) override
	{
		...
		{
#if WITH_EDITOR
			UE_LOGF(LogNeuralPostProcessing, Error, "NNEModelData is invalid at Slot %d.", AllocationId);
#endif
...
{
#if WITH_EDITOR
	UE_LOGF(LogNeuralPostProcessing, Log, "NeuralPostProcessing starting up");
#endif
	...
	{
#if WITH_EDITOR
		UE_LOGF(LogNeuralPostProcessing, Error, "Shaders directory not added. Failed to find NeuralPostProcessing plugin");
#endif
	}
...
{
#if WITH_EDITOR
	UE_LOGF(LogNeuralPostProcessing, Log, "NeuralPostProcessing function shutting down");
#endif
