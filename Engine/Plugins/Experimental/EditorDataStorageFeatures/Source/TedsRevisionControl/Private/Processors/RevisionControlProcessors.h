...
public:
	...
	void UpdateOverlaysForSCCState(UE::Editor::DataStorage::ICoreProvider* DataStorage) const;
...
private:
	...
	UE::Editor::DataStorage::QueryHandle MonitorNewPackagesHandle = UE::Editor::DataStorage::InvalidQueryHandle;
	...
	UE::Editor::DataStorage::QueryHandle RemoveStatusUpdateEndedTagQuery = UE::Editor::DataStorage::InvalidQueryHandle;
	UE::Editor::DataStorage::QueryHandle RemoveStatusUpdateRequiredTagQuery = UE::Editor::DataStorage::InvalidQueryHandle;

	UE::Editor::DataStorage::QueryHandle RemoveSccStateDirtyTagQuery = UE::Editor::DataStorage::InvalidQueryHandle;
