...
public:
	...
	void RemoveTedsColumnMappingToOutlinerColumn(TWeakObjectPtr<const UScriptStruct> TEDSColumnToRemove);
	void AddTedsColumnMappingToOutlinerColumn(TWeakObjectPtr<const UScriptStruct> TEDSColumnToAdd, const FName& OutlinerColumnId);
protected:
