	...
	const UE::Editor::DataStorage::FMetaDataView& Arguments)
{
	...
	IUiProvider::FWidgetConstructorPtr OutEditModeButtonWidgetConstructorPtr;
	IUiProvider::FWidgetConstructorPtr OutContextMenuWidgetConstructorPtr;

	auto AssignEditModeButtonWidgetToColumn = [&OutEditModeButtonWidgetConstructorPtr] (IUiProvider::FWidgetConstructorPtr WidgetConstructor, TConstArrayView<TWeakObjectPtr<const UScriptStruct>>)
	{
		OutEditModeButtonWidgetConstructorPtr = MoveTemp(WidgetConstructor);;
		return false;
	};

	auto AssignContextMenuWidgetToColumn = [&OutContextMenuWidgetConstructorPtr] (IUiProvider::FWidgetConstructorPtr WidgetConstructor, TConstArrayView<TWeakObjectPtr<const UScriptStruct>>)
	{
		OutContextMenuWidgetConstructorPtr = MoveTemp(WidgetConstructor);;
		return false;
	};
