...
void STedsAssetPreviewWidget::ConstructWidget()
{
	...
	// 1) Header
	{
		IUiProvider::FWidgetConstructorPtr OutHeaderButtonsWidgetConstructorPtr;
		auto AssignHeaderButtonsWidgetToColumn = [&OutHeaderButtonsWidgetConstructorPtr] (IUiProvider::FWidgetConstructorPtr WidgetConstructor, TConstArrayView<TWeakObjectPtr<const UScriptStruct>>)
		{
			OutHeaderButtonsWidgetConstructorPtr = MoveTemp(WidgetConstructor);;
			return false;
		};
		...
		if (OutHeaderButtonsWidgetConstructorPtr)
		{
				...
				DataStorage->IsRowAvailable(HeaderWidgetRowHandle))
			{
				...
				DataStorage->AddColumn(HeaderWidgetRowHandle, FExternalWidgetOnClickedColumn_Experimental
					{
						.OnClicked = MakeShared<TDelegate<void()>>(TDelegate<void()>::CreateLambda([this] ()
						{
	...
	// 2) Thumbnail
	{
		IUiProvider::FWidgetConstructorPtr OutThumbnailWidgetConstructorPtr;
		auto AssignThumbnailWidgetToColumn = [&OutThumbnailWidgetConstructorPtr] (IUiProvider::FWidgetConstructorPtr WidgetConstructor, TConstArrayView<TWeakObjectPtr<const UScriptStruct>>)
		{
			OutThumbnailWidgetConstructorPtr = MoveTemp(WidgetConstructor);;
			return false;
		};
	...
	{
		IUiProvider::FWidgetConstructorPtr OutBasicInfoWidgetConstructorPtr;
		auto AssignBasicInfoWidgetToColumn = [&OutBasicInfoWidgetConstructorPtr] (IUiProvider::FWidgetConstructorPtr WidgetConstructor, TConstArrayView<TWeakObjectPtr<const UScriptStruct>>)
		{
			OutBasicInfoWidgetConstructorPtr = MoveTemp(WidgetConstructor);;
			return false;
		};
	...
	// 4) Full Details
	{
		IUiProvider::FWidgetConstructorPtr OutFullInfoWidgetConstructorPtr;
		auto AssignFullInfoWidgetToColumn = [&OutFullInfoWidgetConstructorPtr] (IUiProvider::FWidgetConstructorPtr WidgetConstructor, TConstArrayView<TWeakObjectPtr<const UScriptStruct>>)
		{
			OutFullInfoWidgetConstructorPtr = MoveTemp(WidgetConstructor);;
			return false;
		};
