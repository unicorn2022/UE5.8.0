	...
	const UE::Editor::DataStorage::FMetaDataView& Arguments)
{
	...
	if (bIsAsset)
	{
		...
		{
			ThumbnailConfig.AssetBorderImageOverride = WidgetRowBinder.BindEventAttribute(&FOnGetWidgetSlateBrushColumn_Experimental::OnGetWidgetSlateBrush, FAppStyle::GetNoBrush());
		}
