...
namespace UE::Editor::DataStorage::QueryStack
{
	...
	public:
		FRowFilterNode(ICoreProvider* Storage, const TSharedPtr<IRowNode>& ParentRowNode, ICoreProvider::EFilterOptions Options, 
			const Queries::TConstQueryFunction<bool>& Filter)
			: Storage(Storage)
			, Filter(Filter)
		...
		FRowFilterNode(ICoreProvider* Storage, const TSharedPtr<IRowNode>& ParentRowNode, const Queries::TConstQueryFunction<bool>& Filter)
			: FRowFilterNode(
				Storage, 
				ParentRowNode, 
				ICoreProvider::EFilterOptions::Default, 
				Filter)
		{}
            
		/*
		 * Require that the template type cannot already be a TConstQueryFunction so it will pass to the defined constructor instead of this one.
		 */
		...
		FRowFilterNode(ICoreProvider* Storage, const TSharedPtr<IRowNode>& ParentRowNode, ICoreProvider::EFilterOptions Options, 
			...
			: FRowFilterNode(
				...
				ParentRowNode, 
				Options, 
				Queries::BuildConstQueryFunction<bool>(Forward<FilterFunction>(Filter)))
		{}
	...
	private:
		...
		Queries::TConstQueryFunction<bool> Filter;
		FRowHandleArray Rows;
		TSharedPtr<IRowNode> ParentRowNode;
		RevisionId CachedParentRevisionID = UninitializedRevisionId;
