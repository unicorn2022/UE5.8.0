...
private:
	...
	virtual void RegisterQuery_ActorComponentHandlePopulate(UE::Editor::DataStorage::ICoreProvider& DataStorage);
	...
	UE::Editor::DataStorage::QueryHandle ActorComponentHandlePopulateQuery = UE::Editor::DataStorage::InvalidQueryHandle;
    UE::Editor::DataStorage::QueryHandle GetAllActorComponentsQuery = UE::Editor::DataStorage::InvalidQueryHandle;
};
