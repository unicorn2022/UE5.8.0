...
private:
	...
	static iree_status_t Wait(iree_hal_semaphore_t* BaseSemaphore, uint64_t Value, iree_timeout_t Timeout, iree_hal_wait_flags_t /*Flags*/)
	{
#if IREE_DRIVER_RDG_VERBOSITY == 1
		UE_LOGF(LogIREEDriverRDG, Display, "%ls", StringCast<TCHAR>(__FUNCTION__).Get());
#endif
	...
	static iree_status_t ImportTimepoint(iree_hal_semaphore_t* /*BaseSemaphore*/, uint64_t /*Value*/, iree_hal_queue_affinity_t /*QueueAffinity*/, iree_hal_external_timepoint_t /*ExternalTimepoint*/)
	{
		return iree_make_status(IREE_STATUS_UNIMPLEMENTED, "timepoint import is not yet implemented");
	}

	static iree_status_t ExportTimepoint(iree_hal_semaphore_t* /*BaseSemaphore*/, uint64_t /*Value*/, iree_hal_queue_affinity_t /*QueueAffinity*/, iree_hal_external_timepoint_type_t /*RequestedType*/, iree_hal_external_timepoint_flags_t /*RequestedFlags*/, iree_hal_external_timepoint_t* IREE_RESTRICT /*OutExternalTimepoint*/)
	{
...
const iree_hal_semaphore_vtable_t FSemaphore::VTable =
{
	...
	.import_timepoint = FSemaphore::ImportTimepoint,
	.export_timepoint = FSemaphore::ExportTimepoint
};
