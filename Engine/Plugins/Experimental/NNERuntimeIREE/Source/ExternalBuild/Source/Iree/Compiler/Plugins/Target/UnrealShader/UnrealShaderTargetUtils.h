...
// be a product name like "rtx3090"/"mali-g710"/"adreno", a microarchitecture
// name like "ampere"/"valhall", or "apple" for Apple/Metal GPUs. Returns a null
// TargetAttr if the given |target| is not recognized.
