...
public:
	UnrealTargetDevice(const UnrealShaderTargetOptions & /*options*/) {}
...
public:
	...
	void getDependentDialects(DialectRegistry &registry) const override {
		registry.insert<IREE::Codegen::IREECodegenDialect, IREE::Encoding::IREEEncodingDialect, spirv::SPIRVDialect, gpu::GPUDialect, IREE::GPU::IREEGPUDialect>();
	}
	...
	LogicalResult serializeExecutable(const SerializationOptions &options, IREE::HAL::ExecutableVariantOp variantOp, OpBuilder &executableBuilder) override {
		...
		auto binaryOp = IREE::HAL::ExecutableBinaryOp::create(
				...
				builder.getHeaderPrefixedBufferAttr(
						...
						/*magic=*/iree_hal_unreal_ExecutableDef_file_identifier,
						/*version=*/0));
