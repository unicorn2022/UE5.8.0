...
if [ ! -d "$BUILD_DIR/iree-runtime-mac" ]; then
	...
	echo
	echo Building Mac Runtime: Incremental build... Please do not use for production.
	echo
...
echo =========================================
echo === Building Mac Runtime - DEV version ==
echo =========================================

TRACING_HEADER=$UE_PLUGIN_ROOT/Source/IREETracing/Internal/IREETracing.h

if [ ! -d "$BUILD_DIR/iree-runtime-mac-dev" ]; then
	cmake -G Ninja -B $BUILD_DIR/iree-runtime-mac-dev $UE_SOURCE_DIR/Iree/Runtime \
	...
	cmake --build $BUILD_DIR/iree-runtime-mac-dev
	
	echo
	echo Building Mac Runtime - DEV version: Done
	echo
else
	echo
	echo Building Mac Runtime - DEV version: Incremental build... Please do not use for production.
	echo
