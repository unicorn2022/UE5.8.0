...
{
	virtual ~IPythonCommandMenu() = default;
...
public:
	...
	virtual void ForceDisablePythonAtRuntime(UE::FSourceLocation Location = UE::FSourceLocation::Current()) override;
	...
	virtual void AddStartupScriptAllowPath(FName Owner, const FString& Path) override;
	virtual void RemoveStartupScriptAllowPath(FName Owner) override;
...
private:
	...
	TUniquePtr<IPythonCommandMenu> CmdMenu = nullptr;
	...
	FPathPermissionList StartupScriptAllowedPaths;
};
