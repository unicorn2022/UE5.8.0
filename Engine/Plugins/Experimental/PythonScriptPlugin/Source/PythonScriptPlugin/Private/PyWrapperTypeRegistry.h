...
private:
	...
	TMap<TObjectPtr<UPythonGeneratedClass>, TObjectPtr<UPythonGeneratedClass>> ClassesToReinstance;

	/** Pending pairs of structs that to be re-instanced */
	TMap<TObjectPtr<UPythonGeneratedStruct>, TObjectPtr<UPythonGeneratedStruct>> StructsToReinstance;
};
