...
TSharedPtr<FFloatingPropertiesPropertyNode> FFloatingPropertiesPropertyNode::GetParent() const
{
	...
	{
		UE_LOGF(LogFloatingProperties, Warning, "Invalid parent relationship detected in GetParent.");
		return nullptr;
	}
...
TSharedPtr<FFloatingPropertiesPropertyNode> FFloatingPropertiesPropertyNode::GetChild() const
{
	...
	{
		UE_LOGF(LogFloatingProperties, Warning, "Invalid parent relationship detected in GetChild.");
		return nullptr;
	}
