...
bool FQuicDeserializeMessageTask::DeserializeMessage(FMemoryReader& MessageReader)
{
	...
	case EQuicMessageFormat::Json:
	{
		...
		{
			UE_LOGF(LogQuicMessaging, Error, "[DeserializeMessage] Json deserialize result failed");
		}
	...
	case EQuicMessageFormat::CborPlatformEndianness:
	{
		...
		if (!DeserializeResult)
		{
			UE_LOGF(LogQuicMessaging, Error, "[DeserializeMessage] CborPlatform deserialize result failed");
		}
	...
	case EQuicMessageFormat::CborStandardEndianness:
	{
		...
		if (!DeserializeResult)
		{
			UE_LOGF(LogQuicMessaging, Error, "[DeserializeMessage] CborStandard deserialize result failed");
		}
	...
	case EQuicMessageFormat::TaggedProperty:
	{
		...
		if (!DeserializeResult)
		{
			UE_LOGF(LogQuicMessaging, Error, "[DeserializeMessage] TaggedProperty deserialize result failed");
		}
