...
struct FLiterals
{
	// '!' is used in some literals so that they are not valid identifiers
	...
	FAnsiStringView UnsetFlagEnum = "!UnsetFlagEnum";

	FAnsiStringView Oob = "ERR!oob";

	FAnsiStringView Kinds[3] = { ("Leaf"), ("Struct"), ("Range") };

	FAnsiStringView Ranges[9] = { 
		("Uni"), ("i8"), ("u8"), ("i16"), ("u16"), ("i32"), ("u32"), ("i64"), ("u64") };

	FAnsiStringView RangeTypes[9] = { 
		("(Uni)"), ("(i8)"), ("(u8)"), ("(i16)"), ("(u16)"), ("(i32)"), ("(u32)"), ("(i64)"), ("(u64)") };

	FAnsiStringView Leaves[8][4] = {
		{("bool"),		("ERR!b16"),	("ERR!b32"),	("ERR!b64")},
		{("i8"),		("i16"),		("i32"),		("i64")},
		{("u8"),		("u16"),		("u32"),		("u64")},
		{("ERR!fp8"),	("ERR!fp16"),	("float"),		("double")},
		{("hex8"),		("hex16"),		("hex32"),		("hex64")},
		{("enum8"),		("enum16"),		("enum32"),		("enum64")},
		{("utf8"),		("utf16"),		("utf32"),		("ERR!utf64")},
		{Oob,			Oob,			Oob,			Oob}};
