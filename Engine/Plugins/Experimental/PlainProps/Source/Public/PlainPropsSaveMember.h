...
inline bool Track(bool bDiff, FDiffContext& Ctx, FMemberBindType Type, FMemberId Name, FDiffMetadata Meta, const void* A, const void* B)
{
	if (bDiff)
	{
		Ctx.AddDiff({Type, ToOptional(Name), Meta, A, B, Ctx.LastSibling});
	}
...
PLAINPROPS_API void							SaveMember(FMemberBuilder& Out, const void* Struct, FMemberId Name, const FSaveContext& Ctx, FLeafMemberBinding Member);
PLAINPROPS_API void							SaveMember(FMemberBuilder& Out, const void* Struct, FMemberId Name, const FSaveContext& Ctx, FRangeMemberBinding Member);
PLAINPROPS_API void							SaveMember(FMemberBuilder& Out, const void* Struct, FMemberId Name, const FSaveContext& Ctx, FStructMemberBinding Member);

//////////////////////////////////////////////////////////////////////////

[[nodiscard]] PLAINPROPS_API FMemberSchema	CreateRangeSchema(FScratchAllocator& Scratch, FRangeMemberBinding Member);
