...
public:
	...
	virtual FScopeId					IndexScopeLiteral(FAnsiStringView Scope)			{ return Scope.Len() ? FScopeId(FFlatScopeId{IndexLiteral(Scope)}) : NoId; }
	...
	FNameId								IndexEnumeratorLiteral(FAnsiStringView Flag)		{ return IndexLiteral(Flag); }
};
