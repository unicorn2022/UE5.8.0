...
void FTileDataLayer::Evict()
{
	...
	{
		UE_LOGF(LogGPULightmass, Log, "CPU tile management: evicted %d tiles in %ls, released %.2fMB", OldNum - AllUncompressedTiles.Num(), *FPlatformTime::PrettyTime(EndTime - StartTime), EvictedMemorySize / 1024.0f / 1024.0f);
	}
}
