...
public:
	...
	FLightmapTilePoolGPU(FRHICommandListBase& RHICmdList, int32 NumLayers, FIntPoint InSizeInTiles, FIntPoint TileSize);

	void Initialize(FRHICommandListBase& RHICmdList, TArray<FLayerFormatAndTileSize> Layers);
