...
struct FDenoiserContext
{
	...
	~FDenoiserContext()
	{
		UE_LOGF(LogTemp, Log, "Denoising: %.2lfs initializing filters (%d), %.2lfs executing filters (%d)", FilterInitTime, NumFilterInit, FilterExecutionTime, NumFilterExecution);
	}
