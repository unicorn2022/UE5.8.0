...
public:
	...
	UE_API void AddLineGraph(const TArrayView<FVector2D>& Points, const SlateIM::FGraphLinePointsParams& Params);
	UE_API void AddLineGraph(const TArrayView<double>& Values, const SlateIM::FGraphLineValuesParams& Params);
