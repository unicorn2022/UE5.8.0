...
namespace SlateIM
{
	...
	{
		return ModalDialog(MessageType, DialogText, {.Category = Category, .Title = DialogTitle});
	}

	EAppReturnType::Type ModalDialog(EAppMsgType::Type MessageType, const FStringView& DialogText, const FModalDialogParams& Params)
	{
		...
		return FMessageDialog::Open(Params.Category, MessageType, FText::FromStringView(DialogText), FText::FromStringView(Params.Title));
	}
}
