...
USTRUCT(meta = (DisplayName = "Parent Changed Column (Template)", EditorDataStorage_DynamicColumnTemplate))
struct FEditorDataHierarchyParentChangedTag_Template final : public FEditorDataStorageTag
{
	GENERATED_BODY()
};
