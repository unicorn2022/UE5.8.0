...
public:
	~UEditorDataStorageCompatibility() override;
...
protected:
	UE_API void EnterImmediateMode(UE::Editor::DataStorage::FObjectCompatibilityImmediateScope& Scope) override;
	UE_API void LeaveImmediateMode(UE::Editor::DataStorage::FObjectCompatibilityImmediateScope& Scope) override;
...
private:
	...
	private:
		...
		TArray<FEntry> ProcessingEntries;
	...
	static thread_local UE::Editor::DataStorage::FObjectCompatibilityImmediateScope* ImmediateModeTracker;
