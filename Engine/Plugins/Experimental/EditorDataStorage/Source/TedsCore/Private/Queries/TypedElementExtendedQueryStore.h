...
namespace UE::Editor::DataStorage
{
	...
	{
		mutable FMassEntityQuery NativeQuery; // Used if there's no processor bound. Mutable because NativeQuery does internal state caching.
	...
	public:
		 ...
		 */
		uint64 CalculateQueryTablesTopologyHash(Handle Query) const;
	...
	private:
		...
		bool CheckCompatibility(const FQueryDescription& QueryDescription, const Queries::TConstQueryFunction<void> QueryCallback) const;
