...
{
	return GetStandaloneHLODGuid().IsValid();
}

const FGuid& FFastGeoHLOD::GetStandaloneHLODGuid() const
{
	return GetHLODGuid(EHLODGuidType::Standalone);
}

bool FFastGeoHLOD::IsCustomHLOD() const
{
	return GetCustomHLODGuid().IsValid();
}

const FGuid& FFastGeoHLOD::GetCustomHLODGuid() const
{
	return GetHLODGuid(EHLODGuidType::Custom);
}

const FGuid& FFastGeoHLOD::GetHLODGuid(EHLODGuidType InGuidType) const
{
	if (HLODGuidType == InGuidType)
	{
		return HLODGuid;
	}
	else
...
{
	SetHLODGuid(InStandaloneHLODGuid, EHLODGuidType::Standalone);
}

void FFastGeoHLOD::SetCustomHLODGuid(const FGuid& InCustomHLODGuid)
{
	SetHLODGuid(InCustomHLODGuid, EHLODGuidType::Custom);
}

void FFastGeoHLOD::SetHLODGuid(const FGuid& InGuid, EHLODGuidType InGuidType)
{
	HLODGuid = InGuid;
	HLODGuidType = InGuidType;
}
