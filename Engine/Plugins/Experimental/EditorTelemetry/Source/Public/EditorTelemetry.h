...
public:
	...
	UE_API void RecordEvent_Cooking(const FString& Context, const TArray<FAnalyticsEventAttribute>& Attributes = {});
	UE_API void RecordEvent_Loading(const FString& Context, double LoadingSeconds, const TArray<FAnalyticsEventAttribute>& Attributes = {});
	UE_API void RecordEvent_CoreSystems(const FString& Context, const TArray<FAnalyticsEventAttribute>& Attributes = {});
	UE_API void RecordEvent_DDCResource(const FString& Context, const TArray<FAnalyticsEventAttribute>& Attributes = {});
	UE_API void RecordEvent_DDCSummary(const FString& Context, const TArray<FAnalyticsEventAttribute>& Attributes = {});
	UE_API void RecordEvent_DDCVerification(const FString& Context, const TArray<FAnalyticsEventAttribute>& Attributes = {});
	UE_API void RecordEvent_Zen(const FString& Context, const TArray<FAnalyticsEventAttribute>& Attributes = {});
	UE_API void RecordEvent_VirtualAssets(const FString& Context, const TArray<FAnalyticsEventAttribute>& Attributes = {});
	UE_API void RecordEvent_MemoryLLM(const FString& Context, const TArray<FAnalyticsEventAttribute>& Attributes = {});
	UE_API void RecordEvent_ShaderStats(const FString& Context, const TArray<FAnalyticsEventAttribute>& Attributes = {});
