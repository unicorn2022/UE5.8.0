	...
	FName InDeclarationType)
{
	...
	UE_LOGF(LogWebAPIEditor, Display, "New Type Path: %ls", *TypeInfo->GetPathName());
...
#if WITH_WEBAPI_DEBUG
	UE_LOGF(LogWebAPIEditor, Display, "Template Type Path: %ls", *InTemplateTypeInfo->GetPathName());	
#endif
...
#if WITH_WEBAPI_DEBUG
	UE_LOGF(LogWebAPIEditor, Display, "Duplicate Type Path: %ls", *TypeInfo->GetPathName());
#endif
...
#if WITH_WEBAPI_DEBUG
	UE_LOGF(LogWebAPIEditor, Display, "MakeTypeName: %ls", *Result.ToString());
#endif
