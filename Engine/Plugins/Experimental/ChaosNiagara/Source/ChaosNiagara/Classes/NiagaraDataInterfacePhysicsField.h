...
public:
...
#if WITH_EDITOR
	virtual bool ShouldCompile(EShaderPlatform ShaderPlatform) const override { return !IsMobilePlatform(ShaderPlatform) && 
		IsFeatureLevelSupported(ShaderPlatform, ERHIFeatureLevel::SM5);}
#endif
	...
	virtual bool HasPostSimulateTick() const override { return IsUsedWithCPUScript(); }
