...
namespace UE::Learning
{
	...
	public:
		...
		/** Gets an array of the frames */
		UE_API TLearningArrayView<1, const int32> GetAllFrames() const;
		...
		/** Finds all the frames within the given range, returning the first frame index and the number of frames */
		UE_API bool FindFramesInRange(int32& OutStartFrameIdx, int32& OutFrameNum, const int32 EntryIdx, const int32 RangeStart, const int32 RangeLength) const;
