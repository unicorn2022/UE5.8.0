...
public:
	...
	// Gets the update number which is incremented each time the network is loaded from a snapshot
	UE_API int32 GetUpdateNumber() const;
...
private:
	...
	// Number which is incremented each time the network is loaded from a snapshot
	UPROPERTY(VisibleAnywhere, Category = "Network Properties")
	int32 UpdateNumber = 0;
