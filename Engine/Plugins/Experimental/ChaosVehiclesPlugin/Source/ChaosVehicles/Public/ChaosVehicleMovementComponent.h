...
public:
	...
	void ApplyMigratedVehicleState();
#endif
protected:
	...
	*/
	...
	// migrates physics related state (such as vehicle ouput)
	ENGINE_API virtual void MigratePhysicsState(FArchive& Ar);
...
private:
	...
	FNetworkVehicleStates MigratedVehicleStates;
	bool bIsVehicleStatesMigrated = false;
#endif
};
