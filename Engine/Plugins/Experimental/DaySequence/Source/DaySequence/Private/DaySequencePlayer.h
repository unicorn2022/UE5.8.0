...
public:
	...
	UE_API virtual bool HasEverEvaluated() const override;
	...
	/**
	 * Returns the number of times this sequence has been looped
	*/
	UFUNCTION(BlueprintCallable, Category = "Sequencer|Player")
	UE_API virtual int32 GetCurrentNumLoops() const {return CurrentNumLoops;} ;
