...
private:
	...
	void CreateDataflowProgressBar();
...
private:
	...
	TSharedPtr<SWidget> DataflowProgressBar;

	TSharedPtr<UE::Dataflow::FEngineContext> DataflowContext;
	TSharedPtr<UE::Dataflow::IDataflowEvaluator> DataflowEvaluator;
	...
	FDelegateHandle OnFinishedChangingVariableOverridesDelegateHandle;
};
