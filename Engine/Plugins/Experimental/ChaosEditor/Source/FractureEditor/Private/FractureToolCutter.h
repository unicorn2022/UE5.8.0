...
public:
	...
	UPROPERTY(EditAnywhere, Category = "CommonFracture|Split Islands")
	bool bSplitIslands = true;

	/** Distance threshold for connecting spatially-close vertices before computing islands */
	UPROPERTY(EditAnywhere, Category = "CommonFracture|Split Islands", meta = (EditCondition = "bSplitIslands", Units = "cm", ClampMin = "0.0"))
