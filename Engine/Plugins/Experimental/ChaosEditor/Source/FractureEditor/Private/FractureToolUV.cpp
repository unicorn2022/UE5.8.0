...
void UFractureToolAutoUV::BakeTextureForComponent(UGeometryCollectionComponent* Component)
{
	...
	BakeOp->GutterSize = AutoUVSettings->GutterSize + (AutoUVSettings->bFullyPadGutterOnBake ? OutputRes : AutoUVSettings->GutterPaddingOnBake);
	...
	BakeOp->AttribSettings.ClearGutterChannel = AutoUVSettings->bClearGutterAlpha ? 3 : INDEX_NONE;
