...
struct FDrawDebugPointStyle
{
	...
	/** Construct a Point Style */
	UE_API FDrawDebugPointStyle(
		const FLinearColor InColor = FLinearColor(1.0f, 0.0f, 1.0f, 1.0f),
		const float InThickness = 0.0f);
...
struct FDrawDebugLineStyle
{
	...
	/** Construct a Line Style */
	UE_API FDrawDebugLineStyle(
		const FLinearColor InColor = FLinearColor(1.0f, 0.0f, 1.0f, 1.0f),
		const float InThickness = 0.0f,
		const EDrawDebugLineType InLineType = EDrawDebugLineType::Solid,
		const float InDashWidth = 2.5f,
		const float InDashSpacing = 1.0f,
		const float InDotSpacing = 1.0f);
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library", AdvancedDisplay, meta = (ClampMin = "0", UIMin = "0", Units = "cm"))
...
struct FDrawDebugBackpackSettings
{
	...
	/** Height of the backpack */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library", meta = (ClampMin = "0", UIMin = "0", Units = "cm"))
	float Height = 45.0f;

	/** Depth of the backpack */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library", meta = (ClampMin = "0", UIMin = "0", Units = "cm"))
	float Depth = 15.0f;

	/** Distance the straps extend outward */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library", meta = (ClampMin = "0", UIMin = "0", Units = "cm"))
	float StrapDistance = 25.0f;

	/** The height at which the straps are in contact */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library", meta = (Units = "cm"))
	float StrapContactHeight = 25.0f;

	/** Width of the straps */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library", meta = (Units = "cm"))
	float StrapWidth = 2.5f;

	/** Inset of the straps horizontally */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library", meta = (Units = "cm"))
	float StrapHorizontalInset = 5.0f;

	/** Inset of the straps vertically */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library", meta = (Units = "cm"))
	float StrapVerticalInset = 2.5f;
};
...
struct FDrawDebugBriefcaseSettings
{
	...
	/** Half-extents of the briefcase */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library", meta = (ClampMin = "0", UIMin = "0", Units = "cm"))
	FVector HalfExtents = FVector(20.0f, 5.0f, 15.0f);

	/** Length of the handle */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library", meta = (ClampMin = "0", UIMin = "0", Units = "cm"))
	float HandleLength = 10.0f;

	/** The height of the handle above the briefcase */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library", meta = (ClampMin = "0", UIMin = "0", Units = "cm"))
...
struct FDrawDebugStringSettings
{
	...
	/** Draws the string centered vertically rather than starting from the top left */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library")
	bool bCenterVertically = false;

	/** Draws the string centered horizontally rather than starting from the top left */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library")
...
struct FDrawDebugGraphAxesSettings
{
	...
	/** Settings for the axis arrows */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library")
	FDrawDebugArrowSettings AxisArrowSettings;

	/** Settings for the axis labels */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library")
	FDrawDebugStringSettings AxisLabelSettings;

	/** Draws the axes as a box instead of two arrows */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library")
	bool bDrawAxesBox = false;
};
...
struct FDrawDebugCanvasTextSettings
{
	...
	/** If to draw using a monospaced font */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library", meta = (EditCondition = "!Font", HideEditConditionToggle))
	bool bMonospaced = true;
	...
	/** If to draw a shadow under the text */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library")
	bool bShadow = false;

	/** Color of the shadow */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library", meta = (EditCondition = "bShadow", HideEditConditionToggle))
	...
	/** If to draw an outline around the text */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library")
	bool bOutline = false;

	/** Color of the outline */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library", meta = (EditCondition = "bOutline", HideEditConditionToggle))
	FLinearColor OutlineColor = FLinearColor::White;

	/** Draws the text centered vertically rather than starting from the top left */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library")
	bool bCenterVertically = false;

	/** Draws the text centered horizontally rather than starting from the top left */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Draw Debug Library")
	bool bCenterHorizontally = false;
};
...
{
	/** Destructor will un-bind the delegate if it is still bound */
	UE_API ~FDebugDrawerCanvasBuffer();

	/** Flushes the buffer and draws to the canvas */
	UE_API void Flush(FCanvas* Canvas);

	/** Delegate used to draw to a canvas somewhere */
	FDelegateHandle Delegate;

	/** Scale to draw to the screen */
	float Scale = 1.0f;

	/** Buffered primitive types. 0 - points, 1 - lines, 2 - text */
	TArray<uint8> PrimitiveTypes;

	/** Number of primitives to draw for each buffered call */
	TArray<int32> PrimitiveNums;

	/** Color of each buffered call */
	TArray<FLinearColor> Colors;

	/** Thickness of each buffered call */
	TArray<float> Thicknesses;

	/** Array of point data */
	TArray<FVector> Points;

	/** Array of line segment data */
	TArray<TPair<FVector, FVector>> LineSegments;

	/** Array of text data including draw location */
	TArray<TPair<FVector2D, FText>> Texts;

	/** Array of text setting data */
	TArray<FDrawDebugCanvasTextSettings> TextSettings;
};
...
public: // Constructors
	...
	UE_API FDebugDrawer(UAnimInstance* InAnimInstance);
	...
	UE_API FDebugDrawer(FRigVMDrawInterface* InRigVMDrawInterface, const USceneComponent* InRigVMComponent = nullptr);

	/** Make a debug drawer for a FCanvas */
	UE_API FDebugDrawer(FCanvas* InCanvas);

	/** Make a debug drawer for a UCanvas */
	UE_API FDebugDrawer(UCanvas* InCanvas);

	/** Make a debug drawer for the given canvas buffer. */
	UE_API FDebugDrawer(const TSharedPtr<FDebugDrawerCanvasBuffer>& InCanvasBuffer);

	/** Forward declaration of destructor */
	UE_API ~FDebugDrawer();
	...
	/** Make a debug drawer for an AnimInstance */
	static UE_API FDebugDrawer MakeDebugDrawer(UAnimInstance* AnimInstance);
	...
	/** Make a debug drawer for a FRigVMDrawInterface */
	static UE_API FDebugDrawer MakeDebugDrawer(FRigVMDrawInterface* InRigVMDrawInterface, const USceneComponent* InRigVMComponent = nullptr);

	/** Make a debug drawer for a FCanvas */
	static UE_API FDebugDrawer MakeDebugDrawer(FCanvas* InCanvas, const float InCanvasScale = 1.0f);

	/** Make a debug drawer for a UCanvas */
	static UE_API FDebugDrawer MakeDebugDrawer(UCanvas* InCanvas, const float InCanvasScale = 1.0f);

	/** Make a debug drawer for the given canvas buffer. */
	static UE_API FDebugDrawer MakeDebugDrawer(const TSharedPtr<FDebugDrawerCanvasBuffer>& CanvasBuffer);
	...
	/** Make a debug drawer for the default viewport canvas. This can be expensive so should be called once and stored. */
	static UE_API FDebugDrawer MakeScreenDebugDrawer(const float Scale = 1.0f);
...
public: // Drawer specific interface
	...
	UE_API void CanvasDrawText(const FVector2D& Location, const FText& Text, const FLinearColor& Color, const FDrawDebugCanvasTextSettings& Settings) const;
...
private:
	...
	/** RigVM Draw Interface - used for drawing in a RigVM context. */
	FRigVMDrawInterface* RigVM = nullptr;

	/** Component which the RigVM context is attached to */
	UPROPERTY()
	TObjectPtr<const USceneComponent> RigVMComponent = nullptr;
...
private:
	...
	/** Anim Instance Object - used for debug drawing in an AnimBlueprints. */
	UPROPERTY()
...
private:
	...
	UPROPERTY()
	TObjectPtr<const UObject> VisualLoggerObject = nullptr;
...
private:
	...
	/** Canvas pointer - used for writing to a 2D canvas */
	FCanvas* Canvas = nullptr;

	/** Canvas Scale */
	float CanvasScale = 1.0f;

	/** Canvas buffer used for writing to a canvas at a later point */
	TSharedPtr<FDebugDrawerCanvasBuffer> CanvasBuffer;
};
...
public: // Drawers
	...
	/** Make a debug drawer for an AnimInstance */
	UFUNCTION(BlueprintPure, Category = "Draw Debug Library", meta = (DevelopmentOnly, DefaultToSelf = "AnimInstance"))
	static UE_API FDebugDrawer MakeAnimInstanceDebugDrawer(UAnimInstance* AnimInstance);
	...
	/** Make a debug drawer for a FRigVMDrawInterface */
	static UE_API FDebugDrawer MakeRigVMDebugDrawer(FRigVMDrawInterface* InRigVMDrawInterface, const USceneComponent* InRigVMComponent = nullptr);

	/** Make a debug drawer for a FCanvas */
	static UE_API FDebugDrawer MakeCanvasStructDebugDrawer(FCanvas* InCanvas, const float InScale = 1.0f);

	/** Make a debug drawer for a UCanvas */
	UFUNCTION(BlueprintPure, Category = "Draw Debug Library", meta = (DevelopmentOnly))
	static UE_API FDebugDrawer MakeCanvasDebugDrawer(UCanvas* InCanvas, const float InScale = 1.0f);

	/** Make a debug drawer for the given buffer. */
	static UE_API FDebugDrawer MakeCanvasDebugDrawerFromBuffer(const TSharedPtr<FDebugDrawerCanvasBuffer>& CanvasBuffer);
...
public: // Canvas Functions
	...
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Location, Text, Settings"))
	static UE_API void DrawDebugCanvasText(const FDebugDrawer& Drawer, const FVector2D& Location, const FText& Text, const FLinearColor Color = FLinearColor(1.0f, 0.0f, 1.0f, 1.0f), const FDrawDebugCanvasTextSettings& Settings = FDrawDebugCanvasTextSettings());

	/** Draw a string on the canvas. Only does anything with a ScreenDebugDrawer or CanvasDebugDrawer. */
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Location, String, Settings"))
	static UE_API void DrawDebugCanvasString(const FDebugDrawer& Drawer, const FVector2D& Location, const FString& String, const FLinearColor Color = FLinearColor(1.0f, 0.0f, 1.0f, 1.0f), const FDrawDebugCanvasTextSettings& Settings = FDrawDebugCanvasTextSettings());
	static UE_API void DrawDebugCanvasStringView(const FDebugDrawer& Drawer, const FVector2D& Location, const FStringView String, const FLinearColor Color = FLinearColor(1.0f, 0.0f, 1.0f, 1.0f), const FDrawDebugCanvasTextSettings& Settings = FDrawDebugCanvasTextSettings());

	/** Draw a name on the canvas. Only does anything with a ScreenDebugDrawer or CanvasDebugDrawer. */
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Location, Name, Settings"))
	static UE_API void DrawDebugCanvasName(const FDebugDrawer& Drawer, const FVector2D& Location, const FName& Name, const FLinearColor Color = FLinearColor(1.0f, 0.0f, 1.0f, 1.0f), const FDrawDebugCanvasTextSettings& Settings = FDrawDebugCanvasTextSettings());
...
public: // Convenience functions
	...
	static UE_API void MakeLinearlySpacedFloatArrayView(TArrayView<float> OutValues, const float Start = 0.0f, const float Stop = 1.0f);

	/** Convenience function that adds a float to the end of an array, popping values from the front once the max is reached */
	UFUNCTION(BlueprintPure = false, Category = "Draw Debug Library", meta = (NotBlueprintThreadSafe))
	...
	UFUNCTION(BlueprintPure = false, Category = "Draw Debug Library", meta = (NotBlueprintThreadSafe))
	static UE_API void AddToNameHistoryArray(UPARAM(ref) TArray<FName>& InOutValues, const FName NewValue = NAME_None, const int32 MaxHistoryNum = 60);

	/** Returns a new location and rotation after applying a local offset to the input draw location and rotation */
	UFUNCTION(BlueprintPure, Category = "Draw Debug Library")
	static UE_API void DrawDebugLocalOffset(
		FVector& OutLocation,
	...
	UFUNCTION(BlueprintPure, Category = "Draw Debug Library")
	static UE_API void DrawDebugOrientUprightToFloor(
		FVector& OutLocation,
		FRotator& OutRotation,
	...
	UFUNCTION(BlueprintPure, Category = "Draw Debug Library")
	static UE_API void DrawDebugOrientFloorToUpright(
		FVector& OutLocation,
		FRotator& OutRotation,
		const FVector DrawWorldLocation,
	...
	UFUNCTION(BlueprintPure, Category = "Draw Debug Library")
	static UE_API void DrawDebugOrientUprightToCamera(
		FVector& OutLocation,
		FRotator& OutRotation,
		const FVector DrawWorldLocation,
		const FVector DrawUprightOffset,
		const FRotator CameraRotation,
		const bool bUseOnlyYaw = false);

	/** Create a new location and rotation that orients debug drawing of floor objects such as shapes to face the camera */
	UFUNCTION(BlueprintPure, Category = "Draw Debug Library")
	static UE_API void DrawDebugOrientFloorToCamera(
		FVector& OutLocation,
		FRotator& OutRotation,
		const FVector DrawWorldLocation,
		const FVector DrawFloorOffset,
	...
	UFUNCTION(BlueprintPure, Category = "Draw Debug Library")
	static UE_API void DrawDebugOrientUprightToCanvas(
		FVector& OutLocation,
		FRotator& OutRotation,
...
public: // Style Modifiers
	...
	UFUNCTION(BlueprintPure, Category = "Draw Debug Library", meta = (BlueprintAutocast, CompactNodeTitle = "->", AutoCreateRefTerm = "Color"))
	static UE_API FDrawDebugPointStyle MakeDrawDebugPointStyleFromColor(const FLinearColor& Color);

	/** Make a point style from a color and thickness */
	UFUNCTION(BlueprintPure, Category = "Draw Debug Library")
	static UE_API FDrawDebugPointStyle MakeDrawDebugPointStyleFromColorAndThickness(const FLinearColor Color = FLinearColor(1.0f, 0.0f, 1.0f, 1.0f), const float Thickness = 0.0f);

	/** Make a line style from a color */
	UFUNCTION(BlueprintPure, Category = "Draw Debug Library", meta = (BlueprintAutocast, CompactNodeTitle = "->", AutoCreateRefTerm = "Color"))
	static UE_API FDrawDebugLineStyle MakeDrawDebugLineStyleFromColor(const FLinearColor& Color);

	/** Make a line style from a color and thickness */
	UFUNCTION(BlueprintPure, Category = "Draw Debug Library")
	static UE_API FDrawDebugLineStyle MakeDrawDebugLineStyleFromColorAndThickness(const FLinearColor Color = FLinearColor(1.0f, 0.0f, 1.0f, 1.0f), const float Thickness = 0.0f);
...
public: // Basic Shapes
	...
	static UE_API void DrawDebugConeLookAt(const FDebugDrawer& Drawer, const FVector& Location, const FVector& Direction = FVector::ForwardVector, const FDrawDebugLineStyle& LineStyle = FDrawDebugLineStyle(), const bool bDepthTest = true, const float Length = 20.0f, const float Angle = 10.0f, const int32 Segments = 9);
	...
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Location, Rotation, LineStyle"))
	static UE_API void DrawDebugCross(const FDebugDrawer& Drawer, const FVector& Location, const FRotator& Rotation, const FDrawDebugLineStyle& LineStyle = FDrawDebugLineStyle(), const bool bDepthTest = true, const float HalfLength = 10.0f);
	...
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Location, Rotation, LineStyle"))
	static UE_API void DrawDebugCheckMark(const FDebugDrawer& Drawer, const FVector& Location, const FRotator& Rotation, const FDrawDebugLineStyle& LineStyle = FDrawDebugLineStyle(), const bool bDepthTest = true, const float Radius = 10.0f);

	/** Debug Draw a checkbox on the XY axis */
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Location, Rotation, LineStyle"))
	static UE_API void DrawDebugCheckBox(const FDebugDrawer& Drawer, const FVector& Location, const FRotator& Rotation, const FDrawDebugLineStyle& LineStyle = FDrawDebugLineStyle(), const bool bDepthTest = true, const float HalfLength = 10.0f, const bool bChecked = false, const float TickRatio = 1.75f);

	/** Debug Draw a cross box on the XY axis */
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Location, Rotation, LineStyle"))
	static UE_API void DrawDebugCrossBox(const FDebugDrawer& Drawer, const FVector& Location, const FRotator& Rotation, const FDrawDebugLineStyle& LineStyle = FDrawDebugLineStyle(), const bool bDepthTest = true, const float HalfLength = 10.0f, const bool bCrossed = false, const float CrossRatio = 1.0);

	/** Debug Draw a radio button on the XY axis */
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Location, Rotation, LineStyle"))
	static UE_API void DrawDebugRadioButton(const FDebugDrawer& Drawer, const FVector& Location, const FRotator& Rotation, const FDrawDebugLineStyle& LineStyle = FDrawDebugLineStyle(), const bool bDepthTest = true, const float Radius = 10.0f, const bool bSelected = false, const float InnerButtonRatio = 0.5f, const int32 Segments = 17);
	...
	/** Debug Draw an FBox */
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Location, Rotation, Box"))
	static UE_API void DrawDebugBoxStruct(const FDebugDrawer& Drawer, const FVector& Location, const FRotator& Rotation, const FDrawDebugLineStyle& LineStyle = FDrawDebugLineStyle(), const bool bDepthTest = true, const FBox& Box = FBox());

	/** Debug Draw a FBoxSphereBounds */
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Location, Rotation, Bounds"))
	static UE_API void DrawDebugBoxSphereBounds(const FDebugDrawer& Drawer, const FVector& Location, const FRotator& Rotation, const FDrawDebugLineStyle& LineStyle = FDrawDebugLineStyle(), const bool bDepthTest = true, const FBoxSphereBounds& Bounds = FBoxSphereBounds());
...
public: // Arrows
	...
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Location, Rotation, LineStyle"))
	static UE_API void DrawDebugArrowHead(const FDebugDrawer& Drawer, const FVector& Location, const FRotator& Rotation, const FDrawDebugLineStyle& LineStyle = FDrawDebugLineStyle(), const bool bDepthTest = true, const EDrawDebugArrowHead Type = EDrawDebugArrowHead::Simple, const float Size = 5.0f);
	...
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Location, Rotation, LineStyle, Settings"))
	static UE_API void DrawDebugCircleArrow(const FDebugDrawer& Drawer, const FVector& Location, const FRotator& Rotation, const float Angle, const FDrawDebugLineStyle& LineStyle = FDrawDebugLineStyle(), const bool bDepthTest = true, const float Radius = 10.0f, const float Length = 20.0f, const FDrawDebugArrowSettings& Settings = FDrawDebugArrowSettings());

	/** Debug Draw an arc around the XY axis with arrow heads */
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Location, Rotation, LineStyle, Settings"))
	static UE_API void DrawDebugArcArrow(const FDebugDrawer& Drawer, const FVector& Location, const FRotator& Rotation, const float Angle = 90.0f, const FDrawDebugLineStyle& LineStyle = FDrawDebugLineStyle(), const bool bDepthTest = true, const float Radius = 10.0f, const int32 Segments = 17, const FDrawDebugArrowSettings& Settings = FDrawDebugArrowSettings());
...
public: // Variable Types
	...
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "P0, P1, P2, LineStyle"))
	static UE_API void DrawDebugAngleBetween(const FDebugDrawer& Drawer, const FVector& P0, const FVector& P1, const FVector& P2, const FDrawDebugLineStyle& LineStyle = FDrawDebugLineStyle(), const bool bDepthTest = true, const float AngleRadius = 5.0f, const int32 Segments = 17);
...
public: // Complex Objects
	...
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Location, Rotation, LineStyle"))
	static UE_API void DrawDebugCamera(const FDebugDrawer& Drawer, const FVector& Location, const FRotator& Rotation, const FDrawDebugLineStyle& LineStyle = FDrawDebugLineStyle(), const bool bDepthTest = true, const float Scale = 10.0f, const float FOVDegrees = 30.0f);

	/** Debug draw a backpack */
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Location, Rotation, LineStyle, Settings"))
	static UE_API void DrawDebugBackpack(const FDebugDrawer& Drawer, const FVector& Location, const FRotator& Rotation, const FDrawDebugLineStyle& LineStyle = FDrawDebugLineStyle(), const bool bDepthTest = true, const FDrawDebugBackpackSettings& Settings = FDrawDebugBackpackSettings());

	/** Debug draw a briefcase */
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Location, Rotation, LineStyle, Settings"))
	static UE_API void DrawDebugBriefcase(const FDebugDrawer& Drawer, const FVector& Location, const FRotator& Rotation, const FDrawDebugLineStyle& LineStyle = FDrawDebugLineStyle(), const bool bDepthTest = true, const FDrawDebugBriefcaseSettings& Settings = FDrawDebugBriefcaseSettings());
...
public: // Poses / Skeletons
	...
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Settings"))
	...
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Location, Rotation, LineStyle, Settings"))
	static UE_API void DrawDebugCurvesFromSkeletalMeshComponent(
		const FDebugDrawer& Drawer,
		...
		const FDrawDebugLineStyle& LineStyle = FDrawDebugLineStyle(), 
		const bool bDepthTest = true,
		const FDrawDebugStringSettings& Settings = FDrawDebugStringSettings());
	...
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Location, Settings"))
	static UE_API void DrawDebugCurvesToCanvasFromSkeletalMeshComponent(
		const FDebugDrawer& Drawer,
		const USkeletalMeshComponent* SkeletalMeshComponent,
		const FVector2D& Location,
		const FLinearColor Color = FLinearColor(1.0f, 0.0f, 1.0f, 1.0f),
		const FDrawDebugCanvasTextSettings& Settings = FDrawDebugCanvasTextSettings());

public: // Objects

	/** Debug Draw the bounding box of a static mesh */
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Location, Rotation"))
	static UE_API void DrawDebugStaticMeshBoundingBox(const FDebugDrawer& Drawer, const UStaticMesh* StaticMesh, const FVector& Location, const FRotator& Rotation, const FDrawDebugLineStyle& LineStyle = FDrawDebugLineStyle(), const bool bDepthTest = true);


public: // Text

	/** Get the number of line segments required to draw debug a string. */
	UFUNCTION(BlueprintPure, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "String, Settings"))
	...
	UFUNCTION(BlueprintPure, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Text, Settings"))
	static UE_API int32 DrawDebugTextSegmentNum(const FText& Text, const FDrawDebugStringSettings& Settings = FDrawDebugStringSettings());

	/** Get the number of line segments required to draw debug a name. */
	UFUNCTION(BlueprintPure, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Name, Settings"))
	static UE_API int32 DrawDebugNameSegmentNum(const FName& Name, const FDrawDebugStringSettings& Settings = FDrawDebugStringSettings());
	...
	UFUNCTION(BlueprintPure, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "String, Settings"))
	static UE_API FVector DrawDebugStringCenteringOffset(const FString& String, const FDrawDebugStringSettings& Settings = FDrawDebugStringSettings());
	static UE_API FVector DrawDebugStringViewCenteringOffset(const FStringView String, const FDrawDebugStringSettings& Settings = FDrawDebugStringSettings());

	/** Get the local offset required to center a draw debug text. */
	UFUNCTION(BlueprintPure, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Text, Settings"))
	static UE_API FVector DrawDebugTextCenteringOffset(const FText& Text, const FDrawDebugStringSettings& Settings = FDrawDebugStringSettings());

	/** Get the local offset required to center a draw debug name. */
	UFUNCTION(BlueprintPure, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Name, Settings"))
	static UE_API FVector DrawDebugNameCenteringOffset(const FName& Name, const FDrawDebugStringSettings& Settings = FDrawDebugStringSettings());
	...
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Names, Location, Rotation, LineStyle, Settings"))
	static UE_API void DrawDebugNames(const FDebugDrawer& Drawer, const TArray<FName>& Names, const FVector& Location, const FRotator& Rotation, const FString& Separator = TEXT(", "), const FDrawDebugLineStyle& LineStyle = FDrawDebugLineStyle(), const bool bDepthTest = true, const FDrawDebugStringSettings& Settings = FDrawDebugStringSettings());
	static UE_API void DrawDebugNamesArrayView(const FDebugDrawer& Drawer, const TArrayView<const FName> Names, const FVector& Location, const FRotator& Rotation, const FStringView Separator = TEXT(", "), const FDrawDebugLineStyle& LineStyle = FDrawDebugLineStyle(), const bool bDepthTest = true, const FDrawDebugStringSettings& Settings = FDrawDebugStringSettings());
...
public: // Graphs
	...
	UFUNCTION(BlueprintCallable, Category = "Draw Debug Library", meta = (DevelopmentOnly, AutoCreateRefTerm = "Location, Rotation, TextLineStyle, AxesSettings"))
	static UE_API void DrawDebugGraphAxesLabels(
		const FDebugDrawer& Drawer,
		const FVector& Location,
		const FRotator& Rotation,
		const float XaxisLength = 100.0f,
