...
void UUAFGraphNodeTemplate::HandleVariableDropped_Implementation(UAnimNextController* Controller, URigVMUnitNode* Node, FAnimNextVariableReference Variable) const
{
}
...
{
	UAnimNextTraitStackUnitNode* TraitStackNode = Cast<UAnimNextTraitStackUnitNode>(Controller->AddUnitNodeOfClass(FRigUnit_AnimNextTraitStack::StaticStruct()->GetPathName(), UAnimNextTraitStackUnitNode::StaticClass()->GetPathName(), FRigVMStruct::ExecuteName, InLocation, GetName(), true, true));
