...
class UUAFAnimGraph_EditorData;
...
private:
	...
	friend UUAFAnimGraph_EditorData;
	...
	void HandleAssetRenamed(UAnimNextController* InController, const FAssetData& InAssetData, const FString& InOldName);
