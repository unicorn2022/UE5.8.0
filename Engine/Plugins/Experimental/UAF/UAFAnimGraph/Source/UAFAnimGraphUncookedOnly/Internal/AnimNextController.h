...
public:
	...
	// Upgrade a trait if it needs to be
	UAFANIMGRAPHUNCOOKEDONLY_API bool UpgradeTraitByName(FName InNodeName, FName InTraitInstanceName, bool bSetupUndoRedo = true, bool bPrintPythonCommand = false);
