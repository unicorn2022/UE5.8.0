...
const ITraitInterface* FTraitInterfaceRegistry::Find(FTraitInterfaceUID TraitInterfaceUID) const
{
	...
	{
		UE_LOGF(LogAnimation, Warning, "FTraitInterfaceRegistry::Find: Provided trait interface UID is invalid.");
		return nullptr;
	}
...
void FTraitInterfaceRegistry::Register(const TSharedPtr<ITraitInterface>& TraitInterface)
{
	...
	{
		UE_LOGF(LogAnimation, Warning, "FTraitInterfaceRegistry::Register: Could not register trait interface - Provided trait interface is invalid.");
		return;
	}
...
void FTraitInterfaceRegistry::Unregister(const TSharedPtr<ITraitInterface>& TraitInterface)
{
	if (TraitInterface == nullptr)
	{
		UE_LOGF(LogAnimation, Warning, "FTraitInterfaceRegistry::Unregister: Could not unregister trait interface - Provided trait interface is invalid.");
		return;
	}
