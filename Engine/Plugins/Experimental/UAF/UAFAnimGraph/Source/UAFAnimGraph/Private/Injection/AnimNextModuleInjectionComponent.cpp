...
void FAnimNextModuleInjectionComponent::OnBindToInstance()
{
...
void FAnimNextModuleInjectionComponent::OnReapplyInjection(const UE::UAF::FModuleTaskContext& InContext)
{
	...
	FAnimNextModuleInjectionComponent& Component = InContext.ModuleInstance.GetOrAddComponent<FAnimNextModuleInjectionComponent>();
