...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RigUnit_UAFRunAsset)

FRigUnit_UAFRunAsset_Execute()
{
	SCOPED_NAMED_EVENT(UAF_Run_Asset, FColor::Orange);
	...
	FDataHandle RefPoseDataHandle = OutputPoseComponent.GetRefPose().ReferencePose;
	...
	EvaluateGraph(EvaluateGraphContext, GraphPose);
