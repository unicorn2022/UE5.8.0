...
#define TRAIT_LATENT_PROPERTIES_ENUMERATOR(GeneratorMacro) \
	...
	GeneratorMacro(ModifyCurveParameters) \
...
struct FModifyCurveTask : public FAnimNextEvaluationTask
{
	...
	static FModifyCurveTask Make(float Alpha, EAnimNext_ModifyCurveApplyMode ApplyMode, TConstArrayView<FModifyCurveParameters> CurveParameters);
...
private:
	...
	float Alpha = 1.0f;
	EAnimNext_ModifyCurveApplyMode ApplyMode = EAnimNext_ModifyCurveApplyMode::Add;
	TArray<FModifyCurveParameters, TInlineAllocator<8>> ModifyCurveParameters;
};
