...
namespace UE::UAF
{
	...
	private:
		...
		bool Inject(FInjectionRequestArgs&& InRequestArgs, FInjectionLifetimeEvents&& InLifetimeEvents, UObject* InHost, FUAFWeakSystemReference InReference);
		...
		FUAFWeakSystemReference Reference;
