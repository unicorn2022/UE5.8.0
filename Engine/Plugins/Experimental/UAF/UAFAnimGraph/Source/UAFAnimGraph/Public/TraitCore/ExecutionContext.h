...
namespace UE::UAF
{
	...
	struct FExecutionContext
	{
		...
		// Returns the skeletal mesh component associated to the graph execution, if any
		...
		UE_API void Log(ELogVerbosity::Type Verbosity, const FString& Message, const FString& TraitName) const;
	...
	template<class ComponentType>
	ComponentType& FExecutionContext::GetOrAddComponent() const
	{
		...
		return RootGraphInstance->GetOrAddComponent<ComponentType>();
	}
