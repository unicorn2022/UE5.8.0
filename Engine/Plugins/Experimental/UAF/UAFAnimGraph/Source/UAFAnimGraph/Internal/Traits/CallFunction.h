...
/** Struct used to help call / pick functions across UAF */
USTRUCT(meta = (DisplayName = "UAF Function"))
struct FUAFCallFunctionInfo 
{
	GENERATED_BODY()

#if WITH_EDITORONLY_DATA
	UPROPERTY(VisibleAnywhere, Category = "Call Function", meta = (PinHiddenByDefault, Hidden))
	FRigVMGraphFunctionHeader FunctionHeader;
#endif

	/** The function to call */
	UPROPERTY(EditAnywhere, Category = "Call Function", meta = (PinHiddenByDefault, Hidden))
	FName Function;
...
/** A trait that calls a RigVM function at the specified update point */
USTRUCT(meta = (DisplayName = "Call RigVM Function", AllowDuplicates = "true"))
struct FAnimNextCallFunctionSharedData : public FAnimNextTraitSharedData
{
	GENERATED_BODY()

	/** @TODO: Replace these properties with FUAFCallFunctionInfo once we determine UAF deprecation path */
