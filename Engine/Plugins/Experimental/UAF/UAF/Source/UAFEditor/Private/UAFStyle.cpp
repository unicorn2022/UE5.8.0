...
void FUAFStyle::SetClassIcons()
{
	...
	Set("ClassIcon.UAFSharedVariables", new IMAGE_PLUGIN_BRUSH_SVG("Icons/Archive_16.svg", Icon16x16));
	Set("ClassIcon.UAFSystem", new IMAGE_BRUSH_SVG("Starship/Common/Modules", Icon16x16 ));
	Set("ClassIcon.UAFAnimGraph", new IMAGE_BRUSH_SVG("Starship/Blueprints/icon_BlueprintEditor_EventGraph", Icon16x16));
...
void FUAFStyle::SetSetBindingStyles()
{
	const FVector2D Icon16x16(16.0f, 16.0f);

	Set("SetBindingEditorCommands.UnbindSelection", new CORE_IMAGE_BRUSH_SVG("Starship/Common/Unlinked", Icon16x16));
	Set("SetBindingEditorCommands.SelectWithChildren", new IMAGE_PLUGIN_BRUSH_SVG("Icons/SelectAll_16.svg", Icon16x16));
}

void FUAFStyle::SetBlendProfileStyles()
{
	const FVector2D Icon16x16(16.0f, 16.0f);

	Set("BlendProfiles.TimeProfile", new IMAGE_BRUSH_SVG("Starship/Common/Realtime", Icon16x16));
	Set("BlendProfiles.WeightProfile", new FSlateVectorImageBrush(InResources("Icons/Weight_16.svg"),Icon16x16));
}
