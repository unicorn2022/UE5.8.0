...
private:
	...
	virtual void EnableAssetWizard() override;
	virtual void DisableAssetWizard() override;
...
private:
	...
	TSharedPtr<FUAFAssetDataPropertyIdentifier> UAFAssetDataPropertyIdentifier;

	FTopLevelAssetPath UAFRigVMAssetTopLevelAssetPath;
	FTopLevelAssetPath SystemTopLevelAssetPath;
	FTopLevelAssetPath SharedVariablesTopLevelAssetPath;
	
	FOutOfDateAssetCompilation PIE_UAFCompilationHandler;
