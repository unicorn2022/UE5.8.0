...
namespace UE::UAF::Editor
{
	...
	{
		UUAFSystem* System = Cast<UUAFSystem>(InViewportContext.OutlinerObject);
		...
		const auto AddActor = [&](USkeletalMesh* InSkeletalMesh)
			{
				...
				UAFComponent->SetAssetFromObject(System);
	...
	void FSystemViewportController::OnExit(FAdvancedPreviewScene* PreviewScene)
	{
