...
struct FUtils
{
	...
	static UAFEDITOR_API void GetAllEntryNames(const UUAFRigVMAssetEditorData* InEditorData, TSet<FName>& OutNames);
	...
	static UAFEDITOR_API bool IsValidParameterNameForEntry(const UAnimNextVariableEntry* Entry, const FText& InNewName, FText& OutErrorText);
