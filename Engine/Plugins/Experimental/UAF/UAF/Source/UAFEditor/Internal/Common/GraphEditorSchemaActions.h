...
struct FAnimNextSchemaAction_Variable : public FAnimNextSchemaAction
{
	...
	UE_API void SetVariableAccessorChoice(EVariableAccessorChoice InVariableAccessorChoice, bool bUpdateSearchData = false);
...
struct FAnimNextSchemaAction_Function : public FAnimNextSchemaAction
{
	...
	FAnimNextSchemaAction_Function(const URigVMLibraryNode* InFunctionLibraryNode);
