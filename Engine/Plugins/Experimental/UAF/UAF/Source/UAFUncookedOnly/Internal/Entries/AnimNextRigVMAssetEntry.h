...
class UUAFRigVMAssetEntry : public UObject
{
	GENERATED_BODY()
public:
	// Binds delegates to owning editor data
	UE_API virtual void Initialize(UUAFRigVMAssetEditorData* InEditorData);
	...
	virtual FName GetEntryName() const PURE_VIRTUAL(UUAFRigVMAssetEntry::GetEntryName, return NAME_None;)
