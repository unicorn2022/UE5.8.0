...
FGuid FAnimNextProgrammaticVariable::GetGuid() const
{
	// [TODO] this assumes Variable.Name being unique yet consistent across compilations
	return FGuid::NewDeterministicGuid(Name.ToString(), FCrc::StrCrc32<TCHAR>(TEXT("ProgrammaticVariableGUID")));
}
