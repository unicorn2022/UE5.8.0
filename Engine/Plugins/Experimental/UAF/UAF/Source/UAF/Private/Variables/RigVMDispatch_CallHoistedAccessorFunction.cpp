...
void FRigVMDispatch_CallHoistedAccessorFunctionNative::Execute(FRigVMExtendedExecuteContext& InContext, FRigVMMemoryHandleArray Handles, FRigVMPredicateBranchArray RigVMBranches)
{
	...
	if (!ensureMsgf(TargetProperty->GetClass() == ReturnValueProperty->GetClass(), TEXT("FRigVMDispatch_CallHoistedAccessorFunctionNative::Execute - Type mismatch: %s, %s")
		, *TargetProperty->GetClass()->GetFName().ToString()
		, *ReturnValueProperty->GetClass()->GetFName().ToString()))
	{
		return;
	}
...
void FRigVMDispatch_CallHoistedAccessorFunctionScript::Execute(FRigVMExtendedExecuteContext& InContext, FRigVMMemoryHandleArray Handles, FRigVMPredicateBranchArray RigVMBranches)
{
	...
	if (!ensureMsgf(TargetProperty->GetClass() == ReturnValueProperty->GetClass(), TEXT("FRigVMDispatch_CallHoistedAccessorFunctionScript::Execute - Type mismatch: %s, %s")
		, *TargetProperty->GetClass()->GetFName().ToString()
		, *ReturnValueProperty->GetClass()->GetFName().ToString()))
	{
		return;
