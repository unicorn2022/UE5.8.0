...
void FRigVMTrait_ModuleEventDependency_ActorComponentClassPrimaryTickFunction::OnAddDependency(const UE::UAF::FModuleDependencyContext& InContext) const
{
	...
	{
		UE_LOGF(LogAnimation, Warning, "FRigVMTrait_ModuleEventDependency_ActorComponentClassPrimaryTickFunction: Could not add dependency for component of class [%ls] - UAF Component is not valid.", *GetNameSafe(ComponentClass));
		return;
	}
	...
	if(Actor == nullptr)
	{
		UE_LOGF(LogAnimation, Warning, "FRigVMTrait_ModuleEventDependency_ActorComponentClassPrimaryTickFunction: Could not add dependency for component of class [%ls] - UAF Component has no valid owner.", *GetNameSafe(ComponentClass));
		return;
	}
	...
	{
		UE_LOGF(LogAnimation, Log, "FRigVMTrait_ModuleEventDependency_ActorComponentClassPrimaryTickFunction: Could not add dependency for component of class [%ls] - [%ls] does not have that component.",
			*GetNameSafe(ComponentClass), *Actor->GetName());
		return;
	}
...
void FRigVMTrait_ModuleEventDependency_ActorComponentClassPrimaryTickFunction::OnRemoveDependency(const UE::UAF::FModuleDependencyContext& InContext) const
{
	...
	if(AnimNextComponent == nullptr)
	{
		UE_LOGF(LogAnimation, Warning, "FRigVMTrait_ModuleEventDependency_ActorComponentClassPrimaryTickFunction: Could not remove dependency for component of class [%ls] - UAF Component is not valid.", *GetNameSafe(ComponentClass));
		return;
	}
	...
	if(Actor == nullptr)
	{
		UE_LOGF(LogAnimation, Warning, "FRigVMTrait_ModuleEventDependency_ActorComponentClassPrimaryTickFunction: Could not remove dependency for component of class [%ls] - UAF Component has no valid owner.", *GetNameSafe(ComponentClass));
		return;
	}
	...
	if(TargetComponent == nullptr)
	{
		UE_LOGF(LogAnimation, Log, "FRigVMTrait_ModuleEventDependency_ActorComponentClassPrimaryTickFunction: Could not remove dependency for component of class [%ls] - [%ls] does not have that component.",
			*GetNameSafe(ComponentClass), *Actor->GetName());
		return;
	}
