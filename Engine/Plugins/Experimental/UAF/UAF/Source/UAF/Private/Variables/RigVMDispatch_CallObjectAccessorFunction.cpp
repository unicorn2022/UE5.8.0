...
void FRigVMDispatch_CallObjectAccessorFunctionNative::Execute(FRigVMExtendedExecuteContext& InContext, FRigVMMemoryHandleArray Handles, FRigVMPredicateBranchArray RigVMBranches)
{
	...
	if (!ensureMsgf(TargetProperty->GetClass() == ReturnValueProperty->GetClass(), TEXT("FRigVMDispatch_CallObjectAccessorFunctionNative::Execute - Type mismatch: %s, %s")
...
void FRigVMDispatch_CallObjectAccessorFunctionScript::Execute(FRigVMExtendedExecuteContext& InContext, FRigVMMemoryHandleArray Handles, FRigVMPredicateBranchArray RigVMBranches)
{
	...
	if (!ensureMsgf(TargetProperty->GetClass() == ReturnValueProperty->GetClass(), TEXT("FRigVMDispatch_CallObjectAccessorFunctionScript::Execute - Type mismatch: %s, %s")
		, *TargetProperty->GetClass()->GetFName().ToString()
		, *ReturnValueProperty->GetClass()->GetFName().ToString()))
	{
		return;
