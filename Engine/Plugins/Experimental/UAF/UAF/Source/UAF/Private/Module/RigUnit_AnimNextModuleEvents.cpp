...
UE::UAF::FTickFunctionBindingFunction FRigUnit_AnimNextExecuteBindings_GT::GetBindingFunction() const
{
...
UE::UAF::FTickFunctionBindingFunction FRigUnit_AnimNextExecuteBindings_WT::GetBindingFunction() const
{
	return [](const UE::UAF::FTickFunctionBindingContext& InContext, FTickFunction& InTickFunction)
	{
		const bool bHighPriority = UE::UAF::CVars::CVarHighPriorityAnimNextExecuteBindingsTick.GetValueOnGameThread();
...
UE::UAF::FTickFunctionBindingFunction FRigUnit_AnimNextUserEvent::GetBindingFunction() const
{
