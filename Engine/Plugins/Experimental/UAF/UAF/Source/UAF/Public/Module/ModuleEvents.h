...
struct FAnimNextModule_ActionEvent : public FAnimNextTraitEvent
{
	...
	FAnimNextModule_ActionEvent() = default;

	FAnimNextModule_ActionEvent(TUniqueFunction<void(void)>&& InActionFunction)
		: ActionFunction(MoveTemp(InActionFunction))
	{}
