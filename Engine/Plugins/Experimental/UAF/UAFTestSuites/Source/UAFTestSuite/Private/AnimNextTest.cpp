...
bool FDataRegistryTransformsTest::RunTest(const FString& InParameters)
{
	...
	AddInfo(FString::Printf(TEXT("Average AoS Duration: %lld nanosecs."), AverageAoS));
	AddInfo(FString::Printf(TEXT("Average SoA Duration: %lld nanosecs."), AverageSoA));
