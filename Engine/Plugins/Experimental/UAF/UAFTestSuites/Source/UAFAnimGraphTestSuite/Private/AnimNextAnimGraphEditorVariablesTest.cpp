...
bool FEditor_AnimGraph_Variables::RunTest(const FString& InParameters)
{
	...
	{
		{ UUAFAnimGraphFactory::StaticClass(), UUAFAnimGraph::StaticClass() },
	};
...
bool FEditor_AnimGraph_Graphs::RunTest(const FString& InParameters)
{
	...
	{
		{ UUAFAnimGraphFactory::StaticClass(), UUAFAnimGraph::StaticClass(), false, false, true, true },
	};
	...
	for(const FTestSettings& TestSetting : TestSettings)
	{
		...
		{
			UUAFAnimGraph_EditorData* AnimationGraphEditorData = CastChecked<UUAFAnimGraph_EditorData>(EditorData);
...
bool FEditor_AnimGraph_Variables_Python::RunTest(const FString& InParameters)
{
	...
	const TCHAR* Script = TEXT(
		...
		"animation_graph = unreal.AssetTools.create_asset(asset_tools, asset_name = \"TestAnimGraph\", package_path = \"/Game/\", asset_class = unreal.UAFAnimGraph, factory = unreal.UAFAnimGraphFactory())\n"
