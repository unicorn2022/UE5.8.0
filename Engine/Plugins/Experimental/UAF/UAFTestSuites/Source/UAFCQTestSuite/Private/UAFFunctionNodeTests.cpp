...
{
	UUAFRigVMAsset* AnimNextAsset;
	UAssetEditorSubsystem* AssetEditorSubsystem;
	UUAFRigVMAssetEditorData* EditorData;
	...
	{		
		TestCommandBuilder
			.Do(TEXT("Create AnimNext Animation Graph Asset"), [&]()
			{
				...
				UObject* factoryObject = UAFTestsUtilities::CreateFactoryObject(NewObject<UUAFAnimGraphFactory>(GetTransientPackage(), AnimNextAnimGraphFactoryClass.Get()), UUAFAnimGraph::StaticClass(), "NewAnimNextAnimationGraph");
	...
	{		
		TestCommandBuilder
			...
			{
				const TSubclassOf<UUAFSystemFactory> AnimNextModuleFactoryClass = UUAFSystemFactory::StaticClass();
				UObject* factoryObject = UAFTestsUtilities::CreateFactoryObject(NewObject<UUAFSystemFactory>(GetTransientPackage(), AnimNextModuleFactoryClass.Get()), UUAFSystem::StaticClass(), "NewAnimNextModule");
