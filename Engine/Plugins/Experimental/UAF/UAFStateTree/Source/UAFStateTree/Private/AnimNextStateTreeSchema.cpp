...
UStateTreeAnimNextSchema::UStateTreeAnimNextSchema() : ContextDataDescs(
	{{ AnimStateTreeExecutionContextName, FUAFStateTreeContext::StaticStruct(), FGuid(0xDFB93B7F, 0xEDBE4906, 0x851C66B2, 0x7585FA21) }})
{
}
...
bool UStateTreeAnimNextSchema::IsStructAllowed(const UScriptStruct* InScriptStruct) const
{
	...
	|| InScriptStruct->IsChildOf(UE::UAF::StateTree::FUAFVariableConditionBase::StaticStruct())
...
{
	return InStruct.IsChildOf<FUAFStateTreeContext>();
}
