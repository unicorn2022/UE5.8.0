...
public:
	...
	// When using animation blueprints, can be used to search for a specific pose history node by tag.
	// This allow you to have a pose history node pre-sequencer for blending into sequences,
	// but still capture a separate pose history afterwards for blending out.
	UPROPERTY(EditAnywhere, category = "Stitch")
	FName OverridePoseHistoryTag;
