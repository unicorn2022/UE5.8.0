...
class FMeshTerrainModeActionCommands : public TCommands<FMeshTerrainModeActionCommands>
{
public:
	FMeshTerrainModeActionCommands();
	...
	static void RegisterCommandBindings(TSharedPtr<FUICommandList> UICommandList, TFunction<void(EMeshTerrainModeActionCommands)> OnCommandExecuted);
 ...
 */
class FMeshTerrainModeToolActionCommands : public TInteractiveToolCommands<FMeshTerrainModeToolActionCommands>
{
public:
	FMeshTerrainModeToolActionCommands();
