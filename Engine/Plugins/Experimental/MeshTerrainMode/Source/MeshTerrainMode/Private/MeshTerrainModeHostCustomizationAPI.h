...
#include "MeshTerrainModeHostCustomizationAPI.generated.h"

class UInteractiveToolsContext;

namespace UE::MeshTerrain
{
class FMeshTerrainModeToolkit;
...
class UMeshTerrainModeHostCustomizationAPI : public UObject, public IToolHostCustomizationAPI
{
	GENERATED_BODY()
...
public:
	...
	static UMeshTerrainModeHostCustomizationAPI* Register(UInteractiveToolsContext* ToolsContext, 
		TSharedRef<FMeshTerrainModeToolkit> Toolkit);
...
protected:
	TWeakPtr<FMeshTerrainModeToolkit> Toolkit;
};
}