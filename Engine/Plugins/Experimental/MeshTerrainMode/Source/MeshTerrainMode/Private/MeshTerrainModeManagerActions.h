 ...
 */
class FMeshTerrainModeManagerCommands : public TCommands<FMeshTerrainModeManagerCommands>
{
public:
	FMeshTerrainModeManagerCommands();
...
public:
	...
	TSharedPtr<FUICommandInfo> BeginSculptMeshMoveBrushTool;
	TSharedPtr<FUICommandInfo> BeginSculptMeshPullKelvinBrushTool;
	TSharedPtr<FUICommandInfo> BeginSculptMeshPullSharpKelvinBrushTool;
	TSharedPtr<FUICommandInfo> BeginSculptMeshSmoothBrushTool;
	TSharedPtr<FUICommandInfo> BeginSculptMeshSmoothFillBrushTool;
	TSharedPtr<FUICommandInfo> BeginSculptMeshOffsetBrushTool;
	TSharedPtr<FUICommandInfo> BeginSculptMeshSculptViewBrushTool;
	TSharedPtr<FUICommandInfo> BeginSculptMeshSculptMaxBrushTool;
	TSharedPtr<FUICommandInfo> BeginSculptMeshInflateBrushTool;
	TSharedPtr<FUICommandInfo> BeginSculptMeshScaleKelvinBrushTool;
	TSharedPtr<FUICommandInfo> BeginSculptMeshPinchBrushTool;
	TSharedPtr<FUICommandInfo> BeginSculptMeshTwistKelvinBrushTool;
	TSharedPtr<FUICommandInfo> BeginSculptMeshFlattenBrushTool;
	TSharedPtr<FUICommandInfo> BeginSculptMeshPlaneBrushTool;
	TSharedPtr<FUICommandInfo> BeginSculptMeshPlaneViewAlignedBrushTool;
	TSharedPtr<FUICommandInfo> BeginSculptMeshFixedPlaneBrushTool;
	TSharedPtr<FUICommandInfo> BeginSculptMeshEraseLayerTool;
	...
	// MegaMesh tools
	TSharedPtr<FUICommandInfo> BeginConvertMegaMeshTool;
	TSharedPtr<FUICommandInfo> BeginSplitMegaMeshTool;
	TSharedPtr<FUICommandInfo> BeginMergeMegaMeshTool;
	TSharedPtr<FUICommandInfo> BeginResectionMeshTool;
	TSharedPtr<FUICommandInfo> BeginStitchMegaMeshTool;
	TSharedPtr<FUICommandInfo> BeginHeightmapImport;
	TSharedPtr<FUICommandInfo> BeginHeightSculptTool;
	TSharedPtr<FUICommandInfo> BeginExpandMegaMeshTool;

	TSharedPtr<FUICommandInfo> BeginHeightSculptBrushTool;
	TSharedPtr<FUICommandInfo> BeginHeightSmoothBrushTool;
	TSharedPtr<FUICommandInfo> BeginHeightFlattenBrushTool;
	TSharedPtr<FUICommandInfo> BeginSlopeErodeBrushTool;

	TSharedPtr<FUICommandInfo> BeginCreateMegaMeshRectangleTool;
	TSharedPtr<FUICommandInfo> BeginAddModifierTool;
	TSharedPtr<FUICommandInfo> BeginAppendModifierTool;

	TSharedPtr<FUICommandInfo> BeginAddRemeshModifierTool;
	TSharedPtr<FUICommandInfo> BeginAddPatchModifierTool;
	TSharedPtr<FUICommandInfo> BeginAddProjectModifierTool;
	TSharedPtr<FUICommandInfo> BeginAddInstancedPatchModifierTool;
	TSharedPtr<FUICommandInfo> BeginAddTexturePatchModifierTool;
	TSharedPtr<FUICommandInfo> BeginAddSplineModifierTool;
	TSharedPtr<FUICommandInfo> BeginAddMeshLayerModifierTool;
	TSharedPtr<FUICommandInfo> BeginAddNoiseModifierTool;
	TSharedPtr<FUICommandInfo> BeginAddBooleanModifierTool;
	TSharedPtr<FUICommandInfo> BeginAddLatticeModifierTool;
	TSharedPtr<FUICommandInfo> BeginAddSplineRemeshModifierTool;

	TSharedPtr<FUICommandInfo> RelaunchLastTool;

	// Submodes
	TSharedPtr<FUICommandInfo> EnterShapesSubmode;
	TSharedPtr<FUICommandInfo> EnterCreateSubmode;
	TSharedPtr<FUICommandInfo> EnterEditSubmode;
	TSharedPtr<FUICommandInfo> EnterSculptSubmode;
	TSharedPtr<FUICommandInfo> EnterBakeSubmode;
	TSharedPtr<FUICommandInfo> EnterPaintSubmode;
	TSharedPtr<FUICommandInfo> EnterModifiersSubmode;
