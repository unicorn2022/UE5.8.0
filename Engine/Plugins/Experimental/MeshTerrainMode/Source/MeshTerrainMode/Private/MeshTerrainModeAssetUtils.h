 ...
 */
FString GetNewAssetPathName(const FString& BaseName, const UWorld* TargetWorld, FString SuggestedFolder);
 ...
 */
FString GetGlobalAssetRootPath();
 ...
 */
void OnNewAssetCreated(UObject* Asset);
 ...
 */
bool AutoSaveAsset(UObject* Asset);
