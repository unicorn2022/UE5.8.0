...
private: // Compiled Data
	...
	UPROPERTY(BlueprintReadOnly, Category = Conversation, meta = (AllowPrivateAccess = "true"))
	TMap<FGuid, TObjectPtr<UConversationNode>> ReachableNodeMap;

	// Compiled: Entry points
	UPROPERTY(AssetRegistrySearchable, BlueprintReadOnly, Category = Conversation, meta = (AllowPrivateAccess = "true"))
...
private:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=Conversation, meta = (AllowPrivateAccess = "true"))
