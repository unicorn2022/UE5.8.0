...
ACameraRig_Rail* UVPCameraBlueprintLibrary::SpawnDollyTrackFromPoints(UObject* WorldContextObject, const TArray<FTransform>& Points, ESplinePointType::Type InterpType)
{
	...
	if (World == nullptr)
	{
		UE_LOGF(LogVPUtilities, Warning, "UVPCameraBlueprintLibrary::SpawnDollyTrackFromPoints - Unable to get world");
		return nullptr;
	}

	if (Points.Num() <= 1)
	{
		UE_LOGF(LogVPUtilities, Warning, "UVPCameraBlueprintLibrary::SpawnDollyTrackFromPoints - Too few points");
		return nullptr;
	}
...
ACameraRig_Rail* UVPCameraBlueprintLibrary::SpawnCameraRigFromPoints(UObject* WorldContextObject, const FTransform& RigTransform, const TArray<FVector>& Points, const FVPCameraRigSpawnParams& Params)
{
	...
	if (World == nullptr)
	{
		UE_LOGF(LogVPUtilities, Warning, "UVPCameraBlueprintLibrary::SpawnCameraRigFromPoints - Unable to get world");
		return CameraRig;
	}

	if (Points.Num() <= 1)
	{
		UE_LOGF(LogVPUtilities, Warning, "UVPCameraBlueprintLibrary::SpawnCameraRigFromPoints - Too few points");
		return CameraRig;
	}
	...
	{
		UE_LOGF(LogVPUtilities, Warning, "UVPCameraBlueprintLibrary::SpawnCameraRigFromPoints - Failed to spawn camera rig");
		return CameraRig;
	}
	...
	{
		UE_LOGF(LogVPUtilities, Warning, "UVPCameraBlueprintLibrary::SpawnCameraRigFromPoints - Failed to get Spline");
		return CameraRig;
	}
...
ACameraRig_Rail* UVPCameraBlueprintLibrary::SpawnCameraRigFromSelectedActors(UObject* WorldContextObject, const FTransform& RigTransform, const FVPCameraRigSpawnParams& Params)
{
	...
	UE_LOGF(LogVPUtilities, Warning, "UVPCameraBlueprintLibrary::SpawnCameraRigFromSelectedActors - Only callable from editor");
	return nullptr;
}
