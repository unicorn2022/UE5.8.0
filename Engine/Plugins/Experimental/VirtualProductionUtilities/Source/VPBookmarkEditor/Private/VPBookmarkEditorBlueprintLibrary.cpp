...
bool UVPBookmarkEditorBlueprintLibrary::JumpToBookmarkInLevelEditor(const UVPBookmark* Bookmark)
{
	...
	{
		UE_LOGF(LogVPBookmarkEditor, Warning, "VPBookmarkEditorLibrary::ActivateBookmarkInLevelEditor - Invalid component");
	}
...
bool UVPBookmarkEditorBlueprintLibrary::JumpToBookmarkInLevelEditorByIndex(const int32 BookmarkIndex)
{
	...
	if (Client == nullptr)
	{
		UE_LOGF(LogVPBookmarkEditor, Warning, "VPBookmarkEditorLibrary::ActivateBookmarkInLevelEditorByIndex - Unable to get viewport client");
		return false;
	}
	...
	if (World == nullptr)
	{
		UE_LOGF(LogVPBookmarkEditor, Warning, "VPBookmarkEditorLibrary::ActivateBookmarkInLevelEditorByIndex - Unable to get world");
		return false;
	}
	...
	{
		UE_LOGF(LogVPBookmarkEditor, Warning, "VPBookmarkEditorLibrary::ActivateBookmarkInLevelEditorByIndex - Unable to get world settings");
		return false;
	}
	...
	{
		UE_LOGF(LogVPBookmarkEditor, Warning, "VPBookmarkEditorLibrary::ActivateBookmarkInLevelEditorByIndex - Invalid bookmark index %d", BookmarkIndex);
		return false;
	}
...
AActor* UVPBookmarkEditorBlueprintLibrary::AddBookmarkAtCurrentLevelEditorPosition(const TSubclassOf<AActor> ActorClass, const FVPBookmarkCreationContext CreationContext, const FVector Offset, const bool bFlattenRotation)
{
	...
	{
		UE_LOGF(LogVPBookmarkEditor, Warning, "VPBookmarkEditorLibrary::AddBookmarkAtCurrentLevelEditorPosition - Invalid actor class");
		return nullptr;
	}
	...
	if (Client == nullptr)
	{
		UE_LOGF(LogVPBookmarkEditor, Warning, "VPBookmarkEditorLibrary::AddBookmarkAtCurrentLevelEditorPosition - Unable to get viewport client");
		return nullptr;
	}
	...
	if (World == nullptr)
	{
		UE_LOGF(LogVPBookmarkEditor, Warning, "VPBookmarkEditorLibrary::AddBookmarkAtCurrentLevelEditorPosition - Unable to get world");
		return nullptr;
	}
	...
	if (WorldSettings == nullptr)
	{
		UE_LOGF(LogVPBookmarkEditor, Warning, "VPBookmarkEditorLibrary::AddBookmarkAtCurrentLevelEditorPosition - Unable to get world settings");
		return nullptr;
	}
