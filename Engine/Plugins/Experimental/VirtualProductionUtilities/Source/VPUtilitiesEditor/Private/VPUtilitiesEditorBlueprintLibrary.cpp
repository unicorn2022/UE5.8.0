...
AVPEditorTickableActorBase* UVPUtilitiesEditorBlueprintLibrary::SpawnVPEditorTickableActor(UObject* ContextObject, const TSubclassOf<AVPEditorTickableActorBase> ActorClass, const FVector Location, const FRotator Rotation)
{
	...
	{
		UE_LOGF(LogVPUtilitiesEditor, Warning, "VPUtilitiesEditorBlueprintLibrary::SpawnVPEditorTickableActor - The ActorClass is invalid");
		return nullptr;
	}
	...
	if (World == nullptr)
	{
		UE_LOGF(LogVPUtilitiesEditor, Warning, "VPUtilitiesEditorBlueprintLibrary::SpawnVPEditorTickableActor - The ContextObject is invalid.");
		return nullptr;
	}
...
AVPTransientEditorTickableActorBase* UVPUtilitiesEditorBlueprintLibrary::SpawnVPTransientEditorTickableActor(UObject* ContextObject, const TSubclassOf<AVPTransientEditorTickableActorBase> ActorClass, const FVector Location, const FRotator Rotation)
{
	if (ActorClass.Get() == nullptr)
	{
		UE_LOGF(LogVPUtilitiesEditor, Warning, "VPUtilitiesEditorBlueprintLibrary::SpawnVPTransientEditorTickableActor - The ActorClass is invalid");
		return nullptr;
	}
	...
	if (World == nullptr)
	{
		UE_LOGF(LogVPUtilitiesEditor, Warning, "VPUtilitiesEditorBlueprintLibrary::SpawnVPTransientEditorTickableActor - The ContextObject is invalid.");
		return nullptr;
	}
...
UTexture* UVPUtilitiesEditorBlueprintLibrary::ImportSnapshotTexture(FString FileName, FString SubFolderName, FString AbsolutePathPackage)
{
	...
	{
		UE_LOGF(LogVPUtilitiesEditor, Warning, "Unable to find Texture file %ls", *FileName);
	}
	else
	{
