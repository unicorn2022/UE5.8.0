...
#include "Customizations/PVColliderParamsCustomization.h"
#include "Customizations/PVGrowerSettingsCustomization.h"
#include "Customizations/PVImportStaticMeshParamsCustomization.h"
#include "Customizations/PVLoopDebugStepperCustomization.h"
#include "Customizations/PVTrunkTextureSetupSettingsCustomization.h"

#include "Helpers/PVUtilities.h"

#include "Nodes/PVGrowerSettings.h"
#include "Nodes/GrowerSettings/PVGrowerBaseSettings.h"
...
void FProceduralVegetationEditorModule::ShutdownModule()
{
	...
	if (UObjectInitialized() && !IsEngineExitRequested())
	{
		if (FPropertyEditorModule* PropertyEditor = FModuleManager::GetModulePtr<FPropertyEditorModule>("PropertyEditor"))
		{
			...
			PropertyEditor->UnregisterCustomClassLayout(UPVGrowerBaseSettings::StaticClass()->GetFName());
		}
	}
