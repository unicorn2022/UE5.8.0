...
public:
	...
	virtual TSubclassOf<UPCGBaseSubgraphSettings> GetSubgraphSettingsClass() const override;
...
protected:
	virtual void GetNativeElementActions(FGraphActionMenuBuilder& ActionMenuBuilder, const FPCGActionsFilter& ActionFilter) const override;
};
