...
void IGeometryCollectionEditorPlugin::StartupModule()
{
	...
	UE::Dataflow::Private::RegisterMedialSkeletonRenderableType();
	...
	FDataflowTemplateRegistry::Get().RegisterTemplateFolder(UGeometryCollection::StaticClass(),
		{ TEXT("/GeometryCollectionPlugin/DataflowTemplates"), FSlateIcon("GeometryCollectionEditorStyle", "ClassThumbnail.GeometryCollection") });

	DataflowMenusHandle = UE::DataflowAssetDefinitionHelpers::RegisterDataflowAssetMenus(UGeometryCollection::StaticClass());
}
