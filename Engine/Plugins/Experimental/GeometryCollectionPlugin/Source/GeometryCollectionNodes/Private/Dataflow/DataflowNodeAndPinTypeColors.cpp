...
namespace UE::Dataflow
{
	void RegisterGeometryCollectionNodesColors()
	{
		...
		DATAFLOW_NODE_REGISTER_CREATION_FACTORY_NODE_COLORS_BY_CATEGORY("Utilities", FLinearColor(0.387153f, 0.387153f, 0.387153f, 2.935552f), CDefaultNodeBodyTintColor);
