...
USTRUCT()
struct FDataflowMaterialFloatParameter
{
	GENERATED_BODY()
...
USTRUCT()
struct FDataflowMaterialVectorParameter
{
	GENERATED_BODY()
...
USTRUCT()
struct FDataflowMaterialTextureParameter
{
	GENERATED_BODY()
...
USTRUCT()
struct FDataflowMaterialParameters
{
	GENERATED_BODY()

public:
	UPROPERTY()
	TArray<FDataflowMaterialFloatParameter> FloatParameters;

	UPROPERTY()
	TArray<FDataflowMaterialVectorParameter> VectorParameters;

	UPROPERTY()
	TArray<FDataflowMaterialTextureParameter> TextureParameters;
};

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

/**
 * Add a material float parameter to a parameters object
 * Material parameters are used to create material instances
 */
USTRUCT(Meta = (MeshResizing, Experimental))
struct FMaterialInterfaceSetFloatParameterDataflowNode : public FDataflowNode
{
	GENERATED_USTRUCT_BODY()
	DATAFLOW_NODE_DEFINE_INTERNAL(FMaterialInterfaceSetFloatParameterDataflowNode, "SetMaterialFloatParameter", "Materials", "Instance Value")

public:
	FMaterialInterfaceSetFloatParameterDataflowNode(const UE::Dataflow::FNodeParameters& InParam, FGuid InGuid = FGuid::NewGuid());

private:

	UPROPERTY(meta = (DataflowInput, DataflowOutput, DataflowPassthrough = "MaterialParameters"))
	FDataflowMaterialParameters MaterialParameters;

	UPROPERTY(EditAnywhere, Category = "Parameter", meta = (DataflowInput))
	FDataflowStringTypes ParameterName;

	UPROPERTY(EditAnywhere, Category = "Parameter", meta = (DataflowInput))
	FDataflowNumericTypes ParameterValue;
...
/**
 * Add a material vector4 parameter to a parameters object
 * Material parameters are used to create material instances
 */
USTRUCT(Meta = (MeshResizing, Experimental))
struct FMaterialInterfaceSetVectorParameterDataflowNode : public FDataflowNode
{
	GENERATED_USTRUCT_BODY()
	DATAFLOW_NODE_DEFINE_INTERNAL(FMaterialInterfaceSetVectorParameterDataflowNode, "SetMaterialVectorParameter", "Materials", "Instance Value")

public:
	FMaterialInterfaceSetVectorParameterDataflowNode(const UE::Dataflow::FNodeParameters& InParam, FGuid InGuid = FGuid::NewGuid());
...
private:
	...
	UPROPERTY(EditAnywhere, Category = "Parameter", meta = (DataflowInput))
	FDataflowVectorTypes ParameterValue;
...
/**
 * Add a material texture parameter to a parameters object
 * Material parameters are used to create material instances
 */
USTRUCT(Meta = (MeshResizing, Experimental))
struct FMaterialInterfaceSetTexture2DParameterDataflowNode : public FDataflowNode
{
	GENERATED_USTRUCT_BODY()
	DATAFLOW_NODE_DEFINE_INTERNAL(FMaterialInterfaceSetTexture2DParameterDataflowNode, "SetMaterialTexture2DParameter", "Materials", "Instance Value")

public:
	FMaterialInterfaceSetTexture2DParameterDataflowNode(const UE::Dataflow::FNodeParameters& InParam, FGuid InGuid = FGuid::NewGuid());
...
private:
	...
	UPROPERTY(EditAnywhere, Category = "Parameter", meta = (DataflowInput))
	TObjectPtr<UTexture2D> ParameterValue;
...
/**
 * Make a material instance from another material 
 */
USTRUCT(Meta = (MeshResizing, Experimental))
struct FMaterialInterfaceTerminalDataflowNode : public FDataflowTerminalNode
{
	GENERATED_USTRUCT_BODY()
	DATAFLOW_NODE_DEFINE_INTERNAL(FMaterialInterfaceTerminalDataflowNode, "MaterialTerminal", "Terminal", "Instance Value Parameters")

public:
	FMaterialInterfaceTerminalDataflowNode(const UE::Dataflow::FNodeParameters& InParam, FGuid InGuid = FGuid::NewGuid());
...
private:
	...
	UPROPERTY(EditAnywhere, Category = "Parameters", meta = (DataflowInput))
	FDataflowMaterialParameters MaterialParameters;
