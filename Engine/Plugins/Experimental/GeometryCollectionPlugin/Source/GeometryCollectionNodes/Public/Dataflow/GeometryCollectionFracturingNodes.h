...
private:
	...
	float ClusterRadiusFractionMin = .1f;
	...
	float ClusterRadiusFractionMax = .2f;
...
public:
	...
	/** Whether to split the fractured mesh pieces into separate islands based on geometric connectivity after fracturing */
	UPROPERTY(EditAnywhere, Category = "Common Fracture|Split Islands");
	bool SplitIslands = true;

	/** Distance threshold for connecting spatially-close vertices before computing islands */
	UPROPERTY(EditAnywhere, Category = "Common Fracture|Split Islands", meta = (EditCondition = "SplitIslands", Units = "cm", ClampMin = "0.0"));
