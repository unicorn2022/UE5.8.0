...
public:
	...
	DECLARE_EVENT_OneParam(ISequencerFilterBar, FOnLayoutChanged, EFilterBarLayout /** InNewLayout */);
	...
	FOnLayoutChanged& OnLayoutChanged() { return LayoutChangedEvent; }
	FSimpleMulticastDelegate& OnActivationStateChanged() { return ActivationStateChangedEvent; }
	FOnVisibilityChanged& OnVisibilityChanged() { return VisibilityChangedEvent; }
	virtual FSimpleMulticastDelegate& OnRequestUpdate() override { return RequestUpdateEvent; }
	virtual FSimpleMulticastDelegate& OnTextFilterTextChanged() override { return TextFilterTextChangedEvent; }
	virtual FMuteStateChangedDelegate& OnMuteFiltersChanged() override { return MuteFiltersChangedEvent; }
	...
	bool ShouldShowFilterBarWidget() const;
	bool IsFilterBarVisible() const;
	void ToggleFilterBarVisibility();

	bool IsFilterBarLayout(const EFilterBarLayout InLayout) const;
	void SetToVerticalLayout();
	void SetToHorizontalLayout();
	void ToggleFilterBarLayout();
	...
	virtual bool DoesCommonFilterPass(const Sequencer::TViewModelPtr<Sequencer::FViewModel>& InViewModel, const FString& InFilterName) const override;
...
protected:
	...
	FOnLayoutChanged LayoutChangedEvent;
	FSimpleMulticastDelegate ActivationStateChangedEvent;
	FOnVisibilityChanged VisibilityChangedEvent;
	FSimpleMulticastDelegate RequestUpdateEvent;
	FSimpleMulticastDelegate TextFilterTextChangedEvent;
	FMuteStateChangedDelegate MuteFiltersChangedEvent;
