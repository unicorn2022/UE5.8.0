 ...
 * DEPRECATED 5.8 - use FSkeletalMeshToMeshDataflowNode_v2 instead
 */
USTRUCT(meta = (MeshResizing, Experimental, Deprecated = "5.8"))
 ...
 *
 */
USTRUCT(meta = (MeshResizing, Experimental, Icon = "Icons.SkeletalMesh"))
struct FSkeletalMeshToMeshDataflowNode_v2 final : public FDataflowNode
{
	GENERATED_USTRUCT_BODY()
	DATAFLOW_NODE_DEFINE_INTERNAL(FSkeletalMeshToMeshDataflowNode_v2, "SkeletalMeshToMesh", "Mesh|Utilities", "")
...
public:
	FSkeletalMeshToMeshDataflowNode_v2(const UE::Dataflow::FNodeParameters& InParam, FGuid InGuid = FGuid::NewGuid());
};
