...
private:
	...
	UPROPERTY(EditAnywhere, Category = "UV Unwrap", meta = (DataflowInput, DataflowOutput, DataflowPassthrough = "UVChannelIndex", DataflowUVChannel, ClampMin = 0, ClampMax = 7, UIMin = 0, UIMax = 7))
