...
DECLARE_CYCLE_STAT(TEXT("Buoyancy_Algorithms_FBuoyancyConvexShape_Initialize"), STAT_BuoyancyAlgorithms_FBuoyancyConvexShape_Initialize, STATGROUP_Buoyancy);
DECLARE_CYCLE_STAT(TEXT("Buoyancy_Algorithms_ComputeSubmergedVolumeAndForcesForShape_FindFaceVerticesBelowWater"), STAT_BuoyancyAlgorithms_ComputeSubmergedVolumeAndForcesForShape_FindFaceVerticesBelowWater, STATGROUP_Buoyancy);
