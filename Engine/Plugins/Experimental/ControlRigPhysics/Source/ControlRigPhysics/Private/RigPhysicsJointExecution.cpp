...
//======================================================================================================================
inline FRigPhysicsJointComponent* GetJoint(URigHierarchy* Hierarchy, const FRigComponentKey& Key)
{
...
//======================================================================================================================
FRigUnit_GetPhysicsJointExists_Execute()
{
	if (!ExecuteContext.Hierarchy)
	{
		return;
	}
	bExists = Cast<FRigPhysicsJointComponent>(
		ExecuteContext.Hierarchy->FindComponent(PhysicsJointComponentKey)) != nullptr;
}
...
FRigUnit_HierarchySetJointData_Execute()
{
	...
	if (FRigPhysicsJointComponent* Component = GetJoint(ExecuteContext.Hierarchy, PhysicsJointComponentKey))
	{
		Component->JointData = JointData;
		Component->DirtyFlags |= ERigPhysicsJointComponentDirtyFlags::Joint;
	}
}
...
//======================================================================================================================
FRigUnit_HierarchySetJointLinearLimit_Execute()
{
	DECLARE_SCOPE_HIERARCHICAL_COUNTER_RIGUNIT();
	if (!ExecuteContext.Hierarchy)
	{
	...
	if (FRigPhysicsJointComponent* Component = GetJoint(ExecuteContext.Hierarchy, PhysicsJointComponentKey))
	{
		Component->JointData.LinearConstraint = LinearLimit.LinearConstraint;
		Component->DirtyFlags |= ERigPhysicsJointComponentDirtyFlags::Joint;
	}
}

//======================================================================================================================
FRigUnit_HierarchySetJointConeLimit_Execute()
{
	DECLARE_SCOPE_HIERARCHICAL_COUNTER_RIGUNIT();
	if (!ExecuteContext.Hierarchy)
	{
	...
	if (FRigPhysicsJointComponent* Component = GetJoint(ExecuteContext.Hierarchy, PhysicsJointComponentKey))
	{
		Component->JointData.ConeConstraint = ConeLimit.ConeConstraint;
		Component->DirtyFlags |= ERigPhysicsJointComponentDirtyFlags::Joint;
	}
}

//======================================================================================================================
FRigUnit_HierarchySetJointTwistLimit_Execute()
{
	DECLARE_SCOPE_HIERARCHICAL_COUNTER_RIGUNIT();
	if (!ExecuteContext.Hierarchy)
	{
	...
	if (FRigPhysicsJointComponent* Component = GetJoint(ExecuteContext.Hierarchy, PhysicsJointComponentKey))
	{
		Component->JointData.TwistConstraint = TwistLimit.TwistConstraint;
		Component->DirtyFlags |= ERigPhysicsJointComponentDirtyFlags::Joint;
	}
}
...
FRigUnit_HierarchySetJointDriveData_Execute()
{
	...
	{
		Component->DriveData = DriveData;
		Component->DirtyFlags |= ERigPhysicsJointComponentDirtyFlags::Drive;
	}
}
