...
namespace Chaos
{
	...
	public:
		...
		*/
		...
		/**
		* Called from the game thread to emit events
		*/
		virtual void EmitEvents(UPrimitiveComponent* InComponent, UChaosCache* InCache, FPlaybackTickRecord& TickRecord) const {};
