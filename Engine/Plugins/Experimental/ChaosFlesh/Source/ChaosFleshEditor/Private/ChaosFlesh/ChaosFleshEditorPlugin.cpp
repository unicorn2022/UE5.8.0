...
void IChaosFleshEditorPlugin::StartupModule()
{
	...
	FDataflowTemplateRegistry::Get().RegisterTemplateFolder(UFleshAsset::StaticClass(),
		{ TEXT("/ChaosFlesh/Templates"), FSlateIcon("ChaosFleshEditorStyle", "ClassThumbnail.FleshAsset") });
	
	DataflowMenusHandle = UE::DataflowAssetDefinitionHelpers::RegisterDataflowAssetMenus(UFleshAsset::StaticClass());
