...
public:
	...
	virtual void StartupModule() override
	{
		...
		if (!OrtDllHandle)
		{
			UE_LOGF(LogNNERuntimeRDGHlsl, Fatal, "Failed to load ONNX Runtime shared library!");
			return;
		}
		...
		{
			UE_LOGF(LogNNERuntimeRDGHlsl, Fatal, "Failed to load ONNX Runtime shared library functions!");
			return;
		}
