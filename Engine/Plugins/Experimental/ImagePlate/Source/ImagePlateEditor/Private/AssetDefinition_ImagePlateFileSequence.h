...
public:
	...
	{
		static const auto Categories = { FAssetCategoryPath(EAssetCategoryPaths::Media, NSLOCTEXT("AssetDefinition", "AssetDefinition_ImagePlateFileSequenceSubMenu", "Other"), ECategoryMenuType::Section) };
		return Categories;
	}
