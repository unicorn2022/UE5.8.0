...
USTRUCT(BlueprintType, Category = "LearningAgents")
struct FLearningAgentsImitationLearningLoggingSettings
{
	GENERATED_BODY()
...
public:
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "LearningAgents")
	FLearningAgentsImitationTrainerHyperparameters Hyperparameters;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "LearningAgents")
	FLearningAgentsImitationLearningLoggingSettings LoggingSettings;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "LearningAgents")
	FLearningAgentsImitationLearningValidationSettings ValidationSettings;
