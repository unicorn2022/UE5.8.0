...
namespace GenerateSimpleCollisionNodeHelpers
{
							 ...
							 FProgressCancel* Progress)
	{
		...
		if (NumShapes == 0)
		{
			...
			Hull.SimplifyOptions.MaxTargetFaceCount = Settings.ConvexHullSettings.SimplifyToTriangleCount;
			Hull.SimplifyOptions.GeometricToleranceAfterTarget = Settings.ConvexHullSettings.GeometricToleranceAfterTarget;
