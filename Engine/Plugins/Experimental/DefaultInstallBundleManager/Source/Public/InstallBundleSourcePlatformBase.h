...
#if WITH_PLATFORM_INSTALL_BUNDLE_SOURCE || WITH_PLATFORM_DLC_INSTALL_BUNDLE_SOURCE
...
public:
	...
	virtual void SetAnalyticsProvider(TSharedPtr<IAnalyticsProviderET> NewAnalyticsProvider) override
	{
...
#endif //WITH_PLATFORM_INSTALL_BUNDLE_SOURCE || WITH_PLATFORM_DLC_INSTALL_BUNDLE_SOURCE
