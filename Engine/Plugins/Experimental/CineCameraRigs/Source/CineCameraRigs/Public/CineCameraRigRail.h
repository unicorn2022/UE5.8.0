...
class UE_API ACineCameraRigRail : public ACameraRig_Rail
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintSetter, Category = "Rail Components")
	void SetSplineComponent(UCineSplineComponent* NewSplineComponent) { CineSplineComponent = NewSplineComponent; }
...
#if WITH_EDITOR
	void ConditionalRegisterTimerManager();
