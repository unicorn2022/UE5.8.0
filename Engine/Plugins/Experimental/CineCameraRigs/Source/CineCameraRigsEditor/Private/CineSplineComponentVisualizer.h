...
protected:
	...
	void OnSetMetadataTangent(ECineSplineMetadataTangentType TangentType);
	bool IsMetadataTangent(ECineSplineMetadataTangentType TangentType);
	void GenerateMetadataTangentTypeSubMenu(FMenuBuilder& MenuBuilder) const;
