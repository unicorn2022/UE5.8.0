...
public:
	...
	TOptional<ECineSplineMetadataTangentType> InterpTypeValue;
...
private:
	...
	FText GetInterpType() const;
	void OnInterpTypeChanged(TSharedPtr<FString> NewValue, ESelectInfo::Type SelectInfo);

	TSharedRef<SWidget> OnGenerateInterpTypeComboWidget(TSharedPtr<FString> InComboString);
	void OnInterpTypeComboWidgetOpened();
	void UpdateInterpTypes();
...
private:
	...
	TArray<TSharedPtr<FString>> InterpTypes;
	TSharedPtr<SComboBox<TSharedPtr<FString>>> InterpTypeComboBox;
};
