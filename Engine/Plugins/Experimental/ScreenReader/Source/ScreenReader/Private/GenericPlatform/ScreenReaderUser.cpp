...
FScreenReaderReply FScreenReaderUser::NavigateToNextSibling()
{
	...
	if (CurrentFocusedAccessibleWidget)
	{
		...
		{
			UE_LOGF(LogScreenReaderNavigation, Verbose, "User %d now focused on next sibling %ls.", GetIndex(), *NextSibling->ToString());
...
FScreenReaderReply FScreenReaderUser::NavigateToPreviousSibling()
{
	...
	if (CurrentFocusedAccessibleWidget)
	{
		...
		{
			UE_LOGF(LogScreenReaderNavigation, Verbose, "User %d now focused on previous sibling %ls.", GetIndex(), *PreviousSibling->ToString());
			return FScreenReaderReply::Handled();
		}
	}
	return FScreenReaderReply::Unhandled();
...
FScreenReaderReply FScreenReaderUser::NavigateToFirstAncestor()
{
	...
	if (CurrentFocusedAccessibleWidget)
	{
		...
		{
			UE_LOGF(LogScreenReaderNavigation, Verbose, "User %d now focused on ancestor %ls.", GetIndex(), *Ancestor->ToString());
			return FScreenReaderReply::Handled();
		}
	}
	return FScreenReaderReply::Unhandled();
...
FScreenReaderReply FScreenReaderUser::NavigateToFirstChild()
{
	...
	if (CurrentFocusedAccessibleWidget)
	{
		...
		{
			UE_LOGF(LogScreenReaderNavigation, Verbose, "User %d now focused on first child %ls.", GetIndex(), *Child->ToString());
			return FScreenReaderReply::Handled();
		}
	}
	return FScreenReaderReply::Unhandled();
...
FScreenReaderReply FScreenReaderUser::NavigateToNextWidgetInHierarchy()
{
	...
	if (CurrentFocusedAccessibleWidget)
	{
		...
		{
			UE_LOGF(LogScreenReaderNavigation, Verbose, "User %d now focused on next widget %ls.", GetIndex(), *NextWidget->ToString());
			return FScreenReaderReply::Handled();
		}
	}
	return FScreenReaderReply::Unhandled();
...
FScreenReaderReply FScreenReaderUser::NavigateToPreviousWidgetInHierarchy()
{
	...
	if (CurrentFocusedAccessibleWidget)
	{
		...
		{
			UE_LOGF(LogScreenReaderNavigation, Verbose, "User %d now focused on previous widget %ls.", GetIndex(), *PreviousWidget->ToString());
			return FScreenReaderReply::Handled();
		}
	}
	return FScreenReaderReply::Unhandled();
