...
namespace WorkspaceTabs
{
	...
	WORKSPACEEDITOR_API extern const FName RightSidebarDocumentArea;
}
...
using FOnCreateComment = TDelegate<void(const FWorkspaceEditorContext&, const FVector2f&)>;
...
struct FGraphDocumentWidgetArgs
{
	...
	FOnCreateComment OnCreateComment;
};
