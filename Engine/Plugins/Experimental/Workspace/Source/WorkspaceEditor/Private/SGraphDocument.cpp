...
void SGraphDocument::Construct(const FArguments& InArgs, TSharedRef<FWorkspaceEditor> InHostingApp, const FWorkspaceDocument& InWorkspaceDocument)
{
	...
	OnCreateComment = InArgs._OnCreateComment;
...
void SGraphDocument::BindCommands()
{
	...
	CommandList->MapAction(FGraphEditorCommands::Get().CreateComment,
		FExecuteAction::CreateSP(this, &SGraphDocument::CreateComment));
		
	TWeakPtr<SGraphDocument> WeakDocument = StaticCastSharedRef<SGraphDocument>(AsShared());
	CommandList->MapAction(FGraphEditorCommands::Get().AlignNodesTop, FExecuteAction::CreateSPLambda(this, [WeakDocument](){ if (TSharedPtr<SGraphDocument> SharedDocument = WeakDocument.Pin()) { SharedDocument->GraphEditor->OnAlignTop(); }}));
	CommandList->MapAction(FGraphEditorCommands::Get().AlignNodesTop, FExecuteAction::CreateSPLambda(this, [WeakDocument](){ if (TSharedPtr<SGraphDocument> SharedDocument = WeakDocument.Pin()) { SharedDocument->GraphEditor->OnAlignTop(); }}));
	CommandList->MapAction(FGraphEditorCommands::Get().AlignNodesMiddle, FExecuteAction::CreateSPLambda(this, [WeakDocument](){ if (TSharedPtr<SGraphDocument> SharedDocument = WeakDocument.Pin()) { SharedDocument->GraphEditor->OnAlignMiddle(); }}));
	CommandList->MapAction(FGraphEditorCommands::Get().AlignNodesBottom, FExecuteAction::CreateSPLambda(this, [WeakDocument](){ if (TSharedPtr<SGraphDocument> SharedDocument = WeakDocument.Pin()) { SharedDocument->GraphEditor->OnAlignBottom(); }}));
	CommandList->MapAction(FGraphEditorCommands::Get().AlignNodesLeft, FExecuteAction::CreateSPLambda(this, [WeakDocument](){ if (TSharedPtr<SGraphDocument> SharedDocument = WeakDocument.Pin()) { SharedDocument->GraphEditor->OnAlignLeft(); }}));
	CommandList->MapAction(FGraphEditorCommands::Get().AlignNodesCenter, FExecuteAction::CreateSPLambda(this, [WeakDocument](){ if (TSharedPtr<SGraphDocument> SharedDocument = WeakDocument.Pin()) { SharedDocument->GraphEditor->OnAlignCenter(); }}));
	CommandList->MapAction(FGraphEditorCommands::Get().AlignNodesRight, FExecuteAction::CreateSPLambda(this, [WeakDocument](){ if (TSharedPtr<SGraphDocument> SharedDocument = WeakDocument.Pin()) { SharedDocument->GraphEditor->OnAlignRight(); }}));
	CommandList->MapAction(FGraphEditorCommands::Get().StraightenConnections, FExecuteAction::CreateSPLambda(this, [WeakDocument](){ if (TSharedPtr<SGraphDocument> SharedDocument = WeakDocument.Pin()) { SharedDocument->GraphEditor->OnStraightenConnections(); }}));
	CommandList->MapAction(FGraphEditorCommands::Get().DistributeNodesHorizontally, FExecuteAction::CreateSPLambda(this, [WeakDocument](){ if (TSharedPtr<SGraphDocument> SharedDocument = WeakDocument.Pin()) { SharedDocument->GraphEditor->OnDistributeNodesH(); }}));
	CommandList->MapAction(FGraphEditorCommands::Get().DistributeNodesVertically, FExecuteAction::CreateSPLambda(this, [WeakDocument](){ if (TSharedPtr<SGraphDocument> SharedDocument = WeakDocument.Pin()) { SharedDocument->GraphEditor->OnDistributeNodesV(); }}));
}
...
void SGraphDocument::CreateComment()
{
	OnCreateComment.ExecuteIfBound(FWorkspaceEditorContext(HostingAppPtr.Pin().ToSharedRef(), Document), GraphEditor->GetPasteLocation2f());
}
