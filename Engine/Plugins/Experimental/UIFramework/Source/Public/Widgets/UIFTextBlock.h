...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category = "UI Framework")
	UE_API void SetAutoWrap(bool InAutoWrap);
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category = "UI Framework")
	UE_API void SetWrapWidth(float InWrapWidth);
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category = "UI Framework")
	UE_API void SetWrappingPolicy(ETextWrappingPolicy InWrappingPolicy);
...
private:
	...
	UFUNCTION()
	UE_API void OnRep_AutoWrap();

	UFUNCTION()
	UE_API void OnRep_WrapWidth();

	UFUNCTION()
	UE_API void OnRep_WrappingPolicy();
...
protected:
	...
	virtual void SetAutoWrapToWidget(bool)
	{
	}
	virtual void SetWrapWidthToWidget(float)
	{
	}
	virtual void SetWrappingPolicyToWidget(ETextWrappingPolicy)
	{
	}
...
private:
	...
	UPROPERTY(ReplicatedUsing = OnRep_AutoWrap)
	bool AutoWrap = false;

	UPROPERTY(ReplicatedUsing = OnRep_WrapWidth)
	float WrapWidth = 0.0f;

	UPROPERTY(ReplicatedUsing = OnRep_WrappingPolicy)
...
protected:
	...
	UE_API virtual void SetAutoWrapToWidget(bool) override;
	UE_API virtual void SetWrapWidthToWidget(float) override;
	UE_API virtual void SetWrappingPolicyToWidget(ETextWrappingPolicy) override;
