	...
	virtual void StartupModule() override
	{
		...
		if ( PackagingSettings )
		{
			...
			if ( !bAlreadyInPath )
			{
				...
				UE_LOGF(LogDatasmithRuntime, Log, "Adding %ls to the list of directories to always package otherwise we cannot create dynamic material instances at runtime", MaterialsPath);
			}
		}
#endif // WITH_EDITOR
