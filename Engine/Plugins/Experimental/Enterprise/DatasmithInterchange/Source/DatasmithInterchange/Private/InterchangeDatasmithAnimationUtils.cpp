...
namespace UE::DatasmithInterchange::AnimUtils
{
	...
	void FLevelSequenceImportHelper::ProcessSubsequenceTrack(IDatasmithSubsequenceAnimationElement& SubsequenceAnimation)
	{
		...
		{
			UE_LOGF(LogInterchangeDatasmith, Warning, "Cannot find LevelSequence element for Subsequence element %ls", SubsequenceAnimation.GetLabel());
			return;
		}
	...
	FString FLevelSequenceImportHelper::ProcessVisibilityTrack(IDatasmithVisibilityAnimationElement& VisibilityAnimation, int32 TrackIndex)
	{
		...
		if (!ensure(TrackNode))
		{
			UE_LOGF(LogInterchangeDatasmith, Warning, "Cannot create UInterchangeAnimationTrackNode object for Visibility element %ls", VisibilityAnimation.GetLabel());
			return {};
		}
	...
	FString FLevelSequenceImportHelper::ProcessTransformTrack(IDatasmithTransformAnimationElement& TransformAnimation, int32 TrackIndex)
	{
		...
		if (!ensure(TrackNode))
		{
			UE_LOGF(LogInterchangeDatasmith, Warning, "Cannot create UInterchangeTransformAnimationTrackNode object for Visibility element %ls", TransformAnimation.GetLabel());
			return {};
		}
