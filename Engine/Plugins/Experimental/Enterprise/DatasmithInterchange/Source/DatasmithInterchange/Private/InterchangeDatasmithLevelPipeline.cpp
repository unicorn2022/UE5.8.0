...
UInterchangeActorFactoryNode* UInterchangeDatasmithLevelPipeline::CreateActorFactoryNode(const UInterchangeBaseNode* TranslatedAssetNode) const
{
	...
	{
		return Super::CreateActorFactoryNode(TranslatedAssetNode);
	}
}

void UInterchangeDatasmithLevelPipeline::SetUpFactoryNode(UInterchangeActorFactoryNode* ActorFactoryNode, const UInterchangeSceneNode* SceneNode,
	const UInterchangeBaseNode* TranslatedAssetNode, bool bIsRootJoint /* false */) const
{
	...
	{
		Super::SetUpFactoryNode(ActorFactoryNode, SceneNode, TranslatedAssetNode, bIsRootJoint);
	}
}
