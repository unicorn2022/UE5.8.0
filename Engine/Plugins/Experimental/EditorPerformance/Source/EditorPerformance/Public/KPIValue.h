...
public:
	...
	FKPIValue(FName NewCategory, FText NewDisplayCategory, FName NewName, FText NewDisplayName, FKPIValue::ESeverity NewSeverity, float NewInitialValue, TOptional<float> NewThresholdValue,
		FKPIValue::ECompare NewCompare = ECompare::LessThan, FKPIValue::EDisplayType NewDisplayType=EDisplayType::Number, FKPIValue::EState NewState=NotSet):
		Id(FGuid::NewGuid()),
...
public:
	...
	bool							DeclareKPIHint(FGuid Id, const FText& HintMessage, const FString& DocumentationLink = FString());
