...
void UMetaSoundLiteralViewModel_Boolean::PostInitProperties()
{
...
#if WITH_EDITOR
void UMetaSoundLiteralViewModel_Boolean::PostEditUndo()
{
	Super::PostEditUndo();
...
void UMetaSoundLiteralViewModel_BooleanArray::PostInitProperties()
{
	Super::PostInitProperties();
	SetFlags(RF_Transactional);
}
...
#if WITH_EDITOR
void UMetaSoundLiteralViewModel_BooleanArray::PostEditUndo()
{
	Super::PostEditUndo();
	SetSourceValue(SourceValue);
}
...
void UMetaSoundLiteralViewModel_Integer::PostInitProperties()
{
	Super::PostInitProperties();
	SetFlags(RF_Transactional);
}
...
#if WITH_EDITOR
void UMetaSoundLiteralViewModel_Integer::PostEditUndo()
{
	Super::PostEditUndo();
	SetSourceValue(SourceValue);
}
...
void UMetaSoundLiteralViewModel_IntegerArray::PostInitProperties()
{
	Super::PostInitProperties();
	SetFlags(RF_Transactional);
}
...
#if WITH_EDITOR
void UMetaSoundLiteralViewModel_IntegerArray::PostEditUndo()
{
	Super::PostEditUndo();
	SetSourceValue(SourceValue);
}
...
void UMetaSoundLiteralViewModel_Float::PostInitProperties()
{
	Super::PostInitProperties();
	SetFlags(RF_Transactional);
}
...
#if WITH_EDITOR
void UMetaSoundLiteralViewModel_Float::PostEditUndo()
{
	Super::PostEditUndo();
	SetSourceValue(SourceValue);
}
...
void UMetaSoundLiteralViewModel_FloatArray::PostInitProperties()
{
	Super::PostInitProperties();
	SetFlags(RF_Transactional);
}
...
#if WITH_EDITOR
void UMetaSoundLiteralViewModel_FloatArray::PostEditUndo()
{
	Super::PostEditUndo();
	SetSourceValue(SourceValue);
}
...
void UMetaSoundLiteralViewModel_String::PostInitProperties()
{
	Super::PostInitProperties();
	SetFlags(RF_Transactional);
}
...
#if WITH_EDITOR
void UMetaSoundLiteralViewModel_String::PostEditUndo()
{
	Super::PostEditUndo();
	SetSourceValue(SourceValue);
}
...
void UMetaSoundLiteralViewModel_StringArray::PostInitProperties()
{
	Super::PostInitProperties();
	SetFlags(RF_Transactional);
}
...
#if WITH_EDITOR
void UMetaSoundLiteralViewModel_StringArray::PostEditUndo()
{
	Super::PostEditUndo();
	SetSourceValue(SourceValue);
}
...
void UMetaSoundLiteralViewModel_Object::PostInitProperties()
{
	Super::PostInitProperties();
	SetFlags(RF_Transactional);
}
...
#if WITH_EDITOR
void UMetaSoundLiteralViewModel_Object::PostEditUndo()
{
	Super::PostEditUndo();
	SetSourceValue(SourceValue);
}
...
void UMetaSoundLiteralViewModel_ObjectArray::PostInitProperties()
{
	Super::PostInitProperties();
	SetFlags(RF_Transactional);
}
...
#if WITH_EDITOR
void UMetaSoundLiteralViewModel_ObjectArray::PostEditUndo()
{
	Super::PostEditUndo();
	SetSourceValue(SourceValue);
}
