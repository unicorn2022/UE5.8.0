...
namespace UE::NNE::RuntimeBasic
{
	...
	public:
		...
		struct FWeightInitializationSettings
		{
			...
			EWeightInitializationType Type = EWeightInitializationType::KaimingUniform;
		...
		/** Makes a Softmax Layer */
		UE_API FModelBuilderElement MakeSoftmax(const uint32 InputOutputSize);
