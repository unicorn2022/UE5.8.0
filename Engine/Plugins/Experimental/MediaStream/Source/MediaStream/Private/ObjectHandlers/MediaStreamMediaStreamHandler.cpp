...
UMediaPlayer* FMediaStreamMediaStreamHandler::CreateOrUpdatePlayer(const FMediaStreamObjectHandlerCreatePlayerParams& InParams)
{
	...
	{
		UE_LOGF(LogMediaStream, Error, "Invalid Media Stream in FMediaStreamMediaStreamHandler::CreateOrUpdatePlayer");
		return nullptr;
	}

	if (!InParams.Source)
	{
		UE_LOGF(LogMediaStream, Error, "Invalid Source Object in FMediaStreamMediaStreamHandler::CreateOrUpdatePlayer");
		return nullptr;
	}
	...
	{
		UE_LOGF(LogMediaStream, Error, "Invalid Media Stream Player in FMediaStreamMediaStreamHandler::CreateOrUpdatePlayer");
		return nullptr;
	}
	...
	if (!MediaPlayer)
	{
		UE_LOGF(LogMediaStream, Error, "Invalid Media Player FMediaStreamMediaStreamHandler::CreateOrUpdatePlayer");
		return nullptr;
	}
