...
protected:
	...
	const TCHAR* kHelloV2EndPoint = TEXT("/RS.V2Hello");
...
public:
	...
	virtual FString GetRemoteVersion() const override { return RemoteVersion; }

	virtual bool IsUsingPixelStreaming() const override { return bIsUsingPixelStreaming; }

	virtual FString GetRemotePixelStreamingVersion() const override { return RemotePixelStreamingVersion; }

	virtual FString GetRemoteBuildInfo() const override { return RemoteBuildInfo; }
...
protected:
	...
	void			SendHelloV2();
	void 			OnReceiveHelloV2(IBackChannelPacket& Message);
...
private:
	...
	TArray<FBackChannelRouteDelegate::FDelegate> ExternalHelloRouteDelegates;
