...
void FSkeletalMeshMorphTargetEditingToolsCommands::RegisterCommands()
{
	...
	UI_COMMAND(BeginMorphTargetMaskTool, "Mask Morph Target", "To use this tool, select a Morph Target for editing from the morph target tab using the radio button", EUserInterfaceActionType::ToggleButton, FInputChord());
}
