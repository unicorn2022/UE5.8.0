...
public:
	...
	UE_API void CreatePinWidgets() override;
...
protected:
	...
	UE_API TSharedPtr<SGraphPin> CreatePinWidget(UEdGraphPin* Pin) const override;
	UE_API void AddPin(const TSharedRef<SGraphPin>& PinToAdd) override;
};
