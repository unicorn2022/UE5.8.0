...
#define UE_API RELATIVEBODYANIMINFO_API

/**
 * Base class to limit options for notify class types in RelativeBodyAnimModifier
 */
UCLASS(MinimalAPI)
class URelativeBodyAnimNotifyBase : public UAnimNotify
{
	GENERATED_BODY()
};
...
public:
	...
	UE_API void OnRelativeBodyDenseNotify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, int NumSamplesIn, const TMap<FName,FTransform> &OffsetTransformsForBonesIn, const TArray<FName> &BodyPairsIn, const TArray<float> &BodyPairsSampleTimeIn, const TArray<FVector3f> &BodyPairsLocalReferenceIn, const TArray<bool> &BodyPairsIsParentDominatesIn) const;

	virtual void Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, const FAnimNotifyEventReference& EventReference) override
	{
		// UE_LOGF(LogTemp, Log, "URelativeIKDenseAnimNotify Triggered: %d constraints", NumSamples);
		OnRelativeBodyDenseNotify(MeshComp, Animation, NumSamples, OffsetTransformsForBones, BodyPairs, BodyPairsSampleTime, BodyPairsLocalReference, bBodyPairsIsParentDominates);
	}
	...
	UPROPERTY(VisibleAnywhere, AdvancedDisplay, meta = (Category = "Detail"))
	TMap<FName,FTransform> OffsetTransformsForBones;
 ...
 */
UCLASS(MinimalAPI, meta = (DisplayName = "RelativeBodyPerFrameAnimNotify"))
...
public:
	 ...
	 */
	UFUNCTION(BlueprintImplementableEvent, Category = "Animation")
	UE_API void OnRelativeBodyAnimNotify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, USkeletalMesh* SkeletalMesh, FName Body1, FName Body2, const FVector3f &Loc1, const FVector3f &Loc2, bool IsParentDominates) const;
	...
	virtual void Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, const FAnimNotifyEventReference& EventReference) override
	{
		// UE_LOGF(LogTemp, Log, "URelativeBodyPerFrameAnimNotify Triggered: %d constraints", NumSamples);
...
public:
	 ...
	 */
	UFUNCTION(BlueprintImplementableEvent, Category = "Animation")
	UE_API void OnRelativePropsDenseNotify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, int NumSamplesIn, const TMap<FName,FTransform> &OffsetTransformsForBonesIn, const TArray<FName>& PropsPairsIn, const TArray<float>& PropsPairsSampleTimeIn, const TArray<FVector3f>& PropsPairsLocalReferenceIn) const;

	virtual void Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, const FAnimNotifyEventReference& EventReference) override
	{
		// UE_LOGF(LogTemp, Log, "URelativeIKDenseAnimNotify Triggered: %d constraints", NumSamples);
		OnRelativePropsDenseNotify(MeshComp, Animation, NumSamples, OffsetTransformsForBones, PropsPairs, PropsPairsSampleTime, PropsPairsLocalReference);
	}
	...
	UPROPERTY(VisibleAnywhere, AdvancedDisplay, meta = (Category = "Detail"))
	TArray<FName> PropsPairs;
	
	UPROPERTY(VisibleAnywhere, AdvancedDisplay, meta = (Category = "Detail"))
	TArray<float> PropsPairsSampleTime;
	
	UPROPERTY(VisibleAnywhere, AdvancedDisplay, meta = (Category = "Detail"))
	TArray<FVector3f> PropsPairsLocalReference;

	UPROPERTY(VisibleAnywhere, AdvancedDisplay, meta = (Category = "Detail"))
	TArray<bool> bPropsPairsIsParentDominates;
};
