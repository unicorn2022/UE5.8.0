...
public:
	...
	void UpdatePreviewPoseFromScrubTime(double InTraceStartTime, double InTraceEndTime) const;
...
private:
	...
	enum class EExportValidation
	{
		MultipleTraceRanges,
		NoTrajectorySelected,
		MissingAssetInfo,
		ExportPathIsInvalid,
		AssetAlreadyExists,
		Valid,
