...
public:
	...
	UE_API const UE::Anim::TNamedValueArray<FDefaultAllocator, UE::Anim::FCurveElement>& GetCurveBlendWeights() const;
	UE_API const TArray<FBlendProfileStandaloneCachedData::FMaskedAttributeWeight>& GetAttributeBlendWeights() const;
...
private:
	...
	TArray<FBlendProfileStandaloneCachedData::FMaskedAttributeWeight> AttributeBlendWeights;
