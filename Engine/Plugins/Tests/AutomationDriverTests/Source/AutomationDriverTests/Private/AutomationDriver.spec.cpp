...
void FAutomationDriverSpec::Define()
{
	...
	Describe("Element", [this]()
	{
		...
		Describe("GetText", [this]()
		{
			...
			It("should return all text values if the element displays multiple pieces of text", EAsyncExecution::ThreadPool, [this]()
			{
				TEST_EQUAL(Driver->FindElement(By::Id("Piano"))->GetText().ToString(), *(FString(TEXT("Ab/G#")) + LINE_TERMINATOR + TEXT("Gb/F#") + LINE_TERMINATOR + TEXT("Fb/E#") + LINE_TERMINATOR + TEXT("Eb/D#") + LINE_TERMINATOR + TEXT("Db/C#") + LINE_TERMINATOR + TEXT("Cb/B#") + LINE_TERMINATOR + TEXT("Bb/A#") + LINE_TERMINATOR + TEXT("G") + LINE_TERMINATOR + TEXT("F") + LINE_TERMINATOR + TEXT("E") + LINE_TERMINATOR + TEXT("D") + LINE_TERMINATOR + TEXT("C") + LINE_TERMINATOR + TEXT("B") + LINE_TERMINATOR + TEXT("A")));
			});
