...
public:
	...
	/** Check whether the imported textures are of a specific type */
	UFUNCTION(Exec)
	static UE_API FInterchangeTestFunctionResult CheckTextureType(const TArray<UTexture*>& Textures, TSubclassOf<UTexture> ExpectedTextureType, int32 ExpectedNumber);
