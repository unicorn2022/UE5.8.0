...
public:
	...
	UE_API virtual FString GetPerfTestTypeID() const override;

	UE_API virtual void GatherTestMetadata(TArray<TPair<FString, FString>>& OutMetadata) const override;
	...
	UE_API FString GetCurrentMaterialRegionName() const;
