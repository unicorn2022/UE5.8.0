...
namespace UE::Chaos::ClothAsset
{
	namespace Private
	{
		static void RegisterDataflowNodes()
		{
			...
			DATAFLOW_NODE_REGISTER_CREATION_FACTORY(FChaosClothStripUserAttributesNode);
		...
		static void RegisterRenderingCallbacks()
		{
			...
			UE::Chaos::ClothAsset::RegisterClothRenderableTypes();
		}
		...
		public:
			...
			{
				OutInfos.Add({
					.TargetGroup = ClothCollectionGroup::SimVertices2D,
					.PositionAttributeKey = { ClothCollectionAttribute::SimPosition3D, ClothCollectionGroup::SimVertices3D },
					.IndicesAttributeKey = { ClothCollectionAttribute::SimIndices3D, ClothCollectionGroup::SimFaces },
					.MappingFrom2DTo3DAttributeKey = { ClothCollectionAttribute::SimVertex3DLookup, ClothCollectionGroup::SimVertices2D },
					});
				OutInfos.Add({
					.TargetGroup = ClothCollectionGroup::SimVertices3D,
					.PositionAttributeKey = { ClothCollectionAttribute::SimPosition3D, ClothCollectionGroup::SimVertices3D },
					.IndicesAttributeKey = { ClothCollectionAttribute::SimIndices3D, ClothCollectionGroup::SimFaces },
					.MappingFrom2DTo3DAttributeKey = {},
					});
				OutInfos.Add({
					.TargetGroup = ClothCollectionGroup::RenderVertices,
					.PositionAttributeKey = { ClothCollectionAttribute::RenderPosition, ClothCollectionGroup::RenderVertices },
					.IndicesAttributeKey = { ClothCollectionAttribute::RenderIndices, ClothCollectionGroup::RenderFaces },
					.MappingFrom2DTo3DAttributeKey = {},
					});
