...
public:
	...
	CHAOSCLOTHASSETDATAFLOWNODES_API FChaosClothAssetSimulationBaseConfigNode(const UE::Dataflow::FNodeParameters& InParam, FGuid InGuid = FGuid::NewGuid());
...
protected:
	...
	public:
		...
		CHAOSCLOTHASSETDATAFLOWNODES_API int32 SetPropertyBool(const FName& PropertyName, bool PropertyValue, const TArray<FName>& SimilarPropertyNames = {}, ECollectionPropertyFlags PropertyFlags = ECollectionPropertyFlags::Animatable);
	...
	CHAOSCLOTHASSETDATAFLOWNODES_API virtual void Evaluate(UE::Dataflow::FContext& Context, const FDataflowOutput* Out) const override;
	...
	CHAOSCLOTHASSETDATAFLOWNODES_API void RegisterCollectionConnections();
	...
	CHAOSCLOTHASSETDATAFLOWNODES_API int32 AddPropertyHelper(
		::Chaos::Softs::FCollectionPropertyMutableFacade& Properties,
		const FName& PropertyName,
