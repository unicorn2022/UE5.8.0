...
enum class EChaosClothAssetWeightMapTransferType : uint8
{
	...
	/** Transfer weight maps from the 3D render mesh into the sim mesh using spatial (BVH) mapping. Use this when the source collection contains an imported render mesh with painted weight maps. */
	UseRenderMesh UMETA(DisplayName = "Use Render Mesh"),
};
