...
/**
 * Enumerates possible states of a serialized message.
 *
...
public:
	...
	{
		FTopLevelAssetPath TypeInfo;
		FUdpMessagingTime SerializationStartTime;
		FUdpMessagingTime SerializationEndTime;
	};
