...
UE_API TOptional<FImage> GetImage(const FString& InFullImagePath);
UE_API TArray64<uint8> GetImageData(const FString& InFullImagePath);
...
UE_API FString GetCameraId(TObjectPtr<const UObject> InObject);
