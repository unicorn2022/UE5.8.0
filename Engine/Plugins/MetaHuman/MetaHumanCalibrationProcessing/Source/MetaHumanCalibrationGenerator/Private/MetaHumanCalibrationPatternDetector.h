...
public:
	...
	using FDetectedFrames = TMap<int32, FDetectedFrame>;
	...
	static TUniquePtr<FMetaHumanCalibrationPatternDetector> CreateFromNew(const FPatternInfo& InBoardInfo, const TArray<FCameraInfo>& InCameras, float InScale);
	...
	void SetMaximumNumberOfThreads(int32 InMaximumNumberOfThreads);
	void SetStopToken(UE::CaptureManager::FStopToken InStopToken);
...
private:
	...
	int32 MaximumNumberOfThreads = 4;
	TOptional<UE::CaptureManager::FStopToken> StopToken;
};