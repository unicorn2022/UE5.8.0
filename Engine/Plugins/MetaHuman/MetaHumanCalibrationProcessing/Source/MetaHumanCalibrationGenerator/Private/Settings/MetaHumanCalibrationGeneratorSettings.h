...
private:
	...
	{
		if (!InPropertyChangedEvent.MemberProperty || InPropertyChangedEvent.MemberProperty->GetName() == GET_MEMBER_NAME_CHECKED(UMetaHumanCalibrationGeneratorSettings, CoverageMap))
		{
