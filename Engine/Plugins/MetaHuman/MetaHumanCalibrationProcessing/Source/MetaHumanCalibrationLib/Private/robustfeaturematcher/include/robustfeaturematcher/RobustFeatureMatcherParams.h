...
class RobustFeatureMatcherParams {
    ...
    public:
        ...
        /** 0 = SlowPrecise (SIFT/BRUTEFORCE), 1 = FastLessPrecise (AKAZE/BRUTEFORCE_HAMMING) */
        int getFeatureDetectorType() const {
            return featureDetectorType;
        }

        void setFeatureDetectorType(int detectorType) {
    ...
    private:
        ...
        int featureDetectorType = 0;  // 0 = SlowPrecise (SIFT), 1 = FastLessPrecise (AKAZE)
};
