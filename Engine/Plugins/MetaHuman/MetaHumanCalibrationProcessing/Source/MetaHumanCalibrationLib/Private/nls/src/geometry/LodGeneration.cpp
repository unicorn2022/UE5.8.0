...
{
    auto ModelData = FMetaHumanFileResourceLoader::GetBoundedIOStreamFromFile(lodGenerationModelFile);
    ...
    {
        bSuccess &= io::FromBinaryFile(ModelData.get(), m_baseMeshes);
        bSuccess &= io::FromBinaryFile(ModelData.get(), m_driverMeshNames);
        bSuccess &= io::FromBinaryFile(ModelData.get(), m_wrapDeformers);
        bSuccess &= io::FromBinaryFile(ModelData.get(), m_snapConfigs);
        bSuccess &= io::FromBinaryFile(ModelData.get(), m_meshLods);
