...
template <class T>
void ParallelNoAliasGEMV(Eigen::Ref<Eigen::Matrix<T, -1, 1>, 0, Eigen::InnerStride<1>> out,
                         const Eigen::Ref<const Eigen::Matrix<T, -1, -1, Eigen::RowMajor>, 0, Eigen::OuterStride<-1>>& A,
                         const Eigen::Ref<const Eigen::Matrix<T, -1, 1>, 0, Eigen::InnerStride<1>>& x,
...
template <class T>
void ParallelNoAliasGEMV(Eigen::Ref<Eigen::Matrix<T, -1, 1>, 0, Eigen::InnerStride<1>> out,
                         const Eigen::Ref<const Eigen::Matrix<T, -1, 1>, 0, Eigen::InnerStride<1>>& b,
...
template void ParallelNoAliasGEMV(Eigen::Ref<Eigen::Matrix<float, -1, 1>, 0, Eigen::InnerStride<1>> out, const Eigen::Ref<const Eigen::Matrix<float, -1, -1, Eigen::RowMajor>, 0,
                                                                                          Eigen::OuterStride<-1>>& A,
                                  const Eigen::Ref<const Eigen::Matrix<float, -1, 1>, 0, Eigen::InnerStride<1>>& x, TaskThreadPool* taskThreadPool);
template void ParallelNoAliasGEMV(Eigen::Ref<Eigen::Matrix<double, -1, 1>, 0, Eigen::InnerStride<1>> out, const Eigen::Ref<const Eigen::Matrix<double, -1, -1, Eigen::RowMajor>, 0,
                                                                                           Eigen::OuterStride<-1>>& A,
                                  const Eigen::Ref<const Eigen::Matrix<double, -1, 1>, 0, Eigen::InnerStride<1>>& x, TaskThreadPool* taskThreadPool);
template void ParallelNoAliasGEMV(Eigen::Ref<Eigen::Matrix<float, -1, 1>, 0, Eigen::InnerStride<1>> out, const Eigen::SparseMatrix<float, Eigen::RowMajor>& A,
                                  const Eigen::Ref<const Eigen::Matrix<float, -1, 1>, 0, Eigen::InnerStride<1>>& x, TaskThreadPool* taskThreadPool);
template void ParallelNoAliasGEMV(Eigen::Ref<Eigen::Matrix<double, -1, 1>, 0, Eigen::InnerStride<1>> out, const Eigen::SparseMatrix<double, Eigen::RowMajor>& A,
                                  const Eigen::Ref<const Eigen::Matrix<double, -1, 1>, 0, Eigen::InnerStride<1>>& x, TaskThreadPool* taskThreadPool);
template void ParallelNoAliasGEMV(Eigen::Ref<Eigen::Matrix<float, -1, 1>, 0, Eigen::InnerStride<1>> out, const Eigen::Ref<const Eigen::Matrix<float, -1, 1>, 0, Eigen::InnerStride<1>>& b,
                                  const Eigen::Ref<const Eigen::Matrix<float, -1, -1, Eigen::RowMajor>, 0, Eigen::OuterStride<-1>>& A,
                                  const Eigen::Ref<const Eigen::Matrix<float, -1, 1>, 0, Eigen::InnerStride<1>>& x, TaskThreadPool* taskThreadPool);
template void ParallelNoAliasGEMV(Eigen::Ref<Eigen::Matrix<double, -1, 1>, 0, Eigen::InnerStride<1>> out, const Eigen::Ref<const Eigen::Matrix<double, -1, 1>, 0, Eigen::InnerStride<1>>& b,
