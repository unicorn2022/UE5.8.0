...
public:
     ...
     */
    bool DetectPattern(const std::string& InCameraName, const unsigned char* InImage, std::vector<double>& OutPoints, double& OutChessboardSharpness) const;
     ...
     * @returns True if successful, false upon any error.
     */
    bool Calibrate(const std::vector<std::map<std::string, std::vector<double>>>& InCornerPointsPerCameraPerFrame,
                   std::map<std::string, OpenCVCameraD>& OutCalibrations,
                   double& OutMSE);
     ...
     * @returns True if successful, false upon any error.
     */
    bool ExportCalibrations(const std::map<std::string, OpenCVCameraD>& InCalibrations, const std::string& InExportFilepath) const;
