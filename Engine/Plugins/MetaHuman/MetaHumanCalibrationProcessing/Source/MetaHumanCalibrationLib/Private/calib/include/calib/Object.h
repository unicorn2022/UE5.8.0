...
public:
    ...
    /**
        @brief Is the object of derived class ObjectPlaneInternal.

        A means by which to identity derived class type to avoid the need for dynamic casting and RTTI.

        @return
            true if the object is of derived class ObjectPlaneInternal
    */

    virtual bool isInternalType() const { return false; }
