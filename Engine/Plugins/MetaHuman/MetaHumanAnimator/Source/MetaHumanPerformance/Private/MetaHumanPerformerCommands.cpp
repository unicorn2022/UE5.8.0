...
void FMetaHumanPerformanceCommands::RegisterCommands()
{
	...
	UI_COMMAND(ExportLevelSequence, "Export Level Sequence", "Exports a Level Sequence that matches the sequence in this Performance. Not available when Body Tracking.", EUserInterfaceActionType::Button, FInputChord{});
