...
private:
	...
	const FAssetCategoryPath MetaHumanAdvancedAssetCategoryPath{ MetaHumanAssetCategoryPath, LOCTEXT("MetaHumanAdvancedAssetCategoryLabel", "Advanced"), ECategoryMenuType::Section };
};
