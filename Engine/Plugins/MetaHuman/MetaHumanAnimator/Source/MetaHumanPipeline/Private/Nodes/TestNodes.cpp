...
bool FIntLogNode::Process(const TSharedPtr<FPipelineData>& InPipelineData)
{
	...
	UE_LOGF(LogMetaHumanPipeline, Display, "   Results [%ls] [%i] Value [%i]", *Name, InPipelineData->GetFrameNumber(), Input);
...
bool FFltLogNode::Process(const TSharedPtr<FPipelineData>& InPipelineData)
{
	...
	UE_LOGF(LogMetaHumanPipeline, Display, "   Results [%ls] [%i] Value [%f]", *Name, InPipelineData->GetFrameNumber(), Input);
...
bool FMixLogNode::Process(const TSharedPtr<FPipelineData>& InPipelineData)
{
	...
	UE_LOGF(LogMetaHumanPipeline, Display, "   Results [%ls] [%i] Value [%i] [%f]", *Name, InPipelineData->GetFrameNumber(), Input1, Input2);
