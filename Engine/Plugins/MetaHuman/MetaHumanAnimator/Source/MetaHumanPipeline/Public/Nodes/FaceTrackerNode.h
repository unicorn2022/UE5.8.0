...
public:
	...
	UE_DEPRECATED(5.8, "Use DNAReader instead, DNAAsset has been deprecated.")
...
public:
	...
	static FCalibrationDataType ConvertCameraCalibration(const FCameraCalibration& InCameraCalibration);
	static FCameraCalibration ConvertCalibrationDataType(const FCalibrationDataType& InCalibrationDataType);
