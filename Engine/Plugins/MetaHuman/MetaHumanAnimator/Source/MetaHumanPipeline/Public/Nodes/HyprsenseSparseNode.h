...
namespace UE::MetaHuman::Pipeline
{
	...
	public:
		...
		UE_API bool SetTrackers(const TSharedPtr<UE::NNE::IModelInstanceRunSync>& InFaceTracker, const TSharedPtr<UE::NNE::IModelInstanceRunSync>& InFaceDetector);
	};
	...
	{
	public:
		UE_API FHyprsenseSparseManagedNode(const FString& InName, const FString& InNNEBackend = "");
