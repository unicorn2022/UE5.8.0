...
namespace UE::MetaHuman::Pipeline
{
	...
	protected:
		...
		UE_API bool CheckTrackers(const TMap<ETrackerType, UE::NNE::FTensorShape>& InputValidationMap, const TMap<ETrackerType, TArray<UE::NNE::FTensorShape>>& OutputValidationMap, const TMap<TSharedPtr<UE::NNE::IModelInstanceRunSync>, ETrackerType>& TrackerTypeMap);
		...
		UE_DEPRECATED(5.8, "FaceTracker is deprecated. Use FaceTrackerModel instead.")
		...
		UE_DEPRECATED(5.8, "EyebrowTracker is deprecated. Use EyebrowTrackerModel instead.")
		TSharedPtr<UE::NNE::IModelInstanceGPU> EyebrowTracker{};
		UE_DEPRECATED(5.8, "EyeTracker is deprecated. Use EyeTrackerModel instead.")
		TSharedPtr<UE::NNE::IModelInstanceGPU> EyeTracker{};
		UE_DEPRECATED(5.8, "LipsTracker is deprecated. Use LipsTrackerModel instead.")
		TSharedPtr<UE::NNE::IModelInstanceGPU> LipsTracker{};
		UE_DEPRECATED(5.8, "LipzipTracker is deprecated. Use LipzipTrackerModel instead.")
		TSharedPtr<UE::NNE::IModelInstanceGPU> LipzipTracker{};
		UE_DEPRECATED(5.8, "NasolabialNoseTracker is deprecated. Use NasolabialNoseTrackerModel instead.")
		TSharedPtr<UE::NNE::IModelInstanceGPU> NasolabialNoseTracker{};
		UE_DEPRECATED(5.8, "ChinTracker is deprecated. Use ChinTrackerModel instead.")
		TSharedPtr<UE::NNE::IModelInstanceGPU> ChinTracker{};
		UE_DEPRECATED(5.8, "TeethTracker is deprecated. Use TeethTrackerModel instead.")
		TSharedPtr<UE::NNE::IModelInstanceGPU> TeethTracker{};
		UE_DEPRECATED(5.8, "LipsNasoNoseTeethTracker is deprecated. Use LipsNasoNoseTeethTrackerModel instead.")
		...
		TSharedPtr<UE::NNE::IModelInstanceRunSync> FaceTrackerModel{};
		TSharedPtr<UE::NNE::IModelInstanceRunSync> FaceDetectorModel{};
		TSharedPtr<UE::NNE::IModelInstanceRunSync> EyebrowTrackerModel{};
		TSharedPtr<UE::NNE::IModelInstanceRunSync> EyeTrackerModel{};
		TSharedPtr<UE::NNE::IModelInstanceRunSync> LipsTrackerModel{};
		TSharedPtr<UE::NNE::IModelInstanceRunSync> LipzipTrackerModel{};
		TSharedPtr<UE::NNE::IModelInstanceRunSync> NasolabialNoseTrackerModel{};
		TSharedPtr<UE::NNE::IModelInstanceRunSync> ChinTrackerModel{};
		TSharedPtr<UE::NNE::IModelInstanceRunSync> TeethTrackerModel{};
		TSharedPtr<UE::NNE::IModelInstanceRunSync> LipsNasoNoseTeethTrackerModel{};
		...
		UE_DEPRECATED(5.8, "NNEModels is deprecated. Use NNERunSyncModels instead.")
		...
		TArray<TSharedPtr<UE::NNE::IModelInstanceRunSync>> NNERunSyncModels = { nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr };
