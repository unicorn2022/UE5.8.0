...
DECLARE_DELEGATE_TwoParams(FOnGetABMenuContents, EABImageViewMode InABViewMode, FMenuBuilder& InMenuBuilder)
...
private:
	UE_API TSharedRef<SWidget> CreateViewMenuWidget(EABImageViewMode InViewMode);
	...
	UE_API TSharedRef<SWidget> FillDisplayOptionsForViewMenu(EABImageViewMode InViewMode);
