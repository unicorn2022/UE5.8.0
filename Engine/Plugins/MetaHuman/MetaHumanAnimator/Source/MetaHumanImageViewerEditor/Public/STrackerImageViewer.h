...
public:
	...
	SLATE_BEGIN_ARGS(STrackerImageViewer)
		...
		, _DefaultCurvesColor(FLinearColor::Green)
		, _DefaultPointsColor(FLinearColor::Green)
		, _HighlightedColor(FLinearColor::White)
		, _SelectedColor(FLinearColor::Yellow)
		, _DeactivatedColor(FLinearColor::Gray)
	{}
		SLATE_ATTRIBUTE(const FSlateBrush*, Image)

		/** If the points should be drawn */
		SLATE_ATTRIBUTE(bool, ShouldDrawPoints)

		/** If the curves should be drawn */
		SLATE_ATTRIBUTE(bool, ShouldDrawCurves)

		/** The default color for curves */
		SLATE_ARGUMENT(FLinearColor, DefaultCurvesColor)

		/** The default color for points */
		SLATE_ARGUMENT(FLinearColor, DefaultPointsColor)

		/** The color for highlighted curves and points */
		SLATE_ARGUMENT(FLinearColor, HighlightedColor)

		/** The color for selected curves and points */
		SLATE_ARGUMENT(FLinearColor, SelectedColor)

		/** The color for deactivated curves and points */
		SLATE_ARGUMENT(FLinearColor, DeactivatedColor)
	...
	/** Returns the size of the underlying tracker image. Used to calculate the correct placement of curves and points in the image being displayed */
	UE_API FVector2D GetTrackerImageSize() const { return TrackerImageSize; }

	/** True if the viewer Data Controller contains data */
	...
	/** Sets the data controller for the current frame */
	...
	/** Set the color for curves. This will update the default color */
	UE_API void SetCurvesColor(FLinearColor InColor);

	/** Set the color for points. This will update the default color */
	UE_API void SetPointsColor(FLinearColor InColor);

	/** Set the size for points. This will update the default size */
	UE_API void SetPointsSize(float InSize);
...
protected:
	...
	FLinearColor DefaultCurvesColor;
	FLinearColor DefaultPointsColor;
