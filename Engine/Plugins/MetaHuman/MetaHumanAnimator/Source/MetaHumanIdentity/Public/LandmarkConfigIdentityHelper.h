...
private:
	...
	UE_API void PopulateMarkerDataFromConfig(const TMap<FJsonObject::FStringType, TSharedPtr<class FJsonValue>>& InConfigContourData);
	...
	TSet<FString> NeutralNoBrowsIrisPoseCurveExclusionList;
	TSet<FString> NeutralNoBrowsPoseGroupExclusionList;
