...
struct FPredictiveSolversTaskConfig
{
	...
	TSharedPtr<class IDNAReader> DNAReader;
	UE_DEPRECATED(5.8, "Use DNA Reader instead, this is old DNA Asset User data which has been deprecated in favor of DNA asset.")
