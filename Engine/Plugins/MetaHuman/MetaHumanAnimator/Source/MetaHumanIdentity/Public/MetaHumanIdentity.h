...
public:
	...
	METAHUMANIDENTITY_API virtual void PostInitProperties() override;
...
public:
	...
	UPROPERTY()
	EIdentityInvalidationState InvalidationState_DEPRECATED = EIdentityInvalidationState::None;
...
public:
	...
	/** Deals with error produced by the MetaHuman Identity process - logs message and optionally show user dialog; returns false if an Error and true if no errors, or just a Warning */
