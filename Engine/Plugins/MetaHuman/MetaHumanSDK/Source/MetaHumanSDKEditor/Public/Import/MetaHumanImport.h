...
struct FMetaHumanImportDescription
{
	...
	TMap<FString, FString> PackageRedirects; // Archive-relative package path -> original source package path. Used to fix up references for remapped external dependencies.
};
