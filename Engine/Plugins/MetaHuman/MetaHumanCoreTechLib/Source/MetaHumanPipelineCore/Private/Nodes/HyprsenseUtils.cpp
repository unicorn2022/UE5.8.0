...
namespace UE::MetaHuman::Pipeline
{
	...
	TArray<float, TAlignedHeapAllocator<64>> FHyprsenseUtils::WarpAffineBilinear(const uint8* InSrcImage, int32 InSrcWidth, int32 InSrcHeight, const Matrix23f& InTransform, int32 InTargetWidth, int32 InTargetHeight, bool bInIsDetector) const
	{
		...
		TArray<float, TAlignedHeapAllocator<64>> ResizedNNInput;
	...
	TArray<FHyprsenseUtils::Bbox> FHyprsenseUtils::HardNMS(const TArray<float, TAlignedHeapAllocator<64>>& InScores, const TArray<float, TAlignedHeapAllocator<64>>& InBoxes, float InIouThreshold, float InProbThreshold, int32 InTotalSize, int32 InTopK) const
	{
