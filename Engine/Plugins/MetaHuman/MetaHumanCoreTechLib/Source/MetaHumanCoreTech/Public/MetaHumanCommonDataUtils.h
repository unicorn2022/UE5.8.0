...
struct FMetaHumanCommonDataUtils
{
	...
	/** Returns a soft object ptr to a UObject of UControlRigBlueprint retrieved from asset registry of a specified control rig */
	static UE_API TSoftObjectPtr<UObject> GetDefaultControlRigFromRegistry(const FStringView InAssetPath);

	UE_DEPRECATED(5.8, "Please use GetDefaultControlRigFromRegistry function instead")
