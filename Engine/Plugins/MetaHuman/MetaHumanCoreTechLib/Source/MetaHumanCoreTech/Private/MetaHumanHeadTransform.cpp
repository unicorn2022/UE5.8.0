...
// 	  {
// 		  UE_LOGF(LogTemp, Warning, "Failed to find bone");
// 	  }
// }
// else
// {
// 	  UE_LOGF(LogTemp, Warning, "Failed to load a MetaHuman plugin skeleton");
// }
// 
// UE_LOGF(LogTemp, Warning, "%ls", *HeadBoneInitialTransform.GetRotation().ToString());
// UE_LOGF(LogTemp, Warning, "%ls", *HeadBoneInitialTransform.GetLocation().ToString());
