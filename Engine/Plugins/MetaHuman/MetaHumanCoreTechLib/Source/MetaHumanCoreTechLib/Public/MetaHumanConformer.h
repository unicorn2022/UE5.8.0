        ...
        */
        ...
        public:
            ...
            */
			 ...
			 * @param[out] OutFractionLandmarksInBrowRegion  The fraction of brow landmarks in the brow region when projected onto the face mesh.
			 ...
			 */
			UE_API bool GenerateBrowMeshLandmarks(const FString& InCameraName, TArray<uint8>& OutJsonStream, float & OutFractionLandmarksInBrowRegion, bool bInConcatenate = false) const;
			...
			*/
			 ...
			 */
			 UE_DEPRECATED(5.8, "Use CheckPcaModelFromDnaRigConfig that's accepting DNAReader instead, DNAAsset as asset user data has been deprecated.")
			 ...
			 * @param[in] InConfigurationJson  Path to pca from dna configuration file or Json string containing the config.
			 * @param[in] InDNAReader  An example DNA reader to be used with the config.
			 * @returns True if the config is valid, false otherwise
			 */
			static UE_API bool CheckPcaModelFromDnaRigConfig(const FString& InConfigurationJson, TSharedPtr<IDNAReader> InDNAReader);
			...
			*/
			 ...
			 */
			 UE_DEPRECATED(5.8, "Use DNAToBuffer that's accepting DNAReader instead, DNAAsset as asset user data has been deprecated.")
			static UE_API TArray<uint8> DNAToBuffer(UDNAAsset* InDNAAsset);


			/**
			 * Converts a DNA reader into a byte array.
			 * @param[in] InDNAReader  DNA reader.
			 * @returns The byte array
			 */
			static UE_API TArray<uint8> DNAToBuffer(TSharedPtr<IDNAReader> InDNAReader);
