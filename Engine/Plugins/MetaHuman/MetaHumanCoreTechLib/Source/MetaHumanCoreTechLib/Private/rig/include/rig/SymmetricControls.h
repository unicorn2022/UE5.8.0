...
public:
    ...
    std::vector<int> GuiIndicesToSymmetricIndices(const std::vector<int>& guiIndices) const;

    std::vector<int> GetSymmetricGuiIndices() const;

    std::vector<int> GetNonSymmetricGuiIndices() const;
