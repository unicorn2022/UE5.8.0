...
bool ActorCreationAPI::GenerateBrowMeshLandmarks(const std::string& InCameraName, std::string& OutJsonStream, float& OutFractionLandmarksInBrowRegion, bool concatenate) const
{
    try
    {
        TITAN_RESET_ERROR;
        ...
        const auto headMeshLandmarks = m->browLandmarksGenerator->Generate(m->faceFitting->CurrentDeformedVertices(),
                                                                           ...
                                                                           OutFractionLandmarksInBrowRegion,
                                                                           concatenate);
