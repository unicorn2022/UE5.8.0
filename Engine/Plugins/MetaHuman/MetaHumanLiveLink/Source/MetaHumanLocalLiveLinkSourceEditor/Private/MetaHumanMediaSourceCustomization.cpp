...
void FMetaHumanMediaSourceCustomization::Setup(IDetailLayoutBuilder& InDetailBuilder, bool bInIsVideo)
{
	...
	{
#if WITH_EDITOR
		AddRow(CreateCategory, LOCTEXT("VideoDeviceType", "Video Device Type"), MediaSource->GetWidget(SMetaHumanMediaSourceWidget::EWidgetType::VideoDeviceType));
#endif
	...
	{
#if WITH_EDITOR
		AddRow(CreateCategory, LOCTEXT("AudioDeviceType", "Audio Device Type"), MediaSource->GetWidget(SMetaHumanMediaSourceWidget::EWidgetType::AudioDeviceType));
#endif
	...
	NoCategory.AddCustomRow(LOCTEXT("Connect", "Connect"))
		...
		[
			...
			[
				...
				.IsEnabled_Lambda([this, Settings, bInIsVideo]()
				{
					return ValidateSubjectName().IsEmpty() && MediaSource->CanCreate() && (!bInIsVideo || Cast<UMetaHumanVideoLiveLinkSourceSettings>(Settings)->MonocularAnimationPipelineModels.IsValid());
				})
				.OnClicked_Lambda([this, Settings, bInIsVideo]()
				{
					...
					{ 
						...
						UMetaHumanVideoLiveLinkSourceSettings* VideoSourceSettings = Cast<UMetaHumanVideoLiveLinkSourceSettings>(Settings);
						VideoSubjectSettings->MonocularAnimationPipelineModels = VideoSourceSettings->MonocularAnimationPipelineModels;
