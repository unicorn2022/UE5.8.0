...
{
	UE_LOGF(LogMetaHumanLocalLiveLinkSubject, Display, "Started");
...
//	PipelineRunParameters.SetVerbosity(ELogVerbosity::VeryVerbose); // uncomment for full logging
	...
	UE_LOGF(LogMetaHumanLocalLiveLinkSubject, Display, "Finished");
...
bool FMetaHumanLocalLiveLinkSubject::PushStaticData()
{
	...
	*StaticDataStruct.Cast<FLiveLinkBaseStaticData>() = StaticData;
	...
	UE_LOGF(LogMetaHumanLocalLiveLinkSubject, Display, "New static data for subject \"%ls\"", *SubjectName.ToString());
...
bool FMetaHumanLocalLiveLinkSubject::PushFrameData()
{
	...
	UE_LOGF(LogMetaHumanLocalLiveLinkSubject, Verbose, "New frame");
