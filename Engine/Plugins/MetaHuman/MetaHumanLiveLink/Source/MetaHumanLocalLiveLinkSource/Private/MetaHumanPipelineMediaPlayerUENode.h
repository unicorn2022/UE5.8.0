...
private:
	...
	bool bIsMediaSource = false;
	bool bIsMediaProfile = false;
	...
	TObjectPtr<UMediaSource> VideoMediaSource = nullptr;
	TObjectPtr<UMediaSource> AudioMediaSource = nullptr;
	TWeakObjectPtr<UMediaProfile> MediaProfile = nullptr;
