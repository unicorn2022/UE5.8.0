...
public:
	...
	static void GetVideoDevicesOfType(TArray<FMetaHumanLiveLinkVideoDevice>& VideoDevices, EMetaHumanLocalLiveLinkSourceDeviceType DeviceType);
	...
	UFUNCTION(BlueprintCallable, Category = "MetaHuman Live Link", meta = (AutoCreateRefTerm = "MonocularAnimationPipelineModels"))
	static void CreateVideoSubject(const FLiveLinkSourceHandle& VideoSource, const FMetaHumanLiveLinkVideoFormat& VideoFormat, const FString& SubjectName, FLiveLinkSubjectKey& VideoSubject, bool& Succeeded, float StartTimeout = 5, float FormatWaitTime = 0.1, float SampleTimeout = 5, const FMonocularAnimationPipelineModels& MonocularAnimationPipelineModels = FMonocularAnimationPipelineModels());

	UFUNCTION(BlueprintCallable, Category = "MetaHuman Live Link")
	static void GetAudioDevicesOfType(TArray<FMetaHumanLiveLinkAudioDevice>& AudioDevices, EMetaHumanLocalLiveLinkSourceDeviceType DeviceType);
