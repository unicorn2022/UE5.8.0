...
#include "MetaHumanVideoBaseLiveLinkSubjectMonitorWidget.generated.h"
...
private:
	...
	TObjectPtr<UMetaHumanVideoBaseLiveLinkSubjectSettings> Settings = nullptr;
...
UCLASS(MinimalAPI)
class UMetaHumanVideoBaseLiveLinkSubjectMonitorWidget : public UWidget
{
public:

	GENERATED_BODY()

	UFUNCTION(BlueprintCallable, Category = "MetaHumanLiveLink")
	void SetSubjectSettings(UMetaHumanVideoBaseLiveLinkSubjectSettings* InSettings);

protected:

	// UWidget interface
	virtual TSharedRef<SWidget> RebuildWidget() override;
	virtual void ReleaseSlateResources(bool) override;
	// End of UWidget interface

private:

	TSharedPtr<SMetaHumanVideoBaseLiveLinkSubjectMonitorWidget> Widget = nullptr;
