...
struct FMetaHumanCharacterTeethProperties
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Teeth", meta = (UIMin = "-1", UIMax = "1", ClampMin = "-1", ClampMax = "1"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Teeth", meta = (UIMin = "0", UIMax = "1", ClampMin = "0", ClampMax = "1"))
	float WornDown = 0.0f;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Teeth", meta = (HideAlphaChannel))
