...
USTRUCT()
struct FMetaHumanBodyRigLogicGeneratedAsset
{
	GENERATED_BODY()
...
struct FMetaHumanCharacterGeneratedAssets
{
	 ...
	 */
	METAHUMANCHARACTER_API bool RemoveAssetMetadata(TNotNull<const UObject*> InAsset);
};

struct FMetaHumanCharacterGeneratedAssetOptions
{
	bool bGenerateFaceMesh = true;
	bool bGenerateBodyMesh = true;

	bool bGenerateMergedHeadAndBodyMesh = false;
	bool bGenerateBodyMeasurements = false;

	bool operator==(const FMetaHumanCharacterGeneratedAssetOptions& Other) const = default;
	bool operator!=(const FMetaHumanCharacterGeneratedAssetOptions& Other) const = default;
};
