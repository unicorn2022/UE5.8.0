...
struct METAHUMANCHARACTER_API FMetaHumanCharacterCustomVersion
{
	enum Type : int32
	{
		...
		// Body target pose states serialized to character
		BodyTargetPoseStatesSerialized,
		// Face model coefficients at target pose serialized to character
		FaceModelCoefficientsAtTargetPoseSerialized,
