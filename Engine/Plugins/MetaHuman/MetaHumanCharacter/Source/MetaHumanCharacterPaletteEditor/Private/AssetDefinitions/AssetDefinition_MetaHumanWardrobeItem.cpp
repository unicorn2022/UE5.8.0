...
{
	static const FAssetCategoryPath Path(LOCTEXT("MetaHumanAssetCategoryPath", "MetaHuman"), LOCTEXT("MetaHumanAdvancedAssetCategoryLabel", "Advanced"), ECategoryMenuType::Section);
