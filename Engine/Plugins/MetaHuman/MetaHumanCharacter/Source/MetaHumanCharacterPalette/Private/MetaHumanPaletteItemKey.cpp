...
FMetaHumanPaletteItemKey::FMetaHumanPaletteItemKey() = default;
FMetaHumanPaletteItemKey::~FMetaHumanPaletteItemKey() = default;
FMetaHumanPaletteItemKey::FMetaHumanPaletteItemKey(const FMetaHumanPaletteItemKey&) = default;
FMetaHumanPaletteItemKey::FMetaHumanPaletteItemKey(FMetaHumanPaletteItemKey&&) = default;
FMetaHumanPaletteItemKey& FMetaHumanPaletteItemKey::operator=(const FMetaHumanPaletteItemKey&) = default;
FMetaHumanPaletteItemKey& FMetaHumanPaletteItemKey::operator=(FMetaHumanPaletteItemKey&&) = default;

FMetaHumanPaletteItemKey FMetaHumanPaletteItemKey::FromPrincipalAsset(const TSoftObjectPtr<UObject>& InPrincipalAsset, const FName& InVariation)
{
	...
	FMetaHumanPaletteItemKey Result;
	Result.Variation = InVariation;
	Result.PrincipalAssetOrExternalWardrobeItem = InPrincipalAsset;
	Result.bReferencesExternalWardrobeItem = false;

	return Result;
}

FMetaHumanPaletteItemKey FMetaHumanPaletteItemKey::FromExternalWardrobeItem(const TSoftObjectPtr<UMetaHumanWardrobeItem>& InExternalWardrobeItem, const FName& InVariation)
{
	check(!InExternalWardrobeItem.ToSoftObjectPath().IsSubobject());

	FMetaHumanPaletteItemKey Result;
	Result.Variation = InVariation;
	Result.PrincipalAssetOrExternalWardrobeItem = InExternalWardrobeItem.ToSoftObjectPath();
	Result.bReferencesExternalWardrobeItem = true;
...
bool FMetaHumanPaletteItemKey::TryGetPrincipalAsset(FEditorOnlyAssetReference& OutPrincipalAsset) const
{
...
bool FMetaHumanPaletteItemKey::TryGetExternalWardrobeItem(FEditorOnlyAssetReference& OutWardrobeItem) const
{
	if (bReferencesExternalWardrobeItem)
	{
		OutWardrobeItem = PrincipalAssetOrExternalWardrobeItem;
		return true;
	}
	else
	{
