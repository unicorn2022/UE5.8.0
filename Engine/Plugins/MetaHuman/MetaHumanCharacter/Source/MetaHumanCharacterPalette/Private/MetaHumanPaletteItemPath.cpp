...
FMetaHumanPaletteItemPath::FMetaHumanPaletteItemPath() = default;
FMetaHumanPaletteItemPath::~FMetaHumanPaletteItemPath() = default;
FMetaHumanPaletteItemPath::FMetaHumanPaletteItemPath(const FMetaHumanPaletteItemPath&) = default;
FMetaHumanPaletteItemPath::FMetaHumanPaletteItemPath(FMetaHumanPaletteItemPath&&) = default;
FMetaHumanPaletteItemPath& FMetaHumanPaletteItemPath::operator=(const FMetaHumanPaletteItemPath&) = default;
FMetaHumanPaletteItemPath& FMetaHumanPaletteItemPath::operator=(FMetaHumanPaletteItemPath&&) = default;
...
int32 FMetaHumanPaletteItemPath::Compare(const FMetaHumanPaletteItemPath& Other) const
{
	...
	{
		// This path is longer and therefore "more" than the Other path
		return 1;
	}
	...
	// and therefore this path is "less".
...
uint32 GetTypeHash(const FMetaHumanPaletteItemPath& ItemKey)
{
