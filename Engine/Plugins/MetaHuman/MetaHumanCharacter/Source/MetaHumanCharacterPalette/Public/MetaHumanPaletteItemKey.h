...
public:
	...
	~FMetaHumanPaletteItemKey();
	FMetaHumanPaletteItemKey(const FMetaHumanPaletteItemKey&);
	FMetaHumanPaletteItemKey(FMetaHumanPaletteItemKey&&);
	FMetaHumanPaletteItemKey& operator=(const FMetaHumanPaletteItemKey&);
	FMetaHumanPaletteItemKey& operator=(FMetaHumanPaletteItemKey&&);

	static FMetaHumanPaletteItemKey FromPrincipalAsset(const TSoftObjectPtr<UObject>& InPrincipalAsset, const FName& InVariation);
	static FMetaHumanPaletteItemKey FromExternalWardrobeItem(const TSoftObjectPtr<UMetaHumanWardrobeItem>& InExternalWardrobeItem, const FName& InVariation);
	 ...
	 */
	[[nodiscard]] bool TryGetPrincipalAsset(FEditorOnlyAssetReference& OutPrincipalAsset) const;
	 ...
	 * Otherwise, it will fail and return nothing.
	 */
	[[nodiscard]] bool TryGetExternalWardrobeItem(FEditorOnlyAssetReference& OutWardrobeItem) const;
...
private:
	UPROPERTY(VisibleAnywhere, Category = "Pipeline", meta = (ShowOnlyInnerProperties))
	FEditorOnlyAssetReference PrincipalAssetOrExternalWardrobeItem;
