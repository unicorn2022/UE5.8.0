...
public:
	...
	virtual void InitializeMetaHumanCharacterEditorActor(
		TNotNull<const UMetaHumanInstance*> InCharacterInstance,
...
protected:
	...
	UFUNCTION(BlueprintImplementableEvent, Category = "MetaHuman|Character", meta = (DisplayName = "SetHairVisibilityState"))
	 ...
	 */
	UFUNCTION(BlueprintImplementableEvent, Category = "MetaHuman|Character", meta = (DisplayName = "SetClothingVisibilityState"))
	...
	TObjectPtr<const class UMetaHumanInstance> CharacterInstance;
...
private:
	...
	/** Apply pending component render-state changes now instead of waiting for the next world tick. */
	void FlushPendingRenderStateUpdates() const;
};
