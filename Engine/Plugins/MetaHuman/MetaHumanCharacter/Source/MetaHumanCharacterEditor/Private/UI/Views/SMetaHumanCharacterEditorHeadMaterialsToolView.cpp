...
TSharedRef<SWidget> SMetaHumanCharacterEditorHeadMaterialsToolView::CreateEyelashesSubToolViewMaterialSection()
{
	...
	const void* EyelashesPropertiesDefault = &HeadModelProperties->GetClass()->GetDefaultObject<UMetaHumanCharacterHeadModelEyelashesProperties>()->Eyelashes;
	const TSharedRef<SWidget> EyelashesMaterialWidget =
		...
		[
			...
			.AutoHeight()
			[
				CreatePropertyColorPickerWidget(DyeColorProperty->GetDisplayNameText(), DyeColorProperty, EyelashesProperties, EyelashesPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertyUVColorPickerWidget(MelaninProperty, RednessProperty, EyelashesProperties, EyelashesPropertiesDefault,
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidget(RoughnessProperty->GetDisplayNameText(), RoughnessProperty, EyelashesProperties, EyelashesPropertiesDefault)
			]
...
TSharedRef<SWidget> SMetaHumanCharacterEditorHeadMaterialsToolView::CreateTeethSubToolViewMaterialsSection()
{
	...
	const void* TeethPropertiesDefault = &HeadModelProperties->GetClass()->GetDefaultObject<UMetaHumanCharacterHeadModelTeethProperties>()->Teeth;
	const TSharedRef<SWidget> TeetParametersWidget =
		...
		[
			...
			.AutoHeight()
			[
				CreatePropertyColorPickerWidget(TeethColorProperty->GetDisplayNameText(), TeethColorProperty, TeethProperties, TeethPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertyColorPickerWidget(GumColorProperty->GetDisplayNameText(), GumColorProperty, TeethProperties, TeethPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertyColorPickerWidget(PlaqueColorProperty->GetDisplayNameText(), PlaqueColorProperty, TeethProperties, TeethPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidget(PlaqueAmountProperty->GetDisplayNameText(), PlaqueAmountProperty, TeethProperties, TeethPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidget(JawOpenProperty->GetDisplayNameText(), JawOpenProperty, TeethProperties, TeethPropertiesDefault)
			]
		];
