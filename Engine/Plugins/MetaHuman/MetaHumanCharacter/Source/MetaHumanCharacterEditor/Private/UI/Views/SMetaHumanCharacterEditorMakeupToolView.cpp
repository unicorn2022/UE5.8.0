...
TSharedRef<SWidget> SMetaHumanCharacterEditorMakeupToolView::CreateMakeupToolViewFoundationSection()
{
	...
	const void* FoundationPropertiesDefault = &MakeupToolProperties->GetClass()->GetDefaultObject<UMetaHumanCharacterEditorMakeupToolProperties>()->Foundation;
	const TSharedRef<SWidget> FoundationSectionWidget =
		...
		[
			...
			.AutoHeight()
			[
				CreatePropertyCheckBoxWidget(ApplyFoundationProperty->GetDisplayNameText(), ApplyFoundationProperty, FoundationProperties, FoundationPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidget(IntensityProperty->GetDisplayNameText(), IntensityProperty, FoundationProperties, FoundationPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidget(RoughnessProperty->GetDisplayNameText(), RoughnessProperty, FoundationProperties, FoundationPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidget(ConcealerProperty->GetDisplayNameText(), ConcealerProperty, FoundationProperties, FoundationPropertiesDefault)
			]
		];
...
TSharedRef<SWidget> SMetaHumanCharacterEditorMakeupToolView::CreateMakeupToolViewEyesSection()
{
	...
	const void* EyesPropertiesDefault = &MakeupToolProperties->GetClass()->GetDefaultObject<UMetaHumanCharacterEditorMakeupToolProperties>()->Eyes;
	const TSharedRef<SWidget> EyesSectionWidget =
		...
		[
			...
			.AutoHeight()
			[
				CreatePropertyColorPickerWidget(PrimaryColorProperty->GetDisplayNameText(), PrimaryColorProperty, EyesProperties, EyesPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertyColorPickerWidget(SecondaryColorProperty->GetDisplayNameText(), SecondaryColorProperty, EyesProperties, EyesPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidget(RoughnessProperty->GetDisplayNameText(), RoughnessProperty, EyesProperties, EyesPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidget(OpacityProperty->GetDisplayNameText(), OpacityProperty, EyesProperties, EyesPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidget(MetalnessProperty->GetDisplayNameText(), MetalnessProperty, EyesProperties, EyesPropertiesDefault)
			]
		];
...
TSharedRef<SWidget> SMetaHumanCharacterEditorMakeupToolView::CreateMakeupToolViewBlushSection()
{
	...
	const void* BlushPropertiesDefault = &MakeupToolProperties->GetClass()->GetDefaultObject<UMetaHumanCharacterEditorMakeupToolProperties>()->Blush;
	const TSharedRef<SWidget> BlushSectionWidget =
		...
		[
			...
			.AutoHeight()
			[
				CreatePropertyColorPickerWidget(ColorProperty->GetDisplayNameText(), ColorProperty, BlushProperties, BlushPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidget(IntensityProperty->GetDisplayNameText(), IntensityProperty, BlushProperties, BlushPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidget(RoughnessProperty->GetDisplayNameText(), RoughnessProperty, BlushProperties, BlushPropertiesDefault)
			]
		];
...
TSharedRef<SWidget> SMetaHumanCharacterEditorMakeupToolView::CreateMakeupToolViewLipsSection()
{
	...
	const void* LipsPropertiesDefault = &MakeupToolProperties->GetClass()->GetDefaultObject<UMetaHumanCharacterEditorMakeupToolProperties>()->Lips;
	const TSharedRef<SWidget> LipsSectionWidget =
		...
		[
			...
			.AutoHeight()
			[
				CreatePropertyColorPickerWidget(ColorProperty->GetDisplayNameText(), ColorProperty, LipsProperties, LipsPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidget(RoughnessProperty->GetDisplayNameText(), RoughnessProperty, LipsProperties, LipsPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidget(OpacityProperty->GetDisplayNameText(), OpacityProperty, LipsProperties, LipsPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidget(MetalnessProperty->GetDisplayNameText(), MetalnessProperty, LipsProperties, LipsPropertiesDefault)
			]
		];
