...
void SMetaHumanCharacterEditorToolPanel::Construct(const FArguments& InArgs)
{
	...
	const FLinearColor MidLevelBorderLabelColor = FLinearColor(.02f, .02f, .02f, 1.f);
	const FLinearColor LowLevelBorderLabelColor = FLinearColor(.015f, .015f, .015f, 1.f);

	const FLinearColor TopLevelBorderBackgroundColor = FLinearColor(.02f, .02f, .02f, 1.f);
	const FLinearColor MidLevelBorderBackgroundColor = FLinearColor(.015f, .015f, .015f, 1.f);
	const FLinearColor LowLevelBorderBackgroundColor = FLinearColor(.005f, .005f, .005f, 1.f);
