...
TSharedRef<SWidget> SMetaHumanCharacterEditorHeadModelToolView::CreateEyelashesSubToolViewMaterialSection()
{
	...
	const TSharedRef<SWidget> EyelashesMaterialWidget =
		...
		[
			...
			.AutoHeight()
			[				
				CreatePropertyCheckBoxWidget(EnableGroomsProperty->GetDisplayNameText(), EnableGroomsProperty, EyelashesProperties, EyelashesPropertiesDefault)
			]
	];
		...
		[
			...
			[
				...
				[
					...
					.CurrentValue_Lambda([this, EditablePropertyProperty, HeadModelProperties]()
					{
						return GetEnumPropertyValue<EMetaHumanCharacterTeethPropertyType>(EditablePropertyProperty, HeadModelProperties);
					})
				...
				.AutoWidth()
				[
					CreatePropertyResetButton(TeethProperty, TeethProperties, TeethPropertiesDefault)
				]
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidget(VariationProperty->GetDisplayNameText(), VariationProperty, TeethProperties, TeethPropertiesDefault)
			]
