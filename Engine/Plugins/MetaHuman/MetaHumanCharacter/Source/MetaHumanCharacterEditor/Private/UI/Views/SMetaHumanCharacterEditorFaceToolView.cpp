...
UInteractiveToolPropertySet* SMetaHumanCharacterEditorFaceToolView::GetToolProperties() const
{
	...
	return IsValid(FaceTool) ? FaceTool->GetHeadAndBodyParameterProperties() : nullptr;
}
...
TSharedRef<SWidget> SMetaHumanCharacterEditorFaceToolView::CreateManipulatorsViewSection()
{
	...
	return 
		...
		.AutoHeight()
		[
			CreatePropertySpinBoxWidget(SizeProperty->GetDisplayNameText(), SizeProperty, ManipulatorProperties, ManipulatorPropertiesDefault)
		]
		+ SVerticalBox::Slot()
		.AutoHeight()
		[
			CreatePropertySpinBoxWidget(SpeedProperty->GetDisplayNameText(), SpeedProperty, ManipulatorProperties, ManipulatorPropertiesDefault)
		]
		+ SVerticalBox::Slot()
		.AutoHeight()
		[
		...
		.AutoHeight()
		[
			CreatePropertyCheckBoxWidget(HideProperty->GetDisplayNameText(), HideProperty, ManipulatorProperties, ManipulatorPropertiesDefault)
		];
}
...
TSharedRef<SWidget> SMetaHumanCharacterEditorFaceToolView::CreateHeadParametersViewSection()
{
	...
	FProperty* HeadDeltaProperty = UMetaHumanCharacterEditorHeadAndBodyParameterProperties::StaticClass()->FindPropertyByName(GET_MEMBER_NAME_CHECKED(UMetaHumanCharacterEditorHeadAndBodyParameterProperties, FaceDelta));
	...
	return 
		...
		.AutoHeight()
		[
			CreatePropertySpinBoxWidget(HeadDeltaProperty->GetDisplayNameText(), HeadDeltaProperty, HeadParameterProperties, HeadParameterPropertiesDefault)
		]
