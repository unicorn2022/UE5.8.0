...
static FText GetLabelForConstraintName(const FName& ConstraintName)
{
	...
	else if (ConstraintName == "Hand Circumference")
	{
		LabelText = LOCTEXT("HandCircumferenceLabelText", "Hand Circumference");
	}
...
static FText GetToolTipForConstraintName(const FName& ConstraintName)
{
	...
	{
		ToolTipText = LOCTEXT("HandCircumferenceToolTipText", "Specify hand circumference (cm)");
	}
	else if (ConstraintName == "Inseam")
	{
