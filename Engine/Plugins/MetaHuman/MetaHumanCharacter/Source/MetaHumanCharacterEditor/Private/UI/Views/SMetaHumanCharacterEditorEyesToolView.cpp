	...
	return SNew(SMetaHumanCharacterEditorToolPanel)
		...
		[
			...
			[
				...
				.OnMouseButtonDoubleClick_Lambda([this, EyesToolProperties](FEyePresetItemPtr Item)
				{
					if (Item.IsValid())
					{
						...
						if (IrisPatternTileView.IsValid())
						{
							const TSharedPtr<STileView<TSharedPtr<EMetaHumanCharacterEyesIrisPattern>>> TileView = IrisPatternTileView->GetTileView();
							if (TileView.IsValid())
							{
								for (const TSharedPtr<EMetaHumanCharacterEyesIrisPattern>& TileViewItem: IrisPatternTileView->GetTileViewItems())
								{
									if (*TileViewItem == EyesToolProperties->Eye.Iris.IrisPattern)
									{
										TileView->SetSelection(TileViewItem);
										break;
									}
								}
							}
...
TSharedRef<SWidget> SMetaHumanCharacterEditorEyesToolView::CreateEyesToolViewIrisSection()
{
	...
	const void* IrisPropertiesDefault = &EyesToolProperties->GetClass()->GetDefaultObject<UMetaHumanCharacterEditorEyesToolProperties>()->Eye.Iris;
	const TSharedRef<SWidget> IrisSectionWidget =
		...
		[
			...
			.AutoHeight()
			[
				SAssignNew(IrisPatternTileView, SMetaHumanCharacterEditorTileView<EMetaHumanCharacterEyesIrisPattern>)
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidget(IrisRotationProperty->GetDisplayNameText(), IrisRotationProperty, IrisProperties, IrisPropertiesDefault)
			]

			+ SVerticalBox::Slot()
			.AutoHeight()
			[
				CreatePropertyUVColorPickerWidget(PrimaryColorUProperty, PrimaryColorVProperty, IrisProperties, IrisPropertiesDefault, LOCTEXT("IrisPrimaryColor", "Primary Color"), IrisColorPicker)
			]

			+ SVerticalBox::Slot()
			.AutoHeight()
			[
				CreatePropertyUVColorPickerWidget(SecondaryColorUProperty, SecondaryColorVProperty, IrisProperties, IrisPropertiesDefault, LOCTEXT("IrisSecondaryColor", "Secondary Color"), IrisColorPicker)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidget(ColorBlendProperty->GetDisplayNameText(), ColorBlendProperty, IrisProperties, IrisPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertyComboBoxWidget<EMetaHumanCharacterEyesBlendMethod>(BlendMethodProperty->GetDisplayNameText(), IrisProperties->BlendMethod, BlendMethodProperty, IrisProperties, IrisPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidget(ShadowDetailsProperty->GetDisplayNameText(), ShadowDetailsProperty, IrisProperties, IrisPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidgetNormalized(LimbalRingSizeProperty, IrisProperties, IrisPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidgetNormalized(LimbalRingSoftnessProperty, IrisProperties, IrisPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertyColorPickerWidget(LimbalRingColorProperty->GetDisplayNameText(), LimbalRingColorProperty, IrisProperties, IrisPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidgetNormalized(GlobalSaturationProperty, IrisProperties, IrisPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertyColorPickerWidget(GlobalTintProperty->GetDisplayNameText(), GlobalTintProperty, IrisProperties, IrisPropertiesDefault)
			]
		];
...
TSharedRef<SWidget> SMetaHumanCharacterEditorEyesToolView::CreateEyeToolViewPupilSection()
{
	...
	const void* PupilPropertiesDefault = &EyesToolProperties->GetClass()->GetDefaultObject<UMetaHumanCharacterEditorEyesToolProperties>()->Eye.Pupil;
	TSharedRef<SWidget> PupilSectionWidget =
		...
		[
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidgetNormalized(DilationProperty, PupilProperties, PupilPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidgetNormalized(FeatherProperty, PupilProperties, PupilPropertiesDefault)
			]
		];
...
TSharedRef<SWidget> SMetaHumanCharacterEditorEyesToolView::CreateEyeCorneaViewSection()
{
	...
	const void* CorneaPropertiesDefault = &EyesToolProperties->GetClass()->GetDefaultObject<UMetaHumanCharacterEditorEyesToolProperties>()->Eye.Cornea;
	TSharedRef<SWidget> CorneaSectionWidget =
		...
		[
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidgetNormalized(SizeProperty, CorneaProperties, CorneaPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidgetNormalized(LimbusSoftnessProperty, CorneaProperties, CorneaPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertyColorPickerWidget(LimbusColorProperty->GetDisplayNameText(), LimbusColorProperty, CorneaProperties, CorneaPropertiesDefault)
			]
		];
...
TSharedRef<SWidget> SMetaHumanCharacterEditorEyesToolView::CreateEyesToolViewScleraSection()
{
	...
	const void* ScleraPropertiesDefault = &EyesToolProperties->GetClass()->GetDefaultObject<UMetaHumanCharacterEditorEyesToolProperties>()->Eye.Sclera;
	const TSharedRef<SWidget> ScleraSectionWidget =
		...
		[
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidget(RotationProperty->GetDisplayNameText(), RotationProperty, ScleraProperties, ScleraPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertyCheckBoxWidget(UseCustomTintProperty->GetDisplayNameText(), UseCustomTintProperty, ScleraProperties, ScleraPropertiesDefault)
			]
			...
			[
				...
				[
					CreatePropertyColorPickerWidget(TintProperty->GetDisplayNameText(), TintProperty, ScleraProperties, ScleraPropertiesDefault)
				]
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidgetNormalized(TransmissionSpreadProperty, ScleraProperties, ScleraPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertyColorPickerWidget(TransmissionColorProperty->GetDisplayNameText(), TransmissionColorProperty, ScleraProperties, ScleraPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidgetNormalized(VascularityInstensityProperty, ScleraProperties, ScleraPropertiesDefault)
			]
			...
			.AutoHeight()
			[
				CreatePropertySpinBoxWidgetNormalized(VascularityCoverageProperty, ScleraProperties, ScleraPropertiesDefault)
			]
		];
