...
public:
	...
	UPROPERTY(EditAnywhere, Transient, Category = "FaceAnimation", meta = (EditCondition = "AnimationController == EMetaHumanCharacterAnimationController::AnimSequence", EditConditionHides))
	EMetaHumanAnimationType FaceAnimationType = EMetaHumanAnimationType::SpecificAnimation;

	UPROPERTY(EditAnywhere, Transient, Category = "FaceAnimation",meta = (EditCondition = "AnimationController == EMetaHumanCharacterAnimationController::AnimSequence && FaceAnimationType == EMetaHumanAnimationType::SpecificAnimation", EditConditionHides))
	TObjectPtr<UAnimSequence> FaceSpecificAnimation;

	UPROPERTY(EditAnywhere, Transient, Category = "FaceAnimation", meta = (EditCondition = "AnimationController == EMetaHumanCharacterAnimationController::AnimSequence && FaceAnimationType == EMetaHumanAnimationType::TemplateAnimation", EditConditionHides, GetOptions="GetTemplateAnimationOptions"))
	FName FaceTemplateAnimation;
	
	// Anim sequence Body Animation options
	UPROPERTY(EditAnywhere, Transient, Category = "BodyAnimation", meta = (EditCondition = "AnimationController == EMetaHumanCharacterAnimationController::AnimSequence", EditConditionHides))
	EMetaHumanAnimationType BodyAnimationType = EMetaHumanAnimationType::SpecificAnimation;

	UPROPERTY(EditAnywhere, Transient, Category = "BodyAnimation",meta = (EditCondition = "AnimationController == EMetaHumanCharacterAnimationController::AnimSequence && BodyAnimationType == EMetaHumanAnimationType::SpecificAnimation", EditConditionHides))
	TObjectPtr<UAnimSequence> BodySpecificAnimation;

	UPROPERTY(EditAnywhere, Transient, Category = "BodyAnimation",meta = (EditCondition = "AnimationController == EMetaHumanCharacterAnimationController::AnimSequence && BodyAnimationType == EMetaHumanAnimationType::TemplateAnimation", EditConditionHides, GetOptions = "GetTemplateAnimationOptions"))
