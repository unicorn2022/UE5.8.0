	...
	: FSlateStyleSet{ TEXT("MetaHumanCharacterEditorStyle") }
{
	...
	Set(TEXT("MetaHumanCharacterEditorTools.Rounded.Transparency.DefaultBrush"), new FSlateRoundedBoxBrush(FLinearColor(.04f, .04f, .04f, .7f), 4.f));
	...
	Set(TEXT("MetaHumanCharacterEditorTools.ThumbnailType"), new IMAGE_BRUSH_SVG("UI/Icons/ThumbnailType", Icon16));
	...
	Set(TEXT("MetaHumanCharacterEditorTools.LoadMeshImportTools"), new IMAGE_BRUSH_SVG("UI/Icons/Ribbon_Import", Icon16));
	Set(TEXT("MetaHumanCharacterEditorTools.BeginImportFromDNATool"), new IMAGE_BRUSH("UI/Icons/Tools_Import_FromDNA", Icon32));
	Set(TEXT("MetaHumanCharacterEditorTools.BeginImportFromIdentityTool"), new IMAGE_BRUSH("UI/Icons/Tools_Import_FromIdentity", Icon32));
	Set(TEXT("MetaHumanCharacterEditorTools.BeginImportFromTemplateTool"), new IMAGE_BRUSH_SVG("UI/Icons/Tools_Import_FromTemplate", Icon6));
	Set(TEXT("MetaHumanCharacterEditorTools.BeginImportFromCustomMeshTool"), new IMAGE_BRUSH_SVG("UI/Icons/Tools_Import_FromCustomMesh", Icon6));
	Set(TEXT("MetaHumanCharacterEditorTools.BeginImportFromImageTool"), new IMAGE_BRUSH_SVG("UI/Icons/Tools_Import_FromImage", Icon6));

	Set(TEXT("MetaHumanCharacterEditorTools.BeginAddRemoveLandmarkTool"), new IMAGE_BRUSH_SVG("UI/Icons/Tool_16", Icon16));
	
	Set(TEXT("MetaHumanCharacterEditorTools.LoadHeadAndBodyTools"), new IMAGE_BRUSH_SVG("UI/Icons/Ribbon_Body", Icon16));
	...
	Set(TEXT("MetaHumanCharacterEditorTools.BeginHeadAndBodyBlendTool"), new IMAGE_BRUSH_SVG("UI/Icons/Tools_Body_Blend", Icon16));
	...
	Set(TEXT("MetaHumanCharacterEditorTools.BeginTextureMaterialOverrideTool"), new IMAGE_BRUSH_SVG("UI/Icons/Ribbon_Materials", Icon16));
	...
	Set(TEXT("MetaHumanCharacterEditorTools.LoadExportTools"), new CORE_IMAGE_BRUSH_SVG("Starship/Common/export", Icon16));
	Set(TEXT("MetaHumanCharacterEditorTools.BeginDCCExportTool"), new CORE_IMAGE_BRUSH_SVG("Starship/Common/export", Icon6));
	Set(TEXT("MetaHumanCharacterEditorTools.BeginDNAExportTool"), new CORE_IMAGE_BRUSH_SVG("Starship/Common/export", Icon6));
	Set(TEXT("MetaHumanCharacterEditorTools.BeginGeometryExportTool"), new CORE_IMAGE_BRUSH_SVG("Starship/Common/export", Icon6));
	Set(TEXT("MetaHumanCharacterEditorTools.BeginMaterialsExportTool"), new CORE_IMAGE_BRUSH_SVG("Starship/Common/export", Icon6));
	...
	Set(TEXT("Eyelashes.ShortSparse"), new IMAGE_BRUSH(TEXT("UI/Eyelashes/Sparse"), Icon512));
	Set(TEXT("Eyelashes.ShortFine"), new IMAGE_BRUSH(TEXT("UI/Eyelashes/ShortFine"), Icon512));
	Set(TEXT("Eyelashes.ShortThin"), new IMAGE_BRUSH(TEXT("UI/Eyelashes/Thin"), Icon512));
	Set(TEXT("Eyelashes.LongSlightCurl"), new IMAGE_BRUSH(TEXT("UI/Eyelashes/SlightCurl"), Icon512));
	Set(TEXT("Eyelashes.LongCurl"), new IMAGE_BRUSH(TEXT("UI/Eyelashes/LongCurl"), Icon512));
	Set(TEXT("Eyelashes.LongThickCurl"), new IMAGE_BRUSH(TEXT("UI/Eyelashes/ThickCurl"), Icon512));
	...
	Set(TEXT("MetaHumanCharacterEditorTools.BlendTool.Human"), new IMAGE_BRUSH_SVG("UI/Common/BlendTool_Human", FVector2D(197.f, 310.f)));
	Set(TEXT("MetaHumanCharacterEditorTools.BlendTool.Camera"), new IMAGE_BRUSH_SVG("UI/Common/Camera", Icon24));
