...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "MetaHuman|Lighting")
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "MetaHuman|Background")
