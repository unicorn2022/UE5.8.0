...
{
	if (!CharacterInstance->GetExistingAssemblyOutput().GetPtr<FMetaHumanDefaultAssemblyOutput>())
	{
	...
	const FMetaHumanDefaultAssemblyOutput& AssemblyOutput = CharacterInstance->GetExistingAssemblyOutput().Get<FMetaHumanDefaultAssemblyOutput>();
