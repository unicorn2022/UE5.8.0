...
#include "ChaosClothAsset/USDImportNode_v2.h"  // for FChaosClothAssetUsdClothData
#include "Dataflow/DataflowNode.h"
#include "Dataflow/DataflowFunctionProperty.h"
#include "GeometryCollection/ManagedArrayCollection.h"
#include "USDImportNode_v3.generated.h"

class UStaticMesh;

/** Import a USD file from a third party garment construction software. */
USTRUCT(Meta = (DataflowCloth))
struct FChaosClothAssetUSDImportNode_v3 : public FDataflowNode
{
	GENERATED_USTRUCT_BODY()
	DATAFLOW_NODE_DEFINE_INTERNAL(FChaosClothAssetUSDImportNode_v3, "USDImport", "Cloth", "Cloth USD Import")
...
public:
	...
	FChaosClothAssetUSDImportNode_v3(const UE::Dataflow::FNodeParameters & InParam, FGuid InGuid = FGuid::NewGuid());
