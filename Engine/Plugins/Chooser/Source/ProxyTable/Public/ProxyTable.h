...
public:
	...
	void FindProxyObject(const FGuid& Key, FChooserEvaluationContext& Context, TSoftObjectPtr<UObject>& Result) const;
	FObjectChooserBase::EIteratorStatus FindProxyObjectMulti(const FGuid& Key, FChooserEvaluationContext& Context,
	                                                         FObjectChooserBase::FObjectChooserSoftObjectIteratorCallback Callback) const;
