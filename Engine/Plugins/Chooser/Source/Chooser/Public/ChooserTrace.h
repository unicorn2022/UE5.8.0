...
{
	static UE_API void OutputChooserEvaluation(const UObject* ChooserAsset, const FChooserEvaluationContext& Context, int32 SelectedIndex);
	static UE_API void OutputChooserEvaluation(const UObject* ChooserAsset, const FChooserEvaluationContext& Context, const FChooserIndexArray& SelectedIndex);
