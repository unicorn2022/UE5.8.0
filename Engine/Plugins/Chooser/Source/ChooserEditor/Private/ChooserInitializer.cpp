...
void FGenericChooserInitializer::InitializeSignature(UChooserSignature* Chooser) const
{
...
void FChooserPlayerInitializer::InitializeSignature(UChooserSignature* Chooser) const
{
...
void FNoPrimaryResultChooserInitializer::InitializeSignature(UChooserSignature* Chooser) const
{
	Chooser->ContextData = ContextData;
