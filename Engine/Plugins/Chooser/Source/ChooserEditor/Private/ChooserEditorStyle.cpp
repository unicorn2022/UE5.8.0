	...
	FSlateStyleSet("ChooserEditorStyle")
{
	...
	// tab icon
	Set("ChooserEditor.ChooserTableIconSmall", new IMAGE_BRUSH_SVG("Chooser", Icon16x16));
	
	Set("ChooserEditor.FallbackIcon", new IMAGE_BRUSH_SVG("Fallback", Icon16x16));
	
	// content browser icon
	Set("ChooserEditor.NestedChooserIcon", new IMAGE_BRUSH_SVG("NestedChooser", Icon16x16));
}
