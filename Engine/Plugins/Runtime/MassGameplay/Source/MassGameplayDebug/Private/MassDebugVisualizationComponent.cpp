...
int32 UMassDebugVisualizationComponent::AddDebugVisInstance(const uint16 VisualType, const FTransformFragment& Transform)
{
	return VisualDataISMCs[VisualType]->AddInstance(Transform.GetTransform());
}
