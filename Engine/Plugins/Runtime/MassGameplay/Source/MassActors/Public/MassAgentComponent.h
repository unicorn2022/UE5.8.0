...
public:
	...
	/** Called when a puppet actor is destroyed before its NetID was replicated (e.g., Iris relevancy). */
	UE_API void PuppetReplicationAborted();
...
protected:
	...
	UE_API virtual void SetEntityHandleInternal(const FMassEntityHandle NewHandle);
