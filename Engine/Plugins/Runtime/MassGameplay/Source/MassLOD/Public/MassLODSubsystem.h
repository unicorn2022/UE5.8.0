...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	/** Effective horizontal field of view in degrees at the viewer's actual viewport. */
	float FOV = 90.0f;

	/** Effective viewport aspect ratio (W/H) used when constructing the cull frustum. */
