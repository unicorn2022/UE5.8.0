...
{
	extern MASSCOMMON_API const FName UpdateWorldFromMass;
	extern MASSCOMMON_API const FName SyncWorldToMass;
	extern MASSCOMMON_API const FName Behavior;
	extern MASSCOMMON_API const FName Tasks;
	extern MASSCOMMON_API const FName Avoidance;
	extern MASSCOMMON_API const FName ApplyForces;
	extern MASSCOMMON_API const FName Movement;
}
