...
#define GET_MASSSIMULATION_CONFIG_VALUE(a) \
	UE_DEPRECATED_MACRO(5.8, "Use GetDefault<UMassSimulationSettings>() (or GetMutableDefault) directly.") \
	(GetMutableDefault<UMassSimulationSettings>()->a)
