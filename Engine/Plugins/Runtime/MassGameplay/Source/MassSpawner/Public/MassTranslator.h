...
public:
	 ...
	 * 
	 *  @param InOutTags - this translator's expected tags will be added to this parameter */
	UE_DEPRECATED(5.8, "This function is deprecated, please fetch the tags directly with GetRequiredTags and append then wherever you want.")
	void AppendRequiredTags(FMassTagBitSet& InOutTags) const 
	{
		InOutTags += RequiredTags; 
	}

	FMassTagBitSet GetRequiredTags() const 
	{
		return RequiredTags; 
	}
