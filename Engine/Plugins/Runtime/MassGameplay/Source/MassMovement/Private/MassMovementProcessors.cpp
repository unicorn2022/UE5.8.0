...
void UMassApplyMovementProcessor::ConfigureQueries(const TSharedRef<FMassEntityManager>& EntityManager)
{
	...
	EntityQuery.AddConstSharedRequirement<FSpringMovementSettings>(EMassFragmentPresence::None);	// Do not apply simple movement processor if spring is being used
	EntityQuery.AddTagRequirement<FMassCustomMovementTag>(EMassFragmentPresence::None);	// Do not apply if a custom movement processor handles this entity
	EntityQuery.AddTagRequirement<FMassOffLODTag>(EMassFragmentPresence::None);
