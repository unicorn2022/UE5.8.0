...
class UGameplayInteractionSmartObjectBehaviorDefinition : public USmartObjectBehaviorDefinition
{
	GENERATED_BODY()
public:
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "SmartObject", DisplayName = "State Tree", meta=(Schema="/Script/GameplayInteractionsModule.GameplayInteractionStateTreeSchema"))
