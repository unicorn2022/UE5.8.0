...
{
	extern GAMEPLAYINTERACTIONSMODULE_API const FName ContextActor;	// The actor performing the interaction, using short name to be consistent with naming with StateTreeComponentSchema.
	extern GAMEPLAYINTERACTIONSMODULE_API const FName SmartObjectActor;	// The SmartObjectActor participating in the interaction.
	extern GAMEPLAYINTERACTIONSMODULE_API const FName SmartObjectClaimedHandle;
	extern GAMEPLAYINTERACTIONSMODULE_API const FName SlotEntranceHandle;
	extern GAMEPLAYINTERACTIONSMODULE_API const FName AbortContext;
}
