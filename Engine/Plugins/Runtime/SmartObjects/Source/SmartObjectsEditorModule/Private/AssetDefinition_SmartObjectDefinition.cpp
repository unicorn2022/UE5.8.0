...
{
	static const FAssetCategoryPath Categories[] = { FAssetCategoryPath(EAssetCategoryPaths::AI, LOCTEXT("AssetDefinition_SmartObjectDefinitionSubMenu", "NPC"), ECategoryMenuType::Section) };
	return Categories;
}
