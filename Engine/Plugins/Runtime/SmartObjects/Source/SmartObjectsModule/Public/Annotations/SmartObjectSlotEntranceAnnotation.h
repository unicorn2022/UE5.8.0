 ...
 */
USTRUCT(BlueprintType, meta = (DisplayName="Entrance"))
struct FSmartObjectSlotEntranceAnnotation : public FSmartObjectSlotAnnotation
{
	...
	UE_DEPRECATED(all, "This property has been deprecated. Use EntranceTags instead.")
	UPROPERTY()
	...
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category="Default", meta = (EditCondition = "bCheckTransitionTrajectory"))
