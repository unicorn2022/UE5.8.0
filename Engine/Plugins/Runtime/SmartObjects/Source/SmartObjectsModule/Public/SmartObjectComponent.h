...
{
	/**
	 * Component bound to an existing instance (BindToExistingInstance) will be unbound from the simulation but its associated runtime data will persist.
...
public:
	 ...
	 * @return false if it was not possible to change the enabled state (i.e. if it's not registered or there is no smart object subsystem).
	 */
	UE_DEPRECATED(5.8, "Use other version that is not blueprint pure.")
	UFUNCTION(BlueprintCallable, Category = "SmartObject", meta=(DisplayName="Set SmartObject Enabled (default reason: Gameplay)", ReturnDisplayName="Status changed", DeprecatedFunction="Note", DeprecationMessage="Use version that is not blueprint pure"))
	 ...
	 * @return false if it was not possible to change the enabled state (i.e. if it's not registered or there is no smart object subsystem).
	 */
	UFUNCTION(BlueprintCallable, Category = "SmartObject", BlueprintPure=false, meta=(DisplayName="Set SmartObject Enabled (default reason: Gameplay)", ReturnDisplayName="Status changed"))
	 ...
	 */
	UE_DEPRECATED(5.8, "Use other version that is not blueprint pure.")
	UFUNCTION(BlueprintCallable, Category = "SmartObject", meta=(DisplayName="Set SmartObject Enabled (specific reason)", ReturnDisplayName="Status changed", DeprecatedFunction="Note", DeprecationMessage="Use version that is not blueprint pure"))
	 ...
	 * @return false if it was not possible to change the enabled state (i.e. if it's not registered or there is no smart object subsystem).
	 */
	UFUNCTION(BlueprintCallable, Category = "SmartObject", BlueprintPure=false , meta=(DisplayName="Set SmartObject Enabled (specific reason)", ReturnDisplayName="Status changed"))
