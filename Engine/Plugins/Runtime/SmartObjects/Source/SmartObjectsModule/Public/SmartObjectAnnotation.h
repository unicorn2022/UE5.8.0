...
{
	GENERATED_BODY()
	virtual ~FSmartObjectSlotAnnotation() override = default;
	...
	/** @return true if the annotation has transform. Annotations with transforms can be selected and edited in the editor viewport. */
