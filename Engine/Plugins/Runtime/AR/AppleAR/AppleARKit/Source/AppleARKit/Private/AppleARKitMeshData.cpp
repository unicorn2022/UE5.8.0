...
void FARKitMeshData::UpdateMeshData()
{
	...
	do
	{
		// Copy the vertices
		{
			...
			{
				UE_LOGF(LogAppleARKit, Error, "Mesh anchor contains incorrectly formatted vertex data!");
				break;
			}
		}
		...
		// Copy the indices
		{
			...
			{
				UE_LOGF(LogAppleARKit, Error, "Mesh anchor contains incorrectly formatted index data!");
				break;
			}
		}
...
#if USE_ARKIT_NORMALS
		{
			...
			{
				UE_LOGF(LogAppleARKit, Error, "Mesh anchor contains incorrectly formatted normal data!");
				break;
			}
		}
		...
		// Copy the classification
		{
			...
			if (ARGeometrySource* InClassification = GeometryCopy.classification)
			{
				...
				{
					UE_LOGF(LogAppleARKit, Error, "Mesh anchor contains incorrectly formatted classification data!");
					break;
				}
			}
		}
