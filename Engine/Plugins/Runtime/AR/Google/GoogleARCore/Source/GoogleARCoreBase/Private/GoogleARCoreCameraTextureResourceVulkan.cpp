...
namespace VulkanUtil
{
	EYCbCrModelConversion ToEYCbCrModelConversion(VkSamplerYcbcrModelConversion VulkanYcbcrModelConversion)
	{
		...
		default:
			UE_LOGF(LogGoogleARCore, Error, "Unexpected Vulkan Ycbcr Model Conversion value: %d", VulkanYcbcrModelConversion);
	...
	EYCbCrRange ToEYCbCrRange(VkSamplerYcbcrRange VulkanYcbcrRange)
	{
		...
		default:
			UE_LOGF(LogGoogleARCore, Error, "Unexpected Vulkan Ycbcr Range value: %d", VulkanYcbcrRange);
...
void FARCoreCameraTextureResourceVulkan::FillCameraYCbCrConversionParameters()
{
	...
	{
		UE_LOGF(LogGoogleARCore, Error, "PFN_vkGetAndroidHardwareBufferPropertiesANDROID address not found.");
		return;
	}
