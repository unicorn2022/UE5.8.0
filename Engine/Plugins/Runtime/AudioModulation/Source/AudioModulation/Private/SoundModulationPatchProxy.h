...
namespace AudioModulation
{
	...
	private:
		...
		/** Whether or not the final output should be clamped to [0,1], based on the Parameter passed in from FModulationPatchSettings */
		bool bClampOutputToNormalizedRange = true;
