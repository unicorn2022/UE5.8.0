...
#include "MovieSceneAudioControlBusMixTrack.generated.h"


UCLASS(MinimalAPI)
class UMovieSceneAudioControlBusMixTrack
	: public UMovieSceneNameableTrack
{
	GENERATED_UCLASS_BODY()

public:
	AUDIOMODULATION_API UMovieSceneSection* AddNewControlBusMix(USoundControlBusMix* BusMix);
...
private:
	...
	/** List of all root mix bus sections */
	UPROPERTY()
	TArray<TObjectPtr<UMovieSceneSection>> MixSections;
};
