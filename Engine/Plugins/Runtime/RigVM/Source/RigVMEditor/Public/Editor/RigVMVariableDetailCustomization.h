...
public:
	...
	UE_API FRigVMVariableDetailCustomization(TSharedPtr<IRigVMEditor> InEditor, FRigVMEditorAssetInterfacePtr Blueprint);
...
private:
	...
	UE_API void OnFinishedChangingVariable(const FPropertyChangedEvent& PropertyChangedEvent);
...
private:
	...
	UE_API ECheckBoxState OnGetPublicCheckboxState() const;
	UE_API void OnPublicChanged(ECheckBoxState InNewState);
...
private:
	...
	TWeakInterfacePtr<IRigVMEditorAssetInterface> BlueprintPtr;
	...
	TWeakFieldPtr<const FProperty> CachedVariableProperty;
