...
public:
	...
	/* Create a root */
	UE_DEPRECATED(5.7, "Please use FRigVMFindResult(FRigVMEditorAssetInterfacePtr InBlueprint)")
	UE_API explicit FRigVMFindResult(TWeakObjectPtr<URigVMBlueprint> InBlueprint);
	UE_DEPRECATED(5.7, "Please use FRigVMFindResult(FRigVMEditorAssetInterfacePtr InBlueprint, const FText& InDisplayText)")
	UE_API explicit FRigVMFindResult(TWeakObjectPtr<URigVMBlueprint> InBlueprint, const FText& InDisplayText);
	UE_API explicit FRigVMFindResult(TWeakInterfacePtr<IRigVMEditorAssetInterface> InBlueprint);
	UE_API explicit FRigVMFindResult(TWeakInterfacePtr<IRigVMEditorAssetInterface> InBlueprint, const FText& InDisplayText);
	...
	UE_DEPRECATED(5.7, "Please use FRigVMEditorAssetInterfacePtr GetRigVMAssetInterface()")
	UE_API URigVMBlueprint* GetBlueprint() const;
	UE_API FRigVMEditorAssetInterfacePtr GetRigVMAssetInterface();
	UE_API const FRigVMEditorAssetInterfacePtr GetRigVMAssetInterface() const;
	...
	*/
	...
	UE_API virtual UObject* GetObject(FRigVMEditorAssetInterfacePtr InBlueprint) const;
...
typedef TSharedPtr<FRigVMFindResult> FRigVMFindResultPtr;
typedef STreeView<FRigVMFindResultPtr>  SRigVMFindResultTreeViewType;
...
namespace RigVMFindReferencesHelpers
{
	...
	*/
	void ExpandAllChildren(FRigVMFindResultPtr InTreeNode, TSharedPtr<STreeView<FRigVMFindResultPtr>> InTreeView);
}
...
{
public:
	UE_DEPRECATED(5.7, "Please use FRigVMFindReferencesGraphNode(FRigVMEditorAssetInterfacePtr InBlueprint)")
	FRigVMFindReferencesGraphNode(TWeakObjectPtr<URigVMBlueprint> InBlueprint);
	FRigVMFindReferencesGraphNode(FRigVMEditorAssetInterfacePtr InBlueprint);
	virtual ~FRigVMFindReferencesGraphNode() = default;
	...
	virtual UObject* GetObject(FRigVMEditorAssetInterfacePtr InBlueprint) const override;
...
{
public:
	UE_DEPRECATED(5.7, "Plase use FRigVMFindReferencesPin(FRigVMEditorAssetInterfacePtr InBlueprint, FString InSchemaName)")
	FRigVMFindReferencesPin(TWeakObjectPtr<URigVMBlueprint> InBlueprint, FString InSchemaName);
	FRigVMFindReferencesPin(FRigVMEditorAssetInterfacePtr InBlueprint, FString InSchemaName);
	virtual ~FRigVMFindReferencesPin() = default;
...
{
public:
	UE_DEPRECATED(5.7, "Plase use FRigVMFindReferencesVariable(FRigVMEditorAssetInterfacePtr InBlueprint)")
	FRigVMFindReferencesVariable(TWeakObjectPtr<URigVMBlueprint> InBlueprint);
	FRigVMFindReferencesVariable(FRigVMEditorAssetInterfacePtr InBlueprint);
	virtual ~FRigVMFindReferencesVariable() = default;
...
{
public:
	UE_DEPRECATED(5.7, "Please use FRigVMFindReferencesGraph(FRigVMEditorAssetInterfacePtr InBlueprint, EGraphType InGraphType)")
	FRigVMFindReferencesGraph(TWeakObjectPtr<URigVMBlueprint> InBlueprint, EGraphType InGraphType);
	FRigVMFindReferencesGraph(FRigVMEditorAssetInterfacePtr InBlueprint, EGraphType InGraphType);
	virtual ~FRigVMFindReferencesGraph() = default;
...
private:
	...
	UE_API void OnGetChildren( FRigVMFindResultPtr InItem, TArray< FRigVMFindResultPtr >& OutChildren );

	/* Called when user double clicks on a new result */
	UE_API void OnTreeSelectionDoubleClicked( FRigVMFindResultPtr Item );

	/* Called when a new row is being generated */
	UE_API TSharedRef<ITableRow> OnGenerateRow(FRigVMFindResultPtr InItem, const TSharedRef<STableViewBase>& OwnerTable);
	...
	UE_API void SelectAllItemsHelper(FRigVMFindResultPtr InItemToSelect);
