...
DECLARE_MULTICAST_DELEGATE_TwoParams(FRigVMEditorClosed, const IRigVMEditor*, FRigVMEditorAssetInterfacePtr);
DECLARE_DELEGATE_RetVal_TwoParams(FReply, FRigVMEditorKeyDownDelegate, const FGeometry&, const FKeyEvent&);
...
public:
	...
	virtual FRigVMEditorAssetInterfacePtr GetRigVMAssetInterface() const = 0;
	...
	virtual FRigVMEditorKeyDownDelegate& GetKeyDownDelegate() = 0;
	...
	virtual bool SelectVariable(const FName& VariableName) = 0;
	...
	virtual bool IsRunGraphOnceOn() const = 0;
	virtual bool CanRunGraphOnce() const = 0;

	virtual bool IsDetailsPanelEditingGlobalOptions() const = 0;
	virtual bool IsDetailsPanelEditingClassDefaults() const = 0;
...
protected:
	...
	virtual void CommonInitialization(const TArray<FRigVMEditorAssetInterfacePtr>& InitBlueprints, bool bShouldOpenInDefaultsMode) = 0;
	...
	virtual void AnalyticsTrackNodeEvent(IRigVMEditorAssetInterface* Blueprint, UEdGraphNode *GraphNode, bool bNodeDelete = false) const = 0;
	...
	virtual void OnBlueprintChangedInnerImpl(IRigVMEditorAssetInterface* InBlueprint, bool bIsJustBeingCompiled = false) = 0;
	...
	virtual void AddFindWidget(FToolBarBuilder& ToolbarBuilder) = 0;
	...
	virtual void AddRunOnceWidget(FToolBarBuilder& ToolbarBuilder) = 0;
};
...
public:
	 ...
	 */
	UE_API virtual void InitRigVMEditor(const EToolkitMode::Type Mode, const TSharedPtr< class IToolkitHost >& InitToolkitHost, FRigVMEditorAssetInterfacePtr InRigVMBlueprint);
	...
	UE_API virtual FRigVMEditorAssetInterfacePtr GetRigVMAssetInterface() const override;
...
protected:
	...
	virtual ~FRigVMEditorBase()= default;
	...
	virtual FRigVMEditorKeyDownDelegate& GetKeyDownDelegate() override { return OnKeyDownDelegate; }

	UE_API virtual bool SelectLocalVariable(const UEdGraph* Graph, const FName& VariableName) override;
	UE_API virtual bool SelectVariable(const FName& VariableName) override;
	...
	UE_API void OnBlueprintChangedImpl(IRigVMEditorAssetInterface* InBlueprint, bool bIsJustBeingCompiled);
	...
	UE_API FRigVMController_BulkEditResult OnRequestBulkEditDialog(FRigVMEditorAssetInterfacePtr InBlueprint, URigVMController* InController, URigVMLibraryNode* InFunction, ERigVMControllerBulkEditType InEditType);
	...
	UE_API void ToggleLockGraph();
	UE_API bool IsLockGraphOn() const;
	bool CanLockGraph() const;
	UE_API void ToggleEventQueue();
	UE_API void ToggleRunGraphOnce();
	UE_API void SetRunGraphOnce(bool InRunGraphOnceEnabled);
	UE_API virtual bool IsRunGraphOnceOn() const override;
	virtual bool CanRunGraphOnce() const override { return false; }
	virtual void OnRunGraphOnceToggled(bool bRunGraphOnceEnabled) {}
	...
	UE_API void SetDetailViewForVariable();
	...
	UE_API bool DetailViewShowsVariable() const;
	...
	UE_API virtual void AddLockEditingWidget(FToolBarBuilder& ToolbarBuilder);
	...
	UE_API virtual void HandleRefreshEditorFromBlueprint(FRigVMEditorAssetInterfacePtr InBlueprint);
	...
	UE_API void OnNodeDoubleClicked(FRigVMEditorAssetInterfacePtr InBlueprint, URigVMNode* InNode);
	...
	UE_API virtual void AddRunOnceWidget(FToolBarBuilder& ToolbarBuilder) override;
...
protected:
	...
	FRigVMEditorKeyDownDelegate OnKeyDownDelegate;

	UE_API virtual void SetGraphExplorerWidget(TSharedPtr<SRigVMEditorGraphExplorer> InWidget) override;
