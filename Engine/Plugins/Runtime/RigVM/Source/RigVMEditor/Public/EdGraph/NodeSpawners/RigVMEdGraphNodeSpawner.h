...
public:
	...
	virtual FString GetSpawnerSignature() const { return FString(); }
	virtual URigVMEdGraphNode* Invoke(URigVMEdGraph* ParentGraph, FVector2D const Location) const { return nullptr; }
	...
	FText GetMenuName() const { return MenuName;}
	FText GetMenuTooltip() const { return MenuTooltip;}
	FText GetMenuCategory() const { return MenuCategory;}
	FText GetMenuKeywords() const { return MenuKeywords;}
	FSlateIcon GetMenuIcon() const { return MenuIcon;}
	FLinearColor GetMenuColor() const { return MenuIconTint;}
