...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "RigVM Blueprint")
	static UE_API bool RenderRigVMSubjectToPNG(UObject* InUnitOrDispatchStructOrLibraryNode, const FString& OutFileName);

	UFUNCTION(BlueprintCallable, Category = "RigVM Blueprint")
	static UE_API bool RenderRigVMTemplateToPNG(FName InTemplateNotation, const FString& OutFileName);

	static UE_API bool RenderModelNodeToPNG(URigVMEditorAsset* EditorAsset, URigVMNode* InModelNode, const FString& OutFileName);
	static UE_API UObject* MakeRigVMAssetForSubject(UObject* InUnitOrDispatchStructOrLibraryNode, const URigVMSchema *& OutSchema);
};
