...
protected:
	...
	UE_API FText GetVariableLabelTooltipText(TWeakInterfacePtr<IRigVMEditorAssetInterface> InBlueprint, FName InVariableName) const;
...
protected:
	...
	public:
		...
		FPinInfoMetaData(const FString& InCPPType, const FString& InBoundVariableName, bool InIsInputVariable)
		: CPPType(InCPPType)
		, BoundVariableName(InBoundVariableName)
		, bIsInputVariable(InIsInputVariable)
		{}
	...
	TAttribute<bool> PinDragDropEnabledAttribute;
};
