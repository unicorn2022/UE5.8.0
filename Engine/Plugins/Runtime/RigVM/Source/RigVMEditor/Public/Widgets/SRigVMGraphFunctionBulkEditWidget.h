...
public:
	...
	UE_API void Construct(const FArguments& InArgs, FRigVMEditorAssetInterfacePtr InBlueprint, URigVMController* InController, URigVMLibraryNode* InFunction, ERigVMControllerBulkEditType InEditType);
...
public:
	...
	SLATE_ARGUMENT(FRigVMEditorAssetInterfacePtr, Blueprint)
