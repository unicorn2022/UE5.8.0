...
public:
	...
	UE_DEPRECATED(5.7, "Please use New(const FRigVMExplorerElementKey& InElement, FRigVMEditorAssetInterfacePtr InBlueprint);")
	...
	static TSharedRef<FRigVMGraphExplorerDragDropOp> New(const FRigVMExplorerElementKey& InElement, FRigVMEditorAssetInterfacePtr InBlueprint);
	...
	UE_DEPRECATED(5.7, "Please use FRigVMEditorAssetInterfacePtr GetRigVMAssetInterface() const")
...
private:
	...
	FRigVMEditorAssetInterfacePtr SourceBlueprint;
};
...
private:
	...
	/** Command list for widget-level keyboard shortcuts */
	...
	bool OnReorderVariable(const FRigVMExplorerElementKey& InVariable, int32 NewIndex);
	bool OnReorderLocalVariable(const FRigVMExplorerElementKey& InVariable, int32 NewIndex);
