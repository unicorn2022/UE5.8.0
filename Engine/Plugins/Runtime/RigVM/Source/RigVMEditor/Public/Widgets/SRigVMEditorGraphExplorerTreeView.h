...
DECLARE_DELEGATE_RetVal_TwoParams(bool, FRigVMGraphExplorer_OnReorderVariable, const FRigVMExplorerElementKey&, int32 /* new index */);
...
public:
	...
	FRigVMGraphExplorer_OnReorderVariable OnReorderVariable;
	FRigVMGraphExplorer_OnReorderVariable OnReorderLocalVariable;
...
public:
	...
	virtual TOptional<EItemDropZone> OnCanAcceptDrop(const FDragDropEvent& DragDropEvent, EItemDropZone DropZone, TSharedPtr<FRigVMEditorGraphExplorerTreeElement> TargetItem);
	virtual FReply OnAcceptDrop(const FDragDropEvent& DragDropEvent, EItemDropZone DropZone, TSharedPtr<FRigVMEditorGraphExplorerTreeElement> TargetItem);
...
public:
	...
	virtual ~SRigVMEditorGraphExplorerTreeView() = default;
...
private:
	...
	bool bWasAddNewItemClicked = false;
