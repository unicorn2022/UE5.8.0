...
void SRigVMLogWidget::BindLog(const FRigVMEditorAssetInterfacePtr InRigVMBlueprint)
{
...
void SRigVMLogWidget::UnbindLog(const FRigVMEditorAssetInterfacePtr InRigVMBlueprint)
{
	TSharedPtr<IMessageLogListing> Listing = nullptr;
	FMessageLogModule& MessageLogModule = FModuleManager::LoadModuleChecked<FMessageLogModule>("MessageLog");
