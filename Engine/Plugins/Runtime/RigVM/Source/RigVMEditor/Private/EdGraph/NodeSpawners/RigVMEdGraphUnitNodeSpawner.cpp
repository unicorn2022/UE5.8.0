...
URigVMEdGraphNode* URigVMEdGraphUnitNodeSpawner::SpawnNode(URigVMEdGraph* ParentGraph, FRigVMEditorAssetInterfacePtr RigBlueprint, UScriptStruct* StructTemplate, const FName& InMethodName, FVector2D const Location)
{
	URigVMEdGraphNode* NewNode = nullptr;
...
void URigVMEdGraphUnitNodeSpawner::HookupMutableNode(URigVMNode* InModelNode, FRigVMEditorAssetInterfacePtr InRigBlueprint)
{
