...
URigVMEdGraphNode* URigVMEdGraphTemplateNodeSpawner::SpawnNode(URigVMEdGraph* ParentGraph, FRigVMEditorAssetInterfacePtr RigBlueprint, const FRigVMTemplate* Template, FVector2D const Location)
{
	URigVMEdGraphNode* NewNode = nullptr;
