...
namespace UE::RigVMEditor
{
	...
	{		
		...
		{
			const TSharedRef<FRigVMEdGraphNodeRegistry> NewRegistry = MakeShared<FRigVMEdGraphNodeRegistry>(InRigVMAssetInterface, InRigVMNodeClass, FRigVMEdGraphNodeRegistry::FPrivateToken());
	...
	FRigVMEdGraphNodeRegistry::FRigVMEdGraphNodeRegistry(const TScriptInterface<IRigVMEditorAssetInterface>& InRigVMAssetInterface, UClass* InRigVMNodeClass, FRigVMEdGraphNodeRegistry::FPrivateToken)
