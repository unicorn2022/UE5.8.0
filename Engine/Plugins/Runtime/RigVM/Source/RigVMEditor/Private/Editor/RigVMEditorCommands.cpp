...
void FRigVMEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND(ExecuteGraph, "Execute", "Execute the VM if On.", EUserInterfaceActionType::ToggleButton, FInputChord());
	UI_COMMAND(AutoCompileGraph, "Auto Compile", "Auto-compile the VM if On.", EUserInterfaceActionType::ToggleButton, FInputChord());
	UI_COMMAND(LockGraph, "Nativized", "Runs a nativized backend if On.", EUserInterfaceActionType::ToggleButton, FInputChord());
	...
	UI_COMMAND(RunGraphOnce, "Run Once", "Only evaluate a single frame if On.", EUserInterfaceActionType::ToggleButton, FInputChord());
	...
	UI_COMMAND(FindReferences, "Find References", "Find references of this item", EUserInterfaceActionType::Button, FInputChord(EKeys::F, EModifierKey::Control));
