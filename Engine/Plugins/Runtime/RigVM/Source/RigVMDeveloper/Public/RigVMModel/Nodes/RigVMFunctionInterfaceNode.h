...
public:
	...
	// find outer node which contains this interface node in its graph
	UE_API const URigVMCollapseNode* FindReferencedNode() const;

	// find pin in referenced node that represents this inner pin
