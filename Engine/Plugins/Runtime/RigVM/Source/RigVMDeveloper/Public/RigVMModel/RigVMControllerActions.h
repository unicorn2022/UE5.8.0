...
public:
	...
	// Default destructor
	virtual ~FRigVMBaseAction() = default;
...
public:
	...
	virtual ~FRigVMInjectNodeIntoPinAction() = default;
...
public:
	...
	virtual ~FRigVMEjectNodeFromPinAction() = default;
...
public:
	...
	virtual ~FRigVMRemoveNodesAction() = default;
...
public:
	...
	virtual ~FRigVMSetNodeSelectionAction() = default;
...
public:
	...
	virtual ~FRigVMSetNodePositionAction() = default;
...
public:
	...
	virtual ~FRigVMSetNodeSizeAction() = default;
...
public:
	...
	virtual ~FRigVMSetNodeColorAction() = default;
...
public:
	...
	virtual ~FRigVMSetNodeCategoryAction() = default;
...
public:
	...
	virtual ~FRigVMSetNodeKeywordsAction() = default;
...
public:
	...
	virtual ~FRigVMSetNodeDescriptionAction() = default;
...
public:
	...
	virtual ~FRigVMSetCommentTextAction() = default;
...
public:
	...
	FRigVMRenameVariableAction(URigVMController* InController, const FGuid& InVariableGuid, const FName& InOldVariableName, const FName& InNewVariableName);
	virtual ~FRigVMRenameVariableAction() = default;
...
public:
	...
	virtual ~FRigVMSetPinExpansionAction() = default;
...
public:
	...
	virtual ~FRigVMSetPinWatchAction() = default;
...
public:
	...
	virtual ~FRigVMSetPinDisplayNameAction() = default;
...
public:
	...
	virtual ~FRigVMSetPinCategoryAction() = default;
...
public:
	...
	virtual ~FRigVMChangeNodePinCategoriesAction() = default;
...
public:
	...
	virtual ~FRigVMSetPinCategoryExpansionAction() = default;
...
public:
	...
	virtual ~FRigVMSetPinIndexInCategoryAction() = default;
...
public:
	...
	virtual ~FRigVMSetPinDefaultValueAction() = default;
...
public:
	...
	virtual ~FRigVMInsertArrayPinAction() = default;
...
public:
	...
	virtual ~FRigVMRemoveArrayPinAction() = default;
...
public:
	...
	virtual ~FRigVMAddLinkAction() = default;
...
public:
	...
	virtual ~FRigVMBreakLinkAction() = default;
...
public:
	...
	virtual ~FRigVMChangePinTypeAction() = default;
...
public:
	...
	virtual ~FRigVMCollapseNodesAction() = default;
...
public:
	...
	virtual ~FRigVMExpandNodeAction() = default;
...
public:
	...
	virtual ~FRigVMRenameNodeAction() = default;
...
public:
	...
	virtual ~FRigVMAddExposedPinAction() = default;
...
public:
	...
	virtual ~FRigVMRemoveExposedPinAction() = default;
...
public:
	...
	virtual ~FRigVMRenameExposedPinAction() = default;
...
public:
	...
	virtual ~FRigVMSetPinIndexAction() = default;
...
/**
 * An action to mark an exposed pin as an input variable
 */
USTRUCT()
struct FRigVMMarkExposedPinAsInputVariableAction : public FRigVMBaseAction
{
	GENERATED_BODY()

public:

	FRigVMMarkExposedPinAsInputVariableAction();
	FRigVMMarkExposedPinAsInputVariableAction(URigVMController* InController, URigVMPin* InPin, bool bNewDefinedAsExternalVariableState);
	virtual ~FRigVMMarkExposedPinAsInputVariableAction() = default;
	virtual UScriptStruct* GetScriptStruct() const override { return FRigVMMarkExposedPinAsInputVariableAction::StaticStruct(); }
	virtual bool Undo() override;
	virtual bool Redo() override;
...
public:
	...
	virtual ~FRigVMAddLocalVariableAction() = default;
...
public:
	...
	virtual ~FRigVMRemoveLocalVariableAction() = default;
...
public:
	...
	virtual ~FRigVMRenameLocalVariableAction() = default;
...
public:
	...
	virtual ~FRigVMChangeLocalVariableTypeAction() = default;
...
public:
	...
	virtual ~FRigVMChangeLocalVariableDefaultValueAction() = default;
...
/**
 * An action to reorder a local variable to a new index
 */
USTRUCT()
struct FRigVMSetLocalVariableIndexAction : public FRigVMBaseAction
{
	GENERATED_BODY()

public:
	FRigVMSetLocalVariableIndexAction();
	FRigVMSetLocalVariableIndexAction(URigVMController* InController, const FGuid& InVariableGuid, int32 InOldIndex, int32 InNewIndex);
	virtual ~FRigVMSetLocalVariableIndexAction() = default;
	virtual UScriptStruct* GetScriptStruct() const override { return FRigVMSetLocalVariableIndexAction::StaticStruct(); }
	virtual bool Undo() override;
	virtual bool Redo() override;
...
public:
	...
	virtual ~FRigVMPromoteNodeAction() = default;
...
public:
	...
	virtual ~FRigVMMarkFunctionPublicAction() = default;
...
public:
	...
	virtual ~FRigVMCreateFunctionVariantAction() = default;
...
public:
	...
	virtual ~FRigVMAddFunctionVariantTagAction() = default;
	virtual UScriptStruct* GetScriptStruct() const override { return FRigVMCreateFunctionVariantAction::StaticStruct(); }
	virtual bool Undo() override;
	virtual bool Redo() override;
...
public:
	...
	virtual ~FRigVMRemoveFunctionVariantTagAction() = default;
	virtual UScriptStruct* GetScriptStruct() const override { return FRigVMCreateFunctionVariantAction::StaticStruct(); }
	virtual bool Undo() override;
	virtual bool Redo() override;
...
public:
	...
	virtual ~FRigVMImportFromTextAction() = default;
...
public:
	...
	virtual ~FRigVMReplaceNodesAction() = default;
...
public:
	...
	virtual ~FRigVMAddTraitAction() = default;
...
public:
	...
	virtual ~FRigVMRemoveTraitAction() = default;
