...
public:
	...
	/** Set up this graph */
	UE_DEPRECATED(5.7, "Please use const FRigVMEditorAssetInterfacePtr GetAssetDefaultObject() const")
	UE_API const URigVMBlueprint* GetBlueprintDefaultObject() const;
	UE_API const FRigVMEditorAssetInterfacePtr GetAssetDefaultObject() const;
	UE_API void SetBlueprintClass(const UClass* InClass);
	UE_DEPRECATED(5.7, "Please use void InitializeFromAsset(FRigVMEditorAssetInterfacePtr InAsset);")
	virtual void InitializeFromBlueprint(URigVMBlueprint* InBlueprint) {}
	UE_API virtual void InitializeFromAsset(FRigVMEditorAssetInterfacePtr InAsset);
	...
	UE_DEPRECATED(5.7, "Please use FRigVMEditorAssetInterfacePtr GetAsset() const")
	UE_API URigVMBlueprint* GetBlueprint() const;
	UE_API FRigVMEditorAssetInterfacePtr GetAsset() const;
