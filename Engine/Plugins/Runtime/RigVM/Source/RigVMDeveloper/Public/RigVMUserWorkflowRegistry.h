...
public:
	...
	UFUNCTION(BlueprintCallable, Category = FRigVMUserWorkflowRegistry)
	UE_API int32 RegisterProviderForFunction(const FString InFunctionNotation, FRigVMUserWorkflowProvider InProvider);
...
private:
	...
	int32 MaxHandle = 0;
	mutable TArray<TTuple<int32, const UScriptStruct*, FRigVMUserWorkflowProvider>> ProvidersForUnits;
	mutable TArray<TTuple<int32, const FString, FRigVMUserWorkflowProvider>> ProvidersForDispatchFunctions;
};
