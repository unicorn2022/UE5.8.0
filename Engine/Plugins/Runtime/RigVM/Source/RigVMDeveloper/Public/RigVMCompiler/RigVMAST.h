...
public:
	...
	// virtual destructor
	virtual ~FRigVMBlockExprAST() = default;
...
public:
	...
	// virtual destructor
	virtual ~FRigVMNodeExprAST() = default;
...
public:
	...
	// virtual destructor
	virtual ~FRigVMEntryExprAST() = default;
...
public:
	...
	// virtual destructor
	virtual ~FRigVMInvokeEntryExprAST() = default;
...
public:
	...
	// virtual destructor
	virtual ~FRigVMCallExternExprAST() = default;
...
public:
	...
	// virtual destructor
	virtual ~FRigVMInlineFunctionExprAST() = default;
...
public:
	...
	// virtual destructor
	virtual ~FRigVMNoOpExprAST() = default;
...
public:
	...
	// virtual destructor
	virtual ~FRigVMVarExprAST() = default;
	...
	URigVMPin* GetPin() const { if (ensure(GetProxy().GetSubject()))  { return GetProxy().GetSubjectChecked<URigVMPin>(); } return nullptr; }
	...
	// Returns the clone this variable expression is using.
	const FRigVMVarExprAST* GetVariableCloneExpr() const
	{
		return ClonedVarExpr;
	}
...
private:
	...
	FRigVMASTProxy Proxy;
	const FRigVMVarExprAST* ClonedVarExpr = nullptr;
...
public:
	...
	// virtual destructor
	virtual ~FRigVMLiteralExprAST() = default;
...
public:
	...
	// virtual destructor
	virtual ~FRigVMAssignExprAST() = default;
...
public:
	...
	// virtual destructor
	virtual ~FRigVMCopyExprAST() = default;
...
public:
	...
	// virtual destructor
	virtual ~FRigVMCachedValueExprAST() = default;
...
public:
	...
	// virtual destructor
	virtual ~FRigVMExitExprAST() = default;
...
struct FRigVMParserASTSettings
{
   ...
   bool bFoldSubPinCopies = false;
	...
	// nodes whose input literals must not be shared with other nodes' literals.
	// used by Direct Manipulation to keep per-node registers during interactive editing
	// so that writing to one node's literal register does not affect other nodes.
	// stored as FObjectKey rather than FName to correctly handle duplicate node names
	// inside collapsed graphs. not a UPROPERTY — session-only, intentionally not serialized.
	TSet<FObjectKey> InteractiveNodes;
...
private:
	...
	UE_API bool TraverseNodeExpressionForRequiredVariableClone(FRigVMNodeExprAST* InNodeExpr);
	...
	static bool IsNoOpUnitNode(const URigVMNode* InNode);
