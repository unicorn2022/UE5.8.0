...
bool RigVMStringUtils::SplitPinPathAtStart(FStringView InPinPath, FStringView& LeftMost, FStringView& Right)
{
	return UE::String::SplitFirst(InPinPath, TEXT("."), LeftMost, Right, ESearchCase::IgnoreCase);
}
