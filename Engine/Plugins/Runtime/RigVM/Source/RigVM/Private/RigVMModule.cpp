...
#if RIGVM_TRACE_ENABLED
	IModularFeatures::Get().RegisterModularFeature(IRewindDebuggerRuntimeExtension::ModularFeatureName, &RewindDebuggerRigVMExtension);
#endif
}
...
#if RIGVM_TRACE_ENABLED
	IModularFeatures::Get().UnregisterModularFeature(IRewindDebuggerRuntimeExtension::ModularFeatureName, &RewindDebuggerRigVMExtension);
#endif
}
