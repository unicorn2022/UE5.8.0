...
{
	LLM_SCOPE_BYNAME(TEXT("RigVM/Debug"));
...
void FRigVMDrawInterface::DrawText(const FTransform& WorldOffset, const FVector& Position, const FString& Text, const FLinearColor& Color, float FontScale, float Lifetime)
{
	LLM_SCOPE_BYNAME(TEXT("RigVM/Debug"));
	...
	FRigVMDrawInstruction Instruction(ERigVMDrawSettings::Text, Color, 0.f, WorldOffset, SDPG_Foreground, Lifetime);
	Instruction.Positions.Add(Position);
	Instruction.Text = Text;
	Instruction.FontScale = FontScale;
