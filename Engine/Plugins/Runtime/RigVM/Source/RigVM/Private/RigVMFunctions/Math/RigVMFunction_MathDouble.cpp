...
{
	// nothing to do here - value is assigned in the constructor
}
...
FRigVMFunction_MathDoubleOneMinus_Execute()
{
	Result = 1.0 - Value;
}
...
FRigVMFunction_MathDoubleWrap_Execute()
{
	Result = FMath::Wrap<double>(Value, Minimum, Maximum);
}
