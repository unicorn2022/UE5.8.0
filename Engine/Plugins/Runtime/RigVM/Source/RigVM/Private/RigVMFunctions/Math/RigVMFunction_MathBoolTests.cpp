...
IMPLEMENT_RIGVMSTRUCT_AUTOMATION_TEST(FRigVMFunction_MathBoolAny)
{
	Unit.Array = { true, false, false };
	Execute();
	AddErrorIfFalse(Unit.Result == true, TEXT("unexpected result"));
	AddErrorIfFalse(Unit.IsEmpty == false, TEXT("unexpected result"));
	Unit.Array = { false, false, false };
	Execute();
	AddErrorIfFalse(Unit.Result == false, TEXT("unexpected result"));
	AddErrorIfFalse(Unit.IsEmpty == false, TEXT("unexpected result"));
	Unit.Array = {};
	Execute();
	AddErrorIfFalse(Unit.Result == false, TEXT("unexpected result"));
	AddErrorIfFalse(Unit.IsEmpty == true, TEXT("unexpected result"));
	return true;
}

IMPLEMENT_RIGVMSTRUCT_AUTOMATION_TEST(FRigVMFunction_MathBoolAll)
{
	Unit.Array = { true, false, true };
	Execute();
	AddErrorIfFalse(Unit.Result == false, TEXT("unexpected result"));
	AddErrorIfFalse(Unit.IsEmpty == false, TEXT("unexpected result"));
	Unit.Array = { true, true, true };
	Execute();
	AddErrorIfFalse(Unit.Result == true, TEXT("unexpected result"));
	AddErrorIfFalse(Unit.IsEmpty == false, TEXT("unexpected result"));
	Unit.Array = {};
