...
FText FRigVMDispatch_Constant::GetArgumentTooltip(const FName& InArgumentName, TRigVMTypeIndex InTypeIndex) const
{
	if (InArgumentName == ValueName)
	{
		return LOCTEXT("ConstantValueToolTip", "The constant value defined in this node");
	}
