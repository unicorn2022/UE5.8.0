...
public:
	...
	UE_API bool UpdateExternalVariables(const FRigVMGraphFunctionIdentifier& InLibraryPointer, TArray<FRigVMExternalVariable> InExternalVariables);
	...
	void PostLoad()
	{
		for(FRigVMGraphFunctionData& Function: PublicFunctions)
		{
			...
			Function.PatchExternalVariablesToArguments();
		}
	}
