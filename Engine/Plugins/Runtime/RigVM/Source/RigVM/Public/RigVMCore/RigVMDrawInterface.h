...
public:
	...
	// Capsules are drawn so that they extend along Z
	...
	UE_API void DrawText(const FTransform& WorldOffset, const FVector& Position, const FString& Text, const FLinearColor& Color, float FontScale = 1.f, float Lifetime = -1.f);
