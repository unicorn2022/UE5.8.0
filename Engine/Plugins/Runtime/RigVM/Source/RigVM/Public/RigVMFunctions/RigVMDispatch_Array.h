...
protected:
	...
	static inline FLazyName IsEmptyName = FLazyName(TEXT("IsEmpty"));
...
USTRUCT(meta=(DisplayName = "Reset", Pure))
...
USTRUCT(meta=(DisplayName = "Set Num", Pure))
...
USTRUCT(meta=(DisplayName = "IsEmpty"))
struct FRigVMDispatch_ArrayIsEmpty : public FRigVMDispatch_ArrayBase
{
	GENERATED_BODY()
...
protected:
	virtual FRigVMFunctionPtr GetDispatchFunctionImpl(const FRigVMTemplateTypeMap& InTypes, const FRigVMRegistryHandle& InRegistry) const override { return &FRigVMDispatch_ArrayIsEmpty::Execute; }
	static RIGVM_API void Execute(FRigVMExtendedExecuteContext& InContext, FRigVMMemoryHandleArray Handles, FRigVMPredicateBranchArray Predicates);
};

USTRUCT(meta=(DisplayName = "Init", Pure))
...
USTRUCT(meta=(DisplayName = "Set At", Pure))
...
USTRUCT(meta=(DisplayName = "Add", Pure))
...
USTRUCT(meta=(DisplayName = "Insert", Pure))
...
USTRUCT(meta=(DisplayName = "Remove", Pure))
...
USTRUCT(meta=(DisplayName = "Reverse", Pure))
...
USTRUCT(meta=(DisplayName = "Append", Pure))
...
USTRUCT(meta=(DisplayName = "Union", Pure))
...
USTRUCT(meta=(DisplayName = "For Each", Icon="EditorStyle|GraphEditor.Macro.ForEach_16x", Pure))
