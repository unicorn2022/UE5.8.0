...
public:
	...
	UE_API void UpdateAnimation(FRHICommandListBase& RHICmdList, float NewTime, bool bLooping, bool bIsPlayingBackwards, float PlaybackSpeed, float MotionVectorScale, bool bInterpolateFrames = true);
	...
	UE_API void UpdateAnimation(FRHICommandListBase& RHICmdList, const FAnimationUpdateParameters& UpdatedValues);
