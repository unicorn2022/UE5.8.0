...
public:
	...
	/** Get whether this GeometryCache is interpolating frames. */
	UFUNCTION(BlueprintCallable, Category = "Components|GeometryCache")
	UE_API bool IsInterpolatingFrames() const;

	/** Set whether this GeometryCache is interpolating frames. */
	UFUNCTION(BlueprintCallable, Category = "Components|GeometryCache")
	UE_API void SetInterpolateFrames(const bool bNewInterpolating);
...
protected:
	...
	/** Enable frame interpolation for sub-frame sampling of constant topologies */
