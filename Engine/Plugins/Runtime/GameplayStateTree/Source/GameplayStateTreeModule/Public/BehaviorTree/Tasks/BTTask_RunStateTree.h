...
protected:
	...
	UPROPERTY(EditAnywhere, Category = Task, DisplayName="State Tree", meta = (Schema = "/Script/GameplayStateTreeModule.StateTreeAIComponentSchema", SchemaCanBeOverriden))
