...
void AMultiServerBeaconHostObject::OnClientConnected(AOnlineBeaconClient* NewClientActor, UNetConnection* ClientConnection)
{
	...
	UE_LOGF(LogMultiServerBeacon, Verbose, "AMultiServerBeaconHostObject::OnClientConnected: num client actors connected is %d", ClientActors.Num());
...
void AMultiServerBeaconHostObject::NotifyClientDisconnected(AOnlineBeaconClient* LeavingClientActor)
{
	...
	UE_LOGF(LogMultiServerBeacon, Verbose, "AMultiServerBeaconHostObject::NotifyClientDisconnected: num client actors connected is %d", ClientActors.Num());
}
