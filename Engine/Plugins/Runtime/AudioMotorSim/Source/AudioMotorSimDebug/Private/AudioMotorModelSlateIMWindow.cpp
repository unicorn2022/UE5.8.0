...
FAudioMotorModelSlateIMWindow::FAudioMotorModelSlateIMWindow(const TCHAR* Command, const TCHAR* CommandHelp)
	: FSlateIMNomadTabBase(TEXT("Audio Motor Model Slate IM Window"), Command, CommandHelp, FSlateIcon("CoreStyle", "Launcher.Tabs.Tools"))
{}

void FAudioMotorModelSlateIMWindow::DrawContent(float DeltaTime)
{
	DebugWidget.Draw();
}
