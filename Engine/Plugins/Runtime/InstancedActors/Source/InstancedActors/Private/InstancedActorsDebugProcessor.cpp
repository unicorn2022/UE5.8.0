...
namespace UE::InstancedActors::Debug
{
	...
	namespace
	{
		FAutoConsoleVariableRef AnonymousCVars[] = {
			...
			{TEXT("IA.debug.PreviousRepresentation"), bDebugDrawPrevRepresentation
				...
				"indicates LowResSpawnedActor, Magenta indicates StaticMeshInstance, Purple indicates SkinnedMeshInstance and Red means Off."
			...
			{TEXT("IA.debug.CurrentRepresentationAll"), bDebugDrawAllEntities
				...
				"LowResSpawnedActor, NeonPink indicates StaticMeshInstance, CadetBlue indicates SkinnedMeshInstance, and Red means Off."), ECVF_Cheat},
	};
	}
	...
	FColor GetBatchColor(const EMassRepresentationType Representation)
	{
		...
		case EMassRepresentationType::LowResSpawnedActor:
			...
			break;
		case EMassRepresentationType::SkinnedMeshInstance:
			DrawColor = FColorList::CadetBlue;
			break;
		case EMassRepresentationType::StaticMeshInstance:
...
void UInstancedActorsDebugProcessor::ConfigureQueries(const TSharedRef<FMassEntityManager>& EntityManager)
{
	...
	DebugAllEntityQuery.AddSubsystemRequirement<UMassRepresentationSubsystem>(EMassFragmentAccess::ReadOnly);
	...
	DetailedLODEntityQuery.AddSubsystemRequirement<UMassRepresentationSubsystem>(EMassFragmentAccess::ReadOnly);
