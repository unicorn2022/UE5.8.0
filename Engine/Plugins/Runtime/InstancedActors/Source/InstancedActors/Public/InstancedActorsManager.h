...
protected:
	...
	UE_DEPRECATED(5.8, "Using DespawnAllEntities with a parameter is deprecated.")
	UE_API void DespawnAllEntities(bool bIsSwitchingSubsystems);
...
protected:
	...
	UPROPERTY(Instanced, VisibleAnywhere, BlueprintReadOnly, Category=InstancedActors)
