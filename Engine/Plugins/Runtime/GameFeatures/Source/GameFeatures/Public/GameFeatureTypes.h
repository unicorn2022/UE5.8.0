...
// EGameFeaturePluginState defines the list of public states for game feature plugins.
// Internally, GFP state machines may use additional states to manage transitions between public states
...
ENUM_RANGE_BY_COUNT(EGameFeaturePluginState, EGameFeaturePluginState::MAX);

GAMEFEATURES_API void SerializeForLog(FCbWriter& Writer, EGameFeaturePluginState State);
