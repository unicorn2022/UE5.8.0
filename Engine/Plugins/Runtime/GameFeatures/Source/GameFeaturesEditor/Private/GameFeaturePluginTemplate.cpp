...
FGameFeaturePluginTemplateDescription::FGameFeaturePluginTemplateDescription(FText InName, FText InDescription, FString InOnDiskPath, FString InDefaultSubfolder, FString InDefaultPluginName, TSubclassOf<UGameFeatureData> GameFeatureDataClassOverride, FString GameFeatureDataNameOverride, EPluginEnabledByDefault InEnabledByDefault, FString InPostCreatePythonScriptPath, FString InPostCreatePythonScriptArguments)
	: FPluginTemplateDescription(InName, InDescription, InOnDiskPath, /*bCanContainContent=*/ true, EHostType::Runtime, ELoadingPhase::Default, /*InSupportsContentOnlyProjects=*/ true, InPostCreatePythonScriptPath, InPostCreatePythonScriptArguments)
{
	SortPriority = 10;
