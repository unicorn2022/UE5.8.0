...
public class OpenCV : ModuleRules
{
	public OpenCV(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		else if (Target.Platform == UnrealTargetPlatform.Mac)
		{
			...
			string VersionedDylibName = "libopencv_world.4.5.5.dylib";
			PublicAdditionalLibraries.Add(Path.Combine(BinaryPath, VersionedDylibName));
			RuntimeDependencies.Add(Path.Combine(BinaryPath, VersionedDylibName));
			PublicDefinitions.Add("WITH_OPENCV=1");
		}
