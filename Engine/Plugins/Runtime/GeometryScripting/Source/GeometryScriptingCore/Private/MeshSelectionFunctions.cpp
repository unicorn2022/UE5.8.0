...
)
{
	...
	if (!TargetMesh)
	{
		UE_LOGF(LogGeometry, Warning, "GetMeshUniqueSelectionInfo: TargetMesh is Null");
		NumSelected = Selection.GetNumSelected();
		return;
	}
	else
	...
	EGeometryScriptMeshSelectionType SelectionType)
{
	...
	{
		UE_LOGF(LogGeometry, Warning, "CreateSelectAllMeshSelection: TargetMesh is Null");
		return TargetMesh;
	}
	...
	EGeometryScriptMeshSelectionType SelectionType)
{
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "CreateMeshSelectionByMaterialID: TargetMesh is Null");
		return TargetMesh;
	}
	...
	TargetMesh->ProcessMesh([MaterialID, &Selection, SelectionType](const FDynamicMesh3& ReadMesh)
	{
		...
		{
			UE_LOGF(LogGeometry, Warning, "CreateMeshSelectionByMaterialID: Mesh does not have material IDs");
			return;
		}
	...
	EGeometryScriptMeshSelectionType SelectionType)
{
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "CreateMeshSelectionByPolygroup: TargetMesh is Null");
		return TargetMesh;
	}
	...
	TargetMesh->ProcessMesh([GroupLayer, PolygroupID, &Selection, SelectionType](const FDynamicMesh3& ReadMesh)
	{
		...
		else
		{
			...
			{
				UE_LOGF(LogGeometry, Warning, "CreateMeshSelectionByPolygroup: Requested Polygroup Layer (%d) not found", GroupLayer.ExtendedLayerIndex);
				return;
			}
	...
	EGeometryScriptCombineSelectionMode CombineMode)
{
	...
	{
		UE_LOGF(LogGeometry, Warning, "CombineMeshSelections: Selections have different types, cannot combine");
	}
	...
	bool bAllowPartialInclusion)
{
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "ConvertMeshSelection: TargetMesh is Null");
		return TargetMesh;
	}
	if (FromSelection.GetSelectionType() == NewType)
	{
		UE_LOGF(LogGeometry, Warning, "ConvertMeshSelection: Trying to convert to same type");
	...
	FGeometryScriptMeshSelection& SelectionOut)
{
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "ConvertIndexArrayToMeshSelection: TargetMesh is Null");
		return TargetMesh;
	}
	...
	FGeometryScriptMeshSelection& SelectionOut)
{
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "ConvertIndexSetToMeshSelection: TargetMesh is Null");
		return TargetMesh;
	}
	...
	EGeometryScriptMeshSelectionType& SelectionType)
{
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "ConvertMeshSelectionToIndexArray: TargetMesh is Null");
		return TargetMesh;
	}
	...
	FGeometryScriptMeshSelection& SelectionOut)
{
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "ConvertIndexListToMeshSelection: TargetMesh is Null");
		return TargetMesh;
	}
	if (IndexList.IndexType == EGeometryScriptIndexType::Any)
	{
		UE_LOGF(LogGeometry, Warning, "ConvertIndexListToMeshSelection: IndexList has type Any, cannot convert");
		return TargetMesh;
	}
	...
	EGeometryScriptIndexType ConvertToType)
{
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "ConvertMeshSelectionToIndexList: TargetMesh is Null");
		return TargetMesh;
	}
	...
	*IndexList.List = MoveTemp(TempArray);
	...
	{
		UE_LOGF(LogGeometry, Warning, "ConvertMeshSelectionToIndexList: Conversion is not currently supported");
	}
	...
	int MinNumTrianglePoints)
{
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "SelectMeshElementsInBox: TargetMesh is Null");
		return TargetMesh;
	}
	...
	int MinNumTrianglePoints)
{
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "SelectMeshElementsInSphere: TargetMesh is Null");
		return TargetMesh;
	}
	...
	int MinNumTrianglePoints)
{
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "SelectMeshElementsWithPlane: TargetMesh is Null");
		return TargetMesh;
	}
	...
	int MinNumTrianglePoints)
{
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "SelectMeshElementsByNormalAngle: TargetMesh is Null");
		return TargetMesh;
	}
	...
	double MinAngleDeg)
{
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "SelectMeshSharpEdges: TargetMesh is Null");
		return TargetMesh;
	}
	...
	FGeometryScriptMeshSelection& SelectionOut)
{
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "SelectMeshSplitNormalEdges: TargetMesh is Null");
		return TargetMesh;
	}
	...
	TargetMesh->ProcessMesh([&SelectionOut](const FDynamicMesh3& Mesh)
	{
		...
		{
			UE_LOGF(LogGeometry, Warning, "SelectMeshSplitNormalEdges: TargetMesh does has no normals attribute");
			return;
		}
	...
	FGeometryScriptMeshSelection& SelectionOut)
{
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "SelectMeshBoundaryEdges: TargetMesh is Null");
		return TargetMesh;
	}
...
)
{
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "SelectSelectionBoundaryEdges: TargetMesh is Null");
		return TargetMesh;
	}
...
)
{
	...
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "SelectMeshUVSeamEdges: TargetMesh is Null");
		return TargetMesh;
	}
...
)
{
	...
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "SelectMeshPolyGroupBoundaryEdges: TargetMesh is Null");
		return TargetMesh;
	}
	...
	TargetMesh->ProcessMesh([&SelectionOut, GroupLayer, bExcludeMeshBoundaryEdges](const FDynamicMesh3& Mesh)
	{
		if (GroupLayer.bDefaultLayer == true)
		{
			...
			{
				UE_LOGF(LogGeometry, Warning, "SelectMeshPolyGroupBoundaryEdges: Mesh does not have PolyGroups enabled");
				return;
			}
		...
		else
		{
			...
			{
				UE_LOGF(LogGeometry, Warning, "SelectMeshPolyGroupBoundaryEdges: Requested Polygroup Layer (%d) not found", GroupLayer.ExtendedLayerIndex);
				return;
			}
	...
	int MinNumTrianglePoints)
{
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "SelectMeshElementsInsideMesh: TargetMesh is Null");
		return TargetMesh;
	}
	if (SelectionMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "SelectMeshElementsInsideMesh: SelectionMesh is Null");
		return TargetMesh;
	}
	if (SelectionMesh == TargetMesh)
	{
		UE_LOGF(LogGeometry, Warning, "SelectMeshElementsInsideMesh: SelectionMesh == TargetMesh, this is not supported");
	...
	bool bOnlyToConnected)
{
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "InvertMeshSelection: TargetMesh is Null");
		return TargetMesh;
	}
	...
	EGeometryScriptTopologyConnectionType ConnectionType)
{
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "ExpandMeshSelectionToConnected: TargetMesh is Null");
		return TargetMesh;
	}
	if (Selection.IsEmpty())
	{
		UE_LOGF(LogGeometry, Warning, "ExpandMeshSelectionToConnected: Initial Selection is Empty");
		return TargetMesh;
	}
	if (Selection.GetSelectionType() == EGeometryScriptMeshSelectionType::Vertices)
	{
		// todo: this...
		UE_LOGF(LogGeometry, Warning, "ExpandMeshSelectionToConnected: Vertex Selection currently not supported");
	...
	{
		// todo: implement this
		UE_LOGF(LogGeometry, Warning, "ExpandMeshSelectionToConnected: Edge Selection currently not supported");
		NewSelection.SetSelection(Selection);
		return TargetMesh;
	}
	...
	{
		UE_LOGF(LogGeometry, Warning, "ExpandMeshSelectionToConnected: Expanding Polygroup Selection to Connected Polygroups will not change selection");
	...
	bool bOnlyExpandToFaceNeighbours)
{
	if (TargetMesh == nullptr)
	{
		UE_LOGF(LogGeometry, Warning, "ExpandContractMeshSelection: TargetMesh is Null");
		return TargetMesh;
	}
	if (Selection.IsEmpty())
	{
		UE_LOGF(LogGeometry, Warning, "ExpandContractMeshSelection: Initial Selection is Empty");
		return TargetMesh;
	}
	if (Iterations <= 0)
	{
