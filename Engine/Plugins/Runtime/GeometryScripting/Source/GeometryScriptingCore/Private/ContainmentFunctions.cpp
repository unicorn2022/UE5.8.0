	...
	UGeometryScriptDebug* Debug)
{
	...
	TargetMesh->ProcessMesh([&](const FDynamicMesh3& EditMesh) 
	{
		...
		Hull.bPostSimplify = (Options.SimplifyToFaceCount > 0);
		Hull.SimplifyOptions.MaxTargetFaceCount = Options.SimplifyToFaceCount;
		Hull.SimplifyOptions.GeometricToleranceAfterTarget = Options.GeometricToleranceAfterTarget;
