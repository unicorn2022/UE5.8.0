...
public:
	...
	*/
	...
	//
	// Weight Map Attribute Layer Queries
	//

	UFUNCTION(BlueprintCallable, Category = "GeometryScript|MeshQueries", meta = (ScriptMethod, DisplayName = "Get Weight Map Handle By Name", ExpandEnumAsExecs = "FoundWeights"))
	static UE_API UPARAM(DisplayName = "Weight Map Handle") FGeometryScriptWeightMapHandle GetWeightMapHandle(UDynamicMesh* TargetMesh, FName Name, EGeometryScriptSearchOutcomePins& FoundWeights);
