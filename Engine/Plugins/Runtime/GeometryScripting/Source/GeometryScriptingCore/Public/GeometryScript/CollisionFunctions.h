...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Options)
	float ConvexHullGeometricTolerance = 0.f;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Options)
	float ConvexDecompositionMinPartThickness = 0.1f;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Options)
	float SweptHullSimplifyTolerance = 0.1f;
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Options)
	float VolumeDiffThreshold_Fraction = .15f;
};
