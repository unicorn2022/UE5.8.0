...
public:
	...
	/** After SimplifyToFaceCount is applied, further simplify within this tolerance. If SimplifyToFaceCount <= 0, or this tolerance is <= 0, does not apply. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Options)
	float GeometricToleranceAfterTarget = 0.f;
};
