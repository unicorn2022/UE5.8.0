...
USTRUCT(BlueprintType, meta = (DisplayName = "Weight Map Handle"))
struct FGeometryScriptWeightMapHandle
{
	GENERATED_BODY()
...
public:
	...
	bool IsValid() const
	{
		return WeightMapAttributeLayerIndex >= 0;
	}

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Handle")
	int WeightMapAttributeLayerIndex = -1;
};
