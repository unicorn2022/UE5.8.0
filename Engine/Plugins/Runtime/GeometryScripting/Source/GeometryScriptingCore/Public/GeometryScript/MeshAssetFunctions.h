...
UENUM(BlueprintType)
enum class ECopyMeshToAssetUseNewMaterialsOptions : uint8
{
	// Fully replace asset materials list with the provided set
	ReplaceAssetMaterials = 0,
	// Use the provided new materials as the material for the newly-set LOD, only adding asset materials as-needed
...
struct FGeometryScriptCopyMeshToAssetOptions
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Options, meta=(DisplayName = "Use New Materials"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Options)
	ECopyMeshToAssetUseNewMaterialsOptions NewMaterialUsage = ECopyMeshToAssetUseNewMaterialsOptions::ReplaceAssetMaterials;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Options)
	bool bCleanAssignedMaterials = false;
