	...
	UGeometryScriptDebug* Debug)
{
	...
	const FText FailedToFindValidTextureSource = LOCTEXT("ChannelPack_FailedToFindValidTextureSource",
		"ChannelPack: Failed to find a valid source format for input textures. Sources may be cooked assets / lacking source data");
	...
	if (OutputSourceFormat == TSF_Invalid)
	{
		UE::Geometry::AppendError(Debug, EGeometryScriptErrorType::InvalidInputs, FailedToFindValidTextureSource);
		return Result;
	}
