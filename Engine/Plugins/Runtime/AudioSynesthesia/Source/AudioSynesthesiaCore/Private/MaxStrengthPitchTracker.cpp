...
namespace Audio
{
	...
	{
		UE_CLOGF(!PitchDetector.IsValid(), LogAudioSynesthesiaCore, Warning, "Invalid pointer to pitch detector. MaxStrengthPitchDetector will not return valid results.");
	}
