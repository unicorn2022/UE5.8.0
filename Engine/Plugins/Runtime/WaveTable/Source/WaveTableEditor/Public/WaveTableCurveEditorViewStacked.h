...
namespace WaveTable
{
	namespace Editor
	{
		...
		public:
			...
			UE_API virtual bool ShowDefaultDashedLine() const { return false; }
			UE_API virtual double GetDefaultDashedLineValue() const { return 1.0; } 
		...
		private:
			...
			UE_API void DrawViewGridLineX(FSlateWindowElementList& OutDrawElements, FGridDrawInfo& DrawInfo, ESlateDrawEffect DrawEffect, double OffsetAlpha, bool bIsMajor, bool bDashedLine = false) const;
