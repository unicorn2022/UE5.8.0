...
void FDataRegistryEditorModule::StartupModule()
{
	...
	if (!IsRunningCommandlet())
	{
		...
		PropertyModule.RegisterCustomPropertyTypeLayout("DataRegistryOrTableRow", FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FDataRegistryOrTableRowCustomization::MakeInstance));
		PropertyModule.RegisterCustomPropertyTypeLayout("SoftDataRegistryOrTable", FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FSoftDataRegistryOrTableCustomization::MakeInstance));
...
void FDataRegistryEditorModule::ShutdownModule()
{
	if (!IsRunningCommandlet() && UObjectInitialized() && !IsEngineExitRequested())
	{
		...
		if (FModuleManager::Get().IsModuleLoaded("PropertyEditor"))
		{
			...
			PropertyModule.UnregisterCustomPropertyTypeLayout("SoftDataRegistryOrTable");
			PropertyModule.UnregisterCustomPropertyTypeLayout("DataRegistryOrTableRow");
			PropertyModule.UnregisterCustomPropertyTypeLayout("DataRegistryType");
			PropertyModule.UnregisterCustomPropertyTypeLayout("DataRegistryId");
		}
	}
