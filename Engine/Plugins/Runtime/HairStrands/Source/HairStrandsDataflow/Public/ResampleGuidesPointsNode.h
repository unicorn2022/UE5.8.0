...
private:
	...
	/** 
	* When true, the resampling is done in the context of simulation
	* - Favors power of two point count ( optimized for GPU solvers )
	* - Extend the begginning of the curve to maintain stiffness
	*/
	UPROPERTY(EditAnywhere, Category = Settings)
	bool bResampleForSimulation = true;

	/** Max number of points */
	UPROPERTY(EditAnywhere, Category = Settings, meta = (DisplayName = "Points Count", EditCondition="bResampleForSimulation", EditConditionHides))
	...
	UPROPERTY(EditAnywhere, Category = Settings, meta = (DataflowInput, DisplayName = "Points Count", ClampMin = "2", UIMin = "2", EditCondition = "!bResampleForSimulation", EditConditionHides))
	int32 NumPoints = 16;
};
