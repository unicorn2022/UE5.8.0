...
{ 
	...
	void RegisterGroomDataflowTemplate(const FGroomDataflowTemplateData& DataflowTemplate)
	{
		...
		FDataflowTemplateRegistry::Get().RegisterTemplateAsset(
			...
			{
				.AssetPath = FSoftObjectPath(DataflowTemplate.TemplatePath),
				.DisplayName = FText::FromString(DataflowTemplate.TemplateTitle),
				.Tooltip = FText::FromString(DataflowTemplate.TemplateTooltip),
				.Icon = FSlateIcon("Groom", "ClassThumbnail.GroomAsset")
			});
	}
	...
	void RegisterGroomDataflowTemplatePath(const FString& DataflowTemplatePath)
	{
		...
		FDataflowTemplateRegistry::Get().RegisterTemplateFolder(UGroomAsset::StaticClass(),
			{ DataflowTemplatePath, FSlateIcon("Groom", "ClassThumbnail.GroomAsset") });
	}
	...
	{
		return UE::DataflowAssetDefinitionHelpers::SetDataflowFromTemplatePicker(GroomAsset);
	}
}
