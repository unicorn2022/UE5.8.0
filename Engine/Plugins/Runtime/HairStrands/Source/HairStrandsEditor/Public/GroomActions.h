...
public:
	...
	{
		return NSLOCTEXT("AssetDefinition", "AssetDefinition_Groom", "Groom Asset");
	}
	...
	virtual TConstArrayView<FAssetCategoryPath> GetAssetCategories() const override
	{
		...
		{
			FAssetCategoryPath(EAssetCategoryPaths::Physics, NSLOCTEXT("AssetDefinition", "AssetDefinition_GroomSubMenu", "Other"), ECategoryMenuType::Section)
		};
		return Categories;
	}
