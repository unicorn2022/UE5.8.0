...
#include "DisplayClusterMovieGraphPathTracerPassNode.generated.h"

/**
 * Movie Graph PathTracer render pass node for nDisplay.
 */
UCLASS(BlueprintType)
class DISPLAYCLUSTERMOVIEPIPELINE_API UDisplayClusterMovieGraphPathTracerRenderPassNode : public UMovieGraphPathTracerRenderPassNode
{
	GENERATED_BODY()
