 ...
 * a list of the display cluster's cluster nodes, viewports, or ICVFX cameras to select from.
 */
...
public:
	...
	/** Inspects the specified property's metadata to determine if the node selection array should show cluster nodes or viewports or icvfx cameras in its dropdown lists */
...
private:
	...
	/** The operation mode which indicates whether to display cluster nodes, viewports, or ICVFX cameras in each element's combo box */
