...
public:
	...
	/** Returns mode tools used by this editor instance */
	TSharedRef<FEditorModeTools> GetModeTools() const;
...
private:
	...
	/** A mode tools instance shared among viewports */
	TSharedRef<FEditorModeTools> SharedModeTools;
