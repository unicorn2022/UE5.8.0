...
public:
	...
	*/
	...
	/**
	* Adds a texture transformation pass
	*
	* @param GraphBuilder - RDG builder
	* @param Parameters   - Render parameters
	*/
	virtual void AddTransformTexturePass(FRDGBuilder& GraphBuilder, const FDisplayClusterShaderParameters_TransformTexture& Parameters) const = 0;
