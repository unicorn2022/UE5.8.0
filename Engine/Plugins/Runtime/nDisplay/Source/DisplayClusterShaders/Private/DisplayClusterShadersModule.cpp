...
void FDisplayClusterShadersModule::AddTransformTexturePass(FRDGBuilder& GraphBuilder, const FDisplayClusterShaderParameters_TransformTexture& Parameters) const
{
	FDisplayClusterShadersTransformTexture::AddTransformTexturePass(GraphBuilder, Parameters);
}
