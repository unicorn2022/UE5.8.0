	...
	if (!DllHandle)
	{
		...
		if (!DllHandle && !bInitializeOnce)
		{
			...
			if (DllHandle)
			{
				...
				UE_LOGF(LogDisplayClusterProjectionDomeprojection, Verbose, "Domeprojection API: %ls - %ls.", TEXT("dpCreateContextD3D11"), dpCreateContextFunc ? *StrOk : *StrFail);
				...
				UE_LOGF(LogDisplayClusterProjectionDomeprojection, Verbose, "Domeprojection API: %ls - %ls.", TEXT("dpDestroyContextD3D11"), dpDestroyContextFunc ? *StrOk : *StrFail);
				...
				UE_LOGF(LogDisplayClusterProjectionDomeprojection, Verbose, "Domeprojection API: %ls - %ls.", TEXT("dpLoadConfigurationFromFileD3D11"), dpLoadConfigurationFromFileFunc ? *StrOk : *StrFail);
				...
				UE_LOGF(LogDisplayClusterProjectionDomeprojection, Verbose, "Domeprojection API: %ls - %ls.", TEXT("dpSetClippingPlanesD3D11"), dpSetClippingPlanesFunc ? *StrOk : *StrFail);
				...
				UE_LOGF(LogDisplayClusterProjectionDomeprojection, Verbose, "Domeprojection API: %ls - %ls.", TEXT("dpSetActiveChannelD3D11"), dpSetActiveChannelFunc ? *StrOk : *StrFail);
				...
				UE_LOGF(LogDisplayClusterProjectionDomeprojection, Verbose, "Domeprojection API: %ls - %ls.", TEXT("dpSetCorrectionPassD3D11"), dpSetCorrectionPassFunc ? *StrOk : *StrFail);
				...
				UE_LOGF(LogDisplayClusterProjectionDomeprojection, Verbose, "Domeprojection API: %ls - %ls.", TEXT("dpSetCorrectionPassD3D11_1"), dpSetCorrectionPass1Func ? *StrOk : *StrFail);
				...
				UE_LOGF(LogDisplayClusterProjectionDomeprojection, Verbose, "Domeprojection API: %ls - %ls.", TEXT("dpSetFlipWarpmeshVerticesYD3D11"), dpSetFlipWarpmeshVerticesYFunc ? *StrOk : *StrFail);
				...
				UE_LOGF(LogDisplayClusterProjectionDomeprojection, Verbose, "Domeprojection API: %ls - %ls.", TEXT("dpSetFlipWarpmeshTexcoordsVD3D11"), dpSetFlipWarpmeshTexcoordsVFunc ? *StrOk : *StrFail);

				// dpPreDrawD3D11_1
				dpPreDrawFunc = (dpPreDrawD3D11_1)FPlatformProcess::GetDllExport((HMODULE)DllHandle, TEXT("dpPreDrawD3D11_1"));
				check(dpPreDrawFunc);
				UE_LOGF(LogDisplayClusterProjectionDomeprojection, Verbose, "Domeprojection API: %ls - %ls.", TEXT("dpPreDrawD3D11_1"), dpPreDrawFunc ? *StrOk : *StrFail);

				// dpPostDrawD3D11
				dpPostDrawFunc = (dpPostDrawD3D11)FPlatformProcess::GetDllExport((HMODULE)DllHandle, TEXT("dpPostDrawD3D11"));
				check(dpPostDrawFunc);
				UE_LOGF(LogDisplayClusterProjectionDomeprojection, Verbose, "Domeprojection API: %ls - %ls.", TEXT("dpPostDrawD3D11"), dpPostDrawFunc ? *StrOk : *StrFail);
				...
				UE_LOGF(LogDisplayClusterProjectionDomeprojection, Verbose, "Domeprojection API: %ls - %ls.", TEXT("dpGetOrientation"), dpGetOrientationFunc ? *StrOk : *StrFail);
			}
			else
			{
				UE_LOGF(LogDisplayClusterProjectionDomeprojection, Error, "Couldn't initialize Domeprojection API. No <%ls> library found.", *DllPath);
				return false;
			}
		}
	}
