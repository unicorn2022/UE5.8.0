...
private:
	...
	// Persistent by-name binding to the mesh component used for preview.
	FDisplayClusterSceneComponentRef MeshComponentBinding;

	// Resolved weak handle from the binding above.
