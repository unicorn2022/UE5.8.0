...
public:
	...
	*/
	...
	/** Scale a viewport rect by a per-axis multiplier.
	*
	* @param InRect        - the input rect
	* @param InPerAxisMult - per-axis size multiplier
	*
	* @return - scaled viewport rect
	*/
	static FIntRect ScaleViewportRect(const FIntRect& InRect, const FVector2D& InPerAxisMult);
