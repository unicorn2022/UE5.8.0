...
public:
	...
	virtual IDisplayClusterGUILayerController& GetGuiLayerController() const override;
...
private:
	...
	void OnBackBufferReadyToPresent_SetCustomPresent(class SWindow& Window, class ISlateViewportProvider& ViewportProvider) const;
...
private:
	...
	mutable FCustomPresentRHIRef NativePresentHandler = nullptr;
