...
public:
	...
	virtual bool SynchronizeClusterRendering(FRHIViewport* ViewportRHI, int32& InOutSyncInterval) override;

protected:
	virtual void Procedure_SynchronizePresent(FRHIViewport* ViewportRHI);
	virtual void Step_InitializeFrameSynchronization(FRHIViewport* ViewportRHI);
	virtual void Step_WaitForFrameCompletion(FRHIViewport* ViewportRHI);
	...
	virtual void Step_Present(FRHIViewport* ViewportRHI);
	virtual void Step_FinalizeFrameSynchronization();

	double GetVBlankTimestamp(FRHIViewport* ViewportRHI);
