...
EDisplayClusterCommResult FDisplayClusterClusterNodeCtrlDisabled::GetObjectsData(EDisplayClusterSyncGroup InSyncGroup, TMap<FString, TArray<uint8>>& OutObjectsData)
{
	return EDisplayClusterCommResult::NotAllowed;
}
...
EDisplayClusterCommResult FDisplayClusterClusterNodeCtrlDisabled::GetNativeInputData(TMap<FString, TArray<uint8>>& OutNativeInputData)
{
	return EDisplayClusterCommResult::NotAllowed;
}

EDisplayClusterCommResult FDisplayClusterClusterNodeCtrlDisabled::PropagateStatesData(const TArray<uint8>& InLocalStatesData, TArray<uint8>& OutClusterStatesData)
{
	return EDisplayClusterCommResult::NotAllowed;
}
