...
public:
	...
	TFunction<void(const EDisplayClusterSyncGroup InSyncGroup, TMap<FString, TArray<uint8>>& OutObjectsData)> GetObjectsData_OpLoad;

	/** Caches sync objects data */
	TFunction<void(const EDisplayClusterSyncGroup InSyncGroup, TMap<FString, TArray<uint8>>& InObjectsData)> GetObjectsData_OpSave;
...
public:
	...
	TFunction<void(TMap<FString, TArray<uint8>>& OutNativeInputData)> GetNativeInputData_OpLoad;

	/** Caches input data */
	TFunction<void(TMap<FString, TArray<uint8>>& InNativeInputData)> GetNativeInputData_OpSave;
...
private: // GetObjectsData
	...
	public:
		...
		TMap<FString, TArray<uint8>> ObjData;

	public:

		/** Copies data TO or FROM */
		void CopyData(bool bCopyOutside, TMap<FString, TArray<uint8>>& ObjDataRef)
		{
			if (bCopyOutside)
			{
				ObjDataRef = ObjData;
...
private: // GetNativeInputData
	...
	public:
		...
		/** Copies data TO or FROM */
		void CopyData(bool bCopyOutside, TMap<FString, TArray<uint8>>& NativeInputDataRef)
		{
			if (bCopyOutside)
			{
