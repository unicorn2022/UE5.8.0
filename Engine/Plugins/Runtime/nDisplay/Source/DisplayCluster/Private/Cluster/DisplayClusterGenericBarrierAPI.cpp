...
FDisplayClusterGenericBarrierAPI::FDisplayClusterGenericBarrierAPI()
{
	...
	UE_LOGF(LogDisplayClusterBarrierGP, Log, "GP barrier client '%d' instantiated", ClientSetId)
}
...
FDisplayClusterGenericBarrierAPI::~FDisplayClusterGenericBarrierAPI()
{
	if (IDisplayCluster::IsAvailable())
	{
		...
		UE_LOGF(LogDisplayClusterBarrierGP, Log, "GP barrier client '%d' released", ClientSetId)
	}
}
