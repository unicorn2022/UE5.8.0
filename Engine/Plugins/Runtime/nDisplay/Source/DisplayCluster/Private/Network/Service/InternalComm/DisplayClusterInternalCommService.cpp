...
{
	return DisplayClusterInternalCommStrings::ProtocolName;
}
...
TSharedPtr<FDisplayClusterPacketInternal> FDisplayClusterInternalCommService::ProcessPacket(const TSharedPtr<FDisplayClusterPacketInternal>& Request, const FDisplayClusterSessionInfo& SessionInfo)
{
	...
	if (!Request->GetProtocol().Equals(DisplayClusterInternalCommStrings::ProtocolName, ESearchCase::IgnoreCase) ||
		!Request->GetType().Equals(DisplayClusterInternalCommStrings::TypeRequest, ESearchCase::IgnoreCase))
	{
