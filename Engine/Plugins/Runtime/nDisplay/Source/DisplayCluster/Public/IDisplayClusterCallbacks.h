...
public:
	...
	DECLARE_EVENT_OneParam(IDisplayClusterCallbacks, FDisplayClusterPresentationPreSynchronization_RHIThread, FRHIViewport*);
	...
	DECLARE_EVENT_OneParam(IDisplayClusterCallbacks, FDisplayClusterPresentationPostSynchronization_RHIThread, FRHIViewport*);
