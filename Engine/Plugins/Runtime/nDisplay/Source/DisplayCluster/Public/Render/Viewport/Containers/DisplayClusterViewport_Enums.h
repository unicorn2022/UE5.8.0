...
/**
 * Viewport usage type flags.
 */
enum class EDisplayClusterViewportFlags : uint8
{
	/** The standard viewport does not have any special flags. */
	None = 0,
	...
	/** ICVFX viewports. */
	ICVFX_InnerFrustum = 1 << 1,
	ICVFX_ChromaKey    = 1 << 2,
	ICVFX_LightCard    = 1 << 3,
	ICVFX_UVLightCard  = 1 << 4,

	/** ICVFX render modifiers. */
	ICVFX_Modifier_RenderOverInnerFrustum  = 1 << 5,
	ICVFX_Modifier_RenderUnderInnerFrustum = 1 << 6,

	/** Combined mask for any ICVFX viewport role (excludes modifiers). */
	ICVFX_AnyRole =
	  ICVFX_InnerFrustum
	| ICVFX_ChromaKey
	| ICVFX_LightCard
...
ENUM_CLASS_FLAGS(EDisplayClusterViewportFlags);
