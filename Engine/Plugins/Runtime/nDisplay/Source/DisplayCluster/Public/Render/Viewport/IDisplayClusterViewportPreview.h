...
*/
class DISPLAYCLUSTER_API IDisplayClusterViewportPreview
{
public:
...
public:
	...
	/** Returns the viewport that owns this object. */
	virtual TSharedPtr<IDisplayClusterViewport, ESPMode::ThreadSafe> GetOwningViewport() const = 0;
	...
	/** Deprecated. The base implementation returns nullptr. Use GetOwningViewport() instead. */
	UE_DEPRECATED(5.8, "This function is deprecated. Use GetOwningViewport() instead.")
	virtual IDisplayClusterViewport* GetViewport() const
	{ return nullptr; };
};
