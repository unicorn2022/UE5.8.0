	...
	, bForceApply(false)
{
	...
	UE_LOGF(LogDisplayClusterRemoteControlInterceptor, Log, "DisplayClusterRemoteControlInterceptor has been registered");
}
...
FDisplayClusterRemoteControlInterceptor::~FDisplayClusterRemoteControlInterceptor()
{
	...
	UE_LOGF(LogDisplayClusterRemoteControlInterceptor, Log, "DisplayClusterRemoteControlInterceptor has been unregistered");
}
...
{
	UE_LOGF(LogDisplayClusterRemoteControlInterceptor, VeryVerbose, "Processing replication event SetObjectProperties: %d bytes", Buffer.Num());
...
{
	UE_LOGF(LogDisplayClusterRemoteControlInterceptor, VeryVerbose, "Processing replication event ResetObjectProperties: %d bytes", Buffer.Num());
...
{
	UE_LOGF(LogDisplayClusterRemoteControlInterceptor, VeryVerbose, "Processing replication event InvokeCall: %d bytes", Buffer.Num());
...
{
	UE_LOGF(LogDisplayClusterRemoteControlInterceptor, VeryVerbose, "Processing replication event SetPresetController: %d bytes", Buffer.Num());
