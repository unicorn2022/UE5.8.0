...
{
	UE_LOGF(LogNetworkPredictionExtrasLatentLoad, Display, "STARTUP FNetworkPredictionExtrasLatentLoadModule");
}


void FNetworkPredictionExtrasLatentLoadModule::ShutdownModule()
{
	UE_LOGF(LogNetworkPredictionExtrasLatentLoad, Display, "SHUTDOWN FNetworkPredictionExtrasLatentLoadModule");
}
