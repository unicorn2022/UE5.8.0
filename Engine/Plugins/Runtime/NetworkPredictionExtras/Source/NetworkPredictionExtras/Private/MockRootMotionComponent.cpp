...
UMockRootMotionSource* UMockRootMotionComponent::CreateRootMotionSource(TSubclassOf<UMockRootMotionSource> Source)
{
	...
	UE_LOGF(LogNetworkPrediction, Warning, "CreateRootMotionSource called with null class");
	return nullptr;
}
...
void UMockRootMotionComponent::Input_PlayRootMotionSourceByClass(TSubclassOf<UMockRootMotionSource> Source)
{
	...
	{
		UE_LOGF(LogNetworkPrediction, Warning, "Input_PlayRootMotionSourceByClass called with null class");
	}
}
...
void UMockRootMotionComponent::Input_PlayRootMotionSource(UMockRootMotionSource* Source)
{
	...
	{
		UE_LOGF(LogNetworkPrediction, Warning, "Invalid Source (%ls) in call to Input_PlayRootMotionSource", *GetNameSafe(Source));
		return;
	}
...
void UMockRootMotionComponent::PlayRootMotionSourceByClass(TSubclassOf<UMockRootMotionSource> Source)
{
	...
	{
		UE_LOGF(LogNetworkPrediction, Warning, "PlayRootMotionSourceByClass called with null class");
	}
}
...
UMockRootMotionSource* UMockRootMotionComponent::ResolveRootMotionSource(int32 ID, const TArrayView<const uint8>& Data)
{
	...
	{
		UE_LOGF(LogNetworkPrediction, Warning, "Resolved object %ls is not a subclass of URootMotionSource", *GetNameSafe(Obj));
		return nullptr;
	}
