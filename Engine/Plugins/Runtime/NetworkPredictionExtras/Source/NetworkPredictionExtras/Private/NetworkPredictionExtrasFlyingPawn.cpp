...
{
	UE_LOGF(LogNetworkPrediction, Warning, "======== ANetworkPredictionExtrasFlyingPawn::PrintDebug ========");
	...
	if (StackTrace != nullptr)
	{
		...
		UE_LOGF(LogNetworkPrediction, Log, "Call Stack:\n%ls", ANSI_TO_TCHAR(StackTrace));
