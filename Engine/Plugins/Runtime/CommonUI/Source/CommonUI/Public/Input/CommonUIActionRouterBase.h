...
public:
	...
	UE_API void RegisterScrollRecipient(const UWidget& ScrollableWidget, UWidget* OwningNodeWidget = nullptr);
	UE_API void UnregisterScrollRecipient(const UWidget& ScrollableWidget, UWidget* OwningNodeWidget = nullptr);
	...
	UE_API bool IsWidgetInLeafmostNodeHierarchy(const UWidget& Widget) const;

	UE_API UCommonActivatableWidget* GetLeafmostActivatableWidget() const;
...
private:
	...
	UE_API void HandleVirtualPointerEnabled(bool bEnabled);
