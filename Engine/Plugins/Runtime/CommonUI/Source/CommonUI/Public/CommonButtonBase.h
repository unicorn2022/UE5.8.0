...
public:
	...
	int32 GetMinHeight() const { return MinHeight; }
	COMMONUI_API void SetMinDesiredWidth(int32 InMinWidth);
	int32 GetMinWidth() const { return MinWidth; }
	...
	int32 GetMaxWidth() const { return MaxWidth; }
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Common Button|Setters")
	COMMONUI_API void SetHideInputActionWithKeyboard(bool bInHideInputActionWithKeyboard);
	...
	/** Updates the display name via its bound UIAction **/
	UFUNCTION(BlueprintCallable, Category = "Common Button|Setters")
	COMMONUI_API void SetActionDisplayName(const FText& InDisplayName);
...
protected:
    ...
    */
	...
	COMMONUI_API void RefreshDimensions(const int32 InMinWidth,const int32 InMinHeight,const int32 InMaxWidth,const int32 InMaxHeight);
	...
	COMMONUI_API virtual void UpdateInputActionWidgetVisibility();
