...
public:
	...
	UE_API virtual void ToTextBlockStyle(FTextBlockStyle& OutTextBlockStyle) const;

	UE_API virtual void ApplyToTextBlock(const TSharedRef<STextBlock>& TextBlock) const;
};
