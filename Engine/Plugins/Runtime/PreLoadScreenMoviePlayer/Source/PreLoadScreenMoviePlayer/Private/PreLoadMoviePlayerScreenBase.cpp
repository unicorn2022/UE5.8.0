...
void FPreLoadMoviePlayerScreenBase::Init()
{
	...
	{
		UE_LOGF(LogPreloadMoviePlayer, Log, "Init failed for PreLoadMoviePlayerScreenBase");
		return;
	}
	...
	{
		UE_LOGF(LogPreloadMoviePlayer, Log, "Init failed for PreLoadMoviePlayerScreenBase, no MoviePaths defined.");
		return;
	}
	...
	UE_LOGF(LogPreloadMoviePlayer, Log, "Init completed for PreLoadMoviePlayerScreenBase");
}
