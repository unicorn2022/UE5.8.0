...
private:
	...
	virtual TNotNull<const IStateTreeDebugInfoProvider*> GetDebugInfoProvider() override;
	virtual void SetDebugInfoProvider(TSharedPtr<IStateTreeDebugInfoProvider> InDebugInfoProvider) override;

	TSharedPtr<IStateTreeDebugInfoProvider> DebugInfoProvider;
