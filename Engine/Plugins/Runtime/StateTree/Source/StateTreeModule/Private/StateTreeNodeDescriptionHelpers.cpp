...
FText GetOperatorText(const EComparisonOperator Operator, EStateTreeNodeFormatting Formatting)
{
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
	return GetOperatorText(UE::StateTree::Conditions::GenericAICheckToComparisonOperator(Operator), Formatting);
