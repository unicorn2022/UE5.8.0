...
{
	// Deprecated
	EComparisonOperator GenericAICheckToComparisonOperator(EGenericAICheck Operator)
	{
		switch (Operator)
		{
...
FStateTreeCompareIntCondition::FStateTreeCompareIntCondition(const EGenericAICheck InOperator, const EStateTreeCompare InInverts)
	: FStateTreeCompareIntCondition(UE::StateTree::Conditions::GenericAICheckToComparisonOperator(InOperator), InInverts)
{}
...
// Deprecated
PRAGMA_DISABLE_DEPRECATION_WARNINGS
FStateTreeCompareFloatCondition::FStateTreeCompareFloatCondition(const EGenericAICheck InOperator, const EStateTreeCompare InInverts)
	: FStateTreeCompareFloatCondition(UE::StateTree::Conditions::GenericAICheckToComparisonOperator(InOperator), InInverts)
{
}
PRAGMA_ENABLE_DEPRECATION_WARNINGS
...
// Deprecated
PRAGMA_DISABLE_DEPRECATION_WARNINGS
FStateTreeCompareDistanceCondition::FStateTreeCompareDistanceCondition(const EGenericAICheck InOperator, const EStateTreeCompare InInverts)
	: FStateTreeCompareDistanceCondition(UE::StateTree::Conditions::GenericAICheckToComparisonOperator(InOperator), InInverts)
{
}
PRAGMA_ENABLE_DEPRECATION_WARNINGS
