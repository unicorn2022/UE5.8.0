...
struct FStateTreeCompareIntCondition : public FStateTreeConditionCommonBase
{
	...
	explicit FStateTreeCompareIntCondition(const UE::StateTree::EComparisonOperator InOperator, const EStateTreeCompare InInverts = EStateTreeCompare::Default)
		: bInvert(InInverts == EStateTreeCompare::Invert)
		, Operator(InOperator)
	{}

	UE_DEPRECATED(5.8, "Use EComparisonOperator instead.")
	UE_API explicit FStateTreeCompareIntCondition(const EGenericAICheck InOperator, const EStateTreeCompare InInverts = EStateTreeCompare::Default);
...
UE_STATETREE_ZEROED_TRIVIALLY_COPIED_NO_DESTRUCTOR_INSTANCEDATA(FStateTreeCompareFloatConditionInstanceData);
...
struct FStateTreeCompareFloatCondition : public FStateTreeConditionCommonBase
{
	...
	explicit FStateTreeCompareFloatCondition(const UE::StateTree::EComparisonOperator InOperator, const EStateTreeCompare InInverts = EStateTreeCompare::Default)
		: bInvert(InInverts == EStateTreeCompare::Invert)
		, Operator(InOperator)
	{}

	UE_DEPRECATED(5.8, "Use EComparisonOperator instead.")
	UE_API explicit FStateTreeCompareFloatCondition(const EGenericAICheck InOperator, const EStateTreeCompare InInverts = EStateTreeCompare::Default);
...
UE_STATETREE_ZEROED_TRIVIALLY_COPIED_NO_DESTRUCTOR_INSTANCEDATA(FStateTreeCompareBoolConditionInstanceData);
...
UE_STATETREE_ZEROED_TRIVIALLY_COPIED_NO_DESTRUCTOR_INSTANCEDATA(FStateTreeCompareDistanceConditionInstanceData);
...
struct FStateTreeCompareDistanceCondition : public FStateTreeConditionCommonBase
{
	...
	explicit FStateTreeCompareDistanceCondition(const UE::StateTree::EComparisonOperator InOperator, const EStateTreeCompare InInverts = EStateTreeCompare::Default)
		: bInvert(InInverts == EStateTreeCompare::Invert)
		, Operator(InOperator)
	{}

	UE_DEPRECATED(5.8, "Use EComparisonOperator instead.")
	UE_API explicit FStateTreeCompareDistanceCondition(const EGenericAICheck InOperator, const EStateTreeCompare InInverts = EStateTreeCompare::Default);
...
UE_STATETREE_CONSTRUCTED_TRIVIALLY_COPIED_NO_DESTRUCTOR_INSTANCEDATA(FStateTreeCompareNameConditionInstanceData);
...
UE_STATETREE_CONSTRUCTED_TRIVIALLY_COPIED_NO_DESTRUCTOR_INSTANCEDATA(FStateTreeRandomConditionInstanceData);
