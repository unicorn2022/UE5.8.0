...
/** @return description for a EComparisonOperator. */
extern STATETREEMODULE_API FText GetOperatorText(const EComparisonOperator Operator, EStateTreeNodeFormatting Formatting);

UE_DEPRECATED(5.8, "Use GetOperatorText with EComparisonOperator instead.")
/** @return description for a EComparisonOperator. */
