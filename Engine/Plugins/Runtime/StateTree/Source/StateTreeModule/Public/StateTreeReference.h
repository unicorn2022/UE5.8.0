...
struct FStateTreeReference
{
	...
	/** @return the parameters for the referenced StateTree asset. */
	...
	{
		ConditionallySyncParameters();
		return Parameters.GetMutableValue();
	}
...
private:
	...
	UPROPERTY(EditAnywhere, Category = "StateTree", DisplayName = "State Tree", meta=(SchemaCanBeOverriden))
