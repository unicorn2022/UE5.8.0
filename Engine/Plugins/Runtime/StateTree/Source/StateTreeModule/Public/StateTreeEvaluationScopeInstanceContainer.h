...
namespace UE::StateTree::InstanceData
{
	...
	public:
		...
		[[nodiscard]] FStructView GetDataView(FStateTreeDataHandle DataHandle)
		{
			return Get(DataHandle)->Instance;
		}

		/** @return specified item if the structure was added. */
		[[nodiscard]] FStructView* GetDataViewPtr(FStateTreeDataHandle DataHandle)
		{
