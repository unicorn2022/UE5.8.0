...
struct FNativeGameplayTags : public FGameplayTagNativeAdder
{
	...
	FGameplayTag TestTag4;
	FGameplayTag TestTag5;
	FGameplayTag TestTag6;
	...
	virtual void AddTags() override
	{
		...
		TestTag3 = Manager.AddNativeGameplayTag(TEXT("Test.StateTree.Tag3"));
		TestTag4 = Manager.AddNativeGameplayTag(TEXT("Test.StateTree.Tag4"));
		TestTag5 = Manager.AddNativeGameplayTag(TEXT("Test.StateTree.Tag5"));
		TestTag6 = Manager.AddNativeGameplayTag(TEXT("Test.StateTree.Tag6"));
	}
};
...
FGameplayTag FStateTreeTestBase::GetTestTag4()
{
	return GameplayTagStaticInstance.TestTag4;
}

FGameplayTag FStateTreeTestBase::GetTestTag5()
{
	return GameplayTagStaticInstance.TestTag5;
}

FGameplayTag FStateTreeTestBase::GetTestTag6()
{
	return GameplayTagStaticInstance.TestTag6;
}
