...
TConstArrayView<FAssetCategoryPath> UAssetDefinition_StateTree::GetAssetCategories() const
{
	static FAssetCategoryPath Categories[] =
		{
			FAssetCategoryPath(EAssetCategoryPaths::AI, LOCTEXT("AssetDefinition_StateTreeSubMenu_AI", "NPC"), ECategoryMenuType::Section),
			FAssetCategoryPath(EAssetCategoryPaths::Gameplay, LOCTEXT("StateTree_SubMenu_Gameplay", "Other"), ECategoryMenuType::Section)
		};
