...
struct FStateTreeNodeClassData
{
	...
	TWeakObjectPtr<UStruct> GetWeakStruct() const
	{
		return CachedStruct;
	}
...
private:
	struct FRootClassContainer
	{
		...
		FRootClassContainer(TNotNull<UStruct*> InBaseStruct, int32 InIndex)
	...
	UE_API void CacheClasses(FRootClassContainer& RootClass);
