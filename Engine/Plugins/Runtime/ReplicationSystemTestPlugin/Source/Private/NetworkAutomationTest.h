...
#define UE_NET_TEST_CATCH_INTERNAL(TestSuite, TestCase, BaseClass) \
	...
	INTERNAL_CATCH_TEST_CASE_METHOD2(Catch::DefaultGroup, TestSuite ## _ ## TestCase, (TCatchFixtureWrapper<BaseClass, TestSuite ## _ ## TestCase ## Name>), UE_STRINGIZE(TestSuite ## _ ## TestCase))
