...
void UReplicatedTestObjectBridge::Initialize(UReplicationSystem* InReplicationSystem)
{
	...
	TestObjectFactory = CastChecked<UReplicatedTestObjectFactory>(GetNetFactory(ReplicatedObjectFactoryId));
}
...
UE::Net::FNetRefHandle UReplicatedTestObjectBridge::BeginReplication(UReplicatedTestObject* Instance)
{
	...
	FNetRefHandle Handle = Super::StartReplicatingRootObject(Instance, ReplicatedObjectFactoryId);
...
{
	// Create NetRefHandle for the registered fragments
	TestObjectFactory->AddRootObjectReplicationParams(Instance, Params);
	FNetRefHandle Handle = Super::StartReplicatingRootObject(Instance, ReplicatedObjectFactoryId);
...
UE::Net::FNetRefHandle UReplicatedTestObjectBridge::BeginReplication(FNetRefHandle OwnerHandle, UReplicatedTestObject* SubObjectInstance)
{
	check(OwnerHandle.IsValid());

	// Create NetRefHandle for the registered fragments
	const FSubObjectReplicationParams Params { .RootObjectHandle = OwnerHandle };
...
UE::Net::FNetRefHandle UReplicatedTestObjectBridge::BeginReplication(UReplicatedTestObject* SubObjectInstance, const FSubObjectReplicationParams& Params)
{
	check(Params.RootObjectHandle.IsValid());
...
//////////////////////////////////////////////////////////////////////////
// Implementation for UTestReplicatedIrisObjectWithStableSubObject
//////////////////////////////////////////////////////////////////////////
UTestReplicatedIrisObjectWithStableSubObject::UTestReplicatedIrisObjectWithStableSubObject()
: UReplicatedTestObject()
{
	DefaultSubObject = CreateDefaultSubobject<UTestReplicatedIrisObjectWithObjectReference>(TEXT("DefaultSubObject"));
}

void UTestReplicatedIrisObjectWithStableSubObject::RegisterReplicationFragments(UE::Net::FFragmentRegistrationContext& Fragments, UE::Net::EFragmentRegistrationFlags RegistrationFlags)
{
	Fragments.SetIsFragmentlessNetObject(true);
}
