...
UE_NET_TEST_FIXTURE(FReplicationBridgeTestFixture, CreateObjectWithSingleFragment)
{
	...
	UE_NET_ASSERT_EQ(Align(32u + static_cast<uint32>(sizeof(FReplicationStateHeader)), 8U), Protocol->MaxExternalStateSize);
...
UE_NET_TEST_FIXTURE(FReplicationBridgeTestFixture, CreateObjectWithMultipleFragments)
{
	...
	UE_NET_ASSERT_EQ(Align(36u + static_cast<uint32>(sizeof(FReplicationStateHeader)), 8U), Protocol->MaxExternalStateSize);
...
UE_NET_TEST_FIXTURE(FReplicationBridgeTestFixture, CreateObjectWithMixedFragments)
{
	...
	UE_NET_ASSERT_EQ(Align(40u + static_cast<uint32>(sizeof(FReplicationStateHeader)), 8U), Protocol->MaxExternalStateSize);
