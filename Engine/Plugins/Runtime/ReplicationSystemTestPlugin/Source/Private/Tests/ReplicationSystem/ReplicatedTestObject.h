...
class UReplicatedTestObjectFactory;
...
public:
	...
	virtual bool IsNameStableForNetworking() const override { return Super::IsNameStableForNetworking() || bForceStablyNamed; }
	virtual bool IsFullNameStableForNetworking() const override { return Super::IsFullNameStableForNetworking() || bForceStablyNamed; }
	...
	// Force the object to be treated as stably named
	bool bForceStablyNamed = false;
};
...
/**
 *  A test class for replication of static subobjects
 */
UCLASS()
class UTestReplicatedIrisObjectWithStableSubObject : public UReplicatedTestObject
{
	GENERATED_BODY()

public:
	UTestReplicatedIrisObjectWithStableSubObject();

	// Network interface must be part of base.
	virtual void RegisterReplicationFragments(UE::Net::FFragmentRegistrationContext& Fragments, UE::Net::EFragmentRegistrationFlags RegistrationFlags) override;

	UPROPERTY(Transient)
	TObjectPtr<UReplicatedTestObject> DefaultSubObject;
...
public:
	...
	FNetRefHandle BeginReplication(FNetRefHandle OwnerHandle, UReplicatedTestObject* Instance);
	FNetRefHandle BeginReplication(UReplicatedTestObject* SubObjectInstance, const FSubObjectReplicationParams& Params);
	...
	class FSuppressCreateInstanceFailedEnsureScope
	{
	public:
		explicit FSuppressCreateInstanceFailedEnsureScope(UReplicatedTestObjectBridge& BridgeIn) : Bridge(BridgeIn), bSuppressCreateInstanceFailedEnsure(Bridge.bSuppressCreateInstanceFailedEnsure)
		{
			Bridge.bSuppressCreateInstanceFailedEnsure = true;
		}
		~FSuppressCreateInstanceFailedEnsureScope()
		{
			// Restore
...
protected:
	...
	friend FSuppressCreateInstanceFailedEnsureScope;
	...
	UReplicatedTestObjectFactory* TestObjectFactory = nullptr;
};
