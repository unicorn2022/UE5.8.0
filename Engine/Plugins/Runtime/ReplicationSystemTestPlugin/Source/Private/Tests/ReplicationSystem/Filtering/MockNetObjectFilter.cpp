...
void UMockNetObjectFilter::OnMaxInternalNetRefIndexIncreased(UE::Net::FInternalNetRefIndex NewMaxInternalIndex)
{
...
bool UMockNetObjectFilter::AddObject(UE::Net::FInternalNetRefIndex ObjectIndex, FNetObjectFilterAddObjectParams& Params)
{
...
void UMockNetObjectFilter::RemoveObject(UE::Net::FInternalNetRefIndex ObjectIndex, const FNetObjectFilteringInfo& Info)
{
...
void UMockNetObjectFilter::UpdateObjects(FNetObjectFilterUpdateParams& Params)
{
	...
	for (UE::Net::FInternalNetRefIndex ObjectIndex : MakeArrayView(Params.ObjectIndices, Params.ObjectCount))
	{
...
void UMockNetObjectFilter::Filter(FNetObjectFilteringParams& Params)
{
	...
	UE::Net::FNetBitArrayView AddedObjectsView = MakeNetBitArrayView(AddedObjectIndices);

	bool bIsProperCall = true;
	UE::Net::FNetBitArrayView::ForAllExclusiveBits(GetFilteredObjects(), AddedObjectsView, [](...) {}, [&bIsProperCall](...) {bIsProperCall = false; });
	...
	{
		Params.OutAllowedObjects.Copy(AddedObjectsView);
	}
}
...
bool UMockNetObjectFilterWithCondition::AddObject(UE::Net::FInternalNetRefIndex ObjectIndex, FNetObjectFilterAddObjectParams& Params)
{
...
void UMockNetObjectFilterWithCondition::Filter(FNetObjectFilteringParams& Params)
{
	...
	GetFilteredObjects().ForAllSetBits([&](UE::Net::FInternalNetRefIndex ObjectIndex)
	{
