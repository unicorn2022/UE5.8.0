...
UE_NET_TEST_FIXTURE(FTestInstancedStructNetSerializerFixture, TestSerializeDeltaEqualUnsetInstances)
{
	QuantizeTwoStates();
	SerializeDelta();
}
...
{
	// Equal types but different states
	...
	InstancedStruct1.InitializeAs<FStructForInstancedStructTestA>();
	InstancedStruct1.GetMutable<FStructForInstancedStructTestA>().SomeUint16 += 711U;

	QuantizeTwoStates();
	SerializeDelta();
}

UE_NET_TEST_FIXTURE(FTestInstancedStructNetSerializerFixture, TestSerializeDeltaNonEqualTypes)
{
	// Different types
	InstancedStruct0.InitializeAs<FStructForInstancedStructTestWithArray>();
	InstancedStruct0.GetMutable<FStructForInstancedStructTestWithArray>().ArrayOfTestB.SetNum(17);
...
UE_NET_TEST_FIXTURE(FTestInstancedStructNetSerializerFixture, TestDeserializeDeltaEqualUnsetInstances)
{
	QuantizeTwoStates();
	SerializeDelta();
	DeserializeDelta();
...
UE_NET_TEST_FIXTURE(FTestInstancedStructNetSerializerFixture, TestDeserializeDeltaNonEqualTypes)
{
	// Different types
	InstancedStruct0.InitializeAs<FStructForInstancedStructTestWithArray>();
	InstancedStruct0.GetMutable<FStructForInstancedStructTestWithArray>().ArrayOfTestB.SetNum(17);
...
UE_NET_TEST_FIXTURE(FTestInstancedStructNetSerializerFixture, TestDequantizeDeltaSerializedUnsetInstances)
{
	QuantizeTwoStates();
	SerializeDelta();
	DeserializeDelta();
...
UE_NET_TEST_FIXTURE(FTestInstancedStructNetSerializerFixture, TestDequantizeDeltaSerializedNonEqualStates)
{
	// Equal types but different states
	InstancedStruct0.InitializeAs<FStructForInstancedStructTestA>();
	InstancedStruct0.GetMutable<FStructForInstancedStructTestA>().SomeUint16 += 4711U;
...
UE_NET_TEST_FIXTURE(FTestInstancedStructNetSerializerFixture, TestDequantizeDeltaSerializedNonEqualTypes)
{
	// Different types
	InstancedStruct0.InitializeAs<FStructForInstancedStructTestWithArray>();
	InstancedStruct0.GetMutable<FStructForInstancedStructTestWithArray>().ArrayOfTestB.SetNum(17);
...
// End-to-end tests
UE_NET_TEST_FIXTURE(FTestInstancedStructNetSerializerFixture, CanInitializeInstancedStructInConstructor)
{
	// Add a client
	...
	UE_NET_ASSERT_EQ(ClientObject->ConstructorInitializedInstancedStruct.GetScriptStruct(), static_cast<const UScriptStruct*>(FStructForInstancedStructTestA::StaticStruct()));
}

UE_NET_TEST_FIXTURE(FTestInstancedStructNetSerializerFixture, CanModifyInstancedStructInitializedInConstructor)
{
	// Add a client
	FReplicationSystemTestClient* Client = CreateClient();
	...
	// Spawn object on server
	UInstancedStructNetSerializerTestObject* ServerObject = Server->CreateObject<UInstancedStructNetSerializerTestObject>();
	ServerObject->ConstructorInitializedInstancedStruct.GetMutable<FStructForInstancedStructTestA>().SomeUint16 += 1;
	...
	CA_ASSUME(ClientObject != nullptr);
	UE_NET_ASSERT_EQ(ClientObject->ConstructorInitializedInstancedStruct.GetScriptStruct(), static_cast<const UScriptStruct*>(FStructForInstancedStructTestA::StaticStruct()));
	UE_NET_ASSERT_EQ(ClientObject->ConstructorInitializedInstancedStruct.Get<FStructForInstancedStructTestA>().SomeUint16, ServerObject->ConstructorInitializedInstancedStruct.Get<FStructForInstancedStructTestA>().SomeUint16);
}
...
//
UInstancedStructNetSerializerTestObject::UInstancedStructNetSerializerTestObject()
{
	ConstructorInitializedInstancedStruct.InitializeAs<FStructForInstancedStructTestA>();
}
...
void UInstancedStructNetSerializerTestObject::GetLifetimeReplicatedProps(TArray<class FLifetimeProperty>& OutLifetimeProps) const
{
	...
	DOREPLIFETIME_WITH_PARAMS_FAST(ThisClass, ConstructorInitializedInstancedStruct, Params);
