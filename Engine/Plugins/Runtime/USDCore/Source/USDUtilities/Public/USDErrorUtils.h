...
{
public:
	using FMessageDisplayCallback = TFunction<void(const TArray<TSharedRef<FTokenizedMessage>>&)>;
	...
	static UE_API void DisplayMessagesOnMessageLog(const TArray<TSharedRef<FTokenizedMessage>>& Messages);
...
{
public:
	UE_API FScopedUsdMessageLog(FUsdLogManager::FMessageDisplayCallback = FUsdLogManager::DisplayMessagesOnMessageLog);
