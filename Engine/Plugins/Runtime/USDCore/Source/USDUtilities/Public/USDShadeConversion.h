...
namespace UsdToUnreal
{
	...
	using FParameterValue = TVariant<float, FVector, FTextureParameterValue, FPrimvarReaderParameterValue, bool, int32>;
	 ...
	 * @param bShareAssetsForIdenticalPrims - Whether to reuse identical textures found in the TextureCache or to create dedicated textures for each material
...
namespace UsdUtils
{
	...
	USDUTILITIES_API void AuthorUnrealMaterialBinding(
		pxr::UsdPrim& MeshOrGeomSubsetPrim,
	...
	USDUTILITIES_API bool HasSurfaceOutput(const pxr::UsdPrim& MaterialPrim, const TArray<FString>& RenderContexts);
	...
	USDUTILITIES_API bool HasDisplacementOutput(const pxr::UsdPrim& MaterialPrim, const TArray<FString>& RenderContexts);
	...
	USDUTILITIES_API bool HasVolumeOutput(const pxr::UsdPrim& MaterialPrim, const TArray<FString>& RenderContexts);
