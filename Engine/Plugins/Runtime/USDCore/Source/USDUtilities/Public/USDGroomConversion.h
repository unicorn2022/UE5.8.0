...
namespace UsdToUnreal
{
	 ...
	 * @param bCheckGroomAttributes -  Optional Whether to check the groom-scope attributes, 
	 *                                 should only be checked (true) on the top-level prim
	...
	USDUTILITIES_API bool ConvertGroomHierarchy(
		...
		bool bCheckGroomAttributes = true
	);
}
