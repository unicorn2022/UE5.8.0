...
{
	// Make sure the UnrealUSDWrapper module is loaded first since FUsdInfoCacheImpl will call UnrealUSDWrapper::GetNativeFileFormats
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(FUsdInfoCache::Clear);
