...
// XXX(Epic Games):
// The machinery is in the OpenUSD CMake build to allow enabling or disabling
// memory overloads at OpenUSD build time, but for now they are currently
// only enabled in UE for Windows.
#if PLATFORM_WINDOWS
