...
class UE_DEPRECATED(all, "Use the UUsdAssetCache2 class instead, which is an actual asset you can create on the Content Browser") UUsdAssetCache : public UObject
{
	GENERATED_BODY()
