...
namespace UnrealIdentifiers
{
	...
	extern UNREALUSDWRAPPER_API const FString StaticMeshBuildSettingsAPI;
	extern UNREALUSDWRAPPER_API const FString NaniteBuildSettingsAPI;
	...
	extern UNREALUSDWRAPPER_API const pxr::TfToken OpacityMode;
	extern UNREALUSDWRAPPER_API const pxr::TfToken OpacityThreshold;
	extern UNREALUSDWRAPPER_API const pxr::TfToken Normal;
	extern UNREALUSDWRAPPER_API const pxr::TfToken Specular;
	extern UNREALUSDWRAPPER_API const pxr::TfToken SpecularColor;
	extern UNREALUSDWRAPPER_API const pxr::TfToken UseSpecularWorkflow;
	extern UNREALUSDWRAPPER_API const pxr::TfToken ClearCoat;
	extern UNREALUSDWRAPPER_API const pxr::TfToken ClearCoatRoughness;
	...
	extern UNREALUSDWRAPPER_API const pxr::TfToken Displacement;
	...
	// UCameraComponent properties
	extern UNREALUSDWRAPPER_API FName AspectRatioPropertyName;
	extern UNREALUSDWRAPPER_API FName OrthoWidthPropertyName;
	...
	extern UNREALUSDWRAPPER_API FName DepthOfFieldFstopPropertyName;
	extern UNREALUSDWRAPPER_API FName CameraISOPropertyName;
	extern UNREALUSDWRAPPER_API FName CameraShutterSpeedPropertyName;
