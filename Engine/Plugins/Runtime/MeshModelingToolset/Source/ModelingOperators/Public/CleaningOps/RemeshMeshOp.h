...
public:
	...
	// Note: if bDiscardAttributes and bNeedsWeightMaps are both true, the weight map attributes will be kept through remeshing (but other attributes will be discarded)
	bool bNeedsWeightMaps = false;
...
protected:
	...
	UE_API virtual TUniquePtr<FRemesher> CreateRemesher(ERemeshType Type, FDynamicMesh3* TargetMesh);
