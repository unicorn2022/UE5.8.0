	...
	const FComponentMaterialSet& MaterialSet, bool bApplyToAsset)
{
	...
	{
		UE_LOGF(LogTemp, Warning, "CANNOT MODIFY BUILT-IN ENGINE ASSET %ls", *SkeletalMeshIn->GetPathName());
		return false;
	}
...
void USkeletalMeshToolTarget::CommitMeshDescription(USkeletalMesh* SkeletalMesh, const FCommitter& Committer, int32 LODIndex)
{
	...
	// This scope will invoke the skeletal mesh render data rebuild machinery on scope exit
