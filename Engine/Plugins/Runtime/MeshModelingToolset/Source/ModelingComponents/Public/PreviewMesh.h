...
public:
	...
	*/
	...
	/**
	 * Notify that a deferred edit is completed and cause update of rendering data structures for modified Vertices.
	 * This can reduce the cost of mesh updates, but only if SetEnableRenderMeshDecomposition(true) has been called
	 * @param ModifiedAttribs which mesh attributes have been modified and need to be updated
	 */
	UE_API void NotifyVertexRegionDeferredEditCompleted(const TArray<int32>& Vertices, EMeshRenderAttributeFlags ModifiedAttribs);
