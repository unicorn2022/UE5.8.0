...
namespace Internal
{
	...
	/** Scoped override that forces PostEditChangeWithConditionalUndo onto its safe branch. */
	class FScopedSuppressPostEditChangeCapture
	{
	public:
		MODELINGCOMPONENTS_API FScopedSuppressPostEditChangeCapture();
		MODELINGCOMPONENTS_API ~FScopedSuppressPostEditChangeCapture();

		FScopedSuppressPostEditChangeCapture(const FScopedSuppressPostEditChangeCapture&) = delete;
		FScopedSuppressPostEditChangeCapture& operator=(const FScopedSuppressPostEditChangeCapture&) = delete;
