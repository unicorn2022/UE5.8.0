...
void UPreviewMesh::NotifyVertexRegionDeferredEditCompleted(const TArray<int32>& Vertices, EMeshRenderAttributeFlags ModifiedAttribs)
{
	DynamicMeshComponent->FastNotifyVerticesUpdated(Vertices, ModifiedAttribs);
	NotifyWorldPathTracedOutputInvalidated();
}
