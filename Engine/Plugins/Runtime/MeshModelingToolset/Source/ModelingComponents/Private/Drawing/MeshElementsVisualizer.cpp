...
public:
	...
	virtual void GetEdge(int32 EdgeIndex, int32& VertIndexAOut, int32& VertIndexBOut, EMeshEdgeType& TypeOut) const
	{
		...
		if (Mesh.HasTriangleGroups() && Mesh.IsGroupBoundaryEdge(EdgeIndex))
		{
			EdgeType |= (int32)EMeshEdgeType::GroupBoundary;
		}
...
void UMeshElementsVisualizer::OnCreated()
{
	...
	Settings->WatchProperty(Settings->bShowGroupBoundaries, [this](bool){ bSettingsModified = true; });
	...
	Settings->WatchProperty(Settings->GroupBoundaryColor, [this](FColor) { bSettingsModified = true; });
...
void UMeshElementsVisualizer::UpdateVisibility()
{
	...
	WireframeComponent->bEnableGroupBoundaries = Settings->bShowGroupBoundaries;
	...
	WireframeComponent->GroupBoundaryColor = Settings->GroupBoundaryColor;
