...
namespace UE::ToolTarget::Internal
{
	...
	// Scoped override toggled by FScopedSuppressPostEditChangeCapture.
	static bool bSuppressPostEditChangeCapture = false;
}
...
{
	if (CVarCapturePostEditChangeInTransactions->GetBool() && !bSuppressPostEditChangeCapture)
	{
...
UE::ToolTarget::Internal::FScopedSuppressPostEditChangeCapture::FScopedSuppressPostEditChangeCapture()
	: bSavedValue(bSuppressPostEditChangeCapture)
{
	bSuppressPostEditChangeCapture = true;
}

UE::ToolTarget::Internal::FScopedSuppressPostEditChangeCapture::~FScopedSuppressPostEditChangeCapture()
{
	bSuppressPostEditChangeCapture = bSavedValue;
}
#endif
