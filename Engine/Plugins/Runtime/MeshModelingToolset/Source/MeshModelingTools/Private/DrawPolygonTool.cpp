...
void UDrawPolygonTool::Setup()
{
	...
	const FToolContextSnappingConfiguration SnappingSettings = GetToolManager()->GetContextQueriesAPI()->GetCurrentSnappingSettings();
	SnapProperties->bSnapToWorldGrid = SnappingSettings.IsPositionGridSnappingActive();
...
void UDrawPolygonTool::OnTick(float DeltaTime)
{
	...
	{
		const FToolContextSnappingConfiguration SnappingSettings = GetToolManager()->GetContextQueriesAPI()->GetCurrentSnappingSettings();
		const bool bSnappingEnabledInViewport = SnappingSettings.IsPositionGridSnappingActive();
