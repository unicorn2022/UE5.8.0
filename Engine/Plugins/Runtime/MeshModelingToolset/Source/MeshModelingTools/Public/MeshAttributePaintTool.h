...
{
public:
	virtual ~FFloatAttributeColorMapper() = default;
...
{
public:
	virtual ~IMeshVertexAttributeAdapter() = default;
...
{
public:
	virtual ~IMeshVertexAttributeSource() = default;
 ...
 * Note: a new experimental version of this tool is UMeshAttributePaintToolV2
 */
UCLASS(MinimalAPI)
...
public:
	...
	/** The mode of action for the brush. */
	UPROPERTY(EditAnywhere, Category = Attribute, meta=(DisplayName="Action"))
	EBrushActionMode BrushAction = EBrushActionMode::Paint;

	/** The target value that the brush will accumulate towards. */
	UPROPERTY(EditAnywhere, Category = Attribute, meta=(UIMin=0.0, UIMax=1.0, DisplayName="Value", ModelingQuickEdit, ModelingQuickSettings=150))
...
public:
	...
	UPROPERTY(EditAnywhere, Category = Rendering, meta=(DisplayName="Preview", ModelingQuickSettings=1000))
...
protected:
	...
	UE_API virtual void InitializeAttributes();
	...
	UE_API virtual void ExternalUpdateValues(int32 AttribIndex, const TArray<int32>& VertexIndices, const TArray<float>& NewValues);
