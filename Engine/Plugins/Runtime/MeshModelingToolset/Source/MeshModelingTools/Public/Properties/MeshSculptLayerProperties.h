...
public:
	...
	/** Refresh properties from current mesh data */
	MESHMODELINGTOOLS_API void RefreshFromMesh();
	...
	DECLARE_MULTICAST_DELEGATE(OnMeshLayersPropertiesPanelRequestRebuild);
	OnMeshLayersPropertiesPanelRequestRebuild OnMeshLayersPanelRequestRebuild;
...
private:
	...
	// Helper to read current sculpt layers if possible
	bool ReadSculptLayers(TFunctionRef<void(const UE::Geometry::FDynamicMesh3& Mesh, const UE::Geometry::FDynamicMeshSculptLayers* SculptLayers)> ReadFn);
};
