...
bool ISkeletalMeshEditingInterface::CanModifySkeleton() const
{
	return false;
}

TSharedPtr<SWidget> ISkeletalMeshEditingInterface::GetCustomSkeletonTreeWidget(TSharedPtr<ISkeletalMeshEditorBinding> EditorBinding)
{
	return nullptr;
}
