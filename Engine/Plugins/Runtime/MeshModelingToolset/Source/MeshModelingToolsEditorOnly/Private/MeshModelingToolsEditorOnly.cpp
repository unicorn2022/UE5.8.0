...
void FMeshModelingToolsEditorOnlyModule::StartupModule()
{
	...
	FCoreDelegates::GetOnPostEngineInit().AddRaw(this, &FMeshModelingToolsEditorOnlyModule::OnPostEngineInit);
	
	FSkeletonEditingToolCommands::Register();
	FSkinWeightsPaintToolCommands::Register();
}
