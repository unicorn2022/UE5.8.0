...
bool UAnalyticsBlueprintLibrary::StartSession()
{
	...
	{
		UE_LOGF(LogAnalyticsBPLib, Warning, "StartSession: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
	}
	return false;
}
...
bool UAnalyticsBlueprintLibrary::StartSessionWithAttributes(const TArray<FAnalyticsEventAttr>& Attributes)
{
	...
	{
		UE_LOGF(LogAnalyticsBPLib, Warning, "StartSessionWithAttributes: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
	}
	return false;
}
...
void UAnalyticsBlueprintLibrary::EndSession()
{
	...
	{
		UE_LOGF(LogAnalyticsBPLib, Warning, "EndSession: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
	}
}
...
void UAnalyticsBlueprintLibrary::FlushEvents()
{
	...
	{
		UE_LOGF(LogAnalyticsBPLib, Warning, "FlushEvents: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
	}
}
...
void UAnalyticsBlueprintLibrary::RecordEvent(const FString& EventName)
{
	...
	else
	{
		...
		if (!bHasLogged)
		{
			UE_LOGF(LogAnalyticsBPLib, Warning, "RecordEvent: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
		}
	}
}
...
void UAnalyticsBlueprintLibrary::RecordEventWithAttribute(const FString& EventName, const FString& AttributeName, const FString& AttributeValue)
{
	...
	else
	{
		...
		if (!bHasLogged)
		{
			UE_LOGF(LogAnalyticsBPLib, Warning, "RecordEventWithAttribute: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
		}
	}
}
...
void UAnalyticsBlueprintLibrary::RecordEventWithAttributes(const FString& EventName, const TArray<FAnalyticsEventAttr>& Attributes)
{
	...
	else
	{
		...
		if (!bHasLogged)
		{
			UE_LOGF(LogAnalyticsBPLib, Warning, "RecordEventWithAttributes: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
		}
	}
}
...
void UAnalyticsBlueprintLibrary::RecordItemPurchase(const FString& ItemId, const FString& Currency, int32 PerItemCost, int32 ItemQuantity)
{
	...
	else
	{
		...
		if (!bHasLogged)
		{
			UE_LOGF(LogAnalyticsBPLib, Warning, "RecordItemPurchase: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
		}
	}
}
...
void UAnalyticsBlueprintLibrary::RecordSimpleItemPurchase(const FString& ItemId, int32 ItemQuantity)
{
	...
	else
	{
		...
		if (!bHasLogged)
		{
			UE_LOGF(LogAnalyticsBPLib, Warning, "RecordSimpleItemPurchase: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
		}
	}
}
...
void UAnalyticsBlueprintLibrary::RecordSimpleItemPurchaseWithAttributes(const FString& ItemId, int32 ItemQuantity, const TArray<FAnalyticsEventAttr>& Attributes)
{
	...
	else
	{
		...
		if (!bHasLogged)
		{
			UE_LOGF(LogAnalyticsBPLib, Warning, "RecordSimpleItemPurchaseWithAttributes: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
		}
	}
}
...
void UAnalyticsBlueprintLibrary::RecordSimpleCurrencyPurchase(const FString& GameCurrencyType, int32 GameCurrencyAmount)
{
	...
	{
		UE_LOGF(LogAnalyticsBPLib, Warning, "RecordSimpleCurrencyPurchase: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
	}
}
...
void UAnalyticsBlueprintLibrary::RecordSimpleCurrencyPurchaseWithAttributes(const FString& GameCurrencyType, int32 GameCurrencyAmount, const TArray<FAnalyticsEventAttr>& Attributes)
{
	...
	{
		UE_LOGF(LogAnalyticsBPLib, Warning, "RecordSimpleCurrencyPurchaseWithAttributes: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
	}
}
...
void UAnalyticsBlueprintLibrary::RecordCurrencyPurchase(const FString& GameCurrencyType, int32 GameCurrencyAmount, const FString& RealCurrencyType, float RealMoneyCost, const FString& PaymentProvider)
{
	...
	{
		UE_LOGF(LogAnalyticsBPLib, Warning, "RecordCurrencyPurchase: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
	}
}
...
void UAnalyticsBlueprintLibrary::RecordCurrencyGiven(const FString& GameCurrencyType, int32 GameCurrencyAmount)
{
	...
	{
		UE_LOGF(LogAnalyticsBPLib, Warning, "RecordCurrencyGiven: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
	}
}
...
void UAnalyticsBlueprintLibrary::RecordCurrencyGivenWithAttributes(const FString& GameCurrencyType, int32 GameCurrencyAmount, const TArray<FAnalyticsEventAttr>& Attributes)
{
	...
	{
		UE_LOGF(LogAnalyticsBPLib, Warning, "RecordCurrencyGivenWithAttributes: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
	}
}
...
void UAnalyticsBlueprintLibrary::SetSessionId(const FString& SessionId)
{
	...
	{
		UE_LOGF(LogAnalyticsBPLib, Warning, "SetSessionId: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
	}
}
...
void UAnalyticsBlueprintLibrary::SetUserId(const FString& UserId)
{
	...
	{
		UE_LOGF(LogAnalyticsBPLib, Warning, "SetUserId: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
	}
}
...
void UAnalyticsBlueprintLibrary::SetAge(int32 Age)
{
	...
	{
		UE_LOGF(LogAnalyticsBPLib, Warning, "SetAge: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
	}
}
...
void UAnalyticsBlueprintLibrary::SetLocation(const FString& Location)
{
	...
	{
		UE_LOGF(LogAnalyticsBPLib, Warning, "SetLocation: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
	}
}
...
void UAnalyticsBlueprintLibrary::SetGender(const FString& Gender)
{
	...
	{
		UE_LOGF(LogAnalyticsBPLib, Warning, "SetGender: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
	}
}
...
void UAnalyticsBlueprintLibrary::SetBuildInfo(const FString& BuildInfo)
{
	...
	{
		UE_LOGF(LogAnalyticsBPLib, Warning, "SetBuildInfo: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
	}
}
...
void UAnalyticsBlueprintLibrary::RecordErrorWithAttributes(const FString& Error, const TArray<FAnalyticsEventAttr>& Attributes)
{
	...
	{
		UE_LOGF(LogAnalyticsBPLib, Warning, "RecordErrorWithAttributes: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
	}
}
...
void UAnalyticsBlueprintLibrary::RecordError(const FString& Error)
{
	...
	{
		UE_LOGF(LogAnalyticsBPLib, Warning, "RecordError: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
	}
}
...
void UAnalyticsBlueprintLibrary::RecordProgressWithFullHierarchyAndAttributes(const FString& ProgressType, const TArray<FString>& ProgressNames, const TArray<FAnalyticsEventAttr>& Attributes)
{
	...
	{
		UE_LOGF(LogAnalyticsBPLib, Warning, "RecordProgressWithFullHierarchyAndAttributes: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
	}
}
...
void UAnalyticsBlueprintLibrary::RecordProgressWithAttributes(const FString& ProgressType, const FString& ProgressName, const TArray<FAnalyticsEventAttr>& Attributes)
{
	...
	{
		UE_LOGF(LogAnalyticsBPLib, Warning, "RecordProgressWithAttributes: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
	}
}
...
void UAnalyticsBlueprintLibrary::RecordProgress(const FString& ProgressType, const FString& ProgressName)
{
	...
	{
		UE_LOGF(LogAnalyticsBPLib, Warning, "RecordProgress: Failed to get the default analytics provider. Double check your [Analytics] configuration in your INI");
	}
}
