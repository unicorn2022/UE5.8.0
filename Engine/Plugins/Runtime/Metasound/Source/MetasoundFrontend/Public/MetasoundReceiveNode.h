...
namespace Metasound
{
	...
	{
		DECLARE_METASOUND_PARAM(METASOUNDFRONTEND_API, AddressInput)
		DECLARE_METASOUND_PARAM(METASOUNDFRONTEND_API, DefaultDataInput)
		DECLARE_METASOUND_PARAM(METASOUNDFRONTEND_API, Output)

		extern METASOUNDFRONTEND_API const FDataVertexMetadata AddressInputMetadata;
		extern METASOUNDFRONTEND_API const FDataVertexMetadata DefaultDataInputMetadata;
		extern METASOUNDFRONTEND_API const FDataVertexMetadata OutputMetadata;
	...
	namespace ReceiveNodePrivate
	{
		...
		public:
			...
			void Execute()
			{
				...
				{
					if constexpr (std::is_copy_assignable<TDataType>::value)
					{
