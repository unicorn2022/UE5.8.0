...
namespace Metasound
{
	...
	namespace Frontend
	{
		...
		public:
			...
			/** Create a literal node (deprecated — literal values should be set on the connected node directly). */
		...
		public:
			 ...
			 * @return True on success, false on failure.
			 */
			virtual bool UnregisterDataType(const FName& InDataTypeName) = 0;
			...
			/** Returns DataType info associated with the provided object class. */
			virtual bool GetDataTypeInfo(UClass* InClass, FDataTypeRegistryInfo& OutInfo) const = 0;
