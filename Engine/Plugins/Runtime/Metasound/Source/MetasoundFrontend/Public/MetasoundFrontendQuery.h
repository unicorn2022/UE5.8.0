...
struct FMetaSoundClassInterfaceInfo
{
	...
	UE_API FMetaSoundClassInterfaceInfo(const FMetasoundFrontendClass& InClass);
...
namespace Metasound
{
	namespace Frontend
	{
		...
		{
			UE_API FMetaSoundClassInfo(EMetasoundFrontendClassType InClassType = EMetasoundFrontendClassType::Invalid);
			UE_API FMetaSoundClassInfo(const FMetasoundFrontendClass& InClass);
		...
		public:
			...
			EMetasoundFrontendClassType ClassType = EMetasoundFrontendClassType::Invalid;
			...
			FNodeClassRegistryKey ToRegistryKey() const
			{
				return FNodeClassRegistryKey(ClassType, ClassName, Version);
			}
	...
	using FFrontendQueryValue = TVariant
	<
		FMetasoundFrontendVersion,
		Frontend::FAssetManagerTransaction,
		Frontend::FInterfaceRegistryTransaction,
		Frontend::FMetaSoundClassInfo,
		Frontend::FNodeClassRegistryTransaction
	>;
