...
public:
	...
	virtual TArray<FMetasoundAssetBase*> GetReferencedAssets() const = 0;

#if WITH_EDITORONLY_DATA
	UE_DEPRECATED(5.8, "Dynamic loading of referenced assets is deprecated")
	virtual const TSet<FSoftObjectPath>& GetAsyncReferencedAssetClassPaths() const
	{
		static TSet<FSoftObjectPath> Empty;
		return Empty;
	}
#endif // WITH_EDITORONLY_DATA
	...
	virtual void OnAsyncReferencedAssetsLoaded(const TArray<FMetasoundAssetBase*>& InAsyncReferences) { }
#endif // WITH_EDITORONLY_DATA
	...
	UE_DEPRECATED(5.8, "Feature no longer supported")
	...
	UE_API Metasound::Frontend::FDocumentHandle GetDocumentHandle(bool bReloadBuilder = true);
...
#if WITH_EDITORONLY_DATA
	UE_DEPRECATED(5.8, "Implementation is now internal and moved to VersioningManager.")
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	virtual Metasound::Frontend::FDocumentAccessPtr GetDocumentAccessPtr(bool bReloadBuilder = true) = 0;
