...
namespace Metasound
{
	...
	{
		UE_API Frontend::FNodeClassRegistryKey CreateArrayShuffleNodeClassRegistryKey(const FName& InArrayDataTypeName);
		UE_API FVertexInterface CreateArrayShuffleNodeInterface(const FName& InArrayDataTypeName, const FName& InElementDataTypeName);
		UE_API FNodeClassMetadata CreateArrayShuffleNodeClassMetadata(const FName& InArrayDataTypeName, const FName& InElementDataTypeName, const FText& InArrayDataTypeDisplayText);
	}
	...
	public:
		...
		static const FVertexInterface& GetDefaultInterface()
		{
			...
			using namespace ArrayShuffleNodePrivate;

			static const FVertexInterface DefaultInterface = CreateArrayShuffleNodeInterface(GetMetasoundDataTypeName<ArrayType>,GetMetasoundDataTypeName<ElementType>());
		...
		{
			using namespace ArrayShuffleNodePrivate;
			static const FNodeClassMetadata Metadata = CreateArrayShuffleNodeClassMetadata(GetMetasoundDataTypeName<ArrayType>(), GetMetasoundDataTypeName<ElementType>(), GetMetasoundDataTypeDisplayText<ArrayType>());
