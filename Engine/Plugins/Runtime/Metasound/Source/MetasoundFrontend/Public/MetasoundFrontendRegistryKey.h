...
namespace Metasound::Frontend
{
	/** FNodeClassInfo contains a minimal set of information needed to find and query node classes. 
	  * THIS CLASS IS ACTIVELY BEING DEPRECATED. USE FNodeClassRegistryKey instead.
	  */
	struct FNodeClassInfo
	{
		...
		// Added to aid in deprecation of this class in favor of FNodeClassRegistryKey
		static const FNodeClassInfo& GetInvalid()
		{
			static const FNodeClassInfo Invalid;
			return Invalid;
		}
	};
	...
	struct FNodeClassRegistryKey
	{
		...
		UE_DEPRECATED(5.8, "FNodeClassInfo is actively being deprecated, use overload with NodeClassRegistryKey or otherwise")
