...
namespace Metasound
{
	namespace Frontend
	{
		...
		class IGraphController : public TSharedFromThis<IGraphController>, public IDocumentAccessor
		{
			...
			UE_DEPRECATED(5.8, "Preset options are now serialized in the Preset MetaSound Template")
			virtual const FMetasoundFrontendGraphClassPresetOptions& GetGraphPresetOptions() const;

			UE_DEPRECATED(5.8, "Preset options are now serialized in the Preset MetaSound Template")
			virtual void SetGraphPresetOptions(const FMetasoundFrontendGraphClassPresetOptions& InPresetOptions);
			...
			UE_DEPRECATED(5.8, "Preset options are now serialized in the Preset MetaSound Template")
			virtual const TSet<FName>& GetInputsInheritingDefault() const;

			UE_DEPRECATED(5.8, "Preset options are now serialized in the Preset MetaSound Template")
			virtual bool SetInputInheritsDefault(FName InName, bool bDefaultIsInherited);
			...
			UE_DEPRECATED(5.8, "Use the MetaSound Builder API")
			virtual bool RemoveVariable(const FGuid& InVariableID) { return false; }
			...
			UE_DEPRECATED(5.8, "Use Builder API instead")
			virtual bool ClearLiteralForInput(const FVertexName& InInputName, FGuid InVertexID) { return false;  }
		...
		public:
			...
			static UE_API FDocumentHandle CreateDocumentHandle(FDocumentAccessPtr InDocument, bool bReloadBuilder = true);
