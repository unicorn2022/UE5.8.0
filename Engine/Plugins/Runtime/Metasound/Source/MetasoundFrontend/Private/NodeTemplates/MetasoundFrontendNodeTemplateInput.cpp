	...
	namespace InputNodeTemplatePrivate
	{
			...
			const TArray<FMetasoundFrontendVertexHandle>& ConnectedVertices, const FGuid* InPageID = nullptr)
		{
			...
			if (Locations.IsEmpty())
			{
				...
				{
					UE_LOGF(LogMetaSound, Display, "Template node being generated for input '%ls' had no editor location set.  Procedurally placing near connected node.", *InputName.ToString());
