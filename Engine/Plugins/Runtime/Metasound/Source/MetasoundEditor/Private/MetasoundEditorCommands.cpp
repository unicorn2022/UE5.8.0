...
namespace Metasound
{
	namespace Editor
	{
		void FEditorCommands::RegisterCommands()
		{
			...
			UI_COMMAND(ToggleShowGraph, "Show Graph", "Toggle showing/hiding the graph for the given configured MetaSound", EUserInterfaceActionType::Button, FInputChord(EKeys::G, EModifierKey::Control | EModifierKey::Shift));
			...
			UI_COMMAND(CopySelectionAsConfiguratorCodeToClipboard,
				"Copy Selected As Configurator Code to Clipboard",
				"Reflect configurator C++ code to the clipboard for the given graph selection",
