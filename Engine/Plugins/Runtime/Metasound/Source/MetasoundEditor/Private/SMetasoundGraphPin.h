		...
		public:
			...
			TSharedRef<SWidget> CreateResetToDefaultWidget()
			{
				return SNew(SButton)
					...
					.ContentPadding(0.0f)
					.Visibility(TAttribute<EVisibility>::CreateSPLambda(ParentPinType::AsShared(), [this]()
					{
						...
						if (!ParentPinType::IsConnected())
						{
							...
							if (!Builder || !Builder->GetBuilder().IsValid() || !GraphPin)
							{
					...
					.OnClicked(FOnClicked::CreateSPLambda(ParentPinType::AsShared(), [this]()
					{
