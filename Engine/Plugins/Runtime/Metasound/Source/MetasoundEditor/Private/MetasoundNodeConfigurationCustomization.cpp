...
{
	void FMetaSoundNodeConfigurationCustomization::OnChildRowAdded(IDetailPropertyRow& ChildRow)
	{
		...
		if (ChildHandle)
		{
			TDelegate<void(const FPropertyChangedEvent&)> OnValueChangedDelegate = TDelegate<void(const FPropertyChangedEvent&)>::CreateSP(this, &FMetaSoundNodeConfigurationCustomization::OnChildPropertyChanged);
	...
	void FMetaSoundNodeConfigurationCustomization::OnChildPropertyChanged(const FPropertyChangedEvent& InPropertyChangedEvent)
	{
