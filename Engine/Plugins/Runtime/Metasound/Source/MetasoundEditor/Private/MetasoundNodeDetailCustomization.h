...
namespace Metasound
{
	namespace Editor
	{
		...
		protected:
			...
			virtual void ConfigureLiteralCustomization(FMetasoundDefaultLiteralCustomizationBase&) { }
		...
		protected:
			FMetaSoundFrontendDocumentBuilder* GetBuilder() const;
		...
		protected:
			...
			const Frontend::FTemplateVertexMetadata* GetConstTemplateMetadata() const;
			Frontend::FTemplateVertexMetadata* GetTemplateMetadata() const;
		...
		public:
			...
			virtual void CustomizeDetails(IDetailLayoutBuilder& InDetailLayout) override;
			virtual void ConfigureLiteralCustomization(FMetasoundDefaultLiteralCustomizationBase& InLiteralCustomization) override;
