...
// IMetaSoundPresetWidgetInterface has been soft deprecated. Use IMetaSoundTemplateWidgetInterface instead.
...
public:
	...
	UFUNCTION(BlueprintImplementableEvent, Category = "MetaSound Preset Widget", meta = (DisplayName = "On Initializing Tab"))
