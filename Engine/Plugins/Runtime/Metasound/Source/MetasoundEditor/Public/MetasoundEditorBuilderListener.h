...
struct FGraphInputDefaultChangedArgs
{
	...
	UPROPERTY(BlueprintReadWrite, Category = "Audio|MetaSound|BuilderListener")
	FName InputName;
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnMetaSoundBuilderPageMutate, FName, PageName);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnMetaSoundBuilderGraphInputDefaultChanged, const FGraphInputDefaultChangedArgs&, GraphInputDefaultChangedArgs);
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
	virtual ~UMetaSoundEditorBuilderListener() = default;
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	void OnPageAdded(const Metasound::Frontend::FDocumentMutatePageArgs& PageArgs);
	void OnRemovingPage(const Metasound::Frontend::FDocumentMutatePageArgs& PageArgs);
	void OnBuildPageChanged(const Metasound::Frontend::FDocumentMutatePageArgs& PageArgs);
	...
	UE_DEPRECATED(5.8, "Use the input default changed delegate that includes additional args")
	void OnGraphInputDefaultChanged(int32 Index);
	void OnGraphInputDefaultChanged(const Metasound::Frontend::FDocumentArrayPagedInputArgs& Args);
	...
	// Pages
	UPROPERTY(BlueprintAssignable, BlueprintCallable, Category = "Audio|MetaSound|BuilderListener", DisplayName = "On Page Added")
	FOnMetaSoundBuilderPageMutate OnPageAddedDelegate;

	UPROPERTY(BlueprintAssignable, BlueprintCallable, Category = "Audio|MetaSound|BuilderListener", DisplayName = "On Page Removed")
	FOnMetaSoundBuilderPageMutate OnRemovingPageDelegate;

	UPROPERTY(BlueprintAssignable, BlueprintCallable, Category = "Audio|MetaSound|BuilderListener", DisplayName = "On Build Page Changed")
	FOnMetaSoundBuilderPageMutate OnBuildPageChangedDelegate;
	...
	UE_DEPRECATED(5.8, "Use the GraphInputDefaultChanged delegate that includes additional args")
	UPROPERTY(BlueprintAssignable, BlueprintCallable, Category = "Audio|MetaSound|BuilderListener|InputDelegates", DisplayName = "[Deprecated] On Graph Input Default Changed")
	...
	FOnMetaSoundBuilderGraphInputDefaultChanged OnGraphInputDefaultChangedWithArgsDelegate;
...
private:
	...
	FDelegateHandle OnPageAddedHandle;
	FDelegateHandle OnRemovingPageHandle;
	FDelegateHandle OnBuildPageChangedHandle;
