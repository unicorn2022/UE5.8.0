...
public:
	...
	virtual bool ShouldShowTitleIcon() const { return true; }
	virtual const FSlateBrush* GetNodeTitleIconBrush() const;
	virtual FLinearColor GetNodeTitleIconColor() const { return FLinearColor::White; }
	virtual FText GetNodeTitleIconTooltipText() const { return FText(); }
	...
	const FMetasoundFrontendClass* GetNodeFrontendClass() const;
	const UClass* GetNodeAssetClass() const;
...
protected:
	...
	virtual FLinearColor GetNodeTitleIconColor() const override;
};
...
protected:
	...
	virtual const FSlateBrush* GetNodeTitleIconBrush() const override;
...
public:
	...
	virtual FLinearColor GetNodeTitleColor() const override;
	virtual const FSlateBrush* GetNodeTitleIconBrush() const override;
	virtual FText GetNodeTitleIconTooltipText() const override;
