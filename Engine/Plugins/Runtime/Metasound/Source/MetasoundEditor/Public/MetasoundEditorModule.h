...
namespace Metasound::Editor
{
	namespace Style
	{
		...
		class FMetaSoundNodeConfigurationCustomization;
	...
	using EAssetPrimeStatus = Metasound::Engine::ENodeClassRegistryPrimeStatus;
		using FCreateNodeConfigurationDetails = TFunction<TSharedRef<FMetaSoundNodeConfigurationCustomization>(
	...
	{
	public:
		/** Module name constant for use with FModuleManager. */
		static constexpr FLazyName ModuleName = "MetaSoundEditor";
		...
		UE_DEPRECATED(5.8, "Use IMetaSoundGraphPanelPinFactory::FindPinType instead.")
		...
		UE_DEPRECATED(5.8, "Use IMetaSoundGraphPanelPinFactory::GetCustomPinIcons instead.")
		...
		// Returns the MetaSound GraphPanelPinFactory for registering custom pin types.
		UE_API virtual TSharedRef<IMetaSoundGraphPanelPinFactory> GetGraphPanelPinFactory() const = 0;

		UE_DEPRECATED(5.8, "Use IMetaSoundGraphPanelPinFactory::RegisterPin instead.")
