...
Metasound::Frontend::FDocumentAccessPtr UMetaSoundPatch::GetDocumentAccessPtr(bool bReloadBuilder)
{
...
TArray<FMetasoundAssetBase*> UMetaSoundPatch::GetReferencedAssets() const
{
