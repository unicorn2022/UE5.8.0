...
namespace Metasound::Engine
{
	...
	class FMetaSoundAssetManager :
		public Frontend::FMetaSoundAssetManagerBase,
		public FGCObject
	{
	public:
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
		...
		UE_API virtual TArray<Frontend::FMetaSoundClassInfo> FindRegisteredClassInfo(const FMetaSoundAssetKey& InKey) const override;
...
#if WITH_EDITOR
		UE_API bool ReplaceReferencesInAsset(TScriptInterface<IMetaSoundDocumentInterface> InMetaSound, const Frontend::FNodeRegistryKey& OldClassKey, const Frontend::FNodeRegistryKey& NewClassKey) const;
...
#if WITH_EDITORONLY_DATA
		UE_DEPRECATED(5.8,
			"This is a deprecated feature, and exists to port old soft object references to hard references. "
			"This will become UE_INTERNAL API in a future release.")
		UE_API virtual void RequestAsyncLoadReferencedAssets(FMetasoundAssetBase& InAssetBase, const TSet<FSoftObjectPath>* Paths = nullptr) override;
#endif // WITH_EDITORONLY_DATA
		...
		UE_API virtual void ReregisterLoadedAssets() const override;
		...
		UE_API virtual void WaitUntilAsyncLoadReferencedAssetsComplete(const FMetasoundAssetBase& InAssetBase) override;
#endif // WITH_EDITORONLY_DATA
		...
		UE_INTERNAL virtual Frontend::FMetaSoundAssetRegistrationOptions GetRegistrationOptions() const override;
...
#if WITH_EDITOR
		bool ReplaceReferencesInAssetInternal(UObject* MetaSoundObject, const TMap<FNodeRegistryKey, FNodeRegistryKey>& InOldToNewReferenceKeys) const;
#endif // WITH_EDITOR
