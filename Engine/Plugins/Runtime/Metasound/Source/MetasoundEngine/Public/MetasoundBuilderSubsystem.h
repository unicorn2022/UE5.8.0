...
private:
	...
	UE_API void OnDocumentTemplateChanged(const Metasound::Frontend::FDocumentTemplateChangedArgs& Args) const;
	UE_API void OnEdgeAdded(int32 EdgeIndex) const;
	UE_API void OnInputAdded(int32 InputIndex);
	UE_API void OnInputDataTypeChanged(int32 InputIndex);
	UE_API void OnInputDefaultChanged(const Metasound::Frontend::FDocumentArrayPagedInputArgs& Args) const;
