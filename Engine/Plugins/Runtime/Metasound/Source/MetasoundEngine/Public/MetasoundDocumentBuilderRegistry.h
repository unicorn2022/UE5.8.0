...
namespace Metasound::Engine
{
	...
	public:
...
#if WITH_EDITORONLY_DATA
			WaitUntilVersioningComplete(InMetaSoundObject);
		...
		UE_API virtual TArray<FMetaSoundFrontendDocumentBuilder*> FindBuilders(const FMetasoundFrontendClassName& ClassName) const override;
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	private:
#if WITH_EDITORONLY_DATA
		UE_API void WaitUntilVersioningComplete(UObject& InMetaSoundObject) const;
#endif // WITH_EDITORONLY_DATA
