...
namespace Metasound
{
	...
	struct FNodeDisplayStyle
	{
		...
		/** Name of the Slate style associated with node (color, icon). */
		FName StyleSet;

		/** Name of the node's icon defined in Style. */
		FName Icon;

		/** Name of the color defined in Style. */
		FName Color;
	};
	...
	struct FNodeClassMetadata
	{
		...
		/** Default class interface for the node. */
		FClassInterface DefaultInterface;
