...
#define METASOUND_TRACE_CPUPROFILER_EVENT_SCOPE_COND(Name, Cond)\
	FScopedNamedEventConditionalStatic UE_JOIN(MetaSound_NamedEvent_,__LINE__)(FColor::Green, NAMED_EVENT_STR(#Name), GCycleStatsShouldEmitNamedEvents > 0 && (Cond));\
...
#define METASOUND_TRACE_CPUPROFILER_EVENT_SCOPE_FAST(TraceSpecId, Name) \
	...
	TRACE_CPUPROFILER_EVENT_SCOPE_USE(TraceSpecId, Name, UE_JOIN(MetaSound_NamedEventScope_, __LINE__), true)
