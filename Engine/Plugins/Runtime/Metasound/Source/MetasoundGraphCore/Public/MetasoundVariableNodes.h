...
namespace Metasound
{
	...
	{
		DECLARE_METASOUND_PARAM(METASOUNDGRAPHCORE_API, InputData)
		DECLARE_METASOUND_PARAM(METASOUNDGRAPHCORE_API, OutputData)
		DECLARE_METASOUND_PARAM(METASOUNDGRAPHCORE_API, InputVariable)
		DECLARE_METASOUND_PARAM(METASOUNDGRAPHCORE_API, OutputVariable)

		extern METASOUNDGRAPHCORE_API const FDataVertexMetadata InputDataMetadata;
		extern METASOUNDGRAPHCORE_API const FDataVertexMetadata OutputDataMetadata;
		extern METASOUNDGRAPHCORE_API const FDataVertexMetadata InputVariableMetadata;
		extern METASOUNDGRAPHCORE_API const FDataVertexMetadata OutputVariableMetadata;
	...
	namespace MetasoundVariableNodesPrivate
	{
		...
		public:
			...
			static TUniquePtr<IOperator> CreateOperator(const FBuildOperatorParams& InParams, FBuildResults& OutResults) 
			{
				...
				else 
				{
					...
					UE_LOGF(LogMetaSound, Verbose, "Missing internal variable connection. Failed to create valid \"SetVariable\" operator");
		...
		public:
			...
			static TUniquePtr<IOperator> CreateOperator(const FBuildOperatorParams& InParams, FBuildResults& OutResults) 
			{
				...
				{
					// Nothing to do if there's no input data.
					UE_LOGF(LogMetaSound, Verbose, "Missing internal variable connection. Failed to create valid \"GetDelayedVariable\" operator");
					return MakeUnique<FNoOpOperator>();
				}
			}
		...
		public:
			...
			static TUniquePtr<IOperator> CreateOperator(const FBuildOperatorParams& InParams, FBuildResults& OutResults) 
			{
				...
				{
					// Nothing to do if there's no input data.
					UE_LOGF(LogMetaSound, Verbose, "Missing internal variable connection. Failed to create valid \"GetVariable\" operator");
					return MakeUnique<FNoOpOperator>();
				}
			}
