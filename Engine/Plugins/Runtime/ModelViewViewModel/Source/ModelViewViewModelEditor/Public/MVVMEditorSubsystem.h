...
public:
	...
	UE_API TArray<FMVVMBlueprintPinId> GetConversionFunctionPins(const UWidgetBlueprint* WidgetBlueprint, const UE::MVVM::FConversionFunctionValue& Function, const FProperty* ExpectedArgumentType) const;
