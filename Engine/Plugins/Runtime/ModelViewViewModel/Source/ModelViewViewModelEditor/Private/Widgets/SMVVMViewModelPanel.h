...
private:
	...
	TSet<UObject*> GetSelectedEditableObjects() const;
	bool HandleCanPopoutEditor() const;
	void HandlePopoutEditor();
	...
	void HandleSetObjectBeingDebugged(UObject* DebugObject);
	...
	void CreateViewModelTreeView(UE::PropertyViewer::SPropertyViewer::EPropertyVisibility InPropertyVisibility);
...
private:
	...
	TSharedPtr<SBox> ViewModelTreeViewContainer;
	...
	UE::PropertyViewer::SPropertyViewer::EPropertyVisibility PropertyVisibility;
