 ...
 *
 */
class FModelViewViewModelEditorModule : public IModelViewViewModelEditorModule
{
public:
	...
	//~ Begin IModelViewViewModelEditorModule
	virtual void OpenPopoutEditor(TNotNull<UObject*> InObject, bool bInReadyOnly) override;
	//~ End IModelViewViewModelEditorModule
