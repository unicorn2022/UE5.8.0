...
void FModelViewViewModelEditorModule::OpenPopoutEditor(TNotNull<UObject*> InObject, bool bInReadyOnly)
{
	UE::MVVM::SMVVMPopoutEditor::OpenPopoutEditor(InObject, bInReadyOnly);
}
