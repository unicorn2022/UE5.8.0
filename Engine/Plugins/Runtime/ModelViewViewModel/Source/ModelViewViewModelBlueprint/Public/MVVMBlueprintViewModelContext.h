...
enum class EMVVMBlueprintViewModelContextCreationType : uint8
{
	...
	Resolver,
	// The viewmodel will be fetched from any local context provider, can also be set manually
	Context,
};
...
#if WITH_EDITOR
	[[nodiscard]] UE_API TObjectPtr<UMVVMViewModelContextResolver> CreateDefaultResolver(UObject* Outer) const;
#endif
