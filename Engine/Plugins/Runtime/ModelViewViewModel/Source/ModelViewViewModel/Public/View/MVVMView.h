...
public:
	...
	/** Is the view in a valid constructed state? */
...
private:
	...
	void InitializeSourceParentBinding(FMVVMView_SourceKey SourceKey);
	void UninitializeSourceParentBinding(FMVVMView_SourceKey SourceKey);
...
private:
	...
	TMap<TPair<int32 /* Source Index */, int32 /* Field Index */>, FDelegateHandle> RegisteredBindings;
