...
struct FGeometrySelection
{
	...
	/** Map of soft selected vertices and their weights*/
	TMap<uint64, double> SoftSelectedVertices;
	...
	*/
	...
	/**
	 * @return a FGeometrySelection containing the soft selected vertices
	 */
	FGeometrySelection GetSoftSelectedVertices() const
	{
		FGeometrySelection Result;
		Result.TopologyType = TopologyType;
		Result.ElementType = EGeometryElementType::Vertex;

		SoftSelectedVertices.GetKeys(Result.Selection);
