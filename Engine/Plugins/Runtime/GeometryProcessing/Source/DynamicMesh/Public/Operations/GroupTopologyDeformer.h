...
{
public:
	virtual ~FGroupTopologyDeformer() = default;
	...
	/**
	 * Set the active handle to the given Faces, Edges, Corners
	 */
	UE_API virtual void SetActiveHandle(const TArray<int>& FaceGroupIDs, const TArray<int>& TopologyEdgeIDs, const TArray<int>& TopologyCornerIDs);
