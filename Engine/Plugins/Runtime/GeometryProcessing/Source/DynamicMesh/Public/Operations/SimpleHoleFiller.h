...
public:
	...
	// whether to automatically fill in PrimaryColors on new hole fill triangles
	bool bAutoFillPrimaryColors = true;
...
public:
	...
	virtual ~FSimpleHoleFiller() = default;
...
private:
	// Fill colors on triangles added by the fill, by copying boundary colors
	UE_API void FillColors();
};
