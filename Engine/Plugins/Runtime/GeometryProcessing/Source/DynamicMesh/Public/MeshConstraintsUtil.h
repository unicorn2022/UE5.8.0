...
s	 * EdgeROI that are seams, as well as vertices incident to edges in EdgeROI that are on seams.
	 ...
	 * @param CurveConstraintToleranceDistance threshold distance used to limit how far edges should be allowed to deviate from their constraint curves
	 */
	static UE_API void SetBoundaryConstraintsWithProjection(
		...
		float CurveConstraintToleranceDistance = -1.f);
