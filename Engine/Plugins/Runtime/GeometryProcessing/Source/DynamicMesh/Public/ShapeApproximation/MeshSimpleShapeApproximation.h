...
public:
	...
	/** simplification tolerance for 3D convex hulls, if > 0, applies *after* hull target face count is reached to futher simplify */
	double HullGeometricToleranceAfterTarget = 0.;

	/** simplification tolerance when simplifying 2D (swept/projected) convex hulls; note HullGeometricToleranceAfterTarget is used instead for 3D hulls */
