...
FDynamicMeshTriangleLabelAttribute* UE::Geometry::FindTriangleLabelLayerByName(FDynamicMesh3& Mesh, const FName Name)
{
	FDynamicMeshAttributeSet* AttributeSet = Mesh.Attributes();
	return AttributeSet && Name != NAME_None ? AttributeSet->FindTriangleLabelAttribute(Name) : nullptr;
}

const FDynamicMeshTriangleLabelAttribute* UE::Geometry::FindTriangleLabelLayerByName(const FDynamicMesh3& Mesh, FName Name)
{
	const FDynamicMeshAttributeSet* AttributeSet = Mesh.Attributes();
	return AttributeSet && Name != NAME_None ? AttributeSet->FindTriangleLabelAttribute(Name) : nullptr;
}
