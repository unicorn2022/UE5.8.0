...
private:
	...
	struct FActorFeatureRegisteredDelegate
	{
		...
		/** Check whether this delegate has a valid registration */
		bool IsBound() const
		{
			return Delegate.IsBound() || BPDelegate.IsBound();
		}
	...
	/** Unregister all class feature change delegates in the relevant packages */
	UE_API void PruneUnboundDelegates(TConstArrayView<UPackage*> Packages);
};
