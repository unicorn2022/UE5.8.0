...
void FAudioWidgetsStyle::SetupStyles()
{
	...
	const FVector2f Icon30x30 = FVector2f(30.0f, 30.0f);
	...
	Set("AudioWidgetsStyle.FadeStart", new IMAGE_BRUSH_SVG(TEXT("Slate/Icons/FadeStart_30"), Icon30x30));
	Set("AudioWidgetsStyle.FadeEnd", new IMAGE_BRUSH_SVG(TEXT("Slate/Icons/FadeEnd_30"), Icon30x30));
	...
	Set("AudioWidgetsStyle.LoopStart", new IMAGE_BRUSH_SVG(TEXT("Slate/Icons/LoopStart_30"), Icon30x30));
	Set("AudioWidgetsStyle.LoopEnd", new IMAGE_BRUSH_SVG(TEXT("Slate/Icons/LoopEnd_30"), Icon30x30));
