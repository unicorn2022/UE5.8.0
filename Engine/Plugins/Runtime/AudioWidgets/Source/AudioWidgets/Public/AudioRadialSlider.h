...
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FOnAudioRadialSliderMouseCaptureBeginEvent);
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FOnAudioRadialSliderMouseCaptureEndEvent);
...
public:
	...
	UPROPERTY(BlueprintAssignable, Category = "Widget Event")
	FOnAudioRadialSliderMouseCaptureBeginEvent OnMouseCaptureBegin;

	/** Called when a mouse drag ends. */
	UPROPERTY(BlueprintAssignable, Category = "Widget Event")
	FOnAudioRadialSliderMouseCaptureEndEvent OnMouseCaptureEnd;
