...
struct FAudioMeterWidgetStyle : public FSlateWidgetStyle
{
	...
	// Image to use to represent the meter clipping indicator.
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Appearance)
	FSlateBrush MeterClippingImage;
	FAudioMeterWidgetStyle& SetMeterClippingImage(const FSlateBrush& InMeterClippingImage) { MeterClippingImage = InMeterClippingImage; return *this; }
	...
	// How wide to draw the clipping value indicator
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Appearance)
	float ClippingValueWidth = 2.0f;
	FAudioMeterWidgetStyle& SetClippingValueWidth(float InClippingValueWidth) { ClippingValueWidth = InClippingValueWidth; return *this; }
...
struct FAudioMeterDefaultColorWidgetStyle : public FSlateWidgetStyle
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Style")
	FLinearColor MeterClippingColor = FLinearColor::Transparent;
