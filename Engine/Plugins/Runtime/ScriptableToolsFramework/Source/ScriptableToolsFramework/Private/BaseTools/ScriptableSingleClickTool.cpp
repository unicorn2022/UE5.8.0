...
{
	UE_LOGF(LogTemp, Warning, "UScriptableSingleClickTool: Default TestIfHitByClick Implementation always consumes hit");
...
{
	UE_LOGF(LogTemp, Warning, "UScriptableSingleClickTool: Empty OnHitByClick Implementation");
}
