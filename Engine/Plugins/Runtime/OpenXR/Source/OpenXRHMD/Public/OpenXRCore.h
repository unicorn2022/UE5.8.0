...
// condition of the ensure, which appears in the log before the message. Because of the implicit capture the parameters of x are available.  Then we build the message of the ensure including both x and the XRES_Result. Then return the result of the ensure.
