...
void UOpenXRBlueprintFunctionLibrary::SetEnvironmentBlendMode(EOpenXREnvironmentBlendMode NewBlendMode) 
{
	...
	{
		UE_LOGF(LogUOpenXRBlueprintFunctionLibrary, Warning, "Attempted to set environment blend mode to EOpenXREnvironmentBlendMode::None. No blend mode will be set and the runtime will continue to use its current blend mode.");
		return;
	}
