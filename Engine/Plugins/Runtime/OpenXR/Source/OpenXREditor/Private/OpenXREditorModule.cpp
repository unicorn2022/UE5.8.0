...
void FOpenXREditorModule::StartupModule()
{
	...
	{
		UE_LOGF(LogTemp, Warning, "Existing value for UEditorPerformanceSettings::MaxViewportRenderingResolution will be overriden for OpenXR.");
	}

	UE_LOGF(LogTemp, Log, "OpenXR ignores max viewport resolution in editor to support full HMD resolutions.");
