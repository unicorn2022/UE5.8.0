...
public:
	...
	virtual void FillPropertyMenu(FMenuBuilder& MenuBuilder, const FPropertyBindingWidgetArgs& InArgs, FName InPropertyName, UStruct* InOwnerStruct, TArray<TSharedPtr<FBindingChainElement>> InBindingChain) const override
	{
		SPropertyBinding::FillPropertyMenu(MenuBuilder, InArgs, nullptr, InPropertyName, InOwnerStruct, InBindingChain);
	}
