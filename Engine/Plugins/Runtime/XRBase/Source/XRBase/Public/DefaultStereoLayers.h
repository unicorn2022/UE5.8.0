...
public:
	...
	struct FStereoLayerToRender
	{
		...
		[[nodiscard]] XRBASE_API bool operator < (const FStereoLayerToRender& Lhs);
		[[nodiscard]] XRBASE_API bool operator > (const FStereoLayerToRender& Lhs);
	};
	...
	static UE_API void StereoLayerRender(FRHICommandListImmediate& RHICmdList, const FStereoLayerToRender& Layer, const FDefaultStereoLayers_LayerRenderParams& RenderParams);
