...
namespace SteamAudio
{
	...
	void FSteamAudioModule::StartupModule()
	{
		...
		UE_LOGF(LogSteamAudio, Log, "FSteamAudioModule Startup");

		UE_LOGF(LogSteamAudio, Warning, "The Steam Audio plugin is deprecated and will be removed in a future engine release. Get Valve's version here: https://valvesoftware.github.io/steam-audio/doc/unreal/getting-started.html")
	}

	void FSteamAudioModule::ShutdownModule()
	{
		UE_LOGF(LogSteamAudio, Log, "FSteamAudioModule Shutdown");
