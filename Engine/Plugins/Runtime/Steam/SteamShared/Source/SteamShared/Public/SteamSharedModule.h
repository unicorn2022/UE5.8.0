...
#define LOADING_STEAM_CLIENT_LIBRARY_DYNAMICALLY		(PLATFORM_WINDOWS || PLATFORM_MAC || PLATFORM_ANDROID || (PLATFORM_LINUX && !IS_MONOLITHIC))
...
#define STEAM_UNSUPPORTED_ANDROID_PLATFORMS				(PLATFORM_ANDROID_X64 || PLATFORM_ANDROID_X86)
...
public:
	...
	virtual ~FSteamSharedModule() = default;
...
{
public:
	virtual ~FSteamInstanceHandlerBase() = default;
