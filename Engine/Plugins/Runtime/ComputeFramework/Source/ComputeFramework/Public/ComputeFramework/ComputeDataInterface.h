...
public:
	...
	/** Whether to call InitializePerKernelInputOutputMasks on the provider in addition to Initialize. */
	virtual bool GetRequiresPerKernelInputOutputMasks() const { return false; }
