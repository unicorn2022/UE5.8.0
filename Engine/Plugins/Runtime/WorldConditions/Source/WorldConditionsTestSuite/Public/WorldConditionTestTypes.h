...
USTRUCT()
struct FWorldConditionQueryDefinitionContainer
{
	GENERATED_BODY()
...
UCLASS(hidden)
class UWorldConditionOwnerClassWithNestedStruct : public UObject
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, Category = "Default")
	FWorldConditionQueryDefinitionContainer Container;
};
