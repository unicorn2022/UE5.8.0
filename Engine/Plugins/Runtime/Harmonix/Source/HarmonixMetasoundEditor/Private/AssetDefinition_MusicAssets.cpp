...
#define LOCTEXT_NAMESPACE "AssetDefinition_MusicAssets"
	...
	static const auto Categories = 
		{
			FAssetCategoryPath(EAssetCategoryPaths::Audio, 
				LOCTEXT("AssetDefinition_MetasoundMusicSubMenu", "Advanced"), 
				FCategoryPath(LOCTEXT("AssetDefinition_MetasoundMusicSubMenuSection", "Harmonix"), ECategoryMenuType::Section))
		};
	return Categories;
}
...
TConstArrayView<FAssetCategoryPath> UAssetDefinition_WaveMusic::GetAssetCategories() const
{
	static const auto Categories = 
		{
			FAssetCategoryPath(EAssetCategoryPaths::Audio, 
				LOCTEXT("AssetDefinition_WaveMusicSubMenu", "Advanced"), 
				FCategoryPath(LOCTEXT("AssetDefinition_WaveMusicSubMenuSection", "Harmonix"), ECategoryMenuType::Section))
		};
	return Categories;
}
