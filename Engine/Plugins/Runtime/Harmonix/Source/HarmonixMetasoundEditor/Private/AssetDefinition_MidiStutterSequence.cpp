...
#define LOCTEXT_NAMESPACE "AssetDefinition_MidiStutterSequence"
...
{
	return LOCTEXT("MIDIStutterSequenceDefinition", "MIDI Stutter Sequence");
}
	...
	static const auto Categories = 
		{
			FAssetCategoryPath(EAssetCategoryPaths::Audio, 
				LOCTEXT("AssetDefinition_MidiStutterSequenceSubMenu", "Advanced"), 
				FCategoryPath(LOCTEXT("AssetDefinition_MidiStutterSequenceSubMenuSection", "Harmonix"), ECategoryMenuType::Section))
		};
	return Categories;
}
