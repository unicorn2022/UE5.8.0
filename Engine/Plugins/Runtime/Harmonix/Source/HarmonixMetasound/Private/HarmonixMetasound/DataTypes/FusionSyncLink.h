...
namespace HarmonixMetasound
{
	...
	public:
		...
		void PostExecute()
		{
			if (!Task.IsCompleted())
			{
				UE_LOGF(LogFusionAsync, Warning, "Fusion Async Render: Task created, but was never checked for completion. This probably means you are missing a Fusion Synchronizer Node!");
				Task.Wait();
			}
			Task = {};
		}
