...
{
	// MusicClock no longer ticks, this function is empty
}

void UHarmonixMusicEnvironmentMetronome::Start(double FromSeconds)
{
	UE_LOGF(LogMIDI, Verbose, "UHarmonixMusicEnvironmentMetronome: Starting Metronome at %f seconds", FromSeconds);
...
{
	UE_LOGF(LogMIDI, Verbose, "UHarmonixMusicEnvironmentMetronome: Stopping Metronome");
