...
struct FDtaParser
{
	UE_API static bool DtaStringToJsonString(const FString& InDtaString, FString& OutJsonString, FString& OutErrorMessage);
...
private:
	...
	static bool ParseToJson(const TArray<FString>& Tokens, FString& OutString, FString& OutErrorMessage);
};
