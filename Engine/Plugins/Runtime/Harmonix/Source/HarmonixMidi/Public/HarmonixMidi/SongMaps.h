...
public:
	...
	UE_API float GetMsAtBeat(float Beat) const; // Beat is zero indexed.
	...
	UE_API float GetFractionalBeatAtMs(float Ms) const; // Returns ONE indexed beat, beware.
	UE_API float GetFractionalBeatAtTick(float Tick) const; // Returns ONE indexed beat, beware.
	...
	UE_API float GetMsAtFractionalBarIncludingCountIn(float BarIncludingCountIn) const; // BarIncludingCountIn is zero based
