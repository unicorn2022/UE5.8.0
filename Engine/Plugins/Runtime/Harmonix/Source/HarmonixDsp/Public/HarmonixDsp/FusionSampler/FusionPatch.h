...
// Empty base class for data that will be passed along to the sampler
struct FFusionPatchUserData
{
	virtual ~FFusionPatchUserData() {}

	virtual void OnSamplerConnected(const FFusionSampler* Sampler) {}
	virtual void OnSamplerDisconnected(const FFusionSampler* Sampler) {}
};
...
public:
	...
	UE_API void ConnectSampler(const FFusionSampler* Sampler);
...
private:
	...
	TSharedPtr<FFusionPatchUserData> UserData;
};
...
public:
	...
	TSharedPtr<FFusionPatchUserData> GetUserData() { return FusionPatchData.UserData; }
	UE_API void SetUserData(TSharedRef<FFusionPatchUserData> UserData);
