...
bool UTargetTagRequirementsGameplayEffectComponent::OnActiveGameplayEffectAdded(FActiveGameplayEffectsContainer& GEContainer, FActiveGameplayEffect& ActiveGE) const
{
	...
	{
		UE_LOGF(LogGameplayEffects, Error, "UTargetTagRequirementsGameplayEffectComponent::OnGameplayEffectAdded called with ActiveGE: %ls which had an invalid FActiveGameplayEffectHandle.", *ActiveGE.GetDebugString());
	}
