...
protected:
	...
	/** Change Gameplay effect values before they get applied */
	UFUNCTION(BlueprintImplementableEvent, Category = Ability, DisplayName = "EditSpecValues", meta = (ScriptName = "EditSpecValues"))
	UE_API void BP_EditSpecValues(FGameplayEffectSpecHandle SpecHandle) const;
	...
	/** We need to serialize non-property fields in certain circumstances */
	UE_API virtual void Serialize(FArchive& Ar) override;

#if UE_WITH_REMOTE_OBJECT_HANDLE
	virtual void PostMigrate(const struct FUObjectMigrationContext& MigrationContext) override;
#endif
};
