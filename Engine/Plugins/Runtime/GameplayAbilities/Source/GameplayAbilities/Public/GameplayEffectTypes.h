...
struct FGameplayEffectContextHandle
{
	...
	virtual ~FGameplayEffectContextHandle() = default;
...
struct FGameplayEffectRemovalInfo
{
	...
	/** Which AbilitySystemComponent this Gameplay Effect was applied to */
	UPROPERTY(Transient)
...
enum class EGameplayTagReplicationState : uint8
{
	...
	SimulatedTagOnly,		// tag will be replicated to simulated proxies, but not the owner. Used for GameplayEffect tags
