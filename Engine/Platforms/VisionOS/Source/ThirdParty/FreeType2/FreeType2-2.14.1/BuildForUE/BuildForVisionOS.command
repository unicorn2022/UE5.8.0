...
FREETYPE_VISIONOS_VERSION=FreeType2-2.14.1
PATH_TO_FREETYPE=${THIRD_PARTY_DIRECTORY}/FreeType2/${FREETYPE_VISIONOS_VERSION}

CMAKE_ADDITIONAL_ARGUMENTS=-DFT_REQUIRE_ZLIB=TRUE
CMAKE_ADDITIONAL_ARGUMENTS+=" -DFT_REQUIRE_PNG=TRUE"
# We do not want to use HB 
CMAKE_ADDITIONAL_ARGUMENTS+=" -DFT_DISABLE_HARFBUZZ=TRUE"
CMAKE_ADDITIONAL_ARGUMENTS+=" -DCMAKE_DISABLE_FIND_PACKAGE_HarfBuzz=TRUE"
# We do not want to use bzip2 features for .pcf or .bz2 support 
CMAKE_ADDITIONAL_ARGUMENTS+=" -DFT_DISABLE_BZIP2=TRUE"
