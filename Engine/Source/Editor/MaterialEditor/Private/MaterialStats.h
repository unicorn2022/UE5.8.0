...
public:
	...
	FText GetShaderCodeText(const EMaterialQualityLevel::Type QualityType, const int32 InstanceIndex);

	/** returns the number of shaders in this material w/o compiling shaders */
	FText GetShaderCountText(const EMaterialQualityLevel::Type QualityType, const int32 InstanceIndex);
...
public:
	...
	FText GetShaderCodeText(const EShaderPlatform PlatformID, const EMaterialQualityLevel::Type QualityType, const int32 InstanceIndex);

	/** returns the number of shaders in the material with the specified platform with some quality level.  Does this without compiling shaders. */
	FText GetShaderCountText(const EShaderPlatform PlatformID, const EMaterialQualityLevel::Type QualityType, const int32 InstanceIndex);
