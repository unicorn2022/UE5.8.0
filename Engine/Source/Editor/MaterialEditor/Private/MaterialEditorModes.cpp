...
{
	const TSharedRef<FTabManager::FLayout> StandaloneDefaultLayout = FTabManager::NewLayout("Standalone_MaterialEditor_Layout_v17")
	->AddArea
	(
		...
		(
			...
			(
				...
				(
					...
					->AddTab( FMaterialEditorTabs::NamedReroutesTabId, ETabState::SidebarTab, ESidebarLocation::Right, 0.14f )
				)
			)
		)
	);
