...
void FMaterialEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND( SetShaderBallPreview, "ShaderBall", "Sets the preview mesh to a shader ball primitive.", EUserInterfaceActionType::RadioButton, FInputChord() );
	...
	UI_COMMAND( SelectPreviewMeshMaterialSlots, "Mesh Slots", "Sets the preview mesh slots to apply the material to.", EUserInterfaceActionType::RadioButton, FInputChord() );
