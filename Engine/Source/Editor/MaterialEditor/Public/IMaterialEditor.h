...
public:
	...
	*/
	...
	/** Rebuild the preview + graph view from the asset under edit (Material or MaterialFunction). */
	virtual void RefreshGraphFromOriginal() {}
	...
	virtual void SetCustomPrimitiveData(TConstArrayView<float> CustomFloats) {}
