...
public:
	...
	/** The configuration used in the Material Asset Wizard when creating a new Material. If not set, Content Browser uses the old factory without wizard. */
	UPROPERTY(config, EditAnywhere, Category = Wizard, meta=(AllowedClasses="/Script/UserAssetTagsEditor.TaggedAssetBrowserConfiguration"))
	FSoftObjectPath MaterialWizardConfiguration;

	/** The configuration used in the Material Asset Wizard when creating a new Material Instance. If not set, Content Browser uses the old factory without wizard. */
	UPROPERTY(config, EditAnywhere, Category = Wizard, meta=(AllowedClasses="/Script/UserAssetTagsEditor.TaggedAssetBrowserConfiguration"))
	FSoftObjectPath MaterialInstanceWizardConfiguration;
