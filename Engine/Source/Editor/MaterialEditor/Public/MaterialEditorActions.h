...
public:
	...
	/** Sets the preview mesh to a shader ball */
	...
	/** Set the material slots of the PreviewMesh to apply this material to */
	TSharedPtr< FUICommandInfo > SelectPreviewMeshMaterialSlots;
