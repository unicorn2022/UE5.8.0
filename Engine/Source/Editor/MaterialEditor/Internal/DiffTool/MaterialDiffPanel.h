...
struct FMaterialDiffPanel : public FGCObject
{
	...
	/** The material instance being diffed (nullptr when diffing base materials) */
	TObjectPtr<UMaterialInstance> MaterialInstance = nullptr;

	/** Editor proxy used to display all parameter types including static switches (nullptr when diffing base materials) */
	TObjectPtr<UMaterialEditorInstanceConstant> EditorProxy = nullptr;
