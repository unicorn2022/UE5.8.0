...
class ULevelFactory : public UFactory
{
	...
	UNREALED_API UObject* LevelFactoryCreateText(UClass* Class, UObject* InParent, FName Name, EObjectFlags Flags, UObject* Context, const TCHAR* Type, const TCHAR*& Buffer, const TCHAR* BufferEnd, FFeedbackContext* Warn, TArray<AActor*>* OutActors);
};
