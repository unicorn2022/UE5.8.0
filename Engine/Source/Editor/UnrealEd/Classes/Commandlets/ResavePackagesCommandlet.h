...
protected:
	...
	/** Only valid for bOnlyMaterials.If set, force the materials auto usage flag to the optional value. Don't change the flag's value otherwise */
	TOptional<bool> ForceMaterialAutoUsageFlag; 
