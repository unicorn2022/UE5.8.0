...
#define LOC_DEFINE_REGION
	...
	struct FSourceFileParseContext
	{
		...
		void AddStringTableEntry( const FName InTableId, const FString& InKey, const FString& InSourceString, const FString& InDevNotes );
	...
	private:
		...
		bool AddStringTableEntryImpl( const FName InTableId, const FString& InKey, const FString& InSourceString, const FSourceLocation& InSourceLocation, const FName InPlatformName, const FString& InDevNotes );
	...
	*/
	...
	public:
		...
		FStringMacroDescriptor(FString InName, FMacroArg Arg0, FMacroArg Arg1, FMacroArg Arg2, FMacroArg Arg3) : FMacroDescriptor(InName, 4)
		{
	...
	class FStringTableNotedEntryMacroDescriptor : public FMacroDescriptor
	{
	public:
		FStringTableNotedEntryMacroDescriptor()
			: FMacroDescriptor(TEXT("LOCTABLE_SETNOTESTRING"), 4)
		{
		}
	...
	class FDeclareErrorDescriptor final : public FMacroDescriptor
	{
	public:
		FDeclareErrorDescriptor(const TCHAR* InMacroName, const TCHAR* InKeyParameterName, int32 InMinArguments, int32 InNamespaceIndex, int32 InKeyIndex, int32 InTextIndex);

		virtual void TryParse(const FString& Text, FSourceFileParseContext& Context) const override;
	protected:
		const FString KeyParameterName;
		// Indices of each localized text component in macro argument list
		int32 NamespaceIndex = -1;
		int32 KeyIndex = -1;
		int32 TextIndex = -1;
	};
	...
	static const FString MacroString_NOTELOCTEXT;
	static const FString MacroString_NSNOTELOCTEXT;
