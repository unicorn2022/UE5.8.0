...
private:
	...
	UPROPERTY(EditAnywhere, Category=MaterialEditorInstanceConstant)
	uint32 bOverridePhysMaterial : 1;
	...
	UPROPERTY()
	TObjectPtr<class UMaterialInstanceConstant> PreviewInstance;
	...
	UPROPERTY(EditAnywhere, Category = MaterialEditorInstanceConstant, AdvancedDisplay, meta = (DisplayThumbnail = "false", AllowedClasses = "/Script/CoreUObject.Enum, /Script/Engine.MaterialEnumerationProvider"))
