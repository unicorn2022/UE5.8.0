...
public:
	...
	UPROPERTY(EditAnywhere, config, Category = UserInterface, meta = (ClampMin = 0.25, UIMin = 0.25))
	float OccludedDitheringPatternSize = 2.0f;

	/** The strength of the dithering applied to occluded primitives. */
	UPROPERTY(EditAnywhere, config, Category = UserInterface, meta = (ClampMin = 0.0, UIMin = 0.0, ClampMax = 1.0, UIMax = 1.0, DisplayName = "Occluded Pattern Opacity"))
	float OccludedDithering = 0.8f;

	/** The brightness of occluded primitives. */
	UPROPERTY(EditAnywhere, config, Category = UserInterface, meta = (ClampMin = 0.0, UIMin = 0.0, ClampMax = 1.0, UIMax = 1.0, DisplayName = "Occluded Primitive Brightness"))
...
private:
	void OnPropertyChanged(FName InPropertyName);
