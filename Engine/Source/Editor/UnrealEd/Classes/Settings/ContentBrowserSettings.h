...
public:
	...
	/** Display hint text of keys pressed in content browser in bottom right of the asset view, used to find item by name in a folder */
	UPROPERTY(Config, EditAnywhere, Category = ContentBrowser)
	bool bDisplayQuickJumpText = false;
