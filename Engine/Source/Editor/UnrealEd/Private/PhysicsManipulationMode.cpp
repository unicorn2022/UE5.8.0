...
{
	//UE_LOGF(LogEditorPhysMode, Warning, "Mouse: %ls InDrag: %ls  InRot: %ls", *GEditor->MouseMovement.ToString(), *InDrag.ToString(), *InRot.ToString());
...
{
	//UE_LOGF(LogEditorPhysMode, Warning, "Start Tracking");
...
{
	//UE_LOGF(LogEditorPhysMode, Warning, "End Tracking");
