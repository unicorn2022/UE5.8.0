	...
	: Super(ObjectInitializer)
{
	...
	UE_LOGF(LogWorldPartitionLandscapeBuilder, Display, "IterativeCellSize: %d", IterativeCellSize);
}
...
bool UWorldPartitionLandscapeBuilder::RunInternal(UWorld* World, const FCellInfo& InCellInfo, FPackageSourceControlHelper& PackageHelper)
{
	...
	{
		UE_LOGF(LogWorldPartitionLandscapeBuilder, Error, "Failed to retrieve ULandscapeSubsystem.");
		return false;
	}
}
