...
void UEditorEngine::ToggleFlipConstrainedAspectRatioInPreview()
{
	bFlipConstrainedAspectRatioInPreview ^= true;
	FEditorSupportDelegates::RedrawAllViewports.Broadcast();
}

bool UEditorEngine::GetFlipConstrainedAspectRatioInPreview()
{
	return bFlipConstrainedAspectRatioInPreview;
}
