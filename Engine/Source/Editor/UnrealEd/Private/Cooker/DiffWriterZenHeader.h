...
public:
	...
	FDiffWriterZenHeader(FAccumulatorGlobals& InGlobals, TSharedRef<FDiffOutputRecorder> InDiffOutputRecorder,
	...
	bool IsNameMapIdentical(const TArray<FName>& SourceNames, const TArray<FName>& DestNames,
