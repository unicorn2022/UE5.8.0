...
public:
	...
	struct FCallstackData : public FRefCountedObject
	{
		/** Full callstack */
		...
		FCallstackData(FCallstackData&&) = delete; // FRefCountedObject doesn't allow it
		FCallstackData(const FCallstackData&) = delete;

		FCallstackData& operator=(FCallstackData&&) = delete; // FRefCountedObject doesn't allow it
 ...
 */
class FAccumulator : public FRefCountedObject
{
public:
