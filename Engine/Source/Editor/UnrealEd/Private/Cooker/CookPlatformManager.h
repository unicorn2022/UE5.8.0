...
namespace UE::Cook
{
	...
	struct FPlatformData
	{
		...
		*/
		...
		FAssetRegistrySerializationOptions AssetRegistryDevelopmentSaveOptions;
	...
	*/
	...
	public:
		...
		FPlatformData& CreatePlatformData(UCookOnTheFlyServer& COTFS, const ITargetPlatform* Platform);
