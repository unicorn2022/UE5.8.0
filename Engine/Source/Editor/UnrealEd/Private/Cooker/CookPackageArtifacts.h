...
namespace UE::Cook::Artifact { struct FAppendPackageMetaDataContext; }
...
struct FIncrementalCookAttachments
{
	...
	void Empty();
	void AppendCommitAttachments(UE::Cook::Artifact::FAppendPackageMetaDataContext& Context);
