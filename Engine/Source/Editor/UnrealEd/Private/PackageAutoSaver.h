...
class FPackageAutoSaver final : public IPackageAutoSaver
{
public:
	FPackageAutoSaver();
	...
	virtual void SuspendAutoSave() override { AutoSaveSuspendedCounter++; }
	virtual void ResumeAutoSave() override;
	virtual bool IsAutoSaveSuspended() const override { return AutoSaveSuspendedCounter > 0; }
...
private:
	...
	*/
	...
	/** When >0, the auto-saver will not trigger timer-based auto-saves.  */
	int32 AutoSaveSuspendedCounter = 0;
