...
EEditAction::Type ULegacyEdModeWrapper::GetActionDragDuplicate()
{
	return LegacyEditorMode->GetActionDragDuplicate();
}
...
bool ULegacyEdModeWrapper::RequiresLegacyViewportInteractions() const
{
	return LegacyEditorMode->RequiresLegacyViewportInteractions();
}
