...
using FCustomVersionsStripedMap = TStripedMap<8, const UClass*, TArray<FGuid, TInlineAllocator<1>>>;
...
/** For any ClassNames not already in ClassDigests, look up their UStruct and add them. An optional cache for precalculated custom versions can be used. */
void PrecacheClassDigests(TConstArrayView<FTopLevelAssetPath> ClassNames, FCustomVersionsStripedMap* CustomVersionsCache = nullptr);
