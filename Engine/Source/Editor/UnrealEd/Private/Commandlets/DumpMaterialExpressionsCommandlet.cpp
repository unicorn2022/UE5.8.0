...
int32 UDumpMaterialExpressionsCommandlet::Main(const FString& Params)
{
	...
	{
		UE_LOGF(LogDumpMaterialExpressionsCommandlet, Log, "DumpMaterialExpressions");
		UE_LOGF(LogDumpMaterialExpressionsCommandlet, Log, "This commandlet will dump to a plain text file an info table of all material expressions in the engine and the plugins enabled on the project.");
		UE_LOGF(LogDumpMaterialExpressionsCommandlet, Log, "The output fields include:");
		UE_LOGF(LogDumpMaterialExpressionsCommandlet, Log, "Name - The class name of the material expression");
		UE_LOGF(LogDumpMaterialExpressionsCommandlet, Log, "Type - ControlFlow | HLSLGenerator | CLASS_Deprecated");
		UE_LOGF(LogDumpMaterialExpressionsCommandlet, Log, "ShowInCreateMenu - If the expression appears in the create node dropdown menu");
		UE_LOGF(LogDumpMaterialExpressionsCommandlet, Log, "CreationName - The name displayed in the create node dropdown menu to add an expression");
		UE_LOGF(LogDumpMaterialExpressionsCommandlet, Log, "CreationDescription - The tooltip displayed on the CreationName in the create node dropdown menu");
		UE_LOGF(LogDumpMaterialExpressionsCommandlet, Log, "Caption - The caption displayed on the material expression node");
		UE_LOGF(LogDumpMaterialExpressionsCommandlet, Log, "Tooltip - The tooltip displayed on the material expression node");
		return 0;
	}
	...
	UE_LOGF(LogDumpMaterialExpressionsCommandlet, Log, "Results are written to %ls", *OutputFilePath);
	UE_LOGF(LogDumpMaterialExpressionsCommandlet, Log, "Results are written to %ls", *MatFuncOutputFilePath);
