...
int32 UCopyNaniteFallbackSettingsToRayTracingProxyCommandlet::Main(const FString& Params)
{
	...
	{
		UE_LOGF(LogCopyNaniteFallbackSettingsToRayTracingProxy, Display, "CopyNaniteFallbackSettingsToRayTracingProxy");
		UE_LOGF(LogCopyNaniteFallbackSettingsToRayTracingProxy, Display, "This commandlet will copy non default Nanite Fallback Settings to the Ray Tracing Proxy Settings.");
		return 0;
	}
	...
	UE_LOGF(LogCopyNaniteFallbackSettingsToRayTracingProxy, Display, "Searching for static meshes within the project...");
	...
	UE_LOGF(LogCopyNaniteFallbackSettingsToRayTracingProxy, Display, "Found %d static meshes", StaticMeshAssets.Num());
	...
	UE_LOGF(LogCopyNaniteFallbackSettingsToRayTracingProxy, Display, "Done");
