...
public:
	...
	void GenerateChunkDataFilesForPaths(const int32 InChunkId, const TSet<FName>& InPackagesInChunk, const ITargetPlatform* TargetPlatform, const FString& InLocalizationContentRoot, const FString& InLocalizationMetadataRoot, TArray<FString>& OutChunkFilenames);
...
private:
	...
	struct FCachedLocalizationTargetData
	{
		TSharedPtr<FLocTextHelper> LocTextHelper;
		EGenerateLocResFlags GenerateLocResFlags = {};
	};
	/** Cached localization target data, to avoid redundant work for each chunk */
	TArray<FCachedLocalizationTargetData> CachedLocalizationTargetData;
