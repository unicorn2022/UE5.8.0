...
UDEPRECATED_LightWeightInstanceFactory::UDEPRECATED_LightWeightInstanceFactory(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	SupportedClass = ADEPRECATED_LightWeightInstanceManager::StaticClass();
	bCreateNew = true;
	bEditAfterNew = true;
}

bool UDEPRECATED_LightWeightInstanceFactory::ConfigureProperties()
{
	...
	Filter->AllowedChildrenOfClasses.Add(ADEPRECATED_LightWeightInstanceManager::StaticClass());

	const FText TitleText = LOCTEXT("CreateBlueprintOptions", "Pick Parent Class");
	UClass* ChosenClass = nullptr;
	const bool bPressedOk = SClassPickerDialog::PickClass(TitleText, Options, ChosenClass, ADEPRECATED_LightWeightInstanceManager::StaticClass());
...
UObject* UDEPRECATED_LightWeightInstanceFactory::FactoryCreateNew(UClass* Class, UObject* InParent, FName Name, EObjectFlags Flags, UObject* Context, FFeedbackContext* Warn)
{
