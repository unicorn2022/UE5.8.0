...
public:
	...
	static UNREALED_API void CreateNewBoundEventForActor(AActor* Actor, FName EventName, bool bShouldJumpToNode = true);

	/** Create a new event node in the  blueprint, for the supplied component, event name and blueprint */
	static UNREALED_API void CreateNewBoundEventForComponent(UObject* Component, FName EventName, UBlueprint* Blueprint, FObjectProperty* ComponentProperty, bool bShouldJumpToNode = true);

	/** Create a new event node in the  blueprint, for the supplied class, event name and blueprint */
	static UNREALED_API void CreateNewBoundEventForClass(UClass* Class, FName EventName, UBlueprint* Blueprint, FObjectProperty* ComponentProperty, bool bShouldJumpToNode = true);
