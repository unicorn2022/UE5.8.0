...
public:
	...
	*/
	 ...
	 * @param InstancesThatShouldUseOldClass Subobjects that should keep their old class during reinstantiation, even if a new one is provided by OldToNewClassMap. This shouldn't be used for simple reinstantiation as the old class would be dead. One use-case would be changing the class of an object.
	 */
	static UNREALED_API void PreCreateSubObjectsForReinstantiation(const TMap<UClass*, UClass*>& OldToNewClassMap, UObject* OldObject, UObject* NewUObject, TMap<UObject*, UObject*>& CreatedInstanceMap, const TMap<UObject*, UObject*>* OldToNewInstanceMap = nullptr, TArray< TTuple<UObject*, UObject*>>* OrderedListOfObjectToCopy = nullptr, const TSet<UObject*>* InstancesThatShouldUseOldClass = nullptr);
...
private:
	 ...
	 */
	static UNREALED_API bool PrePopulateInstancingGraphForArchetype(TMap<UObject*,FObjectInstancingGraph>& GraphCache, FObjectInstancingGraph& InstancingGraph, TNotNull<UObject*> OldInstance, UObject* InArchetype, TMap<UObject*, UObject*>* OldToNewInstanceMap = nullptr);


	/** Handles the sub object pre-creation recursively */
	static UNREALED_API void PreCreateSubObjectsForReinstantiation_Inner(const TSet<UObject*>* OldInstancedSubObjects, const TMap<UClass*, UClass*>& OldToNewClassMap, UObject* OldObject, UObject* NewUObject, TMap<UObject*, UObject*>& CreatedInstanceMap, const TMap<UObject*, UObject*>* OldToNewInstanceMap, TArray< TTuple<UObject*, UObject*>>* OrderedListOfObjectToCopy, const TSet<UObject*>* InstancesThatShouldUseOldClass);
	...
	static void ReinstanceWithVersioningData(const FReinstancingState& ReinstancingState, const TSet<UObject*>* InstancesThatShouldUseOldClass);
	...
	static void ReinstanceNormalObjects(TMap<UClass*, UClass*>& OldToNewClassMap, const FReinstancingState& ReinstancingState, const TSet<UObject*>* InstancesThatShouldUseOldClass);
	static void ReinstanceActors(TMap<UClass*, UClass*>& OldToNewClassMap, const FReinstancingState& ReinstancingState, const TSet<UObject*>* InstancesThatShouldUseOldClass);
