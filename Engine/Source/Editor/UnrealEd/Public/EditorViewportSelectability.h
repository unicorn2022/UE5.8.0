...
public:
	...
	/** Registers an additional viewport selectability predicate that is ANDed with the primary predicate. */
	static UE_API FDelegateHandle RegisterObjectSelectablePredicate(const FOnIsObjectSelectableInViewport& InPredicate);

	/** Unregisters a predicate previously registered with RegisterObjectSelectablePredicate. */
	static UE_API void UnregisterObjectSelectablePredicate(const FDelegateHandle InHandle);

	/** Evaluates the registered additional viewport selectability predicates for an object. */
	static UE_API bool PassesAdditionalObjectSelectablePredicates(UObject* const InObject);

	/** Evaluates the registered additional viewport selectability predicates for an hit proxy. */
	static UE_API bool PassesAdditionalObjectSelectablePredicates(HHitProxy* const InHitProxy);
...
protected:
	static UE_API TMap<FDelegateHandle, FOnIsObjectSelectableInViewport>& GetAdditionalObjectSelectablePredicates();
