...
class UEditorSettings : public UObject
{
	...
	/**
	 * Adjusts the Local Cache location. This affects every project and workspace used from your user profile that accepts the UE-LocalDataCachePath environment variable override.
	 * This is usually the first location to query for previously built data.
	 */
	UPROPERTY(EditAnywhere, Category = DerivedDataCache, meta = (DisplayName = "Local DDC Path", ConfigRestartRequired = true))
	FDirectoryPath GlobalLocalDDCPath;

	/**
	 * Adjusts the Shared Cache location. This affects every project and workspace used from your user profile that accepts the UE-SharedDataCachePath environment variable override.
	 ...
	 */
	UPROPERTY(EditAnywhere, Category = DerivedDataCache, meta = (DisplayName = "Shared DDC Path", ConfigRestartRequired = true))
	 ...
	 * This will override the 'Local DDC Path'.
	 */
	 ...
	 * This will override the 'Shared DDC Path'.
	 */
	 ...
	 * This affects every project and workspace used from your user profile that accepts the UE-S3DataCachePath environment variable override.
	 */
	UPROPERTY(EditAnywhere, Category="Derived Data Cache S3", meta = (DisplayName = "Local S3DDC Path", ConfigRestartRequired = true, EditCondition = "bEnableS3DDC"))
