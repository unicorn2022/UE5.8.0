...
public:
	...
	/** Get the threshold used to warn the user about low camera speed */
	UNREALED_API float GetLowSpeedWarningThreshold() const;
...
private:
	...
	/** A threshold used to warn the user about low camera speed */
	UPROPERTY()
	float LowSpeedWarningThreshold = 0.01f;
};
