...
public:
	...
	UNREALED_API int32 AddRuntimeMonitoredDirectory(const FAutoReimportDirectoryConfig& Directory);

	/** Remove runtime directory with the given handle. */
	UNREALED_API void RemoveRuntimeMonitoredDirectory(const int32 Handle);
