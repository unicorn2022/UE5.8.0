...
public:
	...
	// Convert any pending tools-context invalidations into ViewportClient->Invalidate() calls
	UNREALED_API void PropagateInvalidations( FEditorViewportClient* ViewportClient );
	...
	/** True if legacy gizmos are required */
	UNREALED_API bool RequiresLegacyViewportInteractions() const;
	...
	UE_DEPRECATED(5.8, "Use GetCursorVisibilityOverride() instead. `bSoftwareCursorVisible` is not a ref and is hence broken")
	...
	/** Get override cursor visibility settings */
	UNREALED_API bool GetCursorVisibilityOverride(bool& bOutWantsOverride, bool& bOutHardwareCursorVisible, bool& bOutSoftwareCursorVisible) const;
	...
	*/
	...
	UNREALED_API EEditAction::Type GetActionDragDuplicate();
	...
	*/
	...
	UNREALED_API bool UsesViewportITF() const;
	UNREALED_API void SetSupportsViewportITF(bool bIsSupported);
	UNREALED_API bool SupportsViewportITF() const;
	...
	UNREALED_API bool OnTransformCanceled(const FGizmoState& InState) const;
...
protected:
	...
	UNREALED_API void OnViewportListChanged();
...
private:
	...
	/** Determines whether this mode tool can ever support TRS gizmos. */
	bool bViewportITF = true;
