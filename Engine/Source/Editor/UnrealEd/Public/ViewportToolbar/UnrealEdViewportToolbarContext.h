...
public:
	/** Actual viewport for context */
	TWeakPtr<SEditorViewport> Viewport;

	/** View mode filters for context menu */
	...
	/**
	 * Add flags to this array to remove them from the Show Menu (Group)
	 */
	TArray<EShowFlagGroup> ExcludedShowMenuGroupFlags;
	...
	static UE_API TSharedPtr<FEditorViewportClient> GetEditorViewportClient(const FToolMenuContext& Context);
