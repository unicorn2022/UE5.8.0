...
public:
	/**
	 * @return true if any snapping is active and should be applied
	 */
	static UNREALED_API bool IsSnappingActive();
	...
	/**
	 * @return true if *any* snapping that affects translation is enabled
	 */
	static UNREALED_API bool IsTranslationSnappingEnabled(const bool bInRequireSnappingActive = true);

	/**
	 * @return true if orientation snapping to angular grid is enabled
	 */
	static UNREALED_API bool IsRotationSnapEnabled();

	/**
	 * @return true if *any* snapping that affects orientation is enabled
	 */
	static UNREALED_API bool IsRotationSnappingEnabled(const bool bInRequireSnappingActive = true);

	/**
	 * @return true if scale snapping to grid is enabled
	 */
	static UNREALED_API bool IsScaleSnapEnabled();

	/**
	 * @return true if *any* snapping that affects scale is enabled
	 */
	static UNREALED_API bool IsScaleSnappingEnabled(const bool bInRequireSnappingActive = true);
	 ...
	 */
	static UNREALED_API bool SnapDraggedActorsToNearestVertex( FVector& DragDelta, FEditorViewportClient* ViewportClient );
	 ...
	 * @return true if anything was snapped
	 */
	static UNREALED_API bool SnapDragLocationToNearestVertex( const FVector& BaseLocation, FVector& DragDelta, FEditorViewportClient* ViewportClient, bool bIsPivot = false );
	 ...
	 * @return true if anything was snapped
	 */
	static UNREALED_API bool SnapLocationToNearestVertex( FVector& Location, const FVector2D& MouseLocation, FEditorViewportClient* ViewportClient,
		FVector& OutVertexNormal, bool bDrawVertHelpers, const TSet<TWeakObjectPtr<class AActor>>& ActorsToIgnore );
