...
public:
	...
	/** Shows the group menu item for streaming deficit modes */
	TSharedPtr< FUICommandInfo > GroupStreamingDeficitMode;

	/** Changes the viewport to streaming texture deficit mode (WantedMips vs ResidentMips) */
	TSharedPtr< FUICommandInfo > StreamingTextureDeficitMode;

	/** Changes the viewport to streaming texture residency mode (MaxLODs vs ResidentMips) */
	TSharedPtr< FUICommandInfo > StreamingTextureResidencyMode;

	/** Changes the viewport to streaming mesh LOD deficit mode (WantedMips vs ResidentMips) */
	TSharedPtr< FUICommandInfo > StreamingMeshLODDeficitMode;

	/** Changes the viewport to streaming mesh LOD residency mode (MaxLODs vs ResidentLODs) */
	TSharedPtr< FUICommandInfo > StreamingMeshLODResidencyMode;
	...
	/** Changes the viewport to visualize MegaLights debug views */
	TSharedPtr< FUICommandInfo > VisualizeMegaLightsMode;
	...
	/** Changes the viewport to show only specific color channels */
	TSharedPtr< FUICommandInfo > AllChannelsMask;
	TSharedPtr< FUICommandInfo > RedChannelMask;
	TSharedPtr< FUICommandInfo > GreenChannelMask;
	TSharedPtr< FUICommandInfo > BlueChannelMask;
	TSharedPtr< FUICommandInfo > AlphaChannelMask;
	...
	TSharedPtr< FUICommandInfo > Snapping;
	...
	/** Temporarily toggles snapping for the current transform mode (translate/rotate/scale) while held; quick-press toggles permanently */
	TSharedPtr< FUICommandInfo > CurrentTRSSnapToggle;
 ...
 */
UE_DEPRECATED(5.8, "Use UE::UnrealEd::BuildViewModeOptionsMenu instead.")
...
namespace UE::UnrealEd
{
	 ...
	 * Build the viewmode otions menu.
	 * 
	 * @param FMenuBuilder The menu builder to create the menu
	 * @param FViewModeArgs The parameters to customize the view mode menu
	 */
	UNREALED_API void BuildViewModeOptionsMenu(FMenuBuilder& InMenuBuilder, const FViewModeOptionsArgs& InArgs);
}