...
class SDepthBar;
class SEditorViewportGridPanel;
...
public:
	...
	UNREALED_API virtual void AddOverlayWidget(TSharedRef<SWidget> OverlaidWidget, int32 ZOrder = INDEX_NONE);

	/** Removes a widget that was previously overlaid on to this viewport */
	UNREALED_API virtual void RemoveOverlayWidget(TSharedRef<SWidget> OverlaidWidget);
...
///////////////////////////////////////////////////////////////////////////////
	...
	*/
	...
	/**
	 * Manipulate gizmo size
	 */
	UNREALED_API virtual void OnIncreaseGizmoSize();
	UNREALED_API virtual void OnDecreaseGizmoSize();
	UNREALED_API virtual void OnResetGizmoSize();
	 ...
	 */
	UE_DEPRECATED(5.8, "Viewport interactions should be managed from the mode manager layer rather than from individual viewports.")
	...
	UNREALED_API void SetAspectRatio(float AspectRatioIn);
	UNREALED_API void SetUsePlatformAspectRatio();
	UNREALED_API void UnsetAspectRatio();

protected:
	TSharedPtr<SOverlay> ViewportOverlay;

	TSharedPtr<SEditorViewportGridPanel> ViewportAspectRatioManager;
...
private:
	...
	/**
	 * Storing Interactive Tools Context so that we can unbind delegates in the class constructor. Once the new ITF
	 * based gizmos, drag tools and viewport interactions will be the default, this can be removed.
	 */
	TWeakObjectPtr<UModeManagerInteractiveToolsContext> ModeManagerInteractiveToolsContextWeak;
};
