...
protected:
	...
	static void OpenSettings(FName InContainerName, FName InCategoryName, FName InSectionName);
...
public:
	...
	TSharedPtr<FUICommandInfo> OpenEditorPreferences;
	TSharedPtr<FUICommandInfo> OpenKeyboardShortcuts;
