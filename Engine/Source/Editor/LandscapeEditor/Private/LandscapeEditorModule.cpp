...
public:
	...
	virtual void StartupModule() override
	{
		...
		PropertyModule.RegisterCustomPropertyTypeLayout("LandscapeGrassName", FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FLandscapeGrassNameCustomization::MakeInstance));
	...
	virtual void ShutdownModule() override
	{
		...
		PropertyModule.UnregisterCustomPropertyTypeLayout("LandscapeGrassName");
