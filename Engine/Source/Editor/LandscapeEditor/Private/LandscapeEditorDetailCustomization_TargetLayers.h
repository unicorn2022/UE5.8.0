...
protected:
	...
	static EVisibility GetWeightBlendedTargetLayerPaintModeVisibility();
...
protected:
	...
	static ELandscapeTargetLayerActionType GetTargetLayerActionType(const TSharedRef<FLandscapeTargetListInfo> Target);
	static const FSlateBrush* GetTargetLayerActionTypeBrush(const TSharedRef<FLandscapeTargetListInfo> Target);
	static FLinearColor GetTargetLayerBlendGroupStripColor(const TSharedRef<FLandscapeTargetListInfo> Target);
	static EVisibility GetTargetLayerBlendGroupStripVisibility(const TSharedRef<FLandscapeTargetListInfo> Target);
	...
	static void OnTargetLayerCreateClicked(const TSharedRef<FLandscapeTargetListInfo> Target);
	...
	static void OnTargetLayerDeleteClicked(const TSharedRef<FLandscapeTargetListInfo> Target);
	...
	static FText GetTargetBlendMethodText(const TSharedRef<FLandscapeTargetListInfo> InTarget, bool bInIncludeBlendGroup);
	static FText GetTargetBlendGroupText(const TSharedRef<FLandscapeTargetListInfo> InTarget, bool bInAllowNoName);
