...
void FLandscapeEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND(BlueprintBrushTool, "Blueprint", "Custom Blueprint-based brushes that will procedurally affect the landscape's heightmaps and/or weightmaps.", EUserInterfaceActionType::RadioButton, FInputChord());
	...
	UI_COMMAND(SplineTool, "Splines", "Create splines that will procedurally affect the landscape's heightmaps and/or weightmaps.", EUserInterfaceActionType::RadioButton, FInputChord());
