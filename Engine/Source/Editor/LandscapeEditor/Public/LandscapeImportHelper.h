...
enum class ELandscapeImportTransformType : int8
{
	...
	None UMETA(DisplayName="Original", ToolTip="Import the data at the gizmo location in the original size"),
	ExpandOffset UMETA(DisplayName="Expand", ToolTip="Import the data at the gizmo location and expand the data to fill the landscape") ,
	ExpandCentered UMETA(Hidden), 
	Resample UMETA(ToolTip="Resample import data to fit landscape"),
