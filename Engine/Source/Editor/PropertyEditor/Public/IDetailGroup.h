...
public:
	...
	/**
	 * Adds a new row for an external struct property
	 *
	 * @return an interface for customizing the appearance of the property row
	 */
	virtual IDetailPropertyRow& AddExternalStructureProperty(TSharedPtr<IStructureDataProvider> StructDataProvider, FName PropertyName, EPropertyLocation::Type Location, const FAddPropertyParams& Params) = 0;
	...
	*/
	...
	/**
	 * Returns the number of child rows under this group
	 */
