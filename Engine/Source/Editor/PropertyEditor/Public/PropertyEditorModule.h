...
public:
	 ...
	 * A property type is a specific FProperty type, a struct, instanced Object property, or enum type
	 *
	...
	UE_EXPERIMENTAL(5.8, "This function may be removed and replaced with some other signaling mechanism.")
	virtual void RequestRefreshOfAllDetailsPanels();
	...
	DECLARE_EVENT_OneParam(PropertyEditorModule, FOnPropertyMatrixAssetsSaved, const TArray<UObject*>&);
	virtual FOnPropertyMatrixAssetsSaved& OnPropertyMatrixAssetsSaved() { return PropertyMatrixAssetsSaved; }
	...
	UE_EXPERIMENTAL(5.8, "This CVar may be removed.")
	PROPERTYEDITOR_API static TAutoConsoleVariable<bool> CVarAllowPropertyMatrixForNonActors;
private:
...
private:
	...
	/** Event to be called when assets are saved in bulk from the property matrix editor. */
	FOnPropertyMatrixAssetsSaved PropertyMatrixAssetsSaved;
