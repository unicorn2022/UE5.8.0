...
{
public:
	virtual ~IDetailCategoryBuilder() = default;
	/**
	...
	*/
	...
	/**
	 * If valid, the color that represented the category. It can be used to visually identify the category quickly.
	 */
	virtual TOptional<FLinearColor> GetColor() const = 0;

	/**
	 * Set the color that represents the category.
	 */
	virtual void SetColor(FLinearColor InColor) = 0;

	/**
 	 * Clear the color that represents the category.
 	 */
