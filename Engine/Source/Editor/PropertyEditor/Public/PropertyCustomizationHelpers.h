...
namespace PropertyCustomizationHelpers
{
	...
	PROPERTYEDITOR_API TSharedRef<SWidget> MakeComponentPickerWithMenu( UActorComponent* const InitialComponent, const bool AllowClear, FOnShouldFilterActor ActorFilter, FOnShouldFilterComponent ComponentFilter, FOnComponentSelected OnSet, FSimpleDelegate OnClose, UWorld* PickerWorld = nullptr, bool bShowTransient = false);
...
public:
	...
	{}
		...
		/** Optional override for the tooltip of the 'Browse' button */
		SLATE_ATTRIBUTE(FText, OnBrowseToolTipOverride)
		/** Optional override for the icon of the 'Browse' button */
		SLATE_ATTRIBUTE(const FSlateBrush*, OnBrowseIconOverride)
		...
		/** A custom slot added to the row of buttons */
		SLATE_NAMED_SLOT(FArguments, CustomButtonSlot)
...
protected:
	...
	bool GetShouldGenerateHeader() const {return bGenerateHeader;}
	bool GetShouldDisplayResetToDefault() const {return bDisplayResetToDefault;}
	bool GetShouldDisplayElementNum() const {return bDisplayElementNum;}
...
{
public:
	virtual ~ISectionListBuilder() = default;
	/**
