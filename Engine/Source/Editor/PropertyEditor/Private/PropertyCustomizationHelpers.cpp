...
namespace PropertyCustomizationHelpers
{
	...
	TSharedRef<SWidget> MakeComponentPickerWithMenu( UActorComponent* const InitialComponent, const bool AllowClear, FOnShouldFilterActor ActorFilter, FOnShouldFilterComponent ComponentFilter, FOnComponentSelected OnSet, FSimpleDelegate OnClose, UWorld* PickerWorld, bool bShowTransient)
	{
		return
	...
	[	
		...
		[
			SAssignNew(PropertyEditorAsset, SPropertyEditorAsset)
				...
				.OnBrowseToolTipOverride(InArgs._OnBrowseToolTipOverride)
				.OnBrowseIconOverride(InArgs._OnBrowseIconOverride)
