...
private:
	...
	/** @return true if Show Helper Sections is checked. */
	bool IsShowHelperSectionsChecked() const;
	
	/** Called when Show Helper Sections is clicked */
	void OnShowHelperSectionsClicked();
