...
protected:
	...
	/** Called when row favoriting is toggled */
	virtual void OnFavoriteRow(bool bInAddToFavorite);
	
	/** Is row favoriting allowed */
	virtual bool CanFavoriteRow(bool bInAddToFavorite);
