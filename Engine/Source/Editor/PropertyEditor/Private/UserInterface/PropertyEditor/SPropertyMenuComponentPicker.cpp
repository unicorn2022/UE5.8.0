...
void SPropertyMenuComponentPicker::Construct(const FArguments& InArgs)
{
	...
	MenuBuilder.BeginSection(NAME_None, LOCTEXT("BrowseHeader", "Browse"));
	{
		...
		InitOptions.bShowTransient = InArgs._ShowTransient;
		...
		MenuContent =
			...
			[
				...
				[
					SceneOutlinerModule.CreateComponentPicker(InitOptions, FOnComponentPicked::CreateSP(this, &SPropertyMenuComponentPicker::OnItemSelected), InArgs._PickerWorld)
				]
			];
