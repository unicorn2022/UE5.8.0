...
public:
	...
	static FString DetailCategories;
	static FString TransientPerViewDetailCategories;
	static FString PersistentPerViewDetailCategories;
...
public:
	...
	virtual TOptional<FLinearColor> GetColor() const override;
...
private:
	...
	/** Return string key for the given struct in config .ini for this details view's categories */
	const FString& GetDetailCategoriesExpansionSection() const;

	/** Return string key for the given struct in config .ini for this details view */
	FString GetCategoryPathConfigKey(const FString& InPath) const;
...
private:
	...
	int32 SortOrder;
	/** The color that represents the category. */
