...
public:
	...
	/** Global method to remove saved transient detail expansions */
	static void ResetTransientPerViewDetailExpansion();

	/** Global method to remove saved persistent detail expansions */
	static void ResetPersistentPerViewDetailExpansion();
...
public:
	...
	*/
	...
	virtual void SetSearchText(const FText& InSearch) override;
	...
	virtual FName GetViewIdentifier() const override;
	virtual FDetailsViewArgs::EExpansionPersistenceMethod GetExpansionPersistenceMethod() const override;
...
protected:
	...
	/** Return string key for the given struct in config .ini for this details view's properties */
	const FString& GetDetailPropertyExpansionSection() const;

	/** Return string key for the given struct in config .ini for this details view's custom widgets */
	const FString& GetDetailCustomWidgetExpansionSection() const;

	/** Return string key for the given struct in config .ini for this details view */
	FString GetStructExpansionConfigKey(UStruct* InStruct) const;
	...
	/** Creates details filter before filtering nodes */
	FDetailFilter CreateDetailFilter();
...
protected:
	...
	/** Internal details commands */
	TSharedPtr<FUICommandList> InternalCommands;
};
