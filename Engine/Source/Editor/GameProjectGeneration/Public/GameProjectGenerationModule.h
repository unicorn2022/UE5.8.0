...
public:
	...
	UE_DEPRECATED(5.8, "Use CreateEmbeddedProjectBrowser")
	virtual TSharedRef<class SWidget> CreateProjectBrowser(bool bInShowHeaderBar = true, bool bInAllowScrolling = true);

	/** Creates the embedded project browser widget */
	virtual TSharedRef<class SWidget> CreateEmbeddedProjectBrowser();
