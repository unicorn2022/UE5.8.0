...
template <>
struct TWidgetTypeTraits<class SAssetTreeItem>
{
...
public:
	...
	virtual ~SAssetTreeItem() override;
...
protected:
	...
	virtual FText GetNameText() const;
...
template <>
struct TWidgetTypeTraits<class SCollectionTreeItem>
{
	static constexpr bool SupportsInvalidation() { return true; }
};
