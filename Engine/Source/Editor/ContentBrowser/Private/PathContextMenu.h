...
public:
	...
	/** Delegate for when the context menu has successfully edited a favorite folder */
	DECLARE_DELEGATE_OneParam(FOnFolderFavoriteEdited, const FContentBrowserItemPath& /*FolderToEdit*/)
	void SetOnFolderFavoriteEdited(const FOnFolderFavoriteEdited& InOnFolderFavoriteEdited);
	...
	/** Handler for favorite editing */
	void ExecuteEditFavorite();
...
private:
	...
	FOnFolderFavoriteEdited OnFolderFavoriteEdited;
