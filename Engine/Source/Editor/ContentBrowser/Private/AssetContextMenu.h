...
private:
	...
	/** Compares two access specifiers.  Returns < 0 if A less accessible than B, > 0 if A more accessible than B, and 0 if they are equal. **/
	static int32 CompareAssetAccessSpecifiers(EAssetAccessSpecifier A, EAssetAccessSpecifier B);
	...
	bool bCanShowSetAssetAccessMenu = false;
