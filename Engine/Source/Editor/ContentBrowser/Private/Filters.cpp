...
void FFilter_HideOtherDevelopers::BuildFilter()
{
	...
	{
		UE_LOGF(LogContentBrowser, Verbose, "[%ls] FFilterHideOtherDevelopers rebuilt exclusion list: %ls", *FilterBarIdentifier.ToString(), 
	...
	{
		UE_LOGF(LogContentBrowser, Verbose, "[%ls] FFilterHideOtherDevelopers keeping previous exclusion list", *FilterBarIdentifier.ToString());
	}
}
...
void FFilter_HideOtherDevelopers::ActiveStateChanged(bool bActive)
{
	if (bActive)
	{
		UE_LOGF(LogContentBrowser, Verbose, "[%ls] FFilterHideOtherDevelopers active, hiding content from other developers", *FilterBarIdentifier.ToString());
	}
	else
	{
		UE_LOGF(LogContentBrowser, Verbose, "[%ls] FFilterHideOtherDevelopers inactive, showing content from all developers", *FilterBarIdentifier.ToString());
	}
}
