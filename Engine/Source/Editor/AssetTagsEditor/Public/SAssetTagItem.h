...
class SAssetTagItemTableRow;

template <typename ItemType>
struct TWidgetTypeTraits<class SAssetTagItemTableRow<ItemType>>
{
...
template <>
struct TWidgetTypeTraits<class SAssetTagItem>
{
	static constexpr bool SupportsInvalidation() { return true; }
};
...
private:
	...
	{
		return BaseColor.Get(FLinearColor::White).CopyWithNewOpacity(0.3f);
	}

	FLinearColor GetAssetTagDullColor() const
	{
		return BaseColor.Get(FLinearColor::White).CopyWithNewOpacity(0.1f);
	}

	FLinearColor GetAssetTagDisabledColor() const
	{
		return BaseColor.Get(FLinearColor::White).CopyWithNewOpacity(0.04f);
	}
