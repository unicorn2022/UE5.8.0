...
public:
	...
	/** The draw scale of the text on the viewport for infos, warnings, errors... */
	UPROPERTY(config, EditAnywhere, Category=Foreground, meta=(ClampMin="0.1"))
	float ViewportTextScale = 1.f;
