...
#include "Kismet2/BlueprintImpl.h"
...
public:
	...
	//////////////////////////////////////////////////////////////////////////
	// FPinTypeInfo
	/** Class used for creating type tree selection info, which aggregates the various PC_* and PinSubtypes in the schema into a hierarchy */
...
public:
	...
	*/
	 ...
	 */
	UE_API virtual void GetVariableTypeTree(TArray< TSharedPtr<FPinTypeTreeInfo> >& TypeTree, ETypeTreeFilter TypeTreeFilter = ETypeTreeFilter::None) const;
	...
	/** Calculates an estimated width for the specified node */
	static UE_API float EstimateNodeWidth( const UEdGraphNode* Node );
...
private:
	...
	static UE_API const UScriptStruct* Vector2DStruct;
