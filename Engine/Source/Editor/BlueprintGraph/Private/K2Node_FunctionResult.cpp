...
ERenamePinResult UK2Node_FunctionResult::RenameUserDefinedPinImpl(FName OldName, FName NewName, bool bTest)
{
	...
	if (bCheckLocalVariablesNameCollision)
	{
		...
		{
			const FProperty* ExistingProperty = FindFProperty<const FProperty>(Function, NewName);
			if (ExistingProperty)
			{
