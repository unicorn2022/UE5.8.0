...
public:
	...
	/** 
	 * Gets a list of all the viewport tabs in this level editor mapped to arrays of all viewports in that tab. 
	 * There are 4 viewport tabs, mapped to 0 to 3. Standalone viewports are mapped to index 4. 
	 */
	virtual TMap< int32, TArray< TSharedPtr< SLevelViewport > > > GetViewportsByTab() const = 0;
	...
	virtual void GetSceneOutlinerInitializationOptions(const FName TabIdentifier, FSceneOutlinerInitializationOptions& OutInitOptions) = 0;
