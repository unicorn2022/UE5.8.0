...
public:
	...
	TSharedPtr< FUICommandInfo > BuildHLODs_SelectedActors;
	...
	/** Plays from the current position (selected actor or clicked) */
	...
	TSharedPtr< FUICommandInfo > TogglePreviewPlatform;
...
public:
	...
	*/
	static UE_API void PreviewJson_Clicked(FName PlatformName, FString JsonFile);
	...
	*/
	...
	static UE_API void BuildHLODs_SelectedActors_Execute();
	...
	static UE_API void TogglePreviewPlatform();
	static UE_API bool IsPreviewPlatformEnabled();
	static UE_API bool IsPreviewPlatformActive();
	static UE_API bool IsPreviewModeButtonVisible();

	UE_DEPRECATED(5.8, "Use TogglePreviewPlatform instead")
	static void ToggleFeatureLevelPreview() { TogglePreviewPlatform(); }
	UE_DEPRECATED(5.8, "Use IsPreviewPlatformEnabled instead")
	static bool IsFeatureLevelPreviewEnabled() { return IsPreviewPlatformEnabled(); }
	UE_DEPRECATED(5.8, "Use IsPreviewPlatformActive instead")
	static bool IsFeatureLevelPreviewActive() { return IsPreviewPlatformActive(); }
	...
	/** If an actor is selected, plays from its position (AActor::bCanPlayFromHere must be true) otherwise it will play from last clicked position */
	static UE_API void PlayFromHere();
