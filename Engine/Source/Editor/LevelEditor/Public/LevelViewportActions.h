...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	/** Allows this viewport to flip the Constrained Aspect Ratio in Preview */
	TSharedPtr< FUICommandInfo > ToggleFlipConstrainedAspectRatioInPreview;
	...
	/** Enable editor shortcuts when PIE is active */
	TSharedPtr< FUICommandInfo > EnableEditorShortcutsInPIE;
