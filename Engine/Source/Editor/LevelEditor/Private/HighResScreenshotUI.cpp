...
void SHighResScreenshotDialog::Construct( const FArguments& InArgs )
{
	...
	constexpr float WindowBorderPadding = 16.f;
		...
		[
		    ...
		    [
		    	...
		    	[
		    	    ...
		    	    [
		    	    	...
		    	    	.Visibility(this, &SHighResScreenshotDialog::GetCaptureWarningVisibility)
		    	    ]
		    ...
		    [
		    	...
		    	[
		    		...
		    		.ToolTipText(NSLOCTEXT("HighResScreenshot", "OpenScreenshotFolderToolTip", "Open the screenshot folder in the file explorer") )
		    		.OnClicked(this, &SHighResScreenshotDialog::OnOpenScreenshotFolder)
		    		.Text(NSLOCTEXT("HighResScreenshot", "OpenScreenshotFolder", "Open Screenshot Folder"))
		    	]
		    	...
		    	[
		    		...
		    		.ToolTipText(NSLOCTEXT("HighResScreenshot", "ScreenshotCaptureToolTip", "Take a screenshot"))
...
EVisibility SHighResScreenshotDialog::GetCaptureWarningVisibility() const
{
	return Config.ResolutionMultiplier >= 3. ? EVisibility::Visible : EVisibility::Collapsed;
}

FReply SHighResScreenshotDialog::OnOpenScreenshotFolder()
{
	const FString PathToScreenshotFolder = FPaths::ConvertRelativePathToFull(FPaths::ScreenShotDir());

	// Before navigating to folder, check if it exists and create it if not
	IPlatformFile& PlatformFile = FPlatformFileManager::Get().GetPlatformFile();
	if (!PlatformFile.DirectoryExists(*PathToScreenshotFolder))
	{
		PlatformFile.CreateDirectoryTree(*PathToScreenshotFolder);
	}

	// Navigate to folder in explorer
	FPlatformProcess::ExploreFolder(*PathToScreenshotFolder);
