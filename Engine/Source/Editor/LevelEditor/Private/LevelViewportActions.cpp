...
void FLevelViewportCommands::RegisterCommands()
{
	...
	UI_COMMAND( ToggleFlipConstrainedAspectRatioInPreview, "Flip Constrained Aspect Ratio Preview", "Flip the Constrained Aspect Ratio in Preview", EUserInterfaceActionType::ToggleButton, FInputChord() );
	...
	UI_COMMAND( EnableEditorShortcutsInPIE, "Enable editor keyboard shortcuts", "Enable editor keyboard shortcuts when PIE is active", EUserInterfaceActionType::ToggleButton, FInputChord() );
