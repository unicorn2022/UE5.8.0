...
struct FDataLayerCreationParameters
{
	...
	// Required if bIsPrivate is false. Will assign the asset to the created instance.
...
public:
	 ...
	 *	Destructor
	 */
	virtual ~UDataLayerEditorSubsystem() = default;
	...
	UE_DEPRECATED(all, "Use IsActorValidForDataLayerInstances instead.")
	UFUNCTION(meta = (DeprecatedFunction, DeprecationMessage = "Use IsActorValidForDataLayerInstances instead."))
	bool IsActorValidForDataLayer(AActor* Actor) { return false; }
	...
	*/
	UE_DEPRECATED(5.8, "Deprecated data layers should have been removed by now.")
	bool HasDeprecatedDataLayers() const { return false; }
	...
	/** Returns whether the actor handle passes the data layers filter. */
	...
	UE_DEPRECATED(all, "Per-view Data Layer visibility was removed.")
	...
	UE_DEPRECATED(all, "Use SetDataLayerIsLoadedInEditor() instead.")
	...
	UE_DEPRECATED(all, "Use SetDataLayersIsLoadedInEditor() instead.")
	...
	UE_DEPRECATED(all, "Use ToggleDataLayerIsLoadedInEditor() instead.")
	...
	UE_DEPRECATED(all, "Use ToggleDataLayersIsLoadedInEditor() instead.")
	...
	UE_DEPRECATED(all, "Use GetDataLayerInstance instead")
	UFUNCTION(meta = (DeprecatedFunction, DeprecationMessage = "Use GetDataLayerInstance instead"))
	UDataLayerInstance* GetDataLayer(const struct FActorDataLayer& ActorDataLayer) const { return nullptr; }

	PRAGMA_ENABLE_DEPRECATION_WARNINGS

	UE_DEPRECATED(all, "Use GetDataLayerInstance instead")
	UFUNCTION(meta = (DeprecatedFunction, DeprecationMessage = "Use GetDataLayerInstance instead"))
	UDataLayerInstance* GetDataLayerFromLabel(const FName& DataLayerLabel) const { return nullptr; }

	UE_DEPRECATED(all, "Renaming is not permitted anymore")
	UFUNCTION(meta = (DeprecatedFunction, DeprecationMessage = "Renaming is not permitted anymore"))
	bool RenameDataLayer(UDataLayerInstance* DataLayer, const FName& NewDataLayerLabel) { return false; }

	UE_DEPRECATED(all, "Use CreateDataLayerInstance with FDataLayerCreationParameters instead")
	UFUNCTION(meta = (DeprecatedFunction, DeprecationMessage = "Use CreateDataLayerInstance with FDataLayerCreationParameters instead"))
