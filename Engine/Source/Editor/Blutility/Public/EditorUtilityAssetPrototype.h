...
public:
	...
	UE_API bool IsLatestVersion() const;
	bool AreSupportedClassesForBlueprints() const;
	UE_API TArray<TSoftClassPtr<UObject>> GetSupportedClasses() const;
	TArray<FAssetActionSupportCondition> GetAssetActionSupportConditions() const;
	UE_API TArray<FBlutilityFunctionData> GetCallableFunctions() const;
