...
public:
	...
	TSharedPtr<FUICommandInfo> SortAllNodes;
	...
	TSharedPtr<FUICommandInfo> ToggleShowTransportControls;
	...
	TSharedPtr<FUICommandInfo> AddKeyToSelectedCurves;
	TSharedPtr<FUICommandInfo> ResetKeysToDefaultValues;
