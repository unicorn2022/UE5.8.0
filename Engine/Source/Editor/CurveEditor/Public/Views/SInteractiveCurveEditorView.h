...
private:
	...
	UE_API void AddKeyAtScrubTime(bool bUseSelection);
	UE_DEPRECATED(5.8, "Please, use AddKeyAtScrubTime that takes bUseSelection parameter")
	void AddKeyAtScrubTime(TSet<FCurveModelID> ForCurves) { AddKeyAtScrubTime(ForCurves.Num() > 0); }
	...
	UE_API void ResetKeysToDefaultValues(bool bUseSelection);
