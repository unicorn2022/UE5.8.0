...
DECLARE_MULTICAST_DELEGATE(FOnCurveEditorExpandAllNodes);
DECLARE_MULTICAST_DELEGATE(FOnCurveEditorCollapseAllNodes);
...
public:
	...
	UE_DEPRECATED(5.8, "Use FCurveTreeItemSortPredicate instead.")
	...
	/** Returns whether ItemA < ItemB. */
	DECLARE_DELEGATE_RetVal_TwoParams(bool, FCurveTreeItemSortPredicate, const FCurveEditorTreeItem& /* ItemA */, const FCurveEditorTreeItem& /* ItemB */);
	...
	/** Sets a predicate which will be used to sort tree items after they're been marked as needing sort. */
	UE_API void SetSortPredicate(FCurveTreeItemSortPredicate InSortPredicate);
	...
	FOnCurveEditorExpandAllNodes& GetOnExpandAllNodes()
	{
		return ExpandAllNodesDelegate;
	}

	FOnCurveEditorCollapseAllNodes& GetOnCollapseAllNodes()
	{
		return CollapseAllNodesDelegate;
	}
...
private:
	...
	FCurveTreeItemSortPredicate SortPredicate;

	/** Delegate for when toggle expansion state is invoked */
	FOnCurveEditorToggleExpansionState ToggleExpansionStateDelegate;

	/** Delegates for expand/collapse all */
	FOnCurveEditorExpandAllNodes ExpandAllNodesDelegate;
	FOnCurveEditorCollapseAllNodes CollapseAllNodesDelegate;
