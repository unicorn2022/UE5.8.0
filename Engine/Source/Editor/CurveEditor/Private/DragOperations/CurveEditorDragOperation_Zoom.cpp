...
double FCurveEditorDragOperation_Zoom::GetZoomMultiplier_InputAxis(double InMovedMouseX) const
{
	...
	UE_CLOGF(CVarLogHorizontalZoomMultipliers.GetValueOnAnyThread(), LogCurveEditor, Log, "Horizontal Zoom: X: %f, Factor: %f", InMovedMouseX, Factor);
	return Factor;
}
...
double FCurveEditorDragOperation_Zoom::GetZoomMultiplier_OutputAxis(double InMovedMouseY) const
{
	...
	UE_CLOGF(CVarLogVerticalZoomMultipliers.GetValueOnAnyThread(), LogCurveEditor, Log, "Vertical Zoom: X: %f, Factor: %f", InMovedMouseY, Factor);
	return Factor;
}