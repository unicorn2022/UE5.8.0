...
void FCurveEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND(ExpandAllNodes, "Expand All Nodes", "Expand all nodes in the curve editor", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(CollapseAllNodes, "Collapse All Nodes", "Collapse all nodes in the curve editor", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(SortAllNodes, "Sort Nodes", "Sort all nodes in the curve editor", EUserInterfaceActionType::Button, FInputChord());
	...
	UI_COMMAND(ToggleShowTransportControls, "Transport Controls", "Show transport controls (only used if the transport controls are not popped out)", EUserInterfaceActionType::ToggleButton, FInputChord());
	UI_COMMAND(ToggleShowBars, "Bars", "Show Bars like Constraints and Spaces", EUserInterfaceActionType::ToggleButton, FInputChord());
	UI_COMMAND(ToggleShowValueIndicatorLines, "Value Indicators", "Show horizontal, dotted lines on the selected min & max valued key handles", EUserInterfaceActionType::ToggleButton, FInputChord());
	...
	UI_COMMAND(AddKeyToSelectedCurves, "Add Key to Selected Curves", "Add a new key to all curves that have selected keys at the current time.", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(ResetKeysToDefaultValues, "Reset to Default", "Reset selected keys to their default value", EUserInterfaceActionType::Button, FInputChord());
