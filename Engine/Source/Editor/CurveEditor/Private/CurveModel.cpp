...
UObject* FCurveModel::GetOwningObjectOrOuter(UClass* Class) const
{
	...
	return Obj ? Obj->GetTypedOuter(Class) : nullptr;
}
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE(FCurveModel::PutKeys)
