...
public:
	...
	virtual void StartupModule() override
	{
		if (GIsEditor)
		{
			...
			{
				FCoreDelegates::GetOnPostEngineInit().AddRaw(this, &FCurveEditorModule::RegisterCommands);
			}
		}
	...
	{
		UE::CurveEditor::InputState::Shutdown();
...
private:
	...
	void RegisterCommands()
	{
		...
		UE::CurveEditor::InputState::Initialize();
	}
};
