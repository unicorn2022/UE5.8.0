...
class FSequencerTextFilterExpression_Deactivated : public FSequencerTextFilterExpressionContext
{
public:
	FSequencerTextFilterExpression_Deactivated(ISequencerTrackFilters& InFilterInterface);
