...
class FSequencerTextFilterExpression_Filters : public FSequencerTextFilterExpressionContext
{
public:
	FSequencerTextFilterExpression_Filters(ISequencerTrackFilters& InFilterInterface);
