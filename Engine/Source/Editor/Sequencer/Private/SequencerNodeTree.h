...
public:
	...
	/** Schedules an update of the Sequencer outliner filter bar. */
	void RequestFilterUpdate();

	/** @return Whether any filter bar needs to be filtered. */
	...
	/** @return  */
	const TSharedRef<UE::Sequencer::FFilterEvaluator>& GetFilterEvaluator() const { return FilterEvaluator; }
...
private:
	...
	/** Knows about all filter bars that are dirty and handles evaluating them. */
	const TSharedRef<UE::Sequencer::FFilterEvaluator> FilterEvaluator;
