...
public:
	...
	virtual TSharedPtr<UE::Sequencer::FViewModel> GetDragOwnerTrackModel() const override;
...
protected:
	...
	TArray<UE::Sequencer::FInitialRowIndex> InitialSectionRowIndicies;
	...
	/** Cached drag owner track model (computed in AddModel) */
	TWeakPtr<UE::Sequencer::FViewModel> CachedDragOwnerTrackModel;
