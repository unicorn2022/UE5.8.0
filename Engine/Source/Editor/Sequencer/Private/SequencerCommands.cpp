...
void FSequencerCommands::RegisterCommands()
{
	...
	UI_COMMAND( ResetViewRange, "Reset View Range", "Reset view range to the playback range", EUserInterfaceActionType::Button, FInputChord(EKeys::A) );
	UI_COMMAND( ZoomToFit, "Zoom to Fit", "Zoom to Fit", EUserInterfaceActionType::Button, FInputChord(EKeys::F) );
	UI_COMMAND( ZoomToFitSelectionRange, "Focus Selection Range", "Zoom the view to fit the selection range, or the full time bounds if no selection range is set.", EUserInterfaceActionType::Button, FInputChord() );
	...
	UI_COMMAND( NavigateBackward, "Navigate Backward", "Go backward to the previously viewed shot/subsequence", EUserInterfaceActionType::Button, FInputChord(EKeys::ThumbMouseButton), FInputChord(EModifierKey::Alt, EKeys::Left));
	UI_COMMAND( NavigateForward, "Navigate Forward", "Go forward to the previously viewed shot/subsequence", EUserInterfaceActionType::Button, FInputChord(EKeys::ThumbMouseButton2), FInputChord(EModifierKey::Alt, EKeys::Right));
	...
	UI_COMMAND( SetPlayheadScrubbingLimitNone, "None", "While scrubbing, don't restrict the playhead to any range", EUserInterfaceActionType::RadioButton, FInputChord() );
	UI_COMMAND( SetPlayheadScrubbingLimitPlaybackRange, "Playback Range", "While scrubbing, restrict the playhead to the playback range", EUserInterfaceActionType::RadioButton, FInputChord() );
	UI_COMMAND( SetPlayheadScrubbingLimitSelectionRange, "Selection Range", "While scrubbing, restrict the playhead to the selection range", EUserInterfaceActionType::RadioButton, FInputChord() );
	...
	UI_COMMAND( ToggleAutoExpandCurveEditorOnSelection, "Auto Expand Curve Editor on Selection", "Toggles whether selecting items in Sequencer's Outliner will expand Curve Editor's tree view to show the item.", EUserInterfaceActionType::ToggleButton, FInputChord());
	...
	UI_COMMAND( SelectMarkersInSelectionRange, "Select Markers in Selection Range", "Select all markers that fall into the selection range", EUserInterfaceActionType::Button, FInputChord() );
	...
	UI_COMMAND( SelectForward, "Select All Keys, Sections and Markers Forward", "Select all keys, sections and markers forward from the current time", EUserInterfaceActionType::Button, FInputChord(EModifierKey::Control, EKeys::RightBracket) );
	UI_COMMAND( SelectBackward, "Select All Keys, Sections and Markers Backward", "Select all keys, sections and markers backward from the current time", EUserInterfaceActionType::Button, FInputChord(EModifierKey::Control, EKeys::LeftBracket) );
	...
	UI_COMMAND( AddSelectionFromContentBrowser, "Selection from Content Browser", "Add selected content from the content browser", EUserInterfaceActionType::Button, FInputChord());
	...
	UI_COMMAND( ToggleShowMarkedFrames, "Marked Frames", "Show marked frames.", EUserInterfaceActionType::ToggleButton, FInputChord());
	...
	UI_COMMAND( ToggleShowMarkedFramesGlobally, "Marked Frames Globally", "Makes marked frames in this sub-sequence visible in parent/sibling sequences for the current editor session.", EUserInterfaceActionType::ToggleButton, FInputChord() );
	...
	UI_COMMAND( ToggleShowTransportControl, "Transport Controls", "Enables and disables showing the transport controls panel", EUserInterfaceActionType::ToggleButton, FInputChord());
	UI_COMMAND( ToggleTransportControlsPoppedOut, "Popout Transport Controls", "Toggles the popped out state of the transport controls panel", EUserInterfaceActionType::ToggleButton, FInputChord());
	...
	UI_COMMAND( ToggleShowBottomTimeSlider, "Bottom Time Slider", "Enables and disables showing the bottom time slider", EUserInterfaceActionType::ToggleButton, FInputChord());
	...
	UI_COMMAND(DeleteTransformKey, "Delete Transform Key", "Delete the transform key at the current time for the selected actor.", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(DeleteTranslationKey, "Delete Translation Key", "Delete the translation key at the current time for the selected actor.", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(DeleteRotationKey, "Delete Rotation Key", "Delete the rotation key at the current time for the selected actor.", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(DeleteScaleKey, "Delete Scale Key", "Delete the scale key at the current time for the selected actor.", EUserInterfaceActionType::Button, FInputChord());
	...
	UI_COMMAND(ToggleSelectionDetailsPoppedOut, "Popout Selection Details", "Toggles the state of the Sequencer selection details between docked in the Sequencer tab and being popped out to its own tab window", EUserInterfaceActionType::ToggleButton, FInputChord());
	...
	UI_COMMAND(ToggleToolBarVisible, "Toggle Tool Bar Visible", "Toggle between the toolbar panel being visible and hidden", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(ToggleTransportPanelVisible, "Toggle Transport Panel Visible", "Toggle between the transport controls panel being visible and hidden", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(ToggleTransportPanelDocked, "Toggle Transport Panel Docked", "Toggle between the transport controls panel being docked within its inline content or undocked in its own tab window", EUserInterfaceActionType::Button, FInputChord());

	UI_COMMAND(ToggleSimpleView, "Toggle Simple/Full View", "Toggle between Sequencer simplified view and full views", EUserInterfaceActionType::Button, FInputChord(EModifierKey::Control, EKeys::BackSpace))
}
