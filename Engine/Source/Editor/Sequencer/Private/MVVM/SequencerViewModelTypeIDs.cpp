...
UE_SEQUENCER_DEFINE_VIEW_MODEL_TYPE_ID(ITrackRowExtension);
UE_SEQUENCER_DEFINE_VIEW_MODEL_TYPE_ID(ISectionOwnerExtension);
UE_SEQUENCER_DEFINE_VIEW_MODEL_TYPE_ID(ITopLevelChannelHolderExtension);
UE_SEQUENCER_DEFINE_VIEW_MODEL_TYPE_ID(IConditionableExtension);
UE_SEQUENCER_DEFINE_VIEW_MODEL_TYPE_ID(IClockExtension);
UE_SEQUENCER_DEFINE_VIEW_MODEL_TYPE_ID(ISectionDragOwnerExtension);
...
UE_SEQUENCER_DEFINE_VIEW_MODEL_TYPE_ID(FDecorationModelStorageExtension);
