...
{
	TViewModelPtr<IObjectModelExtension> ObjectToDetach;
	...
	if (ObjectToDetach)
	{
		ObjectToDetach.AsModel()->RemoveFromParent();
	}
}
...
{
	TSharedPtr<FSequencerEditorViewModel> SequencerEditorViewModel = WeakEditor.Pin();
	if (SequencerEditorViewModel)
	{	
		return SequencerEditorViewModel->GetSequencer();
	}
...
TSharedPtr<FSequencer> FSequenceModel::GetSequencerImpl() const
{
	...
	if (SequencerEditorViewModel)
	{
		return SequencerEditorViewModel->GetSequencerImpl();
	}
...
void FSequenceModel::OnModifiedIndirectly(UMovieSceneSignedObject*)
{
	...
	TSharedPtr<ISequencer> Sequencer = SequencerEditorViewModel->GetSequencer();
