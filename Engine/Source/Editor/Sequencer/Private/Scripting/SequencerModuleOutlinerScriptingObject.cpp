...
FFrameNumber USequencerModuleOutlinerScriptingObject::GetNextKey(const TArray<FSequencerViewModelScriptingStruct>& InNodes, FFrameNumber FrameNumber, EMovieSceneTimeUnit TimeUnit, const bool bAllowLoop) const
{
	using namespace UE::Sequencer;
	...
	return Outliner->GetNextKey(Nodes, FrameNumber, TimeUnit, Range, bAllowLoop);
}

FFrameNumber USequencerModuleOutlinerScriptingObject::GetPreviousKey(const TArray<FSequencerViewModelScriptingStruct>& InNodes, FFrameNumber FrameNumber, EMovieSceneTimeUnit TimeUnit, const bool bAllowLoop) const
{
	using namespace UE::Sequencer;
	...
	return Outliner->GetPreviousKey(Nodes, FrameNumber, TimeUnit, Range, bAllowLoop);
}
