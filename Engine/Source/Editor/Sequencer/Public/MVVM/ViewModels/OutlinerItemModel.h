...
public:
	...
	UE_API void SetPinned(const bool bInIsPinned) override;

	DECLARE_MULTICAST_DELEGATE_TwoParams(FOnPinStateChanged, const TViewModelPtr<IPinnableExtension>& /*InPinnableExtension*/, const bool /*bInPinned*/)
	/** Delegate that fires when the pin state of this item changes */
	static UE_API FOnPinStateChanged& OnPinStateChanged() { return PinStateChangedDelegate; }
...
private:
	...
	static FOnPinStateChanged PinStateChangedDelegate;
};
