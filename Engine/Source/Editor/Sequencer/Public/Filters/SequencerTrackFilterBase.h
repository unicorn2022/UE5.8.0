...
public:
	...
	/** Evaluates the filter on an item. It allows returning more information to optimize evaluation. */
	SEQUENCER_API virtual UE::Sequencer::FFilterResult Evaluate(FSequencerTrackFilterType InItem) const;
