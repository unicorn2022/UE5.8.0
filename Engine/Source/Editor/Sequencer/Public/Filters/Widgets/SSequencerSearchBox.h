...
private:
	...
	/** Updates the widget search text when the filter changes (@see ISequencerFilterBar::OnTextFilterTextChanged). */
	void OnFilterTextChanged();
	/** Calls SetEnabled when the mute state changes (@see ISequencerFilterBar::OnMuteStateChanged). */
	void OnMuteStateChanged(bool bIsMuted);
