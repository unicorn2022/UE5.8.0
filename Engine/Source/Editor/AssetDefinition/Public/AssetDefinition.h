...
struct EAssetCategoryPaths
{
	...
	static UE_API FAssetCategoryPath Data;
...
DECLARE_DELEGATE_RetVal(bool, FIsActionPlaying)
struct FAssetActionThumbnailOverlayInfo
{
public:
	UE_DEPRECATED(5.8, "Please use the IsActionPlayingDelegate instead.")
	/** Image widget displayed in the top left border */
	TSharedPtr<SWidget> ActionImageWidget;

	/** Attach your IsPlaying action to this delegate that will be used to decide on the action image to use */
	FIsActionPlaying IsActionPlayingDelegate;
...
public:
	...
	virtual FText GetAssetDisplayName() const PURE_VIRTUAL(UAssetDefinition::GetAssetDisplayName, (void)ensureMsgf(false && "NotImplemented", TEXT("NotImplemented")); return FText(); );
	...
	virtual TSoftClassPtr<UObject> GetAssetClass() const PURE_VIRTUAL(UAssetDefinition::GetAssetClass, (void)ensureMsgf(false && "NotImplemented", TEXT("NotImplemented")); return TSoftClassPtr<UClass>(); );

	/** Returns the color associated with this type */
	virtual FLinearColor GetAssetColor() const PURE_VIRTUAL(UAssetDefinition::GetAssetColor, (void)ensureMsgf(false && "NotImplemented", TEXT("NotImplemented")); return FColor::Red; );
...
public:
	...
	virtual EAssetCommandResult OpenAssets(const FAssetOpenArgs& OpenArgs) const PURE_VIRTUAL(UAssetDefinition::OpenAsset, (void)ensureMsgf(false && "NotImplemented", TEXT("NotImplemented")); return EAssetCommandResult::Unhandled; );
