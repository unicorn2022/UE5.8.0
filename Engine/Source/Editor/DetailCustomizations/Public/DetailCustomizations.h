...
public:
	 ...
	 */
	void DETAILCUSTOMIZATIONS_API RegisterDevelopmentStatusWarningSuppression(FName ClassName);
	/**
	 * Removes suppression of DevelopmentStatus warnings for the given class or any derived versions of this class
	 */
	void DETAILCUSTOMIZATIONS_API UnregisterDevelopmentStatusWarningSuppression(FName ClassName);

	bool IsDevelopmentStatusWarningSuppressed(const UClass* Class) const;
