...
public:
	...
	UE_API virtual ~FColorStructCustomization() override;

protected:

	FColorStructCustomization()
		: bIsLinearColor(false)
		, bIgnoreAlpha(false)
		, bIsInlineColorPickerVisible(false)
		, bIsInteractive(false)
		, bIsInBlueprint(false)
...
protected:
	...
	/** True if the property we are editing is contained within a blueprint */
	bool bIsInBlueprint;
