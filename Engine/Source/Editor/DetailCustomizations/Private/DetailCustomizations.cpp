...
void FDetailCustomizationsModule::RegisterDevelopmentStatusWarningSuppression(FName ClassName)
{
	SuppressedDevelopmentStatusWarnings.Add(ClassName);
}

void FDetailCustomizationsModule::UnregisterDevelopmentStatusWarningSuppression(FName ClassName)
{
	SuppressedDevelopmentStatusWarnings.Remove(ClassName);
}

bool FDetailCustomizationsModule::IsDevelopmentStatusWarningSuppressed(const UClass* Class) const
{
...
void FDetailCustomizationsModule::RegisterPropertyTypeCustomizations()
{
	...
	RegisterCustomPropertyTypeLayout("SubScriptStructOf", FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FSubScriptStructOfCustomization::MakeInstance));
	...
	RegisterCustomPropertyTypeLayout("LinearColorRamp", FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FLinearColorRampCustomization::MakeInstance));
	...
	RegisterCustomPropertyTypeLayout("SoundSubmixSendInfo", FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FSoundSubmixSendFilterCustomization::MakeInstance));
	RegisterCustomPropertyTypeLayout("SoundSourceBusSendInfo", FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FSoundSubmixSendFilterCustomization::MakeInstance));
	RegisterCustomPropertyTypeLayout("AttenuationSubmixSendSettings", FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FSoundSubmixSendFilterCustomization::MakeInstance));
	...
	RegisterCustomPropertyTypeLayout("ColorGradingSettings", FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FColorGradingSettingsCustomization::MakeInstance));
...
void FDetailCustomizationsModule::RegisterObjectCustomizations()
{
	...
	RegisterCustomClassLayout("ReflectionCaptureComponent", FOnGetDetailCustomizationInstance::CreateStatic(&FReflectionCaptureDetails::MakeInstance));
	...
	RegisterCustomClassLayout("TextureCubeArray", FOnGetDetailCustomizationInstance::CreateStatic(&FTextureCubeArrayDetails::MakeInstance));
	...
	RegisterCustomClassLayout("StereoLayerComponent", FOnGetDetailCustomizationInstance::CreateStatic(&FStereoLayerComponentCustomization::MakeInstance));
}
