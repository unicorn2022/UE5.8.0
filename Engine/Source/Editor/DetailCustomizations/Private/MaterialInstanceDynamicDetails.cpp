...
void FMaterialInstanceDynamicDetails::CustomizeDetails(IDetailLayoutBuilder& DetailLayout)
{
	...
	TSharedRef<IPropertyHandle> OverrideToonProfileHandle = DetailLayout.GetProperty(GET_MEMBER_NAME_CHECKED(UMaterialInstance, bOverrideToonProfile), UMaterialInstance::StaticClass());
	OverrideToonProfileHandle->MarkHiddenByCustomization();
