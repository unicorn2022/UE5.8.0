...
void FPhysicsConstraintComponentDetails::AddAngularDrive(IDetailLayoutBuilder& DetailBuilder, TSharedPtr<IPropertyHandle> ConstraintInstance, TSharedPtr<IPropertyHandle> ProfilePropertiesProperty)
{
	...
	TSharedPtr<IPropertyHandle> LimitViolationResponseProperty = AngularDriveProperty->GetChildHandle(GET_MEMBER_NAME_CHECKED(FAngularDriveConstraint, LimitViolationResponse));
	...
	AngularMotorCat.AddProperty(LimitViolationResponseProperty);
