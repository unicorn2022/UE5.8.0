...
private:
	...
	// Redirects the found actor to a BP preview actor to be able to choose components in a BP editor context
	bool RedirectActorToBPPreviewActor(TWeakObjectPtr<AActor>& InOutActor, UWorld*& OutWorld) const;

	// Gets (or updates) the cached component
	UActorComponent* GetCachedComponent() const;
...
private:
	...
	TWeakObjectPtr<AActor> CachedFilterActor;
