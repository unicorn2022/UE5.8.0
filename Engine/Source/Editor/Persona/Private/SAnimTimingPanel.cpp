...
void SAnimTimingNode::Construct(const FArguments& InArgs)
{
	...
	{
		case ENotifyTimingElementType::QueuedNotify:
		case ENotifyTimingElementType::NotifyStateBegin:
		case ENotifyTimingElementType::NotifyStateEnd:
		{
			NodeColour = EditorOptions->NotifyTimingNodeColor;
			break;
		}
		case ENotifyTimingElementType::BranchPointNotify:
		{
			NodeColour = EditorOptions->BranchingPointTimingNodeColor;
			break;
		}
		case ENotifyTimingElementType::Section:
		{
...
bool SAnimTimingPanel::IsElementDisplayEnabled(ENotifyTimingElementType::Type ElementType) const
{
	return WeakModel.Pin()->IsTimingElementDisplayEnabled(ElementType);
}

void SAnimTimingPanel::OnElementDisplayEnabledChanged(ENotifyTimingElementType::Type ElementType)
{
	WeakModel.Pin()->ToggleTimingElementDisplayEnabled(ElementType);
	Update();
}

ECheckBoxState SAnimTimingPanel::IsElementDisplayChecked(ENotifyTimingElementType::Type ElementType) const
{
	return WeakModel.Pin()->IsTimingElementDisplayEnabled(ElementType) ? ECheckBoxState::Checked : ECheckBoxState::Unchecked;
}

EVisibility SAnimTimingPanel::IsElementDisplayVisible(ENotifyTimingElementType::Type ElementType) const
{
...
ENotifyTimingElementType::Type FTimingRelevantElement_Section::GetType()
{
	return ENotifyTimingElementType::Section;
}
...
ENotifyTimingElementType::Type FTimingRelevantElement_Notify::GetType()
{
	check(Sequence);
	if(Sequence->Notifies.IsValidIndex(NotifyIndex))
	{
		...
		{
			return ENotifyTimingElementType::BranchPointNotify;
		}
		else
		{
			if(Event.NotifyStateClass)
			{
				return ENotifyTimingElementType::NotifyStateBegin;
			}
			else
			{
				return ENotifyTimingElementType::QueuedNotify;
			}
		}
	}
...
ENotifyTimingElementType::Type FTimingRelevantElement_NotifyStateEnd::GetType()
{
	return ENotifyTimingElementType::NotifyStateEnd;
}
