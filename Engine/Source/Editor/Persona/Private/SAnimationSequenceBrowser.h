...
#include "SAnimationSequenceBrowser.generated.h"
...
UENUM()
enum class EAdditiveTypeFilterMode : uint8
{
	NonAdditive UMETA(DisplayName = "Non-Additive"),
	AnyAdditive UMETA(DisplayName = "Any Additive"),
	LocalSpaceBase UMETA(DisplayName = "Local Space"),
	RotationOffsetMeshSpace UMETA(DisplayName = "Mesh Space"),
};
