 ...
 */
class UE_API FAnimViewportShowCommands : public TCommands<FAnimViewportShowCommands>
{
public:
	...
	// Silence clang deprecation warnings for implicit default copy operator and constructor
	PRAGMA_DISABLE_DEPRECATION_WARNINGS
	~FAnimViewportShowCommands() = default;
	FAnimViewportShowCommands(const FAnimViewportShowCommands&) = delete;
	FAnimViewportShowCommands& operator=(const FAnimViewportShowCommands&) = delete;
	FAnimViewportShowCommands(FAnimViewportShowCommands&&) = delete;
	FAnimViewportShowCommands& operator=(FAnimViewportShowCommands&&) = delete;
	...
	/** Toggles showing all bones */
	TSharedPtr< FUICommandInfo > ToggleShowBoneDrawAll;
	...
	*/
	UE_DEPRECATED(5.8, "This functionality has been deprecated")
