...
public:
	...
	virtual ~FSkeletalMeshReductionSettingsLayout() = default;
...
public:
	...
	virtual ~FSkeletalMeshBuildSettingsLayout() = default;
...
private:
	...
	ECheckBoxState ShouldOptimizeForInstancing() const;
	...
	void OnOptimizeForInstancingChanged(ECheckBoxState NewState);
