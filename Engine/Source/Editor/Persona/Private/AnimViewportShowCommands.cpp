...
void FAnimViewportShowCommands::RegisterCommands()
{
	...
	UI_COMMAND( ToggleShowBoneDrawAll, "Bones", "When enabled displays all bones, otherwise none", EUserInterfaceActionType::ToggleButton, FInputChord(EModifierKey::Shift, EKeys::B));
