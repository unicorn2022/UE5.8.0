...
IPersonaEditorModeManager::IPersonaEditorModeManager()
{
	...
	// Support legacy USelections
	ActorSet->SetElementSelectionSet(SelectionSet);
	ComponentSet->SetElementSelectionSet(SelectionSet);
	ObjectSet->SetElementSelectionSet(SelectionSet);
}
...
UTypedElementSelectionSet* IPersonaEditorModeManager::GetEditorSelectionSet() const
{
