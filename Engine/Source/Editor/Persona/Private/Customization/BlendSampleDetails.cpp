...
void FBlendSampleDetails::CustomizeDetails(class IDetailLayoutBuilder& DetailBuilder)
{
	...
	if(BlendspaceToUse->IsAsset())
	{
		...
		TSharedPtr<IPropertyHandle> MirrorProperty = DetailBuilder.GetProperty(
			GET_MEMBER_NAME_CHECKED(FBlendSample, bMirror), FBlendSample::StaticStruct());
		IDetailPropertyRow& MirrorPropertyRow = CategoryBuilder.AddProperty(MirrorProperty);
	...
	else
	{
		...
		TSharedPtr<IPropertyHandle> MirrorProperty = DetailBuilder.GetProperty(GET_MEMBER_NAME_CHECKED(FBlendSample, bMirror), FBlendSample::StaticStruct());
		IDetailPropertyRow& MirrorPropertyRow = CategoryBuilder.AddProperty(MirrorProperty);
