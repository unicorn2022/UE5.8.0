...
public:
	...
	bool IsTimingElementDisplayEnabled(ENotifyTimingElementType::Type ElementType) const;
	void ToggleTimingElementDisplayEnabled(ENotifyTimingElementType::Type ElementType);
...
private:
	...
	bool TimingElementNodeDisplayFlags[ENotifyTimingElementType::Max];
