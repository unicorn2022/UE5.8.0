...
bool FAnimModel_AnimMontage::IsTimingElementDisplayEnabled(ENotifyTimingElementType::Type ElementType) const
{
	return TimingElementNodeDisplayFlags[ElementType];
}

void FAnimModel_AnimMontage::ToggleTimingElementDisplayEnabled(ENotifyTimingElementType::Type ElementType)
{
