...
struct FTimingRelevantElement_Notify : public FTimingRelevantElementBase
{
	...
	virtual ENotifyTimingElementType::Type GetType() override;
...
DECLARE_DELEGATE_RetVal_OneParam(EVisibility, FOnGetTimingNodeVisibility, ENotifyTimingElementType::Type)
...
public:
	...
	bool IsElementDisplayEnabled(ENotifyTimingElementType::Type ElementType) const;
	ECheckBoxState IsElementDisplayChecked(ENotifyTimingElementType::Type ElementType) const;
	EVisibility IsElementDisplayVisible(ENotifyTimingElementType::Type ElementType) const;

	// Callback from slate when element display flag changes
	// @param ElementType - Flag to set
	void OnElementDisplayEnabledChanged(ENotifyTimingElementType::Type ElementType);
