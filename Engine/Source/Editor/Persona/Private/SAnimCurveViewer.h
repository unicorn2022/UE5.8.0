...
private:
	...
	*/
	...
	/** If the values of the curve represented by this row can be edited */
...
private:
	...
	*/
	...
	/** Whatever this viewer is read only or allows editing of its values */
	bool bIsReadOnlyViewer = false;
