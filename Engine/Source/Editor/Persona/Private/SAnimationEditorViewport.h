...
private:
	...
	/** Toggles showing all bones when not all bones are shown, none otherwise */
	void ToggleShowAllBones();
...
public:
	...
	EAxis::Type GetBoneAsCameraAxis(FAnimationViewportClient::EDirection Direction) const;

	/** Sets the axis for a direction when using the Bone As Camera follow mode */
	void SetBoneAsCameraAxis(FAnimationViewportClient::EDirection Direction, EAxis::Type Axis);
	...
	/** Sets the forward axis for the Bone As Camera follow mode */
