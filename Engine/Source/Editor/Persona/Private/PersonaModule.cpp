...
void FPersonaModule::StartupModule()
{
	...
	// Call this to make sure MDTEditor module is setup
	FModuleManager::Get().LoadModuleChecked(TEXT("MirrorDataTableEditor"));
