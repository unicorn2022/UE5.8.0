...
public:
	...
	UE_API virtual void ReceivedFocus(FViewport* InViewport) override;
	UE_API virtual void LostFocus(FViewport* InViewport) override;
...
//	virtual bool CanSetWidgetMode(UE::Widget::EWidgetMode NewMode) const override;
	...
	/** Gets the axis for a direction when using the Bone As Camera follow mode */
	EAxis::Type GetBoneAsCameraAxis(EDirection Direction) const;

	/** Gets the position offset from the bone origin in world coordiantes for the Bone As Camera follow mode */
	UE::Math::TVector<double> GetBoneAsCameraPositionOffset() const;

	/** Gets the rotation offset from the bone in world coordiantes for the Bone As Camera follow mode */
	FRotator GetBoneAsCameraRotationOffset() const;

	/** Sets the axis for a direction when using the Bone As Camera follow mode */
	void SetBoneAsCameraAxis(EDirection Direction, EAxis::Type Axis);

	/** Sets the position offset from the bone origin in world coordiantes for the Bone As Camera follow mode */
	void SetBoneAsCameraPositionOffset(UE::Math::TVector<double> Offset);

	/** Sets the rotation offset from the bone in world coordiantes for the Bone As Camera follow mode */
	void SetBoneAsCameraRotationOffset(const FRotator& Offset);
...
private:
	...
	*/
	...
	/** The forward axis to use when in EAnimationViewportCameraFollowMode::BoneAsCamera */
	EAxis::Type BoneAsCameraForward = EAxis::Type::X;

	/** The right axis to use when in EAnimationViewportCameraFollowMode::BoneAsCamera */
	EAxis::Type BoneAsCameraRight = EAxis::Type::Y;

	/** The up axis to use when in EAnimationViewportCameraFollowMode::BoneAsCamera */
	EAxis::Type BoneAsCameraUp = EAxis::Type::Z;

	/** The position offset from the bone origin in world space to use when in EAnimationViewportCameraFollowMode::BoneAsCamera */
	UE::Math::TVector<double> BoneAsCameraPositionOffset = UE::Math::TVector<double>::ZeroVector;

	/** The rotation offset from the bone origin in world space to use when in EAnimationViewportCameraFollowMode::BoneAsCamera */
	FRotator BoneAsCameraRotationOffset = FRotator::ZeroRotator;
