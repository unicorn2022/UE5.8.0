...
/*
 * This is an Engine Subsystem that is selectively enabled using WITH_EDITOR so it is available in custom programs that run the editor with -game
 */
UCLASS(MinimalAPI)
class UMassEntityEditorSubsystem : public UEngineSubsystem
{
	GENERATED_BODY()
...
public:
	...
	UE_API static UMassEntityEditorSubsystem* Get();
