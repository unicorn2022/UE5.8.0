...
public:
	...
	virtual TSharedRef<FWorkspaceItem> GetLevelEditorMediaCategory() const override
	{
		return LevelEditorMediaCategory.ToSharedRef();
	}
	...
	void ResetLevelEditorCategory()
	{
		...
		LevelEditorMediaCategory = LevelEditorCategory->AddGroup("Media",
			LOCTEXT("WorkspaceMenu_LevelEditorMediaCategory", "Media"),
			LOCTEXT("WorkspaceMenu_LevelEditorMediaCategoryTooltip", "Open a Media tab."),
			FSlateIcon(FAppStyle::Get().GetStyleSetName(), "LevelEditor.Tabs.Media"), true);
...
private:
	...
	TSharedPtr<FWorkspaceItem> LevelEditorMediaCategory;
