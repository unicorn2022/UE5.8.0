...
void SSequencerTimeSlider::OnMouseEnter(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent)
{
	TimeSliderController->OnMouseEnter( *this, MyGeometry, MouseEvent );
}

void SSequencerTimeSlider::OnMouseLeave(const FPointerEvent& MouseEvent)
{
	TimeSliderController->OnMouseLeave( *this, MouseEvent );
}
...
void SSequencerTimeSlider::OnFocusLost(const FFocusEvent& InFocusEvent)
{
	TimeSliderController->OnFocusLost( *this, InFocusEvent );
}
