...
FContentBrowserItemDataUpdate FContentBrowserItemDataUpdate::MakeItemUnmountedUpdate(FContentBrowserItemData InItemData)
{
	FContentBrowserItemDataUpdate ItemUpdate;
	ItemUpdate.UpdateType = EContentBrowserItemUpdateType::Unmounted;
	ItemUpdate.ItemData = MoveTemp(InItemData);
	return ItemUpdate;
}
