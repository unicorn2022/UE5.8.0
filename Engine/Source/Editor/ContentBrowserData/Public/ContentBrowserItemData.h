...
enum class EContentBrowserItemUpdateType : uint8
{
	...
	Removed,
	/** This item existed and has been unmounted */
	Unmounted,
};
...
public:
	...
	/**
	 * Create an item update for when an item is unmounted.
	 */
	static UE_API FContentBrowserItemDataUpdate MakeItemUnmountedUpdate(FContentBrowserItemData InItemData);
