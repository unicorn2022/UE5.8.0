...
public:
	...
	/**
	 * Attempt to retrieve the source asset path of an alias.
	 * 
	 * @param OutObjectPath The soft object path to fill with the result
	 * @return True if @code this @endcode is an alias and a path was found, false otherwise
	 */
	UE_API bool GetItemAliasedPath(FSoftObjectPath& OutObjectPath) const;
