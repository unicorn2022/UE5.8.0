...
public:
	 ...
	 *
	 * @param InInternalPath The internal path (or object path) of an asset to get aliases for
	...
	/**
	 * Get the source asset path of an alias.
	 * 
	 * @param InItemData The content browser item of an alias
	 * @param OutObjectPath The soft object path to fill with the result
	 * @return True if @code InItemData @endcode is an alias and a path was found, false otherwise
	 */
	UE_API virtual bool GetItemAliasedPath(const FContentBrowserItemData& InItemData, FSoftObjectPath& OutObjectPath) const;
