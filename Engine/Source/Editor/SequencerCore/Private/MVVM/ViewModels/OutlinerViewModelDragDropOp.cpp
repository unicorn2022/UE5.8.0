...
void FOutlinerViewModelDragDropOp::GetTargetAndDropModel(const FViewModelPtr& CurrentViewModel, EItemDropZone InItemDropZone, FViewModelPtr& DropModel, FViewModelPtr& TargetModel) const
{
	DropModel = CurrentViewModel;
