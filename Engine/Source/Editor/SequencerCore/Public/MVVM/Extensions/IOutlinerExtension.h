...
public:
	...
	virtual ~IOutlinerExtension()= default;
	...
	/** Whether this outliner item supports the given column. Default is true for all columns.
	 *  Override to suppress specific columns (e.g. mute/solo on transition sections). */
	virtual bool SupportsOutlinerColumn(const FName& InColumnName) const { return true; }
...
public:
	...
	virtual ~IOutlinerDropTargetOutlinerExtension()= default;
...
public:
	...
	virtual ~ICompoundOutlinerExtension()= default;
