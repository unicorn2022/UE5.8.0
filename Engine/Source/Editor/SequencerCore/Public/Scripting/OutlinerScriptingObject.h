...
public:
	...
	// Expansion
	UFUNCTION(BlueprintCallable, Category = "Sequencer Editor")
	void SetExpansion(const TArray<FSequencerViewModelScriptingStruct>& InNodes, bool bExpanded);

	UFUNCTION(BlueprintPure, Category = "Sequencer Editor")
	bool IsExpanded(FSequencerViewModelScriptingStruct InNode) const;
