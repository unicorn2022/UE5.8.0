...
public:
	...
	/*
	 * CancelUpdate is called if a gizmo cancels a modification.
	 */
...
protected:
	/** Gets the current TransformMode, from the associated TransformGizmo (if available). */
	EGizmoTransformMode GetTransformMode() const;
