...
public:
	...
	virtual void StartupModule() override
	{
		...
		FEditorModeRegistry::Get().RegisterMode<FStaticMeshEditorEdMode>(FStaticMeshEditorEdMode::Id);
	...
	virtual void ShutdownModule() override
	{
		...
		{
			FEditorModeRegistry::Get().UnregisterMode(FStaticMeshEditorEdMode::Id);
		}
