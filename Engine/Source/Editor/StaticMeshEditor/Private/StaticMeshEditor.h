...
private:
	...
	virtual void OnBuildViewportInteractions(UViewportInteractionsBehaviorSource* Source) override;
...
public:
	...
	virtual const TArray<FPrimData>& GetSelectedPrims() const override;
	...
	virtual bool IsShowSimpleCollisionChecked() const override;
	virtual void ToggleShowSimpleCollision() override;
