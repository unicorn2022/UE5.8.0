...
class SStaticMeshLODVisualizerWidget;

enum class EStaticMeshEditorAspectRatio : int32
{
	EFree = 0,
	EPlatform = 1,
...
public:
	...
	void SetCurrentScreenPercentage(float ScreenPercentage);
	float GetScreenPercentageForLOD(int LODIndex);
	int32 GetCurrentMinimumLOD() const;
...
private:
	...
	void SetAspectRatioState(EStaticMeshEditorAspectRatio TestAspectRatio);

	bool IsAspectRatio(EStaticMeshEditorAspectRatio TestAspectRatio) const;
...
private:
	...
	/** Pointer to a LOD visualizer widget to display in the viewport */
	TSharedPtr<SStaticMeshLODVisualizerWidget> LODVisualizer;

	/** The current screen percentage occupied by the asset in the viewport */
	float CurrentScreenPercentage = 0.f;
	...
	/** Current aspect ratio the viewport is set to.*/
	EStaticMeshEditorAspectRatio CurrentAspectRatioMode = EStaticMeshEditorAspectRatio::EPlatform;
};
