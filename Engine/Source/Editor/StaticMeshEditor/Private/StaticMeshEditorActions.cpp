...
void FStaticMeshEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND(SetShowGrid, "Grid", "Displays the viewport grid.", EUserInterfaceActionType::ToggleButton, FInputChord(EKeys::G, EModifierKey::Alt | EModifierKey::Shift));
	...
	UI_COMMAND(SetAspectRatio_Free, "Unconstrained", "Sets the aspect ratio to be unconstrained.", EUserInterfaceActionType::RadioButton, FInputChord());
	UI_COMMAND(SetAspectRatio_Platform, "Platform", "Sets the aspect ratio to be controlled by the current preview platform, if any.", EUserInterfaceActionType::RadioButton, FInputChord());
	UI_COMMAND(SetAspectRatio_6_13, "6:13", "Sets the aspect ratio to be 6:13 (Mobile Portrait Orientation).", EUserInterfaceActionType::RadioButton, FInputChord());
	UI_COMMAND(SetAspectRatio_13_6, "13:6", "Sets the aspect ratio to be 6:13 (Mobile Landscape Orientation).", EUserInterfaceActionType::RadioButton, FInputChord());
	UI_COMMAND(SetAspectRatio_1_1, "1:1", "Sets the aspect ratio to be 1:1 (Square).", EUserInterfaceActionType::RadioButton, FInputChord());
	UI_COMMAND(SetAspectRatio_4_3, "4:3", "Sets the aspect ratio to be 4:3 (Fullscreen).", EUserInterfaceActionType::RadioButton, FInputChord());
	UI_COMMAND(SetAspectRatio_16_10, "16:10", "Sets the aspect ratio to be 16:10 (Laptop).", EUserInterfaceActionType::RadioButton, FInputChord());
	UI_COMMAND(SetAspectRatio_16_9, "16:9", "Sets the aspect ratio to be 16:9 (HD)", EUserInterfaceActionType::RadioButton, FInputChord());	
