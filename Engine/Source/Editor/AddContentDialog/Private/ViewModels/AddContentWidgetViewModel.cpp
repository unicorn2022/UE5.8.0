...
{
	// Prevent reentrancy if the model sends a change event while we're getting the content sources
	if (bBuildingContentSourceViewModels)
	{
		return;
	}

	TGuardValue GuardValue(bBuildingContentSourceViewModels, true);
