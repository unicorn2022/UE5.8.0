...
ERHIFeatureLevel::Type FPIEPreviewDevice::GetPreviewDeviceFeatureLevel() const
{
	switch (DeviceSpecs->DevicePlatform)
	{
		...
		{
			bool bProjectBuiltForMetal = false;
	...
	switch (DeviceSpecs->DevicePlatform)
	{
		case EPIEPreviewDeviceType::Android:
		{
			...
			if (AndroidDeviceProfileSelector)
			{
				...
				DeviceParameters.Add(TEXT("SRC_GPUFamily"), AndroidProperties.GPUFamily);
				DeviceParameters.Add(TEXT("SRC_GLVersion"), AndroidProperties.GLVersion);
				DeviceParameters.Add(TEXT("SRC_VulkanAvailable"), AndroidProperties.VulkanAvailable ? "true" : "false");
				DeviceParameters.Add(TEXT("SRC_VulkanVersion"), AndroidProperties.VulkanVersion);
				DeviceParameters.Add(TEXT("SRC_AndroidVersion"), AndroidProperties.AndroidVersion);
				DeviceParameters.Add(TEXT("SRC_DeviceMake"), AndroidProperties.DeviceMake);
				DeviceParameters.Add(TEXT("SRC_DeviceModel"), AndroidProperties.DeviceModel);
				DeviceParameters.Add(TEXT("SRC_DeviceBuildNumber"), AndroidProperties.DeviceBuildNumber);
				DeviceParameters.Add(TEXT("SRC_UsingHoudini"), AndroidProperties.UsingHoudini ? "true" : "false");
				DeviceParameters.Add(TEXT("SRC_Hardware"), AndroidProperties.Hardware);
				DeviceParameters.Add(TEXT("SRC_Chipset"), AndroidProperties.Chipset);
				DeviceParameters.Add(TEXT("SRC_HMDSystemName"), AndroidProperties.HMDSystemName);
				DeviceParameters.Add(TEXT("SRC_TotalPhysicalGB"), AndroidProperties.TotalPhysicalGB);
				DeviceParameters.Add(TEXT("SRC_SM5Available"), AndroidProperties.SM5Available ? "true" : "false");
				DeviceParameters.Add(TEXT("SRC_VKQuality"), TEXT(""));
