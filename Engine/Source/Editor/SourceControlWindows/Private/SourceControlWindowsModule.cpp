...
public:
	...
	virtual void ShowBranchExplorerTab() override;
	virtual bool CanShowBranchExplorerTab() const override;
	virtual bool IsVisibleBranchExplorerTab() const override;
...
void FSourceControlWindowsModule::ShowBranchExplorerTab()
{
	if (IConsoleObject* CObj = IConsoleManager::Get().FindConsoleObject(TEXT("UnrealRevisionControl.FocusBranchExplorer")))
	{
		CObj->AsCommand()->Execute(/*Args=*/TArray<FString>(), /*InWorld=*/nullptr, *GLog);
	}
}

bool FSourceControlWindowsModule::CanShowBranchExplorerTab() const
{
	ISourceControlModule& SourceControlModule = ISourceControlModule::Get();
...
bool FSourceControlWindowsModule::IsVisibleBranchExplorerTab() const
{
