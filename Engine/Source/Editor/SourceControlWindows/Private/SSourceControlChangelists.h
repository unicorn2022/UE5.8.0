...
private:
	...
	/** Save assets in changelist operations */
	void OnSaveAssetsInChangelist();
	bool CanSaveAssetsInChangelist();
...
private:
	...
	float ChangelistAreaSize = 0.3f; // [0.0f, 1.0f]
	float FileAreaSize = 0.7f;
};
