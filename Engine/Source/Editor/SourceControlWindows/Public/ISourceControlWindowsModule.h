...
struct FSubmitTitleOverrideParameters
{
	TUnion<FString, TArray<FString>> ToSubmit;
};

DECLARE_DELEGATE_RetVal_TwoParams(FSubmitOverrideReply, FCanSubmitOverrideDelegate, const SSubmitOverrideParameters& /*InParameters*/, FText* /*ErrorMessageOut*/);
DECLARE_DELEGATE_RetVal_OneParam(FSubmitOverrideReply, FSubmitOverrideDelegate, const SSubmitOverrideParameters& /*InParameters*/);
DECLARE_DELEGATE_RetVal_OneParam(FText, FSubmitTitleOverrideDelegate, const FSubmitTitleOverrideParameters& /*InParameters*/);
...
public:
	...
	virtual void ShowBranchExplorerTab() = 0;
	virtual bool CanShowBranchExplorerTab() const = 0;
	virtual bool IsVisibleBranchExplorerTab() const = 0;
	...
	FSubmitTitleOverrideDelegate SubmitTitleOverrideDelegate;
};
