...
void FEditorWidgetsModule::StartupModule()
{
	...
	DetailNameAreaObjectFilterRegistry = MakeShared<UE::EditorWidgets::FDetailNameAreaObjectFilterRegistry>();
}

void FEditorWidgetsModule::ShutdownModule()
{
	ObjectNameEditSinkRegistry.Reset();
	DetailNameAreaObjectFilterRegistry.Reset();
...
TSharedRef<UE::EditorWidgets::FDetailNameAreaObjectFilterRegistry> FEditorWidgetsModule::GetDetailNameAreaObjectFilterRegistry() const
{
	return DetailNameAreaObjectFilterRegistry.ToSharedRef();
}
