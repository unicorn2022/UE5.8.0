...
public:
	...
	{}
		...
		/** Height of the suggestion list dropdown */
		SLATE_ARGUMENT(float, SuggestionListHeight)
...
private:
	...
	/** Returns the width for the suggestion list */
	UE_API FOptionalSize GetSuggestionListWidth() const;
