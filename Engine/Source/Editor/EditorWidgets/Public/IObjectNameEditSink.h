...
public:
	...
	/** Whether or not the name has a suffix */
	virtual bool ObjectDisplayNameHasSuffix(const UObject* Object) const
	{
		return false;
	};

	/** Returns the displayed suffix for that object. */
	virtual FText GetObjectDisplayNameSuffix(const UObject* Object) const
	{
		return FText();
	}
