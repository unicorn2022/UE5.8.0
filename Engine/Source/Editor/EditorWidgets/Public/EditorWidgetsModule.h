...
public:
	...
	virtual TSharedRef<UE::EditorWidgets::FDetailNameAreaObjectFilterRegistry> GetDetailNameAreaObjectFilterRegistry() const;
...
private:
	...
	TSharedPtr<UE::EditorWidgets::FDetailNameAreaObjectFilterRegistry> DetailNameAreaObjectFilterRegistry;
};
