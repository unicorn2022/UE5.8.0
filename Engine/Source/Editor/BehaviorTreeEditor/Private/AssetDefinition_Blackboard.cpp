...
{
	static const FAssetCategoryPath Categories[] = { FAssetCategoryPath(EAssetCategoryPaths::AI, LOCTEXT("AssetDefinition_BlackboardSubMenu", "NPC"), ECategoryMenuType::Section) };
	return Categories;
}
