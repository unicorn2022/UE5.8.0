...
public:
	...
	/**Broadcasted when the editor is closed and sends a summary of widget focus data */
	DECLARE_MULTICAST_DELEGATE_OneParam(FSendEditorFocusSummary, TSharedPtr<FJsonObject>/*json summary of focus data*/);
	static EDITORTOOLEVENTS_API FSendEditorFocusSummary OnSendEditorFocusSummary;
};
