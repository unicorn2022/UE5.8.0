...
{
	// Match EditableTextBox style
	const FEditableTextBoxStyle& EditableTextBoxStyle = FCoreStyle::Get().GetWidgetStyle<FEditableTextBoxStyle>("NormalEditableTextBox");

	BorderImageNormal = &EditableTextBoxStyle.BackgroundImageNormal;
	BorderImageHovered = &EditableTextBoxStyle.BackgroundImageHovered;
	BorderImageFocused = &EditableTextBoxStyle.BackgroundImageFocused;
	...
	[
		...
		[
			...
			[
				...
				[
					SNew(SBox)
					.Padding(EditableTextBoxStyle.Padding)
					.VAlign(VAlign_Center)
					.WidthOverride(200.f)
					[
