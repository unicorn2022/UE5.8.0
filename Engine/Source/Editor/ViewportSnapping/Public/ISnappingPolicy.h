...
{
public:
	virtual ~ISnappingPolicy() = default;
	...
	/**
	 * @return true if rotation snapping is enabled
	 */
	virtual bool IsRotationSnappingEnabled() const = 0;

	/**
	 * @return true if translation snapping is enabled
	 */
	virtual bool IsTranslationSnappingEnabled() const = 0;

	/**
	 * @return true if scale snapping is enabled
	 */
	virtual bool IsScaleSnappingEnabled() const = 0;
};
