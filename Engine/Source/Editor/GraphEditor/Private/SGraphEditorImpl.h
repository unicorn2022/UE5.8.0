...
public:
	SLATE_BEGIN_ARGS( SGraphEditorImpl )
		...
		, _GraphSupportsInvalidation(false)
		{}
		...
		/** If set to true, the GraphPanel will be surrounded with a Dynamic Invalidation Panel */
		SLATE_ARGUMENT(bool, GraphSupportsInvalidation)
	SLATE_END_ARGS()
