...
class SVector4TextBox;

template <typename NumericType>
struct TWidgetTypeTraits<SVector4TextBox<NumericType>>
{
	static constexpr bool SupportsInvalidation() { return true; }
};


// Class implementation to create 4 editable text boxes to represent vector/rotator graph pin
template <typename NumericType>
