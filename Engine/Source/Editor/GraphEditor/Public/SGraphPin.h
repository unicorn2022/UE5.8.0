...
template <>
struct TWidgetTypeTraits<class SGraphPin>
{
...
protected:
	...
	// What widget should we show when we change detail slot?
	UE_API virtual TSharedRef<SWidget> OnGetActiveDetailSlotContent(bool bChangedToHighDetail) const;
...
protected:
	...
	/** The slot in which PinImage will be attached when PinNameLODBranchNode switches to HighDetail. Might be stale or null. */
	SHorizontalBox::FSlot* PinImageHighDetailSlot;
