...
private:
	...
	{
		FCachedStringTableEntry(FString InKey, FString InSourceString, FString InDevNotes)
			: Key(MoveTemp(InKey))
	...
	void SetEntry(const FString& InKey, const FString& InSourceString, const FString& InDevNotes);
	...
	/** Editable text for the developer translation context notes */
	TSharedPtr<SMultiLineEditableTextBox> DevNotesEditableTextBox;
	...
	/** The column ID for the developer translation context notes column */
	static const FName StringTableDevNotesColumnId;
