...
namespace UE::Private
{
	...
	*/
	...
	template<>
	inline bool DoesReferencePropertyMatch<FClassProperty>(const FClassProperty* Property, UClass* Type)
	{
		check(Type);
		return Property && Type->IsChildOf(Property->MetaClass);
	}
	template<>
	inline bool DoesReferencePropertyMatch<FSoftClassProperty>(const FSoftClassProperty* Property, UClass* Type)
	{
		check(Type);
		return Property && Type->IsChildOf(Property->MetaClass);
	}
