...
public:
	 ...
	 * @param InModeTools Optional pre-configured mode tools (if nullptr, a new one will be created).
	 */
	FSCSEditorViewportClient(TWeakPtr<class FBlueprintEditor>& InBlueprintEditorPtr, FPreviewScene* InPreviewScene, const TSharedRef<SSCSEditorViewport>& InSCSEditorViewport, FEditorModeTools* InModeTools = nullptr);
