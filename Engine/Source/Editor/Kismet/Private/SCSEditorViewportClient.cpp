...
FSCSEditorViewportClient::FSCSEditorViewportClient(TWeakPtr<FBlueprintEditor>& InBlueprintEditorPtr, FPreviewScene* InPreviewScene, const TSharedRef<SSCSEditorViewport>& InSCSEditorViewport, FEditorModeTools* InModeTools)
	: FEditorViewportClient(InModeTools, InPreviewScene, StaticCastSharedRef<SEditorViewport>(InSCSEditorViewport))
...
{
	//UE_LOGF(LogSCSEditorViewport, Log, "FSCSEditorViewportClient::BeginTransaction() pre: %ls %08x", SessionName, *((uint32*)&ScopedTransaction));
	...
	//UE_LOGF(LogSCSEditorViewport, Log, "FSCSEditorViewportClient::BeginTransaction() post: %ls %08x", SessionName, *((uint32*)&ScopedTransaction));
}

void FSCSEditorViewportClient::EndTransaction()
{
	//UE_LOGF(LogSCSEditorViewport, Log, "FSCSEditorViewportClient::EndTransaction(): %08x", *((uint32*)&ScopedTransaction));
