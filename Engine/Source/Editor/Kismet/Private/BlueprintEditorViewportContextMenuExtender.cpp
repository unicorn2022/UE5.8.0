...
void EditKismetCodeFor( TWeakObjectPtr<UBlueprint> BlueprintRef )
{
	...
	{
		UE_LOGF(LogViewportBlueprintMenu, Warning, "Failed to find blueprint");
	}
}
...
void RecompileOutOfDateKismetForSelection()
{
	...
	{
		UE_LOGF(LogViewportBlueprintMenu, Warning, "%d blueprints failed to be recompiled", BlueprintFailures);
	}
}
