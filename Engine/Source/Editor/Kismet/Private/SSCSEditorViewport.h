...
public:
	SLATE_BEGIN_ARGS(SSCSEditorViewport){}
		...
		SLATE_ARGUMENT(TSharedPtr<class FEditorModeTools>, ModeTools)
	SLATE_END_ARGS()
...
private:
	...
	/** Pre-configured mode tools for the viewport (optional) */
	TSharedPtr<class FEditorModeTools> ModeTools;
};
