...
TSharedPtr<SWidget> FFBlueprintEditorSCSEditorUICustomization::GetControlsWidget(TSharedRef<SSubobjectEditor>& SubobjectEditor, const FSubobjectData& SubobjectData) const
{
	for (const TSharedPtr<ISCSEditorUICustomization>& Customization : Customizations)
	{
