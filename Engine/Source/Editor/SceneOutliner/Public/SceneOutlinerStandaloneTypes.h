...
public:
	...
	friend uint32 GetTypeHash(const FSceneOutlinerTreeItemType& Type)
	{
		return Type.ID; 
	}
...
struct FSceneOutlinerCommonLabelData
{
	...
	static UE_API TOptional<FLinearColor> GetForegroundColor(TWeakPtr<ISceneOutliner> WeakSceneOutliner, const ISceneOutlinerTreeItem& TreeItem);
