...
namespace SceneOutliner
{
	...
	public:
		...
		static UE_API void ChooseRepresentingWorld(TWeakObjectPtr<UWorld>& OutWorld,
			const TWeakObjectPtr<UWorld>& InSpecifiedWorldToDisplay = nullptr,
			const TWeakObjectPtr<UWorld>& InUserChosenWorld = nullptr);
		...
		static UE_API TWeakObjectPtr<AActor> GetActorFromOutlinerTreeItem(const ISceneOutlinerTreeItem& TreeItem, const TSharedPtr<ISceneOutliner>& Outliner);
	};
};
