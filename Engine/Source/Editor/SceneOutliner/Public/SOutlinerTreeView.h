...
template<>
struct TWidgetTypeTraits<class SSceneOutlinerTreeView>
{
...
template<>
struct TWidgetTypeTraits<class SSceneOutlinerTreeRow>
{
	static constexpr bool SupportsInvalidation() { return true; }
};
...
template<>
struct TWidgetTypeTraits<class SSceneOutlinerPinnedTreeRow>
{
	static constexpr bool SupportsInvalidation() { return true; }
};
