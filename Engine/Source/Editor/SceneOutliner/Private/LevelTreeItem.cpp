...
template<>
struct TWidgetTypeTraits<struct SLevelTreeLabel>
{
	...
	void Construct(const FArguments& InArgs, FLevelTreeItem& LevelItem, ISceneOutliner& SceneOutliner, const STableRow<FSceneOutlinerTreeItemPtr>& InRow)
	{
		...
		[
			...
			[
				...
				.ColorAndOpacity(this, &SLevelTreeLabel::GetForegroundColorInternal)
			]
		];
		SetForegroundColor(TAttribute<FSlateColor>::CreateRaw(this, &SLevelTreeLabel::GetForegroundColorInternal));
	}
