...
template<>
struct TWidgetTypeTraits<struct SActorDescTreeLabel>
{
	...
	void Construct(const FArguments& InArgs, FActorDescTreeItem& ActorDescItem, ISceneOutliner& SceneOutliner, const STableRow<FSceneOutlinerTreeItemPtr>& InRow)
	{
		...
		auto MainContent = SNew(SHorizontalBox)
			...
			[
				...
				.ColorAndOpacity(this, &SActorDescTreeLabel::GetForegroundColorInternal)
		...
		SetForegroundColor(TAttribute<FSlateColor>::CreateRaw(this, &SActorDescTreeLabel::GetForegroundColorInternal));
	}
