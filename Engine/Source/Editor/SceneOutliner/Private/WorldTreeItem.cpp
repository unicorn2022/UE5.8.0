...
template<>
struct TWidgetTypeTraits<struct SWorldTreeLabel>
{
		...
		void Construct(const FArguments& InArgs, FWorldTreeItem& WorldItem, ISceneOutliner& SceneOutliner, const STableRow<FSceneOutlinerTreeItemPtr>& InRow)
	{
		...
		[
			...
			[
				...
				.ColorAndOpacity(this, &SWorldTreeLabel::GetForegroundColorInternal)
		...
		SetForegroundColor(TAttribute<FSlateColor>::CreateRaw(this, &SWorldTreeLabel::GetForegroundColorInternal));
	}
...
private:
	...
	FText GetTooltipText() const
	{
		...
		if (Item.IsValid() && Item->CanInteract())
		{
