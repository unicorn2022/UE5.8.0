...
template<>
struct TWidgetTypeTraits<struct SActorTreeLabel>
{
	...
	void Construct(const FArguments& InArgs, FActorTreeItem& ActorItem, ISceneOutliner& SceneOutliner, const STableRow<FSceneOutlinerTreeItemPtr>& InRow)
	{
		...
		auto MainContent = SNew(SHorizontalBox)
			...
			[
				...
				.ColorAndOpacity(this, &SActorTreeLabel::GetForegroundColorInternal)
		...
		SetForegroundColor(TAttribute<FSlateColor>::CreateRaw(this, &SActorTreeLabel::GetForegroundColorInternal));
	}
