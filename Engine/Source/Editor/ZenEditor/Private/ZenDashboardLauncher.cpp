...
void FZenDashboardLauncher::StartZenDashboard(const FString& Path, const FString& Parameters, StartZenDashboardCallback Callback)
{
	...
	{
		UE_LOGF(LogZenDashboardLauncher, Log, "Launched Zen Dashboard executable: %ls %ls", *Path, *Parameters);
...
void FZenDashboardLauncher::CloseZenDashboard()
{
	...
	{
		UE_LOGF(LogZenDashboardLauncher, Log, "Could not find the Zen Dashboard process handler");
	}
}
...
{
	UE_LOGF(LogZenDashboardLauncher, Log, "Could not find the Zen Dashboard executable: %ls. Attempting to build Zen Dashboard.", *Path);
