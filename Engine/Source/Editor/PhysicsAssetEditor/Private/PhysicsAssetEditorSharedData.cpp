...
void FPhysicsAssetEditorSharedData::MakeNewBody(
	int32 NewBoneIndex, bool bAutoSelect, TConstArrayView<int32> BoneIndicesInCreation)
{
	MakeNewBody(
		GetDefault<UPhysicsAssetGenerationSettings>()->CreateParams, NewBoneIndex, bAutoSelect, BoneIndicesInCreation);
}

void FPhysicsAssetEditorSharedData::MakeNewBody(
	const FPhysAssetCreateParams& NewBodyData, const int32 NewBoneIndex, const bool bAutoSelect,
	TConstArrayView<int32> BoneIndicesInCreation)
{
	...
	{
		bCreatedBody = FPhysicsAssetUtils::CreateCollisionFromBone(
			BodySetup, EditorSkelMesh, NewBoneIndex, NewBodyData, 
			DominantWeightBoneInfos[NewBoneIndex], PhysicsAsset, BoneIndicesInCreation);
	}
	else
	{
		bCreatedBody = FPhysicsAssetUtils::CreateCollisionFromBone(
			BodySetup, EditorSkelMesh, NewBoneIndex, NewBodyData, 
			AnyWeightBoneInfos[NewBoneIndex], PhysicsAsset, BoneIndicesInCreation);
	}
