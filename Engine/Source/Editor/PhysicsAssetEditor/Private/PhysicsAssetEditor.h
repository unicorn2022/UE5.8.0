...
public:
	...
	/** IPhysicsAssetEditor interface */
	virtual TArray<int32> GetSelectedBodyIndices() const override;
	virtual TArray<int32> GetSelectedConstraintIndices() const override;

	virtual void ModifySelection(EPhysicsAssetEditorSelection ElementType, const TArray<int32>& Indices, bool bAddToSelection) override;
	...
	/** Store the viewport reference for overlay widget forwarding. */
	...
	void CreateBodiesAndConstraintsForSelectedBones(const EPhysAssetFitGeomType InGeomType, const bool bInShouldCreateConstraints);
...
private:
	...
	/** Viewport for overlay widget forwarding */
