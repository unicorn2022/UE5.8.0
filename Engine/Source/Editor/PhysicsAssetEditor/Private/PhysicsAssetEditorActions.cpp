...
void FPhysicsAssetEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND(CreateBodyWithSingleConvex, "Create Bodies with Single Convex Hull", "Create bodies with the single convex hull primitive type (and optionally create constraints) for the selected bones using current generation settings (see the Tools tab)", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(CreateBodyWithMultiConvex, "Create Bodies with Multi Convex Hull", "Create bodies with the multiple convex hull primitive type (and optionally create constraints) for the selected bones using current generation settings (see the Tools tab)", EUserInterfaceActionType::Button, FInputChord());
