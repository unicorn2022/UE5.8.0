...
public:
	...
	// The optional BoneIndicesInCreation can contain a list of bone indices that will be created -
	// for when bones are checked to see if they are (or will be) physical.
	void MakeNewBody(
		int32 NewBoneIndex, bool bAutoSelect = true,
		TConstArrayView<int32> BoneIndicesInCreation = TConstArrayView<int32>());
	void MakeNewBody(
		const FPhysAssetCreateParams& NewBodyData, const int32 NewBoneIndex, const bool bAutoSelect = true, 
		TConstArrayView<int32> BoneIndicesInCreation = TConstArrayView<int32>());
