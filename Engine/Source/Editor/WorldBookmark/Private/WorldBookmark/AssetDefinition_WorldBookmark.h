...
public:
	...
	{
		static const FAssetCategoryPath Categories[] = { FAssetCategoryPath(EAssetCategoryPaths::World, NSLOCTEXT("AssetDefinition", "WorldBookmark_SubMenu", "World"), ECategoryMenuType::Section) };
		return Categories;
	}
