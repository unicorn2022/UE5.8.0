...
void FDerivedDataInformation::UpdateRemoteCacheState()
{
	...
	if (const UDDCProjectSettings* DDCProjectSettings = GetDefault<UDDCProjectSettings>(); DDCProjectSettings && DDCProjectSettings->EnableWarnings)
	{
		...
		if (EditorSettings && EditorSettings->bEnableDDCNotifications)
		{
			...
			{
				RemoteCacheState = ERemoteCacheState::Warning;
				RemoteCacheWarningMessage = FText(LOCTEXT("GlobalLocalDDCPathWarning", "It is recommended that you set up a valid Local DDC Path.\nDisable this notification or set up a valid Local DDC Path in the settings."));
			}
			...
			{
				RemoteCacheState = ERemoteCacheState::Warning;
				RemoteCacheWarningMessage = FText(LOCTEXT("GlobalSharedDDCPathWarning", "It is recommended that you set up a valid Shared DDC Path.\nDisable this notification or set up a valid Shared DDC Path in the settings."));
			}
			...
			{
				RemoteCacheState = ERemoteCacheState::Warning;
				RemoteCacheWarningMessage = FText(LOCTEXT("S3GloblaLocalPathWarning", "It is recommended that you set up a valid Local S3 DDC Path.\nDisable this notification or set up a valid Local S3 DDC Path in the settings."));
			}
		}
	}
}
