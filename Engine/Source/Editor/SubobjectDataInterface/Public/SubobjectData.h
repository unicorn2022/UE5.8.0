...
public:
	...
	*/
	...
	/** Walks the parent hierarchy and returns the root subobject in this case */
	...
	/**
	* Retrieves tooltip text describing the specified component.
	*
	* @returns An FText object containing a description of the component
	*/
	...
	*/
	...
	/** 
	 * This type has livliness problems due to cycles in the shared pointer graph. This function clears the pointers 
	 *	involved in cycles, but live FSubobjectDatas will start to behave strangely once it is called
	 */
	UE_API void DisposeUnsafe();

	/**
	 * Removes this FSubobjectData from its parent's children, and clears the parent pointer.
	 */
	UE_EXPERIMENTAL(5.8, "This function may be changed.")
	UE_API void DisconnectFromParent();
private:
	/**
