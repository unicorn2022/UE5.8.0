...
private:
	friend class SBuildActivityTableRow;
	...
	TSharedPtr<SWidget> OnGetBuildActivityContextMenuContent();

	bool CanCancelBuildActivity() const;
	void CancelBuildActivity() const;
	bool CanRetryBuildActivity() const;
	void RetryBuildActivity();
	void OpenDestinationForBuildActivity();
	static void OpenDestinationForBuildActivity(TSharedPtr<UE::Zen::Build::FBuildServiceInstance> ServiceInstance, TSharedPtr<FBuildActivity> Item);
	bool CanClearBuildActivity() const;
	void ClearBuildActivity();
	bool CanViewLogForBuildActivity() const;
	void ViewLogForBuildActivity() const;
