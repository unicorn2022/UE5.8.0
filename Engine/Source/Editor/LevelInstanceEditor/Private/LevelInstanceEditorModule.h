...
{
public:
	virtual ~FLevelInstanceEditorModule()= default;
	...
	virtual FOnLevelInstanceEditModeChanged& OnLevelInstanceEditModeChanged() override { return OnLevelInstanceEditModeChangedDelegate; }
	virtual void BroadcastOnLevelInstanceEditModeChanged(ILevelInstanceInterface* LevelInstance, ELevelInstanceEditMode NewMode) override { OnLevelInstanceEditModeChangedDelegate.Broadcast(LevelInstance, NewMode); }
...
private:
	...
	void OnCreateActorBrowserColumns(FSceneOutlinerInitializationOptions& InitOptions, UWorld* World);
	void RegisterToFirstLevelEditor();
	FTopLevelAssetPath GetBrowseToLevelInstanceAsset(const UObject* Object) const;
	...
	FOnLevelInstanceEditModeChanged OnLevelInstanceEditModeChangedDelegate;
