...
{
	UI_COMMAND(DeleteAsset, "Delete Asset", "Delete a Clothing Data from the mesh.", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(DeleteAssetLastLod, "Delete Asset's Last LOD", "Delete the last clothing Data LOD.", EUserInterfaceActionType::Button, FInputChord());
