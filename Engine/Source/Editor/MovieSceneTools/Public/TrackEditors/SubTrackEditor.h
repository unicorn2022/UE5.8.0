...
public:
	...
	/** Virtual destructor. */
	virtual ~FSubTrackEditor() = default;
...
public:
	...
	UE_API virtual void OnDeleteTransformKeysForSelectedObjects(EMovieSceneTransformChannel Channel) override;
...
public:
	...
	void ResetSectionPreviews(const TArray<FFrameNumber>& Frames, const FMovieSceneChannelMetaData* MetaData, UMovieSceneSection* InSection) { ResetSectionPreviews(); }
...
protected:
	...
	UE_API TSharedRef<SWidget> HandleAddSubSequenceComboButtonGetMenuContent(UE::Sequencer::TWeakViewModelPtr<UE::Sequencer::FViewModel> ViewModel);

	/** Add the input UMovieSceneSequence to the input UMovieSceneTrack */
	UE_API void AddSequenceToTrack(UMovieSceneSequence* InMovieSceneSequence, UMovieSceneTrack* InTrack);
