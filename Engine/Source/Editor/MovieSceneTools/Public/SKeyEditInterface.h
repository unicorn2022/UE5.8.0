...
struct FKeyEditData
{
	...
	/** Channel's actual owning UObject (e.g. a decoration). Falls back to OwningSection for section-owned channels. */
...
private:
	...
	TWeakObjectPtr<UObject> WeakOwningObject;
