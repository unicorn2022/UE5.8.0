...
TSharedRef< SWidget > SDesignerToolBar::MakeToolBar(const TSharedPtr< FExtender > InExtenders)
{
	...
	ToolbarBuilder.AddToolBarButton(FSequencerCommands::Get().ToggleLimitViewportSelection, NAME_None, TAttribute<FText>(), TAttribute<FText>(), TAttribute<FSlateIcon>(), "ToggleLimitViewportSelection");
