...
public:
	...
	/** Set the default widget animation display frame rate's numerator. */
	UPROPERTY(EditAnywhere, config, Category = "Designer|Animation", meta = (ClampMin = "1", UIMin = "1"))
	int32 DefaultWidgetAnimationFrameRate;
