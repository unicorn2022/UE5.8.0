...
public:
	...
	UE_API UUIComponent* AddComponent(const UClass* ComponentClass, FName OwnerName, FText& OutErrorMessage);
	...
	UE_API EDataValidationResult ValidateComponents(FDataValidationContext& Context) const;
	...
	UE_API void ReplaceComponentVariableReferences(const FName& OldWidgetName, const FName& NewWidgetName);
