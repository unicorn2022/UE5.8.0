...
public:
	...
	/** Duplicate the widget tree of the passed widget blueprint and assign it as the widget tree of the passed generated class. */
	UE_API void static UpdateGeneratedClassWidgetTree(UWidgetBlueprint* WidgetBP, UWidgetBlueprintGeneratedClass* BPGClass, UWidgetTree* OldWidgetTree, FCompilerResultsLog* MessageLog);
	UE_API void static ClearGeneratedClassWidgetTree(UWidgetBlueprintGeneratedClass* WBC_ToClean, bool bRecompilingOnLoad);

protected:
	UE_API void static FixAbandonedWidgetTree(UWidgetBlueprint* WidgetBP);
