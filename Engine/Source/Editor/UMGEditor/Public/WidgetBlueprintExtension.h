...
public:
	...
	/**
	 * Report references that this extension is holding into a specific widget's class members.
	 *
	 * @param WidgetVariableName       Variable name of the widget on the owning blueprint.
	 * @param WidgetClass              Current class of the widget (use to resolve member kind).
	 * @param OutReferencedProperties  Property/delegate names on WidgetClass that this extension references.
	 * @param OutReferencedFunctions   Function names on WidgetClass that this extension references.
	 */
	virtual void GatherWidgetMemberReferences(FName WidgetVariableName, const UClass* WidgetClass, TSet<FName>& OutReferencedProperties, TSet<FName>& OutReferencedFunctions) const {}
#endif //WITH_EDITOR
