...
UENUM()
enum class EInheritedNamedSlotSelectionMode : uint8
{
	/** Inherited Named slots are not selectable */
	Disabled,

	/** Inherited Named slots are selectable */
	Enabled,
};
...
private:
	...
	struct FItem
	{
		...
		FItem(const FName InInheritedNamedSlotName) : InheritedNamedSlotName(InInheritedNamedSlotName) {}

		TWeakObjectPtr<const UWidget> Widget;
		TWeakObjectPtr<const UWidgetBlueprint> WidgetBlueprint;
		const FName InheritedNamedSlotName;
...
public:
	...
	SLATE_BEGIN_ARGS(SReadOnlyHierarchyView) {}
		...
		SLATE_ARGUMENT_DEFAULT(EInheritedNamedSlotSelectionMode, InheritedNamedSlotSelectionMode) = EInheritedNamedSlotSelectionMode::Enabled;		
...
private:
	...
	EInheritedNamedSlotSelectionMode InheritedNamedSlotSelectionMode;
