...
void FAnimGraphModule::StartupModule()
{
	...
	PropertyModule.RegisterCustomPropertyTypeLayout("AnimSequenceTransformProviderLayer", FOnGetPropertyTypeCustomizationInstance::CreateStatic(&FAnimSequenceTransformProviderLayerCustomization::MakeInstance));
	if(GIsEditor)
	{
