...
namespace UE::StructUtils::Metadata
{
	...
	const FLazyName PropertyBagSchemaClassName = "PropertyBagSchemaClass";
	...
	const FLazyName ExtensionClass = "ExtensionClass";
	...
	const FLazyName HideStructTypeName = "HideStructType";
	...
	namespace Specifiers
	{
		...
		const FLazyName ForceUnitsName = "ForceUnits";
