...
public:
	...
	virtual void CreateSoundClass(class UEdGraphPin* FromPin, const FVector2D& Location, const FString& Name) override;
...
private:
	...
	void OnLaunchReferenceViewer() const;
	
	/** Show and focus the Find in Sound Class Graph tab. */
	void ShowFindInSoundClassGraph();
...
private:
	...
	/** Find in Sound Class Graph widget. */
	TSharedPtr<SFindInSoundClassGraph> FindWidget;
	...
	static const FName FindInSoundClassGraphTabId;
	...
	void OnSearchResultActivated(USoundClassGraphNode* Node);
};
