...
TConstArrayView<FAssetCategoryPath> UAssetDefinition_SoundCue::GetAssetCategories() const
{
	...
	static const auto Categories = { FAssetCategoryPath(EAssetCategoryPaths::Audio, LOCTEXT("SoundCue_SubMenu", "Sources")) };
		...
		UToolMenus::RegisterStartupCallback(FSimpleMulticastDelegate::FDelegate::CreateLambda([]()
		{
...

			{
				...
				Section->AddDynamicEntry(NAME_None, FNewToolMenuSectionDelegate::CreateLambda([](FToolMenuSection& InSection)
				{
					...
					const FSlateIcon Icon = FSlateIcon(FAppStyle::GetAppStyleSetName(), "MediaAsset.AssetActions.SoundConsolidation.Small");
