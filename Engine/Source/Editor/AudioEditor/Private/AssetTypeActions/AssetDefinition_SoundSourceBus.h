		...
		static const auto Categories = 
			{
				FAssetCategoryPath(EAssetCategoryPaths::Audio,
					NSLOCTEXT("AssetDefinition", "AssetDefinitionSoundSourceSubMenu", "Advanced"),
					FCategoryPath(NSLOCTEXT("AssetDefinition", "AssetDefinition_SoundSourceSubMenuSection", "Routing"), ECategoryMenuType::Section))
			};
		return Categories;
	}
