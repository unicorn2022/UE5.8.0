...
UCLASS()
class UAssetDefinition_SoundAttenuation : public UAssetDefinitionDefault_AudioDiffable
{
	GENERATED_BODY()

public:
	// UAssetDefinition Begin
	virtual FText GetAssetDisplayName() const override { return NSLOCTEXT("AssetTypeActions", "AssetTypeActions_SoundAttenuation", "Attenuation"); }
	...
	virtual TConstArrayView<FAssetCategoryPath> GetAssetCategories() const override
	{
		...
		static const auto Categories = { FAssetCategoryPath(EAssetCategoryPaths::Audio, NSLOCTEXT("AssetTypeActions", "AssetSoundAttenuationSubMenu", "Property Settings")) };
