...
class FSoundSubmixEditor : public ISoundSubmixEditor, public FGCObject, public FEditorUndoClient, public FNotifyHook
{
public:
	...
	/** Forces the details panel to re-evaluate property metadata (e.g. EditConditions) after a graph topology change */
	void RefreshDetails();
...
private:
	...
	/** Adds all children of provided parent submix as editable */
	void AddEditableSubmixChildren(USoundSubmixBase* ParentSubmix);
