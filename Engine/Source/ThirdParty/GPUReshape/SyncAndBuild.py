...
branches = [
    ...
    # To add more branches, use:
    # ("feature/<name>", "<Name>", None)
]

# All files and folders to be excluded
source_ignores = [
    ".git",
    "ThirdParty",
    "Documentation"
...
def sync_and_build(branch):
    ...
    if copy_source_path is not None:
        ...
        for path in source_ignores:
            shutil.rmtree(os.path.join(copy_source_path, path), ignore_errors=False, onerror=clean_on_error)
