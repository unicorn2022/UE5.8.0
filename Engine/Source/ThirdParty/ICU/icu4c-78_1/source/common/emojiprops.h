...
public:
    ...
    static UBool hasBinaryProperty(UChar32 c, UCharProperty which);
    static UBool hasBinaryProperty(const char16_t *s, int32_t length, UCharProperty which);

    void addPropertyStarts(const USetAdder *sa, UErrorCode &errorCode) const;
    void addStrings(const USetAdder *sa, UCharProperty which, UErrorCode &errorCode) const;
...
private:
    ...
    UBool hasBinaryPropertyImpl(UChar32 c, UCharProperty which) const;
    UBool hasBinaryPropertyImpl(const char16_t *s, int32_t length, UCharProperty which) const;
