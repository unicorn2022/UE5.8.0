...
static UBool hasEmojiProperty(const BinaryProperty &/*prop*/, UChar32 c, UCharProperty which) {
    return EmojiProps::hasBinaryProperty(c, which);
}

static UBool isIDSUnaryOperator(const BinaryProperty &/*prop*/, UChar32 c, UCharProperty /*which*/) {
...
static UBool isIDCompatMathStart(const BinaryProperty &/*prop*/, UChar32 c, UCharProperty /*which*/) {
...
static UBool isIDCompatMathContinue(const BinaryProperty &prop, UChar32 c, UCharProperty /*which*/) {
...
static UBool isModifierCombiningMark(const BinaryProperty &/*prop*/, UChar32 c, UCharProperty /*which*/) {
...
U_CAPI UBool U_EXPORT2
u_stringHasBinaryProperty(const char16_t *s, int32_t length, UCharProperty which) {
...
static int32_t getBlock(const IntProperty &/*prop*/, UChar32 c, UCharProperty /*which*/) {
    return static_cast<int32_t>(ublock_getCode(c));
}

static int32_t blockGetMaxValue(const IntProperty &/*prop*/, UCharProperty /*which*/) {
...
static int32_t scriptGetMaxValue(const IntProperty &/*prop*/, UCharProperty /*which*/) {
...
static int32_t getIDStatusValue(const IntProperty & /*prop*/, UChar32 c, UCharProperty /*which*/) {
