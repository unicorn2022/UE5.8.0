...
public class SoundTouchZ : ModuleRules
{
	...
	public SoundTouchZ(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		if (bPlatformSupportsSoundTouchZ)
		{
			...
			{
				PublicAdditionalLibraries.Add(Path.Combine(LibraryRootDir, "lib", "Android", "arm64", "Release", "libSoundTouchZ.a"));
			}
			else if (Target.Platform == UnrealTargetPlatform.IOS)
			{
				PublicAdditionalLibraries.Add(Path.Combine(LibraryRootDir, "lib", "IOS", "Release", "libSoundTouchZ.a"));
			}
			...
			{
				PublicAdditionalLibraries.Add(Path.Combine(LibraryRootDir, "lib", "Mac", "Release", "libSoundTouchZ.a"));
			}
