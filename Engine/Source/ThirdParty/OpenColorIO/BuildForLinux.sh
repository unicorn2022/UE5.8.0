...
IMATH_INCLUDE_DIR="$UE_SOURCE_THIRD_PARTY_LOCATION/Imath/Deploy/Imath-3.2.2/include"
IMATH_LIBRARY_PATH="$UE_SOURCE_THIRD_PARTY_LOCATION/Imath/Deploy/Imath-3.2.2/Unix/$ARCH_NAME/lib/libImath-3_2.a"
