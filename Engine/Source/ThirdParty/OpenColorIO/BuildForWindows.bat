...
set OCIO_VERSION=2.5.1
set OCIO_LIB_NAME=OpenColorIO-%OCIO_VERSION%
set ARCH_NAME=%1
set UE_MODULE_LOCATION=%cd%
set UE_THIRD_PARTY_LOCATION=%UE_MODULE_LOCATION%\..
set UE_THIRD_PARTY_LOCATION=%UE_THIRD_PARTY_LOCATION:\=/%
set IMATH_CMAKE_LOCATION=%UE_THIRD_PARTY_LOCATION%/Imath/Deploy/Imath-3.2.2/VS2015/%ARCH_NAME%/lib/cmake/Imath
set ZLIB_INCLUDE_PATH=%UE_THIRD_PARTY_LOCATION%/zlib/1.3/include
if %ARCH_NAME% == x64 (
...
cmake -S . -B build -G "Visual Studio 17 2022" -T version=14.38^
    -A %ARCH_NAME%^
