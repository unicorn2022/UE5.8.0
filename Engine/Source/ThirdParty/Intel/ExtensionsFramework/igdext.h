...
enum INTC_D3D12_FEATURES
{
    ...
    INTC_D3D12_FEATURE_D3D12_OPTIONS3 = 2, ///< D3D12 Options 3
};
...
// Feature Data D3D12 Options 3
struct INTC_D3D12_FEATURE_DATA_D3D12_OPTIONS3
{
    BOOL AsyncCompute; ///< Async Compute Supported (Efficient Async Compute)
};
