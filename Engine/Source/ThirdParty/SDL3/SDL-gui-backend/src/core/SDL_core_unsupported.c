...
/* EG BEGIN */
void SDLCALL SDL_SetX11ErrorHandler(SDL_X11ErrorCallback callbackerror, void *callbackerrordata, SDL_X11IOErrorCallback callbackioerror, void *callbackioerrordata)
{
}
/* EG END */
