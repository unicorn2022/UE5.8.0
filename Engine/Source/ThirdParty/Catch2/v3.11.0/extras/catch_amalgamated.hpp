...
//  Catch v3.11.0
//  Generated: 2025-11-24 18:47:02.532449
//  ----------------------------------------------------------
...
namespace Catch {
    ...
    public:
		...
		constexpr IRunCapture* getRunCapture() const {
			return m_runCapture;
		}
		...
		constexpr void setRunCapture( IRunCapture* runCapture )
		{
...
#    define INTERNAL_CATCH_TEST_GROUP_EVENT2( EventName, ... ) \
        static void EventName(); \
        CATCH_INTERNAL_START_WARNINGS_SUPPRESSION \
        CATCH_INTERNAL_SUPPRESS_GLOBALS_WARNINGS \
		CATCH_INTERNAL_SUPPRESS_UNUSED_VARIABLE_WARNINGS \
        static const Catch::Detail::DummyUse INTERNAL_CATCH_UNIQUE_NAME( dummyUser )( &(EventName) ); \
        CATCH_INTERNAL_SUPPRESS_SHADOW_WARNINGS \
		static void EventName() \
		    CATCH_INTERNAL_STOP_WARNINGS_SUPPRESSION

#    define INTERNAL_CATCH_TEST_GROUP_EVENT( ... ) \
        INTERNAL_CATCH_TEST_GROUP_EVENT2( INTERNAL_CATCH_UNIQUE_NAME( dummyFunction ), __VA_ARGS__  )
...
#define INTERNAL_CATCH_TYPES_REGISTER(TestFunc)\
    ...
    {\
        Catch::AutoReg( Catch::makeTestInvoker(&TestFunc<Ts...>), CATCH_INTERNAL_LINEINFO, Catch::DefaultGroup, Catch::StringRef(), nameAndTags);\
    }
        ...
        namespace INTERNAL_CATCH_MAKE_NAMESPACE(TestName) {                                     \
            ...
            struct TestName {                                         \
                void reg_tests() {                                          \
                    ...
                    (void)expander{(Catch::AutoReg( Catch::makeTestInvoker( &TestFuncName<Types> ), CATCH_INTERNAL_LINEINFO, Catch::DefaultGroup, Catch::StringRef(), Catch::StringRef(), Catch::NameAndTags{ Name " - " + std::string(tmpl_types[index / num_types]) + '<' + types_list[index % num_types] + '>', Tags } ), index++)... };/* NOLINT */\
                }                                                     \
            };                                                        \
            static const int INTERNAL_CATCH_UNIQUE_NAME( globalRegistrar ) = [](){ \
    ...
    #define INTERNAL_CATCH_TEMPLATE_LIST_TEST_CASE_2(TestName, TestFunc, Name, Tags, TmplList)\
        ...
        struct TestName {                                         \
            void reg_tests() {                                          \
                size_t index = 0;                                    \
                using expander = size_t[];                           \
                (void)expander{(Catch::AutoReg( Catch::makeTestInvoker( &TestFunc<Types> ), CATCH_INTERNAL_LINEINFO, Catch::DefaultGroup, Catch::StringRef(), Catch::StringRef(), Catch::NameAndTags{ Name " - " INTERNAL_CATCH_STRINGIZE(TmplList) " - " + std::to_string(index), Tags } ), index++)... };/* NOLINT */\
            }                                                     \
        };\
        static const int INTERNAL_CATCH_UNIQUE_NAME( globalRegistrar ) = [](){ \
        ...
        namespace INTERNAL_CATCH_MAKE_NAMESPACE(TestNameClass) {\
            ...
            struct TestNameClass{\
                void reg_tests(){\
                    ...
                    constexpr char const* types_list[] = {CATCH_REC_LIST(INTERNAL_CATCH_STRINGIZE_WITHOUT_PARENS, INTERNAL_CATCH_REMOVE_PARENS(TypesList))};\
                    constexpr auto num_types = sizeof(types_list) / sizeof(types_list[0]);\
                    (void)expander{(Catch::AutoReg( Catch::makeTestInvoker( &TestName<Types>::test ), CATCH_INTERNAL_LINEINFO, Catch::DefaultGroup, Catch::StringRef(), #ClassName, Catch::NameAndTags{ Name " - " + std::string(tmpl_types[index / num_types]) + '<' + types_list[index % num_types] + '>', Tags } ), index++)... };/* NOLINT */ \
                }\
            };\
            static const int INTERNAL_CATCH_UNIQUE_NAME( globalRegistrar ) = [](){\
        ...
        namespace INTERNAL_CATCH_MAKE_NAMESPACE(TestName){ \
            ...
            struct TestNameClass{\
                void reg_tests(){\
                    size_t index = 0;\
                    using expander = size_t[];\
                    (void)expander{(Catch::AutoReg( Catch::makeTestInvoker( &TestName<Types>::test ), CATCH_INTERNAL_LINEINFO, Catch::DefaultGroup, Catch::StringRef(), #ClassName##_catch_sr, Catch::NameAndTags{ Name " - " INTERNAL_CATCH_STRINGIZE(TmplList) " - " + std::to_string(index), Tags } ), index++)... };/* NOLINT */ \
                }\
            };\
            static const int INTERNAL_CATCH_UNIQUE_NAME( globalRegistrar ) = [](){\
...
namespace Catch {
    ...
    public:
        ...
        virtual std::map<StringRef, std::vector<TestCaseHandle>> const& getAllGroups() const = 0;
...
namespace Catch {
    ...
    public:
        ...
        std::map<StringRef, std::vector<TestCaseHandle>> const& getAllGroups() const override;
    ...
    private:
        ...
        std::map<StringRef, std::vector<TestCaseHandle>> m_groups;
