...
//  Catch v3.11.0
//  Generated: 2025-11-24 18:47:02.614032
//  ----------------------------------------------------------
...
namespace Catch {
    ...
    std::map<StringRef, std::vector<TestCaseHandle>> const& TestRegistry::getAllGroups() const {
        return m_groups;
    }
...
namespace Catch {
    ...
    namespace {
        std::string getCurrentTimestamp() {
            ...
            std::tm timeInfo = {};
#if defined (CATCH_USE_STD_GMTIME) || defined (__IAR_SYSTEMS_ICC__)
