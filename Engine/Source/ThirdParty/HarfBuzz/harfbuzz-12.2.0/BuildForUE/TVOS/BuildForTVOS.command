...
#
# Builds HarfBuzz 12.2.0 static libraries for tvOS (device + simulator) against
# ICU 78 and FreeType2-2.14.1. Outputs to:
#   harfbuzz-12.2.0/lib/TVOS/{Debug,Release}/libharfbuzz.a
#   harfbuzz-12.2.0/lib/TVOS/Simulator/{Debug,Release}/libharfbuzz.a
...
HB_TVOS_VERSION=harfbuzz-12.2.0
...
do
  "${ENGINE_ROOT}/Build/BatchFiles/RunUAT.command" BuildCMakeLib -TargetPlatform=TVOS -TargetArchitecture=${ARCH} -TargetLib=HarfBuzz -TargetLibVersion=${HB_TVOS_VERSION} -TargetConfigs=Debug+Release -LibOutputPath=lib -CMakeGenerator=Makefile -CMakeAdditionalArguments="${CMAKE_ADDITIONAL_ARGUMENTS}" -MakeTarget=${MAKE_TARGET} -SkipCreateChangelist
done

pushd "${ENGINE_ROOT}/Source/ThirdParty/HarfBuzz/${HB_TVOS_VERSION}/lib/TVOS"
