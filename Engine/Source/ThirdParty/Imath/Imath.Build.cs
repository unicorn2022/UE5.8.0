...
public class Imath : ModuleRules
{
	public Imath(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		string DeploymentDirectory = Path.Combine(ModuleDirectory, "Deploy", "Imath-3.2.2");

		PublicSystemIncludePaths.Add(Path.Combine(DeploymentDirectory, "include"));

		// XXX: OpenEXR includes some Imath headers without the
		// leading "Imath/..."
		...
		if (Target.Platform.IsInGroup(UnrealPlatformGroup.Windows))
		{
			...
			string StaticLibName = "Imath-3_2" + LibPostfix + ".lib";
		...
		else if (Target.Platform == UnrealTargetPlatform.Mac)
		{
			...
			string StaticLibName = "libImath-3_2" + LibPostfix + ".a";
