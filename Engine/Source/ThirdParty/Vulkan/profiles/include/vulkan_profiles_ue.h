...
static const VpStructChainerDesc chainerDesc = {
    ...
    [](VkBaseOutStructure* p, void* pUser, PFN_vpStructChainerCb pfnCb) {
        ...
        VkPhysicalDevicePushDescriptorProperties physicalDevicePushDescriptorProperties{ VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES, &physicalDeviceMeshShaderPropertiesEXT };
        p->pNext = static_cast<VkBaseOutStructure*>(static_cast<void*>(&physicalDevicePushDescriptorProperties));
        pfnCb(p, pUser);
    },
    [](uint32_t count, VkBaseOutStructure* p, void* pUser, PFN_vpStructArrayChainerCb pfnCb) {
        pfnCb(count, p, pUser);
    ...
    [](VkBaseOutStructure* p) { (void)p;
            switch (p->sType) {
                ...
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES: {
                    VkPhysicalDevicePushDescriptorProperties* s = static_cast<VkPhysicalDevicePushDescriptorProperties*>(static_cast<void*>(p));
    ...
    [](VkBaseOutStructure* p) -> bool { (void)p;
        bool ret = true;
            switch (p->sType) {
                ...
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES: {
                    VkPhysicalDevicePushDescriptorProperties* prettify_VkPhysicalDevicePushDescriptorProperties = static_cast<VkPhysicalDevicePushDescriptorProperties*>(static_cast<void*>(p));
                    ret = ret && (prettify_VkPhysicalDevicePushDescriptorProperties->maxPushDescriptors >= 32); VP_DEBUG_COND_MSG(!(prettify_VkPhysicalDevicePushDescriptorProperties->maxPushDescriptors >= 32), "Unsupported properties condition: VkPhysicalDevicePushDescriptorProperties::maxPushDescriptors >= 32");
                } break;
                default: break;
            }
        return ret;
