...
CURRENT_LIBRARY_VERSION=3.4.3

# If building OpenEXR version 3.4.3, be sure to apply this patch to disable
# SIMD when building OpenJPH for macOS to ensure that universal binaries can
# be built successfully.
# From the "openexr-3.4.3" source directory, run:
#     git apply ../openexr_v3.4.3_macos_openjph_disable_simd.patch
...
IMATH_CMAKE_LOCATION="$UE_SOURCE_THIRD_PARTY_LOCATION/Imath/Deploy/Imath-3.2.2/Mac/lib/cmake/Imath"
...
rm -f "$INSTALL_LOCATION/$INSTALL_LIB_DIR/pkgconfig/openjph.pc"
