...
set IMATH_CMAKE_LOCATION=%UE_SOURCE_THIRD_PARTY_LOCATION%\Imath\Deploy\Imath-3.2.2\%COMPILER_VERSION_NAME%\%ARCH_NAME%\lib\cmake\Imath
...
del /Q "%INSTALL_LOCATION%\%INSTALL_LIB_DIR%\pkgconfig\openjph.pc"
