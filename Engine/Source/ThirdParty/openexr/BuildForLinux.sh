...
IMATH_CMAKE_LOCATION="$UE_SOURCE_THIRD_PARTY_LOCATION/Imath/Deploy/Imath-3.2.2/Unix/$ARCH_NAME/lib/cmake/Imath"
...
# Hack for building OpenJPH on Rocky Linux 8 for aarch64 Linux where
# this ends up undefined while checking hardware capabilities.
CXX_FLAGS="$CXX_FLAGS -DHWCAP2_SVE2=2"
