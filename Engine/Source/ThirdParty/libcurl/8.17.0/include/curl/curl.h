...
typedef void (*curl_unlock_function)(CURL *handle,
                                     curl_lock_data data,
                                     void *userptr);
typedef void* (*curl_disallowmultithreadedlock_allocate_function)(void);
typedef void (*curl_disallowmultithreadedlock_free_function)(void* lock);
typedef void (*curl_disallowmultithreadedlock_lock_function)(void* lock);
typedef void (*curl_disallowmultithreadedlock_unlock_function)(void* lock);

CURL_EXTERN void curl_set_disallowmultithreadedlock(
  curl_disallowmultithreadedlock_allocate_function,
  curl_disallowmultithreadedlock_free_function,
  curl_disallowmultithreadedlock_lock_function,
  curl_disallowmultithreadedlock_unlock_function);

typedef void (*curl_settimetree_func)(void* easy, void* multi, bool bAdded);

CURL_EXTERN void curl_set_settimetree(curl_settimetree_func);
