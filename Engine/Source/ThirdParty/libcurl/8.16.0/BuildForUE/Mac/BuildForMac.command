...
CMAKE_ADDITIONAL_ARGUMENTS="-DCMAKE_C_FLAGS=\"-DNGHTTP2_STATICLIB=1\" -DUSE_NGHTTP2=ON -DCURL_USE_OPENSSL=ON -DBUILD_CURL_EXE=OFF -DCURL_DISABLE_LDAP=ON -DCURL_DISABLE_LDAPS=ON -DBUILD_SHARED_LIBS=OFF -DCMAKE_FIND_USE_SYSTEM_ENVIRONMENT_PATH=OFF -DCURL_USE_LIBPSL=OFF -DCURL_USE_LIBSSH2=OFF"
