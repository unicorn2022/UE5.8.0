	...
	public VorbisFile(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		else if (Target.IsInPlatformGroup(UnrealPlatformGroup.Unix))
		{
			string fPIC = (Target.LinkType == TargetLinkType.Monolithic)
				? ""
				: "_fPIC";
			PublicAdditionalLibraries.Add(Path.Combine(VorbisFileLibPath, "Unix", Target.Architecture.LinuxName, "libvorbisfile" + fPIC + ".a"));
			PublicAdditionalLibraries.Add(Path.Combine(VorbisFileLibPath, "Unix", Target.Architecture.LinuxName, "libvorbisenc" + fPIC + ".a"));
		}
