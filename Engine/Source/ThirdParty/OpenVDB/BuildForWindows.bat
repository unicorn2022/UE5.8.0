...
rem   - add missing Half instantiations of cwiseAdd()
rem From the "openvdb-13.0.0" source directory, run:
rem     git apply ../openvdb_13.0.0_support_disabling_RTTI.patch
rem     git apply ../openvdb_13.0.0_Vec_Half_cwiseAdd.patch
...
set BOOST_CMAKE_LOCATION=%UE_SOURCE_THIRD_PARTY_LOCATION%\Boost\Deploy\boost-1.88.0\%COMPILER_VERSION_NAME%\%ARCH_NAME%\lib\cmake\Boost-1.88.0
