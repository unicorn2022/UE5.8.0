...
BOOST_LOCATION="$UE_SOURCE_THIRD_PARTY_LOCATION/Boost/Deploy/boost-1.88.0"
BOOST_CMAKE_LOCATION="$BOOST_LOCATION/Unix/$ARCH_NAME/lib/cmake/Boost-1.88.0"
...
( cat <<_EOF_
    ...
    list(APPEND CMAKE_FIND_ROOT_PATH "${ZLIB_LOCATION}")
