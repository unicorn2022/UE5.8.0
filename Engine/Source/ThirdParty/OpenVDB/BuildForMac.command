...
CURRENT_LIBRARY_VERSION=13.0.0

# When building OpenVDB, be sure to apply the following patches:
#   - allow use of the library with RTTI disabled
#   - add missing Half instantiations of cwiseAdd()
# From the "openvdb-13.0.0" source directory, run:
#     git apply ../openvdb_13.0.0_support_disabling_RTTI.patch
#     git apply ../openvdb_13.0.0_Vec_Half_cwiseAdd.patch
...
BOOST_CMAKE_LOCATION="$UE_SOURCE_THIRD_PARTY_LOCATION/Boost/Deploy/boost-1.88.0/Mac/lib/cmake/Boost-1.88.0"
