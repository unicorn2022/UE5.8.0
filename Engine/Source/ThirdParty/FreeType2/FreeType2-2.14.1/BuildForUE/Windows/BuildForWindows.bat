...
set FREETYPE_WINDOWS_VERSION=FreeType2-2.14.1
set CMAKE_ADDITIONAL_ARGUMENTS=-DFT_REQUIRE_PNG=TRUE
set CMAKE_ADDITIONAL_ARGUMENTS=%CMAKE_ADDITIONAL_ARGUMENTS% -DFT_REQUIRE_ZLIB=TRUE
REM We do not want to use HB in FreeType 
set CMAKE_ADDITIONAL_ARGUMENTS=%CMAKE_ADDITIONAL_ARGUMENTS% -DFT_DISABLE_HARFBUZZ=TRUE
set CMAKE_ADDITIONAL_ARGUMENTS=%CMAKE_ADDITIONAL_ARGUMENTS% -DCMAKE_DISABLE_FIND_PACKAGE_HarfBuzz=TRUE
REM # We do not want to use bzip2 features for .pcf or .bz2
set CMAKE_ADDITIONAL_ARGUMENTS=%CMAKE_ADDITIONAL_ARGUMENTS% -DFT_DISABLE_BZIP2=TRUE
