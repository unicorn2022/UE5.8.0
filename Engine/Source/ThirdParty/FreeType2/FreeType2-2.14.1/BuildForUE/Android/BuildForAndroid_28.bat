...
set AdditionalCompileArguments=-DFT_REQUIRE_ZLIB=TRUE -DFT_REQUIRE_PNG=TRUE -DFT_DISABLE_HARFBUZZ=TRUE -DCMAKE_DISABLE_FIND_PACKAGE_HarfBuzz=TRUE -DCMAKE_DISABLE_FIND_PACKAGE_BZip2=TRUE set CMAKE_ADDITIONAL_ARGUMENTS=%CMAKE_ADDITIONAL_ARGUMENTS% -DFT_DISABLE_BZIP2=TRUE -DFT_DISABLE_BZIP2=TRUE -DPNG_LIBRARY=%PATH_TO_PNG% -DPNG_PNG_INCLUDE_DIR=%PATH_TO_PNG% 
