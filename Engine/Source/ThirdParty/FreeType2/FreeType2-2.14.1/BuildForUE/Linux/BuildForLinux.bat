...
set FREETYPE_LINUX_VERSION=FreeType2-2.14.1
...
set CMAKE_ADDITIONAL_ARGUMENTS=-DFT_REQUIRE_ZLIB=TRUE
set CMAKE_ADDITIONAL_ARGUMENTS=%CMAKE_ADDITIONAL_ARGUMENTS% -DFT_REQUIRE_PNG=TRUE
