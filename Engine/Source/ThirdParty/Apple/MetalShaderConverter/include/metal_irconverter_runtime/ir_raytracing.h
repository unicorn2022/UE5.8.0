...
IR_DLL_EXPORT const char* kIRRayDispatchIndirectionKernelName = "RaygenIndirection";
IR_DLL_EXPORT const uint64_t kIRRayDispatchArgumentsBindPoint = 3;
...
// UE BEGIN CHANGE - Ignore in Non Unity if Metal.h is undefined
#endif
// UE END CHANGE - Ignore in Non Unity if Metal.h is underined
