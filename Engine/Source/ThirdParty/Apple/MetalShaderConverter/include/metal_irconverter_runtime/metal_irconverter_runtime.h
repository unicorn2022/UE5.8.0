...
// UE BEGIN CHANGE - Ignore in Non Unity if Metal.h is undefined
#if (defined MTL_EXTERN) || (defined _MTL_EXTERN)
// UE END CHANGE - Ignore in Non Unity if Metal.h is undefined
...
// BEGIN UE Changes - Changes to include from a library
#define IR_DLL_EXPORT   __attribute__((visibility("default")))
#define IR_INLINE       IR_DLL_EXPORT
// END UE Changes
...
IRRuntimeDrawInfo IRRuntimeCalculateDrawInfoForGSEmulation(IRRuntimePrimitiveType primitiveType, indextype_t indexType, uint32_t vertexSizeInBytes, uint32_t maxInputPrimitivesPerMeshThreadgroup, uint32_t instanceCount);

mtlsize_t IRRuntimeCalculateObjectTgCountForTessellationAndGeometryEmulation(uint32_t vertexOrIndexCount,
																			uint32_t objectThreadgroupVertexStride,
																			IRRuntimePrimitiveType primitiveType,
																			uint32_t instanceCount);

uint32_t IRRuntimePrimitiveTypeVertexCount(IRRuntimePrimitiveType primitiveType);

void IRRuntimeCalculateThreadgroupSizeForGeometry(IRRuntimePrimitiveType primitiveType, uint32_t maxInputPrimitivesPerMeshThreadgroup, uint32_t objectThreadgroupVertexStride, uint32_t* objectThreadgroupSize, uint32_t* meshThreadgroupSize);
...
// BEGIN UE Changes - Changes to include from a library
IR_DLL_EXPORT const uint64_t kIRArgumentBufferBindPoint                   = 2;
IR_DLL_EXPORT const uint64_t kIRArgumentBufferHullDomainBindPoint         = 3;
IR_DLL_EXPORT const uint64_t kIRDescriptorHeapBindPoint                   = 0;
IR_DLL_EXPORT const uint64_t kIRSamplerHeapBindPoint                      = 1;
IR_DLL_EXPORT const uint64_t kIRArgumentBufferDrawArgumentsBindPoint      = 4;
IR_DLL_EXPORT const uint64_t kIRArgumentBufferUniformsBindPoint           = 5;
IR_DLL_EXPORT const uint64_t kIRVertexBufferBindPoint                     = 6;
IR_DLL_EXPORT const uint64_t kIRStageInAttributeStartIndex                = 11;
// END UE Changes - Changes to include from a library
