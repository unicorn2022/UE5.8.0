...
#include "Instrumentation/EntryPoints.h"
	...
	#define INSTRUMENTATION_PERMODULE_FUNCTION_ATTRIBUTES INSTRUMENTATION_ENTRYPOINT_ATTRIBUTES INSTRUMENTATION_FUNCTION_HOTPATCHABLE	
#else
	#define INSTRUMENTATION_PERMODULE_FUNCTION_ATTRIBUTES INSTRUMENTATION_ENTRYPOINT_ATTRIBUTES	
#endif
