...
{ 
	...
	OnPostEngineInitHandle = FCoreDelegates::GetOnPostEngineInit().AddStatic(&ANavMeshBoundsVolume::OnPostEngineInit);
#endif
}
...
//{
//	UE_LOGF(LogNavSysModule, Log, "Creating NavigationSystem for world %ls", *World.GetName());
//	
