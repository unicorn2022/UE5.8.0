...
public:
	...
	/** returns the remaining length of the path from Position, including the distance from Position to the NextPathPoint */
	UFUNCTION(BlueprintCallable, Category = "AI|Navigation")
	NAVIGATIONSYSTEM_API double GetLengthFromPosition(FVector Position, int32 NextPathPointIndex) const;
