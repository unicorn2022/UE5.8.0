...
#define NAVMESHVER_TILEVERT_ENCODING			28 // Store vertex data as tile-local floats (dtTileVert) instead of world-space doubles

#define NAVMESHVER_LATEST				NAVMESHVER_TILEVERT_ENCODING
