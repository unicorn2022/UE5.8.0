...
namespace UE::Interchange
{
	...
	namespace SourceNode
	{
		...
		{
			static FString StaticUid = "__SourceNode__";
			return StaticUid;
		}

		const FString& GetExtraInformationKey()
		{
			static FString ExtraInformationKey("__ExtraInformation__Key");
...
{
	const FString TypeName = "SourceNode";
	return TypeName;
}
...
bool UInterchangeSourceNode::GetCustomAlignSkeletalMeshInScene(bool& AttributeValue) const
{
	IMPLEMENT_NODE_ATTRIBUTE_GETTER(AlignSkeletalMeshInScene, bool);
}

bool UInterchangeSourceNode::SetCustomAlignSkeletalMeshInScene(const bool& AttributeValue)
{
	IMPLEMENT_NODE_ATTRIBUTE_SETTER_NODELEGATE(AlignSkeletalMeshInScene, bool)
}
