...
namespace UE
{
	namespace Interchange
	{
		...
		{
			static FString BaseNodeFactoryDependencies_BaseKey = "__BaseNodeFactoryDependencies__";
		...
		{
			static FString AttributesAppliedThroughDelegates_BaseKey = "__AttributeAppliedThroughDelegate__";
...
FString UInterchangeFactoryBaseNode::GetKeyDisplayName(const UE::Interchange::FAttributeKey& NodeAttributeKey) const
{
	...
	{
		KeyDisplayName = UE::Interchange::BuildDisplayNameForArrayKey(TEXT("Factory Dependencies Index "), OriginalKeyName);
	}
...
{
	UE_LOGF(LogInterchangeCore, Error, "GetFactoryDependency is deprecated and will not return correct value. Please use GetFactoryDependencies/HasFactoryDependency instead.");
}

TSet<FString> UInterchangeFactoryBaseNode::GetFactoryDependencies() const
{
	return FactoryDependencies.ToSet();
}

bool UInterchangeFactoryBaseNode::HasFactoryDependency(const FString& DependencyUid) const
{
	return FactoryDependencies.HasItem(DependencyUid);
}
...
{
	const static FString FactoryPrefix = "Factory_";
