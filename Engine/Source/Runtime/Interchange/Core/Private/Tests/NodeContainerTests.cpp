...
bool FNodeContainerTest::RunTest(const FString& Parameters)
{
	...
	const FString TranslatedAssetNodePrefix = "TranslatedAssetNode_";
	...
	const FString TranslatedSceneNodePrefix = "TranslatedSceneNode_";
	...
	const FString FactoryNodePrefix = "FactoryNode_";
