...
#include "InterchangeLODMeshData.h"
...
namespace UE
{
	namespace Interchange
	{
		...
		enum class EAttributeTypes : int32
		{
			...
			InterchangeLODMeshData			= 112,
			InterchangeLODMeshDataArray		= 113,
		...
		protected:
			...
			EAttributeStorageResult MultiSizeSetAttribute(FAttributeAllocationInfo* AttributeAllocationInfo, int32 TargetAllocationIndex, const MultiSizeType& Value, const void* SourceDataPtr, bool& bOutNeedsDefrag);
