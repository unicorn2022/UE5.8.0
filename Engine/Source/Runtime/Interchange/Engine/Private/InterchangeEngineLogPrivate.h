...
public:
		...
		: TaskName(InTaskName)
	{
		...
		UE_LOGF(LogInterchangeEngine, Warning, "%ls", *MessageStr);
	}
...
private:
	...
	int32 TaskID = 0;
	FString TaskName;
	const FString TraceAsyncGameThreadStr = "Game Thread";
	const FString TraceAsyncBackgroundThreadStr = "Background Thread";
};
