...
public:
	...
	/* Parent track for this track. If a parent track is set, the track won't show up under the object binding. */
	UPROPERTY()
	TObjectPtr<UMovieSceneTrack> ParentTrack = nullptr;
	...
	UPROPERTY()
	bool bAutoExpandToKeyframes = true;
...
public:
	...
	/** The decoration container associated with the given row, or null if this track has no per-row containers. */
	virtual UMovieSceneDecorationContainerObject* GetDecorationContainerForRow(int32 RowIndex) const { return nullptr; }
