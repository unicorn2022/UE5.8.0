...
#if WITH_EDITOR
	/*
	 * Whether this playback client can play the given sequence in editor preview.
	 * This gives client actors an opportunity to add themselves to the list of preview contexts in the level editor.
	 */
	virtual bool CanPreview(const UMovieSceneSequence& InSequence) const
	{ 
		return false; 
	}
#endif
