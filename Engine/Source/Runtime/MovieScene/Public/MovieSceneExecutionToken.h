...
{
	virtual ~IMovieScenePreAnimatedToken() = default;
...
{
	virtual ~IMovieScenePreAnimatedTokenProducer()= default;
...
{
	virtual ~IMovieScenePreAnimatedGlobalToken() = default;
...
{
	virtual ~IMovieScenePreAnimatedGlobalTokenProducer() = default;
...
struct IMovieSceneSharedExecutionToken
{
	...
	virtual ~IMovieSceneSharedExecutionToken() = default;
