...
protected:
	...
	/** Cached playback settings for restoring when playback stops. This is used for temporary playback overrides, e.g. PlayLooping **/
	TOptional<FMovieSceneSequencePlaybackSettings> CachedPlaybackSettings;
