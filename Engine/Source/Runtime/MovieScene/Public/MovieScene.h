...
UE_DEPRECATED(5.8, "FMovieSceneOnChannelChanged is now deprecated. Use FMovieSceneOnChannelChangedWithTime")
...
struct FMovieSceneEditorData
{
	...
	/** Saved Sequence Navigator state to restore */
	UPROPERTY()
...
public:
	...
	*/
	...
	UE_DEPRECATED(5.8, "FMovieSceneOnChannelChanged OnChannelChanged() is now deprecated. Use FMovieSceneOnChannelChangedWithTime OnChannelChangedWithTime()")
	FMovieSceneOnChannelChanged& OnChannelChanged() { return OnChannelChangedDelegate_DEPRACRATED; }
	PRAGMA_ENABLE_DEPRECATION_WARNINGS

	FMovieSceneOnChannelChangedWithTime& OnChannelChangedWithTime() { return OnChannelChangedDelegate; }
#endif
...
public:
	...
	/* Remove null tracks on this movie scene. Returns true if any discovered and removed. */
	MOVIESCENE_API bool RemoveNullTracks();
...
private:
	...
	PRAGMA_DISABLE_DEPRECATION_WARNINGS
	FMovieSceneOnChannelChanged OnChannelChangedDelegate_DEPRACRATED;
	PRAGMA_ENABLE_DEPRECATION_WARNINGS
