...
struct FCachedProperty
{
	...
	FProperty* GetValidProperty() const
	{
		...
		if (ContainerAddress && PropertyPtr)
		{
			return PropertyPtr;
		}
		return nullptr;
...
// TEMP: disable this for dSTM-Linux build targets where weak object pointers seem to be larger
