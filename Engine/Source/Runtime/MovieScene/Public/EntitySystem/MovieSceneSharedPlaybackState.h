...
/**
* Playback capability for recording audio from sequences.
*/
struct FMovieSceneAudioRecordingCapability
{
	UE_DECLARE_MOVIESCENE_PLAYBACK_CAPABILITY_API(MOVIESCENE_API, FMovieSceneAudioRecordingCapability)

	// True when recording audio from scene, e.g. via MRQ.
	bool bIsRecordingAudio = false;
};
