...
namespace Audio
{
	...
	{
	public:
		virtual ~IAnalyzerSettings() = default;
	};
	...
	{
	public:
		virtual ~IAnalyzerResult() = default;
	};
	...
	{
	public:
		virtual ~IAnalyzerControls() = default;
	};
	...
	{
	public:
		virtual ~IAnalyzerWorker() = default;
	...
	public:
		...
		{
			static FName AudioExtFeatureName = FName("AudioAnalyzerPlugin");
