...
namespace Audio
{
	...
	{
		public:
			virtual ~IAnalyzerNRTSettings() = default;
	};
	...
	{
	public:
		virtual ~IAnalyzerNRTResult() = default;
	...
	{
	public:
		virtual ~IAnalyzerNRTWorker() = default;
	...
	{
	public:
		virtual ~IAnalyzerNRTFactory() = default;

		// Supplied unique name of IAnalyzerNRTFactory to enable querying of added 
		// analyzer factories
		static FName GetModularFeatureName()
		{
			static FName AudioExtFeatureName = FName("AudioAnalyzerNRTPlugin");
