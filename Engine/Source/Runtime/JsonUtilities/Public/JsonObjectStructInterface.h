...
struct FJsonObjectStructInterfaceRegistry
{
	...
	/* Return whether or not a struct converter has been registered for this ScriptStruct */
	static JSONUTILITIES_API bool HasStructConverterRegistered(const UScriptStruct* ScriptStruct);
};
