...
template<>
inline bool IsConcreteTypeCompatibleWithReflectedType_Impl<FDoubleInterval>(FProperty* Property)
{
	return IsConcreteTypeCompatibleWithReflectedType_BuiltInStruct<FDoubleInterval>(Property);
}
