...
{
	TRACE_CPUPROFILER_EVENT_SCOPE_STR("UE::Projects::Private::Read FPluginManifest");
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE_STR("FPluginManifest::Load");
	// Read the file to a string
	FString FileContents;
	{
		TRACE_CPUPROFILER_EVENT_SCOPE_STR("LoadFileToString");
