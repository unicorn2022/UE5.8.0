...
public:
	...
	virtual bool IsSceneGraphAnimationEnabled() const override
	{
		return Descriptor.bEnableSceneGraphAnimation;
	}

	virtual bool IsRootPlugin() const override
	{
		return Descriptor.bNoCode && Descriptor.bNoGameFeatureContent;
	}
...
public:
	...
	virtual FLeakedPackagesFoundEvent& OnLeakedPackagesFound() override;
...
private:
	...
	/** The callback that is called from within the PluginHandler when leaked packages are found */
	FLeakedPackagesFoundEvent LeakedPackagesFoundEvent;
};
