...
{
	static const FString Extension(".uplugin");
	return Extension;
}
...
TOptional<FText> UE::Projects::Private::Read(UE::Json::FConstObject Object, FPluginDescriptor& Result)
{
	...
	TryGetBoolField(Object, TEXT("EnableSceneGraphAnimation"), Result.bEnableSceneGraphAnimation);
	...
	TryGetBoolField(Object, TEXT("EnableIAS"), Result.bEnableIAS);
	...
	TryGetBoolField(Object, TEXT("NoGameFeatureContent"), Result.bNoGameFeatureContent);
...
void FPluginDescriptor::UpdateJson(FJsonObject& JsonObject) const
{
	...
	if (bEnableSceneGraphAnimation)
	{
		JsonObject.SetBoolField(TEXT("EnableSceneGraphAnimation"), bEnableSceneGraphAnimation);
	}
	else
	{
		JsonObject.RemoveField(TEXT("EnableSceneGraphAnimation"));
	}
	...
	if (!bEnableIAS)
	{
		JsonObject.SetBoolField(TEXT("EnableIAS"), bEnableIAS);
	}
	else
	{
		JsonObject.RemoveField(TEXT("EnableIAS"));
	}
	...
	{
		JsonObject.SetBoolField(TEXT("NoGameFeatureContent"), bNoGameFeatureContent);
	}
