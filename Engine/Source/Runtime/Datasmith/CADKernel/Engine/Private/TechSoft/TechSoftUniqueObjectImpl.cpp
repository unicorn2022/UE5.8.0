...
namespace UE::CADKernel::TechSoft
{
	...
	template<>
	void TUniqueObject<A3DAsmProductOccurrenceDataNX>::InitializeData()
	{
	...
	template<>
	A3DStatus TUniqueObject<A3DAsmProductOccurrenceDataNX>::GetData(const A3DEntity* InEntityPtr)
	{
	...
	template<>
	const A3DEntity* TUniqueObject<A3DAsmProductOccurrenceDataNX>::GetDefaultIndexerValue() const { return nullptr; }
	template<>
