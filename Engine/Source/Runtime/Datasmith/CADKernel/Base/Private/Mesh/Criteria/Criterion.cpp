...
TSharedPtr<FCriterion> FCriterion::CreateCriterion(ECriterion Type, double Value)
{
	...
	default:
		UE_LOGF(LogCADKernelBase, Warning, "CALL of \"FCriterion::CreateCriterion\" NOT EXPECTED");
		return TSharedPtr<FCriterion>();
	}
}
...
double FCriterion::DefaultValue(ECriterion Type)
{
	...
	default:
		UE_LOGF(LogCADKernelBase, Warning, "CALL of \"FCriterion::DefaultValue\" NOT EXPECTED");
		return 0.0;
	}
}
