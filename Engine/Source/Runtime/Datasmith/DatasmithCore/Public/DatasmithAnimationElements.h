...
{
public:
	virtual ~IDatasmithTransformAnimationElement() = default;
...
{
public:
	virtual ~IDatasmithVisibilityAnimationElement() = default;
...
{
public:
	virtual ~IDatasmithSubsequenceAnimationElement() = default;
...
{
public:
	virtual ~IDatasmithLevelSequenceElement() = default;
