...
{
public:
	virtual ~IDatasmithKeyValueProperty() = default;
...
{
public:
	virtual ~IDatasmithActorElement() = default;
...
{
public:
	virtual ~IDatasmithMeshElement() = default;
...
{
public:
	virtual ~IDatasmithMeshActorElement() = default;
...
{
public:
	virtual ~IDatasmithLightActorElement() = default;
...
{
public:
	virtual ~IDatasmithCameraActorElement() = default;
...
{
public:
	virtual ~IDatasmithMaterialIDElement() = default;
...
{
public:
	virtual ~IDatasmithMaterialElement() = default;
...
{
public:
	virtual ~IDatasmithMaterialInstanceElement() = default;
...
{
public:
	virtual ~IDatasmithDecalMaterialElement() = default;
...
{
public:
	virtual ~IDatasmithEnvironmentElement() = default;
...
{
public:
	virtual ~IDatasmithTextureElement() = default;
...
public:
	...
	*/
	...
	virtual ~IDatasmithShaderElement() = default;
...
public:
	...
	virtual ~IDatasmithCompositeTexture() = default;
...
{
public:
	virtual ~IDatasmithScene() = default;
