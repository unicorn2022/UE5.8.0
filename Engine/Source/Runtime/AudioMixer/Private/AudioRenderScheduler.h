...
namespace Audio
{
	...
	public:
		...
		static FAudioRenderStepId FromWaveInstancePlayOrder(const uint32 PlayOrder);
	...
	public:
		...
		// Dump the state of the scheduler after next run
		void DumpSteps();
#endif
	private:
...
#if ENABLE_AUDIO_DEBUG
		void DumpStepsInternal();
		void DumpOnError();

		bool bShouldDumpSteps = false;
		bool bDidDumpOnError = false;
#endif
