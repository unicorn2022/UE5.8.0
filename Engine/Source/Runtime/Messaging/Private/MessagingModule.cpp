...
UE_TRACE_CHANNEL_DEFINE(MessagingChannel,
	"UDP messaging traffic emitted by UdpMessagingTrace (node discovery, message summary/type info, lifecycle stages); "
	"visualized by the UDP Messaging Insights plugin as Timing View tracks.");
#endif
