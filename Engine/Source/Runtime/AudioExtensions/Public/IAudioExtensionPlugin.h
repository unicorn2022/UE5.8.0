...
public:
	...
	*/
	...
	{
		static FString DisplayName = FString("Generic Audio Plugin");
		return DisplayName;
	}
...
public:
	/** Virtual destructor */
	virtual ~IAudioSpatializationFactory() = default;

	// IModularFeature
	static FName GetModularFeatureName()
	{
		static FName AudioExtFeatureName = FName("AudioSpatializationPlugin");
	...
	{
		static FString DisplayName = FString("Generic Audio Spatialization Plugin");
		return DisplayName;
	}
...
public:
	/** Virtual destructor */
	virtual ~IAudioSourceDataOverrideFactory() = default;

	// IModularFeature
	static FName GetModularFeatureName()
	{
		static FName AudioExtFeatureName = FName("AudioSourceDataOverridePlugin");
		return AudioExtFeatureName;
	}
	...
	virtual FString GetDisplayName() override
	{
		static FString DisplayName = FString("Generic Audio Source Data Override Plugin");
		return DisplayName;
	}
	/* End IAudioPluginWithMetadata implementation */
...
public:
	/** Virtual destructor */
	virtual ~IAudioSourceDataOverride() = default;
...
public:
	/** Virtual destructor */
	virtual ~IAudioOcclusionFactory() = default;

	// IModularFeature
	static FName GetModularFeatureName()
	{
		static FName AudioExtFeatureName = FName("AudioOcclusionPlugin");
		return AudioExtFeatureName;
	}
	...
	virtual FString GetDisplayName() override
	{
		static FString DisplayName = FString("Generic Audio Occlusion Plugin");
		return DisplayName;
	}
	/* End IAudioPluginWithMetadata implementation */
...
public:
	/** Virtual destructor */
	virtual ~IAudioOcclusion() = default;
...
public:
	/** Virtual destructor */
	virtual ~IAudioModulationFactory() = default;

	// IModularFeature
	static FName GetModularFeatureName()
	{
		static FName AudioExtFeatureName = FName("AudioModulationPlugin");
		return AudioExtFeatureName;
	}
...
public:
	/** Virtual destructor */
	virtual ~IAudioReverbFactory() = default;

	// IModularFeature
	static FName GetModularFeatureName()
	{
		static FName AudioExtFeatureName = FName("AudioReverbPlugin");
		return AudioExtFeatureName;
	}
	...
	virtual FString GetDisplayName() override
	{
		static FString DisplayName = FString("Generic Audio Reverb Plugin");
		return DisplayName;
	}
	/* End IAudioPluginWithMetadata implementation */
...
{
public:
	virtual ~IAudioPluginListener() = default;
