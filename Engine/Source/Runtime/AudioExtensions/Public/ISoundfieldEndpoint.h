...
{
public:
	virtual ~ISoundfieldEndpointSettingsProxy() = default;
};
...
public:
	...
	virtual ~ISoundfieldEndpoint() = default;
...
public:
	/** Virtual destructor */
	virtual ~ISoundfieldEndpointFactory() = default;
	...
	{
		static FName SoundfieldEndpointName = FName("Soundfield Endpoint");
