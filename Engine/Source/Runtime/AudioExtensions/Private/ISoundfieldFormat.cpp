...
{
	static FName NoEncodingFormatName = FName("No Encoding");
	return NoEncodingFormatName;
}

FName ISoundfieldFactory::GetFormatNameForInheritedEncoding()
{
	static FName InheritedFormatName = FName("Inherited Encoding");
	return InheritedFormatName;
}

FName ISoundfieldFactory::GetModularFeatureName()
{
	static FName SoundfieldFactoryName = FName("Soundfield Format");
