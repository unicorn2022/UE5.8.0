...
public:
	...
	/** Returns the active custom time step. Requires a UFixedFrameRateCustomTimeStep; returns null otherwise. */
	UFUNCTION(BlueprintPure, Category="Utilities|Engine Time", meta=(DisplayName="Get Engine Custom Time Step"))
	static TIMEMANAGEMENT_API UEngineCustomTimeStep* GetEngineCustomTimeStep();
	...
	UFUNCTION(BlueprintPure, Category="Utilities|Engine Time", meta=(DisplayName="Get Custom Time Step Frame Rate"))
	static TIMEMANAGEMENT_API FFrameRate GetCustomTimeStepFrameRate();
};
