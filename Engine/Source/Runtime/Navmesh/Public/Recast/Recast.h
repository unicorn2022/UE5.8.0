...
///  @ingroup recast
///  @param[in,out]	areas				The triangle area ids. [Length: >= @p nt]
///  @param[in]		nt					The number of triangles.
///  @param[in]		areaId				The area id to assign instead of RC_WALKABLE_AREA.
/// @par
/// Used to apply an area id to all walkable triangles. Only replaces RC_WALKABLE_AREA, leaving other area ids unchanged.
NAVMESH_API void rcApplyAreaToTriangles(unsigned char* areas, const int nt, const unsigned char areaId);
//@UE END
