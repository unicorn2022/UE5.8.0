...
struct dtObstacleAvoidanceParams
{
	...
	dtReal weightToi;
	dtReal horizTime;
	dtReal sideBiasThreshold;	///< Threshold for side selection in prepare(), widens the dead zone for head-on encounters //@UE
	dtReal weightRightBias;		///< Weight for preferring right-side passing (reduces head-on oscillation) //@UE
