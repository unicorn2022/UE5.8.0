...
NAVMESH_API void duDrawCylinderArea(duDebugDraw* dd, const duReal* pos, const duReal radius, const duReal height, const unsigned int areaRGBAColor);
NAVMESH_API void duDrawBoxArea(duDebugDraw* dd, const duReal* pos, const duReal* extent, const unsigned int areaRGBAColor);
NAVMESH_API void duDrawConvexArea(duDebugDraw* dd, const duReal* verts, const int nverts, const duReal hmin, const duReal hmax, const unsigned int areaRGBAColor);
