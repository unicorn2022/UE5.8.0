...
public:
	...
	void SetDrawFlags(FMeshDrawSingleShaderBindings& ShaderBindings, ESlateShader InShaderType, bool bDrawDisabledEffect);
...
public:
	...
	static bool ShouldCompilePermutation(const FMaterialShaderPermutationParameters& Parameters)
	{
		return FSlateMaterialShaderPS::ShouldCompilePermutation(Parameters) && IsValidSlateMaterialShaderType(ShaderType, Parameters.Platform);
	}
