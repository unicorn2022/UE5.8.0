...
void FSlateMaterialShaderPS::SetDrawFlags(FMeshDrawSingleShaderBindings& ShaderBindings, ESlateShader InShaderType, bool bDrawDisabledEffect)
{
	FUintVector4 InDrawFlags((bDrawDisabledEffect ? 1u : 0u), uint32(InShaderType), 0, 0);
...
IMPLEMENT_SLATE_MATERIALSHADER_TYPE(Dynamic);
