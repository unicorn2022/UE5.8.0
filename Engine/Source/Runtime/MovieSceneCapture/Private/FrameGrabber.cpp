...
void FFrameGrabber::OnBackBufferReadyToPresentCallback(SWindow& SlateWindow, ISlateViewportProvider& ViewportProvider)
{
	...
	Surfaces[ThisCaptureIndex].Surface.ResolveRenderTarget(PrevFrameTarget, ViewportProvider.GetBackBufferResource(), [this, ThisCaptureIndex](FColor* ColorBuffer, int32 Width, int32 Height) {
		// Handle the frame
