...
public:
	...
	TSharedPtr<IPackageStoreBackend> CreatePackageStoreBackend() const;
	TSharedPtr<IIoDispatcherBackend> CreateIoDispatcherBackend() const;
...
private:
	...
	TArray<FAnsiString> AuthHeaders;
