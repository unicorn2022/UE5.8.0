...
struct FBodyCollisionFilterData
{
	...
	FBodyCollisionFilterData() = default;
	FBodyCollisionFilterData(const FBodyCollisionFilterData&) = default;
	FBodyCollisionFilterData(FBodyCollisionFilterData&&) = default;

	FBodyCollisionFilterData& operator=(const FBodyCollisionFilterData&) = default;
	FBodyCollisionFilterData& operator=(FBodyCollisionFilterData&&) = default;
	PRAGMA_ENABLE_DEPRECATION_WARNINGS

	UE_DEPRECATED(5.8, "Use the FilterInstanceData and Simple/Complex ShapeFilterData objects instead")
	...
	Chaos::Filter::FShapeFilterData SimpleShapeFilterData;
	Chaos::Filter::FShapeFilterData ComplexShapeFilterData;
};
...
public:
	...
	FChaosUserData(Chaos::FPhysicsObject* InPayload) 	:Type(EChaosUserDataType::PhysicsObject), Payload(InPayload) {}
...
template <> FORCEINLINE Chaos::FPhysicsObject* FChaosUserData::Get(void* UserData) { if (!UserData || ((FChaosUserData*)UserData)->Type != EChaosUserDataType::PhysicsObject) { return nullptr; } return (Chaos::FPhysicsObject*)((FChaosUserData*)UserData)->Payload; }
...
template <> FORCEINLINE void FChaosUserData::Set(void* UserData, Chaos::FPhysicsObject* Payload) { check(UserData); ((FChaosUserData*)UserData)->Type = EChaosUserDataType::PhysicsObject; ((FChaosUserData*)UserData)->Payload = Payload; }
...
struct UE_DEPRECATED(5.8, "Use Chaos::Filter::FQueryFilterData instead") FChaosFilterData
{
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
struct UE_DEPRECATED(5.8, "Use ChaosInterface::FSceneQueryCommonParams instead.") FChaosQueryFilterData
{
