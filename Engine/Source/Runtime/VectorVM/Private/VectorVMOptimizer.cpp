...
uint32 OptimizeVectorVMScript(const uint8 *InBytecode, int InBytecodeLen, FVectorVMExtFunctionData *ExtFnIOData, int NumExtFns, FVectorVMOptimizerContext* OptContext, uint64 HashId, uint32 Flags)
{
	...
	while (OpPtrIn < OpPtrInEnd)
	{
		...
		switch (OpCode)
		{
			...
			case EVectorVMOp::add:                                  VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::sub:                                  VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::mul:                                  VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::div:                                  VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::mad:                                  VVMOptimizeVecIns3;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::lerp:                                 VVMOptimizeVecIns3;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::rcp:                                  VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::rsq:                                  VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::sqrt:                                 VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::neg:                                  VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::abs:                                  VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::exp:                                  VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::exp2:                                 VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::log:                                  VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::log2:                                 VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::sin:                                  VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::cos:                                  VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::tan:                                  VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::asin:                                 VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::acos:                                 VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::atan:                                 VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::atan2:                                VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::ceil:                                 VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::floor:                                VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::fmod:                                 VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::frac:                                 VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::trunc:                                VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::clamp:                                VVMOptimizeVecIns3;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::min:                                  VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::max:                                  VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::pow:                                  VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::round:                                VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::sign:                                 VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::step:                                 VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::random:                               VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::noise:                                VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::cmplt:                                VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::cmple:                                VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::cmpgt:                                VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::cmpge:                                VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::cmpeq:                                VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::cmpneq:                               VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::select:                               VVMOptimizeVecIns3;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::addi:                                 VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::subi:                                 VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::muli:                                 VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::divi:                                 VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::clampi:                               VVMOptimizeVecIns3;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::mini:                                 VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::maxi:                                 VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::absi:                                 VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::negi:                                 VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::signi:                                VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::randomi:                              VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::cmplti:                               VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::cmplei:                               VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::cmpgti:                               VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::cmpgei:                               VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::cmpeqi:                               VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::cmpneqi:                              VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::bit_and:                              VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::bit_or:                               VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::bit_xor:                              VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::bit_not:                              VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::bit_lshift:                           VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::bit_rshift:                           VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::logic_and:                            VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::logic_or:                             VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::logic_xor:                            VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::logic_not:                            VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::f2i:                                  VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::i2f:                                  VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::f2b:                                  VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::b2f:                                  VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::i2b:                                  VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::b2i:                                  VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::fasi:                                 VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::iasf:                                 VVMOptimizeVecIns1;             UE_UNREACHABLE_CODE(break;)
			...
			case EVectorVMOp::exec_index:
				...
				OpPtrIn += 2;
				break;
			case EVectorVMOp::noise2D:                              VVMOptimizeVecIns2;             UE_UNREACHABLE_CODE(break;)
			case EVectorVMOp::noise3D:                              VVMOptimizeVecIns3;             UE_UNREACHABLE_CODE(break;)
