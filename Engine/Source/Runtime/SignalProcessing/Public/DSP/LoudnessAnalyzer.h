...
namespace Audio
{
    ...
    UE_API float GetEqualLoudnessAWeigthForFrequency(const float Freq);

	/** Generate equal loudness weight for magnitude spectrum using curve B */
    UE_API float GetEqualLoudnessBWeigthForFrequency(const float Freq);

	/** Generate equal loudness weight for magnitude spectrum using curve C */
    UE_API float GetEqualLoudnessCWeigthForFrequency(const float Freq);

	/** Generate equal loudness weight for magnitude spectrum using curve D */
    UE_API float GetEqualLoudnessDWeigthForFrequency(const float Freq);

	/** Generate equal loudness weight for magnitude spectrum using curve None */
    UE_API float GetEqualLoudnessNoneWeigthForFrequency(const float Freq);
