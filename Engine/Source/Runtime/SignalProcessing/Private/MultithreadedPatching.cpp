...
namespace Audio
{
	...
	int32 FPatchOutput::GetNumSamplesOverhead() const
	{
		return InternalBuffer.Remainder();
	}
	...
	int32 FPatchInput::GetNumSamplesOverhead() const
	{
		if (!OutputHandle.IsValid())
		{
			return 0;
		...
		return OutputHandle->GetNumSamplesOverhead();
	}
