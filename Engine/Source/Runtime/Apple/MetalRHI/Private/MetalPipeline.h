...
enum EMetalPipelineHashOffsets
{
	...
	Offset_BlendStateEnd = Offset_BlendState7 + NumBits_BlendState - 1, // 63
	...
	Offset_PrimitiveTopology = Offset_AlphaToCoverage + NumBits_AlphaToCoverage,
...
private:
	FDelegateHandle ApplicationWillDeactivateDelegateHandle;
	FDelegateHandle ApplicationHasReactivatedDelegateHandle;
