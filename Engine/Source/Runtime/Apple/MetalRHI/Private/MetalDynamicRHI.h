...
public:
...
#if PLATFORM_IOS
	virtual bool RHIReadViewportDataDirect(uint32& OutWidth, uint32& OutHeight, TArray<FColor>& OutData) final override;
#endif // PLATFORM_IOS
	...
	virtual FTextureRHIRef RHIGetViewportBackBufferAtLayerIndex(FRHIViewport* Viewport, uint32 DrawLayerIndex) final override;
	...
	virtual MTL::Device* RHIGetDevice() final override;
