...
public:
	...
	void UpdateDescriptor(FRHICommandListBase& RHICmdList, FRHIDescriptorHandle DescriptorHandle, IRDescriptorTableEntry Descriptor, EMetalDescriptorUpdateType UpdateType);
	...
	void UpdateDescriptor(FRHICommandListBase& RHICmdList, FRHIDescriptorHandle DescriptorHandle, FMetalBuffer* Buffer, EMetalDescriptorUpdateType UpdateType);
	...
	FMetalRHIBuffer* GetStandardResourceHeap() 
	{
		check(StandardResources.GetHeap());
		return StandardResources.GetHeap();
	}
	
	FMetalRHIBuffer* GetSamplerResourceHeap() 
	{
		check(SamplerResources.GetHeap());
		return SamplerResources.GetHeap();
	}
