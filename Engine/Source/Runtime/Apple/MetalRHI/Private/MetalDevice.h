...
public:
	...
	void EndDrawingViewport(const FRHIPresentArgs& InPresentArgs);
	...
	MTLSharedEventPtr CreateSharedEvent();
	...
	FMetalStaticSamplers* GetStaticSamplers()
	{
	...
	void ForceHeapSupport()
	{
		Features |= EMetalFeaturesHeaps;
	}
private:
	FMetalDevice(MTL::Device* MetalDevices);
...
private:
	...
	FMetalStaticSamplers* StaticSamplers;
#endif

#if METAL_RHI_RAYTRACING
	FMetalRayTracingCompactionRequestHandler* RayTracingCompactionRequestHandler;
	FMetalRayTracingPipelineCache* RayTracingPipelineCache;
...
public:
	...
	inline FMetalRayTracingPipelineCache* GetRayTracingPipelineCache() const { return RayTracingPipelineCache; }
