...
{
public:
    FMetalMeshShader(FMetalDevice& Device, const FRHICreateShaderDesc& CreateShaderDesc);
    FMetalMeshShader(FMetalDevice& Device, const FRHICreateShaderDesc& CreateShaderDesc, MTLLibraryPtr InLibrary);
