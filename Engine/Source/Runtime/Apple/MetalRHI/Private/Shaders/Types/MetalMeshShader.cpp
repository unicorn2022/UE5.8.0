...
FMetalMeshShader::FMetalMeshShader(FMetalDevice& MetalDevice, const FRHICreateShaderDesc& CreateShaderDesc)
...
FMetalMeshShader::FMetalMeshShader(FMetalDevice& MetalDevice, const FRHICreateShaderDesc& CreateShaderDesc, MTLLibraryPtr InLibrary)
	: TMetalBaseShader<FRHIMeshShader, SF_Mesh>(MetalDevice)
{
	FMetalCodeHeader Header;
