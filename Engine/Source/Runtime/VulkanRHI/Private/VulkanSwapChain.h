...
public:
	...
	/** Reset the current image index when a present is skipped (e.g. window destroyed). */
	void ResetCurrentImageIndex() { CurrentImageIndex = -1; }
...
protected:
	...
	int32 AcquireImageIndex(TRefCountPtr<FVulkanSemaphore>* OutSemaphore);
