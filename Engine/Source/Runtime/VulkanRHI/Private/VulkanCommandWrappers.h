...
struct FWrapLayer
{
	...
	static void CmdPushDescriptorSetKHR(VkResult Result, VkCommandBuffer CommandBuffer, VkPipelineBindPoint PipelineBindPoint, VkPipelineLayout Layout, uint32_t Set, uint32_t DescriptorWriteCount, const VkWriteDescriptorSet* DescriptorWrites) VULKAN_LAYER_BODY
	static void CmdPushDescriptorSet2KHR(VkResult Result, VkCommandBuffer CommandBuffer, const VkPushDescriptorSetInfo* PushDescriptorSetInfo) VULKAN_LAYER_BODY
	...
	static void CmdEndRenderPass2KHR(VkResult Result, VkCommandBuffer CommandBuffer, const VkSubpassEndInfo* SubpassEndInfo) VULKAN_LAYER_BODY
	...
	static void CmdEndRendering2KHR(VkResult Result, VkCommandBuffer CommandBuffer, const VkRenderingEndInfoKHR* RenderingEndInfo) VULKAN_LAYER_BODY
	...
	static void CmdSetDescriptorBufferOffsets2EXT(VkResult Result, VkCommandBuffer CommandBuffer, const VkSetDescriptorBufferOffsetsInfoEXT* SetDescriptorBufferOffsetsInfo) VULKAN_LAYER_BODY
	...
	static void CmdSetSampleMaskEXT(VkResult Result, VkCommandBuffer CommandBuffer, VkSampleCountFlagBits Samples, const VkSampleMask* SampleMask) VULKAN_LAYER_BODY
	static void CmdSetFragmentShadingRateKHR(VkResult Result, VkCommandBuffer CommandBuffer, const VkExtent2D* FragmentSize, const VkFragmentShadingRateCombinerOpKHR combinerOps[2]) VULKAN_LAYER_BODY

	static void CmdExecuteGeneratedCommandsEXT(VkResult Result, VkCommandBuffer CommandBuffer, VkBool32 IsPreprocessed, const VkGeneratedCommandsInfoEXT* GeneratedCommandsInfo) VULKAN_LAYER_BODY
	static void CmdPreprocessGeneratedCommandsEXT(VkResult Result, VkCommandBuffer CommandBuffer, const VkGeneratedCommandsInfoEXT* GeneratedCommandsInfo, VkCommandBuffer StateCommandBuffer) VULKAN_LAYER_BODY
	static void CreateIndirectCommandsLayoutEXT(VkResult Result, VkDevice Device, const VkIndirectCommandsLayoutCreateInfoEXT* CreateInfo, const VkAllocationCallbacks* Allocator, VkIndirectCommandsLayoutEXT* IndirectCommandsLayout) VULKAN_LAYER_BODY
	static void CreateIndirectExecutionSetEXT(VkResult Result, VkDevice Device, const VkIndirectExecutionSetCreateInfoEXT* CreateInfo, const VkAllocationCallbacks* Allocator, VkIndirectExecutionSetEXT* IndirectExecutionSet) VULKAN_LAYER_BODY
	static void DestroyIndirectCommandsLayoutEXT(VkResult Result, VkDevice Device, VkIndirectCommandsLayoutEXT IndirectCommandsLayout, const VkAllocationCallbacks* Allocator) VULKAN_LAYER_BODY
	static void DestroyIndirectExecutionSetEXT(VkResult Result, VkDevice Device, VkIndirectExecutionSetEXT IndirectExecutionSet, const VkAllocationCallbacks* Allocator) VULKAN_LAYER_BODY
	static void GetGeneratedCommandsMemoryRequirementsEXT(VkResult Result, VkDevice Device, const VkGeneratedCommandsMemoryRequirementsInfoEXT* Info, VkMemoryRequirements2* MemoryRequirements) VULKAN_LAYER_BODY
	static void UpdateIndirectExecutionSetPipelineEXT(VkResult Result, VkDevice Device, VkIndirectExecutionSetEXT IndirectExecutionSet, uint32_t ExecutionSetWriteCount, const VkWriteIndirectExecutionSetPipelineEXT* ExecutionSetWrites) VULKAN_LAYER_BODY
	static void UpdateIndirectExecutionSetShaderEXT(VkResult Result, VkDevice Device, VkIndirectExecutionSetEXT IndirectExecutionSet, uint32_t ExecutionSetWriteCount, const VkWriteIndirectExecutionSetShaderEXT* ExecutionSetWrites) VULKAN_LAYER_BODY
	...
	static void GetPastPresentationTimingEXT(VkResult Result, VkDevice Device, const VkPastPresentationTimingInfoEXT* PastPresentationTimingInfo, VkPastPresentationTimingPropertiesEXT* PastPresentationTimingProperties) VULKAN_LAYER_BODY
	static void GetSwapchainTimeDomainPropertiesEXT(VkResult Result, VkDevice Device, VkSwapchainKHR Swapchain, VkSwapchainTimeDomainPropertiesEXT* SwapchainTimeDomainProperties, uint64_t* TimeDomainsCounter) VULKAN_LAYER_BODY
	static void GetSwapchainTimingPropertiesEXT(VkResult Result, VkDevice Device, VkSwapchainKHR Swapchain, VkSwapchainTimingPropertiesEXT* SwapchainTimingProperties, uint64_t* SwapchainTimingPropertiesCounter) VULKAN_LAYER_BODY
	static void SetSwapchainPresentTimingQueueSizeEXT(VkResult Result, VkDevice Device, VkSwapchainKHR Swapchain, uint32_t Size) VULKAN_LAYER_BODY

	static void CmdBindResourceHeapEXT(VkResult Result, VkCommandBuffer CommandBuffer, const VkBindHeapInfoEXT* BindInfo) VULKAN_LAYER_BODY
	static void CmdBindSamplerHeapEXT(VkResult Result, VkCommandBuffer CommandBuffer, const VkBindHeapInfoEXT* BindInfo) VULKAN_LAYER_BODY
	static void CmdPushDataEXT(VkResult Result, VkCommandBuffer CommandBuffer, const VkPushDataInfoEXT* PushDataInfo) VULKAN_LAYER_BODY
	static void GetPhysicalDeviceDescriptorSizeEXT(VkDeviceSize OutSize, VkPhysicalDevice PhysicalDevice, VkDescriptorType DescriptorType) VULKAN_LAYER_BODY
	static void WriteResourceDescriptorsEXT(VkResult Result, VkDevice Device, uint32_t ResourceCount, const VkResourceDescriptorInfoEXT* Resources, const VkHostAddressRangeEXT* Descriptors) VULKAN_LAYER_BODY
	static void WriteSamplerDescriptorsEXT(VkResult Result, VkDevice Device, uint32_t SamplerCount, const VkSamplerCreateInfo* Samplers, const VkHostAddressRangeEXT* Descriptors) VULKAN_LAYER_BODY

	static void CmdSetRenderingAttachmentLocationsKHR(VkResult Result, VkCommandBuffer CommandBuffer, const VkRenderingAttachmentLocationInfo* LocationInfo) VULKAN_LAYER_BODY
	static void CmdSetRenderingInputAttachmentIndicesKHR(VkResult Result, VkCommandBuffer CommandBuffer, const VkRenderingInputAttachmentIndexInfo* InputAttachmentIndexInfo) VULKAN_LAYER_BODY
};
...
namespace VulkanRHI
{
	...
	static FORCEINLINE_DEBUGGABLE void  vkCmdPushDescriptorSetKHR(VkCommandBuffer CommandBuffer, VkPipelineBindPoint PipelineBindPoint, VkPipelineLayout Layout, uint32_t Set, uint32_t DescriptorWriteCount, const VkWriteDescriptorSet* DescriptorWrites)
	{
		FWrapLayer::CmdPushDescriptorSetKHR(VK_RESULT_MAX_ENUM, CommandBuffer, PipelineBindPoint, Layout, Set, DescriptorWriteCount, DescriptorWrites);
		VULKANAPINAMESPACE::vkCmdPushDescriptorSetKHR(CommandBuffer, PipelineBindPoint, Layout, Set, DescriptorWriteCount, DescriptorWrites);
		FWrapLayer::CmdPushDescriptorSetKHR(VK_SUCCESS, CommandBuffer, PipelineBindPoint, Layout, Set, DescriptorWriteCount, DescriptorWrites);
	}

	static FORCEINLINE_DEBUGGABLE void  vkCmdPushDescriptorSet2KHR(VkCommandBuffer CommandBuffer, const VkPushDescriptorSetInfo* PushDescriptorSetInfo)
	{
		FWrapLayer::CmdPushDescriptorSet2KHR(VK_RESULT_MAX_ENUM, CommandBuffer, PushDescriptorSetInfo);
		VULKANAPINAMESPACE::vkCmdPushDescriptorSet2KHR(CommandBuffer, PushDescriptorSetInfo);
		FWrapLayer::CmdPushDescriptorSet2KHR(VK_SUCCESS, CommandBuffer, PushDescriptorSetInfo);
	}
	...
	// The VK_EXT_fragment_density_map_offset extension requires EndRenderPass2KHR so that we can pack extra info into the struct chain to specify the offsets
 	static FORCEINLINE_DEBUGGABLE void vkCmdEndRenderPass2KHR(VkCommandBuffer CommandBuffer, const VkSubpassEndInfo* SubpassEndInfo)
 	{
		FWrapLayer::CmdEndRenderPass2KHR(VK_RESULT_MAX_ENUM, CommandBuffer, SubpassEndInfo);
 		VULKANAPINAMESPACE::vkCmdEndRenderPass2KHR(CommandBuffer, SubpassEndInfo);
 		FWrapLayer::CmdEndRenderPass2KHR(VK_SUCCESS, CommandBuffer, SubpassEndInfo);
 	}
	...
	static FORCEINLINE_DEBUGGABLE void vkCmdEndRendering2KHR(VkCommandBuffer CommandBuffer, const VkRenderingEndInfoKHR* RenderingEndInfo)
	{
		FWrapLayer::CmdEndRendering2KHR(VK_RESULT_MAX_ENUM, CommandBuffer, RenderingEndInfo);
		VULKANAPINAMESPACE::vkCmdEndRendering2KHR(CommandBuffer, RenderingEndInfo);
		FWrapLayer::CmdEndRendering2KHR(VK_SUCCESS, CommandBuffer, RenderingEndInfo);
	}
	...
	static FORCEINLINE_DEBUGGABLE void vkCmdSetDescriptorBufferOffsets2EXT(VkCommandBuffer CommandBuffer, const VkSetDescriptorBufferOffsetsInfoEXT* SetDescriptorBufferOffsetsInfo)
	{
		FWrapLayer::CmdSetDescriptorBufferOffsets2EXT(VK_RESULT_MAX_ENUM, CommandBuffer, SetDescriptorBufferOffsetsInfo);
		VULKANAPINAMESPACE::vkCmdSetDescriptorBufferOffsets2EXT(CommandBuffer, SetDescriptorBufferOffsetsInfo);
		FWrapLayer::CmdSetDescriptorBufferOffsets2EXT(VK_SUCCESS, CommandBuffer, SetDescriptorBufferOffsetsInfo);
	}
	...
	static FORCEINLINE_DEBUGGABLE void vkCmdSetSampleMaskEXT(VkCommandBuffer CommandBuffer, VkSampleCountFlagBits Samples, const VkSampleMask* SampleMask)
	{
		FWrapLayer::CmdSetSampleMaskEXT(VK_RESULT_MAX_ENUM, CommandBuffer, Samples, SampleMask);
		VULKANAPINAMESPACE::vkCmdSetSampleMaskEXT(CommandBuffer, Samples, SampleMask);
		FWrapLayer::CmdSetSampleMaskEXT(VK_SUCCESS, CommandBuffer, Samples, SampleMask);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetFragmentShadingRateKHR(VkCommandBuffer CommandBuffer, const VkExtent2D* FragmentSize, const VkFragmentShadingRateCombinerOpKHR combinerOps[2])
	{
		FWrapLayer::CmdSetFragmentShadingRateKHR(VK_RESULT_MAX_ENUM, CommandBuffer, FragmentSize, combinerOps);
		VULKANAPINAMESPACE::vkCmdSetFragmentShadingRateKHR(CommandBuffer, FragmentSize, combinerOps);
		FWrapLayer::CmdSetFragmentShadingRateKHR(VK_SUCCESS, CommandBuffer, FragmentSize, combinerOps);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdExecuteGeneratedCommandsEXT(VkCommandBuffer CommandBuffer, VkBool32 IsPreprocessed, const VkGeneratedCommandsInfoEXT* GeneratedCommandsInfo)
	{
		FWrapLayer::CmdExecuteGeneratedCommandsEXT(VK_RESULT_MAX_ENUM, CommandBuffer, IsPreprocessed, GeneratedCommandsInfo);
		VULKANAPINAMESPACE::vkCmdExecuteGeneratedCommandsEXT(CommandBuffer, IsPreprocessed, GeneratedCommandsInfo);
		FWrapLayer::CmdExecuteGeneratedCommandsEXT(VK_SUCCESS, CommandBuffer, IsPreprocessed, GeneratedCommandsInfo);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdPreprocessGeneratedCommandsEXT(VkCommandBuffer CommandBuffer, const VkGeneratedCommandsInfoEXT* GeneratedCommandsInfo, VkCommandBuffer StateCommandBuffer)
	{
		FWrapLayer::CmdPreprocessGeneratedCommandsEXT(VK_RESULT_MAX_ENUM, CommandBuffer, GeneratedCommandsInfo, StateCommandBuffer);
		VULKANAPINAMESPACE::vkCmdPreprocessGeneratedCommandsEXT(CommandBuffer, GeneratedCommandsInfo, StateCommandBuffer);
		FWrapLayer::CmdPreprocessGeneratedCommandsEXT(VK_SUCCESS, CommandBuffer, GeneratedCommandsInfo, StateCommandBuffer);
	}

	static FORCEINLINE_DEBUGGABLE VkResult vkCreateIndirectCommandsLayoutEXT(VkDevice Device, const VkIndirectCommandsLayoutCreateInfoEXT* CreateInfo, const VkAllocationCallbacks* Allocator, VkIndirectCommandsLayoutEXT* IndirectCommandsLayout)
	{
		FWrapLayer::CreateIndirectCommandsLayoutEXT(VK_RESULT_MAX_ENUM, Device, CreateInfo, Allocator, IndirectCommandsLayout);
		VkResult Result = VULKANAPINAMESPACE::vkCreateIndirectCommandsLayoutEXT(Device, CreateInfo, Allocator, IndirectCommandsLayout);
		FWrapLayer::CreateIndirectCommandsLayoutEXT(VK_SUCCESS, Device, CreateInfo, Allocator, IndirectCommandsLayout);
		return Result;
	}

	static FORCEINLINE_DEBUGGABLE VkResult vkCreateIndirectExecutionSetEXT(VkDevice Device, const VkIndirectExecutionSetCreateInfoEXT* CreateInfo, const VkAllocationCallbacks* Allocator, VkIndirectExecutionSetEXT* IndirectExecutionSet)
	{
		FWrapLayer::CreateIndirectExecutionSetEXT(VK_RESULT_MAX_ENUM, Device, CreateInfo, Allocator, IndirectExecutionSet);
		VkResult Result = VULKANAPINAMESPACE::vkCreateIndirectExecutionSetEXT(Device, CreateInfo, Allocator, IndirectExecutionSet);
		FWrapLayer::CreateIndirectExecutionSetEXT(VK_SUCCESS, Device, CreateInfo, Allocator, IndirectExecutionSet);
		return Result;
	}

	static FORCEINLINE_DEBUGGABLE void vkDestroyIndirectCommandsLayoutEXT(VkDevice Device, VkIndirectCommandsLayoutEXT IndirectCommandsLayout, const VkAllocationCallbacks* Allocator)
	{
		FWrapLayer::DestroyIndirectCommandsLayoutEXT(VK_RESULT_MAX_ENUM, Device, IndirectCommandsLayout, Allocator);
		VULKANAPINAMESPACE::vkDestroyIndirectCommandsLayoutEXT(Device, IndirectCommandsLayout, Allocator);
		FWrapLayer::DestroyIndirectCommandsLayoutEXT(VK_SUCCESS, Device, IndirectCommandsLayout, Allocator);
	}

	static FORCEINLINE_DEBUGGABLE void vkDestroyIndirectExecutionSetEXT(VkDevice Device, VkIndirectExecutionSetEXT IndirectExecutionSet, const VkAllocationCallbacks* Allocator)
	{
		FWrapLayer::DestroyIndirectExecutionSetEXT(VK_RESULT_MAX_ENUM, Device, IndirectExecutionSet, Allocator);
		VULKANAPINAMESPACE::vkDestroyIndirectExecutionSetEXT(Device, IndirectExecutionSet, Allocator);
		FWrapLayer::DestroyIndirectExecutionSetEXT(VK_SUCCESS, Device, IndirectExecutionSet, Allocator);
	}

	static FORCEINLINE_DEBUGGABLE void vkGetGeneratedCommandsMemoryRequirementsEXT(VkDevice Device, const VkGeneratedCommandsMemoryRequirementsInfoEXT* Info, VkMemoryRequirements2* MemoryRequirements)
	{
		FWrapLayer::GetGeneratedCommandsMemoryRequirementsEXT(VK_RESULT_MAX_ENUM, Device, Info, MemoryRequirements);
		VULKANAPINAMESPACE::vkGetGeneratedCommandsMemoryRequirementsEXT(Device, Info, MemoryRequirements);
		FWrapLayer::GetGeneratedCommandsMemoryRequirementsEXT(VK_SUCCESS, Device, Info, MemoryRequirements);
	}

	static FORCEINLINE_DEBUGGABLE void vkUpdateIndirectExecutionSetPipelineEXT(VkDevice Device, VkIndirectExecutionSetEXT IndirectExecutionSet, uint32_t ExecutionSetWriteCount, const VkWriteIndirectExecutionSetPipelineEXT* ExecutionSetWrites)
	{
		FWrapLayer::UpdateIndirectExecutionSetPipelineEXT(VK_RESULT_MAX_ENUM, Device, IndirectExecutionSet, ExecutionSetWriteCount, ExecutionSetWrites);
		VULKANAPINAMESPACE::vkUpdateIndirectExecutionSetPipelineEXT(Device, IndirectExecutionSet, ExecutionSetWriteCount, ExecutionSetWrites);
		FWrapLayer::UpdateIndirectExecutionSetPipelineEXT(VK_SUCCESS, Device, IndirectExecutionSet, ExecutionSetWriteCount, ExecutionSetWrites);
	}

	static FORCEINLINE_DEBUGGABLE void vkUpdateIndirectExecutionSetShaderEXT(VkDevice Device, VkIndirectExecutionSetEXT IndirectExecutionSet, uint32_t ExecutionSetWriteCount, const VkWriteIndirectExecutionSetShaderEXT* ExecutionSetWrites)
	{
		FWrapLayer::UpdateIndirectExecutionSetShaderEXT(VK_RESULT_MAX_ENUM, Device, IndirectExecutionSet, ExecutionSetWriteCount, ExecutionSetWrites);
		VULKANAPINAMESPACE::vkUpdateIndirectExecutionSetShaderEXT(Device, IndirectExecutionSet, ExecutionSetWriteCount, ExecutionSetWrites);
		FWrapLayer::UpdateIndirectExecutionSetShaderEXT(VK_SUCCESS, Device, IndirectExecutionSet, ExecutionSetWriteCount, ExecutionSetWrites);
	}
	...
	static FORCEINLINE_DEBUGGABLE VkResult vkGetPastPresentationTimingEXT(VkDevice Device, const VkPastPresentationTimingInfoEXT* PastPresentationTimingInfo, VkPastPresentationTimingPropertiesEXT* PastPresentationTimingProperties)
	{
		FWrapLayer::GetPastPresentationTimingEXT(VK_RESULT_MAX_ENUM, Device, PastPresentationTimingInfo, PastPresentationTimingProperties);
		const VkResult Result = VULKANAPINAMESPACE::vkGetPastPresentationTimingEXT(Device, PastPresentationTimingInfo, PastPresentationTimingProperties);
		FWrapLayer::GetPastPresentationTimingEXT(Result, Device, PastPresentationTimingInfo, PastPresentationTimingProperties);
		return Result;
	}

	static FORCEINLINE_DEBUGGABLE VkResult vkGetSwapchainTimeDomainPropertiesEXT(VkDevice Device, VkSwapchainKHR Swapchain, VkSwapchainTimeDomainPropertiesEXT* SwapchainTimeDomainProperties, uint64_t* TimeDomainsCounter)
	{
		FWrapLayer::GetSwapchainTimeDomainPropertiesEXT(VK_RESULT_MAX_ENUM, Device, Swapchain, SwapchainTimeDomainProperties, TimeDomainsCounter);
		const VkResult Result = VULKANAPINAMESPACE::vkGetSwapchainTimeDomainPropertiesEXT(Device, Swapchain, SwapchainTimeDomainProperties, TimeDomainsCounter);
		FWrapLayer::GetSwapchainTimeDomainPropertiesEXT(Result, Device, Swapchain, SwapchainTimeDomainProperties, TimeDomainsCounter);
		return Result;
	}

	static FORCEINLINE_DEBUGGABLE VkResult vkGetSwapchainTimingPropertiesEXT(VkDevice Device, VkSwapchainKHR Swapchain, VkSwapchainTimingPropertiesEXT* SwapchainTimingProperties, uint64_t* SwapchainTimingPropertiesCounter)
	{
		FWrapLayer::GetSwapchainTimingPropertiesEXT(VK_RESULT_MAX_ENUM, Device, Swapchain, SwapchainTimingProperties, SwapchainTimingPropertiesCounter);
		const VkResult Result = VULKANAPINAMESPACE::vkGetSwapchainTimingPropertiesEXT(Device, Swapchain, SwapchainTimingProperties, SwapchainTimingPropertiesCounter);
		FWrapLayer::GetSwapchainTimingPropertiesEXT(Result, Device, Swapchain, SwapchainTimingProperties, SwapchainTimingPropertiesCounter);
		return Result;
	}

	static FORCEINLINE_DEBUGGABLE VkResult vkSetSwapchainPresentTimingQueueSizeEXT(VkDevice Device, VkSwapchainKHR Swapchain, uint32_t Size)
	{
		FWrapLayer::SetSwapchainPresentTimingQueueSizeEXT(VK_RESULT_MAX_ENUM, Device, Swapchain, Size);
		const VkResult Result = VULKANAPINAMESPACE::vkSetSwapchainPresentTimingQueueSizeEXT(Device, Swapchain, Size);
		FWrapLayer::SetSwapchainPresentTimingQueueSizeEXT(Result, Device, Swapchain, Size);
		return Result;
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdBindResourceHeapEXT(VkCommandBuffer CommandBuffer, const VkBindHeapInfoEXT* BindInfo)
	{
		FWrapLayer::CmdBindResourceHeapEXT(VK_RESULT_MAX_ENUM, CommandBuffer, BindInfo);
		VULKANAPINAMESPACE::vkCmdBindResourceHeapEXT(CommandBuffer, BindInfo);
		FWrapLayer::CmdBindResourceHeapEXT(VK_SUCCESS, CommandBuffer, BindInfo);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdBindSamplerHeapEXT(VkCommandBuffer CommandBuffer, const VkBindHeapInfoEXT* BindInfo)
	{
		FWrapLayer::CmdBindSamplerHeapEXT(VK_RESULT_MAX_ENUM, CommandBuffer, BindInfo);
		VULKANAPINAMESPACE::vkCmdBindSamplerHeapEXT(CommandBuffer, BindInfo);
		FWrapLayer::CmdBindSamplerHeapEXT(VK_SUCCESS, CommandBuffer, BindInfo);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdPushDataEXT(VkCommandBuffer CommandBuffer, const VkPushDataInfoEXT* PushDataInfo)
	{
		FWrapLayer::CmdPushDataEXT(VK_RESULT_MAX_ENUM, CommandBuffer, PushDataInfo);
		VULKANAPINAMESPACE::vkCmdPushDataEXT(CommandBuffer, PushDataInfo);
		FWrapLayer::CmdPushDataEXT(VK_SUCCESS, CommandBuffer, PushDataInfo);
	}

	static FORCEINLINE_DEBUGGABLE VkDeviceSize vkGetPhysicalDeviceDescriptorSizeEXT(VkPhysicalDevice PhysicalDevice, VkDescriptorType DescriptorType)
	{
		FWrapLayer::GetPhysicalDeviceDescriptorSizeEXT(0, PhysicalDevice, DescriptorType);
		const VkDeviceSize OutSize = VULKANAPINAMESPACE::vkGetPhysicalDeviceDescriptorSizeEXT(PhysicalDevice, DescriptorType);
		FWrapLayer::GetPhysicalDeviceDescriptorSizeEXT(OutSize, PhysicalDevice, DescriptorType);
		return OutSize;
	}

	static FORCEINLINE_DEBUGGABLE VkResult vkWriteResourceDescriptorsEXT(VkDevice Device, uint32_t ResourceCount, const VkResourceDescriptorInfoEXT* Resources, const VkHostAddressRangeEXT* Descriptors)
	{
		FWrapLayer::WriteResourceDescriptorsEXT(VK_RESULT_MAX_ENUM, Device, ResourceCount, Resources, Descriptors);
		const VkResult Result = VULKANAPINAMESPACE::vkWriteResourceDescriptorsEXT(Device, ResourceCount, Resources, Descriptors);
		FWrapLayer::WriteResourceDescriptorsEXT(Result, Device, ResourceCount, Resources, Descriptors);
		return Result;
	}

	static FORCEINLINE_DEBUGGABLE VkResult vkWriteSamplerDescriptorsEXT(VkDevice Device, uint32_t SamplerCount, const VkSamplerCreateInfo* Samplers, const VkHostAddressRangeEXT* Descriptors)
	{
		FWrapLayer::WriteSamplerDescriptorsEXT(VK_RESULT_MAX_ENUM, Device, SamplerCount, Samplers, Descriptors);
		const VkResult Result = VULKANAPINAMESPACE::vkWriteSamplerDescriptorsEXT(Device, SamplerCount, Samplers, Descriptors);
		FWrapLayer::WriteSamplerDescriptorsEXT(Result, Device, SamplerCount, Samplers, Descriptors);
		return Result;
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetRenderingAttachmentLocationsKHR(VkCommandBuffer CommandBuffer, const VkRenderingAttachmentLocationInfo* LocationInfo)
	{
		FWrapLayer::CmdSetRenderingAttachmentLocationsKHR(VK_RESULT_MAX_ENUM, CommandBuffer, LocationInfo);
		VULKANAPINAMESPACE::vkCmdSetRenderingAttachmentLocationsKHR(CommandBuffer, LocationInfo);
		FWrapLayer::CmdSetRenderingAttachmentLocationsKHR(VK_SUCCESS, CommandBuffer, LocationInfo);
	}

	static FORCEINLINE_DEBUGGABLE void vkCmdSetRenderingInputAttachmentIndicesKHR(VkCommandBuffer CommandBuffer, const VkRenderingInputAttachmentIndexInfo* InputAttachmentIndexInfo)
	{
		FWrapLayer::CmdSetRenderingInputAttachmentIndicesKHR(VK_RESULT_MAX_ENUM, CommandBuffer, InputAttachmentIndexInfo);
		VULKANAPINAMESPACE::vkCmdSetRenderingInputAttachmentIndicesKHR(CommandBuffer, InputAttachmentIndexInfo);
		FWrapLayer::CmdSetRenderingInputAttachmentIndicesKHR(VK_SUCCESS, CommandBuffer, InputAttachmentIndexInfo);
	}
