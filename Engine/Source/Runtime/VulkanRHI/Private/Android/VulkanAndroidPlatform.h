...
// Enabling debugging gives access to features that have little cost unless enabled (Validation Layer, Renderdoc detection, etc.)
// Because Development is slower on Android, more testing using validation layer occurs on Test builds.
#define VULKAN_HAS_DEBUGGING_ENABLED				(UE_BUILD_DEBUG || UE_BUILD_DEVELOPMENT || UE_BUILD_TEST)
...
public:
	...
	static bool IsWaitingForWindowCreated();
#endif
