...
public:
	...
	virtual IVulkanMemoryAllocator* RHIGetVulkanMemoryAllocator() final override;
	...
	virtual VkCommandBuffer  RHIGetVkCommandBuffer(FRHICommandListBase& ExecutingCmdList) const final override;
	...
	virtual FComputeShaderRHIRef RHICreateComputeShader(const FRHICreateShaderDesc& CreateShaderDesc) final override;
	...
	virtual void RHIResizeViewport(FRHIViewport* Viewport, uint32 SizeX, uint32 SizeY, bool bIsFullscreen, EPixelFormat PixelFormat) final override;
	...
	virtual IRHICommandContext* RHIGetParallelCommandContext(FRHIParallelRenderPassInfo const& ParallelRenderPass) final override;
	...
	virtual void RHISetFDMOffsets(const FVector2f GazePoint[2], FIntPoint FramebufferSize);
...
protected:
	...
	VkDebugUtilsMessengerEXT AddressBindingMessenger = VK_NULL_HANDLE;
