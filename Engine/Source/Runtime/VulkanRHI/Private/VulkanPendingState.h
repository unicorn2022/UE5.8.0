...
public:
	...
	{
		return CurrentState->GetUniformBuffers(Stage);
	}
	...
	FVulkanComputePipelineDescriptorState& GetCurrentState()
	{
		return *CurrentState;
	}
...
public:
	...
	FVulkanGraphicsPipelineDescriptorState& GetCurrentState()
	{
		return *CurrentState;
	}
...
protected:
	...
	void UpdateInputAttachments(FVulkanCommandListContext& Context);
