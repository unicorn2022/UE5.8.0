...
//
class FVulkanSyncPoint final : public FRefCountedObject
{
...
protected:
	...
	TArray<TRefCountPtr<FVulkanSemaphore>> WaitSemaphores; // wait before command buffers
	TArray<FVulkanCommandBuffer*> CommandBuffers;
	TArray<TRefCountPtr<FVulkanSemaphore>> SignalSemaphores; // signaled after command buffers
