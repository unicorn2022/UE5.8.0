...
struct FVkRtBLASBuildData
{
	...
	TArray<VkAccelerationStructureGeometryLinearSweptSpheresDataNV, TInlineAllocator<1>> LSSSegments;
...
public:
	...
	virtual VkDeviceAddress GetDeviceAddress() const { return Address; }

	PRAGMA_DISABLE_DEPRECATION_WARNINGS
	virtual FRayTracingAccelerationStructureAddress GetAccelerationStructureAddress(uint64 GPUIndex) const final override { return GetDeviceAddress(); }
