...
public:
	...
	static ASSETREGISTRY_API TArray<FAssetData> GetAssetsWithOuterForPaths(TConstArrayView<FName> InPackagePaths, FName InOuterPath, bool bInRecursivePaths = false, bool bInIncludeOnlyOnDiskAsset = false, bool bInExactOuter = true);
	 ...
	 */
	static ASSETREGISTRY_API TArray<FAssetData> GetAssetsWithOuterForPaths(TConstArrayView<FName> InPackagePaths, FName InOuterPath, EAssetsWithOuterForPathsFlags InFlags = (EAssetsWithOuterForPathsFlags::ExactOuter | EAssetsWithOuterForPathsFlags::ScanPaths));
#endif
};
