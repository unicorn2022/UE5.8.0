...
class UE_JOIN(GathererClass, AssetClass, _Register) : public UE::AssetDependencyGatherer::Private::FRegisteredAssetDependencyGatherer \
{ \
...
namespace UE_JOIN(GathererClass, AssetClass) \
{ \
	static UE_JOIN(GathererClass, AssetClass, _Register) DefaultObject; \
}
