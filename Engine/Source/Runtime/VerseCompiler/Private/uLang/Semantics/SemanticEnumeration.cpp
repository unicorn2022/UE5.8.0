...
SmallDefinitionArray CEnumeration::FindTypeMember(const CSymbol& Name, EMemberOrigin Origin, const SQualifier& Qualifier, CVisitSet& VisitSet) const
{
    return CLogicalScope::FindDefinitions(Name, Origin, Qualifier, nullptr, VisitSet);
}
