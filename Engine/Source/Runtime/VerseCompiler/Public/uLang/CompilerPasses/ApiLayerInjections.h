...
class IPostParseInjection        : public TApiLayerInjection<IPostParseInjection, const Verse::Vst::TNodeRef<Verse::Vst::Snippet>&>                                { ULANG_FEATURE_ID_DECL(IPostParseInjection); };
class IPreSemAnalysisInjection   : public TApiLayerInjection<IPreSemAnalysisInjection, const Verse::Vst::TNodeRef<Verse::Vst::Project>&, const SProgramContext&>   { ULANG_FEATURE_ID_DECL(IPreSemAnalysisInjection); };
...
class IPostLinkInjection         : public TApiLayerInjection<IPostLinkInjection, const SProgramContext&>                                            { ULANG_FEATURE_ID_DECL(IPostLinkInjection); };
}
