...
public:
    virtual void FilterAst(const TSRef<CSemanticProgram>& SemanticResult, const Verse::Vst::TNodeRef<Verse::Vst::Project>& VstProject, const SBuildContext& BuildContext, const SProgramContext& ProgramContext) = 0;
};
