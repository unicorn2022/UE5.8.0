...
TModularFeatureRegHandle<FeatureType>::TModularFeatureRegHandle(Args_t&&... Args)
...
template<class FeatureType>
uLang::TModularFeatureRegHandle<FeatureType>::~TModularFeatureRegHandle()
{
...
template<class FeatureType>
TModularFeatureIterator<FeatureType>::operator bool() const
{
    return GetModularFeature<FeatureType>(_Index).IsSet();
}

template<class FeatureType>
bool TModularFeatureIterator<FeatureType>::operator!() const
{
    return !(bool)*this;
}

template<class FeatureType>
TSRef<FeatureType> TModularFeatureIterator<FeatureType>::Get() const
{
...
template<class FeatureType>
FeatureType& TModularFeatureIterator<FeatureType>::operator*() const
{
    return *Get();
}
...
template<class FeatureType>
void TModularFeatureIterator<FeatureType>::operator++()
{
    ++_Index;
}
