...
public:
    ...
    virtual void Filter(const Verse::Vst::TNodeRef<Verse::Vst::Snippet>& VstSnippet, const SBuildContext& BuildContext) override
    {
        StaticFilter(VstSnippet.As<Verse::Vst::Node>(), BuildContext);
    }
    //~ End IPostVstFilter interface

    static UE_API void StaticFilter(const Verse::Vst::TNodeRef<Verse::Vst::Node>& VstNode, const SBuildContext& BuildContext);

private:
    static UE_API void StaticFilterHelper(const Verse::Vst::TNodeRef<Verse::Vst::Node>& VstNode,
