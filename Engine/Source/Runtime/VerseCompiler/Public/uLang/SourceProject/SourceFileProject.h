...
public:
    ...
    virtual TOptional<Verse::Vst::TNodeRef<Verse::Vst::Snippet>> GetVst() const override { return _Vst; }
    virtual void SetVst(Verse::Vst::TNodeRef<Verse::Vst::Snippet> Snippet) override { _Vst = Snippet; };
...
private:
    ...
    TOptional<Verse::Vst::TNodeRef<Verse::Vst::Snippet>> _Vst;
