...
public:
    ...
    UE_API virtual SmallDefinitionArray FindTypeMember(const CSymbol& Name, EMemberOrigin Origin, const SQualifier& Qualifier, CVisitSet& VisitSet) const override;
