...
inline uint32_t GetTypeHash(const SCachedEffectSetToEffectClassesKey& Key)
{
...
public:
    ...
    UE_API virtual void ForAllDefinitions(EMemberOrigin, const TFunction<void(const CDefinition&)>&, CVisitSet&) const override;
    ...
    virtual bool IsEntitlementCompatConstraint() const override { return _bEntitlementCompatConstraint; }
...
public:
    ...
    UE_API virtual SmallDefinitionArray FindDefinitions(const CSymbol& Name, EMemberOrigin, const SQualifier& Qualifier, const CAstPackage* ContextPackage, CVisitSet&) const override;
    UE_API virtual void ForAllDefinitions(EMemberOrigin, const TFunction<void(const CDefinition&)>&, CVisitSet&) const override;
};
...
// Public data members
    ...
    // Entitlement class
    UE_API const CClassDefinition* GetEntitlementClassDefinition() const;
    ...
    CClass* _uhtComparableClass{nullptr}; // <uht_comparable> - native UHT structure that supports equality
    ...
    CClass* _expose_to_web_data_sync_service_reads{nullptr};
    CClass* _expose_to_web_data_sync_service_writes{nullptr};
    ...
    TCachedIntrinsicDefinition<CClassDefinition> _cpp_name_attribute{ *this, "/Verse.org/Native/cpp_name_attribute" };
    TCachedIntrinsicDefinition<CFunction> _cpp_name{ *this, "/Verse.org/Native/cpp_name" };
    ...
    TCachedIntrinsicDefinition<CFunction> _taskFunction{ *this, "/Verse.org/Concurrency/task" };

    TCachedIntrinsicDefinition<CClassDefinition> _leaderboardClassDefinition{ *this, "/Verse.org/Leaderboards/player_leaderboard" };

    TCachedIntrinsicDefinition<CClassDefinition> _entitlementClassDefinition{ *this, "/Fortnite.com/Marketplace/entitlement" };
    ...
    TCachedIntrinsicDefinition<CClassDefinition> _preload{ *this, "/Verse.org/Native/preload" };

    TCachedIntrinsicDefinition<CFunction> _MakeMessageInternalFunction{ *this, "/Verse.org/Verse/MakeMessageInternal" };
    TCachedIntrinsicDefinition<CFunction> _MakeAssetFunction{ *this, "/Verse.org/Assets/MakeAsset" };
    TCachedIntrinsicDefinition<CFunction> _MakeCollisionProfileFunction{ *this, "/Verse.org/SceneGraph/MakeCollisionProfile" };
    TCachedIntrinsicDefinition<CFunction> _InitializeComponentFieldFunction{ *this, "/Verse.org/SceneGraph/InitializeComponentField" };
...
// Methods
    ...
    const TSPtr<CSymbolTable>& GetSymbols() const { return _Symbols; }
    ...
    UE_API const SSymbolDefinitionArray* GetGlobalDefinitionsBySymbol(CSymbol Symbol) const;
...
private:
    ...
    TMap<CSymbol, SSymbolDefinitionArray> _GlobalSymbolMap;
