...
public:
    ...
    void GetPath(uLang::CUTF8StringBuilder& OutBuilder, const uLang::UTF8Char SeparatorChar, const uLang::EPathMode Mode) const
    {
        OutBuilder.Reset();
        ...
        {
            OutBuilder.AppendFormat("%c%s", SeparatorChar, AsNameCString());
        }
    }
    ...
    CUTF8String GetPath(const uLang::UTF8Char SeparatorChar, const uLang::EPathMode Mode) const
    {
        ...
        GetPath(Path, SeparatorChar, Mode);
