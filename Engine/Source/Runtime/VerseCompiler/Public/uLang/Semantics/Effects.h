...
inline uint32_t GetTypeHash(const SEffectSet& Effects)
{
...
{
    constexpr SEffectSet Bot{};
    constexpr SEffectSet Top = Bot
#define VISIT(Name) | EEffect::Name
        VERSE_ENUM_EFFECTS(VISIT);
#undef VISIT

    // Singular effects
    constexpr SEffectSet Converges          = Bot;
    ...
    constexpr SEffectSet ParametricTypeDefault = Converges;
    constexpr SEffectSet ModuleDefault = EEffect::allocates | EEffect::dictates | EEffect::diverges;
}
