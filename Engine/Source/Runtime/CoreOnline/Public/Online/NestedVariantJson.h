...
COREONLINE_API TSharedRef<FJsonObject> NestedVariantToJsonObject(const FNestedVariantJson::FMap& Map);

COREONLINE_API void NestedVariantFromJson(const char* InJson, FNestedVariantJson::FMapRef& Map);
COREONLINE_API void NestedVariantFromJson(const char* InJson, FNestedVariantJson::FMap& Map);
COREONLINE_API void NestedVariantFromJsonObject(const TSharedPtr<FJsonObject>& JsonObject, FNestedVariantJson::FMapRef& Map);
COREONLINE_API void NestedVariantFromJsonObject(const TSharedPtr<FJsonObject>& JsonObject, FNestedVariantJson::FMap& Map);
...
struct FJsonSerializerPolicy_NestedVariant
{
	...
	{
		FStackState() = default;
		explicit FStackState(const FGlobalState&) {}
	...
	COREONLINE_API static bool GetValueFromState(const FStackState& State, FValue& OutValue);
	COREONLINE_API static bool GetValueFromState(const FStackState& State, FArrayOfValues& OutArray);
	COREONLINE_API static bool GetValueFromState(const FStackState& State, FMapOfValues& OutMap);
	COREONLINE_API static void ResetValue(FValue& OutValue);
	COREONLINE_API static void ReadObjectStart(FStackState& State);
	COREONLINE_API static void ReadObjectEnd(FStackState& State, FValue& OutValue);
	COREONLINE_API static void ReadArrayStart(FStackState& State);
	COREONLINE_API static void ReadArrayEnd(FStackState& State, FValue& OutValue);
	...
	static void AddValueToObject(FStackState& State, const FString& Identifier, FValue& NewValue);
	static void AddValueToArray(FStackState& State, FValue& NewValue);
