...
const FKey EKeys::Gesture_Pan("Gesture_Pan");
const FKey EKeys::Gesture_Tap("Gesture_Tap");
const FKey EKeys::Gesture_LongPress("Gesture_LongPress");
...
void EKeys::Initialize()
{
	...
	AddKey(FKeyDetails(EKeys::Gesture_Pinch, LOCTEXT("Gesture_Pinch", "Pinch"), FKeyDetails::Gesture | FKeyDetails::Axis1D, "Gesture"));
	AddKey(FKeyDetails(EKeys::Gesture_Flick, LOCTEXT("Gesture_Flick", "Flick"), FKeyDetails::Gesture | FKeyDetails::Axis1D, "Gesture"));
	AddKey(FKeyDetails(EKeys::Gesture_Rotate, LOCTEXT("Gesture_Rotate", "Rotate"), FKeyDetails::Gesture | FKeyDetails::Axis1D, "Gesture"));
	AddKey(FKeyDetails(EKeys::Gesture_Pan, LOCTEXT("Gesture_Pan", "Pan"), FKeyDetails::Gesture | FKeyDetails::Axis2D, "Gesture"));
	AddKey(FKeyDetails(EKeys::Gesture_Tap, LOCTEXT("Gesture_Tap", "Tap"), FKeyDetails::Gesture | FKeyDetails::Axis2D, "Gesture"));
	AddKey(FKeyDetails(EKeys::Gesture_LongPress, LOCTEXT("Gesture_LongPress", "Long Press"), FKeyDetails::Gesture | FKeyDetails::Axis2D, "Gesture"));
...
{
	for (TMap<FKey, TSharedPtr<FKeyDetails> >::TIterator It(InputKeys); It; ++It)
	{
...
void EKeys::AddMenuCategoryDisplayInfo(const FName CategoryName, const FText DisplayName, const FName PaletteIcon)
{
	...
	{
		UE_LOGF(LogInput, Warning, "Category %ls already has menu display info that is being replaced.", *CategoryName.ToString());
	}
