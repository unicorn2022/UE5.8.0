...
public:
	...
	*/
	...
	void SetDefaultIfNull(FRDGBuilder& GraphBuilder, FRDGTextureRef& Out);
	void SetDefaultIfNull(FRDGBuilder& GraphBuilder, FRDGTextureUAVRef& Out);
	void SetDefaultIfNull(FRDGBuilder& GraphBuilder, TRDGBufferAccess<ERHIAccess::IndirectArgs>& Out);
	void SetDefaultIfNull(FRDGBuilder& GraphBuilder, FRDGBufferRef& Out);
	void SetDefaultIfNull(FRDGBuilder& GraphBuilder, FRDGBufferSRVRef& Out);
	void SetDefaultIfNull(FRDGBuilder& GraphBuilder, FRDGBufferUAVRef& Out);
