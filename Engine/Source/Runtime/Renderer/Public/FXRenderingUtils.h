...
class FSubstratePublicGlobalUniformParameters;
...
namespace UE::FXRenderingUtils
{
	...
	RENDERER_API TRDGUniformBufferRef<FSubstratePublicGlobalUniformParameters> GetSubstratePublicGlobalUniformBuffer(
		FRDGBuilder& GraphBuilder,
		TConstStridedView<FSceneView> Views);
	...
	namespace RayTracing
	{
		...
		RENDERER_API FRDGBufferSRVRef GetRayTracingSceneViewRDG(const FSceneInterface& Scene, const FSceneView& View);

		RENDERER_API FRHIShaderResourceView* GetInlineRayTracingBindingDataBuffer(const FSceneInterface& Scene);
