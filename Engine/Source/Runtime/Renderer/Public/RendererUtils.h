...
namespace Substrate
{
	UE_DEPRECATED(5.8, "Use the version that takes FSceneTextures instead")
	...
	RENDERER_API TRDGUniformBufferRef<FSubstratePublicGlobalUniformParameters> GetPublicGlobalUniformBuffer(FRDGBuilder& GraphBuilder, const FSceneTextures& SceneTextures);
}
