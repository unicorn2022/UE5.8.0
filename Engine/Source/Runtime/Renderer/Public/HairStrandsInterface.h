...
enum class EHairStrandsRayTracingPrimitiveType : uint8
{
	Procedural,
	Triangle,
	LinearSweptSphere,
...
struct FHairStrandsInstance : public FRefCountedObject
{
...
typedef TArray<TRefCountPtr<FHairStrandsInstance>> FHairStrandsInstances;
...
// Return true if Linear Swept Spheres enabled for hair strands
RENDERER_API bool IsHairStrandsLinearSweptSpheresEnabled();
