...
enum class ESingleLayerWaterVelocityOutputPass : uint8 
{ 
	None = 0, 
	DepthPrepass = 1, 
	BasePass = 2
...
bool CanSingleLayerWaterDepthPrepassOutputVelocity(EShaderPlatform ShaderPlatform, ERHIFeatureLevel::Type FeatureLevel, bool bIsGameThread = false);
ESingleLayerWaterVelocityOutputPass GetSingleLayerWaterVelocityOutputPass(bool bIsGameThread = false);
