...
public:
	...
	static FBox CalcCellBounds(const FLocation64& CellLoc)
	{
		FBox Box;
	...
	static FVector CalcCellCenter(const FLocation64& CellLoc)
	{
		return RenderingSpatialHash::CalcWorldCellCenter(CellLoc);
	}
