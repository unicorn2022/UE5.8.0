...
/**
 * Persistent scene-representation for VSM shadow rendering.
 */
...
public:
	 ...
	 */
	float GetLightMobilityFactor(FLightSceneId LightId) const;
...
private:
	...
	inline bool IsActive(FLightSceneId LightId) const { return ActiveLights[LightId]; }
	...
	TLightSparseArray<FLightCommonData> LightsCommonData;

	FLightCommonData& GetOrAddLightCommon(FLightSceneId LightId)
	{
	...
	FSceneLightBitArray ActiveLights;
