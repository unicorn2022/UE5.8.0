...
BEGIN_SHADER_PARAMETER_STRUCT(FEyeAdaptationScalarParameters, )
...
BEGIN_SHADER_PARAMETER_STRUCT(FEyeAdaptationParameters, )
	SHADER_PARAMETER_STRUCT_INCLUDE(FEyeAdaptationScalarParameters, Scalars)

	SHADER_PARAMETER_RDG_TEXTURE(Texture2D, ExposureCompensationCurveLUT)
	SHADER_PARAMETER_SAMPLER(SamplerState, ExposureCompensationCurveSampler)
	SHADER_PARAMETER_RDG_TEXTURE(Texture2D, MeterMaskTexture)
	SHADER_PARAMETER_SAMPLER(SamplerState, MeterMaskSampler)
END_SHADER_PARAMETER_STRUCT()

FEyeAdaptationScalarParameters GetEyeAdaptationScalarParameters(const FViewInfo& ViewInfo);
FEyeAdaptationParameters GetEyeAdaptationParameters(FRDGBuilder& GraphBuilder, const FViewInfo& ViewInfo);
