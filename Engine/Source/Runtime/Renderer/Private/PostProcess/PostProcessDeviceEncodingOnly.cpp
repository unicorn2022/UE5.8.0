...
extern uint32 DoesGamutWhitePointMatch(uint32 OutputGamut, const UE::Color::FColorSpace& ColorSpace);
...
FScreenPassTexture AddDeviceEncodingOnlyPass(FRDGBuilder& GraphBuilder, const FViewInfo& View, const FDeviceEncodingOnlyInputs& Inputs)
{
	...
	CommonParameters.ACESTonemapParameters.bScaleWhite = !DoesGamutWhitePointMatch(CommonParameters.OutputDevice.OutputGamut, LimitingColorSpace);
	UE::Color::ACES::GetTransformResources(
		GraphBuilder,
		CommonParameters.OutputDevice.OutputMaxLuminance,
		LimitingColorSpace,
	...
	CommonParameters.TotalSceneColorMultiplier = HDRPaperWhiteRatio * CommonParameters.ACESTonemapParameters.ACESSceneColorMultiplier;
