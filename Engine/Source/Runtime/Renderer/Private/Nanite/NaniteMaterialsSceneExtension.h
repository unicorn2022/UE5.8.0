...
public:
	...
	virtual ~FMaterialsSceneExtension();
	...
	TSharedPtr<bool> AddPendingRequestStaticMeshUpdate(const FPrimitiveSceneInfo* PrimitiveSceneInfo);
	void ClearPendingRequestStaticMeshUpdate(const FPrimitiveSceneInfo* PrimitiveSceneInfo);	
	bool HasPendingRequestStaticMeshUpdate(const FPrimitiveSceneInfo* PrimitiveSceneInfo);
...
private:
	...
	{
	public:
		static constexpr int32 MaterialScatterStride = 4;
	...
	FCriticalSection PrimitivesWithPendingRequestStaticMeshUpdateCS;
	TMap<const FPrimitiveSceneInfo*, TSharedPtr<bool>> PrimitivesWithPendingRequestStaticMeshUpdate;
};
