...
struct FShadeBinning
{
	...
	FRDGBufferRef ShadingDispatchArgs = nullptr;

	FRDGBufferRef ThreadGroupData = nullptr;
...
extern uint32 PackMaterialBitFlags(const FMaterial& Material, uint32 BoundTargetMask, bool bNoDerivativeOps, bool bVoxel, bool bCurve);
