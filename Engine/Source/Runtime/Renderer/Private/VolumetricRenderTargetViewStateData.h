...
public:
	...
	FRDGTextureRef GetOrCreateVolumetricReconstructRTForCloudOnTranslucent(FRDGBuilder& GraphBuilder);
	TRefCountPtr<IPooledRenderTarget> GetVolumetricReconstructRTForCloudOnTranslucent();
...
private:
	...
	TRefCountPtr<IPooledRenderTarget> VolumetricReconstructRTForCloudOnTranslucent;
