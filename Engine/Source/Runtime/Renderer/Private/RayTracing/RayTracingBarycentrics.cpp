...
void RenderRayTracingBarycentricsCS(FRDGBuilder& GraphBuilder, const FViewInfo& View, FRDGTextureRef SceneColor, ERayTracingSceneLayer LayerToTrace, bool bVisualizeProceduralPrimitives, bool bOutputTiming)
{
	FRayTracingBarycentricsCS::FParameters* PassParameters = GraphBuilder.AllocParameters<FRayTracingBarycentricsCS::FParameters>();

	PassParameters->TLAS = View.GetRayTracingSceneLayerViewChecked(LayerToTrace);
...
void RenderRayTracingBarycentricsRGS(FRDGBuilder& GraphBuilder, const FScene& Scene, const FViewInfo& View, FRDGTextureRef SceneColor, ERayTracingSceneLayer LayerToTrace, bool bOutputTiming)
{
	...
	RayGenParameters->TLAS = View.GetRayTracingSceneLayerViewChecked(LayerToTrace);
...
void RenderRayTracingBarycentrics(FRDGBuilder& GraphBuilder, const FScene& Scene, const FViewInfo& View, FRDGTextureRef SceneColor, ERayTracingSceneLayer LayerToTrace, bool bVisualizeProceduralPrimitives, bool bOutputTiming)
{
	...
	{
		RenderRayTracingBarycentricsCS(GraphBuilder, View, SceneColor, LayerToTrace, bVisualizeProceduralPrimitives, bOutputTiming);
	}
	else if (bRayTracingPipeline)
	{
		RenderRayTracingBarycentricsRGS(GraphBuilder, Scene, View, SceneColor, LayerToTrace, bOutputTiming);
	}
}
#endif
