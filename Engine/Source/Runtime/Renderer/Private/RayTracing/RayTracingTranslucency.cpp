...
static float GRayTracingTranslucencyPrimaryRayBias = 1e-5f;
...

	{
		...
		for (int32 ViewIndex = 0, Num = Views.Num(); ViewIndex < Num; ViewIndex++)
		{
			...
			RenderRayTracingPrimaryRaysView(
				...
				ERayTracingSceneLayer::Base, TranslucencySPP, GRayTracingTranslucencyHeightFog, ResolutionFraction,
