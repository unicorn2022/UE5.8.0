	...
	FRDGTextureRef DynamicBentNormalAOTexture)
{
	...
	bool bInlineReflectionAndSky = (NumLights == 1) && !bPrimitivesUseLightingChannels && (Scene.GetMobileDirectionalLightForView(0, View) != nullptr) && !(bPlanarReflection || bClusteredReflection || bSSR);
