...
FSkinnedMeshStateStreamImpl::FSkinnedMeshStateStreamImpl()
{
}
...
void FSkinnedMeshStateStreamImpl::Render_OnCreate(const FSkinnedMeshStaticState& Ss, const FSkinnedMeshDynamicState& Ds, FSkinnedMeshObject*& UserData, bool IsDestroyedInSameFrame)
{
	...
	FSceneInterface& Scene = *LaneUserData;
	...
	FPrimitiveSceneProxy* SceneProxy = FSkinnedMeshSceneProxyDesc::CreateSceneProxy(Desc, false);
...
void FSkinnedMeshStateStreamImpl::Render_OnDestroy(const FSkinnedMeshStaticState& Ss, const FSkinnedMeshDynamicState& Ds, FSkinnedMeshObject*& Object)
{
	if (Object)
	{
		Object->MeshObject->ReleaseResources();
		Object->Release();
		Object = nullptr;
	}
}

void FSkinnedMeshStateStreamImpl::Render_PostUpdate()
{
	TStateStream<FSkinnedMeshStateStreamSettings>::Render_PostUpdate();

	FSceneInterface& Scene = *LaneUserData;

	// TODO: Get rid of this entirely.. no need to create these queues of stuff when it can be done directly render side
	Scene.GetSkeletalMeshUpdater()->PushChangesToStream();
}
