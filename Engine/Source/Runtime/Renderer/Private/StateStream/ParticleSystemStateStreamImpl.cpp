...
FParticleSystemStateStreamCascade::FParticleSystemStateStreamCascade()
{
}
...
FParticleSystemHandle FParticleSystemStateStreamImpl::Game_CreateInstance(const FParticleSystemStaticState& Ss, const FParticleSystemDynamicState& Ds, uint32 LaneId)
{
