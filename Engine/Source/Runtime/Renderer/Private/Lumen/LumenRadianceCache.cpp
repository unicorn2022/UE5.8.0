...
void ClearRadianceProbeIndirectionTexture(FRDGBuilder& GraphBuilder, const FViewInfo& View, FRDGTextureRef RadianceProbeIndirectionTexture, ERDGPassFlags ComputePassFlags)
{
	...
	const FSceneTextures& SceneTextures)
{
	...
	ClearRadianceProbeIndirectionTexture(GraphBuilder, View, RadianceProbeIndirectionTexture, ERDGPassFlags::Compute);
	...
	if (GRadianceCacheUpdate != 0)
	{
		...
		for (int32 RadianceCacheIndex = 0; RadianceCacheIndex < InputArray.Num(); RadianceCacheIndex++)
		{
			...
			if (!Inputs.RadianceProbeIndirectionTexture)
			{
				...
				ClearRadianceProbeIndirectionTexture(GraphBuilder, Inputs.View, Outputs.RadianceCacheParameters.RadianceProbeIndirectionTexture, ClearPassFlags);
			}
		}
