...
BEGIN_SHADER_PARAMETER_STRUCT(FScreenProbeParameters, )
	...
	SHADER_PARAMETER(float, ScreenProbeInterpolationDepthWeightFoliage)
	SHADER_PARAMETER(float, ScreenProbeInterpolationDepthWeightFallback)
	...
	SHADER_PARAMETER_RDG_TEXTURE(Texture2D<UNORM float>, ScreenProbeDisocclusion)
...
extern void ScreenProbeGatherScreenData(
	FRDGBuilder& GraphBuilder,
	const FViewInfo& View,
