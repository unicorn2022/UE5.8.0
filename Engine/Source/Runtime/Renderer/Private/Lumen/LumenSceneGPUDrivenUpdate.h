...
namespace LumenScene
{
	...
	float GetCardTexelDensity(float SurfaceCacheResolution);
	float GetFarFieldCardTexelDensity();
	float GetFarFieldCardMaxDistance();
	int32 GetCardMinResolution(bool bOrthographicCamera, float LumenSceneDetail, float SurfaceCacheResolution);
