...
bool BuildSingleCascadeShadowInfo(FViewInfo &View, FVisibleLightInfoArray& VisibleLightInfos, FLightSceneInfo* LightSceneInfo, FProjectedShadowInfo& OUTSingleCascadeInfo)
{
	...
	const float SplitFar = Proxy->GetMaxShadowReceiverDistance(View, bPrecomputedLightingIsValid);
	...
	FSphere Bounds = Proxy->GetShadowSplitBoundsDepthRange(View, View.ViewMatrices.GetViewOrigin(), SplitNear, SplitFar, &Cascade);
