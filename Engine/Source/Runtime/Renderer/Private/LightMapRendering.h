...
/** Mobile Specific: SLW rendering */
class FMobileSingleLayerWaterPolicy
{
public:
	...
	static RENDERER_API bool ShouldCompilePermutation(const FMeshMaterialShaderPermutationParameters& Parameters);
	static RENDERER_API void ModifyCompilationEnvironment(const FMaterialShaderPermutationParameters& Parameters, FShaderCompilerEnvironment& OutEnvironment);
	...
	friend bool operator==(const FMobileSingleLayerWaterPolicy A, const FMobileSingleLayerWaterPolicy B)
	{
		return true;
	}
};
