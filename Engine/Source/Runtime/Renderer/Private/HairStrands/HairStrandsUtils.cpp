...
FMinHairRadiusAtDepth1 ComputeMinStrandRadiusAtDepth1(
	...
	const float FinalResolutionScale)
{
	FIntPoint Resolution;
	Resolution.X = FMath::CeilToInt32(InResolution.X * FinalResolutionScale);
	Resolution.Y = FMath::CeilToInt32(InResolution.Y * FinalResolutionScale);
