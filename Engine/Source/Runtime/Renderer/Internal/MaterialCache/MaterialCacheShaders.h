...
class FMaterialCacheABufferFillBorderHardwarePagesCS : public FGlobalShader
{
	DECLARE_GLOBAL_SHADER(FMaterialCacheABufferFillBorderHardwarePagesCS);
	SHADER_USE_PARAMETER_STRUCT(FMaterialCacheABufferFillBorderHardwarePagesCS, FGlobalShader);

public:
	BEGIN_SHADER_PARAMETER_STRUCT(FParameters, )
		SHADER_PARAMETER_RDG_BUFFER_SRV(StructuredBuffer<FMaterialCacheBinData>, PageWriteData)
		SHADER_PARAMETER_RDG_TEXTURE_UAV(RWTexture2DArray<float4>, RWABuffer)
		SHADER_PARAMETER_RDG_TEXTURE_SRV(Texture2DArray<uint>, R8Mask)
...
public:
	BEGIN_SHADER_PARAMETER_STRUCT(FParameters, )
		SHADER_PARAMETER_RDG_BUFFER_SRV(StructuredBuffer<FMaterialCacheBinData>, PageWriteData)
		SHADER_PARAMETER_RDG_TEXTURE_UAV(RWTexture2D<uint2>, RWVTLayerCompressed64)
		SHADER_PARAMETER_RDG_TEXTURE_UAV(RWTexture2D<uint4>, RWVTLayerCompressed128)
		...
		SHADER_PARAMETER(uint32, bYCoCg)
