...
public: /** IMaterialCacheTagProvider */
	...
	virtual void Register(FSceneInterface* Scene, FPrimitiveComponentId PrimitiveComponentId, FMaterialCacheVirtualTextureAllocation* VirtualTexture) override;
	virtual void Unregister(FSceneInterface* Scene, FPrimitiveComponentId PrimitiveComponentId, FMaterialCacheVirtualTextureAllocation* VirtualTexture) override;
	virtual void Register(FMaterialCacheVirtualTextureAllocation* VirtualTexture) override;
	virtual void Unregister(FMaterialCacheVirtualTextureAllocation* VirtualTexture) override;
	...
	virtual void NotifyAllTagSceneInvalidation() override;
...
private:
	...
	TMap<TTuple<FPrimitiveComponentId, FGuid>, FMaterialCacheVirtualTextureAllocation*> VirtualTextures;
