...
{
public:
	FMaterialCacheVirtualFinalizer(FScene* InScene, FMaterialCacheVirtualTextureAllocation* Allocation, const FMaterialCacheTagLayout& TagLayout, const FVTProducerDescription& InProducerDesc);
