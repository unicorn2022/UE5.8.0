...
enum class EMediaEvent
{
	...
	/**
	 * Player requests the facade to clear its "last sample still good" cache so the next
	 * TickInput fetches and delivers a fresh sample even if the playback time range has
	 * not advanced.
	 */
	Internal_RequestVideoSampleRefresh,
};
...
public:
	...
	/** Virtual destructor. */
	virtual ~IMediaEventSink() = default;
};
