...
struct FScopedObjectSerializeContext
{
	...
	// specialized context specifically for serializing individual properties during IDTs
	FScopedObjectSerializeContext(UObject* Object, FArchive& Archive, const FPropertyPathName& PathBeingSerialized);
...
private:
	...
	FPropertyPathName SavedSerializedPropertyPath;
#endif
};
