...
TEST_CASE_METHOD(FObjectPtrTestBase, "CoreUObject::TObjectPtr::Default Serialize", "[CoreUObject][ObjectPtr]")
{
	...
	const FName TestPackageName("/Engine/Test/ObjectPtrDefaultSerialize/Transient");
...
TEST_CASE_METHOD(FObjectPtrTestBase, "CoreUObject::TObjectPtr::Soft Object Path", "[CoreUObject][ObjectPtr]")
{
	...
	const FName TestPackageName("/Engine/Test/ObjectPtrSoftObjectPath/Transient");
	UPackage* TestPackage = NewObject<UPackage>(nullptr, TestPackageName, RF_Transient);
	TestPackage->AddToRoot();
...
{
	const FName TestPackage1Name("/Engine/Test/ObjectPtrHashConsistency1/Transient");
...
{
	const FName TestPackage1Name("/Engine/Test/FObjectPtrTestLongPath/Transient");
	UPackage* TestPackage1 = NewObject<UPackage>(nullptr, TestPackage1Name, RF_Transient);
	TestPackage1->AddToRoot();
...
TEST_CASE_METHOD(FObjectPtrTestBase, "CoreUObject::TObjectPtr::Type Specialization", "[CoreUObject][ObjectPtr]")
{
	...
	const FName TestPackageName("/Engine/Test/ObjectPtrTypeSafety/Transient");
	UPackage* TestPackage = NewObject<UPackage>(nullptr, TestPackageName, RF_Transient);
	TestPackage->AddToRoot();
	ON_SCOPE_EXIT
	{
...
{
	const FName TestPackageName("/Engine/Test/ObjectPtr/EvalStressTest/Transient");
	UPackage* TestPackage = NewObject<UPackage>(nullptr, TestPackageName, RF_Transient);
	TestPackage->AddToRoot();
	ON_SCOPE_EXIT
	{
...
{
	const FName TestPackageName("/Engine/Test/TestName/Transient");
	UPackage* TestPackage = NewObject<UPackage>(nullptr, TestPackageName, RF_Transient);
	TestPackage->AddToRoot();
...
{
	const FName TestPackageName("/Engine/TestPackage");
	UPackage* TestPackage = NewObject<UPackage>(nullptr, TestPackageName, RF_Transient);
	TestPackage->AddToRoot();
	UObject* Obj1 = NewObject<UObjectPtrTestClass>(TestPackage, TEXT("Obj1"));
	UObject* Inner1 = NewObject<UObjectPtrTestClass>(Obj1, TEXT("Inner1"));
...
// {
// 	const FName TestExternalPackage1Name("/Engine/Test/ObjectPtrExternalPackages1/Transient");
...
// 	const FName TestPackage1Name("/Engine/Test/ObjectPtrExternalPackages1/Transient");
// 	UPackage* TestPackage1 = NewObject<UPackage>(nullptr, TestPackage1Name, RF_Transient);
// 	TestPackage1->AddToRoot();
// 	UObject* TestOuter1 = NewObject<UObjectPtrTestClass>(TestPackage1, TEXT("TestOuter1"));
// 	UObject* TestOuter2 = NewObject<UObjectPtrTestClass>(TestPackage1, TEXT("TestOuter2"));
...
{
	const FName TestPackageName("/Engine/Test/TestEquals/Transient");
	UPackage* TestPackage = NewObject<UPackage>(nullptr, TestPackageName, RF_Transient);
	TestPackage->AddToRoot();
