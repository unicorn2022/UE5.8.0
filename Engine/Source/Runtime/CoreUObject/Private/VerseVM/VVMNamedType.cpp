...
VNamedType::VNamedType(FAllocationContext Context, VEmergentType* EmergentType, VPackage* InPackage, VArray* InRelativePath, VArray* InBaseName, VArray* InAttributeIndices, VArray* InAttributes, VValue InImportType, bool bInNativeBound)
	...
	, NativeType(Context, InImportType)
	, bNativeBound(bInNativeBound)
{
	if (!InImportType.IsUninitialized())
	{
