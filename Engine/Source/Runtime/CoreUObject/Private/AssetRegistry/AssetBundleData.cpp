...
bool FAssetBundleEntryImportExportTextTest::RunTest(const FString& Parameters)
{
	...
	FString EmptyEntryString = "(BundleName=\"Empty\",AssetPaths=)";
	...
	FString SingleAssetEntryString = "(BundleName=\"Single\",AssetPaths=(\"/Game/Characters/Steve.Steve\"))";
	...
	FString MultiAssetEntryString = "(BundleName=\"Multi\",AssetPaths=(\"/Game/Meshes/ConcreteWall.ConcreteWall\",\"/Game/Meshes/GarbageCan.GarbageCan\",\"/Game/Blueprints/Widget.Widget_C\"))";
	...
	FString SubobjectEntryString = "(BundleName=\"Subobject\",AssetPaths=(\"/Game/Characters/Steve.Steve:Hat\"))";
	...
	FString UnterminatedBundleNameString = "(BundleName=\"TestUnterminated,BundleAssets=))";
	...
	FString MismatchedQuotesString = "(BundleName=\"TestUnterminated,BundleAssets=(\"/Game/Characters/Steve.Steve\")))";
	...
	FString UnsupportedOrderString = "(BundleAssets=(\"/Game/Characters/Steve.Steve\"), BundleName=\"UnsupportedOrder\")";
	...
	FString DuplicateKeysString = "(BundleName=\"DuplicateKeys\",BundleAssets=(\"/Game/Characters/Steve.Steve\"),BundleAssets=(\"/Game/Characters/Will.Will\"))";
...
bool FLegacyAssetBundleEntryTest::RunTest(const FString& Parameters)
{
	...
	EmptyEntry.BundleName = "Empty";
	FString EmptyEntryString = "(BundleName=\"Empty\",AssetPaths=())";
	FString EmptyEntryString2 = "(BundleName=\"Empty\",AssetPaths=)";

	FAssetBundleEntry SingleAssetEntry;
	SingleAssetEntry.BundleName = "Single";
	SingleAssetEntry.AssetPaths.Add(FTopLevelAssetPath(TEXT("/Game/Characters/Steve.Steve")));
	FString SingleAssetEntryString = "(BundleName=\"Single\",BundleAssets=(\"/Game/Characters/Steve.Steve\"))";
	...
	MultiAssetEntry.AssetPaths.Add(FTopLevelAssetPath(TEXT("/Game/Meshes/GarbageCan.GarbageCan")));
	MultiAssetEntry.AssetPaths.Add(FTopLevelAssetPath(TEXT("/Game/Blueprints/Widget.Widget_C")));
	FString MultiAssetEntryString = "(BundleName=\"Multi\",BundleAssets=(\"/Game/Meshes/ConcreteWall.ConcreteWall\",\"/Game/Meshes/GarbageCan.GarbageCan\",\"/Game/Blueprints/Widget.Widget_C\"))";
	...
	FString SubobjectEntryString = "(BundleName=\"Subobject\",BundleAssets=(\"/Game/Characters/Steve.Steve:Hat\"))";
	...
	FString MixedFormatString = "(BundleName=\"MixedFormat\",AssetPaths=(\"/Game/Meshes/ConcreteWall.ConcreteWall\"),BundleAssets=(\"/Game/Meshes/GarbageCan.GarbageCan\",\"/Game/Blueprints/Widget.Widget_C\"))";
