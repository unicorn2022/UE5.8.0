 ...
 */
FDuplicateDataWriter::FDuplicateDataWriter(FDuplicatedObjectAnnotation& InDuplicatedObjects, FLargeMemoryData& InObjectData, UObject* SourceObject,
...
void FDuplicateDataWriter::SetDuplicatedCells(Verse::FDuplicationContext& InDuplicatedCells)
{
...
FArchive& FDuplicateDataWriter::operator<<(Verse::VCell*& Cell)
{
	DuplicatedCells->WriteCellReference(Cell);
	Serialize(&Cell, sizeof(Verse::VCell*));
	return *this;
}
#endif
