...
void UGCObjectReferencer::AddReferencedObjects(UObject* InThis, FReferenceCollector& Collector)
{
	...
	// Only GC protects us against adding new UObjects, but this is called through other means outside of GC that needs to be protected.
	UE::TConditionalScopeLock ReferencedObjectsLock(This->Impl->ReferencedObjectsCritical, !IsGarbageCollecting());
