...
{
	const TSparseSet<UObject*>& PotentiallyReferencedObjects;
	TSparseSet<UObject*>& ReferencingObjects;
	EReferencerFinderFlags Flags;

public:
	FAllReferencesProcessor(const TSparseSet<UObject*>& InPotentiallyReferencedObjects, EReferencerFinderFlags InFlags, TSparseSet<UObject*>& OutReferencingObjects)
...
private:
	...
	const TSparseSet<UObject*>& Targets;
	bool bDoesReferenceAnyTargets = false;
	const bool bSkipInnerReferences;

public:
	FReferencerFinderArchive(const TSparseSet<UObject*>& InTargets, bool bInSkipInnerReferences)
		: FArchiveUObject()
		, Targets(InTargets)
...
static TArray<UObject*> GetAllReferencersIncludingWeak(
	const TSparseSet<UObject*>& Referencees, const TSet<UObject*>* ObjectsToIgnore, const bool bSkipInnerReferences)
{
	...
	TUniquePtr<TSparseSet<UObject*>[]> ThreadResultsAlloc = MakeUnique<TSparseSet<UObject*>[]>(NumThreads);
	TArrayView<TSparseSet<UObject*>> ThreadResults(ThreadResultsAlloc.Get(), NumThreads);
		...
		bSkipInnerReferences](int32 ThreadIndex)
	{
		...
		TSparseSet<UObject*>& ThreadResult = ThreadResults[ThreadIndex];
	...
	for(const TSparseSet<UObject*>& ThreadResult : ThreadResults)
	{
...
static TArray<UObject*> GetAllReferencersExcludingWeak(
	const TSparseSet<UObject*>& Referencees, const TSet<UObject*>* ObjectsToIgnore, const EReferencerFinderFlags Flags)
{
	...
	{
		TSparseSet<UObject*> ThreadResult;
		FAllReferencesProcessor Processor(Referencees, Flags, ThreadResult);
...
TArray<UObject*> GetAllReferencers(
	const TSparseSet<UObject*>& Referencees, const TSet<UObject*>* ObjectsToIgnore, EReferencerFinderFlags Flags)
{
...
{
	return UE::Private::GetAllReferencers(TSparseSet<UObject*>(Referencees), ObjectsToIgnore, Flags);
}

TArray<UObject*> FReferencerFinder::GetAllReferencers(
	const TSet<UObject*>& Referencees, const TSet<UObject*>* ObjectsToIgnore, EReferencerFinderFlags Flags)
{
	TSparseSet<UObject*> AsSparse;
	for(UObject* Obj: Referencees)
	{
		AsSparse.Add(Obj);
	}
	return UE::Private::GetAllReferencers(AsSparse, ObjectsToIgnore, Flags);
}