...
UObjectBase* FUObjectAllocator::AllocateUObject(int32 Size, int32 Alignment, bool bAllowPermanent, int32 OffsetToObject)
{
	void* Result = nullptr;
	...
	return (UObjectBase*)(((uint8*)Result) + OffsetToObject);
}
 ...
 */
void FUObjectAllocator::FreeUObject(UObjectBase *Object, int32 OffsetToObject) const
{
	check(Object);
	...
	{
		FMemory::Free(((uint8*)Object) - OffsetToObject);
	}
