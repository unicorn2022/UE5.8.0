...
FInterfaceProperty::FInterfaceProperty(FFieldVariant InOwner, const FName& InName)
	...
	: Super(InOwner, (const UECodeGen_Private::FPropertyParamsBaseWithOffset&)Prop)
{
	...
	this->InterfaceClass = Prop.InterfaceClassFunc ? Prop.InterfaceClassFunc(ETypeConstructPhase::Inner) : nullptr;
}
...
bool FInterfaceProperty::Identical(TNotNull<const void*> A, const void* B, uint32 PortFlags/* = 0*/) const
{
	FScriptInterface* InterfaceA = (FScriptInterface*)NotNullGet(A);
...
void FInterfaceProperty::SerializeItem(FStructuredArchive::FSlot Slot, TNotNull<void*> Value, void const* Defaults) const
{
	FArchive& UnderlyingArchive = Slot.GetUnderlyingArchive();
	FScriptInterface* InterfaceValue = (FScriptInterface*)NotNullGet(Value);
...
bool FInterfaceProperty::NetSerializeItem(FArchive& Ar, UPackageMap* Map, TNotNull<void*> Data, TArray<uint8> * MetaData) const
{
	...
	{ 
		FScriptInterface* InterfaceValue = (FScriptInterface*)NotNullGet(Data);
...
void FInterfaceProperty::ExportText_Internal(FString& ValueStr, TNotNull<const void*> PropertyValueOrContainer, EPropertyPointerType PropertyPointerType, const void* DefaultValue, UObject* Parent, int32 PortFlags, UObject* ExportRootScope) const
{
...
const TCHAR* FInterfaceProperty::ImportText_Internal(const TCHAR* InBuffer, TNotNull<void*> ContainerOrPropertyPtr, EPropertyPointerType PropertyPointerType, UObject* Parent, int32 PortFlags, FOutputDevice* ErrorText) const
{
