...
FName PPXPreviewOverrides::PerPlatformOverride = NAME_None;
FName PPXPreviewOverrides::PerPlatformGroupOverride = NAME_None;

void PPXPreviewOverrides::SetPPXPreviewOverrides(FName& InPerPlatformOverride, FName& InPerPlatformGroupOverride)
{
	PerPlatformOverride = InPerPlatformOverride;
	PerPlatformGroupOverride = InPerPlatformGroupOverride;
}
