...
EEditorDomainEnabled IsEditorDomainEnabled()
{
	static EEditorDomainEnabled EnabledValue = []()
	{
		...
		{
			UE_LOGF(LogPackageResourceManager, Error,
				"Editor.ini:[CookSettings]:EditorDomainEnabled is deprecated, use Editor.ini:[EditorDomain]:EditorDomainEnabled instead.");
		}
