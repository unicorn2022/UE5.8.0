...
FSoftClassProperty::FSoftClassProperty(FFieldVariant InOwner, const FName& InName)
...
{
	this->MetaClass = Prop.MetaClassFunc ? Prop.MetaClassFunc(ETypeConstructPhase::Inner) : nullptr;
}
