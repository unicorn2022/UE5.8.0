...
static const FString InitString = "__INIT__";

FOptionalProperty::FOptionalProperty(FFieldVariant InOwner, const FName& InName)
...
bool FOptionalProperty::Identical(TNotNull<const void*> A, const void* B, uint32 PortFlags) const
{
	checkSlow(ValueProperty);
...
void FOptionalProperty::SerializeItem(FStructuredArchive::FSlot Slot, TNotNull<void*> Data, void const* Defaults) const
{
...
bool FOptionalProperty::NetSerializeItem(FArchive& Ar, UPackageMap* Map, TNotNull<void*> Data, TArray<uint8>* MetaData /*= nullptr*/) const
{
	bool bSuccess = true;
...
void FOptionalProperty::ExportText_Internal(FString& ValueStr, TNotNull<const void*> ContainerOrPropertyPtr, EPropertyPointerType PropertyPointerType, const void* DefaultValue, UObject* Parent, int32 PortFlags, UObject* ExportRootScope) const
{
	checkSlow(ValueProperty);
...
const TCHAR* FOptionalProperty::ImportText_Internal(const TCHAR* Buffer, TNotNull<void*> ContainerOrPropertyPtr, EPropertyPointerType PropertyPointerType, UObject* Parent, int32 PortFlags, FOutputDevice* ErrorText) const
{
	checkSlow(ValueProperty);
...
bool FOptionalProperty::LoadTypeName(UE::FPropertyTypeName Type, const FPropertyTag* Tag)
{
	...
	FField* Field = FField::TryConstruct(ValueType.GetName(), this, GetFName());
