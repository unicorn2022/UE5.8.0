...
FDoubleProperty::FDoubleProperty(FFieldVariant InOwner, const FName& InName)
...
bool FDoubleProperty::Identical(TNotNull<const void*> A, const void* B, uint32 PortFlags) const
{
	return UE::PreciseFPEqual(*static_cast<const double*>(NotNullGet(A)), B ? *static_cast<const double*>(B) : 0.0);
}
