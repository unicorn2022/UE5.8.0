...
public:
	...
	COREUOBJECT_API UE_STRPROPERTY_CLASS(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FStrProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	COREUOBJECT_API UE_STRPROPERTY_CLASS(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : UE_STRPROPERTY_CLASS(InOwner, InName) {}
