...
public:
	 ...
	 * @params LoadFlags Flags to forward to LoadObject e.g. LOAD_Quiet
	 * @return Loaded UObject, or nullptr if the reference is null or the asset fails to load
	 */
	COREUOBJECT_API UObject* TryLoad(FUObjectSerializeContext* InLoadContext = nullptr, ELoadFlags LoadFlags = LOAD_None) const;
