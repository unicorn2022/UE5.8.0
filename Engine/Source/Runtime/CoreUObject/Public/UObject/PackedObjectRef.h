...
namespace UE::CoreUObject::Private
{
	...
	{
		[[nodiscard]] FPackedObjectRef() = default;

		[[nodiscard]] explicit FPackedObjectRef(UPTRINT InEncodedRef)
			: EncodedRef(InEncodedRef)
		{
		}
		...
		{
			return GetTypeHashHelper(ObjectRef.EncodedRef);
		}
