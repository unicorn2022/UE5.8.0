...
public:
	...
	/**
	 * Query the temporary SaveContext for the saveable state of an object, if any.
	 * Returns false if no save context is available
	 */
	UE_INTERNAL COREUOBJECT_API bool IsUnsaveable(TObjectPtr<UObject> Object) const;
