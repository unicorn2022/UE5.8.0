...
#if WITH_VERSE_VM || defined(__INTELLISENSE__)
/**
* Returns true if the "FrankenGC" is enabled.
*/
COREUOBJECT_API bool IsFrankenGCEnabled();
...
*/
AUTORTFM_DISABLE COREUOBJECT_API void EnableFrankenGCMode(bool bEnable);

/**
* Test to see if franken GC needs to run
*/
AUTORTFM_DISABLE COREUOBJECT_API bool ShouldFrankenGCRun();
...
namespace UE::GC::Private
{
	...
	COREUOBJECT_API void RemoveFromRootForUnload(TSet<const UObject*> ObjectsToRemove);
}
