...
enum EFunctionFlags : uint32
{
	...
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	// DO NOT ADD composite flags to EFunctionFlags. Debugger visualizations have trouble displaying composite flag values as text.
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
};
...
#define FUNC_AllFlags          ((EFunctionFlags)(0xFFFFFFFF))
...
enum class EBlueprintTextLiteralType : uint8
{
	...
	LocalizedText,
	/** Text is localized. The bytecode will contain four strings - source, key, namespace, and devnotes - and should be loaded via FInternationalization */
