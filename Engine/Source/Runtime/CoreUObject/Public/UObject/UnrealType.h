...
public:
	// Constructors.
	COREUOBJECT_API FProperty(FFieldVariant InOwner, const FName& InName);
...
public:
	...
	*/
	 ...
	 */
	void SerializeBinProperty( FStructuredArchive::FSlot Slot, TNotNull<void*> Data, int32 ArrayIdx = -1 )
	{
	 ...
	 */
	void SerializeNonMatchingBinProperty(FStructuredArchive::FSlot Slot, TNotNull<void*> Data, void const* DefaultData, UStruct* DefaultStruct)
	{
	...
	virtual void SerializeItem(FStructuredArchive::FSlot Slot, TNotNull<void*> Value, void const* Defaults = nullptr) const PURE_VIRTUAL(FProperty::SerializeItem, );
	COREUOBJECT_API virtual bool NetSerializeItem(FArchive& Ar, UPackageMap* Map, TNotNull<void*> Data, TArray<uint8> * MetaData = nullptr) const;
	 ...
	 */
	const TCHAR* ImportText_InContainer(const TCHAR* Buffer, TNotNull<void*> Container, UObject* OwnerObject, int32 PortFlags, FOutputDevice* ErrorText = (FOutputDevice*)GWarn) const
	{
	 ...
	 * @returns Buffer pointer advanced by the number of characters consumed when reading the text value
	 */
	const TCHAR* ImportText_Direct(const TCHAR* Buffer, TNotNull<void*> PropertyPtr, UObject* OwnerObject, int32 PortFlags, FOutputDevice* ErrorText = (FOutputDevice*)GWarn) const
	{
...
protected:
	...
	virtual void ExportText_Internal(FString& ValueStr, TNotNull<const void*> PropertyValueOrContainer, EPropertyPointerType PointerType, const void* DefaultValue, UObject* Parent, int32 PortFlags, UObject* ExportRootScope = nullptr) const PURE_VIRTUAL(FProperty::ExportText, );
	virtual const TCHAR* ImportText_Internal(const TCHAR* Buffer, TNotNull<void*> ContainerOrPropertyPtr, EPropertyPointerType PointerType, UObject* OwnerObject, int32 PortFlags, FOutputDevice* ErrorText) const PURE_VIRTUAL(FProperty::ImportText, return nullptr;);

public:
	
	COREUOBJECT_API bool ExportText_Direct(FString& ValueStr, TNotNull<const void*> Data, const void* Delta, UObject* Parent, int32 PortFlags, UObject* ExportRootScope = nullptr) const;
	UE_FORCEINLINE_HINT bool ExportText_InContainer(int32 Index, FString& ValueStr, TNotNull<const void*> Data, const void* Delta, UObject* Parent, int32 PortFlags, UObject* ExportRootScope = nullptr) const
	{
...
public:
	 ...
	 * @note This will also parse and unescape any quoted strings found prior to the terminating character, 
	 *       however a terminating character within a quoted string is not considered as a termination point.
	 * 
	 * @param Buffer		The buffer to parse from.
	 * @param Out			The value to append to on success.
	 * @param Terminator	The token terminator to stop at.
	 * @param MaxTokenLen	Optional limit; will fail if we don't find the terminator within this limit.
	 * 
	 * @return The terminating character location in the buffer, or null if parsing failed.
	 */
	static COREUOBJECT_API const TCHAR* ReadTerminatedToken(const TCHAR* Buffer, FString& Out, const TCHAR Terminator, const int32* MaxTokenLen = nullptr);
	static COREUOBJECT_API const TCHAR* ReadTerminatedToken(const TCHAR* Buffer, FStringBuilderBase& Out, const TCHAR Terminator, const int32* MaxTokenLen = nullptr);
};
...
public:
	...
	TProperty_WithEqualityAndSerializer(FFieldVariant InOwner, const FName& InName)
		: Super(InOwner, InName)
	{
	}
	UE_DEPRECATED(5.8, "TProperty_WithEqualityAndSerializer constructor with InObjectFlags is deprecated, remove that parameter.")
	TProperty_WithEqualityAndSerializer(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : TProperty_WithEqualityAndSerializer(InOwner, InName) {}
	...
	// FProperty interface.
	virtual bool Identical(TNotNull<const void*> A, const void* B, uint32 PortFlags = 0) const override
	{
...
class FNumericProperty : public FProperty
{
	...
	UE_API FNumericProperty(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FNumericProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FNumericProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FNumericProperty(InOwner, InName) {}
	...
	// FProperty interface.
	UE_API virtual const TCHAR* ImportText_Internal(const TCHAR* Buffer, TNotNull<void*> ContainerOrPropertyPtr, EPropertyPointerType PropertyPointerType, UObject* Parent, int32 PortFlags, FOutputDevice* ErrorText) const override;
	UE_API virtual void ExportText_Internal( FString& ValueStr, TNotNull<const void*> PropertyValueOrContainer, EPropertyPointerType PropertyPointerType, const void* DefaultValue, UObject* Parent, int32 PortFlags, UObject* ExportRootScope ) const override;
	// End of FProperty interface
...
public:
	...
	TProperty_Numeric(FFieldVariant InOwner, const FName& InName)
		: Super(InOwner, InName)
	{
	}
	UE_DEPRECATED(5.8, "TProperty_Numeric constructor with InObjectFlags is deprecated, remove that parameter.")
	TProperty_Numeric(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : TProperty_Numeric(InOwner, InName) {}
...
class FByteProperty : public TProperty_Numeric<uint8>
{
	...
	UE_API FByteProperty(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FByteProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FByteProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FByteProperty(InOwner, InName) {}
...
#if UE_WITH_CONSTINIT_UOBJECT
	explicit consteval FByteProperty(UE::CodeGen::ConstInit::FPropertyParams InBaseParams, UE::CodeGen::ConstInit::TObjectRefParam<UEnum> InEnum)
		: Super(InBaseParams)
		, Enum(InEnum)
	{
	}
	...
	UE_API virtual void LinkCompiledInPointerFields(UE::CoreUObject::Private::FCompiledInObjectLinker& Linker);
	...
	// FProperty interface.
	UE_API virtual void SerializeItem(FStructuredArchive::FSlot Slot, TNotNull<void*> Value, void const* Defaults) const override;
	UE_API virtual bool NetSerializeItem(FArchive& Ar, UPackageMap* Map, TNotNull<void*> Data, TArray<uint8> * MetaData = nullptr) const override;
protected:
	UE_API virtual void ExportText_Internal( FString& ValueStr, TNotNull<const void*> PropertyValueOrContainer, EPropertyPointerType PropertyPointerType, const void* DefaultValue, UObject* Parent, int32 PortFlags, UObject* ExportRootScope ) const override;
	UE_API virtual const TCHAR* ImportText_Internal(const TCHAR* Buffer, TNotNull<void*> ContainerOrPropertyPtr, EPropertyPointerType PropertyPointerType, UObject* Parent, int32 PortFlags, FOutputDevice* ErrorText) const override;
public:
...
class FInt8Property : public TProperty_Numeric<int8>
{
	...
	UE_API FInt8Property(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FInt8Property constructor with InObjectFlags is deprecated, remove that parameter.")
	FInt8Property(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FInt8Property(InOwner, InName) {}
...
class FInt16Property : public TProperty_Numeric<int16>
{
	...
	UE_API FInt16Property(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FInt16Property constructor with InObjectFlags is deprecated, remove that parameter.")
	FInt16Property(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FInt16Property(InOwner, InName) {}
...
class FIntProperty : public TProperty_Numeric<int32>
{
	...
	UE_API FIntProperty(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FIntProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FIntProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FIntProperty(InOwner, InName) {}
...
class FInt64Property : public TProperty_Numeric<int64>
{
	...
	UE_API FInt64Property(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FInt64Property constructor with InObjectFlags is deprecated, remove that parameter.")
	FInt64Property(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FInt64Property(InOwner, InName) {}
...
class FUInt16Property : public TProperty_Numeric<uint16>
{
	...
	UE_API FUInt16Property(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FUInt16Property constructor with InObjectFlags is deprecated, remove that parameter.")
	FUInt16Property(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FUInt16Property(InOwner, InName) {}
...
class FUInt32Property : public TProperty_Numeric<uint32>
{
	...
	UE_API FUInt32Property(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FUInt32Property constructor with InObjectFlags is deprecated, remove that parameter.")
	FUInt32Property(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FUInt32Property(InOwner, InName) {}
...
class FUInt64Property : public TProperty_Numeric<uint64>
{
	...
	UE_API FUInt64Property(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FUInt64Property constructor with InObjectFlags is deprecated, remove that parameter.")
	FUInt64Property(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FUInt64Property(InOwner, InName) {}
...
class FFloatProperty : public TProperty_Numeric<float>
{
	...
	UE_API FFloatProperty(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FFloatProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FFloatProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FFloatProperty(InOwner, InName) {}
	...
	UE_API virtual bool Identical(TNotNull<const void*> A, const void* B, uint32 PortFlags) const override;
...
class FDoubleProperty : public TProperty_Numeric<double>
{
	...
	UE_API FDoubleProperty(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FDoubleProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FDoubleProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FDoubleProperty(InOwner, InName) {}
...
public:
	...
	UE_API FBoolProperty(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FBoolProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FBoolProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FBoolProperty(InOwner, InName) {}
...
public:
	...
	UE_API FObjectPropertyBase(FFieldVariant InOwner, const FName& InName);
...
#if UE_WITH_CONSTINIT_UOBJECT
protected:
	explicit consteval FObjectPropertyBase(UE::CodeGen::ConstInit::FPropertyParams InBaseParams, UE::CodeGen::ConstInit::TObjectRefParam<UClass> InPropertyClass)
		: Super(InBaseParams)
...
public:
	...
	// Helper method for deep comparing objects
...
public:
	...
	TFObjectPropertyBase(FFieldVariant InOwner, const FName& InName)
		: Super(InOwner, InName)
	{
		this->PropertyClass = nullptr;
	}
	UE_DEPRECATED(5.8, "TFObjectPropertyBase constructor with InObjectFlags is deprecated, remove that parameter.")
	TFObjectPropertyBase(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : TFObjectPropertyBase(InOwner, InName) {}
	...
	TFObjectPropertyBase(FFieldVariant InOwner, const UECodeGen_Private::FObjectPropertyParams& Prop)
		: Super(InOwner, Prop)
	{
		this->PropertyClass = Prop.ClassFunc ? Prop.ClassFunc(ETypeConstructPhase::Inner) : nullptr;
	}
	/**
	 * Constructor used for constructing compiled-in properties
	 * @param InOwner Owner of the property
...
#if UE_WITH_CONSTINIT_UOBJECT
protected:
	explicit consteval TFObjectPropertyBase(UE::CodeGen::ConstInit::FPropertyParams InBaseParams, UE::CodeGen::ConstInit::TObjectRefParam<UClass> InPropertyClass)
...
class FObjectProperty : public TFObjectPropertyBase<TObjectPtr<UObject>>
{
	...
	UE_API FObjectProperty(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FObjectProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FObjectProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FObjectProperty(InOwner, InName) {}
...
#if UE_WITH_CONSTINIT_UOBJECT
	explicit consteval FObjectProperty(UE::CodeGen::ConstInit::FPropertyParams InBaseParams, UE::CodeGen::ConstInit::TObjectRefParam<UClass> PropertyClass)
...
class FWeakObjectProperty : public TFObjectPropertyBase<FWeakObjectPtr>
{
	...
	UE_API FWeakObjectProperty(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FWeakObjectProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FWeakObjectProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FWeakObjectProperty(InOwner, InName) {}
...
#if UE_WITH_CONSTINIT_UOBJECT
	explicit consteval FWeakObjectProperty(UE::CodeGen::ConstInit::FPropertyParams InBaseParams, UE::CodeGen::ConstInit::TObjectRefParam<UClass> PropertyClass)
		: Super(InBaseParams, PropertyClass)
	{
	}
#endif
...
class FLazyObjectProperty : public TFObjectPropertyBase<FLazyObjectPtr>
{
	...
	UE_API FLazyObjectProperty(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FLazyObjectProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FLazyObjectProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FLazyObjectProperty(InOwner, InName) {}
...
#if UE_WITH_CONSTINIT_UOBJECT
	explicit consteval FLazyObjectProperty(UE::CodeGen::ConstInit::FPropertyParams InBaseParams, UE::CodeGen::ConstInit::TObjectRefParam<UClass> PropertyClass)
		: Super(InBaseParams, PropertyClass)
	{
	}
#endif
...
class FSoftObjectProperty : public TFObjectPropertyBase<FSoftObjectPtr>
{
	...
	UE_API FSoftObjectProperty(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FSoftObjectProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FSoftObjectProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FSoftObjectProperty(InOwner, InName) {}
...
#if UE_WITH_CONSTINIT_UOBJECT
	explicit consteval FSoftObjectProperty(UE::CodeGen::ConstInit::FPropertyParams InBaseParams, UE::CodeGen::ConstInit::TObjectRefParam<UClass> PropertyClass)
		: Super(InBaseParams, PropertyClass)
	{
	}
#endif
...
public:
	...
	UE_API FClassProperty(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FClassProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FClassProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FClassProperty(InOwner, InName) {}
...
#if UE_WITH_CONSTINIT_UOBJECT
	explicit consteval FClassProperty(
		UE::CodeGen::ConstInit::FPropertyParams InBaseParams,
...
public:
	...
	UE_API FSoftClassProperty(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FSoftClassProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FSoftClassProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FSoftClassProperty(InOwner, InName) {}
...
#if UE_WITH_CONSTINIT_UOBJECT
	explicit consteval FSoftClassProperty(
		UE::CodeGen::ConstInit::FPropertyParams InBaseParams,
		UE::CodeGen::ConstInit::TObjectRefParam<UClass> ClassClass,
		UE::CodeGen::ConstInit::TObjectRefParam<UClass> InMetaClass
	)
...
public:
	...
	UE_API FInterfaceProperty(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FInterfaceProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FInterfaceProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FInterfaceProperty(InOwner, InName) {}
...
#if UE_WITH_CONSTINIT_UOBJECT
	explicit consteval FInterfaceProperty(UE::CodeGen::ConstInit::FPropertyParams InBaseParams, UE::CodeGen::ConstInit::TObjectRefParam<UClass> InInterfaceClass)
		: Super(InBaseParams)
...
public:
	...
	UE_API FNameProperty(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FNameProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FNameProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FNameProperty(InOwner, InName) {}
...
public:
	...
	UE_API FArrayProperty(FFieldVariant InOwner, const FName& InName, EArrayPropertyFlags InArrayPropertyFlags=EArrayPropertyFlags::None);
	UE_DEPRECATED(5.8, "FArrayProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FArrayProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags, EArrayPropertyFlags InArrayPropertyFlags=EArrayPropertyFlags::None) : FArrayProperty(InOwner, InName, InArrayPropertyFlags) {}
	...
	UE_API virtual bool Identical(TNotNull<const void*> A, const void* B, uint32 PortFlags) const override;
	UE_API virtual void SerializeItem(FStructuredArchive::FSlot Slot, TNotNull<void*> Value, void const* Defaults) const override;
	UE_API virtual bool NetSerializeItem( FArchive& Ar, UPackageMap* Map, TNotNull<void*> Data, TArray<uint8> * MetaData = NULL ) const override;
protected:
	UE_API virtual void ExportText_Internal(FString& ValueStr, TNotNull<const void*> PropertyValueOrContainer, EPropertyPointerType PropertyPointerType, const void* DefaultValue, UObject* Parent, int32 PortFlags, UObject* ExportRootScope ) const override;
	UE_API virtual const TCHAR* ImportText_Internal(const TCHAR* Buffer, TNotNull<void*> ContainerOrPropertyPtr, EPropertyPointerType PropertyPointerType, UObject* OwnerObject, int32 PortFlags, FOutputDevice* ErrorText) const override;
...
public:
	...
	UE_API static void ExportTextInnerItem(FString& ValueStr, const FProperty* Inner, const void* PropertyValue, int32 NumElements, const void* DefaultValue, int32 DefaultSize, UObject* Parent = nullptr, int32 PortFlags = 0, UObject* ExportRootScope = nullptr);
...
public:
	...
	UE_API FMapProperty(FFieldVariant InOwner, const FName& InName, EMapPropertyFlags InMapFlags=EMapPropertyFlags::None);
	UE_DEPRECATED(5.8, "FMapProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FMapProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags, EMapPropertyFlags InMapFlags=EMapPropertyFlags::None) : FMapProperty(InOwner, InName, InMapFlags) {}
...
public:
	...
	UE_API FSetProperty(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FSetProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FSetProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FSetProperty(InOwner, InName) {}
...
public:
	UE_API FStructProperty(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FStructProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FStructProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FStructProperty(InOwner, InName) {}
...
public:
	...
	UE_API FDelegateProperty(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FDelegateProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FDelegateProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FDelegateProperty(InOwner, InName) {}
...
#if UE_WITH_CONSTINIT_UOBJECT
	explicit consteval FDelegateProperty(UE::CodeGen::ConstInit::FPropertyParams InBaseParams, UE::CodeGen::ConstInit::TObjectRefParam<UFunction> InSignatureFunction)
		: Super(InBaseParams)
...
public:
	...
	UE_API FMulticastDelegateProperty(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FMulticastDelegateProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FMulticastDelegateProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FMulticastDelegateProperty(InOwner, InName) {}
...
#if UE_WITH_CONSTINIT_UOBJECT
	explicit consteval FMulticastDelegateProperty(UE::CodeGen::ConstInit::FPropertyParams InBaseParams, UE::CodeGen::ConstInit::TObjectRefParam<UFunction> InSignatureFunction)
		: Super(InBaseParams)
		, SignatureFunction(InSignatureFunction)
	{
	}
...
public:
	...
	typedef InTCppType TCppType;
	typedef typename Super::TTypeFundamentals TTypeFundamentals;
	TProperty_MulticastDelegate(FFieldVariant InOwner, const FName& InName, UFunction* InSignatureFunction)
		: Super(InOwner, InName)
	{
		this->SignatureFunction = InSignatureFunction;
	}

	TProperty_MulticastDelegate(FFieldVariant InOwner, const FName& InName)
		: Super(InOwner, InName)
	{
		this->SignatureFunction = nullptr;
	}
	UE_DEPRECATED(5.8, "TProperty_MulticastDelegate constructor with InObjectFlags is deprecated, remove that parameter.")
	TProperty_MulticastDelegate(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : TProperty_MulticastDelegate(InOwner, InName) {}
	...
	TProperty_MulticastDelegate(FFieldVariant InOwner, const UECodeGen_Private::FMulticastDelegatePropertyParams& Prop)
		: Super(InOwner, Prop)
	{
		this->SignatureFunction = Prop.SignatureFunctionFunc ? Prop.SignatureFunctionFunc(ETypeConstructPhase::Inner) : nullptr;
	}

#if UE_WITH_CONSTINIT_UOBJECT
	explicit consteval TProperty_MulticastDelegate(UE::CodeGen::ConstInit::FPropertyParams InBaseParams, UE::CodeGen::ConstInit::TObjectRefParam<UFunction> InSignatureFunction)
...
public:
	...
	FMulticastInlineDelegateProperty(FFieldVariant InOwner, const FName& InName)
		: TProperty_MulticastDelegate(InOwner, InName)
	{
	}
	UE_DEPRECATED(5.8, "FMulticastInlineDelegateProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FMulticastInlineDelegateProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FMulticastInlineDelegateProperty(InOwner, InName) {}
...
#if UE_WITH_CONSTINIT_UOBJECT
	explicit consteval FMulticastInlineDelegateProperty(
		UE::CodeGen::ConstInit::FPropertyParams InBaseParams,
		UE::CodeGen::ConstInit::TObjectRefParam<UFunction> InSignatureFunction
	)
		: Super(InBaseParams, InSignatureFunction)
	{
	}
...
public:
	...
	FMulticastSparseDelegateProperty(FFieldVariant InOwner, const FName& InName)
		: TProperty_MulticastDelegate(InOwner, InName)
	{
	}
	UE_DEPRECATED(5.8, "FMulticastSparseDelegateProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FMulticastSparseDelegateProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FMulticastSparseDelegateProperty(InOwner, InName) {}
...
#if UE_WITH_CONSTINIT_UOBJECT
	explicit consteval FMulticastSparseDelegateProperty(
		UE::CodeGen::ConstInit::FPropertyParams InBaseParams,
		UE::CodeGen::ConstInit::TObjectRefParam<UFunction> InSignatureFunction
	)
		: Super(InBaseParams, InSignatureFunction)
...
T* FindFieldChecked( const UStruct* Scope, FName FieldName )
{
	if ( FieldName != NAME_None && Scope != NULL )
	{
		...
		UE_LOGF( LogType, Fatal, "Failed to find %ls %ls in %ls", *T::StaticClass()->GetName(), *FieldName.ToString(), *InitialScope->GetFullName() );
	}
