...
public:
	...
	COREUOBJECT_API FTextProperty(FFieldVariant InOwner, const FName& InName);
	UE_DEPRECATED(5.8, "FTextProperty constructor with InObjectFlags is deprecated, remove that parameter.")
	FTextProperty(FFieldVariant InOwner, const FName& InName, EObjectFlags InObjectFlags) : FTextProperty(InOwner, InName) {}
