...
enum ESaveFlags
{
	...
	SAVE_KeepPersistentGUID			= 0x00000008,	///< Do not replace the persistent GUID when saving a package to a different path. This is potentially dangerous as it could result in duplicate GUIDs and so should only be used in cases
													///< where we know that the resulting package is temporary or will eventually replace the original package file.
	...
	SAVE_Concurrent					= 0x00000100,	///< We are save packages in multiple threads at once and should not call non-threadsafe functions or rely on globals. UE::IsSavingPackage() should be set and PreSave/Postsave functions should be called before/after the entire concurrent save.
...
//	PKG_Unused						= 0x04000000,
	...
	PKG_DynamicImports UE_DEPRECATED(5.8, "This flag is now obsolete.") = 0x10000000,	///< Obsolete
	...
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	// DO NOT ADD composite flags to EPackageFlags. Debugger visualizations have trouble displaying composite flag values as text.
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
};
...
enum EClassFlags
{
	...
	/** Class can contain partials */
	CLASS_Partial			  = 0x00000100u,
	...
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	// DO NOT ADD composite flags to EClassFlags. Debugger visualizations have trouble displaying composite flag values as text.
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
};
...
/** These flags will never be loaded or saved */
#define CLASS_ShouldNeverBeLoaded ((EClassFlags)(CLASS_Native | CLASS_Optional | CLASS_Intrinsic | CLASS_TokenStreamAssembled | CLASS_ReplicationDataIsSetUp))
...
enum EClassCastFlags : uint64
{
	...
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	// DO NOT ADD composite flags to EClassCastFlags. Debugger visualizations have trouble displaying composite flag values as text.
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
};
...
enum EPropertyFlags : uint64
{
	...
	CPF_ForcePostConstructLink			= 0x2000000000000000,	///< Use to force native UCLASS properties to be included in the PostConstructLink chain in a derived Blueprint class, regardless of whether it differs from the native class constructor-initialized value

	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	// DO NOT ADD composite flags to EPropertyFlags. Debugger visualizations have trouble displaying composite flag values as text.
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
};
...
enum class EArrayPropertyFlags : uint8
{
	...
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	// DO NOT ADD composite flags to EArrayPropertyFlags. Debugger visualizations have trouble displaying composite flag values as text.
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
};
...
enum class EMapPropertyFlags : uint8
{
	...
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	// DO NOT ADD composite flags to EMapPropertyFlags. Debugger visualizations have trouble displaying composite flag values as text.
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
};
...
enum class EPropertyObjectReferenceType : uint32
{
	...
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	// DO NOT ADD composite flags to EPropertyObjectReferenceType. Debugger visualizations have trouble displaying composite flag values as text.
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
};
ENUM_CLASS_FLAGS(EPropertyObjectReferenceType);

inline constexpr EPropertyObjectReferenceType EPropertyObjectReferenceType_Any = EPropertyObjectReferenceType::Strong | EPropertyObjectReferenceType::Weak | EPropertyObjectReferenceType::Soft | EPropertyObjectReferenceType::Conservative;
...
enum EObjectFlags : uint32
{
	...
	RF_GeneratePublicHash		=0x00000800,	///< During cooking, generate a public hash for this object even is not marked RF_Public.
	...
	RF_HasDynamicImports		=0x80000000,	///< This object has dynamic imports
	RF_AllocatedInSharedPage UE_DEPRECATED(5.8, "This flag is now obsolete as the functionality is unnecessary.") =0x80000000,	///< Allocated from a ref-counted page shared with other UObjects

	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	// DO NOT ADD composite flags to EObjectFlags. Debugger visualizations have trouble displaying composite flag values as text.
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
};
...
#define RF_Load						((EObjectFlags)(RF_Public | RF_Standalone | RF_Transactional | RF_ClassDefaultObject | RF_ArchetypeObject | RF_GeneratePublicHash | RF_DefaultSubObject | RF_TextExportTransient | RF_InheritableComponentTemplate | RF_DuplicateTransient | RF_NonPIEDuplicateTransient | RF_MigratingAsset | RF_HasDynamicImports)) 
...
enum class EInternalObjectFlags : uint32
{
	...
	LocalNotReady = 1 << 3,		//< Object's memory is local but requires additional work before it can be accessed
#else
	Remote = 0,
	RemoteReference = 0,
	Borrowed = 0,
	...
	PendingConstruction = 1u << 31, ///< Object didn't have its class constructor called yet (only the UObjectBase one to initialize its most basic members)

	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	// DO NOT ADD composite flags to EInternalObjectFlags. Debugger visualizations have trouble displaying composite flag values as text.
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
};
...
enum class EEnumFlags : uint8
{
	...
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	// DO NOT ADD composite flags to EEnumFlags. Debugger visualizations have trouble displaying composite flag values as text.
	// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
};
...
// Macro for defining verse only properties that are the given type with BPVM and another with the new VM
#if WITH_VERSE_VM
#define UE_VERSE_FIELD(T, Name, Initializer) Verse::VRestValue Name {0}
#else
#define UE_VERSE_FIELD(T, Name, Initializer) UE_REMOVE_OPTIONAL_PARENS(T) Name UE_REMOVE_OPTIONAL_PARENS(Initializer)
#endif
...
namespace UM
{
	...
	enum
	{
		...
		/// [PropertyMetadata] Use by "Config" properties. Indicates that changing the value of this property will not take effect until a restart of the program.
		/// If in the editor, then the user will be prompted to reboot now or later.
		///
		/// This is particularly useful on project settings and for state that is read very early on the engine's boot and cannot be changed once it is running.
		/// 
		/// Example:
		///		UPROPERTY(EditAnywhere, Config, Category = "YourCategory", meta=(ConfigRestartRequired=true))
		///		bool bEnableSomeFeature = false;
		...
		/// [PropertyMetaData] Force the specified sibling Editor PropertyNode to refresh itself when this property changes. Useful to trigger an Editor refresh of an unrelated Property when this one is modified in PostEditChangeProperty or similar. If no sibling is specified, all of them will refresh.
...
/**
* Two-phase construction for types. This is used to handle circular dependencies between types.
*/
...
using FTypeConstructFunc = UObject*(ETypeConstructPhase);
...
#define DECLARE_CLASS( TClass, TSuperClass, TStaticFlags, TStaticCastFlags, TPackage, TRequiredAPI ) \
	TRequiredAPI static UClass* GetPrivateStaticClass(ETypeConstructPhase); \
...
public: \
	...
	UE_REWRITE consteval static EClassCastFlags StaticAllClassCastFlags() \
	{ \
...
#define UOBJECT_CPPCLASS_STATICFUNCTIONS_ALLCONFIGS(TClass) \
	...
	#define UOBJECT_CPPCLASS_STATICFUNCTIONS_WITHEDITORONLYDATA(TClass) \
		...
		, FUObjectCppClassStaticFunctions::InjectDynamicImportsForType(&TClass::InjectDynamicImportsFor)
...
// Used to allow constinit initialization UClass variables outside of CoreUObject in modular 
// builds to take pointers to these methods rather than the methods of UObject, which can't 
// be used in constant expressions in a different dll.
template<typename T>
struct TUObjectCppClassStaticThunks
{
#if UE_WITH_CONSTINIT_UOBJECT && !IS_MONOLITHIC
	static void AddReferencedObjects(UObject* ThisObject, FReferenceCollector& Ar)
	{
		T::AddReferencedObjects(ThisObject, Ar);
	}

#if WITH_EDITORONLY_DATA
	static void DeclareCustomVersions(FArchive& Ar, const UClass* SpecificSubclass)
	{
		T::DeclareCustomVersions(Ar, SpecificSubclass);
	}
	static void AppendToClassSchema(FAppendToClassSchemaContext& Context)
	{
		T::AppendToClassSchema(Context);
	}
	static void DeclareConstructClasses(TArray<FTopLevelAssetPath>& OutConstructClasses, const UClass* SpecificSubclass)
	{
		T::DeclareConstructClasses(OutConstructClasses, SpecificSubclass);
	}
	static void InjectDynamicImportsFor(const class FLinkerLoad& Linker, const struct FObjectExport& Export, TArray<struct FDynamicImport>& OutDynamicImports)
	{
		T::InjectDynamicImportsFor(Linker, Export, OutDynamicImports);
	}
...
public:
	...
	typedef void (*InjectDynamicImportsForType)	(const class FLinkerLoad& Linker, const struct FObjectExport& Export, TArray<struct FDynamicImport>& OutDynamicImports);
#endif
	...
	static constexpr FUObjectCppClassStaticFunctions ForClass()
	{
#if IS_MONOLITHIC
		using DispatchType = TClass;
#else
		using DispatchType = TUObjectCppClassStaticThunks<TClass>;
#endif // IS_MONOLITHIC
		return FUObjectCppClassStaticFunctions(
			&DispatchType::AddReferencedObjects
	#if WITH_EDITORONLY_DATA
			, &DispatchType::DeclareCustomVersions, &DispatchType::AppendToClassSchema, &DispatchType::DeclareConstructClasses, &DispatchType::InjectDynamicImportsFor
	#endif
		);
	}
	...
	explicit constexpr FUObjectCppClassStaticFunctions(AddReferencedObjectsType InAddReferencedObjects
		...
		, InjectDynamicImportsForType InInjectDynamicImportsFor
#endif
	)
		...
		, InjectDynamicImportsFor(InInjectDynamicImportsFor)
#endif
	{
		...
		check(InInjectDynamicImportsFor);
#endif
...
public:
	...
	constexpr FUObjectCppClassStaticFunctions(const FUObjectCppClassStaticFunctions&) = default;
	FUObjectCppClassStaticFunctions& operator=(const FUObjectCppClassStaticFunctions&) = default;
...
public:
	...
	InjectDynamicImportsForType GetInjectDynamicImportsFor() const
	{
		return InjectDynamicImportsFor;
	}
	void SetInjectDynamicImportsFor(InjectDynamicImportsForType InInjectDynamicImportsFor)
	{
		check(InInjectDynamicImportsFor != nullptr); // It is not valid to clear single elements (see IsInitialized). Call Reset to clear all elements.
		InjectDynamicImportsFor = InInjectDynamicImportsFor;
	}
#endif
...
private:
	...
	InjectDynamicImportsForType InjectDynamicImportsFor = nullptr;
#endif
...
#define IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(TClass) \
	...
	UClass* Z_Construct_UClass##TClass##_Inner() \
	{ \
		...
		{ \
			...
			GetPrivateStaticClassBody( \
				...
				(TCHAR*)TEXT(#TClass) + 1 + ((TClass::StaticClassFlags & CLASS_Deprecated) ? 11 : 0), \
				Z_Registration_Info_UClass_##TClass.InnerSingleton, \
				TClass::StaticRegisterNatives##TClass, \
				DataSizeOf<TClass>(), \
				alignof(TClass), \
	...
	UClass* TClass::GetPrivateStaticClass(ETypeConstructPhase) \
	{ \
		return Z_Construct_UClass##TClass##_Inner(); \
	}
#endif // !UE_WITH_CONSTINIT_UOBJECT
...
#define IMPLEMENT_CLASS(TClass, TClassCrc) \
	...
	static FRegisterCompiledInInfo AutoInitialize_##TClass(&Z_Construct_UClass_##TClass, TClass::StaticPackage(), TEXT(#TClass), Z_Registration_Info_UClass_##TClass, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(TClass), TClassCrc));
...
#else
#define IMPLEMENT_INTRINSIC_CLASS(TClass, TRequiredAPI, TSuperClass, TSuperRequiredAPI, TPackage, InitCode) \
	TRequiredAPI UClass* Z_Construct_UClass_##TClass(ETypeConstructPhase); \
	...
	{ \
		...
		{ \
			extern TSuperRequiredAPI UClass* Z_Construct_UClass_##TSuperClass(ETypeConstructPhase); \
			UClass* SuperClass = Z_Construct_UClass_##TSuperClass(ETypeConstructPhase::Outer); \
	...
	UClass* Z_Construct_UClass##TClass##_Inner(); \
	UClass* Z_Construct_UClass_##TClass(ETypeConstructPhase Phase) \
	{ \
...
#define IMPLEMENT_INTRINSIC_CLASS_CONSTINIT(TClass, TRequiredAPI, TSuperClass, TSuperRequiredAPI, TPackage, InitCode) \
	...
	constinit TNoDestroy<UClass> Z_ConstInit_UClass_##TClass{NoDestroyConstEval, \
		...
		UE::CodeGen::ConstInit::FStructParams{ \
			...
			.PropertiesSize = DataSizeOf<TClass>(), \
	...
	static FRegisterIntrinsicClass Z_Register_UClass_##TClass{ &Z_ConstInit_UClass_##TClass, &Z_Construct_UClass_##TClass##_Statics::Construct }; \
	UClass* TClass::GetPrivateStaticClass(ETypeConstructPhase) \
	{ \
...
#define REN_ForceNoResetLoaders		    UE_DEPRECATED_MACRO(5.8, "Rename will no longer call ResetLoaders making this flag no longer needed. Prefer REN_AllowPackageLinkerMismatch if you wish to intentionally allow the linker to contain references to objects whose names no longer match what was loaded from disk.") \
										(0x0001) 
...
public:
	/** virtual destructor **/
	virtual ~FRestoreForUObjectOverwrite() = default;
