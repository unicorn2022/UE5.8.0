...
/**
 * Cooked meta-data base class.
 */
UCLASS(Abstract)
class UCookedMetaDataBase : public UObject
{
public:
	GENERATED_BODY()
};
...
class UEnumCookedMetaData : public UCookedMetaDataBase
{
public:
	GENERATED_BODY()
...
class UStructCookedMetaData : public UCookedMetaDataBase
{
public:
	GENERATED_BODY()
...
class UClassCookedMetaData : public UCookedMetaDataBase
{
public:
	GENERATED_BODY()
