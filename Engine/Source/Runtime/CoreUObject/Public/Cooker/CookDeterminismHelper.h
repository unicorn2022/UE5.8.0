...
{
	virtual ~IDeterminismConstructDiagnosticsContext() = default;
...
{
	virtual ~IDeterminismModifiedExportContext() = default;
...
struct IDeterminismModifiedPackageContext
{
	virtual ~IDeterminismModifiedPackageContext() = default;
 ...
 */
class IDeterminismHelper : public FRefCountedObject
{
public:
	/**
