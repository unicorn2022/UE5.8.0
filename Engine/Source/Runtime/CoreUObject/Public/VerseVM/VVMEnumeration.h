...
struct VEnumeration : VNamedType
{
	 ...
	 */
	AUTORTFM_DISABLE static VEnumeration& New(FAllocationContext Context, VPackage* Package, VArray* RelativePath, VArray* EnumName, VArray* AttributeIndices, VArray* Attributes, UEnum* ImportEnum, bool bNative, const TArray<VEnumerator*>& Enumerators);

	AUTORTFM_DISABLE static void SerializeLayout(FAllocationContext Context, VEnumeration*& This, FStructuredArchiveVisitor& Visitor);
...
private:
	AUTORTFM_DISABLE COREUOBJECT_API VEnumeration(FAllocationContext Context, VPackage* InPackage, VArray* InRelativePath, VArray* InEnumName, VArray* InAttributeIndices, VArray* InAttributes, UEnum* InImportEnum, bool bInNative, const TArray<VEnumerator*>& InEnumerators);
	AUTORTFM_DISABLE COREUOBJECT_API VEnumeration(FAllocationContext Context, int32 InNumEnumerators);
