...
#undef VISIT_KIND
	...
	virtual ~FRuntimeType() {} // This can _not_ be = default; for reasons I don't understand

	virtual void InitializeValueFromCopy(void* DestData, const void* SourceData) const override
	{
		InitializeValueFrom(DestData, SourceData, *this);
	}
...
struct FRuntimeTypeDynamic : FRuntimeType
{
	...
	COREUOBJECT_API virtual void InitializeValueFrom(void* DestData, const void* SourceData, const FRuntimeType& SourceType) const override;
	...
	COREUOBJECT_API virtual void ForEachSubobject(const void* Data, TFunctionRef<void(const UObject*)> ObjectFunc) const override;
