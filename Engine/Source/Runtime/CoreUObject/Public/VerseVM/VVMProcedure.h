...
struct VProcedure : VCell
{
	...
	AUTORTFM_DISABLE static VProcedure& NewUninitialized(
	...
	AUTORTFM_DISABLE static void SerializeLayout(FAllocationContext Context, VProcedure*& This, FStructuredArchiveVisitor& Visitor);
