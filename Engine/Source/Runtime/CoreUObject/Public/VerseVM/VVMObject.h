...
struct VObject : VHeapValue
{
	...
	FOpResult LoadField(FAllocationContext Context, const VUniqueString& Name, VValue Self = VValue(), FLoadFieldCacheCase* OutCacheCase = nullptr);
	...
	{
		return GetEmergentType()->Type->StaticCast<VClass>();
	}
...
protected:
	...
	COREUOBJECT_API FOpResult LoadField(FAllocationContext Context, VEmergentType& EmergentType, const VShape::VEntry* Field, VValue Self = VValue(), FLoadFieldCacheCase* OutCacheCase = nullptr);
