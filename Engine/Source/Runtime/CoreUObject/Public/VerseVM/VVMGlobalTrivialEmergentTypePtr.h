...
protected:
	AUTORTFM_DISABLE VEmergentType& Get(FAllocationContext Context, VCppClassInfo* ClassInfo, bool bWithShape)
	{
	...
	AUTORTFM_DISABLE COREUOBJECT_API VEmergentType& GetSlow(FAllocationContext Context, VCppClassInfo* ClassInfo, bool bWithShape);
...
struct TGlobalTrivialEmergentTypePtr : public FGlobalTrivialEmergentTypePtr
{
	...
	AUTORTFM_DISABLE VEmergentType& Get(FAllocationContext Context, bool bWithShape = false)
	{
