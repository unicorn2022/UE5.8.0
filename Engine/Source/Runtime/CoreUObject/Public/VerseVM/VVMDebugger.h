...
struct FDebugger
{
	...
	virtual bool HasConnectedClient() = 0;
};
...
AUTORTFM_DISABLE COREUOBJECT_API void ForEachStackFrame(
	FRunningContext,
	const FOp*,
	VFrame*,
	VTask*,
	const FNativeFrame*,
	AUTORTFM_IMPLICIT_DISABLE TFunctionRef<void(const FLocation*, FFrame)>);
} // namespace Debugger
} // namespace Verse
