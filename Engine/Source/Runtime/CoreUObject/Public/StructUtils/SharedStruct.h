...
struct [[nodiscard]] TSharedStruct
{
	...
	{
		TSharedStruct Result;
		Result.SharedStruct = FSharedStruct::Make<T>();
		return Result;
	}
	...
	{
		TSharedStruct Result;
		Result.SharedStruct = FSharedStruct::Make<T>(Struct);
		return Result;
	}
	...
	{
		TSharedStruct Result;
		Result.SharedStruct = FSharedStruct::Make<BaseStructT>(Forward<TArgs>(InArgs)...);
		return Result;
	}
	...
	{
		return SharedStruct.operator==(Other.SharedStruct);
	}
	...
	template<typename T = BaseStructT>
		requires (std::is_base_of_v<BaseStructT, std::decay_t<T>>)
	bool operator==(const TConstSharedStruct<T>& Other) const
	{
		return SharedStruct.operator==(Other.ConstSharedStruct);
	}
...
struct [[nodiscard]] TConstSharedStruct
{
	...
	template<typename T = BaseStructT>
		requires (std::is_base_of_v<BaseStructT, std::decay_t<T>>)
	TConstSharedStruct(const TSharedStruct<T>& SharedStruct)
	...
	template<typename T = BaseStructT>
		requires (std::is_base_of_v<BaseStructT, std::decay_t<T>>)
	TConstSharedStruct(TSharedStruct<T>&& SharedStruct)
		: ConstSharedStruct(MoveTemp(SharedStruct.SharedStruct))
	{
	}
	...
	static TConstSharedStruct Make()
	{
		...
		SharedStruct.Initialize<BaseStructT>();
		return SharedStruct;
	}
	...
	{
		TConstSharedStruct SharedStruct;
		SharedStruct.Initialize<BaseStructT>(Struct);
		return SharedStruct;
	}
	...
	bool operator==(const TSharedStruct<T>& Other) const
	{
		return ConstSharedStruct.operator==(Other.SharedStruct);
	}
	...
	bool operator==(const TConstSharedStruct<T>& Other) const
	{
		return ConstSharedStruct.operator==(Other.ConstSharedStruct);
	}
