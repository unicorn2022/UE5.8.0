...
UE_DEPRECATED(5.8, "This method will be removed.")
...
{
public:
	virtual ~IAsyncPackageLoader() = default;
	...
	UE_DEPRECATED(5.8, "This method will be removed.")
	virtual bool ShouldAlwaysLoadPackageAsync(const FPackagePath& PackagePath) { return true; }
	...
	*/
	...
	virtual void NotifyRegistrationEvent(FName PackageName, FName Name, ENotifyRegistrationType NotifyRegistrationType, ENotifyRegistrationPhase NotifyRegistrationPhase, FTypeConstructFunc* InRegister, bool InbDynamic, UObject* FinishedObject) = 0;
