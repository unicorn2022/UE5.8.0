...
{
	extern COREUOBJECT_API const FName MessageLogName;
}
...
public:
	 ...
	 * @param The name of the message log to use for warnings/errors/etc
	...
	FDataValidationContext(
			...
			FName InMessageLogName = UE::DataValidation::MessageLogName)
		: AssociatedExternalObjects(InAssociatedObjects)
		, ValidationUsecase(InUsecase)
		, MessageLogName(InMessageLogName)
	...
	FName GetMessageLogName() const { return MessageLogName; }
