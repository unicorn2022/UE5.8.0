	...
	InstallBundleUtil::StartInstallBundleAsyncIOTask(AsyncTasks,
		[this, NewReport]()
		{
			if (FPaths::FileExists(ReportFilename))
			{
				...
				{
					UE_LOGF(LogInstallBundleManager, Display, "Reading InstallManagerBundleReportCache: %ls", *ReportFilename);
				...
				{
					UE_LOGF(LogInstallBundleManager, Warning, "Failed to read: %ls", *ReportFilename);
				}
			}
		},
