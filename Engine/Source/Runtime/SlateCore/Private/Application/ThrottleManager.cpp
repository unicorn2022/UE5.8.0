...
static int32 GSlateAllowThrottling = 1;
static FAutoConsoleVariableRef CVarSlateAllowThrottling(
	TEXT("Slate.bAllowThrottling"),
	GSlateAllowThrottling,
	TEXT("Allow Slate to throttle parts of the engine to ensure the UI is responsive"));
...
bool FSlateThrottleManager::IsAllowingExpensiveTasks( ) const
{
	...
	return (ThrottleCount == 0) || !GSlateAllowThrottling || DisableThrottleCount > 0;
}
