...
FSlateAttributeDescriptor::FContainerInitializer::FAttributeEntry FSlateAttributeDescriptor::FContainerInitializer::AddContainedAttribute(FName AttributeName, SIZE_T Offset, const FInvalidateWidgetReasonAttribute& Reason)
{
	check(Offset <= std::numeric_limits<OffsetType>::max());
	return Descriptor.AddContainedAttribute(ContainerName, AttributeName, (OffsetType)Offset, Reason);
}
...
FSlateAttributeDescriptor::FContainerInitializer::FAttributeEntry FSlateAttributeDescriptor::FContainerInitializer::AddContainedAttribute(FName AttributeName, SIZE_T Offset, FInvalidateWidgetReasonAttribute&& Reason)
{
	check(Offset <= std::numeric_limits<OffsetType>::max());
	return Descriptor.AddContainedAttribute(ContainerName, AttributeName, (OffsetType)Offset, MoveTemp(Reason));
}
