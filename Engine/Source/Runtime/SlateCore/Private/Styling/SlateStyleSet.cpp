...
void FSlateStyleSet::Log(ISlateStyle::EStyleMessageSeverity Severity, const FText& Message) const
{
	...
	{
		UE_LOGF(LogSlateStyle, Error, "%ls", *Message.ToString());
	}
	else if ( Severity == EStyleMessageSeverity::PerformanceWarning )
	{
		UE_LOGF(LogSlateStyle, Warning, "%ls", *Message.ToString());
	}
	...
	{
		UE_LOGF(LogSlateStyle, Log, "%ls", *Message.ToString());
	}
	else
	{
		UE_LOGF(LogSlateStyle, Fatal, "%ls", *Message.ToString());
	}
}
