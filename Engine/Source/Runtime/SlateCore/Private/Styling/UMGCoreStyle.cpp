...
struct FUMGColor
{
	...
	inline static const FSlateColor Black = FLinearColor(0.000000f, 0.000000f, 0.000000f);
	inline static const FSlateColor Title = FLinearColor(0.849999f, 0.849999f, 0.849999f);
	inline static const FSlateColor WindowBorder = FLinearColor(0.577777f, 0.577777f, 0.577777f);
	inline static const FSlateColor Foldout = FLinearColor(0.577777f, 0.577777f, 0.577777f);
	inline static const FSlateColor Input = FLinearColor(0.577777f, 0.577777f, 0.577777f);
	inline static const FSlateColor InputOutline = FLinearColor(0.695111f, 0.695111f, 0.695111f);
	inline static const FSlateColor Recessed = FLinearColor(0.203300f, 0.203300f, 0.203300f);
	inline static const FSlateColor Background = FLinearColor(0.849999f, 0.849999f, 0.849999f);
	inline static const FSlateColor Panel = FLinearColor(0.276422f, 0.276422f, 0.276422f);
	inline static const FSlateColor Header = FLinearColor(0.384266f, 0.384266f, 0.384266f);
	inline static const FSlateColor Dropdown = FLinearColor(0.495466f, 0.495466f, 0.495466f);
	inline static const FSlateColor DropdownOutline = FLinearColor(0.822722f, 0.822722f, 0.822722f);
	inline static const FSlateColor Hover = FLinearColor(0.724268f, 0.724268f, 0.724268f);
	inline static const FSlateColor Hover2 = FLinearColor(0.215861f, 0.215861f, 0.215861f);
	inline static const FSlateColor White = FLinearColor(0.000000f, 1.000000f, 1.000000f);
	inline static const FSlateColor White25 = FLinearColor(0.000000f, 1.000000f, 1.000000f);
	inline static const FSlateColor Highlight = FLinearColor(0.000000f, 0.187821f, 0.679542f);

	inline static const FSlateColor Primary = FLinearColor(0.019382f, 0.496933f, 1.000000f);
	inline static const FSlateColor PrimaryHover = FLinearColor(0.158961f, 0.644480f, 1.000000f);
	inline static const FSlateColor PrimaryPress = FLinearColor(0.009721f, 0.250158f, 0.502886f);
	inline static const FSlateColor Secondary = FLinearColor(0.495466f, 0.495466f, 0.495466f);

	inline static const FSlateColor Foreground = FLinearColor(0.527115f, 0.527115f, 0.527115f);
	inline static const FSlateColor ForegroundHover = FLinearColor(0.000000f, 1.000000f, 1.000000f);
	inline static const FSlateColor ForegroundInverted = FLinearColor(0.472885f, 0.472885f, 0.472885f);
	inline static const FSlateColor ForegroundHeader = FLinearColor(0.577580f, 0.577580f, 0.577580f);

	inline static const FSlateColor Select = FLinearColor(0.019382f, 0.496933f, 1.000000f);
	inline static const FSlateColor SelectInactive = FLinearColor(0.318547f, 0.450786f, 0.520996f);
	inline static const FSlateColor SelectParent = FLinearColor(0.025187f, 0.031896f, 0.042311f);
	inline static const FSlateColor SelectHover = FLinearColor(0.276422f, 0.276422f, 0.276422f);
...
TSharedRef<ISlateStyle> FUMGCoreStyle::Create()
{
	...
	if (!FPaths::FileExists(CanaryPath))
	{
		...
		UE_LOGF(LogSlate, Warning, "FUMGCoreStyle assets not detected, skipping FUMGCoreStyle initialization");
