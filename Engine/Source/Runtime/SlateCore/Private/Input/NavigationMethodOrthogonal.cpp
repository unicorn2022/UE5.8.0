		...
		for (StrideCellPoint[StrideAxis] = StrideAxisMin; StrideCellPoint[StrideAxis] <= StrideAxisMax; ++StrideCellPoint[StrideAxis])
		{
			...
			for (int32 i = WidgetIndexes.Num() - 1; i >= 0; --i)
			{
				...
				if (!HittestGrid->IsCompatibleUserIndex(UserIndex, TestCandidate.UserIndex))
				{
					...
					AddDebugIntermediateResult(TestWidget, HittestGridDebuggingText::NotCompatibleWithUserIndex);
#endif
					continue;
				}
				...
				{
#if WITH_SLATE_DEBUGGING || WITH_SLATE_NAVIGATION_DEBUGGING
					AddDebugIntermediateResult(TestWidget, HittestGridDebuggingText::DoesNotIntersect);
#endif
					continue;
				}
				...
				{
#if WITH_SLATE_DEBUGGING || WITH_SLATE_NAVIGATION_DEBUGGING
					AddDebugIntermediateResult(TestWidget, HittestGridDebuggingText::PreviousWidgetIsBetter);
#endif
					continue;
				}
				...
				{
#if WITH_SLATE_DEBUGGING || WITH_SLATE_NAVIGATION_DEBUGGING
					AddDebugIntermediateResult(TestWidget, HittestGridDebuggingText::NotADescendant);
#endif
					continue;
				}
				...
				{
#if WITH_SLATE_DEBUGGING || WITH_SLATE_NAVIGATION_DEBUGGING
					AddDebugIntermediateResult(TestWidget, HittestGridDebuggingText::Disabled);
#endif
					continue;
				}
				...
				{
#if WITH_SLATE_DEBUGGING || WITH_SLATE_NAVIGATION_DEBUGGING
					AddDebugIntermediateResult(TestWidget, HittestGridDebuggingText::DoesNotSuportKeyboardFocus);
#endif
					continue;
				}
				...
				{
#if WITH_SLATE_DEBUGGING || WITH_SLATE_NAVIGATION_DEBUGGING
					AddDebugIntermediateResult(TestWidget, HittestGridDebuggingText::ParentDisabled);
#endif
					continue;
				}
...
#if WITH_SLATE_DEBUGGING || WITH_SLATE_NAVIGATION_DEBUGGING
				AddDebugIntermediateResult(TestWidget, HittestGridDebuggingText::Valid);
#endif
			}
		}
