...
public:
	...
	virtual ~FSlateApplicationBase() = default;
...
public:
	...
	*/
	...
	/**
	 * Gets the application's cached display metrics without copy.
	 *
	 * @return The cached display metrics.
	 */
	const FDisplayMetrics& GetCachedDisplayMetricsByRef() const { return CachedDisplayMetrics; }
