...
public:
	...
	inline void SetBatchFlags(ESlateBatchDrawFlag InFlags) { BatchFlags = InFlags; }
	inline void AddBatchFlags(ESlateBatchDrawFlag InFlags) { BatchFlags |= InFlags; }
