...
enum class ESlateAttributeInitialization
{
	None = 0, // Do not initialize Slate Attributes values
	AfterConstruct, // Initialize all Slate Attributes values after Construct
};
...
#include "Types/Attributes/SlateAttributeNestedMember.inl"
