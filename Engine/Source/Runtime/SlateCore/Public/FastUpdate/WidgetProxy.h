...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UE_DEPRECATED(5.8, "Use methods instead of direct field access")
	uint8 bIsInGameLayer : 1;

	/** The value of SWidget::IsContent() */
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	/** Only to be called by SWidget::Paint. */
	void SetIsProjectContent(bool bInIsContent)
	{
PRAGMA_DISABLE_DEPRECATION_WARNINGS
		bIsInGameLayer = bInIsContent;
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	}
