...
#ifndef WITH_SLATE_NAVIGATION_DEBUGGING
	#define WITH_SLATE_NAVIGATION_DEBUGGING 1
#endif
...
public:
	static SLATECORE_API void IncrementInvalidationPanelCount(bool bCanCache, bool bCanUseDynamic, bool bSupportsInvalidation);
	static SLATECORE_API void ResetInvalidationPanelCount();
	static uint32 GetNoInvalidationPanels() { return NoInvalidationPanels; }
	static uint32 GetNoDynamicInvalidationPanels() { return NoDynamicInvalidationPanels; }
	static uint32 GetNoDynamicInvalidationPanelsSupportingInvalidation() { return NoDynamicInvalidationPanelsSupportingInvalidation; }
...
private:
	...
	static SLATECORE_API uint32 NoInvalidationPanels;
	static SLATECORE_API uint32 NoDynamicInvalidationPanels;
	static SLATECORE_API uint32 NoDynamicInvalidationPanelsSupportingInvalidation;
};
