...
struct FSpectatorScreenModeTexturePlusEyeLayout
{
	...
	bool IsValid() const 
	{
		...
		{
			UE_LOGF(LogHMD, Warning, "SpectatorScreenModeTexturePlusEyeLayout EyeRect is invalid!  Max is not greater than Min in some dimension.");
			bValid = false;
		}
		if ((TextureRectMax.X <= TextureRectMin.X) || (TextureRectMax.Y <= TextureRectMin.Y))
		{
			UE_LOGF(LogHMD, Warning, "SpectatorScreenModeTexturePlusEyeLayout TextureRect is invalid!  Max is not greater than Min in some dimension.");
			bValid = false;
		}
		...
		{
			UE_LOGF(LogHMD, Warning, "SpectatorScreenModeTexturePlusEyeLayout EyeRect is invalid!  All dimensions must be in 0-1 range.");
			bValid = false;
		}
		...
		{
			UE_LOGF(LogHMD, Warning, "SpectatorScreenModeTexturePlusEyeLayout TextureRect is invalid!  All dimensions must be in 0-1 range.");
			bValid = false;
		}
		return bValid;
	}
