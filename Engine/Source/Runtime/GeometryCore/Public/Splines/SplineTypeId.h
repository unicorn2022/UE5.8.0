...
GEOMETRYCORE_API DECLARE_LOG_CATEGORY_EXTERN(LogSpline, Log, All);
...
public:
                                  ...
                                  const FString& ExistingImplName, const FString& ExistingValueTypeName)
    {
        ...
        {
            UE_LOGF(LogSpline, Error, " HASH COLLISION in SplineTypeId!! ️");
            UE_LOGF(LogSpline, Error, "  TypeId: 0x%08X", TypeId);
            UE_LOGF(LogSpline, Error, "  Attempted registration: Impl=%ls, Value=%ls", 
                   *ImplName, *ValueTypeName);
            UE_LOGF(LogSpline, Error, "  Existing registration: Impl=%ls, Value=%ls",
