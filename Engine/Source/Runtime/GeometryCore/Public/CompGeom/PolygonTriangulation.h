...
namespace PolygonTriangulation
{
	...
	/**
	* Computes a plane centroid and plane normal from an input 3D polygon.
	* @param VertexPositions ordered vertices of 3D polygon.
	* @param PlaneNormalOut normal of the computed plane. Will be normalized.
	* @param PlanePointOut centroid of the computed plane.
	* @return Area of the polygon.
	*/
	template<typename RealType>
	RealType GEOMETRYCORE_API ComputePolygonPlane(const TArray<TVector<RealType>>& VertexPositions, TVector<RealType>& PlaneNormalOut, TVector<RealType>& PlanePointOut );
