...
namespace BufferUtil
{
	...
	/**
	 * Sort an array view's values by the values in a second array view
	 */
	template<typename SortType, typename ValueType>
	void SortByValuesArray(TArrayView<SortType> ToSort, TConstArrayView<ValueType> Values, bool bStableSort, bool bAscendingOrder)
	{
