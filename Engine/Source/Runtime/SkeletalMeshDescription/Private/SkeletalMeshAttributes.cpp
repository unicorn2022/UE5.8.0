...
namespace MeshAttribute
{
	...
	{
		const FName ParentPolygonGroup("ParentPolygonGroup");
	}
...
{
	MeshDescription.VertexAttributes().UnregisterAttribute(MeshAttribute::Vertex::ImportPointIndex);	
}

bool FSkeletalMeshAttributes::RegisterPolygonGroupParentAttribute()
{
	return MeshDescription.PolygonGroupAttributes().RegisterAttribute<int32>(MeshAttribute::PolygonGroup::ParentPolygonGroup, 1, INDEX_NONE).IsValid();	
}
