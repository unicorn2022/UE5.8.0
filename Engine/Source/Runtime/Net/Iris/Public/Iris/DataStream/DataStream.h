...
namespace UE::Net
{
	...
	enum class EDataStreamWriteMode : unsigned
	{
		...
		// Only write debug data that should not count against bandwidth limits
		DebugData,
	};
}
...
public:
	...
	*/
	...
	/** 
	 * @return true if the stream indicates that is has debug data to write.
	 */
	IRISCORE_API virtual bool HasDebugDataToSend() const;
