...
IRISCORE_API bool BreakOnInternalNetRefIndex(UE::Net::FInternalNetRefIndex InternalIndex);
...
IRISCORE_API UE::Net::FInternalNetRefIndex GetDebugNetInternalIndex();
...
struct FNetReplicatedObjectDebugInfo
{
	...
	UE::Net::FInternalNetRefIndex InternalNetRefIndex;
...
extern "C" IRISCORE_API FNetReplicatedObjectDebugInfo DebugInternalNetRefIndex(UE::Net::FInternalNetRefIndex InternalIndex, uint32 ReplicationSystemId);
...
extern "C" IRISCORE_API void SetIrisDebugInternalNetRefIndex(UE::Net::FInternalNetRefIndex InternalIndex);
