...
#		define IRIS_PROFILER_SCOPE(X) PERFORMANCEAPI_INSTRUMENT(UE_STRINGIZE(X))
#		define IRIS_PROFILER_SCOPE_CONDITIONAL(X,Cond) PERFORMANCEAPI_INSTRUMENT(UE_STRINGIZE(X))
#		define IRIS_PROFILER_SCOPE_STR(X) PERFORMANCEAPI_INSTRUMENT_DATA(UE_JOIN(IrisProfilerScope, __LINE__), X)
#		define IRIS_PROFILER_SCOPE_STR_CONDITIONAL(X, Cond) PERFORMANCEAPI_INSTRUMENT_DATA(UE_JOIN(IrisProfilerScope, __LINE__), X)
#		define IRIS_PROFILER_SCOPE_TEXT(X) PERFORMANCEAPI_INSTRUMENT_DATA(UE_JOIN(IrisProfilerScope, __LINE__), X)
#		define IRIS_PROFILER_SCOPE_TEXT_CONDITIONAL(X, Cond) PERFORMANCEAPI_INSTRUMENT_DATA(UE_JOIN(IrisProfilerScope, __LINE__), X)
#	else
...
#		define IRIS_PROFILER_SCOPE_STR(X) TRACE_CPUPROFILER_EVENT_SCOPE_STR(X)
#		define IRIS_PROFILER_SCOPE_STR_CONDITIONAL(X, Cond) TRACE_CPUPROFILER_EVENT_SCOPE_STR_CONDITIONAL(X, Cond)
...
#	define IRIS_PROFILER_SCOPE_STR(X)
#	define IRIS_PROFILER_SCOPE_STR_CONDITIONAL(X, Cond)
