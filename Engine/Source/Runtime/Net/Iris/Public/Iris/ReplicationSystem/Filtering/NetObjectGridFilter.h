...
protected:
	...
	IRISCORE_API virtual bool AddObject(UE::Net::FInternalNetRefIndex ObjectNetIndex, FNetObjectFilterAddObjectParams&) override;
	IRISCORE_API virtual void RemoveObject(UE::Net::FInternalNetRefIndex ObjectNetIndex, const FNetObjectFilteringInfo&) override;
...
protected:
	struct FObjectLocationInfo : public FNetObjectFilteringInfo
	{
		/**
		* Data mapping:
		* uint16 Data[0] = Not used
		* uint16 Data[1] = Not used
...
protected:
	...
	struct FPerObjectInfo
	{
		...
		FCellBox CellBox;
		UE::Net::FInternalNetRefIndex ObjectIndex = UE::Net::InvalidInternalNetRefIndex;
		uint16 FrameCountBeforeCulling = 0U;
		//unused 16bits of padding
	...
	virtual bool BuildObjectInfo(UE::Net::FInternalNetRefIndex ObjectNetIndex, FNetObjectFilterAddObjectParams& Params) { return false; }

	/** Callback when an object is removed from the grid. Useful to cleanup data tied to the object. */
	virtual void OnObjectRemoved(UE::Net::FInternalNetRefIndex ObjectNetIndex) {}
...
private:
	...
	struct FCellObjects
	{
		TSet<UE::Net::FInternalNetRefIndex> ObjectIndices;
	};
	...
	struct FPerConnectionInfo
	{
		...
		TMap<UE::Net::FInternalNetRefIndex, uint16> RecentObjectFrameCount;
	};
