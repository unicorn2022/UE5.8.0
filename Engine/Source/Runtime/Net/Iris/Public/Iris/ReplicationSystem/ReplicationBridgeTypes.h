...
enum class EEndReplicationFlags : uint32
{
	...
	/** If true, replication can be resumed effectively canceling the EndReplication by issuing a StartReplication before the StopReplication has been acknowledged by all clients. */
...
//------------------------------------------------------------------------
//TODO: Delete this when deprecating 5.8
...
UE_DEPRECATED(5.8, "Enum is deprecated")
inline const TCHAR* LexToString(EReplicationBridgeDestroyInstanceReason Reason)
{
...
UE_DEPRECATED(5.8, "Enum is deprecated")
inline const TCHAR* LexToString(EReplicationBridgeDestroyInstanceFlags DestroyFlags)
{
	return TEXT("Deprecated");
}
