...
static_assert((uint32)UE_IRIS_MAX_NETOBJECT_FACTORIES < (uint32)InvalidNetObjectFactoryId, "We currently don't support more then 255 unique factories");
...
public:
	...
	static consteval uint32 GetMaxBits() { return UE::Net::GetBitsNeeded(MaxFactories-1); }
