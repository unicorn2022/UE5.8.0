...
public:
	...
	enum : FGroupIndexType
	{
		...
		AsyncStopReplicationNetObjectGroupIndex,
	...
	/** Special group, NetHandles assigned to this group will be filtered out for all connections used for async end replication */
	bool IsAsyncStopReplicationNetObjectGroup() const { return Index == AsyncStopReplicationNetObjectGroupIndex; }
