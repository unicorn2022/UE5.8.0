...
using FObjectToNetRefHandleSerial = TDelegate<uint64(const TObjectPtr<const UObject>& Object)>;
using FNetRefHandleSerialToObject = TDelegate<TObjectPtr<UObject>(const uint64 Id)>;
