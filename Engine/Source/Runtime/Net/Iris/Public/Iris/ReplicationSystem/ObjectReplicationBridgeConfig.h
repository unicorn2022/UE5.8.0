...
public:
	...
	UClass* GetNetRefHandleGeneratorClass() const { return NetRefHandleGeneratorClass; }
...
private:
	...
	/** 
	 * An optional configuration property defines how a NetRefHandle is generated.
	 *
	 * If not set, the NetRefHandle will be generated as an incremental value starting with 1.
	 */
	UPROPERTY(Config)
	TSubclassOf<UNetRefHandleGenerator> NetRefHandleGeneratorClass;
};
