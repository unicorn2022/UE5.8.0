...
void UNetObjectConnectionFilter::SetReplicateToConnection(UE::Net::FNetRefHandle RefHandle, uint32 ConnectionId, UE::Net::ENetFilterStatus FilterStatus)
{
	...
	const UE::Net::FInternalNetRefIndex ObjectIndex = GetObjectIndex(RefHandle);
...
bool UNetObjectConnectionFilter::AddObject(UE::Net::FInternalNetRefIndex ObjectIndex, FNetObjectFilterAddObjectParams& Params)
{
	...
	UE_LOGF(LogIris, Verbose, "UNetObjectConnectionFilter::AddObject added %u | Mapped to LocalIndex %u", ObjectIndex, LocalIndex);
...
void UNetObjectConnectionFilter::RemoveObject(UE::Net::FInternalNetRefIndex ObjectIndex, const FNetObjectFilteringInfo& InInfo)
{
	bObjectRemoved = true;
	...
	UE_LOGF(LogIris, Verbose, "UNetObjectConnectionFilter::RemoveObject removed %u | Mapped to LocalIndex %u", ObjectIndex, LocalIndex);

	// For good measure. It's not strictly needed.
	LocalToNetRefIndex[LocalIndex] = UE::Net::InvalidInternalNetRefIndex;
}
