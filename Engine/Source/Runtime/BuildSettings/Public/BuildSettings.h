...
namespace BuildSettings
{
	...
	*/
	...
	/**
	 * Returns true if variable exists. Writes value into OutValue if not null
	 */
	BUILDSETTINGS_API bool GetVariable(const TCHAR* InName, TCHAR* OutValue, int OutValueCapacity);
}
