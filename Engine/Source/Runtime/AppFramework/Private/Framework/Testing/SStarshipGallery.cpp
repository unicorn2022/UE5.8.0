...
*/
    ...
    TSharedRef<SWidget> ConstructWidgetGallery()
    {
        ...
        ComboItems.Add(MakeShareable(new FString("Option A One")));
        ComboItems.Add(MakeShareable(new FString("Option A Two")));
        ComboItems.Add(MakeShareable(new FString("Option A Three")));
        ComboItems.Add(MakeShareable(new FString("Option A Four")));
        ComboItems.Add(MakeShareable(new FString("Option A Five")));
        ComboItems.Add(MakeShareable(new FString("Option A Six")));
        ComboItems.Add(MakeShareable(new FString("Option A Seven")));
        ComboItems.Add(MakeShareable(new FString("Option A Eight")));
        ComboItems.Add(MakeShareable(new FString("Option A Nine")));
        ComboItems.Add(MakeShareable(new FString("Option A Ten")));
        ComboItems.Add(MakeShareable(new FString("Option A Eleven")));
        ComboItems.Add(MakeShareable(new FString("Option A Twelve")));
        ComboItems.Add(MakeShareable(new FString("Option A Thirteen")));
        ComboItems.Add(MakeShareable(new FString("Option A Fourteen")));
