...
public:
	...
	void Construct(const FArguments& InArgs)
	{
		...
		JustificationTypeOptions.Add( MakeShareable( new FString( "Left" ) ) );
		JustificationTypeOptions.Add( MakeShareable( new FString( "Center" ) ) );
		JustificationTypeOptions.Add( MakeShareable( new FString( "Right" ) ) );
...
protected:
	...
	FReply HandleInsertHyperlinkClicked()
	{
		...
		TSharedRef<FSlateHyperlinkRun> HyperlinkRun = FSlateHyperlinkRun::Create(
			...
			FTestStyle::Get().GetWidgetStyle<FHyperlinkStyle>(FName("RichText.Editor.Hyperlink")), 
			OnHyperlinkClicked,
...
{
	if (TabIdentifier == FName("AnimationTestTab"))
	{
	...
	else if (TabIdentifier == FName("TableViewTestTab"))
	{
		return SNew(SDockTab)
	...
	else if (TabIdentifier == FName("LayoutExampleTab"))
	{
		return SNew(SDockTab)
...
#if WITH_FANCY_TEXT
	else if (TabIdentifier == FName("RichTextTab"))
	{
		return SNew(SDockTab)
	...
	else if ( TabIdentifier == FName( "MultiLineEditTab" ) )
	{
		return SNew(SDockTab)
...
#endif //WITH_FANCY_TEXT
	else if (TabIdentifier == FName("EditableTextTab"))
	{
		return SNew(SDockTab)
...
#if WITH_FANCY_TEXT
	else if (TabIdentifier == FName("RichEditableTextTab"))
	{
		return SNew(SDockTab)
	...
	else if (TabIdentifier == FName("SplineTestTab"))
	{
		return SNew(SDockTab)
			.Clipping(EWidgetClipping::ClipToBounds)
			[
	...
	else if (TabIdentifier == FName("ElementTestsTab"))
	{
		return SNew(SDockTab)
	...
	else if (TabIdentifier == FName("SplitterTestTab"))
	{
		return SNew(SDockTab)
	...
	else if (TabIdentifier == FName("MultiBoxTestTab"))
	{
		return SNew(SDockTab)
	...
	else if (TabIdentifier == FName("ColorPickerTestTab"))
	{
		return SNew(SDockTab)
	...
	else if ( TabIdentifier == FName("InvalidationTest") )
	{
		return SNew(SDockTab)
			.Clipping(EWidgetClipping::ClipToBounds)
			[
	...
	else if ( TabIdentifier == FName("GammaTest") )
	{
		return SNew(SDockTab)
			.Clipping(EWidgetClipping::ClipToBounds)
			[
	...
	else if (TabIdentifier == FName("NotificationListTestTab"))
	{
		return SNew(SDockTab)
