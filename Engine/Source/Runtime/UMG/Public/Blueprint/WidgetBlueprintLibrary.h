...
public:
	...
	static UMG_API void DrawTextFormatted(UPARAM(ref) FPaintContext& Context, const FText& Text, FVector2D Position, UFont* Font, float FontSize = 16.0f, FName FontTypeFace = FName("Regular"), FLinearColor Tint = FLinearColor::White);
