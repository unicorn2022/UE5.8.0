...
class UViewport : public UContentWidget
{
	...
	/**
	 * True = WorldType in the new viewport will be set to "EditorPreview". This is advised when spawning a UMG viewport for Editor Tooling
	 * as the default World is WorldType=GamePreview and can cause unneeded subsystems to respond to the creation of the new UWorld.
	 */
