...
enum class EFontFacesLoadingPainPolicy : uint8;
...
public:
	...
	DECLARE_DYNAMIC_MULTICAST_SPARSE_DELEGATE(FOnAllFontFacesFinishLoading_EditableText, UEditableText, OnAllFontFacesFinishLoading);
public:
...
protected:
	...
	FOnAllFontFacesFinishLoading_EditableText OnAllFontFacesFinishLoading;
};
