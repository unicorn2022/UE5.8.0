...
public:
	DECLARE_DYNAMIC_MULTICAST_SPARSE_DELEGATE(FOnAllFontFacesFinishLoading_TextLayoutWidget, UTextLayoutWidget, OnAllFontFacesFinishLoading);
...
protected:
	...
	virtual void OnFontFacesLoadingPaintPolicyChange(EFontFacesLoadingPaintPolicy InFontFacesLoadingPaintPolicy) {};
	...
	void SynchronizeTextLayoutProperties(TWidgetType& InWidget)
	{
		...
		InWidget.SetFontFacesLoadingPaintPolicy(FontFacesLoadingPaintPolicy);
	}
	...
	UPROPERTY(BlueprintAssignable, Category = "Font|Event")
	FOnAllFontFacesFinishLoading_TextLayoutWidget OnAllFontFacesFinishLoading;
