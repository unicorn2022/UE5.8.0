...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnScrollBoxFocusUpdatedEvent, const UWidget*, ScrollBox, const bool, bFocused);
...
public:
	...
	/** Called when the focus of the scrollbox has changed */
	UPROPERTY(BlueprintAssignable, Category = "Scroll|Event")
	FOnScrollBoxFocusUpdatedEvent OnFocusUpdated;
...
protected:
	...
	UMG_API void SlateHandleFocusChanging(const FWeakWidgetPath& PreviousFocusPath, const FWidgetPath& NewWidgetPath);
