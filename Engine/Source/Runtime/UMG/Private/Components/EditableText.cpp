...
void UEditableText::SynchronizeProperties()
{
	...
	MyEditableText->SetFontFacesLoadingPaintPolicy(FontFacesLoadingPaintPolicy);
...
void UEditableText::SetFontFacesLoadingPaintPolicy(EFontFacesLoadingPaintPolicy InFontFacesLoadingPaintPolicy)
{
	FontFacesLoadingPaintPolicy = InFontFacesLoadingPaintPolicy;

	if (MyEditableText)
	{
		MyEditableText->SetFontFacesLoadingPaintPolicy(InFontFacesLoadingPaintPolicy);
	}
}
