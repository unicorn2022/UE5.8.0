...
void UTextLayoutWidget::SetFontFacesLoadingPaintPolicy(EFontFacesLoadingPaintPolicy InFontFacesLoadingPaintPolicy)
{
	if (FontFacesLoadingPaintPolicy != InFontFacesLoadingPaintPolicy)
	{
		FontFacesLoadingPaintPolicy = InFontFacesLoadingPaintPolicy;
		OnFontFacesLoadingPaintPolicyChange(InFontFacesLoadingPaintPolicy);
	}
}
