...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
					// We can't use FPlatformString::Strncpy because of circular module dependencies
					strncpy(HostNameBuffer, ArgV[0], MaxLen);
					HostNameBuffer[MaxLen - 1] = '\0';
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
			// We can't use FPlatformString::Strncpy because of circular module dependencies
			strncpy(Channels, ArgV[0], BufferSize);
			Channels[BufferSize - 1] = '\0';
PRAGMA_ENABLE_DEPRECATION_WARNINGS
