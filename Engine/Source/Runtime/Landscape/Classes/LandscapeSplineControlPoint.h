...
// Directly editable data:
	...
	/** Custom HLOD layer to use for this spline control point. Only relevant when using World Partition with spline partitioning. */
...
public:
	...
	virtual bool IsCapturingAsRootObjectForTransaction() const override { return true; }
