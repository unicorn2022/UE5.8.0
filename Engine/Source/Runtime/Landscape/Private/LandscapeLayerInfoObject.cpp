...
FName ULandscapeLayerInfoObject::GetBlendGroup() const
{
	return (BlendMethod == ELandscapeTargetLayerBlendMethod::PremultipliedAlphaBlending) ? BlendGroup : NAME_None;
}
