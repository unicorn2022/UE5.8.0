...
public:
	...
	void AmortizedUpdateGrassMaps(const TArray<FVector>& Cameras, bool bPrioritizeCreation, bool bAllowStartGrassMapGeneration, bool bAnyLandscapeActorHasGrassEnabled);
