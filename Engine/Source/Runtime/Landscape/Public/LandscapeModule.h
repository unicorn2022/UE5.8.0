...
namespace UE::Landscape
{
	...
	DECLARE_DELEGATE_TwoParams(FSetupLandscapePSOPrecacheVertexFactoryDataListDelegate, ULandscapeComponent* /*InLandscapeComponent*/, FPSOPrecacheVertexFactoryDataList& /*VertexFactoryDataList*/);
} // namespace UE::Landscape
...
public:
	...
	virtual void SetSetupLandscapePSOPrecacheVertexFactoryDataListDelegate(const UE::Landscape::FSetupLandscapePSOPrecacheVertexFactoryDataListDelegate& InDelegate) PURE_VIRTUAL(ILandscapeModule::SetSetupLandscapePSOPrecacheVertexFactoryDataListDelegate, );
	virtual const UE::Landscape::FSetupLandscapePSOPrecacheVertexFactoryDataListDelegate& GetSetupLandscapePSOPrecacheVertexFactoryDataListDelegate() const 
		PURE_VIRTUAL(ILandscapeModule::GetSetupLandscapePSOPrecacheVertexFactoryDataListDelegate, static UE::Landscape::FSetupLandscapePSOPrecacheVertexFactoryDataListDelegate Dummy; return Dummy; );
};
