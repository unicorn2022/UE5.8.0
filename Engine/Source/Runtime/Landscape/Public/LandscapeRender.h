...
public:
	...
	virtual bool GetParameterValue(EMaterialParameterType Type, const FHashedMaterialParameterInfo& ParameterInfo, FMaterialParameterValue& OutValue, const FMaterialRenderContext& Context) const
	{
		...
		case EMaterialParameterType::Vector:
			if (ParameterInfo.Name == FName("Landscape_RedMask"))
			{
				OutValue = R;
				return true;
			}
			else if (ParameterInfo.Name == FName("Landscape_GreenMask"))
			{
				OutValue = G;
				return true;
			}
			else if (ParameterInfo.Name == FName("Landscape_BlueMask"))
			{
				OutValue = B;
				return true;
			}
		...
		case EMaterialParameterType::Texture:
			if (ParameterInfo.Name == FName("Landscape_RedTexture"))
			{
				OutValue = RedTexture;
				return true;
			}
			else if (ParameterInfo.Name == FName("Landscape_GreenTexture"))
			{
				OutValue = GreenTexture;
				return true;
			}
			else if (ParameterInfo.Name == FName("Landscape_BlueTexture"))
			{
...
public:
	...
	virtual bool GetParameterValue(EMaterialParameterType Type, const FHashedMaterialParameterInfo& ParameterInfo, FMaterialParameterValue& OutValue, const FMaterialRenderContext& Context) const
	{
		...
		{
		case EMaterialParameterType::Vector:
			if (ParameterInfo.Name == FName("HighlightColor"))
			{
			...
			break;
		case EMaterialParameterType::Texture:
			if (ParameterInfo.Name == FName("SelectedData"))
			{
...
public:
	...
	virtual bool GetParameterValue(EMaterialParameterType Type, const FHashedMaterialParameterInfo& ParameterInfo, FMaterialParameterValue& OutValue, const FMaterialRenderContext& Context) const
	{
		...
		case EMaterialParameterType::Scalar:
			if (ParameterInfo.Name == FName("bInverted"))
			{
...
public:
	...
	virtual bool GetParameterValue(EMaterialParameterType Type, const FHashedMaterialParameterInfo& ParameterInfo, FMaterialParameterValue& OutValue, const FMaterialRenderContext& Context) const
	{
		...
		case EMaterialParameterType::Vector:
			...
			break;
		case EMaterialParameterType::Scalar:
			if (ParameterInfo.Name == FName("Rotation"))
			{
				OutValue = Rotation;
				return true;
			}
			else if (ParameterInfo.Name == FName("NumStripes"))
			{
				OutValue = (float)LayerColors.Num();
				return true;
			}
			else if (ParameterInfo.Name == FName("ComponentSizeVerts"))
			{
