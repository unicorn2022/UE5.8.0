...
public:
	 ...
	 * @param InBuildFlags - Various flags for driving the build
	 */
	...
	FLandscapeGroup* GetLandscapeGroupForProxy(TObjectPtr<ALandscapeProxy> Proxy);
...
private:
	...
	int32 LastVisualTickFrameNumber = -1;
