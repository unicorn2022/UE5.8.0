	...
	: Params(InParams)
{
	...
	UE_LOGF(LogMediaAssets, Verbose, "MediaSoundComponent: FMediaSoundGenerator Created.");
}

FMediaSoundGenerator::~FMediaSoundGenerator()
{
	UE_LOGF(LogMediaAssets, Verbose, "MediaSoundComponent: FMediaSoundGenerator Destroyed.");
}

void FMediaSoundGenerator::OnEndGenerate()
{
	UE_LOGF(LogMediaAssets, Verbose, "MediaSoundComponent: OnEndGenerate called.");
...
void FMediaSoundGenerator::SetSampleQueue(TSharedPtr<FMediaAudioSampleQueue, ESPMode::ThreadSafe>& InSampleQueue)
{
	...
	UE_LOGF(LogMediaAssets, Verbose, "MediaSoundComponent: SetSampleQueue called with new sample queue.");
}
