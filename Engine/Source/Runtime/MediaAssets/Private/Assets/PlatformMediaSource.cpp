...
FString UPlatformMediaSource::GetUrl() const
{
	...
	if (bIsGettingUrl)
	{
		UE_LOGF(LogMediaAssets, Warning, "UPlatformMediaSource::GetUrl - Reentrant calls are not supported. Asset: %ls", *GetPathName());
		return FString();
	}
...
bool UPlatformMediaSource::Validate() const
{
	...
	if (bIsValidating)
	{
		UE_LOGF(LogMediaAssets, Warning, "UPlatformMediaSource::Validate - Reentrant calls are not supported. Asset: %ls", *GetPathName());
		return false;
	}
...
FString UPlatformMediaSource::GetDescriptionString() const
{
	...
	{
		UE_LOGF(LogMediaAssets, Warning, "UPlatformMediaSource::GetConfigurationDisplayText - Reentrant calls are not supported. Asset: %ls", *GetPathName());
		return FString();
	}
...
void UPlatformMediaSource::GetDetailsPanelInfoElements(TArray<FInfoElement>& OutInfoElements) const
{
	...
	{
		UE_LOGF(LogMediaAssets, Warning, "UPlatformMediaSource::GetDetailsPanelInfoElements - Reentrant calls are not supported. Asset: %ls", *GetPathName());
		return;
	}
...
bool UPlatformMediaSource::GetMediaOption(const FName& Key, bool DefaultValue) const
{
	...
	if (bIsGettingOption)
	{
		UE_LOGF(LogMediaAssets, Warning, "UPlatformMediaSource::GetMediaOption - Reentrant calls are not supported. Asset: %ls", *GetPathName());
		return DefaultValue;
	}
...
bool UPlatformMediaSource::HasMediaOption(const FName& Key) const
{
	...
	if (bIsHasOption)
	{
		UE_LOGF(LogMediaAssets, Warning, "UPlatformMediaSource::HasMediaOption - Reentrant calls are not supported. Asset: %ls", *GetPathName());
		return false;
	}
