...
private:
    ...
    )
    {
        ...
        {
            static_assert(
                std::is_same_v<TEMPLATE_PARAMETERS2(TypeA, Subtype)> ||
                std::is_same_v<TEMPLATE_PARAMETERS2(TypeB, Subtype)> ||
                std::is_same_v<TEMPLATE_PARAMETERS2(TypeC, Subtype)> ||
                std::is_same_v<TEMPLATE_PARAMETERS2(TypeD, Subtype)> ||
                std::is_same_v<TEMPLATE_PARAMETERS2(TypeE, Subtype)> ||
                std::is_same_v<TEMPLATE_PARAMETERS2(TypeF, Subtype)>,
