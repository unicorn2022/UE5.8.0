...
namespace AlgoImpl
{
     ...
     */
    inline int32_t HeapGetLeftChildIndex(int32_t Index)
    {
        return Index * 2 + 1;
    }
     ...
     */
    inline bool HeapIsLeaf(int32_t Index, int32_t Count)
    {
     ...
     */
    inline int32_t HeapGetParentIndex(int32_t Index)
    {
        return (Index - 1) / 2;
    }
    ...
    void HeapSiftDown(RangeValueType* Heap, int32_t Index, const int32_t Count, const ProjectionType& Projection, const PredicateType& Predicate)
    {
    ...
    int32_t HeapSiftUp(RangeValueType* Heap, int32_t RootIndex, int32_t NodeIndex, const ProjectionType& Projection, const PredicateType& Predicate)
    {
     ...
     */
    template <typename RangeValueType, typename ProjectionType, typename PredicateType>
    void HeapifyInternal(RangeValueType* First, int32_t Num, ProjectionType Projection, PredicateType Predicate)
    {
...
namespace Algo
{
    ...
    void HeapSort(RangeType& Range, PredicateType Predicate)
    {
    ...
    void HeapSortBy(RangeType& Range, ProjectionType Projection)
    {
    ...
    void HeapSortBy(RangeType& Range, ProjectionType Projection, PredicateType Predicate)
    {
