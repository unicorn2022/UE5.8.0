...
namespace Private
{
    ...
    struct IFunction_OwnedObject_OnHeap : public IFunction_OwnedObject
    {
        ...
        ~IFunction_OwnedObject_OnHeap() override = default;
    };
    ...
    struct IFunction_OwnedObject_Inline : public IFunction_OwnedObject
    {
        ...
        ~IFunction_OwnedObject_Inline() override = default;
    };
    ...
    struct TIsNullableBinding
    {
        static constexpr bool Value = std::is_pointer_v<T> ||
			...
			TIsTFunction<T>::Value;
    };

    template <typename T>
    requires (TIsNullableBinding<T>::Value)
    bool IsBound(const T& Func)
    {
    ...
    {
        AUTORTFM_INFER static Ret Call(void* Obj, ParamTypes&... Params)
        {
    ...
    {
        AUTORTFM_INFER static void Call(void* Obj, ParamTypes&... Params)
        {
    ...
    struct TFunctionRefBase<StorageType, Ret (ParamTypes...)>
    {
        ...
        template <typename FunctorType>
        requires (!std::is_same_v<TFunctionRefBase, typename TDecay<FunctorType>::Type>)
    ...
    {
        static constexpr bool Value = TIsInvocable<FunctorType, ParamTypes...>::Value &&
...
public:
     ...
     */
    template <typename FunctorType>
    requires (!TIsTFunctionRef<typename TDecay<FunctorType>::Type>::Value && Private::TFuncCanBindToFunctor<FuncType, typename TDecay<FunctorType>::Type>::Value)
...
public:
     ...
     */
    template <typename FunctorType>
    requires (!TIsTFunction<typename TDecay<FunctorType>::Type>::Value && Private::TFuncCanBindToFunctor<FuncType, FunctorType>::Value)
...
public:
     ...
     */
    template <typename FunctorType>
    requires (Private::TFuncCanBindToFunctor<FuncType, FunctorType>::Value &&
        !(TIsTUniqueFunction<typename TDecay<FunctorType>::Type>::Value || TIsTFunction<typename TDecay<FunctorType>::Type>::Value))
 ...
 */
template <typename FuncType>
bool operator==(NullPtrType, const TFunction<FuncType>& Func)
{
    return !Func;
}
 ...
 */
template <typename FuncType>
bool operator==(const TFunction<FuncType>& Func, NullPtrType)
{
    return !Func;
}
