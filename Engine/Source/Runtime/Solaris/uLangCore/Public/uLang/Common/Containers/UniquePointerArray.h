...
public:
     ...
     * Constructor
     */
    TUPtrArrayG(RawAllocatorArgsType&&... RawAllocatorArgs)
     ...
     */
    ElementType* Last(int32_t IndexFromTheEnd = 0) const
    {
     ...
     */
    bool Find(ElementType * Item, int32_t& Index) const
    {
     ...
     * @see FindLast, FindLastByPredicate
     */
    int32_t Find(ElementType * Item) const
    {
     ...
     */
    PointerType RemoveAtSwap(int32_t Index)
    {
        PointerType RemovedItem(_PointerStorage[Index], _PointerStorage.GetRawAllocator());
     ...
     */
    int32_t AddUnique(PointerType&& Item)
    {
    ...
    TUPtrArrayG<OtherElementType, OtherAllowNull, ElementAllocatorType, RawAllocatorArgsType...>& As() { return *reinterpret_cast<TUPtrArrayG<OtherElementType, OtherAllowNull, ElementAllocatorType, RawAllocatorArgsType...> *>(this); }
    template<class OtherElementType, bool OtherAllowNull = AllowNull>
    requires ((std::is_convertible_v<OtherElementType*, ElementType*> || std::is_convertible_v<ElementType*, OtherElementType*>) && (AllowNull == OtherAllowNull || OtherAllowNull))
    const TUPtrArrayG<OtherElementType, OtherAllowNull, ElementAllocatorType, RawAllocatorArgsType...>& As() const { return *reinterpret_cast<const TUPtrArrayG<OtherElementType, OtherAllowNull, ElementAllocatorType, RawAllocatorArgsType...> *>(this); }
...
public:
     ...
     */
    ElementType **        begin()       { return _PointerStorage.begin(); }
    ElementType * const * begin() const { return _PointerStorage.begin(); }
    ElementType **        end()         { return _PointerStorage.end(); }
    ElementType * const * end() const   { return _PointerStorage.end(); }
...
protected:
    ...
    void DeleteRange(int32_t BeginIndex, int32_t EndIndex)
    {
