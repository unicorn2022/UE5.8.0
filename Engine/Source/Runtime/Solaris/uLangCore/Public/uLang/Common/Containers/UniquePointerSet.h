...
public:
     ...
     * Constructor
     */
    TUPtrSetG(RawAllocatorArgsType&&... RawAllocatorArgs)
...
{
    static_assert(TAllocatorTraits<ElementAllocatorType>::SupportsMove, "TUPtrSet no longer supports move-unaware allocators");
