...
namespace Algo
{
	...
	void StableSort(RangeType&& Range)
	{
	...
	void StableSort(RangeType&& Range, PredicateType Pred)
	{
	...
	void StableSortBy(RangeType&& Range, ProjectionType Proj)
	{
	...
	void StableSortBy(RangeType&& Range, ProjectionType Proj, PredicateType Pred)
	{
