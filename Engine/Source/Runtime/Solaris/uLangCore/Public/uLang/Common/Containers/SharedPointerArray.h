...
public:
     ...
     * Constructor
     */
    TSPtrArrayG(RawAllocatorArgsType&&... RawAllocatorArgs)
     ...
     */
    template<typename OtherElementType, bool OtherAllowNull>
    requires (std::is_convertible_v<OtherElementType*, InElementType*> && (AllowNull || !OtherAllowNull))
    TSPtrArrayG(std::initializer_list<TSPtrG<OtherElementType, OtherAllowNull, typename InElementAllocatorType::RawAllocatorType, RawAllocatorArgsType...>> InitList, RawAllocatorArgsType&&... RawAllocatorArgs)
        : _PointerStorage(uLang::ForwardArg<RawAllocatorArgsType>(RawAllocatorArgs)...)
        , _DereferenceFunc(nullptr)
    {
    ...
    template<typename OtherElementType, bool OtherAllowNull>
    requires (std::is_convertible_v<OtherElementType*, InElementType*> && (AllowNull || !OtherAllowNull))
    TSPtrArrayG(const TSPtrArrayG<OtherElementType, OtherAllowNull, InElementAllocatorType, RawAllocatorArgsType...>& Other)
     ...
     * @param Other The source array to copy.
     */
    TSPtrArrayG(const TSPtrArrayG& Other)
        : _PointerStorage(Other._PointerStorage)
    {
        ReferenceAll();
        EnableDereference();
    ...
    template<typename OtherElementType, bool OtherAllowNull>
    requires (std::is_convertible_v<OtherElementType*, InElementType*> && (AllowNull || !OtherAllowNull))
    TSPtrArrayG(const TSPtrArrayG<OtherElementType, OtherAllowNull, InElementAllocatorType, RawAllocatorArgsType...>& Other, int32_t ExtraSlack)
    ...
    template<typename OtherElementType, bool OtherAllowNull>
    requires (std::is_convertible_v<OtherElementType*, InElementType*> && (AllowNull || !OtherAllowNull))
    TSPtrArrayG(TSPtrArrayG<OtherElementType, OtherAllowNull, InElementAllocatorType, RawAllocatorArgsType...>&& Other)
     ...
     *                   at the end of the array in the number of elements.
     */
    template<class OtherElementType, bool OtherAllowNull>
    requires (std::is_convertible_v<OtherElementType*, InElementType*> && (AllowNull || !OtherAllowNull))
     ...
     */
    PointerType operator[](int32_t Index) const
    {
     ...
     */
    PointerType Pop(bool bAllowShrinking = true)
    {
     ...
     */
    void Push(const PointerType & Item)
    {
        if (Item)
        {
            Item->Reference();
     ...
     */
    PointerType Last(int32_t IndexFromTheEnd = 0) const
    {
     ...
     */
    bool Find(const ElementType* Item, int32_t& Index) const
    {
        return _PointerStorage.Find(const_cast<ElementType*>(Item), Index);
    }
    bool Find(const PointerType& Item, int32_t& Index) const
    {
    ...
    int32_t Find(const PointerType& Item) const
    {
     ...
     */
    bool FindLast(const PointerType & Item, int32_t& Index) const
    {
     ...
     * @returns Index of the found element. IndexNone otherwise.
     */
    int32_t FindLast(const PointerType & Item) const
    {
     ...
     */
    template <typename Predicate>
    int32_t FindLastByPredicate(Predicate Pred) const
    {
     ...
     */
    template <typename KeyType>
    TOptional<PointerType> FindByKey(const KeyType& Key) const
    {
     ...
     */
    template <typename Predicate>
    TOptional<PointerType> FindByPredicate(Predicate Pred) const
    {
     ...
     */
    PointerType RemoveAt(int32_t Index)
    {
    ...
    void RemoveAt(int32_t Index, CountType Count, bool bAllowShrinking = true)
    {
     ...
     */
    template <typename CountType>
    void RemoveAtSwap(int32_t Index, CountType Count, bool bAllowShrinking = true)
    {
        DereferenceRange(Index, Index + int32_t(Count));
    ...
    int32_t AddNew(CtorArgsType&&... CtorArgs)
    {
     ...
     */
    template <typename... CtorArgsType>
    void InsertNew(int32_t Index, CtorArgsType&&... CtorArgs)
    {
        ElementType * Item = new(_PointerStorage.GetRawAllocator()) ElementType(uLang::ForwardArg<CtorArgsType>(CtorArgs)...);
        Item->Reference();
        EnableDereference();
     ...
     */
    int32_t Add(const PointerType& Item)
    {
        if (Item)
        {
            Item->Reference();
     ...
     */
    int32_t AddUnique(const PointerType& Item)
    {
     ...
     */
    template<class OtherElementType, bool OtherAllowNull = AllowNull>
    requires ((std::is_convertible_v<OtherElementType*, ElementType*> || std::is_convertible_v<ElementType*, OtherElementType*>) && (AllowNull == OtherAllowNull || OtherAllowNull))
    TSPtrArrayG<OtherElementType, OtherAllowNull, ElementAllocatorType, RawAllocatorArgsType...>& As() { return *reinterpret_cast<TSPtrArrayG<OtherElementType, OtherAllowNull, ElementAllocatorType, RawAllocatorArgsType...> *>(this); }
    template<class OtherElementType, bool OtherAllowNull = AllowNull>
    requires ((std::is_convertible_v<OtherElementType*, ElementType*> || std::is_convertible_v<ElementType*, OtherElementType*>) && (AllowNull == OtherAllowNull || OtherAllowNull))
    const TSPtrArrayG<OtherElementType, OtherAllowNull, ElementAllocatorType, RawAllocatorArgsType...>& As() const { return *reinterpret_cast<const TSPtrArrayG<OtherElementType, OtherAllowNull, ElementAllocatorType, RawAllocatorArgsType...> *>(this); }
...
public:
    ...
    {
    public:
        Iterator() : _Item(nullptr) {} //-V730
        Iterator(ElementType * const * Item, const typename InElementAllocatorType::RawAllocatorType & Allocator) : _Item(Item) { Ptr()._Allocator = Allocator; } //-V730
        ~Iterator() = default;
        const PointerType& operator*() const { ULANG_ASSERT(_Item); Ptr()._Object = *_Item; Ptr().EnableRelease(); return Ptr(); }
        const ElementType* operator->() const { ULANG_ASSERT(_Item); return *_Item; }
        bool               operator==(const Iterator & Other) const { return _Item == Other._Item; }
        bool               operator!=(const Iterator & Other) const { return _Item != Other._Item; }
        Iterator&          operator++()    { ++_Item; return *this; }
        Iterator           operator++(int) { Iterator Temp = *this; ++*this; return Temp; }
        Iterator&          operator--()    { --_Item; return *this; }
        Iterator           operator--(int) { Iterator Temp = *this; --*this; return Temp; }
        friend Iterator    operator+(const Iterator& Left, int32_t Right) { Iterator Temp = Left; Temp._Item += Right; return Temp; }
        friend Iterator    operator+(int32_t Left, const Iterator& Right) { Iterator Temp = Right; Temp._Item += Left; return Temp; }
        friend int32_t     operator-(const Iterator& Left, const Iterator& Right) { return static_cast<int32_t>(Left._Item - Right._Item); }

    protected:
        PointerType& Ptr() const { return *(PointerType*)&_DummyPtr; }
    ...
    Iterator begin()       { return Iterator(_PointerStorage.begin(), _PointerStorage.GetRawAllocator()); }
    Iterator begin() const { return Iterator(_PointerStorage.begin(), _PointerStorage.GetRawAllocator()); }
    Iterator end()         { return Iterator(_PointerStorage.end(), _PointerStorage.GetRawAllocator()); }
    Iterator end() const   { return Iterator(_PointerStorage.end(), _PointerStorage.GetRawAllocator()); }

protected:

    /** Set the release function pointer to a valid value */
    void EnableDereference()
    {
    ...
    void Dereference(int32_t Index)
    {
    ...
    void ReferenceRange(int32_t BeginIndex, int32_t EndIndex)
    {
    ...
    void DereferenceRange(int32_t BeginIndex, int32_t EndIndex)
    {
        for (int32_t Index = BeginIndex; Index < EndIndex; ++Index)
        {
            Dereference(Index);
...
{
    static constexpr bool Value = TAllocatorTraits<ElementAllocatorType>::IsZeroConstruct;
};
...
struct TContainerTraits<TSPtrArrayG<ElementType, AllowNull, ElementAllocatorType, RawAllocatorArgsType...>> : public TContainerTraitsBase<TSPtrArrayG<ElementType, AllowNull, ElementAllocatorType, RawAllocatorArgsType...>>
{
    ...
    static constexpr bool MoveWillEmptyContainer = TAllocatorTraits<ElementAllocatorType>::SupportsMove;
};
