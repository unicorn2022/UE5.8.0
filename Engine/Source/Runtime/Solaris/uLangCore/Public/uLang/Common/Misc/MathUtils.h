...
public:
    ...
    template <class T>
    static constexpr bool IsPowerOf2(const T X)
    {
        return X > 0 && (X & (X - 1)) == 0;
    }
    ...
    static double ReinterpretInt64AsDouble(uint64_t Int)
    {
    ...
    static double FloatNaN()      { return ReinterpretInt64AsDouble(0x7ff8'0000'0000'0000); }
    static double FloatInfinity() { return ReinterpretInt64AsDouble(0x7ff0'0000'0000'0000); }
    ...
    static bool FloatNotEqual(double Left, double Right)
    {
        return !FloatEqual(Left, Right);
    }

    static bool FloatGreater(double Left, double Right)
    {
        return FloatLess(Right, Left);
    }

    static bool FloatGreaterEqual(double Left, double Right)
    {
