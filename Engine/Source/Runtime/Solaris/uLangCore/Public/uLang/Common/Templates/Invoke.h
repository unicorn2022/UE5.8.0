...
namespace Private
{
    ...
    requires (std::is_convertible_v<typename TDecay<CallableType>::Type*, typename TDecay<BaseType>::Type*>)
    auto DereferenceIfNecessary(CallableType&& Callable) -> decltype((CallableType&&)Callable)
    {
...
AUTORTFM_INFER auto Invoke(FuncType&& Func, ArgTypes&&... Args)
...
auto Invoke(ReturnType ObjType::*pdm, CallableType&& Callable)
...
auto Invoke(ReturnType (ObjType::*PtrMemFun)(PMFArgTypes...), CallableType&& Callable, ArgTypes&&... Args)
...
template <typename ReturnType, typename ObjType, typename... PMFArgTypes, typename CallableType, typename... ArgTypes>
auto Invoke(ReturnType (ObjType::*PtrMemFun)(PMFArgTypes...) const, CallableType&& Callable, ArgTypes&&... Args)
    -> decltype((Private::DereferenceIfNecessary<ObjType>(uLang::ForwardArg<CallableType>(Callable)).*PtrMemFun)(uLang::ForwardArg<ArgTypes>(Args)...))
{
    return (Private::DereferenceIfNecessary<ObjType>(uLang::ForwardArg<CallableType>(Callable)).*PtrMemFun)(uLang::ForwardArg<ArgTypes>(Args)...);
}
