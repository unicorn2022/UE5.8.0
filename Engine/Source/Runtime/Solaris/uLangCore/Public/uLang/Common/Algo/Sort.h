...
namespace Algo
{
    ...
    void Sort(RangeType&& Range, PredicateType Pred)
    {
    ...
    void SortBy(RangeType&& Range, ProjectionType Proj)
    {
    ...
    void SortBy(RangeType&& Range, ProjectionType Proj, PredicateType Pred)
    {
