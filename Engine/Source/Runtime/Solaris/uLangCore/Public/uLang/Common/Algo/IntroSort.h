...
namespace Algo
{
    ...
    void IntroSort(RangeType&& Range)
    {
    ...
    void IntroSort(RangeType&& Range, PredicateType Predicate)
    {
    ...
    void IntroSortBy(RangeType&& Range, ProjectionType Projection)
    {
    ...
    void IntroSortBy(RangeType&& Range, ProjectionType Projection, PredicateType Predicate)
    {
