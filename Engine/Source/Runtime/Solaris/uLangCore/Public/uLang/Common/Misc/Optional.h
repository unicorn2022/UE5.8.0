...
struct AUTORTFM_INFER TOptional
{
public:
    ...
    bool IsSet() const { return _Result == EResult::OK; }
    EResult GetResult() const { return _Result; }
    explicit operator bool() const { return _Result == EResult::OK; }

    operator       OptionalType*()       { return IsSet() ? &_Value.Get() : nullptr; }
    operator const OptionalType*() const { return IsSet() ? &_Value.Get() : nullptr; }
