...
public:
    ...
    ~TUTF8StringBuilder()    = default; // Memory will be released via the embedded string object
    ...
    UTF8Char LastByte() const               { return _String.ToStringView().LastByte(); }

    // Comparison operators

    template<class OtherAllocatorType, typename... OtherAllocatorArgsType>
    bool operator==(const TUTF8StringBuilder<OtherAllocatorType, OtherAllocatorArgsType...>& Other) const { return _String == Other._String; }
    template<class OtherAllocatorType, typename... OtherAllocatorArgsType>
    bool operator!=(const TUTF8StringBuilder<OtherAllocatorType, OtherAllocatorArgsType...>& Other) const { return _String != Other._String; }
    template<class OtherAllocatorType, typename... OtherAllocatorArgsType>
    bool operator==(const TUTF8String<OtherAllocatorType, OtherAllocatorArgsType...>& Other) const { return _String == Other; }
    template<class OtherAllocatorType, typename... OtherAllocatorArgsType>
    bool operator!=(const TUTF8String<OtherAllocatorType, OtherAllocatorArgsType...>& Other) const { return _String != Other; }
    ...
    const char* AsCString() const               { return _String.AsCString(); }
    const char* operator*() const               { return _String.AsCString(); }
...
protected:
    ...
    int32_t InputByteIdxToDirectIdx(int32_t InIdx) const                   { return _String._String.InputByteIdxToDirectIdx(InIdx); }
    bool    InputByteIdxSpan(int32_t& InOutIdx, int32_t& InOutSpan) const  { return _String._String.InputByteIdxSpan(InOutIdx, InOutSpan); }

private:

    /// Compute allocation size from requested size
    static size_t CalculateBytesToAllocate(size_t RequestedBytes)
    {
    ...
    void Construct(const UTF8Char* String, size_t ByteLength, const AllocatorType& Allocator)
    {
    ...
    void EnsureAllocated(size_t BytesNeeded)
    {
        // Do we need to grow?
...
template<class AllocatorType, typename... AllocatorArgsType>
TUTF8StringBuilder<AllocatorType, AllocatorArgsType...>::TUTF8StringBuilder(const char* NullTerminatedString, AllocatorArgsType&&... AllocatorArgs)
    : _String(NoInit)
{
...
template<class AllocatorType, typename... AllocatorArgsType>
TUTF8StringBuilder<AllocatorType, AllocatorArgsType...>::TUTF8StringBuilder(const CUTF8StringView& StringView, AllocatorArgsType&&... AllocatorArgs)
    : _String(NoInit)
{
...
template<class AllocatorType, typename... AllocatorArgsType>
template<typename... FormatterArgsType>
TUTF8StringBuilder<AllocatorType, AllocatorArgsType...>::TUTF8StringBuilder(AllocatorArgsType&&... AllocatorArgs, const char* NullTerminatedFormat, FormatterArgsType&&... FormatterArgs)
    : _String(NoInit)
{
...
template<class AllocatorType, typename... AllocatorArgsType>
TUTF8StringBuilder<AllocatorType, AllocatorArgsType...>::TUTF8StringBuilder(const TUTF8StringBuilder& Other)
    : _String(NoInit)
{
...
template<class AllocatorType, typename... AllocatorArgsType>
TUTF8StringBuilder<AllocatorType, AllocatorArgsType...>::TUTF8StringBuilder(TUTF8StringBuilder&& Other)
...
template<class AllocatorType, typename... AllocatorArgsType>
TUTF8String<AllocatorType, AllocatorArgsType...> TUTF8StringBuilder<AllocatorType, AllocatorArgsType...>::MoveToString()
{
...
template<class AllocatorType, typename... AllocatorArgsType>
TUTF8StringBuilder<AllocatorType, AllocatorArgsType...>& TUTF8StringBuilder<AllocatorType, AllocatorArgsType...>::operator=(const TUTF8StringBuilder& Other)
{
...
template<class AllocatorType, typename... AllocatorArgsType>
TUTF8StringBuilder<AllocatorType, AllocatorArgsType...>& TUTF8StringBuilder<AllocatorType, AllocatorArgsType...>::operator=(TUTF8StringBuilder&& Other)
{
...
template<class AllocatorType, typename... AllocatorArgsType>
TUTF8StringBuilder<AllocatorType, AllocatorArgsType...>& TUTF8StringBuilder<AllocatorType, AllocatorArgsType...>::operator=(const CUTF8StringView& StringView)
{
