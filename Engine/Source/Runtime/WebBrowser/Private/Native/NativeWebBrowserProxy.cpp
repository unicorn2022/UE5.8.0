...
void FNativeWebBrowserProxy::OnDragEnter(const FGeometry& MyGeometry, const FDragDropEvent& DragDropEvent)
{
	// Not supported on this platform
}

FReply FNativeWebBrowserProxy::OnDragOver(const FGeometry& MyGeometry, const FDragDropEvent& DragDropEvent)
{
	// Not supported on this platform
	return FReply::Unhandled();
}

void FNativeWebBrowserProxy::OnDragLeave(const FDragDropEvent& DragDropEvent)
{
	// Not supported on this platform
}

FReply FNativeWebBrowserProxy::OnDrop(const FGeometry& MyGeometry, const FDragDropEvent& DragDropEvent)
{
	// Not supported on this platform
	return FReply::Unhandled();
}
