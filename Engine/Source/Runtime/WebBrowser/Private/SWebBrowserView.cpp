...
void SWebBrowserView::OnDragEnter(const FGeometry& MyGeometry, const FDragDropEvent& DragDropEvent)
{
	if (BrowserWindow.IsValid())
	{
...
FReply SWebBrowserView::OnDragOver(const FGeometry& MyGeometry, const FDragDropEvent& DragDropEvent)
{
	if (BrowserWindow.IsValid())
	{
...
void SWebBrowserView::OnDragLeave(const FDragDropEvent& DragDropEvent)
{
	if (BrowserWindow.IsValid())
	{
...
FReply SWebBrowserView::OnDrop(const FGeometry& MyGeometry, const FDragDropEvent& DragDropEvent)
{
	if (BrowserWindow.IsValid())
	{
