...
public:
	...
	WEBBROWSER_API virtual void OnDragEnter(const FGeometry& MyGeometry, const FDragDropEvent& DragDropEvent) override;
	WEBBROWSER_API virtual FReply OnDragOver(const FGeometry& MyGeometry, const FDragDropEvent& DragDropEvent) override;
	WEBBROWSER_API virtual void OnDragLeave(const FDragDropEvent& DragDropEvent) override;
	WEBBROWSER_API virtual FReply OnDrop(const FGeometry& MyGeometry, const FDragDropEvent& DragDropEvent) override;
