...
void FAnimGraphRuntimeTrace::OutputBlendSpacePlayerValues(
	...
	FVector InFilteredPosition)
{
	...
	TRACE_OBJECT(InContext.AnimInstanceProxy->GetAnimInstanceObject());
	TRACE_OBJECT(InBlendSpace);

	UE_TRACE_LOG(Animation, BlendSpacePlayer, AnimationChannel)
		<< BlendSpacePlayer.Cycle(FPlatformTime::Cycles64())
		<< BlendSpacePlayer.AnimInstanceId(FObjectTrace::GetObjectId(InContext.AnimInstanceProxy->GetAnimInstanceObject()))
		<< BlendSpacePlayer.BlendSpaceId(FObjectTrace::GetObjectId(InBlendSpace))
		<< BlendSpacePlayer.NodeId(InNodeId)
		<< BlendSpacePlayer.PositionX(static_cast<float>(InPosition.X))
		<< BlendSpacePlayer.PositionY(static_cast<float>(InPosition.Y))
		<< BlendSpacePlayer.PositionZ(static_cast<float>(InPosition.Z))
		<< BlendSpacePlayer.FilteredPositionX(static_cast<float>(InFilteredPosition.X))
		<< BlendSpacePlayer.FilteredPositionY(static_cast<float>(InFilteredPosition.Y))
		<< BlendSpacePlayer.FilteredPositionZ(static_cast<float>(InFilteredPosition.Z));
}
