...
private:
	...
	// Apply the rotation additive in root space, effectively ignoring any root bone rotation.
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Settings, meta = (PinHiddenByDefault, AllowPrivateAccess))
	bool bApplyAdditiveInRootSpace = false;
