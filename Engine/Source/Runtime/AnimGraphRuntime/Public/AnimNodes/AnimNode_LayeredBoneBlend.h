...
public:
	...
	/** Whether to update the base pose first or after all the blend poses */
	UPROPERTY(Experimental, EditAnywhere, BlueprintReadWrite, Category = Config, meta = (PinHiddenByDefault))
	bool bUpdateBasePoseFirst = false;
