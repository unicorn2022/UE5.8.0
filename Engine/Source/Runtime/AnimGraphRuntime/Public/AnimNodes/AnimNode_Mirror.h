...
UENUM()
enum class EMirrorBlendType : uint8
{
...
public:
	...
	// Get mirror blend type. Default to inertialization for backwards compatibility.
	ANIMGRAPHRUNTIME_API virtual EMirrorBlendType GetBlendType() const;
...
private:
	...
	void MirrorPoseInPlace(FPoseContext& InPose);
...
protected:
	...
	UPROPERTY(EditAnywhere, Category = MirrorTransition, meta = (PinHiddenByDefault, FoldProperty))
	EMirrorBlendType BlendType = EMirrorBlendType::Inertialization;
