...
#define INSTRUMENTATION_ENUM_CLASS_FLAGS(Enum) \
	INSTRUMENTATION_FUNCTION_ATTRIBUTES FORCEINLINE           Enum& operator|=(Enum& Lhs, Enum Rhs) { return Lhs = (Enum)((__underlying_type(Enum))Lhs | (__underlying_type(Enum))Rhs); } \
	INSTRUMENTATION_FUNCTION_ATTRIBUTES FORCEINLINE           Enum& operator&=(Enum& Lhs, Enum Rhs) { return Lhs = (Enum)((__underlying_type(Enum))Lhs & (__underlying_type(Enum))Rhs); } \
	INSTRUMENTATION_FUNCTION_ATTRIBUTES FORCEINLINE           Enum& operator^=(Enum& Lhs, Enum Rhs) { return Lhs = (Enum)((__underlying_type(Enum))Lhs ^ (__underlying_type(Enum))Rhs); } \
	INSTRUMENTATION_FUNCTION_ATTRIBUTES FORCEINLINE constexpr Enum  operator| (Enum  Lhs, Enum Rhs) { return (Enum)((__underlying_type(Enum))Lhs | (__underlying_type(Enum))Rhs); } \
	INSTRUMENTATION_FUNCTION_ATTRIBUTES FORCEINLINE constexpr Enum  operator& (Enum  Lhs, Enum Rhs) { return (Enum)((__underlying_type(Enum))Lhs & (__underlying_type(Enum))Rhs); } \
	INSTRUMENTATION_FUNCTION_ATTRIBUTES FORCEINLINE constexpr Enum  operator^ (Enum  Lhs, Enum Rhs) { return (Enum)((__underlying_type(Enum))Lhs ^ (__underlying_type(Enum))Rhs); } \
	INSTRUMENTATION_FUNCTION_ATTRIBUTES FORCEINLINE constexpr bool  operator! (Enum  E)             { return !(__underlying_type(Enum))E; } \
	INSTRUMENTATION_FUNCTION_ATTRIBUTES FORCEINLINE constexpr Enum  operator~ (Enum  E)             { return (Enum)~(__underlying_type(Enum))E; }
