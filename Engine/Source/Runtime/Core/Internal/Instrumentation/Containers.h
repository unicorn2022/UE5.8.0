...
public:
	INSTRUMENTATION_FUNCTION_ATTRIBUTES static void* Alloc(SIZE_T Size);
	INSTRUMENTATION_FUNCTION_ATTRIBUTES static void Free(void* Data);
	INSTRUMENTATION_FUNCTION_ATTRIBUTES static void* AllocWithGuards(SIZE_T Size);
	INSTRUMENTATION_FUNCTION_ATTRIBUTES static void FreeWithGuards(void* Data);
...
public:
	...
	public:
		 ...
		 */
		INSTRUMENTATION_FUNCTION_ATTRIBUTES FORCEINLINE void MoveToEmpty(ForAnyElementType& Other)
		{
			if (Data)
			{
		...
		/** Destructor. */
		INSTRUMENTATION_FUNCTION_ATTRIBUTES FORCEINLINE ~ForAnyElementType()
		{
			if (Data)
			{
				TBaseAllocator::Free(Data);
		...
		INSTRUMENTATION_FUNCTION_ATTRIBUTES FORCEINLINE void* GetAllocation() const
		{
			return Data;
		}
		...
		INSTRUMENTATION_FUNCTION_ATTRIBUTES FORCEINLINE SizeType CalculateSlackReserve(SizeType NumElements, SIZE_T NumBytesPerElement) const
		{
			return DefaultCalculateSlackReserve(NumElements, NumBytesPerElement, true);
		}
		INSTRUMENTATION_FUNCTION_ATTRIBUTES FORCEINLINE SizeType CalculateSlackReserve(SizeType NumElements, SIZE_T NumBytesPerElement, uint32 AlignmentOfElement) const
		{
			return DefaultCalculateSlackReserve(NumElements, NumBytesPerElement, true, (uint32)AlignmentOfElement);
		}
		INSTRUMENTATION_FUNCTION_ATTRIBUTES FORCEINLINE SizeType CalculateSlackShrink(SizeType NumElements, SizeType NumAllocatedElements, SIZE_T NumBytesPerElement) const
		{
			return DefaultCalculateSlackShrink(NumElements, NumAllocatedElements, NumBytesPerElement, true);
		}
		INSTRUMENTATION_FUNCTION_ATTRIBUTES FORCEINLINE SizeType CalculateSlackShrink(SizeType NumElements, SizeType NumAllocatedElements, SIZE_T NumBytesPerElement, uint32 AlignmentOfElement) const
		{
			return DefaultCalculateSlackShrink(NumElements, NumAllocatedElements, NumBytesPerElement, true, (uint32)AlignmentOfElement);
		}
		INSTRUMENTATION_FUNCTION_ATTRIBUTES FORCEINLINE SizeType CalculateSlackGrow(SizeType NumElements, SizeType NumAllocatedElements, SIZE_T NumBytesPerElement) const
		{
			return DefaultCalculateSlackGrow(NumElements, NumAllocatedElements, NumBytesPerElement, true);
		}
		INSTRUMENTATION_FUNCTION_ATTRIBUTES FORCEINLINE SizeType CalculateSlackGrow(SizeType NumElements, SizeType NumAllocatedElements, SIZE_T NumBytesPerElement, uint32 AlignmentOfElement) const
		{
	...
	public:
		...
		INSTRUMENTATION_FUNCTION_ATTRIBUTES FORCEINLINE ElementType* GetAllocation() const
		{
...
>
class TInstrumentationSafeSparseSetAllocator
{
public:

	/** Computes the number of hash buckets to use for a given number of elements. */
	INSTRUMENTATION_FUNCTION_ATTRIBUTES static FORCEINLINE uint32 GetNumberOfHashBuckets(uint32 NumHashedElements)
	{
...
template<typename BaseAllocator = TInstrumentationSafeBaseAllocator>
struct TInstrumentationSafeCompactSetAllocator
{
	using InElementAllocator = TInstrumentationSafeAllocator<32, BaseAllocator>;
...
using TInstrumentationSafeSetAllocator = TInstrumentationSafeCompactSetAllocator<BaseAllocator>;
#else
template<typename BaseAllocator>
using TInstrumentationSafeSetAllocator = TInstrumentationSafeSparseSetAllocator<BaseAllocator>;
#endif
