...
void FForkPageProtector::ProtectMemoryRegions()
{
	...
	UE_LOGF(LogHAL, Warning, "Protect Page Finder has been enabled and is about to protect pages. Output location:");
	UE_LOGF(LogHAL, Warning, "'%ls'", *FPaths::ConvertRelativePathToFull(GetOutputFileLocation()));
