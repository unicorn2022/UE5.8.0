...
namespace Tasks2Tests
{
	...
	void EmptyPerfTest(bool last)
	{
		...
		if(last)
		{
			UE_LOGF(LogTemp, Display, "--------------------------EMPTY Perf Test--------------------------------");
		}

		{
			...
			if(last)
			{
				UE_LOGF(LogTemp, Display, "EmptyBusyWaitGlobal Basic Performance:          Spawning %d tasks took %f (%f avg) secs total, %f (%f avg) secs spawning and %f (%f avg) secs dispatching", NumTasks, Total, TotalAvg, Spawned, SpawnedAvg, End, EndAvg);
			}
		}

		{
			...
			if(last)
			{
				UE_LOGF(LogTemp, Display, "EmptyBusyWaitLocal Basic Performance:           Spawning %d tasks took %f (%f avg) secs total, %f (%f avg) secs spawning and %f (%f avg) secs dispatching", NumTasks, Total, TotalAvg, Spawned, SpawnedAvg, End, EndAvg);
			}
		}

		{
			...
			if(last)
			{
				UE_LOGF(LogTemp, Display, "EmptyBusyWaitLocal Awaitable Performance:       Spawning %d tasks took %f (%f avg) secs total, %f (%f avg) secs spawning and %f (%f avg) secs dispatching", NumTasks, Total, TotalAvg, Spawned, SpawnedAvg, End, EndAvg);
			}
		}

		if(last)
		{
			UE_LOGF(LogTemp, Display, "--------------------------END EMPTY Perf Test-----------------------------");
		}
	}
	...
	void BasicPerfTest(bool last)
	{
		...
		if(last)
		{
			UE_LOGF(LogTemp, Display, "--------------------------SIMPLE Perf Test--------------------------------");
		}
...

		{
			...
			if(last)
			{
				UE_LOGF(LogTemp, Display, "FibworkBusyWait Basic Performance:              Spawning %d tasks took %f (%f avg) secs total, %f (%f avg) secs spawning and %f (%f avg) secs dispatching", NumTasks, Total, TotalAvg, Spawned, SpawnedAvg, End, EndAvg);
			}
		}

		{
			...
			if(last)
			{
				UE_LOGF(LogTemp, Display, "FibworkBusyWait Awaitable Performance:          Spawning %d tasks took %f (%f avg) secs total, %f (%f avg) secs spawning and %f (%f avg) secs dispatching", NumTasks, Total, TotalAvg, Spawned, SpawnedAvg, End, EndAvg);
			}
		}

		if(last)
		{
			UE_LOGF(LogTemp, Display, "--------------------------END SIMPLE Perf Test--------------------------------");
		}
		SGarbage++;
	}
	...
	void StealingPerfTest(bool last)
	{
		...
		if(last)
		{
			UE_LOGF(LogTemp, Display, "--------------------------STEALING Perf Test--------------------------------");
		}
		volatile int64& Garbage = SGarbage;
		volatile int64& TestVal = STestVal;

		{
			...
			if(last)
			{
				UE_LOGF(LogTemp, Display, "FibworkBusyWaitStealing Basic Performance:      Spawning %d tasks took %f (%f avg) secs total, %f (%f avg) secs spawning and %f (%f avg) secs dispatching", NumTasks, Total, TotalAvg, Spawned, SpawnedAvg, End, EndAvg);
			}
		}

		{
			...
			if(last)
			{
				UE_LOGF(LogTemp, Display, "FibworkBusyWaitStealing Awaitable Performance:  Spawning %d tasks took %f (%f avg) secs total, %f (%f avg) secs spawning and %f (%f avg) secs dispatching", NumTasks, Total, TotalAvg, Spawned, SpawnedAvg, End, EndAvg);
			}
		}

		if(last)
		{
			UE_LOGF(LogTemp, Display, "--------------------------END STEALING Perf Test--------------------------------");
		}
		SGarbage++;
	}
