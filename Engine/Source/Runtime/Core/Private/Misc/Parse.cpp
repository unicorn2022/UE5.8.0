...
// Parse a quadword.
//
bool FParse::Value(const TCHAR* Stream, const TCHAR* Match, uint64& Value, const TCHAR** OptStreamGotTo)
{
	return FParse::Value( Stream, Match, *(int64*)&Value, OptStreamGotTo);
}

//
// Parse a signed quadword.
//
bool FParse::Value(const TCHAR* Stream, const TCHAR* Match, int64& Value, const TCHAR** OptStreamGotTo)
{
	TCHAR Temp[4096] = {};
	TCHAR* Ptr = Temp;
	if (FParse::Value( Stream, Match, Temp, UE_ARRAY_COUNT(Temp), true, OptStreamGotTo))
	{
		Value = 0;
		bool Negative = (*Ptr=='-');
		Ptr += Negative;
...
// Get a name.
//
bool FParse::Value(const TCHAR* Stream, const TCHAR* Match, FName& Name, const TCHAR** OptStreamGotTo)
{
	TCHAR TempStr[NAME_SIZE];

	if (!FParse::Value(Stream, Match, TempStr, NAME_SIZE, true, OptStreamGotTo))
	{
		return false;
	}
...
// Get a uint32.
//
bool FParse::Value(const TCHAR* Stream, const TCHAR* Match, uint32& Value, const TCHAR** OptStreamGotTo)
{
	TCHAR Temp[256];
	if (!FParse::Value(Stream, Match, Temp, UE_ARRAY_COUNT(Temp), true, OptStreamGotTo))
	{
...
// Get a byte.
//
bool FParse::Value(const TCHAR* Stream, const TCHAR* Match, uint8& Value, const TCHAR** OptStreamGotTo)
{
	TCHAR Temp[256];
	if (!FParse::Value(Stream, Match, Temp, UE_ARRAY_COUNT(Temp), true, OptStreamGotTo))
	{
...
// Get a signed byte.
//
bool FParse::Value(const TCHAR* Stream, const TCHAR* Match, int8& Value, const TCHAR** OptStreamGotTo)
{
	TCHAR Temp[256];
	if (!FParse::Value(Stream, Match, Temp, UE_ARRAY_COUNT(Temp), true, OptStreamGotTo))
	{
...
// Get a word.
//
bool FParse::Value(const TCHAR* Stream, const TCHAR* Match, uint16& Value, const TCHAR** OptStreamGotTo)
{
	TCHAR Temp[256];
	if (!FParse::Value(Stream, Match, Temp, UE_ARRAY_COUNT(Temp), true, OptStreamGotTo))
	{
...
// Get a signed word.
//
bool FParse::Value(const TCHAR* Stream, const TCHAR* Match, int16& Value, const TCHAR** OptStreamGotTo)
{
	TCHAR Temp[256];
	if (!FParse::Value(Stream, Match, Temp, UE_ARRAY_COUNT(Temp), true, OptStreamGotTo))
	{
...
//
bool FParse::Value(const TCHAR* Stream, const TCHAR* Match, float& Value, const TCHAR** OptStreamGotTo)
{
	TCHAR Temp[256];
	if (!FParse::Value(Stream, Match, Temp, UE_ARRAY_COUNT(Temp), true, OptStreamGotTo))
	{
...
//
bool FParse::Value(const TCHAR* Stream, const TCHAR* Match, double& Value, const TCHAR** OptStreamGotTo)
{
	TCHAR Temp[256];
	if (!FParse::Value(Stream, Match, Temp, UE_ARRAY_COUNT(Temp), true, OptStreamGotTo))
	{
...
//
bool FParse::Value(const TCHAR* Stream, const TCHAR* Match, int32& Value, const TCHAR** OptStreamGotTo)
{
	TCHAR Temp[256];
	if (!FParse::Value(Stream, Match, Temp, UE_ARRAY_COUNT(Temp), true, OptStreamGotTo))
	{
...
// Get a boolean value.
//
bool FParse::Bool(const TCHAR* Stream, const TCHAR* Match, bool& OnOff, const TCHAR** OptStreamGotTo)
{
	TCHAR TempStr[16];
	if (FParse::Value(Stream, Match, TempStr, UE_ARRAY_COUNT(TempStr), true, OptStreamGotTo))
	{
...
//
bool FParse::Value(const TCHAR* Stream, const TCHAR* Match, struct FGuid& Guid, const TCHAR** OptStreamGotTo)
{
	TCHAR Temp[256];
