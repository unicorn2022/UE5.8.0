...
void FPageAllocator::LatchProtectedMode()
{
	...
	if (bNoProtection)
	{
		UE_LOGF(LogTemp, Display, "Enabling purgatory and virtual memory protection to catch stale pointers to mem stacks items (and other users of the page allocator).");
