...
FPreLoadFile::FPreLoadFile(const TCHAR* InPath)
	: FDelayedAutoRegisterHelper([] { if constexpr (STATS) { return EDelayedRegisterRunPhase::StatSystemReady; } else { return EDelayedRegisterRunPhase::FileSystemReady; }}(), [this] {
