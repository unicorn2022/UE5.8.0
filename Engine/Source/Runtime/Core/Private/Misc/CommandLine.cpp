...
{
	UE_CLOGF(!bIsInitialized, LogInit, Fatal, "Attempting to get the command line but it hasn't been initialized yet.");
	return CmdLine;
}
...
#endif
		UE_LOGF(LogInit, Fatal, "%ls", *ErrorMessage.ToString());
	}
