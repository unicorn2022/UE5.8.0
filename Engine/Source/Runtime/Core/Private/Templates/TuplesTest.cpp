...
using TestPopTupleType = TTuple<float, char, int, void, bool>;

// Check that TTuplePopBack works
static_assert(std::is_same_v<TTuplePopBack<TestPopTupleType, 0>::Type, TTuple<float, char, int, void, bool>>);
static_assert(std::is_same_v<TTuplePopBack<TestPopTupleType, 1>::Type, TTuple<float, char, int, void>>);
static_assert(std::is_same_v<TTuplePopBack<TestPopTupleType, 2>::Type, TTuple<float, char, int>>);
static_assert(std::is_same_v<TTuplePopBack<TestPopTupleType, 3>::Type, TTuple<float, char>>);
static_assert(std::is_same_v<TTuplePopBack<TestPopTupleType, 4>::Type, TTuple<float>>);
static_assert(std::is_same_v<TTuplePopBack<TestPopTupleType, 5>::Type, TTuple<>>);

// Check that TTuplePopFront works
static_assert(std::is_same_v<TTuplePopFront<TestPopTupleType, 0>::Type, TTuple<float, char, int, void, bool>>);
static_assert(std::is_same_v<TTuplePopFront<TestPopTupleType, 1>::Type, TTuple<char, int, void, bool>>);
static_assert(std::is_same_v<TTuplePopFront<TestPopTupleType, 2>::Type, TTuple<int, void, bool>>);
static_assert(std::is_same_v<TTuplePopFront<TestPopTupleType, 3>::Type, TTuple<void, bool>>);
static_assert(std::is_same_v<TTuplePopFront<TestPopTupleType, 4>::Type, TTuple<bool>>);
static_assert(std::is_same_v<TTuplePopFront<TestPopTupleType, 5>::Type, TTuple<>>);

// Check that TTuplePopBack preserves qualifiers
static_assert(std::is_same_v<TTuplePopBack<const          TestPopTupleType, 2>::Type, const          TTuple<float, char, int>>);
static_assert(std::is_same_v<TTuplePopBack<      volatile TestPopTupleType, 2>::Type,       volatile TTuple<float, char, int>>);
static_assert(std::is_same_v<TTuplePopBack<const volatile TestPopTupleType, 2>::Type, const volatile TTuple<float, char, int>>);

// Check that TTuplePopFront preserves qualifiers
static_assert(std::is_same_v<TTuplePopFront<const          TestPopTupleType, 2>::Type, const          TTuple<int, void, bool>>);
static_assert(std::is_same_v<TTuplePopFront<      volatile TestPopTupleType, 2>::Type,       volatile TTuple<int, void, bool>>);
static_assert(std::is_same_v<TTuplePopFront<const volatile TestPopTupleType, 2>::Type, const volatile TTuple<int, void, bool>>);
