...
UE_TRACE_CHANNEL_DEFINE(CookChannel, "Package cook events: package names and IDs, asset class names, and per-package timing scopes for each cook processing stage. Enables the Unreal Cooking Insights (Packages) tab in Timing Insights profiler.")
