...
static double GBlockingDialogDuration = 0.0;
...
void FBootProfiling::AddBlockingDialogDuration(double Seconds)
{
	GBlockingDialogDuration += Seconds;
}

double FBootProfiling::GetBlockingDialogDuration()
{
	return GBlockingDialogDuration;
}
