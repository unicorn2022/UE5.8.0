...
UE_TRACE_CHANNEL(StatsChannel, "Named stat declarations and batched stat operations (increment, decrement, add, set) for integer and float stats declared with DECLARE_STATS_GROUP. Viewable in Unreal Insights alongside the Counters channel.")
