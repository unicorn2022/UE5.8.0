...
{
	UE_CLOGF(!(InData && Num > 0), LogSerialization, Fatal, "Tried to initialize an FLargeMemoryReader with a null or empty buffer. Archive name: %ls.", *ArchiveName.ToString());
