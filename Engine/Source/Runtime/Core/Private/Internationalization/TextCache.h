...
public:
	...
	FText FindOrCache(const TCHAR* InTextLiteral, const FTextId& InTextId, FStringView InDevNotes = {});
	FText FindOrCache(FStringView InTextLiteral, const FTextId& InTextId, FStringView InDevNotes = {});
	FText FindOrCache(FString&& InTextLiteral, const FTextId& InTextId, FStringView InDevNotes = {});
#else
