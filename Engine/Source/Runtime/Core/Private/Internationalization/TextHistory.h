...
inline const auto& NsNoteLocTextMarker = TEXT("NSNOTELOCTEXT");
inline const auto& NoteLocTextMarker = TEXT("NOTELOCTEXT");
...
public:
	...
	//~ IRefCountedObject
	virtual void AddRef() const override final { TRefCountingMixin<FTextHistory>::AddRef(); }
	virtual FReturnedRefCountValue Release() const override final { return TRefCountingMixin<FTextHistory>::Release(); }
	virtual FReturnedRefCountValue GetRefCount() const override final { return TRefCountingMixin<FTextHistory>::GetRefCount(); }
	...
	virtual const FString& GetDevNotes() const;
#endif
...
#if WITH_EDITORONLY_DATA
	FTextHistory_Base(const FTextId& InTextId, FString&& InSourceString, FString&& InDevNotes);
#endif
...
#if WITH_EDITORONLY_DATA
	virtual const FString& GetDevNotes() const override;
#endif
...
#if WITH_EDITORONLY_DATA
	/** The developer notes to give translators context on this string */
	FString DevNotes;
#endif
};
