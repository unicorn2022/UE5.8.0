...
void FTextSourceSiteContext::StreamStructuredArchive(FStructuredArchive::FSlot Slot)
{
	...
	UnderlyingArchive.UsingCustomVersion(FFortniteMainBranchObjectVersion::GUID);
	if (UnderlyingArchive.CustomVer(FFortniteMainBranchObjectVersion::GUID) >= FFortniteMainBranchObjectVersion::AddDevNotesToFText && !UnderlyingArchive.IsFilterEditorOnly())
	{
