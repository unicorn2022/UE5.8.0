...
public:
	static FCultureRef Create()
	{
		...
		FCultureRef Culture = FCulture::Create(MakeUnique<FLegacyCultureImplementation>(
			...
			FString("Invariant Language (Invariant Country)"),									//const FString EnglishName
			1033,																				//const int KeyboardLayoutId
			1033,																				//const int LCID
			FString{},																			//const FString Name
			FString("Invariant Language (Invariant Country)"),									//const FString NativeName
			FString("INT"),																		//const FString UnrealLegacyThreeLetterISOLanguageName
			FString("ivl"),																		//const FString ThreeLetterISOLanguageName
			FString("iv"),																		//const FString TwoLetterISOLanguageName
