...
bool FLLMScopeTest::RunTest(const FString& Parameters)
{
	...
	bool bIsEnabled = FLowLevelMemTracker::IsEnabled();
	{
		...
		if (bIsEnabled)
		{
			TestEqual(TEXT("NameExisting has proper name"), LocalLLM.GetActiveTagData(ELLMTracker::Default)->GetName(), FName("LLMTestParentTag_LLMTestChildTag1"));
			TestEqual(TEXT("NameExisting has proper parent"), LocalLLM.GetActiveTagData(ELLMTracker::Default)->GetParent()->GetName(), FName("LLMTestParentTag"));
		}
	}
	{
		...
		if (bIsEnabled)
		{
			TestEqual(TEXT("NameNew has proper name"), LocalLLM.GetActiveTagData(ELLMTracker::Default)->GetName(), FName("LLMTestParentTag_LLMTestChildTag4"));
			TestEqual(TEXT("NameNew has proper parent"), LocalLLM.GetActiveTagData(ELLMTracker::Default)->GetParent()->GetName(), FName("LLMTestParentTag"));
		}
	}
	{
		...
		if (bIsEnabled)
		{
			TestEqual(TEXT("ByTag has proper name"), LocalLLM.GetActiveTagData(ELLMTracker::Default)->GetName(), FName("LLMTestParentTag_LLMTestChildTag2"));
			TestEqual(TEXT("ByTag has proper parent"), LocalLLM.GetActiveTagData(ELLMTracker::Default)->GetParent()->GetName(), FName("LLMTestParentTag"));
		}
	}
	{
		...
		if (bIsEnabled)
		{
			TestEqual(TEXT("Parsed parent tag has proper name"), LocalLLM.GetActiveTagData(ELLMTracker::Default)->GetName(), FName("LLMTestParentTag_LLMTestChildTag3"));
			TestEqual(TEXT("Parsed parent tag has proper parent"), LocalLLM.GetActiveTagData(ELLMTracker::Default)->GetParent()->GetName(), FName("LLMTestParentTag"));
		}
	}
