...
{
	UE_LOGF(LogHAL, Fatal, "FPlatformProcess::GetDllHandle not implemented on this platform");
	return NULL;
}

void FGenericPlatformProcess::FreeDllHandle( void* DllHandle )
{
	UE_LOGF(LogHAL, Fatal, "FPlatformProcess::FreeDllHandle not implemented on this platform");
}

void* FGenericPlatformProcess::GetDllExport( void* DllHandle, const TCHAR* ProcName )
{
	UE_LOGF(LogHAL, Fatal, "FPlatformProcess::GetDllExport not implemented on this platform");
	return NULL;
}
...
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::ExecutablePath not implemented on this platform");
	return NULL;
}

const TCHAR* FGenericPlatformProcess::ExecutableName(bool bRemoveExtension)
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::ExecutableName not implemented on this platform");
	return NULL;
}

FString FGenericPlatformProcess::GenerateApplicationPath( const FString& AppName, EBuildConfiguration BuildConfiguration)
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::GenerateApplicationPath not implemented on this platform");
	return FString();
}
...
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::GetModuleExtension not implemented on this platform");
	return TEXT("");
}
...
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::LaunchURL not implemented on this platform");
}
...
{
	UE_LOGF(LogHAL, Warning, "FGenericPlatformProcess::CanLaunchURL not implemented on this platform");
	return false;
}

FString FGenericPlatformProcess::GetGameBundleId()
{
	UE_LOGF(LogHAL, Warning, "FGenericPlatformProcess::GetGameBundleId not implemented on this platform");
	return TEXT("");
}
...
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::CreateProc not implemented on this platform");
	return FProcHandle();
}
...
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::CreateProc with std out/in/err not implemented on this platform");
	return FProcHandle();
}
...
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::OpenProcess not implemented on this platform");
	return FProcHandle();
}

bool FGenericPlatformProcess::IsProcRunning( FProcHandle & ProcessHandle )
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::IsProcRunning not implemented on this platform");
	return false;
}

void FGenericPlatformProcess::WaitForProc( FProcHandle & ProcessHandle )
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::WaitForProc not implemented on this platform");
}

void FGenericPlatformProcess::CloseProc(FProcHandle & ProcessHandle)
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::CloseProc not implemented on this platform");
}

void FGenericPlatformProcess::TerminateProc( FProcHandle & ProcessHandle, bool KillTree )
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::TerminateProc not implemented on this platform");
}
...
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::TerminateProcTreeWithPredicate not implemented on this platform");
}

FGenericPlatformProcess::EWaitAndForkResult FGenericPlatformProcess::WaitAndFork()
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::WaitAndFork not implemented on this platform");
	return EWaitAndForkResult::Error;
}

bool FGenericPlatformProcess::GetProcReturnCode( FProcHandle & ProcHandle, int32* ReturnCode )
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::GetProcReturnCode not implemented on this platform");
	return false;
}

bool FGenericPlatformProcess::GetApplicationMemoryUsage(uint32 ProcessId, SIZE_T* OutMemoryUsage)
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::GetApplicationMemoryUsage: not implemented on this platform");
	return false;
}

bool FGenericPlatformProcess::IsApplicationRunning( uint32 ProcessId )
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::IsApplicationRunning not implemented on this platform");
	return false;
}
...
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::GetApplicationName not implemented on this platform");
	return FString();
}
...
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::ExecProcess not implemented on this platform");
	return false;
}
...
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::LaunchFileInDefaultExternalApplication not implemented on this platform");
	return false;
}

void FGenericPlatformProcess::ExploreFolder( const TCHAR* FilePath )
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::ExploreFolder not implemented on this platform");
}
...
FEvent* FGenericPlatformProcess::CreateSynchEvent(bool bIsManualReset)
{
	...
	return Event;
#else
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::CreateSynchEvent not implemented on this platform");
	return NULL;
#endif
}
...
#else
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::CreateThread not implemented on this platform");
	return NULL;
#endif
}
...
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::ClosePipe not implemented on this platform");
}

bool FGenericPlatformProcess::CreatePipe(void*& ReadPipe, void*& WritePipe, bool bWritePipeLocal)
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::CreatePipe not implemented on this platform");
	return false;
}

FString FGenericPlatformProcess::ReadPipe( void* ReadPipe )
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::ReadPipe not implemented on this platform");
	return FString();
}

bool FGenericPlatformProcess::ReadPipeToArray(void* ReadPipe, TArray<uint8> & Output)
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::ReadPipeToArray not implemented on this platform");
	return false;
}

bool FGenericPlatformProcess::WritePipe(void* WritePipe, const FString& Message, FString* OutWritten)
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::WriteToPipe not implemented on this platform");
	return false;
}
...
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::NewInterprocessSynchObject not implemented on this platform");
	return NULL;
}

bool FGenericPlatformProcess::DeleteInterprocessSynchObject(FSemaphore * Object)
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::DeleteInterprocessSynchObject not implemented on this platform");
	return false;
}

bool FGenericPlatformProcess::Daemonize()
{
	UE_LOGF(LogHAL, Fatal, "FGenericPlatformProcess::Daemonize not implemented on this platform");
	return false;
}
...
{
	UE_LOGF(LogHAL, Fatal, "FPlatformSystemWideMutex not implemented on this platform.");
}
	...
	virtual bool CreateSentinelFile(const TCHAR* Name, const FString& Contents) override
	{
		...
		if (IFileManager::Get().FileExists(*SavedFilename))
		{
			if (!IFileManager::Get().Delete(*SavedFilename))
			{
				...
				UE_LOGF(LogHAL, Error, "Another instance is running, unable to delete Sentinel file %ls", *SavedFilename);
				return false;
			}
		}
