...
public:
	...
	{
		using namespace UE::Paths;

		auto RunGetExtTest = [this](const TCHAR* InPath, const TCHAR* InExpectedExt, const TCHAR* InExpectedExtDot)
		{
			const FStringView Path = InPath;
			TestViewTransform([](const FStringView& InPath2) { return FPathViews::GetExtension(InPath2, /*bIncludeDot*/ false); }, Path, InExpectedExt);
			TestViewTransform([](const FStringView& InPath2) { return FPathViews::GetExtension(InPath2); }, Path, InExpectedExt);
			...
			TestViewTransform([](const FStringView& InPath2) { return FPathViews::GetExtension(InPath2, EFlags::IncludeDot); }, Path, InExpectedExtDot);
		};

		auto RunGetExtTestFull = [this](const TCHAR* InPath, const TCHAR* InExpectedExt, const TCHAR* InExpectedExtDot,
			const TCHAR* InExpectedExtCompound, const TCHAR* InExpectedExtDotCompound)
		{
			const FStringView Path = InPath;
			TestViewTransform([](const FStringView& InPath2)
				{ return FPathViews::GetExtension(InPath2); },
				Path, InExpectedExt);
			TestViewTransform([](const FStringView& InPath2)
				{ return FPathViews::GetExtension(InPath2, EFlags::None); },
				Path, InExpectedExt);
			TestViewTransform([](const FStringView& InPath2)
				{ return FPathViews::GetExtension(InPath2, EFlags::IncludeDot); },
				Path, InExpectedExtDot);
			TestViewTransform([](const FStringView& InPath2)
				{ return FPathViews::GetExtension(InPath2, EFlags::AllowCompoundExtension); },
				Path, InExpectedExtCompound);
			TestViewTransform([](const FStringView& InPath2)
				{ return FPathViews::GetExtension(InPath2, EFlags::IncludeDot | EFlags::AllowCompoundExtension); },
				Path, InExpectedExtDotCompound);
			};

		RunGetExtTest(TEXT(""),											TEXT(""),	TEXT(""));
		RunGetExtTest(TEXT(".txt"), 									TEXT("txt"),TEXT(".txt"));
		RunGetExtTest(TEXT(".tar.gz"),									TEXT("gz"), TEXT(".gz"));
		RunGetExtTest(TEXT(".tar.gz/"),									TEXT(""),	TEXT(""));
		RunGetExtTest(TEXT(".tar.gz\\"),								TEXT(""),	TEXT(""));
		RunGetExtTest(TEXT("File"),										TEXT(""),	TEXT(""));
		RunGetExtTest(TEXT("File.txt"),									TEXT("txt"),TEXT(".txt"));
		RunGetExtTestFull(TEXT("File.tar.gz"),							TEXT("gz"), TEXT(".gz"),	TEXT("tar.gz"), TEXT(".tar.gz"));
		RunGetExtTestFull(TEXT("File.tar.gz/"),							TEXT(""),	TEXT(""),		TEXT(""),		TEXT(""));
		RunGetExtTestFull(TEXT("File.tar.gz\\"),						TEXT(""),	TEXT(""),		TEXT(""),		TEXT(""));
		RunGetExtTest(TEXT("C:/Folder/File"),							TEXT(""),	TEXT(""));
		RunGetExtTest(TEXT("C:\\Folder\\File"),							TEXT(""),	TEXT(""));
		RunGetExtTest(TEXT("C:/Folder/File.txt"),						TEXT("txt"),TEXT(".txt"));
		RunGetExtTest(TEXT("C:\\Folder\\File.txt"),						TEXT("txt"),TEXT(".txt"));
		RunGetExtTestFull(TEXT("C:/Folder/File.tar.gz"),				TEXT("gz"), TEXT(".gz"),	TEXT("tar.gz"),	TEXT(".tar.gz"));
		RunGetExtTestFull(TEXT("C:\\Folder\\File.tar.gz"),				TEXT("gz"), TEXT(".gz"),	TEXT("tar.gz"),	TEXT(".tar.gz"));
		RunGetExtTestFull(TEXT("C:/Folder/First.Last/File"),			TEXT(""),	TEXT(""),		TEXT(""),		TEXT(""));
		RunGetExtTestFull(TEXT("C:\\Folder\\First.Last\\File"),			TEXT(""),	TEXT(""),		TEXT(""),		TEXT(""));
		RunGetExtTestFull(TEXT("C:/Folder/First.Last/File.txt"),		TEXT("txt"),TEXT(".txt"),	TEXT("txt"),	TEXT(".txt"));
		RunGetExtTestFull(TEXT("C:\\Folder\\First.Last\\File.txt"),		TEXT("txt"),TEXT(".txt"),	TEXT("txt"),	TEXT(".txt"));
		RunGetExtTestFull(TEXT("C:/Folder/First.Last/File.tar.gz"),		TEXT("gz"), TEXT(".gz"),	TEXT("tar.gz"), TEXT(".tar.gz"));
		RunGetExtTestFull(TEXT("C:\\Folder\\First.Last\\File.tar.gz"),	TEXT("gz"), TEXT(".gz"),	TEXT("tar.gz"), TEXT(".tar.gz"));
