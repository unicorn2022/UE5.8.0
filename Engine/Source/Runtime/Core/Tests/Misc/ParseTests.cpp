...
TEST_CASE("Parse::InitFromString", "[Parse][Smoke]")
{
	SECTION("FVector2D")
	{
		...
		FString Expected("X=0.000 Y=1.000");
	...
	SECTION("FVector")
	{
		...
		FString Expected("X=0.000 Y=1.000 Z=2.000");
		CHECK(Value.ToString() == Expected);
	...
	SECTION("FVector4")
	{
		...
		FString Expected("X=0.000 Y=1.000 Z=2.000 W=3.000");
		CHECK(Value.ToString() == Expected);
	...
	SECTION("FQuat")
	{
		...
		FString Expected("X=0.000000000 Y=1.000000000 Z=2.000000000 W=3.000000000");
		CHECK(Value.ToString() == Expected);
	...
	SECTION("FLinearColor")
	{
		...
		FString Expected("(R=0.000000,G=1.000000,B=2.000000,A=3.000000)");
		CHECK(Value.ToString() == Expected);
	...
	SECTION("FColor")
	{
		...
		FString Expected("(R=0,G=1,B=2,A=3)");
		CHECK(Value.ToString() == Expected);
	...
	SECTION("FRotator")
	{
		...
		FString Expected("P=0.000000 Y=1.000000 R=2.000000");
		CHECK(Value.ToString() == Expected);
		...
		auto [Input, ExpectedResults] = GENERATE_COPY(table<const TCHAR*, double>(
			{
				...
				{ TEXT("a=-340282346638528859811704183484516925440.0"), -340282346638528859811704183484516925440.0 },
				{ TEXT("a=" UE_STRINGIZE(DBL_MAX)), DBL_MAX },
				{ TEXT("a=-" UE_STRINGIZE(DBL_MAX)), -DBL_MAX },
				// quoted
				{ TEXT("a=\"0.0\""), 0.0 },
				{ TEXT("a=\"0.5\""), 0.5 },
