...
TEST_CASE_NAMED(FGuidTest, "System::Core::Misc::Guid", "[ApplicationContextMask][SmokeFilter]")
{
	...
	// GUID combines
	const FGuid g6_0;
	const FGuid g6_1(TEXT("e500d989a5db77bc696e79ee785f4a69"));
	const FGuid g6_2(TEXT("89d900e5bc77dba5ee796e69694a5f78"));
	const FGuid g6_3(TEXT("43be1e3368afb993e98aaa574a6d550f"));

	CHECK_MESSAGE(TEXT("Combining 2 GUIDs"), FGuid::Combine(g6_1, g6_2) == g6_3);
	CHECK_MESSAGE(TEXT("Combining 2 invalid GUIDs"), !FGuid::CombineValid(g6_0, g6_0).IsValid());
	CHECK_MESSAGE(TEXT("Combining 1 valid GUID and 1 invalid GUID"), FGuid::CombineValid(g6_1, g6_0) == g6_1);
	CHECK_MESSAGE(TEXT("Combining 1 invalid GUID and 1 valid GUID"), FGuid::CombineValid(g6_0, g6_1) == g6_1);
	CHECK_MESSAGE(TEXT("Combining 2 valid GUIDs "), FGuid::CombineValid(g6_1, g6_2) == g6_3);
}
