...
TEST_CASE_NAMED(FFormatStringValidatorTest, "System::Core::String::FormatStringSan", "[Core][String][FormatStringSan]")
{
	...
	SECTION("Accepted Formatting")
	{
		...
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::Ok, TEXT("Test %ld"), long(32)));
		...
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::Ok, TEXT("%zu"), size_t(44)));
	...
	SECTION("NumberOfArguments")
	{
		...
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::Ok,                  TEXT("abcxyz")));
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::NotEnoughSpecifiers, TEXT("abcxyz"), 1));
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::NotEnoughSpecifiers, TEXT("abcxyz"), 1, 2));
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::NotEnoughSpecifiers, TEXT("abcxyz"), 1, 2, 3));
		...
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::NotEnoughArguments,  TEXT("abc%dxyz")));
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::Ok,                  TEXT("abc%dxyz"), 1));
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::NotEnoughSpecifiers, TEXT("abc%dxyz"), 1, 2));
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::NotEnoughSpecifiers, TEXT("abc%dxyz"), 1, 2, 3));
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::NotEnoughSpecifiers, TEXT("abc%dxyz"), 1, 2, 3, 4));
		...
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::NotEnoughArguments,  TEXT("abc%d %dxyz")));
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::NotEnoughArguments,  TEXT("abc%d %dxyz"), 1));
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::Ok,                  TEXT("abc%d %dxyz"), 1, 2));
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::NotEnoughSpecifiers, TEXT("abc%d %dxyz"), 1, 2, 3));
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::NotEnoughSpecifiers, TEXT("abc%d %dxyz"), 1, 2, 3, 4));
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::NotEnoughSpecifiers, TEXT("abc%d %dxyz"), 1, 2, 3, 4, 5));
		...
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::NotEnoughArguments,  TEXT("abc%d %d %dxyz")));
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::NotEnoughArguments,  TEXT("abc%d %d %dxyz"), 1));
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::NotEnoughArguments,  TEXT("abc%d %d %dxyz"), 1, 2));
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::Ok,                  TEXT("abc%d %d %dxyz"), 1, 2, 3));
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::NotEnoughSpecifiers, TEXT("abc%d %d %dxyz"), 1, 2, 3, 4));
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::NotEnoughSpecifiers, TEXT("abc%d %d %dxyz"), 1, 2, 3, 4, 5));
		STATIC_CHECK(UE_CHECK_FORMAT_STRING_ERR(E::NotEnoughSpecifiers, TEXT("abc%d %d %dxyz"), 1, 2, 3, 4, 5, 6));
	}
}
