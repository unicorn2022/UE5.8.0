...
TEST_CASE_NAMED(FStringFindTest, "System::Core::String::Find", "[Core][String][SmokeFilter]")
{
	SECTION("FindFirst")
	{
		...
		CHECK(FindFirst(TEXT(""), TEXT("")) == 0);
		CHECK(FindFirst(TEXT("A"), TEXT("")) == 0);
		...
		CHECK(FindFirst(FStringView(), FStringView()) == 0);
		CHECK(FindFirst(TEXT("A"), FStringView()) == 0);
	}
	...
	SECTION("FindLast")
	{
		...
		CHECK(FindLast(TEXT(""), TEXT("")) == 0);
		CHECK(FindLast(TEXT("A"), TEXT("")) == 1);
		...
		CHECK(FindLast(FStringView(), FStringView()) == 0);
		CHECK(FindLast(TEXT("A"), FStringView()) == 1);
	}
	...
	SECTION("FindFirstOfAny")
	{
		...
		CHECK(FindFirstOfAny(TEXT(""), {TEXT("AB")}) == INDEX_NONE);
		...
		CHECK(FindFirstOfAny(TEXT(""), {TEXT("")}, ESearchCase::IgnoreCase, &MatchIndex) == 0);
		CHECK(MatchIndex == 0);
		CHECK(FindFirstOfAny(TEXT(""), {TEXT("AB"), TEXT("")}, ESearchCase::IgnoreCase, &MatchIndex) == 0);
		CHECK(MatchIndex == 1);

		CHECK(FindFirstOfAny(FStringView(), {FStringView()}, ESearchCase::IgnoreCase, &MatchIndex) == 0);
		CHECK(MatchIndex == 0);
		CHECK(FindFirstOfAny(FStringView(), {TEXTVIEW("AB"), FStringView()}, ESearchCase::IgnoreCase, &MatchIndex) == 0);
		CHECK(MatchIndex == 1);

		CHECK(FindFirstOfAny(TEXT("ABC"), {TEXT("")}, ESearchCase::IgnoreCase, &MatchIndex) == 0);
		CHECK(MatchIndex == 0);
		CHECK(FindFirstOfAny(TEXT("--abCDABCD--"), {TEXT("XY"), TEXT("")}, ESearchCase::IgnoreCase, &MatchIndex) == 0);
		CHECK(MatchIndex == 1);
		CHECK(FindFirstOfAny(TEXT("--abCDABCD--"), {TEXT("AB"), TEXT("CD"), TEXT("")}, ESearchCase::IgnoreCase, &MatchIndex) == 0);
		CHECK(MatchIndex == 2);

		CHECK(FindFirstOfAny(TEXT("ABC"), {FStringView()}, ESearchCase::IgnoreCase, &MatchIndex) == 0);
		CHECK(MatchIndex == 0);
		CHECK(FindFirstOfAny(TEXTVIEW("--abCDABCD--"), {TEXTVIEW("XY"), FStringView()}, ESearchCase::IgnoreCase, &MatchIndex) == 0);
		CHECK(MatchIndex == 1);
		CHECK(FindFirstOfAny(TEXTVIEW("--abCDABCD--"), {TEXTVIEW("AB"), TEXTVIEW("CD"), FStringView()}, ESearchCase::IgnoreCase, &MatchIndex) == 0);
		CHECK(MatchIndex == 2);
	}
	...
	SECTION("FindLastOfAny")
	{
		...
		CHECK(FindLastOfAny(TEXT(""), {TEXT("AB")}) == INDEX_NONE);
		...
		CHECK(FindLastOfAny(TEXT(""), {TEXT("")}, ESearchCase::IgnoreCase, &MatchIndex) == 0);
		CHECK(MatchIndex == 0);
		CHECK(FindLastOfAny(TEXT(""), {TEXT("AB"), TEXT("")}, ESearchCase::IgnoreCase, &MatchIndex) == 0);
		CHECK(MatchIndex == 1);

		CHECK(FindLastOfAny(FStringView(), {FStringView()}, ESearchCase::IgnoreCase, &MatchIndex) == 0);
		CHECK(MatchIndex == 0);
		CHECK(FindLastOfAny(FStringView(), {TEXTVIEW("AB"), FStringView()}, ESearchCase::IgnoreCase, &MatchIndex) == 0);
		CHECK(MatchIndex == 1);

		CHECK(FindLastOfAny(TEXT("ABC"), {TEXT("")}, ESearchCase::IgnoreCase, &MatchIndex) == 3);
		CHECK(MatchIndex == 0);
		CHECK(FindLastOfAny(TEXT("--ABCDABcd--"), {TEXT("XY"), TEXT("")}, ESearchCase::IgnoreCase, &MatchIndex) == 12);
		CHECK(MatchIndex == 1);
		CHECK(FindLastOfAny(TEXT("--ABCDABcd--"), {TEXT("AB"), TEXT("CD"), TEXT("")}, ESearchCase::IgnoreCase, &MatchIndex) == 12);
		CHECK(MatchIndex == 2);

		CHECK(FindLastOfAny(TEXT("ABC"), {FStringView()}, ESearchCase::IgnoreCase, &MatchIndex) == 3);
		CHECK(MatchIndex == 0);
		CHECK(FindLastOfAny(TEXT("--ABCDABcd--"), {TEXTVIEW("XY"), FStringView()}, ESearchCase::IgnoreCase, &MatchIndex) == 12);
		CHECK(MatchIndex == 1);
		CHECK(FindLastOfAny(TEXT("--ABCDABcd--"), {TEXTVIEW("AB"), TEXTVIEW("CD"), FStringView()}, ESearchCase::IgnoreCase, &MatchIndex) == 12);
		CHECK(MatchIndex == 2);
	}
