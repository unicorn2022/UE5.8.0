...
TEST_CASE_NAMED(FStructuredLogFormatTest, "Core::Logging::StructuredLogFormat", "[Core][SmokeFilter]")
{
	...
	// Test array indexing
	Test(TEXT("{Array[0]}"), ANSITEXTVIEW(R"(1)"), {.bAllowSubObjectReferences = true});
	Test(TEXT("{Array[1]}"), ANSITEXTVIEW(R"(2)"), {.bAllowSubObjectReferences = true});
	Test(TEXT("{Array[2]}"), ANSITEXTVIEW(R"(3)"), {.bAllowSubObjectReferences = true});
	Test(TEXT("{ArrayWithNestedFormat[0]}"), ANSITEXTVIEW(R"(X=1)"), {.bAllowSubObjectReferences = true});
	Test(TEXT("{ArrayWithNestedFormat[1]}"), ANSITEXTVIEW(R"(Y=2)"), {.bAllowSubObjectReferences = true});
	Test(TEXT("{ArrayWithNestedFormat[2]}"), ANSITEXTVIEW(R"(Z=3)"), {.bAllowSubObjectReferences = true});
	Test(TEXT("{ArrayWithNestedFormat[0]/X}"), ANSITEXTVIEW(R"(1)"), {.bAllowSubObjectReferences = true});
	Test(TEXT("{ArrayWithNestedFormat[1]/Y}"), ANSITEXTVIEW(R"(2)"), {.bAllowSubObjectReferences = true});
	Test(TEXT("{ArrayWithNestedFormat[2]/Z}"), ANSITEXTVIEW(R"(3)"), {.bAllowSubObjectReferences = true});
	...
	// Test array indexing
	TestLoc(LOCTEXT("ArrayIndex0", "{Array[0]}"), ANSITEXTVIEW(R"(1)"), {.bAllowSubObjectReferences = true});
	TestLoc(LOCTEXT("ArrayIndex1", "{Array[1]}"), ANSITEXTVIEW(R"(2)"), {.bAllowSubObjectReferences = true});
	TestLoc(LOCTEXT("ArrayIndex2", "{Array[2]}"), ANSITEXTVIEW(R"(3)"), {.bAllowSubObjectReferences = true});
	TestLoc(LOCTEXT("ArrayWithNestedFormatIndex0", "{ArrayWithNestedFormat[0]}"), ANSITEXTVIEW(R"(X=1)"), {.bAllowSubObjectReferences = true});
	TestLoc(LOCTEXT("ArrayWithNestedFormatIndex1", "{ArrayWithNestedFormat[1]}"), ANSITEXTVIEW(R"(Y=2)"), {.bAllowSubObjectReferences = true});
	TestLoc(LOCTEXT("ArrayWithNestedFormatIndex2", "{ArrayWithNestedFormat[2]}"), ANSITEXTVIEW(R"(Z=3)"), {.bAllowSubObjectReferences = true});
	TestLoc(LOCTEXT("ArrayWithNestedFormatIndex0X", "{ArrayWithNestedFormat[0]/X}"), ANSITEXTVIEW(R"(1)"), {.bAllowSubObjectReferences = true});
	TestLoc(LOCTEXT("ArrayWithNestedFormatIndex1Y", "{ArrayWithNestedFormat[1]/Y}"), ANSITEXTVIEW(R"(2)"), {.bAllowSubObjectReferences = true});
	TestLoc(LOCTEXT("ArrayWithNestedFormatIndex2Z", "{ArrayWithNestedFormat[2]/Z}"), ANSITEXTVIEW(R"(3)"), {.bAllowSubObjectReferences = true});
