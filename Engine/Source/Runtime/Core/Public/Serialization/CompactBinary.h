...
using FCbBufferAllocator = TNotNull<UE::TFunctionWithContext<FUniqueBuffer (uint64 Size)>>;

/**
 * A reference to a function that is used to allocate memory for compact binary data.
 * The provider of the allocator must manage ownership of the memory for which a view is returned.
 */
using FCbMemoryAllocator = TNotNull<UE::TFunctionWithContext<FMutableMemoryView (uint64 Size)>>;
...
using FCbFieldVisitor = TNotNull<UE::TFunctionWithContext<void (FCbFieldView)>>;
...
// Types to support debug visualizers.

// A field/array/object in memory can be visualized in a debugger supporting natvis by casting to this type.
// (FDebugCb*)Pointer works for any field/array/object that starts with its field type.
struct UE_INTERNAL FDebugCb {};

// Types that visualize a pointer to a value, *not* a pointer to a field.
struct UE_INTERNAL FDebugCbObject {};
struct UE_INTERNAL FDebugCbUniformObject {};
struct UE_INTERNAL FDebugCbArray {};
struct UE_INTERNAL FDebugCbUniformArray {};
struct UE_INTERNAL FDebugCbBinary {};
struct UE_INTERNAL FDebugCbString {};
struct UE_INTERNAL FDebugCbIntegerPositive {};
struct UE_INTERNAL FDebugCbIntegerNegative {};
struct UE_INTERNAL FDebugCbFloat32 {};
struct UE_INTERNAL FDebugCbFloat64 {};
struct UE_INTERNAL FDebugCbObjectAttachment {};
struct UE_INTERNAL FDebugCbBinaryAttachment {};
struct UE_INTERNAL FDebugCbHash {};
struct UE_INTERNAL FDebugCbUuid {};
struct UE_INTERNAL FDebugCbDateTime {};
struct UE_INTERNAL FDebugCbTimeSpan {};
struct UE_INTERNAL FDebugCbObjectId {};
struct UE_INTERNAL FDebugCbCustomById {};
struct UE_INTERNAL FDebugCbCustomByName {};

namespace UE::CompactBinary::Private
{

PRAGMA_DISABLE_INTERNAL_WARNINGS;
CORE_API void ReferenceDebugTypes(
	FDebugCb*,
	FDebugCbObject*,
	FDebugCbUniformObject*,
	FDebugCbArray*,
	FDebugCbUniformArray*,
	FDebugCbBinary*,
	FDebugCbString*,
	FDebugCbIntegerPositive*,
	FDebugCbIntegerNegative*,
	FDebugCbFloat32*,
	FDebugCbFloat64*,
	FDebugCbObjectAttachment*,
	FDebugCbBinaryAttachment*,
	FDebugCbHash*,
	FDebugCbUuid*,
	FDebugCbDateTime*,
	FDebugCbTimeSpan*,
