...
public:
	 ...
	 * Does not call @ref IModuleInterface::PreUnloadCallback. Calls @ref IModuleInterface::ShutdownModule.
	 *
	 ...
	 * Calls @ref IModuleInterface::StartupModule. Does not call @ref IModuleInterface::PostLoadCallback.
	 *
	 * @param InModuleName The base name of the module file.  Should not include path, extension or platform/configuration info.  This is just the "module name" part of the module file name.  Names should be globally unique.
	 ...
	 * Calls @ref IModuleInterface::StartupModule and @ref IModuleInterface::PostLoadCallback.
	 *
	 ...
	 * Calls @ref IModuleInterface::PreUnloadCallback and @ref IModuleInterface::ShutdownModule.
	 *
...
public:
	...
	*/
	...
	/**
	 * Gets a multicast delegate that is executed to trigger the removal of all UObjects belonging to a list of modules, when these modules are unloaded.
	 * This event only occurs with merged modules, when a merged library is being unmounted.
	 *
	 * @return The delegate.
	 */
	...
	/**
	 * Gets a multicast delegate that is executed right before a merged library is unmounted, after every object in linked modules has been destroyed.
	 * This event only occurs with merged modules, when a merged library is being unmounted.
	 *
	 * @return The delegate.
	 */
	...
	{
		return OnLibraryUnmountCallback;
	}
	 ...
	 *
	 * The first parameter is the name of script package associated with the module.
	 *
...
private:
	...
	/** Multicast delegate called to remove anything left before a library unmounts. */
	TTSMulticastDelegate<void()> OnLibraryUnmountCallback;
...
class AUTORTFM_DISABLE FStaticallyLinkedModuleRegistrant
{
public:
...
#define IMPLEMENT_TARGET_NAME_REGISTRATION() \
	...
	{ \
		...
		{ \
			FPlatformMisc::SetUBTTargetName(TEXT(UE_STRINGIZE(UE_TARGET_NAME))); \
		} \
