...
// HEADER_UNIT_UNSUPPORTED - Clang not supporting header units
	...
	#define UE_CLANG_SUPPRESS [[clang::suppress]]
#endif
...
#define PRAGMA_ENABLE_NONPORTABLE_INCLUDE_PATH_WARNING \
		...
		#define PRAGMA_DISABLE_CAST_FUNCTION_TYPE_MISMATCH_WARNINGS \
			_Pragma("clang diagnostic push") \
			_Pragma("clang diagnostic ignored \"-Wcast-function-type-mismatch\"") // cast from 'FARPROC' (aka 'long long (*)()') to 'blah' (aka '<signature>') converts to incompatible function type
	#else
		#define PRAGMA_DISABLE_CAST_FUNCTION_TYPE_MISMATCH_WARNINGS
	#endif // __has_warning("-Wcast-function-type-mismatch")
