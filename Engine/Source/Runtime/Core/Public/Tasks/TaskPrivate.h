...
namespace UE::Tasks
{
	...
	/** Options used to override general scheduler priority and integrate with other systems */
	...
	/** Namespace for internals of task system, do not use these from general engine code */
	namespace Private
	{
		class FTaskBase;
