...
#ifndef UE_ENABLE_STATS_FILE_DEPRECATED_IN_5_8
#define UE_ENABLE_STATS_FILE_DEPRECATED_IN_5_8 0
#endif

#if UE_ENABLE_INCLUDE_ORDER_DEPRECATED_IN_5_8 || UE_ENABLE_STATS_FILE_DEPRECATED_IN_5_8
...
#endif // UE_ENABLE_INCLUDE_ORDER_DEPRECATED_IN_5_8 || UE_ENABLE_STATS_FILE_DEPRECATED_IN_5_8
...
public:
	/** Destructor. */
	virtual ~IStatsWriteFile() = default;
	...
	inline FStatNameAndInfo ReadFName( FArchive& Ar, bool bHasFNameMap )
	{
		...
		if( !bHasFNameMap )
		{
			...
			else
			{
				...
				{
					TheFName = FName( "Unknown FName" );
					Number = 0;
					UE_LOGF( LogTemp, Warning, "Missing FName Indexed: %d, %d", Index, Number );
				}
			}
		}
		else
