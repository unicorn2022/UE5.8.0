...
struct FExtendedPlatformMemoryStats
{
	...
	/** How many bytes have been copied from shared to private as a result of copy-on-write */
	SIZE_T Shared_Memory_COW_Bytes;
};
...
struct FUnixPlatformMemory : public FGenericPlatformMemory
{
	...
	static CORE_API void IncSharedMemoryCOWBytes(size_t Bytes);
};
