...
// HEADER_UNIT_SKIP - Cause cirular dependencies for header units
	...
	#ifndef PRAGMA_DISABLE_IGNORED_PRAGMAS_WARNINGS
	#define PRAGMA_DISABLE_IGNORED_PRAGMAS_WARNINGS
		// MSVC supports all `#pragma section` actions
	#endif // PRAGMA_DISABLE_IGNORED_PRAGMAS_WARNINGS

	#ifndef PRAGMA_ENABLE_IGNORED_PRAGMAS_WARNINGS
	#define PRAGMA_ENABLE_IGNORED_PRAGMAS_WARNINGS
		// MSVC supports all `#pragma section` actions
	#endif // PRAGMA_ENABLE_IGNORED_PRAGMAS_WARNINGS

	#ifndef PRAGMA_DISABLE_CAST_FUNCTION_TYPE_MISMATCH_WARNINGS
	#define PRAGMA_DISABLE_CAST_FUNCTION_TYPE_MISMATCH_WARNINGS \
		__pragma(warning(push)) \
		__pragma(warning(disable: 4191)) /* disable the "unsafe conversion from 'FARPROC' to 'blah'" warning */
	#endif // PRAGMA_DISABLE_CAST_FUNCTION_TYPE_MISMATCH_WARNINGS

	#ifndef PRAGMA_ENABLE_CAST_FUNCTION_TYPE_MISMATCH_WARNINGS
	#define PRAGMA_ENABLE_CAST_FUNCTION_TYPE_MISMATCH_WARNINGS \
		__pragma(warning(pop))
	#endif // PRAGMA_ENABLE_CAST_FUNCTION_TYPE_MISMATCH_WARNINGS
	...
	// Disable common CA warnings around SDK includes
		...
		#define UE_COMPILER_THIRD_PARTY_INCLUDES_START \
			...
			__pragma(warning(disable: 4834))  /* discarding return value of function with 'nodiscard' attribute. */ \
