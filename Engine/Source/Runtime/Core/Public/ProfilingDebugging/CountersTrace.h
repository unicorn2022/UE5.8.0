...
#define __TRACE_DECLARE_INLINE_COUNTER(CounterDisplayName, CounterType, CounterDisplayHint) \
	...
	static FCountersTrace::CounterType UE_JOIN(__TraceCounter, __LINE__)(CounterDisplayName, CounterDisplayHint);
...
#define __TRACE_INLINE_COUNTER_SET(CounterDisplayName, Value, CounterType, CounterDisplayHint) \
	...
	UE_JOIN(__TraceCounter, __LINE__).Set(Value);
...
#define TRACE_DECLARE_COUNTER(CounterType, CounterName, CounterDisplayName, CounterDisplayHint) \
	__TRACE_CHECK_COUNTER_NAME(CounterDisplayName) \
	FCountersTrace::CounterType UE_JOIN(__GTraceCounter, CounterName)(CounterDisplayName, CounterDisplayHint);
...
#define TRACE_DECLARE_INT_COUNTER_EXTERN(CounterName) \
	extern FCountersTrace::FCounterInt UE_JOIN(__GTraceCounter, CounterName);

#define TRACE_DECLARE_UNCHECKED_INT_COUNTER_EXTERN(CounterName) \
	extern FCountersTrace::FCounterUncheckedInt UE_JOIN(__GTraceCounter, CounterName);
...
#define TRACE_DECLARE_ATOMIC_INT_COUNTER_EXTERN(CounterName) \
	extern FCountersTrace::FCounterAtomicInt UE_JOIN(__GTraceCounter, CounterName);

#define TRACE_DECLARE_UNCHECKED_ATOMIC_INT_COUNTER_EXTERN(CounterName) \
	extern FCountersTrace::FCounterUncheckedAtomicInt UE_JOIN(__GTraceCounter, CounterName);
...
#define TRACE_DECLARE_FLOAT_COUNTER_EXTERN(CounterName) \
	extern FCountersTrace::FCounterFloat UE_JOIN(__GTraceCounter, CounterName);

#define TRACE_DECLARE_UNCHECKED_FLOAT_COUNTER_EXTERN(CounterName) \
	extern FCountersTrace::FCounterUncheckedFloat UE_JOIN(__GTraceCounter, CounterName);
...
#define TRACE_DECLARE_ATOMIC_FLOAT_COUNTER_EXTERN(CounterName) \
	extern FCountersTrace::FCounterAtomicFloat UE_JOIN(__GTraceCounter, CounterName);

#define TRACE_DECLARE_UNCHECKED_ATOMIC_FLOAT_COUNTER_EXTERN(CounterName) \
	extern FCountersTrace::FCounterUncheckedAtomicFloat UE_JOIN(__GTraceCounter, CounterName);
...
#define TRACE_COUNTER_SET(CounterName, Value) \
	UE_JOIN(__GTraceCounter, CounterName).Set(Value);

#define TRACE_COUNTER_GET(CounterName) \
	UE_JOIN(__GTraceCounter, CounterName).Get();

#define TRACE_COUNTER_ADD(CounterName, Value) \
	UE_JOIN(__GTraceCounter, CounterName).Add(Value);

#define TRACE_COUNTER_SUBTRACT(CounterName, Value) \
	UE_JOIN(__GTraceCounter, CounterName).Subtract(Value);

#define TRACE_COUNTER_INCREMENT(CounterName) \
	UE_JOIN(__GTraceCounter, CounterName).Increment();

#define TRACE_COUNTER_DECREMENT(CounterName) \
	UE_JOIN(__GTraceCounter, CounterName).Decrement();
...
#define TRACE_COUNTER_SET_IF_DIFFERENT(CounterName, Value) \
	UE_JOIN(__GTraceCounter, CounterName).SetIfDifferent(Value);

#define TRACE_COUNTER_ADD_IF_NOT_ZERO(CounterName, Value) \
	UE_JOIN(__GTraceCounter, CounterName).AddIfNotZero(Value);

#define TRACE_COUNTER_SUBTRACT_IF_NOT_ZERO(CounterName, Value) \
	UE_JOIN(__GTraceCounter, CounterName).SubtractIfNotZero(Value);
...
#define TRACE_COUNTER_SET_ALWAYS(CounterName, Value) \
	UE_JOIN(__GTraceCounter, CounterName).SetAlways(Value);

#define TRACE_COUNTER_ADD_ALWAYS(CounterName, Value) \
	UE_JOIN(__GTraceCounter, CounterName).AddAlways(Value);

#define TRACE_COUNTER_SUBTRACT_ALWAYS(CounterName, Value) \
	UE_JOIN(__GTraceCounter, CounterName).SubtractAlways(Value);
