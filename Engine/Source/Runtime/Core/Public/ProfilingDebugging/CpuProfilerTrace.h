...
#define TRACE_CPUPROFILER_EVENT_MANUAL_START(EventNameStr) \
	if (CpuChannel) \
	{ \
		static uint32 UE_JOIN(__CpuProfilerEventSpecId, __LINE__) = FCpuProfilerTrace::OutputEventType(EventNameStr, __FILE__, __LINE__); \
		FCpuProfilerTrace::OutputBeginEvent(UE_JOIN(__CpuProfilerEventSpecId, __LINE__)); \
	}
...
#define TRACE_CPUPROFILER_EVENT_SCOPE_STR_CONDITIONAL(NameStr, Condition) \
	TRACE_CPUPROFILER_EVENT_DECLARE(UE_JOIN(__CpuProfilerEventSpecId, __LINE__)); \
	TRACE_CPUPROFILER_EVENT_SCOPE_USE(UE_JOIN(__CpuProfilerEventSpecId, __LINE__), NameStr, UE_JOIN(__CpuProfilerEventScope, __LINE__), (Condition));
...
#define TRACE_CPUPROFILER_EVENT_SCOPE_STR_ON_CHANNEL_CONDITIONAL(NameStr, Channel, Condition) \
	TRACE_CPUPROFILER_EVENT_DECLARE(UE_JOIN(__CpuProfilerEventSpecId, __LINE__)); \
	TRACE_CPUPROFILER_EVENT_SCOPE_USE_ON_CHANNEL(UE_JOIN(__CpuProfilerEventSpecId, __LINE__), NameStr, UE_JOIN(__CpuProfilerEventScope, __LINE__), Channel, (Condition));
...
#define TRACE_CPUPROFILER_EVENT_SCOPE_TEXT_CONDITIONAL(Name, Condition) \
	FCpuProfilerTrace::FDynamicEventScope UE_JOIN(__CpuProfilerEventScope, __LINE__)(Name, (Condition), __FILE__, __LINE__);
...
#define TRACE_CPUPROFILER_EVENT_SCOPE_TEXT_ON_CHANNEL_CONDITIONAL(Name, Channel, Condition) \
	FCpuProfilerTrace::FDynamicEventScope UE_JOIN(__CpuProfilerEventScope, __LINE__)(Name, Channel, (Condition), __FILE__, __LINE__);
