...
protected:
	...
	#define COUNT_INSTANCES(TypeName) \
		struct FCount##TypeName : FInstanceCountingObject { FCount##TypeName() : FInstanceCountingObject(TEXT(UE_STRINGIZE(TypeName))) {} }; FCount##TypeName TypeName##Count; 
	...
	#define COUNT_INSTANCES_AND_LOG(TypeName) \
		struct FCount##TypeName : FInstanceCountingObject { FCount##TypeName() : FInstanceCountingObject(TEXT(UE_STRINGIZE(TypeName)), true) {} }; FCount##TypeName TypeName##Count;
