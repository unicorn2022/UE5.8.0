...
public:
	...
	/**
	 * Get a (statically cached) Rec2020 color space.
	 *
	 * @return FColorSpace Rec2020 color space
	 */
	static CORE_API const FColorSpace& GetRec2020();

	/**
	 * Get a (statically cached) P3-D65 color space.
	 *
	 * @return FColorSpace P3-D65 color space
	 */
	static CORE_API const FColorSpace& GetP3D65();
