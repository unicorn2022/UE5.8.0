...
class UE_DEPRECATED(5.8, "Use TIntrusiveMutex.")
TExternalMutex final
{
...
using FExternalMutex UE_DEPRECATED(5.7, "Use TIntrusiveMutex.") = TExternalMutex<Core::Private::FExternalMutexParams>;
