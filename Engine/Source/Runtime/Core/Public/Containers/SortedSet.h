...
public:
	 ...
	 */
	UE_FORCEINLINE_HINT int32 Remove(KeyInitType InKey, EAllowShrinking AllowShrinking = UE::Core::Private::AllowShrinkingByDefault<ArrayAllocator>())
	{
		...
		Elements.RemoveAt(RemoveIndex, AllowShrinking);
		return 1;
	}
