...
template <typename InElementType, typename ArrayAllocator = FDefaultAllocator, typename SortPredicate = TLess<typename TTypeTraits<InElementType>::ConstPointerType>> class TSortedSet;
