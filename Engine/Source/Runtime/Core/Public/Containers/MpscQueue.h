...
public:
	...
	[[nodiscard]] TMpscQueue() : TMpscQueue(::new(AllocatorType::Malloc(sizeof(FNode), alignof(FNode))) FNode)
	{
	}
	...
	{
		UE_AUTORTFM_REPORT_HAZARD_IF_CLOSED(MpscQueue);
...
private:
	...
	[[nodiscard]] explicit TMpscQueue(FNode* Sentinel) : Head(Sentinel), Tail(Sentinel)
	{
	}
