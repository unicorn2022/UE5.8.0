...
public:
	...
	[[nodiscard]] UE_FORCEINLINE_HINT bool AtomicGet() const
	{
		const uint32 Current = static_cast<uint32>(FPlatformAtomics::AtomicRead_Relaxed((const volatile int32*)&Data));
