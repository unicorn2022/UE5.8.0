...
public:
	...
	*/
	 ...
	 */
	static CORE_API FString GetExtension(const FString& InPath, UE::Paths::EFlags Flags = UE::Paths::EFlags::None);
	/** Legacy version of GetExtension that uses a bool to specify bIncludeDot. EFlags::AllowCompoundExtension == 0. */
	static CORE_API FString GetExtension(const FString& InPath, bool bIncludeDot);
