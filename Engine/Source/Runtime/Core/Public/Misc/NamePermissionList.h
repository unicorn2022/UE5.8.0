...
public:
	FNamePermissionList() {}
	virtual ~FNamePermissionList() = default;
...
DECLARE_DELEGATE_RetVal(bool, FDelegateEnablePathFilter);
...
public:
	...
	virtual ~FPathPermissionList() = default;
	...
	*/
	...
	CORE_API void AddEnablePathFilterDelegate(FName Owner, FDelegateEnablePathFilter Delegate);
	CORE_API bool RemoveEnablePathFilterDelegate(FName Owner);
...
protected:
	...
	FDelegateEnablePathFilter OnEnablePathFilterDelegate;
	...
	TMap<FName, FDelegateEnablePathFilter> EnablePathFilterDelegates;
};
