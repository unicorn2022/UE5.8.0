...
struct FMapErrors
{
	...
	/** The landscape proxy property has been overridden but is invalid.  */
	static CORE_API FLazyName LandscapeProxyInvalidPropertyOverride_Warning;

	/** At least one of the landscape grass type overrides is invalid.  */
	static CORE_API FLazyName LandscapeProxyInvalidGrassTypesOverride_Warning;
