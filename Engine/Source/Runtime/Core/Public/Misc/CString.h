...
public:
	...
	*/
	 ...
	 */
	UE_REWRITE static int32 FormatV(CharType* Dest, SIZE_T DestSize, const CharType* Format, va_list Args)
	{
		return FPlatformString::FormatV(Dest, DestSize, Format, Args);
	}
