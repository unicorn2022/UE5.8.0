...
struct FParse
{
	...
	/** Parses a name. */
	static CORE_API bool Value(const TCHAR* Stream, const TCHAR* Match, FName& Name, const TCHAR** OptStreamGotTo = nullptr);
	/** Parses a uint32. */
	static CORE_API bool Value(const TCHAR* Stream, const TCHAR* Match, uint32& Value, const TCHAR** OptStreamGotTo = nullptr);
	/** Parses a globally unique identifier. */
	static CORE_API bool Value(const TCHAR* Stream, const TCHAR* Match, struct FGuid& Guid, const TCHAR** OptStreamGotTo = nullptr);
	...
	*/
	...
	/** Parses a byte. */
	static CORE_API bool Value(const TCHAR* Stream, const TCHAR* Match, uint8& Value, const TCHAR** OptStreamGotTo = nullptr);
	/** Parses a signed byte. */
	static CORE_API bool Value(const TCHAR* Stream, const TCHAR* Match, int8& Value, const TCHAR** OptStreamGotTo = nullptr);
	/** Parses a uint16. */
	static CORE_API bool Value(const TCHAR* Stream, const TCHAR* Match, uint16& Value, const TCHAR** OptStreamGotTo = nullptr);
	/** Parses a signed word. */
	static CORE_API bool Value(const TCHAR* Stream, const TCHAR* Match, int16& Value, const TCHAR** OptStreamGotTo = nullptr);
	/** Parses a floating-point value. */
	static CORE_API bool Value(const TCHAR* Stream, const TCHAR* Match, float& Value, const TCHAR** OptStreamGotTo = nullptr);
	/** Parses a double precision floating-point value. */
	static CORE_API bool Value(const TCHAR* Stream, const TCHAR* Match, double& Value, const TCHAR** OptStreamGotTo = nullptr);
	/** Parses a signed double word. */
	static CORE_API bool Value(const TCHAR* Stream, const TCHAR* Match, int32& Value, const TCHAR** OptStreamGotTo = nullptr);
	/** Parses a string. 
	 * @param Stream, the string you want to extract the value from.
	 * @param Match, the identifier for the value in the stream.
	 * @param Value, the destination to the value to be extracted to.
	...
	*/
	...
	/** Parses an FText. Doesn't support OptStreamGotTo like the other Value versions due to FText parsing
	 * not returning the end of the text
	 * @param Stream, the string you want to extract the value from.
	 * @param Match, the identifier for the value in the stream.
	 * @param Value, the destination FText value to be extracted to.
	...
	*/
	...
	/** Parses a quadword. */
	static CORE_API bool Value(const TCHAR* Stream, const TCHAR* Match, uint64& Value, const TCHAR** OptStreamGotTo = nullptr);
	/** Parses a signed quadword. */
	static CORE_API bool Value(const TCHAR* Stream, const TCHAR* Match, int64& Value, const TCHAR** OptStreamGotTo = nullptr);
	/** Parses a boolean value. */
	static CORE_API bool Bool(const TCHAR* Stream, const TCHAR* Match, bool& OnOff, const TCHAR** OptStreamGotTo = nullptr);
