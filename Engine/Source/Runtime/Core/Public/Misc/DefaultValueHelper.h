...
public:
	 ...
	 */
	UE_REWRITE static bool ParseInt(const FString& Source, int32& OutVal)
	{ 
		return ParseInt(*Source, OutVal); 
	}
	static CORE_API bool ParseInt(const TCHAR* Source, int32& OutVal);
