...
public:
	...
	FGrowableMallocBase()
		...
		, TotalAllocs(0)
	{}
	virtual ~FGrowableMallocBase() = default;
...
public:
	...
	* Destructor
	*/
	virtual ~FGrowableMallocChunk() = default;
...
public:
	...
	*/
	...
	bool Free(GrowableAllocationBaseType* Memory)
	{
		...
		UE_LOGF(LogCore, Fatal, "Tried to free invalid pointer");
		return false;
	}
	...
	*/
	...
	/** triggered during out of memory failure for this allocator */
	 void OutOfMemory(uint32 Size)
	 {
		 ...
		 UE_LOGF(LogCore, Fatal, "FGrowableAllocator: OOM allocating %dbytes %fMB", Size, static_cast<float>(Size) / 1024.0f / 1024.0f);
#endif
	 }
