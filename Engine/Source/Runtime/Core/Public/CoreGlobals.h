...
UE_DEPRECATED(5.8, "This variable is no longer set and will be removed.")
...
namespace UE::CoreUObject::Private
{
	...
	/** Used to visualize tag values in FAssetData in the debugger */
	struct FStoreBase;
}
...
extern CORE_API UE::CoreUObject::Private::FStoreBase* const* GCoreFixedTagStoresForDebugVisualizers;
