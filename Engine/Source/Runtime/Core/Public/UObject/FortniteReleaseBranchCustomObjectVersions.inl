...
// Add new fictitious forces modes to the cloth simulation
FORTNITE_RELEASE_VERSION(ChaosClothAddNewFictitiousForcesModes, 18)

// Updated how blend spaces calculate the effective animation length of the sample point
FORTNITE_RELEASE_VERSION(BlendSpaceUpdatedSamplePointAnimationLengthDerivation, 19)

// Fix to make the override option to "Use Half Precision" work in Material Editor when the cvar r.Mobile.FloatPrecisionMode=2
FORTNITE_RELEASE_VERSION(MaterialHalfPrecisionFixup, 20)
