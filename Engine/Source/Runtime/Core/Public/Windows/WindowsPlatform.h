...
#define PLATFORM_SUPPORTS_MIMALLOC							1
#define PLATFORM_SUPPORTS_NAMED_PIPES						1
#define PLATFORM_COMPILER_HAS_TCHAR_WMAIN					1
#define PLATFORM_SUPPORTS_EARLY_MOVIE_PLAYBACK				(!WITH_EDITOR) // movies will start before engine is initialized
...
#define PLATFORM_SUPPORTS_SPECIALIZATION_CONSTANTS			1
#define PLATFORM_USES_DYNAMIC_HDR_SETTING					1
...
#define PLATFORM_HAS_128BIT_ATOMICS							(WINVER >= 0x602)
