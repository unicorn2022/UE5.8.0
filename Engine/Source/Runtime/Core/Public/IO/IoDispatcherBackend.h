...
public:
	...
	/**
	 * Mark the request as failed, just like calling ::SetFailed only this version allows the caller to
	 * set the desired EIoErrorCode rather than accepting the default one.
	 */
