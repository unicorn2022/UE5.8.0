...
UE_FORCEINLINE_HINT constexpr auto Invoke(FuncType&& Func, ArgTypes&&... Args)
...
constexpr auto Invoke(ReturnType ObjType::*pdm, TargetType&& Target)
...
template <
	...
	typename    TargetType,
	typename... ArgTypes,
	typename    ObjType = TMemberPtrOuter_T<PtrMemFunType>
>
constexpr auto Invoke(PtrMemFunType PtrMemFun, TargetType&& Target, ArgTypes&&... Args)
...
#include "Traits/MemberFunctionPtrOuterDeprecated.h"
#endif
