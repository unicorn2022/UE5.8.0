...
{
	/**
	 * Emplaces a copy of the delegate instance into the given target delegate.
	 * Target MUST be private since no locks are taken! (CreateCopy into a temporary, then move.)
	 */
	virtual void CreateCopy(const FPrivateDelegateAllocation& Target) const = 0;
