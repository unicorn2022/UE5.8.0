...
public:
	...
	{
		new (Target) TBaseUFunctionDelegateInstance(*this);
	}
...
public:
	...
	void CreateCopy(const FPrivateDelegateAllocation& Target) const final
	{
		new (Target) TBaseSPMethodDelegateInstance(*this);
	}
...
public:
	...
	void CreateCopy(const FPrivateDelegateAllocation& Target) const final
	{
		new (Target) TBaseSPLambdaDelegateInstance(*this);
	}
...
public:
	...
	void CreateCopy(const FPrivateDelegateAllocation& Target) const final
	{
		new (Target) TBaseRawMethodDelegateInstance(*this);
	}
...
public:
	...
	void CreateCopy(const FPrivateDelegateAllocation& Target) const final
	{
		new (Target) TBaseUObjectMethodDelegateInstance(*this);
	}
...
public:
	...
	void CreateCopy(const FPrivateDelegateAllocation& Target) const final
	{
		new (Target) TBaseStaticDelegateInstance(*this);
	}
...
public:
	...
	void CreateCopy(const FPrivateDelegateAllocation& Target) const final
	{
		new (Target) TBaseFunctorDelegateInstance(*this);
	}
...
public:
	...
	void CreateCopy(const FPrivateDelegateAllocation& Target) const final
	{
		new (Target) TWeakBaseFunctorDelegateInstance(*this);
	}
