...
enum EPixelFormat : uint8
{
	...
	// If updating this enum, remember to update FOREACH_ENUM_EPIXELFORMAT_CORE below.
};
...
// This should match the definition of FOREACH_ENUM_EPIXELFORMAT generated in NoExportTypes.generated.h.
// It is defined separately here to prevent clashes of the macro name when NoExportTypes.h is also included.
#define FOREACH_ENUM_EPIXELFORMAT_CORE(op) \
	op(PF_Unknown) \
	op(PF_A32B32G32R32F) \
	op(PF_B8G8R8A8) \
	op(PF_G8) \
