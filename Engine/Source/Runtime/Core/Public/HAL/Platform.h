...
//@port Define the platform here to be zero when compiling for other platforms
	...
	#define UE_PLATFORM_WINDOWS 0
#endif
#if !defined(UE_PLATFORM_MAC)
	#define UE_PLATFORM_MAC 0
#endif
#if !defined(UE_PLATFORM_IOS)
	#define UE_PLATFORM_IOS 0
#endif
#if !defined(UE_PLATFORM_TVOS)
	#define UE_PLATFORM_TVOS 0
#endif
#if !defined(UE_PLATFORM_ANDROID)
	#define UE_PLATFORM_ANDROID 0
#endif
#if !defined(UE_PLATFORM_APPLE)
	#define UE_PLATFORM_APPLE 0
#endif
#if !defined(UE_PLATFORM_LINUX)
	#define UE_PLATFORM_LINUX 0
#endif
#if !defined(UE_PLATFORM_UNIX)
	#define UE_PLATFORM_UNIX 0
#endif
#if !defined(UE_PLATFORM_MICROSOFT)
	#define UE_PLATFORM_MICROSOFT 0
#endif
...
#ifndef USING_MEMORY_SANITISER
	#define USING_MEMORY_SANITISER 0
#endif
...
// UE5.2+ requires SSE4.2.
	...
	#endif
#endif
#define PLATFORM_ENABLE_POPCNT_INTRINSIC UE_DEPRECATED_MACRO(5.8, "PLATFORM_ENABLE_POPCNT_INTRINSIC has been deprecated and should be replaced with 1.") 1
...
#define PLATFORM_COMPILER_SUPPORTS_CONSTEXPR_BUILTIN_FILE_AND_LINE UE_DEPRECATED_MACRO(5.7, "PLATFORM_COMPILER_SUPPORTS_CONSTEXPR_BUILTIN_FILE_AND_LINE has been deprecated and should be replaced with 1.") 1
...
#endif
#define PLATFORM_COMPILER_SUPPORTS_CONSTRAINED_DESTRUCTORS UE_DEPRECATED_MACRO(5.8, "PLATFORM_COMPILER_SUPPORTS_CONSTRAINED_DESTRUCTORS has been deprecated and should be replaced with 1.") 1
#define PLATFORM_TCHAR_IS_4_BYTES UE_DEPRECATED_MACRO(5.8, "PLATFORM_TCHAR_IS_4_BYTES has been deprecated and should be replaced with 0.") 0
...
#ifndef PLATFORM_SUPPORTS_SPECIALIZATION_CONSTANTS 
	#define PLATFORM_SUPPORTS_SPECIALIZATION_CONSTANTS 0
#endif

#ifndef PLATFORM_SUPPORT_SPLIT_PLAYERS_RT
	#define PLATFORM_SUPPORT_SPLIT_PLAYERS_RT 0
#endif
...
// Our  LowLevelMemTracker wants to store data about an allocation in the high bits, so it assumes high bits are 0.
// Some platforms store data about an allocation of their own in the high bits. Let LLM know that on those platforms 
// it is okay to discard those bits when storing a copy of the pointer for reference.
#if !defined(PLATFORM_STORES_DATA_IN_POINTER_HIGH_BITS)
	#define PLATFORM_STORES_DATA_IN_POINTER_HIGH_BITS 0
#endif
...
#ifndef PLATFORM_USES_DYNAMIC_HDR_SETTING
	#define PLATFORM_USES_DYNAMIC_HDR_SETTING 0
#endif

#ifndef PLATFORM_PROVIDES_HDR_PAPER_WHITE
	#define PLATFORM_PROVIDES_HDR_PAPER_WHITE 0
#endif
...
#ifndef PLATFORM_THREAD_LOCAL_IS_UNSAFE_IN_MODULES
	#define PLATFORM_THREAD_LOCAL_IS_UNSAFE_IN_MODULES 0
#endif
...
#define PLATFORM_CONSOLE (#)
	...
	#error PLATFORM_32BITS should not be defined.
#endif
#ifdef PLATFORM_64BITS
	#error PLATFORM_64BITS should not be defined.
#endif
#define PLATFORM_32BITS UE_DEPRECATED_MACRO(5.8, "PLATFORM_32BITS is deprecated as UE only supports 64-bit.") 0
#define PLATFORM_64BITS UE_DEPRECATED_MACRO(5.8, "PLATFORM_64BITS is deprecated as UE only supports 64-bit.") 1
...
// Disable UBSan on a given function
#ifndef UE_DISABLE_UBSAN
	#define UE_DISABLE_UBSAN
#endif
...
// By default we assume that platforms require us to not have `nullptr` as arguments to
// memory operations (like `memcpy`, `memset`, `memmove`, etc). `n3322` will define that
// having `nullptr` as arguments to these functions with a size of 0 is ok, rather than
// the UB it caused previously.
#ifndef UE_PLATFORM_REQUIRES_NONNULL_MEMOP_ARGS
#	define UE_PLATFORM_REQUIRES_NONNULL_MEMOP_ARGS 1
#endif
...
// Expands out to x, TEXT(x), WIDETEXT(x) or UTF8TEXT(x) depending on CharType
#define CHARTEXT(CharType, x) \
	( \
		...
		{ \
			...
			else if constexpr (std::is_same_v<UnqualifiedCharType, WIDECHAR>) \
			{ \
				return WIDETEXT(x); \
			} \
