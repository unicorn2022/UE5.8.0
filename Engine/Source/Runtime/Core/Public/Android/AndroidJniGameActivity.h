...
namespace UE::Jni
{
	struct FGameActivity: Java::Lang::FObject
	{
		...
		static void JNICALL nativeSetConfigRulesVariables(JNIEnv* env, jobject thiz, Java::Lang::TArray<jstring>* KeyValuePairs, Java::Lang::TArray<jbyte>* Utf8Vars);
		...
		static void JNICALL nativeOnAudioFocusChanged(JNIEnv* env, jobject thiz, jint FocusChange);
#if USE_ANDROID_INPUT
		...
		static constexpr FNativeMethod NativeMethods[]
		{
			...
			UE_JNI_NATIVE_METHOD(nativeOnAudioFocusChanged)
		};
	};
}
