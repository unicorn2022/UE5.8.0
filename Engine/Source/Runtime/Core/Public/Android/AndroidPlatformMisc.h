...
enum class EAndroidAudioFocusChange
{
...
struct FAndroidMisc : public FGenericPlatformMisc
{
	...
	static CORE_API FString GetBillingConfigCountryCode();
	static CORE_API bool GetIsAlternativeBillingOnlyAvailable();
...
public:
	...
	// return UTF8 versions of the configrules
...
#if !UE_BUILD_SHIPPING
	static CORE_API bool IsConsoleOpen();
#endif
