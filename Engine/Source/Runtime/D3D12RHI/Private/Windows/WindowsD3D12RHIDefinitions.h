...
#define UE_D3D12_SDK_VERSION (D3D12_SDK_VERSION)
...
#define D3D12RHI_HAS_LAYOUT_VIDEO_QUEUE_COMMON                                  (UE_D3D12_SDK_VERSION  < 618)
#define D3D12RHI_HAS_LAYOUT_DIRECT_QUEUE_GENERIC_READ_COMPUTE_QUEUE_ACCESSIBLE  (UE_D3D12_SDK_VERSION >= 618)
#define D3D12RHI_COMMON_AND_PRESENT_ARE_DISTINCT                                0

// Needed for XR
#define D3D12RHI_SUPPORTS_ALIASED_RHI_RESOURCES 1

#define USE_BUFFER_POOL_ALLOCATOR 1
#define USE_TEXTURE_POOL_ALLOCATOR 1
