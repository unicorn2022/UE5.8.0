...
inline FName GetD3DCommandQueueTypeFName(ED3D12QueueType QueueType)
{
	switch (QueueType)
	{
	default: checkNoEntry(); // fallthrough
	case ED3D12QueueType::Direct: { static const FName Name(TEXT("3D"));      return Name; }
	case ED3D12QueueType::Async:  { static const FName Name(TEXT("Compute")); return Name; }
	case ED3D12QueueType::Copy:   { static const FName Name(TEXT("Copy"));    return Name; }
	}
}
