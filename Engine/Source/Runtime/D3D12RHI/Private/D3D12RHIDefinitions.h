...
#ifndef D3D12RHI_BARRIER_LOGGING
	#define D3D12RHI_BARRIER_LOGGING !(UE_BUILD_SHIPPING)
#endif
...
#if WITH_NVAPI && (D3D12_MAX_DEVICE_INTERFACE >= 5) && D3D12_RHI_RAYTRACING && !UE_BUILD_SHIPPING
	#define WITH_NVAPI_RAYTRACING_VALIDATION 1
#else
	#define WITH_NVAPI_RAYTRACING_VALIDATION 0
#endif
