...
void D3D12BufferStats::UpdateBufferStats(FD3D12Buffer& Buffer, bool bAllocating)
{
    ...
    // With D3D12RHI_PLATFORM_LOW_LEVEL_RES_TRACK=1, MemoryTrace_Alloc is called during resource allocation
#if UE_MEMORY_TRACE_ENABLED  && (D3D12RHI_PLATFORM_LOW_LEVEL_RES_TRACK == 0)
