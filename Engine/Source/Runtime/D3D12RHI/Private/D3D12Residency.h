...
extern bool GD3D12StartResourceResident;
#endif
...
namespace D3DX12Residency
{
...
#endif
			Object.Initialize(pResource, ObjectSize, 0, GD3D12StartResourceResident ? ManagedObject::RESIDENCY_STATUS::RESIDENT : ManagedObject::RESIDENCY_STATUS::EVICTED);
		}
	}
#endif
	...
	inline void InitializeResidencyManager(ResidencyManager& ResidencyManager, ID3D12Device* Device, uint32 GPUIndex, IDXGIAdapter3* Adapter, uint32 MaxLatency)
	{
		if (GEnableResidencyManagement)
		{
			ResidencyManager.SetStartEvicted(!GD3D12StartResourceResident);
