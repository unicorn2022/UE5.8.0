...
public:
	...
	virtual void AddRef() const override                        { FRHIResource::AddRef(); }
	virtual FReturnedRefCountValue Release() const override	    { return FReturnedRefCountValue{ FRHIResource::Release() }; }
	virtual FReturnedRefCountValue GetRefCount() const override { return  FReturnedRefCountValue{ FRHIResource::GetRefCount() }; }
	...
	void UpdateTexture(FD3D12CommandContext& Context, uint32 MipIndex, uint32 DestX, uint32 DestY, uint32 DestZ, const D3D12_TEXTURE_COPY_LOCATION& SourceCopyLocation, FD3D12Resource* SourceResource);
...
namespace UE::D3D12RHI::TextureUtils
{
	...
	void ReconcileInitialState(FRHICommandListBase& RHICmdList, FD3D12Texture* Texture, ED3D12Access CurrentD3D12Access, ED3D12Access NeededD3D12Access, bool bNeedsDiscard);
