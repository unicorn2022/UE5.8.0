...
using FD3D12DescriptorIndex = uint32;
...
namespace UE::D3D12Descriptors
{
	...
	void CopyDescriptor(FD3D12Device* Device, FD3D12DescriptorHeap* TargetHeap, FD3D12DescriptorIndex DstIndex, D3D12_CPU_DESCRIPTOR_HANDLE SrcCpuHandle);
	...
	void CopyDescriptors(FD3D12Device* Device, FD3D12DescriptorHeap* TargetHeap, FD3D12DescriptorHeap* SourceHeap, TConstArrayView<FD3D12DescriptorIndex> Indices);
...
struct FD3D12DescriptorHeap : public FD3D12DeviceChild, public FRefCountedObject
{
public:
	...
	// Heap created as an allocation from a descriptor manager.
	FD3D12DescriptorHeap(FD3D12DescriptorManager* Manager, uint32 InOffset, uint32 InNumDescriptors);
...
private:
	...
	// Manager this heap is a suballocation of, if any.
	FD3D12DescriptorManager* Manager = nullptr;
...
public:
	...
	FD3D12DescriptorHeap* AllocateSubheap(uint32 InNumDescriptors);
	void FreeSubheap(FD3D12DescriptorHeap* InHeap);
