...
public:
	...
	TOptional<FRHIDescriptorAllocation> AllocateDescriptors(ERHIDescriptorTypeMask DescriptorTypeMask, uint32 DescriptorCount);

	void FreeDescriptor(FRHIDescriptorHandle Handle);
	void FreeDescriptors(FRHIDescriptorAllocation Allocation, ERHIDescriptorTypeMask TypeMask);
...
public:
	...
	void InitializeDescriptor(FRHIDescriptorHandle DstHandle, const FD3D12SamplerState* SamplerState);
...
public:
	...
	void InitializeDescriptor(FRHIDescriptorHandle DstHandle, const FD3D12View* View);
	void UpdateDescriptor(FD3D12ContextArray const& Contexts, FRHIDescriptorHandle DstHandle, const FD3D12View* View);
...
private:
	...
	{
		FD3D12DescriptorHeapPtr       GpuHeap;
		TArray<FD3D12DescriptorIndex> UpdatedIndices;
		bool                          bInUse = true;
...
public:
	...
	void InitializeDescriptor(FRHIDescriptorHandle DstHandle, const FD3D12SamplerState* SamplerState);
	void InitializeDescriptor(FRHIDescriptorHandle DstHandle, const FD3D12View* View);
	void UpdateDescriptor(FD3D12ContextArray const& Contexts, FRHIDescriptorHandle DstHandle, const FD3D12View* SourceView);
