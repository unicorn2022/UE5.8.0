...
public:
	...
	FCharacterNetworkMoveData(const FCharacterNetworkMoveData&) = default;
	FCharacterNetworkMoveData(FCharacterNetworkMoveData&&) = default;
	FCharacterNetworkMoveData& operator=(const FCharacterNetworkMoveData&) = default;
	FCharacterNetworkMoveData& operator=(FCharacterNetworkMoveData&&) = default;
	...
	UE_DEPRECATED(5.8, "This property has been deprecated. Please use MovementBasePhysicsObjectOwner instead and use that to create a FMovementBaseInterfaceData. See UCharacterMovementComponent::ServerMove_PerformMovement for an example of this.")
	class UPrimitiveComponent* MovementBase;

	TObjectPtr<UObject> MovementBasePhysicsObjectOwner;
...
public:
	...
	FClientAdjustment()
		...
		, NewBase(NULL)
		, NewMovementBasePhysicsObjectOwner(nullptr)
	...
	~FClientAdjustment() = default;
	FClientAdjustment(const FClientAdjustment&) = default;
	FClientAdjustment(FClientAdjustment&&) = default;
	FClientAdjustment& operator=(const FClientAdjustment&) = default;
	FClientAdjustment& operator=(FClientAdjustment&&) = default;
	PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UE_DEPRECATED(5.8, "This property has been deprecated. Please use NewMovementBasePhysicsObjectOwner instead and use that to create a FMovementBaseInterfaceData. See UCharacterMovementComponent::ClientHandleMoveResponse for an example of this.")
	...
	TObjectPtr<UObject> NewMovementBasePhysicsObjectOwner;
	...
	void Serialize(FArchive& Archive)
	{
		if (Archive.IsMigratingRemoteObjects())
		{
			...
			Archive << NewMovementBasePhysicsObjectOwner;
			PRAGMA_DISABLE_DEPRECATION_WARNINGS
			NewBase = Cast<UPrimitiveComponent>(NewMovementBasePhysicsObjectOwner.Get());
			PRAGMA_ENABLE_DEPRECATION_WARNINGS
