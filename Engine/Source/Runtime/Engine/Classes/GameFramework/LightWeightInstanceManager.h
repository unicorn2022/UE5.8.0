...
UCLASS(BlueprintType, Blueprintable, Experimental, MinimalAPI, Deprecated, meta = (DeprecationMessage ="Deprecated in 5.8. Consider using InstancedActors for similar functionality"))
class ADEPRECATED_LightWeightInstanceManager : public AActor, public IActorInstanceManagerInterface
{
...
public:
	ENGINE_API virtual ~ADEPRECATED_LightWeightInstanceManager();
...
protected:
	...
	ENGINE_API virtual void PreSpawnInitialization(const FActorInstanceHandle& Handle, AActor* SpawnedActor);
