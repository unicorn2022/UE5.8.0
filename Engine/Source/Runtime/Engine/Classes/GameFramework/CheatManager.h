...
class UCheatManager : public UObject
{
	...
	UE_DEPRECATED(5.8, "Use the FDebugCameraManager class instead")
	UPROPERTY(meta = (DeprecatedProperty, DeprecationMessage = "Use the FDebugCameraManager class instead"))
