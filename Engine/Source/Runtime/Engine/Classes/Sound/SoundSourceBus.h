...
public:
	...
	UPROPERTY(EditAnywhere, Category = "Sound|Source Bus")
	...
	UPROPERTY(EditAnywhere, Category = "Sound|Source Bus", meta = (UIMin = 0.0, ClampMin = 0.0))
	...
	UPROPERTY(EditAnywhere, Category = "Sound|Source Bus", meta=(DisplayName="Audio Bus Return"))
