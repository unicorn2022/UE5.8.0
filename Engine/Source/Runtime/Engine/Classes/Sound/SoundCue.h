...
{
public:
	virtual ~ISoundCueAudioEditor() = default;
...
protected:
	...
	UPROPERTY(EditAnywhere, Category = "Voice Management", Meta = (Tooltip = "The priority of the subtitle.  Defaults to 10000.  Higher values will play instead of lower values."))
...
public:
	...
	UPROPERTY(EditAnywhere, Category = "Sound", meta=(DisplayAfter="AttenuationSettings"))
