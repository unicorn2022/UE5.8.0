...
#include "AudioPlatformSettings.h"
...
class UAudioSettings : public UDeveloperSettings
{
	...
	*/
	UPROPERTY(config, EditAnywhere, Category = "Mix", AdvancedDisplay, meta = (ConfigRestartRequired = true))
...
private:
	...
	// Per-platform audio options container
	UPROPERTY(config, EditAnywhere, Category="Platform Settings", meta = (ShowOnlyInnerProperties))
...
public:
	...
	// Convenience accessors for per-platform settings
	ENGINE_API FDecodeCacheSettings GetDecodeCacheSettings() const;
