...
public:
	...
	inline static FRectLightSceneProxyDesc BuildSceneProxyDesc(const URectLightComponent& InLightComponent)
	{
		FRectLightSceneProxyDesc ProxyDesc;
...
protected:
	...
	ENGINE_API static void BuildSceneProxyDesc(const URectLightComponent& InLightComponent, FRectLightSceneProxyDesc& OutProxyDesc);
