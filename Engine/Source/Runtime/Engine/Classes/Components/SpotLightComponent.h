...
class USpotLightComponent : public UPointLightComponent
{
	...
	static FVector2f GetClampedConeAngles(float InInnerConeAngle, float InOuterConeAngle);
	ENGINE_API FVector2f GetClampedConeAngles() const;
	...
	inline static FSpotLightSceneProxyDesc BuildSceneProxyDesc(const USpotLightComponent& InLightComponent)
	{
		FSpotLightSceneProxyDesc ProxyDesc;
...
protected:
	...
	ENGINE_API static void BuildSceneProxyDesc(const USpotLightComponent& InLightComponent, FSpotLightSceneProxyDesc& OutProxyDesc);
};