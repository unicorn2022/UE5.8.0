...
class USplineMeshComponent : public UStaticMeshComponent, public IInterface_CollisionDataProvider
{
	...
	*/
	...
	UPROPERTY(EditAnywhere, Category = HLOD, AdvancedDisplay)
	TObjectPtr<UHLODLayer> HLODLayerOverrideForSplinePartitioning;
#endif
...
public:
	...
	ENGINE_API UHLODLayer* GetHLODLayerForSplinePartitioning() const;
...
public:
	// OnCreatePhysicsState calls RecreateCollision() which uses DuplicateObject
	// and other GT-only operations, making it unsafe for async execution.
	virtual bool AllowsAsyncPhysicsStateCreation() const override { return false; }
	virtual bool AllowsAsyncPhysicsStateDestruction() const override { return false; }
...
public:
	ENGINE_API virtual bool SupportsDefaultCollision() override;
