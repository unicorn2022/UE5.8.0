...
#if WITH_EDITORONLY_DATA
	UPROPERTY(Transient)
	TObjectPtr<UMaterial> DebugTextureMaterial = nullptr;
#endif
};
...
public:
	...
	EStereoLayerType GetStereoLayerType() const { return StereoLayerType; }
...
protected:
	...
	/** Render priority among all stereo layers. Layers with higher priorities will be rendered on top of layers with lower priorities. **/
	UPROPERTY(EditAnywhere, BlueprintReadOnly, export, Category= "StereoLayer")
	int32 Priority;
