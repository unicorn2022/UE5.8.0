...
class UChildActorComponent : public USceneComponent
{
	...
	/**
	 * Sets whether or not the owner of the child actor will be set to the owner of this component 
	 * @param bInSetChildActorOwner Will the owner of this component be set as the owner of the child actor
	 */
	void SetChildActorOwnerOnCreation(bool bInSetChildActorOwner) { bSetOwner = bInSetChildActorOwner; }
