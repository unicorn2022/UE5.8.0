...
class USceneCaptureComponentCube : public USceneCaptureComponent
{
	...
	/** Transient, used for runtime reflection captures, to support time slicing. */
	uint8 ReflectionTimeSliceFirst;			// First slice to render
	uint8 ReflectionTimeSliceCount;			// Number of slices to render

	/** Transient, used for runtime reflection captures.  Not dereferenced, just used to look up the reflection cube map array index. */
	UReflectionCaptureComponent* ReflectionComponent;
