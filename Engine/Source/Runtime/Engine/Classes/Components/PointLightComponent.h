...
public:
	...
	inline static FPointLightSceneProxyDesc BuildSceneProxyDesc(const UPointLightComponent& InLightComponent)
	{
		FPointLightSceneProxyDesc ProxyDesc;
...
protected:
	...
	ENGINE_API static void BuildSceneProxyDesc(const UPointLightComponent& InLightComponent, FPointLightSceneProxyDesc& OutProxyDesc);
};