...
class UKismetStringLibrary : public UBlueprintFunctionLibrary
{
	...
	**/
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Utilities|String")
	static ENGINE_API TArray<FString> ParseIntoArray(const FString& SourceString, const FString& Delimiter = FString(" "), const bool CullEmptyStrings = true);
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Utilities|String")
	static ENGINE_API FString JoinStringArray(const TArray<FString>& SourceArray, const FString&  Separator = FString(" "));
