...
enum class EMemoryUnit : uint8
{
	...
	/* Auto-select based on magnitude using IEC (1024-based) */
	Auto_IEC,

	/* IEC (1024-based) */
	Unit_KiB, Unit_MiB, Unit_GiB, Unit_TiB, Unit_PiB, Unit_EiB,

	/* Auto-select based on magnitude using SI (1000-based) */
	Auto_SI,
...
class UKismetTextLibrary : public UBlueprintFunctionLibrary
{
	...
	UFUNCTION(BlueprintPure, meta=(DisplayName="As Memory (Specific Unit)", AdvancedDisplay = "1"), Category="Utilities|Text")
	static ENGINE_API FText AsMemoryUnit(int64 NumBytes, EMemoryUnit Unit = EMemoryUnit::Auto_IEC, bool bUseGrouping = true, int32 MinimumIntegralDigits = 1, int32 MaximumIntegralDigits = 324, int32 MinimumFractionalDigits = 0, int32 MaximumFractionalDigits = 3);
