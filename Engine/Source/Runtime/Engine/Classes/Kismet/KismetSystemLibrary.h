...
class UKismetSystemLibrary : public UBlueprintFunctionLibrary
{
	...
	static ENGINE_API void RaiseScriptError(const FString& ErrorMessage = FString("An error occurred"));
	...
	UFUNCTION(BlueprintPure, Category="Utilities", meta = (DisplayName = "Get Object Path String", BlueprintThreadSafe))
...
#if WITH_EDITOR
	// Gets the UObject associated with a SoftPath, loading if necessary.
	UFUNCTION(BlueprintPure, Category = "Utilities")
	static UObject* GetObjectFromSoftPath(const FSoftObjectPath& Path);

	// Gets the UClass associated with a SoftPath, loading if necessary.
	UFUNCTION(BlueprintPure, Category = "Utilities")
	static UClass* GetClassFromSoftPath(const FSoftClassPath& Path);
#endif
	...
	static ENGINE_API void LogString(const FString& InString = FString("Hello"), bool bPrintToLog = true);
	...
	static ENGINE_API void PrintString(const UObject* WorldContextObject, const FString& InString = FString("Hello"), bool bPrintToScreen = true, bool bPrintToLog = true, FLinearColor TextColor = FLinearColor(0.0f, 0.66f, 1.0f), float Duration = 2.f, const FName Key = NAME_None);
