...
{
	/** do NOT cast to UTextureLODSettings !
	use GetTextureLODSettings() instead !
	@todo CBTLDP : remove the public inheritance, hold TextureLODSettings as member instead?
	**/
...
public:
	...
	ENGINE_API void SetPreviewTextureGroupRedirect(const UTextureLODSettings* InPreviewTextureGroupRedirect);

	const UTextureLODSettings* GetPreviewTextureGroupRedirect() const
	{
...
private:
	...
	UTextureLODSettings const * PreviewTextureGroupRedirect = nullptr;  // @todo CBTLDP : why is this a member here and not a static or global ?
