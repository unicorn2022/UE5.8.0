...
public:
	...
	*/
	...
	ENGINE_API virtual void SetDisabled(const bool Disabled);
	ENGINE_API virtual bool GetDisabled() const;
	
	ENGINE_API virtual void SetSleepType(const Chaos::ESleepType SleepType);
	ENGINE_API virtual Chaos::ESleepType GetSleepType() const;
	
	ENGINE_API virtual void SetRigidState(const Chaos::EObjectStateType ObjectState);
	ENGINE_API virtual Chaos::EObjectStateType GetRigidState() const;

	ENGINE_API virtual void SetGravityEnabled(const bool Enabled);
	ENGINE_API virtual bool GetGravityEnabled() const;
