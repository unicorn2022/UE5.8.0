...
public:
	...
	uint32				bSupportsParallelTick:1; // Indicates if this channel can be ticked in parallel with other NetConnection::Tick steps. Set this in the Init function of derived class
	...
	/** Indicates if this channel can be ticked in parallel with other NetConnection::Tick steps*/
	bool SupportsParallelTick() const
	{
		return bSupportsParallelTick;
	}
