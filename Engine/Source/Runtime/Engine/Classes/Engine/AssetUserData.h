	...
	: public UObject
{
	...
	/** Merge this Asset User Data with the given one. Used when merging Skeletal Meshes.
	* 
	* @return true if the merge has completed successfully. */
	virtual bool Merge(const TNotNull<UAssetUserData*> Other)
	{
		return false;
	}
};
