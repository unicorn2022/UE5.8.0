...
public:
	 ...
	 */
	ENGINE_API virtual TSharedRef<SViewport> CreateGameViewportWidget();

	UE_DEPRECATED(5.8, "Use parameterless overload instead")
	 ...
	 * @param MonitorIndex	[in] Index of the entry in FDisplayMetrics::MonitorInfo
	 */
	static ENGINE_API void ConditionallyOverrideSettings( int32& ResolutionX, int32& ResolutionY, EWindowMode::Type& WindowMode, int32 MonitorIndex = -1 );
	 ...
	 * @param MonitorIndex	[in] Index of the entry in FDisplayMetrics::MonitorInfo
	 */
	static ENGINE_API void DetermineGameWindowResolution( int32& ResolutionX, int32& ResolutionY, EWindowMode::Type& WindowMode, bool bUseWorkAreaForWindowed = false, int32 MonitorIndex = -1 );
