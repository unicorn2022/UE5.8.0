...
UENUM()
enum class EStaticMeshLODStreaming : uint8
{
	/** Use the default behavior (LOD Group controls LOD streaming). */
	Default,
	/** Enable LOD streaming. */
	Enabled,
	/** Disable LOD streaming. */
	Disabled,
};
...
private:
	...
	EStaticMeshLODStreaming LODStreaming;
...
public:
	...
	void SetLODStreaming(EStaticMeshLODStreaming InLODStreaming)
	{
		LODStreaming = InLODStreaming;
	}
