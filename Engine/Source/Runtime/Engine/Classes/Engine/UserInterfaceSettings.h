...
public:
	...
	/** Convert font size from the editor render DPI to the project FontResolution DPI */
	ENGINE_API float ConvertFontSizeFromNativeToDisplay(float FontSize) const;

	/** Convert font size from the project FontResolution DPI to the editor render DPI */
	ENGINE_API float ConvertFontSizeFromDisplayToNative(float FontSize) const;
