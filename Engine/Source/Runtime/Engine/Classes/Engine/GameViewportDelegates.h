...
/**
 * Delegate type used by UGameViewportClient when a non-HDR screenshot has been captured
 *
 * The first parameter is the width.
 * The second parameter is the height.
 * The third parameter is the array of bitmap data (FColor).
 * @see UGameViewportClient
 */
DECLARE_MULTICAST_DELEGATE_ThreeParams(FOnScreenshotCaptured, int32 /*Width*/, int32 /*Height*/, const TArray<FColor>& /*Colors*/);

/**
 * Delegate type used by UGameViewportClient when an HDR screenshot has been captured
 *
 * The first parameter is the width.
 * The second parameter is the height.
 * The third parameter is the array of bitmap data (FLinearColor).
 * @see UGameViewportClient
 */
...
/**
 * Delegate type used by UGameViewportClient for when the window moves to another display
 *
 * @see UGameViewportClient
 */
DECLARE_MULTICAST_DELEGATE(FOnWindowDisplayChanged);
