...
struct FSubsurfaceProfileStruct
{
	...
	*/
	...
	/** A value of 1 indicates physically correct extinction. */
	UPROPERTY(Category = "Transmission", EditAnywhere, BlueprintReadOnly, AdvancedDisplay, meta = (ClampMin = "0.01", UIMax = "100.0", ClampMax = "100.0", SliderExponent="24"))
	float ExtinctionScale;
	
	UPROPERTY(Category = "Transmission", EditAnywhere, BlueprintReadOnly, AdvancedDisplay, meta = (ClampMin = "0.01", UIMax = "0.99", ClampMax = "1.0"))
	float NormalScale;

	/**
	* Scale the transmission in addition to scattering. Majorly used for backward compatability. A value of 1 indicates physically correct scale - No additional scaling.
	*/
	UPROPERTY(Category = "Transmission", EditAnywhere, BlueprintReadOnly, AdvancedDisplay, meta = (ClampMin = "0.1", UIMax = "10.0", ClampMax = "10.0"))
	float DistanceScale;
