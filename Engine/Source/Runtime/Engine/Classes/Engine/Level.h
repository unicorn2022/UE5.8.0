...
public:
	...
	/** Number of actors marked for pending unload by GC */
	int32 NumActorsMarkedForPendingUnloadByGC = 0;
...
private:
	...
	/** Returns the optional cook package name (used by FUpdateLevelVisibilityLevelInfo) */
	ENGINE_API FName GetCookPackageName() const;
	friend struct FUpdateLevelVisibilityLevelInfo;
