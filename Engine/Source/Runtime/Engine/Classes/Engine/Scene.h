...
/** Used by FPostProcessSettings to determine the tonemapping method. */
UENUM()
enum class ETonemappingMethod : uint8
{
	Filmic UMETA(DisplayName = "Filmic"),
	StandardACES UMETA(DisplayName = "Standard ACES", ToolTip = "Film settings do not apply to this method."),
	MAX,
};
...
{
	CosineFourthLaw	= 0 UMETA(DisplayName = "Cosine Fourth Law (Default)"),
	Texture			= 1 UMETA(DisplayName = "Texture"),
	Oval			= 2 UMETA(DisplayName = "Oval")
};
...
struct FColorGradingSettings
{
	...
	UPROPERTY(Interp, BlueprintReadWrite, Category = "Color Grading|Shadows", meta = (UIMin = "-1.0", UIMax = "1.0", DisplayName = "ShadowsMax"))
	float ShadowsMax;

	UPROPERTY(Interp, BlueprintReadWrite, Category = "Color Grading|Highlights", meta = (UIMin = "-1.0", UIMax = "1.0", DisplayName = "HighlightsMin"))
	float HighlightsMin;

	UPROPERTY(Interp, BlueprintReadWrite, Category = "Color Grading|Highlights", meta = (UIMin = "1.0", UIMax = "10.0", DisplayName = "HighlightsMax"))
	float HighlightsMax;
...
struct FPostProcessSettings
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category=Overrides, meta=(PinHiddenByDefault, InlineEditConditionToggle))
	uint8 bOverride_TonemappingMethod:1;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category=Overrides, meta=(PinHiddenByDefault, InlineEditConditionToggle))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category=Overrides, meta=(PinHiddenByDefault, InlineEditConditionToggle))
	uint8 bOverride_MegaLightsFrontLayerTranslucency:1;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category=Overrides, meta=(PinHiddenByDefault, InlineEditConditionToggle))
	uint8 bOverride_VignetteType:1;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category=Overrides, meta=(PinHiddenByDefault, InlineEditConditionToggle))
	uint8 bOverride_VignetteCenter:1;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category=Overrides, meta=(PinHiddenByDefault, InlineEditConditionToggle))
	uint8 bOverride_VignetteColor:1;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category=Overrides, meta=(PinHiddenByDefault, InlineEditConditionToggle))
	uint8 bOverride_VignetteSize:1;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category=Overrides, meta=(PinHiddenByDefault, InlineEditConditionToggle))
	uint8 bOverride_VignetteSoftness:1;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category=Overrides, meta=(PinHiddenByDefault, InlineEditConditionToggle))
	uint8 bOverride_VignetteTexture:1;
...
#if WITH_EDITORONLY_DATA
	UPROPERTY()
	uint8 bOverride_FilmGrainTexelSize_DEPRECATED:1;
#endif

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category=Overrides, meta=(PinHiddenByDefault, InlineEditConditionToggle))
	uint8 bOverride_FilmGrainScale:1;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category=Overrides, meta=(PinHiddenByDefault, InlineEditConditionToggle))
	uint8 bOverride_DepthOfFieldEnabled:1;
	...
	UE_DEPRECATED(5.8, "Field will be removed")
	UPROPERTY()
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Overrides, meta = (PinHiddenByDefault, InlineEditConditionToggle))
	uint32 bOverride_LumenAmbientOcclusionIntensity : 1;
	...
	*/
	...
	/** Controls the method of tonemapping. */
	UPROPERTY(interp, BlueprintReadWrite, Category="Film", meta=(editcondition = "bOverride_TonemappingMethod", DisplayName = "Method"))
	...
	/** Allows control over the strength of Lumen's Short Range Ambient Occlusion. */
	UPROPERTY(interp, EditAnywhere, BlueprintReadWrite, Category = "Global Illumination|Lumen Global Illumination", AdvancedDisplay, meta = (ClampMin = "0", UIMax = "1", ClampMax = "1", editcondition = "bOverride_LumenAmbientOcclusionIntensity", DisplayName = "Ambient Occlusion Intensity"))
	float LumenAmbientOcclusionIntensity;
	...
	/** Scale factor for Lumen Surface Cache resolution.  Smaller values save GPU memory, at a cost in quality.  Defaults to 0.5 for Scene Captures if not overridden. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Global Illumination|Lumen Global Illumination", meta = (ClampMin = ".5", ClampMax = "1", editcondition = "bOverride_LumenSurfaceCacheResolution"))
	...
	/** Whether to use high quality direct lighting on the front layer of translucent surfaces.  Other layers will use the lower quality Translucency Lighting Volume.  Increases GPU cost when enabled. */
	UPROPERTY(interp, EditAnywhere, BlueprintReadWrite, Category = "Rendering Features", meta = (editcondition = "bOverride_MegaLightsFrontLayerTranslucency", DisplayName = "MegaLights - High Quality Translucency"))
	uint8 MegaLightsFrontLayerTranslucency : 1;
	...
	*/
	...
	/** The shape type of the vignette */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Lens|Image Effects", AdvancedDisplay, meta=(editcondition = "bOverride_VignetteType"))
	EVignetteType VignetteType;

	/** Position of the vignette center in UV space.  */
	UPROPERTY(interp, BlueprintReadWrite, Category="Lens|Image Effects", AdvancedDisplay, meta=(UIMin = "0.0", UIMax = "1.0", editcondition = "bOverride_VignetteCenter"))
	FVector2f VignetteCenter;

	/** Color multiplied with areas that are masked by the vignette. Default is black. */
	UPROPERTY(interp, BlueprintReadWrite, Category="Lens|Image Effects", AdvancedDisplay, meta=(editcondition = "bOverride_VignetteColor"))
	FLinearColor VignetteColor;

	/** Scale of the vignette shape in screenspace. Can be used to scale vignette anamorphically. Default is 1. */
	UPROPERTY(interp, BlueprintReadWrite, Category="Lens|Image Effects", AdvancedDisplay, meta=(ClampMin = "0.0", UIMin = "0.1", UIMax = "2.0", editcondition = "bOverride_VignetteSize"))
	FVector2f VignetteSize;

	/** The softness of the transition from opaque to transparant on the edge of the vignette shape. */
	UPROPERTY(interp, BlueprintReadWrite, Category="Lens|Image Effects", AdvancedDisplay, meta=(ClampMin = "0.001", UIMax = "10.0", editcondition = "bOverride_VignetteSoftness"))
	float VignetteSoftness;

	/** Defines the shape of the vignette when VignetteType is set to Texture */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Lens|Image Effects", AdvancedDisplay, meta=(editcondition = "bOverride_VignetteTexture", DisplayName = "Vignette Texture"))
	TObjectPtr<class UTexture> VignetteTexture;
	...
	UE_DEPRECATED(5.8, "Use FilmGrainScale instead")
	UPROPERTY()
	float FilmGrainTexelSize_DEPRECATED;
#endif

	/** Controls the size of the film grain. Size of texel of FilmGrainTexture on screen. */
	UPROPERTY(interp, BlueprintReadWrite, Category = "Film Grain", meta = (UIMin = "0.0", UIMax = "4.0", editcondition = "bOverride_FilmGrainScale"))
	...
	/** When false, post-process depth of field will not be used. When true, DoF may be used depending on lens and scalability settings. */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Lens|Depth of Field", meta=(editcondition = "bOverride_DepthOfFieldEnabled", DisplayName = "Enabled"))
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
		...
		if (bOverride_FilmGrainTexelSize_DEPRECATED)
		{
			bOverride_FilmGrainScale = true;
			FilmGrainScale = FVector2f(FilmGrainTexelSize_DEPRECATED, FilmGrainTexelSize_DEPRECATED);
		}
