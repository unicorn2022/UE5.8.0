...
public:
	...
	ENGINE_API virtual void SetProxyConnection(bool bEnabled) override;
	ENGINE_API virtual bool IsProxyConnection() const override;

private:
	void AssignConnectionHandle();

protected:
	virtual void RemoveLocalPlayer(UGameInstance* GameInstance, ULocalPlayer* LocalPlayer);
};
