...
class IInterface_PostProcessVolume
{
	...
	// Returns true if the sphere around Point with radius SphereRadius intersects with the volume
	// OutDistanceToPoint is set to the distance to the nearest point on the volume,
	// or may be set to FLT_MAX if Point is outside the blending range of the volume.
