...
protected:
	...
	/** Gets cached camera location and rotation, possibly modified to assist replication */
	ENGINE_API virtual void GetCameraCacheLocationAndRotationForServer(FVector& OutLocation, FRotator& OutRotation) const;

	/** Gets last frame's cached camera location and rotation, possibly modified to assist replication */
	ENGINE_API virtual void GetLastFrameCameraCacheLocationAndRotationForServer(FVector& OutLocation, FRotator& OutRotation) const;
