...
protected:
	...
	/** If true, an asset player instance ID has been successfully set */
	bool bHasValidAssetPlayerInstanceID = false;
	
	/** Instance ID for this asset player node. Used to identify concurrently playing instances of the same animation during notify triggering. */
	uint32 AssetPlayerInstanceID = 0;
