...
struct FAnimationCurveIdentifier
{
	...
	~FAnimationCurveIdentifier() = default;
	FAnimationCurveIdentifier(const FAnimationCurveIdentifier&) = default;
	FAnimationCurveIdentifier(FAnimationCurveIdentifier&&) = default;
	FAnimationCurveIdentifier& operator=(const FAnimationCurveIdentifier&) = default;
	FAnimationCurveIdentifier& operator=(FAnimationCurveIdentifier&&) = default;
