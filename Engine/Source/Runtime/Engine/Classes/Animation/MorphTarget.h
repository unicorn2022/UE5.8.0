...
{
public:
	virtual ~FFinishBuildMorphTargetData() = default;
...
#if !WITH_EDITOR
	/** compressed morph mesh vertex data for each LOD */
	virtual const TArray<FMorphTargetCompressedLODModel>& GetCompressedLODModels() const { return CompressedLODModels; }

	/** compressed morph mesh vertex data for each LOD */
	virtual TArray<FMorphTargetCompressedLODModel>& GetCompressedLODModels() { return CompressedLODModels; }
#endif
