...
private:
	...
	ENGINE_API void UpdateFrameRate_DeprecatedLoad();
#endif
...
protected:
	...
	/** Archive-based key generation — writes key data directly to archive without allocating an intermediate FString. Opt-in via a.AnimSequence.UseBinaryDDCKey. */
	bool CreateDerivedDataKey(const ITargetPlatform* TargetPlatform, FArchive& Output) const;
	...
	mutable UE::FMutex CacheTasksMutex;
...
public:
	...
	friend class FAnimSequenceTransformProviderBuildAsyncCacheTask;
