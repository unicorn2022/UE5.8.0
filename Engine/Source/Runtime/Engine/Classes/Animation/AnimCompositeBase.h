...
protected:
	...
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category=AnimSegment, meta=(DisplayName = "Animation Reference"))
...
public:
	...
	UPROPERTY(BlueprintReadOnly, VisibleAnywhere, Category=AnimSegment, meta=(DisplayName = "Starting Position"))
	float StartPos;

	/** Time to start playing AnimSequence at. */
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category=AnimSegment, meta=(DisplayName = "Start Time"))
	float AnimStartTime;

	/** Time to end playing the AnimSequence at. */
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category=AnimSegment, meta=(DisplayName = "End Time"))
	float AnimEndTime;

	/** Playback speed of this animation. If you'd like to reverse, set -1*/
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category=AnimSegment, meta=(DisplayName = "Play Rate"))
	float AnimPlayRate;

	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category=AnimSegment, meta=(DisplayName = "Loop Count"))
	int32 LoopingCount;
...
struct FAnimTrack
{
	...
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category=AnimTrack, EditFixedSize)
