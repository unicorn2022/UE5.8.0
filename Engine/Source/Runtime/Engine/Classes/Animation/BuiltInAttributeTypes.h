...
namespace UE
{
	namespace Anim
	{
		...
		/** Non blendable types*/
		template<>
		struct TAttributeTypeTraits<FNonBlendableQuaternionAnimationAttribute> : public TAttributeTypeTraits<FQuaternionAnimationAttribute>
		{
			enum
			{
				IsBlendable = false,
		...
		/** Non blendable types*/
		template<>
		struct TAttributeTypeTraits<FNonBlendableVectorAnimationAttribute> : public TAttributeTypeTraits<FVectorAnimationAttribute>
		{
			enum
			{
				IsBlendable = false,
		...
		/** Non blendable types*/
		template<>
		struct TAttributeTypeTraits<FNonBlendableTransformAnimationAttribute> : public TAttributeTypeTraits<FTransformAnimationAttribute>
		{
			enum
			{
				IsBlendable = false,
		...
		template<>
		struct TAttributeTypeTraits<FNonBlendableFloatAnimationAttribute> : public TAttributeTypeTraits<FFloatAnimationAttribute>
		{
			enum
			{
				IsBlendable = false,
		...
		template<>
		struct TAttributeTypeTraits<FNonBlendableIntegerAnimationAttribute> : public TAttributeTypeTraits<FIntegerAnimationAttribute>
		{
			enum
			{
				IsBlendable = false,
