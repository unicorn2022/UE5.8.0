...
void ULocalLightComponent::BuildSceneProxyDesc(const ULocalLightComponent& InLightComponent, FLocalLightSceneProxyDesc& OutProxyDesc)
{
	ULightComponent::BuildSceneProxyDesc(InLightComponent, OutProxyDesc);

	OutProxyDesc.MaxDrawDistance = InLightComponent.MaxDrawDistance;
	OutProxyDesc.MaxDistanceFadeRange = InLightComponent.MaxDistanceFadeRange;
	OutProxyDesc.InverseExposureBlend = InLightComponent.InverseExposureBlend;
	OutProxyDesc.AttenuationRadius = InLightComponent.AttenuationRadius;
}