...
DEFINE_LOG_CATEGORY(LogSkyAtmosphereComponent)
...
void USkyAtmosphereComponent::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
	...
	if (CategoryName == FName("Planet") ||
		CategoryName == FName("Atmosphere") ||
		CategoryName == FName("Atmosphere - Rayleigh") ||
		CategoryName == FName("Atmosphere - Mie") ||
		CategoryName == FName("Atmosphere - Absorption") ||
		CategoryName == FName("Art direction"))
	{
