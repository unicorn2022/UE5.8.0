...
ESlateGesture UKismetInputLibrary::PointerEvent_GetGestureType(const FPointerEvent& Input)
{
	...
	static_assert( (int32)EGestureEvent::Pan == (int32)ESlateGesture::Pan, "EGestureEvent == ESlateGesture" );
	static_assert( (int32)EGestureEvent::Tap == (int32)ESlateGesture::Tap, "EGestureEvent == ESlateGesture" );
	static_assert( (int32)EGestureEvent::Flick == (int32)ESlateGesture::Flick, "EGestureEvent == ESlateGesture" );
	...
	case EGestureEvent::Pan:
		return ESlateGesture::Pan;
	case EGestureEvent::Tap:
		return ESlateGesture::Tap;
	case EGestureEvent::Flick:
		return ESlateGesture::Flick;
