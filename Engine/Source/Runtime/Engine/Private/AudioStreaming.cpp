...
void FAsyncStreamDerivedChunkWorker::DoWork()
{
	...
	UE_LOGF(LogAudio, Verbose, "Start of ASync DDC Chunk read for key: %ls", *DerivedDataKey);
	...
	UE_LOGF(LogAudio, Verbose, "End of Async DDC Chunk Load. DDC Key: %ls", *DerivedDataKey);
}
