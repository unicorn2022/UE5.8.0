...
IMPLEMENT_CUSTOM_SIMPLE_AUTOMATION_TEST(
	FLoadingTests_IsReadyForAsyncPostLoad_FullFlush,
	FLoadingTests_ZenLoaderOnly_Base,
	TEXT("System.Engine.Loading.IsReadyForAsyncPostLoad.FullFlush"),
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter
)
bool FLoadingTests_IsReadyForAsyncPostLoad_FullFlush::RunTest(const FString& Parameters)
{
	FLoadingTestsScope LoadingTestScope(this);
