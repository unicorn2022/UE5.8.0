...
bool FMaterialSourceTemplate::Preload(EShaderPlatform ShaderPlatform)
{
	...
	{
		UE_LOGF(LogMaterial, Error, "Error in MaterialTemplate.ush source template at line %d offset %d: %ls", ErrorInfo.Line, ErrorInfo.Offset, ErrorInfo.Message.GetData());
		return false;
	}
