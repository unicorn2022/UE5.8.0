...
#include "Materials/MaterialIRPreshader.h"
...
struct FMaterialIRValueAnalyzer
{
	...
	void Setup(UMaterialInterface* InMaterialInterface, FMaterialIRModule* InModule, FMaterialIRPreshader* InPreshader, FMaterialInsights* InInsights = nullptr);
	...
	// Preshader intermediate representation
	...
	TMap<UE::Shader::FValue, uint32> UniformPrimitiveDefaultValueOffsets{};
