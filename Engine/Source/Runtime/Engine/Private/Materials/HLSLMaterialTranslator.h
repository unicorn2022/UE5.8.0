...
{
public:
	virtual ~IMaterialExpressionVisitor() = default;
...
// Specify which shader frequency an entry appears in
using FShaderFrequencyMask = uint64;
...
protected:
	...
	struct FUniformExpressionInPreshader
	{
		TRefCountPtr<FMaterialUniformExpression> UniformExpression;
		EMaterialValueType CodeChunkMaterialValueType = (EMaterialValueType)0;
	};
	...
	TArray<FUniformExpressionInPreshader> UniformExpressionShaderFrequencies;

	TMap<UE::Shader::FValue, uint32> DefaultUniformValues;
	uint32 UniformPreshaderOffset = 0u;
	uint32 UniformPreshaderOffsetVS = 0u;
	...
	/** Substrate data for a Translator*/
...
protected:
	...
	const TCHAR* GetCurrentMaterialUniformBufferName() const;
	...
	*/	
	...
	virtual int32 VectorComponent(int32 Vector, int32 Component) override;
	virtual int32 BitfieldExtract(int32 Value, int32 BitOffset, int32 BitCount) override;
	...
	virtual int32 ProcessPhysicsField(int32 PositionArg, EPositionOrigin PositionOrigin, const int32 OutputType, const int32 TargetIndex, const bool bSampleField) override;
	...
	*/
	...
	void GenerateUniformExpressionMacro(FStringBuilderBase& FormattedCode, const FShaderCodeChunk&	CodeChunk);
	FString GenerateUniformExpressionMacroDefinitions();
