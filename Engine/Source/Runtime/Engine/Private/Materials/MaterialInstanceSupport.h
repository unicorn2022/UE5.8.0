...
public:
	...
	FMICReentranceGuard(const UMaterialInstance* InMaterial)
	{
		if (!IsInParallelGameThread())
		{
			...
			{
				UE_LOGF(LogMaterial, Warning, "InMaterial: %ls GameThread: %d RenderThread: %d", *InMaterial->GetFullName(), IsInGameThread(), IsInRenderingThread());
...
*/
class FMaterialInstanceRenderProxy: public FMaterialRenderProxy
{
public:
	/** Initialization constructor. */
	FMaterialInstanceRenderProxy(UMaterialInstance* InOwner);
...
template <> FORCEINLINE THashedMaterialParameterMap<bool>& FMaterialInstanceRenderProxy::GetValueArray() { return StaticSwitchParameterArray; }
template <> FORCEINLINE THashedMaterialParameterMap<float>& FMaterialInstanceRenderProxy::GetValueArray() { return ScalarParameterArray; }
template <> FORCEINLINE THashedMaterialParameterMap<FLinearColor>& FMaterialInstanceRenderProxy::GetValueArray() { return VectorParameterArray; }
template <> FORCEINLINE THashedMaterialParameterMap<FVector4d>& FMaterialInstanceRenderProxy::GetValueArray() { return DoubleVectorParameterArray; }
template <> FORCEINLINE THashedMaterialParameterMap<const UTexture*>& FMaterialInstanceRenderProxy::GetValueArray() { return TextureParameterArray; }
template <> FORCEINLINE THashedMaterialParameterMap<const UTextureCollection*>& FMaterialInstanceRenderProxy::GetValueArray() { return TextureCollectionParameterArray; }
template <> FORCEINLINE THashedMaterialParameterMap<const URuntimeVirtualTexture*>& FMaterialInstanceRenderProxy::GetValueArray() { return RuntimeVirtualTextureParameterArray; }
template <> FORCEINLINE THashedMaterialParameterMap<const USparseVolumeTexture*>& FMaterialInstanceRenderProxy::GetValueArray() { return SparseVolumeTextureParameterArray; }
template <> FORCEINLINE THashedMaterialParameterMap<const UMaterialParameterCollection*>& FMaterialInstanceRenderProxy::GetValueArray() { return ParameterCollectionParameterArray; }
template <> FORCEINLINE const THashedMaterialParameterMap<bool>& FMaterialInstanceRenderProxy::GetValueArray() const { return StaticSwitchParameterArray; }
template <> FORCEINLINE const THashedMaterialParameterMap<float>& FMaterialInstanceRenderProxy::GetValueArray() const { return ScalarParameterArray; }
template <> FORCEINLINE const THashedMaterialParameterMap<FLinearColor>& FMaterialInstanceRenderProxy::GetValueArray() const { return VectorParameterArray; }
template <> FORCEINLINE const THashedMaterialParameterMap<FVector4d>& FMaterialInstanceRenderProxy::GetValueArray() const { return DoubleVectorParameterArray; }
template <> FORCEINLINE const THashedMaterialParameterMap<const UTexture*>& FMaterialInstanceRenderProxy::GetValueArray() const { return TextureParameterArray; }
template <> FORCEINLINE const THashedMaterialParameterMap<const UTextureCollection*>& FMaterialInstanceRenderProxy::GetValueArray() const { return TextureCollectionParameterArray; }
template <> FORCEINLINE const THashedMaterialParameterMap<const URuntimeVirtualTexture*>& FMaterialInstanceRenderProxy::GetValueArray() const { return RuntimeVirtualTextureParameterArray; }
template <> FORCEINLINE const THashedMaterialParameterMap<const USparseVolumeTexture*>& FMaterialInstanceRenderProxy::GetValueArray() const { return SparseVolumeTextureParameterArray; }
template <> FORCEINLINE const THashedMaterialParameterMap<const UMaterialParameterCollection*>& FMaterialInstanceRenderProxy::GetValueArray() const { return ParameterCollectionParameterArray; }
