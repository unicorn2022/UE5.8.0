...
{
	UE_LOGF(LogLightMap,Log,"Lightmap size on disk");
	UE_LOGF(LogLightMap,Log,"Source (KB),Source is Compressed,Platform Data (KB),Lightmap");
	for (TObjectIterator<ULightMapTexture2D> It; It; ++It)
	{
		ULightMapTexture2D* Lightmap = *It;
		UE_LOGF(LogLightMap,Log,"%f,%d,%f,%ls",
...
FName FLightMapPendingTexture::GetLightmapName(int32 TextureIndex, int32 CoefficientIndex)
{
	...
	do
	{
		...
		{
			PotentialName = FString("HQ_Lightmap") + FString::FromInt(LightmapIndex) + TEXT("_") + FString::FromInt(TextureIndex);
		}
		else
		{
			PotentialName = FString("LQ_Lightmap") + TEXT("_") + FString::FromInt(LightmapIndex) + TEXT("_") + FString::FromInt(TextureIndex);
		}
...
FName FLightMapPendingTexture::GetSkyOcclusionTextureName(int32 TextureIndex)
{
	...
	do
	{
		PotentialName = FString("SkyOcclusion") + FString::FromInt(LightmapIndex) + TEXT("_") + FString::FromInt(TextureIndex);
...
FName FLightMapPendingTexture::GetAOMaterialMaskTextureName(int32 TextureIndex)
{
	...
	do
	{
		PotentialName = FString("AOMaterialMask") + FString::FromInt(LightmapIndex) + TEXT("_") + FString::FromInt(TextureIndex);
...
FName FLightMapPendingTexture::GetShadowTextureName(int32 TextureIndex)
{
	...
	do
	{
		PotentialName = FString("StaticShadow") + FString::FromInt(LightmapIndex) + TEXT("_") + FString::FromInt(TextureIndex);
...
FName FLightMapPendingTexture::GetVirtualTextureName(int32 TextureIndex, int32 CoefficientIndex)
{
	...
	do
	{
		if (CoefficientIndex < NUM_HQ_LIGHTMAP_COEF)
		{
			PotentialName = FString("VirtualTexture") + FString::FromInt(LightmapIndex) + TEXT("_") + FString::FromInt(TextureIndex) + FString("_HQ");
		}
		else
		{
			PotentialName = FString("VirtualTexture") + FString::FromInt(LightmapIndex) + TEXT("_") + FString::FromInt(TextureIndex) + FString("_LQ");
		}
