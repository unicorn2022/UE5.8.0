...
static void DoPostProcessSettingsSanityCheck()
{
...

	{
		...
		RenameMap.Add(TEXT("FilmGrainScale"), TEXT(""));
...
FPostProcessSettings::FPostProcessSettings()
{
	...
	TonemappingMethod = ETonemappingMethod::Filmic;
	...
	bMegaLights = true;
	MegaLightsFrontLayerTranslucency = false;
	...
	VignetteType = EVignetteType::CosineFourthLaw;
	VignetteCenter = FVector2f(0.5f, 0.5f);
	VignetteColor = FLinearColor::Black;
	VignetteSize = FVector2f(1.0f, 1.0f);
	VignetteSoftness = 5.0f;
	Sharpen = 0.0f;
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
	FilmGrainTexelSize_DEPRECATED = 1.0f;
PRAGMA_ENABLE_DEPRECATION_WARNINGS
#endif
	FilmGrainScale = FVector2f{1.0f, 1.0f};
	...
	LumenAmbientOcclusionIntensity = 1.0f;
