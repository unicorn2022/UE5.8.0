...
int32 GLevelStreamingContinuouslyIncrementalGCWhileActorsPendingPurge = 0; // Disabled by default
...
int32 GLevelStreamingLowMemoryActorsPendingPurgeCount = MAX_int32;
...
static FAutoConsoleVariableRef CVarContinuouslyIncrementalGCWhileActorsPendingPurge(
	TEXT("s.ContinuouslyIncrementalGCWhileActorsPendingPurge"),
	GLevelStreamingContinuouslyIncrementalGCWhileActorsPendingPurge,
	TEXT("Whether to repeatedly kick off incremental GC when there are actors (from levels) still waiting to be purged."),
	ECVF_Default
);
...
static FAutoConsoleVariableRef CVarLevelStreamingLowMemoryActorsPendingPurgeCount(
	TEXT("s.LevelStreamingLowMemoryActorsPendingPurgeCount"),
	GLevelStreamingLowMemoryActorsPendingPurgeCount,
	TEXT("When system is in low memory state, if the number of actors from streaming levels to purge meets or exceeds this value, perform a 'soft' GC."),
	ECVF_Default
);
