...
USoundBase* UDialogueWave::GetWaveFromContext(const FDialogueContext& Context) const
{
	...
	{
		UE_LOGF(LogAudio, Warning, "UDialogueWave::GetWaveFromContext requires a Context.Speaker (%ls).", *GetPathName());
		return nullptr;
	}
...
{
	static const FString DialogueWaveSuffix = "_DialogueWave";
	static const FString DialogueSuffix = "_Dialogue";
