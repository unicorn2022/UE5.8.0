...
void AStaticMeshActor::PostInitializeComponents()
{
...
void AStaticMeshActor::LoadedFromAnotherClass(const FName& OldClassName)
{
	...
	{
		static FName InterpActor_NAME("InterpActor");
		static FName PhysicsActor_NAME("PhysicsActor");
...
void AStaticMeshActor::PostEditChangeChainProperty(FPropertyChangedChainEvent& PropertyChangedEvent)
{
	...
	if (PropertyChangedEvent.Property != nullptr)
	{
		...
		if (PropertyChangedEvent.Property->GetFName() == FName("bStaticMeshReplicateMovement"))
		{
	...
	static FName SimulatePhysics_NAME("bSimulatePhysics");
