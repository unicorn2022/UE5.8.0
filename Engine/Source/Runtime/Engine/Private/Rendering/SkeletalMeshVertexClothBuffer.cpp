...
*/
void FSkeletalMeshVertexClothBuffer::Init(const TArrayView<const FMeshToMeshVertData>& InMappingData, const TArrayView<const FClothBufferIndexMapping>& InClothIndexMapping)
{
	// Allocate new data
	AllocateData();
