...
public:
	...
	void RemoveComponentReferences(const IPrimitiveComponent* Component, FRemovedRenderAssetArray& RemovedRenderAssets)
	{ 
...
private:
	...
	FORCEINLINE_DEBUGGABLE void SetAsStatic(FDynamicRenderAssetInstanceManager& DynamicComponentManager, const IPrimitiveComponent* Primitive, bool bIsConcurrent = false);
	FORCEINLINE_DEBUGGABLE void SetAsDynamic(FDynamicRenderAssetInstanceManager& DynamicComponentManager, FStreamingTextureLevelContext& LevelContext, const IPrimitiveComponent* Primitive, bool bIsConcurrent = false);
};
