...
protected:
	...
	void DoAsyncReallocate(FRHICommandListImmediate& RHICmdList, const FContext& Context);
	/** Transform the texture into a virtual texture. The virtual texture. */
	void DoConvertToVirtualWithNewMips(FRHICommandListImmediate& RHICmdList, const FContext& Context);
	...
	bool DoConvertToNonVirtual(FRHICommandListImmediate& RHICmdList, const FContext& Context);
	...
	void DoFinishUpdate(FRHICommandListImmediate& RHICmdList, const FContext& Context);
