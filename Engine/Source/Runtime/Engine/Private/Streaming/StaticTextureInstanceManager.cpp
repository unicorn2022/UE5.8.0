...
EAddComponentResult FStaticRenderAssetInstanceManager::Add(const IPrimitiveComponent* Component, FStreamingTextureLevelContext& LevelContext, float MaxAllowedUIDensity)
{
	if (!AsyncView)
	{
		FRenderAssetInstanceState* State = StateSync.SyncAndGetState();
...
void FStaticRenderAssetInstanceManager::Remove(const IPrimitiveComponent* Component, FRemovedRenderAssetArray* RemovedRenderAssets)
{
	FRenderAssetInstanceState* State = StateSync.SyncAndGetState();
