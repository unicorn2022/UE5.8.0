...
namespace FObjectEditorUtils
{
	...
	{
		static const FName CategoryKey("Category");
	...
	bool IsFunctionHiddenFromClass( const UFunction* InFunction,const UClass* Class )
	{
		...
		if( InFunction )
		{
			...
			static const FName FunctionCategory("Category"); // FBlueprintMetadata::MD_FunctionCategory
	...
	{
		static const FName DevelopmentStatusKey("DevelopmentStatus");
		static const FString EarlyAccessValue("EarlyAccess");
		static const FString ExperimentalValue("Experimental");
