...
static FName InvisibleWall_NAME("InvisibleWall");
...
static FName InvisibleWallDynamic_NAME("InvisibleWallDynamic");
...
void ABlockingVolume::LoadedFromAnotherClass(const FName& OldClassName)
{
	...
	{
		static FName DynamicBlockingVolume_NAME("DynamicBlockingVolume");
...
void ABlockingVolume::PostEditChangeChainProperty(FPropertyChangedChainEvent& PropertyChangedEvent)
{
	...
	static FName Mobility_NAME("Mobility");
