...
void UCameraShakeSourceComponent::Start()
{
	...
	{
		UE_LOGF(LogCameraShakeSourceComponent, Error, "%ls: No camera shake was specified on this source. Me = %ls, Owner = %ls", ANSI_TO_TCHAR(__FUNCTION__), *this->GetFullName(), *GetOwner()->GetFullName());
	}
}
