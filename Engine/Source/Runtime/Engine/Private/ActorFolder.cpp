...
{
	static const FName NAME_FolderGuid("FolderGuid");
	static const FName NAME_ParentFolderGuid("ParentFolderGuid");
	static const FName NAME_FolderLabel("FolderLabel");
	static const FName NAME_FolderInitiallyExpanded("FolderInitiallyExpanded");
	static const FName NAME_FolderIsDeleted("FolderIsDeleted");
	static const FName NAME_OuterPackageName("OuterPackageName");
};
