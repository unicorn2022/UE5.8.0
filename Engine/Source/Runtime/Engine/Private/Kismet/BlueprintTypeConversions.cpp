...
#define DEFINE_CONVERSION_FUNCTIONS(BASETYPE, DOUBLEVARIANT, FLOATVARIANT)									\
	...
	UE::Kismet::BlueprintTypeConversions::Internal::FStructConversionEntry BASETYPE##Entry(					\
		...
		TEXT(UE_STRINGIZE(MAKE_CONVERSION_FUNCTION_NAME(DOUBLEVARIANT, FLOATVARIANT))),						\
		TEXT(UE_STRINGIZE(MAKE_CONVERSION_FUNCTION_NAME(FLOATVARIANT, DOUBLEVARIANT))),						\
...
UE::Kismet::BlueprintTypeConversions::Internal::FStructConversionEntry FBox2DEntry(
	...
	TEXT(UE_STRINGIZE(MAKE_CONVERSION_FUNCTION_NAME(FBox2d, FBox2f))),
	TEXT(UE_STRINGIZE(MAKE_CONVERSION_FUNCTION_NAME(FBox2f, FBox2d))),
...
UE::Kismet::BlueprintTypeConversions::Internal::FStructConversionEntry FVector2DEntry(
	...
	TEXT(UE_STRINGIZE(MAKE_CONVERSION_FUNCTION_NAME(FVector2d, FVector2f))),
	TEXT(UE_STRINGIZE(MAKE_CONVERSION_FUNCTION_NAME(FVector2f, FVector2d))),
