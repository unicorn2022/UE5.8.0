...
FRelativeViewMatrices FRelativeViewMatrices::Create(const FViewMatrices& Matrices, const FViewMatrices& PrevMatrices)
{
	...
	Initializer.ViewToWorld = Matrices.GetViewToWorld();
	Initializer.WorldToView = Matrices.GetWorldToView();
	Initializer.ViewToClip = Matrices.GetViewToClip();
	Initializer.ClipToView = Matrices.GetClipToView();
	Initializer.PrevViewToWorld = PrevMatrices.GetViewToWorld();
	Initializer.PrevClipToView = PrevMatrices.GetClipToView();
