...
void UVirtualTextureBuilder::Serialize(FArchive& Ar)
{
	...
	if (Ar.IsCooking() && Ar.IsSaving())
	{
		...
		// Clear Texture during cook for target platforms that don't support virtual texturing.
		if (!UseVirtualTexturing(Ar.CookingTarget()))
		{
			Texture = nullptr;
