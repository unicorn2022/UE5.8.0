...
public:
	...
	virtual TOptional<bool> RequiresEmptyPackageBeforePopulate(const UPackage* Package) override;
	...
	virtual TOptional<bool> SkipSaveGeneratorPackage(const UPackage* OwnerPackage) override;
