...
void FStreamingGenerationProxyErrorHandler::OnRejectedActorDescViewMutator(const IWorldPartitionActorDescInstanceView& ActorDescView, const FActorDescViewMutator& RejectedOverrides, EActorDescViewMutatorRejectedReason Reason)
{
	InnerErrorHandler->OnRejectedActorDescViewMutator(ActorDescView, RejectedOverrides, Reason);
}
#endif
