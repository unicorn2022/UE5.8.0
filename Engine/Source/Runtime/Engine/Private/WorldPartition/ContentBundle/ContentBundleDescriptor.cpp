...
{
	UE_CLOGF(!InContentBundleID.IsValid(), LogContentBundle, Log, "Called UContentBundleDescriptor::GetContentBundleCompactString with an invalid Content Bundle guid.")
