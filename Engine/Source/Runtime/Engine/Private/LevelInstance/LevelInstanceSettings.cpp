...
#if WITH_EDITOR
bool ULevelInstanceSettings::IsLevelInstancePropertyOverrideSettingEnabled() const
{
	return GetDefault<UEditorExperimentalSettings>()->bEnableLevelInstancePropertyOverrides;
}

bool ULevelInstanceSettings::IsPropertyOverridePolicyDefined() const
{
...
{
	return IsLevelInstancePropertyOverrideSettingEnabled() && IsPropertyOverridePolicyDefined();
}
