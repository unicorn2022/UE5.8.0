...
private:
	...
	{
	public:
		virtual ~FPropertyOverridePolicy() = default;
	...
	// Central GC-protection store for all UObject hard refs serialized during the editing session.
	// Populated by FWorldPartitionPropertyOverrideArchive and released in Unload().
	UPROPERTY(Transient)
