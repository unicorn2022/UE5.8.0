...
void UEdGraphNode::PostLoad()
{
	...
	{
		UE_LOGF(LogBlueprint, Warning, "Node '%ls' missing NodeGuid, this can cause deterministic cooking issues please resave package.", *GetPathName());
	...
	{
		UE_LOGF(LogBlueprint, Warning, "Node '%ls' missing NodeGuid because of upgrade from old package version, this can cause deterministic cooking issues please resave package.", *GetPathName());
