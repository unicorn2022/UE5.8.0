...
UPhysicsSettings::UPhysicsSettings(const FObjectInitializer& ObjectInitializer)
	...
	, bPartialIslandSleep(false)
	, MomentumPropagation(0.3f)
	, PostStepWakeThreshold(20.0f)
	, MinimumMotionless(0.1f)
	, LinearWakeThresholdMultiplier(10.0f)
	, AngularWakeThresholdMultiplier(10.0f)
{
}
...
void UPhysicsSettings::LoadSurfaceType()
{
	...
	const FString KeyName = "DisplayName";
	const FString HiddenMeta = "Hidden";
	const FString UnusedDisplayName = "Unused";
