...
void UChaosEventRelay::DispatchPhysicsTrailingEvents(const TArray<FChaosTrailingEvent>& TrailingEvents)
{
	if (OnTrailingEvent.IsBound())
	{
		OnTrailingEvent.Broadcast(TrailingEvents);
	}
}
