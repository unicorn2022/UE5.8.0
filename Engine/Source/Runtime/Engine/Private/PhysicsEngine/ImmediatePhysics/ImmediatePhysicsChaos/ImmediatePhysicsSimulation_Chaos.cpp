...
namespace ImmediatePhysics_Chaos
{
		...
		Chaos::FCollisionDetectorSettings* CollisionDetectorSettings)
	{
		...
		UE_LOGF(LogChaosJoint, Verbose, "Simulate Dt = %f Steps %d x %f (Rewind %f)", DeltaTime, NumSteps, StepTime, RewindTime);
	...
	const Chaos::FPBDCollisionSolverSettings& FSimulation::GetCollisionSolverSettings() const
	{
		return Implementation->Collisions.GetSolverSettings();
	}
