...
public:
	...
	virtual bool Tick() override
	{
		...
		if (FCsvProfiler* CSVProfiler = FCsvProfiler::Get())
		{
			...
			{
				static FName GTUsageStat("Budget/GT");
				static FName GTCNCUsageStat("Budget/GTCNC");
				static FName RTUsageStat("Budget/RT");
				static FName AdjustedUsageStat("Budget/Adjusted");
