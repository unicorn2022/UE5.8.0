...
void ASpotLight::LoadedFromAnotherClass(const FName& OldClassName)
{
	...
	{
		static FName SpotLightStatic_NAME("SpotLightStatic");
		static FName SpotLightMovable_NAME("SpotLightMovable");
		static FName SpotLightStationary_NAME("SpotLightStationary");
