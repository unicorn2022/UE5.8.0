...
namespace UE
{
	namespace Anim
	{
		...
		struct Attributes
		{
			...
			/** Add any new or accumulate with existing custom attributes with optional per attribute weight overrides */
			static ENGINE_API void AccumulateAttributesWithOverrideWeights(const FStackAttributeContainer& SourceAttributes, FStackAttributeContainer& OutAttributes, const TMap<FAttributeId, float>& AttributeWeightOverrides, float Weight, EAdditiveAnimationType AdditiveType);
