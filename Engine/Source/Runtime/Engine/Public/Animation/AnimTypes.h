...
public:
	...
	virtual ~FAnimNotifyEvent() = default;
...
struct FMarkerSyncData
{
	...
	UE_DEPRECATED(5.8, "Use flavor of CollectMarkersInRange() that takes in an UMirrorDataTable")
	...
	void CollectMarkersInRange(float PrevPosition, float NewPosition, TArray<FPassedMarker>& OutMarkersPassedThisTick, float TotalDeltaMove, const UMirrorDataTable* MirrorDataTable);
};
