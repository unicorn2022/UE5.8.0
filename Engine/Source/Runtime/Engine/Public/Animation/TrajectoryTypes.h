...
public:
	...
	ENGINE_API static void DebugDrawTrajectory(const FTransformTrajectory& Trajectory, const UObject* Owner, const FLogCategoryBase& Category, ELogVerbosity::Type Verbosity, const float DebugThickness = 0.f, float HeightOffset = 0.f, bool bDisplayVelocity = false);
#endif
};
