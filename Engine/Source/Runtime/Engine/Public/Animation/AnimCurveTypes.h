...
public:
	PRAGMA_DISABLE_DEPRECATION_WARNINGS	// Constructors implicitly initialization deprecated FSmartName
	FAnimCurveBase() 
		: CurveTypeFlags(0)
	{
#if WITH_EDITORONLY_DATA
	...
	PRAGMA_ENABLE_DEPRECATION_WARNINGS // FSmartName deprecation
...
struct FRawCurveTracks
{
	...
	*/
	...
	/**
	 * Add new curve from the provided name and return true if success
