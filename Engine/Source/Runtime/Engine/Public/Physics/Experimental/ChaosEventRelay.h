...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FTrailingEventSignature, const TArray<FChaosTrailingEvent>&, TrailingEvents);
...
public:
	...
	ENGINE_API void DispatchPhysicsTrailingEvents(const TArray<FChaosTrailingEvent>& TrailingEvents);
	...
	UPROPERTY(BlueprintAssignable, Category = "Physics Events")
	FTrailingEventSignature OnTrailingEvent;
};
