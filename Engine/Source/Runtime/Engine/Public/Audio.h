...
public:
	...
	struct FDebugInfo
	{
		...
		/** Max relative render cost already logged for this sound 
		(used to limit log spam from RelativeRenderCostLogThresholdCVar) */
		float MaxLoggedRelativeRenderCost = 0.f;
