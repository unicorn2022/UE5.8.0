...
{
	virtual void Errorf(const FString& Format) = 0;

	virtual FMaterialShadingModelField GetMaterialShadingModels() = 0;
	...
	virtual int32 SubstrateThicknessStackPush(class UMaterialExpression* Expression, FScalarMaterialInput* Input) = 0;
	virtual int32 SubstrateThicknessStackPush(class UMaterialExpression* Expression, FExpressionInput* Input) = 0;
	...
	virtual FSubstrateThicknessExpression* SubstrateThicknessStackGetExpression(int32 Index) = 0;
	...
	virtual FSubstrateOperator& SubstrateCompilationRegisterOperator(int32 OperatorType, FGuid SubstrateExpressionGuid, FGuid ChildMaterialExpressionGuid, class UMaterialExpression* Parent, FGuid SubstrateParentExpressionGuid, bool bUseParameterBlending = false) = 0;
	virtual FSubstrateOperator& SubstrateGetDefaultBSDFOperator(FGuid MaterialExpressionGuid, class UMaterialExpression* Parent) = 0;
	...
	virtual class FMaterialCompiler* GetCompilerLegacy() = 0;
	virtual class MIR::FEmitter* GetCompilerNew() = 0;

	virtual void PushFunction(class FMaterialFunctionCompileState* FunctionState) = 0;
...
{
public:
	virtual ~FMaterialCompiler() = default;
	...
	virtual int32 VectorComponent(int32 Vector, int32 Component) = 0;
	virtual int32 BitfieldExtract(int32 Value, int32 BitOffset, int32 BitCount) = 0;
	...
	virtual int32 ProcessPhysicsField(int32 PositionArg, EPositionOrigin PositionOrigin, const int32 OutputType, const int32 TargetIndex, const bool bSampleField) = 0;
	...
	virtual int32 MainDirectionalLightIlluminance() = 0;
	virtual int32 MainDirectionalLightDirection() = 0;
	...
	virtual int32 SubstrateToonBSDF(
		int32 ToonProfileId,
		...
		const FString& SharedLocalBasisIndexMacro, FSubstrateOperator* PromoteToOperator) = 0;
	...
	virtual struct FSubstrateTranslatorDataInterface& GetSubstrateTranslatorData() = 0;
...
public:
	...
	virtual int32 VectorComponent(int32 Vector, int32 Component) override { return Compiler->VectorComponent(Vector, Component); }
	virtual int32 BitfieldExtract(int32 Value, int32 BitOffset, int32 BitCount) override { return Compiler->BitfieldExtract(Value, BitOffset, BitCount); }
	...
	virtual int32 ProcessPhysicsField(int32 PositionArg, EPositionOrigin PositionOrigin, const int32 OutputType, const int32 TargetIndex, const bool bSampleField)  override { return Compiler->ProcessPhysicsField(PositionArg, PositionOrigin, OutputType, TargetIndex, bSampleField); }
	...
	virtual int32 MainDirectionalLightIlluminance() override
	{
		return Compiler->MainDirectionalLightIlluminance();
	}

	virtual int32 MainDirectionalLightDirection() override
	{
	...
	virtual int32 SubstrateToonBSDF(
		...
		int32 PatternUVs,
		int32 Anisotropy, int32 Tangent,
		const FString& SharedLocalBasisIndexMacro, FSubstrateOperator* PromoteToOperator) override
	{
		return Compiler->SubstrateToonBSDF(
			ToonProfileId,
			BaseColor, Metallic, Specular, Roughness,
			EmissiveColor, Normal,
			PatternUVs,
			Anisotropy, Tangent,
			SharedLocalBasisIndexMacro, PromoteToOperator);
	}
	...
	virtual struct FSubstrateTranslatorDataInterface& GetSubstrateTranslatorData() override
	{
		return Compiler->GetSubstrateTranslatorData();
	}
