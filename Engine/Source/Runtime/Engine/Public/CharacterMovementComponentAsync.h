...
{
	virtual ~FCharacterAsyncOutput() = default;
...
struct FCharacterMovementComponentAsyncOutput : public Chaos::FSimCallbackOutput
{
	...
	virtual ~FCharacterMovementComponentAsyncOutput() = default;
...
{
	// TODO: Convert this to use new FMovementBaseInterfaceData struct
...
{
	virtual ~FCharacterAsyncInput() = default;
...
{
	virtual ~FUpdatedComponentAsyncInput() = default;
...
struct FCharacterMovementComponentAsyncInput : public Chaos::FSimCallbackInput
{
	...
	virtual ~FCharacterMovementComponentAsyncInput() = default;
