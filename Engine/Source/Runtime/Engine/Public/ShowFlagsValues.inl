...
/** Needed for VMI_VisualizeMegaLights, Whether to enable the MegaLights visualization mode. */
SHOWFLAG_ALWAYS_ACCESSIBLE(VisualizeMegaLights, SFG_Hidden, NSLOCTEXT("UnrealEd", "VisualizeMegaLightsSF", "MegaLights Visualization"))
...
/** Whether to show the color grading visualization displays. */
SHOWFLAG_ALWAYS_ACCESSIBLE(VisualizeColorGrading, SFG_Visualize, NSLOCTEXT("UnrealEd", "VisualizeColorGrading", "Visualize Color Grading"))
...
/** Draws mode specific gizmos and controls in the viewports (should only be set on viewport clients that are editing the level itself) */
SHOWFLAG_FIXED_IN_SHIPPING(0, ModeWidgets, SFG_Advanced, NSLOCTEXT("UnrealEd", "ModeWidgetsSF", "Mode Gizmos"))
/**  */
...
/** Disable the (main) deferred sky atmosphere render pass while preserving atmospheric lighting. */
SHOWFLAG_ALWAYS_ACCESSIBLE(DeferredAtmospherePass, SFG_Advanced, NSLOCTEXT("UnrealEd", "DeferredAtmospherePassSF", "Deferred Atmosphere Pass"))
...
/** Visualize streaming texture deficit (WantedMips - ResidentMips) */
SHOWFLAG_FIXED_IN_SHIPPING(0, StreamingTextureDeficit, SFG_Hidden, NSLOCTEXT("UnrealEd", "StreamingTextureDeficit", "Streaming Texture Deficit"))
/** Visualize streaming texture residency (MaxLODs - ResidentMips) */
SHOWFLAG_FIXED_IN_SHIPPING(0, StreamingTextureResidency, SFG_Hidden, NSLOCTEXT("UnrealEd", "StreamingTextureResidency", "Streaming Texture Residency"))
/** Visualize streaming mesh LOD deficit (WantedMips - ResidentMips) */
SHOWFLAG_FIXED_IN_SHIPPING(0, StreamingMeshLODDeficit, SFG_Hidden, NSLOCTEXT("UnrealEd", "StreamingMeshLODDeficit", "Streaming Mesh LOD Deficit"))
/** Visualize streaming mesh LOD residency (MaxLODs - ResidentLODs) */
SHOWFLAG_FIXED_IN_SHIPPING(0, StreamingMeshLODResidency, SFG_Hidden, NSLOCTEXT("UnrealEd", "StreamingMeshLODResidency", "Streaming Mesh LOD Residency"))
...
SHOWFLAG_FIXED_IN_SHIPPING(0, MaterialCacheVirtualTextureAllocator, SFG_Hidden, NSLOCTEXT("UnrealEd", "MaterialCacheVirtualTextureAllocator", "Material Cache Virtual Texture Allocator"))
...
/** Use screen space traces in MegaLights */
SHOWFLAG_ALWAYS_ACCESSIBLE(MegaLightsScreenTraces, SFG_MegaLights, NSLOCTEXT("UnrealEd", "MegaLightsScreenTracesSF", "Screen Traces"))
/** Use world space traces in MegaLights */
SHOWFLAG_ALWAYS_ACCESSIBLE(MegaLightsWorldSpaceTraces, SFG_MegaLights, NSLOCTEXT("UnrealEd", "MegaLightsWorldSpaceTracesSF", "World Space Traces"))
/** Use far field traces in MegaLights */
SHOWFLAG_ALWAYS_ACCESSIBLE(MegaLightsFarFieldTraces, SFG_MegaLights, NSLOCTEXT("UnrealEd", "MegaLightsFarFieldTracesSF", "Far Field Traces"))
/** Use strand hair voxel traces in MegaLights */
SHOWFLAG_ALWAYS_ACCESSIBLE(MegaLightsHairVoxelTraces, SFG_MegaLights, NSLOCTEXT("UnrealEd", "MegaLightsHairVoxelTracesSF", "Hair Voxel Traces"))
