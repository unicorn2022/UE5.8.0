...
public:
	...
	*/
	...
	ENGINE_API virtual uint8 GetStreamingLODWantedDeficit() const override;
#endif

	ENGINE_API virtual FDesiredLODLevel GetDesiredLODLevel_RenderThread(const FSceneView* View) const override;
...
protected:
	...
	uint8 bMobileGPUScene:1;
#if RHI_RAYTRACING
	uint8 bHasRayTracingRepresentation : 1;
