...
public:
	struct ConstructionValues
	{
		...
		ConstructionValues& AllowLumenPrimitiveTrackingInPreviewWorld(const bool bInAllowLumenPrimitiveTrackingInPreviewWorld) { bAllowLumenPrimitiveTrackingInPreviewWorld = bInAllowLumenPrimitiveTrackingInPreviewWorld; return *this; }
