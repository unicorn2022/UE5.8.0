...
public:
	...
	/** 
	 * For methods that draw multiple bones, draws local rotation axes for all when set to true.
	 * For methods that draw a single bone this option has no effect.
	 */
	bool bDrawAllLocalRotationAxes = false;
};
