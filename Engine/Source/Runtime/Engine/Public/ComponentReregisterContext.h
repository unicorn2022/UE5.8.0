...
public:
	...
	*/
	...
	DECLARE_EVENT(FGlobalComponentReregisterContext, FOnGlobalComponentReregisterContextCreated);
	static FOnGlobalComponentReregisterContextCreated& OnGlobalComponentReregisterContextCreated() { return GlobalComponentReregisterContextCreatedEvent; }

	DECLARE_EVENT(FGlobalComponentReregisterContext, FOnGlobalComponentReregisterContextDestroyed);
	static FOnGlobalComponentReregisterContextDestroyed& OnGlobalComponentReregisterContextDestroyed() { return GlobalComponentReregisterContextDestroyedEvent; }
...
private:
	...
	ENGINE_API static FOnGlobalComponentReregisterContextCreated GlobalComponentReregisterContextCreatedEvent;

	/** Static delegate broadcasted when the last active FGlobalComponentReregisterContext is destroyed. */
	ENGINE_API static FOnGlobalComponentReregisterContextDestroyed GlobalComponentReregisterContextDestroyedEvent;
