...
public:
	...
	// This delegate is called just before an audio device is destroyed,
	// allowing listeners to flush any async work that could deadlock during OnAudioDeviceDestroyed.
	DECLARE_TS_MULTICAST_DELEGATE_OneParam(FOnPreAudioDeviceDestroyed, Audio::FDeviceId /* AudioDeviceId*/);
	static ENGINE_API FOnPreAudioDeviceDestroyed OnPreAudioDeviceDestroyed;
