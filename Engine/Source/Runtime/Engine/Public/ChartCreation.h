...
public:
	...
	virtual ~IPerformanceDataConsumer() = default;
};
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
	FPerformanceTrackingChart(const FPerformanceTrackingChart&) = default;
	FPerformanceTrackingChart& operator=(const FPerformanceTrackingChart&) = default;
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UE_DEPRECATED(5.8, "StartTemperatureLevel has been superseded by StartTemperature and/or StartThermalState because it's behavior was poorly defined (on android it was temperature, on ios it was a thermal status enum value).")
	float StartTemperatureLevel;
	UE_DEPRECATED(5.8, "StopTemperatureLevel has been superseded by StopTemperature and/or StopThermalState because it's behavior was poorly defined (on android it was temperature, on ios it was a thermal status enum value).")
	float StopTemperatureLevel;
	float StartTemperature;
	float StopTemperature;
	EDeviceThermalState StartThermalState;
	EDeviceThermalState StopThermalState;
...
public:
	...
	*/
	ENGINE_API void DumpChart(double InWallClockTimeFromStartOfCharting, FString InMapName, FString InDeviceProfileName = FString("Unknown"));
	...
	virtual ~FDumpFPSChartToEndpoint() = default;
