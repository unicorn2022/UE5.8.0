...
public:
	...
	/** Get whether this visualization mode should be enabled on mobile **/
	ENGINE_API bool GetMaterialEnableOnMobile(FName InMaterialName) const;
