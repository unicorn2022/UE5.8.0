...
public:
	...
	uint32 PrimitiveLocalToWorldHash = 0u;
};
...
public:
	...
	auto GetLocalBoundsSetup()		{ return GetSetup<FInstanceAttributeTracker::EFlag::SkinningDataChanged>(Flags.bHasPerInstanceLocalBounds, ForceFullFlags.bHasPerInstanceLocalBounds, InstanceLocalBounds); }
	auto GetSkinningDataSetup()		{ return GetSetup<FInstanceAttributeTracker::EFlag::SkinningDataChanged>(Flags.bHasPerInstanceSkinningData, ForceFullFlags.bHasPerInstanceSkinningData, InstanceSkinningData); }
