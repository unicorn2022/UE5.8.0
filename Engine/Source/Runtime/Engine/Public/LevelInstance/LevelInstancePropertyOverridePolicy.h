...
class ULevelInstancePropertyOverridePolicy : public UWorldPartitionPropertyOverridePolicy
{
	GENERATED_BODY()
public:
	ENGINE_API ULevelInstancePropertyOverridePolicy(FVTableHelper& Helper);
	ULevelInstancePropertyOverridePolicy() = default;
	virtual ~ULevelInstancePropertyOverridePolicy() = default;
