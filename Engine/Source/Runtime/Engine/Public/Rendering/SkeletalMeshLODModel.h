...
public:
	...
	*/
	ENGINE_API void GetVertices(TArray<FSoftSkinVertex>& Vertices, const FSkeletalMeshUnifiedBoneIndices* UnifiedBoneIndices = nullptr) const;
	...
	*/
	ENGINE_API void GetNonClothVertices(TArray<FSoftSkinVertex>& OutVertices, const FSkeletalMeshUnifiedBoneIndices* UnifiedBoneIndices = nullptr) const;
