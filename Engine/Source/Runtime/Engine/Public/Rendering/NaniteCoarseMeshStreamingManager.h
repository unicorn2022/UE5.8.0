...
namespace Nanite
{
class UE_DEPRECATED(5.8, "Coarse Mesh Streaming is deprecated.") FCoarseMeshStreamingManager : public IStreamingManager
{
public:
...
private:
	...
	void RegisterComponent(const IPrimitiveComponent* Primitive, bool bCheckStaticMeshChanged);
	void UnregisterComponent(const IPrimitiveComponent* Primitive);
	void UnregisterComponentInternal(const IPrimitiveComponent* Primitive, UStreamableRenderAsset* RenderAsset);
	...
	TMap<UStreamableRenderAsset*, TSet<const IPrimitiveComponent*>> RequestReleaseComponentsMap;
	TMap<UStreamableRenderAsset*, TSet<const IPrimitiveComponent*>> RegisteredComponentsMap;
	TMap<const IPrimitiveComponent*, UStreamableRenderAsset*> ComponentToRenderAssetLookUpMap;
