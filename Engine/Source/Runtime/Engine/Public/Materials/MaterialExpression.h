...
class UMaterialExpression : public UObject
{
	...
	*/
	...
	/**
	 * Returns specific EMaterialValueType when the result is MaterialAttributes or Substrate Material, MCT_Unknown otherwise
	 */
	EMaterialValueType GetCompositeOutput(int32 OutputIndex);
	...
	UE_DEPRECATED(5.8, "Please use SubstrateGenerateMaterialTopologyTree taking the FSubstrateTranslatorDataInterface parameter.")
	...
	/**
	 * A Substrate material is a tree with FrontMaterial being its root and BSDF being leaves, with operators in the middle.
	 ...
	 */
	ENGINE_API virtual FSubstrateOperator* SubstrateGenerateMaterialTopologyTree(struct FSubstrateTranslatorDataInterface& SubstrateTranslatorData, class UMaterialExpression* Parent, int32 OutputIndex);
