...
class UMaterialExpressionSetMaterialAttributes : public UMaterialExpression
{
	...
	virtual FSubstrateOperator* SubstrateGenerateMaterialTopologyTree(struct FSubstrateTranslatorDataInterface& SubstrateTranslatorData, UMaterialExpression* Parent, int32 OutputIndex) override;
