...
UCLASS(collapsecategories, hidecategories = Object, meta = (DisplayName = "MaterialCache"))
...
private:
#if WITH_EDITOR
	uint32 GetPackedAttributeIndex(EMaterialCacheAttribute Attribute);
	
	/** Attributes in declaration order */
	TArray<EMaterialCacheAttribute> TagAttributes;
