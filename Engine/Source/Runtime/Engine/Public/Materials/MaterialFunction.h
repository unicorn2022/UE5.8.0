...
#if WITH_EDITORONLY_DATA
	UE_DEPRECATED(All, "bPrefixParameterNames has been deprecated.")
	UPROPERTY(meta = (DeprecatedProperty, DeprecationMessage = "bPrefixParameterNames has been deprecated."))
	uint8 bPrefixParameterNames_DEPRECATED:1;

	UE_DEPRECATED(5.8, "Experimental bEnableExecWire is no longer supported.")
	UPROPERTY(meta = (DeprecatedProperty, DeprecationMessage = "Experimental bEnableExecWire is no longer supported."))
	uint8 bEnableExecWire_DEPRECATED : 1;
#endif // WITH_EDITORONLY_DATA

	UPROPERTY(EditAnywhere, Category = MaterialFunction, meta=(DisplayName="Enable new material translator"))
