...
enum class EMaterialAggregateAttributeType
{
	...
	// This is needed because of the way materials and material attributes sadly work. The normal attribute
	// default value is automatically assigned to (0, 0, 1) or VertexNormal depending on whether the material
	// is in tangent or world space normals. If one day this mechanism changes or is removed, remove this entrys 
	// and make Normals simple float3s.
	Normal,
...
// Aggregate APIs specific for the MaterialAttributes data type.
namespace MaterialAttributesAggregate
{

// Returns an array of all the MaterialAttributes properties.
...
// Returns whether specified material Property is enabled in a MaterialAttributes aggregate with given number of custom UVs enabled.
inline bool IsPropertyEnabled(EMaterialProperty Property)
{
