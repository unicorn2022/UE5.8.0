...
UCLASS(collapsecategories, hidecategories=Object, MinimalAPI, meta=(MIR_OnDemandInputRequest))
...
#if WITH_EDITOR
protected:
	ERHIShadingPath::Type GetShadingPathToCompile(EShaderPlatform ShaderPlatform, ERHIFeatureLevel::Type FeatureLevel, EMaterialQualityLevel::Type MaterialQualityLevel);
