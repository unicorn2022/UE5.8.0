...
private:
	...
	/** Allocates CachedData if needed, populates ParentLayerIndexRemap from the parent's layers,
	 *  and pushes the result to the render proxy. Does NOT touch the texture-sampling cache. */
	void UpdateCachedLayerData();
};
