...
public:
	...
	UE_DEPRECATED(5.8, "Use MaterialExpressionUtils::GetSamplerTypeForTexture instead.")
	static ENGINE_API EMaterialSamplerType GetSamplerTypeForTexture(const UTexture* Texture, bool ForceNoVT = false);

	UE_DEPRECATED(5.8, "Use MaterialExpressionUtils::VerifySamplerType instead.")
	static ENGINE_API bool VerifySamplerType(const FString& TexturePathName, EMaterialSamplerType CorrectSamplerType, bool bSRGB, EMaterialSamplerType SamplerType, FString& OutErrorMessage);

	UE_DEPRECATED(5.8, "Use MaterialExpressionUtils::VerifySamplerType instead.")
	static ENGINE_API bool VerifySamplerType(EShaderPlatform ShaderPlatform,const ITargetPlatform* TargetPlatform,const UTexture* Texture,EMaterialSamplerType SamplerType,FString& OutErrorMessage);
#endif // WITH_EDITOR
};
