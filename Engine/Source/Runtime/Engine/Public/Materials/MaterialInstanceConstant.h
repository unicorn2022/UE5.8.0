...
class UMaterialInstanceConstant : public UMaterialInstance
{
	...
	*/
	...
	ENGINE_API void SetDoubleVectorParameterValueEditorOnly(const FMaterialParameterInfo& ParameterInfo, FVector4d Value);
	...
	ENGINE_API void SetParameterCollectionParameterValueEditorOnly(const FMaterialParameterInfo& ParameterInfo, class UMaterialParameterCollection* Value);
