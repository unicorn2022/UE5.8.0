...
class UMaterialExpressionMaterialFunctionCall : public UMaterialExpression
{
	...
	ENGINE_API virtual FSubstrateOperator* SubstrateGenerateMaterialTopologyTree(struct FSubstrateTranslatorDataInterface& SubstrateTranslatorData, class UMaterialExpression* Parent, int32 OutputIndex) override;
