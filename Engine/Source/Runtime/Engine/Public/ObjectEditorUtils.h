...
public:
	...
	UPROPERTY(config)
	FName DevelopmentStatusKey{"Valkyrie_DevelopmentStatus"};
	FString DevelopmentStatusValue_Experimental{"Experimental"};

	UPROPERTY(config)
	FName DeprecationStatusKey{"Valkyrie_DeprecationStatus"};
	FString DeprecationStatusValue_Deprecated{"Deprecated"};
};
