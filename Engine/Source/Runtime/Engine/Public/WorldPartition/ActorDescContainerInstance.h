...
public:
	...
	DECLARE_MULTICAST_DELEGATE_TwoParams(FActorDescInstanceAddedToContainerEvent, UActorDescContainerInstance*, FWorldPartitionActorDescInstance*);
	UE_EXPERIMENTAL(5.8, "This new static delegate is experimental and the API is subject to change.")
	static ENGINE_API FActorDescInstanceAddedToContainerEvent OnActorDescInstanceAddedToContainer;
	
	DECLARE_MULTICAST_DELEGATE_TwoParams(FActorDescInstanceRemovedFromContainerEvent, UActorDescContainerInstance*, FWorldPartitionActorDescInstance*);
	UE_EXPERIMENTAL(5.8, "This new static delegate is experimental and the API is subject to change.")
	static ENGINE_API FActorDescInstanceRemovedFromContainerEvent OnActorDescInstanceRemovedFromContainer;
...
private:
	...
	void OnActorDescPreUpdate(FWorldPartitionActorDesc* InActorDesc);
