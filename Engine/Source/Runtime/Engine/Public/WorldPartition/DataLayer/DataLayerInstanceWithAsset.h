...
public:
	...
	virtual FString GetDataLayerShortName() const override { return DataLayerAsset ? DataLayerAsset->GetName() : GetFName().ToString(); }
	virtual FString GetDataLayerFullName() const override { return DataLayerAsset ? DataLayerAsset->GetPathName() : GetFName().ToString(); }
	//~ End UDataLayerInstance interface
