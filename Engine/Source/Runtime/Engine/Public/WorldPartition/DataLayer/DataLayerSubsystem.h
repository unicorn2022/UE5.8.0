...
public:
	...
	UE_DEPRECATED(all, "Use GetDataLayerInstanceFromAsset instead.")
	UFUNCTION(meta = (DeprecatedFunction, DeprecationMessage = "DataLayerSubsystem is deprecated, use GetDataLayerInstanceFromAsset in DataLayerManager"))
	UDataLayerInstance* GetDataLayerFromLabel(FName InDataLayerLabel) const { return nullptr; }
