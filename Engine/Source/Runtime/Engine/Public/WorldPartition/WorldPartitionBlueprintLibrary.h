...
#if WITH_EDITOR
	ENGINE_API FActorDesc(const FWorldPartitionActorDescInstance& InActorDesc);
#endif
...
public:
	...
	/**
	 * Returns the Data Layer Manager for the current world context.
	 */
	...
	/**
	 * Returns the Data Layer Manager for the provided object.
	 */
	UFUNCTION(BlueprintCallable, Category = "World Partition")
	static UDataLayerManager* GetDataLayerManagerForObject(class UObject* Object);
};
