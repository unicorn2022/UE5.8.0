...
public:
	...
	// Test if HLOD actor descriptors are equals, but without considering properties that may change after the HLOD actor is built.
	ENGINE_API bool EqualsUnbuilt(const FHLODActorDesc& Other) const;
