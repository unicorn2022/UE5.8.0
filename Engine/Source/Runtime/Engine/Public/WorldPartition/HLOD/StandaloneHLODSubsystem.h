...
public:
	...
	ENGINE_API void ForEachStandaloneHLODActorWithLevelInstanceGuid(TFunctionRef<void(AWorldPartitionStandaloneHLOD*, const FGuid& LevelInstanceGuid)> Func) const;
	...
	ENGINE_API bool GetChildHLODActorsContainer(const FActorContainerID& InContainerID, FActorContainerID& OutChildContainerID) const;
...
private:
	...
	TMap<FActorContainerID, FActorContainerID> HLODContainerToChildHLODActorsContainer;
