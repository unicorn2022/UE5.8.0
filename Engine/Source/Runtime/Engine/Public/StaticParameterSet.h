...
struct FStaticParameterBase
{
	...
	void UpdateHash(THasher& HashState) const
	{
...
struct FStaticSwitchParameter : public FStaticParameterBase
{
	...
	void UpdateHash(FXxHash64Builder& HashState) const
	{
...
struct FStaticComponentMaskParameter : public FStaticParameterBase
{
	...
	UE_DEPRECATED(5.8, "Use overload accepting an FXxHash64Builder; SHA1 hashes are no longer used")
