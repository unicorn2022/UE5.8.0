...
private:
	...
	void Build(FAsyncDistanceFieldTask* Task);
...
#if WITH_EDITOR
	/** Finishes a singular async task to completion, but does not delete it */
	void FinalizeAsyncTask(FAsyncDistanceFieldTask* InTask, FObjectCacheContextScope& InObjectCacheScope) const;
#endif
