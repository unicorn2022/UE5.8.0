...
public:
	...
	ENGINE_API TObjectCacheIterator<ISkinnedMeshComponent> GetSkinnedMeshComponents();
	ENGINE_API TObjectCacheIterator<ISkinnedMeshComponent> GetSkinnedMeshComponents(USkinnedAsset* InSkinnedAsset);
...
private:
	...
	TComponentTypeCache<ISkinnedMeshComponent, USkinnedAsset> SkinnedMeshCache;
