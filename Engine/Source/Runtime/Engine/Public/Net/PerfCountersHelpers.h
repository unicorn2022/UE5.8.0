...
#include "CoreMinimal.h"
	...
	/** @brief Helper function for setting a performance counter. Compiled out if PerfCounterModule isn't used.
	*/
	void ENGINE_API PerfCountersSet(const FString& Name, double Val, uint32 Flags = 0);
	...
	*/
	...
	inline float PerfCountersGet(const FString& Name, float DefaultVal) { return DefaultVal; }
	inline double PerfCountersGet(const FString& Name, double DefaultVal) { return DefaultVal; }
	inline int32 PerfCountersGet(const FString& Name, int32 DefaultVal) { return DefaultVal; }
	inline uint32 PerfCountersGet(const FString& Name, uint32 DefaultVal) { return DefaultVal; }
