...
struct FControlChannelOutBunch : public FOutBunch
{
	...
	{
		UE_LOGF(LogNet, Fatal,"Cannot send Names on the control channel");
		SetError();
		return *this;
	}
	FArchive& operator<<(UObject*& Object)
	{
		UE_LOGF(LogNet, Fatal,"Cannot send Objects on the control channel");
		SetError();
		return *this;
	}
};
