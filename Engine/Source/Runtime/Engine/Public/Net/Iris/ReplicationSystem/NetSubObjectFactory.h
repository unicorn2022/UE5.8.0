...
protected:
	...
	// FillRootObjectReplicationParams should not be called for subobjects
	ENGINE_API virtual void FillRootObjectReplicationParams(const UE::Net::FRootObjectReplicationParamsContext& Context, UE::Net::FRootObjectReplicationParams& OutParams) override final;
