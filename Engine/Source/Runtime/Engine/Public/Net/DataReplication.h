...
public:
	...
	/**
	 * Enqueue any pending RPCs meant to be done within an AutoRTFM transaction.
	 * @see UNetDriver::PostTickDispatch
	 */
	ENGINE_API void EnqueuePendingTransactionalRPCs();
...
private:
	 ...
	 * @see EnqueuePendingTransactionalRPCs
	 */
