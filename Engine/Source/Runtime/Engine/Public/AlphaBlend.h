...
namespace UE::Anim
{
	inline constexpr EAlphaBlendOption DefaultBlendOption = EAlphaBlendOption::HermiteCubic;
}
...
struct FAlphaBlendArgs
{
	...
	/** Blend Time */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Blend", meta = (UIMin = "0", ClampMin = "0"))
	float BlendTime;
...
private:
	/** Blend Time */
	UPROPERTY(EditAnywhere, Category = "Blend", meta = (UIMin = "0", ClampMin = "0"))
	float	BlendTime;
