...
public:
	...
	void DetectGestures(TArrayView<const UE::FTouchState> TouchStates, UPlayerInput* PlayerInput, float DeltaTime);
...
protected:
	...
	void HandleGesture(UPlayerInput* PlayerInput, FKey Gesture, bool bStarted, bool bEnded);
