...
#if WITH_EDITOR
	/**
	 * Return whether this actor is displayable in common UI (i.e. SceneOutliner), checks for things like
	 * validity, if it is a BuilderBrush, etc.
	 *
	 * @return true if this actor is displayable in common UI
	 */
	ENGINE_API bool IsActorDisplayable(const AActor* InActor);
#endif // WITH_EDITOR
