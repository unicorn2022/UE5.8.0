...
/** Get the number of tiles needed to represent a surface */
ENGINE_API FIntPoint GetMaterialCacheTileCount(float TriangleArea, float TexelSize, TOptional<FIntPoint> MaxTileCount = {});
