...
#include "VirtualTextureVisualizationData.generated.h"
...
public:
	...
	/** Set the current mode through the console and return the previously set mode. */
	ENGINE_API EVirtualTextureVisualizationMode SetModeUsingConsoleCommand(EVirtualTextureVisualizationMode InMode);
