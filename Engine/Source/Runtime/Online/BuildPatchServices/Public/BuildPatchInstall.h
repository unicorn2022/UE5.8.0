...
namespace BuildPatchServices
{
	...
	enum class EInstallMode : uint32
	{
		...
		// Download chunk data to file only, to be unpacked as a later process. Chunk data will not be decrypted or decompressed.
		Preload,
...
static_assert((uint32)BuildPatchServices::EInstallMode::InvalidOrMax == 5, "Please add support for the extra values to the Lex functions below.");
