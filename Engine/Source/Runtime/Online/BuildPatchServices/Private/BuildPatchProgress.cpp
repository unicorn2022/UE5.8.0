...
namespace BuildPatchServices
{
	...
	*****************************************************************************/
	static_assert((uint32)BuildPatchServices::EBuildPatchState::NUM_PROGRESS_STATES == 13, "Please add support for the extra EBuildPatchState values to bHasProgressValue.");
	const bool FBuildPatchProgress::bHasProgressValue[static_cast<int32>(EBuildPatchState::NUM_PROGRESS_STATES)] =
	{
		...
		true,  // Downloading
		true,  // Installing
		true,  // RunningCustomUninstallAction
	...
	static_assert((uint32)BuildPatchServices::EBuildPatchState::NUM_PROGRESS_STATES == 13, "Please add support for the extra EBuildPatchState values to bCountsTowardsProgress.");
	const bool FBuildPatchProgress::bCountsTowardsProgress[static_cast<int32>(EBuildPatchState::NUM_PROGRESS_STATES)] =
	{
		...
		true,  // Downloading
		true,  // Installing
		false, // RunningCustomUninstallAction
		true,  // MovingToInstall
		true,  // SettingAttributes
		true,  // BuildVerification
		false, // CleanUp
