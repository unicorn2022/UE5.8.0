...
namespace BuildPatchServices
{
	...
	struct FScannerFileElement
	{
		FBlockRange FileScannerRange;
		FFilenameId ScanFilename;
		TSet<FString> ScanTagSet;
		uint64 ScannerFileLocation;
	};
	...
	{
	public:
		static IDataScanner* Create(const TArray<uint32>& ChunkWindowSizes, const TArray<uint8>& Data, const ICloudEnumeration* CloudEnumeration, FStatsCollector* StatsCollector, uint64 DataOffset);
	};
