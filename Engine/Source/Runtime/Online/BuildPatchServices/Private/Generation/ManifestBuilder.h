...
namespace BuildPatchServices
{
	...
	public:
		...
		// The encryption secret key to use for this manifest.
		TArray<uint8> EncryptionSecretKey;
		// The ID of the encryption secret key used by this manifest.
	...
	public:
		...
		virtual bool SaveToFile(const FString& Filename, FSHAHash* OutSHA1Hash, FMD5Hash* OutMD5Hash) = 0;
		virtual FBuildPatchAppManifest& GetManifest() const = 0;
	};
