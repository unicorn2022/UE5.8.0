...
namespace BuildPatchServices
{
	...
	{
	public:
		FChunkDataSizeProvider(const TArray<FBuildPatchAppManifestPtr>& InitialManifests)
		{
			for (const FBuildPatchAppManifestPtr& InitialManifest : InitialManifests)
			{
				AddManifestData(InitialManifest);
			}
		}
	...
	IChunkDataSizeProvider* FChunkDataSizeProviderFactory::Create(const TArray<FBuildPatchAppManifestPtr>& InitialManifests)
	{
		return new FChunkDataSizeProvider(InitialManifests);
	}
}
