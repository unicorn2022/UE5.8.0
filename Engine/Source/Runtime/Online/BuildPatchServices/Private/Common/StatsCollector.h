...
namespace BuildPatchServices
{
	...
	class FStatsScopedCounter
	{
	public:
		FStatsScopedCounter(volatile FStatsCollector::FAtomicValue* InStat)
			: Stat(InStat)
		{
			FStatsCollector::Accumulate(Stat, 1);
		}
		~FStatsScopedCounter()
		{
			FStatsCollector::Accumulate(Stat, -1);
