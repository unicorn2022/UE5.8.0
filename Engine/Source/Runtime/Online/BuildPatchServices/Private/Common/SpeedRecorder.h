...
namespace BuildPatchServices
{
	...
	public:
		virtual ~ISpeedRecorder() = default;
		 ...
		 * @param bIncludeInactiveTime   If True speed will be averaged over the entire Seconds period. Default is to only average over periods of active download within the Seconds period.
		 * @return the average speed over the past given seconds.
		 */
		virtual double GetAverageSpeed(float Seconds, bool bIncludeInactiveTime = false) const = 0;
