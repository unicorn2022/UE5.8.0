...
#define TEST_SIZE(ar, value) \
	_TEST_EQUAL(TEXT("size check"), ar.Num(), value)

#define TEST_EMPTY(ar) TEST_SIZE(ar, 0)

#define TEST_CONTAINS(expression, value) \
	_TEST_EQUAL(TEXT("contains check"), expression.Contains(value), true)
