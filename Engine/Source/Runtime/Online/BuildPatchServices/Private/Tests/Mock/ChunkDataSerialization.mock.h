...
namespace BuildPatchServices
{
	...
	public:
		...
		virtual bool DecompressAndDecryptValidatedRead(const FChunkHeader& InHeader, FMutableMemoryView InDestionationBuffer, const FUniqueBuffer& InCompressedBuffer) const
		{
			return false;
		}
