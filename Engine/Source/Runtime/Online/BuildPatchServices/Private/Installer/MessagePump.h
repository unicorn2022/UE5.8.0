...
namespace BuildPatchServices
{
	...
	public:
		...
		/**
		 * Sends out a request to resolve the uri to the delta file location
		 * @param Request   Request for the delta file location
		 * @param OnResponse   A delegate to call with a response to delta location
		 */
		virtual void SendRequest(FDeltaUriRequest Request, TFunction<void(FExpiratedUrisResponse)> OnResponse) = 0;
