...
namespace BuildPatchServices
{
	...
	{
		// Explicitly add the config file to the cache so that it's not "found" later.
		// "Found" files are loaded in read-only mode ("NoSave" flag is "true"), but we may need to write new prereq IDs to this file.
		GConfig->Add(LocalMachineConfigFile, FConfigFile());
	}
