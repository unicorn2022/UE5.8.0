...
namespace BuildPatchServices
{
	...
	*/
	struct FChunkDbSourceConfig
	{
		...
		// If we are loading from a chunkDB, in reverse order, we can truncate the chunkDB files as we go if desired.
		// This is for preload support.
		bool bTruncateChunkDbs = false;
	...
	{
	public:
		virtual ~IConstructorChunkDbChunkSource() = default;
		...
		virtual void TryTruncateFiles(int32 RemainingChunkCount) =0;
	...
	public:
		virtual ~IChunkDbChunkSourceStat() = default;
