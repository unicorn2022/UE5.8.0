...
namespace BuildPatchServices
{
	...
	*/
	...
	{
	public:
		virtual ~IConstructorInstallChunkSource() = default;
		...
		// is deleted
		virtual void GetChunksForFile(const FString& InstallationDirectory, const FString& FilenameInManifest, TSet<FGuid>& OutChunks) const = 0;
	...
	public:
		virtual ~IInstallChunkSourceStat() = default;
