...
namespace BuildPatchServices
{
	...
	public:
		...
		virtual void RecordMissingDelta(const FString& DeltaUrl, const FString& BaseVersion, const FString& PatchVersion) override {}
	...
	void FInstallerAnalytics::RecordMissingDelta(const FString& DeltaUrl, const FString& BaseVersion, const FString& PatchVersion)
	{
		TArray<FAnalyticsEventAttribute> Attributes;
		Attributes.Add(FAnalyticsEventAttribute(TEXT("DeltaUrl"), DeltaUrl));
		Attributes.Add(FAnalyticsEventAttribute(TEXT("BaseVersion"), BaseVersion));
		Attributes.Add(FAnalyticsEventAttribute(TEXT("PatchVersion"), PatchVersion));
		QueueAnalyticsEvent(TEXT("Patcher.Error.Delta"), MoveTemp(Attributes));
	}
	...
	{
		//static const FName EndpointName = "CDN.Chunk";
	}
