...
namespace BuildPatchServices
{
	...
	public:
		...
		/**
		 * Set whether connection scaling is enabled.
		 * @param bEnableScaling -- Enables download scaling, true to enable.
		 */
		virtual void SetConnectionScaling(bool bEnableScaling) = 0;

		virtual ~IDownloadConnectionCount() = default;
	};
