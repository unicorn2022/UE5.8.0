...
namespace BuildPatchServices
{
	...
	public:
		 ...
		 */
		static IDownloadServiceStatistics* Create(const TSharedPtr<ISpeedRecorder>& SpeedRecorder, const TSharedPtr<IDataSizeProvider>& DataSizeProvider, const TSharedPtr<IInstallerAnalytics>& InstallerAnalytics);
	};
}