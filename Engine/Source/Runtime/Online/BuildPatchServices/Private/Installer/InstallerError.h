...
namespace BuildPatchServices
{
	...
	namespace InitializationErrorCodes
	{
		...
		static const TCHAR* EmptyCloudDirectories = TEXT("08");
		static const TCHAR* VerifyOnlyActionMixedWithOtherActions = TEXT("09");
		static const TCHAR* MissingEncryptionKeyForNonPreload = TEXT("10");
		static const TCHAR* InvalidEncryptionKeyForNonPreload = TEXT("11");
		static const TCHAR* InvalidInstallToMemory = TEXT("11");
		static const TCHAR* InvalidMemoryConstructionConfig = TEXT("12");
	}
	...
	namespace ConstructionErrorCodes
	{
		...
		static const TCHAR* SymlinkCreateFail = TEXT("09");
		static const TCHAR* SymlinkCreateForbidden = TEXT("10");
		static const TCHAR* CloseFileError = TEXT("11");
	}
	...
	namespace VerifyErrorCodes
	{
		...
		static const TCHAR* DeleteCorruptedFileFailed = TEXT("06");
	}
	...
	/**
	 * A list of the error codes we will use for each case of the uninstall action failure.
	 */
	namespace UninstallCustomActionErrorPrefixes
	{
	...
	/**
	 * A list of the error codes we will use for each case of the prerequisites install failure.
	 */
	...
	public:
		virtual ~IInstallerError() = default;
		...
		/**
		 * Resets the current error state without unregistering delegates added by RegisterForErrors.
		 * @param bPreserveCancelled	If true the canceled error state is preserved instead of being reset.
		 */
		virtual void ResetError(bool bPreserveCancelled) = 0;
