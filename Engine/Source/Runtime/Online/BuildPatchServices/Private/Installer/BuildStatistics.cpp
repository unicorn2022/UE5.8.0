...
namespace BuildPatchServices
{
	...
	public:
		...
		virtual int64 GetDownloadedBytes() const override;
		virtual int64 GetDiskReadBytes() const override;
		virtual int64 GetDiskWrittenBytes() const override;
	...
	{
		return Installer->GetDiskReadSpeedRecorder()->GetAverageSpeed(10.0f, true);
	}

	double FBuildStatistics::GetDiskWriteByteSpeed() const
	{
		return Installer->GetDiskWriteSpeedRecorder()->GetAverageSpeed(10.0f, true);
	}

	int64 FBuildStatistics::GetDownloadedBytes() const
	{
		return Installer->GetCloudChunkSourceStatistics()->GetDownloadedBytes();
	}

	int64 FBuildStatistics::GetDiskReadBytes() const
	{
		return Installer->GetInstallChunkSourceStatistics()->GetBytesRead()
		     + Installer->GetVerifierStatistics()->GetBytesVerified();
	}

	int64 FBuildStatistics::GetDiskWrittenBytes() const
	{
		return Installer->GetFileConstructorStatistics()->GetBytesConstructed();
	}
