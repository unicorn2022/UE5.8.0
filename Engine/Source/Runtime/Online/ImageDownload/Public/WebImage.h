...
public:
	...
	inline FWebImage& SetStandInBrush(TAttribute<const FSlateBrush*> StandInBrushIn)
	{
		StandInBrush = StandInBrushIn;
		DownloadedBrush.Reset();
		return *this;
	}

	/** Set draw type for the downloaded image brush */
	IMAGEDOWNLOAD_API void SetDownloadedBrushDrawType(ESlateBrushDrawType::Type DrawType);

	/** Set outline settings for the downloaded image brush */
	IMAGEDOWNLOAD_API void SetDownloadedBrushOutlineSettings(FSlateBrushOutlineSettings OutlineSettings);
...
private:
	...
	/** Outline settings for the downloaded image brush */
	FSlateBrushOutlineSettings DownloadedBrushOutlineSettings;

	/** Draw type for the downloaded image brush */
	ESlateBrushDrawType::Type DownloadedBrushDrawType;
