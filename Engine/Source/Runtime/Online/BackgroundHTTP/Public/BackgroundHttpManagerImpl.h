...
public:
	...
	BACKGROUNDHTTP_API virtual void Initialize(bool bClearPreExistingRequestsAtStartup) override;
	...
	BACKGROUNDHTTP_API virtual FString GetTempFileLocationForURL(const FString& URL, const FString& RequestID) override;
	...
	BACKGROUNDHTTP_API virtual void SetLimitedDataPreference(int32 Value) override;
...
protected:
	...
	BACKGROUNDHTTP_API virtual int DeleteAllTemporaryFiles(bool Recursively, const TCHAR* FileExtension);
...
protected:
	...
	mutable FRWLock ActiveRequestLock;
