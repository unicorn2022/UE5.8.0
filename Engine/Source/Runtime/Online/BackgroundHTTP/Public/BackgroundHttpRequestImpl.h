...
enum class EBackgroundHttpRequestCompletionResult
{
	Success,
	GenericError, 
	OutOfDiskSpaceError,
...
public:
	...
	virtual ~FBackgroundHttpRequestImpl() = default;
	...
	BACKGROUNDHTTP_API virtual void RequeueRequest() override;
	...
	BACKGROUNDHTTP_API virtual bool HasSeenOutOfDiskSpaceError() const override { return bHasSeenOutOfDiskSpaceError; }
	
	UE_DEPRECATED(5.8, "FBackgroundHttpRequestImpl::NotifyNotificationObjectOfComplete(bool) is deprecated, please use NotifyNotificationObjectOfComplete(EBackgroundHttpRequestCompletionResult) instead.")
	BACKGROUNDHTTP_API virtual void NotifyNotificationObjectOfComplete(const bool bWasSuccess);
	BACKGROUNDHTTP_API virtual void NotifyNotificationObjectOfComplete(EBackgroundHttpRequestCompletionResult Result);
...
protected:
	...
	bool bHasSeenOutOfDiskSpaceError = false;
