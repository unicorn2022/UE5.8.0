...
{
	UE_LOGF(LogXmpp, Log, "FXmppTest::OnLoginComplete UserJid=%ls Success=%ls Error=%ls",
...
{
	UE_LOGF(LogXmpp, Log, "FXmppTest::OnLogoutComplete UserJid=%ls Success=%ls Error=%ls",
		*UserJid.GetFullPath(), bWasSuccess ? TEXT("true") : TEXT("false"), *Error);
