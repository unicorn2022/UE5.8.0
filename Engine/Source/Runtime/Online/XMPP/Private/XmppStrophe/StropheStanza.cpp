...
void FStropheStanza::AddChild(const FStropheStanza& Child)
{
	...
	{
		UE_LOGF(LogXmpp, Error, "Failed to add child");
	}
}
...
void FStropheStanza::SetNamespace(const FString& Namespace)
{
	...
	{
		UE_LOGF(LogXmpp, Error, "Failed to set namespace to %ls", *Namespace);
	}
}
...
void FStropheStanza::SetAttribute(const FString& Key, const FString& Value)
{
	...
	{
		UE_LOGF(LogXmpp, Error, "Failed to set attribute %ls to %ls", *Key, *Value);
	}
}
...
void FStropheStanza::SetName(const FString& Name)
{
	...
	{
		UE_LOGF(LogXmpp, Error, "Failed to set name to %ls", *Name);
	}
}
...
void FStropheStanza::SetText(const FString& Text)
{
	...
	{
		UE_LOGF(LogXmpp, Error, "Failed to set text to %ls", *Text);
	}
}
...
FString FStropheStanza::GetText() const
{
	...
	{
		UE_LOGF(LogXmpp, Warning, "No text found in stanza");
	}
...
void FStropheStanza::SetType(const FString& Type)
{
	...
	{
		UE_LOGF(LogXmpp, Error, "Failed to set type to %ls", *Type);
	}
}
...
void FStropheStanza::SetId(const FString& Id)
{
	...
	{
		UE_LOGF(LogXmpp, Error, "Failed to set ID to %ls", *Id);
	}
}
...
void FStropheStanza::SetTo(const FString& To)
{
	...
	{
		UE_LOGF(LogXmpp, Error, "Failed to set To value to %ls", *To);
	}
}
...
void FStropheStanza::SetFrom(const FString& From)
{
	...
	{
		UE_LOGF(LogXmpp, Error, "Failed to set From value to %ls", *From);
	}
}
...
bool FStropheStanza::AddBodyWithText(const FString& Text)
{
	...
	{
		UE_LOGF(LogXmpp, Error, "Failed to add body text: %ls", *Text);
		return false;
	}
