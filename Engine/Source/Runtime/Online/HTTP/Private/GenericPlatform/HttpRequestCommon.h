...
protected:
	...
	HTTP_API void LogRequest() const;
	HTTP_API void LogResponse(const TSharedPtr<FHttpResponseCommon>& InResponse) const;
	HTTP_API void LogHeaders(const TMap<FString, FString>& Headers, bool bShouldLogAsWarning, bool bIsResponse) const;
	HTTP_API void LogContent(bool bShouldLogDetails, const IHttpBase& HttpBase, bool bIsResponse) const;
...
protected:
	...
	double TimeStartedWaitingInQueue = 0.0;
