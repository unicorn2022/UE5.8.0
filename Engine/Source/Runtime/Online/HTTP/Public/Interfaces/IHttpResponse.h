...
{
	static constexpr TCHAR ErrorNamespace[] = TEXT("errors.com.epicgames.httpresponse");
	/**
...
public:
	/**
	* Return the content with a MoveTemp if possible.
	*
	* @return - The content array
	*/
	virtual TArray<uint8> TakeContent() = 0;
