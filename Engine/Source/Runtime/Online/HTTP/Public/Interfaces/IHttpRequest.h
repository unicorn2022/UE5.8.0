...
{
	extern HTTP_API const FName HttpVersion;
	extern HTTP_API const FName RequestMode;
#if UE_HTTP_SUPPORT_UNIX_SOCKET
	extern HTTP_API const FName UnixSocketPath;
#endif //UE_HTTP_SUPPORT_UNIX_SOCKET
	extern HTTP_API const FName EnableCookies;
}
