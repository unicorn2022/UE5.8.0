...
namespace MediaPlayerOptionValues
{
	...
	{ static FName OptName("Environment"); return OptName; }
	inline const FName& Environment_Sequencer()
	{ static FName OptName("Sequencer"); return OptName; }
	inline const FName& Environment_Preview()
	{ static FName OptName("Preview"); return OptName; }

	inline const FName& ImgMediaSmartCacheEnabled()
	{ static FName OptName("ImgMediaSmartCacheEnabled"); return OptName; }
	inline const FName& ImgMediaSmartCacheTimeToLookAhead()
	{ static FName OptName("ImgMediaSmartCacheTimeToLookAhead"); return OptName; }
	...
	{ static FName OptName("ViewMediaTexture"); return OptName; }

	/**
	 * Requests parsing timecode meta data if available.
	 */
	inline const FName& ParseTimecodeInfo()
	{ static FName OptName("ParseTimecodeInfo"); return OptName; }
}
