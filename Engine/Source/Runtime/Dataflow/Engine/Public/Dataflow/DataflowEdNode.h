...
public:
...
#if WITH_EDITOR
	DATAFLOWENGINE_API virtual void AllocateDefaultPins() override;
	DATAFLOWENGINE_API virtual FText GetNodeTitle(ENodeTitleType::Type TitleType) const override;
	...
	// UObject interface
	DATAFLOWENGINE_API void Serialize(FArchive& Ar) override;
	...
	DATAFLOWENGINE_API static TSharedPtr<UE::Dataflow::FGraph> GetDataflowGraphFromPin(const UEdGraphPin& Pin);
	DATAFLOWENGINE_API static TSharedPtr<const FDataflowNode> GetDataflowNodeFromPin(const UEdGraphPin& Pin);
	DATAFLOWENGINE_API static const FDataflowInput* GetDataflowInputFromPin(const UEdGraphPin& Pin);
	DATAFLOWENGINE_API static const FDataflowOutput* GetDataflowOutputFromPin(const UEdGraphPin& Pin);
	DATAFLOWENGINE_API static bool CanConnectPins(const UEdGraphPin& OutputPin, const UEdGraphPin& InputPin);
	DATAFLOWENGINE_API static bool CanConvertPins(const UEdGraphPin& OutputPin, const UEdGraphPin& InputPin);

	DATAFLOWENGINE_API static FSlateIcon GetIconFromNode(const FDataflowNode& Node);
#endif
