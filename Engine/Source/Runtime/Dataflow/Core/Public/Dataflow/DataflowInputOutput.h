...
private:
	...
	DATAFLOWCORE_API void CheckRequired(UE::Dataflow::FContext& Context) const;
...
public:
	...
	*/
	...
	UE_DEPRECATED(5.8, "HasNodeFailedOrErrored is deprecated and will only return false, failure or error of node should be done by listening to the context log messages")
