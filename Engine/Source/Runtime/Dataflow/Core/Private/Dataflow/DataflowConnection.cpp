...
void FDataflowConnection::GetSupportedTypes(TArray<FName>& OutSupportedTypes) const
{
	if (bIsAnyType && TypePolicy)
	{
		TypePolicy->GetSupportedTypes(OutSupportedTypes);
	}
}
