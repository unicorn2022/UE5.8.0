...
struct FDataflowSimulationNode : public FDataflowNode
{
	...
	virtual ~FDataflowSimulationNode() = default;
...
struct FDataflowInvalidNode : public FDataflowSimulationNode
{
	...
	/** FDataflowNode interface */
	virtual ~FDataflowInvalidNode() = default;
...
struct FDataflowExecutionNode : public FDataflowSimulationNode
{
	...
	/** FDataflowNode interface */
	virtual ~FDataflowExecutionNode() = default;
...
/** Advance the rigid solver in time */
USTRUCT(meta = (DataflowSimulation))
struct FAdvanceRigidPhysicsSolverDataflowNode : public FDataflowSimulationNode
{
	GENERATED_BODY()
	DATAFLOW_NODE_DEFINE_INTERNAL(FAdvanceRigidPhysicsSolverDataflowNode, "AdvanceRigidSolver", "Physics|Solver", UDataflow::SimulationTag)

public:
	
	FAdvanceRigidPhysicsSolverDataflowNode(const UE::Dataflow::FNodeParameters& InParam, FGuid InGuid = FGuid::NewGuid())
	: FDataflowSimulationNode(InParam, InGuid)
	{
		RegisterInputConnection(&SimulationTime);
		RegisterInputConnection(&State);
		RegisterOutputConnection(&State,&State);
	}
	...
	UPROPERTY(Transient, SkipSerialization, Meta = (DataflowInput, DataflowOutput, DataflowPassthrough = "State"))
...
/** Main terminal node for simulation */
USTRUCT(meta = (DataflowSimulation))
struct FSceneSimulationTerminalDataflowNode : public FDataflowSimulationNode
{
	GENERATED_BODY()
	DATAFLOW_NODE_DEFINE_INTERNAL(FSceneSimulationTerminalDataflowNode, "SceneSimulationTerminal", "Terminal|Scene", UDataflow::SimulationTag)
public:
	
	FSceneSimulationTerminalDataflowNode(const UE::Dataflow::FNodeParameters& InParam, FGuid InGuid = FGuid::NewGuid())
	: FDataflowSimulationNode(InParam, InGuid)
	{
		RegisterInputConnection(&State);
	}
...
/** Main terminal node for scene setup */
USTRUCT(meta = (DataflowSimulation))
struct FRigidSceneSetupTerminalDataflowNode : public FDataflowSimulationNode
{
	GENERATED_BODY()
	DATAFLOW_NODE_DEFINE_INTERNAL(FRigidSceneSetupTerminalDataflowNode, "RigidSceneSetupTerminal", "Terminal|Scene", UDataflow::SimulationTag)
public:
	
	FRigidSceneSetupTerminalDataflowNode(const UE::Dataflow::FNodeParameters& InParam, FGuid InGuid = FGuid::NewGuid())
	: FDataflowSimulationNode(InParam, InGuid)
	{
		RegisterInputConnection(&State);
	}
