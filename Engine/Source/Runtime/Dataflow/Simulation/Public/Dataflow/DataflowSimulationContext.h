...
namespace UE::Dataflow
{
	...
	public:
		...
		virtual ~TSimulationContext() override = default;
		...
		/** Return state associated with the rigids dataflow simulation */
		UE_INTERNAL DATAFLOWSIMULATION_API FRigidPhysicsSceneDataflowState* GetRigidState();

		/** Set the name of scene created through the rigids dataflow */
		UE_INTERNAL DATAFLOWSIMULATION_API void SetRigidSceneName(const FString& InSceneName);

		/** Get the name of scene created through the rigids dataflow */
		UE_INTERNAL DATAFLOWSIMULATION_API const FString& GetRigidSceneName();
#endif
...
#if UE_RIGIDPHYSICS_API_ENABLED
		UE_INTERNAL TPimplPtr<FRigidPhysicsSceneDataflowState> RigidState;
		UE_INTERNAL FString SceneName = "";
#endif
	};
