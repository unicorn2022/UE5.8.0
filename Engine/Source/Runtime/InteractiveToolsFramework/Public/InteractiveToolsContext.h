 ...
 * InputRouter, ToolManager, GizmoManager, TargetManager, ToolGroupManager, and ContextStore. In the simplest
...
public:
	...
	INTERACTIVETOOLSFRAMEWORK_API virtual void SetCreateToolGroupManagerFunc(TUniqueFunction<UToolGroupManager* (const FContextInitInfo&)> Func);
	...
	INTERACTIVETOOLSFRAMEWORK_API virtual void SetShutdownToolGroupManagerFunc(TUniqueFunction<void(UToolGroupManager*)> Func);
...
public:
	...
	/** current UToolGroupManager for this Context */
	UPROPERTY()
	TObjectPtr<UToolGroupManager> ToolGroupManager;
...
protected:
	...
	TUniqueFunction<UToolGroupManager* (const FContextInitInfo&)> CreateToolGroupManagerFunc;
	...
	TUniqueFunction<void(UToolGroupManager*)> ShutdownToolGroupManagerFunc;
