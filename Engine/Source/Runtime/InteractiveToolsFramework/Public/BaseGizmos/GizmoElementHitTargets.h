...
public:
	...
	INTERACTIVETOOLSFRAMEWORK_API virtual void SetTransformAdjuster(const TSharedPtr<UE::GizmoRenderingUtil::IViewBasedTransformAdjuster>& InAdjuster) override;
	INTERACTIVETOOLSFRAMEWORK_API virtual TSharedPtr<UE::GizmoRenderingUtil::IViewBasedTransformAdjuster> GetTransformAdjuster() const override;
...
protected:
	/**
	 * An optional transform adjuster to apply when testing hit geometry.
	 * Note that while the name indicates it's view-based, it may also be used to apply any transform.
	 */
