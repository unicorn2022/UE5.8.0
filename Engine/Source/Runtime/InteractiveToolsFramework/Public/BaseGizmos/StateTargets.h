...
public:
	...
	virtual void CancelUpdate() final
	{
	}
};
...
public:
	...
	TUniqueFunction<void(void)> CancelUpdateFunction = TUniqueFunction<void(void)>();
};
...
public:
	...
	virtual void CancelUpdate() override
	{
		if (TargetComponent.IsValid() && TransactionManager)
		{
