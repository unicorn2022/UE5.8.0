...
public:
	...
	// Axis0 (or the Bitangent axis) of the plane in which the circle lies, must be perpendicular to the normal and tangent.  
	// Start and end angles for partial circles are relative to this axis.
	UE_DEPRECATED(5.8, "Use SetAxisBitangent instead")
	INTERACTIVETOOLSFRAMEWORK_API virtual void SetAxis0(const FVector& InAxis0);

	// Bitangent axis of the plane in which the circle lies, must be perpendicular to Axis1/Tangent.
	// Start and end angles for partial circles are relative to this axis.
	INTERACTIVETOOLSFRAMEWORK_API virtual void SetAxisBitangent(const FVector& InAxisBitangent);

	UE_DEPRECATED(5.8, "Use GetAxisBitangent instead")
	INTERACTIVETOOLSFRAMEWORK_API virtual FVector GetAxis0() const;

	// Bitangent axis of the plane in which the circle lies, must be perpendicular to Axis1/Tangent.
	INTERACTIVETOOLSFRAMEWORK_API virtual FVector GetAxisBitangent() const;

	// Axis1 (usually the "Side" axis) of the plane in which circle lies, must be perpendicular to Axis0.
	UE_DEPRECATED(5.8, "Use SetAxisTangent instead")
	INTERACTIVETOOLSFRAMEWORK_API virtual void SetAxis1(const FVector& InAxis1);

	// Tangent axis of the plane in which the circle lies, must be perpendicular to the normal and bitangent.
	INTERACTIVETOOLSFRAMEWORK_API virtual void SetAxisTangent(const FVector& InAxisTangent);

	UE_DEPRECATED(5.8, "Use GetAxisTangent instead")
	INTERACTIVETOOLSFRAMEWORK_API virtual FVector GetAxis1() const;

	// Tangent axis of the plane in which the circle lies, must be perpendicular to the normal and bitangent.
	INTERACTIVETOOLSFRAMEWORK_API virtual FVector GetAxisTangent() const;
