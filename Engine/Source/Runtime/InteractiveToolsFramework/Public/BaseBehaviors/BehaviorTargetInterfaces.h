...
{
public:
	virtual ~IModifierToggleBehaviorTarget() = default;
...
{
public:
	virtual ~IKeyInputBehaviorTarget() = default;
...
{
public:
	virtual ~IClickBehaviorTarget() = default;
...
{
public:
	virtual ~IMouseWheelBehaviorTarget() = default;
...
{
public:
	virtual ~IClickSequenceBehaviorTarget() = default;
...
{
public:
	virtual ~IHoverBehaviorTarget() = default;
...
public:
	...
	{
		virtual ~IPropertyInterface() = default;
...
public:
	...
	virtual ~ITwoAxisPropertyEditBehaviorTarget() = default;
