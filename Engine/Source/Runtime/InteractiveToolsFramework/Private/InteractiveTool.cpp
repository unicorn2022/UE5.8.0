...
{
	UInteractiveToolPropertySet* PropertyCache = bSaving ? FindOrAddDynamicPropertyCache(CacheIdentifier) : FindDynamicPropertyCache(CacheIdentifier);
...
TObjectPtr<UInteractiveToolPropertySet> UInteractiveToolPropertySet::FindDynamicPropertyCache(const FString& CacheIdentifier) const
{
	UInteractiveToolPropertySet* CDO = GetMutableDefault<UInteractiveToolPropertySet>(GetClass());
	TObjectPtr<UInteractiveToolPropertySet>* Found = CDO->CachedPropertiesMap.Find(CacheIdentifier);
...
TObjectPtr<UInteractiveToolPropertySet> UInteractiveToolPropertySet::FindOrAddDynamicPropertyCache(const FString& CacheIdentifier) const
{
	UInteractiveToolPropertySet* CDO = GetMutableDefault<UInteractiveToolPropertySet>(GetClass());
	TObjectPtr<UInteractiveToolPropertySet>* Found = CDO->CachedPropertiesMap.Find(CacheIdentifier);
	if (Found == nullptr)
