...
{
	SetAxisTangent(InAxis0);
}

void UGizmoElementCircleBase::SetAxisBitangent(const FVector& InAxisTangent)
{
	Axis0 = InAxisTangent.GetSafeNormal();
}
...
FVector UGizmoElementCircleBase::GetAxisBitangent() const
{
	return Axis0;
}
...
{
	SetAxisTangent(InAxis1);
}

void UGizmoElementCircleBase::SetAxisTangent(const FVector& InAxisBitangent)
{
	Axis1 = InAxisBitangent.GetSafeNormal();
}
...
FVector UGizmoElementCircleBase::GetAxisTangent() const
{
	return Axis1;
}
