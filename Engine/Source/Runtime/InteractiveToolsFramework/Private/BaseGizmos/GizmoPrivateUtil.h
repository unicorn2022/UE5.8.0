...
namespace UE::GizmoUtil 
{
	 ...
	 */
	double ClampRayOrigin(const UGizmoViewContext* InViewContext, FVector& InOutRayOrigin, const FVector& InRayDirection, const double InMaxDepth = UE_LARGE_HALF_WORLD_MAX1);
