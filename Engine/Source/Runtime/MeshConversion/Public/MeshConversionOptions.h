...
public:
	...
	/** If non-negative, sets the max valid material ID to assign -- IDs higher than this will be reset to 0. Ignored if negative. */
	int32 MaxValidMaterialID = INDEX_NONE;
