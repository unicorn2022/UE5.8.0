...
protected:
	...
	*/
	...
	/**
	 * Transfer triangle label attributes from DynamicMesh AttributeSet to MeshDescription.
	 * Will copy to existing MeshDescription TriangleAttribute<FName> if one with the same name exists.
	 * Otherwise will register a new one.
	 */
	UE_INTERNAL void ConvertTriangleAttributes(const FDynamicMesh3* MeshIn, FMeshDescription& MeshOut, const TArray<FTriangleID>& IndexToTriangleIDMap);
