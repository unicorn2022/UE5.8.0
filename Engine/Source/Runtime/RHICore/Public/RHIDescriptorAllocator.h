...
public:
	...
	RHICORE_API void Free(TConstArrayView<FRHIDescriptorHandle> InHandles);
...
private:
	...
	RHICORE_API void FreeInternal(FRHIDescriptorAllocation Allocation);
	...
	{
		uint32 Count = 0;
		TArray<uint64, TInlineAllocator<16>> Callstack;
	};
	TMap<uint32, FDebugDescriptorAllocation> DebugOutstandingAllocations;
#endif
...
public:
	...
	using FRHIHeapDescriptorAllocator::HandlesAllocations;
