...
RHICORE_API bool AreRayTracingShadersEnabled();

RHICORE_API bool AllowVendorDevice();

// Utility for RHIs to load the bindless configuration before ShaderPlatformConfig is initialized.
RHICORE_API ERHIBindlessConfiguration GetBindlessConfigurationOnStartup(EShaderPlatform Platform);
