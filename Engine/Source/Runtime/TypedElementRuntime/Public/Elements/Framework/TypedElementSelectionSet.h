...
public:
	 ...
	 */
	TYPEDELEMENTRUNTIME_API bool SelectElement(const FTypedElementHandle& InElementHandle, FTypedElementSelectionOptions InSelectionOptions);
	 ...
	 * @return True if the selection was changed, false otherwise.
	 */
	TYPEDELEMENTRUNTIME_API bool DeselectElement(const FTypedElementHandle& InElementHandle, FTypedElementSelectionOptions InSelectionOptions);
	...
	TYPEDELEMENTRUNTIME_API FName GetNameForTedsIntegration() const;
