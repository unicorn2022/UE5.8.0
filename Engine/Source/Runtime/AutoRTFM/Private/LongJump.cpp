...
UE_AUTORTFM_NOAUTORTFM __attribute__((noinline)) __attribute((naked)) bool FLongJump::SaveContext(void* Buffer)
{
	__asm
	{
...
UE_AUTORTFM_NOAUTORTFM __attribute__((noinline)) __attribute((naked)) void FLongJump::RestoreContext(void* Buffer)
{
	__asm
	{
		// rcx: Buffer, rax: Return value
