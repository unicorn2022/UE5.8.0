...
{ \
	...
	{ \
		UE_LOGF(LogAR, Warning, "%ls unable to cast to %ls from %ls in Update", *U##NetworkClassName::StaticClass()->GetName(), *U##NativeClassName::StaticClass()->GetName(), *TrackedGeometry->GetName()); \
	} \
} \
