...
public:
	...
	static void RequestCTTokenAsync(TDelegate<void(bool Success, FString Output)> Callback);
	static FString GetEligibilityRegionStatic();
...
private:
	void GetEligibilityRegionAsync();
...
private:
	...
	FString TestOverrideEligibilityRegion;
	FString CachedEligibilityRegion;
	TAtomic<bool> bCachedEligibilityRegionInitialized = false;
