...
namespace UE::Editor::DataStorage
{
	...
	struct FQueryResult final
	{
		...
		FQueryResult(const FQueryResult& Other)
			: Count(Other.Count.load())
			, Completed(Other.Completed)
		{}
		
		FQueryResult(FQueryResult&& Other) noexcept
			: Count(Other.Count.load())
			, Completed(Other.Completed)
		{}
		
		FQueryResult& operator=(const FQueryResult& Other)
		{
		...
		FQueryResult& operator=(FQueryResult&& Other) noexcept
		{
			Count.store(Other.Count.load());
			Completed = Other.Completed;
			return *this;
