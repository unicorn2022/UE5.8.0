...
public:
	...
	/**
	 * All factories will have this called after every Register functions on all factories are called
	 */
	virtual void PostRegister(UE::Editor::DataStorage::ICoreProvider& DataStorage) {}
	...
	virtual void RegisterHierarchies(UE::Editor::DataStorage::ICoreProvider& DataStorage) {}
	...
	/** 
     * Used to register searchers for a specific property type to be used in the default generated property searcher. The widget constructor
     * can be used to provide a custom searcher if more complex searching logic is needed. Implementations of this function should mostly be
     * calling `RegisterSearcherGeneratorForProperty` on the UI provider.
     */
    virtual void RegisterPropertySearchers(UE::Editor::DataStorage::IUiProvider& DataStorageUi) const {}
	 ...
	 * can be used to provide a custom sorter if more complex sorting logic is needed. Implementations of this function should mostly be
