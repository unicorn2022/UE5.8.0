 ...
 */
USTRUCT(meta = (DisplayName = "Level Tag"))
...
/**
 * Tag on a row that to denote this is a PIE specific row (e.g PIE actors, PIE folders)
 */
USTRUCT(meta = (DisplayName = "PIE Object"))
struct FEditorDataStoragePieObjectTag final : public FEditorDataStorageTag
{
	GENERATED_BODY()
};

/**
 * Tag on a row that stores the editor only guid of the row
 */
USTRUCT(meta = (DisplayName = "Guid"))
struct FEditorDataStorageGuidColumn final : public FEditorDataStorageColumn
{
	GENERATED_BODY()
	FGuid Guid;
};
...
namespace UE::Editor::DataStorage
{
	...
	using FPieObjectTag = FEditorDataStoragePieObjectTag;
	using FGuidColumn = FEditorDataStorageGuidColumn;
}  // namespace UE::Editor::DataStorage