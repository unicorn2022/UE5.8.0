...
/**
 * Tag on to indicate that this row should be expanded in the UI
 */
USTRUCT(meta = (DisplayName = "Expanded item"))
struct FExpandedInUITag : public FEditorDataStorageTag
{
	GENERATED_BODY()
};