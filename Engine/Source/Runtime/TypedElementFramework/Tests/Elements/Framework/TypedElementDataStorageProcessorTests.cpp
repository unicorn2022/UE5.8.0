...
namespace UE::Editor::DataStorage::Debug::ProcessorTests
{
	...
	void RegisterProcessors()
	{
		...
		{
			PrimaryTable =
				DataStorage->RegisterTable<FTEDSProcessorTestsReferenceColumn, FTEDSProcessorTests_PrimaryTag>(FName("ProcessorTests Primary Table"));
		}
		if (SecondaryTable == InvalidTableHandle)
		{
			SecondaryTable =
				DataStorage->RegisterTable<FTEDSProcessorTestsReferenceColumn, FTEDSProcessorTests_SecondaryTag>(FName("ProcessorTests Secondary Table"));
		}
