...
namespace UE::Editor::DataStorage::ColumnUtils
{
	namespace Private
	{
		static const FName NAME_DynamicTemplateMetadata("EditorDataStorage_DynamicColumnTemplate");
		static const FName NAME_DerivedFromDynamicTemplateMetadata("EditorDataStorage_DerivedFromDynamicTemplate");
	}
