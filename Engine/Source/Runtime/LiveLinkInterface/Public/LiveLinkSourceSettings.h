...
public:
	...
	UPROPERTY(config)
	int32 DefaultSourceFrameBufferSize = 64;
};
...
public:
	...
	/** Get the source name that should be displayed in the UI, based on the subject's source name override and the source type. */
	LIVELINKINTERFACE_API virtual FText GetSourceNameOverride(class ULiveLinkSubjectSettings* SubjectSettings, FText SourceType);
