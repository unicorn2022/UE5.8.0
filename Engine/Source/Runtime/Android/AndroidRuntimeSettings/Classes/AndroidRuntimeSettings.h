...
UENUM(meta = (Deprecated = "5.8", DeprecationMessage = "EOculusMobileDevice is no longer used."))
...
{
	enum UE_DEPRECATED(5.8, "Please don't use") Type : int
	{
...
public:
	...
	// Package for Android OpenXR. This will result in changes to the android manifest and some runtime behavior changes related to XR applications.  Do not query this setting at runtime in a game, use AndroidThunkCpp_IsXRImmersiveHMDApplication() or AndroidThunkCpp_IsOpenXRImmersiveHMDApplication(). 
	UPROPERTY(GlobalConfig, EditAnywhere, Category = "Advanced APK Packaging", Meta = (DisplayName = "Package for OpenXR Immersive devices in general."))
	bool bPackageForOpenXRImmersive;
	
	// Package for Oculus Mobile devices. When enabled, it will enable build support for arm64 and vulkan, and disable build support for x86_64, Vulkan Desktop, and OpenGL.  Also manifest changes and some runtime behavior changes.  Do not query this setting at runtime in a game, use AndroidThunkCpp_IsXRImmersiveHMDApplication() or AndroidThunkCpp_IsOculusMobileApplication().
...
// 	bool bSplitIntoSeparateApks;
	...
	/** DEPRECATED 5.8 */ 
	UE_DEPRECATED(5.8, "This option has been removed, please don't use")
	UPROPERTY(meta = (DeprecatedProperty, DeprecationMessage = "This option has been removed, please don't use"))
...
private:
	...
	UE_DEPRECATED(5.8, "HandleMetaQuestSupport deprecated and replaced by HandleXRSupport()")
	UE_API void HandleMetaQuestSupport() { HandleXRSupport(); }
	UE_API void HandleXRSupport();
