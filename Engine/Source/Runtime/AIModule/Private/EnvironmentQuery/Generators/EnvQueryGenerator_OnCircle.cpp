	...
	: Super(ObjectInitializer)
{
	...
	PointOnCircleSpacingMethod = EEnvQueryPointSpacingMethod::BySpaceBetween;
...
void UEnvQueryGenerator_OnCircle::GenerateItems(FEnvQueryInstance& QueryInstance) const
{
	...
	if ((AngleDegree <= 0.f) || 
		(AngleDegree > 360.f) || 
		(RadiusValue <= 0.f) || 
		((PointOnCircleSpacingMethod == EEnvQueryPointSpacingMethod::BySpaceBetween) && (ItemSpace <= 0.f)) ||
		((PointOnCircleSpacingMethod == EEnvQueryPointSpacingMethod::ByNumberOfPoints) && (NumPoints <= 0)))
	{
		return;
	}
	...
	{
		case EEnvQueryPointSpacingMethod::BySpaceBetween:
		{
		...
		case EEnvQueryPointSpacingMethod::ByNumberOfPoints:
		{
...
FText UEnvQueryGenerator_OnCircle::GetDescriptionDetails() const
{
	...
	FText Desc = PointOnCircleSpacingMethod == EEnvQueryPointSpacingMethod::BySpaceBetween 
