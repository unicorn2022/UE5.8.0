...
bool UBlackboardKeyType_Object::IsAllowedByFilter(UBlackboardKeyType* FilterOb) const
{
	...
	UE_CLOGF(BaseClass == nullptr, LogBlackboard, Warning, "Cannot assign %ls to a Blackboard Key with null base class. Should the base class be changed?", FilterObject ? *FilterObject->DescribeSelf() : TEXT("NULL"));
