...
public:
	...
	/** @return node memory. Virtual override for when GetNodeMemory fails to find NodeMemory */
	AIMODULE_API virtual uint8* GetNodeMemoryAux(const UBTNode* Node, int32 InstanceIdx) const;
