...
class UEnvQueryGenerator_Donut : public UEnvQueryGenerator_ProjectedPoints
{
	...
	/** how we are choosing where the points are in the ring */
	UPROPERTY(EditDefaultsOnly, Category = Generator)
	EEnvQueryPointSpacingMethod PointOnRingSpacingMethod;

	/** items will be generated on a ring this much apart */
	UPROPERTY(EditDefaultsOnly, Category = Generator, meta = (EditCondition = "PointOnRingSpacingMethod == EEnvQueryPointSpacingMethod::BySpaceBetween", EditConditionHides))
	FAIDataProviderFloatValue SpaceBetweenPoints;

	/** number of items to generate for each ring */
	UPROPERTY(EditDefaultsOnly, Category = Generator, meta = (EditCondition = "PointOnRingSpacingMethod == EEnvQueryPointSpacingMethod::ByNumberOfPoints", EditConditionHides))
