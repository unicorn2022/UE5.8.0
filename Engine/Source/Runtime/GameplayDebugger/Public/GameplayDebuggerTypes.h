...
{
	extern GAMEPLAYDEBUGGER_API FString ColorNameInput;
	extern GAMEPLAYDEBUGGER_API FString ColorNameEnabled;
	extern GAMEPLAYDEBUGGER_API FString ColorNameDisabled;
	extern GAMEPLAYDEBUGGER_API FString ColorNameEnabledActiveRow;
	extern GAMEPLAYDEBUGGER_API FString ColorNameDisabledActiveRow;

	extern GAMEPLAYDEBUGGER_API FString Separator;
	extern GAMEPLAYDEBUGGER_API FString SeparatorSpace;
}
