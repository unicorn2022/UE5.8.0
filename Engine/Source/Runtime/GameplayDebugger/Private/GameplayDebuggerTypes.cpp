...
{
	FString ColorNameInput = "white";
	FString ColorNameEnabled = "green";
	FString ColorNameDisabled = "grey";
	FString ColorNameEnabledActiveRow = "green";
	FString ColorNameDisabledActiveRow = "black";

	FString Separator = "{white} | ";
	FString SeparatorSpace = "  ";
}
...
FString FGameplayDebuggerInputHandler::ToString() const
{
	...
	if (Modifier.bShift)
	{
		KeyDesc = FString("Shift+") + KeyDesc;
	}

	if (Modifier.bAlt)
	{
		KeyDesc = FString("Alt+") + KeyDesc;
	}
	
	if (Modifier.bCtrl)
	{
		KeyDesc = FString("Ctrl+") + KeyDesc;
	}
	
	if (Modifier.bCmd)
	{
		KeyDesc = FString("Cmd+") + KeyDesc;
	}
