...
#if MASS_DO_PARALLEL
	UE_LOGF(LogMass, Log, "MassEntity running with MULTITHREADING support.");
#else
	UE_LOGF(LogMass, Log, "MassEntity running in game thread.");
#endif // MASS_DO_PARALLEL

	UE::Mass::Relations::RegisterChildOfRelation();
	UE::Mass::FElementBitSet::OnModuleInitialized();
}
...
#endif
	UE::Mass::FElementBitSet::OnModuleShutdown();
}
