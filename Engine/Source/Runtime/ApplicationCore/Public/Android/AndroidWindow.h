...
public:
	...
	{
		static inline ANativeWindow* PreviousPendingANativeWindow = nullptr;
	...
	public:
		...
		void SetANativeWindow(ANativeWindow* ANativeHandle) 
		{ 
			PreviousPendingANativeWindow = PendingANativeWindow;
			PendingANativeWindow = ANativeHandle;
		}

		ANativeWindow* GetPreviousANativeWindow() const { return PreviousPendingANativeWindow; }
