...
public:
	...
	*/
	...
	/**
	 * Callback which is fired before the "user" input device connection change. When this is fired, the input device metadata may not yet be populated.
	 * 
	 * This is intended for any "lower level" systems which want to directly access device connection changes before other engine plugins and game code does.
	 * 
	 * This should only be fired if there is a valid FInputDeviceScope which can be used to derive the hardware info from.
	 * 
	 ...
	 */
	DECLARE_MULTICAST_DELEGATE_ThreeParams(FOnInputDeviceHardwareInfoAvailable, EInputDeviceConnectionState /* NewConnectionState */, FPlatformUserId /* PlatformUserId */, FInputDeviceId /* InputDeviceId */);
	...
	FOnInputDeviceHardwareInfoAvailable& GetOnInputDeviceHardwareInfoAvailable() const { return OnInputDeviceHardwareInfoAvailable; }
...
protected:
	...
	*/
	...
	/**
	 * Callback which is fired right before the actual OnInputDeviceConnectionChange function for any systems which want to be notified
	 * before any game code is, if there is a valid FInputDeviceScope.
	 */
	static APPLICATIONCORE_API FOnInputDeviceHardwareInfoAvailable OnInputDeviceHardwareInfoAvailable;
