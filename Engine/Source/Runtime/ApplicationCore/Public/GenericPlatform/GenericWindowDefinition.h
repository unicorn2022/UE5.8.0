...
enum class EWindowType
{
	...
	GameWindow UE_DEPRECATED(5.8, "There is no longer any meaningful distinction between game and normal window. Use Normal instead. Windows now opt in to the Slate Console Debugger using a boolean property.")
};
