...
struct FGenericPlatformApplicationMisc
{
	...
	*/
	...
	/** Returns true when native platform gesture recognizers should be used instead of software gesture detection. */
	static APPLICATIONCORE_API bool AreNativeGesturesEnabled();
...
private:
	static APPLICATIONCORE_API TAutoConsoleVariable<bool> CVarEnableNativeGestureRecognition;
};
