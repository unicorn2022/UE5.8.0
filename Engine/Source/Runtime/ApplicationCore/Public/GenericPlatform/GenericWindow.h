...
public:
	...
	/** @return true if the window supports dynamic cursor locking */
	APPLICATIONCORE_API virtual bool SupportsDynamicCursorLock() const;

	/** @return true if the window supports fullscreen */
	...
	/** Returns true if this window will not be used for presenting rendered frames to a display. */
	APPLICATIONCORE_API virtual bool IsRenderingOffScreen() const;
