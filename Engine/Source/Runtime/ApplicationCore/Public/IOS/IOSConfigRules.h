...
class FIOSConfigRules : public FGenericConfigRules
{
...
public:
	...
	static APPLICATIONCORE_API bool Init(TMap<FString, FString>&& PredefinedVariables);
	static APPLICATIONCORE_API const TMap<FString, FString>& GetConfigRulesMap() { return ConfigRuleVariablesMap; }
};
