...
public:
	...
	APPLICATIONCORE_API virtual void SetLightColor(int32 ControllerId, FColor Color) override;
	APPLICATIONCORE_API virtual void ResetLightColor(int32 ControllerId) override;
