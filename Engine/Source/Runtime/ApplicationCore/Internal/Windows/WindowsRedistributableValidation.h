...
struct VersionInfo
{
	...
	/** Set if any version number is non-zero. */
	inline bool IsSet() const
	{
		return Major || Minor || Bld || Rbld;
	}
...
inline constexpr VersionInfo MinRedistVersion = { 14, 50, 35719, 0 };

inline constexpr VersionInfo MinGameInputRedistVersion = { 3, 1, 26100, 6879 };
