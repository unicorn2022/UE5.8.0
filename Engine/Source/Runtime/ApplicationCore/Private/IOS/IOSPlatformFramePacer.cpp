...
-(void)signal:(id)param
{
	...
	if (IsEngineExitRequested())
	{
		...
		// Allow ListeningEvents to keep firing indefinitely during Engine Exit so that the
		// RHIThread never hangs waiting due to frame limiting in FMetalDevice::EndDrawingViewport
