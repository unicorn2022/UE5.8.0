...
{
	UE_LOGF(LogAccessibility, VeryVerbose, "UIA Property Changed: %i", Property);
...
void FWindowsUIAManager::DumpAccessibilityStats() const
{
	...
	UE_LOGF(LogAccessibility, Log, "Dumping Windows accessibility stats:");
	UE_LOGF(LogAccessibility, Log, "Number of Widget Providers: %i", NumWidgetProviders);
	UE_LOGF(LogAccessibility, Log, "Number of non-Widget Providers: %i", NumControlProviders);
