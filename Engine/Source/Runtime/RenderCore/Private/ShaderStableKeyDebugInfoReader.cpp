...
FString UE::ShaderUtils::FShaderStableKeyDebugInfoReader::GetShaderStableNameOptions(const FShaderHash& ShaderHash, int32 MaxOptionsToInclude)
{
...
{
#if UE_WITH_SHK_READER
	UE_LOGF(LogInit, Log, "%ls", *GetPSOStableNameOptions(Initializer));
#endif // UE_WITH_SHK_READER
}
