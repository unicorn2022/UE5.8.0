...
private:
	// TODO: Replace AUTORTFM_INFER with AUTORTFM_DISABLE on the class.
	// Will require AutoRTFM-disabling the bulk of RenderCore.
	AUTORTFM_INFER void ExecuteLambdaFunc(FRHIComputeCommandList& RHICmdList)
	{
	...
	AUTORTFM_INFER void Execute(FRHIComputeCommandList& RHICmdList) override
	{
#if !USE_NULL_RHI
