...
RENDERCORE_API bool GetMaterialSimulateMobileForLowQuality(const FStaticShaderPlatform Platform);

UE_DEPRECATED(5.8, "This function is deprecated, please use UseGPUScene now by only passing the EShaderPlatform as an argument")
...
namespace Substrate
{
	...
	const uint8 IgnoreMaterialQualityLevelsForClosurePerPixel = 255;
