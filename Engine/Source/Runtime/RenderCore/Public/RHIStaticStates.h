 ...
 */
template<typename TInitializerType, typename TRHIResourceType>
class TStaticStateRHI
{
	static_assert(TIsDerivedFrom<TRHIResourceType, FRHIResource>::IsDerived, "Argument TRHIResourceType must derive from FRHIResource");

public:
	static TRHIResourceType* GetRHI()
	{
...
private:
	...
	{
	public:
		TRefCountPtr<TRHIResourceType> StateRHI;
	...
	static TGlobalResource<FStaticStateResource, FRenderResource::EInitPhase::Pre> StaticResource;
};

template<typename TInitializerType, typename TRHIResourceType>
TGlobalResource<typename TStaticStateRHI<TInitializerType, TRHIResourceType>::FStaticStateResource, FRenderResource::EInitPhase::Pre> TStaticStateRHI<TInitializerType, TRHIResourceType>::StaticResource;

/**
 * A static RHI sampler state resource.
 * TStaticSamplerState<...>::GetRHI() will return a sampler state with the desired settings.
 */
template<
...
>
class TStaticSamplerState : public TStaticStateRHI<TStaticSamplerState<Filter, AddressU, AddressV, AddressW, MipBias, MaxAnisotropy, BorderColor, SamplerComparisonFunction>, FRHISamplerState>
{
public:
 ...
 * TStaticRasterizerState<...>::GetRHI() will return a rasterizer state with the desired settings.
 */
...
class TStaticRasterizerState : public TStaticStateRHI<TStaticRasterizerState<FillMode, CullMode, DepthClipMode, bEnableMSAA>, FRHIRasterizerState>
{
public:
 ...
 * TStaticDepthStencilState<...>::GetRHI() will return a depth stencil state with the desired settings.
 */
template<
 ...
 * TStaticBlendState<...>::GetRHI() will return a blend state with the desired settings.
 * 
