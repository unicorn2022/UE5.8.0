...
class UE_DEPRECATED(5.8, "Oculus shaders no longer supported") FOculusVertexShader : public FGlobalShader
{
...
class UE_DEPRECATED(5.8, "Oculus shaders no longer supported") FOculusBlackShader : public FGlobalShader
{
...
class UE_DEPRECATED(5.8, "Oculus shaders no longer supported") FOculusAlphaInverseShader : public FGlobalShader
{
...
class UE_DEPRECATED(5.8, "Use FOculusOpenXRCubemapPS() instead.") FOculusCubemapPS : public FGlobalShader
{
