...
class FD3D11Sync
{
	...
	static TSpscQueue<FD3D11Sync> ActiveSyncs;

public:
	static void EnqueueSync(FGraphEventRef Event);

	static void PollSyncsUntil(FGraphEvent* Target);

	static void PollSyncs()
	{
		PollSyncsUntil(nullptr);
	}
};
