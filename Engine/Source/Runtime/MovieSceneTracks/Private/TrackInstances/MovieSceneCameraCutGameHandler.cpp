...
{
static bool bCameraCutSetViewTargetThroughPlayerController = true;
FAutoConsoleVariableRef CVarCameraCutSetViewTargetThroughPlayerController(
	TEXT("Sequencer.CameraCutSetViewTargetThroughPlayerController"),
	bCameraCutSetViewTargetThroughPlayerController,
		...
		const FRestoreStateParams& Params)
{
	...
	if (PC)
	{
		...
		if (bCameraCutSetViewTargetThroughPlayerController)
		{
