...
{
	FMovieSceneChannelMetaData NoiseMetaData(MetaData);
	NoiseMetaData.bCanBeKeyed = false;
	return ProxyData.AddWithDefaultEditorData(PerlinNoiseChannel, NoiseMetaData);
}
#else
