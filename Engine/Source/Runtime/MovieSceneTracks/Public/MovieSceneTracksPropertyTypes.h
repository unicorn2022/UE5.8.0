...
MOVIESCENETRACKS_API void ConvertOperationalProperty(const FActorReferenceComponent& InComponentData, TObjectPtr<AActor>& Out);
MOVIESCENETRACKS_API void ConvertOperationalProperty(const FActorReferenceComponent& InComponentData, TSoftObjectPtr<AActor>& Out);
MOVIESCENETRACKS_API void ConvertOperationalProperty(const TSoftObjectPtr<AActor> InActor, FActorReferenceComponent& Out);
MOVIESCENETRACKS_API void ConvertOperationalProperty(const TObjectPtr<AActor> InActor, FActorReferenceComponent& Out);
