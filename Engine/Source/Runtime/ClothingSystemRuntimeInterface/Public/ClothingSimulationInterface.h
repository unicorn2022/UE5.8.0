...
protected:
	 ...
	 * Simulation data for this actor should be written back to SimDataIndex in AppendSimulationData
	...
	virtual void GetCollisions(FClothCollisionData& OutCollisions, bool bIncludeExternal = true) const {};
