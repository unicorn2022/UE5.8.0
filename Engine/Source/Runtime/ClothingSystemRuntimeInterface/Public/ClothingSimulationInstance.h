...
public:
	...
	UE_DEPRECATED(5.8, "GetCollisions has been deprecated. Use CollisionSources to add external collisions instead.")
	...
	UE_DEPRECATED(5.8, "AppendUniqueCollisions has been deprecated. Use CollisionSources to add external collisions instead.")
	void AppendUniqueCollisions(FClothCollisionData& OutCollisions, bool bIncludeExternal) const {}
