...
struct FClothCollisionData
{
	...
	bool IsEmpty() const
	{
		return Spheres.IsEmpty() && SphereConnections.IsEmpty() && Convexes.IsEmpty() && Boxes.IsEmpty() && ExtrudedTaperedCapsules.IsEmpty();;
	}
	...
	// Extruded tapered capsule data
	UPROPERTY(EditAnywhere, Category = Collision)
	TArray<FClothCollisionPrim_ExtrudedTaperedCapsule> ExtrudedTaperedCapsules;
};
