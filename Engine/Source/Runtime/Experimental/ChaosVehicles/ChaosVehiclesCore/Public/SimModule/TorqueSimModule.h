...
namespace Chaos
{
	...
	public:
		...
		void SetGroundInteraction(Chaos::FPBDRigidParticleHandle* GroundParticleIn, const FVector& ImpactPointIn, const FVector& ImpactNormalIn)
		{ 
			GroundBody = GroundParticleIn; 
			ImpactPoint = ImpactPointIn;
			ImpactNormal = ImpactNormalIn;
		}

		Chaos::FPBDRigidParticleHandle* GetGroundBody() const { return GroundBody; }
		void ClearGroundBody() { GroundBody = nullptr; }
	...
	protected:
		...
		Chaos::FPBDRigidParticleHandle* GroundBody = nullptr;
