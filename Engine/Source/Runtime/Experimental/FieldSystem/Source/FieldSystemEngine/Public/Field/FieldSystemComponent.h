...
protected:
	...
	/** Whether to intialise this component in Editor worlds */
	UPROPERTY(EditDefaultsOnly, Category=Field)
	bool bEnableInEditorWorlds;

	/** Whether to intialise this component in Preview worlds (both game and editor) */
	UPROPERTY(EditDefaultsOnly, Category=Field)
	bool bEnableInPreviewWorlds;
