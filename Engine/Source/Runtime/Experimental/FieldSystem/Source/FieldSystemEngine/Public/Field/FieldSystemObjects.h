...
public:
	virtual ~UFieldSystemMetaData() = default;
...
public:
	virtual ~UFieldSystemMetaDataIteration() = default;
...
public:
	virtual ~UFieldSystemMetaDataProcessingResolution() = default;
...
public:
	virtual ~UFieldSystemMetaDataFilter() = default;
...
public:
	virtual ~UFieldNodeBase() = default;
...
public:
	virtual ~UFieldNodeFloat() = default;
...
class UFieldNodeVector : public UFieldNodeBase
{
	GENERATED_BODY()
public:
	virtual ~UFieldNodeVector() = default;
...
public:
	...
	virtual ~UUniformInteger() = default;
...
public:
	...
	{}
	virtual ~URadialIntMask() = default;
...
public:
	...
	virtual ~UUniformScalar() = default;
...
public:
	...
	virtual ~URadialFalloff() = default;
...
public:
	...
	virtual ~UUniformVector() = default;
...
* RotatedRadialVector
*/
UCLASS(ClassGroup = "Field", meta = (BlueprintSpawnableComponent, ToolTip = "Set a radial vector value rotated around an axis. The direction is the normalized vector from the field position to the sample, rotated by Angle degrees around Axis. The output is equal to magnitude * rotated direction"), ShowCategories = ("Field"), MinimalAPI)
...
public:
	...
	virtual ~URotatedRadialVector() = default;
	...
	FIELDSYSTEMENGINE_API URotatedRadialVector* SetRotatedRadialVector(
		UPARAM(DisplayName = "Field Magnitude") float Magnitude,
		UPARAM(DisplayName = "Center Position") FVector Position,
		UPARAM(DisplayName = "Rotation Angle") float Angle,
		UPARAM(DisplayName = "Rotation Axis") FVector Axis);
	...
	/** Rotation angle in degrees applied to the radial direction */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Field", DisplayName = "Rotation Angle")
	float Angle;

	/** Axis around which the radial direction is rotated */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Field", DisplayName = "Rotation Axis")
	FVector Axis;
};
...
public:
	...
	virtual ~UOperatorField() = default;
...
public:
	...
	virtual ~UToIntegerField() = default;
...
public:
	...
	virtual ~UReturnResultsTerminal() = default;
