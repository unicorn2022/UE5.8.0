...
{
	Super::OnRegister();
	// make sure we unregister the events before register them again , because the geometry collection component may call RegisterChaosEvents before OnRegister is called on the dispatcher
