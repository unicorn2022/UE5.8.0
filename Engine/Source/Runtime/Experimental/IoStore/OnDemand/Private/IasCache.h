...
public:
	...
	be released prior to abandonment; TUniquePtr->Release()->Abandon().*/
	...
	/** Update the value initially provided by FIasCacheConfig::JournalMagic */
	virtual void UpdateMagicValue(uint32 MagicValue) = 0;
};
