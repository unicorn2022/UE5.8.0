...
public:
	...
	GEOMETRYCOLLECTIONENGINE_API virtual void SetLinearDamping(float InDamping) override;
	GEOMETRYCOLLECTIONENGINE_API virtual void SetAngularDamping(float InDamping) override;
...
protected:
	...
	GEOMETRYCOLLECTIONENGINE_API void SetLinearDampingPerTransform(const TArray<int32>& TransformIndices, float InDamping);

	UFUNCTION(BlueprintCallable, Category = "ChaosPhysics")
	GEOMETRYCOLLECTIONENGINE_API void SetAngularDampingPerTransform(const TArray<int32>& TransformIndices, float InDamping);
...
#define COPY_ON_WRITE_ATTRIBUTES \
	...
	*/
	...
	/** Changes whether or not this component will get future trailing notifications. */
	UFUNCTION(BlueprintCallable, Category = "Physics")
	GEOMETRYCOLLECTIONENGINE_API void SetNotifyTrailings(bool bNewNotifyTrailings);
	...
	/** Changes whether or not this component will get future global trailing notifications. */
	UFUNCTION(BlueprintCallable, Category = "Physics")
	GEOMETRYCOLLECTIONENGINE_API void SetNotifyGlobalTrailings(bool bNewNotifyGlobalTrailings);
	...
	* The transforms are representing the center of mass of each piece and are in component space 
	*/
	UFUNCTION(BlueprintCallable, Category = "ChaosPhysics")
	GEOMETRYCOLLECTIONENGINE_API TArray<FTransform> GetCurrentTransforms();

	/**
	* Get current transforms from a specific list of indices
	* The transforms are representing the center of mass of each piece and are in component space
	*/
	UFUNCTION(BlueprintCallable, Category = "ChaosPhysics")
	GEOMETRYCOLLECTIONENGINE_API TArray<FTransform> GetCurrentTransformsFromIndices(const TArray<int32>& TransformIndices);
...
public:
	...
	/** If true, this component will generate trailing events that will be listened by the global event relay. */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "ChaosPhysics|Events|Global")
	bool bNotifyGlobalTrailings;
...
protected:
	...
	/**
	 * Move the component each tick to follow the dynamically-simulated root bone; stops once the root breaks.
	 * Not supported for kinematic roots or cluster union members.
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "ChaosPhysics|General")
...
private:
	...
	Chaos::Filter::FShapeFilterData InitialShapeFilterData;
	Chaos::Filter::FInstanceData InitialFilterInstanceData;
