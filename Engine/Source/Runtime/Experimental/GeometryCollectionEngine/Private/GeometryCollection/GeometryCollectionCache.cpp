...
void UGeometryCollectionCache::GetAssetRegistryTags(FAssetRegistryTagsContext Context) const
{
	...
	Context.AddTag(FAssetRegistryTag(TagName_Name, SupportedCollection ? SupportedCollection->GetName() : FString("None"), FAssetRegistryTag::TT_Alphabetical));
	Context.AddTag(FAssetRegistryTag(TagName_IdGuid, SupportedCollection ? SupportedCollection->GetIdGuid().ToString() : FString("INVALID"), FAssetRegistryTag::TT_Hidden));
	Context.AddTag(FAssetRegistryTag(TagName_StateGuid, SupportedCollection ? CompatibleCollectionState.ToString() : FString("INVALID"), FAssetRegistryTag::TT_Hidden));
}
