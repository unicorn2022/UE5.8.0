...
protected:
	...
	TConstArrayView<FGeometryCollectionMeshElement> GetSectionArray(bool bUsesSubSections, bool bRemoveInternalFaces) const;

	/** Sets up a FMeshBatch for a specific LOD and section. */
	void GetMeshElement(
		int32 LODIndex,
		int32 SectionIndex,
	...
	using FMaterialArrayType = TArray<FMaterialRenderProxy*, TInlineAllocator<32>>;

	void GetSectionMaterialProxies(TConstArrayView<FGeometryCollectionMeshElement> InSectionArray, FMaterialArrayType& OutMaterialProxies) const;
	...
	bool IsRayTracingStaticRelevant() const { return bUseStaticRayTracingInstances; }
	...
	void GetStaticRayTracingInstances(FStaticRayTracingInstances& OutRayTracingInstances, FRHIUniformBuffer* UniformBuffer);
	RayTracing::FGeometryGroupHandle GetRayTracingGeometryGroupHandle() const;
#endif
...
protected:
	...
	TArray<int32> TransformToInstanceMapping;
...
#if RHI_RAYTRACING
	bool bUseStaticRayTracingInstances = false;
#endif
...
private:
	...
	TArray<FGeometryCollectionTransformBuffer, TInlineAllocator<4>> TransformBuffers;

	const bool bHasRayTracingRepresentation = false;

#if RHI_RAYTRACING
	const FGeometryCollectionRayTracingResources& RayTracingResources;
	RayTracing::FGeometryGroupHandle RayTracingGeometryGroupHandle;

	FRayTracingGeometry RayTracingGeometry;
	FRWBuffer RayTracingDynamicVertexBuffer;

	TArray<FMeshBatch> CachedPartRayTracingMaterials;
...
#if RHI_RAYTRACING
	virtual bool IsRayTracingRelevant() const override { return FGeometryCollectionSceneProxyBase::IsRayTracingRelevant(); }
	virtual bool IsRayTracingStaticRelevant() const override { return FGeometryCollectionSceneProxyBase::IsRayTracingStaticRelevant(); }
	virtual bool HasRayTracingRepresentation() const override { return FGeometryCollectionSceneProxyBase::HasRayTracingRepresentation(); }
	virtual void GetDynamicRayTracingInstances(FRayTracingInstanceCollector& Collector) override { return FGeometryCollectionSceneProxyBase::GetDynamicRayTracingInstances(Collector, GetLocalToWorld(), GetUniformBuffer(), bAnyMaterialHasWorldPositionOffset); }
#endif
...
public:
	...
	virtual void GetStaticRayTracingInstances(FStaticRayTracingInstances& OutRayTracingInstances) override { return FGeometryCollectionSceneProxyBase::GetStaticRayTracingInstances(OutRayTracingInstances, GetUniformBuffer()); }
	virtual RayTracing::FGeometryGroupHandle GetRayTracingGeometryGroupHandle() const override { return FGeometryCollectionSceneProxyBase::GetRayTracingGeometryGroupHandle(); }
#endif
