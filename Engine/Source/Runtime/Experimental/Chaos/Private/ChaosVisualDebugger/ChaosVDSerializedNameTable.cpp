...
namespace Chaos::VisualDebugger
{
	...
	uint64 FChaosVDSerializableNameTable::AddNameToTable(const FChaosVDSerializedNameEntry& InNameEntry)
	{
		...
		int32 NameNumber = InNameEntry.NameNumber == NAME_NO_NUMBER ? NAME_NO_NUMBER_INTERNAL : InNameEntry.NameNumber;

		NamesByID.Add(InNameEntry.NameID, FName(InNameEntry.Name, NameNumber));
