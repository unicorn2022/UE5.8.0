...
namespace Chaos
{
		...
		FReal& OutTime, FVec3& OutPosition, FVec3& OutNormal, int32& OutFaceIndex, FVec3& OutFaceNormal)
	{
		...
		if (bResult)
		{
			...
			OutPosition = OutNormal * SphereRadius;
			TransformSweepResultsToWorld(bResult, OutTime, bComputeMTD, TestSphere, SphereLocation, WorldSweepDir, OutPosition, OutNormal, OutFaceIndex, OutPosition, OutNormal, OutFaceNormal);
		}
		return bResult;
	}
