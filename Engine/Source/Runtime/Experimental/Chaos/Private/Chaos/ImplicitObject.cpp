...
namespace Chaos
{
	...
	{
		static const FName SphereName = "Sphere";
		static const FName BoxName = "Box";
		static const FName PlaneName = "Plane";
		static const FName CapsuleName = "Capsule";
		static const FName TransformedName = "Transformed";
		static const FName UnionName = "Union";
		static const FName LevelSetName = "LevelSet";
		static const FName MLLevelSetName = "MLLevelSet";
		static const FName UnknownName = "Unknown";
		static const FName ConvexName = "Convex";
		static const FName TaperedCylinderName = "TaperedCylinder";
		static const FName CylinderName = "Cylinder";
		static const FName TriangleMeshName = "TriangleMesh";
		static const FName HeightFieldName = "HeightField";
		static const FName TaperedCapsuleName = "TaperedCapsule";
		static const FName UnionClusteredName = "UnionClustered";
