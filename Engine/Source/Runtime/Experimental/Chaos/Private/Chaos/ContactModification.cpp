...
namespace Chaos
{
	...
	void FContactPairModifier::GetWorldContactLocations(int32 ContactPointIdx, FVec3& OutLocation0, FVec3& OutLocation1) const
	{
		...
		TArrayView<FManifoldPoint> ManifoldPoints = Constraint->GetManifoldPoints();
		const FManifoldPoint& ManifoldPoint = ManifoldPoints[ContactPointIdx];
	...
	void FContactPairModifier::ModifyEnablePositionSolve(bool bEnable, int32 ContactPointIdx)
	{
		Constraint->SetManifoldPointPositionSolveEnabled(ContactPointIdx, bEnable);
		Constraint->SetModifierApplied();
	}

	void FContactPairModifier::ModifyEnableVelocitySolve(bool bEnable, int32 ContactPointIdx)
	{
		Constraint->SetManifoldPointVelocitySolveEnabled(ContactPointIdx, bEnable);
		Constraint->SetModifierApplied();
	}

	void FContactPairModifier::ModifyEnableFriction(bool bEnable, int32 ContactPointIdx)
	{
		Constraint->SetManifoldPointFrictionEnabled(ContactPointIdx, bEnable);
		Constraint->SetModifierApplied();
	}
	...
	int32 FContactPairModifier::AddContact(const FVec3& WorldPos0, const FVec3& WorldPos1, const FVec3& WorldNormal) const
	{
		FContactPointf ContactPoint;
		ContactPoint.ShapeContactPoints[0] = Constraint->GetShapeWorldTransform0().InverseTransformPositionNoScale(WorldPos0);
		ContactPoint.ShapeContactPoints[1] = Constraint->GetShapeWorldTransform1().InverseTransformPositionNoScale(WorldPos1);
		ContactPoint.ShapeContactNormal = Constraint->GetShapeWorldTransform1().InverseTransformVectorNoScale(WorldNormal);
		ContactPoint.Phi = FRealSingle(FVec3::DotProduct(WorldPos0 - WorldPos1, WorldNormal));
	
		int32 ContactIndex = Constraint->AddManifoldPoint(ContactPoint);
		Constraint->SetModifierApplied();
		return ContactIndex;
	}
