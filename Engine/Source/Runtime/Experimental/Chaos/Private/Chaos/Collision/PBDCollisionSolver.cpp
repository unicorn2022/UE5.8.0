...
namespace Chaos
{
	namespace CVars
	{
		...
		bool bChaos_PBDCollisionSolver_Use1DFriction = false;
		FAutoConsoleVariableRef CVarChaos_PBDCollisionSolver_CVarUse1DFriction(TEXT("p.Chaos.Solver.Use1DFriction"), bChaos_PBDCollisionSolver_Use1DFriction, TEXT("Use 1 dimensional friction along the velocity axis."));
	}
