...
namespace Chaos
{
	...
	namespace Private
	{
		...
		void FPBDCollisionContainerSolverJacobi::ResetImpl(const int32 MaxCollisions)
		{
		...
		bool FPBDCollisionContainerSolverJacobi::SortConstraintsByPartitionIndex(const TArray<int32>& PartitionIndices, const TArray<int32>& PrefixSum)
		{
			Private::SortArrayByPartitionIndex(CollisionConstraints, PartitionIndices, PrefixSum);
			return true;
		}

		void FPBDCollisionContainerSolverJacobi::GetAllConstrainedParticles(TArray<const FGeometryParticleHandle*>& ParticleHandles) const
		{
		...
		void FPBDCollisionContainerSolverJacobi::ApplyPositionConstraints(const FReal Dt, const int32 It, const int32 NumIts, const int32 BeginIndex, const int32 EndIndex)
		{
			check(NumSolvers() <= GetNumConstraints());
		...
		void FPBDCollisionContainerSolverJacobi::ApplyVelocityConstraints(const FReal Dt, const int32 It, const int32 NumIts, const int32 BeginIndex, const int32 EndIndex)
		{
			check(NumSolvers() <= GetNumConstraints());
		...
		void FPBDCollisionContainerSolverJacobi::ApplyProjectionConstraints(const FReal Dt, const int32 It, const int32 NumIts, const int32 BeginIndex, const int32 EndIndex)
		{
		...
		bool FPBDCollisionContainerSolverJacobi::SolveVelocityImpl(const FReal InDt, const int32 It, const int32 NumIts, const int32 ConstraintBeginIndex, const int32 ConstraintEndIndex, const FPBDCollisionSolverSettings& SolverSettings)
		{
			...
			const int32 BeginIndex = FMath::Min(ConstraintBeginIndex, NumSolvers());
			const int32 EndIndex = FMath::Min(ConstraintEndIndex, NumSolvers());
