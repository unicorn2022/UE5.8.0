	...
	, bWriteDebugInfo(bWriteDebugInfoIn)
{
	...
	FFileHelper::SaveStringToFile(FString("Running Newton's Method\r\n"), *file);
	FFileHelper::SaveStringToFile(FString("Current Configuration:\r\n"), *file, FFileHelper::EEncodingOptions::AutoDetect, &IFileManager::Get(), EFileWrite::FILEWRITE_Append);
	FFileHelper::SaveStringToFile((FString("Newton Tol = ") + FString::SanitizeFloat(MNewtonTol) + FString("\r\n")), *file, FFileHelper::EEncodingOptions::AutoDetect, &IFileManager::Get(), EFileWrite::FILEWRITE_Append);
	FFileHelper::SaveStringToFile((FString("CG Tol = ") + FString::SanitizeFloat(MCGTol) + FString("\r\n")), *file, FFileHelper::EEncodingOptions::AutoDetect, &IFileManager::Get(), EFileWrite::FILEWRITE_Append);
	FFileHelper::SaveStringToFile((FString("Max Newton Iters = ") + FString::FromInt(MNumNewtonIterations) + FString("\r\n")), *file, FFileHelper::EEncodingOptions::AutoDetect, &IFileManager::Get(), EFileWrite::FILEWRITE_Append);
	FFileHelper::SaveStringToFile((FString("Max CG Iters = ") + FString::FromInt(MNumCGIterations) + FString("\r\n")), *file, FFileHelper::EEncodingOptions::AutoDetect, &IFileManager::Get(), EFileWrite::FILEWRITE_Append);
	FFileHelper::SaveStringToFile(FString("ConsModel: Corotated\r\n"), *file, FFileHelper::EEncodingOptions::AutoDetect, &IFileManager::Get(), EFileWrite::FILEWRITE_Append);
...
void FNewtonEvolution::WriteOutputLog(const int32 Frame) 
{
	...
	FFileHelper::SaveStringToFile((FString("Frame = ") + FString::FromInt(Frame) + FString("\r\n")), *file, FFileHelper::EEncodingOptions::AutoDetect, &IFileManager::Get(), EFileWrite::FILEWRITE_Append);
	FFileHelper::SaveStringToFile((FString("Time = ") + FString::SanitizeFloat(MTime) + FString("\r\n")), *file, FFileHelper::EEncodingOptions::AutoDetect, &IFileManager::Get(), EFileWrite::FILEWRITE_Append);
	FFileHelper::SaveStringToFile(FString("---------------------------------------------------\r\n"), *file, FFileHelper::EEncodingOptions::AutoDetect, &IFileManager::Get(), EFileWrite::FILEWRITE_Append);
}
...
//#pragma omp parallel for
	...
	void FNewtonEvolution::DoNewtonStep(const int32 max_it_newton, const FSolverReal newton_tol, const int32 max_it_cg, const FSolverReal cg_tol, Func1 P, Func2 dP, const FSolverReal Time, const FSolverReal Dt, const TArray<TArray<TVector<int32, 2>>>& IncidentElements, const TArray<FSolverReal>& nodal_mass, Func3 set_bcs, Func4 project_bcs, Func5 add_external_force, Func6 update_position_based_state, FSolverParticles& InParticles, TArray<FSolverReal>& ResidualNorm, bool use_cg, FSolverReal cg_prctg_reduce, bool no_verbose) {
		...
		for (int32 it = 0; it < MNumNewtonIterations; it++)
		{
			...
			FFileHelper::SaveStringToFile((FString("Newton Residual two Norm = ") + FString::SanitizeFloat(Norm) + FString("\r\n")), *file, FFileHelper::EEncodingOptions::AutoDetect, &IFileManager::Get(), EFileWrite::FILEWRITE_Append);
			if (Norm < newton_tol) {
				FFileHelper::SaveStringToFile((FString("Newton converged to tolerance ") + FString::SanitizeFloat(newton_tol) + FString(" in = ") + FString::FromInt(it) + FString("\r\n")), *file, FFileHelper::EEncodingOptions::AutoDetect, &IFileManager::Get(), EFileWrite::FILEWRITE_Append);
			...
			FFileHelper::SaveStringToFile((FString("Linear Residual two Norm = ") + FString::SanitizeFloat(Norm) + FString("\r\n")), *file, FFileHelper::EEncodingOptions::AutoDetect, &IFileManager::Get(), EFileWrite::FILEWRITE_Append);
