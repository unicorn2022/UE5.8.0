...
#if INTEL_ISPC
#include "PerParticlePBDCollisionConstraintISPCDataVerification.ispc.generated.h"
...
static_assert(sizeof(Chaos::FImplicitObject) + offsetof(ispc::FExtrudedTaperedCapsule, Origin) == Chaos::FExtrudedTaperedCapsule::FISPCDataVerifier::OffsetOfOrigin());
static_assert(sizeof(ispc::FExtrudedTaperedCapsule::Origin) == Chaos::FExtrudedTaperedCapsule::FISPCDataVerifier::SizeOfOrigin());
static_assert(sizeof(Chaos::FImplicitObject) + offsetof(ispc::FExtrudedTaperedCapsule, MajorAxis) == Chaos::FExtrudedTaperedCapsule::FISPCDataVerifier::OffsetOfMajorAxis());
static_assert(sizeof(ispc::FExtrudedTaperedCapsule::MajorAxis) == Chaos::FExtrudedTaperedCapsule::FISPCDataVerifier::SizeOfMajorAxis());
static_assert(sizeof(Chaos::FImplicitObject) + offsetof(ispc::FExtrudedTaperedCapsule, MinorAxis) == Chaos::FExtrudedTaperedCapsule::FISPCDataVerifier::OffsetOfMinorAxis());
static_assert(sizeof(ispc::FExtrudedTaperedCapsule::MinorAxis) == Chaos::FExtrudedTaperedCapsule::FISPCDataVerifier::SizeOfMinorAxis());
static_assert(sizeof(Chaos::FImplicitObject) + offsetof(ispc::FExtrudedTaperedCapsule, HalfLength) == Chaos::FExtrudedTaperedCapsule::FISPCDataVerifier::OffsetOfHalfLength());
static_assert(sizeof(ispc::FExtrudedTaperedCapsule::HalfLength) == Chaos::FExtrudedTaperedCapsule::FISPCDataVerifier::SizeOfHalfLength());
static_assert(sizeof(Chaos::FImplicitObject) + offsetof(ispc::FExtrudedTaperedCapsule, HalfWidth) == Chaos::FExtrudedTaperedCapsule::FISPCDataVerifier::OffsetOfHalfWidth());
static_assert(sizeof(ispc::FExtrudedTaperedCapsule::HalfWidth) == Chaos::FExtrudedTaperedCapsule::FISPCDataVerifier::SizeOfHalfWidth());
static_assert(sizeof(Chaos::FImplicitObject) + offsetof(ispc::FExtrudedTaperedCapsule, Radius1) == Chaos::FExtrudedTaperedCapsule::FISPCDataVerifier::OffsetOfRadius1());
static_assert(sizeof(ispc::FExtrudedTaperedCapsule::Radius1) == Chaos::FExtrudedTaperedCapsule::FISPCDataVerifier::SizeOfRadius1());
static_assert(sizeof(Chaos::FImplicitObject) + offsetof(ispc::FExtrudedTaperedCapsule, Radius2) == Chaos::FExtrudedTaperedCapsule::FISPCDataVerifier::OffsetOfRadius2());
static_assert(sizeof(ispc::FExtrudedTaperedCapsule::Radius2) == Chaos::FExtrudedTaperedCapsule::FISPCDataVerifier::SizeOfRadius2());
...
static_assert(sizeof(ispc::FConvexStructureData::Data) == Chaos::FConvexStructureData::FISPCDataVerifier::SizeOfData()); //-V568
