...
namespace Chaos
{
	...
	public:
		...
		CHAOS_API ESleepType GetSleepType_External() const;
		CHAOS_API void SetSleepType_External(const ESleepType SleepType);

		CHAOS_API bool GetDisabled_External() const;
		CHAOS_API void SetDisabled_External(const bool Disabled);

		CHAOS_API bool GetGravityEnabled_External() const;
		CHAOS_API void SetGravityEnabled_External(const bool Enabled);
