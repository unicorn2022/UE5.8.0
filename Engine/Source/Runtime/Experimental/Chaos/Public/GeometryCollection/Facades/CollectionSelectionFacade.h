...
namespace GeometryCollection::Facades
{
	...
	*/
	...
	public:
		...
		{
			None = 0,
			SelectionGroupCantBeFound = 1,
			AttributeCantBeFound = 2
		};
		...
		*/
		...
		CHAOS_API void AddSelectionToCollection(const FName InGroupName, const TBitArray<>& InSelectionArray, const FString InAttribute, const bool bStoreAsFloat);

		CHAOS_API EErrorCode GetSelectionFromCollection(const FName InGroupName, const FString& InAttribute, TBitArray<>& OutSelectionArray) const;
	...
	private:
		...
		void RegisterSelectionInCollection(const FName InGroupName, FString InAttribute);
	};
