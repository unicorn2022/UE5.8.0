	...
	*/
	...
	public:
		...
		*/
		...
		CHAOS_API TArray<int32> SelectRandom(bool bDeterministic, int32 RandomSeed, float RandomThresholdVal) const;
		CHAOS_API TArray<int32> SelectRandom(const int32 NumElems, const bool bDeterministic, const int32 RandomSeed, const float RandomThresholdVal) const;
		...
		/**  */
		static CHAOS_API void SelectByPercentage(TArray<int32>& InOutSelection, int32 Percentage, bool Deterministic, int32 RandomSeed);
		...
		/**
		* Fill an array of bool that contains whether or not a vertex is contained in a transformed box
		* The transformed box must be in collection space
		*/
		CHAOS_API void SelectVerticesInTransformedBox(const FBox& InBox, const FTransform& InBoxTransform, TArray<bool>& OutVertexSelection) const;
		CHAOS_API void SelectVerticesInTransformedBox(const FBox& InBox, const FTransform& InBoxTransform, TBitArray<>& OutVertexSelection) const;

		/**
		* Fill an array of bool that contains whether or not a vertex is contained in a sphere
		* The sphere must be in collection space
		*/
		CHAOS_API void SelectVerticesInSphere(const FSphere& InSphere, TArray<bool>& OutVertexSelection) const;
		CHAOS_API void SelectVerticesInSphere(const FSphere& InSphere, TBitArray<>& OutVertexSelection) const;

		/**
		* Fill an array of bool that contains whether or not a vertex is on a specific side of a plane 
		* The plane must be defined in collection space
		*/
		CHAOS_API void SelectVerticesOnPlaneSide(const FPlane& InPlane, bool bUsePositiveSide, TArray<bool>& OutVertexSelection) const;
		CHAOS_API void SelectVerticesOnPlaneSide(const FPlane& InPlane, bool bUsePositiveSide, TBitArray<>& OutVertexSelection) const;
...
//		TArray<int32> SelectCentroidInConvex(const SOMECONVEXTYPE& InConvex, const FTransform& InTransform, const FTransform& InTransform) const;
		...
		*/
		...
		CHAOS_API void ConvertVertexSelectionToCurveSelection(const TBitArray<>& InVertexSelection, bool bAllElementsMustBeSelected, TBitArray<>& OutCurveSelection) const;
		...
		*/
		...
		/**
		* Compute and return VertexToFaceIndices array
		*/
		CHAOS_API void GetVertexToFaceIndicesArray(TArray<TArray<int32>>& VertexToFaceIndices) const;
