	...
	*/
	...
	public:
		...
		*/
		...
		/** 
		* Get centroid in collection space ( center of the bounding boxes of each transform )
		* NOTE : Only transform with geometry associated with them will have a centroid , the rest will have a centroid set a the origin of the collection
		* IMPORTANT : The resulting array is indexed on transform group
		*/
		CHAOS_API TArray<FVector> GetTransformCentroidsInCollectionSpace() const;
