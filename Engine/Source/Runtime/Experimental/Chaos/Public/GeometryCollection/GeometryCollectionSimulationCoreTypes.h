...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
		...
		, bGenerateGlobalTrailingData(false)
		, EnableGravity(true)
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
		...
		, bGenerateGlobalTrailingData(Other.bGenerateGlobalTrailingData)
		...
		, bGyroscopicTorqueEnabled(Other.bGyroscopicTorqueEnabled)
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
		, ShapeFilterData(Other.ShapeFilterData)
		, ShapeInstanceData(Other.ShapeInstanceData)
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	bool bGenerateGlobalTrailingData : 1;
	...
	bool bGyroscopicTorqueEnabled : 1;

	int32 PositionSolverIterations;
	int32 VelocitySolverIterations;
	int32 ProjectionSolverIterations;
	...
	UE_DEPRECATED(5.8, "Use ShapeFilterData and ShapeInstanceData instead")
