...
namespace Chaos::VisualDebugger
{
	...
	/** Version of Chaos Archive that allows CVD to provide its own shared context instance */
	class FChaosVDSharedContextArchive : public FChaosArchive
	{
	public:
		explicit FChaosVDSharedContextArchive(FArchive& ArIn, const TSharedRef<FChaosArchiveContext>& InExternalSharedContext)
