...
public:
	...
	virtual ~FUniformInteger() = default;
...
public:
	...
	virtual ~FRadialIntMask() = default;
...
public:
	...
	virtual ~FUniformScalar() = default;
...
public:
	...
	virtual ~FRadialFalloff() = default;
...
public:
	...
	virtual ~FUniformVector() = default;
...
class FRotatedRadialVector : public FFieldNode<FVector>
{
	typedef FFieldNode<FVector> Super;

public:

	FRotatedRadialVector(float MagnitudeIn = 1.f,
		FVector PositionIn = FVector(0, 0, 0),
		float AngleIn = 0.f,
		FVector AxisIn = FVector(0, 0, 1))
		: Super()
		, Magnitude(MagnitudeIn)
		, Position(PositionIn)
		, Angle(AngleIn)
		, Axis(AxisIn)
	{}
	virtual FFieldNodeBase* NewCopy() const override { return new FRotatedRadialVector(Magnitude, Position, Angle, Axis); }
	virtual ~FRotatedRadialVector() = default;

	CHAOS_API virtual void Evaluate(FFieldContext&, TFieldArrayView<FVector>& Results) const override;
	CHAOS_API virtual bool operator==(const FFieldNodeBase& Node) override;

	/** Serialization API */
	virtual FFieldNodeBase::ESerializationType SerializationType() const override { return FFieldNodeBase::ESerializationType::FieldNode_FRotatedRadialVector; }
	CHAOS_API virtual void Serialize(FArchive& Ar) override;
...
public:
	...
	virtual ~FConversionField() = default;
...
public:
	...
	virtual ~FReturnResultsTerminal() = default;
