...
public:
	...
	virtual ~FFieldSystemMetaData() = default;
...
public:
	...
	virtual ~FFieldSystemMetaDataProcessingResolution() = default;
...
public:
	...
	virtual ~FFieldSystemMetaDataFilter() = default;
...
public:
	...
	virtual ~FFieldSystemMetaDataResults() = default;
...
public:
	...
	virtual ~FFieldSystemMetaDataIteration() = default;
...
public:
	...
	enum ESerializationType
	{
		...
		FieldNode_FRotatedRadialVector
	};

	FFieldNodeBase() : Name("") {}
	virtual ~FFieldNodeBase() = default;
