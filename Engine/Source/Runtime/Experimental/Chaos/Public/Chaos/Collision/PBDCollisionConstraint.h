	...
	*/
	...
	public:
		...
		*/
		...
		inline void SetManifoldPointPositionSolveEnabled(const int32 ManifoldPointIndex, bool bInEnabled)
		{
			ManifoldPoints[ManifoldPointIndex].Flags.bDisablePositionSolve = !bInEnabled;
		}

		inline void SetManifoldPointVelocitySolveEnabled(const int32 ManifoldPointIndex, bool bInEnabled)
		{
			ManifoldPoints[ManifoldPointIndex].Flags.bDisableVelocitySolve = !bInEnabled;
		}

		inline void SetManifoldPointFrictionEnabled(const int32 ManifoldPointIndex, bool bInEnabled)
		{
			ManifoldPoints[ManifoldPointIndex].Flags.bDisableFriction = !bInEnabled;
		}
	...
	private:
		...
		union FFlags
		{
			...
			struct
			{
				...
				uint16 bCanRestoreManifold : 1;			// Can we try to restore the manifold this frame (set following narrowphase, cleared when reset for some reason)
