	...
	namespace Private
	{
		...
		*/
		...
		private:
			...
			void CreateSolvers();
			void UpdatePositionShockPropagation(const int32 It, const int32 NumIts, const int32 BeginIndex, const int32 EndIndex, const FPBDCollisionSolverSettings& SolverSettings);
			void UpdateVelocityShockPropagation(const int32 It, const int32 NumIts, const int32 BeginIndex, const int32 EndIndex, const FPBDCollisionSolverSettings& SolverSettings);
			void ApplyShockPropagation(const FSolverReal ShockPropagation, const int32 BeginIndex, const int32 EndIndex);
			void UpdateCollisions(const FSolverReal InDt, const int32 BeginIndex, const int32 EndIndex);
			...
			TArray<FSolverReal> AppliedShockPropagation;
