...
namespace Chaos
{
	...
	*/
	...
	public:
		...
		// Whether to use a split-impulse for the position correction. In split-impulse mode
		// the position correction is momentumless
		uint32 bUseSplitImpulse : 1;
	};
