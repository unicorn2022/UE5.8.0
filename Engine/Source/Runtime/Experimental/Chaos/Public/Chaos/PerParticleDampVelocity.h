...
public:
	...
	~FPerParticleDampVelocity() = default;

	void UpdatePositionBasedState(const FSolverParticles& Particles, const int32 Offset, const int32 Range);
	UE_INTERNAL CHAOS_API void UpdatePositionBasedState(const FSolverParticlesRange& Particles);
	...
	UE_INTERNAL CHAOS_API void SetProperties(
