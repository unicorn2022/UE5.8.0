...
struct FErrorInterpolationSettings
{
	...
	{}
	~FErrorInterpolationSettings() = default;
...
struct FProxyInterpolationBase
{
	...
	{}
	virtual ~FProxyInterpolationBase() = default;
...
public:
	...
	virtual void AccumulateErrorXR(const Chaos::FVec3 X, const FQuat R, const int32 CurrentSimTick, const int32 ErrorSmoothDuration) { }
	...
	* @param ErrorDirectionalDecayMultiplier is a multiplier where 0.25 means a 25% decay along the direction of physics movement that aligns with the error offset direction, parameter gets overridden if there are custom settings for this particle */
	...
	/** Get FErrorInterpolationSettings which stores custom settings for render interpolation error corrections, returns nullptr if there are no custom settings */
	virtual const FErrorInterpolationSettings* GetErrorInterpolationSettings() const { return nullptr; }

	/** Reset FErrorInterpolationSettings */
	virtual void ResetErrorInterpolationSettings() { }
};
...
struct FProxyInterpolationError : FProxyInterpolationBase
{
	...
	{}
	virtual ~FProxyInterpolationError() = default;
	...
	CHAOS_API virtual void AccumulateErrorXR(const Chaos::FVec3 X, const FQuat R, const int32 CurrentSimTick, const int32 ErrorSmoothDuration) override;
...
public:
	...
	virtual const FErrorInterpolationSettings* GetErrorInterpolationSettings() const override
    {
		return ErrorInterpolationSettings.Get();
	}

	virtual void ResetErrorInterpolationSettings() override
	{
		ErrorInterpolationSettings.Reset();
	}	
...
struct FProxyInterpolationErrorVelocity : FProxyInterpolationError
{
	...
	{}
	virtual ~FProxyInterpolationErrorVelocity() = default;
