...
namespace Chaos
{
	...
	*/
	...
	enum class EResimType : uint8
	{
		...
		FrozenDuringResim = 2, // this particle is "frozen" (made kinematic), updates and integration should be skipped
	...
	public:
		...
		virtual ~TGeometryParticlesImp() = default;
	...
	public:
		...
		void UpdateWorldSpaceState(const int32 Index, const FRigidTransform3& WorldTransform, const FVec3& BoundsExpansion)
		{
			...
			ensureMsgf(MWorldSpaceInflatedBounds[Index].IsValid(), TEXT("Invalid world space inflated bounds. %s, BoundsExpansion(%s)"),
				*MWorldSpaceInflatedBounds[Index].ToString(), *BoundsExpansion.ToString());
		}
		...
		void UpdateWorldSpaceStateSwept(const int32 Index, const FRigidTransform3& WorldTransform, const FVec3& BoundsExpansion, const FVec3& DeltaX)
		{
			...
			ensureMsgf(MWorldSpaceInflatedBounds[Index].IsValid(), TEXT("Invalid world space inflated bounds. %s, BoundsExpansion(%s), DeltaX(%s)"),
				*MWorldSpaceInflatedBounds[Index].ToString(), *BoundsExpansion.ToString(), *DeltaX.ToString());
		}
