...
public:
	...
	explicit FSolverParticlesRange(FSolverParticles& InParticles)
		: TParticlesRange<FSolverParticles>(&InParticles, 0, InParticles.Size())
	{}

	explicit FSolverParticlesRange(const FSolverParticles& InParticles)
		: TParticlesRange<FSolverParticles>(const_cast<FSolverParticles*>(&InParticles), 0, InParticles.Size())
	{}
