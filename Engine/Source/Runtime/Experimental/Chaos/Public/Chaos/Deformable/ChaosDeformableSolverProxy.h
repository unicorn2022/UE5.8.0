...
namespace Chaos::Softs
{
	...
	public:
		...
		FThreadingProxy(const UObject* InOwner = nullptr, FName InTypeName = FName())
			...
			, TypeName(InTypeName)
		{}
		virtual ~FThreadingProxy() = default;
	...
	public:
		...
		virtual ~FFleshThreadingProxy() = default;
		...
		public:
			...
			virtual ~FFleshInputBuffer() = default;
		...
		public:
			...
			virtual ~FFleshOutputBuffer() = default;
		...
		public:
			...
			virtual ~FFleshRestartBuffer() = default;
