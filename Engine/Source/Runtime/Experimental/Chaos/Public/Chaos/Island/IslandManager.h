...
namespace Chaos::Private
{
	...
	*/
	...
	public:
		...
		bool IsSleeping() const { return Flags.bIsSleeping; }
	...
	*/
	...
	private:
		...
		CHAOS_API bool ShouldAssignLevels(const FPBDIsland* Island) const;
		...
		// Access to FPBDIslandParticle::Edges
		// Access to FPBDIslandParticle::IslandArrayIndex
		UE_MT_DECLARE_RW_ACCESS_DETECTOR(LocalNodeAccessDetector);

		// Access to FPBDIslandConstraint::Nodes[2], FPBDIslandConstraint::NodeArrayIndices[2]
		// Access to FPBDIslandConstraint::ContainerIndex, FPBDIslandConstraint::IslandArrayIndex
		UE_MT_DECLARE_RW_ACCESS_DETECTOR(LocalEdgeAccessDetector);

		// Access to FPBDIsland::Nodes, FPBDIsland::ContainerEdges
		UE_MT_DECLARE_RW_ACCESS_DETECTOR(LocalIslandAccessDetector);

		// Access to FPBDIslandManager::Nodes
		UE_MT_DECLARE_RW_ACCESS_DETECTOR(GlobalNodesAccessDetector);

		// Access to FPBDIslandManager::Edges
		UE_MT_DECLARE_RW_ACCESS_DETECTOR(GlobalEdgesAccessDetector);
	};
