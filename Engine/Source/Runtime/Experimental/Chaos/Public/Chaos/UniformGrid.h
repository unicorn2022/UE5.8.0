...
public:
	...
	CHAOS_API void BaseNodeIndex(const TVector<T, 3>& X, TVector<int32, 3>& Index, TVector<T, 3>& weights) const;
	...
	CHAOS_API TVector<T, 3> Node(int32 FlatIndexIn) const;

	CHAOS_API int32 FlatIndex(const TVector<int32, 3>& Index) const;
	...
	CHAOS_API void UpdateGridFromPositions(const Chaos::TDynamicParticles<T, 3>& InParticles);
