...
namespace Chaos
{
	...
	*/
	...
	public:
		...
		// Get the total number of mid phases for all particles
		CHAOS_API int32 GetNumMidPhases() const;

		// Get the number of mid phases involving a particular particle
		CHAOS_API int32 GetNumMidPhases(const FGeometryParticleHandle* Particle) const;
