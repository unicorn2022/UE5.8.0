...
namespace Chaos
{
	...
	public:
		...
		{
			FRealSingle CenterDistanceSquared = FVec3f::DistSquared(Other.GetCenterf(), GetCenterf());
			FRealSingle RadialSum = Other.GetRadiusf() + GetRadiusf();
			return RadialSum * RadialSum >= CenterDistanceSquared;
		}
