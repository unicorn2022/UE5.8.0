...
namespace Chaos
{
	...
	public:
		...
		void MoveToOtherParticles(const TArrayView<int32>& Indices, TParticles<T, d>& Other)
		{
			MoveToOtherArrayCollection(Indices, Other);
			AddDirtyValidation(Indices.Num());
		}
	...
	private:
		...
		/** Increase the dirty validation count by NumDirty */
		void AddDirtyValidation(const int32 NumDirty)
		{
#if PARTICLE_ITERATOR_RANGED_FOR_CHECK
			MDirtyValidationCount += NumDirty;
#endif
		}
