...
namespace Chaos
{
	...
	public:
		...
		UE_DEPRECATED(5.8, "Use GetCombinedShapeFilterData instead")  FCollisionFilterData GetQueryData() const;
		UE_DEPRECATED(5.8, "Use SetCombinedShapeFilterData instead")  void SetQueryData(const FCollisionFilterData& InQueryData);

		UE_DEPRECATED(5.8, "Use GetCombinedShapeFilterData instead") FCollisionFilterData GetSimData() const;
		UE_DEPRECATED(5.8, "Use SetCombinedShapeFilterData instead") void SetSimData(const FCollisionFilterData& InSimData);
		...
		UE_DEPRECATED(5.8, "Get/SetCombinedShapeFilterData instead")
	...
	public:
		...
		UE_DEPRECATED(5.8, "Use GetCombinedShapeFilterData instead") FCollisionFilterData GetQueryData() const { return CollisionData.Read().GetQueryData(); }
		UE_DEPRECATED(5.8, "Use SetCombinedShapeFilterData instead") void SetQueryData(const FCollisionFilterData& InQueryData)
		{
			CollisionData.Modify(true, DirtyFlags, Proxy, ShapeIdx, [InQueryData](FCollisionData& Data) { Data.SetQueryData(InQueryData); });
		}

		UE_DEPRECATED(5.8, "Use GetCombinedShapeFilterData instead") FCollisionFilterData GetSimData() const { return CollisionData.Read().GetSimData(); }
		UE_DEPRECATED(5.8, "Use SetCombinedShapeFilterData instead") void SetSimData(const FCollisionFilterData& InSimData)
		{
	...
	public:
		...
		PRAGMA_DISABLE_DEPRECATION_WARNINGS
		UE_DEPRECATED(5.8, "Use GetCombinedShapeFilterData instead") FCollisionFilterData GetQueryData() const { return CollisionData.GetQueryData(); }
		UE_DEPRECATED(5.8, "Use SetCombinedShapeFilterData instead") void SetQueryData(const FCollisionFilterData& InQueryData) { CollisionData.SetQueryData(InQueryData); }

		UE_DEPRECATED(5.8, "Use GetCombinedShapeFilterData instead") FCollisionFilterData GetSimData() const { return CollisionData.GetSimData(); }
		UE_DEPRECATED(5.8, "Use SetCombinedShapeFilterData instead") void SetSimData(const FCollisionFilterData& InSimData) { CollisionData.SetSimData(InSimData); }
		PRAGMA_ENABLE_DEPRECATION_WARNINGS
		...
		template <typename Lambda>
		UE_DEPRECATED(5.8, "Get/SetCombinedShapeFilterData instead")
		void ModifySimData(const Lambda& LambdaFunc) { LambdaFunc(CollisionData.SimData); }
		PRAGMA_ENABLE_DEPRECATION_WARNINGS
		...
		FMaterialData& GetMaterialDataImpl()
		{
			if (bIsSingleMaterial)
			{
				...
				if (ExistingMaterial.IsValid())
				{
					...
					UE_LOGF(LogChaos, Warning, "Perf/memory warning: request for Material Array on single-material ShapeInstance");
	...
	inline FCollisionFilterData FPerShapeData::GetQueryData() const
	{
		PRAGMA_DISABLE_DEPRECATION_WARNINGS
		return DownCast([](const auto& ShapeInstance) -> FCollisionFilterData { return ShapeInstance.GetQueryData(); });
		PRAGMA_ENABLE_DEPRECATION_WARNINGS
	}
	...
	inline FCollisionFilterData FPerShapeData::GetSimData() const
	{
		PRAGMA_DISABLE_DEPRECATION_WARNINGS
		return DownCast([](const auto& ShapeInstance) -> FCollisionFilterData { return ShapeInstance.GetSimData(); });
		PRAGMA_ENABLE_DEPRECATION_WARNINGS
	}
