...
// Linker tables written under __PackageSummary in UE_INTERNAL_UNIVERSAL_PLACEHOLDERS
// builds, where placeholder stubs hide import class/outer information from the object
// graph.  Encoding the raw tables makes every name and reference auditable from the JSON.
#define UE_JSON_LINKER_NAME_TABLE_KEY_TCHAR   TEXT("PackageNameTable")
#define UE_JSON_LINKER_IMPORT_TABLE_KEY_TCHAR TEXT("PackageImportTable")