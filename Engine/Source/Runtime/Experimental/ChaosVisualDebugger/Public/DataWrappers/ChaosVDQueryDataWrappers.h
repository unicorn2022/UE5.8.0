...
struct FChaosVDCollisionObjectQueryParams : public FChaosVDWrapperDataBase
{
	...
	FChaosVDCollisionObjectQueryParams() = default;
	FChaosVDCollisionObjectQueryParams(const FChaosVDCollisionObjectQueryParams&) = default;
	FChaosVDCollisionObjectQueryParams(FChaosVDCollisionObjectQueryParams&&) = default;
	FChaosVDCollisionObjectQueryParams& operator=(const FChaosVDCollisionObjectQueryParams&) = default;
	FChaosVDCollisionObjectQueryParams& operator=(FChaosVDCollisionObjectQueryParams&&) = default;
	...
	void CopyFrom(const TOther& Other)
	{
		...
		ObjectTypesToQuery64 = Other.GetObjectTypesToQuery();
	...
	UE_DEPRECATED(5.8, "ObjectTypesToQuery has been deprecated")
	UPROPERTY(meta = (DeprecatedProperty, DeprecationMessage = "ObjectTypesToQuery has been deprecated"))
	uint8 ObjectTypesToQuery_DEPRECATED = 0;
	#endif // WITH_EDITORONLY_DATA

	UE_INTERNAL uint64 ObjectTypesToQuery64 = 0;
