...
bool FChaosVDCollisionObjectQueryParams::Serialize(FArchive& Ar)
{
	...
	{
		uint8 OldObjectTypesToQuery;
		Ar << OldObjectTypesToQuery;
		ObjectTypesToQuery64 = OldObjectTypesToQuery;

#if WITH_EDITORONLY_DATA
		PRAGMA_DISABLE_DEPRECATION_WARNINGS
		ObjectTypesToQuery_DEPRECATED = OldObjectTypesToQuery;
		PRAGMA_ENABLE_DEPRECATION_WARNINGS
#endif // WITH_EDITORONLY_DATA
	}
	else
	{
		Ar << ObjectTypesToQuery64;
	}
	Ar << IgnoreMask;
