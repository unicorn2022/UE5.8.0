...
public:
	...
	virtual ~FQueuedLocalFileRequest() = default;
...
public:
	...
	/** Current stream Archive */
	TSharedPtr<FArchive> LocalFileAr;
	...
	TFunction<void(TFunction<void()> Complete)> PostHeaderDownloaded = [](TFunction<void()> Complete) { Complete(); };
...
protected:
	...
	FString GetLocalPlayerUniqueNetId() const;
