...
{
	static const FString DefaultFactoryName = "LocalFileNetworkReplayStreaming";
...
{
	static const FString Attrib_StreamerState = "StreamerState";
	static const FString Attrib_ReplayName = "ReplayName";
	static const FString Attrib_LengthInMS = "LengthInMS";
