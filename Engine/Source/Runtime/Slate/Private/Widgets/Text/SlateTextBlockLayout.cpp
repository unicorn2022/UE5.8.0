...
{
	if (!TextLayout || TextLayout->IsEmpty())
	{
		return LayerId;
	}
...
void FSlateTextBlockLayout::SetOnAllFontFacesFinishLoading(const FSimpleDelegate& InAllFontFacesFinishLoading)
{
	if (TextLayout)
	{
		TextLayout->SetOnAllFontFacesFinishLoading(InAllFontFacesFinishLoading);
	}
}

void FSlateTextBlockLayout::SetFontFacesLoadingPaintPolicy(EFontFacesLoadingPaintPolicy InFontFacesLoadingPaintPolicy)
{
	if (TextLayout)
	{
