...
void STextBlock::Construct( const FArguments& InArgs )
{
	...
	//if(!bSimpleTextMode)
	{
		...
		TextLayoutCache->SetFontFacesLoadingPaintPolicy(InArgs._FontFacesLoadingPaintPolicy);
	}

	if (InArgs._OnAllFontFacesFinishLoading.IsBound() && TextLayoutCache)
	{
		TextLayoutCache->SetOnAllFontFacesFinishLoading(InArgs._OnAllFontFacesFinishLoading);
	}
}
...
void STextBlock::SetTextStyle(const FTextBlockStyle* InTextStyle, bool bUpdateTextLayout)
{
	if (InTextStyle)
	{
...
void STextBlock::SetFontFacesLoadingPaintPolicy(EFontFacesLoadingPaintPolicy InFontFacesLoadingPaintPolicy)
{
	if (TextLayoutCache)
	{
		TextLayoutCache->SetFontFacesLoadingPaintPolicy(InFontFacesLoadingPaintPolicy);
	}
}
