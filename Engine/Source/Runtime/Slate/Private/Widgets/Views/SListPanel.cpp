...
{
	int32 OldPreferredNumLines = PreferredNumLines;
	...
	if (OldPreferredNumLines != PreferredNumLines)
	{
...
{
	if (FirstLineScrollOffset != InFirstLineScrollOffset)
	{
...
{
	if (OverscrollAmount != InOverscrollAmount)
	{
