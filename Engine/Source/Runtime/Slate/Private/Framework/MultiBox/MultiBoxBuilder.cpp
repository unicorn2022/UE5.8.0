...
void FToolBarBuilder::AddToolBarButton(const FButtonArgs& Args)
{
	...
	if (Args.VisibilityOverride.IsSet())
	{
		NewToolBarButtonBlock->SetVisibilityOverride(Args.VisibilityOverride);
	}	
...
TSharedPtr<FToolBarComboButtonBlock> FToolBarBuilder::AddComboButton(
	const FUIAction& InAction,
...
)
{
	...
	return NewToolBarComboButtonBlock;
}
