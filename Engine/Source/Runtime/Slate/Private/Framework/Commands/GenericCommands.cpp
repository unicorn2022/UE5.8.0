...
void FGenericCommands::RegisterCommands()
{
	...
	UI_COMMAND(Redo, "Redo", "Redo last action", EUserInterfaceActionType::Button, FInputChord(EModifierKey::Control, EKeys::Y), FInputChord(EModifierKey::Control | EModifierKey::Shift, EKeys::Z))
