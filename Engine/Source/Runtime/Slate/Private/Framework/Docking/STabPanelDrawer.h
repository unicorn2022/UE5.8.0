...
private:
	...
	FMargin GetTabLabelOverlayPadding() const;
	FOptionalSize GetTabLabelOverlayMaxSize() const;
	...
	TWeakPtr<SWidget> TabLabelOverlay;
	TWeakPtr<SWidget> OpenTabInNewWindowButton;
	TWeakPtr<SWidget> ButtonSpacer;
	TWeakPtr<SWidget> DismissButton;
