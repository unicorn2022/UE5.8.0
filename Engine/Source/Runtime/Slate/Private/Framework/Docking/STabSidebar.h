...
public:
	...
	/**
	 * Attempt to dismiss a drawer in the sidebar for a specified tab
	 *
	 * @return true if the passed in tab is contained in this sidebar and was dismissed
	 */
	bool TryDismissSidebarDrawer(TSharedRef<SDockTab> ForTab);

	/**
	 * Attempt to toggle a drawer in the sidebar for a specified tab
	 *
	 * @return true if the passed in tab is contained in this sidebar and was toggled
	 */
	bool TryToggleSidebarDrawer(TSharedRef<SDockTab> ForTab);
private:
