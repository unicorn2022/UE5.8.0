...
/** Invoked when the touch has started.  */
DECLARE_DELEGATE(FOnTouchStart);

/** Invoked when the touch has moved.  */
DECLARE_DELEGATE(FOnTouchMove);

/** Invoked when the touch has ended.  */
DECLARE_DELEGATE(FOnTouchEnd);
...
/** A Delegate for an debug object to access */
DECLARE_DELEGATE_RetVal_OneParam(bool, FAccessDebugObject, UObject* /*InObject*/);
