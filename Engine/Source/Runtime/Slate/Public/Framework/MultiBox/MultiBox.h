...
template <>
struct TWidgetTypeTraits<class SMultiBlockBaseWidget>
{
...
template <>
struct TWidgetTypeTraits<class SMultiBoxWidget>
{
	static constexpr bool SupportsInvalidation() { return true; }
};
...
public:
	 ...
	 */
	void SetMultiBox( const TSharedRef< FMultiBox >& InMultiBox )
	{
		MultiBox = InMultiBox;
	}
	...
	*/
	void SetMaxHeight(TAttribute<float> InMaxHeight) { MaxHeight = MoveTemp(InMaxHeight); }
