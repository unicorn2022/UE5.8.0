...
public:
	...
	*/
	...
	/**
	* @param InDelegate A delegate to access debug objects with.
	*/
	virtual void SetDebugObjectAccessDelegate(FAccessDebugObject InDelegate) = 0;
...
public:
	...
	/** Virtual destructor. */
	virtual ~IWidgetReflector( ) = default;
};
