...
template <>
struct TWidgetTypeTraits<class SWidgetSwitcher>
{
...
class SWidgetSwitcher
	: public SPanel
{
	SLATE_DECLARE_WIDGET_API(SWidgetSwitcher, SPanel, SLATE_API)
public:
...
private:
	void SetActiveWidgetIndexInternal();

	/** Holds the desired widget index */
	TSlateAttribute<int32> WidgetIndex;
	...
	TOneDynamicChildBase<FSlot, TSlateAttribute<int32>> OneDynamicChild;
