...
template<>
struct TWidgetTypeTraits<class SExpandableArea>
{
...
public:
	 ...
	 */
	UE_DEPRECATED(5.8, "Changing the style needs to update other properties. Use SetStyle if the style has changed")
	SLATE_API void InvalidateStyle();

	/**
	 * Invalidates the border brush
	 */
	UE_DEPRECATED(5.8, "No need to call this function anymore, use SetBorderBrush")
