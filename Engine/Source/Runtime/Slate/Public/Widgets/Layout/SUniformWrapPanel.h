...
template <>
struct TWidgetTypeTraits<class SUniformWrapPanel>
{
...
public:
	...
	struct FSlot : public TWidgetSlotWithAttributeSupport<FSlot>, public TAlignmentWidgetSlotMixin<FSlot>
	{
		FSlot()
		...
		SLATE_SLOT_BEGIN_ARGS_OneMixin(FSlot, TWidgetSlotWithAttributeSupport<FSlot>, TAlignmentWidgetSlotMixin<FSlot>)
		SLATE_SLOT_END_ARGS()
