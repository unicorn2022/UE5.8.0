...
public:
	...
	SLATE_BEGIN_ARGS(SRadialBox)
		...
		/** How much space to leave between the widgets and the edge of the panel */
		SLATE_ARGUMENT(float, MarginSize)
	...
	void SetClockwiseOrder(bool bInClockwiseOrder) { bClockwiseOrder = bInClockwiseOrder; }
	SLATE_API void SetSectorCentralAngle(float InSectorCentralAngle);
	void SetMarginSize(float InMarginSize) { MarginSize = InMarginSize; }
