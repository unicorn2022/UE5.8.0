...
template <>
struct TWidgetTypeTraits<class SEditableTextBox>
{
...
public:
	 ...
	 */
	SLATE_API void SetTextBoxForegroundColor(TAttribute<FSlateColor> InForegroundColor);
	 ...
	 */
	SLATE_API void SetTextBoxBackgroundColor(TAttribute<FSlateColor> InBackgroundColor);
	 ...
	 */
	SLATE_API void SetReadOnlyForegroundColor(TAttribute<FSlateColor> InReadOnlyForegroundColor);
	 ...
	 */
	SLATE_API void SetFocusedForegroundColor(TAttribute<FSlateColor> InFocusedForegroundColor);
	 ...
	 */
	SLATE_API void SetMinimumDesiredWidth(TAttribute<float> InMinimumDesiredWidth);
...
protected:
	...
	/** Callback when the user's cursor position and/or selection has changed. */
	SLATE_API void OnEditableTextCursorMovedWithSelection(const FTextLocation& InLocation, const FTextSelection& TextSelection);
	...
	/** Callback when the user's selection and/or cursor position of the text has changed. */
	FOnCursorMovedWithSelection OnCursorMovedWithSelection;
...
private:
	...
	const FSlateBrush* DetermineBorderImage() const;
