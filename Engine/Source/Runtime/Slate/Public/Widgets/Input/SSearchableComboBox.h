...
template <>
struct TWidgetTypeTraits<class SSearchableComboBox>
{
...
public:
	 ...
	 */
	SLATE_API void SetSelectedItem(TSharedPtr<FString> InSelectedItem, ESelectInfo::Type InSelectInfo = ESelectInfo::OnNavigation);

	/** @return the item currently selected by the combo box. */
	SLATE_API TSharedPtr<FString> GetSelectedItem();
...
protected:
	...
	SLATE_API void SetOptionsSource(const TArray< TSharedPtr<FString> >* InOptionsSource);
...
private:
	...
	SLATE_API virtual FReply OnButtonClicked() override;
