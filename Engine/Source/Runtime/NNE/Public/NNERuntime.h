...
public:
	 ...
	 * @param AdditionalFileData Additional raw binary data of the neural network model. Can be passed to UNNEModelData::DeserializeRuntimeSettings.
	 ...
	 * @return Ok if the runtime is able to create model data, FailFileIdNotSupported if this fileId is not supported and Fail otherwise.
	 */
	 ...
	 * 
	 * @return A new instance of the runtime settings or nullptr if runtime settings are not supported by this runtime.
	 */
