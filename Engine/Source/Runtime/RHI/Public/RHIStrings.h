...
RHI_API const TCHAR* GetDescriptorTypeString(ERHIDescriptorType InDescriptorType);
RHI_API FString GetDescriptorMaskString(ERHIDescriptorTypeMask InTypeMask);
...
inline FName GetRenderQueryTypeName(ERenderQueryType QueryType)
{
	switch (QueryType)
	{
	default: checkNoEntry(); // fallthrough
	case RQT_Undefined:		{ static const FName Name(TEXT("Undefined"));      return Name; }
	case RQT_Occlusion:		{ static const FName Name(TEXT("GPUOcclusion"));    return Name; }
	case RQT_AbsoluteTime:	{ static const FName Name(TEXT("GPUAbsoluteTime")); return Name; }
	}
}
