...
struct FPipelineCacheFileFormatPSO
{
	...
	struct GraphicsDescriptor
	{
		...
		FShaderHash FragmentShader;
		FShaderHash GeometryShader;
		FShaderHash MeshShader;
		FShaderHash AmplificationShader;
	...
	static bool Init(FPipelineCacheFileFormatPSO& PSO, FComputePipelineStateInitializer const& Init, EPSOPrecacheResult PSOPrecacheResult);
	static bool Init(FPipelineCacheFileFormatPSO& PSO, FGraphicsPipelineStateInitializer const& Init, EPSOPrecacheResult PSOPrecacheResult);
...
public:
	...
	*/
	...
	RHI_API static void CacheGraphicsPSO(uint32 RunTimeHash, FGraphicsPipelineStateInitializer const& Initializer, EPSOPrecacheResult PSOPrecacheResult, FPipelineStateStats** OutStats = nullptr);
	RHI_API static void CacheComputePSO(uint32 RunTimeHash, FComputePipelineStateInitializer const& Initializer, EPSOPrecacheResult PSOPrecacheResult, FPipelineStateStats** OutStats = nullptr);
...
private:
	...
	static void LogNewGraphicsPSOToConsoleAndCSV(FPipelineCacheFileFormatPSO& PSO, uint32 PSOHash, EPSOPrecacheResult PSOPrecacheResult);
	static void LogNewComputePSOToConsoleAndCSV(FPipelineCacheFileFormatPSO& PSO, uint32 PSOHash, EPSOPrecacheResult PSOPrecacheResult);
...
private:
	...
	static TMap<uint32, FPipelineCacheFileFormatPSO> NewPSOs;
