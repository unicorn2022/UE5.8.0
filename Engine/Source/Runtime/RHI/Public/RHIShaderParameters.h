...
struct FRHIShaderParameterResource
{
	...
	FRHIShaderParameterResource(FRHIDescriptorRange* InDescriptorRange, uint16 InIndex)
		: FRHIShaderParameterResource(FRHIShaderParameterResource::EType::DescriptorRange, InDescriptorRange, InIndex)
	{
	}
...
struct FRHIBatchedShaderParameters
{
	...
	inline void SetBindlessShaderUniformBuffer(FRHIUniformBuffer* UniformBuffer)
	{
		AddBindlessParameter(UniformBuffer, (uint16)0);
	}
	...
	inline void SetDescriptorRange(uint32 Index, FRHIDescriptorRange* DescriptorRange)
	{
		AddResourceParameter(DescriptorRange, (uint16)Index);
	}
