	...
	FQueuedThreadPool& Get()
	{
		if (PSOPrecompileCompileThreadPool.load() == nullptr)
		{
			...
			if (PSOPrecompileCompileThreadPool.load() == nullptr)
			{
				...
				FQueuedThreadPool* PSOPrecompileCompileThreadPoolLocal = FPSOQueuedThreadPoolWrapper::Allocate();
				...
				PSOPrecompileCompileThreadPool = new FPSOQueuedThreadPoolWrapper(PSOPrecompileCompileThreadPoolLocal);
			}
		}
