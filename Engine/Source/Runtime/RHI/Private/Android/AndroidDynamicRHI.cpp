...
namespace UE
{
	namespace FAndroidPlatformDynamicRHI
	{
		...
		static FRHIOnWindowCreatedCallbackType OnRHIWindowCreatedCallback;

		FRHIOnWindowCreatedCallbackType& GetRHIOnWindowCreatedCallback()
		{
			return OnRHIWindowCreatedCallback;
		}

		void SetRHIOnWindowCreatedCallback(FRHIOnWindowCreatedCallbackType&& InOnWindowCreatedCallback)
		{
			OnRHIWindowCreatedCallback = MoveTemp(InOnWindowCreatedCallback);
		}
