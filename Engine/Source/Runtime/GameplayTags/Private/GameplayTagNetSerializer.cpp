...
void FGameplayTagNetSerializer::Quantize(FNetSerializationContext& Context, const FNetQuantizeArgs& Args)
{
	...
	else
	{
		...
		{
			UE_LOGF(LogGameplayTags, Error, "FGameplayTagNetSerializer::Quantize Could not find required FGameplayTagTokenStore");
			ensure(false);
		}
	}
}
...
void FGameplayTagNetSerializer::Dequantize(FNetSerializationContext& Context, const FNetDequantizeArgs& Args)
{
	...
	else
	{
		...
		{
			UE_LOGF(LogGameplayTags, Error, "FGameplayTagNetSerializer::Dequantize Could not find required FGameplayTagTokenStore");
			ensure(false);
