...
class FNullInstallBundleManager final : public IInstallBundleManager
{
	...
	virtual EInstallBundleResult GetAllMountedBundles(TArray<FName>& OutBundleNames) const override
	{
		return EInstallBundleResult::OK;
	}

	virtual EInstallBundleResult GetAllBundlesWithState(EInstallBundleInstallState InstallState, TArray<FName>& OutBundleNames) const override
	{
		return EInstallBundleResult::OK;
	}
