...
#pragma warning restore CS1591
	...
	public class BgScriptSchema
	{
		...
		static XmlSchemaType CreateNodeType()
		{
			...
			extension.Attributes.Add(CreateSchemaAttribute("OptionalRequires", ScriptSchemaStandardType.NameOrTagList, XmlSchemaUse.Optional));
			...
			extension.Attributes.Add(CreateSchemaAttribute("AllowRetry", ScriptSchemaStandardType.Boolean, XmlSchemaUse.Optional));
