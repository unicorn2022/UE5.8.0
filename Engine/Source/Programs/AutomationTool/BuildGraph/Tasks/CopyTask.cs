...
namespace AutomationTool.Tasks
{
	...
	public class CopyTaskParameters
	{
		...
		/// <summary>
		/// Whether copied files should be tagged in the default set.
		/// </summary>
		[TaskParameter(Optional = true)]
		public bool TagInDefaultSet { get; set; } = true;
	}
	...
	public class CopyTask : BgTaskImpl
	{
		...
		public override async Task ExecuteAsync(JobContext job, HashSet<FileReference> buildProducts, Dictionary<string, HashSet<FileReference>> tagNameToFileSet)
		{
			...
			try
			{
				...
				// Eventually this should be removed once we confirm all our copies do not require the implicit tagging.
				if (_parameters.TagInDefaultSet)
				{
