...
namespace AutomationTool.Tasks
{
	...
	public class RetrieveArtifactTaskParameters
	{
		...
		/// <summary>
		/// Whether or not to throw an error if the artifact was not found
		/// </summary>
		/// <remarks>For backwards compatibility defaults to true</remarks>
		[TaskParameter(Optional = true)]
		public bool ErrorIfNotFound { get; set; } = true;
	...
	public class RetrieveArtifactTask : BgTaskImpl
	{
		...
		public override async Task ExecuteAsync(JobContext job, HashSet<FileReference> buildProducts, Dictionary<string, HashSet<FileReference>> tagNameToFileSet)
		{
			...
			if (artifact == null)
			{
				...
				{
					Logger.LogInformation("Unable to find any artifact matching given criteria.");
				}
				return;
			}
