...
namespace AutomationTool.Tasks
{
	...
	public class CreateArtifactTask : BgTaskImpl
	{
		...
		/// <summary> The name of the artifact we are uploading. </summary>
		protected ArtifactName Name { get; private set; }

		/// <summary> The type of the artifact being uploaded </summary>
		protected ArtifactType Type { get; private set; }

		/// <summary> Stream Id resolved from parameters or environment variable </summary>
		protected StreamId? StreamId { get; private set; }

		/// <summary> Commit Id resolved from parameters or environment variable </summary>
		protected CommitId? CommitId { get; private set; }
		...
		public CreateArtifactTask(CreateArtifactTaskParameters parameters)
		{
			...
			Type = new ArtifactType(_parameters.Type);
		}
		...
		public override async Task ExecuteAsync(JobContext job, HashSet<FileReference> buildProducts, Dictionary<string, HashSet<FileReference>> tagNameToFileSet)
		{
			...
			IArtifactBuilder artifact = await hordeClient.Artifacts.CreateAsync(Name, Type, _parameters.Description, StreamId.Value, CommitId, keys, metadata);
