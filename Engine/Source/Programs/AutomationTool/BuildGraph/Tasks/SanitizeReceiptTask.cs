			...
			foreach (FileReference targetFile in targetFiles)
			{
				...
				using (new LogIndentScope("  "))
				{
					...
					foreach (BuildProduct buildProduct in receipt.BuildProducts)
					{
						...
						{
							Logger.LogInformation("Removing build product: {BuildProduct}", buildProduct.Path);
						}
					}
					...
					foreach (RuntimeDependency runtimeDependency in receipt.RuntimeDependencies)
					{
						...
						{
							Logger.LogInformation("Removing runtime dependency: {RuntimeDependency}", runtimeDependency.Path);
						}
					}
