...
namespace Gauntlet
{
	...
	public interface ITargetDevice : IDisposable
	{
		...
		/// <summary>
		/// Take a screenshot using device soft
		/// Filename is saved in the format of: yy-MM-dd-HH-mm-ss-ff
		/// </summary>
		public void TakeScreenshot(string ScreenshotName) 
		{
			Log.Warning(KnownLogEvents.Gauntlet_TestEvent, "Screenshot capture is not implemented");
		}
