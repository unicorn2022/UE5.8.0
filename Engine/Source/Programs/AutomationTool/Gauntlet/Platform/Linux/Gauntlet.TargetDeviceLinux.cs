...
{
	/// <summary>
	/// Linux Implementation of the Linux Platform Support
	/// </summary>
	public class LinuxPlatformSupport : TargetPlatformSupportBase
	{
	...
	public class TargetDeviceLinux : TargetDeviceDesktopCommon
	{
		...
		protected override IAppInstall InstallStagedBuild(UnrealAppConfig AppConfig, StagedBuild InBuild)
		{
			...
			LinuxApp.WorkingDirectory = Path.GetDirectoryName(LinuxApp.ExecutablePath);
