...
namespace EpicGames.Serialization.Tests
{
	...
	public class JupiterTests
	{
		...
		public void WriteArray()
		{
			...
			ReadOnlyMemory<byte> memory = new(objectData);
			CbField o = new(memory);
			...
			IoHash[] blobs = [.. blobList.Select(field => field.AsHash())];
