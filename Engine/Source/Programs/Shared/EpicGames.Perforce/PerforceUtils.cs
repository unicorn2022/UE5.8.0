...
namespace EpicGames.Perforce
{
	...
	public static class PerforceUtils
	{
		...
		/// </summary>
		public static readonly HashSet<string> CodeExtensions =
		[
			".c",
			".cc",
			".cpp",
		...
		public static string GetClientRelativePath(DirectoryReference workspaceRoot, FileReference workspaceFile)
		{
			...
			{
				throw new ArgumentException($"File '{workspaceFile}' is not under workspace root '{workspaceRoot}'", nameof(workspaceFile));
			}
