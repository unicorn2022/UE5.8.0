...
namespace EpicGames.Perforce
{
	...
	public static class PerforceOutput
	{
		...
		{
			public static readonly Utf8String Code = new("code");
			public static readonly Utf8String Stat = new("stat");
			public static readonly Utf8String Info = new("info");
			public static readonly Utf8String Error = new("error");
			public static readonly Utf8String Io = new("io");
			public static readonly Utf8String Func = new("func");
			public static readonly Utf8String IsSparse = new("isSparse");
		}
		...
		/// <returns>Output object</returns>
		public static IPerforceOutput FromResponse(PerforceResponse response) => FromResponses([response]);
		...
		public static async IAsyncEnumerable<PerforceResponse> ReadStreamingResponsesAsync(this IPerforceOutput perforce, Type? statRecordType, [EnumeratorCancellation] CancellationToken cancellationToken)
		{
			...
			List<PerforceResponse> responses = [];
