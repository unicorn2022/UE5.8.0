...
{
	internal const string EnvVar = "EPICGAMES_P4_FIXTURE_SERVER_URL";
	internal const string EdgeEnvVar = "EPICGAMES_P4_FIXTURE_EDGE_SERVER_URL";
	private const string UseDefaultMarker = "default";
	private const string DefaultUrl = "p4://test.user@localhost:1666";
#pragma warning disable CA1823, IDE0051 // Unused field - kept for future use
	private const string DefaultEdgeUrl = "p4://test.user@localhost:1667";
#pragma warning restore CA1823, IDE0051
	...
	{
		return GetPerforceConnection(connectionString, _clientName, LoggerFactory.CreateLogger<PerforceConnection>());
	}

	internal static PerforceConnection GetPerforceConnection(string connectionString, string clientName, ILogger logger)
	{
		...
		return new PerforceConnection(perforceSettings, logger);
	}
