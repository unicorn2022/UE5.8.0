...
namespace EpicGames.UBA
{
	...
	public interface IServer : IBaseInterface
	{
		...
		/// <summary>
		/// Set config (.toml) that should be used by all clients.
		/// </summary>
		/// <param name="config"></param>
		public abstract void SetClientsConfig(IConfig config);
		...
		/// <summary>
		/// Create a null server
		/// </summary>
		public static IServer CreateNullServer() => new NullServer();
	}
}
