...
namespace EpicGames.Redis
{
	...
	{
		static readonly JsonSerializerOptions s_options = new() { PropertyNameCaseInsensitive = true, PropertyNamingPolicy = JsonNamingPolicy.CamelCase };
	...
	public static class RedisSerializer
	{
		...
		static readonly Dictionary<Type, Type> s_typeToConverterType = [];
		...
		static readonly ConcurrentDictionary<Type, IRedisConverter<object>> s_typeToObjectConverter = new();
