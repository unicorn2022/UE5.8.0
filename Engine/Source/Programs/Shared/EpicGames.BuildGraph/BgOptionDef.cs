...
namespace EpicGames.BuildGraph
{
	...
	class BgBoolOptionSerializer : BgObjectSerializer<BgBoolOptionDef>
	{
		...
		{
			BgBoolOptionDef option = new(obj.Get(x => x.Name, null!));
			obj.CopyTo(option);
			return option;
		}
	}
	...
	class BgIntOptionSerializer : BgObjectSerializer<BgIntOptionDef>
	{
		...
		{
			BgIntOptionDef option = new(obj.Get(x => x.Name, null!));
			obj.CopyTo(option);
			return option;
		}
	}
	...
	class BgStringOptionSerializer : BgObjectSerializer<BgStringOptionDef>
	{
		...
		{
			BgStringOptionDef option = new(obj.Get(x => x.Name, null!));
			obj.CopyTo(option);
			return option;
		}
	}
	...
	class BgListOptionSerializer : BgObjectSerializer<BgListOptionDef>
	{
		...
		{
			BgListOptionDef option = new(obj.Get(x => x.Name, null!));
			obj.CopyTo(option);
			return option;
		}
	}
