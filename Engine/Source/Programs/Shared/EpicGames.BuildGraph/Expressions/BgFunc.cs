...
namespace EpicGames.BuildGraph.Expressions
{
		...
		where TResult : BgExpr
	{
		...
		/// </summary>
		public static implicit operator BgFunc<TResult>(Func<TResult> func) => new(func);
		...
		where TResult : BgExpr
	{
		...
		/// Implicit conversion from a regular C# function
		/// </summary>
		public static implicit operator BgFunc<TArg, TResult>(Func<TArg, TResult> func) => new(func);
		...
		where TResult : BgExpr
	{
		...
		/// Implicit conversion from a regular C# function
		/// </summary>
		public static implicit operator BgFunc<TArg1, TArg2, TResult>(Func<TArg1, TArg2, TResult> func) => new(func);
