...
namespace EpicGames.BuildGraph
{
	...
	public class BgObjectDef
	{
		...
		/// <returns></returns>
		public BgObjectDef<T> WithType<T>() => new(Properties);

		/// <summary>
		/// Cache of serializer instances
		/// </summary>
		static readonly ConcurrentDictionary<Type, BgObjectSerializer> s_typeToSerializer = new();
	...
	public class BgObjectDef<T> : BgObjectDef
	{
		...
		{
			Dictionary<string, PropertySetter> nameToProperty = new(StringComparer.Ordinal);
