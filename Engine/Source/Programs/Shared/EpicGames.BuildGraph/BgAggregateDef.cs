...
namespace EpicGames.BuildGraph
{
	...
	public class BgAggregateDef
	{
		...
		/// </summary>
		public HashSet<BgNodeDef> RequiredNodes { get; } = [];
	...
	public class BgAggregateExpressionDef
	{
		...
		public List<BgNodeExpressionDef> RequiredNodes { get; } = [];
		...
		{
			BgAggregateDef aggregate = new(Name);
	...
	class BgAggregateExpressionDefSerializer : BgObjectSerializer<BgAggregateExpressionDef>
	{
		...
		{
			BgAggregateExpressionDef aggregate = new(obj.Get(x => x.Name, ""));
