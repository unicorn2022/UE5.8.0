...
namespace EpicGames.Horde.Tests.Storage
{
	...
	public class StorageNamespaceTests
	{
		...
		class TestNode
		{
			public static BlobType BlobType = new("{99601905-4F6E-A089-03D6-F187711BAFEE}", 1);
		...
		public async Task PacketFlushAsync()
		{
			...
			BundleOptions bundleOptions = new() { MinCompressionPacketSize = 100, MaxBlobSize = 1024 * 1024, MaxVersion = BundleVersion.LatestV2 };
