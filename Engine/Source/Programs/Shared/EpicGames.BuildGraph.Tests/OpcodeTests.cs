...
namespace EpicGames.BuildGraph.Tests
{
	...
	public class OpcodeTests
	{
		...
		public void StrSplit()
		{
			...
			Assert.IsTrue(Enumerable.SequenceEqual((IEnumerable<object>)result, ["1", "2", "3"]));
		}
		...
		public void StrOption()
		{
			...
			Assert.IsTrue(result.Values!.SequenceEqual(["value1", "value2"]));
			Assert.IsTrue(result.ValueDescriptions!.SequenceEqual(["desc1", "desc2"]));
		}
		...
		public void EnumParse()
		{
			...
			Assert.ThrowsExactly<InvalidDataException>(() => Evaluate(BgEnum<TestEnum>.Parse("Other")));
		}
		...
		public void ListEmpty()
		{
			...
			Assert.IsTrue(Enumerable.SequenceEqual([], (IEnumerable<object>)result));
		}
		...
		public void ListPush()
		{
			...
			Assert.IsTrue(Enumerable.SequenceEqual([1], (IEnumerable<object>)result1));

			object result2 = Evaluate(BgList<BgInt>.Empty.Add(1, 2).Add(3));
			Assert.IsTrue(Enumerable.SequenceEqual([1, 2, 3], (IEnumerable<object>)result2));
		}
		...
		public void ListConcat()
		{
			...
			Assert.IsTrue(Enumerable.SequenceEqual([1, 2, 3], (IEnumerable<object>)result));
		}
		...
		public void ListUnion()
		{
			...
			Assert.IsTrue(Enumerable.SequenceEqual([1, 2, 3], (IEnumerable<object>)result1));
		...
		public void ListExcept()
		{
			...
			Assert.IsTrue(Enumerable.SequenceEqual([1, 2], (IEnumerable<object>)result1));

			object result2 = Evaluate(BgList<BgInt>.Create(1, 2, 3).Except(BgList<BgInt>.Create(3)));
			Assert.IsTrue(Enumerable.SequenceEqual([1, 2], (IEnumerable<object>)result2));
		}
		...
		public void ListSelect()
		{
			...
			Assert.IsTrue(Enumerable.SequenceEqual([9, 9, 18, 18, 27], (IEnumerable<object>)result));
		}
		...
		public void ListWhere()
		{
			...
			Assert.IsTrue(Enumerable.SequenceEqual([2, 2, 3], (IEnumerable<object>)result));
		}
		...
		public void Throw()
		{
			Assert.ThrowsExactly<BgBytecodeException>(() => Evaluate(BgExpr.Throw<BgInt>("this is an exception")));
		}
		...
		public void Call()
		{
			BgFunc<BgBool> func = new(() => true);
			object result1 = Evaluate(func.Call());
			Assert.AreEqual(true, result1);

			BgFunc<BgInt, BgInt> func2 = new(x => (x * 3) + 2);
			object result2 = Evaluate(func2.Call(7));
			Assert.AreEqual(23, result2);

			BgFunc<BgInt, BgInt> func3a = new(x => x * 3);
			BgFunc<BgInt, BgInt> func3b = new(x => func3a.Call(x) + 2);
			object result3 = Evaluate(func3b.Call(7));
			Assert.AreEqual(23, result3);

			BgFunc<BgInt, BgInt, BgInt> func4 = new((x, y) => (x + y));
