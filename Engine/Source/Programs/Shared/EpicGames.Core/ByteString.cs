...
namespace EpicGames.Core
{
	...
	public readonly struct ByteString : IEquatable<ByteString>, IComparable<ByteString>
	{
		...
		public static ByteString Parse(ReadOnlySpan<byte> text) => new(StringUtils.ParseHexString(text));
		...
		/// <param name="text">Text to parse</param>
		/// <returns>New byte string instance</returns>
		public static ByteString Parse(string text) => new(StringUtils.ParseHexString(text));
