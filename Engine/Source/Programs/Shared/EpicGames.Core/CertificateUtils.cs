...
namespace EpicGames.Core
{
	...
	public static class CertificateUtils
	{
		...
		public static byte[] CreateSelfSignedCert(string dnsName, string friendlyName)
		{
			...
			{
				X500DistinguishedName distinguishedName = new($"CN={dnsName}");
				CertificateRequest request = new(distinguishedName, algorithm, HashAlgorithmName.SHA256, RSASignaturePadding.Pkcs1);
