...
namespace EpicGames.Core
{
	...
	public record struct UHTTargetSettings
	{
		...
		public readonly void Write(IMemoryWriter writer)
		{
			writer.WriteString(CompiledInObjectFormat.ToString());
			writer.WriteBoolean(GenerateEnumMaxValues);
			writer.WriteBoolean(ValidateModuleDependencies);
		}
		...
		/// <summary>
		/// If true, enable the input cache read
		/// </summary>
		public bool EnableInputCacheRead { get; set; } = false;

		/// <summary>
		/// If true, enable the input cache write
		/// </summary>
