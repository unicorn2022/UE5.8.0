...
namespace EpicGames.Core
{
	...
	public enum EClassFlags : uint
	{
		...
		/// </summary>
		Inherit = Transient | Optional | DefaultConfig | Config | Partial | PerObjectConfig | ConfigDoNotCheckDefaults | NotPlaceable | Const | HasInstancedReference |
		...
		/// </summary>
		SaveInCompiledInClasses = Abstract | DefaultConfig | GlobalUserConfig | ProjectUserConfig | PerPlatformConfig | Config | Transient | Optional | Native | Partial | NotPlaceable | PerObjectConfig |
	...
	public enum EPropertyFlags : ulong
	{
		...
		/// <summary>
		/// Use to force native UCLASS properties to be included in the PostConstructLink chain in a derived Blueprint class, regardless of whether it differs from the native class constructor-initialized value
		/// </summary>
		ForcePostConstructLink = 0x2000000000000000,
	...
	{
		private static readonly Lazy<List<string>> BitNames = new(() =>
		{
			List<string> Out = [];
	...
	public enum EVerseClassFlags : uint
	{
		...
		PersonaConstructible = 0x00004000u,   // This class may be constructed by Persona
		HasVar = 0x00008000u,                 // This class has at least one mutable variable.
		InheritsFromBlueprint = 0x00010000u,  // This class has a blueprint class as (transitive) superclass
		HasTransientSubobjects = 0x00020000u, // This class has a non-serialized reference to an archetype instantiation
