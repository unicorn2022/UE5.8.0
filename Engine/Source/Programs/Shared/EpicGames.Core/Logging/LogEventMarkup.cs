...
#pragma warning disable CS1591
		public static LogValue Channel => new(LogValueType.Channel, "");
		public static LogValue Severity => new(LogValueType.Severity, "");
		public static LogValue Message => new(LogValueType.Message, "");
		public static LogValue LineNumber => new(LogValueType.LineNumber, "");
		public static LogValue ColumnNumber => new(LogValueType.ColumnNumber, "");
		public static LogValue Symbol => new(LogValueType.Symbol, "");
		public static LogValue ErrorCode => new(LogValueType.ErrorCode, "");
		public static LogValue ToolName => new(LogValueType.ToolName, "");
		public static LogValue ScreenshotTest => new(LogValueType.ScreenshotTest, "");
