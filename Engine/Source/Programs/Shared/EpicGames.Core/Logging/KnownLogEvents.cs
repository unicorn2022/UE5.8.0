...
namespace EpicGames.Core
{
	...
	/// </summary>
	[System.Diagnostics.CodeAnalysis.SuppressMessage("Naming", "CA1707:Identifiers should not contain underscores", Justification = "Intentional")]
	public static class KnownLogEvents
	{
		...
		/// UBA message
		/// </summary>
		public static EventId UBA { get; } = new EventId(111);
		...
		/// <summary>
		/// Docker messages that are unactionable and can be ignored
		/// </summary>
		public static EventId Systemic_Docker { get; } = new EventId(771);
		...
		/// <summary>
		/// RaceDetector Sanitizer Error
		/// </summary>
		public static EventId Sanitizer_RaceDetector { get; } = new EventId(803);
