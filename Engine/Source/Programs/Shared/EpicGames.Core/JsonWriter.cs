...
namespace EpicGames.Core
{
	...
	public sealed class JsonWriter : IDisposable
	{
		...
		public JsonWriter(string fileName, JsonWriterStyle style = JsonWriterStyle.Readable)
			: this(new StreamWriter(new FileStream(fileName, FileMode.Create, FileAccess.Write, FileShare.Read)))
		{
			_style = style;
		}
		...
		public JsonWriter(FileReference fileName, JsonWriterStyle style = JsonWriterStyle.Readable)
			: this(new StreamWriter(new FileStream(fileName.FullName, FileMode.Create, FileAccess.Write, FileShare.Read)))
		{
			_style = style;
		}
