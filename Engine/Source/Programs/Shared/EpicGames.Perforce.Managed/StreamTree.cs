...
namespace EpicGames.Perforce.Managed
{
	...
	public class StreamFile
	{
		...
		#region Field names
		static readonly Utf8String s_lengthField = new("len");
		static readonly Utf8String s_digestField = new("dig");
		static readonly Utf8String s_typeField = new("type");
		static readonly Utf8String s_revisionField = new("rev");
		#endregion
		...
		public StreamFile(Utf8String path, CbObject field)
		{
			...
			Md5Hash digest = new(field[s_digestField].AsBinary());
	...
	public class StreamTreeRef
	{
		...
		#region Field names
		static readonly Utf8String s_hashField = new("hash");
		#endregion
	...
	public class StreamTree
	{
		...
		#region Field names
		static readonly Utf8String s_nameField = new("name");
		static readonly Utf8String s_pathField = new("path");
		static readonly Utf8String s_filesField = new("files");
		static readonly Utf8String s_treesField = new("trees");
		#endregion
		...
		public StreamTree(Utf8String path, CbObject @object)
		{
			...
			foreach (CbField fileField in fileArray)
			{
				...
				StreamFile file = new(filePath, fileObject);
			...
			foreach (CbField treeField in treeArray)
			{
				...
				StreamTreeRef tree = new(treePath, treeObject);
