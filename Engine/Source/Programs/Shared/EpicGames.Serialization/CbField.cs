...
namespace EpicGames.Serialization
{
	...
	public readonly struct CbBinaryAttachment(IoHash hash) : IEquatable<CbBinaryAttachment>
	{
		...
		public static implicit operator CbBinaryAttachment(IoHash hash) => new(hash);
	...
	{
		/// <inheritdoc/>
		public override CbBinaryAttachment Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options) => IoHash.Parse(reader.GetUtf8String());
	...
	public readonly struct CbObjectAttachment(IoHash hash) : IEquatable<CbObjectAttachment>
	{
		...
		/// </summary>
		/// <param name="hash">The attachment to convert</param>
		public static implicit operator CbObjectAttachment(IoHash hash) => new(hash);
	...
	{
		/// <inheritdoc/>
		public override CbObjectAttachment Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options) => IoHash.Parse(reader.GetUtf8String());
	...
	public class CbField : IEquatable<CbField>, IEnumerable<CbField>
	{
		...
		/// </summary>
		public Utf8String Name => new(Memory.Slice(_payloadOffset - _nameLen, _nameLen));
		...
		/// <param name="defaultValue"></param>
		/// <returns></returns>
		public TimeSpan AsTimeSpan(TimeSpan defaultValue = default) => new(AsTimeSpanTicks(defaultValue.Ticks));
...
#pragma warning disable CA1043 // Use Integral Or String Argument For Indexers
		public CbField this[CbFieldName name] => this.FirstOrDefault(field => field.Name == name.Text) ?? Empty;
#pragma warning restore CA1043 // Use Integral Or String Argument For Indexers
		...
		public static void WriteField(Utf8JsonWriter writer, CbField field, JsonSerializerOptions options)
		{
			switch (field.GetType())
			{
				...
				case CbFieldType.TimeSpan:
					...
					break;
				default:
					throw new NotImplementedException($"Unhandled type '{field.GetType()}' in cb-json converter");
			}
		}
	}
	...
	public class CbFieldIterator
	{
		...
		public void IterateRangeAttachments(Action<CbField> visitor)
		{
			...
			{
				for (CbFieldIterator it = new(this); it; ++it)
				{
	...
	{
		[DebuggerBrowsable(DebuggerBrowsableState.RootHidden)]
		public object?[] Value => [.. array.Select(x => x.Value)];
	}
	...
	public class CbArray : IEnumerable<CbField>
	{
		...
		/// <param name="field"></param>
		/// <returns></returns>
		public static CbArray FromFieldNoCheck(CbField field) => new(field);
	...
	class CbObjectDebugView(CbObject obj)
	{
		...
		[DebuggerBrowsable(DebuggerBrowsableState.RootHidden)]
		public Property[] Properties => [.. obj.Select(x => new Property { Name = x.Name.ToString(), Value = x.Value })];
	}
	...
	public class CbObject : IEnumerable<CbField>
	{
		...
		/// Empty array constant
		/// </summary>
		public static CbObject Empty { get; } = FromFieldNoCheck(new CbField(new byte[] { (byte)CbFieldType.Object, 0 }));
...
#pragma warning restore CA1043 // Use Integral Or String Argument For Indexers
		...
		/// <param name="field"></param>
		/// <returns></returns>
		public static CbObject FromFieldNoCheck(CbField field) => new(field);
