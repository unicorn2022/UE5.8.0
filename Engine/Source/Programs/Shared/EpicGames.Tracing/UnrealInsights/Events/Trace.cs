...
namespace EpicGames.Tracing.UnrealInsights.Events
{
	...
	{
		public static readonly EventType EventType = new(0, "$Trace", "NewTrace", EventType.FlagImportant | EventType.FlagNoSync,
			[
	...
	{
		public static readonly EventType EventType = new(0, "$Trace", "ThreadInfo", EventType.FlagImportant | EventType.FlagMaybeHasAux | EventType.FlagNoSync,
			[
