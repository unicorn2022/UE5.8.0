...
namespace EpicGames.Tracing.UnrealInsights.Events
{
	public class Field
	{
		...
		public static Field FromBool(bool value) => new(value);
		public static Field FromInt(int value) => new(value);
		public static Field FromLong(long value) => new(value);
		public static Field FromFloat(float value) => new(value);
		public static Field FromDouble(double value) => new(value);
		public static Field FromString(string value) => new(value);
		public static Field FromArray(byte[] value) => new(value);
	}
