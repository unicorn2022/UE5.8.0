...
namespace EpicGames.Tracing.UnrealInsights
{
	...
	{
		public Dictionary<ushort, EventType> EventTypes { get; } = [];
		public Dictionary<ushort, List<ITraceEvent>> EventsPerThread { get; } = [];
		...
		public void Read(Stream stream)
		{
			...
			void ReadThreadStream(ushort threadId)
			{
				...
				using BinaryReader threadReader = new(threadStream);
		...
		{
			Dictionary<ushort, MemoryStream> threadStreams = [];
		...
		{
			Dictionary<ushort, List<ITraceEvent>> eventsPerUid = [];
