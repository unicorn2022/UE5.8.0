...
namespace EpicGames.AspNet
{
	...
	public static partial class CustomMediaTypeNames
	{
		...
		/// <summary>
		/// Media type for Jupiter inline payload
		/// </summary>
	...
	public class CbInputFormatter : InputFormatter
	{
		...
		/// <summary>
		/// Formats a byte array as a hexadecimal dump with line breaks every 16 bytes
		/// </summary>
		/// <param name="data">The byte array to format</param>
		/// <param name="maxLength">Maximum number of bytes to include in the dump</param>
		/// <returns>Formatted hexadecimal string with whitespace and line breaks</returns>
