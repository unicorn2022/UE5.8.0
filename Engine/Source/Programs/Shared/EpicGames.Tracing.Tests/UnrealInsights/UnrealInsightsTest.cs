...
namespace EpicGames.Tracing.Tests.UnrealInsights
{
	...
	public class UnrealInsightsTest
	{
		...
		public void WriteUtraceFile()
		{
			...
			UnrealInsightsWriter writer = new();

			TraceNewTraceEvent newTraceEvent1 = new(1001, 2001, 31, 8);
			TraceNewTraceEvent newTraceEvent2 = new(1002, 2002, 32, 8);
			TraceNewTraceEvent newTraceEvent3 = new(1003, 2003, 33, 8);
			CpuProfilerEventSpecEvent cpu1 = new(400, "MyCpuEventSpecEvent1");
			...
			UnrealInsightsReader reader = new();
			reader.Read(ms);
		...
		public void WriteUtraceExample()
		{
			...
			TraceNewTraceEvent newTrace1 = new(25582215261913, cycleFrequency, 21069, 8);
			TraceThreadInfoEvent threadInfo1 = new(2, 171380, -1, "GameThread");
			TraceThreadInfoEvent threadInfo2 = new(3, 0, 2147483647, "Trace");
			DiagnosticsSession2Event diagnosticsSession = new("Finally it works", "HELLO WORLD", "QAGame.uproject -trace=cpu -game", "++UE5+Main", "++UE5+Main-CL-17442524", 1000, 3, 4);
			CpuProfilerEventSpecEvent cpuEventSpec1 = new(1, "MyCpuEventSpecEvent1");
			CpuProfilerEventSpecEvent cpuEventSpec2 = new(2, "MyCpuEventSpecEvent2");
			CpuProfilerEventSpecEvent cpuEventSpec3 = new(3, "MyCpuEventSpecEvent3");
			CpuProfilerEventSpecEvent cpuEventSpec4 = new(4, "MyCpuEventSpecEvent4");
			CpuProfilerEventSpecEvent cpuEventSpec5 = new(5, "MyCpuEventSpecEvent5");
			CpuProfilerEventSpecEvent cpuEventSpec6 = new(6, "MyCpuEventSpecEvent6");
			CpuProfilerEventSpecEvent cpuEventSpec7 = new(7, "MyCpuEventSpecEvent7");
			CpuProfilerEventSpecEvent cpuEventSpec8 = new(8, "MyCpuEventSpecEvent8");
			CpuProfilerEventSpecEvent cpuEventSpecTesting = new(9, "TestingSome");
			CpuProfilerEventBatchEvent cpuBatch1 = new(cpuBatchData1);
			...
			CpuProfilerSerializer cpuSerializerThread3 = new(cycleFrequency);
