...
namespace EpicGames.Horde.Storage.Bundles.V2
{
	...
	class FlushedPacketHandle : PacketHandle
	{
		...
		static readonly Utf8String s_fragmentPrefix = new("pkt=");
		...
		{
			PacketReaderCacheKey cacheKey = new(_outer, _packetOffset);
...
#pragma warning disable CA2000
			PacketReader reader = new(_storageNamespace, _cache, _outer, this, packet.Target, packet);
...
#pragma warning restore CA2000
		...
		{
			BundlePageCacheKey bundlePageCacheKey = new(_outer, pageIdx);
