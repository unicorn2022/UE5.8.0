...
namespace EpicGames.Horde.Storage
{
	...
	public readonly record struct RefCacheTime(DateTime Utc)
	{
		...
		/// </summary>
		public static implicit operator RefCacheTime(DateTime time) => new(time);

		/// <summary>
		/// Implicit conversion operator from timespan values.
		/// </summary>
		public static implicit operator RefCacheTime(TimeSpan age) => new(age);
	}
	...
	public class StorageStats
	{
		...
		/// Stat name to value
		/// </summary>
		public List<(string, long)> Values { get; } = [];
