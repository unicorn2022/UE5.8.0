...
namespace EpicGames.Horde.Storage
{
	...
	{
		/// <inheritdoc/>
		public override RefName Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options) => new(new Utf8String(reader.GetUtf8String().ToArray()));
	...
	{
		/// <inheritdoc/>
		public override RefName Read(CbField field) => new(field.AsUtf8String());
