...
namespace EpicGames.Horde.Storage
{
	...
	public class FindNodesResponse
	{
		...
		/// </summary>
		public List<FindNodeResponse> Nodes { get; set; } = [];
	}
	...
	public class UpdateMetadataRequest
	{
		...
		/// </summary>
		public List<AddAliasRequest> AddAliases { get; set; } = [];

		/// <summary>
		/// List of aliases to remove
		/// </summary>
		public List<RemoveAliasRequest> RemoveAliases { get; set; } = [];

		/// <summary>
		/// List of refs to add
		/// </summary>
		public List<AddRefRequest> AddRefs { get; set; } = [];

		/// <summary>
		/// List of refs to remove
		/// </summary>
		public List<RemoveRefRequest> RemoveRefs { get; set; } = [];
	}
