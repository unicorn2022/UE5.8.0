...
namespace EpicGames.Horde.Storage.Nodes
{
	...
	public class CommitNode
	{
		...
		/// </summary>
		public Dictionary<Guid, IHashedBlobRef> Metadata { get; } = [];
	...
	{
		static readonly BlobType s_blobType = new(CommitNode.BlobTypeGuid, 1);
		...
		public override CommitNode Read(IBlobReader reader, BlobSerializerOptions options)
		{
			...
			DirectoryNodeRef contents = new(length, contentsNode);
