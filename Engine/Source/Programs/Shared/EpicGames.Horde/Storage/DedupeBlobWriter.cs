...
namespace EpicGames.Horde.Storage
{
	...
	public sealed class DedupeBlobWriter : BlobWriter
	{
		...
		class DedupeCache
		{
			...
			readonly Queue<BlobKey> _blobKeys = new();
			readonly Dictionary<BlobKey, IHashedBlobRef> _blobKeyToHandle = [];
	...
	public static class DedupeBlobWriterExtensions
	{
		...
		/// </summary>
		public static DedupeBlobWriter WithDedupe(this IBlobWriter writer, int maxKeys = DedupeBlobWriter.DefaultMaxKeys) => new(writer, maxKeys);
