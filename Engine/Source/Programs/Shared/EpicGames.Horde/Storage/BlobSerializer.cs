...
namespace EpicGames.Horde.Storage
{
	...
	public static class BlobSerializer
	{
		...
		public static T Deserialize<T>(BlobData blobData, BlobSerializerOptions? options = null)
		{
			...
			BlobReader reader = new(blobData, options);
	...
	public class BlobSerializerOptions
	{
		...
		readonly ConcurrentDictionary<Type, BlobConverter> _cachedConverters = new();
		static readonly ConcurrentDictionary<Type, BlobConverter> s_cachedDefaultConverters = new();
		...
		{
			BlobSerializerOptions options = new();
