...
namespace EpicGames.Horde.Telemetry
{
	...
	public class PostTelemetryEventStreamRequest
	{
		...
		/// </summary>
		public List<System.Text.Json.JsonElement> Events { get; set; } = [];
	}
	...
	public class GetTelemetryMetricsResponse
	{
		...
		/// </summary>
		public List<GetTelemetryMetricResponse> Metrics { get; set; } = [];
	}
	...
	public class TelemetryChartConfig
	{
		...
		/// </summary>
		public List<TelemetryChartMetricConfig> Metrics { get; set; } = [];
	...
	public class TelemetryCategoryConfig
	{
		...
		/// </summary>
		public List<TelemetryChartConfig> Charts { get; set; } = [];
	}
	...
	public class TelemetryViewConfig
	{
		...
		/// </summary>
		public List<TelemetryVariableConfig> Variables { get; set; } = [];

		/// <summary>
		/// The categories contained within the view
		/// </summary>
		public List<TelemetryCategoryConfig> Categories { get; set; } = [];
	}
	...
	{
		/// <inheritdoc/>
		public override TelmetryViewId FromStringId(StringId id) => new(id);
	...
	public class GetTelemetryChartResponse
	{
		...
		/// List of configured metrics
		/// </summary>
		public List<GetTelemetryChartMetricResponse> Metrics { get; set; } = [];
	...
	public class GetTelemetryCategoryResponse
	{
		...
		/// The charts contained within the category
		/// </summary>
		public List<GetTelemetryChartResponse> Charts { get; set; } = [];
	}
	...
	public class GetTelemetryViewResponse
	{
		...
		///  The variables used to filter the view data
		/// </summary>
		public List<GetTelemetryVariableResponse> Variables { get; set; } = [];

		/// <summary>
		/// The categories contained within the view
		/// </summary>
		public List<GetTelemetryCategoryResponse> Categories { get; set; } = [];
	}
}
