...
namespace EpicGames.Horde.Jobs
{
	...
	public readonly record struct JobStepBatchId(SubResourceId SubResourceId)
	{
		...
		/// </summary>
		public static JobStepBatchId GenerateNewId() => new(SubResourceId.GenerateNewId());

		/// <inheritdoc cref="SubResourceId.Parse(System.String)"/>
		public static JobStepBatchId Parse(string text) => new(SubResourceId.Parse(text));
	...
	{
		/// <inheritdoc/>
		public override JobStepBatchId FromSubResourceId(SubResourceId subResourceId) => new(subResourceId);
