...
namespace HordeServer.Jobs
{
	...
	public interface IJobStepRef
	{
		...
		/// <summary>
		/// The job the jobstep belongs to.
		/// </summary>
		/// <remarks>This is optional due to backwards compatibility for previously serialized items.</remarks>
		public JobId? JobId { get; }

		/// <summary>
		/// The batch the jobstep belongs to.
		/// </summary>
		/// <remarks>This is optional due to backwards compatibility for previously serialized items.</remarks>
		public JobStepBatchId? BatchId { get; }

		/// <summary>
		/// The step the job step represents.
		/// </summary>
		/// <remarks>This is optional due to backwards compatibility for previously serialized items.</remarks>
