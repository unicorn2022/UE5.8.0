...
#pragma warning restore CA1710 // Identifiers should have correct suffix
	{
		...
		/// <summary>
		/// Whether to create warning issues for this node
		/// </summary>
		bool? CreateWarningIssues { get; }
	...
	public class NodeAnnotations : Dictionary<string, string>, IReadOnlyNodeAnnotations
	{
		...
		/// <inheritdoc cref="IReadOnlyNodeAnnotations.CreateWarningIssues"/>
		public const string CreateWarningIssuesKeyName = "CreateWarningIssues";
		...
		/// <inheritdoc/>
		public bool? CreateWarningIssues
		{
			get => GetBoolValue(CreateWarningIssuesKeyName);
			set => SetBoolValue(CreateWarningIssuesKeyName, value);
		}
