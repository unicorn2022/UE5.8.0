...
public static class KnownPropertyNames
{
	...
	/// <summary>
	/// The total size of the working drive, in bytes
	/// </summary>
	public const string WorkingDiskTotalSize = "WorkingDiskTotalSize";

	/// <summary>
	/// Amount of available free space on the working drive, in bytes
	/// </summary>
	public const string WorkingDiskFreeSpace = "WorkingDiskFreeSpace";

	/// <summary>
	/// The total size of the system drive, in bytes
	/// </summary>
	public const string SystemDiskTotalSize = "SystemDiskTotalSize";

	/// <summary>
	/// Amount of available free space on the system drive, in bytes
	/// </summary>
	public const string SystemDiskFreeSpace = "SystemDiskFreeSpace";
