...
namespace EpicGames.Horde.Issues
{
	...
	public class GetIssueResponse
	{
		...
		{
			get => _rootCommitId;
			set => _rootCommitId = value;
		}
		CommitId? _rootCommitId;

		/// <summary>
		/// User that provided the root cause analysis
		/// </summary>
		public GetThinUserInfoResponse? RootCauseOwnerInfo { get; set; }

		/// <summary>
		/// Root Cause Category for this issue
		/// </summary>
		public string? RootCauseCategory { get; set; }

		/// <summary>
		/// Root Cause Summary for this issue
		/// </summary>
	...
	public class FindIssueResponse
	{
		...
		/// User that provided the root cause analysis
		/// </summary>
		public GetThinUserInfoResponse? RootCauseOwner { get; set; }
		...
		/// <summary>
		/// Changelist that introduced this issue
		/// </summary>
		public CommitId? RootCommitId
		{
			get => _rootCommitId;
	...
	public class UpdateIssueRequest
	{
		...
		/// <summary>
		/// The change at which the issue is claimed to have been introduced.
		/// </summary>
		public CommitId? RootCommitId
		{
			get => _rootCommitId == null ? null : String.IsNullOrWhiteSpace(_rootCommitId.Name) ? CommitId.Empty : _rootCommitId;
			set => _rootCommitId = value;
		}
		CommitId? _rootCommitId;

		/// <summary>
		/// New user id for owner of the root cause analysis, can be cleared by passing empty string
		/// </summary>
		public string? RootCauseOwnerId { get; set; }
