...
namespace EpicGames.Horde.Issues
{
	...
	public class IssueHandlerContext
	{
		...
		/// <summary>
		/// Log Channel => Channel Grouping
		/// </summary>
		public IReadOnlyDictionary<string, string> ChannelGroups { get; }
		...
		/// Constructor
		/// </summary>
		public IssueHandlerContext(StreamId streamId, TemplateId templateId, string nodeName, IReadOnlyDictionary<string, string> channelGroups, IReadOnlyDictionary<string, string> nodeAnnotations)
		{
			StreamId = streamId;
