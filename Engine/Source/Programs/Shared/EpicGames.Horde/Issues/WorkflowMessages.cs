...
namespace EpicGames.Horde.Issues
{
	...
	public class GetWorkflowResponse : IWorkflow
	{
		...
		/// <inheritdoc cref="IWorkflow.EscalateRootCauseAnalysisTimes"/>
		public List<int> EscalateRootCauseAnalysisTimes { get; set; }

		IReadOnlyList<int> IWorkflow.EscalateRootCauseAnalysisTimes => EscalateRootCauseAnalysisTimes;

		/// <inheritdoc/>
		public bool AutoRcaEnabled { get; set; }

		/// <inheritdoc/>
		public bool AutoRcaSlackEnabled { get; set; }
		...
		public GetWorkflowResponse()
		{
			ReportTimes = [];
			EscalateTimes = [];
			EscalateRootCauseAnalysisTimes = [];
		}
		...
		{
			Id = workflow.Id;
			ReportTimes = [.. workflow.ReportTimes];
			...
			EscalateTimes = [.. workflow.EscalateTimes];
			EscalateRootCauseAnalysisTimes = [.. workflow.EscalateRootCauseAnalysisTimes];
			AutoRcaEnabled = workflow.AutoRcaEnabled;
			AutoRcaSlackEnabled = workflow.AutoRcaSlackEnabled;
