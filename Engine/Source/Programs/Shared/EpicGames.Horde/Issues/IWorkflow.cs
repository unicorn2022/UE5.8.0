...
namespace EpicGames.Horde.Issues
{
	...
	public interface IWorkflow
	{
		...
		/// <summary>
		/// Times after a manual root cause analysis has been opened to escalate to the owner, in minutes. Continues to notify on the last interval once reaching the end of the list.
		/// </summary>
		IReadOnlyList<int> EscalateRootCauseAnalysisTimes { get; }

		/// <summary>
		/// Whether to automatically run RCA processing for issues in this workflow
		/// </summary>
		bool AutoRcaEnabled { get; }

		/// <summary>
		/// Whether to post auto-RCA results to the issue's Slack triage thread
		/// </summary>
		bool AutoRcaSlackEnabled { get; }
