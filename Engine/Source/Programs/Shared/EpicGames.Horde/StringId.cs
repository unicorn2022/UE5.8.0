...
namespace EpicGames.Horde
{
	...
	{
		/// <inheritdoc/>
		public override StringId Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options) => new(new Utf8String(reader.GetUtf8String().ToArray()));
