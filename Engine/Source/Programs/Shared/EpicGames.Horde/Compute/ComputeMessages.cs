...
namespace EpicGames.Horde.Compute
{
	...
	public class AssignComputeResponse
	{
		...
		/// </summary>
		public Dictionary<string, int> AssignedResources { get; set; } = [];
	...
	public class ResourceNeedsMessage
	{
		...
		/// </summary>
		public Dictionary<string, int> ResourceNeeds { get; set; } = [];
	}
	...
	public class GetResourceNeedsResponse
	{
		...
		/// </summary>
		public List<ResourceNeedsMessage> ResourceNeeds { get; set; } = [];
	}
}
