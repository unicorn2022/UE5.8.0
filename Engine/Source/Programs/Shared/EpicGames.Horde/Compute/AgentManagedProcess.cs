...
namespace EpicGames.Horde.Compute
{
	...
	public sealed class AgentManagedProcess : IAsyncDisposable
	{
		...
		readonly TaskCompletionSource<int> _result = new(TaskCreationOptions.RunContinuationsAsynchronously);
		...
		void AppendData(ReadOnlySpan<byte> data)
		{
			for (; ; )
			{
				...
				else
				{
					...
					str = Encoding.UTF8.GetString(_buffer.AsSpan(0, _bufferLength));
					_bufferLength = 0;
				}
