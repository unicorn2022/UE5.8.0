...
namespace EpicGames.Horde.Commits
{
	...
	public class CommitIdWithOrder : CommitId, IEquatable<CommitIdWithOrder>, IComparable<CommitIdWithOrder>
	{
		...
		/// <summary>
		/// Gets the Perforce change number if the commit name is numeric, otherwise
		/// falls back to using the Order property.
		/// </summary>
		public int GetPerforceChangeOrOrder()
			=> TryGetPerforceChange() ?? Order;
