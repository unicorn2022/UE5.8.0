...
namespace EpicGames.Horde.Server
{
	...
	public class GetServerInfoResponse
	{
		...
		/// List of plugins
		/// </summary>
		public ServerPluginInfoResponse[] Plugins { get; set; } = [];

		/// <summary>
		/// The environment that the server is running in (e.g. "Development", "Production")
		/// </summary>
	...
	public class ServerStatusSubsystem
	{
		...
		/// List of updates
		/// </summary>
		public ServerStatusUpdate[] Updates { get; set; } = [];
	}
	...
	public class ServerStatusResponse
	{
		...
		/// </summary>
		public ServerStatusSubsystem[] Statuses { get; set; } = [];
	}
	...
	/// <param name="UserAcls">List of ACL actions the current user has for this plugin</param>
	public record ServerPluginInfoResponse(string Name, string? Description, bool Loaded, string? Version = null, string[]? UserAcls = null);
