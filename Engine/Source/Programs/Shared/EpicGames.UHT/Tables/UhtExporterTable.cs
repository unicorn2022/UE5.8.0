...
namespace EpicGames.UHT.Tables
{
	...
	public readonly struct UhtExporter
	{
		...
		public UhtExporter(UhtExporterAttribute attribute, UhtExporterDelegate exporterDelegate)
		{
			...
			CppFilters = attribute.CppFilters != null ? [.. attribute.CppFilters] : new List<string>();
			HeaderFilters = attribute.HeaderFilters != null ? [.. attribute.HeaderFilters] : new List<string>();
			OtherFilters = attribute.OtherFilters != null ? [.. attribute.OtherFilters] : new List<string>();
		}
	}
