			...
			try
			{
				...
				tokenReader.Optional(':', () =>
				{
					tokenReader
						...
						.RequireCppIdentifier(UhtCppIdentifierOptions.None, identifier =>
						{
						...
						.While(',', () =>
						{
							tokenReader
								...
								.RequireCppIdentifier(UhtCppIdentifierOptions.AllowTemplates, identifier =>
								{
						...
						.Optional("VINTERFACES", () =>
						{
							...
							{
								tokenReader.RequireCppIdentifier(UhtCppIdentifierOptions.None, identifier =>
								{
