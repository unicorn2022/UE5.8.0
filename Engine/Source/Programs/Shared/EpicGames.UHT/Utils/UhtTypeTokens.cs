...
namespace EpicGames.UHT.Utils
{
	...
	public struct UhtTypeSegment
	{
		...
		public UhtTypeSegment(UhtInputCacheReader reader)
		{
			Start = reader.ReadInt32();
			End = reader.ReadInt32();
			TypeStart = reader.ReadInt32();
			TypeEnd = reader.ReadInt32();
			FindFilter = (UhtFindOptions)reader.ReadUInt64();
		}
		...
		public void Write(UhtInputCacheWriter writer)
		{
			...
			writer.WriteInt32(TypeStart);
			writer.WriteInt32(TypeEnd);
			writer.WriteUInt64((ulong)FindFilter);
		}
	}
			...
			while (true)
			{
				...
				switch (symbolChar)
				{
					...
					default:
						...
						{
							tokenReader.SkipBrackets('(', ')', 0, x => typeTokens.Add(x));
						}
	...
	public readonly struct UhtTypeTokensRef
	{
		...
		/// Construct a new instance of a type tokens
		/// </summary>
		/// <param name="allTokens">Collection of tokens</param>
		/// <param name="segments">Collection of segments</param>
		/// <param name="reader">Binary archive</param>
		public UhtTypeTokensRef(ReadOnlyMemory<UhtToken> allTokens, ReadOnlyMemory<UhtTypeSegment> segments, UhtInputCacheReader reader)
		{
			AllTokens = allTokens;
			Segments = segments;
			DeclarationSegmentIndex = reader.ReadInt32();
			FullDeclarationSegmentIndex = reader.ReadInt32();
		}
		...
		public void Write(UhtInputCacheWriter writer)
		{
			writer.WriteInt32(DeclarationSegmentIndex);
			writer.WriteInt32(FullDeclarationSegmentIndex);
		}
