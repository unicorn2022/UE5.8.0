...
namespace EpicGames.UHT.Types
{
	...
	public class UhtByteProperty : UhtNumericProperty
	{
		...
		/// <inheritdoc/>
		protected override string CodeGenParamsStruct => "FBytePropertyParams";

		/// <inheritdoc/>
		protected override string CodeGenParamsFlags => "UECodeGen_Private::EPropertyGenFlags::Byte";
		...
		public UhtByteProperty(UhtInputCacheReader reader, UhtType outer) : base(reader, outer)
		{
			Enum = reader.ReadType() as UhtEnum;
			CppForm = (UhtByteCppForm)reader.ReadUInt8();
		}
		...
		{
			return AppendParamsDefRef(builder, context, Enum, UhtSingletonType.Registered, true);
		}
		...
		{
			return builder.Append($"{ConstInitSingletonRef(context, Enum, true)}, ");
		}
