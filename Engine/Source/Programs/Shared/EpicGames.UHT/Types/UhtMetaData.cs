...
namespace EpicGames.UHT.Types
{
	...
	public struct UhtMetaDataKey
	{
		...
		/// <summary>
		/// Read from the archive reader
		/// </summary>
		/// <param name="reader">Source cache reader</param>
		public UhtMetaDataKey(UhtInputCacheReader reader)
		{
	...
	/// </summary>
	sealed class UhtMetaDataKeyComparer : IEqualityComparer<UhtMetaDataKey>, IComparer<UhtMetaDataKey>
	{
		/// <summary>
		/// Compare two keys
		/// </summary>
