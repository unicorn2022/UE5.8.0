...
public:
	...
	virtual void UpdateLastValidationForFiles(const FString& InCLId, const FName& InValidatorId, const FString& InValidatorConfig, const TArray<FSCFileRef>& InFiles, const FDateTime& InNewTimestamp) override {}
	...
	virtual FDateTime GetLastKnownShelfUpToDate(const FString& InCLId) const { return FDateTime::MinValue(); }
	virtual void SetLastShelfKnownUpToDate(const FString& InCLId, const FDateTime& InDateTime) { }
...
public:
	...
	virtual void SetIntegrationFieldValue(const FString& InCLId, const FString& InIntegrationFieldId, const FString& InValue);
	virtual FDateTime GetLastKnownShelfUpToDate(const FString& InCLId) const;
	virtual void SetLastShelfKnownUpToDate(const FString& InCLId, const FDateTime& InDateTime);
