...
inline TSharedRef<FUserPresence> GetGenericPresenceA(FAccountId AccountId)
{
...
inline TSharedRef<FUserPresence> GetGenericPresenceB(FAccountId AccountId)
{
	TSharedRef<FUserPresence> Presence = MakeShared<FUserPresence>();
...
inline FPartialUpdatePresence::Params GetGenericPresenceMutationAtoB(FAccountId AccountId)
{
...
inline void CheckPresenceAreEqual(const FUserPresence& Presence1, const FUserPresence& Presence2)
{
...
inline void CheckPresencesNotEqual(const FUserPresence& Presence1, const FUserPresence& Presence2)
{
	CHECK(Presence1.GameStatus != Presence2.GameStatus);
	CHECK(Presence1.Joinability != Presence2.Joinability);
	CHECK(Presence1.RichPresenceString != Presence2.RichPresenceString);
