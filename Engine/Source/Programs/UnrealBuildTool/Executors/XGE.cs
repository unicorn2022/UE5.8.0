...
#pragma warning disable IDE0044 // Make field readonly - these private static fields are set by XML configuration.
		...
		/// </summary>
		[XmlConfigFile(Category = ExecutorName)]
...
#pragma warning restore IDE0044
		...
		private static readonly List<string> CompileAutoRecover = new List<string> {
		...
		private static readonly List<string> LinkAutoRecover = new List<string> {
		...
		internal const string ExecutorName = "XGE";
