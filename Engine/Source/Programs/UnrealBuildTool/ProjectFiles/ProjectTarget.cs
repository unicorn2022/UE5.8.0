...
namespace UnrealBuildTool
{
	...
	class ProjectTarget : Project
	{
		...
		public FileReference TargetFilePath { get; }
		...
		public Func<UnrealTargetPlatform, UnrealTargetConfiguration, TargetRules> CreateRulesDelegate { get; }

		/// Delegate for creating a rules instance for a given platform/configuration/architecture
		public Func<UnrealTargetPlatform, UnrealTargetConfiguration, UnrealArch, TargetRules> CreateRulesDelegateWithArch { get;  }
