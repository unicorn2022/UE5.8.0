...
namespace UnrealBuildTool
{
	...
	static class ActionSerialization
	{
		...
		/// </summary>
		static readonly IReadOnlyDictionary<Type, IActionSerializer> TypeToSerializer;

		/// <summary>
		/// Map from serializer name to instance
		/// </summary>
		static readonly IReadOnlyDictionary<string, IActionSerializer> NameToSerializer;
