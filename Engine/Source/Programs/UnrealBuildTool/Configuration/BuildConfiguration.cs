...
namespace UnrealBuildTool
{
	...
	internal sealed class BuildConfiguration
	{
		...
		[Obsolete("Deprecated in UE5.8. HybridExecutor is no longer supported")]
		...
		/// </summary>
		[XmlConfigFile]
		public string[] RemoteExecutorPriority { get; set; } = [XGE.ExecutorName, SNDBS.ExecutorName, FASTBuild.ExecutorName, UBAExecutor.ExecutorName];
		...
		/// </summary>
		[XmlConfigFile(Deprecated = true)]
		[Obsolete("Deprecated in UE5.8. Replace with bAllowUBAExecutor")]
		...
		/// <summary>
		/// If true, enable the UHT input cache for both reading and writing
		/// </summary>
		[CommandLine("-EnableUHTInputCache")]
		[XmlConfigFile(Category = "UEBuildConfiguration")]
		public bool bEnableUHTInputCache { get; set; } = false;

		/// <summary>
		/// If true, do not build UHT, assume it is already built.
		/// </summary>
		[Obsolete("Deprecated in UE5.8.")]
		...
		/// <summary>
		/// Whether to generate target makefiles in parallel.
		/// </summary>
		[XmlConfigFile(Category = "BuildConfiguration")]
		public bool bParallelMakefileGeneration { get; set; } = true;
