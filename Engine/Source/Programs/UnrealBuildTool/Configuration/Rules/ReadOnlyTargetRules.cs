...
#pragma warning disable CS1591
		...
		public bool bAutoRTFMRedirectionInstrumentation => Inner.bAutoRTFMRedirectionInstrumentation;

		public bool bUseChaosMemoryTracking => Inner.bUseChaosMemoryTracking;

		public bool bCompileRewindDebuggerSupport => Inner.bCompileRewindDebuggerSupport;

		public bool bCompileChaosVisualDebuggerSupport => Inner.bCompileChaosVisualDebuggerSupport;
	
		public bool bCompileAsioSSLSupport => Inner.bCompileAsioSSLSupport;
		...
		public bool bMultiViewPerSlateWindowSupport => Inner.bMultiViewPerSlateWindowSupport;
		...
		public bool bEnableConfigSystem => Inner.bEnableConfigSystem;
		...
		public bool bEnableTraceSecureConnection => Inner.bEnableTraceSecureConnection;
		...
		public bool bExcludeParallelIrisSupport => Inner.bExcludeParallelIrisSupport;
		...
		public bool bUseSparseSetStrictMode => Inner.bUseSparseSetStrictMode;

		public bool bUseCompactSetAsDefault => Inner.bUseCompactSetAsDefault;

		public bool bUseAndroidJni => Inner.bUseAndroidJni;
		...
		public IReadOnlyList<UnrealTargetConfiguration> AdaptiveUnityDisablesOptimizationsConfigurations => Inner.AdaptiveUnityDisablesOptimizationsConfigurations;
		...
		public IReadOnlyList<string> StaticAnalyzerPVSConfigs => Inner.StaticAnalyzerPVSConfigs;
		...
		public bool bMinCpuArchAPX => Inner.bMinCpuArchAPX;
		...
		public IReadOnlyDictionary<string, string> BuildSettingsVariables => Inner.BuildSettingsVariables.AsReadOnly();
...
#pragma warning restore CA1822
		...
		/// </summary>
		public List<string> SelectedTestModuleNames => Inner.SelectedTestModuleNames;
