...
namespace UnsyncUI
{
	...
	public partial class App : Application
    {
		...
		internal bool UnsyncSupportsStdout = false;
		...
		protected override void OnStartup(StartupEventArgs e)
		{
			...
			if (UnsyncPath != null)
			{
				try
				{
					...
					{
						proc.StartInfo = new System.Diagnostics.ProcessStartInfo(UnsyncPath, "sync --help")
						{
							CreateNoWindow = true,
						...
						{
							UnsyncSupportsStdout = helpText.Contains("--stdout");
						}
						else
						{
							proc.Kill();
