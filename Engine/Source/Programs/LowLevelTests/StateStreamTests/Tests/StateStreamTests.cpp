...
TEST_CASE("StateStream::SingleInstance", "[StateStream]")
{
	...
	uint32 LaneId = ManagerImpl.Game_CreateLane();
	ManagerImpl.Game_SetDefaultLane(LaneId);
