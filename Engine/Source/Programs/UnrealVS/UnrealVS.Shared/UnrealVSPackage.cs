...
namespace UnrealVS
{
		...
		IDisposable
	{
		...
		private const string VersionString = "v1.87";
		...
		protected override async System.Threading.Tasks.Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
		{
			...
			BuildAndProfile = new BuildAndProfile();
			...
			// Create 'CycleRelatedFiles' instance
			CycleRelatedFiles = new CycleRelatedFiles();

			// Create 'UbaVisualizer' instance
			UbaVisualizer = new UbaVisualizer();

			// Create 'CopyIncludePath' instance
			CopyIncludePath = new CopyIncludePath();
		...
		protected override void Dispose(bool disposing)
		{
			...
			BatchBuilder = null;
			QuickBuilder = null;
			BuildAndProfile?.Dispose();
			BuildAndProfile = null;
			...
			CopyIncludePath?.Dispose();
			CopyIncludePath = null;
		...
		/// CycleRelatedFiles feature
		private CycleRelatedFiles CycleRelatedFiles;
		...
		/// Our Build and Profile component
		private BuildAndProfile BuildAndProfile;
		...
		/// CopyIncludePath feature
		private CopyIncludePath CopyIncludePath;
