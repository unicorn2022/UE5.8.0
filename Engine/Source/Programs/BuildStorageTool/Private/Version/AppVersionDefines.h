...
#define BUILD_STORAGE_TOOL_VERSION_MAJOR 1
#define BUILD_STORAGE_TOOL_VERSION_MINOR 0
#define BUILD_STORAGE_TOOL_VERSION_PATCH 0

#define BUILD_STORAGE_TOOL_VERSION_STRING "1.00"
