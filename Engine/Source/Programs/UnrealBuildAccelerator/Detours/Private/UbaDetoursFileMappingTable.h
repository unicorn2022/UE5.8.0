...
namespace uba
{
	...
	struct FileInfo
	{
		...
		SharedMemoryHandle trueFileMapHandle;
	...
	bool Rpc_UpdateDirectory(const StringKey& dirKey, const tchar* dirName, u64 dirNameLen, bool lockDirTable = true);
	...
	bool Rpc_GetEntryOffset(DirTableOffset& out, const StringKey& entryNameKey, StringView entryName, bool checkIfDir = false);
	bool Rpc_GetEntryInformation(DirectoryTable::EntryInformation& out, const StringKey& entryNameKey, StringView entryName, bool checkIfDir = false);
	...
	void Rpc_GetSharedMemory(SharedMemoryView& view, SharedMemoryAllocatorHandle allocatorHandle, u8* allocatorMem, SharedMemoryHandle handle, u64 offset, u64 size, const tchar* hint, SharedMemoryMapType type = SharedMemoryMapType_ReadOnly);
