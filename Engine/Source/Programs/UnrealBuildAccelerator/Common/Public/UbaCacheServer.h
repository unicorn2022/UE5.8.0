...
namespace uba
{
	...
	private:
		...
		Atomic<u32> m_addsSinceMaintenance = 0;
		Atomic<u64> m_cacheKeyFetchCount = 0;
		Atomic<u64> m_cacheKeyHitCount = 0;
		Atomic<bool> m_isRunningMaintenance = false;
		Atomic<bool> m_bucketIsOverflowing = false;
		Atomic<bool> m_forceMaintenance = false;
		...
		Atomic<u64> m_totalEntryCount = 0;
