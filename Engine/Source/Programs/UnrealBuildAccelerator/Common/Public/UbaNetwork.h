...
namespace uba
{
	...
	static constexpr u32 SessionNetworkVersion = 53;
	...
	#define UBA_STORAGE_MESSAGES \
		...
		UBA_STORAGE_MESSAGE(ReportBadCas) \
	...
	#define UBA_SESSION_MESSAGES \
		...
		UBA_SESSION_MESSAGE(SpeedTest) \
		UBA_SESSION_MESSAGE(LogEntry) \
		UBA_SESSION_MESSAGE(Symlink) \
