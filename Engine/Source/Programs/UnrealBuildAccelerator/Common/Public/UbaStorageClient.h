...
namespace uba
{
	...
	public:
		...
		virtual bool StoreCasFileClient(CasKey& out, StringKey fileNameKey, const tchar* fileName, SharedMemoryHandle mappingFile, u64 mappingOffset, u64 fileSize, const tchar* hint, bool keepMappingInMemory = false, bool storeCompressed = true) override;
		virtual bool HasCasFile(const CasKey& casKey, CasEntry** out, bool useMapping, bool allowFail) override;
