...
namespace uba
{
	...
	public:
		...
		void TraverseConnections(const Function<void(NetworkBackend&, void*)>& func);
	...
	private:
		...
		Atomic<u64> m_sendBytes = 0;
		Atomic<u64> m_recvBytes = 0;
		Atomic<u32> m_recvCount = 0;
		Atomic<bool> m_isDisconnecting = false;
		Timer m_sendTimer;
		...
		Atomic<u32> m_connectionCount = 0;
		bool m_useMessagePriority;
		bool m_useThreadedSend;
