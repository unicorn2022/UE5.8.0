...
#define UBA_ALLPLATFORM_TESTS \
		...
		UBA_TEST(TestSharedMemory) \
		UBA_TEST(TestFileMapping) \
...
#define UBA_WINDOWS_TESTS \
		...
		UBA_TEST(TestCreateVirtualFile) \
		UBA_TEST(TestRemoteCreateVirtualFile) \
		UBA_TEST(TestRegisterVirtualFile) \
		UBA_TEST(TestRemoteRegisterVirtualFile) \
		UBA_TEST(TestRemoteProcessSpecialCase1) \
		UBA_TEST(TestOverlayAccessOrdering) \
		UBA_TEST(TestRemoteOverlayAccessOrdering) \
		UBA_TEST(TestSessionSpecialCopy) \
		UBA_TEST(TestFileMapWrite) \
		UBA_TEST(TestRemoteFileMapWrite) \
...
#define UBA_LINUX_TESTS \
		...
		UBA_TEST(TestDetouredSymlinks) \
		UBA_TEST(TestRemoteDetouredSymlinks) \
		UBA_TEST(TestGlibcPatcher) \
