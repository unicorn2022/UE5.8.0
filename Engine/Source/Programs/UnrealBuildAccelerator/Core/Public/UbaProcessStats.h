...
#define UBA_PROCESS_STATS \
		...
		UBA_PROCESS_STAT(createSharedMemory, 50) \
		UBA_PROCESS_STAT(commitSharedMemory, 50) \
		UBA_PROCESS_STAT(getSharedMemory, 50) \
	...
	struct KernelStats
	{
		#define UBA_KERNEL_STATS \
			...
			UBA_KERNEL_STAT(ExtendedTimer, virtualFree, 50) \
			UBA_KERNEL_STAT(ExtendedTimer, virtualAlloc2, 50) \
			UBA_KERNEL_STAT(TimeAndBytes, mapViewOfFile3, 50) \
			UBA_KERNEL_STAT(ExtendedTimer, unmapViewOfFile2, 50) \
