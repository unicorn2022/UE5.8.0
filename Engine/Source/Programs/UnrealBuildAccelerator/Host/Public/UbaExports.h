...
extern "C"
{
	...
	UBA_API void LogWriter_SetGlobal(uba::LogWriter* writer);
	...
	UBA_API bool ProcessHandle_IsCancelled(const uba::ProcessHandle* handle);
	...
	UBA_API bool SessionServer_CreateVirtualFile(uba::SessionServer* server, const uba::tchar* filename, const void* memory, uba::u64 memorySize, bool transient, bool registerToDir);
	UBA_API bool SessionServer_DeleteVirtualFile(uba::SessionServer* server, const uba::tchar* filename, bool registerToDir);
	...
	UBA_API bool SessionServer_DisableRemoteExecutionOnAgent(uba::SessionServer* server, const uba::tchar* agentName);
	...
	UBA_API void Scheduler_GetProcessWeightThatCanRunRemotelyNow2(uba::Scheduler* scheduler, float& outTotal, float& outCrossArchitecture, float& outCrossPlatform);
