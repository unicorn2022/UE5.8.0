...
namespace UnrealGameSync
{
	...
	public class WorkspaceState
	{
		...
		public bool StreamSwitched { get; set; } = false; // Whether the stream has been switched since the last sync
		...
		public void CopyFrom(WorkspaceState other)
		{
			...
			StreamSwitched = other.StreamSwitched;
	...
	public class ReadOnlyWorkspaceState
	{
		...
		public bool StreamSwitched => _inner.StreamSwitched;
