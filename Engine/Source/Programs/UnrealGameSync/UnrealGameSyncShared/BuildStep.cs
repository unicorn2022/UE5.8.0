...
namespace UnrealGameSync
{
	...
	public class BuildStep
	{
		...
		public List<Guid> LocalCompileRequires { get; } = new List<Guid>();
		...
		public BuildStep(ConfigObject obj)
		{
			...
			List<Guid> localCompileRequires = new List<Guid>();
			foreach (string localCompileRequireString in obj.GetValue("LocalCompileRequires", String.Empty).Split(';', StringSplitOptions.RemoveEmptyEntries))
			{
				if (Guid.TryParse(localCompileRequireString, out Guid localCompileRequire))
				{
					localCompileRequires.Add(localCompileRequire);
				}
			}
			LocalCompileRequires = localCompileRequires;
