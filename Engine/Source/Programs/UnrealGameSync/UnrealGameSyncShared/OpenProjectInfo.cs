...
#pragma warning restore CA1508
				...
				UserWorkspaceSettings userWorkspaceSettings = userSettings.FindOrAddWorkspaceSettings(branchDirectoryName, perforceSettings.ServerAndPort, perforceSettings.UserName, perforceSettings.ClientName!, branchPath, projectPath, selectedProject.LocalPath ?? String.Empty, logger);
...
#pragma warning restore CA2000
					...
					ConfigFile workspaceProjectConfigFile = await WorkspaceUpdate.ReadProjectConfigFile(perforceClient, projectInfo, logger);
