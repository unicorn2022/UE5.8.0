...
namespace UnrealGameSync
{
	...
	public class ApplicationTheme
	{
		...
		[Theme]
		public Color WarningColor { get; init; } = Color.FromArgb(SystemColors.HotTrack.B, SystemColors.HotTrack.G, SystemColors.HotTrack.R);
		[Theme]
		...
		static ApplicationTheme CreateDarkTheme()
		{
			return new ApplicationTheme(DarkThemeId)
			{
				...
				WarningColor = Color.FromArgb(255, 170, 84),
