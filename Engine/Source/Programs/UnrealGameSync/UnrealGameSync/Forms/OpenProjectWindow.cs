...
#pragma warning restore CS0649 // Avoid unused private fields
		...
		private void GenerateP4ConfigCheckbox_Click(object sender, EventArgs e)
		{
			if (GenerateP4ConfigCheckbox.Checked && !IsP4ConfigSet())
			{
				string message =
					"The P4CONFIG variable is not set but you've chosen to generate a P4Config file."
					+ Environment.NewLine + Environment.NewLine
					+ "You must set a P4CONFIG value and restart UGS before enabling this option."
					+ Environment.NewLine + Environment.NewLine
					+ "This is not a required feature. If you're not familiar with what this is, it's perfectly "
					+ "safe to leave this option disabled and continue.";
				...
				GenerateP4ConfigCheckbox.Checked = false;
			}
		}
		...
		private static bool IsP4ConfigSet()
		{
			return !String.IsNullOrEmpty(PerforceEnvironment.Default.GetValue("P4CONFIG"));
		}
	}
}
