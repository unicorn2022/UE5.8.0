...
namespace UnrealGameSync
{
	partial class SyncFilter
	{
		...
		/// </summary>
		private void InitializeComponent(bool defaultToWorkspaceView=false)
		{
			...
			WorkspaceControl = new Controls.WorkspaceSyncFilterControl();
		...
		private Controls.WorkspaceSyncFilterControl WorkspaceControl;
