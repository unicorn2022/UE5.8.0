...
namespace UnrealGameSync
{
	partial class WorkspaceControl
	{
		...
		private void InitializeComponent()
		{
			...
			OptionsContextMenu_SyncPrecompiledBinariesProjectOverride = new ToolStripMenuItem();
			...
			RunAfterSyncCheckBox = new UnrealGameSync.Controls.ReadOnlyCheckbox();
			BuildAfterSyncCheckBox = new UnrealGameSync.Controls.ReadOnlyCheckbox();
			...
			GenerateAfterSyncCheckBox = new UnrealGameSync.Controls.ReadOnlyCheckbox();
			OpenSolutionAfterSyncCheckBox = new UnrealGameSync.Controls.ReadOnlyCheckbox();
			tableLayoutPanel3 = new TableLayoutPanel();
			FilterButton = new Button();
			OptionsButton = new Button();
			PCBLabel = new Label();
			BuildListFooterLayoutPanel = new FlowLayoutPanel();
			...
			BuildListFooterLayoutPanel.SuspendLayout();
			...
			OptionsContextMenu_ScheduledSync.Size = new Size(301, 22);
			...
			OptionsContextMenu_SyncPrecompiledBinaries.Size = new Size(301, 22);
			...
			// 
			// OptionsContextMenu_SyncPrecompiledBinariesProjectOverride
			// 
			OptionsContextMenu_SyncPrecompiledBinariesProjectOverride.DropDownItems.AddRange(new ToolStripItem[] { disabledToolStripMenuItem, toolStripSeparator11, editorToolStripMenuItem, editorPhysXToolStripMenuItem });
			OptionsContextMenu_SyncPrecompiledBinariesProjectOverride.Name = "OptionsContextMenu_SyncPrecompiledBinariesProjectOverride";
			OptionsContextMenu_SyncPrecompiledBinariesProjectOverride.Size = new Size(301, 22);
			OptionsContextMenu_SyncPrecompiledBinariesProjectOverride.Text = "Sync Precompiled Binaries Project Override";
			OptionsContextMenu_SyncPrecompiledBinariesProjectOverride.Click += OptionsContextMenu_SyncPrecompiledBinariesProjectOverride_Click;
			// 
			...
			OptionsContextMenu_ImportSnapshots.Size = new Size(301, 22);
			...
			OptionsContextMenu_AutoResolveConflicts.Size = new Size(301, 22);
			...
			OptionsContextMenu_AlwaysClobberFiles.Size = new Size(301, 22);
			...
			OptionsContextMenu_AlwaysDeleteFiles.Size = new Size(301, 22);
			...
			OptionsContextMenu_SyncFilter.Size = new Size(301, 22);
			...
			OptionsContextMenu_Presets.Size = new Size(301, 22);
			...
			OptionsContextMenu_EditorBuildConfiguration.Size = new Size(301, 22);
			...
			OptionsContextMenu_CustomizeBuildSteps.Size = new Size(301, 22);
			...
			OptionsContextMenu_EditorArguments.Size = new Size(301, 22);
			...
			toolStripSeparator5.Size = new Size(298, 6);
			// 
			...
			tabLabelsToolStripMenuItem.Size = new Size(301, 22);
			...
			showChangesToolStripMenuItem.Size = new Size(301, 22);
			...
			OptionsContextMenu_TimeZone.Size = new Size(301, 22);
			...
			BuildListContextMenu_Sync.Size = new Size(199, 22);
			...
			BuildListContextMenu_SyncContentOnly.Size = new Size(199, 22);
			...
			BuildListContextMenu_SyncOnlyThisChange.Size = new Size(199, 22);
			...
			BuildListContextMenu_Build.Size = new Size(199, 22);
			...
			BuildListContextMenu_Rebuild.Size = new Size(199, 22);
			...
			BuildListContextMenu_GenerateProjectFiles.Size = new Size(199, 22);
			...
			BuildListContextMenu_Cancel.Size = new Size(199, 22);
			...
			BuildListContextMenu_OpenVisualStudio.Size = new Size(199, 22);
			...
			BuildListContextMenu_Bisect_Separator.Size = new Size(196, 6);
			// 
			// BuildListContextMenu_Bisect_Pass
			// 
			BuildListContextMenu_Bisect_Pass.Name = "BuildListContextMenu_Bisect_Pass";
			BuildListContextMenu_Bisect_Pass.Size = new Size(199, 22);
			...
			BuildListContextMenu_Bisect_Fail.Size = new Size(199, 22);
			...
			BuildListContextMenu_Bisect_Include.Size = new Size(199, 22);
			...
			BuildListContextMenu_Bisect_Exclude.Size = new Size(199, 22);
			...
			BuildListContextMenu_MarkGood.Size = new Size(199, 22);
			...
			BuildListContextMenu_MarkBad.Size = new Size(199, 22);
			...
			BuildListContextMenu_WithdrawReview.Size = new Size(199, 22);
			...
			BuildListContextMenu_LeaveComment.Size = new Size(199, 22);
			...
			BuildListContextMenu_EditComment.Size = new Size(199, 22);
			...
			BuildListContextMenu_StartInvestigating.Size = new Size(199, 22);
			...
			BuildListContextMenu_FinishInvestigating.Size = new Size(199, 22);
			...
			BuildListContextMenu_AddStar.Size = new Size(199, 22);
			...
			BuildListContextMenu_RemoveStar.Size = new Size(199, 22);
			...
			BuildListContextMenu_TimeZoneSeparator.Size = new Size(196, 6);
			// 
			// BuildListContextMenu_ShowServerTimes
			// 
			BuildListContextMenu_ShowServerTimes.Name = "BuildListContextMenu_ShowServerTimes";
			BuildListContextMenu_ShowServerTimes.Size = new Size(199, 22);
			...
			BuildListContextMenu_ShowLocalTimes.Size = new Size(199, 22);
			...
			BuildListContextMenu_CopyChangelistNumber.Size = new Size(199, 22);
			...
			BuildListContextMenu_OpenPreflight.Size = new Size(199, 22);
			...
			BuildListContextMenu_MoreInfo.Size = new Size(199, 22);
			...
			flowLayoutPanel1.Location = new Point(454, 17);
			...
			OptionsButton.Location = new Point(1223, 13);
			...
			// PCBLabel
			// 
			PCBLabel.Anchor = AnchorStyles.Left | AnchorStyles.Right;
			PCBLabel.AutoSize = true;
			PCBLabel.ImageAlign = ContentAlignment.MiddleRight;
			PCBLabel.Location = new Point(1325, 0);
			PCBLabel.Name = "PCBLabel";
			PCBLabel.Size = new Size(29, 15);
			PCBLabel.TabIndex = 10;
			PCBLabel.Text = "PCB";
			PCBLabel.TextAlign = ContentAlignment.MiddleRight;
			// 
			// BuildListFooterLayoutPanel
			// 
			BuildListFooterLayoutPanel.AutoSize = true;
			BuildListFooterLayoutPanel.Controls.Add(PCBLabel);
			BuildListFooterLayoutPanel.Dock = DockStyle.Fill;
			BuildListFooterLayoutPanel.FlowDirection = FlowDirection.RightToLeft;
			BuildListFooterLayoutPanel.Location = new Point(3, 423);
			BuildListFooterLayoutPanel.Name = "BuildListFooterLayoutPanel";
			BuildListFooterLayoutPanel.Size = new Size(1357, 18);
			BuildListFooterLayoutPanel.TabIndex = 2;
			BuildListFooterLayoutPanel.WrapContents = false;
			// 
			// tableLayoutPanel2
			// 
			...
			StatusLayoutPanel.Controls.Add(BuildListFooterLayoutPanel, 0, 2);
			...
			StatusLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Absolute, 24F));
			...
			BuildList.Size = new Size(1363, 272);
			...
			// 
			MoreToolsContextMenu.Items.AddRange(new ToolStripItem[]
			{
			...
			MoreToolsContextMenu_CleanWorkspace.Size = new Size(202, 22);
			...
			FilterContextMenu.Size = new Size(232, 148);
			// 
			...
			BuildListFooterLayoutPanel.ResumeLayout(false);
			BuildListFooterLayoutPanel.PerformLayout();
			...
			StatusLayoutPanel.PerformLayout();
		...
		private System.Windows.Forms.ToolStripMenuItem OptionsContextMenu_SyncPrecompiledBinariesProjectOverride;
		...
		private System.Windows.Forms.FlowLayoutPanel BuildListFooterLayoutPanel;
	}
}
