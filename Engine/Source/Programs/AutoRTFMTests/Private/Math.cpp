...
// transaction is expected to match the value returned when called outside the
// transaction.
// Function must be the deterministic function with the signature 'T()'.
template<typename FUNC>
void Check(AUTORTFM_IMPLICIT_ENABLE FUNC&& Function)
{
	...
	SECTION("With Commit")
	{
		...
		AutoRTFM::Testing::Commit([&] { Got = Function(); });
