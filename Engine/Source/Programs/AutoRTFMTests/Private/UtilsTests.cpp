...
TEST_CASE("Log2")
{
	static_assert(AutoRTFM::Log2(0u) == 0);
	static_assert(AutoRTFM::Log2(1u) == 0);
	static_assert(AutoRTFM::Log2(2u) == 1);
	static_assert(AutoRTFM::Log2(3u) == 1);
	static_assert(AutoRTFM::Log2(4u) == 2);
	static_assert(AutoRTFM::Log2(5u) == 2);
	static_assert(AutoRTFM::Log2(0x0fffu) == 11);
	static_assert(AutoRTFM::Log2(0x1000u) == 12);
	static_assert(AutoRTFM::Log2(0x1001u) == 12);
	static_assert(AutoRTFM::Log2<uint8_t>(0x0) == 0);
	static_assert(AutoRTFM::Log2<uint8_t>(0xf0) == 7);
	static_assert(AutoRTFM::Log2<uint16_t>(0x0) == 0);
	static_assert(AutoRTFM::Log2<uint16_t>(0xcdef) == 15);
	static_assert(AutoRTFM::Log2<uint32_t>(0x7fffffff) == 30);
	static_assert(AutoRTFM::Log2<uint32_t>(0x80000000) == 31);
	static_assert(AutoRTFM::Log2<uint32_t>(0x80000001) == 31);
	static_assert(AutoRTFM::Log2<uint32_t>(0xfffffffe) == 31);
	static_assert(AutoRTFM::Log2<uint32_t>(0xffffffff) == 31);
	static_assert(AutoRTFM::Log2<uint64_t>(0x7fffffffffffffff) == 62);
	static_assert(AutoRTFM::Log2<uint64_t>(0x8000000000000000) == 63);
	static_assert(AutoRTFM::Log2<uint64_t>(0x8000000000000001) == 63);
	static_assert(AutoRTFM::Log2<uint64_t>(0xfffffffffffffffe) == 63);
	static_assert(AutoRTFM::Log2<uint64_t>(0xffffffffffffffff) == 63);

	for (int Index = 1; Index <= 8; ++Index)
	{
		int LowValue  = (1 << Index) / 2;
		REQUIRE(AutoRTFM::Log2<uint8_t> (LowValue) == Index-1);
		REQUIRE(AutoRTFM::Log2<uint16_t>(LowValue) == Index-1);
		REQUIRE(AutoRTFM::Log2<uint32_t>(LowValue) == Index-1);

		int HighValue = (1 << Index) - 1;
		REQUIRE(AutoRTFM::Log2<uint8_t> (HighValue) == Index-1);
		REQUIRE(AutoRTFM::Log2<uint16_t>(HighValue) == Index-1);
		REQUIRE(AutoRTFM::Log2<uint32_t>(HighValue) == Index-1);
	}
}