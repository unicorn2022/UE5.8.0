...
public:
	...
	static constexpr FKeepAliveConfig DefaultKeepAlive = FKeepAliveConfig {false, 0, 0};

							FAsioSocket(asio::ip::tcp::socket& InSocket, const FKeepAliveConfig& KeepAlive = DefaultKeepAlive);
	virtual					~FAsioSocket();
