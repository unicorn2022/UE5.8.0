...
//		GeometryCollectionAlgo::ParentTransform(Collection, 0, 1);
		...
		GeometryCollectionAlgo::DeleteCoincidentVertices(Coll, 1e-2f);
		...
		GeometryCollectionAlgo::DeleteZeroAreaFaces(Coll, 1e-4f);
	...
	void TestFillHoles()
	{
		...
		GeometryCollectionAlgo::FindOpenBoundaries(Coll, 1e-2f, BoundaryVertexIndices);
