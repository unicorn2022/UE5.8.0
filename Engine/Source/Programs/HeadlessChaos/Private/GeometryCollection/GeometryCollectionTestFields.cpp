...
namespace GeometryCollectionTest
{
	...
	void Fields_RadialIntMask()
	{
		...
		for (int32 Index = 0; Index < 10; Index++)
		{
			...
			//UE_LOGF(GCTF_Log, Error, "[%d] %d", Index, ResultsView[Index]);
		}
		delete RadialMask;
	}
	...
	void Fields_RadialFalloff()
	{
		...
		for (int32 Index = 0; Index < 10; Index++)
		{
			...
			//UE_LOGF(GCTF_Log, Error, "[%d] sample:%3.5f (%3.5f,%3.5f,%3.5f) %3.5f", Index,
			//	ExpectedVal ,
	...
	void Fields_UniformVector()
	{
		...
		for (int32 Index = 0; Index < 10; Index++)
		{
			...
			//UE_LOGF(GCTF_Log, Error, "[%d] sample:(%3.5f,%3.5f,%3.5f) (%3.5f,%3.5f,%3.5f) (%3.5f,%3.5f,%3.5f)", Index,
	...
	void Fields_SumVectorFullMult()
	{
		...
		for (int32 Index = 0; Index < 10; Index++)
		{
			...
			//UE_LOGF(GCTF_Log, Error, "[%d:%3.5f] sample:(%3.5f,%3.5f,%3.5f) (%3.5f,%3.5f,%3.5f) (%3.5f,%3.5f,%3.5f)", Index,
	...
	void Fields_SumScalar()
	{
		...
		for (int32 Index = 0; Index < NumPoints; Index++)
		{
			...
			//UE_LOGF(GCTF_Log, Error, "[%d:%3.5f] sample:(%3.5f,%3.5f,%3.5f) %3.5f -> %3.5f", Index,
