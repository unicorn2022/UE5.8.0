...
namespace ChaosTest {
	...
	{
		// Change the filter to block everything and to be marked as simple collision
		PRAGMA_DISABLE_INTERNAL_WARNINGS
		const Chaos::Filter::FShapeFilterData ShapeFilterData = Chaos::Filter::FShapeFilterBuilder::BuildBlockAll(Chaos::EFilterFlags::SimpleCollision);
