...
namespace ChaosTest
{
	...
	*/
	...
	void VectorizedAABBRaycast()
	{
		...
		FAABBVectorized AABB(MakeVectorRegisterFloat(565429.188f-12.0f, -17180.4355f-12.0f, -95264.4219f-12.0f, 0.f), MakeVectorRegisterFloat(568988.312f+12.0f, -13372.2793f+12.0f, -93649.4609f+12.0f, 0.f));

		constexpr float Length = 371.331360f;
		const VectorRegister4Float RayStart = MakeVectorRegisterFloat(565223.812f, -13919.9111f, -93982.5078f, 0.f);
		const VectorRegister4Float RayDir = MakeVectorRegisterFloat(0.0622759163f, -0.997566581f, -0.0313483514f, 0.f);
		const VectorRegister4Float RayInvDir = MakeVectorRegisterFloat(16.0575714f, -1.00243938f, -31.8996048f, 0.f);
