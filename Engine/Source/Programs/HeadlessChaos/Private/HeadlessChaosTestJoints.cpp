...
namespace ChaosTest {
	 ...
	 */
	template <typename TEvolution>
	void JointConstraint_ShortChainAnimated(const bool bProjectionEnabled)
	{
		const int32 NumIterations = 10;
		const FReal Gravity = 980;
		const FReal BoxSize = 100;
		...
		for (FPBDJointConstraintHandle* Joint : Test.Joints)
		{
			FPBDJointSettings Settings = Joint->GetSettings();
			Settings.bProjectionEnabled = bProjectionEnabled;
	 ...
	 */
	template <typename TEvolution>
	void JointConstraint_LongChainAnimated(const bool bProjectionEnabled)
	{
		...
		const FReal AcceptableDistanceError = bProjectionEnabled ? 6.5 : 5;
	...
	void JointConstraint_LongChainLinearJoints()
	{
		...
		for (int32 JointIndex = 0; JointIndex < NumParticles - 1; ++JointIndex)
		{
			...
			NonLinearJointTest.JointPositions.Add(NonLinearJointTest.ParticlePositions[JointIndex]);
		...
		for (int JointIndex = 0; JointIndex < LinearJointTest.JointPositions.Num(); ++JointIndex)
		{
			...
			EXPECT_LT(NonLinearDistanceError, LinearDistanceError);

			//// Uncomment for debugging
			//printf("ParticleIndex1: %d\n", ParticleIndex1);
			//printf("Linear Particle1 X: %f, %f, %f\n", LinearJointTest.GetParticle(ParticleIndex1)->GetX().X, LinearJointTest.GetParticle(ParticleIndex1)->GetX().Y, LinearJointTest.GetParticle(ParticleIndex1)->GetX().Z);
			//printf("Linear Particle1 P: %f, %f, %f\n", LinearJointTest.GetParticle(ParticleIndex1)->CastToRigidParticle()->GetP().X, LinearJointTest.GetParticle(ParticleIndex1)->CastToRigidParticle()->GetP().Y, LinearJointTest.GetParticle(ParticleIndex1)->CastToRigidParticle()->GetP().Z);
			//printf("Nonlinear Particle1 X: %f, %f, %f\n", NonLinearJointTest.GetParticle(ParticleIndex1)->GetX().X, NonLinearJointTest.GetParticle(ParticleIndex1)->GetX().Y, NonLinearJointTest.GetParticle(ParticleIndex1)->GetX().Z);
			//printf("Nonlinear Particle1 P: %f, %f, %f\n", NonLinearJointTest.GetParticle(ParticleIndex1)->CastToRigidParticle()->GetP().X, NonLinearJointTest.GetParticle(ParticleIndex1)->CastToRigidParticle()->GetP().Y, NonLinearJointTest.GetParticle(ParticleIndex1)->CastToRigidParticle()->GetP().Z);
			//printf("Expected Particle1: %f, %f, %f\n", LinearJointTest.ParticlePositions[ParticleIndex1].X, LinearJointTest.ParticlePositions[ParticleIndex1].Y, LinearJointTest.ParticlePositions[ParticleIndex1].Z);
			//printf("ParticleIndex2: %d\n", ParticleIndex2);
			//printf("Linear Particle2 X: %f, %f, %f\n", LinearJointTest.GetParticle(ParticleIndex2)->GetX().X, LinearJointTest.GetParticle(ParticleIndex2)->GetX().Y, LinearJointTest.GetParticle(ParticleIndex2)->GetX().Z);
			//printf("Linear Particle2 P: %f, %f, %f\n", LinearJointTest.GetParticle(ParticleIndex2)->CastToRigidParticle()->GetP().X, LinearJointTest.GetParticle(ParticleIndex2)->CastToRigidParticle()->GetP().Y, LinearJointTest.GetParticle(ParticleIndex2)->CastToRigidParticle()->GetP().Z);
			//printf("Nonlinear Particle2 X: %f, %f, %f\n", NonLinearJointTest.GetParticle(ParticleIndex2)->GetX().X, NonLinearJointTest.GetParticle(ParticleIndex2)->GetX().Y, NonLinearJointTest.GetParticle(ParticleIndex2)->GetX().Z);
			//printf("Nonlinear Particle2 P: %f, %f, %f\n", NonLinearJointTest.GetParticle(ParticleIndex2)->CastToRigidParticle()->GetP().X, NonLinearJointTest.GetParticle(ParticleIndex2)->CastToRigidParticle()->GetP().Y, NonLinearJointTest.GetParticle(ParticleIndex2)->CastToRigidParticle()->GetP().Z);
			//printf("Expected Particle2: %f, %f, %f\n", LinearJointTest.ParticlePositions[ParticleIndex2].X, LinearJointTest.ParticlePositions[ParticleIndex2].Y, LinearJointTest.ParticlePositions[ParticleIndex2].Z);
			//printf("JointIndex: %d\n", JointIndex);
			//printf("LinearDistanceError: %f\n", LinearDistanceError);
			//printf("NonLinearDistanceError: %f\n", NonLinearDistanceError);
			//printf("LinearDistance: %f\n", LinearDistance);
			//printf("NonLinearDistance: %f\n", NonLinearDistance);
			//printf("ExpectedDistance: %f\n", ExpectedDistance);
			//printf("\n");
		}
	}
	...
	GTEST_TEST(AllEvolutions, JointTests_TestShortJointChainWithAnimatedRootProjectionEnabled) {
		JointConstraint_ShortChainAnimated<FPBDRigidsEvolutionGBF>(true);
	}	
	
	GTEST_TEST(AllEvolutions, JointTests_TestShortJointChainWithAnimatedRootProjectionDisabled) {
		JointConstraint_ShortChainAnimated<FPBDRigidsEvolutionGBF>(false);
	}

	GTEST_TEST(AllEvolutions, JointTests_TestLongJointChainWithAnimatedRootProjectionEnabled) {
		JointConstraint_LongChainAnimated<FPBDRigidsEvolutionGBF>(true);
	}

	GTEST_TEST(AllEvolutions, JointTests_TestLongJointChainWithAnimatedRootProjectionDisabled) {
		JointConstraint_LongChainAnimated<FPBDRigidsEvolutionGBF>(false);
	}
