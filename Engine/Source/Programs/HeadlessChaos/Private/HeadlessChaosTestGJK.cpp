...
namespace ChaosTest
{
	...
	void SimplexTriangle()
	{
...

		{
			...
			const FVec3 ClosestPoint = TriangleSimplexFindOrigin(Simplex, Idxs, Barycentric);
			EXPECT_EQ(Idxs.NumVerts, 3);
			EXPECT_FLOAT_EQ(ClosestPoint[0], -1e-9f);
			EXPECT_FLOAT_EQ(ClosestPoint[1], 0);
			EXPECT_FLOAT_EQ(ClosestPoint[2], 0);
			EXPECT_EQ(Idxs[0], 0);
			EXPECT_EQ(Idxs[1], 1);
	...
	void GJKBoxBoxSweep()
	{
...

		{
			...
			ConvexParticles[0] = { 51870.2305f, 54369.6719f, 19200.0000f };
			ConvexParticles[1] = { -91008.5625f, -59964.0000f, -19199.9629f };
			ConvexParticles[2] = { 51870.2305f, 54369.6758f, -19199.9668f };
			ConvexParticles[3] = { 22164.4883f, 124647.500f, -19199.9961f };
			ConvexParticles[4] = { 34478.5000f, 123975.492f, -19199.9961f };
			ConvexParticles[5] = { -91008.5000f, -59963.9375f, 19200.0000f };
			ConvexParticles[6] = { -91008.5000f, 33715.5625f, 19200.0000f };
			ConvexParticles[7] = { 34478.4961f, 123975.500f, 19200.0000f };
			ConvexParticles[8] = { 22164.4922f, 124647.500f, 19200.0000f };
			ConvexParticles[9] = { -91008.5000f, 33715.5625f, -19199.9961f };
	...
	{
		{
			...
			ConvexParticles[0] ={-256.000031f,12.0000601f,384.000061f};
			ConvexParticles[1] ={256.000031f,12.0000601f,384.000061f};
			ConvexParticles[2] ={256.000031f,12.0000601f,6.10351563e-05f};
			ConvexParticles[3] ={-256.000031f,-11.9999399f,6.10351563e-05f};
			ConvexParticles[4] ={-256.000031f,12.0000601f,6.10351563e-05f};
			ConvexParticles[5] ={-256.000031f,-11.9999399f,384.000061f};
			ConvexParticles[6] ={256.000031f,-11.9999399f,6.10351563e-05f};
			ConvexParticles[7] ={256.000031f,-11.9999399f,384.000061f};
	...
	{
		{
			...
			ConvexParticles[0] ={-127.216454f,203.240234f,124.726524f};
			ConvexParticles[1] ={125.708847f,203.240295f,124.726524f};
			ConvexParticles[2] ={-120.419685f,207.124924f,-0.386817127f};
			ConvexParticles[3] ={-32.9052734f,91.5147095f,199.922119f};
			ConvexParticles[4] ={118.912071f,91.3693237f,155.363205f};
			ConvexParticles[5] ={31.3977623f,91.5147705f,199.922150f};
			ConvexParticles[6] ={115.392204f,91.6678925f,162.647476f};
			ConvexParticles[7] ={-120.419701f,91.1026840f,-0.386809498f};
			ConvexParticles[8] ={118.912086f,207.124985f,-0.386806667f};
			ConvexParticles[9] ={118.912086f,91.1027603f,-0.386806667f};
			ConvexParticles[10] ={-120.419685f,91.3692703f,155.363174f};
			ConvexParticles[11] ={-110.103012f,199.020554f,160.910324f};
			ConvexParticles[12] ={-116.899742f,91.6678467f,162.647491f};
			ConvexParticles[13] ={31.3977337f,194.240265f,194.534988f};
			ConvexParticles[14] ={-32.9052925f,194.240204f,194.534958f};
			ConvexParticles[15] ={108.595482f,199.020599f,160.910309f};
...

		{
			...
			ConvexParticles[0] ={7400.00000f, 12600.0000f, 206.248123f};
			ConvexParticles[1] ={7500.00000f, 12600.0000f, 199.994904f};
			ConvexParticles[2] ={7500.00000f, 12700.0000f, 189.837433f};
	...
	void NegativeScaleConvexTest()
	{
		...
		{
			{512.000061f, -1279.99988f, -383.999939f},
			{511.999969f, 6.81566016e-05f, 2.23802308e-05f},
			{512.000000f, -255.999939f, 2.23802308e-05f},
			{-2.36513770e-05f, -1.52587909e-05f, -2.84217094e-14f},
			{1.80563184e-05f, -256.000031f, -2.84217094e-14f},
			{2.26354750e-05f, -1024.00000f, -383.999969f},
			{7.96019594e-05f, -1280.00000f, -383.999969f},
			{512.000061f, -1023.99994f, -383.999939f}
		};
	...
	GTEST_TEST(GJKTests, GJK_LargeScaledBoxBoxTest)
	{
		...
		ConvexParticles[0] = { 500.000000f, -500.000031f, 2.84217094e-14f };
		ConvexParticles[1] = { 500.000000f, 499.999969f, -50.0000153f };
		ConvexParticles[2] = { 500.000000f, -500.000031f, -50.0000153f };
		ConvexParticles[3] = { -500.000183f, 499.999969f, -50.0000153f };
		ConvexParticles[4] = { -500.000183f, -500.000031f, 2.84217094e-14f };
		ConvexParticles[5] = { -500.000183f, -500.000031f, -50.0000153f };
		ConvexParticles[6] = { -500.000183f, 499.999969f, -2.84217094e-14f };
		ConvexParticles[7] = { 500.000000f, 499.999969f, -2.84217094e-14f };
	...
	GTEST_TEST(GJKTests, GJK_SweepSphereConvexMesh)
	{
		...
		{
			{ -1320.50159f, 461.919220f, 18.5806618f },
			{ -1321.64062f, 464.953125f, -81.3668213f },
			{ -723.913879f, 585.305603f, -65.5020828f },
			{ -1026.47400f, -493.330170f, -13.7665596f },
			{ -1027.61304f, -490.296295f, -113.714035f },
			{ -723.348694f, 578.755981f, 34.2816010f },
			{ -668.640442f, -417.582031f, -31.4263611f },
			{ -669.205688f, -411.032410f, -131.210037f }
		};
	...
	GTEST_TEST(GJKTests, GJK_SweepConvexMeshConvexMesh)
	{
		...
		{
			{ 372.876678f, 1253.23181f, 1937.96875f },
			{ -516.649231f, 1253.23181f, 1937.96875f },
			{ -516.649231f, 1253.23181f, 1873.81213f },
			{ -516.649231f, 1253.23181f, 1873.81213f },
			{ 372.876678f, 1253.23181f, 1873.81213f },
			{ 372.876678f, -2157.82104f, 2122.00000f },
			{ 372.876678f, -2157.82104f, 2057.84326f },
			{ -516.649231f, -2157.82104f, 2057.84326f },
			{ -516.649231f, -2157.82104f, 2122.00000f }
		};
		...
		{
			{ 73.4703674f, -61.1765442f, -0.19269731f },
			{ -58.2119789f, -43.0196724f, 150.211761f },
			{ 56.7236938f, -43.0196762f, 150.211761f },
			{ 73.4703674f, 87.8292542f, -0.19269731f },
			{ -73.4703674f, 87.8292542f, -0.19269731f },
			{ -73.4703751f, -61.1765366f, -0.19269731f },
			{ -45.8896980f, 52.8858337f, 150.211761f },
			{ 44.4014816f, 52.8858109f, 150.211761f }
		};
