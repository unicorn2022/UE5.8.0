	...
	*/
	...
	void ImplicitSphere()
	{
		...
		// Intersects
		{
			// Overlap
			{
				Chaos::FSphere Sphere0(FVec3(0), 2);
				Chaos::FSphere Sphere1(FVec3(4, 0, 0), 3);
				EXPECT_TRUE(Sphere0.Intersects(Sphere1));
				EXPECT_TRUE(Sphere1.Intersects(Sphere0));
			}
			// Tangent
			{
				Chaos::FSphere Sphere0(FVec3(0), 2);
				Chaos::FSphere Sphere1(FVec3(5, 0, 0), 3);
				EXPECT_TRUE(Sphere0.Intersects(Sphere1));
				EXPECT_TRUE(Sphere1.Intersects(Sphere0));
			}
			// Separating
			{
				Chaos::FSphere Sphere0(FVec3(0), 2);
				Chaos::FSphere Sphere1(FVec3(6, 0, 0), 3);
				EXPECT_FALSE(Sphere0.Intersects(Sphere1));
				EXPECT_FALSE(Sphere1.Intersects(Sphere0));
			}
		}
	}
	...
	void ConvexHull2()
	{
		...
		}
		{
			...
			Particles[2] = { 1, 1, -1 };
			Particles[3] = { 0, 0, 0.5 };
			Particles[4] = (Particles[3] - Particles[1]) * 0.5 + Particles[1] + FConvex::FVec3Type{ 0, 0, 0.1f };
			TArray<TVector<int32, 3>> Indices;
			Chaos::FConvexBuilder::BuildConvexHull(Particles, Indices);
		...
		}
		{
			...
			Particles[3] = { 0, 0, 0.5 };
			Particles[4] = (Particles[3] - Particles[1]) * 0.5 + Particles[1] + FConvex::FVec3Type{ 0, 0, 0.1f };
			Particles[5] = Particles[4] + FConvex::FVec3Type{ -0.1f, 0, 0 };
			TArray<TVector<int32, 3>> Indices;
			Chaos::FConvexBuilder::BuildConvexHull(Particles, Indices);
		...
		}
		{
			...
			Particles[6] = { 1, 1, -1 };
			Particles[7] = { 1, 1, 1 };
			Particles[8] = { 0.966962576f, -0.0577232838f, 0.959515572f };
