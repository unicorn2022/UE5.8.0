...
public:
	...
	{
		UE_LOGF(LogBenchmarkTool, Log, "Running '%ls'...", *this->Name);
...
public:
	...
	void RunBenchmarks()
	{
		...
		{
			UE_LOGF(LogBenchmarkTool, Display, 
				"%-30ls %10ld iterations took %5ld ms (%f us/iteration)",
				*Line.Name,
				Line.IterationCount,
...
struct DummyRefCount : public FRefCountedObject
{
	int _ = 0;
};
