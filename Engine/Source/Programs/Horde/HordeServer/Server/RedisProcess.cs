...
namespace HordeServer.Server
{
	...
	public sealed class RedisProcess : IAsyncDisposable
	{
		...
		public void Start(string arguments)
		{
			...
			_process = new ManagedProcess(_processGroup, tempRedisExe.FullName, $"{arguments} --bind 127.0.0.1 --port {_port} --save \"\" --appendonly no --databases 3000", redisExe.Directory.FullName, null, ProcessPriorityClass.Normal);
