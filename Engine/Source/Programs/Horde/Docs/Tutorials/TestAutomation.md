...
3. Once completed the test results will be availble in the [Automation Hub](../Config/TestAutomationHub.md) which features finely grained filters and views that can cross compare platforms and streams.
