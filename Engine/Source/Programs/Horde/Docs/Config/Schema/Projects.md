...
`retentionOptions` | [RetentionOptions](#retentionoptions)<br>Default storage retention options for all streams in this project
...
`ignorePatternFiles` | `string[]`<br>Additional ignore pattern files applied to all streams in this project. Streams can append additional files via their own IgnorePatternFiles property. Paths are relative to workspace root.
