...
internal class HttpMessageHandlerStub(HttpStatusCode statusCode, string content) : HttpMessageHandler
{
...
public class PerforceLoadBalancerTests : BuildTestSetup
{
	...
	internal static GlobalConfig GetConfig(params string[] perforceHosts)
	{
