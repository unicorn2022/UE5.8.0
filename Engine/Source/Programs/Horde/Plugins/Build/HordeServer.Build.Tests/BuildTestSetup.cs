...
namespace HordeServer.Tests
{
	...
	public class BuildTestSetup : ServerTestSetup
	{
		...
		public IBuildHealthFilterCollection BuildHealthFilterCollection => ServiceProvider.GetRequiredService<IBuildHealthFilterCollection>();
		...
		public ConformTaskSource ConformTaskSource => ServiceProvider.GetRequiredService<ConformTaskSource>();
		...
		public TestHealthService TestHealthService => ServiceProvider.GetRequiredService<TestHealthService>();
		...
		public BuildHealthFilterController BuildHealthFilterController => GetBuildHealthFilterController();
		...
		protected override void ConfigureServices(IServiceCollection services)
		{
			...
			services.AddSingleton<TestHealthService>();
		...
		private BuildHealthFilterController GetBuildHealthFilterController()
		{
			BuildHealthFilterController buildHealthFilterCtrl = ActivatorUtilities.CreateInstance<BuildHealthFilterController>(ServiceProvider);
			buildHealthFilterCtrl.ControllerContext = GetControllerContext();
			return buildHealthFilterCtrl;
		}
