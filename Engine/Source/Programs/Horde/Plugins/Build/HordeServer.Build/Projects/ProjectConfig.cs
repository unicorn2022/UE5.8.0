...
namespace HordeServer.Projects
{
	...
	public class ProjectConfig
	{
		...
		/// <summary>
		/// Default storage retention options for all streams in this project
		/// </summary>
		...
		/// <summary>
		/// Additional ignore pattern files applied to all streams in this project.
		/// Streams can append additional files via their own IgnorePatternFiles property.
