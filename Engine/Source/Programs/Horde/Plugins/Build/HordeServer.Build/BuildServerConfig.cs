...
namespace HordeServer
{
	...
	public class BuildServerConfig : PluginServerConfig
	{
		...
		/// <summary>
		/// Whether to disable bisection tasks
		/// </summary>
		public bool DisableBisection { get; set; } = true;
		...
		/// <summary>
		/// The number of days to go back in historical data to evaluate test health
		/// </summary>
		public int TestHealthHistoryEvaluationDays { get; set; } = 14;

		/// <summary>
		/// The number of days after which a test health report remind for improvement
		/// </summary>
		public int TestHealthReportRemindDays { get; set; } = 14;
