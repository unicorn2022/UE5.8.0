...
namespace HordeServer.Devices
{
	...
	public class DevicesController : ControllerBase
	{
		...
		[HttpDelete]
		[Route("/api/v1/reservations/{reservationGuid}")]
		public async Task<ActionResult> DeleteReservationV1Async(string reservationGuid, [FromQuery] bool force = false)
		{
			IDeviceReservation? reservation = await _deviceService.TryGetReservationFromLegacyGuidAsync(reservationGuid);
			...
			await _deviceService.DeleteReservationAsync(reservation.Id, force);
