...
namespace HordeServer.Devices
{
	...
	public sealed class DeviceService : IHostedService, IAsyncDisposable
	{
		...
		/// </summary>
		public DeviceService(IDeviceCollection devices, IUserCollection userCollection, JobService jobService, IServerInfo serverInfo, IOptionsMonitor<BuildServerConfig> settings, IOptionsMonitor<BuildConfig> buildConfig, INotificationService notificationService, IClock clock, Tracer tracer, ILogger<DeviceService> logger, IAuditLog<DeviceId> auditLog)
		{
		...
		public async Task<bool> DeleteReservationAsync(ObjectId id, bool force = false)
		{
			...
			{
				_logger.LogInformation("Force deleting reservation {ReservationGuid}", reservation.LegacyGuid);
			}
