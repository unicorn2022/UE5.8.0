...
namespace HordeServer.Issues
{
	...
	public interface IIssueSpan
	{
		...
		/// <summary>
		/// The maximum rank achieved during suspect scoring for this span. A value of 0 means all suspects
		/// are tied with no meaningful differentiation (no file/symbol/note matches). Null if not yet computed
		/// or for spans created before this property was added.
		/// </summary>
		public int? MaxSuspectRank { get; }
