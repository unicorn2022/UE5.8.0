...
namespace HordeServer.Issues
{
	...
	public interface IIssue
	{
		...
		/// <summary>
		/// Root commit for this issue
		/// </summary>
		public CommitId? RootCommitId { get; }

		/// <summary>
		/// User to provide the root cause analysis for this issue
		/// </summary>
		public UserId? RootCauseOwnerId { get; }

		/// <summary>
		/// Root cause category for this issue
		/// </summary>
		public string? RootCauseCategory { get; }

		/// <summary>
		/// Root cause summary for this issue
		/// </summary>
		public string? RootCauseSummary { get; }

		/// <summary>
		/// An issue id that is marked as a duplicate
		/// </summary>
		public int? DuplicateIssueId { get; }
