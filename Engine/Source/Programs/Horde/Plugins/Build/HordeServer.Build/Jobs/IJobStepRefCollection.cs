...
namespace HordeServer.Jobs
{
	...
	{
		/// <summary>
		/// Inserts or replaces a JobStepRef.
		/// </summary>
		...
		/// <param name="logger">Logger to use throughout.</param>
		...
		/// <param name="includePreStartAndSkippedStates">Whether to include pre-run and skipped states.</param>
		/// <param name="cancellationToken">Cancellation token for the operation</param>
		/// <returns>List of step references</returns>
		Task<List<IJobStepRef>> GetStepsForNodeAsync(StreamId streamId, TemplateId templateId, string nodeName, CommitIdWithOrder? commitId, bool includeFailed, int maxCount, bool includePreStartAndSkippedStates, CancellationToken cancellationToken = default);
	...
	static class JobStepRefCollectionExtensions
	{
		...
		/// Updates a job step ref.
		/// </summary>
		/// <param name="jobStepRefs">The job step ref collection.</param>
		/// <param name="job">The job which the job step belongs to..</param>
		/// <param name="batch">The batch which the job step belongs to.</param>
		/// <param name="step">The step.</param>
		/// <param name="graph">The graph.</param>
		/// <param name="logger">The logger.</param>
		/// <returns>Task object associated with the operation.</returns>
