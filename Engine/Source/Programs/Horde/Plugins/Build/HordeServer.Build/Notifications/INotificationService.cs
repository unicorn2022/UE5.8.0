...
namespace HordeServer.Notifications
{
	...
	public interface INotificationService
	{
		...
		/// </summary>
		/// <param name="report">The report data to send</param>
		/// <param name="recipient">The recipient of the report</param>
		/// <param name="carbonCopies">The users to send a carbon copy</param>
		/// <param name="cancellationToken">Cancellation token for the operation</param>
		/// <returns></returns>
		...
		/// </summary>
		/// <param name="userIds">The user ids to start conversation with</param>
		/// <param name="cancellationToken">Cancellation token for the operation</param>
		/// <returns></returns>
		...
		/// Get Channel link
		/// </summary>
		/// <param name="channel">The channel to get the link for</param>
		/// <param name="cancellationToken">Cancellation token for the operation</param>
		/// <returns></returns>
