...
namespace HordeServer.Notifications.Sinks
{
	...
	public sealed class ExperimentalSlackNotificationSink : INotificationSink, IDisposable
	{
		...
		/// <inheritdoc/>
		/// <remarks>No-op: this sink only handles job completion/step notifications via the processor. Session conflict reports are sent by the primary SlackNotificationSink.</remarks>
