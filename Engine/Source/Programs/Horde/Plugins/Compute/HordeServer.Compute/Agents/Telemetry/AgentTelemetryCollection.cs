...
namespace HordeServer.Agents.Telemetry
{
	...
	public sealed class AgentTelemetryCollection : IAgentTelemetryCollection, IHostedService, IAsyncDisposable
	{
		class AgentTelemetryDocument : IAgentTelemetry
		{
			...
			[BsonElement("hdd_tot")]
			public long WorkingTotalDisk { get; set; }

			[BsonElement("hdd_free")]
			public long WorkingFreeDisk { get; set; }

			[BsonElement("sys_hdd_tot")]
			public long SystemTotalDisk { get; set; }

			[BsonElement("sys_hdd_free")]
			public long SystemFreeDisk { get; set; }
		}
...
#pragma warning restore CA2213
		...
		public void Add(AgentId agentId, NewAgentTelemetry telemetry)
		{
			...
			document.WorkingFreeDisk = telemetry.WorkingFreeDiskMb;
			document.WorkingTotalDisk = telemetry.WorkingTotalDiskMb;
			document.SystemTotalDisk = telemetry.SystemTotalDiskMb;
			document.SystemFreeDisk = telemetry.SystemFreeDiskMb;
