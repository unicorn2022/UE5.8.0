...
namespace HordeServer
{
	...
	public class ComputeConfig : IPluginConfig
	{
		...
		/// <summary>
		/// Macros within the compute config
		/// </summary>
		...
		/// <summary>
		/// Telemetry store for lease and compute telemetry data
		/// </summary>
		public TelemetryStoreId TelemetryStoreId { get; set; } = TelemetryStoreId.Default;
