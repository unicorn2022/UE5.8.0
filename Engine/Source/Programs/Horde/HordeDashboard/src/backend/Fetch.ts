...
export class Fetch {
    ...
    get(url: string, config?: FetchRequestConfig) {
        ...
        return new Promise<FetchResponse>(async (resolve, reject) => {
            ...
            try {
                ...
                const response = await fetch(url, this.buildRequest("GET", undefined, config)).then(response => {
    ...
    put(url: string, data?: any, config?: FetchRequestConfig) {
        ...
        return new Promise<FetchResponse>((resolve, reject) => {
            ...
            fetch(url, this.buildRequest("PUT", data, config)).then(response => {
    ...
    patch(url: string, data?: any, config?: FetchRequestConfig) {
        ...
        return new Promise<FetchResponse>((resolve, reject) => {
            ...
            fetch(url, this.buildRequest("PATCH", data, config)).then(response => {
    ...
    delete(url: string, config?: FetchRequestConfig) {
        ...
        return new Promise<FetchResponse>((resolve, reject) => {
            ...
            fetch(url, this.buildRequest("DELETE", undefined, config)).then(response => {
