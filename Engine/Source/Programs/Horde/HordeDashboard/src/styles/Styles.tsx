...
registerIcons({
   ...
   icons: {
      ...
      "Grouped": IconContents.GROUP_OBJECTS,
      "UnGrouped": IconContents.UNGROUP_OBJECTS,
      "PredictiveAnalysis": IconContents.PREDICTIVE_ANALYSIS
   }
});
...
export const getHordeStyling = () => {
   ...
   const hordeClasses = mergeStyleSets({
      ...
      labelCategoryRow: {
         selectors: {
            ':hover': {
               backgroundColor: dashboard.darktheme ? 'rgba(255,255,255,0.08) !important' : 'rgba(0,0,0,0.04) !important'
            }
         }
      },
      commandBar: {
