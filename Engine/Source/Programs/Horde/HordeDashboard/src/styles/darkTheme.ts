...
// Checkbox border colors (brighter for visibility in dark mode)
const checkboxBorderColor = "#6F6F6F"
const checkboxBorderHoverColor = "#8F8F8F"
const checkboxBorderDisabledColor = "#4F4F4F"
                ...
                root: {
                    selectors: {
                        "&:not(.is-checked):not(.is-disabled):hover .ms-Checkbox-checkbox": {
                            borderColor: `${checkboxBorderHoverColor} !important`,
                        },
                        "&.is-disabled .ms-Checkbox-checkbox": {
                            borderColor: `${checkboxBorderDisabledColor} !important`,
                        }
                    }
                }
            }
