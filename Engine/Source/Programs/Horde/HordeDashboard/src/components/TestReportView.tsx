...
const getTestdataBreadcrumbProps = async (testdata: TestDataWrapper) => {
    ...
    const aliasParam = new URLSearchParams(window.location.search).get("alias");
    ...
    const crumbItems: BreadcrumbItem[] = [
        ...
        {
            text: getStreamDisplayName(stream, aliasParam),
            link: stream ? getStreamLink(stream.id, aliasParam) : undefined
        },
        {
