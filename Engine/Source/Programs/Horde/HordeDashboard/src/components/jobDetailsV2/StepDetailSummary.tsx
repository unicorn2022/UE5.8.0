...
import { GetReportResponse, JobStepError, JobStepOutcome, JobStepState } from '../../backend/Api';
      ...
      <Stack className={hordeClasses.raised}>
         <Stack tokens={{ childrenGap: 18 }}>
            ...
            <Stack >
               ...
               {!!stepMessage && <Stack verticalFill verticalAlign="center" style={{ paddingTop: 12 }} tokens={{ childrenGap: 6 }}>
                  <Text variant='medium' style={{ fontWeight: "bolder" }}>Step Message:</Text>
                  <Stack horizontal verticalFill verticalAlign="center" style={{ paddingLeft: 24, paddingTop: 2 }} tokens={{ childrenGap: 6 }}>
                     {!!stepMessageColor && <FontIcon style={{ fontSize: 13, color: stepMessageColor }} iconName="Square" />}
                     <Text>{stepMessage}</Text>
                  </Stack>
               </Stack>}
