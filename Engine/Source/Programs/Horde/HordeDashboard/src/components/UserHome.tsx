...
class UserJobsHandler {
   ...
   async update() {
      ...
      try {
         let filter = "id,streamId,name,change,preflightChange,preflightCommitId,templateId,templateHash,graphHash,startedByUserInfo,createTime,state,arguments,updateTime,labels,defaultLabel,batches,autoSubmit,autoSubmitChange,preflightDescription,abortedByUserInfo,cancellationReason";
...
const BisectionPanel: React.FC = observer(() => {
   ...
   // Bisection is currently disabled via feature flag
   return null;
