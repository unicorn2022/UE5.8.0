...
namespace JobDriver.Tests
{
	class JobRpcClientStub : JobRpc.JobRpcClient
	{
		...
		public override AsyncUnaryCall<RpcUpdateAgentWorkspacesResponse> UpdateAgentWorkspacesAsync(RpcUpdateAgentWorkspacesRequest request, CallOptions options)
		{
			RpcUpdateAgentWorkspacesResponse res = new () { Retry = false };
			return Wrap(res);
		}
