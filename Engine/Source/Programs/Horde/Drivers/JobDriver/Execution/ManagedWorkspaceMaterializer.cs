...
public sealed class ManagedWorkspaceMaterializer : IWorkspaceMaterializer
{
	...
	/// <inheritdoc/>
	public DirectoryReference SyncDir => _workspace.WorkspaceDir;
	
	/// <inheritdoc/>
	public DirectoryReference BaseDir => _workspace.MetadataDir;
	...
	{
		// Implemented in PerforceExecutor.ConformAsync
	...
	{
		if (_lastSyncedChangeNum is not null)
		{
			_perforceLogger?.AddClientView(SyncDir, _workspace.StreamView, _lastSyncedChangeNum.Value);
		}
	}
