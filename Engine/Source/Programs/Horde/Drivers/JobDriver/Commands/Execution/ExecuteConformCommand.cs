...
namespace JobDriver.Commands.Execution
{
	...
	class ExecuteConformCommand : Command
	{
		...
		public ExecuteConformCommand(HordeClientFactory hordeClientFactory, IEnumerable<IWorkspaceMaterializerFactory> materializerFactories, IOptions<DriverSettings> driverSettings, Tracer tracer)
		{
		...
		public override async Task<int> ExecuteAsync(ILogger logger)
		{
			...
			ConformExecutor conformExecutor = new ConformExecutor(hordeClient, _materializerFactories, WorkingDir, AgentId, LeaseId, conformTask, _driverSettings.Value, _tracer, logger);
