...
public class RequestHelper : IRequestHelper
{
	...
	public IActionResult? EnsureSingleRangeRequest(HttpContext context)
	{
		// asp.net does not support serving multi range requests so we return an error should that be requested
		if (context.Request.Headers.Range.ToString().Contains(',', StringComparison.OrdinalIgnoreCase))
		{
