...
public class ScyllaSettings : IValidatableObject
{
	...
	/// <summary>
	/// Whether a AWS Keyspace is used, adjusts requests to be compatible with this flavor of Cassandra.
	/// </summary>
	public bool UseAWSKeyspace { get; set; } = false;

	/// <summary>
	/// Set to false to disable use of SSL, this is only used when connecting to a CosmosDB instance or a AWS Keyspace instance
	/// </summary>
	...
	/// <summary>
	/// Used to override the consistency level for requests
	/// </summary>
	public ConsistencyLevel DefaultConsistencyLevel { get; set; } = ConsistencyLevel.LocalOne;
