...
namespace Jupiter.Implementation
{
	public class MemoryCachedContentIdStore : IContentIdStore
	{
		...
		public Task PutAsync(NamespaceId ns, ContentId contentId, BlobId[] blobIdentifiers, ulong compressedSize, ulong rawSize, CancellationToken cancellationToken)
		{
			Task actualPutTask = _actualContentIdStore.PutAsync(ns, contentId, blobIdentifiers, compressedSize, rawSize, cancellationToken);
