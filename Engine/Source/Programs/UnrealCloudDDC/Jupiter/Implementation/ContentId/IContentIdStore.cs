...
namespace Jupiter.Implementation
{
	public interface IContentIdStore
	{
		...
		/// <param name="compressedSize">Size of the blob when compressed</param>
		/// <param name="rawSize">Size of the blob when decompressed</param>
		/// <param name="cancellationToken">Cancellation token for the operation</param>
		/// <returns></returns>
		Task PutAsync(NamespaceId ns, ContentId contentId, BlobId[] blobIdentifiers, ulong compressedSize, ulong rawSize, CancellationToken cancellationToken = default);
