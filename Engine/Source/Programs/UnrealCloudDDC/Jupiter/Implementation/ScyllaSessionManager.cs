...
namespace Jupiter.Implementation
{
	public interface IScyllaSessionManager
	{
		...
		/// <summary>
		/// True when AWS Keyspace is being used
		/// </summary>
		bool IsAWSKeyspace { get; }
	}
	...
	public class ScyllaSessionManager : IScyllaSessionManager
	{
		...
		public ScyllaSessionManager(ISession replicatedSession, ISession localSession, bool isScylla, bool isCassandra, bool isKeyspace)
		{
			_replicatedSession = replicatedSession;
			_localSession = localSession;
			IsAWSKeyspace = isKeyspace;
			IsScylla = isScylla;
