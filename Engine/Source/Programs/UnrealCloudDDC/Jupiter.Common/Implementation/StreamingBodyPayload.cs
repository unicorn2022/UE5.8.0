...
namespace Jupiter.Common.Implementation
{
	...
	public class BufferedPayloadOptions
	{
		...
		/// <summary>
		/// The default root to create temporary buffered files under, defaults to %TEMP%/temp-payloads or /tmp/temp-payloads
		/// </summary>
		public string FilesystemTempPayloadRoot { get; set; } = Path.Combine(Path.GetTempPath(), "temp-payloads");
	}
