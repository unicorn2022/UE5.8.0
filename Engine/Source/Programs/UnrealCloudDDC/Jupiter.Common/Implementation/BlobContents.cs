...
namespace Jupiter.Implementation
{
	public sealed class BlobContents : IDisposable, IAsyncDisposable
	{
		...
		public BlobContents(Stream stream, long length, string? localPath = null, string? absolutePath = null)
		{
			_stream = stream;
		...
		public Stream Stream
		{
			get
			{
				if (_bufferedPayload != null && _stream == null)
				{
		...
		public IBufferedPayload? BufferedPayload => _bufferedPayload;
