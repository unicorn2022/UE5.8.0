...
bool SwitchVersion(const FString& ProjectFileName)
{
	...
	{
		FPlatformMisc::MessageBoxExt(EAppMsgType::Ok, TEXT("Couldn't set association for project. Check if the uproject file contains a valid JSON and if the file is writeable."), TEXT("Error"));
		return false;
	}
