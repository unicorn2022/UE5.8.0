...
namespace PerfSummaries
{
	...
	class SummaryTableDataJsonWriteHelper
	{
		...
		public static void WriteJsonFile(bool bSerializeToStream, string filename, Dictionary<string, dynamic> dictToSerialize, bool bWriteIndented)
		{
	...
	class SummaryTableRowData
	{
		...
		public void Add(SummaryTableElement.Type type, string name, string value, ColourThresholdList colorThresholdList = null, string tooltip = "", uint flags = 0)
		{
			...
			// Always treat csvid as string
			bool bIsCsvId = type == SummaryTableElement.Type.CsvMetadata && name == "csvid";
			if (!bIsCsvId)
			{
				try
				{
