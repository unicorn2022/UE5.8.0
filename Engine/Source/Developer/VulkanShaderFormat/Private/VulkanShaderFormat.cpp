...
static const FGuid UE_SHADER_VULKAN_SM6_VER = FGuid("506C4300-261F-4B9B-97AE-3921B3CFFF34");
...
public:
	...
	{
		uint32 Version = GetTypeHash(InternalGetVersion(Format));
	...
	{
		CompileVulkanShader(Input, PreprocessOutput, Output);
	}
