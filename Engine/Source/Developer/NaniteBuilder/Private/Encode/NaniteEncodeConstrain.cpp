...
void ConstrainClusters( TArray< FClusterGroup >& ClusterGroups, TArray< FCluster >& Clusters )
{
	...
	UE_LOGF( LogStaticMesh, Log, "ConstrainClusters:" );
	UE_LOGF( LogStaticMesh, Log, "  Input: %d Clusters, %d Triangles and %d Vertices", NumOldClusters, TotalOldTriangles, TotalOldVertices );
	UE_LOGF( LogStaticMesh, Log, "  Output without splits: %d Clusters, %d Triangles and %d Vertices", NumOldClusters, TotalNewTriangles, TotalNewVertices );
	UE_LOGF( LogStaticMesh, Log, "  Output with splits: %d Clusters, %d Triangles and %d Vertices", Clusters.Num(), TotalNewTrianglesWithSplits, TotalNewVerticesWithSplits );
}
