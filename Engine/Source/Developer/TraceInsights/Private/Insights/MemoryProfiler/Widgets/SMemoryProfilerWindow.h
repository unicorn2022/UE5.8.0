...
public:
	...
	TSharedPtr<SMemAllocTableTreeView> OpenNewMemAllocTableTreeViewTab(const FText& InTabDisplayName);
...
private:
	...
	TSharedRef<SDockTab> SpawnTab_UserAnnotations(const FSpawnTabArgs& Args);
	void OnUserAnnotationsTabClosed(TSharedRef<SDockTab> TabBeingClosed);
...
private:
	...
	/** The User Annotations panel widget. */
	TSharedPtr<TimingProfiler::SUserAnnotationsPanel> UserAnnotationsPanel;
