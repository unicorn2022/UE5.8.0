...
public:
	...
	virtual ~FThreadTimingTrackImpl() override = default;
	...
	TSharedPtr<const ITimingEvent> FindMaxEventInstance(uint32 TimerId, double StartTime, double EndTime, double MaxValidTime) const;
	TSharedPtr<const ITimingEvent> FindMinEventInstance(uint32 TimerId, double StartTime, double EndTime, double MaxValidTime) const;
