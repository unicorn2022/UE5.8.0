...
public:
	 ...
	 */
	void Construct(const FArguments& InArgs, const FText& InViewName, ETreeType InTreeType);
...
private:
	...
	FTimerNodePtr CreateTimerNodeRec(const TraceServices::FTimingProfilerButterflyNode& Node, const TraceServices::ITimingProfilerProvider& TimingProfilerProvider);
