...
public:
	...
	ETimerAggregationMode GetAggregationMode() { return AggregationMode; }
...
private:
	...
	void Mode_OnSelectionChanged(TSharedPtr<ETimerAggregationMode> InAggregationMode, ESelectInfo::Type SelectInfo);
	TSharedRef<SWidget> Mode_OnGenerateWidget(TSharedPtr<ETimerAggregationMode> InAggregationMode) const;
	FText Mode_GetSelectedText() const;
	FText Mode_GetText(ETimerAggregationMode InAggregationMode) const;
	FText Mode_GetSelectedTooltipText() const;
	FText Mode_GetTooltipText(ETimerAggregationMode InAggregationMode) const;
	...
	void ToggleShowFormatInTimerNames_Execute();
...
private:
	...
	TArray<TSharedPtr<ETimerAggregationMode>> ModeOptionsSource;

	TSharedPtr<SComboBox<TSharedPtr<ETimerAggregationMode>>> ModeComboBox;
