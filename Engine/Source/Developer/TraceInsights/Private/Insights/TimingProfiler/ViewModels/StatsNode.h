...
public:
	...
	FStatsNode(uint32 InCounterId, const FText& InDisplayName, const FName InMetaGroupName, EStatsNodeType InType, EStatsNodeDataType InDataType);

	/** Initialization constructor for the group node. */
	explicit FStatsNode(const FText& InDisplayName);
