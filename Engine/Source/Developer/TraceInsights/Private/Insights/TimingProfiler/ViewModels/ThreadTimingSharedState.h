...
private:
	...
	{
	public:
		virtual ~ITimingViewSettings() = default;
	...
	public:
		...
		virtual ~FTimingViewPersistentSettings() = default;
	...
	public:
		...
		virtual ~FTimingViewLocalSettings() = default;
...
public:
	...
	TSharedPtr<const ITimingEvent> FindMaxEventInstance(uint32 TimerId, double StartTime, double EndTime, double MaxValidTime);
	TSharedPtr<const ITimingEvent> FindMinEventInstance(uint32 TimerId, double StartTime, double EndTime, double MaxValidTime);
