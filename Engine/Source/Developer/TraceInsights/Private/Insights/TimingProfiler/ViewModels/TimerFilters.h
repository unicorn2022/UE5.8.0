...
public:
	...
	virtual ~FTimerNameFilterState() = default;

	virtual void Update() override;

	virtual bool ApplyFilter(const FBaseFilterContext& Context) const override;
...
public:
	...
	virtual ~FTimerNameFilter() = default;
...
public:
	...
	virtual ~FMetadataFilterState() = default;
...
private:
	...
	bool ApplyFilterToMetadata(const TraceServices::FMetadataSpec* MetadataSpec, TArrayView<const uint8>& Metadata) const;

	bool ShouldShowAllMetadataEvents() const { return bKeyAllowsAll && bTermAllowsAll; }
...
private:
	...
	bool bKeyAllowsAll = false;
	bool bTermAllowsAll = false;
...
public:
	...
	virtual ~FMetadataFilter() = default;
