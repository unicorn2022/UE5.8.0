...
DECLARE_LOG_CATEGORY_EXTERN(LogLoadingProfiler, Log, All);
...
public:
	...
	/** @return true, if the Requests tree view is visible */
...
private:
	...
	bool bIsEventAggregationTreeViewVisible = false;

	/** If the Object Type Aggregation tree view is visible or hidden. */
	bool bIsObjectTypeAggregationTreeViewVisible = false;

	/** If the Package Details tree view is visible or hidden. */
	bool bIsPackageDetailsTreeViewVisible = false;

	/** If the Export Details tree view is visible or hidden. */
	bool bIsExportDetailsTreeViewVisible = false;

	/** If the Requests tree view is visible or hidden. */
	bool bIsRequestsTreeViewVisible = false;

	/** The id of the Asset Loading Insights major tab. */
	FName MajorTabId;

	/** The name of the Loading Profiler log listing. */
