...
private:
	...
	void UpdateStreamTypeAndSessionName(const TraceServices::IAnalysisSession& Session);
	bool TryUpdateDiagnosticsInfo(const TraceServices::IAnalysisSession& Session);
	...
	FText GetEngineVersionText() const { return EngineVersionText; }
	...
	FText GetVFSPathsText() const { return VFSPathsText; }
	...
	EVisibility IsVisibleEngineVersionText() const { return EngineVersionText.IsEmpty() ? EVisibility::Collapsed : EVisibility::Visible; }
	...
	EVisibility IsVisibleVFSPathsText() const { return VFSPathsText.IsEmpty() ? EVisibility::Collapsed : EVisibility::Visible; }
