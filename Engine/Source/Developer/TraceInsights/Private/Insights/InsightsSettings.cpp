...
void FInsightsSettings::ResetToDefaults()
{
	...
	bShowFormatInTimerNames = Defaults.bShowFormatInTimerNames;
}
...
void FInsightsSettings::LoadFromConfig()
{
	...
	GConfig->GetBool(TEXT("Insights.TimingProfiler"), TEXT("bShowFormatInTimerNames"), bShowFormatInTimerNames, SettingsIni);
	GConfig->GetInt(TEXT("Insights.TimingProfiler"), TEXT("TimingTrackDepthLimit.Min"), TimingTrackDepthLimitMin, SettingsIni);
	GConfig->GetInt(TEXT("Insights.TimingProfiler"), TEXT("TimingTrackDepthLimit.Max"), TimingTrackDepthLimitMax, SettingsIni);
	...
	GConfig->GetInt(TEXT("Insights.TimingProfiler.TimersView"), TEXT("AggregationMode"), TimersViewAggregationMode, SettingsIni);
	...
	{
		int32 FrameTypeInt = (int32)GoToFrameType;
		GConfig->GetInt(TEXT("Insights.GoToFrame"), TEXT("FrameType"), FrameTypeInt, SettingsIni);
		GoToFrameType = (ETraceFrameType)FrameTypeInt;
	}
	GConfig->GetInt64(TEXT("Insights.GoToFrame"), TEXT("FrameNumber"), GoToFrameFrameNumber, SettingsIni);
	GConfig->GetBool(TEXT("Insights.GoToFrame"), TEXT("bZoomTimingView"), bGoToFrameZoomTimingView, SettingsIni);
	GConfig->GetBool(TEXT("Insights.GoToFrame"), TEXT("bSelectTimeRange"), bGoToFrameSelectTimeRange, SettingsIni);

	//////////////////////////////////////////////////
	// [Insights.GoToTime]

	GConfig->GetDouble(TEXT("Insights.GoToTime"), TEXT("Time"), GoToTimeTime, SettingsIni);
	GConfig->GetDouble(TEXT("Insights.GoToTime"), TEXT("TimeRangeDuration"), GoToTimeTimeRangeDuration, SettingsIni);
	GConfig->GetBool(TEXT("Insights.GoToTime"), TEXT("bZoomTimingView"), bGoToTimeZoomTimingView, SettingsIni);
	GConfig->GetBool(TEXT("Insights.GoToTime"), TEXT("bSelectTimeRange"), bGoToTimeSelectTimeRange, SettingsIni);
...
void FInsightsSettings::SaveToConfig()
{
	...
	GConfig->SetBool(TEXT("Insights.TimingProfiler"), TEXT("bShowFormatInTimerNames"), bShowFormatInTimerNames, SettingsIni);
	GConfig->SetInt(TEXT("Insights.TimingProfiler"), TEXT("TimingTrackDepthLimit.Min"), TimingTrackDepthLimitMin, SettingsIni);
	GConfig->SetInt(TEXT("Insights.TimingProfiler"), TEXT("TimingTrackDepthLimit.Max"), TimingTrackDepthLimitMax, SettingsIni);
	...
	GConfig->SetInt(TEXT("Insights.TimingProfiler.TimersView"), TEXT("AggregationMode"), TimersViewAggregationMode, SettingsIni);
	...
	GConfig->SetInt(TEXT("Insights.GoToFrame"), TEXT("FrameType"), (int32)GoToFrameType, SettingsIni);
	GConfig->SetString(TEXT("Insights.GoToFrame"), TEXT("FrameNumber"), *FString::Printf(TEXT("%lld"), GoToFrameFrameNumber), SettingsIni);
	GConfig->SetBool(TEXT("Insights.GoToFrame"), TEXT("bZoomTimingView"), bGoToFrameZoomTimingView, SettingsIni);
	GConfig->SetBool(TEXT("Insights.GoToFrame"), TEXT("bSelectTimeRange"), bGoToFrameSelectTimeRange, SettingsIni);

	//////////////////////////////////////////////////
	// [Insights.GoToTime]

	GConfig->SetDouble(TEXT("Insights.GoToTime"), TEXT("Time"), GoToTimeTime, SettingsIni);
	GConfig->SetDouble(TEXT("Insights.GoToTime"), TEXT("TimeRangeDuration"), GoToTimeTimeRangeDuration, SettingsIni);
	GConfig->SetBool(TEXT("Insights.GoToTime"), TEXT("bZoomTimingView"), bGoToTimeZoomTimingView, SettingsIni);
	GConfig->SetBool(TEXT("Insights.GoToTime"), TEXT("bSelectTimeRange"), bGoToTimeSelectTimeRange, SettingsIni);
