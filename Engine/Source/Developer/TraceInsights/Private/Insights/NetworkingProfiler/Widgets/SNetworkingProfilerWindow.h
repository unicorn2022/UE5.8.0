...
class FNetworkingProfilerCommands;
...
private:
	...
	const FNetworkingProfilerCommands& GetCommands() const;
	void BindCommands();

	//////////////////////////////////////////////////
	// Toggle Commands

	INSIGHTS_DECLARE_TOGGLE_COMMAND(TogglePacketViewVisibility)
	INSIGHTS_DECLARE_TOGGLE_COMMAND(TogglePacketContentViewVisibility)
	INSIGHTS_DECLARE_TOGGLE_COMMAND(ToggleNetStatsViewVisibility)
	INSIGHTS_DECLARE_TOGGLE_COMMAND(ToggleNetStatsCountersViewVisibility)
