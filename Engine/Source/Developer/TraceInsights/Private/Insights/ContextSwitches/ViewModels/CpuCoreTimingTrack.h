...
public:
	...
	virtual ~FCpuCoreTimingTrack() = default;
...
private:
	bool FindCpuCoreTimingEvent(const FTimingEventSearchParameters& InParameters, TFunctionRef<void(double, double, uint32, const TraceServices::FCpuCoreEvent&)> InFoundPredicate) const;
