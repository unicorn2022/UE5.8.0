...
namespace UE::Insights::Automation::TestNames
{
	const FStringView EditorTests = TEXTVIEW("UnrealInsights.Editor.");
	const FStringView ClientTests = TEXTVIEW("UnrealInsights.Client.");
	const FStringView ViewerStaticTraceTests = TEXTVIEW("UnrealInsights.Trace.Analysis.");
	const FStringView ViewerLiveTraceTests = TEXTVIEW("UnrealInsights.Analysis.");
	const FStringView HubTests = TEXTVIEW("UnrealInsights.Hub.");
	const FStringView UnitTests = TEXTVIEW("UnrealInsights.UnitTest.");
}
