...
static const FGuid UE_SHADER_PCD3D_SM6_VER    = FGuid("123ac6e6-a0a2-4a5f-b8be-4102376788ab");
...
public:
		...
		FShaderCompilerOutput& Output) const
	{
		...
		CompileD3DShader(Input, PreprocessOutput, Output, DetermineShaderModel(Input));
	}
