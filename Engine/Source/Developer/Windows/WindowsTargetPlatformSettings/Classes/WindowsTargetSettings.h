...
enum class ECompilerVersion : uint8
{
	...
	VisualStudio2026 = 5 UMETA(DisplayName = "Visual Studio 2026"),
	Clang = 6 UMETA(DisplayName = "Clang"),
	Intel = 7 UMETA(DisplayName = "Intel oneAPI"),
};
...
public:
	...
	/** Controls the level of ray tracing support for Windows. r.RayTracing cvar also needs to be enabled. */
