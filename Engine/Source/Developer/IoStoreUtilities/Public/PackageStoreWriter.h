...
public:
	...
	DECLARE_TS_MULTICAST_DELEGATE_OneParam(FEntryCreatedEvent, const FEntryCreatedEventArgs&);
	 ...
	 */
	DECLARE_TS_MULTICAST_DELEGATE_OneParam(FCommitEvent, const FCommitEventArgs&);
	 ...
	 */
	DECLARE_TS_MULTICAST_DELEGATE_OneParam(FMarkUpToDateEvent, const FMarkUpToDateEventArgs&);
