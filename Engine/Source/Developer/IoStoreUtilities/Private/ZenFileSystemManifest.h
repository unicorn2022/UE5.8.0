...
#if WITH_EDITOR
	void ConstructReferencedSetClientPath(const FString& MetadataDirectoryPath);
	void SetCookSandbox(UE::Cook::ICookSandbox* InCookSandbox);
#endif
...
private:
	...
	UE::Cook::ICookSandbox* CookSandbox = nullptr;
#endif
