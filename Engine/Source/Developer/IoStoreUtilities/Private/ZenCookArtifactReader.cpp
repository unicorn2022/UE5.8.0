...
FZenCookArtifactReader::FZenCookArtifactReader(
	...
	, StorageServerPlatformFile(nullptr)
{
}
#else
{
...
void FZenCookArtifactReader::InitializeConnection()
{
#if !UE_BUILD_SHIPPING
	...
	StorageServerPlatformFile.Reset(IStorageServerClientModule::Get().TryCreateCustomPlatformFile(*ZenRootPath,
