...
concept CArgTypes =
	...
	|| std::is_same_v<T, FStringView>;


////////////////////////////////////////////////////////////////////////////////
template <CArgTypes Type> FArgument TArgument(FStringView Name, FStringView Desc);
...
{
public:
	template <CArgTypes Type> Type	Get(FStringView Name) const;
	template <CArgTypes Type> Type	Get(FStringView Name, Type Default) const;
