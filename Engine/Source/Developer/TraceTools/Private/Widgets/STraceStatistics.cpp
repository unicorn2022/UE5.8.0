...
FText STraceStatistics::GetTraceSystemStateText() const
{
	...
	static_assert((uint8)FTraceStatus::ETraceSystemStatus::TracingToSecureNetwork == (uint8)FTraceAuxiliary::ETraceSystemStatus::TracingToSecureNetwork);
	...
	case FTraceStatus::ETraceSystemStatus::TracingToSecureNetwork:
	{
		return LOCTEXT("TracingToSecureNetwork", "Tracing to secure network connection");
	}
	default:
