...
public:
	...
	virtual void RegisterCommands() override
	{
		...
		UI_COMMAND(ToggleStatNamedEvents, "Stat Named Events", "Significantly increases the number of CPU profiler events by activating tracing for the named events system.", EUserInterfaceActionType::ToggleButton, FInputChord());
	}
