...
#elif PLATFORM_LINUX
#define GET_GL_ENTRYPOINTS(Type,Func) { Func = reinterpret_cast<Type>(SDL_GL_GetProcAddress(#Func)); if (NULL == Func) { UE_LOGF(LogInit, Fatal, "Failed to find entry point for %ls", TEXT(#Func)); }}
