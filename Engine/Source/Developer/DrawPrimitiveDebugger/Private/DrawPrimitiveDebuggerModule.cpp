...
{
#if WITH_PRIMITIVE_DEBUGGER
	UE_LOGF(LogDrawPrimitiveDebugger, Log, "Collecting a single frame graphics data capture");
...
void FDrawPrimitiveDebuggerModule::EnableLiveCapture()
{
	...
	{
		UE_LOGF(LogDrawPrimitiveDebugger, Log, "Enabling live graphics data capture");
...
void FDrawPrimitiveDebuggerModule::DisableLiveCapture()
{
	...
	if (bLiveCaptureEnabled)
	{
		UE_LOGF(LogDrawPrimitiveDebugger, Log, "Disabling live graphics data capture");
		bLiveCaptureEnabled = false;
...
{
#if WITH_PRIMITIVE_DEBUGGER
	UE_LOGF(LogDrawPrimitiveDebugger, Log, "Clearing the captured graphics data from the Primitive Debugger");
...
void FDrawPrimitiveDebuggerModule::OpenDebugWindow()
{
	...
	{
		UE_LOGF(LogDrawPrimitiveDebugger, Log, "Opening the Primitive Debugger");
...
void FDrawPrimitiveDebuggerModule::CloseDebugWindow()
{
	...
	if (DebuggerTab.IsValid())
	{
		UE_LOGF(LogDrawPrimitiveDebugger, Log, "Closing the Primitive Debugger");
