...
struct FGatherTextFromPackagesConfiguration
{
	...
	/* Specifications for how to gather text from specific metadata keys from BP/struct/enum assets. */
	UPROPERTY(config, EditAnywhere, Category = "MetaData", AdvancedDisplay)
	TArray<FMetaDataKeyGatherSpecification> MetadataKeySpecifications;
	...
	UPROPERTY(config, EditAnywhere, Category = "MetaData", AdvancedDisplay)
	TArray<FString> MetadataFieldOwnerTypesToInclude;

	/** List of field owner types (eg, MyClass, MyStruct, etc) that should have fields within them excluded from the gather. */
	UPROPERTY(config, EditAnywhere, Category = "MetaData", AdvancedDisplay)
	TArray<FString> MetadataFieldOwnerTypesToExclude;

	/** List of outer types (eg, Property, Function, ScriptStruct, etc) of fields that should be included in the gather, or empty to include everything. */
	UPROPERTY(config, EditAnywhere, Category = "MetaData", AdvancedDisplay)
	TArray<FString> MetadataFieldOuterTypesToInclude;

	/** List of outer types (eg, Property, Function, ScriptStruct, etc) of fields that should be excluded from the gather. */
	UPROPERTY(config, EditAnywhere, Category = "MetaData", AdvancedDisplay)
	TArray<FString> MetadataFieldOuterTypesToExclude;
