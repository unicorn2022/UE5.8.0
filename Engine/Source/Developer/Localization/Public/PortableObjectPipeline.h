...
namespace PortableObjectPipeline
{
	...
	/** Given developer-entered translator context notes, condition it so it can be written as the extracted comment field of a PO file */
	LOCALIZATION_API FString GetConditionedDevNotesForExtractedComment(const FString& DevNotes);
