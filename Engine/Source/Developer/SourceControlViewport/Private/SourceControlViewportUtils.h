...
// Helper method to set the opacity value. Refreshes the viewport but does not persist; call SaveFeedbackSettings when the user commits.
void SetFeedbackOpacity(FViewportClient* ViewportClient, uint8 Opacity);

// Persist current overlay settings to ini.
