...
class FTraceFilterByBuildVersion;
class FTraceFilterByBranch;
class FTraceFilterByChangelist;
class FTraceFilterByEngineVersion;
...
private:
	...
	TSharedRef<SWidget> MakeBuildVersionColumnHeaderMenu();
	TSharedRef<SWidget> MakeBuildVersionFilterMenu();
	void BuildBuildVersionFilterSubMenu(FMenuBuilder& InMenuBuilder);
	...
	TSharedRef<SWidget> MakeChangelistColumnHeaderMenu();
	TSharedRef<SWidget> MakeChangelistFilterMenu();
	void BuildChangelistFilterSubMenu(FMenuBuilder& InMenuBuilder);

	TSharedRef<SWidget> MakeEngineVersionColumnHeaderMenu();
	TSharedRef<SWidget> MakeEngineVersionFilterMenu();
	void BuildEngineVersionFilterSubMenu(FMenuBuilder& InMenuBuilder);
...
private:
	...
	TSharedPtr<FTraceFilterByBuildVersion> FilterByBuildVersion;
	TSharedPtr<FTraceFilterByBranch> FilterByBranch;
	TSharedPtr<FTraceFilterByChangelist> FilterByChangelist;
	TSharedPtr<FTraceFilterByEngineVersion> FilterByEngineVersion;
