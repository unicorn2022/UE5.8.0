...
FTraceFilterByBuildVersion::FTraceFilterByBuildVersion()
{
	ToggleAllActionTooltip = LOCTEXT("FilterByBuildVersion_ToggleAll_Tooltip", "Shows or hides all build versions.");
}
...
FTraceFilterByChangelist::FTraceFilterByChangelist()
{
	ToggleAllActionTooltip = LOCTEXT("FilterByChangelist_ToggleAll_Tooltip", "Shows or hides traces of all changelists.");
}

////////////////////////////////////////////////////////////////////////////////////////////////////

void FTraceFilterByChangelist::AddDefaultValues(TArray<uint8>& InOutDefaultValues) const
{
	for (uint8 ChangelistCategory = 0; ChangelistCategory < (uint8)EChangelistCategory::InvalidOrMax; ++ChangelistCategory)
	{
		InOutDefaultValues.Add(ChangelistCategory);
	}
}

////////////////////////////////////////////////////////////////////////////////////////////////////

FText FTraceFilterByChangelist::ValueToText(const uint8 InValue) const
{
	switch ((EChangelistCategory)InValue)
	{
	case EChangelistCategory::Zero:    return LOCTEXT("FilterByChangelist_Zero", "0");
	case EChangelistCategory::NotZero: return LOCTEXT("FilterByChangelist_NotZero", "!= 0");
...
FTraceFilterByEngineVersion::FTraceFilterByEngineVersion()
{
	ToggleAllActionTooltip = LOCTEXT("FilterByEngineVersion_ToggleAll_Tooltip", "Shows or hides all engine versions.");
}
