 ...
 */
class FLegacyProjectLauncherModule
	: public ILegacyProjectLauncherModule
{
public:
	...
	{
		FGlobalTabmanager::Get()->RegisterNomadTabSpawner(ProjectLauncherTabName, FOnSpawnTab::CreateRaw(this, &FLegacyProjectLauncherModule::SpawnProjectLauncherTab))
			.SetDisplayName(NSLOCTEXT("FProjectLauncherModule", "ProjectLauncherTabTitle", "Legacy Project Launcher (deprecated)"))
			.SetTooltipText(NSLOCTEXT("FProjectLauncherModule", "ProjectLauncherTooltipText", "Open the Legacy Project Launcher tab (note: this tool is deprecated)."))
...
IMPLEMENT_MODULE(FLegacyProjectLauncherModule, LegacyProjectLauncher);
