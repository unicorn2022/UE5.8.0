...
template <typename InAsserterType>
struct TBaseTest
{
	using AsserterType = InAsserterType;
...
template <typename InAsserterType>
using TTestInstanceGenerator = TUniquePtr<TBaseTest<InAsserterType>>(*)(TTestRunner<InAsserterType>&);
...
#define TEST_CLASS_WITH_BASE_AND_ASSERTS(_ClassName, _TestDir, _BaseClass, _AsserterType) _TEST_CLASS_IMPL(_ClassName, _TestDir, _BaseClass, _AsserterType, DefaultFlags)
