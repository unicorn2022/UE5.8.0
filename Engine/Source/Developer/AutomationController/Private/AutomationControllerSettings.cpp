...
void UAutomationControllerSettings::PostInitProperties()
{
	...
	{
		UE_LOGF(LogAutomationControllerSettings, Warning, "UAutomationControllerSettings::bTreatLogWarningsAsTestErrors is deprecated. Use bElevateLogWarningsToErrors instead.");
