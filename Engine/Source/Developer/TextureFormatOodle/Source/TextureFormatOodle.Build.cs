...
public class TextureFormatOodle : ModuleRules
{
	...
	protected void SetDynamicLibNameStrings()
	{
		...
		{
			DynamicLibNamePrefix = (Target.Architecture == UnrealArch.Arm64) ? "oo2tex_winuwparm64_" : "oo2tex_win64_";
	...
	public TextureFormatOodle(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		AddDynamicLibsForVersion("2.9.15");
		AddDynamicLibsForVersion("2.9.16");

		string LatestOodleVersion = "2.9.16";
