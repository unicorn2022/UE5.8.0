...
public:
	...
	virtual ~FAnimDataBaseAction() = default;
...
public:
	...
	virtual ~FOpenBracketAction() = default;
protected:
	FOpenBracketAction() {}
...
public:
	...
	virtual ~FCloseBracketAction() = default;
protected:
	FCloseBracketAction() {}
	UE_API virtual TUniquePtr<FChange> ExecuteInternal(IAnimationDataModel* Model, IAnimationDataController* Controller) override;
	UE_API virtual FString ToStringInternal() const override;
...
public:
	...
	virtual ~FAddTrackAction() = default;
protected:
	FAddTrackAction() {}
	UE_API virtual TUniquePtr<FChange> ExecuteInternal(IAnimationDataModel* Model, IAnimationDataController* Controller) override;
	UE_API virtual FString ToStringInternal() const override;
...
public:
	...
	virtual ~FRemoveTrackAction() = default;
protected:
	FRemoveTrackAction() {}
	UE_API virtual TUniquePtr<FChange> ExecuteInternal(IAnimationDataModel* Model, IAnimationDataController* Controller) override;
	UE_API virtual FString ToStringInternal() const override;
...
public:
	...
	virtual ~FSetTrackKeysAction() = default;
protected:
	FSetTrackKeysAction() {}
	UE_API virtual TUniquePtr<FChange> ExecuteInternal(IAnimationDataModel* Model, IAnimationDataController* Controller) override;
	UE_API virtual FString ToStringInternal() const override;
...
public:
	...
	virtual ~FResizePlayLengthInFramesAction() override = default;
protected:
...
public:
	...
	virtual ~FSetFrameRateAction() override = default;
protected:
	FSetFrameRateAction() {}
	UE_API virtual TUniquePtr<FChange> ExecuteInternal(IAnimationDataModel* Model, IAnimationDataController* Controller) override;
	UE_API virtual FString ToStringInternal() const override;
...
public:
	...
	virtual ~FAddCurveAction() = default;
protected:
	FAddCurveAction() {}
	UE_API virtual TUniquePtr<FChange> ExecuteInternal(IAnimationDataModel* Model, IAnimationDataController* Controller) override;
	UE_API virtual FString ToStringInternal() const override;
...
public:
	...
	virtual ~FAddFloatCurveAction() = default;
protected:
...
public:
	...
	virtual ~FAddTransformCurveAction() = default;
protected:
...
public:
	...
	virtual ~FRemoveCurveAction() = default;
protected:
	FRemoveCurveAction() {}
	UE_API virtual TUniquePtr<FChange> ExecuteInternal(IAnimationDataModel* Model, IAnimationDataController* Controller) override;
	UE_API virtual FString ToStringInternal() const override;
...
public:
	...
	virtual ~FSetCurveFlagsAction() = default;
protected:
...
public:
	...
	virtual ~FRenameCurveAction() = default;
protected:
	FRenameCurveAction() {}
	UE_API virtual TUniquePtr<FChange> ExecuteInternal(IAnimationDataModel* Model, IAnimationDataController* Controller) override;
	UE_API virtual FString ToStringInternal() const override;
...
public:
	...
	virtual ~FScaleCurveAction() = default;
protected:
	FScaleCurveAction() {}
	UE_API virtual TUniquePtr<FChange> ExecuteInternal(IAnimationDataModel* Model, IAnimationDataController* Controller) override;
	UE_API virtual FString ToStringInternal() const override;
...
public:
	...
	virtual ~FAddRichCurveKeyAction() = default;
protected:
...
public:
	...
	virtual ~FSetRichCurveKeyAction() = default;
protected:
...
public:
	...
	virtual ~FRemoveRichCurveKeyAction() = default;
protected:
...
public:
	...
	virtual ~FSetRichCurveKeysAction() = default;
protected:
...
public:
	...
	virtual ~FSetRichCurveAttributesAction() = default;
protected:
...
public:
	...
	virtual ~FSetCurveColorAction() = default;
protected:
...
public:
	...
	virtual ~FSetCurveCommentAction() = default;
protected:
...
public:
	...
	virtual ~FAddAtributeAction() = default;
protected:
	FAddAtributeAction() {}
	UE_API virtual TUniquePtr<FChange> ExecuteInternal(IAnimationDataModel* Model, IAnimationDataController* Controller) override;
	UE_API virtual FString ToStringInternal() const override;
...
public:
	...
	virtual ~FRemoveAtributeAction() = default;
protected:
...
public:
	...
	virtual ~FAddAtributeKeyAction() = default;
protected:
...
public:
	...
	virtual ~FSetAtributeKeyAction() = default;
protected:
...
public:
	...
	virtual ~FRemoveAtributeKeyAction() = default;
protected:
...
public:
	...
	virtual ~FSetAtributeKeysAction() = default;
protected:
