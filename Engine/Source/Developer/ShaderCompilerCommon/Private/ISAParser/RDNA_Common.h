...
inline uint32 GetAdvanceAmount(EInstructionType InstructionType)
{
...
inline bool IsSOP2(const uint32* Code, uint32& AdvanceAmount)
{
...
inline bool IsSOPK(const uint32* Code, uint32& AdvanceAmount)
{
...
inline bool IsSOP1(const uint32* Code, uint32& AdvanceAmount)
{
...
inline bool IsSOPC(const uint32* Code, uint32& AdvanceAmount)
{
...
inline bool IsSOPP(const uint32* Code, uint32& AdvanceAmount)
{
...
inline bool IsSMEM(const uint32* Code, uint32& AdvanceAmount)
{
...
inline bool IsVOP2(const uint32* Code, uint32& AdvanceAmount)
{
...
inline bool IsVOP3(const uint32* Code, uint32& AdvanceAmount)
{
...
inline bool IsVOP1(const uint32* Code, uint32& AdvanceAmount)
{
...
inline bool IsVOPC(const uint32* Code, uint32& AdvanceAmount)
{
...
inline bool IsVOP3P(const uint32* Code, uint32& AdvanceAmount)
{
...
inline bool IsVINTERP(const uint32* Code, uint32& AdvanceAmount)
{
...
inline bool IsLDSGDS(const uint32* Code, uint32& AdvanceAmount)
{
...
inline bool IsMUBUF(const uint32* Code, uint32& AdvanceAmount)
{
...
inline bool IsMTBUF(const uint32* Code, uint32& AdvanceAmount)
{
...
inline bool IsMIMG(const uint32* Code, uint32& AdvanceAmount)
{
...
inline bool IsEXPORT(const uint32* Code, uint32& AdvanceAmount)
{
...
inline bool IsFSG(const uint32* Code, uint32& AdvanceAmount)
{
...
inline EInstructionType DecodeInstructionType(const uint32* Code, uint32& AdvanceAmount)
{
...
inline const char* ToString(EInstructionType Inst)
{
