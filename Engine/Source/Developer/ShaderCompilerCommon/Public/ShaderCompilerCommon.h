...
UE_DEPRECATED(5.8, "HandleReflectedGlobalConstantBufferMember now needs Input and ShaderParameterParser parameters for future features")
extern SHADERCOMPILERCOMMON_API void HandleReflectedGlobalConstantBufferMember(
	FStringView MemberName,
	uint32 ConstantBufferIndex,
	int32 ReflectionOffset,
...
inline void HandleReflectedUniformBuffer(const FShaderCompilerInput& Input, FStringView UniformBufferName, int32 ReflectionSlot, int32 BufferSize, FShaderCompilerOutput& CompilerOutput)
{
	HandleReflectedUniformBuffer(Input, UniformBufferName, ReflectionSlot, 0, BufferSize, CompilerOutput);
}

inline void HandleReflectedUniformBuffer(const FShaderCompilerInput& Input, FStringView UniformBufferName, int32 ReflectionSlot, FShaderCompilerOutput& CompilerOutput)
{
	HandleReflectedUniformBuffer(Input, UniformBufferName, ReflectionSlot, 0, CompilerOutput);
}
...
inline void HandleReflectedShaderResource(FStringView ResourceName, int32 ReflectionSlot, int32 BindCount, FShaderCompilerOutput& CompilerOutput)
{
	HandleReflectedShaderResource(ResourceName, 0, ReflectionSlot, BindCount, CompilerOutput);
}

inline void HandleReflectedShaderResource(FStringView ResourceName, int32 ReflectionSlot, FShaderCompilerOutput& CompilerOutput)
{
...
inline void HandleReflectedShaderUAV(FStringView UAVName, int32 ReflectionSlot, int32 BindCount, FShaderCompilerOutput& CompilerOutput)
{
	HandleReflectedShaderUAV(UAVName, 0, ReflectionSlot, BindCount, CompilerOutput);
}

inline void HandleReflectedShaderUAV(FStringView UAVName, int32 ReflectionSlot, FShaderCompilerOutput& CompilerOutput)
{
...
inline void HandleReflectedShaderSampler(FStringView SamplerName, int32 ReflectionSlot, int32 BindCount, FShaderCompilerOutput& CompilerOutput)
{
	HandleReflectedShaderSampler(SamplerName, 0, ReflectionSlot, BindCount, CompilerOutput);
}

inline void HandleReflectedShaderSampler(FStringView SamplerName, int32 ReflectionSlot, FShaderCompilerOutput& CompilerOutput)
{
