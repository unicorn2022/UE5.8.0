...
struct FSpirvReflectBindings
{
	...
	TArray<SpvReflectInterfaceVariable*> PushConstants;
	...
	/** Gathers all push constant variables from the specified SPIRV-Reflect module. */
	SHADERCOMPILERCOMMON_API void GatherPushConstants(const spv_reflect::ShaderModule& SpirvReflection);
