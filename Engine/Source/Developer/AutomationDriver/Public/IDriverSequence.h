...
public:
	...
	/**
	 * Queues a move of the cursor from its current position to a new position which is specified
	 */
	virtual IAsyncActionSequence& MoveToPosition(const FVector2D& Position) = 0;
...
public:
	 ...
	 * Queues a move of the cursor from its current position to a new position which is specified
	 */
	virtual IActionSequence& MoveToPosition(const FVector2D& Position) = 0;
