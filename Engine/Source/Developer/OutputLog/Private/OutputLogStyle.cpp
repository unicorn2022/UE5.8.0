	...
	: FSlateStyleSet(StyleName)
{
	...
	// Output Log Window
	{
		...
		Set("OutputLog.OpenSourceLocation", new IMAGE_BRUSH_SVG("Starship/Common/folder-open", Icon16x16));
		Set("OutputLog.ClearLog", new IMAGE_BRUSH_SVG("Starship/Common/delete-outline", Icon16x16));
	}
