...
{
	return UE::Geometry::TessellationUtil::CalculateErrorBounds(
		Barycentrics, VertexNormals, VertexUVs, Displacements, DisplacementMap, 
		0.f, FVector2f(1.f), // here, handle center and magnitude in displacement map
		0);
}
