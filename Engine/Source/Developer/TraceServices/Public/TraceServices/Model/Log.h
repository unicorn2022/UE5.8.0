...
public:
	...
	/**
	 * Gets the number of log message specs.
	 *
	 * @returns The current number of log message specs.
	 */
	virtual uint64 GetMessageSpecCount() const { return 0; }
	...
	/**
	 * Gets the total number of messages received with unknown message spec.
	 *
	 * @returns The total number of messages received with unknown message spec.
	 */
	virtual uint64 GetUnknownSpecTotalCount() const { return 0; }

	/**
	 * Gets the number of messages received with unknown message spec and still unresolved.
	 *
	 * @returns The number of messages received with unknown message spec and still unresolved.
	 */
	virtual uint64 GetUnresolvedSpecCount() const { return 0; }
};
...
public:
	 ...
	 */
	virtual void UpdateMessageSpec(uint64 LogPoint) {}
	 ...
	 */
	UE_DEPRECATED(5.8, "Use AppendMessage(uint64, double, TArrayView<const uint8>) instead.")
	virtual void AppendMessage(uint64 LogPoint, double Time, const uint8* FormatArgs) {}
	 ...
	 * @param LogPoint The unique identity (memory address) of the message instrumentation.
	 * @param Time The time in seconds of the event.
	 * @param FormatArgsView The arguments to use in conjunction with the spec's FormatString.
	 */
	virtual void AppendMessage(uint64 LogPoint, double Time, TArrayView<const uint8> FormatArgsView) {}
	 ...
	 * @param LogPoint The unique identity (memory address) of the message instrumentation.
	 * @param Time The time in seconds of the event.
	 * @param StoredText The persistent message text.
	 */
	virtual void AppendMessage(uint64 LogPoint, double Time, const TCHAR* StoredText) = 0;
};
