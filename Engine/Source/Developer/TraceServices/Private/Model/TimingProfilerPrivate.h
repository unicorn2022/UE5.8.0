...
public:
	...
	virtual const ITimingProfilerTimerReader& GetTimerReader() const override { return *this; }
	...
	virtual void MakeTimerDisplayName(const FTimingProfilerTimer& InTimer, TStringBuilder<1024>& InOutDisplayName) const override;
