...
private:
	...
	struct FRootHeap
	{
		...
		void LogStats();
		void LogAllocSizeHistogram();
		void LogEventDistanceHistogram();
		...
		static constexpr uint32 NumAllocSizeHistogramPow2 = 66;
		uint64 AllocSizeHistogramPow2[NumAllocSizeHistogramPow2] = { 0 };
		uint64 MaxAllocSize = 0;

		static constexpr uint32 NumEventDistanceHistogramPow10 = 13;
		uint32 EventDistanceHistogramPow10[NumEventDistanceHistogramPow10] = { 0 };
...
private:
	void AllocInternal(uint32 ThreadId, double Time, uint32 CallstackId, uint64 Address, uint64 Size, uint32 Alignment, HeapId RootHeap);
	void FreeInternal(uint32 ThreadId, double Time, uint32 CallstackId, uint64 Address, HeapId RootHeap);
