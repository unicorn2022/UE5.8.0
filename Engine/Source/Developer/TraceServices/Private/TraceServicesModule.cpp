...
private:
	...
	TraceServices::FObjectModule ObjectModule;
};
...
void FTraceServicesModule::StartupModule()
{
	...
	IModularFeatures::Get().RegisterModularFeature(TraceServices::ModuleFeatureName, &ObjectModule);
}
...
void FTraceServicesModule::ShutdownModule()
{
	...
	IModularFeatures::Get().UnregisterModularFeature(TraceServices::ModuleFeatureName, &ObjectModule);
