	...
	switch (RouteId)
	{
		case RouteId_Spec:
		{
			...
			else
			{
				...
				UE_LOGF(LogTraceServices, Warning, "Stats counter %u already declared.", StatId);
			}
			...
			if (Name.IsEmpty())
			{
				UE_LOGF(LogTraceServices, Warning, "Invalid counter name for Stats counter %u.", StatId);
			...
			//if (!Name.IsEmpty())
			{
				...
				{
					UE_LOGF(LogTraceServices, Error, "Stats counter %u redeclared with different name.", StatId);
				}
			}
			...
			if (!Group.IsEmpty())
			{
				...
				{
					UE_LOGF(LogTraceServices, Error, "Stats counter %u redeclared with different group name.", StatId);
				}
			}
			...
			if (!Description.IsEmpty())
			{
				...
				{
					UE_LOGF(LogTraceServices, Error, "Stats counter %u redeclared with different description.", StatId);
				}
			}
			...
			{
				UE_LOGF(LogTraceServices, Error, "Stats counter %u redeclared with different IsFloatingPoint flag.", StatId);
			}
			...
			{
				UE_LOGF(LogTraceServices, Error, "Stats counter %u redeclared with different IsResetEveryFrame flag.", StatId);
			}
			...
			{
				UE_LOGF(LogTraceServices, Error, "Stats counter %u redeclared with different display hint.", StatId);
			}
			break;
		}
