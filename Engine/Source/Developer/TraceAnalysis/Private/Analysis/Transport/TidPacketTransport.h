...
public:
	...
	/**
	 * The "pseudo threads" have a fixed
	 * index in the thread stream array.
	 */
	enum class EThreadStreamIndex : uint32
	{
		Events = 0,
		Importants = 1,
		PseudoImportants = 2,
		RealThreadsStart = 3,
							...
							FTidPacketTransport() {}
	virtual					~FTidPacketTransport() = default;
	...
	FStreamReader*			GetKnownStream(EThreadStreamIndex KnownThread);
...
private:
	...
	TArray<FThreadStream>	Threads = {
								...
								{ {}, ETransportTid::PseudoImportants }
							};
...
public:
	...
	virtual ~FTidPacketTransportSync() = default;
};
