...
////////////////////////////////////////////////////////////////////////////////
FUtf8StringView FStoreClient::FTraceInfo::GetMetadataUri() const
{
	const FResponse* Response = (const FResponse*)this;
	return Response->GetString("metadata_uri", "");
}
...
////////////////////////////////////////////////////////////////////////////////
TUniquePtr<FStoreClient> FStoreClient::Create(const TCHAR* Host, uint32 Port)
{
	static asio::io_context IoContext;
	...
	FStoreClient* Ptr = (FStoreClient*)Impl;
	return TUniquePtr<FStoreClient>(Ptr);
}
