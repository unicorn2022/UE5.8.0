...
FAnsiStringView LexToString(EHttpErrorCode ErrorCode)
{
	switch (ErrorCode)
	{
	case EHttpErrorCode::None:                return ANSITEXTVIEW("None");
	case EHttpErrorCode::Unknown:             return ANSITEXTVIEW("Unknown");
	case EHttpErrorCode::Canceled:            return ANSITEXTVIEW("Canceled");
	case EHttpErrorCode::ResolveHost:         return ANSITEXTVIEW("ResolveHost");
	case EHttpErrorCode::Connect:             return ANSITEXTVIEW("Connect");
	case EHttpErrorCode::TlsConnect:          return ANSITEXTVIEW("TlsConnect");
	case EHttpErrorCode::TlsPeerVerification: return ANSITEXTVIEW("TlsPeerVerification");
	case EHttpErrorCode::TimedOut:            return ANSITEXTVIEW("TimedOut");
	default:                                  return ANSITEXTVIEW("Invalid");
	}

}

bool TryLexFromString(EHttpErrorCode& OutErrorCode, FAnsiStringView View)
{
	if (View == ANSITEXTVIEW("None"))
	{
		OutErrorCode = EHttpErrorCode::None;
	}
	else if (View == ANSITEXTVIEW("Unknown"))
	{
		OutErrorCode = EHttpErrorCode::Unknown;
	}
	else if (View == ANSITEXTVIEW("Canceled"))
	{
		OutErrorCode = EHttpErrorCode::Canceled;
	}
	else if (View == ANSITEXTVIEW("ResolveHost"))
	{
		OutErrorCode = EHttpErrorCode::ResolveHost;
	}
	else if (View == ANSITEXTVIEW("Connect"))
	{
		OutErrorCode = EHttpErrorCode::Connect;
	}
	else if (View == ANSITEXTVIEW("TlsConnect"))
	{
		OutErrorCode = EHttpErrorCode::TlsConnect;
	}
	else if (View == ANSITEXTVIEW("TlsPeerVerification"))
	{
		OutErrorCode = EHttpErrorCode::TlsPeerVerification;
	}
	else if (View == ANSITEXTVIEW("TimedOut"))
	{
		OutErrorCode = EHttpErrorCode::TimedOut;
	}
	else
	{
		return false;
