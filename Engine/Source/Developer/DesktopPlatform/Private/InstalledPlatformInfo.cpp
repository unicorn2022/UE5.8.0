...
void FInstalledPlatformInfo::ParsePlatformConfiguration(FString PlatformConfiguration)
{
	...
	{
		UE_LOGF(LogInstalledPlatforms, Warning, "Unable to read configuration from %ls", *PlatformConfiguration);
	...
	{
		UE_LOGF(LogInstalledPlatforms, Warning, "Unable to read platform from %ls", *PlatformConfiguration);
		bCanCreateEntry = false;
	}
	...
	{
		UE_LOGF(LogInstalledPlatforms, Warning, "Unable to read project type from %ls", *PlatformConfiguration);
		bCanCreateEntry = false;
	}
