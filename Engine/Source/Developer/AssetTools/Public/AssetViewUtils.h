...
namespace AssetViewUtils
{
	...
	struct FDeleteFolderParameters
	{
		...
		bool bShowConfirmationBeforeLoadingAssets = true;
	};
	ASSETTOOLS_API bool DeleteFolders(const FDeleteFolderParameters& InOptions);
	...
	UE_DEPRECATED(5.8, "This is no longer supported")
