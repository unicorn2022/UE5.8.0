 ...
 * @param DebugName        The name of the job, for debugging/logging purposes only.
...
UE_DEPRECATED(5.8, "Use LaunchTaskInThreadPool with DebugName and MemoryEstimate = 0.")
UE_API void LaunchTaskInThreadPool(
	IRequestOwner& Owner,
	FQueuedThreadPool* ThreadPool,
	TUniqueFunction<void ()>&& TaskBody);
