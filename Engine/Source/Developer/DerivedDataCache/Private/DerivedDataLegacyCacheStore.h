...
public:
	...
	virtual void GatherVerificationStats(FDerivedDataCacheVerificationStats& OutStats) const { }
};
...
public:
	...
	explicit FLegacyCacheKey(FStringView FullKey);

	[[nodiscard]] inline const FCacheKey& GetKey() const { return Key; }
	[[nodiscard]] inline const FSharedString& GetFullKey() const { return FullKey; }
