...
{
public:
	FTestCacheStore(const TCHAR* Name, ICacheStoreOwner& Owner, ECacheStoreFlags Flags, ETestCacheStoreFlags TestFlags);
...
FTestCacheStore::FTestCacheStore(const TCHAR* Name, ICacheStoreOwner& Owner, const ECacheStoreFlags Flags, const ETestCacheStoreFlags InTestFlags)
	: CacheStorePolicy(ECachePolicy::None)
	, CacheStoreFlags(Flags | ECacheStoreFlags::NativeAsync)
	, TestFlags(InTestFlags)
{
	...
	Owner.Add({Name}, this, CacheStoreFlags);
}
...
ITestCacheStore* CreateTestCacheStore(const TCHAR* Name, ICacheStoreOwner& Owner, const ECacheStoreFlags Flags, const ETestCacheStoreFlags TestFlags)
{
	return new FTestCacheStore(Name, Owner, Flags, TestFlags);
}
