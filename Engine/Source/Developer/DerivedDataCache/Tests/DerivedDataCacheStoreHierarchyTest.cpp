...
TEST_CASE("DerivedData::Cache::Hierarchy::PartialRecordPropagation", "[DerivedData]")
{
	...
	TUniquePtr<ILegacyCacheStore> Hierarchy(CreateCacheStoreHierarchy(StoreOwner, Maintainer, [](IMemoryCacheStore*& OutCache) { OutCache = nullptr; }));

	ITestCacheStore* Store0 = CreateTestCacheStore(TEXT("Store0"), *StoreOwner, ECacheStoreFlags::Local | ECacheStoreFlags::Query | ECacheStoreFlags::Store, ETestCacheStoreFlags::Async);
	ITestCacheStore* Store1 = CreateTestCacheStore(TEXT("Store1"), *StoreOwner, ECacheStoreFlags::Local | ECacheStoreFlags::Query | ECacheStoreFlags::Store, ETestCacheStoreFlags::Async);
	ITestCacheStore* Store2 = CreateTestCacheStore(TEXT("Store2"), *StoreOwner, ECacheStoreFlags::Local | ECacheStoreFlags::Query | ECacheStoreFlags::Store, ETestCacheStoreFlags::Async);
...
TEST_CASE("DerivedData::Cache::Hierarchy::BlockingRequestOwner", "[DerivedData]")
{
	...
	ITestCacheStore* Store0 = CreateTestCacheStore(TEXT("Store0"), *StoreOwner, ECacheStoreFlags::Local | ECacheStoreFlags::Query | ECacheStoreFlags::Store, ETestCacheStoreFlags::Async | ETestCacheStoreFlags::Wait);
	ITestCacheStore* Store1 = CreateTestCacheStore(TEXT("Store1"), *StoreOwner, ECacheStoreFlags::Local | ECacheStoreFlags::Query | ECacheStoreFlags::Store, ETestCacheStoreFlags::Async);
