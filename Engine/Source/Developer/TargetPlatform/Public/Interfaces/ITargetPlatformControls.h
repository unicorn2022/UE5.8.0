...
public:
	...
	*/
	...
	/**
	 * Checks whether the platform has non-trivial patching requirements, where regular workflows
	 * may result in invalid patches. It is recommended to check the platform's documentation.
	 *
	 * @return true if this platform has non-trivial patching requirements, false otherwise.
	 */
	virtual bool HasNonTrivialPatchGeneration() const = 0;
	...
	*
	* @return true if this platform has a secure shippable package format, false otherwise.
	*/
	 ...
	 */
	UE_DEPRECATED(5.9, "GetAllTextureFormats is deprecated.")
	virtual void GetAllTextureFormats(TArray<FName>& OutFormats) const { }

	/**
	 * GetTextureFormatModuleHints is not used and should be deleted
	 */
	...
	*/
	...
	/** Virtual destructor. */
	virtual ~ITargetPlatformControls() = default;
