...
public:
	...
	virtual bool HasNonTrivialPatchGeneration() const override
	{
		return TPlatformProperties::HasNonTrivialPatchGeneration();
	}
...
public:
	...
	virtual bool IsRunningPlatform() const override 
	{
		return TargetPlatformSettings->IsRunningPlatform();
	}
	virtual bool IsServerOnly() const override 
	{
	...
	virtual bool HasNonTrivialPatchGeneration() const override 
	{
		return TargetPlatformControls->HasNonTrivialPatchGeneration();
	}
	virtual bool HasSecurePackageFormat() const override 
	{
...
public:
	...
	/** Virtual destructor. */
	virtual ~FTargetPlatformMerged() = default;
