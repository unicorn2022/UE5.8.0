...
namespace BuildStatisticManager
{
	...
	public:
		...
		~FBuildStatisticScope()
		{
			...
			UE_LOGF(LogMeshDescriptionBuildStatistic, Log, "%ls: %f seconds - Counter: %d - Total Time: %f", *TimerDescription, ScopeTime, StatisticData.Counter, StatisticData.TotalTime);
		}
	private:
