...
TRACEINSIGHTSCORE_API FString FormatTimeValue(const double Duration, const int32 NumDigits = 2);
TRACEINSIGHTSCORE_API FString FormatTimeAuto(const double Duration, const int32 NumDigits = 2);
TRACEINSIGHTSCORE_API FString FormatTimeMs(const double Duration, const int32 NumDigits = 3, bool bAddTimeUnit = false);
