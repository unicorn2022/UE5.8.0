...
public:
	UE_NONCOPYABLE(FBaseTreeNode);

	/** Initialization constructor for the node. */
	explicit FBaseTreeNode(bool bInIsGroup)
	 ...
	 */
	//UE_DEPRECATED(5.8, "Override the GetDisplayName() instead")
	...
	virtual uint32 GetDefaultSortOrder() const
	{
		return DefaultSortOrder;
	}

	//UE_DEPRECATED(5.8, "Override GetDefaultSortOrder() in a custom node instead")
...
private:
	...
	uint32 DefaultSortOrder = 0; // deprecated in UE 5.8

	/** The name of this node. */
	const FName Name; // deprecated in UE 5.8
