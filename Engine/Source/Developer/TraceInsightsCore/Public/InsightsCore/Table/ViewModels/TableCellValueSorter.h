...
public:
	...
	virtual ~FTableCellValueSorter() = default;
	...
	bool ShouldSortGroupsFirst() const { return bShouldSortGroupsFirst; }
	void SetShouldSortGroupsFirst(bool bOnOff) { bShouldSortGroupsFirst = bOnOff; }
...
protected:
	...
	bool bShouldSortGroupsFirst = true;
};
