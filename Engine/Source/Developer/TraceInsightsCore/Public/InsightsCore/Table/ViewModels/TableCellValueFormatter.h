...
public:
	...
	virtual ~FTableCellValueFormatter() = default;
...
class FInt64ValueFormatterAsUInt32InfiniteNumber : public FTableCellValueFormatter
{
public:
	UE_API virtual FText FormatValue(const TOptional<FTableCellValue>& InValue) const override;
...
UE_DEPRECATED(5.8, "Please fix the spelling for 'Infinte'")
typedef FInt64ValueFormatterAsUInt32InfiniteNumber FInt64ValueFormatterAsUInt32InfinteNumber;
...
public:
	...
	virtual ~FInt64ValueFormatterAsMemory() = default;
...
public:
	...
	virtual ~FDoubleValueFormatterAsCustomNumber() = default;
...
class FDoubleValueFormatterAsPercent : public FTableCellValueFormatter
{
public:
	FDoubleValueFormatterAsPercent()
	{
		FormattingOptions.MinimumFractionalDigits = 2;
		FormattingOptions.MaximumFractionalDigits = 2;
	}
	virtual ~FDoubleValueFormatterAsPercent() = default;
