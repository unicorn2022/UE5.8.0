...
public:
	...
	UE_API FFilterConfiguratorNode(bool bInIsGroup);

	UE_DEPRECATED(5.8, "Use constructor without Name")
	UE_API FFilterConfiguratorNode(FName InName, bool bInIsGroup) : FFilterConfiguratorNode(bInIsGroup) {}
	...
	virtual ~FFilterConfiguratorNode() = default;
	...
	UE_API bool ApplyFilters(const FBaseFilterContext& Context) const;
