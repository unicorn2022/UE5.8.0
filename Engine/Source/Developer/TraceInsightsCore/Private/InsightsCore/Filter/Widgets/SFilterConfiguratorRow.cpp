...
{
	FFilterConfiguratorNodePtr ChildNode = MakeShared<FFilterConfiguratorNode>(false);
...
{
	FFilterConfiguratorNodePtr ChildNode = MakeShared<FFilterConfiguratorNode>(true);
	ChildNode->SetAvailableFilters(FilterConfiguratorNodePtr->GetAvailableFilters());
