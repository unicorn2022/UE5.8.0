...
private:
	...
	/** The remaining files retry period. Time left until we retry a file's CanQuerySourceControl status. */
	FTimespan RemainingPeriodPolicy;
	...
	/** Last time a file was added to the list of monitored files. */
	double LastAddedFileTimeSecs = 0.0;

	/** Last time some files were left remaining after inspection. */
	double LastRemainingFileTimeSecs = 0.0;
