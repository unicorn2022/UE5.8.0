...
/** Deprecated delegates called on pre-submit for data validation */
...
/** Structure to hold result of pre-submit data validation. */
struct FSourceControlValidationDelegateResult
{
	/** Validation result. */
	EDataValidationResult Result = EDataValidationResult::NotValidated;
	/** Error messages output during validation. */
	TArray<FText> Errors;
	/** Warning messages output during validation. */
	TArray<FText> Warnings;
	/** All messages (including error and warnings output during validation. */
	TArray<FText> AllMessages;
};

/** Delegates called on pre-submit for data validation. */
DECLARE_DELEGATE_TwoParams(FSourceControlPreSubmitChangelistValidationExDelegate, FSourceControlChangelistPtr /*Changelist*/, FSourceControlValidationDelegateResult& /*Result*/);
DECLARE_DELEGATE_TwoParams(FSourceControlPreSubmitFilesValidationExDelegate, TArray<FSourceControlStateRef>& /*States*/, FSourceControlValidationDelegateResult& /*Result*/);
...
public:
	...
	// Deprecating pure virtuals using final keyword to catch derived implementations.
	UE_DEPRECATED(5.7, "Use RegisterPreSubmitChangelistValidationEx instead.")
	virtual void RegisterPreSubmitDataValidation(const FSourceControlPreSubmitDataValidationDelegate& PreSubmitDataValidationDelegate) final {};
	UE_DEPRECATED(5.8, "Use RegisterPreSubmitChangelistValidationEx instead.")
	virtual void RegisterPreSubmitChangelistValidation(const FSourceControlPreSubmitChangelistValidationDelegate& PreSubmitChangelistValidationDelegate) final {};
	UE_DEPRECATED(5.8, "Use RegisterPreSubmitFilesValidationEx instead.")
	virtual void RegisterPreSubmitFilesValidation(const FSourceControlPreSubmitFilesValidationDelegate& PreSubmitFilesValidationDelegate) final {};
	UE_DEPRECATED(5.7, "Use UnregisterPreSubmitChangelistValidation instead.")
	virtual void UnregisterPreSubmitDataValidation() final {};
	UE_DEPRECATED(5.7, "Use GetRegisteredPreSubmitChangelistValidation instead.")
	virtual FSourceControlPreSubmitDataValidationDelegate GetRegisteredPreSubmitDataValidation() final { return FSourceControlPreSubmitDataValidationDelegate(); };
	UE_DEPRECATED(5.8, "Use GetRegisteredPreSubmitChangelistValidationEx instead.")
	virtual FSourceControlPreSubmitChangelistValidationDelegate GetRegisteredPreSubmitChangelistValidation() final { return FSourceControlPreSubmitChangelistValidationDelegate(); };
	UE_DEPRECATED(5.8, "Use GetRegisteredPreSubmitFilesValidationEx instead.")
	virtual FSourceControlPreSubmitFilesValidationDelegate GetRegisteredPreSubmitFilesValidation() final { return FSourceControlPreSubmitFilesValidationDelegate(); };

	/**
	 * Register a delegate to be called to validate asset changes by changelist before submitting changes
	 */
	virtual void RegisterPreSubmitChangelistValidationEx(const FSourceControlPreSubmitChangelistValidationExDelegate& PreSubmitChangelistValidationDelegate) = 0;
	 ...
	 */
	virtual FSourceControlPreSubmitChangelistValidationExDelegate GetRegisteredPreSubmitChangelistValidationEx() = 0;

	/**
	 * Register a delegate to be called to validate asset changes by files before submitting changes
	 */
	virtual void RegisterPreSubmitFilesValidationEx(const FSourceControlPreSubmitFilesValidationExDelegate& PreSubmitFilesValidationDelegate) = 0;
	 ...
	 */
	virtual FSourceControlPreSubmitFilesValidationExDelegate GetRegisteredPreSubmitFilesValidationEx() = 0;
