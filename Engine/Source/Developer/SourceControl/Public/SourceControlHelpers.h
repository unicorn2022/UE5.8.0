...
public:
	...
	*/
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Editor Revision Control Helpers", meta = (Keywords = "Source Control"))
	static UE_API FSourceControlState QueryFileState(const FString& InFile, bool bSilent = false, bool bUseSourceControlStateCache = false);

	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | Editor Revision Control Helpers", meta = (Keywords = "Source Control"))
	static UE_API TArray<FSourceControlState> QueryFileStates(TArray<FString> InFiles, bool bSilent = false, bool bUseSourceControlStateCache = false);
