...
void FRevisionControlStyleManager::SetActiveRevisionControlStyle(FName InNewActiveRevisionControlStyleName)
{
	...
	{
		UE_LOGF(LogSlate, Error, "Could not set the active revision control style, make sure the style you are setting exists and is registered with the FSlateStyleRegistry");
	}
...
FDefaultRevisionControlStyle::FDefaultRevisionControlStyle() : FSlateStyleSet(StyleName)
{
	...
	Set("RevisionControl.Merged", new CORE_IMAGE_BRUSH_SVG("Starship/SourceControl/RC_Merged", CoreStyleConstants::Icon16x16, FStyleColors::Foreground));
	...
	Set("RevisionControl.BranchExplorerTab", new CORE_IMAGE_BRUSH_SVG("Starship/SourceControl/RC_BranchExplorer", CoreStyleConstants::Icon16x16));
	...
	Set("RevisionControl.BranchExplorer.BranchList.Branch", new CORE_IMAGE_BRUSH_SVG("Starship/SourceControl/RC_Branch", CoreStyleConstants::Icon16x16));
	Set("RevisionControl.BranchExplorer.BranchList.PersonalBranch", new CORE_IMAGE_BRUSH_SVG("Starship/Common/Developer", CoreStyleConstants::Icon16x16));
	Set("RevisionControl.BranchExplorer.Merge", new CORE_IMAGE_BRUSH_SVG("Starship/SourceControl/RC_Merged", CoreStyleConstants::Icon16x16));
	Set("RevisionControl.BranchExplorer.NewBranch", new CORE_IMAGE_BRUSH_SVG("Starship/SourceControl/RC_NewBranch", CoreStyleConstants::Icon16x16));

	Set("RevisionControl.Cross", new CORE_IMAGE_BRUSH_SVG("Starship/Common/close", CoreStyleConstants::Icon16x16));
	Set("RevisionControl.Inspect", new CORE_IMAGE_BRUSH_SVG("Starship/Common/visible", CoreStyleConstants::Icon16x16));

	Set("RevisionControl.Filter.ResetToDefault", new CORE_IMAGE_BRUSH_SVG("Starship/Common/ResetToDefault", CoreStyleConstants::Icon16x16));
	...
	Set("RevisionControl.VerticalLineEnd", new CORE_IMAGE_BRUSH_SVG("Starship/SourceControl/RC_VerticalLineEnd", CoreStyleConstants::Icon26x26));
	...
	Set("RevisionControl.CheckCircleLine_Check", new CORE_IMAGE_BRUSH_SVG("Starship/SourceControl/RC_CheckCircleLine_Check", CoreStyleConstants::Icon26x26));
	Set("RevisionControl.CheckCircleLine_Circle", new CORE_IMAGE_BRUSH_SVG("Starship/SourceControl/RC_CheckCircleLine_Circle", CoreStyleConstants::Icon26x26));
	...
	Set("RevisionControl.BranchPoint_Branch", new CORE_IMAGE_BRUSH_SVG("Starship/SourceControl/RC_BranchCircle_Branch", CoreStyleConstants::Icon26x26));
	Set("RevisionControl.BranchPoint_Circle", new CORE_IMAGE_BRUSH_SVG("Starship/SourceControl/RC_BranchCircle_Circle", CoreStyleConstants::Icon26x26));
