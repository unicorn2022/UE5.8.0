...
public:
	...
	virtual void RegisterPreSubmitChangelistValidationEx(const FSourceControlPreSubmitChangelistValidationExDelegate& PreSubmitChangelistValidationDelegate) override;
	virtual void UnregisterPreSubmitChangelistValidation() override;
	virtual FSourceControlPreSubmitChangelistValidationExDelegate GetRegisteredPreSubmitChangelistValidationEx() override;
	
	virtual void RegisterPreSubmitFilesValidationEx(const FSourceControlPreSubmitFilesValidationExDelegate& PreSubmitFilesValidationDelegate) override;
	virtual void UnregisterPreSubmitFilesValidation() override;
	virtual FSourceControlPreSubmitFilesValidationExDelegate GetRegisteredPreSubmitFilesValidationEx() override;
...
private:
	...
	/** Time last status update got queued */
	FDateTime PendingStatusUpdateQueuedTime;
	...
	FSourceControlPreSubmitChangelistValidationExDelegate OnSourceControlPreSubmitChangelistValidation;

	/** To call when doing pre-submit files validation */
	FSourceControlPreSubmitFilesValidationExDelegate OnSourceControlPreSubmitFilesValidation;
