...
bool FDefaultSourceControlProvider::UsesSoftRevertOnDelete() const
{
	return false;
}
...
TOptional<bool> FDefaultSourceControlProvider::HasChangesToSync() const
{
	return TOptional<bool>();
}

TOptional<bool> FDefaultSourceControlProvider::HasChangesToCheckIn() const
{
	return TOptional<bool>();
}
