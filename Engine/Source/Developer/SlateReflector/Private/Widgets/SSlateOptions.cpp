...
void SSlateOptions::Construct( const FArguments& InArgs )
{
	...
	struct DebugLocal : Local
	{
		static void FillPaintSubmenu(FMenuBuilder& MenuBuilder)
		{
			...
			AddMenuEntry(MenuBuilder, Icon, LOCTEXT("Paint_OnlyInvalidationRoot", "Only Invalidation Root"), TEXT("SlateDebugger.Paint.OnlyInvalidationRoot"));
		...
		static void FillPrepassSubmenu(FMenuBuilder& MenuBuilder)
		{
			...
			AddMenuEntry(MenuBuilder, Icon, LOCTEXT("Prepass_OnlyInvalidationRoot", "Only Invalidation Root"), TEXT("SlateDebugger.Prepass.OnlyInvalidationRoot"));
