...
public:
	 ...
	 * Destructor
	 */
	virtual ~FWidgetReflectorNodeBase() = default;
	...
	/**
	 * @return The source object obtained from the widget's meta data.
	 */
	virtual UObject* GetWidgetSourceObject() const = 0;
...
public:
	 ...
	 * Destructor
	 */
	virtual ~FLiveWidgetReflectorNode() = default;
	...
	virtual UObject* GetWidgetSourceObject() const override;
...
public:
	 ...
	 * Destructor
	 */
	virtual ~FSnapshotWidgetReflectorNode() = default;
