...
UObject* FLiveWidgetReflectorNode::GetWidgetSourceObject() const
{
	if (Widget.IsValid())
	{
		return FReflectionMetaData::GetWidgetSourceObject(*Widget.Pin());
	}
...
UObject* FSnapshotWidgetReflectorNode::GetWidgetSourceObject() const
{
	return nullptr;
}
...
{
#if UE_SLATE_WITH_DYNAMIC_INVALIDATION
	return InWidget.IsValid() ? InWidget->SupportsInvalidationRecursive(SWidget::EInvalidationStrategy::UseCachedValue) : false;
#else
	return false;
#endif
}
