...
static FText GetFriendlyNameFromRHINameMac(FName InRHIName)
{
	...
	case SP_METAL_SM5_IOS:
		FriendlyRHIName = LOCTEXT("MetalMobileSM5", "iOS Metal Desktop Renderer (SM5, Metal 2.4+, iOS 15.0 or later)");
		break;
	case SP_METAL_SM6_IOS:
		FriendlyRHIName = LOCTEXT("MetalMobileSM6", "iOS Metal Desktop Renderer (SM6, Metal 3.0+, iOS 18.0 or later)");
		break;
	...
	case SP_METAL_SM5_TVOS:
		FriendlyRHIName = LOCTEXT("MetalMobileSM5TV", "tvOS Metal Desktop Renderer (SM5, Metal 2.4+, tvOS 15.0 or later)");
		break;
	case SP_METAL_SM5:
...
void FMacTargetSettingsCustomization::CustomizeDetails( IDetailLayoutBuilder& DetailBuilder )
{
	...
	TargetShaderFormatsDetails->CreateTargetShaderFormatsPropertyView(TargetPlatformSettings, &GetFriendlyNameFromRHINameMac, nullptr, ECategoryPriority::Important);
