...
public:
	 ...
	 */
	UE_DEPRECATED(5.8, "Modern Xcode is now the only option. This property is no longer used.")
	UPROPERTY(meta = (DeprecatedProperty, DeprecationMessage = "Modern Xcode is now the only option. This property is no longer used."))
	bool bUseModernXcode = true;
	 ...
	 */
	UPROPERTY(EditAnywhere, config, Category=Xcode, DisplayName = "Apple Dev Account Team ID")
	FString CodeSigningTeam;
	
	/**
	 * Bundle ID used for nativr Xcode code signing
	 */
	UPROPERTY(EditAnywhere, config, Category=Xcode, DisplayName = "Bundle ID")
	 ...
	 */
	UPROPERTY(EditAnywhere, config, Category=Xcode, DisplayName = "Bundle ID Prefix")
	 ...
	 */
	UPROPERTY(EditAnywhere, config, Category=Xcode, DisplayName = "Mac: Published App Name")
	FString ApplicationDisplayName;

	/**
	 * The App Category that will be used for Apple App Store submissions
	 */
	UPROPERTY(EditAnywhere, config, Category=Xcode, DisplayName = "App Category")
	FString AppCategory;
	
	/**
	 * The template info.plist used for Mac game targets
	 */
	UPROPERTY(EditAnywhere, config, Category="Plist Files", DisplayName = "Mac: Info.plist Template")
	FFilePath TemplateMacPlist;
	
	/**
	 * The template info.plist used for iOS game targets
	 */
	UPROPERTY(EditAnywhere, config, Category="Plist Files", DisplayName = "IOS / TVOS: Info.plist Template")
	FFilePath TemplateIOSPlist;
	
	/**
	 * The premade entitlement file used for development Mac builds
	 */
	UPROPERTY(EditAnywhere, config, Category="Entitlements", DisplayName = "Mac: Entitlements")
	FFilePath PremadeMacEntitlements;
	
	/**
	 * The premade entitlement file used for shipping Mac builds
	 */
	UPROPERTY(EditAnywhere, config, Category="Entitlements", DisplayName = "Mac:  Entitlements (Shipping config override)")
	FFilePath ShippingSpecificMacEntitlements;
	
	/**
	 * The premade entitlement file used for development IOS builds
	 */
	UPROPERTY(EditAnywhere, config, Category="Entitlements", DisplayName = "IOS: Entitlements")
	FFilePath PremadeIOSEntitlements;
	
	/**
	 * The premade entitlement file used for shipping IOS builds
	 */
	UPROPERTY(EditAnywhere, config, Category="Entitlements",  DisplayName = "IOS: Entitlements (Shipping config override)")
	FFilePath ShippingSpecificIOSEntitlements;
	
	/**
	 * Enable native Xcode code signing
	 */
	UPROPERTY(EditAnywhere, config, Category="Code Signing")
	 ...
	 */
	UPROPERTY(EditAnywhere, config, Category="Code Signing", DisplayName="Mac: Sign To Run Locally")
	bool bMacSignToRunLocally;
	
	/**
	 * The name (prefix or full) of the certificate to use for Mac code signing.
	 */
	UPROPERTY(EditAnywhere, config, Category="Code Signing", meta = (EditCondition="!bUseAutomaticCodeSigning && !bMacSignToRunLocally"), DisplayName = "Mac: Signing Identity")
	FString MacSigningIdentity;
	
	/**
	 * The name (prefix or full) of the certificate to use for IOS and TVOS code signing
	 */
	UPROPERTY(EditAnywhere, config, Category="Code Signing", meta = (EditCondition="!bUseAutomaticCodeSigning", DisplayName = "IOS / TVOS: Signing Identity"))
	 ...
	 */
	UPROPERTY(EditAnywhere, config, Category="Code Signing", meta = (EditCondition="!bUseAutomaticCodeSigning", DisplayName = "IOS: Provisioning Profile"))
	 ...
	 */
	UPROPERTY(EditAnywhere, config, Category="Code Signing", meta = (EditCondition="!bUseAutomaticCodeSigning", DisplayName = "TVOS: Provisioning Profile"))
	 ...
	 */
	UPROPERTY(EditAnywhere, config, Category="Code Signing", meta = (EditCondition="bUseAutomaticCodeSigning"))
	bool bUseAppStoreConnect;
	
	/**
	 * The Issuer ID for your App Store Connect API
	 */
	UPROPERTY(EditAnywhere, config, Category="Code Signing", meta = (EditCondition="bUseAutomaticCodeSigning && bUseAppStoreConnect", DisplayName = "App Store Connect: Issuer ID"))
	 ...
	 */
	UPROPERTY(EditAnywhere, config, Category="Code Signing", meta = (EditCondition="bUseAutomaticCodeSigning && bUseAppStoreConnect", DisplayName = "App Store Connect: Key ID"))
	FString AppStoreConnectKeyID;
	
	/**
	 * The path to the downloaded .p8 file shared with your team
	 */
	UPROPERTY(EditAnywhere, config, Category="Code Signing", meta = (EditCondition="bUseAutomaticCodeSigning && bUseAppStoreConnect", DisplayName = "App Store Connect: Key File"))
	FFilePath AppStoreConnectKeyPath;
	
	/**
	 * The path to the optional PrivacyInfo.xcprivacy file for your project
	 */
	UPROPERTY(EditAnywhere, config, Category="Privacy Manifests", meta = (DisplayName = "Mac: Additional Privacy Info"))
	FFilePath AdditionalPrivacyInfoMac;
	
	/**
	 * The path to the optional PrivacyInfo.xcprivacy file for your project
	 */
	UPROPERTY(EditAnywhere, config, Category="Privacy Manifests", meta = (DisplayName = "IOS/TVOS/VisionOS: Additional Privacy Info"))
