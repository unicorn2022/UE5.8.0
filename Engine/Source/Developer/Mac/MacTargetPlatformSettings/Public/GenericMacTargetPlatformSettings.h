...
public:
	...
	virtual bool SupportsFeature( ETargetPlatformFeatures Feature ) const override
	{
		...
		{
			static bool bEnableMobileRenderingFeatureOnMac = false;
			...
			if (!bHasCachedValue)
			{
				...
				for (const FName& Format : TargetedShaderFormats)
				{
					...
					{
						bEnableMobileRenderingFeatureOnMac = true;
						break;
					}
				}
			...
			return bEnableMobileRenderingFeatureOnMac;
		}
	...
	virtual ERayTracingRuntimeMode GetRayTracingMode() const override
	{
		...
		return TTargetPlatformSettingsBase<TProperties>::ParseRuntimeRayTracingMode(TEXT("/Script/MacTargetPlatform.MacTargetSettings"));
	}
