...
Should one find one's self faced with a choice between `Current/ushell.bat` and
an `Active/ushell.bat`, prefer the `Current/` one. This will always exist and is
