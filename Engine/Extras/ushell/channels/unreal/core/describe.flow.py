...
if sys.platform == "darwin":
    sln_open.source("cmds/sln.py", "OpenXcode")
else:
...
sln_vscode = flow.describe.Command()
sln_vscode.source("cmds/sln.py", "OpenVSCode")
sln_vscode.invoke("sln", "open", "code")

sln_tiny = flow.describe.Command()
sln_tiny.source("cmds/sln.py", "Tiny")
sln_tiny.invoke("sln", "open", "tiny")

sln_file = flow.describe.Command()
sln_file.source("cmds/sln.py", "File")
sln_file.invoke("sln", "open", "file")

sln_vs = flow.describe.Command()
sln_vs.source("cmds/sln.py", "OpenVS")
sln_vs.invoke("sln", "open", "vs")

sln_rider = flow.describe.Command()
sln_rider.source("cmds/sln.py", "OpenRider")
sln_rider.invoke("sln", "open", "rider")
...
#-------------------------------------------------------------------------------
ai = flow.describe.Command()
ai.source("cmds/ai/cmd.py", "Ai")
ai.invoke("ai")
