...
class ClangDb(unrealcmd.Cmd):
    ...
    noallmodules = unrealcmd.Opt(False, "Do not add the -AllModules argument when running UnrealBuildTool")
    ...
    def main(self):
        ...
        if not self.args.noallmodules:
            ubt_args = (*ubt_args, "-allmodules")
