...
namespace PDBReader
{
	...
	struct StructFieldCounts
	{
		...
		public uint NumFunctionMembers;
	}
	...
	internal unsafe class PDBReader
	{
		...
		[DllImport(LibraryName)]
		internal static extern void ReadFunctionMembers(
			PDBHandle* handle,
			TPIRecord* fieldListRecord,
			[In, Out, MarshalAs(UnmanagedType.LPArray)] FunctionMemberInfo[] functions
			);
	}

	[Flags]
	enum FunctionMemberFlags
	{
		None = 0x0,
		Virtual = 0x1,
		Static = 0x2,
	...
	struct FunctionMemberInfo
	{
		public IntPtr Name;
		public uint TypeIndex;
		public FunctionMemberFlags Flags;
		public IntPtr ReturnType;
		public IntPtr Parameters;

		public bool IsVirtual { get { return (Flags & FunctionMemberFlags.Virtual) != FunctionMemberFlags.None; } }
		public bool IsStatic { get { return (Flags & FunctionMemberFlags.Static) != FunctionMemberFlags.None; } }
		public bool IsConst { get { return (Flags & FunctionMemberFlags.Const) != FunctionMemberFlags.None; } }
		public bool IsPure { get { return (Flags & FunctionMemberFlags.Pure) != FunctionMemberFlags.None; } }
		public bool IsIntro { get { return (Flags & FunctionMemberFlags.Intro) != FunctionMemberFlags.None; } }
	}
}
