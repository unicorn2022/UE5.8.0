...
namespace P4VUtils.Commands
{
	...
	public class BuildVersion
	{
		...
		/// <summary>Perforce changelist number this build was made from</summary>
		public int? Changelist { get; set; }
		/// <summary>Oldest changelist this build is compatible with</summary>
		public int? CompatibleChangelist { get; set; }
		/// <summary>Whether this is a licensee build</summary>
		public int? IsLicenseeVersion { get; set; }
		/// <summary>Whether this is a promoted build</summary>
		public int? IsPromotedBuild { get; set; }
		/// <summary>Source control branch name</summary>
		public string? BranchName { get; set; }
		/// <summary>Unique identifier for this build</summary>
	...
	/// <summary>Logging extension methods</summary>
