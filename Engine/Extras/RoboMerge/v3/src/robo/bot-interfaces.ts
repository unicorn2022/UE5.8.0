...
export interface IPCControls {
	...
	forceSetLastClWithContext(value: number, culprit: string, reason: string, unblock?: boolean, isSkip?: boolean): number
...
// ReconsiderArgs are the additional args used by stomp etc. I'm adding commandOverride to them, even though that's a
