...
export function getDisplayNameFromBranchArg(branchArg: BranchArg): string {
	return (branchArg as Branch).displayName || branchArg as string
}
...
export enum StompRequestResult {
	'Invalid',
	'Valid',
	'LimitedInfo'
}
...
export interface StompVerification extends OperationResult {
	requestResult?: keyof typeof StompRequestResult
...
export function GetStompVerificationResult(verifyResult: StompVerification): OperationResult {
	...
	if (verifyResult.requestResult === 'Invalid') {
...
export type EditableBranch = BranchBase & {
	...
	displayName: string // computed from config.displayName or name
...
export type MergeMode = 'safe' | 'normal' | 'null' | 'clobber' | 'skip' | 'manual'
...
export interface Blockage {
	...
	triager?: string
	triagerEmail?: Promise<string | null>
	approval?: {
...
export interface AlreadyIntegrated {
	change: ChangeInfo
	action: MergeAction
	reason?: 'already_integrated' | 'no_files'
}
...
export interface MergeConflictAdditionalInformation {
	...
	// Limited information mode for large changelists
	limitedInfoMode?: boolean
}

export function isA_MergeConflictAdditionalInformation(obj: any): obj is MergeConflictAdditionalInformation {
  return (
    obj !== null &&
    typeof obj === "object" &&
    typeof obj.resolveResult === "object" &&
    (obj.describeResult === undefined || typeof obj.describeResult === "object") &&
    (obj.disableStompReason === undefined || typeof obj.disableStompReason === "string") &&
    (obj.client === undefined || typeof obj.client === "string") &&
    (obj.limitedInfoMode === undefined || typeof obj.limitedInfoMode === "boolean")
  )
}
...
export type NagBlockageEvent = {
	sourceBranch: Branch
	conflict: PersistentConflict
	triager: string
	triagerEmail: Promise<string>
