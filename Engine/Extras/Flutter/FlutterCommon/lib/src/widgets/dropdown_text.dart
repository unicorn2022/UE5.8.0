...
class DropdownText<ItemType> extends StatelessWidget {
  const DropdownText({
    Key? key,
    required this.value,
    required this.items,
...
/// The inner contents of a [DropdownText], showing the text and the chevron icon.
class _DropdownTextInner extends StatelessWidget {
  const _DropdownTextInner({
    Key? key,
    required this.text,
