...
class EpicLozengeButton extends StatelessWidget {
  ...
  /// The function to call when the button is pressed. If not provided, the button is considered inactive and will
  ...
  /// Whether to show button outliner or not.
  final bool bShowBorder;

  @override
  Widget build(BuildContext context) {
    final ThemeData theme = Theme.of(context);

    final Color colorToUse = onPressed == null ? UnrealColors.gray42 : (color ?? theme.colorScheme.primary);
        ...
        child: GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: bShowBorder ? Border.all(color: UnrealColors.gray06, width: 1) : null,
            ),
            child: Center(
              widthFactor: 1,
              child: Text(
                ...
                style: theme.textTheme.headlineSmall!.copyWith(
                  color: colorToUse?.alpha == 0 ? theme.colorScheme.onSurface : theme.colorScheme.onPrimary,
                ),
              ),
            ),
          ),
