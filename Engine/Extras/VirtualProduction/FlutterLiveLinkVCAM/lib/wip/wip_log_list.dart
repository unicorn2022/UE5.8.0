...
/// Temporary page showing the list of log files.
class WipLogList extends StatefulWidget {
  const WipLogList({Key? key}) : super(key: key);

  static const String route = '/';

  @override
  State<WipLogList> createState() => _WipLogListState();
}

class _WipLogListState extends State<WipLogList> {
