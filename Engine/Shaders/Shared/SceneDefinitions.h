...
#define PRIMITIVE_SCENE_DATA_FLAG_UNUSED_2									0x10000
...
#define PRIMITIVE_SCENE_DATA_FLAG_UNUSED_3									0x100000
...
// NOTE: Reverse culling in Nanite was implemented, but found to create issues with HLOD/PLA that rely on the flag for certain
// behavior with non-Nanite. Will need a resolution for these issues before we're able to add support back. See UE-174319
