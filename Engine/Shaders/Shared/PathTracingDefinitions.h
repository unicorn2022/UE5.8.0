...
// Constants for 'PATH_TRACER_KERNEL_TYPE'
#define PATH_TRACER_KERNEL_CAMERA 0   // Camera rays only
#define PATH_TRACER_KERNEL_INNER  1   // Internal single-bounce
#define PATH_TRACER_KERNEL_TAIL   2   // Internal tail bounces (from a fixed point up to the max)
...
#define PATHTRACER_MASK_CAMERA_OPAQUE                       0x01            // Visible to Camera and BlendMode=Opaque+Masked 
#define PATHTRACER_MASK_CAMERA_TRANSLUCENT                  0x02            // Visible to Camera and BlendMode=Translucent+others (all blend modes outside of opaque and masked)
#define PATHTRACER_MASK_SHADOW                              0x04            // Casts shadows: all blend modes
#define PATHTRACER_MASK_INDIRECT_OPAQUE                     0x08            // Affects Indirect and BlendMode=Opaque+Masked 
#define PATHTRACER_MASK_INDIRECT_TRANSLUCENT                0x10            // Affects Indirect and BlendMode=Translucent+others
#define PATHTRACER_MASK_REFLECTION_OPAQUE                   0x20            // Visible in Reflections and BlendMode=Opaque+Masked
#define PATHTRACER_MASK_REFLECTION_TRANSLUCENT              0x40			// Visible in Reflections and BlendMode=Translucent+others
#define PATHTRACER_MASK_SSS_RANDOM_WALK                     0x80            // Visible to SSS random walks
...
#define PATH_TRACER_DEBUG_VIZ_LIGHT_GRID_LIST_HASH      22
#define PATH_TRACER_DEBUG_VIZ_LIGHT_GRID_SINGULAR       23
#define PATH_TRACER_DEBUG_VIZ_DECAL_GRID_COUNT 			24
#define PATH_TRACER_DEBUG_VIZ_DECAL_GRID_AXIS			25
#define PATH_TRACER_DEBUG_VIZ_DECAL_GRID_LIST_HASH      26
#define PATH_TRACER_DEBUG_VIZ_VOLUME_LIGHT_COUNT        27
#define PATH_TRACER_DEBUG_VIZ_HITKIND                   28
#define PATH_TRACER_DEBUG_VIZ_TRANSPARENCY_COUNT		29
#define PATH_TRACER_DEBUG_VIZ_SSS_COLOR                 30
#define PATH_TRACER_DEBUG_VIZ_SSS_RADIUS                31
#define PATH_TRACER_DEBUG_VIZ_SSS_WEIGHT                32
#define PATH_TRACER_DEBUG_VIZ_SSS_PHASE                 33
#define PATH_TRACER_DEBUG_VIZ_FUZZ_COLOR                34
#define PATH_TRACER_DEBUG_VIZ_FUZZ_ROUGHNESS            35
#define PATH_TRACER_DEBUG_VIZ_FUZZ_AMOUNT               36
#define PATH_TRACER_DEBUG_VIZ_BSDF_OPACITY              37
#define PATH_TRACER_DEBUG_VIZ_SUBSTRATE_WEIGHT_V		38
#define PATH_TRACER_DEBUG_VIZ_SUBSTRATE_TRANSMITTANCE_N 39
#define PATH_TRACER_DEBUG_VIZ_SUBSTRATE_COVERAGE_ABOVE_N 40
#define PATH_TRACER_DEBUG_VIZ_SUBSTRATE_F90 			41
#define PATH_TRACER_DEBUG_VIZ_EYE_IRIS_MASK             42
#define PATH_TRACER_DEBUG_VIZ_EYE_CAUSTIC_NORMAL        43
#define PATH_TRACER_DEBUG_VIZ_EYE_IRIS_NORMAL           44
#define PATH_TRACER_DEBUG_VIZ_BACKFACING_NORMAL         45
#define PATH_TRACER_DEBUG_VIZ_HAIR_PRIMITIVE_UV         46
#define PATH_TRACER_DEBUG_VIZ_TRIANGLE_ID               47
#define PATH_TRACER_DEBUG_VIZ_INSTANCE_ID               48
#define PATH_TRACER_DEBUG_VIZ_CLUSTER_ID                49
#define PATH_TRACER_DEBUG_VIZ_DECAL_COVERAGE            50
#define PATH_TRACER_DEBUG_VIZ_DECAL_COLOR               51
#define PATH_TRACER_DEBUG_VIZ_DECAL_NORMAL              52
#define PATH_TRACER_DEBUG_VIZ_DECAL_RMS                 53
#define PATH_TRACER_DEBUG_VIZ_DECAL_RADIANCE            54
#define PATH_TRACER_DEBUG_VIZ_DECAL_RESPONSE_MASK       55
#define PATH_TRACER_DEBUG_VIZ_DECAL_USE_DBUFFER         56
