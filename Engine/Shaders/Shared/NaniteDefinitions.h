...
#define NANITE_MAX_HIERARCHY_BONE_INFLUENCES				16
#define NANITE_HIERARCHY_NUM_BONES_BITS						5
#define NANITE_HIERARCHY_BONE_INDICES_OFFSET_BITS			27
...
#define NANITE_MAX_HIERARCHY_CHILDREN_BITS					6
#define NANITE_MAX_HIERARCHY_CHILDREN						(1 << NANITE_MAX_HIERARCHY_CHILDREN_BITS)
...
#define NANITE_HIERARCHY_NODE_SLICE_SIZE_DWORDS				60
...
#define NANITE_VIEW_FLAG_PREFILTERED_DISTANT_DEPTH_CULL		0x80
#define NANITE_VIEW_FLAG_FORCE_DISPLACEMENT_FALLBACK		0x100
...
#define NANITE_MAX_CURVE_RADIUS_QUANTIZATION_BITS			8
#define NANITE_MAX_CURVE_RADIUS_QUANTIZATION_BYTES			((NANITE_MAX_CURVE_RADIUS_QUANTIZATION_BITS + 7) / 8)
...
#define NANITE_MATERIAL_FLAG_TRANSLUCENT					0x2000
#define NANITE_MATERIAL_FLAG_USED							0x4000
#define NANITE_MATERIAL_FLAG_CURVE							0x8000
...
#define NANITE_FIXED_FUNCTION_BIN_CURVE						0x20
...
#define NANITE_DEBUG_FLAG_DISABLE_SKINNED_NODE_BOUNDS				0x20
#define NANITE_DEBUG_FLAG_DISABLE_WPO_DISABLE_DISTANCE				0x40
#define NANITE_DEBUG_FLAG_DISABLE_PIXEL_PROGRAMMABLE_DISTANCE		0x80
#define NANITE_DEBUG_FLAG_DISABLE_DISPLACEMENT_FADE_OUT_DISTANCE	0x100
#define NANITE_DEBUG_FLAG_DRAW_ONLY_ROOT_DATA						0x200
#define NANITE_DEBUG_FLAG_HIDE_ASSEMBLY_PARTS						0x400
#define NANITE_DEBUG_FLAG_WRITE_ASSEMBLY_META						0x800

#define NANITE_INVALID_RASTER_BIN		0xFFFFu
#define NANITE_INVALID_RASTER_GROUP		0xFFFFu
#define NANITE_INVALID_SHADING_GROUP	0xFFFFu
...
#define NANITE_SHADING_BIN_GROUP_COUNT		5
#define NANITE_SHADING_BIN_GROUP_RESERVE	6
...
#define NANITE_VISUALIZE_CURVES								40u
...
INLINE_ATTR FNaniteMaterialFlags UnpackNaniteMaterialFlags(UINT_TYPE Packed)
{
	...
	MaterialFlags.bCurve = (Packed & NANITE_MATERIAL_FLAG_CURVE) != 0u;
	MaterialFlags.bFirstPersonLerp = (Packed & NANITE_MATERIAL_FLAG_FIRST_PERSON_LERP) != 0u;
	MaterialFlags.bTranslucent = (Packed & NANITE_MATERIAL_FLAG_TRANSLUCENT) != 0u;
...
INLINE_ATTR UINT_TYPE PackNaniteMaterialBitFlags(FNaniteMaterialFlags Flags)
{
	...
	if (Flags.bCurve)
	{
		MaterialBitFlags |= NANITE_MATERIAL_FLAG_CURVE;
	}
	...
	if (Flags.bTranslucent)
	{
		MaterialBitFlags |= NANITE_MATERIAL_FLAG_TRANSLUCENT;
	}
...
struct FNaniteStats
{
	...
	UINT_TYPE NumActiveRasterBins;
	UINT_TYPE NumActiveRasterGroups;
	UINT_TYPE NumEmptySWRasterGroups;
	UINT_TYPE NumEmptyHWRasterGroups;
	UINT_TYPE NumTotalShadingBins;
	UINT_TYPE NumTotalShadingGroups;
	UINT_TYPE NumEmptyShadingDispatches;
...
{
	UINT_TYPE GroupIndex;
	UINT_TYPE MaterialCBIndexVS;
	UINT_TYPE MaterialCBIndexPS;
	UINT_TYPE MaterialCBIndexCS;
	UINT_TYPE MaterialCBIndexVS_Compact;
	UINT_TYPE MaterialCBIndexCS_Compact;
...
struct FNaniteShadingGroupMeta
{
	UINT_TYPE ElementDwordCount;
	UINT_TYPE ElementDwordStart;
	UINT_TYPE ElementDwordWriteOffset;
	UINT_TYPE ThreadGroupCount;
	UINT_TYPE ThreadGroupStart;
	UINT_TYPE ThreadGroupWriteOffset;
	UINT_TYPE Pad[2];
};

struct FNaniteShadingGroupAllocator
{
	UINT_TYPE NextElementDword;
	UINT_TYPE NextThreadGroup;
	UINT_TYPE Pad[2];
};
...
struct FNaniteShadingBinMeta
{
	...
	// Bindless Only
	// Shading group index
	UINT_TYPE ShadingGroup;

	UINT_TYPE MaterialCBIndex;
	UINT_TYPE FirstThreadGroup;	// Relative to current group
	UINT_TYPE QuadBinning;
	UINT_TYPE Pad;
};

// https://github.com/microsoft/DirectXShaderCompiler/issues/2181
#define NANITE_SHADING_BIN_META_ELEMENT_COUNT_OFFSET		0u
#define NANITE_SHADING_BIN_META_RANGE_START_OFFSET			4u
#define NANITE_SHADING_BIN_META_MATERIAL_FLAGS_OFFSET		8u
#define NANITE_SHADING_BIN_META_SHADING_GROUP_OFFSET		12u
#define NANITE_SHADING_BIN_META_MATERIAL_CB_INDEX_OFFSET	16u
#define NANITE_SHADING_BIN_META_FIRST_THREAD_GROUP			20u
#define NANITE_SHADING_BIN_META_QUAD_BINNING				24u
