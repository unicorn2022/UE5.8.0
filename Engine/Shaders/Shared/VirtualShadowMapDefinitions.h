...
// Number of per-page slices in Shadow.Virtual.DirtyPageFlags. 
#define VSM_DIRTY_PAGE_FLAGS_NUM_SLICES 6

// 1x border for bilinear filtering
#define VSM_PREFILTERED_DISTANT_BORDER_SIZE 1u
#define VSM_PREFILTERED_DISTANT_PAGE_SIZE (VSM_PAGE_SIZE + 2u * VSM_PREFILTERED_DISTANT_BORDER_SIZE)
...
#define VSM_PROJ_FLAG_HAS_PREFILTERED_DISTANT		(1U << 7) // Allocate and update a filterable shadow representation
...
#define VSM_STAT_PREFILTERED_DISTANT_PAGES				23
...
// Next data
#define VSM_NEXT_FLAG_KEEP_PAGE	(1u << 0)
#define VSM_NEXT_FLAG_ID_VALID	(1u << 1)
