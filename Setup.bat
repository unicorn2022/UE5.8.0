...
rem Installing VC++ Redistributable for Engine...
echo Installing VC++ Redistributable for Engine...
start /wait Engine\Extras\Redist\en-us\vc_redist.x64.exe /quiet /norestart

rem Installing Game Input Redistributable for Engine...
echo Installing Game Input Redistributable for Engine...
start /wait Engine\Extras\Redist\en-us\GameInputRedist.msi /quiet /norestart
